...
public class InsertSourceTag {
   ...
   * argument provided (only the first is examined). If a directory, all child directories and java
  ...
  public void run(String[] args) {
    if (args.length == 0) {
      ...
      System.out.println(
          "   " + ANY_CLASS_OPTION + ": Process any class. Default is only public classes.");
      ...
      System.out.println(
          "   " + REPLACE_OPTION + ": Replace existing source tags. Default is do not replace.");

      System.out.println(
          "   " + SVN_OPTION + ": Add the svn URL keyword. Default is do not add keyword.");
  ...
  /**
   * Process the given file or directory. If a directory, this method will be called recursively for
   * all child directories and files.
   *
      ...
      if (inJavadocBlock || inCommentBlock) {
        ...
        if (matcher.find()) {
          if (inJavadocBlock) {
            ...
            System.out.println(
                "   *** Mis-placed end marker for comment block " + "- skipping this file ***");
            System.out.println();
            return false;
          }
        }
        ...
        if (matcher.find()) {
          ...
          if (unknownPrecedingContent) {
            System.out.println(
                "   *** Javadocs do not directly precede class" + " - skipping file ***");
            System.out.println();
            return false;
          }
            ...
            if (matcher.find()) {
              ...
              if (!matcher.find()) {
                if (optionFixBreaks) {
                  ...
                  System.out.println(
                      "   *** Incomplete source tag detected" + "- skipping this file ***");
                  System.out.println();
                  return false;
                }
              }
