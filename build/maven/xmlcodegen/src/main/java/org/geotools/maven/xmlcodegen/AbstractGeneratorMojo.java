...
public abstract class AbstractGeneratorMojo extends AbstractMojo {
  ...
  /**
   * Flag controlling wether files should overide files that already exist with the same name. False
   * by default.
   *
   ...
   * expected relative filesystem location. The main advantage of this approach is that it supports
   * schema files that have cyclic dependencies (e.g. GML 3.2).
   *
