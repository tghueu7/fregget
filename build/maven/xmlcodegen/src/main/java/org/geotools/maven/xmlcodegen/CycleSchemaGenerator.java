...
public class CycleSchemaGenerator extends SchemaGenerator {
  ...
  /**
   * The depth integer required by the parent API. This class does not use it, so we put the maximum
   * value here to defend against accidentally calling the wrong parent method.
   */
  ...
  protected AttributeType createType(final XSDSimpleTypeDefinition xsdType, int depth) {
    ...
    AttributeType gtType =
        new AbstractLazyAttributeTypeImpl(name(xsdType), Object.class, false, false, null, null) {
          @Override
  ...
  protected AttributeType createType(final XSDComplexTypeDefinition xsdType, int depth) {
    ...
    ComplexType gtType =
        new AbstractLazyComplexTypeImpl(name(xsdType), false, xsdType.isAbstract(), null, null) {
          ...
          public Collection<PropertyDescriptor> buildDescriptors() {
            if (!followComplexTypes) {
              ...
              for (XSDParticle particle :
                  (List<XSDParticle>) Schemas.getChildElementParticles(xsdType, false)) {
  ...
  public List<AttributeType> sort() {
    List<AttributeType> sorted =
        new ArrayList<AttributeType>((Collection<AttributeType>) types.values());
    Collections.sort(
        sorted,
