...
public abstract class AbstractGenerator {
   ...
   *
   * <p>THe file written out is located under {@link #location}, with the path generated from {@link
   * #packageBase} appended.
   *
  ...
  /**
   * Attempts to locate a schema file by name by iterating through {@link #schemaLookupDirectories}.
   *
   ...
   *
   * <p>The class of the template is formed by prepending <code>org.geotools.xml.codegen.</code> to
   * <code>name</code>.
   *
   * <p>
   *
   ...
   * @throws RuntimeException If any exceptions ( ex, relection) occur. while attempting to execute
   *     the template.
   */
