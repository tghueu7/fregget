...
public class BindingGenerator extends AbstractGenerator {
  ...
  void generate(XSDNamedComponent c, XSDSchema schema) {
    ...
    try {
      String result =
          execute("CLASS", new Object[] {c, bindingConstructorArguments, bindingBaseClass});
  ...
  public static void main(String[] args) throws Exception {
    XSDSchema schema =
        Schemas.parse("/home/jdeolive/devel/geotools/trunk/demo/xml-po/src/main/xsd/po.xsd");
