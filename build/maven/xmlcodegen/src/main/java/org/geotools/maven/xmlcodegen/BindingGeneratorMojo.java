...
public class BindingGeneratorMojo extends AbstractGeneratorMojo {
  ...
  /**
   * Flag controlling wether a parser configuration ( {@link org.geotools.xml.Configuration} ) the
   * default is true.
   *
  ...
  /**
   * Flag controlling wether bindings for attributes should be generated, default is false.
   *
  ...
  /**
   * Flag controlling wether bindings for eleements should be generated, default is false.
   *
   * @parameter expression="false"
   */
  ...
  /**
   * Flag controlling wether bindings for types should be generated, default is true.
   *
   * @parameter expression="true"
   */
  ...
  /**
   * Flag controlling wether test for bindings should be generated, default is false.
   *
   * @parameter expression="false"
   */
  ...
  /**
   * List of constructor arguments that should be supplied to generated bindings. Each argument is a
   * 'name','type','mode' triplet. 'name' and 'type' declare the name and class of the argument
   * respectivley. 'mode' can be set to "member", or "parent". If set to "member" the argument will
   * be set to a member of the binding. If set to "parent" the argument will passed through to the
   * call to the super constructor. The default is "member"
   *
   * @parameter
   */
  ...
  /**
   * The base class for complex bindings. If unspecified {@link
   * org.geotools.xml.AbstractComplexBinding} is used.
   *
  ...
  /**
   * The base class for simple bindings. If unspecified {@link
   * org.geotools.xml.AbstractSimpleBinding} is used.
   *
        ...
        if ("jar".equals(dep.getType())) {
          ...
          ArtifactResolutionResult result =
              artifactResolver.resolveTransitively(
                  artifacts, artifact, remoteRepositories, localRepository, artifactMetadataSource);
