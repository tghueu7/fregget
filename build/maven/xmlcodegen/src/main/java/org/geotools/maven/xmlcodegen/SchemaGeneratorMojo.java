...
public class SchemaGeneratorMojo extends AbstractGeneratorMojo {
  ...
  /**
   * Flag controlling wether complex types should be composed of geotools attribute descriptors
  ...
  String[] imports;
  /**
   * Flag controlling wether paths are printed out as the generator recurses through the schema.
   *
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    if (imports != null) {
      ...
      ClassLoader ext =
          new URLClassLoader(
              (URL[]) urls.toArray(new URL[urls.size()]), getClass().getClassLoader());
