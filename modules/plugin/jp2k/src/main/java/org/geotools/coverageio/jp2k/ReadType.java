...
enum ReadType {
    ...
    RenderedImage read(
      ...
      try {
        ...
        if (LOGGER.isLoggable(Level.WARNING))
          LOGGER.log(
              Level.WARNING,
              "Unable to compute source area for file " + rasterFile.getAbsolutePath(),
              e);
        return null;
      } finally {
        // close everything
  ...
  JAI_IMAGEREAD {
    ...
    RenderedImage read(
      ...
      if (tileDimension != null) {
        ...
        raster =
            JAI.create("ImageRead", pbjImageRead, new RenderingHints(JAI.KEY_IMAGE_LAYOUT, layout));
  ...
  JAI_IMAGEREAD_MT {
    ...
    RenderedImage read(
      ...
      if (tileDimension != null) {
        ...
        raster =
            JAI.create(
                "ImageReadMT", pbjImageRead, new RenderingHints(JAI.KEY_IMAGE_LAYOUT, layout));
   ...
   * @return a {@link RenderedImage} instance that matches the provided request parameters as close
   *     as possible.
