...
enum ReadType {
    ...
    JAI_IMAGEREAD {
        ...
        RenderedImage read(
            ...
            if (tileDimension != null) {
                ...
                raster = JAI.create("ImageRead", pbjImageRead, new RenderingHints(JAI
    ...
    JAI_IMAGEREAD_MT {
        ...
        RenderedImage read(
            ...
            if (tileDimension != null) {
                ...
                final ImageLayout layout = new ImageLayout();
                layout.setTileWidth(tileDimension.width).setTileHeight(tileDimension.height);
                raster = JAI.create("ImageReadMT", pbjImageRead, new RenderingHints(JAI
                        .KEY_IMAGE_LAYOUT, layout));
            } else
     ...
     * Logger.
     */
    private final static Logger LOGGER = org.geotools.util.logging.Logging.getLogger(ReadType
            .class);
     ...
     * @param rasterFile
     * @param readDimension
     * @param tileDimension  a {@link Dimension} object that can be used to suggest specific
