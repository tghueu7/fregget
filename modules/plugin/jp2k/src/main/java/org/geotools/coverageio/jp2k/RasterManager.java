...
class RasterManager {
    ...
    class OverviewsController {
        final ArrayList<RasterManager.OverviewLevel> resolutionsLevels = new 
                ArrayList<OverviewLevel>();
    ...
    class DecimationController {
        ...
        void performDecimation(
            ...
            if (imageIndex == 0) {
                ...
                // raster dimensions. The solution is to have the rater dimensions on each level 
                // and to confront raster dimensions,
                //which means working
    ...
    class SpatialDomainManager {
        ...
        private void prepareCoverageSpatialElements() throws TransformException, FactoryException {
            ...
            //
            coverageGeographicBBox = ImageUtilities
        ...
        private void setBaseParameters() {
            ...
            final OverviewLevel highestLevel = RasterManager.this.overviewsController
