  ...
  class DecimationController {
    ...
    void performDecimation(
      ...
      if (imageIndex == 0) {
        ...
        // work on overviews
        // TODO this is bad side effect of how the Overviews are managed right now. There are two
        // problems here,
        // first we are assuming that we are working with LON/LAT, second is that we are getting
        // just an approximation of
        // raster dimensions. The solution is to have the rater dimensions on each level and to
        // confront raster dimensions,
        // which means working
        rasterWidth =
