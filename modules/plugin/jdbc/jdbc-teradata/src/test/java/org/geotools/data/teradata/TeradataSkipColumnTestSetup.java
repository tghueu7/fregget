...
public class TeradataSkipColumnTestSetup extends JDBCSkipColumnTestSetup {
    ...
    protected void createSkipColumnTable() throws Exception {
        ...
        run("CREATE TABLE \"skipcolumn\"(\"fid\" PRIMARY KEY not null generated always as " +
                "identity (start with 0)  integer, \"id\" integer, \"geom\" ST_GEOMETRY, " +
                "\"weirdproperty\" dollar,\"name\" varchar(200))");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                ...
                + fixture.getProperty("schema") + "', 'skipcolumn', 'geom', 2, " + getDelegate()
                .getSrid4326() + ", 'POINT')");
