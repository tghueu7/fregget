...
public class TeradataFilterToSQLOnlineTest extends JDBCTestSupport {
    ...
    public void testIt() throws Exception {
        ...
        ff.equals(ff.literal("intProperty"), ff.literal(5));
        SimpleFeatureIterator features = dataStore.getFeatureSource("cpi").getFeatures(filter)
                .features();
    ...
    private static class TeradataFilterToSQLTestSetup extends TeradataTestSetup {
        ...
        protected void setUpData() throws Exception {
            ...
            run("CREATE TABLE \"cpi\"(" //
                    ...
                    + "\"stringProperty\" varchar(200) casespecific) UNIQUE PRIMARY INDEX" +
            ...
            run("CREATE MULTISET TABLE \"cpi_geometry_idx\""
                    + " (intProperty INTEGER NOT NULL, doubleProperty double precision not null, " +
                    "cellid INTEGER NOT NULL)"
                    + " UNIQUE PRIMARY INDEX (intProperty,doubleProperty)");
//                    + " (id INTEGER NOT NULL, cellid INTEGER NOT NULL)");
            run("CREATE HASH INDEX cpi_geometry_idx_idx (cellid) ON cpi_geometry_idx ORDER BY " +
                    "(cellid);");
