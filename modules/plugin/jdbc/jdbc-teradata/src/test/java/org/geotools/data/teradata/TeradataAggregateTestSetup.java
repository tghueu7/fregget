...
public class TeradataAggregateTestSetup extends JDBCAggregateTestSetup {
    ...
    protected void createAggregateTable() throws Exception {
        run("CREATE TABLE \"aggregate\"(\"fid\" PRIMARY KEY not null generated always as identity" +
        ...
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                ...
                + fixture.getProperty("schema") + "', 'aggregate', 'geom', 2, " + getDelegate()
                .getSrid4326() + ", 'POLYGON')");
        ...
        run("INSERT INTO \"aggregate\" (\"fid\", \"id\",\"geom\",\"name\") VALUES (0, 0,'POLYGON(" +
                "(12 6, 14 8, 16 6, 16 4, 14 4, 12 6))', 'muddy1');");
        ...
        run("INSERT INTO \"aggregate\" (\"fid\", \"id\",\"geom\",\"name\") VALUES (2, 2,'POLYGON(" +
                "(12 6, 14 8, 16 6, 16 4, 14 4, 12 6))', 'muddy2');");
    }
