...
public class TeradataPrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    protected void createAutoGeneratedPrimaryKeyTable() throws Exception {
        run("CREATE TABLE \"auto\"(\"key\" PRIMARY KEY not null generated always as identity " +
                "(start with 1) integer, \"name\" varchar(200), geom ST_Geometry)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','auto', " +
                "'geom', " +
    ...
    protected void createMultiColumnPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','multi', " +
                "'geom', " +
                "2, " + getDelegate().getSrid4326() + ", 'ST_Geometry')");
    ...
    protected void createNonIncrementingPrimaryKeyTable() throws Exception {
        run("CREATE TABLE \"noninc\"(\"key\" PRIMARY KEY NOT NULL integer, \"name\" varchar(200)," +
                " geom ST_Geometry)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','noninc'," +
                " 'geom'," +
                "2, " + getDelegate().getSrid4326() + ", 'ST_Geometry')");
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        run("CREATE TABLE \"seq\" ( \"key\" generated always as identity (start with 1)  integer," +
                " \"name\" varchar(200), geom ST_Geometry)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','seq', " +
                "'geom', 2, " +
...
"(SELECT NEXTVAL('SEQ_KEY_SEQUENCE')),'three',NULL)");*/
    ...
    protected void createUniqueIndexTable() throws Exception {
        run("CREATE TABLE \"uniq\"(\"key\" UNIQUE NOT NULL int, \"name\" varchar(200), geom " +
                "ST_Geometry)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','uniq', " +
                "'geom', 2, " +
                getDelegate().getSrid4326() + ", 'ST_Geometry')");
...
//        run("CREATE UNIQUE INDEX \"uniq_key_index\" ON \"uniq\"(\"key\")");
    ...
    protected void createNonFirstColumnPrimaryKey() throws Exception {
        run("CREATE TABLE \"nonfirst\"(\"name\" varchar(200), \"key\" PRIMARY KEY not null " +
                "generated always as identity (start with 1) integer, geom ST_Geometry)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','test','auto', " +
                "'geom', " +
    ...
    private void createExtraTables() throws Exception {
        run("CREATE TABLE \"uniquetablenotgenerated\" ( \"key\" UNIQUE not null integer, \"name\"" +
                " VARCHAR(256), \"geom\" ST_GEOMETRY)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','" + fixture
                .getProperty("schema")
                + "','uniquetablenotgenerated', 'geom', 2, " + getDelegate().getSrid4326() + ", " +
                "'GEOMETRY')");
        insertFeatures("uniquetablenotgenerated");

        run("CREATE TABLE \"uniquetable\" ( \"key\" UNIQUE generated always as identity (start " +
                "with 1) integer not null, \"name\" VARCHAR(256), \"geom\" ST_GEOMETRY)");
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME, " +
                "F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('','" + fixture
                .getProperty("schema")
    ...
    private void dropExtraTables() throws Exception {
        ...
        runSafe("delete from SYSSPATIAL.GEOMETRY_COLUMNS where " +
                "f_table_name='uniquetablenotgenerated'");
    ...
    private void insertFeatures(String tableName) throws Exception {
        run("INSERT INTO \"" + tableName + "\" (\"key\", \"name\",\"geom\" ) VALUES (1,'one'," +
                "NULL)");
        run("INSERT INTO \"" + tableName + "\" (\"key\", \"name\",\"geom\" ) VALUES (2,'two'," +
                "NULL)");
        run("INSERT INTO \"" + tableName + "\" (\"key\", \"name\",\"geom\" ) VALUES (3,'three'," +
                "NULL)");
    }
