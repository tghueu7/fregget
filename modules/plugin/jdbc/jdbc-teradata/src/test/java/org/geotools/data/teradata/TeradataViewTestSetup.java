...
public class TeradataViewTestSetup extends JDBCViewTestSetup {
    ...
    protected void createLakesTable() throws Exception {
        ...
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                ...
                fixture.getProperty("database") + "', 'lakes', 'geom', 2, " + getDelegate()
                .getSrid4326() + ", 'POLYGON')");

        run("INSERT INTO lakes VALUES (0, 0, 'POLYGON((12 6, 14 8, 16 6, 16 4, 14 4, 12 6))', " +
                "'muddy')");
    }
    ...
    protected void createLakesView() throws Exception {
        ...
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME," +
                " F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('', '" +
                fixture.getProperty("database") + "', 'lakesview', 'geom', 2, " + getDelegate()
                .getSrid4326() + ", 'POLYGON')");
    }
    ...
    protected void createLakesView2() throws Exception {
        ...
        run("INSERT INTO SYSSPATIAL.GEOMETRY_COLUMNS (F_TABLE_CATALOG, F_TABLE_SCHEMA, " +
                "F_TABLE_NAME," +
                " F_GEOMETRY_COLUMN, COORD_DIMENSION, SRID, GEOM_TYPE) VALUES ('', '" +
                fixture.getProperty("database") + "', 'lakesview2', 'geom', 2, " + getDelegate()
                .getSrid4326() + ", 'POLYGON')");
        ...
        run("INSERT INTO gt_pk_metadata VALUES('" + fixture.getProperty("schema") + "', " +
