...
public class SQLServerJTDSJNDITest {
  ...
  /**
   * This test should fail with an IOException because there is actually no such JNDI to connect to,
   * but the factory lookup will have succeeded before throwing the exception.
   *
