...
public class MySQLDataStoreFactory extends JDBCDataStoreFactory {
    ...
    public static final Param ENHANCED_SPATIAL_SUPPORT =
            new Param("enhancedSpatialSupport", Boolean.class, "Enhanced Spatial Support", false,
                    false);
    ...
    protected JDBCDataStore createDataStoreInternal(JDBCDataStore dataStore, Map params)
        ...
        if (enhancedSpatialFlag == null) {
            ...
            dataStore.getLogger().info("MySQL version does not support enhancedSpatialSupport. " +
                    "Disabling it");
