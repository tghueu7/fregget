...
public class MySQLDialectBasic extends BasicSQLDialect {
  ...
  public Envelope decodeGeometryEnvelope(ResultSet rs, int column, Connection cx)
    ...
    try {
       ...
       * ST_Envelope() returns the point or the line segment as its MBR rather than returning an
       * invalid polygon therefore we must override behavior and check for a geometry and not a
       * polygon
       */
      // TODO: srid
