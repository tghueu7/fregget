...
public class SpatiaLiteDialect extends BasicSQLDialect {
    ...
    public void registerClassToSqlMappings(Map<Class<?>, Integer> mappings) {
        ...
        mappings.put(Geometries.MULTILINESTRING.getBinding(), Geometries.MULTILINESTRING
                .getSQLType());
        ...
        mappings.put(Geometries.GEOMETRYCOLLECTION.getBinding(), Geometries.GEOMETRYCOLLECTION
                .getSQLType());
    ...
    public void postCreateTable(String schemaName, SimpleFeatureType featureType, Connection cx)
        ...
        for (AttributeDescriptor ad : featureType.getAttributeDescriptors()) {
            if (ad instanceof GeometryDescriptor) {
                ...
                //type
                String gType = Geometries.getForBinding((Class<? extends Geometry>) gd.getType()
                        .getBinding()).getName();
                if (gType == null) {
    ...
    public void postCreateFeatureType(SimpleFeatureType featureType, DatabaseMetaData metadata,
        ...
        for (AttributeDescriptor ad : featureType.getAttributeDescriptors()) {
            ...
            ResultSet rs = metadata.getTables(null, dataStore.escapeNamePattern(metadata, 
                    schemaName),
