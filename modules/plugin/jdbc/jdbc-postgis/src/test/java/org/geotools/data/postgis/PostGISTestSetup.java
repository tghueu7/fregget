...
public class PostGISTestSetup extends JDBCTestSetup {
    ...
    protected void setUpData() throws Exception {
        ...
        run("INSERT INTO GEOMETRY_COLUMNS VALUES('', 'public', 'ft1', 'geometry', 2, '4326', " +
                "'POINT')");
        if (isVersion2()) {
        ...
        run("INSERT INTO \"ft1\" VALUES(0, ST_GeometryFromText('POINT(0 0)', 4326), 0, 0.0, " +
                "'zero')");
        run("INSERT INTO \"ft1\" VALUES(1, ST_GeometryFromText('POINT(1 1)', 4326), 1, 1.1, " +
                "'one')");
        run("INSERT INTO \"ft1\" VALUES(2, ST_GeometryFromText('POINT(2 2)', 4326), 2, 2.2, " +
                "'two')");
        ...
        run("CREATE TABLE \"ft3\"(" //
                ...
                + "\"doubleProperty\" double precision, " // 
                + "\"stringProperty\" varchar)");
        run("INSERT INTO \"ft3\" VALUES(0, ST_GeometryFromText('POINT(0 0)', 4326), 0, 0.0, " +
                "'zero')");
    }
