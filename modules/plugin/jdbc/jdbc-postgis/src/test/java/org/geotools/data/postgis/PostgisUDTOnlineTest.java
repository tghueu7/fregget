...
public class PostgisUDTOnlineTest extends JDBCUDTOnlineTest {
  ...
  public void testRead() throws Exception {
    ...
    try {
      ...
      assertEquals(
          "00000000-0000-0000-0000-000000000000", item.getAttribute(aname("ut13")).toString());
  ...
  public void testBigDate() throws Exception {
    ...
    filter =
        ff.greaterOrEqual(ff.property(aname("bd")), ff.literal(df.parse("1970-01-01T00:00:00 AD")));
