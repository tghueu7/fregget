...
public class DB2EmptyGeometryTestSetup extends JDBCEmptyGeometryTestSetup {
    ...
    protected void createEmptyGeometryTable() throws Exception {
        ...
        con.prepareStatement("CREATE TABLE " + DB2TestUtil.SCHEMA_QUOTED + ".\"empty\"(\"fid\" " +
                "int  PRIMARY KEY not null GENERATED ALWAYS AS IDENTITY,  "
                + "\"id\" integer, "
        ...
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_point", DB2TestUtil.SRSNAME, 
                con);
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_linestring", DB2TestUtil
                .SRSNAME, con);
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_polygon", DB2TestUtil.SRSNAME,
                con);
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_multipoint", DB2TestUtil
                .SRSNAME, con);
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_linestring", DB2TestUtil
                .SRSNAME, con);
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "empty", "geom_multipolygon", DB2TestUtil
                .SRSNAME, con);
