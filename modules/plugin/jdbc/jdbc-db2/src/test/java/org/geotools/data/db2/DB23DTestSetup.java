...
public class DB23DTestSetup extends JDBC3DTestSetup {
  ...
  //        con.prepareStatement("CREATE SEQUENCE "+getSquenceNameQuoted()+ " AS INTEGER  start with
  // 1").execute();
  ...
  protected void createLine3DTable() throws Exception {
    ...
    // "+DB2TestUtil.SCHEMA_QUOTED+"."+tableNameQuoted+"(\"fid\" int  generated always as identity
