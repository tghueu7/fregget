...
//    }
    ...
    protected void setUpData() throws Exception {
        ...
        sb.append("CREATE TABLE " + DB2TestUtil.SCHEMA_QUOTED + ".\"ft1\" ").append("(\"id\" int " +
        ...
        sb.append("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"ft1\" VALUES (")
                .append("0,db2gse.st_PointFromText('POINT(0 0)'," + DB2TestUtil.SRID + "), 0, " +
                        "0.0,'zero')");
        con.prepareStatement(sb.toString()).execute();

        sb = new StringBuffer();
        sb.append("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"ft1\" VALUES (")
                .append("1,db2gse.st_PointFromText('POINT(1 1)'," + DB2TestUtil.SRID + "), 1, " +
                        "1.1,'one')");
        con.prepareStatement(sb.toString()).execute();

        sb = new StringBuffer();
        sb.append("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"ft1\" VALUES (")
                .append("2,db2gse.st_PointFromText('POINT(2 2)'," + DB2TestUtil.SRID + "), 2, " +
                        "2.2,'two')");
        con.prepareStatement(sb.toString()).execute();
