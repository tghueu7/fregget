...
public class DB2PrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
  ...
  protected void createNonIncrementingPrimaryKeyTable() throws Exception {
    ...
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (1,'one',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (2,'two',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (3,'three',NULL)")
        .execute();
  ...
  protected void createMultiColumnPrimaryKeyTable() throws Exception {
    ...
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (1,'x','one',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (2,'y','two',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (3,'z','three',NULL)")
        .execute();
  ...
  protected void createNullPrimaryKeyTable() throws Exception {
    ...
    Connection con = getDataSource().getConnection();
    con.prepareStatement(
            "CREATE TABLE " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" ( \"name\" varchar(255) )")
        .execute();

    // insert data
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" (\"name\") VALUES ( 'one' )")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" (\"name\") VALUES ( 'two' )")
        .execute();
    con.prepareStatement(
  ...
  protected void createUniqueIndexTable() throws Exception {
    ...
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (1,'one',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (2,'two',NULL)")
        .execute();
    con.prepareStatement(
            "INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (3,'three',NULL)")
        .execute();
