...
public class DB2PrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    protected void createAutoGeneratedPrimaryKeyTable() throws Exception {
        ...
        String stmt = "create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"auto\" (\"key\" int generated always as identity (start with 1, increment by " +
                "1),\"name\" varchar(255),  \"geom\" DB2GSE.ST_GEOMETRY, primary key (\"key\"))";
        con.prepareStatement(stmt).execute();
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "auto", "geom", DB2TestUtil.SRSNAME, con);

        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"auto\" (\"name\"," +
                "\"geom\")  VALUES ('one',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"auto\" (\"name\"," +
                "\"geom\")  VALUES ('two',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"auto\" (\"name\"," +
                "\"geom\")  VALUES ('three',NULL)").execute();
    ...
    protected void createNonIncrementingPrimaryKeyTable() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"noninc\" (\"key\" int not null,\"name\" varchar(255),  \"geom\" DB2GSE" +
                ".ST_GEOMETRY, primary key (\"key\"))").execute();
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "noninc", "geom", DB2TestUtil.SRSNAME, con);

        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (1," +
                "'one',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (2," +
                "'two',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"noninc\" VALUES (3," +
                "'three',NULL)").execute();
    ...
    protected void createMultiColumnPrimaryKeyTable() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"multi\" (\"key1\" int not null, \"key2\" varchar(255) not null,\"name\" " +
                "varchar(255) , \"geom\" DB2GSE.ST_GEOMETRY, primary key (\"key1\",\"key2\"))")
                .execute();
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "multi", "geom", DB2TestUtil.SRSNAME, con);

        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (1," +
                "'x','one',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (2," +
                "'y','two',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"multi\" VALUES (3," +
                "'z','three',NULL)").execute();
    ...
    protected void createNullPrimaryKeyTable() throws Exception {
        //set up table
        Connection con = getDataSource().getConnection();
        con.prepareStatement("CREATE TABLE " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" ( \"name\"" +
                " varchar(255) )").execute();

        // insert data
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" (\"name\") " +
                "VALUES ( 'one' )").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" (\"name\") " +
                "VALUES ( 'two' )").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nokey\" (\"name\") " +
                "VALUES ( 'three' )").execute();
        con.close();
    }
    ...
    protected void createNonFirstColumnPrimaryKey() throws Exception {
        ...
        String stmt = "create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"nonfirst\" (\"name\" varchar(255), \"key\" int generated always as identity " +
                "(start with 1, increment by 1), \"geom\" DB2GSE.ST_GEOMETRY, primary key " +
                "(\"key\"))";
        con.prepareStatement(stmt).execute();
        DB2Util.executeRegister(DB2TestUtil.SCHEMA, "nonfirst", "geom", DB2TestUtil.SRSNAME, con);

        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nonfirst\" " +
                "(\"name\",\"geom\")  VALUES ('one',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nonfirst\" " +
                "(\"name\",\"geom\")  VALUES ('two',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"nonfirst\" " +
                "(\"name\",\"geom\")  VALUES ('three',NULL)").execute();
    ...
    protected void createUniqueIndexTable() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"uniq\" (\"key\" int not null,\"name\" varchar(255),  \"geom\" DB2GSE" +
                ".ST_GEOMETRY)").execute();
        ...
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (1," +
                "'one',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (2," +
                "'two',NULL)").execute();
        con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + ".\"uniq\" VALUES (3," +
                "'three',NULL)").execute();
