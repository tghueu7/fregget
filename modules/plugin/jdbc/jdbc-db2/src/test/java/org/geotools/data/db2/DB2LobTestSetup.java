...
public class DB2LobTestSetup extends JDBCLobTestSetup {
    ...
    protected void createLobTable() throws Exception {
        ...
        con.prepareStatement("create table " + DB2TestUtil.SCHEMA_QUOTED +
                ".\"testlob\" (\"fid\" int not null , \"blob_field\" BLOB(32) , \"clob_field\" " +
                "CLOB(32), \"raw_field\" BLOB(32), PRIMARY KEY(\"fid\"))").execute();

        PreparedStatement ps = con.prepareStatement("INSERT INTO " + DB2TestUtil.SCHEMA_QUOTED + 
