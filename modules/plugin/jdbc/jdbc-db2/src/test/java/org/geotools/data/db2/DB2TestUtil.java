...
//	protected final static String SRSNAME = "DEFAULT_SRS";
    ...
    static boolean existsTable(String schemaName, String tableName, Connection con) throws 
            SQLException {
    ...
    static boolean existsTrigger(String schemaName, String triggerName, Connection con) throws 
            SQLException {
        PreparedStatement ps = con.prepareStatement(
    ...
    static boolean existsSequence(String schemaName, String seqName, Connection con) throws 
            SQLException {
        PreparedStatement ps = con.prepareStatement(
    ...
    static boolean existsIndex(String schemaName, String indexName, Connection con) throws 
            SQLException {
    ...
    static void dropTable(String schemaName, String tableName, Connection con) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("drop table \"" + schemaName + "\".\"" + 
                tableName + "\"");
        ps.execute();
        ps.close();
    }
    ...
    static void dropView(String schemaName, String tableName, Connection con) throws SQLException {
        if (existsTable(schemaName, tableName, con) == false) return;
        PreparedStatement ps = con.prepareStatement("drop view \"" + schemaName + "\".\"" + 
                tableName + "\"");
        ps.execute();
        ps.close();
    }
    ...
    static void dropIndex(String schemaName, String indexName, Connection con) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("drop index \"" + schemaName + "\".\"" + 
                indexName + "\"");
        ps.execute();
        ps.close();
    }

    static void dropTrigger(String schemaName, String triggerName, Connection con) throws 
            SQLException {
        if (existsTrigger(schemaName, triggerName, con) == false) return;
        PreparedStatement ps = con.prepareStatement("drop trigger \"" + schemaName + "\".\"" + 
                triggerName + "\"");
        ps.execute();
        ps.close();
    }

    static void dropSequence(String schemaName, String seqName, Connection con) throws 
            SQLException {
        if (existsSequence(schemaName, seqName, con) == false) return;
        PreparedStatement ps = con.prepareStatement("drop sequence \"" + schemaName + "\".\"" + 
                seqName + "\"");
        ps.execute();
        ps.close();
    }
    ...
    public static void executecCreateSRS(String srsName, int srsId, double xoffset, double 
            xscale, double yoffset, double yscale,
