...
public class DB2PrimaryKeyFinderTestSetup extends JDBCPrimaryKeyFinderTestSetup {
    ...
    protected void createMetadataTable() throws Exception {
        ...
        con.prepareStatement("CREATE TABLE \"" + DB2TestUtil.SCHEMA + "\".gt_pk_metadata ( " + 
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("CREATE TABLE \"" + DB2TestUtil.SCHEMA + "\".\"seqtable\" ( \"key\" " +
                "integer not null,  "
        ...
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".\"seqtable\" (\"key\", " +
                "\"name\",\"geom\" ) VALUES (" +
        ...
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".gt_pk_metadata VALUES"
                + "('" + DB2TestUtil.SCHEMA + "', 'seqtable', 'key', 0, 'sequence', '" + 
                getSquenceName() + "')").execute();
        con.close();
    }
    ...
    protected void createPlainTable() throws Exception {
        ...
        con.prepareStatement("CREATE TABLE \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\" ( " +
                "\"key1\" int, \"key2\" int, "
        ...
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\" VALUES " +
                "(1, 2, 'one', NULL)").execute();
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\" VALUES " +
                "(2, 3, 'two', NULL)").execute();
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\" VALUES " +
                "(3, 4, 'three', NULL)").execute();
        con.close();
    ...
    protected void createAssignedSinglePkView() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("CREATE VIEW \"" + DB2TestUtil.SCHEMA + "\".\"assignedsinglepk\" AS " +
                "SELECT * FROM \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\"").execute();
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".gt_pk_metadata VALUES"
                + "('" + DB2TestUtil.SCHEMA + "', 'assignedsinglepk', 'key1', 0, 'assigned', " +
                "NULL)").execute();
        con.close();
    }
    ...
    protected void createAssignedMultiPkView() throws Exception {
        Connection con = getDataSource().getConnection();
        con.prepareStatement("CREATE VIEW \"" + DB2TestUtil.SCHEMA + "\".\"assignedmultipk\" AS " +
                "SELECT * FROM \"" + DB2TestUtil.SCHEMA + "\".\"plaintable\"").execute();
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".gt_pk_metadata VALUES"
                + "('" + DB2TestUtil.SCHEMA + "', 'assignedmultipk', 'key1', 0, 'assigned', NULL)" +
                "").execute();
        con.prepareStatement("INSERT INTO \"" + DB2TestUtil.SCHEMA + "\".gt_pk_metadata VALUES"
                + "('" + DB2TestUtil.SCHEMA + "', 'assignedmultipk', 'key2', 1, 'assigned', NULL)" +
                "").execute();
        con.close();
