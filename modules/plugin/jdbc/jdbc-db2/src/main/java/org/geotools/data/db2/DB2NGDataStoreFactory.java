...
public class DB2NGDataStoreFactory extends JDBCDataStoreFactory {
    ...
    public static String GetWKBZTypes = "select db2gse.st_asbinary(db2gse.st_point(1,2,3,0)) from" +
            " sysibm.sysdummy1";
    public static String SelectGeometryColumns = "select * from db2gse.st_geometry_columns where " +
            "0 = 1";
     ...
     */
    public static final Param USE_SELECTIVITY = new Param("Use selectivity clause", Boolean
            .class, "Use selectivity clause for spatial queries", false, Boolean.TRUE);
    ...
    protected JDBCDataStore createDataStoreInternal(JDBCDataStore dataStore, Map params)
        ...
        try {
            ...
            DB2DialectInfo di = ((DB2SQLDialectPrepared) dataStore.getSQLDialect())
                    .getDb2DialectInfo();
