...
public class DB2FilterToSQL extends PreparedFilterToSQL {
  ...
  private static HashMap<Class<?>, String> DB2_SPATIAL_PREDICATES = new HashMap<Class<?>, String>();
   ...
   * where the numeric value is the fraction of rows that will be returned by using the index scan.
   * This doesn't have to be true. The value 0.001 is typically used to force the use of the spatial
   * in all cases if the spatial index exists.
   *
