...
public class DB2Util {
  ...
  public static void executeUnRegister(
      String schemaName, String tableName, String columnName, Connection con) throws SQLException {
  ...
  public static void encodeGeometryValue(Geometry value, int srid, StringBuffer sql)
    ...
    sql.append(
        MessageFormat.format(
            pattern, new Object[] {new WKTWriter().write(value), Integer.toString(srid)}));
  }
}
