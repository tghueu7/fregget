...
public class DB2Util {
    ...
    public static void executeRegister(String schemaName, String tableName, String columnName, 
                                       String srsName, Connection con) throws SQLException {
    ...
    public static void executeRegisterAndCalculateExtent(String schemaName, String tableName, 
                                                         String columnName, String srsName, 
    ...
    public static void executeUnRegister(String schemaName, String tableName, String columnName, 
                                         Connection con) throws SQLException {
    ...
    static {
        ...
        PARAMETER_MARKES.put(MultiLineString.class, "DB2GSE.ST_MLineFromWKB(cast (? as BLOB(2G))," +
                "{0})");
        PARAMETER_MARKES.put(MultiPolygon.class, "DB2GSE.ST_MPolyFromWKB(cast (? as BLOB(2G))," +
                "{0})");
        PARAMETER_MARKES.put(Geometry.class, "DB2GSE.ST_GeomFromWKB(cast (? as BLOB(2G)),{0})");
        PARAMETER_MARKES.put(GeometryCollection.class, "DB2GSE.ST_GeomCollFromWKB(cast (? as BLOB" +
                "(2G)),{0})");
    ...
    static public void prepareGeometryValue(Class<? extends Geometry> gClass, int srid, Class 
            binding, StringBuffer sql) {
        String pattern = null;
