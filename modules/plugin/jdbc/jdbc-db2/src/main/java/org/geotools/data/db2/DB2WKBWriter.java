...
public class DB2WKBWriter {
  ...
  /**
   * Creates a writer that writes {@link Geometry} using {@link BIG_ENDIAN} byte order. If the input
   * geometry has a small coordinate dimension, coordinates will be padded with {@link
   * NULL_ORDINATE}.
   */
