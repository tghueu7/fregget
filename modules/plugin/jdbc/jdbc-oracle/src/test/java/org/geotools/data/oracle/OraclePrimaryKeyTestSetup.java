...
public class OraclePrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )" +
                " VALUES ('seq','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180,180," +
                "0.5), " +
    ...
    protected void createNonIncrementingPrimaryKeyTable() throws Exception {
        run("CREATE TABLE noninc (key INT, name VARCHAR(255)," +
                " geom MDSYS.SDO_GEOMETRY, PRIMARY KEY(key))");
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )" +
                " VALUES ('noninc','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180,180," +
                "0.5), " +
                "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5)), 4326)");
    ...
    protected void createMultiColumnPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )" +
                " VALUES ('multi','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180,180," +
                "0.5), " +
                "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5)), 4326)");
    ...
    protected void createUniqueIndexTable() throws Exception {
        ...
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )" +
                " VALUES ('uniq','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180,180," +
                "0.5), " +
                "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5)), 4326)");
    ...
    protected void createNonFirstColumnPrimaryKey() throws Exception {
        run("CREATE TABLE nonfirst (name VARCHAR(255), key INT, " +
                " geom MDSYS.SDO_GEOMETRY)");
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )" +
                " VALUES ('nonfirst','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180," +
                "180,0.5), " +
                "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5)), 4326)");
