...
public class Oracle3DTestSetup extends JDBC3DTestSetup {
    ...
    protected void createLine3DTable() throws Exception {
        ...
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID)"
                + " VALUES ('line3d','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180," +
                "180,0.5), "
                + "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5), MDSYS.SDO_DIM_ELEMENT('Z',-1000,1000," +
                "0.5)), 4326)");
    ...
    protected void createPoint3DTable() throws Exception {
        ...
        run("INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID)"
                + " VALUES ('point3d','geom',MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('X',-180," +
                "180,0.5), "
                + "MDSYS.SDO_DIM_ELEMENT('Y',-90,90,0.5), MDSYS.SDO_DIM_ELEMENT('Z',-1000,1000," +
                "0.5)), 4326)");
