...
public class SDOCreateTest {
  ...
  public void testXYZ_PolygonWithHole() throws Exception {
    checkValue(
        MDSYS.SDO_GEOMETRY(
            ...
            MDSYS.SDO_ORDINATE_ARRAY(
                2, 4, 99, 4, 3, 99, 10, 3, 99, 13, 5, 99, 13, 9, 99, 11, 13, 99, 5, 13, 99, 2, 11,
                99, 2, 4, 99, 7, 5, 99, 7, 10, 99, 10, 10, 99, 10, 5, 99, 7, 5, 99)),
  ...
  public void testXYZ_MultiPolygon() throws Exception {
    checkValue(
        MDSYS.SDO_GEOMETRY(
            ...
            MDSYS.SDO_ORDINATE_ARRAY(
                2, 3, 99, 7, 3, 99, 7, 9, 99, 2, 9, 99, 2, 3, 99, 9, 5, 99, 13, 5, 99, 11, 5, 99, 9,
                5, 99)),
        "MULTIPOLYGON (((2 3, 7 3, 7 9, 2 9, 2 3)), ((9 5, 13 5, 11 5, 9 5)))");
  }
  ...
  public void testXYZM_MultiPolygon() throws Exception {
    checkValue(
        MDSYS.SDO_GEOMETRY(
            ...
            MDSYS.SDO_ORDINATE_ARRAY(
                2, 3, 99, 88, 7, 3, 99, 88, 7, 9, 99, 88, 2, 9, 99, 88, 2, 3, 99, 88, 9, 5, 99, 88,
                13, 5, 99, 88, 11, 5, 99, 88, 9, 5, 99, 88)),
        "MULTIPOLYGON (((2 3, 7 3, 7 9, 2 9, 2 3)), ((9 5, 13 5, 11 5, 9 5)))");
  }
  ...
  public void testXY_GeometryCollection_Doc() throws Exception {
    checkValue(
        MDSYS.SDO_GEOMETRY(
            ...
            MDSYS.SDO_ORDINATE_ARRAY(
                1, 1, 1, 2, 2, 1, 2, 2, 3, 2, 3, 3, 2, 3, 2, 2, 5, 1, 9, 5, 5, 5, 5, 1, 5, 3, 6, 4,
                6, 3, 5, 3)),
  ...
  public void testXYM_GeometryCollection_Doc() throws Exception {
    checkValue(
        MDSYS.SDO_GEOMETRY(
            ...
            MDSYS.SDO_ORDINATE_ARRAY(
                1, 1, 99, 1, 2, 99, 2, 1, 99, 2, 2, 99, 3, 2, 99, 3, 3, 99, 2, 3, 99, 2, 2, 99, 5,
                1, 99, 9, 5, 99, 5, 5, 99, 5, 1, 99, 5, 3, 99, 6, 4, 99, 6, 3, 99, 5, 3, 99)),
        "GEOMETRYCOLLECTION (POINT (1 1), LINESTRING (1 2, 2 1), POLYGON ((2 2, 3 2, 3 3, 2 3, 2 2)), POLYGON ((5 1, 9 5, 5 5, 5 1), (5 3, 6 4, 6 3, 5 3)))");
  }
  ...
  private Geometry create(SDO_GEOMETRY oraGeom, GeometryFactory gf) {
    return SDO.create(
        gf, oraGeom.gType, oraGeom.srid, oraGeom.ptType, oraGeom.elemInfo, oraGeom.ordinates);
  }
}
