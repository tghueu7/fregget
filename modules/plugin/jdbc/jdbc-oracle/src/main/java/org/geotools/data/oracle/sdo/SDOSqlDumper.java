...
public class SDOSqlDumper {
   ...
   * class, as we now have more than one class using this (which is why it changed to public static)
   *
  ...
  private static String toSDOGeom(Polygon polygon, int srid) {
    ...
    if (polygon.getNumInteriorRing() > 0) {
      LOGGER.warning(
          "Polygon contains Interior Rings. " + "These rings will not be included in the query.");
    }
