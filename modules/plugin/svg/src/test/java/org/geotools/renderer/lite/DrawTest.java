...
public class DrawTest {
  ...
  public void testRenderingHints() throws Exception {
    ...
    mc.dispose();
    ImageAssert.assertEquals(
        new File("./src/test/resources/org/geotools/renderer/lite/test-data/labeledPolygon.png"),
        image,
        1000);
  }
  ...
  public void testPoint() throws Exception {
    ...
    ImageAssert.assertEquals(
        new File("./src/test/resources/org/geotools/renderer/lite/test-data/pointHouse.png"),
        image,
        1000);
  }
  ...
  public void testDisplacedPoint() throws Exception {
    ...
    BufferedImage image =
        RendererBaseTest.showRender("PointHouseDisplaced", renderer, TIME, bounds, listener);
    ImageAssert.assertEquals(
        new File(
