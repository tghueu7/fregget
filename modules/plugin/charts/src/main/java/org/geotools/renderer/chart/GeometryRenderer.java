...
public class GeometryRenderer extends AbstractXYItemRenderer {
    ...
    public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea,
                         PlotRenderingInfo plotInfo, XYPlot plot, ValueAxis domainAxis, ValueAxis
                                 rangeAxis,
    ...
    void drawGeometry(Geometry g, Graphics2D g2, int series, int item, Rectangle2D dataArea,
        ...
        if (g instanceof GeometryCollection) {
            ...
            for (int i = 0; i < gc.getNumGeometries(); i++) {
                drawGeometry(
                        gc.getGeometryN(i), g2, series, item, dataArea, plot, domainAxis, 
                        rangeAxis);
            }
            ...
            if (fillPolygons) {
                ...
                if (p instanceof Color) {
                    Color c = (Color) p;
                    p = new Color(c.getRed() / 255f, c.getGreen() / 255f, c.getBlue() / 255f, 
                            polygonFillOpacity);
                }
                g2.setPaint(p);
    ...
    static class TranslatedLiteShape extends LiteShape {
        ...
        class TranslatedIterator implements PathIterator {
            ...
            public int currentSegment(float[] coords) {
                ...
                coords[0] = (float) domainAxis.valueToJava2D(coords[0], dataArea, plot
                        .getDomainAxisEdge());
                coords[1] = (float) rangeAxis.valueToJava2D(coords[1], dataArea, plot
                        .getRangeAxisEdge());
                return i;
            }
