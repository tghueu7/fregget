...
public class PropertyDataStoreTest extends TestCase {
  ...
  /**
   * In response to <a href="http://jira.codehaus.org/browse/GEOT-3540">GEOT-3540 PropertyDataStore
   * doesn't support empty trailing spaces</a>.
   *
  ...
  public void testTransactionIndependence() throws Exception {
    ...
    SimpleFeature chrisFeature =
        SimpleFeatureBuilder.build(
            ROAD, new Object[] {new Integer(5), "chris", wkt.read("POINT(6 6)")}, "fid5");
