...
public class WorldImageWriterTest extends WorldImageBaseTestCase {
  ...
  /**
   * This method is responsible for loading the provided source object as a cverage then for writing
   * it on the temp directoy and finally for rereading the coverage back into memory in order to
   * display it.
   *
  ...
  /**
   * TestRunner for testing inside a java application. It gives us the ability to keep windows open
