...
public final class WorldImageFormat extends AbstractGridFormat implements Format {
  ...
  /**
   * Retrieves a {@link WorldImageReader} in case the providede <code>source</code> can be accepted
   * as a valid source for a world image. The method returns null otherwise.
   *
  ...
  /**
   * Takes an image file extension (such as .gif, including the '.') and returns it's corresponding
   * world file extension (such as .gfw).
   *
