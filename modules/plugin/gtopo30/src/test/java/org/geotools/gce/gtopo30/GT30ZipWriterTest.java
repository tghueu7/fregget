...
public class GT30ZipWriterTest extends GT30TestBase {
  ...
  public void test() throws Exception {
    ...
    if (format.accepts(statURL)) {
      ...
      writer.write(
          gc, (GeneralParameterValue[]) params.values().toArray(new GeneralParameterValue[1]));
  ...
  public void testExternalZIP() throws Exception {
    ...
    assertTrue(
        "Unable to parse source data for this GTOPO30 write test", format.accepts(sourceURL));
