 ...
 * value
 * using a new supplied one. A new layout is used in order to convert to the required image 
 * layout. Default
    ...
    private static final class NoDataReplacerDescriptor extends OperationDescriptorImpl {
        ...
        public NoDataReplacerDescriptor() {
            super(new String[][]{{"GlobalName", OPERATION_NAME},
                    ...
                    new Object[]{new Double(Double.NaN), new Short((short) -9999), new Double
                            (10.0E-6)},        // Default values for parameters,
