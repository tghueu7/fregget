...
public class GPKGConfiguration extends Configuration {
    ...
    protected final void registerBindings(MutablePicoContainer container) {
        ...
        container.registerComponentImplementation(GPKG.geopkgtype_features, 
                Geopkgtype_featuresBinding.class);
        container.registerComponentImplementation(GPKG.geopkgtype_tiles, Geopkgtype_tilesBinding
                .class);
        container.registerComponentImplementation(GPKG.gridsettype_grids, 
                Gridsettype_gridsBinding.class);
