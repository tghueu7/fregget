 ...
 * <pre>
 * 	 <code>
 *  &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;xs:complexType name="geopkgtype_tiles" 
...
public class Geopkgtype_tilesBinding extends LayertypeBinding {
    ...
    public Layer parseLayer(ElementInstance instance, Node node, Object value) throws Exception {
        ...
        layer.setCoverage((GeoPackageProcessRequest.TilesLayer.TilesCoverage) node.getChildValue
                ("coverage"));
