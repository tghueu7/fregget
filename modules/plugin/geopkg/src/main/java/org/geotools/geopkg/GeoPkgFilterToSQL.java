...
public class GeoPkgFilterToSQL extends PreparedFilterToSQL {
  ...
  protected Object visitBinarySpatialOperator(
    ...
    // get the attribute, it will expand the default geom name if necessary and give access to the
    // user data
    ...
    try {
      if (primaryKey != null
        ...
        // fall back on direct BBOX tests, it's still faster than loading the whole geometry and to
        // do BBOX in memory
        StringBuffer sb = new StringBuffer();
