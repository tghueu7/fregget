...
public class GeoPkgPrimaryKeyFinderTestSetup extends JDBCPrimaryKeyFinderTestSetup {
    ...
    protected void createPlainTable() throws Exception {
        run("CREATE TABLE plaintable (key1 integer primary key, key2 int, name varchar(255),geom " +
                "BLOB)");
        ...
        run(sql);
        sql = "INSERT INTO gpkg_geometry_columns VALUES ('plaintable', 'geom', 'POINT', 4326, 0, " +
                "0)";
        run(sql);
