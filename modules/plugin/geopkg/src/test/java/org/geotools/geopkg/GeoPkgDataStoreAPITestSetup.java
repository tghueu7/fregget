...
public class GeoPkgDataStoreAPITestSetup extends JDBCDataStoreAPITestSetup {
    ...
    protected void createLakeTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('lake', 'geom', 'POLYGON', 4326, " +
                "0, 0)";
        run(sql);
    ...
    protected void createRiverTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('river', 'geom', " +
                "'MULTILINESTRING', 4326, 0, 0)";
        run(sql);
        sql = "INSERT INTO gpkg_contents (table_name, data_type, identifier, srs_id) VALUES "
        ...
        MultiLineString line = gb.multiLineString(gb.lineString(5, 5, 7, 4), gb.lineString(7, 5, 
                9, 7, 13, 7), gb.lineString(7, 5, 9, 3, 11, 3));
    ...
    protected void createRoadTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('road', 'geom', 'LINESTRING', " +
                "4326, 0, 0)";
        run(sql);
        sql = "INSERT INTO gpkg_contents (table_name, data_type, identifier, srs_id) VALUES " +
