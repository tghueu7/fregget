 ...
 * <pre>
 *   <code>
 *  &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;xs:complexType name="coveragetype" 
...
public class CoveragetypeBindingTest extends GPKGTestSupport {
    ...
    public void testType() {
        assertEquals(GeoPackageProcessRequest.TilesLayer.TilesCoverage.class, binding(GPKG
    ...
    public void testParse() throws Exception {
        buildDocument("<coverage><minZoom>1</minZoom><maxZoom>10</maxZoom><minColumn>100" +
                "</minColumn><maxColumn>1000</maxColumn><minRow>50</minRow><maxRow>500</maxRow" +
                "></coverage>");
        Object result = parse(GPKG.coveragetype);
        assertTrue(result instanceof GeoPackageProcessRequest.TilesLayer.TilesCoverage);
        GeoPackageProcessRequest.TilesLayer.TilesCoverage coverage = (GeoPackageProcessRequest
                .TilesLayer.TilesCoverage) result;
