...
public class GeoPkgPrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    protected void createAutoGeneratedPrimaryKeyTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('auto', 'geom', 'POINT', 4326, 0," +
                " 0)";
        run(sql);
    ...
    protected void createMultiColumnPrimaryKeyTable() throws Exception {
        run("CREATE TABLE multi( key1 INTEGER NOT NULL, key2 VARCHAR NOT NULL, name VARCHAR, " +
                "PRIMARY KEY(key1,key2))");

        run("ALTER TABLE multi add geom BLOB");
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('multi', 'geom', 'POINT', 4326, " +
                "0, 0)";
        run(sql);
        sql = "INSERT INTO gpkg_contents (table_name, data_type, identifier, srs_id) VALUES "
    ...
    protected void createNonIncrementingPrimaryKeyTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('noninc', 'geom', 'POINT', 4326, " +
                "0, 0)";
        run(sql);
        sql = "INSERT INTO gpkg_contents (table_name, data_type, identifier, srs_id) VALUES "
    ...
    protected void createNonFirstColumnPrimaryKey() throws Exception {
        run("CREATE TABLE nonfirst(name VARCHAR, fid INTEGER PRIMARY KEY AUTOINCREMENT, geom " +
                "BLOB)");
        // run("SELECT AddGeometryColumn('nonfirst','geom',4326,'POINT',2)");
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('nonfirst', 'geom', 'POINT', " +
                "4326, 0, 0)";
        run(sql);
        sql = "INSERT INTO gpkg_contents (table_name, data_type, identifier, srs_id) VALUES "
    ...
    protected void createUniqueIndexTable() throws Exception {
        ...
        String sql = "INSERT INTO gpkg_geometry_columns VALUES ('uniq', 'geom', 'POINT', 4326, 0," +
                " 0)";
        run(sql);
