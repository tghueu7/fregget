...
public class LongitudeFirstFactoryOverrideTest {
    ...
    public void setUp() throws Exception {
        ...
        ReferencingFactoryFinder.addAuthorityFactory(new CoordinateOperationFactoryUsingWKT(null,
    ...
    public void testFallbackOnEPSGDatabase() throws Exception {
        ...
        CoordinateReferenceSystem target = CRS.decode("EPSG:4326");
        CoordinateOperation co = CRS.getCoordinateOperationFactory(true).createOperation(source, 
                target);
