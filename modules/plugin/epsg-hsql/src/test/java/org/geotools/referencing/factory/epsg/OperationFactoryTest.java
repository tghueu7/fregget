...
public class OperationFactoryTest extends TestCase {
  ...
  /**
   * Tests the creation of an operation from EPSG:4230 to EPSG:4326. They are the same CRS than the
   * one tested in {@link DefaultDataSourceTest#testTransformations}.
   */
  ...
  /**
   * Tests findOperations method for a pair of known CRSs. 23030 (Projected) to 4326 (geographic 2D)
