...
public class ThreadedHsqlEpsgFactory extends ThreadedEpsgFactory {
  ...
  /**
   * Creates a new instance of this data source using the specified hints. The priority is set to a
   * lower value than the {@linkplain FactoryOnAccess}'s one in order to give precedence to the
