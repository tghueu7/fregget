...
public class DatabaseCreationScript {
  ...
  public static void main(String[] args) throws Exception {
     ...
     * instructions - update ThreadedHsqlEpsgFactory.VERSION - modify the "directory" variable below
     * to point to the folder containing the SQL scripts
     */
    ...
    try {
      ...
      SQLException e =
          new SQLException(
              "Error occurred while executing " + "the EPSG database creation scripts");
