...
public class UtilitiesTest extends Assert {
    ...
    public void testGetEnvelope() throws FactoryException, TransformException {
        ...
        GeneralEnvelope wgs84_2 = new GeneralEnvelope(Utilities.getEnvelopeAsWGS84(envelope, 
                false));
    ...
    public void testCropRegion() throws TransformException {
        ...
        Rectangle cropRegion = Utilities.getCropRegion(envelope, gg2D.getGridToCRS2D
    ...
    public void testCreateCoverage() throws IOException {
        ...
        int imageIndex = 0;
        PlanarImage image = ConstantDescriptor.create(10f, 10f, new Byte[]{1}, GeoTools
                .getDefaultHints());
        ...
        GridGeometry2D gg2D = new GridGeometry2D(new GridEnvelope2D(bounds), raster2Model, 
                spatialReferenceSystem2D);

        GeneralEnvelope coverageEnvelope2D = new GeneralEnvelope(gg2D.getEnvelope());
        GridSampleDimension[] sampleDimensions = new GridSampleDimension[]{new 
                GridSampleDimension("testDim")};
        // Creation of the Coverage
        GridCoverage2D coverage1 = (GridCoverage2D) Utilities.createCoverageFromImage
                (coverageFactory, coverageName, imageIndex, image,
