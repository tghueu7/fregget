...
public class DimensionlessAxisTest extends Assert {
   ...
   *
   * <p>This really is a toy example; if you have a formal fixed data dictionary consider the use of
   * a Java Enumeration (and EnumMeasure), if you have an open ended data dictionary consider a
  ...
  public void testElevation() {
    DimensionlessAxis HEIGHT =
        new DimensionlessAxis(
            1, new NameImpl("height"), new SimpleInternationalString("Height from sealevel"));
  ...
  public void testImage() {
    ...
    assertTrue(
        sample.getDescription().compareTo(new SimpleInternationalString("Axis for GRAY bands"))
            == 0);
