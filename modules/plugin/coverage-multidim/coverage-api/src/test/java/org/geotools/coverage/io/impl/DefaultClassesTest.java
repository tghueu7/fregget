  ...
  public void testDefaultFileDriver() {
    DefaultFileDriver driver =
        new DefaultFileDriver(
            ...
            EnumSet.of(
                DriverCapabilities.CONNECT, DriverCapabilities.CREATE, DriverCapabilities.DELETE));
  ...
  public void testDefaultGridCoverageResponse() {
    ...
    assertTrue(
        CRS.equalsIgnoreMetadata(
            response.getCoordinateReferenceSystem(), cov.getCoordinateReferenceSystem()));
    ...
    DirectPosition2D pos =
        new DirectPosition2D(cov.getEnvelope2D().getCenterX(), cov.getEnvelope2D().getCenterY());
