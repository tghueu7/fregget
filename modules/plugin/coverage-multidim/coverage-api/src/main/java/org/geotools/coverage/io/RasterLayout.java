...
public class RasterLayout {
  ...
  /**
   * Returns the value of <code>minX</code> if it is valid, and otherwise returns the value from the
   * supplied <code>RenderedImage</code>. If <code>minX</code> is not valid and fallback is null, 0
   * is returned.
   *
  ...
  /**
   * Returns the value of <code>minY</code> if it is valid, and otherwise returns the value from the
   * supplied <code>RenderedImage</code>. If <code>minY</code> is not valid and fallback is null, 0
   * is returned.
   *
   * @param fallback the <code>RenderedImage</code> fallback.
