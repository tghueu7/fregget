...
public class Identification implements CharSequence, Serializable {
  ...
  /**
   * Returns a subsequence of this identification. The new identification will contains a substring
   * of the {@linkplain #name}, but the {@linkplain #type} will be unchanged.
   */
