...
public interface Driver extends OptionalFactory, Factory {
   ...
   * of each implementation should be provided to the user so they can make an intellegent choice in
   * the matter).
   *
   ...
   * (jars or libraries).
   *
   * <p>One may ask how this is different than {@link #canConnect(Map)}, and basically available can
   * be used by finder mechanisms to list available {@link Driver}s.
   *
