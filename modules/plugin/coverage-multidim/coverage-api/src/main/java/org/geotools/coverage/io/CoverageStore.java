...
public interface CoverageStore extends CoverageSource {
     ...
     * {@link #update(CoverageReadRequest, ProgressListener)} method.
     * <p>
     *
     * @return Param a {@link Map} describing the {@link Map} for 
     * {@link #update(CoverageReadRequest, ProgressListener)}.
     */
     ...
     * getUpdateParameterInfo method; and should be limited to the
