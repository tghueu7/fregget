...
public class CoverageResponse {
  ...
  private List<GridCoverage> results = Collections.synchronizedList(new ArrayList<GridCoverage>());
  ...
  /**
   * Get the status of this coverage response. It should always be checked before assuming any data
   * is available.
   *
