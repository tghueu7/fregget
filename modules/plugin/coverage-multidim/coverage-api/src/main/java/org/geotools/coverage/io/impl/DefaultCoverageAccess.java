...
public class DefaultCoverageAccess implements CoverageAccess {
    ...
    protected final Map<String, Parameter<?>> accessParameters = new HashMap<String, 
            Parameter<?>>();

    protected final Map<String, Serializable> connectionParameters = new HashMap<String, 
            Serializable>();
