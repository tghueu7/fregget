...
public interface CoverageAccess {
   ...
   *
   * <p>You can check isCreateSupported() prior to calling this method. Implementing subclasses may
   * throw an {@link UnsupportedOperationException} in case the related Driver won't allow {@link
  ...
  /**
   * Test to see if this coverage access is suitable for deleting a {@link CoverageSource} referred
   * by Name, with the specified set of parameters.
   *
   ...
   * @param Hints Implementation specific Hints; please consult the javadocs for the Driver you are
   *     working with.
   */
   ...
   *
   * <p>Many file based formats won't allow to perform such operation, but db based source should be
   * quite happy with it.
   *
   * @param name
   * @param params
