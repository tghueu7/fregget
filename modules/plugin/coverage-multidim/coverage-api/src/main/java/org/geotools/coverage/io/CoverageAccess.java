...
public interface CoverageAccess {
    ...
    public enum AccessType {
         ...
         * {@link CoverageAccess#access(Name, Map, AccessType, Hints, ProgressListener)} is able to
     ...
     * @param params     Additional parameters as needed to indicate what part of the data set to
     *                  access
     * @param accessType Requested level of access
     * @param Hints      Implementation specific hints; please review the javadocs for your 
     *                   Driver for details
     ...
     * @param Hints  Implementations specific Hints, please check the javadocs for your driver 
     *               for details
     ...
     * @param Hints  Implementation specific Hints; please consult the javadocs for the Driver 
