...
public class NetCDFMultiDimTest {
    ...
    public void test() throws Exception {
        ...
        assertEquals("2012-04-01T02:00:00.000Z,2012-04-01T03:00:00.000Z", reader.getMetadataValue
                (D, "RUNTIME_DOMAIN"));
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 0, 1,
                2, 3);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 4, 5,
                6, 7);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 8, 9,
                10, 11);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 12, 
                13, 14, 15);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 16, 
                17, 18, 19);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 20, 
                21, 22, 23);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 24, 
                25, 26, 27);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 28, 
                29, 30, 31);
    ...
    private void checkFoursome(NetCDFReader reader, GeneralParameterValue[] pams, double a, 
    ...
    public void test2DTime_DiffSize(File file) throws Exception {
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 32, 
                33, 34, 35);
        ...
        checkFoursome(reader, new GeneralParameterValue[]{zValue, timeValue, runtimeValue}, 36, 
                37, 38, 39);
    }
    ...
    public void test2DTime_FeatureCollection_DiffSize() throws Exception {
        ...
        String content = FileUtils.readFileToString(new File(dir, "twodimtime_diffsize.fc"), 
                "UTF-8");
    ...
    public void test2DTime_Aggregation_DiffSize() throws Exception {
        File dir = TestData.file(this, "twodimtime");
        String content = FileUtils.readFileToString(new File(dir, "twodimtime_diffsize.ncml"), 
                "UTF-8");
        content = content.replaceAll("\\$\\{DIRECTORY\\}", dir.toString());
