...
public class NetCDFMultiDimTest {
  ...
  public void test() throws Exception {
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 8, 9, 10, 11);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 12, 13, 14, 15);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 16, 17, 18, 19);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 20, 21, 22, 23);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 24, 25, 26, 27);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 28, 29, 30, 31);
  }
  ...
  public void test2DTime_DiffSize(File file) throws Exception {
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 32, 33, 34, 35);
    ...
    checkFoursome(
        reader, new GeneralParameterValue[] {zValue, timeValue, runtimeValue}, 36, 37, 38, 39);
  }
