...
public final class CoordinateHandlerFinder {
  ...
  private static final Logger LOGGER = Logging.getLogger(CoordinateHandlerFinder.class.toString());
  ...
  /**
   * Finds all available implementations of {@link CoordinateHandlerSpi} which have registered using
