...
public class NetCDFImageReader extends GeoSpatialImageReader implements FileSetManager {
  ...
  private void init() throws IOException {
    ...
    try {
      if (dataset != null) {
        ...
        uniqueTimeAttribute =
            ancillaryFileManager.getParameterAsBoolean(NetCDFUtilities.UNIQUE_TIME_ATTRIBUTE);
  ...
  public BufferedImage read(int imageIndex, ImageReadParam param) throws IOException {
    ...
    final BufferedImage image =
        new BufferedImage(colorModel, raster, colorModel.isAlphaPremultiplied(), properties);
  ...
  public SimpleFeatureType getIndexSchema(
      Name coverageName, CoordinateSystem coordinateSystem, boolean isShared) throws Exception {
    // get the name for this variable to check his coveragename
    final String _coverageName = coverageName.toString();
    // get the coverage definition for this variable, at this stage this exists otherwise we would
    // have skipped it!
  ...
  public IIOMetadata getImageMetadata(int imageIndex) throws IOException {
    ...
    SampleModel sampleModel =
        new BandedSampleModel(
            wrapper.getSampleModel().getDataType(), width, height, wrapper.getNumBands());
    final ColorModel colorModel = ImageIOUtilities.createColorModel(sampleModel);
