...
public class Slice2DIndex {
    ...
    public static class Slice2DIndexManager {
         ...
         * @throws IOException
         */
        public static void writeIndexFile(File file, List<Slice2DIndex> indexList) throws 
                IOException {
            ...
            try {
                ...
                raf.writeInt(size);
                long dataPosition = ADDRESS_POSITION + (size + 1) * ADDRESS_SIZE; // the +1 is to
                // have the end address
