...
public class ShapefileDumperTest {
  ...
  /**
   * Returns a collection from the dumper folder given a type name. The support shapefile data store
   * will be closed automatically by the test machinery during tear down
   *
   * @param typeName
   * @return
   * @throws IOException
