...
public class TestCaseSupport {
  ...
  /**
   * Set to {@code true} if {@code println} are wanted during normal execution. It doesn't apply to
  ...
  /**
   * Copies the specified shape file into the {@code test-data} directory, together with its sibling
   * ({@code .dbf}, {@code .shp}, {@code .shx} and {@code .prj} files).
   */
