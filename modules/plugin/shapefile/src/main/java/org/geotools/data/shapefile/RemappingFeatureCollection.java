...
class RemappingFeatureCollection extends DecoratingSimpleFeatureCollection {
  ...
  /**
   * Returns a shapefile compatible collection, that is, geometry field is always named the_geom and
   * field names have a max length of 10. Will return the original collection if already compatible
   *
   * @param fc
   * @return
   */
  ...
  /**
   * Remaps a SimpleFeature, using the given mappings (oldname -> mappedname). The builder uses the
   * mapped schema.
   *
   * @param source
