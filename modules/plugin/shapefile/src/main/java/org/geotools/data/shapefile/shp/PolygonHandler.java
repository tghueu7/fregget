...
public class PolygonHandler implements ShapeHandler {
    ...
    public Object read(ByteBuffer buffer, ShapeType type, boolean flatFeature) {
        ...
        for (int part = 0; part < numParts; part++) {
            ...
            CoordinateSequence csRing =
                    JTS.createCS(geometryFactory.getCoordinateSequenceFactory(), length + close, 
                            dimensions);
            // double area = 0;
            // int sx = offset;
    ...
    public void write(ByteBuffer buffer, Object geometry) {
        ...
        final CoordinateSequence[] coordinates;
        {
            ...
            coordinates = (CoordinateSequence[]) allCoords.toArray(new 
                    CoordinateSequence[allCoords.size()]);
