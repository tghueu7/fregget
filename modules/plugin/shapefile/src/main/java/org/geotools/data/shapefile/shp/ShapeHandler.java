...
public interface ShapeHandler {
  ...
  /**
   * Get the length of the given geometry Object in <b>bytes</b> not 16-bit words. This is easier to
   * keep track of, since the ByteBuffer deals with bytes. <b>Do not include the 8 bytes of
   * record.</b>
   *
