...
public class ShapefileDataStoreFactory implements FileDataStoreFactorySpi {
  ...
  public static final Param URLP =
      new Param("url", URL.class, "url to a .shp file", true, null, new KVP(Param.EXT, "shp"));
  ...
  /**
   * Looks up a parameter, if not found it returns the default value, assuming there is one, or null
   * otherwise
   *
   * @param <T>
   * @param param
