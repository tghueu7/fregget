...
public class DbaseFileHeader {
   ...
   * refCal.set(Calendar.HOUR, 12); refCal.set(Calendar.MINUTE, 0); refCal.set(Calendar.SECOND, 0);
   * refCal.set(Calendar.MILLISECOND, 0); MILLIS_SINCE_4713 = refCal.getTimeInMillis() - 43200000L;
   ...
   * column. The decimal count only applies to numbers(N), and floating point values (F), and refers
   * to the number of characters to reserve after the decimal point. <B>Don't expect miracles from
   * this...</B>
   *
   * <PRE>
