...
public class Commands {
  ...
  /**
   * A command to close an {@link SeStreamOp stream} (ie, {@link SeDelete}, {@link SeInsert}, {@link
   * SeQuery}, {@link SeUpdate}).
   */
  ...
  public static final class GetLayerCommand extends Command<SeLayer> {
    ...
    /**
     * @return the SeLayer corresponding to the provided SeTable, or {@code null} if the table has
     *     no shape column
     */
