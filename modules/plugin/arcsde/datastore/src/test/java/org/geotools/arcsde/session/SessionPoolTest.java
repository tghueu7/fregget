...
public class SessionPoolTest {
  ...
  /**
   * Sets up a new SessionPool with the connection parameters stored in <code>connParams</code> and
   * throws an exception if something goes wrong
   *
   * @param connParams a set of connection parameters from where the new SessionPool will connect to
   *     the SDE database and create connections
   * @return
  ...
  /**
   * Tests that the pool creation fails if a wrong set of parameters is passed (i.e. maxConnections
   * is lower than minConnections)
   *
   * @throws IOException
   * @throws UnavailableConnectionException
   */
  ...
  /**
   * tests that no more than pool.maxConnections connections can be created, and once one connection
   * is freed, it is ready to be used again.
   *
   * @throws Exception
   */
  @Test
