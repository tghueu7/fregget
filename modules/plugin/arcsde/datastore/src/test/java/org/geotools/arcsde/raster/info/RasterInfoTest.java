  ...
  private RasterInfo createPyramid() {
    ...
    pyramid.addPyramidLevel(
        ...
        new ReferencedEnvelope(
            2.0019762845849804, 2028.0019762845852, -2.0019607843137237, 2039.9980392156863, crs),
        imageOffset,
        extentOffset,
        5,
        5,
    ...
    pyramid.addPyramidLevel(
        3,
        new ReferencedEnvelope(
            6.005928853754941, 2023.9980237154152, 2.0019607843137237, 2035.9941176470588, crs),
        imageOffset,
        extentOffset,
        3,
        3,
    ...
    pyramid.addPyramidLevel(
        4,
        new ReferencedEnvelope(
            4.013833992094863, 2032.005928853755, 10.009803921568619, 2027.986274509804, crs),
        imageOffset,
        extentOffset,
        2,
        2,
    ...
    pyramid.addPyramidLevel(
        5,
        new ReferencedEnvelope(
            30.029644268774707, 2015.9901185770752, 26.025490196078408, 2011.9705882352941, crs),
        imageOffset,
        extentOffset,
        1,
        1,
    ...
    pyramid.addPyramidLevel(
        6,
        new ReferencedEnvelope(
            62.06126482213439, 1983.9584980237157, 58.05686274509799, 1979.9392156862746, crs),
        imageOffset,
        extentOffset,
        1,
        1,
