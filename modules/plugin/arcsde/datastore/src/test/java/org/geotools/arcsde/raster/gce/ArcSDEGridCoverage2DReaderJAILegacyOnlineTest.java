...
public class ArcSDEGridCoverage2DReaderJAILegacyOnlineTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    DEBUG = Boolean.valueOf(rasterTestData.getRasterTestDataProperty(RASTER_TEST_DEBUG_TO_DISK));
  ...
  /**
   * Test method for {@link org.geotools.arcsde.raster.gce.ArcSDEGridCoverage2DReaderJAI#getInfo()}.
   */
  @Test
  @Ignore
  ...
  private GridCoverage2D readCoverage(
    ...
    requestParams[1] =
        new Parameter<OverviewPolicy>(AbstractGridFormat.OVERVIEW_POLICY, OverviewPolicy.NEAREST);
