...
public class ClobTestData {
   ...
   * and if <code>insertTestData == true</code> also inserts some sample values. *Stolen as is from
   * TestData*
   *
  ...
  private static SeColumnDefinition[] createBaseTable(
      final ISession session, final SeTable table, final SeLayer layer, final String configKeyword)
      throws IOException {
