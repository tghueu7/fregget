...
public class ArcSDEGridCoverage2DReaderJAIOnlineTest {
  ...
  private GridCoverage2D testReadFullLevel0(
      final RasterCellType cellType, final int numBands, final RasterCellType resultingCellType)
      throws Exception {
  ...
  private GridCoverage2D readCoverage(
    ...
    requestParams[1] =
        new Parameter<OverviewPolicy>(AbstractGridFormat.OVERVIEW_POLICY, OverviewPolicy.SPEED);
