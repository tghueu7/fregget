...
public class ArcSDEQueryTest {
  ...
  /**
   * Filters are separated into backend supported and unsupported filters. Once split they should be
   * simplified to avoid silly filters like {@code 1 = 1 AND 1 = 1}
   *
   * @throws IOException
   * @throws CQLException
   */
  ...
  public void testSimplifiesFilters() throws IOException, CQLException {
    ...
    System.out.println(
        "geom: " + geometryFilter + ", sql: " + sqlFilter + ", unsupp: " + unsupportedFilter);
