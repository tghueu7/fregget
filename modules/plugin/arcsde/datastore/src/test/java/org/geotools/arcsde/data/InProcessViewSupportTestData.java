    ...
    final Command<SeLayer> createLayerCmd =
        new Command<SeLayer>() {
          ...
          public SeLayer execute(ISession session, SeConnection connection)
            ...
            colDefs[1] =
                new SeColumnDefinition("NAME", SeColumnDefinition.TYPE_STRING, 255, 0, false);
    ...
    Command<Void> createCmd =
        new Command<Void>() {
          ...
          public Void execute(ISession session, SeConnection connection)
            ...
            colDefs[0] =
                new SeColumnDefinition("ID", SeColumnDefinition.TYPE_INTEGER, 10, 0, false);
            colDefs[1] =
                new SeColumnDefinition("MASTER_ID", SeColumnDefinition.TYPE_INTEGER, 10, 0, false);
            colDefs[2] =
                new SeColumnDefinition("NAME", SeColumnDefinition.TYPE_STRING, 255, 0, false);
            colDefs[3] =
                new SeColumnDefinition(
                    "DESCRIPTION", SeColumnDefinition.TYPE_STRING, 255, 0, false);
