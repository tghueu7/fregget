...
public final class ArcSDERasterFormat extends AbstractGridFormat implements Format {
    ...
    readParameters =
        new ParameterGroup(
            new DefaultParameterDescriptorGroup(
                mInfo, new GeneralParameterDescriptor[] {READ_GRIDGEOMETRY2D, OVERVIEW_POLICY}));
  }

  /**
   * @param source either a {@link String} or {@link File} instance representing the connection URL
      ...
      if (reader == null) {
        ...
        try {
          ...
          if (reader == null) {
            ...
            reader =
                new ArcSDEGridCoverage2DReaderJAI(this, rasterReaderFactory, rasterInfo, hints);
  ...
  /**
   * @param input either a {@link String} or a {@link File} instance representing the connection URL
   *     to a given coverage
   ...
   *
   * @param sdeUrl a url representing the connection parameters to an arcsde server instance provied
