...
final class FeatureTypeInfo {
   ...
   * @param definitionQuery the object that represents the SQL SELECT statement for the runtime view
   * @param sdeDefinitionQuery the object homologous to the {@code definitionQuery}, that holds the
   *     query in ArcSDE Java API terms
