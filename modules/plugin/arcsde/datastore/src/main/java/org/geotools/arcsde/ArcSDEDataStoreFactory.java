...
public final class ArcSDEDataStoreFactory implements DataStoreFactorySpi {
  ...
  public static final Param NAMESPACE_PARAM =
      new Param(
          NAMESPACE_PARAM_NAME, String.class, "namespace associated to this data store", false);
  ...
  public static final Param USER_PARAM =
      new Param(USER_NAME_PARAM_NAME, String.class, "name of a valid database user account.", true);
  ...
  public static final Param VERSION_PARAM =
      new Param(VERSION_PARAM_NAME, String.class, "The ArcSDE database version to use.", false);
   ...
   * @return a new <code>SdeDataStore</code> pointing to the database defined by <code>params</code>
  ...
  final ArcSDEDataStore createDataStore(ArcSDEDataStoreConfig config, final ISessionPool connPool)
     ...
     *
     * <p>check if directconnect string has a schema Multiple GeoDB Syntax: Oracle 10g user's schema
     * geodatabase <schema_name> is the name of the schema that owns the geodatabase.
