...
public enum RasterCellType {
  TYPE_16BIT_S(
      16, DataBuffer.TYPE_SHORT, true, NumberRange.create(Short.MIN_VALUE, Short.MAX_VALUE)), //
  ...
  TYPE_32BIT_REAL(
      32, DataBuffer.TYPE_FLOAT, true, NumberRange.create(Float.MIN_VALUE, Float.MAX_VALUE)), //
  TYPE_32BIT_S(
      32, DataBuffer.TYPE_INT, true, NumberRange.create(Integer.MIN_VALUE, Integer.MAX_VALUE)), //
  TYPE_32BIT_U(
      64, DataBuffer.TYPE_DOUBLE, false, NumberRange.create(0D, (double) Math.pow(2, 32) - 1)), //
  TYPE_4BIT(
      4, DataBuffer.TYPE_BYTE, false, NumberRange.create((byte) 0, (byte) Math.pow(2, 4) - 1)), //
  TYPE_64BIT_REAL(
      64, DataBuffer.TYPE_DOUBLE, true, NumberRange.create(Double.MIN_VALUE, Double.MAX_VALUE)), //
  TYPE_8BIT_S(
  ...
  public static RasterCellType valueOf(final int seRasterPixelType) {
    ...
    throw new NoSuchElementException("Raster pixel type " + seRasterPixelType + " does not exist");
  }
