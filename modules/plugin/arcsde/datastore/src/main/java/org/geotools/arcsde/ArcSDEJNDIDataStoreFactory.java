...
public class ArcSDEJNDIDataStoreFactory implements DataStoreFactorySpi {
  ...
  /**
   * Creates and {@link ArcSDEDataStore} from the provided {@code params}, where the connection pool
   * is provided by JNDI.
   *
   ...
   *       version the datastore shall work upon. If non provided or empty, the DEFAULT version will
   *       be used.
