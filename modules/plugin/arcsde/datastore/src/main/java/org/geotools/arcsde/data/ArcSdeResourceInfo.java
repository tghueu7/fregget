...
public final class ArcSdeResourceInfo implements ResourceInfo {
   ...
   *
   * @return {@code true} if the FeatureType does not refers to an actual table or registered view,
   *     but is built from a SQL SELECT statement, {@code false} otherwise
   */
