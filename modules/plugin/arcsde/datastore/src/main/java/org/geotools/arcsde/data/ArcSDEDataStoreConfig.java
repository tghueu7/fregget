...
public class ArcSDEDataStoreConfig {
     ...
     */
    private static final String NULL_ARGUMENTS_MSG = "Illegal arguments. At least one of them was" +
            " null. Check to pass "
    ...
    public static final String ALLOW_NON_SPATIAL_TABLES_PARAM_NAME = "datastore" +
     ...
     * @throws IllegalArgumentException if at least one mandatory parameter is present but does 
