...
abstract class TileDataFetcher {
  ...
  /**
   * Returns a {@code TileDataFetcher} that knows how to translate the raw pixel data from an {@link
   * SeRasterTile} with pixel type {@code nativeType} to a {@link TileInfo}'s internal array with a
   * pixel type determined by {@code targetCellType}.
   *
