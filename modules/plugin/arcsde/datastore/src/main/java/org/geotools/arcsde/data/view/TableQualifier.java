...
class TableQualifier {
  /**
   * Returns a Table with the same name as the argument one but fully qualified in the ArcSDE sense.
   *
   ...
   * @throws IllegalStateException if an SDE error is catched up while asking <code>conn</code> for
   *     the database and user name.
   */
