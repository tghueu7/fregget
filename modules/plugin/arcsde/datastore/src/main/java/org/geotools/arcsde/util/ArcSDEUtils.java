...
public final class ArcSDEUtils {
   ...
   *     DefaultEngineeringCRS#CARTESIAN_2D}, otherwise an equivalent CRS from the EPSG database if
   *     found, or a CRS built from the seCoordRef WKT otherwise.
   */
    ...
    try {
      ...
      if (coordSys instanceof PeGeographicCS) {
        ...
        throw new RuntimeException(
            "Shouldnt happen!: Unnkown SeCoordSys type: " + coordSys.getClass().getName());
      }
      int seEpsgCode;
