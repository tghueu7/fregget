...
public class PreGeneralizedSimpleFeatureTest extends TestCase {
    ...
    private boolean testHint(Key hintKey) {
        ...
        try {
            ...
            GeneralizationInfos ginfos = provider.getGeneralizationInfos
                    ("src/test/resources/geninfo_horizontal.xml");
    ...
    public void testSimpleFeatureBasics() {
        ...
        try {
            ...
            for (int i = 0; i < feature1.getType().getAttributeDescriptors().size(); i++) {
                ...
                Object value2 = feature1.getAttribute(feature1.getType().getAttributeDescriptors
                        ().get(
                        i).getLocalName());
            ...
            assertFalse(feature2.getProperties("the_geom").contains(feature1.getProperty
                    ("the_geom")));
