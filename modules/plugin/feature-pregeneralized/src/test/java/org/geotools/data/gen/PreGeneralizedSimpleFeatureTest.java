...
public class PreGeneralizedSimpleFeatureTest extends TestCase {
  ...
  public void testSimpleFeatureBasics() {
    ...
    try {
      ...
      assertFalse(
          feature1.getDefaultGeometryProperty().equals(feature2.getDefaultGeometryProperty()));
      ...
      assertTrue(
          feature1.getProperty("the_geom").getValue().equals(feature1.getAttribute("the_geom")));
      // assertFalse(feature1.getProperty("CAT_ID").getValue().equals(feature2.getAttribute("CAT_ID"
      // )));
      assertFalse(
          feature1.getProperty("the_geom").getValue().equals(feature2.getAttribute("the_geom")));
      ...
      assertTrue(
          feature1.getProperties(new NameImpl("CAT_ID")).contains(feature1.getProperty("CAT_ID")));
      assertFalse(
          feature2
              .getProperties(new NameImpl("the_geom"))
