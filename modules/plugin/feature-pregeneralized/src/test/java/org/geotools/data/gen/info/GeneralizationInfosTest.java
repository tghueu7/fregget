...
public class GeneralizationInfosTest extends TestCase {
  ...
  public void testGeneralizationInfos() {
    ...
    assertTrue("WSInfo".equals(info1.getGeneralizationForDistance(100.0).getDataSourceNameSpace()));

    assertTrue(info1.getGeneralizationForDistance(1000.0).getFeatureName().equals("GenFeature2"));
    assertTrue(info1.getGeneralizationForDistance(10000.0).getFeatureName().equals("GenFeature2"));
    assertTrue("DSDistance".equals(info1.getGeneralizationForDistance(1000.0).getDataSourceName()));
    assertTrue(
        "WSDistance".equals(info1.getGeneralizationForDistance(1000.0).getDataSourceNameSpace()));

    assertTrue(info2.getGeneralizationForDistance(99.0) == null);
    assertTrue(info2.getGeneralizationForDistance(100.0).getGeomPropertyName().equals("the_geom1"));
    assertTrue(info2.getGeneralizationForDistance(999.0).getGeomPropertyName().equals("the_geom1"));
    assertTrue(
        info2.getGeneralizationForDistance(1000.0).getGeomPropertyName().equals("the_geom2"));
    assertTrue(
        info2.getGeneralizationForDistance(10000.0).getGeomPropertyName().equals("the_geom2"));

    assertTrue("DSInfos".equals(info2.getGeneralizationForDistance(100.0).getDataSourceName()));
    assertTrue(
        "WSInfos".equals(info2.getGeneralizationForDistance(100.0).getDataSourceNameSpace()));
