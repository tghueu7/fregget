...
public class RasterLayerRequest {
  ...
  private void setDefaultParameterValues() {
    ...
    // get the read parameters for this format plus the ones for the basic format and set them to
    // the default
    ...
    if (name.equals(AbstractGridFormat.READ_GRIDGEOMETRY2D.getName())) {
      ...
      if (rasterManager.getConfiguration().getCatalogConfigurationBean().isHeterogeneousCRS()) {
        ...
        GridGeometry2D padded =
            new GridGeometry2D(paddedRange, gg.getGridToCRS(), gg.getCoordinateReferenceSystem());
