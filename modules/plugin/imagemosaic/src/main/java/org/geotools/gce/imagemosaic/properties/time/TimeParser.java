...
public class TimeParser {
   ...
   * string may contains either a single date, or a start time, end time and a period. In the first
   * case, this method returns a singleton containing only the parsed date. In the second case, this
   * method returns a list including all dates from start time up to the end time with the interval
