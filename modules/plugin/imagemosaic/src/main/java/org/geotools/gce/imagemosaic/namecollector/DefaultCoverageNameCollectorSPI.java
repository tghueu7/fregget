...
public class DefaultCoverageNameCollectorSPI implements CoverageNameCollectorSPI {
  ...
  /**
   * The Default {@link CoverageNameCollector} for StructuredGridCoverage readers simply returns the
   * coverageName provided as input of the call (put into the properties map to be handled)
   */
