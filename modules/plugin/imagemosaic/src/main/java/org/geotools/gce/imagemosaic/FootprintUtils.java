...
class FootprintUtils {
  ...
  /**
   * Write a footprint summary file (".fpt") given an input <String,Geometry> map containing granule
   * location and related geometry, and the index shapefile store to associate footprints to
   * granules.
   *
