...
public class Indexer {
  ...
  public static class Collectors {
     ...
     * why there is not a <CODE>set</CODE> method for the collector property.
     *
  ...
  public static class Coverages {
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the coverage property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
  ...
  public static class MultipleBandsDimensions {
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the multipleBandsDimension property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
