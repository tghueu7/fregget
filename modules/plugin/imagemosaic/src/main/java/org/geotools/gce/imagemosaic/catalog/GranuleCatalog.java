...
public abstract class GranuleCatalog {
  ...
  /**
   * Returns the footprint for the given granule. Mind, when applying insets we might have the case
   * of the geometry being empty (negative buffer eroded it fully), in that case the granule must
   * not be loaded
   *
   * @param sf
   * @return
