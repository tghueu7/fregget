...
//        }
//        
//        // impose the color model and samplemodel as the constant operation does not take them into account!
...
//        }
      ...
      Assert.isTrue(il.isValid(ImageLayout.WIDTH_MASK |
              ImageLayout.HEIGHT_MASK |
              ImageLayout.SAMPLE_MODEL_MASK));
        RenderedImage finalImage= MosaicDescriptor.create(
                new RenderedImage[0], 
                MosaicDescriptor.MOSAIC_TYPE_OVERLAY, 
                null, 
                null, 
                new double[][] { { CoverageUtilities.getMosaicThreshold(il.getSampleModel(null).getDataType()) } }, 
                bkgValues, 
                renderingHints);
