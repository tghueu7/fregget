...
public class ImageMosaicFileResourceInfo extends DefaultResourceInfo implements FileResourceInfo {
   ...
   * features related to the same file location by scanning the underlying iterator and caching the
   * next feature which doesn't belong to same file.
   *
   * <p>Important note: the featureIterator need to be get using a sortBy clause on location to make
