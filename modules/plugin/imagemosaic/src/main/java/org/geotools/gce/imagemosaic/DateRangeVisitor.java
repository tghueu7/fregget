...
class DateRangeVisitor extends RangeVisitor {
  ...
  /**
   * Merge 2 ranges together. In order to speed up the computations, this method does the assumption
   * that the 2 date ranges are already sorted (first < second) and they intersect together.
   *
