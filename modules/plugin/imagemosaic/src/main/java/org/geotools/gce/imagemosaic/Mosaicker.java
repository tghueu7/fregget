...
public class Mosaicker {
  ...
  /**
   * @return
   * @param useFinalImageLayout whether the layout should be created from the requested bounds or no
   ...
   * @param skipSingleElementOptimization whether the single element case should be optimized. some
   *     callers wish to skip this since there are a few differences along this path that can cause
   *     issues (namely using the final image layout for operations)
   */
