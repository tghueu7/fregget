...
class ImageLevelsMapper {
   ...
   *
   * <p>Note that all the available resolutions on the underlying mosaics are considered overviews,
   * except the native resolution level of the first mosaic.
   */
  ...
  public ImageLevelsMapper(Properties properties) {
    ...
    // array is organized in 3 layers of resolutions (see the main javadoc at the beginning of the
    // class):
  ...
  protected ImageMosaicReader getReader(
      Integer imageChoice, String coverageName, URL sourceURL, Hints hints) throws IOException {
