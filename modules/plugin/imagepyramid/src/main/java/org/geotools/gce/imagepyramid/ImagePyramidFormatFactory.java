...
public final class ImagePyramidFormatFactory implements GridFormatFactorySpi {
   ...
   * ImageIO classes this method is suitable for understanding if such a plugin is available or not,
   * preventing users from having problems later on when trying to instantiate it.
   *
