...
public abstract class BaseGDALGridCoverage2DReader extends BaseGridCoverage2DReader
  ...
  private static final Logger LOGGER =
      org.geotools.util.logging.Logging.getLogger(BaseGDALGridCoverage2DReader.class.toString());
  ...
  private void parseCommonMetadata(final GDALCommonIIOImageMetadata metadata) {
    ...
    if (this.originalGridRange == null)
      this.originalGridRange =
          new GridEnvelope2D(new Rectangle(0, 0, metadata.getWidth(), metadata.getHeight()));
          ...
          try {
            ...
            this.originalEnvelope =
                CRS.transform(
                    ...
                    new GeneralEnvelope(((GridEnvelope2D) this.originalGridRange)));
