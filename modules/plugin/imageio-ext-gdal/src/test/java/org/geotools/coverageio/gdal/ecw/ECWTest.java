...
public final class ECWTest extends GDALTestCase {
    ...
    public void test() throws Exception {
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        final ParameterValue<Boolean> jai = ((AbstractGridFormat) reader.getFormat())
                .USE_JAI_IMAGEREAD.createValue();
        jai.setValue(true);
        ...
        final ParameterValue<GridGeometry2D> gg = ((AbstractGridFormat) reader.getFormat())
                .READ_GRIDGEOMETRY2D.createValue();
        ...
        final ParameterValue<GridGeometry2D> gg2 = ((AbstractGridFormat) reader.getFormat())
                .READ_GRIDGEOMETRY2D.createValue();
        gg2.setValue(new GridGeometry2D(new GridEnvelope2D(new Rectangle(0, 0, (int) (range
                .width), (int) (range.height))), wrongEnvelope));
