...
public final class ArcGridVisualizationTest extends ArcGridTestCaseAdapter {
  ...
  /**
   * This test tries to read GZipped ascii grids first by supplying the {@link ArcGridReader} with a
   * {@link File} that points to a gzipped coverage, second by opening up a {@link GZIPInputStream}
   * and asking {@link ImageIO} to wrap it with an {@link ImageInputStream}.
   *
   * @throws IOException
   */
