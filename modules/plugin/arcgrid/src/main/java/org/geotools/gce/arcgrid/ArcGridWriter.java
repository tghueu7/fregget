...
public final class ArcGridWriter extends AbstractGridCoverageWriter implements GridCoverageWriter {
    ...
    private void writeGridCoverage(GridCoverage2D gc,
        ...
        try {
            ...
            mWriter.write(null, new IIOImage(source, null,
                    new AsciiGridsImageMetadata(cols, rows, cellsizeX, cellsizeY, xl, yl, true, 
                            grass, inNoData)), null);
    ...
    private static GridCoverage2D reShapeData(final GridCoverage2D gc, final Hints hints) {
        ...
        final GeneralGridEnvelope newGridrange = new GeneralGridEnvelope(new int[]{0, 0}, new 
                int[]{Nx, Ny});
        final GridGeometry2D newGridGeometry = new GridGeometry2D(newGridrange, new 
    ...
    private void writeCRSInfo(CoordinateReferenceSystem crs) throws IOException {
        ...
        String prjName = ascFile.getName().substring(0, ascFile.getName().lastIndexOf(".")) + "" +
                ".prj";
    ...
    private static void ensureWeCanWrite(GridCoverage coverage,
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        if (coverage instanceof GridCoverage2D && !(coverage.getGridGeometry() instanceof 
                GridGeometry2D))
