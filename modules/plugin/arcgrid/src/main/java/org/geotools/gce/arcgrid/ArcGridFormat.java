...
public final class ArcGridFormat extends AbstractGridFormat implements Format {
    ...
    writeParameters =
        new ParameterGroup(
            new DefaultParameterDescriptorGroup(
                mInfo,
                new GeneralParameterDescriptor[] {GRASS, GEOTOOLS_WRITE_PARAMS, FORCE_CELLSIZE}));
  ...
  /**
   * Retrieves the default instance for the {@link ArcGridFormat} of the {@link GeoToolsWriteParams}
   * to control the writing process.
   *
   * @return a default instance for the {@link ArcGridFormat} of the {@link GeoToolsWriteParams} to
