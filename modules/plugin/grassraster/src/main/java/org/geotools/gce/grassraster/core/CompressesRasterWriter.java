...
public class CompressesRasterWriter {
   ...
   * the place for the header is written to file, in the end the header is re-written with the right
   * rowaddresses (at the begin we do not know how much compression will influence).
   *
