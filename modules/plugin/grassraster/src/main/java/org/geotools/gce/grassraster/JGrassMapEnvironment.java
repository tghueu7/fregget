...
public class JGrassMapEnvironment {
  ...
  /**
   * The PROJ_WKT file, that keeps the projection informations as defined by JGRASS to be compatible
   * with geotools.
   */
  ...
  public JGrassMapEnvironment(File cellFile) {
    ...
    FCELL =
        new File(mapsetPath + File.separator + JGrassConstants.FCELL + File.separator + mapName);
    CELLHD =
        new File(mapsetPath + File.separator + JGrassConstants.CELLHD + File.separator + mapName);
   ...
   * Constructs an instance of {@linkplain JGrassMapEnvironment}.
   *
   * <p>This constructor is a facility method in the case the mapset file and the name of the GRASS
   * raster map are passed.
   *
