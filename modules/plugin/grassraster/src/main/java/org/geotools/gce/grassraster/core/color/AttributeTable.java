...
public class AttributeTable {
  ...
  public class CellAttribute {
    ...
    /**
     * Compare a value to the range of values in this attribute If the cat is below the renage then
     * return -1, if it is aboove the ramge then return +1, if it is equal return 0
     */
