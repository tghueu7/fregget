...
public class GrassBinaryRasterWriteHandler {
   ...
   *
   * <p>supported are 1 for float and 2 for double (jgrass only supports those two), the default is
   * double.
   */
   ...
   *
   * <p><b>NOTE:</b> they could be missing if the mapset has just been created and this is the first
   ...
   *
   * <p>The space for the header of the rasterfile is created, filling the spaces with zeros. After
