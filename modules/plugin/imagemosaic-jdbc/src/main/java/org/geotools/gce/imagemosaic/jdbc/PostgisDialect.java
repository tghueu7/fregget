...
public class PostgisDialect extends DBDialect {
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.gce.imagemosaic.jdbc.DBDialect#getRegisterSpatialStatement(java.lang
     * .String,
     *      java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.gce.imagemosaic.jdbc.DBDialect#getUnregisterSpatialStatement(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.gce.imagemosaic.jdbc.DBDialect#getCreateSpatialTableStatement(java.lang
     * .String)
     */
    @Override
    protected String getCreateSpatialTableStatement(String tableName)
        ...
        statement += (" (" + getConfig().getKeyAttributeNameInSpatialTable() + " CHAR(64) NOT " +
                "NULL ");
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.gce.imagemosaic.jdbc.DBDialect#getCreateSpatialTableStatementJoined(java
     * .lang.String)
     */
    @Override
