...
public class H2Test extends AbstractTest {
    public static String EPSG_31287_TOWGS84 = "PROJCS[\"MGI / Austria Lambert\",GEOGCS[\"MGI\", " +
            "DATUM[\"Militar-Geographische Institut\","
            + "SPHEROID[\"Bessel 1841\", 6377397.155, 299.1528128, AUTHORITY[\"EPSG\",\"7004\"]], "
            + "TOWGS84[577.326,90.129,463.919,5.137,1.474,5.297,2.4232],AUTHORITY[\"EPSG\"," +
            "\"6312\"]],"
            ...
            + "PARAMETER[\"latitude_of_origin\", 47.5], PARAMETER[\"standard_parallel_1\", 49.0]," +
            " PARAMETER[\"false_easting\", 400000.0],"
            + "PARAMETER[\"false_northing\", 400000.0], PARAMETER[\"standard_parallel_2\", 46.0]," +
            " UNIT[\"m\", 1.0],"
