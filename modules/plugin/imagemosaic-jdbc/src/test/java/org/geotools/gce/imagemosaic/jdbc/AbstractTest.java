...
public abstract class AbstractTest extends TestCase {
    ...
    protected void imageMosaic(String name, String configUrl,
                               ...
                               CoordinateReferenceSystem crs, boolean expectsData) throws 
            IOException {
        // Hints hints = new
        ...
        outTransp.setValue((transparentColor == null) ? ImageMosaicJDBCFormat
    ...
    public void setUp() throws Exception {
        ...
        if (fixture == null) {
            ...
            if (LOGGER.isLoggable(Level.CONFIG)) {
                ...
                LOGGER
                        .log(Level.CONFIG,
                                "to Documents and Settings/userid/.geotools/imagemosaic  " +
                                        "(Windows) ");
                LOGGER
                        .log(Level.CONFIG,
