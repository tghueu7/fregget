...
public class JDBCAccessH2Custom extends JDBCAccessCustom {
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.jdbc.custom.JDBCAccessCustom#startTileDecoders(java.awt
     * .Rectangle, org.geotools.geometry.GeneralEnvelope, org.geotools.gce.imagemosaic.jdbc
     * .ImageLevelInfo, java.util.concurrent.LinkedBlockingQueue, org.geotools.coverage.grid
     * .GridCoverageFactory)
     */
    @Override
