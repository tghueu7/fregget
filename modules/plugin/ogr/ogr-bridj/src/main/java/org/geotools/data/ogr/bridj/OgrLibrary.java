...
public class OgrLibrary {
    ...
    public static native Pointer<Byte> OGRGeometryTypeToName(ValuedEnum<OgrLibrary
            .OGRwkbGeometryType> eType);

    public static native ValuedEnum<OgrLibrary.OGRwkbGeometryType> OGRMergeGeometryTypes
            (ValuedEnum<OgrLibrary.OGRwkbGeometryType> eMain, ValuedEnum<OgrLibrary
                    .OGRwkbGeometryType> eExtra);

    public static native int OGRParseDate(Pointer<Byte> pszInput, Pointer<OGRField> psOutput, int
            nOptions);

    public static native Pointer<Byte> GDALVersionInfo(Pointer<Byte> charPtr1);

    public static native int GDALCheckVersion(int nVersionMajor, int nVersionMinor, Pointer<Byte>
            pszCallingComponentName);

    public static native int OGR_G_CreateFromWkb(Pointer<Byte> charPtr1, Pointer<?> 
            OGRSpatialReferenceH1, Pointer<Pointer<?>> OGRGeometryHPtr1, int int1);

    public static native int OGR_G_CreateFromWkt(Pointer<Pointer<Byte>> charPtrPtr1, Pointer<?> 
            OGRSpatialReferenceH1, Pointer<Pointer<?>> OGRGeometryHPtr1);

    public static native int OGR_G_CreateFromFgf(Pointer<Byte> charPtr1, Pointer<?> 
            OGRSpatialReferenceH1, Pointer<Pointer<?>> OGRGeometryHPtr1, int int1, 
                                                 Pointer<Integer> intPtr1);

    public static native void OGR_G_DestroyGeometry(Pointer<?> OGRGeometryH1);

    public static native Pointer<?> OGR_G_CreateGeometry(ValuedEnum<OgrLibrary
            .OGRwkbGeometryType> OGRwkbGeometryType1);

    public static native Pointer<?> OGR_G_ApproximateArcAngles(double dfCenterX, double 
            dfCenterY, double dfZ, double dfPrimaryRadius, double dfSecondaryAxis, double 
            dfRotation, double dfStartAngle, double dfEndAngle, double dfMaxAngleStepSizeDegrees);
    ...
    public static native void OGR_G_GetEnvelope(Pointer<?> OGRGeometryH1, Pointer<OGREnvelope> 
            OGREnvelopePtr1);

    public static native int OGR_G_ImportFromWkb(Pointer<?> OGRGeometryH1, Pointer<Byte> 
            charPtr1, int int1);

    public static native int OGR_G_ExportToWkb(Pointer<?> OGRGeometryH1, ValuedEnum<OgrLibrary
            .OGRwkbByteOrder> OGRwkbByteOrder1, Pointer<Byte> charPtr1);

    public static native int OGR_G_WkbSize(Pointer<?> hGeom);

    public static native int OGR_G_ImportFromWkt(Pointer<?> OGRGeometryH1, Pointer<Pointer<Byte>>
            charPtrPtr1);

    public static native int OGR_G_ExportToWkt(Pointer<?> OGRGeometryH1, Pointer<Pointer<Byte>> 
            charPtrPtr1);
    ...
    public static native void OGR_G_DumpReadable(Pointer<?> OGRGeometryH1, Pointer<OgrLibrary
            ._IO_FILE> FILEPtr1, Pointer<Byte> charPtr1);
    ...
    public static native Pointer<Byte> OGR_G_ExportToGMLEx(Pointer<?> OGRGeometryH1, 
                                                           Pointer<Pointer<Byte>> papszOptions);

    public static native Pointer<Byte> OGR_G_ExportToKML(Pointer<?> OGRGeometryH1, Pointer<Byte> 
            pszAltitudeMode);
    ...
    public static native void OGR_G_AssignSpatialReference(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRSpatialReferenceH1);

    public static native Pointer<?> OGR_G_GetSpatialReference(Pointer<?> OGRGeometryH1);

    public static native int OGR_G_Transform(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRCoordinateTransformationH1);

    public static native int OGR_G_TransformTo(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRSpatialReferenceH1);
    ...
    public static native Pointer<?> OGR_G_Buffer(Pointer<?> OGRGeometryH1, double double1, int 
            int1);

    public static native Pointer<?> OGR_G_Intersection(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRGeometryH2);
    ...
    public static native Pointer<?> OGR_G_Difference(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRGeometryH2);

    public static native Pointer<?> OGR_G_SymDifference(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRGeometryH2);
    ...
    public static native Pointer<?> OGR_G_SymmetricDifference(Pointer<?> OGRGeometryH1, 
                                                              Pointer<?> OGRGeometryH2);
    ...
    public static native void OGR_G_GetPoint(Pointer<?> OGRGeometryH1, int iPoint, 
                                             Pointer<Double> doublePtr1, Pointer<Double> 
                                                     doublePtr2, Pointer<Double> doublePtr3);

    public static native void OGR_G_SetPoint(Pointer<?> OGRGeometryH1, int iPoint, double 
            double1, double double2, double double3);

    public static native void OGR_G_SetPoint_2D(Pointer<?> OGRGeometryH1, int iPoint, double 
            double1, double double2);

    public static native void OGR_G_AddPoint(Pointer<?> OGRGeometryH1, double double1, double 
            double2, double double3);

    public static native void OGR_G_AddPoint_2D(Pointer<?> OGRGeometryH1, double double1, double 
            double2);
    ...
    public static native int OGR_G_AddGeometryDirectly(Pointer<?> OGRGeometryH1, Pointer<?> 
            OGRGeometryH2);

    public static native int OGR_G_RemoveGeometry(Pointer<?> OGRGeometryH1, int int1, int int2);

    public static native Pointer<?> OGRBuildPolygonFromEdges(Pointer<?> hLinesAsCollection, int 
            bBestEffort, int bAutoClose, double dfTolerance, Pointer<Integer> peErr);
    ...
    public static native Pointer<?> OGR_Fld_Create(Pointer<Byte> charPtr1, ValuedEnum<OgrLibrary
            .OGRFieldType> OGRFieldType1);
    ...
    public static native ValuedEnum<OgrLibrary.OGRFieldType> OGR_Fld_GetType(Pointer<?> 
                                                                                     OGRFieldDefnH1);

    public static native void OGR_Fld_SetType(Pointer<?> OGRFieldDefnH1, ValuedEnum<OgrLibrary
            .OGRFieldType> OGRFieldType1);

    public static native ValuedEnum<OgrLibrary.OGRJustification> OGR_Fld_GetJustify(Pointer<?> 
                                                                                            OGRFieldDefnH1);

    public static native void OGR_Fld_SetJustify(Pointer<?> OGRFieldDefnH1, ValuedEnum<OgrLibrary
            .OGRJustification> OGRJustification1);
    ...
    public static native void OGR_Fld_Set(Pointer<?> OGRFieldDefnH1, Pointer<Byte> charPtr1, 
                                          ValuedEnum<OgrLibrary.OGRFieldType> OGRFieldType1, int 
                                                  int1, int int2, ValuedEnum<OgrLibrary
            .OGRJustification> OGRJustification1);
    ...
    public static native Pointer<Byte> OGR_GetFieldTypeName(ValuedEnum<OgrLibrary.OGRFieldType> 
                                                                    OGRFieldType1);
    ...
    public static native int OGR_FD_GetFieldIndex(Pointer<?> OGRFeatureDefnH1, Pointer<Byte> 
            charPtr1);

    public static native void OGR_FD_AddFieldDefn(Pointer<?> OGRFeatureDefnH1, Pointer<?> 
            OGRFieldDefnH1);

    public static native ValuedEnum<OgrLibrary.OGRwkbGeometryType> OGR_FD_GetGeomType(Pointer<?> 
                                                                                              OGRFeatureDefnH1);

    public static native void OGR_FD_SetGeomType(Pointer<?> OGRFeatureDefnH1, 
                                                 ValuedEnum<OgrLibrary.OGRwkbGeometryType> 
                                                         OGRwkbGeometryType1);
    ...
    public static native int OGR_F_SetGeometryDirectly(Pointer<?> OGRFeatureH1, Pointer<?> 
            OGRGeometryH1);
    ...
    public static native Pointer<Integer> OGR_F_GetFieldAsIntegerList(Pointer<?> OGRFeatureH1, 
                                                                      int int1, Pointer<Integer> 
                                                                              intPtr1);

    public static native Pointer<Double> OGR_F_GetFieldAsDoubleList(Pointer<?> OGRFeatureH1, int 
            int1, Pointer<Integer> intPtr1);

    public static native Pointer<Pointer<Byte>> OGR_F_GetFieldAsStringList(Pointer<?> 
                                                                                   OGRFeatureH1, 
                                                                           int int1);

    public static native Pointer<Byte> OGR_F_GetFieldAsBinary(Pointer<?> OGRFeatureH1, int int1, 
                                                              Pointer<Integer> intPtr1);

    public static native int OGR_F_GetFieldAsDateTime(Pointer<?> OGRFeatureH1, int int1, 
                                                      Pointer<Integer> intPtr1, Pointer<Integer> 
                                                              intPtr2, Pointer<Integer> intPtr3, 
                                                      Pointer<Integer> intPtr4, Pointer<Integer> 
                                                              intPtr5, Pointer<Integer> intPtr6, 
                                                      Pointer<Integer> intPtr7);

    public static native void OGR_F_SetFieldInteger(Pointer<?> OGRFeatureH1, int int1, int int2);

    public static native void OGR_F_SetFieldDouble(Pointer<?> OGRFeatureH1, int int1, double 
            double1);

    public static native void OGR_F_SetFieldString(Pointer<?> OGRFeatureH1, int int1, 
                                                   Pointer<Byte> charPtr1);

    public static native void OGR_F_SetFieldIntegerList(Pointer<?> OGRFeatureH1, int int1, int 
            int2, Pointer<Integer> intPtr1);

    public static native void OGR_F_SetFieldDoubleList(Pointer<?> OGRFeatureH1, int int1, int 
            int2, Pointer<Double> doublePtr1);

    public static native void OGR_F_SetFieldStringList(Pointer<?> OGRFeatureH1, int int1, 
                                                       Pointer<Pointer<Byte>> charPtrPtr1);

    public static native void OGR_F_SetFieldRaw(Pointer<?> OGRFeatureH1, int int1, 
                                                Pointer<OGRField> OGRFieldPtr1);

    public static native void OGR_F_SetFieldBinary(Pointer<?> OGRFeatureH1, int int1, int int2, 
                                                   Pointer<Byte> GBytePtr1);

    public static native void OGR_F_SetFieldDateTime(Pointer<?> OGRFeatureH1, int int1, int int2,
                                                     int int3, int int4, int int5, int int6, int 
                                                             int7, int int8);
    ...
    public static native void OGR_F_DumpReadable(Pointer<?> OGRFeatureH1, Pointer<OgrLibrary
            ._IO_FILE> FILEPtr1);

    public static native int OGR_F_SetFrom(Pointer<?> OGRFeatureH1, Pointer<?> OGRFeatureH2, int 
            int1);

    public static native int OGR_F_SetFromWithMap(Pointer<?> OGRFeatureH1, Pointer<?> 
            OGRFeatureH2, int int1, Pointer<Integer> intPtr1);
    ...
    public static native void OGR_F_SetStyleStringDirectly(Pointer<?> OGRFeatureH1, Pointer<Byte>
            charPtr1);

    public static native Pointer<?> OGR_F_GetStyleTable(Pointer<?> OGRFeatureH1);

    public static native void OGR_F_SetStyleTableDirectly(Pointer<?> OGRFeatureH1, Pointer<?> 
            OGRStyleTableH1);

    public static native void OGR_F_SetStyleTable(Pointer<?> OGRFeatureH1, Pointer<?> 
            OGRStyleTableH1);

    public static native Pointer<Byte> OGR_L_GetName(Pointer<?> OGRLayerH1);

    public static native ValuedEnum<OgrLibrary.OGRwkbGeometryType> OGR_L_GetGeomType(Pointer<?> 
                                                                                             OGRLayerH1);

    public static native Pointer<?> OGR_L_GetSpatialFilter(Pointer<?> OGRLayerH1);

    public static native void OGR_L_SetSpatialFilter(Pointer<?> OGRLayerH1, Pointer<?> 
            OGRGeometryH1);

    public static native void OGR_L_SetSpatialFilterRect(Pointer<?> OGRLayerH1, double double1, 
                                                         double double2, double double3, double 
                                                                 double4);

    public static native int OGR_L_SetAttributeFilter(Pointer<?> OGRLayerH1, Pointer<Byte> 
            charPtr1);
    ...
    public static native int OGR_L_GetExtent(Pointer<?> OGRLayerH1, Pointer<OGREnvelope> 
            OGREnvelopePtr1, int int1);

    public static native int OGR_L_TestCapability(Pointer<?> OGRLayerH1, Pointer<Byte> charPtr1);

    public static native int OGR_L_CreateField(Pointer<?> OGRLayerH1, Pointer<?> OGRFieldDefnH1, 
                                               int int1);
    ...
    public static native void OGR_L_SetStyleTableDirectly(Pointer<?> OGRLayerH1, Pointer<?> 
            OGRStyleTableH1);

    public static native void OGR_L_SetStyleTable(Pointer<?> OGRLayerH1, Pointer<?> 
            OGRStyleTableH1);

    public static native int OGR_L_SetIgnoredFields(Pointer<?> OGRLayerH1, Pointer<Pointer<Byte>>
            charPtrPtr1);
    ...
    public static native Pointer<?> OGR_DS_GetLayerByName(Pointer<?> OGRDataSourceH1, 
                                                          Pointer<Byte> charPtr1);
    ...
    public static native Pointer<?> OGR_DS_CreateLayer(Pointer<?> OGRDataSourceH1, Pointer<Byte> 
            charPtr1, Pointer<?> OGRSpatialReferenceH1, ValuedEnum<OgrLibrary.OGRwkbGeometryType>
            OGRwkbGeometryType1, Pointer<Pointer<Byte>> charPtrPtr1);

    public static native Pointer<?> OGR_DS_CopyLayer(Pointer<?> OGRDataSourceH1, Pointer<?> 
            OGRLayerH1, Pointer<Byte> charPtr1, Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OGR_DS_TestCapability(Pointer<?> OGRDataSourceH1, Pointer<Byte> 
            charPtr1);

    public static native Pointer<?> OGR_DS_ExecuteSQL(Pointer<?> OGRDataSourceH1, Pointer<Byte> 
            charPtr1, Pointer<?> OGRGeometryH1, Pointer<Byte> charPtr2);

    public static native void OGR_DS_ReleaseResultSet(Pointer<?> OGRDataSourceH1, Pointer<?> 
            OGRLayerH1);
    ...
    public static native void OGR_DS_SetStyleTableDirectly(Pointer<?> OGRDataSourceH1, Pointer<?>
            OGRStyleTableH1);

    public static native void OGR_DS_SetStyleTable(Pointer<?> OGRDataSourceH1, Pointer<?> 
            OGRStyleTableH1);

    public static native Pointer<Byte> OGR_Dr_GetName(Pointer<?> OGRSFDriverH1);

    public static native Pointer<?> OGR_Dr_Open(Pointer<?> OGRSFDriverH1, Pointer<Byte> charPtr1,
                                                int int1);

    public static native int OGR_Dr_TestCapability(Pointer<?> OGRSFDriverH1, Pointer<Byte> 
            charPtr1);

    public static native Pointer<?> OGR_Dr_CreateDataSource(Pointer<?> OGRSFDriverH1, 
                                                            Pointer<Byte> charPtr1, 
                                                            Pointer<Pointer<Byte>> charPtrPtr1);

    public static native Pointer<?> OGR_Dr_CopyDataSource(Pointer<?> OGRSFDriverH1, Pointer<?> 
            OGRDataSourceH1, Pointer<Byte> charPtr1, Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OGR_Dr_DeleteDataSource(Pointer<?> OGRSFDriverH1, Pointer<Byte> 
            charPtr1);

    public static native Pointer<?> OGROpen(Pointer<Byte> charPtr1, int int1, Pointer<Pointer<?>>
            OGRSFDriverHPtr1);

    public static native Pointer<?> OGROpenShared(Pointer<Byte> charPtr1, int int1, 
                                                  Pointer<Pointer<?>> OGRSFDriverHPtr1);
    ...
    public static native Pointer<?> OGR_SM_GetPart(Pointer<?> hSM, int nPartId, Pointer<Byte> 
            pszStyleString);

    public static native int OGR_SM_AddPart(Pointer<?> hSM, Pointer<?> hST);

    public static native int OGR_SM_AddStyle(Pointer<?> hSM, Pointer<Byte> pszStyleName, 
                                             Pointer<Byte> pszStyleString);
    ...
    public static native void OGR_ST_SetUnit(Pointer<?> hST, ValuedEnum<OgrLibrary.OGRSTUnitId> 
            eUnit, double dfGroundPaperScale);

    public static native Pointer<Byte> OGR_ST_GetParamStr(Pointer<?> hST, int eParam, 
                                                          Pointer<Integer> bValueIsNull);

    public static native int OGR_ST_GetParamNum(Pointer<?> hST, int eParam, Pointer<Integer> 
            bValueIsNull);

    public static native double OGR_ST_GetParamDbl(Pointer<?> hST, int eParam, Pointer<Integer> 
            bValueIsNull);

    public static native void OGR_ST_SetParamStr(Pointer<?> hST, int eParam, Pointer<Byte> 
            pszValue);
    ...
    public static native int OGR_ST_GetRGBFromString(Pointer<?> hST, Pointer<Byte> pszColor, 
                                                     Pointer<Integer> pnRed, Pointer<Integer> 
                                                             pnGreen, Pointer<Integer> pnBlue, 
    ...
    public static native int OGR_STBL_SaveStyleTable(Pointer<?> hStyleTable, Pointer<Byte> 
            pszFilename);

    public static native int OGR_STBL_LoadStyleTable(Pointer<?> hStyleTable, Pointer<Byte> 
            pszFilename);
