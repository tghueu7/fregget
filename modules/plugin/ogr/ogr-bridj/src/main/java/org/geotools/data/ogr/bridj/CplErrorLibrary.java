...
public class CplErrorLibrary {
    ...
    public static native void CPLError(ValuedEnum<CplErrorLibrary.CPLErr> eErrClass, int err_no, 
                                       Pointer<Byte> fmt, Object... varargs);

    public static native void CPLErrorV(ValuedEnum<CplErrorLibrary.CPLErr> CPLErr1, int int1, 
    ...
    public static native void CPLLoggingErrorHandler(ValuedEnum<CplErrorLibrary.CPLErr> CPLErr1, 
                                                     int int1, Pointer<Byte> charPtr1);

    public static native void CPLDefaultErrorHandler(ValuedEnum<CplErrorLibrary.CPLErr> CPLErr1, 
                                                     int int1, Pointer<Byte> charPtr1);

    public static native void CPLQuietErrorHandler(ValuedEnum<CplErrorLibrary.CPLErr> CPLErr1, 
                                                   int int1, Pointer<Byte> charPtr1);

    public static native void CPLTurnFailureIntoWarning(int bOn);

    public static native Pointer<CPLErrorHandler> CPLSetErrorHandler(Pointer<CPLErrorHandler> 
                                                                             CPLErrorHandler1);
    ...
    public static native void CPLDebug(Pointer<Byte> charPtr1, Pointer<Byte> charPtr2, Object... 
            varargs);
