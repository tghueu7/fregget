...
public class OsrLibrary {
    ...
    public static final String SRS_PT_IMW_POLYCONIC = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_SWISS_OBLIQUE_CYLINDRICAL = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_LAMBERT_CONFORMAL_CONIC_2SP_BELGIUM = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_LAMBERT_CONFORMAL_CONIC_1SP = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_MI_25 = (String) 
            "Transverse_Mercator_MapInfo_25";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_MI_22 = (String) 
            "Transverse_Mercator_MapInfo_22";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_MI_21 = (String) 
            "Transverse_Mercator_MapInfo_21";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_MI_24 = (String) 
            "Transverse_Mercator_MapInfo_24";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_MI_23 = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_WKT_WGS84 = (String) "GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\"," +
            "SPHEROID[\"WGS 84\",6378137,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]],TOWGS84[0,0," +
            "0,0,0,0,0],AUTHORITY[\"EPSG\",\"6326\"]],PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\"," +
            "\"8901\"]],UNIT[\"degree\",0.0174532925199433,AUTHORITY[\"EPSG\",\"9108\"]]," +
            "AUTHORITY[\"EPSG\",\"4326\"]]";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_GAUSSSCHREIBERTMERCATOR = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_LAMBERT_AZIMUTHAL_EQUAL_AREA = (String) 
            "Lambert_Azimuthal_Equal_Area";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_UA_DEGREE_CONV = (String) "0.0174532925199433";
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PP_PERSPECTIVE_POINT_HEIGHT = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_TRANSVERSE_MERCATOR_SOUTH_ORIENTED = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_LAMBERT_CONFORMAL_CONIC_2SP = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_LABORDE_OBLIQUE_MERCATOR = (String) 
    ...
    /// <i>native declaration : /home/aaime/devel/gdal/gdal-1.8.0/ogr/ogr_srs_api.h</i>
    public static final String SRS_PT_HOTINE_OBLIQUE_MERCATOR_TWO_POINT_NATURAL_ORIGIN = (String)
    ...
    public static native Pointer<Byte> OSRAxisEnumToName(ValuedEnum<OsrLibrary
    ...
    public static native int OSRImportFromWkt(Pointer<?> OGRSpatialReferenceH1, 
                                              Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRImportFromProj4(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1);

    public static native int OSRImportFromESRI(Pointer<?> OGRSpatialReferenceH1, 
                                               Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRImportFromPCI(Pointer<?> hSRS, Pointer<Byte> charPtr1, 
                                              Pointer<Byte> charPtr2, Pointer<Double> doublePtr1);

    public static native int OSRImportFromUSGS(Pointer<?> OGRSpatialReferenceH1, @CLong long l1, 
                                               @CLong long l2, Pointer<Double> doublePtr1, @CLong
                                                       long l3);

    public static native int OSRImportFromXML(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1);

    public static native int OSRImportFromDict(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, Pointer<Byte> charPtr2);

    public static native int OSRImportFromPanorama(Pointer<?> OGRSpatialReferenceH1, @CLong long 
            l1, @CLong long l2, @CLong long l3, Pointer<Double> doublePtr1);

    public static native int OSRImportFromOzi(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, Pointer<Byte> charPtr2, Pointer<Byte> charPtr3);

    public static native int OSRImportFromMICoordSys(Pointer<?> OGRSpatialReferenceH1, 
                                                     Pointer<Byte> charPtr1);

    public static native int OSRImportFromERM(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, Pointer<Byte> charPtr2, Pointer<Byte> charPtr3);

    public static native int OSRImportFromUrl(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1);

    public static native int OSRExportToWkt(Pointer<?> OGRSpatialReferenceH1, 
                                            Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRExportToPrettyWkt(Pointer<?> OGRSpatialReferenceH1, 
                                                  Pointer<Pointer<Byte>> charPtrPtr1, int int1);

    public static native int OSRExportToProj4(Pointer<?> OGRSpatialReferenceH1, 
                                              Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRExportToPCI(Pointer<?> OGRSpatialReferenceH1, 
                                            Pointer<Pointer<Byte>> charPtrPtr1, 
                                            Pointer<Pointer<Byte>> charPtrPtr2, 
                                            Pointer<Pointer<Double>> doublePtrPtr1);

    public static native int OSRExportToUSGS(Pointer<?> OGRSpatialReferenceH1, Pointer<CLong> 
            lPtr1, Pointer<CLong> lPtr2, Pointer<Pointer<Double>> doublePtrPtr1, Pointer<CLong> 
            lPtr3);

    public static native int OSRExportToXML(Pointer<?> OGRSpatialReferenceH1, 
                                            Pointer<Pointer<Byte>> charPtrPtr1, Pointer<Byte> 
                                                    charPtr1);

    public static native int OSRExportToPanorama(Pointer<?> OGRSpatialReferenceH1, Pointer<CLong>
            lPtr1, Pointer<CLong> lPtr2, Pointer<CLong> lPtr3, Pointer<CLong> lPtr4, 
                                                 Pointer<Double> doublePtr1);

    public static native int OSRExportToMICoordSys(Pointer<?> OGRSpatialReferenceH1, 
                                                   Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRExportToERM(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, Pointer<Byte> charPtr2, Pointer<Byte> charPtr3);
    ...
    public static native int OSRSetAttrValue(Pointer<?> hSRS, Pointer<Byte> pszNodePath, 
                                             Pointer<Byte> pszNewNodeValue);

    public static native Pointer<Byte> OSRGetAttrValue(Pointer<?> hSRS, Pointer<Byte> pszName, 
                                                       int iChild);

    public static native int OSRSetAngularUnits(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, double double1);

    public static native double OSRGetAngularUnits(Pointer<?> OGRSpatialReferenceH1, 
                                                   Pointer<Pointer<Byte>> charPtrPtr1);

    public static native int OSRSetLinearUnits(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, double double1);

    public static native int OSRSetLinearUnitsAndUpdateParameters(Pointer<?> 
                                                                          OGRSpatialReferenceH1, 
                                                                  Pointer<Byte> charPtr1, double 
                                                                          double1);

    public static native double OSRGetLinearUnits(Pointer<?> OGRSpatialReferenceH1, 
                                                  Pointer<Pointer<Byte>> charPtrPtr1);

    public static native double OSRGetPrimeMeridian(Pointer<?> OGRSpatialReferenceH1, 
                                                    Pointer<Pointer<Byte>> charPtrPtr1);
    ...
    public static native int OSRIsSameGeogCS(Pointer<?> OGRSpatialReferenceH1, Pointer<?> 
            OGRSpatialReferenceH2);

    //public static native int OSRIsVertCS(Pointer<? > OGRSpatialReferenceH1, Pointer<? > 
    // OGRSpatialReferenceH2);
    public static native int OSRIsSame(Pointer<?> OGRSpatialReferenceH1, Pointer<?> 
            OGRSpatialReferenceH2);
    ...
    public static native int OSRSetTOWGS84(Pointer<?> hSRS, double double1, double double2, 
                                           double double3, double double4, double double5, double
                                                   double6, double double7);

    public static native int OSRGetTOWGS84(Pointer<?> hSRS, Pointer<Double> doublePtr1, int int1);

    public static native int OSRSetGeogCS(Pointer<?> hSRS, Pointer<Byte> pszGeogName, 
                                          Pointer<Byte> pszDatumName, Pointer<Byte> 
                                                  pszEllipsoidName, double dfSemiMajor, double 
                                                  dfInvFlattening, Pointer<Byte> pszPMName, 
                                          double dfPMOffset, Pointer<Byte> pszUnits, double 
                                                  dfConvertToRadians);

    public static native double OSRGetSemiMajor(Pointer<?> OGRSpatialReferenceH1, 
                                                Pointer<Integer> OGRErrPtr1);

    public static native double OSRGetSemiMinor(Pointer<?> OGRSpatialReferenceH1, 
                                                Pointer<Integer> OGRErrPtr1);

    public static native double OSRGetInvFlattening(Pointer<?> OGRSpatialReferenceH1, 
                                                    Pointer<Integer> OGRErrPtr1);

    public static native int OSRSetAuthority(Pointer<?> hSRS, Pointer<Byte> pszTargetKey, 
                                             Pointer<Byte> pszAuthority, int nCode);

    public static native Pointer<Byte> OSRGetAuthorityCode(Pointer<?> hSRS, Pointer<Byte> 
            pszTargetKey);

    public static native Pointer<Byte> OSRGetAuthorityName(Pointer<?> hSRS, Pointer<Byte> 
            pszTargetKey);

    public static native int OSRSetProjection(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1);

    public static native int OSRSetProjParm(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, double double1);

    public static native double OSRGetProjParm(Pointer<?> hSRS, Pointer<Byte> pszParmName, double
            dfDefault, Pointer<Integer> OGRErrPtr1);

    public static native int OSRSetNormProjParm(Pointer<?> OGRSpatialReferenceH1, Pointer<Byte> 
            charPtr1, double double1);

    public static native double OSRGetNormProjParm(Pointer<?> hSRS, Pointer<Byte> pszParmName, 
                                                   double dfDefault, Pointer<Integer> OGRErrPtr1);
    ...
    public static native int OSRSetStatePlaneWithUnits(Pointer<?> hSRS, int nZone, int bNAD83, 
                                                       Pointer<Byte> pszOverrideUnitName, double 
                                                               dfOverrideUnit);
    ...
    public static native Pointer<Byte> OSRGetAxis(Pointer<?> hSRS, Pointer<Byte> pszTargetKey, 
                                                  int iAxis, Pointer<ValuedEnum<OsrLibrary
            .OGRAxisOrientation>> peOrientation);

    //public static native int OSRSetAxes(Pointer<Byte > pszTargetKey, Pointer<Byte > 
    // pszXAxisName, ValuedEnum<OsrLibrary.OGRAxisOrientation > eXAxisOrientation, Pointer<Byte >
    // pszYAxisName, ValuedEnum<OsrLibrary.OGRAxisOrientation > eYAxisOrientation);
    public static native int OSRSetACEA(Pointer<?> hSRS, double dfStdP1, double dfStdP2, double 
            dfCenterLat, double dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetAE(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                      double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetBonne(Pointer<?> hSRS, double dfStandardParallel, double 
            dfCentralMeridian, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetCEA(Pointer<?> hSRS, double dfStdP1, double dfCentralMeridian,
                                       double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetCS(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                      double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEC(Pointer<?> hSRS, double dfStdP1, double dfStdP2, double 
            dfCenterLat, double dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEckert(Pointer<?> hSRS, int nVariation, double 
            dfCentralMeridian, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEckertIV(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEckertVI(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEquirectangular(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetEquirectangular2(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfPseudoStdParallel1, double dfFalseEasting, double 
            dfFalseNorthing);

    public static native int OSRSetGS(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetGH(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetGEOS(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfSatelliteHeight, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetGaussSchreiberTMercator(Pointer<?> hSRS, double dfCenterLat, 
                                                           double dfCenterLong, double dfScale, 
                                                           double dfFalseEasting, double 
                                                                   dfFalseNorthing);

    public static native int OSRSetGnomonic(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetHOM(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                       double dfAzimuth, double dfRectToSkew, double dfScale, 
                                       double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetHOM2PNO(Pointer<?> hSRS, double dfCenterLat, double dfLat1, 
                                           double dfLong1, double dfLat2, double dfLong2, double 
                                                   dfScale, double dfFalseEasting, double 
                                                   dfFalseNorthing);

    public static native int OSRSetIWMPolyconic(Pointer<?> hSRS, double dfLat1, double dfLat2, 
                                                double dfCenterLong, double dfFalseEasting, 
                                                double dfFalseNorthing);

    public static native int OSRSetKrovak(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfAzimuth, double dfPseudoStdParallelLat, double dfScale, double
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetLAEA(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong,
                                        double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetLCC(Pointer<?> hSRS, double dfStdP1, double dfStdP2, double 
            dfCenterLat, double dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetLCC1SP(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfScale, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetLCCB(Pointer<?> hSRS, double dfStdP1, double dfStdP2, double 
            dfCenterLat, double dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetMC(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                      double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetMercator(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfScale, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetMollweide(Pointer<?> hSRS, double dfCentralMeridian, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetNZMG(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong,
                                        double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetOS(Pointer<?> hSRS, double dfOriginLat, double dfCMeridian, 
                                      double dfScale, double dfFalseEasting, double 
                                              dfFalseNorthing);

    public static native int OSRSetOrthographic(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetPolyconic(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetPS(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                      double dfScale, double dfFalseEasting, double 
                                              dfFalseNorthing);

    public static native int OSRSetRobinson(Pointer<?> hSRS, double dfCenterLong, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetSinusoidal(Pointer<?> hSRS, double dfCenterLong, double 
            dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetStereographic(Pointer<?> hSRS, double dfCenterLat, double 
            dfCenterLong, double dfScale, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetSOC(Pointer<?> hSRS, double dfLatitudeOfOrigin, double 
            dfCentralMeridian, double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetTM(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                      double dfScale, double dfFalseEasting, double 
                                              dfFalseNorthing);

    public static native int OSRSetTMVariant(Pointer<?> hSRS, Pointer<Byte> pszVariantName, 
                                             double dfCenterLat, double dfCenterLong, double 
                                                     dfScale, double dfFalseEasting, double 
                                                     dfFalseNorthing);

    public static native int OSRSetTMG(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong, 
                                       double dfFalseEasting, double dfFalseNorthing);

    public static native int OSRSetTMSO(Pointer<?> hSRS, double dfCenterLat, double dfCenterLong,
                                        double dfScale, double dfFalseEasting, double 
                                                dfFalseNorthing);

    public static native int OSRSetVDG(Pointer<?> hSRS, double dfCenterLong, double 
            dfFalseEasting, double dfFalseNorthing);
    ...
    public static native Pointer<?> OCTNewCoordinateTransformation(Pointer<?> hSourceSRS, 
                                                                   Pointer<?> hTargetSRS);

    public static native void OCTDestroyCoordinateTransformation(Pointer<?> 
                                                                         OGRCoordinateTransformationH1);

    public static native int OCTTransform(Pointer<?> hCT, int nCount, Pointer<Double> x, 
                                          Pointer<Double> y, Pointer<Double> z);

    public static native int OCTTransformEx(Pointer<?> hCT, int nCount, Pointer<Double> x, 
                                            Pointer<Double> y, Pointer<Double> z, 
    ...
    public static native Pointer<Pointer<Byte>> OPTGetParameterList(Pointer<Byte> 
                                                                            pszProjectionMethod, 
                                                                    Pointer<Pointer<Byte>> 
                                                                            ppszUserName);

    public static native int OPTGetParameterInfo(Pointer<Byte> pszProjectionMethod, Pointer<Byte>
            pszParameterName, Pointer<Pointer<Byte>> ppszUserName, Pointer<Pointer<Byte>> 
            ppszType, Pointer<Double> pdfDefaultValue);

    public int sys_nerr() {
        try {
            return (int) BridJ.getNativeLibrary("osr").getSymbolPointer("sys_nerr").as(int.class)
                    .get();
        } catch (Throwable $ex$) {
    ...
    public OsrLibrary sys_nerr(int sys_nerr) {
        try {
            {
                BridJ.getNativeLibrary("osr").getSymbolPointer("sys_nerr").as(int.class).set
                        (sys_nerr);
                return this;
            }
        } catch (Throwable $ex$) {
    ...
    public int signgam() {
        try {
            return (int) BridJ.getNativeLibrary("osr").getSymbolPointer("signgam").as(int.class)
                    .get();
        } catch (Throwable $ex$) {
            throw new RuntimeException($ex$);
        }
    ...
    public OsrLibrary signgam(int signgam) {
        try {
            {
                BridJ.getNativeLibrary("osr").getSymbolPointer("signgam").as(int.class).set
                        (signgam);
                return this;
            }
        } catch (Throwable $ex$) {
