...
public class OsrLibrary {
  ...
  public static native int OSRImportFromPCI(
      Pointer<?> hSRS, Pointer<Byte> charPtr1, Pointer<Byte> charPtr2, Pointer<Double> doublePtr1);
  ...
  public static native int OSRExportToXML(
      Pointer<?> OGRSpatialReferenceH1, Pointer<Pointer<Byte>> charPtrPtr1, Pointer<Byte> charPtr1);
  ...
  public static native double OSRGetProjParm(
      Pointer<?> hSRS, Pointer<Byte> pszParmName, double dfDefault, Pointer<Integer> OGRErrPtr1);
  ...
  public static native int OSRSetEckertIV(
      Pointer<?> hSRS, double dfCentralMeridian, double dfFalseEasting, double dfFalseNorthing);
  ...
  public static native int OSRSetVDG(
      Pointer<?> hSRS, double dfCenterLong, double dfFalseEasting, double dfFalseNorthing);
  // public static native int OSRSetWagner(Pointer<? > hSRS, int nVariation, double dfFalseEasting,
  // double dfFalseNorthing);
