...
public class BridjOGR implements OGR {
    ...
    public void CheckError(int code) throws IOException {
        ...
        switch (code) {
            ...
            case OGRERR_NOT_ENOUGH_DATA:
                throw new IOException("OGR reported not enough data was provided in the last " +
                        "call: " + error);
    ...
    public Object DataSourceExecuteSQL(Object dataSource, String sql, Object spatialFilter) {
        return OGR_DS_ExecuteSQL((Pointer<?>) dataSource, pointerToCString(sql), (Pointer<?>) 
                spatialFilter, null);
    }
    ...
    public void FeatureSetFieldDateTime(Object feature, int field, int year,
                                        int month, int day, int hour, int minute, int second, int
                                                    tz) {
        OGR_F_SetFieldDateTime((Pointer<?>) feature, field, year, month, day, hour, minute, 
                second, tz);
    }
    ...
    public void FeatureGetFieldAsDateTime(Object feature, int i, int[] yeara, int[] montha,
                                          int[] daya, int[] houra, int[] minutea, int[] seconda, 
                                          int[] tzFlag) {
        ...
        OGR_F_GetFieldAsDateTime((Pointer<?>) feature, i, year, month, day, hour, minute, second,
                timeZone);
    ...
    public String SpatialRefGetAuthorityCode(Object spatialRef, String authority) {
        return getCString(OSRGetAuthorityCode((Pointer<?>) spatialRef, pointerToCString
                (authority)));
    }
