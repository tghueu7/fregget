...
public class JniOGR implements OGR {
    ...
    public void FeatureGetFieldAsDateTime(Object feature, int i, int[] year,
                                          int[] month, int[] day, int[] hour, int[] minute, int[]
                                                      second,
                                          int[] tzFlag) {
    ...
    public static void main(String[] args) throws Exception {
        ogr.RegisterAll();
        DataSource ds = ogr.Open("/Users/jdeolive/Projects/geotools/git/modules/library/sample" +
                "-data/src/main/resources/org/geotools/test-data/shapes/statepop.shp");
