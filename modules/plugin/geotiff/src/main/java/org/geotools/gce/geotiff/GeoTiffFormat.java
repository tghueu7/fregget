...
public class GeoTiffFormat extends AbstractGridFormat implements Format {
     ...
     */
    public static final DefaultParameterDescriptor<Boolean> RETAIN_AXES_ORDER = new 
            DefaultParameterDescriptor<Boolean>(
    ...
    public GeoTiffFormat() {
        ...
        writeParameters = new ParameterGroup(
                new DefaultParameterDescriptorGroup(
                        mInfo,
                        new GeneralParameterDescriptor[]{RETAIN_AXES_ORDER, AbstractGridFormat
                                .GEOTOOLS_WRITE_PARAMS, AbstractGridFormat.PROGRESS_LISTENER}));
    ...
    public boolean accepts(Object o, Hints hints) {
        ...
        try {
            ...
            // get a stream
            inputStream = (ImageInputStream) ((o instanceof ImageInputStream) ? o : ImageIO
