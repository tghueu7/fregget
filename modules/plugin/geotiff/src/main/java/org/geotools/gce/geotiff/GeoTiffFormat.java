...
public class GeoTiffFormat extends AbstractGridFormat implements Format {
        ...
        new ParameterGroup(
            new DefaultParameterDescriptorGroup(
                ...
                new GeneralParameterDescriptor[] {
                  READ_GRIDGEOMETRY2D, INPUT_TRANSPARENT_COLOR, SUGGESTED_TILE_SIZE
                }));
   ...
   * tag. If anything more subtle is wrong with the file, we deal with that when we try and read it.
   *
  ...
  public boolean accepts(Object o, Hints hints) {
    ...
    try {
      ...
      inputStream =
          (ImageInputStream)
              ((o instanceof ImageInputStream) ? o : ImageIO.createImageInputStream(o));
      if (inputStream == null) {
  ...
  /**
   * Retrieves a {@link GeoTiffWriter} or <code>null</code> if the provided <code>destination</code>
   * is suitable.
   *
