...
public class GeoTiffWriteParams extends GeoToolsWriteParams {
   ...
   * data should be converted for storage in the input stream. In addition, the value to be written
   * to the <code>PhotometricInterpretation</code> tag is supplied.
   *
   * @param colorConverter a <code>TIFFColorConverter</code> object, or <code>null</code>.
   * @param photometricInterpretation the value to be written to the <code>PhotometricInterpretation
   *     </code> tag in the root IFD.
   ...
   * compressor</code> is <code>null</code> this will also cause any previously appended type to be
   * removed from the array.
   *
   * @param compressor the <code>TIFFCompressor</code> to be used for encoding, or <code>null</code>
