...
public interface InterpolationType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.InterpolationType#getInterpolationMethod
   * <em>Interpolation Method</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.InterpolationType#getInterpolationAxes
   * <em>Interpolation Axes</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
