 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ScaleToExtentTypeImpl#getTargetAxisExtent <em>Target Axis
 *       Extent</em>}
 * </ul>
 *
 * @generated
...
public class ScaleToExtentTypeImpl extends EObjectImpl implements ScaleToExtentType {
  /**
   * The cached value of the '{@link #getTargetAxisExtent() <em>Target Axis Extent</em>}' reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TargetAxisExtentType> getTargetAxisExtent() {
    if (targetAxisExtent == null) {
      targetAxisExtent =
          new EObjectResolvingEList<TargetAxisExtentType>(
              TargetAxisExtentType.class,
              this,
              Wcs20Package.SCALE_TO_EXTENT_TYPE__TARGET_AXIS_EXTENT);
    }
