 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.DescribeEOCoverageSetTypeImpl#getEoId <em>Eo Id</em>}
 *   <li>{@link net.opengis.wcs20.impl.DescribeEOCoverageSetTypeImpl#getContainmentType
 *       <em>Containment Type</em>}
 *   <li>{@link net.opengis.wcs20.impl.DescribeEOCoverageSetTypeImpl#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.wcs20.impl.DescribeEOCoverageSetTypeImpl#getDimensionTrim <em>Dimension
 *       Trim</em>}
 *   <li>{@link net.opengis.wcs20.impl.DescribeEOCoverageSetTypeImpl#getCount <em>Count</em>}
 * </ul>
 *
 * @generated
 */
public class DescribeEOCoverageSetTypeImpl extends RequestBaseTypeImpl
    implements DescribeEOCoverageSetType {
  /**
    ...
    if (eoId == null) {
      eoId =
          new EDataTypeEList<String>(
              String.class, this, Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__EO_ID);
    }
    return eoId;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__CONTAINMENT_TYPE,
              oldContainmentType,
              containmentType));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__SECTIONS,
              oldSections,
              newSections);
      ...
      if (sections != null)
        msgs =
            ((InternalEObject) sections)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__SECTIONS,
                    null,
                    msgs);
      if (newSections != null)
        msgs =
  ...
  public EList<DimensionTrimType> getDimensionTrim() {
    if (dimensionTrim == null) {
      dimensionTrim =
          new EObjectResolvingEList<DimensionTrimType>(
              DimensionTrimType.class,
              this,
              Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__DIMENSION_TRIM);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__COUNT,
              oldCount,
              count));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__CONTAINMENT_TYPE:
        return CONTAINMENT_TYPE_EDEFAULT == null
            ? containmentType != null
            : !CONTAINMENT_TYPE_EDEFAULT.equals(containmentType);
      case Wcs20Package.DESCRIBE_EO_COVERAGE_SET_TYPE__SECTIONS:
