 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.CapabilitiesTypeImpl#getServiceMetadata <em>Service
 *       Metadata</em>}
 *   <li>{@link net.opengis.wcs20.impl.CapabilitiesTypeImpl#getContents <em>Contents</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.CAPABILITIES_TYPE__SERVICE_METADATA,
              oldServiceMetadata,
              newServiceMetadata);
      ...
      if (serviceMetadata != null)
        msgs =
            ((InternalEObject) serviceMetadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.CAPABILITIES_TYPE__SERVICE_METADATA,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.CAPABILITIES_TYPE__CONTENTS,
              oldContents,
              newContents);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (contents != null)
        msgs =
            ((InternalEObject) contents)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.CAPABILITIES_TYPE__CONTENTS,
                    null,
                    msgs);
      if (newContents != null)
        msgs =
