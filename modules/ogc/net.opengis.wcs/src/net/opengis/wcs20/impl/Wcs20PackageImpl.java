...
public class Wcs20PackageImpl extends EPackageImpl implements Wcs20Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Wcs20Package#eINSTANCE} when that field is
  ...
  public static Wcs20Package init() {
    ...
    Wcs20PackageImpl theWcs20Package =
        (Wcs20PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wcs20PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Wcs20PackageImpl());
  ...
  public void createPackageContents() {
    ...
    createEReference(
        coverageDescriptionsTypeEClass, COVERAGE_DESCRIPTIONS_TYPE__COVERAGE_DESCRIPTION);
    ...
    createEAttribute(
        coverageSubtypeParentTypeEClass, COVERAGE_SUBTYPE_PARENT_TYPE__COVERAGE_SUBTYPE);
    createEReference(
        coverageSubtypeParentTypeEClass, COVERAGE_SUBTYPE_PARENT_TYPE__COVERAGE_SUBTYPE_PARENT);
    ...
    createEAttribute(
        interpolationMethodTypeEClass, INTERPOLATION_METHOD_TYPE__INTERPOLATION_METHOD);
    ...
    createEAttribute(
        describeEOCoverageSetTypeEClass, DESCRIBE_EO_COVERAGE_SET_TYPE__CONTAINMENT_TYPE);
    createEReference(describeEOCoverageSetTypeEClass, DESCRIBE_EO_COVERAGE_SET_TYPE__SECTIONS);
    createEReference(
        describeEOCoverageSetTypeEClass, DESCRIBE_EO_COVERAGE_SET_TYPE__DIMENSION_TRIM);
  ...
  public void initializePackageContents() {
    ...
    Ows20Package theOws20Package =
        (Ows20Package) EPackage.Registry.INSTANCE.getEPackage(Ows20Package.eNS_URI);
    ...
    initEClass(
        ...
        CoverageDescriptionsType.class,
    ...
    initEReference(
        ...
        this.getCoverageDescriptionType(),
        null,
        "coverageDescription",
        null,
        0,
    ...
    initEClass(
        ...
        CoverageSubtypeParentType.class,
    ...
    initEReference(
        ...
        this.getCoverageSubtypeParentType(),
        null,
    ...
    initEReference(
        ...
        theOws20Package.getWGS84BoundingBoxType(),
        null,
        "wGS84BoundingBox",
        null,
        0,
    ...
    initEAttribute(
        ...
        theEcorePackage.getEFeatureMapEntry(),
        "boundingBoxGroup",
        null,
        0,
        -1,
    ...
    initEReference(
        ...
        theOws20Package.getBoundingBoxType(),
        null,
        "boundingBox",
        null,
        0,
    ...
    initEReference(
        ...
        theOws20Package.getMetadataType(),
        null,
        "metadata",
        null,
        0,
    ...
    initEReference(
        ...
        this.getCoverageDescriptionsType(),
        null,
    ...
    initEAttribute(
        ...
        theOws20Package.getServiceType(),
        "service",
        "WCS",
        1,
        1,
    ...
    initEClass(
        extensionItemTypeEClass,
        ExtensionItemType.class,
        "ExtensionItemType",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getExtensionItemType_Name(),
        ecorePackage.getEString(),
        "name",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getExtensionItemType_Namespace(),
        ecorePackage.getEString(),
        "namespace",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getExtensionItemType_SimpleContent(),
        ecorePackage.getEString(),
        "simpleContent",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getExtensionItemType_ObjectContent(),
        this.getObject(),
        null,
        "objectContent",
        null,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getRangeIntervalType_StartComponent(),
        ecorePackage.getEString(),
        "startComponent",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getRangeIntervalType_EndComponent(),
        ecorePackage.getEString(),
        "endComponent",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getRangeItemType_RangeComponent(),
        ecorePackage.getEString(),
        "rangeComponent",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getRangeItemType_RangeInterval(),
        this.getRangeIntervalType(),
        null,
        "rangeInterval",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getRangeSubsetType_RangeItems(),
        this.getRangeItemType(),
        null,
        "rangeItems",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getScaleAxisByFactorType_ScaleAxis(),
        this.getScaleAxisType(),
        null,
        "scaleAxis",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getScaleByFactorType_ScaleFactor(),
        ecorePackage.getEDouble(),
        "scaleFactor",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getScaleToExtentType_TargetAxisExtent(),
        this.getTargetAxisExtentType(),
        null,
        "targetAxisExtent",
        null,
        0,
    ...
    initEClass(
        scaleToSizeTypeEClass,
        ScaleToSizeType.class,
        "ScaleToSizeType",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getScaleToSizeType_TargetAxisSize(),
        this.getTargetAxisSizeType(),
        null,
        "targetAxisSize",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getScalingType_ScaleByFactor(),
        this.getScaleByFactorType(),
        null,
        "scaleByFactor",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getScalingType_ScaleAxesByFactor(),
        this.getScaleAxisByFactorType(),
        null,
        "scaleAxesByFactor",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getScalingType_ScaleToSize(),
        this.getScaleToSizeType(),
        null,
        "scaleToSize",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getScalingType_ScaleToExtent(),
        this.getScaleToExtentType(),
        null,
        "scaleToExtent",
        null,
        0,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getTargetAxisSizeType_TargetSize(),
        ecorePackage.getEDouble(),
        "targetSize",
        null,
        0,
    ...
    initEClass(
        interpolationAxesTypeEClass,
        InterpolationAxesType.class,
        "InterpolationAxesType",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getInterpolationAxesType_InterpolationAxis(),
        this.getInterpolationAxisType(),
        null,
        "interpolationAxis",
        null,
        0,
    ...
    initEClass(
        interpolationAxisTypeEClass,
        InterpolationAxisType.class,
        "InterpolationAxisType",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getInterpolationAxisType_Axis(),
        ecorePackage.getEString(),
        "axis",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getInterpolationAxisType_InterpolationMethod(),
        ecorePackage.getEString(),
        "interpolationMethod",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getInterpolationMethodType_InterpolationMethod(),
        ecorePackage.getEString(),
        "interpolationMethod",
        null,
        0,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getInterpolationType_InterpolationMethod(),
        this.getInterpolationMethodType(),
        null,
        "interpolationMethod",
        null,
        0,
        ...
        IS_ORDERED);
    initEReference(
        getInterpolationType_InterpolationAxes(),
        this.getInterpolationAxesType(),
        null,
        "interpolationAxes",
        null,
        0,
    ...
    initEClass(
        ...
        DescribeEOCoverageSetType.class,
    ...
    initEReference(
        ...
        IS_ORDERED);
    initEAttribute(
        getDescribeEOCoverageSetType_Count(),
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        versionStringType_1EDataType,
        String.class,
        "VersionStringType_1",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        qNameEDataType, QName.class, "QName", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        filterEDataType, Filter.class, "Filter", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        sortByEDataType, SortBy.class, "SortBy", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgml3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "gml.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:dynamicFeature:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsddynamicFeature3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "dynamicFeature.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdtopology3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "topology.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdcoverage3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "coverage.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:coordinateReferenceSystems:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdcoordinateReferenceSystems3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "coordinateReferenceSystems.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:observation:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdobservation3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "observation.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:temporalReferenceSystems:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdtemporalReferenceSystems3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "temporalReferenceSystems.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:deprecatedTypes:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsddeprecatedTypes3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "deprecatedTypes.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:temporalTopology:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdtemporalTopology3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "temporalTopology.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:opengis:specification:gml:schema-xsd:dictionary:v3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnopengisspecificationgmlschemaxsddictionaryv3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "dictionary.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgmlBase3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "gmlBase.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdtemporal3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "temporal.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdfeature3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "feature.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsddirection3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "direction.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:valueObjects:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdvalueObjects3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "valueObjects.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:geometryBasic0d1d:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgeometryBasic0d1d3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "geometryBasic0d1d.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:coordinateSystems:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdcoordinateSystems3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "coordinateSystems.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsddatums3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "datums.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:coordinateOperations:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdcoordinateOperations3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "coordinateOperations.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:referenceSystems:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdreferenceSystems3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "referenceSystems.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdmeasures3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "measures.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdunits3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "units.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgrids3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "grids.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:geometryAggregates:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgeometryAggregates3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "geometryAggregates.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:geometryPrimitives:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgeometryPrimitives3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "geometryPrimitives.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:geometryComplexes:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgeometryComplexes3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "geometryComplexes.xsd"});
  }
  ...
  protected void createUrnxogcspecificationgmlschemaxsdbasicTypes3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "basicTypes.xsd"});
  }

  /**
   * Initializes the annotations for
   * <b>urn:x-ogc:specification:gml:schema-xsd:geometryBasic2d:3.2.1</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
  ...
  protected void createUrnxogcspecificationgmlschemaxsdgeometryBasic2d3Annotations() {
    ...
    addAnnotation(this, source, new String[] {"appinfo", "geometryBasic2d.xsd"});
  }
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(containmentTypeEEnum, source, new String[] {"name", "ContainmentType"});
    addAnnotation(sectionEEnum, source, new String[] {"name", "ContainmentType"});
    addAnnotation(
        versionStringTypeEDataType,
        source,
        new String[] {
