 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionsTypeImpl#getCoverageDescription
 *       <em>Coverage Description</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageDescriptionsTypeImpl extends EObjectImpl implements CoverageDescriptionsType {
  /**
   * The cached value of the '{@link #getCoverageDescription() <em>Coverage Description</em>}'
  ...
  public EList<CoverageDescriptionType> getCoverageDescription() {
    if (coverageDescription == null) {
      coverageDescription =
          new EObjectContainmentEList<CoverageDescriptionType>(
              CoverageDescriptionType.class,
              this,
              Wcs20Package.COVERAGE_DESCRIPTIONS_TYPE__COVERAGE_DESCRIPTION);
    }
