 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.RequestBaseTypeImpl#getExtension <em>Extension</em>}
 *   <li>{@link net.opengis.wcs20.impl.RequestBaseTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs20.impl.RequestBaseTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.wcs20.impl.RequestBaseTypeImpl#getBaseUrl <em>Base Url</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.REQUEST_BASE_TYPE__EXTENSION,
              oldExtension,
              newExtension);
      ...
      if (extension != null)
        msgs =
            ((InternalEObject) extension)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.REQUEST_BASE_TYPE__EXTENSION,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.REQUEST_BASE_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.REQUEST_BASE_TYPE__VERSION,
              oldVersion,
              version));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.REQUEST_BASE_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
