 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ScaleToSizeTypeImpl#getTargetAxisSize <em>Target Axis
 *       Size</em>}
 * </ul>
 *
 * @generated
...
public class ScaleToSizeTypeImpl extends EObjectImpl implements ScaleToSizeType {
  /**
   * The cached value of the '{@link #getTargetAxisSize() <em>Target Axis Size</em>}' reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TargetAxisSizeType> getTargetAxisSize() {
    if (targetAxisSize == null) {
      targetAxisSize =
          new EObjectResolvingEList<TargetAxisSizeType>(
              TargetAxisSizeType.class, this, Wcs20Package.SCALE_TO_SIZE_TYPE__TARGET_AXIS_SIZE);
    }
