 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.InterpolationAxesTypeImpl#getInterpolationAxis
 *       <em>Interpolation Axis</em>}
 * </ul>
 *
 * @generated
 */
public class InterpolationAxesTypeImpl extends EObjectImpl implements InterpolationAxesType {
  /**
   * The cached value of the '{@link #getInterpolationAxis() <em>Interpolation Axis</em>}' reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<InterpolationAxisType> getInterpolationAxis() {
    if (interpolationAxis == null) {
      interpolationAxis =
          new EObjectResolvingEList<InterpolationAxisType>(
              InterpolationAxisType.class,
              this,
              Wcs20Package.INTERPOLATION_AXES_TYPE__INTERPOLATION_AXIS);
    }
