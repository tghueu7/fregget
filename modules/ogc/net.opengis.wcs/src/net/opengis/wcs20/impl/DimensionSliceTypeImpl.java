 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.DimensionSliceTypeImpl#getSlicePoint <em>Slice Point</em>}
 * </ul>
 *
 * @generated
 */
public class DimensionSliceTypeImpl extends DimensionSubsetTypeImpl implements DimensionSliceType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DIMENSION_SLICE_TYPE__SLICE_POINT,
              oldSlicePoint,
              slicePoint));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs20Package.DIMENSION_SLICE_TYPE__SLICE_POINT:
        return SLICE_POINT_EDEFAULT == null
            ? slicePoint != null
            : !SLICE_POINT_EDEFAULT.equals(slicePoint);
    }
