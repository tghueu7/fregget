 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ScaleAxisByFactorTypeImpl#getScaleAxis <em>Scale Axis</em>}
 * </ul>
 *
 * @generated
 */
public class ScaleAxisByFactorTypeImpl extends EObjectImpl implements ScaleAxisByFactorType {
  ...
  public EList<ScaleAxisType> getScaleAxis() {
    if (scaleAxis == null) {
      scaleAxis =
          new EObjectResolvingEList<ScaleAxisType>(
              ScaleAxisType.class, this, Wcs20Package.SCALE_AXIS_BY_FACTOR_TYPE__SCALE_AXIS);
    }
    return scaleAxis;
  }
