 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getCoverageId <em>Coverage Id</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getDimensionSubsetGroup <em>Dimension
 *       Subset Group</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getDimensionSubset <em>Dimension
 *       Subset</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getMediaType <em>Media Type</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getFilter <em>Filter</em>}
 *   <li>{@link net.opengis.wcs20.impl.GetCoverageTypeImpl#getSortBy <em>Sort By</em>}
 * </ul>
 *
 * @generated
 */
public class GetCoverageTypeImpl extends RequestBaseTypeImpl implements GetCoverageType {
  ...
  /**
   * The cached value of the '{@link #getDimensionSubsetGroup() <em>Dimension Subset Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.GET_COVERAGE_TYPE__COVERAGE_ID,
              oldCoverageId,
              coverageId));
  }
  ...
  public FeatureMap getDimensionSubsetGroup() {
    if (dimensionSubsetGroup == null) {
      dimensionSubsetGroup =
          new BasicFeatureMap(this, Wcs20Package.GET_COVERAGE_TYPE__DIMENSION_SUBSET_GROUP);
    }
  ...
  public EList<DimensionSubsetType> getDimensionSubset() {
    return getDimensionSubsetGroup()
        .list(Wcs20Package.Literals.GET_COVERAGE_TYPE__DIMENSION_SUBSET);
  }
  ...
  public void setFormat(String newFormat) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs20Package.GET_COVERAGE_TYPE__FORMAT, oldFormat, format));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.GET_COVERAGE_TYPE__MEDIA_TYPE,
              oldMediaType,
              mediaType));
  }
  ...
  public void setFilter(Filter newFilter) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs20Package.GET_COVERAGE_TYPE__FILTER, oldFilter, filter));
  }
  ...
  public EList<SortBy> getSortBy() {
    if (sortBy == null) {
      sortBy =
          new EDataTypeUniqueEList<SortBy>(
              SortBy.class, this, Wcs20Package.GET_COVERAGE_TYPE__SORT_BY);
    }
    return sortBy;
  }
