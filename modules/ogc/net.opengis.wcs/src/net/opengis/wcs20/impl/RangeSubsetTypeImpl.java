 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.RangeSubsetTypeImpl#getRangeItems <em>Range Items</em>}
 * </ul>
 *
 * @generated
 */
public class RangeSubsetTypeImpl extends EObjectImpl implements RangeSubsetType {
  ...
  public EList<RangeItemType> getRangeItems() {
    if (rangeItems == null) {
      rangeItems =
          new EObjectResolvingEList<RangeItemType>(
              RangeItemType.class, this, Wcs20Package.RANGE_SUBSET_TYPE__RANGE_ITEMS);
    }
    return rangeItems;
  }
