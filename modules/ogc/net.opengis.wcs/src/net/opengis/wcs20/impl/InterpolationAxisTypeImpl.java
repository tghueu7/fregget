 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.InterpolationAxisTypeImpl#getAxis <em>Axis</em>}
 *   <li>{@link net.opengis.wcs20.impl.InterpolationAxisTypeImpl#getInterpolationMethod
...
public class InterpolationAxisTypeImpl extends EObjectImpl implements InterpolationAxisType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs20Package.INTERPOLATION_AXIS_TYPE__AXIS, oldAxis, axis));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.INTERPOLATION_AXIS_TYPE__INTERPOLATION_METHOD,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs20Package.INTERPOLATION_AXIS_TYPE__INTERPOLATION_METHOD:
        return INTERPOLATION_METHOD_EDEFAULT == null
            ? interpolationMethod != null
            : !INTERPOLATION_METHOD_EDEFAULT.equals(interpolationMethod);
    }
