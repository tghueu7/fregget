 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getWGS84BoundingBox <em>WGS84
 *       Bounding Box</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getCoverageId <em>Coverage Id</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getCoverageSubtype <em>Coverage
 *       Subtype</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getCoverageSubtypeParent <em>Coverage
 *       Subtype Parent</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getMetadataGroup <em>Metadata
 *       Group</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageSummaryTypeImpl#getMetadata <em>Metadata</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageSummaryTypeImpl extends DescriptionTypeImpl implements CoverageSummaryType {
  ...
  /**
   * The cached value of the '{@link #getCoverageSubtypeParent() <em>Coverage Subtype Parent</em>}'
    ...
    if (wGS84BoundingBox == null) {
      wGS84BoundingBox =
          new EObjectContainmentEList<WGS84BoundingBoxType>(
              ...
              this,
              Wcs20Package.COVERAGE_SUMMARY_TYPE__WGS84_BOUNDING_BOX);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_ID,
              oldCoverageId,
              coverageId));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUBTYPE,
              oldCoverageSubtype,
              coverageSubtype));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUBTYPE_PARENT,
              oldCoverageSubtypeParent,
  ...
  public void setCoverageSubtypeParent(CoverageSubtypeParentType newCoverageSubtypeParent) {
    if (newCoverageSubtypeParent != coverageSubtypeParent) {
      ...
      if (coverageSubtypeParent != null)
        msgs =
            ((InternalEObject) coverageSubtypeParent)
                .eInverseRemove(
                    this,
      ...
      if (newCoverageSubtypeParent != null)
        msgs =
            ((InternalEObject) newCoverageSubtypeParent)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUBTYPE_PARENT,
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Wcs20Package.COVERAGE_SUMMARY_TYPE__BOUNDING_BOX_GROUP);
    }
    ...
    switch (featureID) {
      ...
      case Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_ID:
        return COVERAGE_ID_EDEFAULT == null
            ? coverageId != null
            : !COVERAGE_ID_EDEFAULT.equals(coverageId);
      case Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUBTYPE:
        return COVERAGE_SUBTYPE_EDEFAULT == null
            ? coverageSubtype != null
            : !COVERAGE_SUBTYPE_EDEFAULT.equals(coverageSubtype);
      case Wcs20Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUBTYPE_PARENT:
