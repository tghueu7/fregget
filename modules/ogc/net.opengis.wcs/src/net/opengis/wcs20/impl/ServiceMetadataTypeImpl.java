 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ServiceMetadataTypeImpl#getFormatSupported <em>Format
 *       Supported</em>}
 *   <li>{@link net.opengis.wcs20.impl.ServiceMetadataTypeImpl#getExtension <em>Extension</em>}
 * </ul>
 *
 * @generated
 */
public class ServiceMetadataTypeImpl extends EObjectImpl implements ServiceMetadataType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_METADATA_TYPE__FORMAT_SUPPORTED,
              oldFormatSupported,
              formatSupported));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_METADATA_TYPE__EXTENSION,
              oldExtension,
              newExtension);
      ...
      if (extension != null)
        msgs =
            ((InternalEObject) extension)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.SERVICE_METADATA_TYPE__EXTENSION,
                    null,
                    msgs);
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs20Package.SERVICE_METADATA_TYPE__FORMAT_SUPPORTED:
        return FORMAT_SUPPORTED_EDEFAULT == null
            ? formatSupported != null
            : !FORMAT_SUPPORTED_EDEFAULT.equals(formatSupported);
      case Wcs20Package.SERVICE_METADATA_TYPE__EXTENSION:
