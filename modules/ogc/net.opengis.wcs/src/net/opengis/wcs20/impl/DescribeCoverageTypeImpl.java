 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.DescribeCoverageTypeImpl#getCoverageId <em>Coverage Id</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (coverageId == null) {
      coverageId =
          new EDataTypeEList<String>(
              String.class, this, Wcs20Package.DESCRIBE_COVERAGE_TYPE__COVERAGE_ID);
    }
    return coverageId;
  }
