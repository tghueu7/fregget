 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.RangeIntervalTypeImpl#getStartComponent <em>Start
 *       Component</em>}
 *   <li>{@link net.opengis.wcs20.impl.RangeIntervalTypeImpl#getEndComponent <em>End Component</em>}
 * </ul>
 *
 * @generated
 */
public class RangeIntervalTypeImpl extends EObjectImpl implements RangeIntervalType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.RANGE_INTERVAL_TYPE__START_COMPONENT,
              oldStartComponent,
              startComponent));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.RANGE_INTERVAL_TYPE__END_COMPONENT,
              oldEndComponent,
              endComponent));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs20Package.RANGE_INTERVAL_TYPE__START_COMPONENT:
        return START_COMPONENT_EDEFAULT == null
            ? startComponent != null
            : !START_COMPONENT_EDEFAULT.equals(startComponent);
      case Wcs20Package.RANGE_INTERVAL_TYPE__END_COMPONENT:
        return END_COMPONENT_EDEFAULT == null
            ? endComponent != null
            : !END_COMPONENT_EDEFAULT.equals(endComponent);
    }
