 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getCoverageId <em>Coverage
 *       Id</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getCoverageFunction <em>Coverage
 *       Function</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getRangeType <em>Range Type</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageDescriptionTypeImpl#getServiceParameters <em>Service
 *       Parameters</em>}
 * </ul>
 *
 * @generated
...
public class CoverageDescriptionTypeImpl extends EObjectImpl implements CoverageDescriptionType {
  ...
  /**
   * The cached value of the '{@link #getCoverageFunction() <em>Coverage Function</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getServiceParameters() <em>Service Parameters</em>}'
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_ID,
              oldCoverageId,
              coverageId));
  }
  ...
  public NotificationChain basicSetCoverageFunction(
      Object newCoverageFunction, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_FUNCTION,
              oldCoverageFunction,
              newCoverageFunction);
  ...
  public void setCoverageFunction(Object newCoverageFunction) {
    if (newCoverageFunction != coverageFunction) {
      ...
      if (coverageFunction != null)
        msgs =
            ((InternalEObject) coverageFunction)
                .eInverseRemove(
                    this,
      ...
      if (newCoverageFunction != null)
        msgs =
            ((InternalEObject) newCoverageFunction)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs20Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_FUNCTION,
  ...
  public EList<Object> getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList<Object>(
              Object.class, this, Wcs20Package.COVERAGE_DESCRIPTION_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_DESCRIPTION_TYPE__RANGE_TYPE,
              oldRangeType,
              newRangeType);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRangeType(Object newRangeType) {
    if (newRangeType != rangeType) {
      ...
      if (rangeType != null)
        msgs =
            ((InternalEObject) rangeType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.COVERAGE_DESCRIPTION_TYPE__RANGE_TYPE,
                    null,
                    msgs);
      if (newRangeType != null)
        msgs =
            ((InternalEObject) newRangeType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.COVERAGE_DESCRIPTION_TYPE__RANGE_TYPE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_DESCRIPTION_TYPE__SERVICE_PARAMETERS,
              oldServiceParameters,
  ...
  public void setServiceParameters(ServiceParametersType newServiceParameters) {
    if (newServiceParameters != serviceParameters) {
      ...
      if (serviceParameters != null)
        msgs =
            ((InternalEObject) serviceParameters)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs20Package.COVERAGE_DESCRIPTION_TYPE__SERVICE_PARAMETERS,
      ...
      if (newServiceParameters != null)
        msgs =
            ((InternalEObject) newServiceParameters)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs20Package.COVERAGE_DESCRIPTION_TYPE__SERVICE_PARAMETERS,
