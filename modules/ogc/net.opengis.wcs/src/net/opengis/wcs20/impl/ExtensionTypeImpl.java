 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ExtensionTypeImpl#getContents <em>Contents</em>}
 * </ul>
 *
 * @generated
 */
public class ExtensionTypeImpl extends EObjectImpl implements ExtensionType {
  ...
  public EList<ExtensionItemType> getContents() {
    if (contents == null) {
      contents =
          new EObjectResolvingEList<ExtensionItemType>(
              ExtensionItemType.class, this, Wcs20Package.EXTENSION_TYPE__CONTENTS);
    }
    return contents;
  }
