 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.DimensionTrimTypeImpl#getTrimLow <em>Trim Low</em>}
 *   <li>{@link net.opengis.wcs20.impl.DimensionTrimTypeImpl#getTrimHigh <em>Trim High</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DIMENSION_TRIM_TYPE__TRIM_LOW,
              oldTrimLow,
              trimLow));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.DIMENSION_TRIM_TYPE__TRIM_HIGH,
              oldTrimHigh,
              trimHigh));
  }
