 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.CoverageOfferingsTypeImpl#getServiceMetadata <em>Service
 *       Metadata</em>}
 *   <li>{@link net.opengis.wcs20.impl.CoverageOfferingsTypeImpl#getOfferedCoverage <em>Offered
 *       Coverage</em>}
 * </ul>
 *
 * @generated
...
public class CoverageOfferingsTypeImpl extends EObjectImpl implements CoverageOfferingsType {
  /**
   * The cached value of the '{@link #getServiceMetadata() <em>Service Metadata</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getOfferedCoverage() <em>Offered Coverage</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.COVERAGE_OFFERINGS_TYPE__SERVICE_METADATA,
              oldServiceMetadata,
              newServiceMetadata);
  ...
  public void setServiceMetadata(ServiceMetadataType newServiceMetadata) {
    if (newServiceMetadata != serviceMetadata) {
      ...
      if (serviceMetadata != null)
        msgs =
            ((InternalEObject) serviceMetadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.COVERAGE_OFFERINGS_TYPE__SERVICE_METADATA,
                    null,
                    msgs);
      if (newServiceMetadata != null)
        msgs =
            ((InternalEObject) newServiceMetadata)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.COVERAGE_OFFERINGS_TYPE__SERVICE_METADATA,
                    null,
  ...
  public EList<OfferedCoverageType> getOfferedCoverage() {
    if (offeredCoverage == null) {
      offeredCoverage =
          new EObjectContainmentEList<OfferedCoverageType>(
              OfferedCoverageType.class,
              this,
              Wcs20Package.COVERAGE_OFFERINGS_TYPE__OFFERED_COVERAGE);
    }
