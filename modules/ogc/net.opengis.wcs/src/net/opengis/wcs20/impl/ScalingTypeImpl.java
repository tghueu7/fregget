 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ScalingTypeImpl#getScaleByFactor <em>Scale By Factor</em>}
 *   <li>{@link net.opengis.wcs20.impl.ScalingTypeImpl#getScaleAxesByFactor <em>Scale Axes By
 *       Factor</em>}
 *   <li>{@link net.opengis.wcs20.impl.ScalingTypeImpl#getScaleToSize <em>Scale To Size</em>}
 *   <li>{@link net.opengis.wcs20.impl.ScalingTypeImpl#getScaleToExtent <em>Scale To Extent</em>}
 * </ul>
 *
 * @generated
 */
public class ScalingTypeImpl extends EObjectImpl implements ScalingType {
  ...
  /**
   * The cached value of the '{@link #getScaleAxesByFactor() <em>Scale Axes By Factor</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  Wcs20Package.SCALING_TYPE__SCALE_BY_FACTOR,
                  oldScaleByFactor,
                  scaleByFactor));
      }
    }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  Wcs20Package.SCALING_TYPE__SCALE_AXES_BY_FACTOR,
                  oldScaleAxesByFactor,
                  scaleAxesByFactor));
      }
    }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  Wcs20Package.SCALING_TYPE__SCALE_TO_SIZE,
                  oldScaleToSize,
                  scaleToSize));
      }
    }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  Wcs20Package.SCALING_TYPE__SCALE_TO_EXTENT,
                  oldScaleToExtent,
                  scaleToExtent));
      }
    }
