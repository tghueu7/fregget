 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ServiceParametersTypeImpl#getCoverageSubtype <em>Coverage
 *       Subtype</em>}
 *   <li>{@link net.opengis.wcs20.impl.ServiceParametersTypeImpl#getCoverageSubtypeParent
 *       <em>Coverage Subtype Parent</em>}
 *   <li>{@link net.opengis.wcs20.impl.ServiceParametersTypeImpl#getNativeFormat <em>Native
 *       Format</em>}
 *   <li>{@link net.opengis.wcs20.impl.ServiceParametersTypeImpl#getExtension <em>Extension</em>}
 * </ul>
 *
 * @generated
 */
public class ServiceParametersTypeImpl extends EObjectImpl implements ServiceParametersType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_PARAMETERS_TYPE__COVERAGE_SUBTYPE,
              oldCoverageSubtype,
              coverageSubtype));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_PARAMETERS_TYPE__COVERAGE_SUBTYPE_PARENT,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_PARAMETERS_TYPE__NATIVE_FORMAT,
              oldNativeFormat,
              nativeFormat));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.SERVICE_PARAMETERS_TYPE__EXTENSION,
              oldExtension,
              newExtension);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setExtension(ExtensionType newExtension) {
    if (newExtension != extension) {
      ...
      if (extension != null)
        msgs =
            ((InternalEObject) extension)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.SERVICE_PARAMETERS_TYPE__EXTENSION,
                    null,
                    msgs);
      if (newExtension != null)
        msgs =
            ((InternalEObject) newExtension)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.SERVICE_PARAMETERS_TYPE__EXTENSION,
                    null,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs20Package.SERVICE_PARAMETERS_TYPE__NATIVE_FORMAT:
        return NATIVE_FORMAT_EDEFAULT == null
            ? nativeFormat != null
            : !NATIVE_FORMAT_EDEFAULT.equals(nativeFormat);
      case Wcs20Package.SERVICE_PARAMETERS_TYPE__EXTENSION:
