 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ContentsTypeImpl#getCoverageSummary <em>Coverage
 *       Summary</em>}
 *   <li>{@link net.opengis.wcs20.impl.ContentsTypeImpl#getExtension <em>Extension</em>}
 * </ul>
 *
 * @generated
 */
public class ContentsTypeImpl extends ContentsBaseTypeImpl implements ContentsType {
  ...
  public EList<CoverageSummaryType> getCoverageSummary() {
    if (coverageSummary == null) {
      coverageSummary =
          new EObjectContainmentEList<CoverageSummaryType>(
              CoverageSummaryType.class, this, Wcs20Package.CONTENTS_TYPE__COVERAGE_SUMMARY);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.CONTENTS_TYPE__EXTENSION,
              oldExtension,
              newExtension);
      ...
      if (extension != null)
        msgs =
            ((InternalEObject) extension)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs20Package.CONTENTS_TYPE__EXTENSION,
                    null,
                    msgs);
