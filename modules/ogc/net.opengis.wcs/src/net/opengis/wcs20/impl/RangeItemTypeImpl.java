 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.RangeItemTypeImpl#getRangeComponent <em>Range Component</em>}
 *   <li>{@link net.opengis.wcs20.impl.RangeItemTypeImpl#getRangeInterval <em>Range Interval</em>}
 * </ul>
 *
 * @generated
 */
public class RangeItemTypeImpl extends EObjectImpl implements RangeItemType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs20Package.RANGE_ITEM_TYPE__RANGE_COMPONENT,
              oldRangeComponent,
              rangeComponent));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  Wcs20Package.RANGE_ITEM_TYPE__RANGE_INTERVAL,
                  oldRangeInterval,
                  rangeInterval));
      }
    }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs20Package.RANGE_ITEM_TYPE__RANGE_COMPONENT:
        return RANGE_COMPONENT_EDEFAULT == null
            ? rangeComponent != null
            : !RANGE_COMPONENT_EDEFAULT.equals(rangeComponent);
      case Wcs20Package.RANGE_ITEM_TYPE__RANGE_INTERVAL:
