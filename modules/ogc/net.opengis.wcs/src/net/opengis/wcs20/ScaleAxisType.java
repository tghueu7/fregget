...
public interface ScaleAxisType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScaleAxisType#getAxis <em>Axis</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScaleAxisType#getScaleFactor <em>Scale
   * Factor</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
