...
public interface ScalingType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScalingType#getScaleByFactor <em>Scale By
   * Factor</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScalingType#getScaleAxesByFactor <em>Scale Axes
   * By Factor</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScalingType#getScaleToSize <em>Scale To
   * Size</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ScalingType#getScaleToExtent <em>Scale To
   * Extent</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
