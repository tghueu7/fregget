 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.OfferedCoverageType#getAbstractCoverage <em>Abstract
 *       Coverage</em>}
 *   <li>{@link net.opengis.wcs20.OfferedCoverageType#getServiceParameters <em>Service
 *       Parameters</em>}
 * </ul>
 *
...
public interface OfferedCoverageType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Like its role model gml:AbstractCoverageType in GML 3.2.1, this element serves as the head of a
   * substitution group which may contain any coverage whose type is derived, however, from
   * gmlcov:AbstractCoverageType (rather than gml:AbstractCoverageType). It may act as a variable in
   * the definition of content models where it is required to permit any coverage to be valid.
   * <!-- end-model-doc -->
   *
   ...
   * @model type="java.lang.Object" containment="true" required="true" transient="true"
   *     changeable="false" volatile="true" derived="true" extendedMetaData="kind='element'
   *     name='AbstractCoverage' namespace='http://www.opengis.net/gmlcov/1.0'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.OfferedCoverageType#getServiceParameters
