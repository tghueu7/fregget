 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.CoverageDescriptionsType#getCoverageDescription <em>Coverage
 *       Description</em>}
 * </ul>
 *
...
public interface CoverageDescriptionsType extends EObject {
  /**
   * Returns the value of the '<em><b>Coverage Description</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wcs20.CoverageDescriptionType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='CoverageDescription'
