...
public interface InterpolationAxisType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.InterpolationAxisType#getAxis <em>Axis</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.InterpolationAxisType#getInterpolationMethod
