...
public interface TargetAxisSizeType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.TargetAxisSizeType#getAxis <em>Axis</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.TargetAxisSizeType#getTargetSize <em>Target
   * Size</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
