...
public interface RangeItemType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.RangeItemType#getRangeComponent <em>Range
   * Component</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.RangeItemType#getRangeInterval <em>Range
   * Interval</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
