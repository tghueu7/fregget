 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.CapabilitiesType#getServiceMetadata <em>Service Metadata</em>}
 *   <li>{@link net.opengis.wcs20.CapabilitiesType#getContents <em>Contents</em>}
 * </ul>
 *
...
public interface CapabilitiesType extends CapabilitiesBaseType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Despite its name this element should not be confuse with the OWSServiceMetadata defined in OWS
   * Common.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ServiceMetadata'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.CapabilitiesType#getServiceMetadata <em>Service
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.CapabilitiesType#getContents
