 ...
 * it has been created to carry around name and namespace of the various values since various of
 * them are literals
 *
...
public interface ExtensionItemType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ExtensionItemType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ExtensionItemType#getNamespace
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ExtensionItemType#getSimpleContent <em>Simple
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.ExtensionItemType#getObjectContent <em>Object
   * Content</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
