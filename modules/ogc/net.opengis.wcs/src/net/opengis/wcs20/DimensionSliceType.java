 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.DimensionSliceType#getSlicePoint <em>Slice Point</em>}
 * </ul>
 *
...
public interface DimensionSliceType extends DimensionSubsetType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Slice Point</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DimensionSliceType#getSlicePoint <em>Slice
   * Point</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
