 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.DimensionSubsetType#getDimension <em>Dimension</em>}
 *   <li>{@link net.opengis.wcs20.DimensionSubsetType#getCRS <em>CRS</em>}
 * </ul>
 *
 * @see net.opengis.wcs20.Wcs20Package#getDimensionSubsetType()
 * @model abstract="true" extendedMetaData="name='DimensionSubsetType' kind='elementOnly'"
 * @generated
 */
public interface DimensionSubsetType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DimensionSubsetType#getDimension
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DimensionSubsetType#getCRS <em>CRS</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
