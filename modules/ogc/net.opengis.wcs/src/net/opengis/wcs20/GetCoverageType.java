 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getCoverageId <em>Coverage Id</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getDimensionSubsetGroup <em>Dimension Subset
 *       Group</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getDimensionSubset <em>Dimension Subset</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getMediaType <em>Media Type</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getFilter <em>Filter</em>}
 *   <li>{@link net.opengis.wcs20.GetCoverageType#getSortBy <em>Sort By</em>}
 * </ul>
 *
...
public interface GetCoverageType extends RequestBaseType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.GetCoverageType#getCoverageId <em>Coverage
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Dimension Subset Group</b></em>' attribute list. The list
  ...
  /**
   * Returns the value of the '<em><b>Dimension Subset</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wcs20.DimensionSubsetType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Definition of the desired subset of the domain of the coverage. This is either a Trim
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * MimeType of the format the resulting coverage shall be encoded in. Dafault is the coverage's
   * native format. Type is anyURI because of the type of the element "mimeType" in "gml:FileType".
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.GetCoverageType#getFormat <em>Format</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Optional element indicating the MimeType of the response of a GetCoverage request. Only
   * currently allowed valued is "multipart/related".
   * <!-- end-model-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI" extendedMetaData="kind='element'
   *     name='mediaType' namespace='##targetNamespace'"
   * @generated
   */
  String getMediaType();

  /**
   * Sets the value of the '{@link net.opengis.wcs20.GetCoverageType#getMediaType <em>Media
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.GetCoverageType#getFilter <em>Filter</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
