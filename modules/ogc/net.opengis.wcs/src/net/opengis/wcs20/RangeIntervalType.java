...
public interface RangeIntervalType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.RangeIntervalType#getStartComponent <em>Start
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.RangeIntervalType#getEndComponent <em>End
   * Component</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
