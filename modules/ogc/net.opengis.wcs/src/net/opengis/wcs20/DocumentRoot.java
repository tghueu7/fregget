 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCapabilities <em>Capabilities</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getContents <em>Contents</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageDescription <em>Coverage Description</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageDescriptions <em>Coverage
 *       Descriptions</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageId <em>Coverage Id</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageOfferings <em>Coverage Offerings</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageSubtype <em>Coverage Subtype</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageSubtypeParent <em>Coverage Subtype
 *       Parent</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getCoverageSummary <em>Coverage Summary</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getDescribeCoverage <em>Describe Coverage</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getDimensionSlice <em>Dimension Slice</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getDimensionSubset <em>Dimension Subset</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getDimensionTrim <em>Dimension Trim</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getExtension <em>Extension</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getGetCoverage <em>Get Coverage</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getOfferedCoverage <em>Offered Coverage</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getServiceMetadata <em>Service Metadata</em>}
 *   <li>{@link net.opengis.wcs20.DocumentRoot#getServiceParameters <em>Service Parameters</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCapabilities
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This element redefines the OWS Common [OGC 06-121r9] Contents section with a CoverageSummary,
   * in accordance with the rules for modification laid down there. In addition it allows WCS
   * extensions or application profiles to extend its content.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getContents <em>Contents</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Description of a coverage available from a WCS server. This description shall include
   * sufficient information to allow all valid GetCoverage operation requests to be prepared by a
   * WCS client.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageDescription
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageDescriptions
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This element represents coverage identifiers. It uses the same type as gml:id to allow for
   * identifier values to be used in both contexts.
   * <!-- end-model-doc -->
   *
   ...
   *     name='CoverageId' namespace='##targetNamespace'"
   * @generated
   */
  String getCoverageId();

  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageId <em>Coverage
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * CoverageOfferings is the virtual document that a WCS offers. It consists of service metadata
   * and a set of offered coverages. The CoverageOfferings element is never delivered to the client,
   * however, responses of WCS requests are composed of constituents of the CoverageOfferings tree.
   * Hence, CoverageOfferings serves to define responses.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageOfferings <em>Coverage
   * Offerings</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * CoverageSubtype characterizes the type of a coverage. This element shall contain the name of
   * the XML root element that would be delivered if a GML encoded result were requested from the
   * GetCoverage operation. The content model of the named element shall be described by a schema
   * that is either normatively referenced by the WCS core specification or by a requirement in a
   * WCS extension, the associated conformance class for which has been included in the ows:Profiles
   * of the server's GetCapabilities response. This CoverageSubtype is delivered in GetCapabilities
   * and DescribeCoverage to allow clients an estimation of the amount of data to be expected in the
   * domain and range set. For example, a GridCoverage has a small domain set structure, but
   * typically a large range set; a MultiSolidCoverage, on the other hand, tends to have large
   * domain sets and small range sets.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageSubtype <em>Coverage
   * Subtype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='CoverageSubtypeParent'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageSubtypeParent
   * <em>Coverage Subtype Parent</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A CoverageSummary contains information essential for accessing a coverage served by a WCS. The
   * CoverageId is the identifier used to address a particular coverage. The CoverageSubtype is the
   * name of the root of this coverage when expressed in XML.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getCoverageSummary <em>Coverage
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getDescribeCoverage <em>Describe
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='DimensionSlice' namespace='##targetNamespace'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getDimensionSlice <em>Dimension
   * Slice</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Definition of the desired subset of the domain of the coverage. This is either a Trim
   * operation, or a Slice operation.
   * <!-- end-model-doc -->
   *
   ...
   *     derived="true" extendedMetaData="kind='element' name='DimensionSubset'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='DimensionTrim' namespace='##targetNamespace'
   *     affiliation='DimensionSubset'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getDimensionTrim <em>Dimension
   * Trim</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Extension element used to hook in additional content e.g. in extensions or application
   * profiles.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getExtension <em>Extension</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getGetCapabilities <em>Get
   ...
   * retrieve a subset of one coverage.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getGetCoverage <em>Get
   * Coverage</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * An OfferedCoverage is the information set about a specific coverage offered by the WCS service
   * on hand. It consists of a coverage, as defined in the GML Application Schema for Coverages [OGC
   * 09-146r2] and coverage specific service parameters. Like CoverageOfferings, an OfferedCoverage
   * element is never delivered to the client, but defines the response of coverage access requests.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getOfferedCoverage <em>Offered
   * Coverage</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * ServiceMetadata contains information describing the WCS service on hand. Extension elements
   * allow WCS extension standards to define their individual extra service metadata.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getServiceMetadata <em>Service
   ...
   * helps identifying the type of coverage on hand, in particular with respect to the potential
   * size of its domainSet and rangeSet components. Extension elements allow WCS extensions to plug
   * in their particular coverage-specific service information.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DocumentRoot#getServiceParameters <em>Service
