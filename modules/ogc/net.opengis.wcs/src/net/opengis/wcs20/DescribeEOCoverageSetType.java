 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the model object ' <em><b>Describe EO Coverage Set</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs20.DescribeEOCoverageSetType#getEoId <em>Eo Id</em>}
 *   <li>{@link net.opengis.wcs20.DescribeEOCoverageSetType#getContainmentType <em>Containment
 *       Type</em>}
 *   <li>{@link net.opengis.wcs20.DescribeEOCoverageSetType#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.wcs20.DescribeEOCoverageSetType#getDimensionTrim <em>Dimension
 *       Trim</em>}
 *   <li>{@link net.opengis.wcs20.DescribeEOCoverageSetType#getCount <em>Count</em>}
 * </ul>
 *
...
public interface DescribeEOCoverageSetType extends RequestBaseType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of identifiers of desired coverages. A client can obtain identifiers by a prior
   ...
   * @model unique="false" required="true" extendedMetaData="kind='element' name='CoverageId'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DescribeEOCoverageSetType#getContainmentType
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DescribeEOCoverageSetType#getSections
  ...
  /**
   * @model unique="false" required="true" extendedMetaData="kind='element' name='DimensionTime'
   *     namespace='##targetNamespace'"
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs20.DescribeEOCoverageSetType#getCount
