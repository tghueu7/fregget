 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Section</b></em>', and utility
...
public enum Section implements Enumerator {
  ...
  private static final Section[] VALUES_ARRAY =
      new Section[] {
        COVERAGEDESCRIPTIONS, DATASETSERIESDESCRIPTIONS, ALL,
      };
  ...
  public static Section get(int value) {
    switch (value) {
      case COVERAGEDESCRIPTIONS_VALUE:
        return COVERAGEDESCRIPTIONS;
      case DATASETSERIESDESCRIPTIONS_VALUE:
