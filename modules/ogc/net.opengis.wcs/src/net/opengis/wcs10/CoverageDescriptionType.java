 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.CoverageDescriptionType#getCoverageOffering <em>Coverage
 *       Offering</em>}
 *   <li>{@link net.opengis.wcs10.CoverageDescriptionType#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.wcs10.CoverageDescriptionType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface CoverageDescriptionType extends EObject {
  /**
   * Returns the value of the '<em><b>Coverage Offering</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wcs10.CoverageOfferingType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Coverage Offering</em>' containment reference list isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageDescriptionType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageDescriptionType#getVersion
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wcs10.CoverageDescriptionType#getVersion
   * <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wcs10.CoverageDescriptionType#getVersion
