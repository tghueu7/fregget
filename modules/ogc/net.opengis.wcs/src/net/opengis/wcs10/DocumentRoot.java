 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getAxisDescription <em>Axis Description</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getAxisDescription1 <em>Axis Description1</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getCapability <em>Capability</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getContentMetadata <em>Content Metadata</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getCoverageDescription <em>Coverage Description</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getCoverageOffering <em>Coverage Offering</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getCoverageOfferingBrief <em>Coverage Offering
 *       Brief</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getDescribeCoverage <em>Describe Coverage</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getFormats <em>Formats</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getGetCoverage <em>Get Coverage</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getInterpolationMethod <em>Interpolation Method</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getInterval <em>Interval</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getLonLatEnvelope <em>Lon Lat Envelope</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getMetadataLink <em>Metadata Link</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getName <em>Name</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getRangeSet1 <em>Range Set1</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSingleValue <em>Single Value</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSpatialDomain <em>Spatial Domain</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSpatialSubset <em>Spatial Subset</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSupportedCRSs <em>Supported CR Ss</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSupportedFormats <em>Supported Formats</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSupportedInterpolations <em>Supported
 *       Interpolations</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getTemporalDomain <em>Temporal Domain</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getTemporalSubset <em>Temporal Subset</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getTimePeriod <em>Time Period</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getTimeSequence <em>Time Sequence</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getWCSCapabilities <em>WCS Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getClosure <em>Closure</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getSemantic <em>Semantic</em>}
 *   <li>{@link net.opengis.wcs10.DocumentRoot#getType <em>Type</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getAxisDescription <em>Axis
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Axis Description1</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getAxisDescription1 <em>Axis
   * Description1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Capability</em>' containment reference isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getCapability
   * <em>Capability</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of brief descriptions of all coverages avaialble from this WCS, or a reference
   * to another service from which this information is available.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getContentMetadata <em>Content
   * Metadata</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Reply from a WCS that performed the DescribeCoverage operation, containing one or more full
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getCoverageDescription
   * <em>Coverage Description</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Coverage Offering</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getCoverageOffering <em>Coverage
   * Offering</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Coverage Offering Brief</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getCoverageOfferingBrief
   * <em>Coverage Offering Brief</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS to perform the DescribeCoverage operation. In this XML encoding, no "request"
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getDescribeCoverage <em>Describe
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Contains a simple text description of the object. For WCS use, removed optional
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getDescription
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getDomainSet <em>Domain Set</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifiers of one or more formats in which coverage content can be retrieved. The codeSpace
   * optional attribute can reference the semantic of the format identifiers.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getFormats <em>Formats</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS to perform the GetCapabilities operation. In this XML encoding, no "request"
   * parameter is included, since the element name specifies the specific operation.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getGetCapabilities <em>Get
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS to perform the GetCoverage operation. In this XML encoding, no "request"
   * parameter is included, since the element name specifies the specific operation.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getGetCoverage <em>Get
   * Coverage</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Interpolation Method</b></em>' attribute. The default value is
   * <code>"nearest neighbor"</code>. The literals are from the enumeration {@link
   * net.opengis.wcs10.InterpolationMethodType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Interpolation Method</em>' attribute isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model default="nearest neighbor" unique="false" upper="-2" transient="true" volatile="true"
   *     derived="true" extendedMetaData="kind='element' name='interpolationMethod'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getInterpolationMethod
   * <em>Interpolation Method</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Interval</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getInterval <em>Interval</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of one or more commonly used or formalised word(s) or phrase(s) used to describe
   * the subject. When needed, the optional "type" can name the type of the associated list of
   * keywords that shall all have the same type. Also when needed, the codeSpace attribute of that
   * "type" can also reference the type name authority and/or thesaurus. (Largely based on
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getKeywords <em>Keywords</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Lon Lat Envelope</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getLonLatEnvelope <em>Lon Lat
   * Envelope</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Metadata Link</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getMetadataLink <em>Metadata
   * Link</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifier for the object, normally a descriptive name. For WCS use, removed optional CodeSpace
   * attribute from gml:name.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getRangeSet <em>Range Set</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Range Set1</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getRangeSet1 <em>Range Set1</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Service</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getService <em>Service</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSingleValue <em>Single
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial Domain</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSpatialDomain <em>Spatial
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial Subset</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSpatialSubset <em>Spatial
   * Subset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Supported CR Ss</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSupportedCRSs <em>Supported CR
   * Ss</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Supported Formats</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSupportedFormats <em>Supported
   * Formats</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Supported Interpolations</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='supportedInterpolations'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSupportedInterpolations
   * <em>Supported Interpolations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Defines the temporal domain of a coverage offering, that is, the times for which valid data are
   * available. The times shall to be ordered from the oldest to the newest.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getTemporalDomain <em>Temporal
   * Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Subset</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getTemporalSubset <em>Temporal
   * Subset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getTimePeriod <em>Time
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Time Sequence</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getTimeSequence <em>Time
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>WCS Capabilities</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getWCSCapabilities <em>WCS
   * Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Closure</b></em>' attribute. The default value is <code>
   * "closed"</code>. The literals are from the enumeration {@link net.opengis.wcs10.ClosureType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model default="closed" unsettable="true" extendedMetaData="kind='attribute' name='closure'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getClosure <em>Closure</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wcs10.DocumentRoot#getClosure <em>Closure</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wcs10.DocumentRoot#getClosure
   * <em>Closure</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Definition of the semantics or meaning of the values in the XML element it belongs to. The
   * value of this "semantic" attribute can be a RDF Property or Class of a taxonomy or ontology.
   * <!-- end-model-doc -->
   *
   ...
   *     name='semantic' namespace='##targetNamespace'"
   * @generated
   */
  String getSemantic();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.DocumentRoot#getSemantic <em>Semantic</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Datatype of a typed literal value. This URI typically references XSD simple types. It has the
   * same semantic as rdf:datatype.
   * <!-- end-model-doc -->
   *
