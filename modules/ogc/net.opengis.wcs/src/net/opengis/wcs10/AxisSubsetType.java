 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.AxisSubsetType#getName <em>Name</em>}
 * </ul>
 *
...
public interface AxisSubsetType extends ValueEnumBaseType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Name or identifier of one axis in this coverage. This name shall match that of an
   * AxisDescription element in the DescribeCoverage XML response.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AxisSubsetType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
