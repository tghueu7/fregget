 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Metadata Type Type</b></em>', and
...
public final class MetadataTypeType extends AbstractEnumerator {
  ...
  public static final MetadataTypeType TC211_LITERAL =
      new MetadataTypeType(TC211, "TC211", "TC211");
  ...
  public static final MetadataTypeType OTHER_LITERAL =
      new MetadataTypeType(OTHER, "other", "other");
  ...
  private static final MetadataTypeType[] VALUES_ARRAY =
      new MetadataTypeType[] {
        TC211_LITERAL, FGDC_LITERAL, OTHER_LITERAL,
      };
