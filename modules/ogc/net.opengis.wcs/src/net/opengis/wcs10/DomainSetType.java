 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Defines the spatial-temporal domain set of a coverage offering. The domainSet shall include a
 * SpatialDomain (describing the spatial locations for which coverages can be requested), a
 * TemporalDomain (describing the time instants or inter-vals for which coverages can be requested),
 * or both.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.DomainSetType#getSpatialDomain <em>Spatial Domain</em>}
 *   <li>{@link net.opengis.wcs10.DomainSetType#getTemporalDomain <em>Temporal Domain</em>}
 *   <li>{@link net.opengis.wcs10.DomainSetType#getTemporalDomain1 <em>Temporal Domain1</em>}
 * </ul>
 *
...
public interface DomainSetType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='spatialDomain'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSetType#getSpatialDomain <em>Spatial
   ...
   * @model containment="true" extendedMetaData="kind='element' name='temporalDomain'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSetType#getTemporalDomain <em>Temporal
   * Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSetType#getTemporalDomain1 <em>Temporal
   * Domain1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
