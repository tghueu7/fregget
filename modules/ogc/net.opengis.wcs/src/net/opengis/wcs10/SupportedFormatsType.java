 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.SupportedFormatsType#getFormats <em>Formats</em>}
 *   <li>{@link net.opengis.wcs10.SupportedFormatsType#getNativeFormat <em>Native Format</em>}
 * </ul>
 *
...
public interface SupportedFormatsType extends EObject {
  /**
   * Returns the value of the '<em><b>Formats</b></em>' containment reference list. The list
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.SupportedFormatsType#getNativeFormat <em>Native
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
