 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Closure Type</b></em>', and utility
...
public final class ClosureType extends AbstractEnumerator {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The specified minimum value is NOT included in this range, and the specified maximum value IS
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The specified minimum value IS included in this range, and the specified maximum value is NOT
   * included in this range.
   * <!-- end-model-doc -->
   *
   ...
   * @ordered
   */
  public static final ClosureType OPEN_CLOSED_LITERAL =
      new ClosureType(OPEN_CLOSED, "openClosed", "open-closed");
   ...
   * @ordered
   */
  public static final ClosureType CLOSED_OPEN_LITERAL =
      new ClosureType(CLOSED_OPEN, "closedOpen", "closed-open");
  ...
  private static final ClosureType[] VALUES_ARRAY =
      new ClosureType[] {
        CLOSED_LITERAL, OPEN_LITERAL, OPEN_CLOSED_LITERAL, CLOSED_OPEN_LITERAL,
      };
