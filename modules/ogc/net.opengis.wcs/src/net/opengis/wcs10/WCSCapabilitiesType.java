 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Metadata for a WCS server, also known as Capabilities document. Reply from a WCS that performed
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.WCSCapabilitiesType#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.WCSCapabilitiesType#getCapability <em>Capability</em>}
 *   <li>{@link net.opengis.wcs10.WCSCapabilitiesType#getContentMetadata <em>Content Metadata</em>}
 *   <li>{@link net.opengis.wcs10.WCSCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.wcs10.WCSCapabilitiesType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface WCSCapabilitiesType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Service'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getService
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Capability'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getCapability
   ...
   *     name='ContentMetadata' namespace='##targetNamespace'"
   * @generated
   */
  ContentMetadataType getContentMetadata();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getContentMetadata
   * <em>Content Metadata</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getVersion
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getVersion
   * <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wcs10.WCSCapabilitiesType#getVersion
