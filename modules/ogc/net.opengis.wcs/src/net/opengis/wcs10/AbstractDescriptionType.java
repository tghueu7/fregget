 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.AbstractDescriptionType#getMetadataLink <em>Metadata Link</em>}
 *   <li>{@link net.opengis.wcs10.AbstractDescriptionType#getDescription1 <em>Description1</em>}
 *   <li>{@link net.opengis.wcs10.AbstractDescriptionType#getName1 <em>Name1</em>}
 *   <li>{@link net.opengis.wcs10.AbstractDescriptionType#getLabel <em>Label</em>}
 * </ul>
 *
 * @see net.opengis.wcs10.Wcs10Package#getAbstractDescriptionType()
 * @model abstract="true" extendedMetaData="name='AbstractDescriptionType' kind='elementOnly'"
 * @generated
 */
public interface AbstractDescriptionType extends AbstractDescriptionBaseType {
  /**
   * Returns the value of the '<em><b>Metadata Link</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wcs10.MetadataLinkType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Metadata Link</em>' containment reference list isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AbstractDescriptionType#getDescription1
   * <em>Description1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AbstractDescriptionType#getName1
   * <em>Name1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AbstractDescriptionType#getLabel
