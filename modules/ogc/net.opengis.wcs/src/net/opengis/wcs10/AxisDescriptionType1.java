 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.AxisDescriptionType1#getAxisDescription <em>Axis Description</em>}
 * </ul>
 *
...
public interface AxisDescriptionType1 extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Axis Description</em>' containment reference isn't clear, there
   ...
   *     name='AxisDescription' namespace='##targetNamespace'"
   * @generated
   */
  AxisDescriptionType getAxisDescription();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.AxisDescriptionType1#getAxisDescription
   * <em>Axis Description</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
