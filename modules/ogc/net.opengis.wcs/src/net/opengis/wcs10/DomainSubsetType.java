 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Defines the desired subset of the domain set of the coverage. Is a GML property containing either
 * or both spatialSubset and temporalSubset GML objects.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.DomainSubsetType#getSpatialSubset <em>Spatial Subset</em>}
 *   <li>{@link net.opengis.wcs10.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}
 *   <li>{@link net.opengis.wcs10.DomainSubsetType#getTemporalSubset1 <em>Temporal Subset1</em>}
 * </ul>
 *
...
public interface DomainSubsetType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='spatialSubset'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSubsetType#getSpatialSubset <em>Spatial
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSubsetType#getTemporalSubset <em>Temporal
   * Subset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Subset1</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DomainSubsetType#getTemporalSubset1
   * <em>Temporal Subset1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
