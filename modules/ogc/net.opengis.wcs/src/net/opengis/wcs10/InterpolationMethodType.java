 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Codes that identify interpolation methods. The meanings of these codes are defined in Annex B of
...
public final class InterpolationMethodType extends AbstractEnumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Nearest Neighbor</b></em>' literal object isn't clear, there
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Bilinear</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Bicubic</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #BICUBIC_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Lost Area</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Barycentric</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  public static final InterpolationMethodType NEAREST_NEIGHBOR_LITERAL =
      new InterpolationMethodType(NEAREST_NEIGHBOR, "nearestNeighbor", "nearest neighbor");
  ...
  public static final InterpolationMethodType BILINEAR_LITERAL =
      new InterpolationMethodType(BILINEAR, "bilinear", "bilinear");
  ...
  public static final InterpolationMethodType BICUBIC_LITERAL =
      new InterpolationMethodType(BICUBIC, "bicubic", "bicubic");
  ...
  public static final InterpolationMethodType LOST_AREA_LITERAL =
      new InterpolationMethodType(LOST_AREA, "lostArea", "lost area");
  ...
  public static final InterpolationMethodType BARYCENTRIC_LITERAL =
      new InterpolationMethodType(BARYCENTRIC, "barycentric", "barycentric");
  ...
  public static final InterpolationMethodType NONE_LITERAL =
      new InterpolationMethodType(NONE, "none", "none");
  ...
  /**
   * Returns the '<em><b>Interpolation Method Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Interpolation Method Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
