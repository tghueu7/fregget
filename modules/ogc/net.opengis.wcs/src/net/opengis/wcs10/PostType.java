 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.PostType#getOnlineResource <em>Online Resource</em>}
 * </ul>
 *
...
public interface PostType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Online Resource</em>' containment reference isn't clear, there
   ...
   *     name='OnlineResource' namespace='##targetNamespace'"
   * @generated
   */
  OnlineResourceType getOnlineResource();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.PostType#getOnlineResource <em>Online
