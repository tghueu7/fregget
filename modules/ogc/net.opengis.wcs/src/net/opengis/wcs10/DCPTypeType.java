 ...
 * and/or one Post is included in this element. More than one Get and/or Post is allowed to support
 * including alternative URLs for uses such as load balancing or backup.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.DCPTypeType#getHTTP <em>HTTP</em>}
 * </ul>
 *
...
public interface DCPTypeType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>HTTP</em>' containment reference isn't clear, there really should
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='HTTP'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.DCPTypeType#getHTTP <em>HTTP</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
