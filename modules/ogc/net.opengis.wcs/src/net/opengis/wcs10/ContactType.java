 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.ContactType#getPhone <em>Phone</em>}
 *   <li>{@link net.opengis.wcs10.ContactType#getAddress <em>Address</em>}
 *   <li>{@link net.opengis.wcs10.ContactType#getOnlineResource <em>Online Resource</em>}
 * </ul>
 *
...
public interface ContactType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ContactType#getPhone <em>Phone</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ContactType#getAddress <em>Address</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ContactType#getOnlineResource <em>Online
