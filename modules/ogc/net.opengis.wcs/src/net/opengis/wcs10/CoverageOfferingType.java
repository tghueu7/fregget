 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.CoverageOfferingType#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.wcs10.CoverageOfferingType#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.wcs10.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}
 *   <li>{@link net.opengis.wcs10.CoverageOfferingType#getSupportedFormats <em>Supported
 *       Formats</em>}
 *   <li>{@link net.opengis.wcs10.CoverageOfferingType#getSupportedInterpolations <em>Supported
 *       Interpolations</em>}
 * </ul>
 *
...
public interface CoverageOfferingType extends CoverageOfferingBriefType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='domainSet'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingType#getDomainSet <em>Domain
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='rangeSet'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingType#getRangeSet <em>Range
   * Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='supportedCRSs'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingType#getSupportedCRSs
   * <em>Supported CR Ss</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   *     name='supportedFormats' namespace='##targetNamespace'"
   * @generated
   */
  SupportedFormatsType getSupportedFormats();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingType#getSupportedFormats
   * <em>Supported Formats</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Specifies whether and how the server can interpolate coverage values over the spatial domain,
   * when a GetCoverage request requires resampling, reprojection, or other generalization. If
   * supportedInterpolations is absent or empty with no default, then clients should assume
   * nearest-neighbor interpolation. If the only interpolation method listed is "none", clients can
   * only retrieve coverages from this layer in its native CRS and at its native resolution.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='supportedInterpolations'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingType#getSupportedInterpolations
