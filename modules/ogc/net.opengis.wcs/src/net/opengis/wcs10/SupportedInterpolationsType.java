 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.SupportedInterpolationsType#getInterpolationMethod
 *       <em>Interpolation Method</em>}
 *   <li>{@link net.opengis.wcs10.SupportedInterpolationsType#getDefault <em>Default</em>}
 * </ul>
 *
...
public interface SupportedInterpolationsType extends EObject {
  /**
   * Returns the value of the '<em><b>Interpolation Method</b></em>' attribute. The literals are
   * from the enumeration {@link net.opengis.wcs10.InterpolationMethodType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Interpolation Method</em>' attribute list isn't clear, there
   ...
   * "nearest neighbor"</code>. The literals are from the enumeration {@link
   ...
   * @model default="nearest neighbor" unsettable="true" extendedMetaData="kind='attribute'
   *     name='default'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.SupportedInterpolationsType#getDefault
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wcs10.SupportedInterpolationsType#getDefault
   * <em>Default</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.SupportedInterpolationsType#getDefault <em>Default</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
