 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.AddressType#getDeliveryPoint <em>Delivery Point</em>}
 *   <li>{@link net.opengis.wcs10.AddressType#getCity <em>City</em>}
 *   <li>{@link net.opengis.wcs10.AddressType#getAdministrativeArea <em>Administrative Area</em>}
 *   <li>{@link net.opengis.wcs10.AddressType#getPostalCode <em>Postal Code</em>}
 *   <li>{@link net.opengis.wcs10.AddressType#getCountry <em>Country</em>}
 *   <li>{@link net.opengis.wcs10.AddressType#getElectronicMailAddress <em>Electronic Mail
 *       Address</em>}
 * </ul>
 *
...
public interface AddressType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AddressType#getDeliveryPoint <em>Delivery
   * Point</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AddressType#getAdministrativeArea
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AddressType#getPostalCode <em>Postal
   * Code</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AddressType#getCountry <em>Country</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.AddressType#getElectronicMailAddress
