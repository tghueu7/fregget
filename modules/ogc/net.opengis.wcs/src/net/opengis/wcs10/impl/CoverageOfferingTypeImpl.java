 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl#getSupportedCRSs <em>Supported CR
 *       Ss</em>}
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl#getSupportedFormats <em>Supported
 *       Formats</em>}
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl#getSupportedInterpolations
 *       <em>Supported Interpolations</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageOfferingTypeImpl extends CoverageOfferingBriefTypeImpl
    implements CoverageOfferingType {
  /**
  ...
  /**
   * The cached value of the '{@link #getSupportedCRSs() <em>Supported CR Ss</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSupportedFormats() <em>Supported Formats</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSupportedInterpolations() <em>Supported
   * Interpolations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET,
              oldDomainSet,
              newDomainSet);
  ...
  public void setDomainSet(DomainSetType newDomainSet) {
    if (newDomainSet != domainSet) {
      ...
      if (domainSet != null)
        msgs =
            ((InternalEObject) domainSet)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET,
                    null,
                    msgs);
      if (newDomainSet != null)
        msgs =
            ((InternalEObject) newDomainSet)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_TYPE__RANGE_SET,
              oldRangeSet,
              newRangeSet);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRangeSet(RangeSetType1 newRangeSet) {
    if (newRangeSet != rangeSet) {
      ...
      if (rangeSet != null)
        msgs =
            ((InternalEObject) rangeSet)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__RANGE_SET,
                    null,
                    msgs);
      if (newRangeSet != null)
        msgs =
            ((InternalEObject) newRangeSet)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__RANGE_SET,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS,
              oldSupportedCRSs,
              newSupportedCRSs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSupportedCRSs(SupportedCRSsType newSupportedCRSs) {
    if (newSupportedCRSs != supportedCRSs) {
      ...
      if (supportedCRSs != null)
        msgs =
            ((InternalEObject) supportedCRSs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS,
                    null,
                    msgs);
      if (newSupportedCRSs != null)
        msgs =
            ((InternalEObject) newSupportedCRSs)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS,
              oldSupportedFormats,
              newSupportedFormats);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSupportedFormats(SupportedFormatsType newSupportedFormats) {
    if (newSupportedFormats != supportedFormats) {
      ...
      if (supportedFormats != null)
        msgs =
            ((InternalEObject) supportedFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS,
                    null,
                    msgs);
      if (newSupportedFormats != null)
        msgs =
            ((InternalEObject) newSupportedFormats)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS,
              oldSupportedInterpolations,
  ...
  public void setSupportedInterpolations(SupportedInterpolationsType newSupportedInterpolations) {
    if (newSupportedInterpolations != supportedInterpolations) {
      ...
      if (supportedInterpolations != null)
        msgs =
            ((InternalEObject) supportedInterpolations)
                .eInverseRemove(
                    this,
      ...
      if (newSupportedInterpolations != null)
        msgs =
            ((InternalEObject) newSupportedInterpolations)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs10Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS,
