 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl#getRequest <em>Request</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl#getException <em>Exception</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl#getVendorSpecificCapabilities
 *       <em>Vendor Specific Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class WCSCapabilityTypeImpl extends EObjectImpl implements WCSCapabilityType {
  ...
  /**
   * The cached value of the '{@link #getVendorSpecificCapabilities() <em>Vendor Specific
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITY_TYPE__REQUEST,
              oldRequest,
              newRequest);
  ...
  public void setRequest(RequestType newRequest) {
    if (newRequest != request) {
      ...
      if (request != null)
        msgs =
            ((InternalEObject) request)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITY_TYPE__REQUEST,
                    null,
                    msgs);
      if (newRequest != null)
        msgs =
            ((InternalEObject) newRequest)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITY_TYPE__REQUEST,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITY_TYPE__EXCEPTION,
              oldException,
              newException);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setException(ExceptionType newException) {
    if (newException != exception) {
      ...
      if (exception != null)
        msgs =
            ((InternalEObject) exception)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITY_TYPE__EXCEPTION,
                    null,
                    msgs);
      if (newException != null)
        msgs =
            ((InternalEObject) newException)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITY_TYPE__EXCEPTION,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetVendorSpecificCapabilities(
      VendorSpecificCapabilitiesType newVendorSpecificCapabilities, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITY_TYPE__VENDOR_SPECIFIC_CAPABILITIES,
              oldVendorSpecificCapabilities,
              newVendorSpecificCapabilities);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setVendorSpecificCapabilities(
    ...
    if (newVendorSpecificCapabilities != vendorSpecificCapabilities) {
      ...
      if (vendorSpecificCapabilities != null)
        msgs =
            ((InternalEObject) vendorSpecificCapabilities)
                .eInverseRemove(
                    this,
      ...
      if (newVendorSpecificCapabilities != null)
        msgs =
            ((InternalEObject) newVendorSpecificCapabilities)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs10Package.WCS_CAPABILITY_TYPE__VENDOR_SPECIFIC_CAPABILITIES,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITY_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITY_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
