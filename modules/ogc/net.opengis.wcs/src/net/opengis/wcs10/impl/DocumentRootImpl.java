 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema
 *       Location</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getAxisDescription <em>Axis
 *       Description</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getAxisDescription1 <em>Axis
 *       Description1</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getCapability <em>Capability</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getContentMetadata <em>Content
 *       Metadata</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getCoverageDescription <em>Coverage
 *       Description</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getCoverageOffering <em>Coverage
 *       Offering</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getCoverageOfferingBrief <em>Coverage
 *       Offering Brief</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getDescribeCoverage <em>Describe
 *       Coverage</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getFormats <em>Formats</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getGetCapabilities <em>Get
 *       Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getGetCoverage <em>Get Coverage</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getInterpolationMethod <em>Interpolation
 *       Method</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getInterval <em>Interval</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getLonLatEnvelope <em>Lon Lat Envelope</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getMetadataLink <em>Metadata Link</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getRangeSet1 <em>Range Set1</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSingleValue <em>Single Value</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSpatialDomain <em>Spatial Domain</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSpatialSubset <em>Spatial Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSupportedCRSs <em>Supported CR Ss</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSupportedFormats <em>Supported
 *       Formats</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSupportedInterpolations <em>Supported
 *       Interpolations</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getTemporalDomain <em>Temporal Domain</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getTemporalSubset <em>Temporal Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getTimePeriod <em>Time Period</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getTimeSequence <em>Time Sequence</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getWCSCapabilities <em>WCS
 *       Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getClosure <em>Closure</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getSemantic <em>Semantic</em>}
 *   <li>{@link net.opengis.wcs10.impl.DocumentRootImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
  ...
  /**
   * The default value of the '{@link #getInterpolationMethod() <em>Interpolation Method</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap =
          new EcoreEMap(
              ...
              this,
              Wcs10Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
    ...
    if (xSISchemaLocation == null) {
      xSISchemaLocation =
          new EcoreEMap(
              ...
              EStringToStringMapEntryImpl.class,
              this,
              Wcs10Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public AxisDescriptionType1 getAxisDescription() {
    return (AxisDescriptionType1)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetAxisDescription(
      AxisDescriptionType1 newAxisDescription, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION, newAxisDescription, msgs);
  }
  ...
  public void setAxisDescription(AxisDescriptionType1 newAxisDescription) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION, newAxisDescription);
  }
  ...
  public AxisDescriptionType getAxisDescription1() {
    return (AxisDescriptionType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION1, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetAxisDescription1(
      AxisDescriptionType newAxisDescription1, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION1, newAxisDescription1, msgs);
  }
  ...
  public void setAxisDescription1(AxisDescriptionType newAxisDescription1) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__AXIS_DESCRIPTION1, newAxisDescription1);
  }
  ...
  public WCSCapabilityType getCapability() {
    return (WCSCapabilityType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__CAPABILITY, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetCapability(
      WCSCapabilityType newCapability, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__CAPABILITY, newCapability, msgs);
  }
  ...
  public void setCapability(WCSCapabilityType newCapability) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__CAPABILITY, newCapability);
  }
  ...
  public ContentMetadataType getContentMetadata() {
    return (ContentMetadataType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__CONTENT_METADATA, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetContentMetadata(
      ContentMetadataType newContentMetadata, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__CONTENT_METADATA, newContentMetadata, msgs);
  }
  ...
  public void setContentMetadata(ContentMetadataType newContentMetadata) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__CONTENT_METADATA, newContentMetadata);
  }
  ...
  public CoverageDescriptionType getCoverageDescription() {
    return (CoverageDescriptionType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_DESCRIPTION, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetCoverageDescription(
      CoverageDescriptionType newCoverageDescription, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_DESCRIPTION,
  ...
  public void setCoverageDescription(CoverageDescriptionType newCoverageDescription) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_DESCRIPTION, newCoverageDescription);
  }
  ...
  public CoverageOfferingType getCoverageOffering() {
    return (CoverageOfferingType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetCoverageOffering(
      CoverageOfferingType newCoverageOffering, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING, newCoverageOffering, msgs);
  }
  ...
  public void setCoverageOffering(CoverageOfferingType newCoverageOffering) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING, newCoverageOffering);
  }
  ...
  public CoverageOfferingBriefType getCoverageOfferingBrief() {
    return (CoverageOfferingBriefType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING_BRIEF, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetCoverageOfferingBrief(
      CoverageOfferingBriefType newCoverageOfferingBrief, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING_BRIEF,
  ...
  public void setCoverageOfferingBrief(CoverageOfferingBriefType newCoverageOfferingBrief) {
    ((FeatureMap.Internal) getMixed())
        .set(
            Wcs10Package.Literals.DOCUMENT_ROOT__COVERAGE_OFFERING_BRIEF, newCoverageOfferingBrief);
  }
  ...
  public DescribeCoverageType getDescribeCoverage() {
    return (DescribeCoverageType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__DESCRIBE_COVERAGE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetDescribeCoverage(
      DescribeCoverageType newDescribeCoverage, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__DESCRIBE_COVERAGE, newDescribeCoverage, msgs);
  }
  ...
  public void setDescribeCoverage(DescribeCoverageType newDescribeCoverage) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__DESCRIBE_COVERAGE, newDescribeCoverage);
  }
  ...
  public void setDescription(String newDescription) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__DESCRIPTION, newDescription);
  }
  ...
  public NotificationChain basicSetDomainSet(DomainSetType newDomainSet, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__DOMAIN_SET, newDomainSet, msgs);
  }
  ...
  public void setDomainSet(DomainSetType newDomainSet) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__DOMAIN_SET, newDomainSet);
  }
  ...
  public NotificationChain basicSetFormats(CodeListType newFormats, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__FORMATS, newFormats, msgs);
  }
  ...
  public void setFormats(CodeListType newFormats) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__FORMATS, newFormats);
  }
  ...
  public GetCapabilitiesType getGetCapabilities() {
    return (GetCapabilitiesType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, true);
  }
  ...
  public NotificationChain basicSetGetCapabilities(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, newGetCapabilities, msgs);
  }
  ...
  public void setGetCapabilities(GetCapabilitiesType newGetCapabilities) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, newGetCapabilities);
  }
  ...
  public GetCoverageType getGetCoverage() {
    return (GetCoverageType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__GET_COVERAGE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetGetCoverage(
      GetCoverageType newGetCoverage, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__GET_COVERAGE, newGetCoverage, msgs);
  }
  ...
  public void setGetCoverage(GetCoverageType newGetCoverage) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__GET_COVERAGE, newGetCoverage);
  }
  ...
  public InterpolationMethodType getInterpolationMethod() {
    return (InterpolationMethodType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__INTERPOLATION_METHOD, true);
  }
  ...
  public void setInterpolationMethod(InterpolationMethodType newInterpolationMethod) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__INTERPOLATION_METHOD, newInterpolationMethod);
  }
  ...
  public NotificationChain basicSetInterval(IntervalType newInterval, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__INTERVAL, newInterval, msgs);
  }
  ...
  public void setInterval(IntervalType newInterval) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__INTERVAL, newInterval);
  }
  ...
  public NotificationChain basicSetKeywords(KeywordsType newKeywords, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__KEYWORDS, newKeywords, msgs);
  }
  ...
  public void setKeywords(KeywordsType newKeywords) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__KEYWORDS, newKeywords);
  }
  ...
  public LonLatEnvelopeType getLonLatEnvelope() {
    return (LonLatEnvelopeType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__LON_LAT_ENVELOPE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetLonLatEnvelope(
      LonLatEnvelopeType newLonLatEnvelope, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__LON_LAT_ENVELOPE, newLonLatEnvelope, msgs);
  }
  ...
  public void setLonLatEnvelope(LonLatEnvelopeType newLonLatEnvelope) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__LON_LAT_ENVELOPE, newLonLatEnvelope);
  }
  ...
  public MetadataLinkType getMetadataLink() {
    return (MetadataLinkType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__METADATA_LINK, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetMetadataLink(
      MetadataLinkType newMetadataLink, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__METADATA_LINK, newMetadataLink, msgs);
  }
  ...
  public void setMetadataLink(MetadataLinkType newMetadataLink) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__METADATA_LINK, newMetadataLink);
  }
  ...
  public NotificationChain basicSetRangeSet(RangeSetType1 newRangeSet, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__RANGE_SET, newRangeSet, msgs);
  }
  ...
  public void setRangeSet(RangeSetType1 newRangeSet) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__RANGE_SET, newRangeSet);
  }
  ...
  public NotificationChain basicSetRangeSet1(RangeSetType newRangeSet1, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__RANGE_SET1, newRangeSet1, msgs);
  }
  ...
  public void setRangeSet1(RangeSetType newRangeSet1) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__RANGE_SET1, newRangeSet1);
  }
  ...
  public NotificationChain basicSetService(ServiceType newService, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__SERVICE, newService, msgs);
  }
  ...
  public void setService(ServiceType newService) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SERVICE, newService);
  }
  ...
  public TypedLiteralType getSingleValue() {
    return (TypedLiteralType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SINGLE_VALUE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSingleValue(
      TypedLiteralType newSingleValue, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__SINGLE_VALUE, newSingleValue, msgs);
  }
  ...
  public void setSingleValue(TypedLiteralType newSingleValue) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SINGLE_VALUE, newSingleValue);
  }
  ...
  public SpatialDomainType getSpatialDomain() {
    return (SpatialDomainType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_DOMAIN, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSpatialDomain(
      SpatialDomainType newSpatialDomain, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_DOMAIN, newSpatialDomain, msgs);
  }
  ...
  public void setSpatialDomain(SpatialDomainType newSpatialDomain) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_DOMAIN, newSpatialDomain);
  }
  ...
  public SpatialSubsetType getSpatialSubset() {
    return (SpatialSubsetType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_SUBSET, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSpatialSubset(
      SpatialSubsetType newSpatialSubset, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_SUBSET, newSpatialSubset, msgs);
  }
  ...
  public void setSpatialSubset(SpatialSubsetType newSpatialSubset) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SPATIAL_SUBSET, newSpatialSubset);
  }
  ...
  public SupportedCRSsType getSupportedCRSs() {
    return (SupportedCRSsType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_CR_SS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSupportedCRSs(
      SupportedCRSsType newSupportedCRSs, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_CR_SS, newSupportedCRSs, msgs);
  }
  ...
  public void setSupportedCRSs(SupportedCRSsType newSupportedCRSs) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_CR_SS, newSupportedCRSs);
  }
  ...
  public SupportedFormatsType getSupportedFormats() {
    return (SupportedFormatsType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_FORMATS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSupportedFormats(
      SupportedFormatsType newSupportedFormats, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_FORMATS, newSupportedFormats, msgs);
  }
  ...
  public void setSupportedFormats(SupportedFormatsType newSupportedFormats) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_FORMATS, newSupportedFormats);
  }
  ...
  public SupportedInterpolationsType getSupportedInterpolations() {
    return (SupportedInterpolationsType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_INTERPOLATIONS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSupportedInterpolations(
      SupportedInterpolationsType newSupportedInterpolations, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wcs10Package.Literals.DOCUMENT_ROOT__SUPPORTED_INTERPOLATIONS,
  ...
  public TimeSequenceType getTemporalDomain() {
    return (TimeSequenceType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_DOMAIN, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalDomain(
      TimeSequenceType newTemporalDomain, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_DOMAIN, newTemporalDomain, msgs);
  }
  ...
  public void setTemporalDomain(TimeSequenceType newTemporalDomain) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_DOMAIN, newTemporalDomain);
  }
  ...
  public TimeSequenceType getTemporalSubset() {
    return (TimeSequenceType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_SUBSET, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalSubset(
      TimeSequenceType newTemporalSubset, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_SUBSET, newTemporalSubset, msgs);
  }
  ...
  public void setTemporalSubset(TimeSequenceType newTemporalSubset) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__TEMPORAL_SUBSET, newTemporalSubset);
  }
  ...
  public NotificationChain basicSetTimePeriod(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__TIME_PERIOD, newTimePeriod, msgs);
  }
  ...
  public void setTimePeriod(TimePeriodType newTimePeriod) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__TIME_PERIOD, newTimePeriod);
  }
  ...
  public TimeSequenceType getTimeSequence() {
    return (TimeSequenceType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__TIME_SEQUENCE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTimeSequence(
      TimeSequenceType newTimeSequence, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__TIME_SEQUENCE, newTimeSequence, msgs);
  }
  ...
  public void setTimeSequence(TimeSequenceType newTimeSequence) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__TIME_SEQUENCE, newTimeSequence);
  }
  ...
  public WCSCapabilitiesType getWCSCapabilities() {
    return (WCSCapabilitiesType)
        getMixed().get(Wcs10Package.Literals.DOCUMENT_ROOT__WCS_CAPABILITIES, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetWCSCapabilities(
      WCSCapabilitiesType newWCSCapabilities, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wcs10Package.Literals.DOCUMENT_ROOT__WCS_CAPABILITIES, newWCSCapabilities, msgs);
  }
  ...
  public void setWCSCapabilities(WCSCapabilitiesType newWCSCapabilities) {
    ((FeatureMap.Internal) getMixed())
        .set(Wcs10Package.Literals.DOCUMENT_ROOT__WCS_CAPABILITIES, newWCSCapabilities);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOCUMENT_ROOT__CLOSURE,
              oldClosure,
              closure,
              !oldClosureESet));
  }
  ...
  public void setSemantic(String newSemantic) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.DOCUMENT_ROOT__SEMANTIC, oldSemantic, semantic));
  }
  ...
  public void setType(String newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.DOCUMENT_ROOT__TYPE, oldType, type));
  }
