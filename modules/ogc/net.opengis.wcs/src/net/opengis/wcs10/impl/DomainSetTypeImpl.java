 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DomainSetTypeImpl#getSpatialDomain <em>Spatial Domain</em>}
 *   <li>{@link net.opengis.wcs10.impl.DomainSetTypeImpl#getTemporalDomain <em>Temporal Domain</em>}
 *   <li>{@link net.opengis.wcs10.impl.DomainSetTypeImpl#getTemporalDomain1 <em>Temporal
 *       Domain1</em>}
 * </ul>
 *
 * @generated
...
public class DomainSetTypeImpl extends EObjectImpl implements DomainSetType {
  /**
   * The cached value of the '{@link #getSpatialDomain() <em>Spatial Domain</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalDomain() <em>Temporal Domain</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalDomain1() <em>Temporal Domain1</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN,
              oldSpatialDomain,
              newSpatialDomain);
  ...
  public void setSpatialDomain(SpatialDomainType newSpatialDomain) {
    if (newSpatialDomain != spatialDomain) {
      ...
      if (spatialDomain != null)
        msgs =
            ((InternalEObject) spatialDomain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN,
                    null,
                    msgs);
      if (newSpatialDomain != null)
        msgs =
            ((InternalEObject) newSpatialDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN,
              oldTemporalDomain,
              newTemporalDomain);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTemporalDomain(TimeSequenceType newTemporalDomain) {
    if (newTemporalDomain != temporalDomain) {
      ...
      if (temporalDomain != null)
        msgs =
            ((InternalEObject) temporalDomain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN,
                    null,
                    msgs);
      if (newTemporalDomain != null)
        msgs =
            ((InternalEObject) newTemporalDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalDomain1(
      TimeSequenceType newTemporalDomain1, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1,
              oldTemporalDomain1,
              newTemporalDomain1);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTemporalDomain1(TimeSequenceType newTemporalDomain1) {
    if (newTemporalDomain1 != temporalDomain1) {
      ...
      if (temporalDomain1 != null)
        msgs =
            ((InternalEObject) temporalDomain1)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1,
                    null,
                    msgs);
      if (newTemporalDomain1 != null)
        msgs =
            ((InternalEObject) newTemporalDomain1)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1,
                    null,
