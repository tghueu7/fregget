 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingBriefTypeImpl#getLonLatEnvelope <em>Lon Lat
 *       Envelope</em>}
 *   <li>{@link net.opengis.wcs10.impl.CoverageOfferingBriefTypeImpl#getKeywords <em>Keywords</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageOfferingBriefTypeImpl extends AbstractDescriptionTypeImpl
    implements CoverageOfferingBriefType {
  /**
   * The cached value of the '{@link #getLonLatEnvelope() <em>Lon Lat Envelope</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.COVERAGE_OFFERING_BRIEF_TYPE__LON_LAT_ENVELOPE,
              oldLonLatEnvelope,
              newLonLatEnvelope);
  ...
  public void setLonLatEnvelope(LonLatEnvelopeType newLonLatEnvelope) {
    if (newLonLatEnvelope != lonLatEnvelope) {
      ...
      if (lonLatEnvelope != null)
        msgs =
            ((InternalEObject) lonLatEnvelope)
                .eInverseRemove(
                    this,
      ...
      if (newLonLatEnvelope != null)
        msgs =
            ((InternalEObject) newLonLatEnvelope)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wcs10Package.COVERAGE_OFFERING_BRIEF_TYPE__LON_LAT_ENVELOPE,
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, Wcs10Package.COVERAGE_OFFERING_BRIEF_TYPE__KEYWORDS);
    }
    return keywords;
  }
