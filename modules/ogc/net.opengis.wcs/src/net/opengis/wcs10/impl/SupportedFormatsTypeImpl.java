 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.SupportedFormatsTypeImpl#getFormats <em>Formats</em>}
 *   <li>{@link net.opengis.wcs10.impl.SupportedFormatsTypeImpl#getNativeFormat <em>Native
 *       Format</em>}
 * </ul>
 *
 * @generated
    ...
    if (formats == null) {
      formats =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SUPPORTED_FORMATS_TYPE__FORMATS);
    }
    return formats;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SUPPORTED_FORMATS_TYPE__NATIVE_FORMAT,
              oldNativeFormat,
              nativeFormat));
  }
