 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageType1Impl#getDCPType <em>DCP Type</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (dCPType == null) {
      dCPType =
          new EObjectContainmentEList(
              DCPTypeType.class, this, Wcs10Package.DESCRIBE_COVERAGE_TYPE1__DCP_TYPE);
    }
    return dCPType;
  }
