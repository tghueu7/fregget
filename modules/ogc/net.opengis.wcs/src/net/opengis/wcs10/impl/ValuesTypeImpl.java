 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.ValuesTypeImpl#getDefault <em>Default</em>}
 * </ul>
 *
 * @generated
 */
public class ValuesTypeImpl extends ValueEnumTypeImpl implements ValuesType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUES_TYPE__DEFAULT, oldDefault, newDefault);
  ...
  public void setDefault(TypedLiteralType newDefault) {
    if (newDefault != default_) {
      ...
      if (default_ != null)
        msgs =
            ((InternalEObject) default_)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.VALUES_TYPE__DEFAULT, null, msgs);
      if (newDefault != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUES_TYPE__DEFAULT, newDefault, newDefault));
  }
