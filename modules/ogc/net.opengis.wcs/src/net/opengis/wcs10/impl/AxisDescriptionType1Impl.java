 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.AxisDescriptionType1Impl#getAxisDescription <em>Axis
 *       Description</em>}
 * </ul>
 *
 * @generated
...
public class AxisDescriptionType1Impl extends EObjectImpl implements AxisDescriptionType1 {
  ...
  public NotificationChain basicSetAxisDescription(
      AxisDescriptionType newAxisDescription, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION,
              oldAxisDescription,
              newAxisDescription);
  ...
  public void setAxisDescription(AxisDescriptionType newAxisDescription) {
    if (newAxisDescription != axisDescription) {
      ...
      if (axisDescription != null)
        msgs =
            ((InternalEObject) axisDescription)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION,
                    null,
                    msgs);
      if (newAxisDescription != null)
        msgs =
            ((InternalEObject) newAxisDescription)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION,
                    null,
