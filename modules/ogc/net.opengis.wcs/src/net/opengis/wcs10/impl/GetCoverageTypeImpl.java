 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getSourceCoverage <em>Source
 *       Coverage</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getDomainSubset <em>Domain Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getRangeSubset <em>Range Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getInterpolationMethod <em>Interpolation
 *       Method</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getOutput <em>Output</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCoverageTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
...
public class GetCoverageTypeImpl extends EObjectImpl implements GetCoverageType {
  ...
  /**
   * The cached value of the '{@link #getDomainSubset() <em>Domain Subset</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getRangeSubset() <em>Range Subset</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getInterpolationMethod() <em>Interpolation Method</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getExtendedProperties() <em>Extended Properties</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__SOURCE_COVERAGE,
              oldSourceCoverage,
              sourceCoverage));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetDomainSubset(
      DomainSubsetType newDomainSubset, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET,
              oldDomainSubset,
              newDomainSubset);
  ...
  public void setDomainSubset(DomainSubsetType newDomainSubset) {
    if (newDomainSubset != domainSubset) {
      ...
      if (domainSubset != null)
        msgs =
            ((InternalEObject) domainSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET,
                    null,
                    msgs);
      if (newDomainSubset != null)
        msgs =
            ((InternalEObject) newDomainSubset)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetRangeSubset(
      RangeSubsetType newRangeSubset, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__RANGE_SUBSET,
              oldRangeSubset,
              newRangeSubset);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRangeSubset(RangeSubsetType newRangeSubset) {
    if (newRangeSubset != rangeSubset) {
      ...
      if (rangeSubset != null)
        msgs =
            ((InternalEObject) rangeSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__RANGE_SUBSET,
                    null,
                    msgs);
      if (newRangeSubset != null)
        msgs =
            ((InternalEObject) newRangeSubset)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__RANGE_SUBSET,
                    null,
  ...
  public void setInterpolationMethod(InterpolationMethodType newInterpolationMethod) {
    ...
    interpolationMethod =
        newInterpolationMethod == null ? INTERPOLATION_METHOD_EDEFAULT : newInterpolationMethod;
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__INTERPOLATION_METHOD,
              oldInterpolationMethod,
              interpolationMethod,
              !oldInterpolationMethodESet));
  }
  ...
  public NotificationChain basicSetOutput(OutputType newOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.GET_COVERAGE_TYPE__OUTPUT, oldOutput, newOutput);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setOutput(OutputType newOutput) {
    if (newOutput != output) {
      ...
      if (output != null)
        msgs =
            ((InternalEObject) output)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__OUTPUT,
                    null,
                    msgs);
      if (newOutput != null)
        msgs =
            ((InternalEObject) newOutput)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.GET_COVERAGE_TYPE__OUTPUT,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__OUTPUT,
              newOutput,
              newOutput));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_COVERAGE_TYPE__EXTENDED_PROPERTIES,
              oldExtendedProperties,
              extendedProperties));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs10Package.GET_COVERAGE_TYPE__SOURCE_COVERAGE:
        return SOURCE_COVERAGE_EDEFAULT == null
            ? sourceCoverage != null
            : !SOURCE_COVERAGE_EDEFAULT.equals(sourceCoverage);
      case Wcs10Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET:
      ...
      case Wcs10Package.GET_COVERAGE_TYPE__EXTENDED_PROPERTIES:
        return EXTENDED_PROPERTIES_EDEFAULT == null
            ? extendedProperties != null
            : !EXTENDED_PROPERTIES_EDEFAULT.equals(extendedProperties);
    }
  ...
  public String toString() {
    ...
    if (interpolationMethodESet) result.append(interpolationMethod);
