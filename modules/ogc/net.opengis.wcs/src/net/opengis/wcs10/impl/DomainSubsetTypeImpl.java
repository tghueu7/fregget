 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DomainSubsetTypeImpl#getSpatialSubset <em>Spatial
 *       Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.DomainSubsetTypeImpl#getTemporalSubset <em>Temporal
 *       Subset</em>}
 *   <li>{@link net.opengis.wcs10.impl.DomainSubsetTypeImpl#getTemporalSubset1 <em>Temporal
 *       Subset1</em>}
 * </ul>
 *
 * @generated
...
public class DomainSubsetTypeImpl extends EObjectImpl implements DomainSubsetType {
  /**
   * The cached value of the '{@link #getSpatialSubset() <em>Spatial Subset</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalSubset() <em>Temporal Subset</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalSubset1() <em>Temporal Subset1</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET,
              oldSpatialSubset,
              newSpatialSubset);
  ...
  public void setSpatialSubset(SpatialSubsetType newSpatialSubset) {
    if (newSpatialSubset != spatialSubset) {
      ...
      if (spatialSubset != null)
        msgs =
            ((InternalEObject) spatialSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET,
                    null,
                    msgs);
      if (newSpatialSubset != null)
        msgs =
            ((InternalEObject) newSpatialSubset)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET,
              oldTemporalSubset,
              newTemporalSubset);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTemporalSubset(TimeSequenceType newTemporalSubset) {
    if (newTemporalSubset != temporalSubset) {
      ...
      if (temporalSubset != null)
        msgs =
            ((InternalEObject) temporalSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET,
                    null,
                    msgs);
      if (newTemporalSubset != null)
        msgs =
            ((InternalEObject) newTemporalSubset)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalSubset1(
      TimeSequenceType newTemporalSubset1, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1,
              oldTemporalSubset1,
              newTemporalSubset1);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTemporalSubset1(TimeSequenceType newTemporalSubset1) {
    if (newTemporalSubset1 != temporalSubset1) {
      ...
      if (temporalSubset1 != null)
        msgs =
            ((InternalEObject) temporalSubset1)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1,
                    null,
                    msgs);
      if (newTemporalSubset1 != null)
        msgs =
            ((InternalEObject) newTemporalSubset1)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1,
                    null,
