 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DCPTypeTypeImpl#getHTTP <em>HTTP</em>}
 * </ul>
 *
 * @generated
 */
public class DCPTypeTypeImpl extends EObjectImpl implements DCPTypeType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.DCP_TYPE_TYPE__HTTP, oldHTTP, newHTTP);
  ...
  public void setHTTP(HTTPType newHTTP) {
    if (newHTTP != hTTP) {
      ...
      if (hTTP != null)
        msgs =
            ((InternalEObject) hTTP)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.DCP_TYPE_TYPE__HTTP, null, msgs);
      if (newHTTP != null)
        msgs =
            ((InternalEObject) newHTTP)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.DCP_TYPE_TYPE__HTTP, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.DCP_TYPE_TYPE__HTTP, newHTTP, newHTTP));
  }
