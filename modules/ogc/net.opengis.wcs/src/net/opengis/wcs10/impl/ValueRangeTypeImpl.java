 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#getMin <em>Min</em>}
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#getMax <em>Max</em>}
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#isAtomic <em>Atomic</em>}
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#getClosure <em>Closure</em>}
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#getSemantic <em>Semantic</em>}
 *   <li>{@link net.opengis.wcs10.impl.ValueRangeTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class ValueRangeTypeImpl extends EObjectImpl implements ValueRangeType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUE_RANGE_TYPE__MIN, oldMin, newMin);
    ...
    if (newMin != min) {
      ...
      if (min != null)
        msgs =
            ((InternalEObject) min)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.VALUE_RANGE_TYPE__MIN, null, msgs);
      if (newMin != null)
        msgs =
            ((InternalEObject) newMin)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.VALUE_RANGE_TYPE__MIN, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUE_RANGE_TYPE__MIN, newMin, newMin));
  }
  ...
  public NotificationChain basicSetMax(TypedLiteralType newMax, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUE_RANGE_TYPE__MAX, oldMax, newMax);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newMax != max) {
      ...
      if (max != null)
        msgs =
            ((InternalEObject) max)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.VALUE_RANGE_TYPE__MAX, null, msgs);
      if (newMax != null)
        msgs =
            ((InternalEObject) newMax)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.VALUE_RANGE_TYPE__MAX, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUE_RANGE_TYPE__MAX, newMax, newMax));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.VALUE_RANGE_TYPE__ATOMIC,
              oldAtomic,
              atomic,
              !oldAtomicESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.VALUE_RANGE_TYPE__CLOSURE,
              oldClosure,
              closure,
              !oldClosureESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.VALUE_RANGE_TYPE__SEMANTIC,
              oldSemantic,
              semantic));
  }
  ...
  public void setType(String newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.VALUE_RANGE_TYPE__TYPE, oldType, type));
  }
  ...
  public String toString() {
    ...
    if (atomicESet) result.append(atomic);
