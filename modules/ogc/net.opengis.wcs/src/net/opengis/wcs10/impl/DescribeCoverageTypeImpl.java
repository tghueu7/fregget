 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl#getCoverage <em>Coverage</em>}
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
    ...
    if (coverage == null) {
      coverage =
          new EDataTypeUniqueEList(
              String.class, this, Wcs10Package.DESCRIBE_COVERAGE_TYPE__COVERAGE);
    }
    return coverage;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DESCRIBE_COVERAGE_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DESCRIBE_COVERAGE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DESCRIBE_COVERAGE_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.DESCRIBE_COVERAGE_TYPE__EXTENDED_PROPERTIES,
