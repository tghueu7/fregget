 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.KeywordsTypeImpl#getKeyword <em>Keyword</em>}
 *   <li>{@link net.opengis.wcs10.impl.KeywordsTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class KeywordsTypeImpl extends EObjectImpl implements KeywordsType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.KEYWORDS_TYPE__KEYWORD, oldKeyword, keyword));
  }
  ...
  public NotificationChain basicSetType(CodeType newType, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.KEYWORDS_TYPE__TYPE, oldType, newType);
  ...
  public void setType(CodeType newType) {
    if (newType != type) {
      ...
      if (type != null)
        msgs =
            ((InternalEObject) type)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.KEYWORDS_TYPE__TYPE, null, msgs);
      if (newType != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.KEYWORDS_TYPE__TYPE, newType, newType));
  }
