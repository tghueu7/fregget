 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.RangeSetTypeImpl#getAxisDescription <em>Axis
 *       Description</em>}
 *   <li>{@link net.opengis.wcs10.impl.RangeSetTypeImpl#getNullValues <em>Null Values</em>}
 *   <li>{@link net.opengis.wcs10.impl.RangeSetTypeImpl#getRefSys <em>Ref Sys</em>}
 *   <li>{@link net.opengis.wcs10.impl.RangeSetTypeImpl#getRefSysLabel <em>Ref Sys Label</em>}
 *   <li>{@link net.opengis.wcs10.impl.RangeSetTypeImpl#getSemantic <em>Semantic</em>}
 * </ul>
 *
 * @generated
 */
public class RangeSetTypeImpl extends AbstractDescriptionTypeImpl implements RangeSetType {
  /**
   * The cached value of the '{@link #getAxisDescription() <em>Axis Description</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (axisDescription == null) {
      axisDescription =
          new EObjectContainmentEList(
              AxisDescriptionType1.class, this, Wcs10Package.RANGE_SET_TYPE__AXIS_DESCRIPTION);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RANGE_SET_TYPE__NULL_VALUES,
              oldNullValues,
              newNullValues);
  ...
  public void setNullValues(ValueEnumType newNullValues) {
    if (newNullValues != nullValues) {
      ...
      if (nullValues != null)
        msgs =
            ((InternalEObject) nullValues)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.RANGE_SET_TYPE__NULL_VALUES,
                    null,
                    msgs);
      if (newNullValues != null)
        msgs =
            ((InternalEObject) newNullValues)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.RANGE_SET_TYPE__NULL_VALUES,
                    null,
  ...
  public void setRefSys(String newRefSys) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.RANGE_SET_TYPE__REF_SYS, oldRefSys, refSys));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RANGE_SET_TYPE__REF_SYS_LABEL,
              oldRefSysLabel,
              refSysLabel));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RANGE_SET_TYPE__SEMANTIC,
              oldSemantic,
              semantic));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs10Package.RANGE_SET_TYPE__REF_SYS_LABEL:
        return REF_SYS_LABEL_EDEFAULT == null
            ? refSysLabel != null
            : !REF_SYS_LABEL_EDEFAULT.equals(refSysLabel);
      case Wcs10Package.RANGE_SET_TYPE__SEMANTIC:
