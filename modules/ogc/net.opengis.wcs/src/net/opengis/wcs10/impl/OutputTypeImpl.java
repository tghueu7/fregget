 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.OutputTypeImpl#getCrs <em>Crs</em>}
 *   <li>{@link net.opengis.wcs10.impl.OutputTypeImpl#getFormat <em>Format</em>}
 * </ul>
 *
 * @generated
 */
public class OutputTypeImpl extends EObjectImpl implements OutputType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.OUTPUT_TYPE__CRS, oldCrs, newCrs);
    ...
    if (newCrs != crs) {
      ...
      if (crs != null)
        msgs =
            ((InternalEObject) crs)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.OUTPUT_TYPE__CRS, null, msgs);
      if (newCrs != null)
        msgs =
            ((InternalEObject) newCrs)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.OUTPUT_TYPE__CRS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.OUTPUT_TYPE__CRS, newCrs, newCrs));
  }
  ...
  public NotificationChain basicSetFormat(CodeType newFormat, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.OUTPUT_TYPE__FORMAT, oldFormat, newFormat);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setFormat(CodeType newFormat) {
    if (newFormat != format) {
      ...
      if (format != null)
        msgs =
            ((InternalEObject) format)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.OUTPUT_TYPE__FORMAT, null, msgs);
      if (newFormat != null)
        msgs =
            ((InternalEObject) newFormat)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.OUTPUT_TYPE__FORMAT, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.OUTPUT_TYPE__FORMAT, newFormat, newFormat));
  }
