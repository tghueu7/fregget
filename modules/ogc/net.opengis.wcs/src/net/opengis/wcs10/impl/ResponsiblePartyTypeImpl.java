 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual
 *       Name</em>}
 *   <li>{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation
 *       Name</em>}
 *   <li>{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl#getOrganisationName1
 *       <em>Organisation Name1</em>}
 *   <li>{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position
 *       Name</em>}
 *   <li>{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact
 *       Info</em>}
 * </ul>
 *
 * @generated
...
public class ResponsiblePartyTypeImpl extends EObjectImpl implements ResponsiblePartyType {
  ...
  /**
   * The default value of the '{@link #getOrganisationName1() <em>Organisation Name1</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getOrganisationName1() <em>Organisation Name1</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getContactInfo() <em>Contact Info</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME,
              oldIndividualName,
              individualName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME,
              oldOrganisationName,
              organisationName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME1,
              oldOrganisationName1,
              organisationName1));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME,
              oldPositionName,
              positionName));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO,
              oldContactInfo,
              newContactInfo);
  ...
  public void setContactInfo(ContactType newContactInfo) {
    if (newContactInfo != contactInfo) {
      ...
      if (contactInfo != null)
        msgs =
            ((InternalEObject) contactInfo)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO,
                    null,
                    msgs);
      if (newContactInfo != null)
        msgs =
            ((InternalEObject) newContactInfo)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO,
                    null,
    ...
    switch (featureID) {
      ...
      case Wcs10Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME:
        return ORGANISATION_NAME_EDEFAULT == null
            ...
            : !ORGANISATION_NAME_EDEFAULT.equals(organisationName);
      case Wcs10Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME1:
        return ORGANISATION_NAME1_EDEFAULT == null
            ? organisationName1 != null
            : !ORGANISATION_NAME1_EDEFAULT.equals(organisationName1);
      case Wcs10Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME:
