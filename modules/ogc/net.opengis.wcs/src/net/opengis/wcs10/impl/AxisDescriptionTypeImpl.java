 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl#getValues <em>Values</em>}
 *   <li>{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl#getRefSys <em>Ref Sys</em>}
 *   <li>{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl#getRefSysLabel <em>Ref Sys
 *       Label</em>}
 *   <li>{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl#getSemantic <em>Semantic</em>}
 * </ul>
 *
 * @generated
 */
public class AxisDescriptionTypeImpl extends AbstractDescriptionTypeImpl
    implements AxisDescriptionType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.AXIS_DESCRIPTION_TYPE__VALUES,
              oldValues,
              newValues);
  ...
  public void setValues(ValuesType newValues) {
    if (newValues != values) {
      ...
      if (values != null)
        msgs =
            ((InternalEObject) values)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.AXIS_DESCRIPTION_TYPE__VALUES,
                    null,
                    msgs);
      if (newValues != null)
        msgs =
            ((InternalEObject) newValues)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.AXIS_DESCRIPTION_TYPE__VALUES,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.AXIS_DESCRIPTION_TYPE__REF_SYS,
              oldRefSys,
              refSys));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.AXIS_DESCRIPTION_TYPE__REF_SYS_LABEL,
              oldRefSysLabel,
              refSysLabel));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.AXIS_DESCRIPTION_TYPE__SEMANTIC,
              oldSemantic,
              semantic));
  }
