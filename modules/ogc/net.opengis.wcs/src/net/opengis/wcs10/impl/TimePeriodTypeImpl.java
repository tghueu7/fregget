 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.TimePeriodTypeImpl#getBeginPosition <em>Begin Position</em>}
 *   <li>{@link net.opengis.wcs10.impl.TimePeriodTypeImpl#getEndPosition <em>End Position</em>}
 *   <li>{@link net.opengis.wcs10.impl.TimePeriodTypeImpl#getTimeResolution <em>Time
 *       Resolution</em>}
 *   <li>{@link net.opengis.wcs10.impl.TimePeriodTypeImpl#getFrame <em>Frame</em>}
 * </ul>
 *
 * @generated
 */
public class TimePeriodTypeImpl extends EObjectImpl implements TimePeriodType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
              oldBeginPosition,
              newBeginPosition);
      ...
      if (beginPosition != null)
        msgs =
            ((InternalEObject) beginPosition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.TIME_PERIOD_TYPE__END_POSITION,
              oldEndPosition,
              newEndPosition);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (endPosition != null)
        msgs =
            ((InternalEObject) endPosition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.TIME_PERIOD_TYPE__END_POSITION,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.TIME_PERIOD_TYPE__TIME_RESOLUTION,
              oldTimeResolution,
              timeResolution));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.TIME_PERIOD_TYPE__FRAME,
              oldFrame,
              frame,
              !oldFrameESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs10Package.TIME_PERIOD_TYPE__TIME_RESOLUTION:
        return TIME_RESOLUTION_EDEFAULT == null
            ? timeResolution != null
            : !TIME_RESOLUTION_EDEFAULT.equals(timeResolution);
      case Wcs10Package.TIME_PERIOD_TYPE__FRAME:
        return isSetFrame();
    }
  ...
  public String toString() {
    ...
    result.append(timeResolution);
    result.append(", frame: ");
    if (frameESet) result.append(frame);
