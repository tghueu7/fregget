 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl#getCapability <em>Capability</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl#getContentMetadata <em>Content
 *       Metadata</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class WCSCapabilitiesTypeImpl extends EObjectImpl implements WCSCapabilitiesType {
  ...
  /**
   * The cached value of the '{@link #getContentMetadata() <em>Content Metadata</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITIES_TYPE__SERVICE,
              oldService,
              newService);
      ...
      if (service != null)
        msgs =
            ((InternalEObject) service)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITIES_TYPE__SERVICE,
                    null,
                    msgs);
      if (newService != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITIES_TYPE__CAPABILITY,
              oldCapability,
              newCapability);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setCapability(WCSCapabilityType newCapability) {
    if (newCapability != capability) {
      ...
      if (capability != null)
        msgs =
            ((InternalEObject) capability)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITIES_TYPE__CAPABILITY,
                    null,
                    msgs);
      if (newCapability != null)
        msgs =
            ((InternalEObject) newCapability)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITIES_TYPE__CAPABILITY,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITIES_TYPE__CONTENT_METADATA,
              oldContentMetadata,
              newContentMetadata);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setContentMetadata(ContentMetadataType newContentMetadata) {
    if (newContentMetadata != contentMetadata) {
      ...
      if (contentMetadata != null)
        msgs =
            ((InternalEObject) contentMetadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITIES_TYPE__CONTENT_METADATA,
                    null,
                    msgs);
      if (newContentMetadata != null)
        msgs =
            ((InternalEObject) newContentMetadata)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.WCS_CAPABILITIES_TYPE__CONTENT_METADATA,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITIES_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.WCS_CAPABILITIES_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
