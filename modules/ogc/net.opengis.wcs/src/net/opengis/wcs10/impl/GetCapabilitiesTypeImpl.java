 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getSection <em>Section</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
...
public class GetCapabilitiesTypeImpl extends EObjectImpl implements GetCapabilitiesType {
   ...
   * @ordered
   */
  protected static final CapabilitiesSectionType SECTION_EDEFAULT =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__SECTION,
              oldSection,
              section,
              !oldSectionESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.GET_CAPABILITIES_TYPE__EXTENDED_PROPERTIES,
