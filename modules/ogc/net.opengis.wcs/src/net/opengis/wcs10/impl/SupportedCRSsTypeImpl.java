 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl#getRequestResponseCRSs <em>Request
 *       Response CR Ss</em>}
 *   <li>{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl#getRequestCRSs <em>Request CR Ss</em>}
 *   <li>{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl#getResponseCRSs <em>Response CR
 *       Ss</em>}
 *   <li>{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl#getNativeCRSs <em>Native CR Ss</em>}
 * </ul>
 *
 * @generated
 */
public class SupportedCRSsTypeImpl extends EObjectImpl implements SupportedCRSsType {
  /**
   * The cached value of the '{@link #getRequestResponseCRSs() <em>Request Response CR Ss</em>}'
  ...
  /**
   * The cached value of the '{@link #getRequestCRSs() <em>Request CR Ss</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getResponseCRSs() <em>Response CR Ss</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getNativeCRSs() <em>Native CR Ss</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (requestResponseCRSs == null) {
      requestResponseCRSs =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SUPPORTED_CR_SS_TYPE__REQUEST_RESPONSE_CR_SS);
    }
  ...
  public EList getRequestCRSs() {
    if (requestCRSs == null) {
      requestCRSs =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SUPPORTED_CR_SS_TYPE__REQUEST_CR_SS);
    }
    return requestCRSs;
  }
  ...
  public EList getResponseCRSs() {
    if (responseCRSs == null) {
      responseCRSs =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SUPPORTED_CR_SS_TYPE__RESPONSE_CR_SS);
    }
    return responseCRSs;
  }
  ...
  public EList getNativeCRSs() {
    if (nativeCRSs == null) {
      nativeCRSs =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SUPPORTED_CR_SS_TYPE__NATIVE_CR_SS);
    }
    return nativeCRSs;
  }
