 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.RequestTypeImpl#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.impl.RequestTypeImpl#getDescribeCoverage <em>Describe
 *       Coverage</em>}
 *   <li>{@link net.opengis.wcs10.impl.RequestTypeImpl#getGetCoverage <em>Get Coverage</em>}
 * </ul>
 *
 * @generated
 */
public class RequestTypeImpl extends EObjectImpl implements RequestType {
  /**
   * The cached value of the '{@link #getGetCapabilities() <em>Get Capabilities</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getDescribeCoverage() <em>Describe Coverage</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getGetCoverage() <em>Get Coverage</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public NotificationChain basicSetGetCapabilities(
      GetCapabilitiesType1 newGetCapabilities, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.REQUEST_TYPE__GET_CAPABILITIES,
              oldGetCapabilities,
              newGetCapabilities);
  ...
  public void setGetCapabilities(GetCapabilitiesType1 newGetCapabilities) {
    if (newGetCapabilities != getCapabilities) {
      ...
      if (getCapabilities != null)
        msgs =
            ((InternalEObject) getCapabilities)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__GET_CAPABILITIES,
                    null,
                    msgs);
      if (newGetCapabilities != null)
        msgs =
            ((InternalEObject) newGetCapabilities)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__GET_CAPABILITIES,
                    null,
  ...
  public NotificationChain basicSetDescribeCoverage(
      DescribeCoverageType1 newDescribeCoverage, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.REQUEST_TYPE__DESCRIBE_COVERAGE,
              oldDescribeCoverage,
              newDescribeCoverage);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setDescribeCoverage(DescribeCoverageType1 newDescribeCoverage) {
    if (newDescribeCoverage != describeCoverage) {
      ...
      if (describeCoverage != null)
        msgs =
            ((InternalEObject) describeCoverage)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__DESCRIBE_COVERAGE,
                    null,
                    msgs);
      if (newDescribeCoverage != null)
        msgs =
            ((InternalEObject) newDescribeCoverage)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__DESCRIBE_COVERAGE,
                    null,
  ...
  public NotificationChain basicSetGetCoverage(
      GetCoverageType1 newGetCoverage, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.REQUEST_TYPE__GET_COVERAGE,
              oldGetCoverage,
              newGetCoverage);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setGetCoverage(GetCoverageType1 newGetCoverage) {
    if (newGetCoverage != getCoverage) {
      ...
      if (getCoverage != null)
        msgs =
            ((InternalEObject) getCoverage)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__GET_COVERAGE,
                    null,
                    msgs);
      if (newGetCoverage != null)
        msgs =
            ((InternalEObject) newGetCoverage)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.REQUEST_TYPE__GET_COVERAGE,
                    null,
