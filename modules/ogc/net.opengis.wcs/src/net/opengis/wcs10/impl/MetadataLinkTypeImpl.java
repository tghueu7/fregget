 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.MetadataLinkTypeImpl#getMetadataType <em>Metadata Type</em>}
 * </ul>
 *
 * @generated
 */
public class MetadataLinkTypeImpl extends MetadataAssociationTypeImpl implements MetadataLinkType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.METADATA_LINK_TYPE__METADATA_TYPE,
              oldMetadataType,
              metadataType,
              !oldMetadataTypeESet));
  }
  ...
  public String toString() {
    ...
    if (metadataTypeESet) result.append(metadataType);
