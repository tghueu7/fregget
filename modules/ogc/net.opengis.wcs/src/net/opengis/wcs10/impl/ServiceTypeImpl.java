 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getResponsibleParty <em>Responsible
 *       Party</em>}
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getAccessConstraints <em>Access
 *       Constraints</em>}
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.wcs10.impl.ServiceTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class ServiceTypeImpl extends AbstractDescriptionTypeImpl implements ServiceType {
  ...
  /**
   * The cached value of the '{@link #getResponsibleParty() <em>Responsible Party</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAccessConstraints() <em>Access Constraints</em>}'
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, Wcs10Package.SERVICE_TYPE__KEYWORDS);
    }
    return keywords;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetResponsibleParty(
      ResponsiblePartyType newResponsibleParty, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SERVICE_TYPE__RESPONSIBLE_PARTY,
              oldResponsibleParty,
              newResponsibleParty);
  ...
  public void setResponsibleParty(ResponsiblePartyType newResponsibleParty) {
    if (newResponsibleParty != responsibleParty) {
      ...
      if (responsibleParty != null)
        msgs =
            ((InternalEObject) responsibleParty)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.SERVICE_TYPE__RESPONSIBLE_PARTY,
                    null,
                    msgs);
      if (newResponsibleParty != null)
        msgs =
            ((InternalEObject) newResponsibleParty)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs10Package.SERVICE_TYPE__RESPONSIBLE_PARTY,
                    null,
  ...
  public NotificationChain basicSetFees(CodeListType newFees, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.SERVICE_TYPE__FEES, oldFees, newFees);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setFees(CodeListType newFees) {
    if (newFees != fees) {
      ...
      if (fees != null)
        msgs =
            ((InternalEObject) fees)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.SERVICE_TYPE__FEES, null, msgs);
      if (newFees != null)
        msgs =
            ((InternalEObject) newFees)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Wcs10Package.SERVICE_TYPE__FEES, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs10Package.SERVICE_TYPE__FEES, newFees, newFees));
  }
  ...
  public EList getAccessConstraints() {
    if (accessConstraints == null) {
      accessConstraints =
          new EObjectContainmentEList(
              CodeListType.class, this, Wcs10Package.SERVICE_TYPE__ACCESS_CONSTRAINTS);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SERVICE_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SERVICE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
