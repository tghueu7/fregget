 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl#getEnvelope <em>Envelope</em>}
 *   <li>{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl#getGridGroup <em>Grid Group</em>}
 *   <li>{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl#getGrid <em>Grid</em>}
 *   <li>{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl#getPolygon <em>Polygon</em>}
 * </ul>
 *
 * @generated
 */
public class SpatialDomainTypeImpl extends EObjectImpl implements SpatialDomainType {
    ...
    if (envelope == null) {
      envelope =
          new EDataTypeUniqueEList(
              GeneralEnvelope.class, this, Wcs10Package.SPATIAL_DOMAIN_TYPE__ENVELOPE);
    }
    return envelope;
  }
  ...
  ////            envelopeGroup = new BasicFeatureMap(this,
  // Wcs10Package.SPATIAL_DOMAIN_TYPE__ENVELOPE_GROUP);
    ...
    if (polygon == null) {
      polygon =
          new EObjectContainmentEList(
              PolygonType.class, this, Wcs10Package.SPATIAL_DOMAIN_TYPE__POLYGON);
    }
    return polygon;
  }
