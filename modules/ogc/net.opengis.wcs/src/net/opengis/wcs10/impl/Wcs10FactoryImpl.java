...
public class Wcs10FactoryImpl extends EFactoryImpl implements Wcs10Factory {
  ...
  public static Wcs10Factory init() {
    try {
      Wcs10Factory theWcs10Factory =
          (Wcs10Factory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/wcs");
  ...
  public SupportedInterpolationsType createSupportedInterpolationsType() {
    SupportedInterpolationsTypeImpl supportedInterpolationsType =
        new SupportedInterpolationsTypeImpl();
  ...
  public VendorSpecificCapabilitiesType createVendorSpecificCapabilitiesType() {
    VendorSpecificCapabilitiesTypeImpl vendorSpecificCapabilitiesType =
        new VendorSpecificCapabilitiesTypeImpl();
   ...
   * @generated
   */
  public CapabilitiesSectionType createCapabilitiesSectionTypeFromString(
   ...
   * @generated
   */
  public InterpolationMethodType createInterpolationMethodTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public MetadataTypeType createMetadataTypeTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public CapabilitiesSectionType createCapabilitiesSectionTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createCapabilitiesSectionTypeFromString(
        Wcs10Package.Literals.CAPABILITIES_SECTION_TYPE, initialValue);
  }
   ...
   * @generated
   */
  public String convertCapabilitiesSectionTypeObjectToString(
      EDataType eDataType, Object instanceValue) {
    return convertCapabilitiesSectionTypeToString(
        Wcs10Package.Literals.CAPABILITIES_SECTION_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public InterpolationMethodType createInterpolationMethodTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createInterpolationMethodTypeFromString(
        Wcs10Package.Literals.INTERPOLATION_METHOD_TYPE, initialValue);
  }
   ...
   * @generated
   */
  public String convertInterpolationMethodTypeObjectToString(
      EDataType eDataType, Object instanceValue) {
    return convertInterpolationMethodTypeToString(
   ...
   * @generated
   */
  public MetadataTypeType createMetadataTypeTypeObjectFromString(
      EDataType eDataType, String initialValue) {
