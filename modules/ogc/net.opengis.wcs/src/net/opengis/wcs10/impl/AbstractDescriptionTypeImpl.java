 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl#getMetadataLink <em>Metadata
 *       Link</em>}
 *   <li>{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl#getDescription1
 *       <em>Description1</em>}
 *   <li>{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl#getName1 <em>Name1</em>}
 *   <li>{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl#getLabel <em>Label</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractDescriptionTypeImpl extends AbstractDescriptionBaseTypeImpl
    implements AbstractDescriptionType {
  /**
   * The cached value of the '{@link #getMetadataLink() <em>Metadata Link</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (metadataLink == null) {
      metadataLink =
          new EObjectContainmentEList(
              MetadataLinkType.class, this, Wcs10Package.ABSTRACT_DESCRIPTION_TYPE__METADATA_LINK);
    }
    return metadataLink;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.ABSTRACT_DESCRIPTION_TYPE__DESCRIPTION1,
              oldDescription1,
              description1));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.ABSTRACT_DESCRIPTION_TYPE__NAME1,
              oldName1,
              name1));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.ABSTRACT_DESCRIPTION_TYPE__LABEL,
              oldLabel,
              label));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs10Package.ABSTRACT_DESCRIPTION_TYPE__DESCRIPTION1:
        return DESCRIPTION1_EDEFAULT == null
            ? description1 != null
