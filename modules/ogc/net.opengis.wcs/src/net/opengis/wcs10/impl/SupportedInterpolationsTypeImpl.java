 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.SupportedInterpolationsTypeImpl#getInterpolationMethod
 *       <em>Interpolation Method</em>}
 *   <li>{@link net.opengis.wcs10.impl.SupportedInterpolationsTypeImpl#getDefault <em>Default</em>}
 * </ul>
 *
 * @generated
 */
public class SupportedInterpolationsTypeImpl extends EObjectImpl
    implements SupportedInterpolationsType {
  /**
   ...
   * @ordered
   */
  protected static final InterpolationMethodType DEFAULT_EDEFAULT =
      InterpolationMethodType.NEAREST_NEIGHBOR_LITERAL;
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SUPPORTED_INTERPOLATIONS_TYPE__INTERPOLATION_METHOD,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs10Package.SUPPORTED_INTERPOLATIONS_TYPE__DEFAULT,
              oldDefault,
              default_,
              !oldDefaultESet));
  }
