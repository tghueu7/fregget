...
public class Wcs10PackageImpl extends EPackageImpl implements Wcs10Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Wcs10Package#eINSTANCE} when that field is
  ...
  public static Wcs10Package init() {
    if (isInited)
      return (Wcs10Package) EPackage.Registry.INSTANCE.getEPackage(Wcs10Package.eNS_URI);

    // Obtain or create and register package
    Wcs10PackageImpl theWcs10Package =
        (Wcs10PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wcs10PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Wcs10PackageImpl());
    ...
    GmlPackageImpl theGmlPackage =
        (GmlPackageImpl)
            (EPackage.Registry.INSTANCE.getEPackage(GmlPackage.eNS_URI) instanceof GmlPackageImpl
                ? EPackage.Registry.INSTANCE.getEPackage(GmlPackage.eNS_URI)
  ...
  public void createPackageContents() {
    ...
    createEReference(
        coverageOfferingBriefTypeEClass, COVERAGE_OFFERING_BRIEF_TYPE__LON_LAT_ENVELOPE);
    ...
    createEAttribute(
        supportedInterpolationsTypeEClass, SUPPORTED_INTERPOLATIONS_TYPE__INTERPOLATION_METHOD);
  ...
  public void initializePackageContents() {
    ...
    GmlPackage theGmlPackage =
        (GmlPackage) EPackage.Registry.INSTANCE.getEPackage(GmlPackage.eNS_URI);
    XMLTypePackage theXMLTypePackage =
        (XMLTypePackage) EPackage.Registry.INSTANCE.getEPackage(XMLTypePackage.eNS_URI);
    XlinkPackage theXlinkPackage =
        (XlinkPackage) EPackage.Registry.INSTANCE.getEPackage(XlinkPackage.eNS_URI);
    ...
    initEClass(
        ...
        AbstractDescriptionBaseType.class,
    ...
    initEReference(
        ...
        this.getCoverageOfferingBriefType(),
        null,
    ...
    initEReference(
        ...
        this.getSupportedInterpolationsType(),
        null,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getDescribeCoverageType_BaseUrl(),
        ecorePackage.getEString(),
        "baseUrl",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getDescribeCoverageType_ExtendedProperties(),
        this.getMap(),
        "extendedProperties",
        null,
        0,
    ...
    initEAttribute(
        ...
        this.getCapabilitiesSectionType(),
        "section",
        "/",
        0,
        1,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getGetCoverageType_ExtendedProperties(),
        this.getMap(),
        "extendedProperties",
        null,
        0,
    ...
    initEReference(
        ...
        theGmlPackage.getTimePositionType(),
        null,
        "timePosition",
        null,
        0,
    ...
    initEClass(
        ...
        SupportedInterpolationsType.class,
    ...
    initEAttribute(
        ...
        theGmlPackage.getTimeDurationType(),
        "timeResolution",
        null,
        0,
        1,
    ...
    initEClass(
        ...
        VendorSpecificCapabilitiesType.class,
    ...
    initEReference(
        ...
        this.getVendorSpecificCapabilitiesType(),
        null,
    ...
    initEEnum(
        capabilitiesSectionTypeEEnum, CapabilitiesSectionType.class, "CapabilitiesSectionType");
    addEEnumLiteral(capabilitiesSectionTypeEEnum, CapabilitiesSectionType.__LITERAL);
    addEEnumLiteral(
        capabilitiesSectionTypeEEnum, CapabilitiesSectionType.WCS_CAPABILITIES_SERVICE_LITERAL);
    addEEnumLiteral(
        capabilitiesSectionTypeEEnum, CapabilitiesSectionType.WCS_CAPABILITIES_CAPABILITY_LITERAL);
    addEEnumLiteral(
    ...
    initEEnum(
        interpolationMethodTypeEEnum, InterpolationMethodType.class, "InterpolationMethodType");
    ...
    initEDataType(
        ...
        CapabilitiesSectionType.class,
        "CapabilitiesSectionTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
    ...
    initEDataType(
        ...
        "InterpolationMethodTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        metadataTypeTypeObjectEDataType,
        MetadataTypeType.class,
        "MetadataTypeTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(
        capabilitiesSectionTypeEEnum, source, new String[] {"name", "CapabilitiesSectionType"});
    addAnnotation(closureTypeEEnum, source, new String[] {"name", "closure_._type"});
    addAnnotation(
        interpolationMethodTypeEEnum, source, new String[] {"name", "InterpolationMethodType"});
