 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.RequestType#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wcs10.RequestType#getDescribeCoverage <em>Describe Coverage</em>}
 *   <li>{@link net.opengis.wcs10.RequestType#getGetCoverage <em>Get Coverage</em>}
 * </ul>
 *
...
public interface RequestType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.RequestType#getGetCapabilities <em>Get
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Describe Coverage</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='DescribeCoverage' namespace='##targetNamespace'"
   * @generated
   */
  DescribeCoverageType1 getDescribeCoverage();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.RequestType#getDescribeCoverage <em>Describe
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Get Coverage</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='GetCoverage'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.RequestType#getGetCoverage <em>Get
   * Coverage</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
