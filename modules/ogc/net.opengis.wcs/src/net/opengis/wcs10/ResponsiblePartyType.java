 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}
 *   <li>{@link net.opengis.wcs10.ResponsiblePartyType#getOrganisationName <em>Organisation
 *       Name</em>}
 *   <li>{@link net.opengis.wcs10.ResponsiblePartyType#getOrganisationName1 <em>Organisation
 *       Name1</em>}
 *   <li>{@link net.opengis.wcs10.ResponsiblePartyType#getPositionName <em>Position Name</em>}
 *   <li>{@link net.opengis.wcs10.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}
 * </ul>
 *
...
public interface ResponsiblePartyType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ResponsiblePartyType#getIndividualName
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ResponsiblePartyType#getOrganisationName
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ResponsiblePartyType#getOrganisationName1
   * <em>Organisation Name1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ResponsiblePartyType#getPositionName
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs10.ResponsiblePartyType#getContactInfo <em>Contact
