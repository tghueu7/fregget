 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This schema defines the DescribeCoverage operation request and reply XML elements and types, used
 * by an OGC Web Coverage Service (WCS). JDE 2003-07-24 changes: Changed first and third "include"
 * below to "import" so as to bring more than one namespace Made spatialDomain a global element so
 * as to substitute for it in GetCoverage spatialSubset
 *
 * <p>JDE 2003-07-28 - Made temporalSubset of type TimeSequenceType (from owsBase.xsd, uses
 * gml:timePosition). AEW 03/07/29 Changes made: Edited documentation of some elements and types
 *
 * <p>AEW 03/07/30 Changes made: Corrrected defintion of temporalDomain element, makiing first
 * letter of name lower case
 *
 * <p>AEW 03/08/01 Changes made: Edited documentation of many types
 *
 * <p>JDE 03/08/27 Changes made: Made DescribeCoverage/@service and DescribeCoverage/@version
 * required Added CoverageDescription/@version (required) and CoverageDescription/@updateSequence
 * (optional)
 *
 * <p>AEW 04/07/14 Changes made: Changed two "import" statement for the "wcs" namespace to "include"
 * statements. Added "import" statement for the "gml" namespace used in gml4wcs.xsd.
 *
 * <p>AEW 05/07/15 Changes made: Changed documentation of updateSequence attribute in
 * CoverageDescription element
 *
 * <p>This schema defines the Capabilities operation request and reply XML elements and types used
 * by an OGC Web Coverage Service (WCS). This schema with the schemas it uses are believed to be GML
 * Application Schemas. AEW 03/07/22 Changes made: Changed element name "Section" to "section" in
 * GetCapabilities Added documentation elements in GetCapabilities, CapabilitiesSectionType,
 * ContentMetadata, AbstractDescriptionBaseType, AbstractDescriptionType Expanded documentation of
 * WCS_CapabilitiesType Moved documentation from Service to ServiceType Edited documentation of
 * OnlineResourceType, electronicMailAddress in AddressType Expanded separator comment before
 * ContentMetadata elements and types Added separator comment before CoverageOfferingBrief Moved
 * metadataLink from AbstractDescriptionType to AbstractDescriptionBaseType in
 * CoverageOfferingBrief, replaced boundedBy with a new lonLatBoundingBox (added to owsBase.xsd);
 * and made temporal domain of type TimeSequenceType. AEW 03/07/29 Changes made: Changed optionality
 * and documentation os "fees" and accessConstraints" elements in ServiceType Changed reference to
 * gml:description to reference to (wcs:)description in AbstractDescriptionBaseType AEW 03/07/30
 * Changes made: Added "version" and "updateSequence" attributes to ServiceType, WCSCapabilityType,
 * and ContentMetadata JDE 03/07/30 - Added "version" and "updateSequence" attributes to
 * WCS_Capabilities type 03/08/27 - Made "version" attribute required AEW 04/07/13 Changes made:
 * Added declaration of the "xlink" namespace. In wcs:AbstractDescriptionType, added the elements
 * wcs:description and wcs:name, and the attribute "gml:id" with use="prohibited". AEW 05/07/18
 * Changes made: Changed documentation of updateSequence attribute in GetCapabilities element,
 * WCS_CapabilitiesType, ServiceType, WCSCapabilityType, and ContentMetadata element. Added
 * documentation of all enumeration values in CapabilitiesSectionType. Added documentation of
 * WCSCapabilityType, DCPTypeType, CoverageOfferingBriefType, and AbstractDescriptionType. JDE
 * 2005/08/31 Changes made: AbstractDescriptionBaseType: made metadataLink repeatable This schema
 * defines the XML elements and types expected to be used by multiple OGC Web Services (OWSs). This
 * schema is believed to be a GML Application Schema. AEW 03/07/22 Changes made: Added
 * [xml:lang="en"] above Moved interpolationMethod and InterpolationMethodType here from
 * DescribeCoverage.xsd, because I know the WCTS will also use it. Added documentation elements in
 * InterpolationMethodType (JDE 2003-07-28) Added LonLatBoundingBox, TimeSequence, name and
 * description.
 *
 * <p>AEW 03/07/29 Changes made: Edited documentation of "keywords" element and various other parts
 *
 * <p>AEW 03/07/30 Changes made: Changed Substitution Group of lonLatEnvelope to gml:Envelope
 *
 * <p>JDE 03/07/30 Changes made: Removed the Substitution Group on lonLatEnvelope (we only want to
 * use it in the context of CoverageOfferingBrief) Added timeResolution to TimePeriodType
 *
 * <p>AEW 03/08/01 Changes made: In SupportedCRSsType, changed element name from NativeCRSs to
 * nativeCRSs Edited documentation of many types
 *
 * <p>AEW 04/07/17 Changes made: Changed fived value of srsName attribute in LonLatEnvelopeBaseType
 * to URN value in "ogc" URN namespace, based on OWS Common and OGC 05-010. Also, defined srsName
 * attribute as being anyURI type, and explicitly marked its use as optional. Modified definition of
 * wcs:name element to be in gml:name substitutionGroup. Modified definition of wcs:description
 * element to no longer be in gml:name substitutionGroup.
 *
 * <p>GML profile for WCS AEW 03/07/22 Changes made: Edited documentation of "name" element
 *
 * <p>JDE 2003-07-28: Added indeterminatePosition attribute to timePosition Added 11 new elements
 * and types from geometryBasic2d.xsd (to define Polygon, used in
 * CoverageDescription...SpatialDomain)
 *
 * <p>AEW 03/07/29 Changes made: Rearranged elements and types and inserted comments indicating the
 * GML schema from which groups of elements and types were copied or edited into this profile
 *
 * <p>JDE 2003-07-30 Added TimeDurationType This schema defines the values and enumeration elements
 * and types used by the OGC Web Coverage Service (WCS). JDE 2003-07-30 Removed empty "sequence"
 * from valueEnumType AEW 2005-07-15 Edited almost all documentation elements to remove TBRs and
 * TBDs and to make them clearer. However, I do not know enough to resolve the TBD in the
 * documentation of the "atomic" attribute in the valueRangeType. I also added documentation
 * elements where I thought they were needed.
 * <!-- end-model-doc -->
 *
...
public interface Wcs10Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AbstractDescriptionBaseTypeImpl
   * <em>Abstract Description Base Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int ABSTRACT_DESCRIPTION_BASE_TYPE__META_DATA_PROPERTY =
      GmlPackage.ABSTRACT_GML_TYPE__META_DATA_PROPERTY;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl
   * <em>Abstract Description Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int ABSTRACT_DESCRIPTION_TYPE__META_DATA_PROPERTY =
      ABSTRACT_DESCRIPTION_BASE_TYPE__META_DATA_PROPERTY;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AddressTypeImpl <em>Address
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl <em>Axis
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AxisDescriptionType1Impl <em>Axis
   * Description Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ValueEnumBaseTypeImpl <em>Value Enum
   * Base Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.AxisSubsetTypeImpl <em>Axis Subset
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ContactTypeImpl <em>Contact
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ContentMetadataTypeImpl <em>Content
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.CoverageDescriptionTypeImpl
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.CoverageOfferingBriefTypeImpl
   * <em>Coverage Offering Brief Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int COVERAGE_OFFERING_BRIEF_TYPE__META_DATA_PROPERTY =
      ABSTRACT_DESCRIPTION_TYPE__META_DATA_PROPERTY;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl <em>Coverage
   * Offering Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS =
      COVERAGE_OFFERING_BRIEF_TYPE_FEATURE_COUNT + 4;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DCPTypeTypeImpl <em>DCP Type
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl <em>Describe
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DescribeCoverageType1Impl
   * <em>Describe Coverage Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DocumentRootImpl <em>Document
   * Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DomainSetTypeImpl <em>Domain Set
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.DomainSubsetTypeImpl <em>Domain
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ExceptionTypeImpl <em>Exception
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl <em>Get
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.GetCapabilitiesType1Impl <em>Get
   * Capabilities Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.GetCoverageTypeImpl <em>Get Coverage
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.GetCoverageType1Impl <em>Get Coverage
   * Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.GetTypeImpl <em>Get Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.HTTPTypeImpl <em>HTTP Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ValueRangeTypeImpl <em>Value Range
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.IntervalTypeImpl <em>Interval
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.KeywordsTypeImpl <em>Keywords
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.LonLatEnvelopeBaseTypeImpl <em>Lon
   * Lat Envelope Base Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.LonLatEnvelopeTypeImpl <em>Lon Lat
   * Envelope Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.MetadataAssociationTypeImpl
   * <em>Metadata Association Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int METADATA_ASSOCIATION_TYPE__META_DATA_GROUP =
      GmlPackage.META_DATA_PROPERTY_TYPE__META_DATA_GROUP;
   ...
   * @ordered
   */
  int METADATA_ASSOCIATION_TYPE_FEATURE_COUNT =
      GmlPackage.META_DATA_PROPERTY_TYPE_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.MetadataLinkTypeImpl <em>Metadata
   * Link Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.OnlineResourceTypeImpl <em>Online
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.OutputTypeImpl <em>Output Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.PostTypeImpl <em>Post Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.RangeSetTypeImpl <em>Range Set
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.RangeSetType1Impl <em>Range Set
   * Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.RangeSubsetTypeImpl <em>Range Subset
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.RequestTypeImpl <em>Request
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ServiceTypeImpl <em>Service
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl <em>Spatial
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.SpatialSubsetTypeImpl <em>Spatial
   * Subset Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl <em>Supported
   * CR Ss Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.SupportedFormatsTypeImpl
   * <em>Supported Formats Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.SupportedInterpolationsTypeImpl
   * <em>Supported Interpolations Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.TelephoneTypeImpl <em>Telephone
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.TimePeriodTypeImpl <em>Time Period
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.TimeSequenceTypeImpl <em>Time
   * Sequence Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.TypedLiteralTypeImpl <em>Typed
   * Literal Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ValueEnumTypeImpl <em>Value Enum
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.ValuesTypeImpl <em>Values Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.VendorSpecificCapabilitiesTypeImpl
   * <em>Vendor Specific Capabilities Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl <em>WCS
   * Capabilities Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl <em>WCS
   * Capability Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link com.vividsolutions.jts.geom.Envelope <em>Envelope</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link org.geotools.geometry.GeneralEnvelope <em>General
   * Envelope</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.CapabilitiesSectionType <em>Capabilities
   * Section Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.InterpolationMethodType <em>Interpolation
   * Method Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs10.MetadataTypeType <em>Metadata Type
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AbstractDescriptionBaseType
   * <em>Abstract Description Base Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AbstractDescriptionType
   * <em>Abstract Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.AbstractDescriptionType#getMetadataLink <em>Metadata Link</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.AbstractDescriptionType#getDescription1 <em>Description1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AbstractDescriptionType#getName1 <em>Name1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AbstractDescriptionType#getLabel <em>Label</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AddressType <em>Address
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AddressType#getDeliveryPoint <em>Delivery Point</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.AddressType#getCity
   * <em>City</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AddressType#getAdministrativeArea <em>Administrative Area</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.AddressType#getPostalCode
   * <em>Postal Code</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.AddressType#getCountry
   * <em>Country</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AddressType#getElectronicMailAddress <em>Electronic Mail Address</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AxisDescriptionType <em>Axis
   * Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.AxisDescriptionType#getValues <em>Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AxisDescriptionType#getRefSys <em>Ref Sys</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AxisDescriptionType#getRefSysLabel <em>Ref Sys Label</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.AxisDescriptionType#getSemantic <em>Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AxisDescriptionType1 <em>Axis
   * Description Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.AxisDescriptionType1#getAxisDescription <em>Axis Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.AxisSubsetType <em>Axis Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.AxisSubsetType#getName
   * <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ContactType <em>Contact
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ContactType#getPhone <em>Phone</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ContactType#getAddress <em>Address</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ContactType#getOnlineResource <em>Online Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ContentMetadataType <em>Content
   * Metadata Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.ContentMetadataType#getCoverageOfferingBrief <em>Coverage Offering
   * Brief</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getActuate <em>Actuate</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getArcrole <em>Arcrole</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ContentMetadataType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getRemoteSchema <em>Remote Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ContentMetadataType#getRole
   * <em>Role</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ContentMetadataType#getShow
   * <em>Show</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getTitle <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ContentMetadataType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ContentMetadataType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.CoverageDescriptionType
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.CoverageDescriptionType#getCoverageOffering <em>Coverage Offering</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.CoverageDescriptionType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Update Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.CoverageDescriptionType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Version</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.CoverageOfferingBriefType
   * <em>Coverage Offering Brief Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat Envelope</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.CoverageOfferingBriefType#getKeywords <em>Keywords</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.CoverageOfferingType <em>Coverage
   * Offering Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingType#getDomainSet <em>Domain Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingType#getRangeSet <em>Range Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingType#getSupportedFormats <em>Supported Formats</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.CoverageOfferingType#getSupportedInterpolations <em>Supported
   * Interpolations</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DCPTypeType <em>DCP Type
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DCPTypeType#getHTTP <em>HTTP</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DescribeCoverageType <em>Describe
   * Coverage Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.DescribeCoverageType#getCoverage <em>Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.DescribeCoverageType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.DescribeCoverageType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Version</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.DescribeCoverageType#getBaseUrl <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.DescribeCoverageType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DescribeCoverageType1 <em>Describe
   * Coverage Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.DescribeCoverageType1#getDCPType <em>DCP Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wcs10.DocumentRoot#getMixed
   * <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wcs10.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wcs10.DocumentRoot#getXSISchemaLocation
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getAxisDescription <em>Axis Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Axis Description</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getAxisDescription1 <em>Axis Description1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getCapability <em>Capability</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getContentMetadata <em>Content Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getCoverageDescription <em>Coverage Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getCoverageOffering <em>Coverage Offering</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getCoverageOfferingBrief <em>Coverage Offering Brief</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getDescribeCoverage <em>Describe Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.DocumentRoot#getDescription
   * <em>Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getDomainSet <em>Domain Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Domain Set</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getFormats <em>Formats</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getGetCoverage <em>Get Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.DocumentRoot#getInterpolationMethod <em>Interpolation Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getInterval <em>Interval</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getKeywords <em>Keywords</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getLonLatEnvelope <em>Lon Lat Envelope</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Lon Lat Envelope</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getMetadataLink <em>Metadata Link</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.DocumentRoot#getName
   * <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getRangeSet <em>Range Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Range Set</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getRangeSet1 <em>Range Set1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSingleValue <em>Single Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSpatialDomain <em>Spatial Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSpatialSubset <em>Spatial Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSupportedCRSs <em>Supported CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported CR Ss</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSupportedFormats <em>Supported Formats</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported Formats</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getSupportedInterpolations <em>Supported Interpolations</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported Interpolations</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getTemporalDomain <em>Temporal Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getTemporalSubset <em>Temporal Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getTimePeriod <em>Time Period</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getTimeSequence <em>Time Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DocumentRoot#getWCSCapabilities <em>WCS Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.DocumentRoot#getClosure
   * <em>Closure</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.DocumentRoot#getSemantic
   * <em>Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.DocumentRoot#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DomainSetType <em>Domain Set
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSetType#getSpatialDomain <em>Spatial Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Spatial Domain</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSetType#getTemporalDomain <em>Temporal Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Temporal Domain</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSetType#getTemporalDomain1 <em>Temporal Domain1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.DomainSubsetType <em>Domain Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSubsetType#getSpatialSubset <em>Spatial Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Spatial Subset</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Temporal Subset</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.DomainSubsetType#getTemporalSubset1 <em>Temporal Subset1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ExceptionType <em>Exception
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ExceptionType#getFormat
   * <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.GetCapabilitiesType <em>Get
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getSection <em>Section</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Service</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Update Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Version</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Base Url</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCapabilitiesType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Extended Properties</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.GetCapabilitiesType1 <em>Get
   * Capabilities Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.GetCapabilitiesType1#getDCPType <em>DCP Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>DCP Type</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.GetCoverageType <em>Get Coverage
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCoverageType#getSourceCoverage <em>Source Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.GetCoverageType#getDomainSubset <em>Domain Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.GetCoverageType#getRangeSubset <em>Range Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCoverageType#getInterpolationMethod <em>Interpolation Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Interpolation Method</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.GetCoverageType#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.GetCoverageType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.GetCoverageType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.GetCoverageType#getBaseUrl
   * <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.GetCoverageType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Extended Properties</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.GetCoverageType1 <em>Get Coverage
   * Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.GetCoverageType1#getDCPType <em>DCP Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>DCP Type</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.GetType#getOnlineResource <em>Online Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Online Resource</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wcs10.HTTPType#getGroup
   * <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.HTTPType#getGet <em>Get</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.HTTPType#getPost <em>Post</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.IntervalType <em>Interval
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.IntervalType#getRes <em>Res</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.KeywordsType <em>Keywords
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.KeywordsType#getKeyword
   * <em>Keyword</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.KeywordsType#getType <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.LonLatEnvelopeBaseType <em>Lon Lat
   * Envelope Base Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.LonLatEnvelopeType <em>Lon Lat
   * Envelope Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.LonLatEnvelopeType#getTimePosition <em>Time Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.MetadataAssociationType
   * <em>Metadata Association Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.MetadataLinkType <em>Metadata Link
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.MetadataLinkType#getMetadataType <em>Metadata Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.OnlineResourceType <em>Online
   * Resource Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.OnlineResourceType#getActuate <em>Actuate</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Actuate</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.OnlineResourceType#getArcrole <em>Arcrole</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Arcrole</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.OnlineResourceType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.OnlineResourceType#getRole
   * <em>Role</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.OnlineResourceType#getShow
   * <em>Show</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.OnlineResourceType#getTitle
   * <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.OnlineResourceType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.OutputType#getCrs <em>Crs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.OutputType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.PostType#getOnlineResource <em>Online Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Online Resource</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.RangeSetType <em>Range Set
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.RangeSetType#getAxisDescription <em>Axis Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.RangeSetType#getNullValues <em>Null Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.RangeSetType#getRefSys
   * <em>Ref Sys</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.RangeSetType#getRefSysLabel
   * <em>Ref Sys Label</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.RangeSetType#getSemantic
   * <em>Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.RangeSetType1 <em>Range Set
   * Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.RangeSetType1#getRangeSet <em>Range Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Range Set</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.RangeSubsetType <em>Range Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.RangeSubsetType#getAxisSubset <em>Axis Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.RequestType <em>Request
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.RequestType#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Get Capabilities</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.RequestType#getDescribeCoverage <em>Describe Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Describe Coverage</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.RequestType#getGetCoverage <em>Get Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Get Coverage</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ResponsiblePartyType
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ResponsiblePartyType#getOrganisationName1 <em>Organisation Name1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ResponsiblePartyType#getPositionName <em>Position Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ServiceType <em>Service
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.ServiceType#getKeywords <em>Keywords</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Keywords</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ServiceType#getResponsibleParty <em>Responsible Party</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ServiceType#getFees <em>Fees</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.ServiceType#getAccessConstraints <em>Access Constraints</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.ServiceType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Update Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ServiceType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.SpatialDomainType <em>Spatial
   * Domain Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs10.SpatialDomainType#getEnvelope <em>Envelope</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs10.SpatialDomainType#getGridGroup <em>Grid Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SpatialDomainType#getGrid <em>Grid</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SpatialDomainType#getPolygon <em>Polygon</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.SpatialSubsetType <em>Spatial
   * Subset Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.SupportedCRSsType <em>Supported CR
   * Ss Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SupportedCRSsType#getRequestResponseCRSs <em>Request Response CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SupportedCRSsType#getRequestCRSs <em>Request CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SupportedCRSsType#getResponseCRSs <em>Response CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SupportedCRSsType#getNativeCRSs <em>Native CR Ss</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.SupportedFormatsType <em>Supported
   * Formats Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.SupportedFormatsType#getFormats <em>Formats</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.SupportedFormatsType#getNativeFormat <em>Native Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.SupportedInterpolationsType
   * <em>Supported Interpolations Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.SupportedInterpolationsType#getInterpolationMethod <em>Interpolation
   * Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.SupportedInterpolationsType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.TelephoneType <em>Telephone
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.TelephoneType#getVoice
   * <em>Voice</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.TelephoneType#getFacsimile
   * <em>Facsimile</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.TimePeriodType <em>Time Period
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.TimePeriodType#getBeginPosition <em>Begin Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.TimePeriodType#getEndPosition <em>End Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.TimePeriodType#getTimeResolution <em>Time Resolution</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.TimePeriodType#getFrame
   * <em>Frame</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.TimeSequenceType <em>Time Sequence
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs10.TimeSequenceType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.TimeSequenceType#getTimePosition <em>Time Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Time Position</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.TimeSequenceType#getTimePeriod <em>Time Period</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.TypedLiteralType <em>Typed Literal
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.TypedLiteralType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.TypedLiteralType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ValueEnumBaseType <em>Value Enum
   * Base Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs10.ValueEnumBaseType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.ValueEnumBaseType#getInterval <em>Interval</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs10.ValueEnumBaseType#getSingleValue <em>Single Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ValueEnumType <em>Value Enum
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueEnumType#getSemantic
   * <em>Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueEnumType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.ValueRangeType <em>Value Range
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ValueRangeType#getMin <em>Min</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ValueRangeType#getMax <em>Max</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueRangeType#isAtomic
   * <em>Atomic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueRangeType#getClosure
   * <em>Closure</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueRangeType#getSemantic
   * <em>Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs10.ValueRangeType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.ValuesType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.VendorSpecificCapabilitiesType
   * <em>Vendor Specific Capabilities Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs10.VendorSpecificCapabilitiesType#getAny <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.WCSCapabilitiesType <em>WCS
   * Capabilities Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Service</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilitiesType#getCapability <em>Capability</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Capability</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilitiesType#getContentMetadata <em>Content Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Content Metadata</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.WCSCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Update Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.WCSCapabilitiesType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Version</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs10.WCSCapabilityType <em>WCS
   * Capability Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilityType#getRequest <em>Request</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilityType#getException <em>Exception</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs10.WCSCapabilityType#getVendorSpecificCapabilities <em>Vendor Specific
   * Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.WCSCapabilityType#getUpdateSequence <em>Update Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Update Sequence</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs10.WCSCapabilityType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Version</em>'.
  ...
  /**
   * Returns the meta object for class '{@link com.vividsolutions.jts.geom.Envelope
   * <em>Envelope</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link org.geotools.geometry.GeneralEnvelope <em>General
   * Envelope</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wcs10.CapabilitiesSectionType
   * <em>Capabilities Section Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wcs10.InterpolationMethodType
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wcs10.MetadataTypeType <em>Metadata Type
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wcs10.CapabilitiesSectionType
   * <em>Capabilities Section Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wcs10.ClosureType <em>Closure Type
   * Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wcs10.InterpolationMethodType
   * <em>Interpolation Method Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wcs10.MetadataTypeType <em>Metadata
   * Type Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  interface Literals {
     ...
     * net.opengis.wcs10.impl.AbstractDescriptionBaseTypeImpl <em>Abstract Description Base
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.AbstractDescriptionTypeImpl
     * <em>Abstract Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Metadata Link</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference ABSTRACT_DESCRIPTION_TYPE__METADATA_LINK =
        eINSTANCE.getAbstractDescriptionType_MetadataLink();
     ...
     * @generated
     */
    EAttribute ABSTRACT_DESCRIPTION_TYPE__DESCRIPTION1 =
        eINSTANCE.getAbstractDescriptionType_Description1();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.AddressTypeImpl <em>Address
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.AxisDescriptionTypeImpl
     * <em>Axis Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.AxisDescriptionTypeImpl
     ...
     * @generated
     */
    EAttribute AXIS_DESCRIPTION_TYPE__REF_SYS_LABEL =
        eINSTANCE.getAxisDescriptionType_RefSysLabel();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.AxisDescriptionType1Impl
     * <em>Axis Description Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.AxisDescriptionType1Impl
    ...
    /**
     * The meta object literal for the '<em><b>Axis Description</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION =
        eINSTANCE.getAxisDescriptionType1_AxisDescription();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.AxisSubsetTypeImpl <em>Axis
     * Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ContactTypeImpl <em>Contact
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ContentMetadataTypeImpl
     * <em>Content Metadata Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.ContentMetadataTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Coverage Offering Brief</b></em>' containment
     ...
     * @generated
     */
    EReference CONTENT_METADATA_TYPE__COVERAGE_OFFERING_BRIEF =
        eINSTANCE.getContentMetadataType_CoverageOfferingBrief();
     ...
     * @generated
     */
    EAttribute CONTENT_METADATA_TYPE__REMOTE_SCHEMA =
        eINSTANCE.getContentMetadataType_RemoteSchema();
     ...
     * @generated
     */
    EAttribute CONTENT_METADATA_TYPE__UPDATE_SEQUENCE =
        eINSTANCE.getContentMetadataType_UpdateSequence();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.CoverageDescriptionTypeImpl
     * <em>Coverage Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Coverage Offering</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference COVERAGE_DESCRIPTION_TYPE__COVERAGE_OFFERING =
        eINSTANCE.getCoverageDescriptionType_CoverageOffering();
     ...
     * @generated
     */
    EAttribute COVERAGE_DESCRIPTION_TYPE__UPDATE_SEQUENCE =
        eINSTANCE.getCoverageDescriptionType_UpdateSequence();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.CoverageOfferingBriefTypeImpl
     * <em>Coverage Offering Brief Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Lon Lat Envelope</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference COVERAGE_OFFERING_BRIEF_TYPE__LON_LAT_ENVELOPE =
        eINSTANCE.getCoverageOfferingBriefType_LonLatEnvelope();
     ...
     * @generated
     */
    EReference COVERAGE_OFFERING_BRIEF_TYPE__KEYWORDS =
        eINSTANCE.getCoverageOfferingBriefType_Keywords();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.CoverageOfferingTypeImpl
     * <em>Coverage Offering Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.CoverageOfferingTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Supported CR Ss</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS =
        eINSTANCE.getCoverageOfferingType_SupportedCRSs();

    /**
     * The meta object literal for the '<em><b>Supported Formats</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS =
        eINSTANCE.getCoverageOfferingType_SupportedFormats();

    /**
     * The meta object literal for the '<em><b>Supported Interpolations</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS =
        eINSTANCE.getCoverageOfferingType_SupportedInterpolations();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DCPTypeTypeImpl <em>DCP Type
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DescribeCoverageTypeImpl
     ...
     * @generated
     */
    EAttribute DESCRIBE_COVERAGE_TYPE__EXTENDED_PROPERTIES =
        eINSTANCE.getDescribeCoverageType_ExtendedProperties();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DescribeCoverageType1Impl
     * <em>Describe Coverage Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>DCP Type</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DocumentRootImpl <em>Document
     * Root</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Axis Description1</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Content Metadata</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__COVERAGE_OFFERING_BRIEF =
        eINSTANCE.getDocumentRoot_CoverageOfferingBrief();
     ...
     * @generated
     */
    EAttribute DOCUMENT_ROOT__INTERPOLATION_METHOD =
        eINSTANCE.getDocumentRoot_InterpolationMethod();
    ...
    /**
     * The meta object literal for the '<em><b>Metadata Link</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Spatial Domain</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Spatial Subset</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__SUPPORTED_INTERPOLATIONS =
        eINSTANCE.getDocumentRoot_SupportedInterpolations();

    /**
     * The meta object literal for the '<em><b>Temporal Domain</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Temporal Subset</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Time Sequence</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>WCS Capabilities</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DomainSetTypeImpl <em>Domain
     * Set Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Temporal Domain1</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.DomainSubsetTypeImpl
     * <em>Domain Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.DomainSubsetTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Temporal Subset1</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1 =
        eINSTANCE.getDomainSubsetType_TemporalSubset1();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ExceptionTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.GetCapabilitiesTypeImpl
     ...
     * @generated
     */
    EAttribute GET_CAPABILITIES_TYPE__EXTENDED_PROPERTIES =
        eINSTANCE.getGetCapabilitiesType_ExtendedProperties();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.GetCapabilitiesType1Impl
     * <em>Get Capabilities Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.GetCapabilitiesType1Impl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.GetCoverageTypeImpl <em>Get
     * Coverage Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Domain Subset</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute GET_COVERAGE_TYPE__INTERPOLATION_METHOD =
        eINSTANCE.getGetCoverageType_InterpolationMethod();
     ...
     * @generated
     */
    EAttribute GET_COVERAGE_TYPE__EXTENDED_PROPERTIES =
        eINSTANCE.getGetCoverageType_ExtendedProperties();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.GetCoverageType1Impl <em>Get
     * Coverage Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.GetCoverageType1Impl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.GetTypeImpl <em>Get
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.HTTPTypeImpl <em>HTTP
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.IntervalTypeImpl <em>Interval
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.KeywordsTypeImpl <em>Keywords
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.LonLatEnvelopeBaseTypeImpl
     * <em>Lon Lat Envelope Base Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.LonLatEnvelopeBaseTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.LonLatEnvelopeTypeImpl <em>Lon
     * Lat Envelope Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.LonLatEnvelopeTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Time Position</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference LON_LAT_ENVELOPE_TYPE__TIME_POSITION =
        eINSTANCE.getLonLatEnvelopeType_TimePosition();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.MetadataAssociationTypeImpl
     * <em>Metadata Association Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.MetadataLinkTypeImpl
     * <em>Metadata Link Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.MetadataLinkTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.OnlineResourceTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.OutputTypeImpl <em>Output
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.PostTypeImpl <em>Post
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.RangeSetTypeImpl <em>Range Set
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Axis Description</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.RangeSetType1Impl <em>Range
     * Set Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.RangeSubsetTypeImpl <em>Range
     * Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Axis Subset</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.RequestTypeImpl <em>Request
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ResponsiblePartyTypeImpl
     * <em>Responsible Party Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME1 =
        eINSTANCE.getResponsiblePartyType_OrganisationName1();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ServiceTypeImpl <em>Service
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Responsible Party</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Access Constraints</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl
     * <em>Spatial Domain Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.SpatialDomainTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.SpatialSubsetTypeImpl
     * <em>Spatial Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.SpatialSubsetTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.SupportedCRSsTypeImpl
     * <em>Supported CR Ss Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.SupportedCRSsTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Request Response CR Ss</b></em>' containment
     * reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference SUPPORTED_CR_SS_TYPE__REQUEST_RESPONSE_CR_SS =
        eINSTANCE.getSupportedCRSsType_RequestResponseCRSs();

    /**
     * The meta object literal for the '<em><b>Request CR Ss</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Response CR Ss</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Native CR Ss</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.SupportedFormatsTypeImpl
     * <em>Supported Formats Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute SUPPORTED_FORMATS_TYPE__NATIVE_FORMAT =
        eINSTANCE.getSupportedFormatsType_NativeFormat();

    /**
     * The meta object literal for the '{@link
     * net.opengis.wcs10.impl.SupportedInterpolationsTypeImpl <em>Supported Interpolations
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute SUPPORTED_INTERPOLATIONS_TYPE__INTERPOLATION_METHOD =
        eINSTANCE.getSupportedInterpolationsType_InterpolationMethod();
     ...
     * @generated
     */
    EAttribute SUPPORTED_INTERPOLATIONS_TYPE__DEFAULT =
        eINSTANCE.getSupportedInterpolationsType_Default();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.TelephoneTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.TimePeriodTypeImpl <em>Time
     * Period Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.TimePeriodTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Begin Position</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.TimeSequenceTypeImpl <em>Time
     * Sequence Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Time Period</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.TypedLiteralTypeImpl <em>Typed
     * Literal Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ValueEnumBaseTypeImpl
     * <em>Value Enum Base Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.ValueEnumBaseTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Interval</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Single Value</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ValueEnumTypeImpl <em>Value
     * Enum Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ValueRangeTypeImpl <em>Value
     * Range Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.ValuesTypeImpl <em>Values
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link
     * net.opengis.wcs10.impl.VendorSpecificCapabilitiesTypeImpl <em>Vendor Specific Capabilities
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute VENDOR_SPECIFIC_CAPABILITIES_TYPE__ANY =
        eINSTANCE.getVendorSpecificCapabilitiesType_Any();

    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl
     * <em>WCS Capabilities Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.impl.WCSCapabilitiesTypeImpl
     ...
     * @generated
     */
    EReference WCS_CAPABILITIES_TYPE__CONTENT_METADATA =
        eINSTANCE.getWCSCapabilitiesType_ContentMetadata();
     ...
     * @generated
     */
    EAttribute WCS_CAPABILITIES_TYPE__UPDATE_SEQUENCE =
        eINSTANCE.getWCSCapabilitiesType_UpdateSequence();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.impl.WCSCapabilityTypeImpl <em>WCS
     * Capability Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Vendor Specific Capabilities</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference WCS_CAPABILITY_TYPE__VENDOR_SPECIFIC_CAPABILITIES =
        eINSTANCE.getWCSCapabilityType_VendorSpecificCapabilities();
     ...
     * @generated
     */
    EAttribute WCS_CAPABILITY_TYPE__UPDATE_SEQUENCE =
        eINSTANCE.getWCSCapabilityType_UpdateSequence();
    ...
    /**
     * The meta object literal for the '{@link com.vividsolutions.jts.geom.Envelope
     * <em>Envelope</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see com.vividsolutions.jts.geom.Envelope
    ...
    /**
     * The meta object literal for the '{@link org.geotools.geometry.GeneralEnvelope <em>General
     * Envelope</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.CapabilitiesSectionType
     * <em>Capabilities Section Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.CapabilitiesSectionType
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.ClosureType <em>Closure Type</em>}'
     * enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.InterpolationMethodType
     * <em>Interpolation Method Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs10.InterpolationMethodType
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs10.MetadataTypeType <em>Metadata Type
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
