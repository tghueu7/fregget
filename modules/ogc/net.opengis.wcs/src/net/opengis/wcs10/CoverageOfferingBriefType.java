 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs10.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat
 *       Envelope</em>}
 *   <li>{@link net.opengis.wcs10.CoverageOfferingBriefType#getKeywords <em>Keywords</em>}
 * </ul>
 *
...
public interface CoverageOfferingBriefType extends AbstractDescriptionType {
   ...
   *     name='lonLatEnvelope' namespace='##targetNamespace'"
   * @generated
   */
  LonLatEnvelopeType getLonLatEnvelope();

  /**
   * Sets the value of the '{@link net.opengis.wcs10.CoverageOfferingBriefType#getLonLatEnvelope
   * <em>Lon Lat Envelope</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
