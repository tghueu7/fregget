...
public class GmlPackageImpl extends EPackageImpl implements GmlPackage {
  ...
  public static GmlPackage init() {
    ...
    GmlPackageImpl theGmlPackage =
        (GmlPackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GmlPackageImpl
  ...
  public void createPackageContents() {
    ...
    createEReference(
        envelopeWithTimePeriodTypeEClass, ENVELOPE_WITH_TIME_PERIOD_TYPE__TIME_POSITION);
    ...
    timeIndeterminateValueTypeObjectEDataType =
        createEDataType(TIME_INDETERMINATE_VALUE_TYPE_OBJECT);
  ...
  public void initializePackageContents() {
    ...
    initEClass(
        ...
        AbstractGeometryBaseType.class,
    ...
    initEClass(
        ...
        AbstractRingPropertyType.class,
    ...
    initEReference(
        ...
        this.getAbstractGeometricPrimitiveType(),
        null,
        "geometricPrimitive",
        null,
        0,
    ...
    initEReference(
        ...
        this.getEnvelopeWithTimePeriodType(),
        null,
    ...
    initEReference(
        ...
        this.getAbstractRingPropertyType(),
        null,
        "exterior",
        null,
        0,
    ...
    initEAttribute(
        ...
        this.getTimeIndeterminateValueType(),
    ...
    initEEnum(
        ...
        TimeIndeterminateValueType.class,
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        nameListEDataType, List.class, "NameList", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(
        timeIndeterminateValueTypeEEnum,
        source,
        new String[] {"name", "TimeIndeterminateValueType"});
    addAnnotation(
        doubleListEDataType,
        source,
        new String[] {
    ...
    addAnnotation(
        ...
        new String[] {
          ...
          "memberTypes",
              "http://www.eclipse.org/emf/2003/XMLType#dateTime http://www.eclipse.org/emf/2003/XMLType#date http://www.eclipse.org/emf/2003/XMLType#gYearMonth http://www.eclipse.org/emf/2003/XMLType#gYear http://www.eclipse.org/emf/2003/XMLType#anyURI http://www.eclipse.org/emf/2003/XMLType#decimal"
        });
    addAnnotation(
        timeDurationTypeEDataType,
        source,
