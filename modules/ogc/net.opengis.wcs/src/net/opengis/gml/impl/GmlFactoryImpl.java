...
public class GmlFactoryImpl extends EFactoryImpl implements GmlFactory {
  ...
  public static GmlFactory init() {
    try {
      GmlFactory theGmlFactory =
          (GmlFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/gml");
  ...
  public List createDoubleListFromString(EDataType eDataType, String initialValue) {
    ...
    for (StringTokenizer stringTokenizer = new StringTokenizer(initialValue);
  ...
  public String convertDoubleListToString(EDataType eDataType, Object instanceValue) {
    ...
    for (Iterator i = list.iterator(); i.hasNext(); ) {
      result.append(
          XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.DOUBLE, i.next()));
      result.append(' ');
    }
  ...
  public String convertIntegerListToString(EDataType eDataType, Object instanceValue) {
    ...
    for (Iterator i = list.iterator(); i.hasNext(); ) {
      result.append(
          XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.INTEGER, i.next()));
      result.append(' ');
    }
    return result.substring(0, result.length() - 1);
  }
  ...
  public String convertNameListToString(EDataType eDataType, Object instanceValue) {
    ...
    for (Iterator i = list.iterator(); i.hasNext(); ) {
      result.append(
          XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.NAME, i.next()));
      result.append(' ');
    }
    return result.substring(0, result.length() - 1);
  }
  ...
  public Object createTemporalPositionTypeFromString(EDataType eDataType, String initialValue) {
    ...
    try {
      result =
          XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.GYEAR, initialValue);
      if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
        return result;
      }
    } catch (RuntimeException e) {
  ...
  public Object createTimeDurationTypeFromString(EDataType eDataType, String initialValue) {
    ...
    try {
      result =
          XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.DURATION, initialValue);
      if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
        return result;
      }
    } catch (RuntimeException e) {
  ...
  public String convertTimeDurationTypeToString(EDataType eDataType, Object instanceValue) {
    ...
    if (XMLTypePackage.Literals.DURATION.isInstance(instanceValue)) {
      try {
        String value =
            XMLTypeFactory.eINSTANCE.convertToString(
                XMLTypePackage.Literals.DURATION, instanceValue);
        if (value != null) return value;
      } catch (Exception e) {
        // Keep trying other member types until all have failed.
      }
  ...
  public TimeIndeterminateValueType createTimeIndeterminateValueTypeObjectFromString(
    ...
    return createTimeIndeterminateValueTypeFromString(
        GmlPackage.Literals.TIME_INDETERMINATE_VALUE_TYPE, initialValue);
  }
  ...
  public String convertTimeIndeterminateValueTypeObjectToString(
    ...
    return convertTimeIndeterminateValueTypeToString(
        GmlPackage.Literals.TIME_INDETERMINATE_VALUE_TYPE, instanceValue);
  }
