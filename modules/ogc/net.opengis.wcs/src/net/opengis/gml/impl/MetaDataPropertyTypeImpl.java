 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getMetaDataGroup <em>Meta Data
 *       Group</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getMetaData <em>Meta Data</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getAbout <em>About</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml.impl.MetaDataPropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class MetaDataPropertyTypeImpl extends EObjectImpl implements MetaDataPropertyType {
  ...
  public FeatureMap getMetaDataGroup() {
    if (metaDataGroup == null) {
      metaDataGroup =
          new BasicFeatureMap(this, GmlPackage.META_DATA_PROPERTY_TYPE__META_DATA_GROUP);
    }
  ...
  public AbstractMetaDataType getMetaData() {
    return (AbstractMetaDataType)
        getMetaDataGroup().get(GmlPackage.Literals.META_DATA_PROPERTY_TYPE__META_DATA, true);
  }
  ...
  public NotificationChain basicSetMetaData(
    ...
    return ((FeatureMap.Internal) getMetaDataGroup())
        .basicAdd(GmlPackage.Literals.META_DATA_PROPERTY_TYPE__META_DATA, newMetaData, msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.META_DATA_PROPERTY_TYPE__ABOUT, oldAbout, about));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.META_DATA_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.META_DATA_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.META_DATA_PROPERTY_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.META_DATA_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.META_DATA_PROPERTY_TYPE__ROLE, oldRole, role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.META_DATA_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.META_DATA_PROPERTY_TYPE__TITLE, oldTitle, title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.META_DATA_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
