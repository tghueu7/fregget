 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.RectifiedGridTypeImpl#getOrigin <em>Origin</em>}
 *   <li>{@link net.opengis.gml.impl.RectifiedGridTypeImpl#getOffsetVector <em>Offset Vector</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.RECTIFIED_GRID_TYPE__ORIGIN, oldOrigin, newOrigin);
    ...
    if (newOrigin != origin) {
      ...
      if (origin != null)
        msgs =
            ((InternalEObject) origin)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - GmlPackage.RECTIFIED_GRID_TYPE__ORIGIN,
                    null,
                    msgs);
      if (newOrigin != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.RECTIFIED_GRID_TYPE__ORIGIN,
              newOrigin,
              newOrigin));
  }
    ...
    if (offsetVector == null) {
      offsetVector =
          new EObjectResolvingEList(
              VectorType.class, this, GmlPackage.RECTIFIED_GRID_TYPE__OFFSET_VECTOR);
    }
    return offsetVector;
  }
