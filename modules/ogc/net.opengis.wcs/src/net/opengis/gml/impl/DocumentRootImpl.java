 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema
 *       Location</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getGeometricPrimitive <em>Geometric
 *       Primitive</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getGeometry <em>Geometry</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getGML <em>GML</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getObject <em>Object</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getMetaData <em>Meta Data</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getRing <em>Ring</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getSurface <em>Surface</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getBoundedBy <em>Bounded By</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getEnvelope <em>Envelope</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getEnvelopeWithTimePeriod <em>Envelope With
 *       Time Period</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getGrid <em>Grid</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getInterior <em>Interior</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getLinearRing <em>Linear Ring</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getMetaDataProperty <em>Meta Data
 *       Property</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getPolygon <em>Polygon</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getRectifiedGrid <em>Rectified Grid</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getTimePosition <em>Time Position</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getId <em>Id</em>}
 *   <li>{@link net.opengis.gml.impl.DocumentRootImpl#getRemoteSchema <em>Remote Schema</em>}
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap =
          new EcoreEMap(
              ...
              this,
              GmlPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
    ...
    if (xSISchemaLocation == null) {
      xSISchemaLocation =
          new EcoreEMap(
              ...
              EStringToStringMapEntryImpl.class,
              this,
              GmlPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public AbstractGeometricPrimitiveType getGeometricPrimitive() {
    return (AbstractGeometricPrimitiveType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__GEOMETRIC_PRIMITIVE, true);
  }
  ...
  public NotificationChain basicSetGeometricPrimitive(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            GmlPackage.Literals.DOCUMENT_ROOT__GEOMETRIC_PRIMITIVE, newGeometricPrimitive, msgs);
  }
  ...
  public NotificationChain basicSetGeometry(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__GEOMETRY, newGeometry, msgs);
  }
  ...
  public NotificationChain basicSetGML(AbstractGMLType newGML, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__GML, newGML, msgs);
  }
  ...
  public NotificationChain basicSetObject(EObject newObject, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__OBJECT, newObject, msgs);
  }
  ...
  public AbstractMetaDataType getMetaData() {
    return (AbstractMetaDataType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__META_DATA, true);
  }
  ...
  public NotificationChain basicSetMetaData(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__META_DATA, newMetaData, msgs);
  }
  ...
  public NotificationChain basicSetRing(AbstractRingType newRing, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__RING, newRing, msgs);
  }
  ...
  public NotificationChain basicSetSurface(AbstractSurfaceType newSurface, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__SURFACE, newSurface, msgs);
  }
  ...
  public NotificationChain basicSetBoundedBy(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__BOUNDED_BY, newBoundedBy, msgs);
  }
  ...
  public void setBoundedBy(BoundingShapeType newBoundedBy) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__BOUNDED_BY, newBoundedBy);
  }
  ...
  public NotificationChain basicSetDescription(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__DESCRIPTION, newDescription, msgs);
  }
  ...
  public void setDescription(StringOrRefType newDescription) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__DESCRIPTION, newDescription);
  }
  ...
  public NotificationChain basicSetEnvelope(EnvelopeType newEnvelope, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__ENVELOPE, newEnvelope, msgs);
  }
  ...
  public void setEnvelope(EnvelopeType newEnvelope) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__ENVELOPE, newEnvelope);
  }
  ...
  public EnvelopeWithTimePeriodType getEnvelopeWithTimePeriod() {
    return (EnvelopeWithTimePeriodType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__ENVELOPE_WITH_TIME_PERIOD, true);
  }
  ...
  public NotificationChain basicSetEnvelopeWithTimePeriod(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            GmlPackage.Literals.DOCUMENT_ROOT__ENVELOPE_WITH_TIME_PERIOD,
  ...
  public AbstractRingPropertyType getExterior() {
    return (AbstractRingPropertyType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__EXTERIOR, true);
  }
  ...
  public NotificationChain basicSetExterior(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__EXTERIOR, newExterior, msgs);
  }
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__EXTERIOR, newExterior);
  }
  ...
  public NotificationChain basicSetGrid(GridType newGrid, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__GRID, newGrid, msgs);
  }
  ...
  public AbstractRingPropertyType getInterior() {
    return (AbstractRingPropertyType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__INTERIOR, true);
  }
  ...
  public NotificationChain basicSetInterior(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__INTERIOR, newInterior, msgs);
  }
  ...
  public void setInterior(AbstractRingPropertyType newInterior) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__INTERIOR, newInterior);
  }
  ...
  public NotificationChain basicSetLinearRing(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__LINEAR_RING, newLinearRing, msgs);
  }
  ...
  public void setLinearRing(LinearRingType newLinearRing) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__LINEAR_RING, newLinearRing);
  }
  ...
  public MetaDataPropertyType getMetaDataProperty() {
    return (MetaDataPropertyType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__META_DATA_PROPERTY, true);
  }
  ...
  public NotificationChain basicSetMetaDataProperty(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__META_DATA_PROPERTY, newMetaDataProperty, msgs);
  }
  ...
  public void setMetaDataProperty(MetaDataPropertyType newMetaDataProperty) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__META_DATA_PROPERTY, newMetaDataProperty);
  }
  ...
  public NotificationChain basicSetName(CodeType newName, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__NAME, newName, msgs);
  }
  ...
  public NotificationChain basicSetPolygon(PolygonType newPolygon, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__POLYGON, newPolygon, msgs);
  }
  ...
  public NotificationChain basicSetPos(DirectPositionType newPos, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__POS, newPos, msgs);
  }
  ...
  public RectifiedGridType getRectifiedGrid() {
    return (RectifiedGridType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__RECTIFIED_GRID, true);
  }
  ...
  public NotificationChain basicSetRectifiedGrid(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__RECTIFIED_GRID, newRectifiedGrid, msgs);
  }
  ...
  public void setRectifiedGrid(RectifiedGridType newRectifiedGrid) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__RECTIFIED_GRID, newRectifiedGrid);
  }
  ...
  public TimePositionType getTimePosition() {
    return (TimePositionType)
        getMixed().get(GmlPackage.Literals.DOCUMENT_ROOT__TIME_POSITION, true);
  }
  ...
  public NotificationChain basicSetTimePosition(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(GmlPackage.Literals.DOCUMENT_ROOT__TIME_POSITION, newTimePosition, msgs);
  }
  ...
  public void setTimePosition(TimePositionType newTimePosition) {
    ((FeatureMap.Internal) getMixed())
        .set(GmlPackage.Literals.DOCUMENT_ROOT__TIME_POSITION, newTimePosition);
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, GmlPackage.DOCUMENT_ROOT__ID, oldId, id));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.DOCUMENT_ROOT__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
