 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.TimePositionTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml.impl.TimePositionTypeImpl#getCalendarEraName <em>Calendar Era
 *       Name</em>}
 *   <li>{@link net.opengis.gml.impl.TimePositionTypeImpl#getFrame <em>Frame</em>}
 *   <li>{@link net.opengis.gml.impl.TimePositionTypeImpl#getIndeterminatePosition <em>Indeterminate
 *       Position</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.TIME_POSITION_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.TIME_POSITION_TYPE__CALENDAR_ERA_NAME,
              oldCalendarEraName,
              calendarEraName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.TIME_POSITION_TYPE__FRAME,
              oldFrame,
              frame,
              !oldFrameESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GmlPackage.TIME_POSITION_TYPE__INDETERMINATE_POSITION,
