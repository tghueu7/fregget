 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.PolygonTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml.impl.PolygonTypeImpl#getInterior <em>Interior</em>}
 * </ul>
 *
 * @generated
 */
public class PolygonTypeImpl extends AbstractSurfaceTypeImpl implements PolygonType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.POLYGON_TYPE__EXTERIOR, oldExterior, newExterior);
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    if (newExterior != exterior) {
      ...
      if (exterior != null)
        msgs =
            ((InternalEObject) exterior)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - GmlPackage.POLYGON_TYPE__EXTERIOR, null, msgs);
      if (newExterior != null)
        msgs =
            ((InternalEObject) newExterior)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - GmlPackage.POLYGON_TYPE__EXTERIOR, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GmlPackage.POLYGON_TYPE__EXTERIOR, newExterior, newExterior));
  }
    ...
    if (interior == null) {
      interior =
          new EObjectContainmentEList(
              AbstractRingPropertyType.class, this, GmlPackage.POLYGON_TYPE__INTERIOR);
    }
    return interior;
  }
