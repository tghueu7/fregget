 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.impl.BoundingShapeTypeImpl#getEnvelopeGroup <em>Envelope Group</em>}
 *   <li>{@link net.opengis.gml.impl.BoundingShapeTypeImpl#getEnvelope <em>Envelope</em>}
 * </ul>
 *
 * @generated
 */
public class BoundingShapeTypeImpl extends EObjectImpl implements BoundingShapeType {
  ...
  public EnvelopeType getEnvelope() {
    return (EnvelopeType)
        getEnvelopeGroup().get(GmlPackage.Literals.BOUNDING_SHAPE_TYPE__ENVELOPE, true);
  }
  ...
  public NotificationChain basicSetEnvelope(EnvelopeType newEnvelope, NotificationChain msgs) {
    return ((FeatureMap.Internal) getEnvelopeGroup())
        .basicAdd(GmlPackage.Literals.BOUNDING_SHAPE_TYPE__ENVELOPE, newEnvelope, msgs);
  }
  ...
  public void setEnvelope(EnvelopeType newEnvelope) {
    ((FeatureMap.Internal) getEnvelopeGroup())
        .set(GmlPackage.Literals.BOUNDING_SHAPE_TYPE__ENVELOPE, newEnvelope);
  }
