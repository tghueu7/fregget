...
public class GmlValidator extends EObjectValidator {
  ...
  protected boolean validate(
    ...
    switch (classifierID) {
      ...
      case GmlPackage.ABSTRACT_GEOMETRY_BASE_TYPE:
        return validateAbstractGeometryBaseType(
            (AbstractGeometryBaseType) value, diagnostics, context);
   ...
   * @generated
   */
  public boolean validateAbstractGeometryBaseType(
      AbstractGeometryBaseType abstractGeometryBaseType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateAbstractGMLType(
      AbstractGMLType abstractGMLType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateCodeListType(
      CodeListType codeListType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateGridLimitsType(
      GridLimitsType gridLimitsType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateDoubleList_ItemType(
      List doubleList, DiagnosticChain diagnostics, Map context) {
    boolean result = true;
  ...
  public boolean validateIntegerList_ItemType(
      List integerList, DiagnosticChain diagnostics, Map context) {
    boolean result = true;
  ...
  public boolean validateNameList_ItemType(
      List nameList, DiagnosticChain diagnostics, Map context) {
    boolean result = true;
   ...
   * @generated
   */
  public boolean validateTemporalPositionType(
      Object temporalPositionType, DiagnosticChain diagnostics, Map context) {
    boolean result =
        validateTemporalPositionType_MemberTypes(temporalPositionType, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateTemporalPositionType_MemberTypes(
      Object temporalPositionType, DiagnosticChain diagnostics, Map context) {
    if (diagnostics != null) {
      BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
      if (XMLTypePackage.Literals.DATE_TIME.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateDateTime(temporalPositionType, tempDiagnostics, context))
          return true;
      }
      if (XMLTypePackage.Literals.DATE.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateDate(temporalPositionType, tempDiagnostics, context))
          return true;
      }
      if (XMLTypePackage.Literals.GYEAR_MONTH.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateGYearMonth(temporalPositionType, tempDiagnostics, context))
          return true;
      }
      if (XMLTypePackage.Literals.GYEAR.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateGYear(temporalPositionType, tempDiagnostics, context))
          return true;
      }
      if (XMLTypePackage.Literals.ANY_URI.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateAnyURI(
            (String) temporalPositionType, tempDiagnostics, context)) return true;
      }
      if (XMLTypePackage.Literals.DECIMAL.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateDecimal(
            (BigDecimal) temporalPositionType, tempDiagnostics, context)) return true;
      }
      ...
      if (XMLTypePackage.Literals.ANY_URI.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateAnyURI((String) temporalPositionType, null, context))
          return true;
      }
      if (XMLTypePackage.Literals.DECIMAL.isInstance(temporalPositionType)) {
        if (xmlTypeValidator.validateDecimal((BigDecimal) temporalPositionType, null, context))
          return true;
      }
    }
    return false;
   ...
   * @generated
   */
  public boolean validateTimeDurationType(
      Object timeDurationType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateTimeDurationType_MemberTypes(
      Object timeDurationType, DiagnosticChain diagnostics, Map context) {
    if (diagnostics != null) {
      BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
      if (XMLTypePackage.Literals.DURATION.isInstance(timeDurationType)) {
        if (xmlTypeValidator.validateDuration(timeDurationType, tempDiagnostics, context))
          return true;
      }
      if (XMLTypePackage.Literals.DECIMAL.isInstance(timeDurationType)) {
        if (xmlTypeValidator.validateDecimal(
            (BigDecimal) timeDurationType, tempDiagnostics, context)) return true;
      }
      List children = tempDiagnostics.getChildren();
      for (int i = 0; i < children.size(); i++) {
        diagnostics.add((Diagnostic) children.get(i));
      ...
      if (XMLTypePackage.Literals.DECIMAL.isInstance(timeDurationType)) {
        if (xmlTypeValidator.validateDecimal((BigDecimal) timeDurationType, null, context))
          return true;
      }
    }
    return false;
   ...
   * @generated
   */
  public boolean validateVectorTypeBase(
      List vectorTypeBase, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateGridEnvelope(
      GridEnvelope gridEnvelope, DiagnosticChain diagnostics, Map context) {
    return true;
  }
} // GmlValidator
