...
public class GmlAdapterFactory extends AdapterFactoryImpl {
   ...
   * net.opengis.gml.AbstractGeometricPrimitiveType <em>Abstract Geometric Primitive Type</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.AbstractMetaDataType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.AbstractRingPropertyType
   * <em>Abstract Ring Property Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.AbstractRingType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.AbstractSurfaceType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.BoundingShapeType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.CodeListType <em>Code List
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.CodeType <em>Code
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.DirectPositionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.EnvelopeWithTimePeriodType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.GridEnvelopeType <em>Grid
   * Envelope Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.GridLimitsType <em>Grid
   * Limits Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.GridType <em>Grid
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.LinearRingType <em>Linear
   * Ring Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.PointType <em>Point
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.PolygonType <em>Polygon
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.RectifiedGridType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.ReferenceType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.StringOrRefType <em>String
   * Or Ref Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.TimePositionType <em>Time
   * Position Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.gml.VectorType <em>Vector
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
