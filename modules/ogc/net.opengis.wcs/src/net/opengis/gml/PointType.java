 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.PointType#getPos <em>Pos</em>}
 * </ul>
 *
...
public interface PointType extends AbstractGeometryType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='pos'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.PointType#getPos <em>Pos</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
