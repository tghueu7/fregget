 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Time Indeterminate Value
...
public final class TimeIndeterminateValueType extends AbstractEnumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Now</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #NOW_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Unknown</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #UNKNOWN_LITERAL
  ...
  public static final TimeIndeterminateValueType AFTER_LITERAL =
      new TimeIndeterminateValueType(AFTER, "after", "after");
  ...
  public static final TimeIndeterminateValueType BEFORE_LITERAL =
      new TimeIndeterminateValueType(BEFORE, "before", "before");
  ...
  public static final TimeIndeterminateValueType NOW_LITERAL =
      new TimeIndeterminateValueType(NOW, "now", "now");
  ...
  public static final TimeIndeterminateValueType UNKNOWN_LITERAL =
      new TimeIndeterminateValueType(UNKNOWN, "unknown", "unknown");
  ...
  private static final TimeIndeterminateValueType[] VALUES_ARRAY =
      new TimeIndeterminateValueType[] {
        AFTER_LITERAL, BEFORE_LITERAL, NOW_LITERAL, UNKNOWN_LITERAL,
      };
  ...
  /**
   * Returns the '<em><b>Time Indeterminate Value Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Time Indeterminate Value Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
