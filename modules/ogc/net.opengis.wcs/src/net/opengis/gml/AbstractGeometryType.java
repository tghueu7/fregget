 ...
 * element may have an identifying attribute ("id"), a name (attribute "name") and a description
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.AbstractGeometryType#getSrsName <em>Srs Name</em>}
 * </ul>
 *
 * @see net.opengis.gml.GmlPackage#getAbstractGeometryType()
 * @model abstract="true" extendedMetaData="name='AbstractGeometryType' kind='empty'"
 * @generated
 */
public interface AbstractGeometryType extends AbstractGeometryBaseType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * No gid attribute added. In general srsName points to a CRS instance of
   * CoordinateReferenceSystemType (see coordinateReferenceSystems.xsd). For well known references
   * it is not required that the CRS description exists at the location the URI points to (Note:
   * These "WKCRS"-ids still have to be specified). If no srsName attribute is given, the CRS must
   * be specified as part of the larger context this geometry element is part of, e.g. a geometric
   * aggregate.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.AbstractGeometryType#getSrsName <em>Srs
   * Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
