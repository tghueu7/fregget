 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.EnvelopeWithTimePeriodType#getTimePosition <em>Time Position</em>}
 *   <li>{@link net.opengis.gml.EnvelopeWithTimePeriodType#getFrame <em>Frame</em>}
 * </ul>
 *
...
public interface EnvelopeWithTimePeriodType extends EnvelopeType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.EnvelopeWithTimePeriodType#getFrame
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml.EnvelopeWithTimePeriodType#getFrame
   * <em>Frame</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml.EnvelopeWithTimePeriodType#getFrame
