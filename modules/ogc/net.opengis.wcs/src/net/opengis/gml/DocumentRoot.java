 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getGeometricPrimitive <em>Geometric Primitive</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getGeometry <em>Geometry</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getGML <em>GML</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getObject <em>Object</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getMetaData <em>Meta Data</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getRing <em>Ring</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getSurface <em>Surface</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getBoundedBy <em>Bounded By</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getEnvelope <em>Envelope</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getEnvelopeWithTimePeriod <em>Envelope With Time
 *       Period</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getGrid <em>Grid</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getInterior <em>Interior</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getLinearRing <em>Linear Ring</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getMetaDataProperty <em>Meta Data Property</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getName <em>Name</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getPolygon <em>Polygon</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getRectifiedGrid <em>Rectified Grid</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getTimePosition <em>Time Position</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getId <em>Id</em>}
 *   <li>{@link net.opengis.gml.DocumentRoot#getRemoteSchema <em>Remote Schema</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getBoundedBy <em>Bounded By</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getDescription
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getEnvelope <em>Envelope</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getEnvelopeWithTimePeriod
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getExterior <em>Exterior</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getGrid <em>Grid</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getInterior <em>Interior</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getLinearRing <em>Linear Ring</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getMetaDataProperty <em>Meta Data
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifier for the object, normally a descriptive name. An object may have several names,
   * typically assigned by different authorities. The authority for a name is indicated by the value
   * of its (optional) codeSpace attribute. The name may or may not be unique, as determined by the
   * rules of the organization responsible for the codeSpace.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getName <em>Name</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getPolygon <em>Polygon</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getPos <em>Pos</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Rectified Grid</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getRectifiedGrid <em>Rectified
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getTimePosition <em>Time
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Database handle for the object. It is of XML type "ID", so is constrained to be unique in the
   * XML document within which it occurs. An external identifier for the object in the form of a URI
   * may be constructed using standard XML and XPointer methods. This is done by concatenating the
   * URI for the document, a fragment separator "#", and the value of the id attribute.
   * <!-- end-model-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Reference to an XML Schema fragment that specifies the content model of the propertyi's value.
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.DocumentRoot#getRemoteSchema <em>Remote
   * Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
