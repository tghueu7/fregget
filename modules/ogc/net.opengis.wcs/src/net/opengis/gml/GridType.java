 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Implicitly defines an unrectified grid, which is a network composed of two or more sets of
 * equally spaced parallel lines in which the members of each set intersect the members of the other
 * sets at right angles. This profile does not extend AbstractGeometryType, so it defines the
 * srsName attribute.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.GridType#getLimits <em>Limits</em>}
 *   <li>{@link net.opengis.gml.GridType#getAxisName <em>Axis Name</em>}
 *   <li>{@link net.opengis.gml.GridType#getDimension <em>Dimension</em>}
 * </ul>
 *
...
public interface GridType extends AbstractGeometryType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.GridType#getDimension <em>Dimension</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
