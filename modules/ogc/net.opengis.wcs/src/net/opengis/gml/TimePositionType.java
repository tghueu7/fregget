 ...
 * calendarEraName attribute provides the name of the calendar era to which the date is referenced
 * (e.g. the Meiji era of the Japanese calendar).
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml.TimePositionType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml.TimePositionType#getCalendarEraName <em>Calendar Era Name</em>}
 *   <li>{@link net.opengis.gml.TimePositionType#getFrame <em>Frame</em>}
 *   <li>{@link net.opengis.gml.TimePositionType#getIndeterminatePosition <em>Indeterminate
 *       Position</em>}
 * </ul>
 *
...
public interface TimePositionType extends EObject {
   ...
   * @model dataType="net.opengis.gml.TemporalPositionType" extendedMetaData="name=':0'
   *     kind='simple'"
   * @generated
   */
  Object getValue();
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.TimePositionType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.TimePositionType#getCalendarEraName <em>Calendar
   * Era Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.TimePositionType#getFrame <em>Frame</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml.TimePositionType#getFrame <em>Frame</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml.TimePositionType#getFrame
  ...
  /**
   * Returns the value of the '<em><b>Indeterminate Position</b></em>' attribute. The default value
   * is <code>"after"</code>. The literals are from the enumeration {@link
   ...
   * @model default="after" unsettable="true" extendedMetaData="kind='attribute'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.TimePositionType#getIndeterminatePosition
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml.TimePositionType#getIndeterminatePosition
   * <em>Indeterminate Position</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
