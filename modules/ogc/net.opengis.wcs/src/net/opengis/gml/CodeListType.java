 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml.CodeListType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml.CodeListType#getCodeSpace <em>Code Space</em>}
 * </ul>
 *
...
public interface CodeListType extends EObject {
   ...
   * @model dataType="net.opengis.gml.NameList" many="false" extendedMetaData="name=':0'
   *     kind='simple'"
   * @generated
   */
  List getValue();
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml.CodeListType#getCodeSpace <em>Code Space</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
