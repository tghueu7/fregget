 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Identifier of a spatial interpolation method applicable to continuous grid coverages, plus the
 * optional "null Resistance" parameter.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.InterpolationMethodType#getNullResistance <em>Null
 *       Resistance</em>}
 * </ul>
 *
...
public interface InterpolationMethodType extends InterpolationMethodBaseType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifier of how the server handles null values when spatially interpolating values in this
   * field using this interpolation method. This identifier shall be selected from the referenced
   * dictionary. This parameter shall be omitted when the rule for handling nulls is unknown.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.InterpolationMethodType#getNullResistance
   * <em>Null Resistance</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
