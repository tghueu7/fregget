 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.GetCoverageType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.GetCoverageType#getDomainSubset <em>Domain Subset</em>}
 *   <li>{@link net.opengis.wcs11.GetCoverageType#getRangeSubset <em>Range Subset</em>}
 *   <li>{@link net.opengis.wcs11.GetCoverageType#getOutput <em>Output</em>}
 * </ul>
 *
...
public interface GetCoverageType extends RequestBaseType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.GetCoverageType#getIdentifier
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.GetCoverageType#getDomainSubset <em>Domain
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.GetCoverageType#getRangeSubset <em>Range
   * Subset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.GetCoverageType#getOutput <em>Output</em>}'
