 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getAvailableKeys <em>Available Keys</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getAxisSubset <em>Axis Subset</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getCapabilities <em>Capabilities</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getContents <em>Contents</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getCoverage <em>Coverage</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getCoverageDescriptions <em>Coverage
 *       Descriptions</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getCoverages <em>Coverages</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getCoverageSummary <em>Coverage Summary</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getDescribeCoverage <em>Describe Coverage</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGetCoverage <em>Get Coverage</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridBaseCRS <em>Grid Base CRS</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridCRS <em>Grid CRS</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridCS <em>Grid CS</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridOffsets <em>Grid Offsets</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridOrigin <em>Grid Origin</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getGridType <em>Grid Type</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getInterpolationMethods <em>Interpolation
 *       Methods</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getTemporalDomain <em>Temporal Domain</em>}
 *   <li>{@link net.opengis.wcs11.DocumentRoot#getTemporalSubset <em>Temporal Subset</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * List of all the available (valid) key values for this axis. For numeric keys, signed values
   * should be ordered from negative infinity to positive infinity.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getAvailableKeys <em>Available
   * Keys</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * List of selected Keys for this axis, to be used for selecting values in a vector range field.
   * TBD.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getAxisSubset <em>Axis
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * XML encoded WCS GetCapabilities operation response. The Capabilities document provides clients
   * with service metadata about a specific service instance, including metadata about the coverages
   * served. If the server does not implement the updateSequence parameter, the server shall always
   * return the Capabilities document, without the updateSequence parameter. When the server
   * implements the updateSequence parameter and the GetCapabilities operation request included the
   * updateSequence parameter with the current value, the server shall return this element with only
   * the "version" and "updateSequence" attributes. Otherwise, all optional sections shall be
   * included or not depending on the actual value of the Contents parameter in the GetCapabilities
   * operation request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getCapabilities
   * <em>Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Contents section of WCS service metadata (or Capabilities) XML document. For the WCS, these
   * contents are brief metadata about the coverages available from this server, or a reference to
   * another source from which this metadata is available.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getContents <em>Contents</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Complete data for one coverage, referencing each coverage file either remotely or locally in
   * the same message.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getCoverage <em>Coverage</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getCoverageDescriptions
   * <em>Coverage Descriptions</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Coverages</em>' containment reference isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getCoverages <em>Coverages</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Coverage Summary</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getCoverageSummary <em>Coverage
   * Summary</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS to perform the DescribeCoverage operation. This operation allows a client to
   * retrieve descriptions of one or more coverages. In this XML encoding, no "request" parameter is
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getDescribeCoverage <em>Describe
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS server to perform the GetCapabilities operation. This operation allows a
   * client to retrieve a Capabilities XML document providing metadata for the specific WCS server.
   * In this XML encoding, no "request" parameter is included, since the element name specifies the
   * specific operation.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGetCapabilities <em>Get
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Request to a WCS to perform the GetCoverage operation. This operation allows a client to
   * retrieve a subset of one coverage. In this XML encoding, no "request" parameter is included,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGetCoverage <em>Get
   * Coverage</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Association to the coordinate reference system (CRS) in which this Grid CRS is specified. A
   * GridCRS can use any type of baseCRS, including GeographicCRS, ProjectedCRS, ImageCRS, or a
   * different GridCRS. For a GridCRS, this association is limited to a remote definition of the
   * baseCRS (not encoded in-line).
   * <!-- end-model-doc -->
   *
   ...
   *     name='GridBaseCRS' namespace='##targetNamespace'"
   * @generated
   */
  String getGridBaseCRS();

  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridBaseCRS <em>Grid Base
   * CRS</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Grid CRS</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridCRS <em>Grid CRS</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Grid CS</b></em>' attribute. The default value is <code>
   * "urn:ogc:def:cs:OGC:0.0:Grid2dSquareCS"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Association to the (Cartesian) grid coordinate system used by this Grid CRS. In this use of a
   * (Cartesian) grid coordinate system, the grid positions shall be in the centers of the image or
   * other grid coverage values (not between the grid values), as specified in ISO 19123. Also, the
   * grid point indices at the origin shall be 0, 0 (not 1,1), as specified in ISO 19123. This
   * GridCS defaults to the most commonly used grid coordinate system, which is referenced by the
   * URN "urn:ogc:def:cs:OGC:0.0:Grid2dSquareCS". For a GridCRS, this association is limited to a
   * remote definition of the GridCS (not encoded in-line).
   * <!-- end-model-doc -->
   *
   ...
   * @model default="urn:ogc:def:cs:OGC:0.0:Grid2dSquareCS" unique="false"
   *     dataType="org.eclipse.emf.ecore.xml.type.AnyURI" upper="-2" transient="true"
   *     volatile="true" derived="true" extendedMetaData="kind='element' name='GridCS'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridCS <em>Grid CS</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Two or more grid position offsets from the grid origin in the GridBaseCRS of this GridCRS.
   * Example: For the grid2dIn2dCRS OperationMethod, this Offsets element shall contain four values,
   * the first two values shall specify the grid offset for the first grid axis in the 2D base CRS,
   * and the second pair of values shall specify the grid offset for the second grid axis. In this
   * case, the middle two values are zero for un-rotated and un-skewed grids.
   * <!-- end-model-doc -->
   *
   ...
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType" upper="-2"
   *     transient="true" volatile="true" derived="true" extendedMetaData="kind='element'
   *     name='GridOffsets' namespace='##targetNamespace'"
   * @generated
   */
  Object getGridOffsets();

  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridOffsets <em>Grid
   * Offsets</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Grid Origin</b></em>' attribute. The default value is <code>
   * "0 0"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Coordinates of the grid origin position in the GridBaseCRS of this GridCRS. This origin
   * defaults be the most commonly used origin in a GridCRS used in the output part of a
   * GetCapabilities operation request, namely "0 0". This element is adapted from gml:pos.
   * <!-- end-model-doc -->
   *
   ...
   * @model default="0 0" unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
   *     upper="-2" transient="true" volatile="true" derived="true" extendedMetaData="kind='element'
   *     name='GridOrigin' namespace='##targetNamespace'"
   * @generated
   */
  Object getGridOrigin();

  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridOrigin <em>Grid
   * Origin</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Grid Type</b></em>' attribute. The default value is <code>
   * "urn:ogc:def:method:WCS:1.1:2dSimpleGrid"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Association to the OperationMethod used to define this Grid CRS. This association defaults to
   * an association to the most commonly used method, which is referenced by the URN
   * "urn:ogc:def:method:WCS:1.1:2dSimpleGrid". For a GridCRS, this association is limited to a
   * remote definition of a grid definition Method (not encoded in-line) that encodes a variation on
   * the method implied by the CV_RectifiedGrid class in ISO 19123, without the inheritance from
   * CV_Grid.
   * <!-- end-model-doc -->
   *
   ...
   * @model default="urn:ogc:def:method:WCS:1.1:2dSimpleGrid" unique="false"
   *     dataType="org.eclipse.emf.ecore.xml.type.AnyURI" upper="-2" transient="true"
   *     volatile="true" derived="true" extendedMetaData="kind='element' name='GridType'
   *     namespace='##targetNamespace'"
   * @generated
   */
  String getGridType();
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getGridType <em>Grid Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Identifier</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model unique="false" dataType="net.opengis.wcs11.IdentifierType" upper="-2" transient="true"
   *     volatile="true" derived="true" extendedMetaData="kind='element' name='Identifier'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getIdentifier
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * List of the interpolation method(s) that can uses when continuous grid coverage resampling is
   * needed.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getInterpolationMethods
   * <em>Interpolation Methods</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Definition of the temporal domain of a coverage, the times for which valid data are available.
   * The times should to be ordered from the oldest to the newest.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getTemporalDomain <em>Temporal
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.DocumentRoot#getTemporalSubset <em>Temporal
   * Subset</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
