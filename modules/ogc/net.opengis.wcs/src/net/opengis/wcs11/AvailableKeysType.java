 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.AvailableKeysType#getKey <em>Key</em>}
 * </ul>
 *
...
public interface AvailableKeysType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Valid key value for this axis. There will normally be more than one key value for an axis, but
   * one is allowed for special circumstances.
   * <!-- end-model-doc -->
   *
