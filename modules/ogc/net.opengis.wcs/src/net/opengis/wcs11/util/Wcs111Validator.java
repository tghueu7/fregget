...
public class Wcs111Validator extends EObjectValidator {
  ...
  protected boolean validate(
    ...
    switch (classifierID) {
      ...
      case Wcs111Package.INTERPOLATION_METHOD_BASE_TYPE:
        return validateInterpolationMethodBaseType(
            (InterpolationMethodBaseType) value, diagnostics, context);
      case Wcs111Package.INTERPOLATION_METHODS_TYPE:
        return validateInterpolationMethodsType(
            (InterpolationMethodsType) value, diagnostics, context);
   ...
   * @generated
   */
  public boolean validateAvailableKeysType(
   ...
   * @generated
   */
  public boolean validateAxisSubsetType(
  ...
  public boolean validateContentsType(
      ContentsType contentsType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateCoverageDomainType(
   ...
   * @generated
   */
  public boolean validateCoveragesType(
   ...
   * @generated
   */
  public boolean validateDomainSubsetType(
   ...
   * @generated
   */
  public boolean validateFieldSubsetType(
  ...
  public boolean validateGetCoverageType(
      GetCoverageType getCoverageType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateGridCrsType(
   ...
   * @generated
   */
  public boolean validateInterpolationMethodBaseType(
      InterpolationMethodBaseType interpolationMethodBaseType,
   ...
   * @generated
   */
  public boolean validateInterpolationMethodsType(
   ...
   * @generated
   */
  public boolean validateOutputType(
   ...
   * @generated
   */
  public boolean validateSpatialDomainType(
   ...
   * @generated
   */
  public boolean validateTimeSequenceType(
  ...
  public boolean validateIdentifierType(
      String identifierType, DiagnosticChain diagnostics, Map context) {
  ...
  public static final PatternMatcher[][] IDENTIFIER_TYPE__PATTERN__VALUES =
      new PatternMatcher[][] {new PatternMatcher[] {XMLTypeUtil.createPatternMatcher(".+")}};
   ...
   * @generated
   */
  public boolean validateIdentifierType_Pattern(
      String identifierType, DiagnosticChain diagnostics, Map context) {
    return validatePattern(
        Wcs111Package.Literals.IDENTIFIER_TYPE,
        identifierType,
   ...
   * @generated
   */
  public boolean validateInterpolationMethodBaseTypeBase(
      String interpolationMethodBaseTypeBase, DiagnosticChain diagnostics, Map context) {
    return true;
  }
  ...
  public boolean validateTimeDurationType_MemberTypes(
    ...
    if (diagnostics != null) {
      ...
      if (XMLTypePackage.Literals.DURATION.isInstance(timeDurationType)) {
        if (xmlTypeValidator.validateDuration(
            (Duration) timeDurationType, tempDiagnostics, context)) return true;
      }
      ...
      if (XMLTypePackage.Literals.DURATION.isInstance(timeDurationType)) {
        if (xmlTypeValidator.validateDuration((Duration) timeDurationType, null, context))
          return true;
      }
      if (XMLTypePackage.Literals.DECIMAL.isInstance(timeDurationType)) {
