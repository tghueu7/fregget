...
public class Wcs11AdapterFactory extends AdapterFactoryImpl {
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.AvailableKeysType
   * <em>Available Keys Type</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.AxisSubsetType <em>Axis
   * Subset Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.AxisType <em>Axis
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CapabilitiesType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.ContentsType
   * <em>Contents Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CoverageDescriptionsType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CoverageDescriptionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CoverageDomainType
   * <em>Coverage Domain Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CoveragesType
   * <em>Coverages Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.CoverageSummaryType
   * <em>Coverage Summary Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.DescribeCoverageType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.DocumentRoot
   * <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.DomainSubsetType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.FieldSubsetType
   * <em>Field Subset Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.FieldType <em>Field
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.GetCapabilitiesType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.GetCoverageType <em>Get
   * Coverage Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.GridCrsType <em>Grid Crs
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.ImageCRSRefType
   ...
   * net.opengis.wcs11.InterpolationMethodBaseType <em>Interpolation Method Base Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.InterpolationMethodsType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.InterpolationMethodType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.OutputType <em>Output
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.RangeSubsetType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.RangeType <em>Range
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.RequestBaseType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.SpatialDomainType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.TimePeriodType <em>Time
   * Period Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wcs11.TimeSequenceType
