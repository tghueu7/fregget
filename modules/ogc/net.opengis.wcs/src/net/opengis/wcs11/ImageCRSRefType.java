 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.ImageCRSRefType#getImageCRS <em>Image CRS</em>}
 * </ul>
 *
...
public interface ImageCRSRefType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Image CRS</em>' attribute isn't clear, there really should be
   ...
   *     name='ImageCRS' namespace='http://www.opengis.net/gml'"
   * @generated
   */
  Object getImageCRS();

  /**
   * Sets the value of the '{@link net.opengis.wcs11.ImageCRSRefType#getImageCRS <em>Image
   * CRS</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
