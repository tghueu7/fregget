 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getWGS84BoundingBox <em>WGS84
 *       Bounding Box</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getSupportedCRS <em>Supported
 *       CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getSupportedFormat <em>Supported
 *       Format</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getCoverageSummary <em>Coverage
 *       Summary</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl#getIdentifier1 <em>Identifier1</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageSummaryTypeImpl extends DescriptionTypeImpl implements CoverageSummaryType {
  ...
  /**
   * The cached value of the '{@link #getSupportedFormat() <em>Supported Format</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getCoverageSummary() <em>Coverage Summary</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Wcs111Package.COVERAGE_SUMMARY_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (wGS84BoundingBox == null) {
      wGS84BoundingBox =
          new EObjectContainmentEList(
              ...
              this,
              Wcs111Package.COVERAGE_SUMMARY_TYPE__WGS84_BOUNDING_BOX);
    }
  ...
  public EList getSupportedCRS() {
    if (supportedCRS == null) {
      supportedCRS =
          new EDataTypeEList(
              String.class, this, Wcs111Package.COVERAGE_SUMMARY_TYPE__SUPPORTED_CRS);
    }
    return supportedCRS;
  }
  ...
  public EList getSupportedFormat() {
    if (supportedFormat == null) {
      supportedFormat =
          new EDataTypeEList(
              String.class, this, Wcs111Package.COVERAGE_SUMMARY_TYPE__SUPPORTED_FORMAT);
    }
    ...
    if (coverageSummary == null) {
      coverageSummary =
          new EObjectContainmentEList(
              ...
              this,
              Wcs111Package.COVERAGE_SUMMARY_TYPE__COVERAGE_SUMMARY);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_SUMMARY_TYPE__IDENTIFIER,
              oldIdentifier,
              identifier));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_SUMMARY_TYPE__IDENTIFIER1,
              oldIdentifier1,
              identifier1));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs111Package.COVERAGE_SUMMARY_TYPE__IDENTIFIER1:
        return IDENTIFIER1_EDEFAULT == null
            ? identifier1 != null
            : !IDENTIFIER1_EDEFAULT.equals(identifier1);
    }
