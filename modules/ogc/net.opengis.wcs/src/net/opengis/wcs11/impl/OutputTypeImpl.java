 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.OutputTypeImpl#getGridCRS <em>Grid CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.OutputTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wcs11.impl.OutputTypeImpl#isStore <em>Store</em>}
 * </ul>
 *
 * @generated
 */
public class OutputTypeImpl extends EObjectImpl implements OutputType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.OUTPUT_TYPE__GRID_CRS, oldGridCRS, newGridCRS);
  ...
  public void setGridCRS(GridCrsType newGridCRS) {
    if (newGridCRS != gridCRS) {
      ...
      if (gridCRS != null)
        msgs =
            ((InternalEObject) gridCRS)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs111Package.OUTPUT_TYPE__GRID_CRS, null, msgs);
      if (newGridCRS != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.OUTPUT_TYPE__GRID_CRS, newGridCRS, newGridCRS));
  }
  ...
  public void setFormat(String newFormat) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.OUTPUT_TYPE__FORMAT, oldFormat, format));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.OUTPUT_TYPE__STORE,
              oldStore,
              store,
              !oldStoreESet));
  }
