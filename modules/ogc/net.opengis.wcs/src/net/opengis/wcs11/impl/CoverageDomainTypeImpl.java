 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.CoverageDomainTypeImpl#getSpatialDomain <em>Spatial
 *       Domain</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDomainTypeImpl#getTemporalDomain <em>Temporal
 *       Domain</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN,
              oldSpatialDomain,
              newSpatialDomain);
      ...
      if (spatialDomain != null)
        msgs =
            ((InternalEObject) spatialDomain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN,
              oldTemporalDomain,
              newTemporalDomain);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (temporalDomain != null)
        msgs =
            ((InternalEObject) temporalDomain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN,
                    null,
                    msgs);
