 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.ContentsTypeImpl#getCoverageSummary <em>Coverage
 *       Summary</em>}
 *   <li>{@link net.opengis.wcs11.impl.ContentsTypeImpl#getSupportedCRS <em>Supported CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.ContentsTypeImpl#getSupportedFormat <em>Supported
 *       Format</em>}
 *   <li>{@link net.opengis.wcs11.impl.ContentsTypeImpl#getOtherSource <em>Other Source</em>}
 * </ul>
 *
 * @generated
 */
public class ContentsTypeImpl extends EObjectImpl implements ContentsType {
  ...
  /**
   * The cached value of the '{@link #getOtherSource() <em>Other Source</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (coverageSummary == null) {
      coverageSummary =
          new EObjectContainmentEList(
              CoverageSummaryType.class, this, Wcs111Package.CONTENTS_TYPE__COVERAGE_SUMMARY);
    }
  ...
  public EList getSupportedCRS() {
    if (supportedCRS == null) {
      supportedCRS =
          new EDataTypeEList(String.class, this, Wcs111Package.CONTENTS_TYPE__SUPPORTED_CRS);
    }
    return supportedCRS;
  }
  ...
  public EList getSupportedFormat() {
    if (supportedFormat == null) {
      supportedFormat =
          new EDataTypeEList(String.class, this, Wcs111Package.CONTENTS_TYPE__SUPPORTED_FORMAT);
    }
  ...
  public EList getOtherSource() {
    if (otherSource == null) {
      otherSource =
          new EObjectContainmentEList(
              OnlineResourceType.class, this, Wcs111Package.CONTENTS_TYPE__OTHER_SOURCE);
    }
    return otherSource;
  }
