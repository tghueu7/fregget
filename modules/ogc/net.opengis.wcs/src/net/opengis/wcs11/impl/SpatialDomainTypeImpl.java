 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getGridCRS <em>Grid CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getTransformation
 *       <em>Transformation</em>}
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getImageCRS <em>Image CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl#getPolygon <em>Polygon</em>}
 * </ul>
 *
 * @generated
 */
public class SpatialDomainTypeImpl extends EObjectImpl implements SpatialDomainType {
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Wcs111Package.SPATIAL_DOMAIN_TYPE__BOUNDING_BOX_GROUP);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.SPATIAL_DOMAIN_TYPE__GRID_CRS,
              oldGridCRS,
              newGridCRS);
  ...
  public void setGridCRS(GridCrsType newGridCRS) {
    if (newGridCRS != gridCRS) {
      ...
      if (gridCRS != null)
        msgs =
            ((InternalEObject) gridCRS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.SPATIAL_DOMAIN_TYPE__GRID_CRS,
                    null,
                    msgs);
      if (newGridCRS != null)
        msgs =
            ((InternalEObject) newGridCRS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.SPATIAL_DOMAIN_TYPE__GRID_CRS,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.SPATIAL_DOMAIN_TYPE__TRANSFORMATION,
              oldTransformation,
              transformation));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.SPATIAL_DOMAIN_TYPE__IMAGE_CRS,
              oldImageCRS,
              newImageCRS);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (imageCRS != null)
        msgs =
            ((InternalEObject) imageCRS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.SPATIAL_DOMAIN_TYPE__IMAGE_CRS,
                    null,
                    msgs);
      if (newImageCRS != null)
        msgs =
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs111Package.SPATIAL_DOMAIN_TYPE__GRID_CRS:
        return gridCRS != null;
      case Wcs111Package.SPATIAL_DOMAIN_TYPE__TRANSFORMATION:
        return TRANSFORMATION_EDEFAULT == null
            ? transformation != null
            : !TRANSFORMATION_EDEFAULT.equals(transformation);
      case Wcs111Package.SPATIAL_DOMAIN_TYPE__IMAGE_CRS:
