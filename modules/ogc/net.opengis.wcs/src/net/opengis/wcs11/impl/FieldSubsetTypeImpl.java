 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.FieldSubsetTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldSubsetTypeImpl#getInterpolationType <em>Interpolation
 *       Type</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldSubsetTypeImpl#getAxisSubset <em>Axis Subset</em>}
 * </ul>
 *
 * @generated
 */
public class FieldSubsetTypeImpl extends EObjectImpl implements FieldSubsetType {
  ...
  /**
   * The default value of the '{@link #getInterpolationType() <em>Interpolation Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getInterpolationType() <em>Interpolation Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAxisSubset() <em>Axis Subset</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.FIELD_SUBSET_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.FIELD_SUBSET_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.FIELD_SUBSET_TYPE__INTERPOLATION_TYPE,
              oldInterpolationType,
              interpolationType));
  }
    ...
    if (axisSubset == null) {
      axisSubset =
          new EObjectContainmentEList(
              AxisSubsetType.class, this, Wcs111Package.FIELD_SUBSET_TYPE__AXIS_SUBSET);
    }
    return axisSubset;
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wcs111Package.FIELD_SUBSET_TYPE__INTERPOLATION_TYPE:
        return INTERPOLATION_TYPE_EDEFAULT == null
            ? interpolationType != null
            : !INTERPOLATION_TYPE_EDEFAULT.equals(interpolationType);
      case Wcs111Package.FIELD_SUBSET_TYPE__AXIS_SUBSET:
