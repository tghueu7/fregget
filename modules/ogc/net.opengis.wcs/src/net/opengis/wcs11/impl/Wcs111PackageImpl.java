...
public class Wcs111PackageImpl extends EPackageImpl implements Wcs111Package {
  ...
  public static Wcs111Package init() {
    if (isInited)
      return (Wcs111Package) EPackage.Registry.INSTANCE.getEPackage(Wcs111Package.eNS_URI);

    // Obtain or create and register package
    Wcs111PackageImpl theWcs111Package =
        (Wcs111PackageImpl)
            (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof Wcs111PackageImpl
                ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI)
                : new Wcs111PackageImpl());
