 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.InterpolationMethodTypeImpl#getNullResistance <em>Null
 *       Resistance</em>}
 * </ul>
 *
 * @generated
 */
public class InterpolationMethodTypeImpl extends InterpolationMethodBaseTypeImpl
    implements InterpolationMethodType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.INTERPOLATION_METHOD_TYPE__NULL_RESISTANCE,
              oldNullResistance,
              nullResistance));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs111Package.INTERPOLATION_METHOD_TYPE__NULL_RESISTANCE:
        return NULL_RESISTANCE_EDEFAULT == null
            ? nullResistance != null
            : !NULL_RESISTANCE_EDEFAULT.equals(nullResistance);
    }
