 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.TimePeriodTypeImpl#getBeginPosition <em>Begin Position</em>}
 *   <li>{@link net.opengis.wcs11.impl.TimePeriodTypeImpl#getEndPosition <em>End Position</em>}
 *   <li>{@link net.opengis.wcs11.impl.TimePeriodTypeImpl#getTimeResolution <em>Time
 *       Resolution</em>}
 *   <li>{@link net.opengis.wcs11.impl.TimePeriodTypeImpl#getFrame <em>Frame</em>}
 * </ul>
 *
 * @generated
 */
public class TimePeriodTypeImpl extends EObjectImpl implements TimePeriodType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
              oldBeginPosition,
              beginPosition));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.TIME_PERIOD_TYPE__END_POSITION,
              oldEndPosition,
              endPosition));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.TIME_PERIOD_TYPE__TIME_RESOLUTION,
              oldTimeResolution,
              timeResolution));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.TIME_PERIOD_TYPE__FRAME,
              oldFrame,
              frame,
              !oldFrameESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wcs111Package.TIME_PERIOD_TYPE__BEGIN_POSITION:
        return BEGIN_POSITION_EDEFAULT == null
            ? beginPosition != null
            : !BEGIN_POSITION_EDEFAULT.equals(beginPosition);
      case Wcs111Package.TIME_PERIOD_TYPE__END_POSITION:
        return END_POSITION_EDEFAULT == null
            ? endPosition != null
            : !END_POSITION_EDEFAULT.equals(endPosition);
      case Wcs111Package.TIME_PERIOD_TYPE__TIME_RESOLUTION:
