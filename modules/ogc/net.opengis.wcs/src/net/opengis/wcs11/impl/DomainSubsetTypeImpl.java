 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.DomainSubsetTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.wcs11.impl.DomainSubsetTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.wcs11.impl.DomainSubsetTypeImpl#getTemporalSubset <em>Temporal
 *       Subset</em>}
 * </ul>
 *
 * @generated
...
public class DomainSubsetTypeImpl extends EObjectImpl implements DomainSubsetType {
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Wcs111Package.DOMAIN_SUBSET_TYPE__BOUNDING_BOX_GROUP);
    }
  ...
  public BoundingBoxType getBoundingBox() {
    return (BoundingBoxType)
        getBoundingBoxGroup().get(Wcs111Package.Literals.DOMAIN_SUBSET_TYPE__BOUNDING_BOX, true);
  }
  ...
  public NotificationChain basicSetBoundingBox(
    ...
    return ((FeatureMap.Internal) getBoundingBoxGroup())
        .basicAdd(Wcs111Package.Literals.DOMAIN_SUBSET_TYPE__BOUNDING_BOX, newBoundingBox, msgs);
  }
  ...
  public void setBoundingBox(BoundingBoxType newBoundingBox) {
    ((FeatureMap.Internal) getBoundingBoxGroup())
        .set(Wcs111Package.Literals.DOMAIN_SUBSET_TYPE__BOUNDING_BOX, newBoundingBox);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET,
              oldTemporalSubset,
              newTemporalSubset);
      ...
      if (temporalSubset != null)
        msgs =
            ((InternalEObject) temporalSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET,
                    null,
                    msgs);
