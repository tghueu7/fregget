 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.RangeSubsetTypeImpl#getFieldSubset <em>Field Subset</em>}
 * </ul>
 *
 * @generated
 */
public class RangeSubsetTypeImpl extends EObjectImpl implements RangeSubsetType {
  /**
   * The cached value of the '{@link #getFieldSubset() <em>Field Subset</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (fieldSubset == null) {
      fieldSubset =
          new EObjectContainmentEList(
              FieldSubsetType.class, this, Wcs111Package.RANGE_SUBSET_TYPE__FIELD_SUBSET);
    }
    return fieldSubset;
  }
