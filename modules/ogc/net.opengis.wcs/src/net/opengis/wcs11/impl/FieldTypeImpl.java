 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.FieldTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldTypeImpl#getDefinition <em>Definition</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldTypeImpl#getNullValue <em>Null Value</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldTypeImpl#getInterpolationMethods <em>Interpolation
 *       Methods</em>}
 *   <li>{@link net.opengis.wcs11.impl.FieldTypeImpl#getAxis <em>Axis</em>}
 * </ul>
 *
 * @generated
 */
public class FieldTypeImpl extends DescriptionTypeImpl implements FieldType {
  ...
  /**
   * The cached value of the '{@link #getInterpolationMethods() <em>Interpolation Methods</em>}'
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.FIELD_TYPE__IDENTIFIER,
              oldIdentifier,
              identifier));
  }
  ...
  public NotificationChain basicSetDefinition(
      UnNamedDomainType newDefinition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.FIELD_TYPE__DEFINITION,
              oldDefinition,
              newDefinition);
      ...
      if (definition != null)
        msgs =
            ((InternalEObject) definition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.FIELD_TYPE__DEFINITION,
                    null,
                    msgs);
  ...
  public EList getNullValue() {
    if (nullValue == null) {
      nullValue =
          new EObjectContainmentEList(CodeType.class, this, Wcs111Package.FIELD_TYPE__NULL_VALUE);
    }
    return nullValue;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.FIELD_TYPE__INTERPOLATION_METHODS,
              oldInterpolationMethods,
  ...
  public void setInterpolationMethods(InterpolationMethodsType newInterpolationMethods) {
    if (newInterpolationMethods != interpolationMethods) {
      ...
      if (interpolationMethods != null)
        msgs =
            ((InternalEObject) interpolationMethods)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.FIELD_TYPE__INTERPOLATION_METHODS,
                    null,
                    msgs);
      if (newInterpolationMethods != null)
        msgs =
            ((InternalEObject) newInterpolationMethods)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.FIELD_TYPE__INTERPOLATION_METHODS,
                    null,
