...
public class Wcs11PackageImpl extends EPackageImpl implements Wcs11Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Wcs11Package#eINSTANCE} when that field is
  ...
  public static Wcs11Package init() {
    if (isInited)
      return (Wcs11Package) EPackage.Registry.INSTANCE.getEPackage(Wcs11Package.eNS_URI);

    // Obtain or create and register package
    Wcs11PackageImpl theWcs11Package =
        (Wcs11PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wcs11PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Wcs11PackageImpl());
  ...
  public void createPackageContents() {
    ...
    createEReference(
        interpolationMethodsTypeEClass, INTERPOLATION_METHODS_TYPE__INTERPOLATION_METHOD);
  ...
  public void initializePackageContents() {
    ...
    initEReference(
        ...
        theOws11Package.getReferenceGroupType(),
        null,
        "coverage",
        null,
        1,
    ...
    initEReference(
        ...
        theOws11Package.getWGS84BoundingBoxType(),
        null,
        "wGS84BoundingBox",
        null,
        0,
    ...
    initEReference(
        ...
        this.getInterpolationMethodsType(),
        null,
    ...
    initEReference(
        ...
        theOws11Package.getUnNamedDomainType(),
        null,
        "definition",
        null,
        1,
    ...
    initEClass(
        ...
        InterpolationMethodsType.class,
    ...
    initEDataType(
        ...
        String.class,
        "InterpolationMethodBaseTypeBase",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(
        ...
        new String[] {
          ...
          "memberTypes",
              "http://www.eclipse.org/emf/2003/XMLType#duration http://www.eclipse.org/emf/2003/XMLType#decimal"
        });
  }
} // Wcs11PackageImpl
