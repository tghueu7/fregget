 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getAvailableKeys <em>Available Keys</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getMeaning <em>Meaning</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getUOM <em>UOM</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getReferenceSystem <em>Reference System</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wcs11.impl.AxisTypeImpl#getIdentifier <em>Identifier</em>}
 * </ul>
 *
 * @generated
 */
public class AxisTypeImpl extends DescriptionTypeImpl implements AxisType {
  /**
   * The cached value of the '{@link #getAvailableKeys() <em>Available Keys</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.AXIS_TYPE__AVAILABLE_KEYS,
              oldAvailableKeys,
              newAvailableKeys);
  ...
  public void setAvailableKeys(AvailableKeysType newAvailableKeys) {
    if (newAvailableKeys != availableKeys) {
      ...
      if (availableKeys != null)
        msgs =
            ((InternalEObject) availableKeys)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__AVAILABLE_KEYS,
                    null,
                    msgs);
      if (newAvailableKeys != null)
        msgs =
            ((InternalEObject) newAvailableKeys)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__AVAILABLE_KEYS,
                    null,
  ...
  public NotificationChain basicSetMeaning(DomainMetadataType newMeaning, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.AXIS_TYPE__MEANING, oldMeaning, newMeaning);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setMeaning(DomainMetadataType newMeaning) {
    if (newMeaning != meaning) {
      ...
      if (meaning != null)
        msgs =
            ((InternalEObject) meaning)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__MEANING, null, msgs);
      if (newMeaning != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.AXIS_TYPE__MEANING, newMeaning, newMeaning));
  }
  ...
  public NotificationChain basicSetDataType(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.AXIS_TYPE__DATA_TYPE, oldDataType, newDataType);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newDataType != dataType) {
      ...
      if (dataType != null)
        msgs =
            ((InternalEObject) dataType)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__DATA_TYPE, null, msgs);
      if (newDataType != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.AXIS_TYPE__DATA_TYPE,
              newDataType,
              newDataType));
  }
  ...
  public NotificationChain basicSetUOM(DomainMetadataType newUOM, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.AXIS_TYPE__UOM, oldUOM, newUOM);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newUOM != uOM) {
      ...
      if (uOM != null)
        msgs =
            ((InternalEObject) uOM)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__UOM, null, msgs);
      if (newUOM != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.AXIS_TYPE__UOM, newUOM, newUOM));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.AXIS_TYPE__REFERENCE_SYSTEM,
              oldReferenceSystem,
              newReferenceSystem);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (referenceSystem != null)
        msgs =
            ((InternalEObject) referenceSystem)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.AXIS_TYPE__REFERENCE_SYSTEM,
                    null,
                    msgs);
  ...
  public EList getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(MetadataType.class, this, Wcs111Package.AXIS_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.AXIS_TYPE__IDENTIFIER,
              oldIdentifier,
              identifier));
  }
