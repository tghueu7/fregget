...
public class Wcs11FactoryImpl extends EFactoryImpl implements Wcs11Factory {
  ...
  public static Wcs11Factory init() {
    try {
      Wcs11Factory theWcs11Factory =
          (Wcs11Factory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/wcs/1.1.1");
  ...
  public InterpolationMethodBaseType createInterpolationMethodBaseType() {
    InterpolationMethodBaseTypeImpl interpolationMethodBaseType =
        new InterpolationMethodBaseTypeImpl();
   ...
   * @generated
   */
  public String createInterpolationMethodBaseTypeBaseFromString(
   ...
   * @generated
   */
  public String convertInterpolationMethodBaseTypeBaseToString(
