 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.GetCoverageTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.impl.GetCoverageTypeImpl#getDomainSubset <em>Domain Subset</em>}
 *   <li>{@link net.opengis.wcs11.impl.GetCoverageTypeImpl#getRangeSubset <em>Range Subset</em>}
 *   <li>{@link net.opengis.wcs11.impl.GetCoverageTypeImpl#getOutput <em>Output</em>}
 * </ul>
 *
 * @generated
 */
public class GetCoverageTypeImpl extends RequestBaseTypeImpl implements GetCoverageType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs11Package.GET_COVERAGE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs11Package.GET_COVERAGE_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs11Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET,
              oldDomainSubset,
              newDomainSubset);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (domainSubset != null)
        msgs =
            ((InternalEObject) domainSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs11Package.GET_COVERAGE_TYPE__DOMAIN_SUBSET,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs11Package.GET_COVERAGE_TYPE__RANGE_SUBSET,
              oldRangeSubset,
              newRangeSubset);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (rangeSubset != null)
        msgs =
            ((InternalEObject) rangeSubset)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs11Package.GET_COVERAGE_TYPE__RANGE_SUBSET,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetOutput(OutputType newOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wcs11Package.GET_COVERAGE_TYPE__OUTPUT, oldOutput, newOutput);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newOutput != output) {
      ...
      if (output != null)
        msgs =
            ((InternalEObject) output)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs11Package.GET_COVERAGE_TYPE__OUTPUT,
                    null,
                    msgs);
      if (newOutput != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs11Package.GET_COVERAGE_TYPE__OUTPUT,
              newOutput,
              newOutput));
  }
