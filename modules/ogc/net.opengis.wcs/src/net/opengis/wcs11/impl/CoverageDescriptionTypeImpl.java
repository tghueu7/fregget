 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getIdentifier
 *       <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getDomain <em>Domain</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getRange <em>Range</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getSupportedCRS <em>Supported
 *       CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl#getSupportedFormat <em>Supported
 *       Format</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageDescriptionTypeImpl extends DescriptionTypeImpl
    implements CoverageDescriptionType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_DESCRIPTION_TYPE__IDENTIFIER,
              oldIdentifier,
              identifier));
  }
    ...
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_DESCRIPTION_TYPE__DOMAIN,
              oldDomain,
              newDomain);
  ...
  public void setDomain(CoverageDomainType newDomain) {
    if (newDomain != domain) {
      ...
      if (domain != null)
        msgs =
            ((InternalEObject) domain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.COVERAGE_DESCRIPTION_TYPE__DOMAIN,
                    null,
                    msgs);
      if (newDomain != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.COVERAGE_DESCRIPTION_TYPE__RANGE,
              oldRange,
              newRange);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (range != null)
        msgs =
            ((InternalEObject) range)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wcs111Package.COVERAGE_DESCRIPTION_TYPE__RANGE,
                    null,
                    msgs);
      if (newRange != null)
        msgs =
  ...
  public EList getSupportedCRS() {
    if (supportedCRS == null) {
      supportedCRS =
          new EDataTypeEList(
              String.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__SUPPORTED_CRS);
    }
    return supportedCRS;
  }
  ...
  public EList getSupportedFormat() {
    if (supportedFormat == null) {
      supportedFormat =
          new EDataTypeEList(
              String.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__SUPPORTED_FORMAT);
    }
