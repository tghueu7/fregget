 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getGridBaseCRS <em>Grid Base CRS</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getGridType <em>Grid Type</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getGridOrigin <em>Grid Origin</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getGridOffsets <em>Grid Offsets</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getGridCS <em>Grid CS</em>}
 *   <li>{@link net.opengis.wcs11.impl.GridCrsTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class GridCrsTypeImpl extends EObjectImpl implements GridCrsType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.GRID_CRS_TYPE__SRS_NAME, oldSrsName, srsName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.GRID_CRS_TYPE__GRID_BASE_CRS,
              oldGridBaseCRS,
              gridBaseCRS));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.GRID_CRS_TYPE__GRID_TYPE,
              oldGridType,
              gridType,
              !oldGridTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.GRID_CRS_TYPE__GRID_ORIGIN,
              oldGridOrigin,
              gridOrigin,
              !oldGridOriginESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.GRID_CRS_TYPE__GRID_OFFSETS,
              oldGridOffsets,
              gridOffsets));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wcs111Package.GRID_CRS_TYPE__GRID_CS,
              oldGridCS,
              gridCS,
              !oldGridCSESet));
  }
  ...
  public void setId(Object newId) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wcs111Package.GRID_CRS_TYPE__ID, oldId, id));
  }
    ...
    switch (featureID) {
      ...
      case Wcs111Package.GRID_CRS_TYPE__GRID_BASE_CRS:
        return GRID_BASE_CRS_EDEFAULT == null
            ? gridBaseCRS != null
            : !GRID_BASE_CRS_EDEFAULT.equals(gridBaseCRS);
      case Wcs111Package.GRID_CRS_TYPE__GRID_TYPE:
      ...
      case Wcs111Package.GRID_CRS_TYPE__GRID_OFFSETS:
        return GRID_OFFSETS_EDEFAULT == null
            ? gridOffsets != null
            : !GRID_OFFSETS_EDEFAULT.equals(gridOffsets);
      case Wcs111Package.GRID_CRS_TYPE__GRID_CS:
        return isSetGridCS();
      case Wcs111Package.GRID_CRS_TYPE__ID:
  ...
  public String toString() {
    ...
    if (gridTypeESet) result.append(gridType);
    else result.append("<unset>");
    result.append(", gridOrigin: ");
    if (gridOriginESet) result.append(gridOrigin);
    else result.append("<unset>");
    result.append(", gridOffsets: ");
    result.append(gridOffsets);
    result.append(", gridCS: ");
    if (gridCSESet) result.append(gridCS);
    else result.append("<unset>");
    result.append(", id: ");
    result.append(id);
    result.append(')');
