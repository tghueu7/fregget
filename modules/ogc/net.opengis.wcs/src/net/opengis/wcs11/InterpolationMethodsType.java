 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.InterpolationMethodsType#getInterpolationMethod <em>Interpolation
 *       Method</em>}
 *   <li>{@link net.opengis.wcs11.InterpolationMethodsType#getDefault <em>Default</em>}
 * </ul>
 *
...
public interface InterpolationMethodsType extends EObject {
  /**
   * Returns the value of the '<em><b>Interpolation Method</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wcs11.InterpolationMethodType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifier of interpolation method that will be used if the client does not specify one. Should
   * be included when a default exists and is known. (Arliss) Can any string be used to identify an
   * interpolation method in a KVP encoded Get Coverage operation request?
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.InterpolationMethodsType#getDefault
