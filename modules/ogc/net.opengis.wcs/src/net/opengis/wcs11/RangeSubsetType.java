 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Selection of desired subset of the coverage's range fields, (optionally) the interpolation method
 * applied to each field, and (optionally) field subsets.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.RangeSubsetType#getFieldSubset <em>Field Subset</em>}
 * </ul>
 *
...
public interface RangeSubsetType extends EObject {
  /**
   * Returns the value of the '<em><b>Field Subset</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wcs11.FieldSubsetType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
