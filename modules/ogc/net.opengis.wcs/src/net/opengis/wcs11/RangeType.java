 ...
 * race, or radiances by wavelength. Each range field is typically an observable whose meaning and
 * reference system are referenced by URIs.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.RangeType#getField <em>Field</em>}
 * </ul>
 *
...
public interface RangeType extends EObject {
  /**
   * Returns the value of the '<em><b>Field</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.wcs11.FieldType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
