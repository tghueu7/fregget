 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This XML Schema Document defines the DescribeCoverage operation request and response XML elements
 * and types, used by the OGC Web Coverage Service (WCS). Copyright (c) 2007 Open Geospatial
 * Consortium, Inc, All Rights Reserved. This XML Schema Document encodes the elements and types
 * that are shared by multiple WCS operations. Copyright (c) 2007 Open Geospatial Consortium, Inc,
 * All Rights Reserved. This XML Schema Document defines a GridCRS element that is much simpler but
 * otherwise similar to a specialization of gml:DerivedCRS. This GridCRS roughly corresponds to the
 * CV_RectifiedGrid class in ISO 19123, without inheritance from CV_Grid. This GridCRS is designed
 * for use by the OGC Web Coverage Service (WCS) and elsewhere. This XML Schema Document is not a
 * GML Application Schema, although it uses the GML 3.1.1 profile for WCS 1.1.1. Copyright (c) 2007
 * Open Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document defines
 * interpolation method elements and types, used by the OGC Web Coverage Service (WCS). Copyright
 * (c) 2007 Open Geospatial Consortium, Inc, All Rights Reserved. This XML Schema Document includes
 * and imports, directly and indirectly, all the XML Schemas defined by the OWS Common Implemetation
 * Specification. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML
 * Schema Document encodes the GetResourceByID operation request message. This typical operation is
 * specified as a base for profiling in specific OWS specifications. For information on the allowed
 * changes and limitations in such profiling, see Subclause 9.4.1 of the OWS Common specification.
 * Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document
 * encodes the parts of the MD_DataIdentification class of ISO 19115 (OGC Abstract Specification
 * Topic 11) which are expected to be used for most datasets. This Schema also encodes the parts of
 * this class that are expected to be useful for other metadata. Both may be used within the
 * Contents section of OWS service metadata (Capabilities) documents. Copyright (c) 2006 Open
 * Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document encodes various
 * parameters and parameter types that can be used in OWS operation requests and responses.
 * Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document
 * encodes the parts of ISO 19115 used by the common "ServiceIdentification" and "ServiceProvider"
 * sections of the GetCapabilities operation response, known as the service metadata XML document.
 * The parts encoded here are the MD_Keywords, CI_ResponsibleParty, and related classes. The UML
 * package prefixes were omitted from XML names, and the XML element names were all capitalized, for
 * consistency with other OWS Schemas. This document also provides a simple coding of text in
 * multiple languages, simplified from Annex J of ISO 19115. Copyright (c) 2006 Open Geospatial
 ...
 * Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the typical Contents
 * section of an OWS service metadata (Capabilities) document. This Schema can be built upon to
 * define the Contents section for a specific OWS. If the ContentsBaseType in this XML Schema cannot
 * be restricted and extended to define the Contents section for a specific OWS, all other relevant
 * parts defined in owsContents.xsd shall be used by the "ContentsType" in the wxsContents.xsd
 * prepared for the specific OWS. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights
 * Reserved. This XML Schema Document specifies types and elements for input and output of operation
 * data, allowing including multiple data items with each data item either included or referenced.
 * The contents of each type and element specified here can be restricted and/or extended for each
 * use in a specific OWS specification. Copyright (c) 2006 Open Geospatial Consortium, Inc. All
 * Rights Reserved. This XML Schema Document specifies types and elements for document or resource
 * references and for package manifests that contain multiple references. The contents of each type
 * and element specified here can be restricted and/or extended for each use in a specific OWS
 * specification. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved.
 * <!-- end-model-doc -->
 *
...
public interface Wcs11Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.AvailableKeysTypeImpl <em>Available
   * Keys Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.AxisSubsetTypeImpl <em>Axis Subset
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.AxisTypeImpl <em>Axis Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CapabilitiesTypeImpl <em>Capabilities
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.ContentsTypeImpl <em>Contents
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CoverageDescriptionsTypeImpl
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CoverageDomainTypeImpl <em>Coverage
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CoveragesTypeImpl <em>Coverages
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl <em>Coverage
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.RequestBaseTypeImpl <em>Request Base
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.DescribeCoverageTypeImpl <em>Describe
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.DocumentRootImpl <em>Document
   * Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.DomainSubsetTypeImpl <em>Domain
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.FieldSubsetTypeImpl <em>Field Subset
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.FieldTypeImpl <em>Field Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.GetCapabilitiesTypeImpl <em>Get
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.GetCoverageTypeImpl <em>Get Coverage
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.GridCrsTypeImpl <em>Grid Crs
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.ImageCRSRefTypeImpl <em>Image CRS Ref
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.InterpolationMethodBaseTypeImpl
   * <em>Interpolation Method Base Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.InterpolationMethodsTypeImpl
   * <em>Interpolation Methods Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.InterpolationMethodTypeImpl
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.OutputTypeImpl <em>Output Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.RangeSubsetTypeImpl <em>Range Subset
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.RangeTypeImpl <em>Range Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl <em>Spatial
   * Domain Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.TimePeriodTypeImpl <em>Time Period
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wcs11.impl.TimeSequenceTypeImpl <em>Time
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.AvailableKeysType <em>Available
   * Keys Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.AvailableKeysType#getKey
   * <em>Key</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.AxisSubsetType <em>Axis Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs11.AxisSubsetType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.AxisSubsetType#getKey
   * <em>Key</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs11.AxisType#getAvailableKeys <em>Available Keys</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.AxisType#getMeaning <em>Meaning</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.AxisType#getDataType <em>Data Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link net.opengis.wcs11.AxisType#getUOM
   * <em>UOM</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.AxisType#getReferenceSystem <em>Reference System</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs11.AxisType#getMetadata <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.AxisType#getIdentifier
   * <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CapabilitiesType <em>Capabilities
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.CapabilitiesType#getContents <em>Contents</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.ContentsType <em>Contents
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.ContentsType#getCoverageSummary <em>Coverage Summary</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.ContentsType#getSupportedCRS <em>Supported CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.ContentsType#getSupportedFormat <em>Supported Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.ContentsType#getOtherSource <em>Other Source</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CoverageDescriptionsType
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoverageDescriptionsType#getCoverageDescription <em>Coverage
   * Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CoverageDescriptionType
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getMetadata <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Metadata</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getDomain <em>Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getRange <em>Range</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getSupportedCRS <em>Supported CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Supported CRS</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageDescriptionType#getSupportedFormat <em>Supported Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Supported Format</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CoverageDomainType <em>Coverage
   * Domain Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CoveragesType <em>Coverages
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoveragesType#getCoverage <em>Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.CoverageSummaryType <em>Coverage
   * Summary Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoverageSummaryType#getMetadata <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Metadata</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoverageSummaryType#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageSummaryType#getSupportedCRS <em>Supported CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Supported CRS</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageSummaryType#getSupportedFormat <em>Supported Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Supported Format</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.CoverageSummaryType#getCoverageSummary <em>Coverage Summary</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Coverage Summary</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageSummaryType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.CoverageSummaryType#getIdentifier1 <em>Identifier1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.DescribeCoverageType <em>Describe
   * Coverage Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.DescribeCoverageType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wcs11.DocumentRoot#getMixed
   * <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wcs11.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wcs11.DocumentRoot#getXSISchemaLocation
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getAvailableKeys <em>Available Keys</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Available Keys</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getAxisSubset <em>Axis Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getCapabilities <em>Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getContents <em>Contents</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Contents</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getCoverage <em>Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getCoverageDescriptions <em>Coverage Descriptions</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getCoverages <em>Coverages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getCoverageSummary <em>Coverage Summary</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getDescribeCoverage <em>Describe Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getGetCoverage <em>Get Coverage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getGridBaseCRS
   * <em>Grid Base CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getGridCRS <em>Grid CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getGridCS
   * <em>Grid CS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getGridOffsets
   * <em>Grid Offsets</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getGridOrigin
   * <em>Grid Origin</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getGridType
   * <em>Grid Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.DocumentRoot#getIdentifier
   * <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getInterpolationMethods <em>Interpolation Methods</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getTemporalDomain <em>Temporal Domain</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Temporal Domain</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DocumentRoot#getTemporalSubset <em>Temporal Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.DomainSubsetType <em>Domain Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wcs11.DomainSubsetType#getBoundingBoxGroup <em>Bounding Box Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DomainSubsetType#getBoundingBox <em>Bounding Box</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Temporal Subset</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.FieldSubsetType <em>Field Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.FieldSubsetType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.FieldSubsetType#getInterpolationType <em>Interpolation Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.FieldSubsetType#getAxisSubset <em>Axis Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.FieldType#getIdentifier
   * <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.FieldType#getDefinition <em>Definition</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.FieldType#getNullValue <em>Null Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.FieldType#getInterpolationMethods <em>Interpolation Methods</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Interpolation Methods</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.FieldType#getAxis <em>Axis</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.GetCapabilitiesType <em>Get
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.GetCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.GetCoverageType <em>Get Coverage
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.GetCoverageType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.GetCoverageType#getDomainSubset <em>Domain Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.GetCoverageType#getRangeSubset <em>Range Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.GetCoverageType#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.GridCrsType <em>Grid Crs
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getGridBaseCRS
   * <em>Grid Base CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getGridType
   * <em>Grid Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getGridOrigin
   * <em>Grid Origin</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getGridOffsets
   * <em>Grid Offsets</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getGridCS
   * <em>Grid CS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.GridCrsType#getId
   * <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.ImageCRSRefType <em>Image CRS Ref
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.ImageCRSRefType#getImageCRS
   * <em>Image CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.InterpolationMethodBaseType
   * <em>Interpolation Method Base Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.InterpolationMethodsType
   * <em>Interpolation Methods Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.InterpolationMethodsType#getInterpolationMethod <em>Interpolation
   * Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.InterpolationMethodsType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.InterpolationMethodType
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.InterpolationMethodType#getNullResistance <em>Null Resistance</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.OutputType#getGridCRS <em>Grid CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Grid CRS</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.OutputType#getFormat
   * <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.OutputType#isStore
   * <em>Store</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.RangeSubsetType <em>Range Subset
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.RangeSubsetType#getFieldSubset <em>Field Subset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.RangeType#getField <em>Field</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.RequestBaseType <em>Request Base
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.RequestBaseType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.RequestBaseType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.RequestBaseType#getBaseUrl
   * <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.RequestBaseType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.SpatialDomainType <em>Spatial
   * Domain Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs11.SpatialDomainType#getBoundingBoxGroup <em>Bounding Box Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute list '<em>Bounding Box Group</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.SpatialDomainType#getBoundingBox <em>Bounding Box</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.SpatialDomainType#getGridCRS <em>Grid CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Grid CRS</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.SpatialDomainType#getTransformation <em>Transformation</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wcs11.SpatialDomainType#getImageCRS <em>Image CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.SpatialDomainType#getPolygon <em>Polygon</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.TimePeriodType <em>Time Period
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.TimePeriodType#getBeginPosition <em>Begin Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.TimePeriodType#getEndPosition <em>End Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.TimePeriodType#getTimeResolution <em>Time Resolution</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wcs11.TimePeriodType#getFrame
   * <em>Frame</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wcs11.TimeSequenceType <em>Time Sequence
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wcs11.TimeSequenceType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wcs11.TimeSequenceType#getTimePosition <em>Time Position</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wcs11.TimeSequenceType#getTimePeriod <em>Time Period</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='IdentifierType'
   *     baseType='http://www.eclipse.org/emf/2003/XMLType#string' pattern='.+'"
   * @generated
   */
  EDataType getIdentifierType();

  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Interpolation Method Base
   * Type Base</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   *     extendedMetaData="name='InterpolationMethodBaseType_._base'
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData="name='TimeDurationType'
   *     memberTypes='http://www.eclipse.org/emf/2003/XMLType#duration
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.AvailableKeysTypeImpl
     * <em>Available Keys Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs11.impl.AvailableKeysTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.AxisSubsetTypeImpl <em>Axis
     * Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.AxisTypeImpl <em>Axis
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Available Keys</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CapabilitiesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.ContentsTypeImpl <em>Contents
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CoverageDescriptionsTypeImpl
     * <em>Coverage Descriptions Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CoverageDescriptionTypeImpl
     * <em>Coverage Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute COVERAGE_DESCRIPTION_TYPE__IDENTIFIER =
        eINSTANCE.getCoverageDescriptionType_Identifier();
     ...
     * @generated
     */
    EAttribute COVERAGE_DESCRIPTION_TYPE__SUPPORTED_CRS =
        eINSTANCE.getCoverageDescriptionType_SupportedCRS();
     ...
     * @generated
     */
    EAttribute COVERAGE_DESCRIPTION_TYPE__SUPPORTED_FORMAT =
        eINSTANCE.getCoverageDescriptionType_SupportedFormat();

    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CoverageDomainTypeImpl
     * <em>Coverage Domain Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs11.impl.CoverageDomainTypeImpl
     ...
     * @generated
     */
    EReference COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN =
        eINSTANCE.getCoverageDomainType_SpatialDomain();
     ...
     * @generated
     */
    EReference COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN =
        eINSTANCE.getCoverageDomainType_TemporalDomain();

    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CoveragesTypeImpl
     * <em>Coverages Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs11.impl.CoveragesTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Coverage</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.CoverageSummaryTypeImpl
     ...
     * @generated
     */
    EAttribute COVERAGE_SUMMARY_TYPE__SUPPORTED_CRS =
        eINSTANCE.getCoverageSummaryType_SupportedCRS();
     ...
     * @generated
     */
    EAttribute COVERAGE_SUMMARY_TYPE__SUPPORTED_FORMAT =
        eINSTANCE.getCoverageSummaryType_SupportedFormat();
     ...
     * @generated
     */
    EReference COVERAGE_SUMMARY_TYPE__COVERAGE_SUMMARY =
        eINSTANCE.getCoverageSummaryType_CoverageSummary();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.DescribeCoverageTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.DocumentRootImpl <em>Document
     * Root</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Interpolation Methods</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference DOCUMENT_ROOT__INTERPOLATION_METHODS =
        eINSTANCE.getDocumentRoot_InterpolationMethods();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.DomainSubsetTypeImpl
     ...
     * @generated
     */
    EAttribute DOMAIN_SUBSET_TYPE__BOUNDING_BOX_GROUP =
        eINSTANCE.getDomainSubsetType_BoundingBoxGroup();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.FieldSubsetTypeImpl <em>Field
     * Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute FIELD_SUBSET_TYPE__INTERPOLATION_TYPE =
        eINSTANCE.getFieldSubsetType_InterpolationType();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.FieldTypeImpl <em>Field
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Null Value</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.GetCapabilitiesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.GetCoverageTypeImpl <em>Get
     * Coverage Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.GridCrsTypeImpl <em>Grid Crs
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.ImageCRSRefTypeImpl <em>Image
     * CRS Ref Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wcs11.impl.ImageCRSRefTypeImpl
     ...
     * net.opengis.wcs11.impl.InterpolationMethodBaseTypeImpl <em>Interpolation Method Base
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.InterpolationMethodsTypeImpl
     * <em>Interpolation Methods Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Interpolation Method</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference INTERPOLATION_METHODS_TYPE__INTERPOLATION_METHOD =
        eINSTANCE.getInterpolationMethodsType_InterpolationMethod();
     ...
     * @generated
     */
    EAttribute INTERPOLATION_METHODS_TYPE__DEFAULT =
        eINSTANCE.getInterpolationMethodsType_Default();

    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.InterpolationMethodTypeImpl
     * <em>Interpolation Method Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute INTERPOLATION_METHOD_TYPE__NULL_RESISTANCE =
        eINSTANCE.getInterpolationMethodType_NullResistance();

    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.OutputTypeImpl <em>Output
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.RangeSubsetTypeImpl <em>Range
     * Subset Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Field Subset</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.RangeTypeImpl <em>Range
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.RequestBaseTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.SpatialDomainTypeImpl
     ...
     * @generated
     */
    EAttribute SPATIAL_DOMAIN_TYPE__BOUNDING_BOX_GROUP =
        eINSTANCE.getSpatialDomainType_BoundingBoxGroup();
     ...
     * @generated
     */
    EAttribute SPATIAL_DOMAIN_TYPE__TRANSFORMATION =
        eINSTANCE.getSpatialDomainType_Transformation();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.TimePeriodTypeImpl <em>Time
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wcs11.impl.TimeSequenceTypeImpl <em>Time
     * Sequence Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
