 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Definition of one axis in a field for which there are a vector of values. This type is largely a
 * subset of the ows:DomainType as needed for a range field axis.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.AxisType#getAvailableKeys <em>Available Keys</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getMeaning <em>Meaning</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getUOM <em>UOM</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getReferenceSystem <em>Reference System</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wcs11.AxisType#getIdentifier <em>Identifier</em>}
 * </ul>
 *
...
public interface AxisType extends DescriptionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='AvailableKeys'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getAvailableKeys <em>Available
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getMeaning <em>Meaning</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getDataType <em>Data Type</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getUOM <em>UOM</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getReferenceSystem <em>Reference
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Optional unordered list of other metadata elements about this axis. A list of required and
   * optional other metadata elements for this quantity can be specified in a WCS Application
   * Profile.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisType#getIdentifier <em>Identifier</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
