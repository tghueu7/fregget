 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.AxisSubsetType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.AxisSubsetType#getKey <em>Key</em>}
 * </ul>
 *
...
public interface AxisSubsetType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.AxisSubsetType#getIdentifier
  ...
  /**
   * Returns the value of the '<em><b>Key</b></em>' attribute list. The list contents are of type
   * {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of (at least one) Key, to be used for selecting values in a range vector field.
   * The Keys within this list shall be unique. TBD.
   * <!-- end-model-doc -->
   *
