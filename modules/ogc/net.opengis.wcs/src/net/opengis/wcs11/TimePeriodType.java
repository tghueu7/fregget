 ...
 * xlinks on the begin/end elements. (Arliss) What does this mean? What do the TimeResolution and
 * "frame" mean?
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.TimePeriodType#getBeginPosition <em>Begin Position</em>}
 *   <li>{@link net.opengis.wcs11.TimePeriodType#getEndPosition <em>End Position</em>}
 *   <li>{@link net.opengis.wcs11.TimePeriodType#getTimeResolution <em>Time Resolution</em>}
 *   <li>{@link net.opengis.wcs11.TimePeriodType#getFrame <em>Frame</em>}
 * </ul>
 *
...
public interface TimePeriodType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Begin Position</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.TimePeriodType#getBeginPosition <em>Begin
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>End Position</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.TimePeriodType#getEndPosition <em>End
   * Position</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.wcs11.TimeDurationType" extendedMetaData="kind='element'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.TimePeriodType#getTimeResolution <em>Time
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.TimePeriodType#getFrame <em>Frame</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wcs11.TimePeriodType#getFrame <em>Frame</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wcs11.TimePeriodType#getFrame
