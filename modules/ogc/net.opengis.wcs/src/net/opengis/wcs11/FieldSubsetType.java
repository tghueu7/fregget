 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.FieldSubsetType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wcs11.FieldSubsetType#getInterpolationType <em>Interpolation Type</em>}
 *   <li>{@link net.opengis.wcs11.FieldSubsetType#getAxisSubset <em>Axis Subset</em>}
 * </ul>
 *
...
public interface FieldSubsetType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.FieldSubsetType#getIdentifier
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Optional identifier of the spatial interpolation type to be applied to this range field. This
   * interpolation type shall be one that is identified for this Field in the CoverageDescription.
   * When this parameter is omitted, the interpolation method used shall be the default method
   * specified for this Field, if any.
   * <!-- end-model-doc -->
   *
   ...
   *     name='InterpolationType' namespace='##targetNamespace'"
   * @generated
   */
  String getInterpolationType();

  /**
   * Sets the value of the '{@link net.opengis.wcs11.FieldSubsetType#getInterpolationType
   * <em>Interpolation Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Axis Subset</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wcs11.AxisSubsetType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
