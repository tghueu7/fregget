 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Definition of the spatial-temporal domain of a coverage. The Domain shall include a SpatialDomain
 * (describing the spatial locations for which coverages can be requested), and should included a
 * TemporalDomain (describing the time instants or intervals for which coverages can be requested).
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wcs11.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}
 *   <li>{@link net.opengis.wcs11.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}
 * </ul>
 *
...
public interface CoverageDomainType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='SpatialDomain'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.CoverageDomainType#getSpatialDomain <em>Spatial
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Although optional, the TemporalDomain should be included whenever a value is known or a useful
  ...
  /**
   * Sets the value of the '{@link net.opengis.wcs11.CoverageDomainType#getTemporalDomain
   * <em>Temporal Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
