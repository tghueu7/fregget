 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestTypeImpl#getSource <em>Source</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestTypeImpl#getResourceType <em>Resource Type</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestTypeImpl#getResourceFormat <em>Resource
 *       Format</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestTypeImpl#getHarvestInterval <em>Harvest
 *       Interval</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestTypeImpl#getResponseHandler <em>Response
 *       Handler</em>}
 * </ul>
 *
 * @generated
...
public class HarvestTypeImpl extends RequestBaseTypeImpl implements HarvestType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.HARVEST_TYPE__SOURCE, oldSource, source));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_TYPE__RESOURCE_TYPE,
              oldResourceType,
              resourceType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_TYPE__RESOURCE_FORMAT,
              oldResourceFormat,
              resourceFormat,
              !oldResourceFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_TYPE__HARVEST_INTERVAL,
              oldHarvestInterval,
              harvestInterval));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_TYPE__RESPONSE_HANDLER,
              oldResponseHandler,
              responseHandler));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.HARVEST_TYPE__RESOURCE_TYPE:
        return RESOURCE_TYPE_EDEFAULT == null
            ? resourceType != null
            : !RESOURCE_TYPE_EDEFAULT.equals(resourceType);
      case Csw20Package.HARVEST_TYPE__RESOURCE_FORMAT:
        return isSetResourceFormat();
      case Csw20Package.HARVEST_TYPE__HARVEST_INTERVAL:
        return HARVEST_INTERVAL_EDEFAULT == null
            ? harvestInterval != null
            : !HARVEST_INTERVAL_EDEFAULT.equals(harvestInterval);
      case Csw20Package.HARVEST_TYPE__RESPONSE_HANDLER:
  ...
  public String toString() {
    ...
    if (resourceFormatESet) result.append(resourceFormat);
