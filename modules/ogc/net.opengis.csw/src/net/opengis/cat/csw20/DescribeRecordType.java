 ...
 *
 * <p>schemaLanguage - preferred schema language (W3C XML Schema by default) outputFormat -
 * preferred output format (application/xml by default)
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.DescribeRecordType#getTypeName <em>Type Name</em>}
 *   <li>{@link net.opengis.cat.csw20.DescribeRecordType#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.cat.csw20.DescribeRecordType#getSchemaLanguage <em>Schema Language</em>}
 * </ul>
 *
...
public interface DescribeRecordType extends RequestBaseType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DescribeRecordType#getOutputFormat
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.DescribeRecordType#getOutputFormat
   * <em>Output Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.cat.csw20.DescribeRecordType#getOutputFormat <em>Output Format</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Schema Language</b></em>' attribute. The default value is
   * <code>"http://www.w3.org/XML/Schema"</code>.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Schema Language</em>' attribute isn't clear, there really should
   ...
   * @model default="http://www.w3.org/XML/Schema" unsettable="true"
   *     dataType="org.eclipse.emf.ecore.xml.type.AnyURI" extendedMetaData="kind='attribute'
   *     name='schemaLanguage'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DescribeRecordType#getSchemaLanguage
   * <em>Schema Language</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.DescribeRecordType#getSchemaLanguage
   * <em>Schema Language</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.cat.csw20.DescribeRecordType#getSchemaLanguage <em>Schema Language</em>}' attribute
   * is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
