 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.RequestBaseTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.RequestBaseTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.RequestBaseTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.RequestBaseTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.REQUEST_BASE_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.REQUEST_BASE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.REQUEST_BASE_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.REQUEST_BASE_TYPE__EXTENDED_PROPERTIES,
