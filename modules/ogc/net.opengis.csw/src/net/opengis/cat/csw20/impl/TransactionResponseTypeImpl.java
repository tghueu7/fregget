 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionResponseTypeImpl#getTransactionSummary
 *       <em>Transaction Summary</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionResponseTypeImpl#getInsertResult <em>Insert
 *       Result</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionResponseTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class TransactionResponseTypeImpl extends EObjectImpl implements TransactionResponseType {
  ...
  /**
   * The cached value of the '{@link #getInsertResult() <em>Insert Result</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_RESPONSE_TYPE__TRANSACTION_SUMMARY,
  ...
  public EList<InsertResultType> getInsertResult() {
    if (insertResult == null) {
      insertResult =
          new EObjectContainmentEList<InsertResultType>(
              InsertResultType.class, this, Csw20Package.TRANSACTION_RESPONSE_TYPE__INSERT_RESULT);
    }
    return insertResult;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_RESPONSE_TYPE__VERSION,
              oldVersion,
              version));
  }
