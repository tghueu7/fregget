 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.BriefRecordTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.BriefRecordTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.BriefRecordTypeImpl#getType <em>Type</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.BriefRecordTypeImpl#getBoundingBox <em>Bounding Box</em>}
 * </ul>
 *
 * @generated
 */
public class BriefRecordTypeImpl extends AbstractRecordTypeImpl implements BriefRecordType {
    ...
    if (identifier == null) {
      identifier =
          new EObjectResolvingEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.BRIEF_RECORD_TYPE__IDENTIFIER);
    }
    return identifier;
  }
  ...
  public EList<SimpleLiteral> getTitle() {
    if (title == null) {
      title =
          new EObjectResolvingEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.BRIEF_RECORD_TYPE__TITLE);
    }
    return title;
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this, Notification.RESOLVE, Csw20Package.BRIEF_RECORD_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(SimpleLiteral newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.BRIEF_RECORD_TYPE__TYPE, oldType, type));
  }
