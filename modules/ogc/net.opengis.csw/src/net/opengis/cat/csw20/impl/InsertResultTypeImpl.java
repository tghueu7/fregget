 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.InsertResultTypeImpl#getBriefRecord <em>Brief
 *       Record</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.InsertResultTypeImpl#getHandleRef <em>Handle Ref</em>}
 * </ul>
 *
 * @generated
 */
public class InsertResultTypeImpl extends EObjectImpl implements InsertResultType {
  /**
   * The cached value of the '{@link #getBriefRecord() <em>Brief Record</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<BriefRecordType> getBriefRecord() {
    if (briefRecord == null) {
      briefRecord =
          new EObjectContainmentEList<BriefRecordType>(
              BriefRecordType.class, this, Csw20Package.INSERT_RESULT_TYPE__BRIEF_RECORD);
    }
    return briefRecord;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.INSERT_RESULT_TYPE__HANDLE_REF,
              oldHandleRef,
              handleRef));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.INSERT_RESULT_TYPE__HANDLE_REF:
        return HANDLE_REF_EDEFAULT == null
            ? handleRef != null
            : !HANDLE_REF_EDEFAULT.equals(handleRef);
    }
