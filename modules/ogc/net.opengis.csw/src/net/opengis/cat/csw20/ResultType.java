 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Result Type</b></em>', and utility
...
public enum ResultType implements Enumerator {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Validate the request and return an Acknowledgement message if it is valid. Continue processing
