 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.UpdateTypeImpl#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.UpdateTypeImpl#getRecordProperty <em>Record
 *       Property</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.UpdateTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.UpdateTypeImpl#getHandle <em>Handle</em>}
 * </ul>
 *
 * @generated
 */
public class UpdateTypeImpl extends EObjectImpl implements UpdateType {
  ...
  /**
   * The cached value of the '{@link #getRecordProperty() <em>Record Property</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<RecordPropertyType> getRecordProperty() {
    if (recordProperty == null) {
      recordProperty =
          new EObjectContainmentEList<RecordPropertyType>(
              RecordPropertyType.class, this, Csw20Package.UPDATE_TYPE__RECORD_PROPERTY);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.UPDATE_TYPE__CONSTRAINT,
              oldConstraint,
              newConstraint);
      ...
      if (constraint != null)
        msgs =
            ((InternalEObject) constraint)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.UPDATE_TYPE__CONSTRAINT,
                    null,
                    msgs);
  ...
  public void setHandle(String newHandle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.UPDATE_TYPE__HANDLE, oldHandle, handle));
  }
