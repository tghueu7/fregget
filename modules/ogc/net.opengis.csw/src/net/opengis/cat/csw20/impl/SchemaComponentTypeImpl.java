 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.SchemaComponentTypeImpl#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SchemaComponentTypeImpl#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SchemaComponentTypeImpl#getParentSchema <em>Parent
 *       Schema</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SchemaComponentTypeImpl#getSchemaLanguage <em>Schema
 *       Language</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SchemaComponentTypeImpl#getTargetNamespace <em>Target
 *       Namespace</em>}
 * </ul>
 *
 * @generated
...
public class SchemaComponentTypeImpl extends EObjectImpl implements SchemaComponentType {
  ...
  public FeatureMap getAny() {
    return (FeatureMap)
        getMixed().<FeatureMap.Entry>list(Csw20Package.Literals.SCHEMA_COMPONENT_TYPE__ANY);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SCHEMA_COMPONENT_TYPE__PARENT_SCHEMA,
              oldParentSchema,
              parentSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SCHEMA_COMPONENT_TYPE__SCHEMA_LANGUAGE,
              oldSchemaLanguage,
              schemaLanguage));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SCHEMA_COMPONENT_TYPE__TARGET_NAMESPACE,
              oldTargetNamespace,
              targetNamespace));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.SCHEMA_COMPONENT_TYPE__PARENT_SCHEMA:
        return PARENT_SCHEMA_EDEFAULT == null
            ? parentSchema != null
            : !PARENT_SCHEMA_EDEFAULT.equals(parentSchema);
      case Csw20Package.SCHEMA_COMPONENT_TYPE__SCHEMA_LANGUAGE:
        return SCHEMA_LANGUAGE_EDEFAULT == null
            ? schemaLanguage != null
            : !SCHEMA_LANGUAGE_EDEFAULT.equals(schemaLanguage);
      case Csw20Package.SCHEMA_COMPONENT_TYPE__TARGET_NAMESPACE:
        return TARGET_NAMESPACE_EDEFAULT == null
