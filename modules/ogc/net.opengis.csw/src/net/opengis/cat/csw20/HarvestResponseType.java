 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.HarvestResponseType#getAcknowledgement
 *       <em>Acknowledgement</em>}
 *   <li>{@link net.opengis.cat.csw20.HarvestResponseType#getTransactionResponse <em>Transaction
 *       Response</em>}
 * </ul>
 *
...
public interface HarvestResponseType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Acknowledgement</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Acknowledgement'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.HarvestResponseType#getAcknowledgement
   * <em>Acknowledgement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='TransactionResponse'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.HarvestResponseType#getTransactionResponse
