 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.ElementSetNameTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.ElementSetNameTypeImpl#getTypeNames <em>Type Names</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.ELEMENT_SET_NAME_TYPE__VALUE,
              oldValue,
              value,
              !oldValueESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.ELEMENT_SET_NAME_TYPE__TYPE_NAMES,
              oldTypeNames,
              typeNames));
  }
