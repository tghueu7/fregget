...
public class Csw20PackageImpl extends EPackageImpl implements Csw20Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Csw20Package#eINSTANCE} when that field is
  ...
  public static Csw20Package init() {
    ...
    Csw20PackageImpl theCsw20Package =
        (Csw20PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Csw20PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Csw20PackageImpl());
  ...
  public void createPackageContents() {
    ...
    createEReference(
        describeRecordResponseTypeEClass, DESCRIBE_RECORD_RESPONSE_TYPE__SCHEMA_COMPONENT);
    ...
    createEAttribute(
        getRecordByIdResponseTypeEClass, GET_RECORD_BY_ID_RESPONSE_TYPE__ABSTRACT_RECORD_GROUP);
    createEReference(
        getRecordByIdResponseTypeEClass, GET_RECORD_BY_ID_RESPONSE_TYPE__ABSTRACT_RECORD);
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getAcknowledgementType_TimeStamp(),
        this.getCalendar(),
        "timeStamp",
        null,
        0,
    ...
    initEReference(
        ...
        theOws10Package.getBoundingBoxType(),
        null,
        "boundingBox",
        null,
        0,
