 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordByIdTypeImpl#getId <em>Id</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordByIdTypeImpl#getElementSetName <em>Element Set
 *       Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordByIdTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordByIdTypeImpl#getOutputSchema <em>Output
 *       Schema</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORD_BY_ID_TYPE__ELEMENT_SET_NAME,
              oldElementSetName,
              newElementSetName);
      ...
      if (elementSetName != null)
        msgs =
            ((InternalEObject) elementSetName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORD_BY_ID_TYPE__ELEMENT_SET_NAME,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORD_BY_ID_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORD_BY_ID_TYPE__OUTPUT_SCHEMA,
              oldOutputSchema,
              outputSchema));
  }
