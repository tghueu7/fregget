 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#getInsert <em>Insert</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#getUpdate <em>Update</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#getDelete <em>Delete</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#getRequestId <em>Request Id</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionTypeImpl#isVerboseResponse <em>Verbose
 *       Response</em>}
 * </ul>
 *
 * @generated
...
public class TransactionTypeImpl extends RequestBaseTypeImpl implements TransactionType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_TYPE__REQUEST_ID,
              oldRequestId,
              requestId));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_TYPE__VERBOSE_RESPONSE,
              oldVerboseResponse,
              verboseResponse,
              !oldVerboseResponseESet));
  }
  ...
  public String toString() {
    ...
    if (verboseResponseESet) result.append(verboseResponse);
