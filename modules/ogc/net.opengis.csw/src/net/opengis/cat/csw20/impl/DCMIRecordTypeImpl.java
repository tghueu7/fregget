 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.DCMIRecordTypeImpl#getDCElement <em>DC Element</em>}
 * </ul>
 *
 * @generated
 */
public class DCMIRecordTypeImpl extends AbstractRecordTypeImpl implements DCMIRecordType {
  ...
  /**
   * The cached value of the '{@link #getDCElement()() <em>DCElement</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (dcElement == null) {
      dcElement =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.DCMI_RECORD_TYPE__DC_ELEMENT);
    }
    return dcElement;
  }
