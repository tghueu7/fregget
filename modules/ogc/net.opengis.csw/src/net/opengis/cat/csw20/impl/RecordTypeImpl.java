 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.RecordTypeImpl#getAnyText <em>Any Text</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.RecordTypeImpl#getBoundingBox <em>Bounding Box</em>}
 * </ul>
 *
 * @generated
 */
public class RecordTypeImpl extends DCMIRecordTypeImpl implements RecordType {
  ...
  public EList<String> getAnyText() {
    if (anyText == null) {
      anyText =
          new EObjectContainmentEList<String>(
              String.class, this, Csw20Package.RECORD_TYPE__ANY_TEXT);
    }
    return anyText;
  }
