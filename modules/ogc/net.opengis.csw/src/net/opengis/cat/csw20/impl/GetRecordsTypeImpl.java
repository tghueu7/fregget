 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getDistributedSearch <em>Distributed
 *       Search</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getResponseHandler <em>Response
 *       Handler</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getMaxRecords <em>Max Records</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getOutputSchema <em>Output
 *       Schema</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getRequestId <em>Request Id</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getResultType <em>Result Type</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getStartPosition <em>Start
 *       Position</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsTypeImpl#getQuery <em>Query</em>}
 * </ul>
 *
 * @generated
 */
public class GetRecordsTypeImpl extends RequestBaseTypeImpl implements GetRecordsType {
  /**
   * The cached value of the '{@link #getDistributedSearch() <em>Distributed Search</em>}'
   ...
   * @generated
   */
  public NotificationChain basicSetDistributedSearch(
      DistributedSearchType newDistributedSearch, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__DISTRIBUTED_SEARCH,
              oldDistributedSearch,
  ...
  public void setDistributedSearch(DistributedSearchType newDistributedSearch) {
    if (newDistributedSearch != distributedSearch) {
      ...
      if (distributedSearch != null)
        msgs =
            ((InternalEObject) distributedSearch)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_TYPE__DISTRIBUTED_SEARCH,
                    null,
                    msgs);
      if (newDistributedSearch != null)
        msgs =
            ((InternalEObject) newDistributedSearch)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_TYPE__DISTRIBUTED_SEARCH,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__RESPONSE_HANDLER,
              oldResponseHandler,
              responseHandler));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__MAX_RECORDS,
              oldMaxRecords,
              maxRecords));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__OUTPUT_SCHEMA,
              oldOutputSchema,
              outputSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__REQUEST_ID,
              oldRequestId,
              requestId));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__RESULT_TYPE,
              oldResultType,
              resultType,
              !oldResultTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_TYPE__START_POSITION,
              oldStartPosition,
              startPosition));
  }
  ...
  public void setQuery(Object newQuery) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.GET_RECORDS_TYPE__QUERY, oldQuery, query));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.GET_RECORDS_TYPE__RESPONSE_HANDLER:
        return RESPONSE_HANDLER_EDEFAULT == null
            ? responseHandler != null
            : !RESPONSE_HANDLER_EDEFAULT.equals(responseHandler);
      case Csw20Package.GET_RECORDS_TYPE__ANY:
        return any != null && !any.isEmpty();
      case Csw20Package.GET_RECORDS_TYPE__MAX_RECORDS:
        return MAX_RECORDS_EDEFAULT == null
            ? maxRecords != null
            : !MAX_RECORDS_EDEFAULT.equals(maxRecords);
      case Csw20Package.GET_RECORDS_TYPE__OUTPUT_FORMAT:
        return isSetOutputFormat();
      case Csw20Package.GET_RECORDS_TYPE__OUTPUT_SCHEMA:
        return OUTPUT_SCHEMA_EDEFAULT == null
            ? outputSchema != null
            : !OUTPUT_SCHEMA_EDEFAULT.equals(outputSchema);
      case Csw20Package.GET_RECORDS_TYPE__REQUEST_ID:
        return REQUEST_ID_EDEFAULT == null
            ? requestId != null
            : !REQUEST_ID_EDEFAULT.equals(requestId);
      case Csw20Package.GET_RECORDS_TYPE__RESULT_TYPE:
        return isSetResultType();
      case Csw20Package.GET_RECORDS_TYPE__START_POSITION:
        return START_POSITION_EDEFAULT == null
            ? startPosition != null
            : !START_POSITION_EDEFAULT.equals(startPosition);
      case Csw20Package.GET_RECORDS_TYPE__QUERY:
