 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.DeleteTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DeleteTypeImpl#getHandle <em>Handle</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DeleteTypeImpl#getTypeName <em>Type Name</em>}
 * </ul>
 *
 * @generated
 */
public class DeleteTypeImpl extends EObjectImpl implements DeleteType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DELETE_TYPE__CONSTRAINT,
              oldConstraint,
              newConstraint);
      ...
      if (constraint != null)
        msgs =
            ((InternalEObject) constraint)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DELETE_TYPE__CONSTRAINT,
                    null,
                    msgs);
  ...
  public void setHandle(String newHandle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.DELETE_TYPE__HANDLE, oldHandle, handle));
  }
  ...
  public void setTypeName(String newTypeName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.DELETE_TYPE__TYPE_NAME, oldTypeName, typeName));
  }
