 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Users may insert, update, or delete catalogue entries. If the verboseResponse attribute has the
 * value "true", then one or more csw:InsertResult elements must be included in the response.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.TransactionType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionType#getInsert <em>Insert</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionType#getUpdate <em>Update</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionType#getDelete <em>Delete</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionType#getRequestId <em>Request Id</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionType#isVerboseResponse <em>Verbose Response</em>}
 * </ul>
 *
...
public interface TransactionType extends RequestBaseType {
   ...
   * are of type {@link net.opengis.cat.csw20.InsertType}.
   * <!-- begin-user-doc -->
   *
   ...
   * are of type {@link net.opengis.cat.csw20.UpdateType}.
   * <!-- begin-user-doc -->
   *
   ...
   * are of type {@link net.opengis.cat.csw20.DeleteType}.
   * <!-- begin-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionType#getRequestId <em>Request
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Verbose Response</b></em>' attribute. The default value is
   * <code>"false"</code>.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Verbose Response</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionType#isVerboseResponse
   * <em>Verbose Response</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.TransactionType#isVerboseResponse
   * <em>Verbose Response</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.cat.csw20.TransactionType#isVerboseResponse <em>Verbose Response</em>}' attribute
   * is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
