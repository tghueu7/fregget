 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.SchemaComponentType#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.cat.csw20.SchemaComponentType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.SchemaComponentType#getParentSchema <em>Parent Schema</em>}
 *   <li>{@link net.opengis.cat.csw20.SchemaComponentType#getSchemaLanguage <em>Schema
 *       Language</em>}
 *   <li>{@link net.opengis.cat.csw20.SchemaComponentType#getTargetNamespace <em>Target
 *       Namespace</em>}
 * </ul>
 *
...
public interface SchemaComponentType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Parent Schema</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SchemaComponentType#getParentSchema
   * <em>Parent Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SchemaComponentType#getSchemaLanguage
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Target Namespace</em>' attribute isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SchemaComponentType#getTargetNamespace
   * <em>Target Namespace</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
