 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsResponseTypeImpl#getRequestId <em>Request
 *       Id</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsResponseTypeImpl#getSearchStatus <em>Search
 *       Status</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsResponseTypeImpl#getSearchResults <em>Search
 *       Results</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetRecordsResponseTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class GetRecordsResponseTypeImpl extends EObjectImpl implements GetRecordsResponseType {
  ...
  /**
   * The cached value of the '{@link #getSearchStatus() <em>Search Status</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSearchResults() <em>Search Results</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_RESPONSE_TYPE__REQUEST_ID,
              oldRequestId,
              requestId));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetSearchStatus(
      RequestStatusType newSearchStatus, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_STATUS,
              oldSearchStatus,
              newSearchStatus);
  ...
  public void setSearchStatus(RequestStatusType newSearchStatus) {
    if (newSearchStatus != searchStatus) {
      ...
      if (searchStatus != null)
        msgs =
            ((InternalEObject) searchStatus)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_STATUS,
                    null,
                    msgs);
      if (newSearchStatus != null)
        msgs =
            ((InternalEObject) newSearchStatus)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_STATUS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetSearchResults(
      SearchResultsType newSearchResults, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_RESULTS,
              oldSearchResults,
              newSearchResults);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSearchResults(SearchResultsType newSearchResults) {
    if (newSearchResults != searchResults) {
      ...
      if (searchResults != null)
        msgs =
            ((InternalEObject) searchResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_RESULTS,
                    null,
                    msgs);
      if (newSearchResults != null)
        msgs =
            ((InternalEObject) newSearchResults)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.GET_RECORDS_RESPONSE_TYPE__SEARCH_RESULTS,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_RECORDS_RESPONSE_TYPE__VERSION,
              oldVersion,
              version));
  }
