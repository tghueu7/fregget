 ...
 *
 * <p>status - status of the search timestamp - the date and time when the result set was modified
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.RequestStatusType#getTimestamp <em>Timestamp</em>}
 * </ul>
 *
...
public interface RequestStatusType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Timestamp</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.RequestStatusType#getTimestamp
   * <em>Timestamp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
