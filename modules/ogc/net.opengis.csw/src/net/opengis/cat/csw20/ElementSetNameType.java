 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.ElementSetNameType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.cat.csw20.ElementSetNameType#getTypeNames <em>Type Names</em>}
 * </ul>
 *
...
public interface ElementSetNameType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.ElementSetNameType#getValue
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.ElementSetNameType#getValue
   * <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.cat.csw20.ElementSetNameType#getValue
   ...
   * @model dataType="net.opengis.cat.csw20.TypeNameListType" extendedMetaData="kind='attribute'
   *     name='typeNames'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.ElementSetNameType#getTypeNames <em>Type
   * Names</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
