 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Includes representations of result set members if maxRecords > 0. The items must conform to one
 * of the csw:Record views or a profile-specific representation.
 *
 * <p>resultSetId - id of the result set (a URI). elementSet - The element set that has been
 * returned (i.e., "brief", "summary", "full") recordSchema - schema reference for included
 * records(URI) numberOfRecordsMatched - number of records matched by the query
 * numberOfRecordsReturned - number of records returned to client nextRecord - position of next
 * record in the result set (0 if no records remain). expires - the time instant when the result set
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getAbstractRecordGroup <em>Abstract Record
 *       Group</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getAbstractRecord <em>Abstract Record</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getElementSet <em>Element Set</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getExpires <em>Expires</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getNextRecord <em>Next Record</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getNumberOfRecordsMatched <em>Number Of
 *       Records Matched</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getNumberOfRecordsReturned <em>Number Of
 *       Records Returned</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getRecordSchema <em>Record Schema</em>}
 *   <li>{@link net.opengis.cat.csw20.SearchResultsType#getResultSetId <em>Result Set Id</em>}
 * </ul>
 *
...
public interface SearchResultsType extends EObject {
  /**
   * Returns the value of the '<em><b>Abstract Record Group</b></em>' attribute list. The list
   * contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Record Group</em>' attribute list isn't clear, there
  ...
  /**
   * Returns the value of the '<em><b>Abstract Record</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.AbstractRecordType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Record</em>' containment reference list isn't clear,
   ...
   *     extendedMetaData="kind='element' name='AbstractRecord' namespace='##targetNamespace'
  ...
  /**
   * Returns the value of the '<em><b>Element Set</b></em>' attribute. The literals are from the
   * enumeration {@link net.opengis.cat.csw20.ElementSetType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Element Set</em>' attribute isn't clear, there really should be
   ...
   * @model unsettable="true" extendedMetaData="kind='attribute' name='elementSet'"
   * @generated
   */
  ElementSetType getElementSet();

  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getElementSet <em>Element
   * Set</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getElementSet
   * <em>Element Set</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @see #isSetElementSet()
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getElementSet
   * <em>Element Set</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Expires</em>' attribute isn't clear, there really should be more
   * of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getExpires
   * <em>Expires</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Next Record</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getNextRecord <em>Next
   * Record</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Number Of Records Matched</em>' attribute isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getNumberOfRecordsMatched
   * <em>Number Of Records Matched</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Number Of Records Returned</em>' attribute isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Record Schema</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getRecordSchema
   * <em>Record Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Result Set Id</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SearchResultsType#getResultSetId <em>Result
   * Set Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
