 ...
 * updated, deleted). If the client did not specify a requestId, the server may assign one (a URI
 * value).
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalInserted <em>Total
 *       Inserted</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalUpdated <em>Total Updated</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalDeleted <em>Total Deleted</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionSummaryType#getRequestId <em>Request Id</em>}
 * </ul>
 *
...
public interface TransactionSummaryType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Total Inserted</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalInserted
   * <em>Total Inserted</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Total Updated</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalUpdated
   * <em>Total Updated</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Total Deleted</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionSummaryType#getTotalDeleted
   * <em>Total Deleted</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionSummaryType#getRequestId
