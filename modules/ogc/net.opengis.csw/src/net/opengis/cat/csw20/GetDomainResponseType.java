 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.GetDomainResponseType#getDomainValues <em>Domain Values</em>}
 * </ul>
 *
...
public interface GetDomainResponseType extends EObject {
  /**
   * Returns the value of the '<em><b>Domain Values</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.DomainValuesType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Domain Values</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='DomainValues'
