 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.QueryTypeImpl#getElementSetName <em>Element Set
 *       Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryTypeImpl#getElementName <em>Element Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryTypeImpl#getSortBy <em>Sort By</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryTypeImpl#getTypeNames <em>Type Names</em>}
 * </ul>
 *
 * @generated
 */
public class QueryTypeImpl extends AbstractQueryTypeImpl implements QueryType {
  /**
   * The cached value of the '{@link #getElementSetName() <em>Element Set Name</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetElementSetName(
      ElementSetNameType newElementSetName, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_TYPE__ELEMENT_SET_NAME,
              oldElementSetName,
              newElementSetName);
  ...
  public void setElementSetName(ElementSetNameType newElementSetName) {
    if (newElementSetName != elementSetName) {
      ...
      if (elementSetName != null)
        msgs =
            ((InternalEObject) elementSetName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.QUERY_TYPE__ELEMENT_SET_NAME,
                    null,
                    msgs);
      if (newElementSetName != null)
        msgs =
            ((InternalEObject) newElementSetName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.QUERY_TYPE__ELEMENT_SET_NAME,
                    null,
  ...
  public EList<QName> getElementName() {
    if (elementName == null) {
      elementName =
          new EDataTypeUniqueEList<QName>(QName.class, this, Csw20Package.QUERY_TYPE__ELEMENT_NAME);
    }
    return elementName;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetConstraint(
      QueryConstraintType newConstraint, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_TYPE__CONSTRAINT,
              oldConstraint,
              newConstraint);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setConstraint(QueryConstraintType newConstraint) {
    if (newConstraint != constraint) {
      ...
      if (constraint != null)
        msgs =
            ((InternalEObject) constraint)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Csw20Package.QUERY_TYPE__CONSTRAINT, null, msgs);
      if (newConstraint != null)
        msgs =
            ((InternalEObject) newConstraint)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Csw20Package.QUERY_TYPE__CONSTRAINT, null, msgs);
  ...
  public void setSortBy(SortBy[] newSortBy) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.QUERY_TYPE__SORT_BY, oldSortBy, sortBy));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_TYPE__TYPE_NAMES,
              oldTypeNames,
              typeNames));
  }
