 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.InsertType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.InsertType#getHandle <em>Handle</em>}
 *   <li>{@link net.opengis.cat.csw20.InsertType#getTypeName <em>Type Name</em>}
 * </ul>
 *
...
public interface InsertType extends EObject {
   ...
   *     many="true" extendedMetaData="kind='elementWildcard' wildcards='##other' name=':0'
   *     processing='strict'"
   * @generated
   */
  FeatureMap getAny();
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.InsertType#getHandle <em>Handle</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.InsertType#getTypeName <em>Type Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
