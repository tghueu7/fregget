 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.GetDomainResponseTypeImpl#getDomainValues <em>Domain
 *       Values</em>}
 * </ul>
 *
 * @generated
...
public class GetDomainResponseTypeImpl extends EObjectImpl implements GetDomainResponseType {
  /**
   * The cached value of the '{@link #getDomainValues() <em>Domain Values</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<DomainValuesType> getDomainValues() {
    if (domainValues == null) {
      domainValues =
          new EObjectContainmentEList<DomainValuesType>(
              DomainValuesType.class, this, Csw20Package.GET_DOMAIN_RESPONSE_TYPE__DOMAIN_VALUES);
    }
    return domainValues;
  }
