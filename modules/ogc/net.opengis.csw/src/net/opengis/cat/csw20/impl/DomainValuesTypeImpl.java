 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getPropertyName <em>Property
 *       Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getParameterName <em>Parameter
 *       Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getListOfValues <em>List Of
 *       Values</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getConceptualScheme <em>Conceptual
 *       Scheme</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getRangeOfValues <em>Range Of
 *       Values</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getType <em>Type</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DomainValuesTypeImpl#getUom <em>Uom</em>}
 * </ul>
 *
 * @generated
 */
public class DomainValuesTypeImpl extends EObjectImpl implements DomainValuesType {
  ...
  /**
   * The cached value of the '{@link #getListOfValues() <em>List Of Values</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getConceptualScheme() <em>Conceptual Scheme</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getRangeOfValues() <em>Range Of Values</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DOMAIN_VALUES_TYPE__PROPERTY_NAME,
              oldPropertyName,
              propertyName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DOMAIN_VALUES_TYPE__PARAMETER_NAME,
              oldParameterName,
              parameterName));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetListOfValues(
      ListOfValuesType newListOfValues, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DOMAIN_VALUES_TYPE__LIST_OF_VALUES,
              oldListOfValues,
              newListOfValues);
  ...
  public void setListOfValues(ListOfValuesType newListOfValues) {
    if (newListOfValues != listOfValues) {
      ...
      if (listOfValues != null)
        msgs =
            ((InternalEObject) listOfValues)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__LIST_OF_VALUES,
                    null,
                    msgs);
      if (newListOfValues != null)
        msgs =
            ((InternalEObject) newListOfValues)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__LIST_OF_VALUES,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetConceptualScheme(
      ConceptualSchemeType newConceptualScheme, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DOMAIN_VALUES_TYPE__CONCEPTUAL_SCHEME,
              oldConceptualScheme,
              newConceptualScheme);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setConceptualScheme(ConceptualSchemeType newConceptualScheme) {
    if (newConceptualScheme != conceptualScheme) {
      ...
      if (conceptualScheme != null)
        msgs =
            ((InternalEObject) conceptualScheme)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__CONCEPTUAL_SCHEME,
                    null,
                    msgs);
      if (newConceptualScheme != null)
        msgs =
            ((InternalEObject) newConceptualScheme)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__CONCEPTUAL_SCHEME,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetRangeOfValues(
      RangeOfValuesType newRangeOfValues, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DOMAIN_VALUES_TYPE__RANGE_OF_VALUES,
              oldRangeOfValues,
              newRangeOfValues);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRangeOfValues(RangeOfValuesType newRangeOfValues) {
    if (newRangeOfValues != rangeOfValues) {
      ...
      if (rangeOfValues != null)
        msgs =
            ((InternalEObject) rangeOfValues)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__RANGE_OF_VALUES,
                    null,
                    msgs);
      if (newRangeOfValues != null)
        msgs =
            ((InternalEObject) newRangeOfValues)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.DOMAIN_VALUES_TYPE__RANGE_OF_VALUES,
                    null,
  ...
  public void setType(QName newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.DOMAIN_VALUES_TYPE__TYPE, oldType, type));
  }
  ...
  public void setUom(String newUom) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.DOMAIN_VALUES_TYPE__UOM, oldUom, uom));
  }
