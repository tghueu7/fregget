 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.RecordType#getAnyText <em>Any Text</em>}
 *   <li>{@link net.opengis.cat.csw20.RecordType#getBoundingBox <em>Bounding Box</em>}
 * </ul>
 *
...
public interface RecordType extends DCMIRecordType {
  /**
   * Returns the value of the '<em><b>Any Text</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw._2._0.EmptyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Any Text</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='AnyText'
