 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.GetDomainTypeImpl#getPropertyName <em>Property Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.GetDomainTypeImpl#getParameterName <em>Parameter
 *       Name</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_DOMAIN_TYPE__PROPERTY_NAME,
              oldPropertyName,
              propertyName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.GET_DOMAIN_TYPE__PARAMETER_NAME,
              oldParameterName,
              parameterName));
  }
