 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.DescribeRecordTypeImpl#getTypeName <em>Type Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DescribeRecordTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.DescribeRecordTypeImpl#getSchemaLanguage <em>Schema
 *       Language</em>}
 * </ul>
 *
 * @generated
...
public class DescribeRecordTypeImpl extends RequestBaseTypeImpl implements DescribeRecordType {
  ...
  public EList<QName> getTypeName() {
    if (typeName == null) {
      typeName =
          new EDataTypeUniqueEList<QName>(
              QName.class, this, Csw20Package.DESCRIBE_RECORD_TYPE__TYPE_NAME);
    }
    return typeName;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DESCRIBE_RECORD_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.DESCRIBE_RECORD_TYPE__SCHEMA_LANGUAGE,
              oldSchemaLanguage,
              schemaLanguage,
              !oldSchemaLanguageESet));
  }
  ...
  public String toString() {
    ...
    if (schemaLanguageESet) result.append(schemaLanguage);
    else result.append("<unset>");
    result.append(')');
