 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.DescribeRecordResponseType#getSchemaComponent <em>Schema
 *       Component</em>}
 * </ul>
 *
...
public interface DescribeRecordResponseType extends EObject {
  /**
   * Returns the value of the '<em><b>Schema Component</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.cat.csw20.SchemaComponentType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Schema Component</em>' containment reference list isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='SchemaComponent'
