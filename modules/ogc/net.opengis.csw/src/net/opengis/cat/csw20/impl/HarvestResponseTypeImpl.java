 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestResponseTypeImpl#getAcknowledgement
 *       <em>Acknowledgement</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.HarvestResponseTypeImpl#getTransactionResponse
 *       <em>Transaction Response</em>}
 * </ul>
 *
 * @generated
 */
public class HarvestResponseTypeImpl extends EObjectImpl implements HarvestResponseType {
  /**
   * The cached value of the '{@link #getAcknowledgement() <em>Acknowledgement</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTransactionResponse() <em>Transaction Response</em>}'
   ...
   * @generated
   */
  public NotificationChain basicSetAcknowledgement(
      AcknowledgementType newAcknowledgement, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_RESPONSE_TYPE__ACKNOWLEDGEMENT,
              oldAcknowledgement,
              newAcknowledgement);
  ...
  public void setAcknowledgement(AcknowledgementType newAcknowledgement) {
    if (newAcknowledgement != acknowledgement) {
      ...
      if (acknowledgement != null)
        msgs =
            ((InternalEObject) acknowledgement)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.HARVEST_RESPONSE_TYPE__ACKNOWLEDGEMENT,
                    null,
                    msgs);
      if (newAcknowledgement != null)
        msgs =
            ((InternalEObject) newAcknowledgement)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.HARVEST_RESPONSE_TYPE__ACKNOWLEDGEMENT,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.HARVEST_RESPONSE_TYPE__TRANSACTION_RESPONSE,
  ...
  public void setTransactionResponse(TransactionResponseType newTransactionResponse) {
    if (newTransactionResponse != transactionResponse) {
      ...
      if (transactionResponse != null)
        msgs =
            ((InternalEObject) transactionResponse)
                .eInverseRemove(
                    this,
      ...
      if (newTransactionResponse != null)
        msgs =
            ((InternalEObject) newTransactionResponse)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Csw20Package.HARVEST_RESPONSE_TYPE__TRANSACTION_RESPONSE,
