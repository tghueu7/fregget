 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.DescribeRecordResponseTypeImpl#getSchemaComponent
 *       <em>Schema Component</em>}
 * </ul>
 *
 * @generated
 */
public class DescribeRecordResponseTypeImpl extends EObjectImpl
    implements DescribeRecordResponseType {
  /**
   * The cached value of the '{@link #getSchemaComponent() <em>Schema Component</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<SchemaComponentType> getSchemaComponent() {
    if (schemaComponent == null) {
      schemaComponent =
          new EObjectContainmentEList<SchemaComponentType>(
              SchemaComponentType.class,
              this,
              Csw20Package.DESCRIBE_RECORD_RESPONSE_TYPE__SCHEMA_COMPONENT);
    }
