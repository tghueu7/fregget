 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.QueryConstraintTypeImpl#getFilter <em>Filter</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryConstraintTypeImpl#getCqlText <em>Cql Text</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.QueryConstraintTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_CONSTRAINT_TYPE__FILTER,
              oldFilter,
              newFilter);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_CONSTRAINT_TYPE__CQL_TEXT,
              oldCqlText,
              cqlText));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.QUERY_CONSTRAINT_TYPE__VERSION,
              oldVersion,
              version));
  }
