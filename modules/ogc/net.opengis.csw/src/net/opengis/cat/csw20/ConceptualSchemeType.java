 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.ConceptualSchemeType#getName <em>Name</em>}
 *   <li>{@link net.opengis.cat.csw20.ConceptualSchemeType#getDocument <em>Document</em>}
 *   <li>{@link net.opengis.cat.csw20.ConceptualSchemeType#getAuthority <em>Authority</em>}
 * </ul>
 *
...
public interface ConceptualSchemeType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.ConceptualSchemeType#getName
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Document</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.ConceptualSchemeType#getDocument
   * <em>Document</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Authority</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.ConceptualSchemeType#getAuthority
   * <em>Authority</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
