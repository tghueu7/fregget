 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionSummaryTypeImpl#getTotalInserted <em>Total
 *       Inserted</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionSummaryTypeImpl#getTotalUpdated <em>Total
 *       Updated</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionSummaryTypeImpl#getTotalDeleted <em>Total
 *       Deleted</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.TransactionSummaryTypeImpl#getRequestId <em>Request
 *       Id</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED,
              oldTotalInserted,
              totalInserted));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED,
              oldTotalUpdated,
              totalUpdated));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED,
              oldTotalDeleted,
              totalDeleted));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.TRANSACTION_SUMMARY_TYPE__REQUEST_ID,
              oldRequestId,
              requestId));
  }
