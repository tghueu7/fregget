 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getPropertyName <em>Property Name</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getParameterName <em>Parameter Name</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getListOfValues <em>List Of Values</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getConceptualScheme <em>Conceptual
 *       Scheme</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getRangeOfValues <em>Range Of Values</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getType <em>Type</em>}
 *   <li>{@link net.opengis.cat.csw20.DomainValuesType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface DomainValuesType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Property Name</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getPropertyName
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Parameter Name</em>' attribute isn't clear, there really should
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI" extendedMetaData="kind='element'
   *     name='ParameterName' namespace='##targetNamespace'"
   * @generated
   */
  String getParameterName();

  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getParameterName
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>List Of Values</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ListOfValues'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getListOfValues <em>List
   * Of Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Conceptual Scheme</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ConceptualScheme'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getConceptualScheme
   * <em>Conceptual Scheme</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Range Of Values</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='RangeOfValues'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getRangeOfValues <em>Range
   * Of Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Uom</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DomainValuesType#getUom <em>Uom</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
