 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getAbstractRecordGroup <em>Abstract
 *       Record Group</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getAbstractRecord <em>Abstract
 *       Record</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getAny <em>Any</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getElementSet <em>Element Set</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getExpires <em>Expires</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getNextRecord <em>Next Record</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getNumberOfRecordsMatched
 *       <em>Number Of Records Matched</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getNumberOfRecordsReturned
 *       <em>Number Of Records Returned</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getRecordSchema <em>Record
 *       Schema</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SearchResultsTypeImpl#getResultSetId <em>Result Set
 *       Id</em>}
 * </ul>
 *
 * @generated
...
public class SearchResultsTypeImpl extends EObjectImpl implements SearchResultsType {
  /**
   * The cached value of the '{@link #getAbstractRecordGroup() <em>Abstract Record Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getNumberOfRecordsMatched() <em>Number Of Records
   * Matched</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getNumberOfRecordsMatched() <em>Number Of Records
   * Matched</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getNumberOfRecordsReturned() <em>Number Of Records
  ...
  /**
   * The cached value of the '{@link #getNumberOfRecordsReturned() <em>Number Of Records
   * Returned</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getAbstractRecordGroup() {
    if (abstractRecordGroup == null) {
      abstractRecordGroup =
          new BasicFeatureMap(this, Csw20Package.SEARCH_RESULTS_TYPE__ABSTRACT_RECORD_GROUP);
    }
  ...
  public EList<AbstractRecordType> getAbstractRecord() {
    return getAbstractRecordGroup()
        .list(Csw20Package.Literals.SEARCH_RESULTS_TYPE__ABSTRACT_RECORD);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__ELEMENT_SET,
              oldElementSet,
              elementSet,
              !oldElementSetESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__EXPIRES,
              oldExpires,
              expires));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__NEXT_RECORD,
              oldNextRecord,
              nextRecord));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__NUMBER_OF_RECORDS_MATCHED,
              oldNumberOfRecordsMatched,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__NUMBER_OF_RECORDS_RETURNED,
              oldNumberOfRecordsReturned,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__RECORD_SCHEMA,
              oldRecordSchema,
              recordSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.SEARCH_RESULTS_TYPE__RESULT_SET_ID,
              oldResultSetId,
              resultSetId));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.SEARCH_RESULTS_TYPE__NEXT_RECORD:
        return NEXT_RECORD_EDEFAULT == null
            ? nextRecord != null
            : !NEXT_RECORD_EDEFAULT.equals(nextRecord);
      case Csw20Package.SEARCH_RESULTS_TYPE__NUMBER_OF_RECORDS_MATCHED:
        return NUMBER_OF_RECORDS_MATCHED_EDEFAULT == null
            ? numberOfRecordsMatched != null
            : !NUMBER_OF_RECORDS_MATCHED_EDEFAULT.equals(numberOfRecordsMatched);
      case Csw20Package.SEARCH_RESULTS_TYPE__NUMBER_OF_RECORDS_RETURNED:
        return NUMBER_OF_RECORDS_RETURNED_EDEFAULT == null
            ? numberOfRecordsReturned != null
            : !NUMBER_OF_RECORDS_RETURNED_EDEFAULT.equals(numberOfRecordsReturned);
      case Csw20Package.SEARCH_RESULTS_TYPE__RECORD_SCHEMA:
        return RECORD_SCHEMA_EDEFAULT == null
            ? recordSchema != null
            : !RECORD_SCHEMA_EDEFAULT.equals(recordSchema);
      case Csw20Package.SEARCH_RESULTS_TYPE__RESULT_SET_ID:
        return RESULT_SET_ID_EDEFAULT == null
            ? resultSetId != null
            : !RESULT_SET_ID_EDEFAULT.equals(resultSetId);
    }
  ...
  public String toString() {
    ...
    if (elementSetESet) result.append(elementSet);
