 ...
 * for any reason, a service exception report indicating a TransactionFailure is returned instead.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.TransactionResponseType#getTransactionSummary <em>Transaction
 *       Summary</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionResponseType#getInsertResult <em>Insert
 *       Result</em>}
 *   <li>{@link net.opengis.cat.csw20.TransactionResponseType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface TransactionResponseType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Insert Result</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.InsertResultType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Insert Result</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='InsertResult'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.TransactionResponseType#getVersion
