 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.ConceptualSchemeTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.ConceptualSchemeTypeImpl#getDocument <em>Document</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.ConceptualSchemeTypeImpl#getAuthority <em>Authority</em>}
 * </ul>
 *
 * @generated
 */
public class ConceptualSchemeTypeImpl extends EObjectImpl implements ConceptualSchemeType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.CONCEPTUAL_SCHEME_TYPE__NAME, oldName, name));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.CONCEPTUAL_SCHEME_TYPE__DOCUMENT,
              oldDocument,
              document));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.CONCEPTUAL_SCHEME_TYPE__AUTHORITY,
              oldAuthority,
              authority));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Csw20Package.CONCEPTUAL_SCHEME_TYPE__AUTHORITY:
        return AUTHORITY_EDEFAULT == null
            ? authority != null
