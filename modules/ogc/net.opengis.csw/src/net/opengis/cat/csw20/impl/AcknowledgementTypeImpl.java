 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.AcknowledgementTypeImpl#getEchoedRequest <em>Echoed
 *       Request</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.AcknowledgementTypeImpl#getRequestId <em>Request Id</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.AcknowledgementTypeImpl#getTimeStamp <em>Time Stamp</em>}
 * </ul>
 *
 * @generated
 */
public class AcknowledgementTypeImpl extends EObjectImpl implements AcknowledgementType {
  /**
   * The cached value of the '{@link #getEchoedRequest() <em>Echoed Request</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetEchoedRequest(
      EchoedRequestType newEchoedRequest, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.ACKNOWLEDGEMENT_TYPE__ECHOED_REQUEST,
              oldEchoedRequest,
              newEchoedRequest);
  ...
  public void setEchoedRequest(EchoedRequestType newEchoedRequest) {
    if (newEchoedRequest != echoedRequest) {
      ...
      if (echoedRequest != null)
        msgs =
            ((InternalEObject) echoedRequest)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.ACKNOWLEDGEMENT_TYPE__ECHOED_REQUEST,
                    null,
                    msgs);
      if (newEchoedRequest != null)
        msgs =
            ((InternalEObject) newEchoedRequest)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.ACKNOWLEDGEMENT_TYPE__ECHOED_REQUEST,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.ACKNOWLEDGEMENT_TYPE__REQUEST_ID,
              oldRequestId,
              requestId));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.ACKNOWLEDGEMENT_TYPE__TIME_STAMP,
              oldTimeStamp,
              timeStamp));
  }
