 ...
 * included as children of the SearchResults element. The RequestId is only included if the client
 * specified it.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.GetRecordsResponseType#getRequestId <em>Request Id</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordsResponseType#getSearchStatus <em>Search Status</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordsResponseType#getSearchResults <em>Search
 *       Results</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordsResponseType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface GetRecordsResponseType extends EObject {
   ...
   *     name='RequestId' namespace='##targetNamespace'"
   * @generated
   */
  String getRequestId();

  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordsResponseType#getRequestId
   * <em>Request Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Search Status</em>' containment reference isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='SearchStatus'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordsResponseType#getSearchStatus
   * <em>Search Status</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Search Results</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='SearchResults'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordsResponseType#getSearchResults
   * <em>Search Results</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordsResponseType#getVersion
