 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getType <em>Type</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getSubject <em>Subject</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getRelation <em>Relation</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getModified <em>Modified</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getSpatial <em>Spatial</em>}
 *   <li>{@link net.opengis.cat.csw20.SummaryRecordType#getBoundingBox <em>Bounding Box</em>}
 * </ul>
 *
...
public interface SummaryRecordType extends AbstractRecordType {
  /**
   * Returns the value of the '<em><b>Identifier</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A name given to the resource. Typically, Title will be a name by which the resource is formally
   * known.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" required="true" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='title' namespace='http://purl.org/dc/elements/1.1/'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.SummaryRecordType#getType <em>Type</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Subject</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='subject'
   *     namespace='http://purl.org/dc/elements/1.1/'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Format</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * hardware, or other equipment needed to display or operate the resource. Examples of dimensions
   * include size and duration. Recommended best practice is to select a value from a controlled
   * vocabulary (for example, the list of Internet Media Types defining computer media formats).
   * <!-- end-model-doc -->
   *
   ...
   *     extendedMetaData="kind='element' name='format' namespace='http://purl.org/dc/elements/1.1/'
  ...
  /**
   * Returns the value of the '<em><b>Relation</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Modified</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Modified</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='modified'
  ...
  /**
   * Returns the value of the '<em><b>Spatial</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.cat.csw20.SimpleLiteral}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial</em>' containment reference list isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='spatial'
   *     namespace='http://purl.org/dc/terms/'"
   * @generated
   */
   ...
   * contents are of type {@link net.opengis.ows10.BoundingBoxType}.
   * <!-- begin-user-doc -->
   *
