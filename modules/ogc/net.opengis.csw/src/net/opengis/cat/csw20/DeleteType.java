 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.DeleteType#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.cat.csw20.DeleteType#getHandle <em>Handle</em>}
 *   <li>{@link net.opengis.cat.csw20.DeleteType#getTypeName <em>Type Name</em>}
 * </ul>
 *
...
public interface DeleteType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Constraint'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DeleteType#getConstraint
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DeleteType#getHandle <em>Handle</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.DeleteType#getTypeName <em>Type Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
