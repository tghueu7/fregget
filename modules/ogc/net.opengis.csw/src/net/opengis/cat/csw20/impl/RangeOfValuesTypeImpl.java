 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.RangeOfValuesTypeImpl#getMinValue <em>Min Value</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.RangeOfValuesTypeImpl#getMaxValue <em>Max Value</em>}
 * </ul>
 *
 * @generated
 */
public class RangeOfValuesTypeImpl extends EObjectImpl implements RangeOfValuesType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.RANGE_OF_VALUES_TYPE__MIN_VALUE,
              oldMinValue,
              newMinValue);
  ...
  public void setMinValue(EObject newMinValue) {
    if (newMinValue != minValue) {
      ...
      if (minValue != null)
        msgs =
            ((InternalEObject) minValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.RANGE_OF_VALUES_TYPE__MIN_VALUE,
                    null,
                    msgs);
      if (newMinValue != null)
        msgs =
            ((InternalEObject) newMinValue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.RANGE_OF_VALUES_TYPE__MIN_VALUE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Csw20Package.RANGE_OF_VALUES_TYPE__MAX_VALUE,
              oldMaxValue,
              newMaxValue);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setMaxValue(EObject newMaxValue) {
    if (newMaxValue != maxValue) {
      ...
      if (maxValue != null)
        msgs =
            ((InternalEObject) maxValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.RANGE_OF_VALUES_TYPE__MAX_VALUE,
                    null,
                    msgs);
      if (newMaxValue != null)
        msgs =
            ((InternalEObject) newMaxValue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Csw20Package.RANGE_OF_VALUES_TYPE__MAX_VALUE,
                    null,
