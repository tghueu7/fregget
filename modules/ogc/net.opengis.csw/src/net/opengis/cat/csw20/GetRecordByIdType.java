 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Convenience operation to retrieve default record representations by identifier. Id - object
 * identifier (a URI) that provides a reference to a catalogue item (or a result set if the
 * catalogue supports persistent result sets). ElementSetName - one of "brief, "summary", or "full"
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.GetRecordByIdType#getId <em>Id</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordByIdType#getElementSetName <em>Element Set Name</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordByIdType#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.cat.csw20.GetRecordByIdType#getOutputSchema <em>Output Schema</em>}
 * </ul>
 *
...
public interface GetRecordByIdType extends RequestBaseType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordByIdType#getElementSetName
   * <em>Element Set Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordByIdType#getOutputFormat
  ...
  /**
   * Unsets the value of the '{@link net.opengis.cat.csw20.GetRecordByIdType#getOutputFormat
   * <em>Output Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.cat.csw20.GetRecordByIdType#getOutputFormat <em>Output Format</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.GetRecordByIdType#getOutputSchema
   * <em>Output Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
