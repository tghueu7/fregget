 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.RangeOfValuesType#getMinValue <em>Min Value</em>}
 *   <li>{@link net.opengis.cat.csw20.RangeOfValuesType#getMaxValue <em>Max Value</em>}
 * </ul>
 *
...
public interface RangeOfValuesType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Min Value</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='MinValue'
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.RangeOfValuesType#getMinValue <em>Min
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Max Value</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='MaxValue'
   *     namespace='##targetNamespace'"
   * @generated
   */
  EObject getMaxValue();
  ...
  /**
   * Sets the value of the '{@link net.opengis.cat.csw20.RangeOfValuesType#getMaxValue <em>Max
   * Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
