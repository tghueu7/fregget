 ...
 *
 * <ul>
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getType <em>Type</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getSubject <em>Subject</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getRelation <em>Relation</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getModified <em>Modified</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getSpatial <em>Spatial</em>}
 *   <li>{@link net.opengis.cat.csw20.impl.SummaryRecordTypeImpl#getBoundingBox <em>Bounding
 *       Box</em>}
 * </ul>
 *
 * @generated
...
public class SummaryRecordTypeImpl extends AbstractRecordTypeImpl implements SummaryRecordType {
  ...
  public EList<SimpleLiteral> getIdentifier() {
    if (identifier == null) {
      identifier =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__IDENTIFIER);
    }
    return identifier;
  }
  ...
  public EList<SimpleLiteral> getTitle() {
    if (title == null) {
      title =
          new EObjectResolvingEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__TITLE);
    }
    return title;
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  Csw20Package.SUMMARY_RECORD_TYPE__TYPE,
                  oldType,
                  type));
      }
    }
  ...
  public void setType(SimpleLiteral newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Csw20Package.SUMMARY_RECORD_TYPE__TYPE, oldType, type));
  }
  ...
  public EList<SimpleLiteral> getSubject() {
    if (subject == null) {
      subject =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__SUBJECT);
    }
    return subject;
  }
  ...
  public EList<SimpleLiteral> getFormat() {
    if (format == null) {
      format =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__FORMAT);
    }
    return format;
  }
  ...
  public EList<SimpleLiteral> getRelation() {
    if (relation == null) {
      relation =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__RELATION);
    }
    return relation;
  }
  ...
  public EList<SimpleLiteral> getModified() {
    if (modified == null) {
      modified =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__MODIFIED);
    }
    return modified;
  }
  ...
  public EList<SimpleLiteral> getAbstract() {
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public EList<SimpleLiteral> getSpatial() {
    if (spatial == null) {
      spatial =
          new EObjectContainmentEList<SimpleLiteral>(
              SimpleLiteral.class, this, Csw20Package.SUMMARY_RECORD_TYPE__SPATIAL);
    }
    return spatial;
  }
  ...
  public EList<BoundingBoxType> getBoundingBox() {
    if (boundingBox == null) {
      boundingBox =
          new EObjectResolvingEList<BoundingBoxType>(
              BoundingBoxType.class, this, Csw20Package.SUMMARY_RECORD_TYPE__BOUNDING_BOX);
    }
    return boundingBox;
  }
