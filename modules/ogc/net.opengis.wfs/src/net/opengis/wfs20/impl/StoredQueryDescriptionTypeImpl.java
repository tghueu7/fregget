 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getParameter
 *       <em>Parameter</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getQueryExpressionText
 *       <em>Query Expression Text</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class StoredQueryDescriptionTypeImpl extends EObjectImpl
    implements StoredQueryDescriptionType {
  /**
  ...
  /**
   * The cached value of the '{@link #getQueryExpressionText() <em>Query Expression Text</em>}'
    ...
    if (title == null) {
      title =
          new EObjectContainmentEList<TitleType>(
              TitleType.class, this, Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__TITLE);
    }
    return title;
  }
    ...
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<AbstractType>(
              AbstractType.class, this, Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public EList<MetadataType> getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList<MetadataType>(
              MetadataType.class, this, Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__METADATA);
    }
    return metadata;
  }
  ...
  public EList<ParameterExpressionType> getParameter() {
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList<ParameterExpressionType>(
              ParameterExpressionType.class,
              this,
              Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList<QueryExpressionTextType> getQueryExpressionText() {
    if (queryExpressionText == null) {
      queryExpressionText =
          new EObjectContainmentEList<QueryExpressionTextType>(
              QueryExpressionTextType.class,
              this,
              Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__QUERY_EXPRESSION_TEXT);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.STORED_QUERY_DESCRIPTION_TYPE__ID, oldId, id));
  }
