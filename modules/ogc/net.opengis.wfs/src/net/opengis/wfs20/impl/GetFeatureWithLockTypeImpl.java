 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureWithLockTypeImpl#getExpiry <em>Expiry</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureWithLockTypeImpl#getLockAction <em>Lock
 *       Action</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_WITH_LOCK_TYPE__EXPIRY,
              oldExpiry,
              expiry,
              !oldExpiryESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_WITH_LOCK_TYPE__LOCK_ACTION,
              oldLockAction,
              lockAction,
              !oldLockActionESet));
  }
