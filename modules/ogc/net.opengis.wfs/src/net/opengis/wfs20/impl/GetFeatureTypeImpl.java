 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getCount <em>Count</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getResolve <em>Resolve</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getResolveDepth <em>Resolve Depth</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getResolveTimeout <em>Resolve
 *       Timeout</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getResultType <em>Result Type</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getStartIndex <em>Start Index</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getFormatOptions <em>Format Options</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getViewParams <em>View Params</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getAbstractQueryExpressionGroup
 *       <em>Abstract Query Expression Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetFeatureTypeImpl#getAbstractQueryExpression <em>Abstract
 *       Query Expression</em>}
 * </ul>
 *
 * @generated
...
public class GetFeatureTypeImpl extends BaseRequestTypeImpl implements GetFeatureType {
  ...
  protected static final Object RESOLVE_DEPTH_EDEFAULT =
      Wfs20Factory.eINSTANCE.createFromString(
  ...
  /**
   * The cached value of the '{@link #getAbstractQueryExpressionGroup() <em>Abstract Query
   * Expression Group</em>}' attribute list.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.GET_FEATURE_TYPE__COUNT, oldCount, count));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__RESOLVE,
              oldResolve,
              resolve,
              !oldResolveESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__RESOLVE_DEPTH,
              oldResolveDepth,
              resolveDepth,
              !oldResolveDepthESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__RESOLVE_TIMEOUT,
              oldResolveTimeout,
              resolveTimeout,
              !oldResolveTimeoutESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__RESULT_TYPE,
              oldResultType,
              resultType,
              !oldResultTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__START_INDEX,
              oldStartIndex,
              startIndex,
              !oldStartIndexESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__METADATA,
              oldMetadata,
              metadata));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_FEATURE_TYPE__FORMAT_OPTIONS,
              oldFormatOptions,
              formatOptions));
  }
  ...
  public EList<Map> getViewParams() {
    if (viewParams == null) {
      viewParams =
          (EList) new EDataTypeEList(Map.class, this, Wfs20Package.GET_FEATURE_TYPE__VIEW_PARAMS);
    }
    return viewParams;
  }
  ...
  public FeatureMap getAbstractQueryExpressionGroup() {
    if (abstractQueryExpressionGroup == null) {
      abstractQueryExpressionGroup =
          new BasicFeatureMap(this, Wfs20Package.GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP);
    }
  ...
  public EList<AbstractQueryExpressionType> getAbstractQueryExpression() {
    return getAbstractQueryExpressionGroup()
        .list(Wfs20Package.Literals.GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION);
  }
    ...
    switch (featureID) {
      ...
      case Wfs20Package.GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION:
        ...
        getAbstractQueryExpression()
            .addAll((Collection<? extends AbstractQueryExpressionType>) newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wfs20Package.GET_FEATURE_TYPE__FORMAT_OPTIONS:
        return FORMAT_OPTIONS_EDEFAULT == null
            ? formatOptions != null
  ...
  public String toString() {
    ...
    if (outputFormatESet) result.append(outputFormat);
    else result.append("<unset>");
    result.append(", resolve: ");
    if (resolveESet) result.append(resolve);
    else result.append("<unset>");
    result.append(", resolveDepth: ");
    if (resolveDepthESet) result.append(resolveDepth);
    else result.append("<unset>");
    result.append(", resolveTimeout: ");
    if (resolveTimeoutESet) result.append(resolveTimeout);
    else result.append("<unset>");
    result.append(", resultType: ");
    if (resultTypeESet) result.append(resultType);
    else result.append("<unset>");
    result.append(", startIndex: ");
    if (startIndexESet) result.append(startIndex);
    else result.append("<unset>");
