 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getMember <em>Member</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getAdditionalValues <em>Additional
 *       Values</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getTruncatedResponse <em>Truncated
 *       Response</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getNext <em>Next</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getNumberMatched <em>Number
 *       Matched</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getNumberReturned <em>Number
 *       Returned</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getPrevious <em>Previous</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl#getTimeStamp <em>Time Stamp</em>}
 * </ul>
 *
 * @generated
 */
public class ValueCollectionTypeImpl extends EObjectImpl implements ValueCollectionType {
  ...
  /**
   * The cached value of the '{@link #getAdditionalValues() <em>Additional Values</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTruncatedResponse() <em>Truncated Response</em>}'
  ...
  public EList<Collection> getMember() {
    if (member == null) {
      member =
          new EDataTypeUniqueEList<Collection>(
              Collection.class, this, Wfs20Package.VALUE_COLLECTION_TYPE__MEMBER);
    }
    return member;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__ADDITIONAL_VALUES,
              oldAdditionalValues,
              newAdditionalValues);
  ...
  public void setAdditionalValues(AdditionalValuesType newAdditionalValues) {
    if (newAdditionalValues != additionalValues) {
      ...
      if (additionalValues != null)
        msgs =
            ((InternalEObject) additionalValues)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.VALUE_COLLECTION_TYPE__ADDITIONAL_VALUES,
                    null,
                    msgs);
      if (newAdditionalValues != null)
        msgs =
            ((InternalEObject) newAdditionalValues)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.VALUE_COLLECTION_TYPE__ADDITIONAL_VALUES,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__TRUNCATED_RESPONSE,
              oldTruncatedResponse,
  ...
  public void setTruncatedResponse(TruncatedResponseType newTruncatedResponse) {
    if (newTruncatedResponse != truncatedResponse) {
      ...
      if (truncatedResponse != null)
        msgs =
            ((InternalEObject) truncatedResponse)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.VALUE_COLLECTION_TYPE__TRUNCATED_RESPONSE,
                    null,
                    msgs);
      if (newTruncatedResponse != null)
        msgs =
            ((InternalEObject) newTruncatedResponse)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.VALUE_COLLECTION_TYPE__TRUNCATED_RESPONSE,
                    null,
  ...
  public void setNext(String newNext) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.VALUE_COLLECTION_TYPE__NEXT, oldNext, next));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__NUMBER_MATCHED,
              oldNumberMatched,
              numberMatched));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__NUMBER_RETURNED,
              oldNumberReturned,
              numberReturned));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__PREVIOUS,
              oldPrevious,
              previous));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_COLLECTION_TYPE__TIME_STAMP,
              oldTimeStamp,
              timeStamp));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wfs20Package.VALUE_COLLECTION_TYPE__NUMBER_MATCHED:
        return NUMBER_MATCHED_EDEFAULT == null
            ? numberMatched != null
            : !NUMBER_MATCHED_EDEFAULT.equals(numberMatched);
      case Wfs20Package.VALUE_COLLECTION_TYPE__NUMBER_RETURNED:
        return NUMBER_RETURNED_EDEFAULT == null
            ? numberReturned != null
            : !NUMBER_RETURNED_EDEFAULT.equals(numberReturned);
      case Wfs20Package.VALUE_COLLECTION_TYPE__PREVIOUS:
        return PREVIOUS_EDEFAULT == null ? previous != null : !PREVIOUS_EDEFAULT.equals(previous);
      case Wfs20Package.VALUE_COLLECTION_TYPE__TIME_STAMP:
        return TIME_STAMP_EDEFAULT == null
            ? timeStamp != null
