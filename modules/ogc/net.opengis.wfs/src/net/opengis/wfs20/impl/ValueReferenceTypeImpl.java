 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ValueReferenceTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wfs20.impl.ValueReferenceTypeImpl#getAction <em>Action</em>}
 * </ul>
 *
 * @generated
 */
public class ValueReferenceTypeImpl extends EObjectImpl implements ValueReferenceType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.VALUE_REFERENCE_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.VALUE_REFERENCE_TYPE__ACTION,
              oldAction,
              action,
              !oldActionESet));
  }
  ...
  public String toString() {
    ...
    if (actionESet) result.append(action);
