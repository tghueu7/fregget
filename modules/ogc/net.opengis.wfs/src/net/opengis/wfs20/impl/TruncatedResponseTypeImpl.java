 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.TruncatedResponseTypeImpl#getExceptionReport <em>Exception
 *       Report</em>}
 * </ul>
 *
 * @generated
...
public class TruncatedResponseTypeImpl extends EObjectImpl implements TruncatedResponseType {
  /**
   * The cached value of the '{@link #getExceptionReport() <em>Exception Report</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRUNCATED_RESPONSE_TYPE__EXCEPTION_REPORT,
              oldExceptionReport,
              newExceptionReport);
  ...
  public void setExceptionReport(ExceptionReportType newExceptionReport) {
    if (newExceptionReport != exceptionReport) {
      ...
      if (exceptionReport != null)
        msgs =
            ((InternalEObject) exceptionReport)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRUNCATED_RESPONSE_TYPE__EXCEPTION_REPORT,
                    null,
                    msgs);
      if (newExceptionReport != null)
        msgs =
            ((InternalEObject) newExceptionReport)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRUNCATED_RESPONSE_TYPE__EXCEPTION_REPORT,
                    null,
