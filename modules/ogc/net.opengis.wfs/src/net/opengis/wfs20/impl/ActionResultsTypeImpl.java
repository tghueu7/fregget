 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ActionResultsTypeImpl#getFeature <em>Feature</em>}
 * </ul>
 *
 * @generated
 */
public class ActionResultsTypeImpl extends EObjectImpl implements ActionResultsType {
  ...
  public EList<CreatedOrModifiedFeatureType> getFeature() {
    if (feature == null) {
      feature =
          new EObjectContainmentEList<CreatedOrModifiedFeatureType>(
              CreatedOrModifiedFeatureType.class, this, Wfs20Package.ACTION_RESULTS_TYPE__FEATURE);
    }
    return feature;
  }
