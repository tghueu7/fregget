 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.AdditionalValuesTypeImpl#getValueCollection <em>Value
 *       Collection</em>}
 *   <li>{@link net.opengis.wfs20.impl.AdditionalValuesTypeImpl#getSimpleFeatureCollectionGroup
 *       <em>Simple Feature Collection Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.AdditionalValuesTypeImpl#getSimpleFeatureCollection
...
public class AdditionalValuesTypeImpl extends EObjectImpl implements AdditionalValuesType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION,
              oldValueCollection,
              newValueCollection);
      ...
      if (valueCollection != null)
        msgs =
            ((InternalEObject) valueCollection)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION,
                    null,
                    msgs);
  ...
  public FeatureMap getSimpleFeatureCollectionGroup() {
    if (simpleFeatureCollectionGroup == null) {
      simpleFeatureCollectionGroup =
          new BasicFeatureMap(
              this, Wfs20Package.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP);
    }
  ...
  public SimpleFeatureCollectionType getSimpleFeatureCollection() {
    return (SimpleFeatureCollectionType)
        getSimpleFeatureCollectionGroup()
            .get(Wfs20Package.Literals.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION, true);
  }
  ...
  public NotificationChain basicSetSimpleFeatureCollection(
    ...
    return ((FeatureMap.Internal) getSimpleFeatureCollectionGroup())
        .basicAdd(
            Wfs20Package.Literals.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION,
