 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryListItemTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryListItemTypeImpl#getReturnFeatureType <em>Return
 *       Feature Type</em>}
 *   <li>{@link net.opengis.wfs20.impl.StoredQueryListItemTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class StoredQueryListItemTypeImpl extends EObjectImpl implements StoredQueryListItemType {
  ...
  /**
   * The cached value of the '{@link #getReturnFeatureType() <em>Return Feature Type</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (title == null) {
      title =
          new EObjectContainmentEList<TitleType>(
              TitleType.class, this, Wfs20Package.STORED_QUERY_LIST_ITEM_TYPE__TITLE);
    }
    return title;
  }
  ...
  public EList<QName> getReturnFeatureType() {
    if (returnFeatureType == null) {
      returnFeatureType =
          new EDataTypeEList<QName>(
              QName.class, this, Wfs20Package.STORED_QUERY_LIST_ITEM_TYPE__RETURN_FEATURE_TYPE);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.STORED_QUERY_LIST_ITEM_TYPE__ID, oldId, id));
  }
