 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.DescribeStoredQueriesTypeImpl#getStoredQueryId <em>Stored
 *       Query Id</em>}
 * </ul>
 *
 * @generated
 */
public class DescribeStoredQueriesTypeImpl extends BaseRequestTypeImpl
    implements DescribeStoredQueriesType {
  /**
  ...
  public EList<URI> getStoredQueryId() {
    if (storedQueryId == null) {
      storedQueryId =
          new EDataTypeUniqueEList<URI>(
              URI.class, this, Wfs20Package.DESCRIBE_STORED_QUERIES_TYPE__STORED_QUERY_ID);
    }
