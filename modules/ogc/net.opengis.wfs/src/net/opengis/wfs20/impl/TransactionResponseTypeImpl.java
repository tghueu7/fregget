 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl#getTransactionSummary
 *       <em>Transaction Summary</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl#getInsertResults <em>Insert
 *       Results</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl#getUpdateResults <em>Update
 *       Results</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl#getReplaceResults <em>Replace
 *       Results</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class TransactionResponseTypeImpl extends EObjectImpl implements TransactionResponseType {
  /**
   * The cached value of the '{@link #getTransactionSummary() <em>Transaction Summary</em>}'
  ...
  /**
   * The cached value of the '{@link #getInsertResults() <em>Insert Results</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUpdateResults() <em>Update Results</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getReplaceResults() <em>Replace Results</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetTransactionSummary(
      TransactionSummaryType newTransactionSummary, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_RESPONSE_TYPE__TRANSACTION_SUMMARY,
              oldTransactionSummary,
  ...
  public void setTransactionSummary(TransactionSummaryType newTransactionSummary) {
    if (newTransactionSummary != transactionSummary) {
      ...
      if (transactionSummary != null)
        msgs =
            ((InternalEObject) transactionSummary)
                .eInverseRemove(
                    this,
      ...
      if (newTransactionSummary != null)
        msgs =
            ((InternalEObject) newTransactionSummary)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.TRANSACTION_RESPONSE_TYPE__TRANSACTION_SUMMARY,
  ...
  public NotificationChain basicSetInsertResults(
      ActionResultsType newInsertResults, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_RESPONSE_TYPE__INSERT_RESULTS,
              oldInsertResults,
              newInsertResults);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setInsertResults(ActionResultsType newInsertResults) {
    if (newInsertResults != insertResults) {
      ...
      if (insertResults != null)
        msgs =
            ((InternalEObject) insertResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRANSACTION_RESPONSE_TYPE__INSERT_RESULTS,
                    null,
                    msgs);
      if (newInsertResults != null)
        msgs =
            ((InternalEObject) newInsertResults)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRANSACTION_RESPONSE_TYPE__INSERT_RESULTS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetUpdateResults(
      ActionResultsType newUpdateResults, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_RESPONSE_TYPE__UPDATE_RESULTS,
              oldUpdateResults,
              newUpdateResults);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUpdateResults(ActionResultsType newUpdateResults) {
    if (newUpdateResults != updateResults) {
      ...
      if (updateResults != null)
        msgs =
            ((InternalEObject) updateResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRANSACTION_RESPONSE_TYPE__UPDATE_RESULTS,
                    null,
                    msgs);
      if (newUpdateResults != null)
        msgs =
            ((InternalEObject) newUpdateResults)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.TRANSACTION_RESPONSE_TYPE__UPDATE_RESULTS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetReplaceResults(
      ActionResultsType newReplaceResults, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_RESPONSE_TYPE__REPLACE_RESULTS,
              oldReplaceResults,
              newReplaceResults);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setReplaceResults(ActionResultsType newReplaceResults) {
    if (newReplaceResults != replaceResults) {
      ...
      if (replaceResults != null)
        msgs =
            ((InternalEObject) replaceResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.TRANSACTION_RESPONSE_TYPE__REPLACE_RESULTS,
      ...
      if (newReplaceResults != null)
        msgs =
            ((InternalEObject) newReplaceResults)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.TRANSACTION_RESPONSE_TYPE__REPLACE_RESULTS,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_RESPONSE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
