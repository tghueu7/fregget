 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.WFSCapabilitiesTypeImpl#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wfs20.impl.WFSCapabilitiesTypeImpl#getFeatureTypeList <em>Feature Type
 *       List</em>}
 *   <li>{@link net.opengis.wfs20.impl.WFSCapabilitiesTypeImpl#getFilterCapabilities <em>Filter
 *       Capabilities</em>}
 * </ul>
 *
 * @generated
...
public class WFSCapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.WFS_CAPABILITIES_TYPE__WSDL, oldWSDL, newWSDL);
  ...
  public void setWSDL(WSDLType newWSDL) {
    if (newWSDL != wSDL) {
      ...
      if (wSDL != null)
        msgs =
            ((InternalEObject) wSDL)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.WFS_CAPABILITIES_TYPE__WSDL,
                    null,
                    msgs);
      if (newWSDL != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.WFS_CAPABILITIES_TYPE__WSDL, newWSDL, newWSDL));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST,
              oldFeatureTypeList,
              newFeatureTypeList);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (featureTypeList != null)
        msgs =
            ((InternalEObject) featureTypeList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES,
  ...
  public void setFilterCapabilities(FilterCapabilitiesType newFilterCapabilities) {
    if (newFilterCapabilities != filterCapabilities) {
      ...
      if (filterCapabilities != null)
        msgs =
            ((InternalEObject) filterCapabilities)
                .eInverseRemove(
                    this,
      ...
      if (newFilterCapabilities != null)
        msgs =
            ((InternalEObject) newFilterCapabilities)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES,
