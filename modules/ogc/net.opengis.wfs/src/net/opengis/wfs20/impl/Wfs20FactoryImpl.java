...
public class Wfs20FactoryImpl extends EFactoryImpl implements Wfs20Factory {
  ...
  public static Wfs20Factory init() {
    try {
      Wfs20Factory theWfs20Factory =
          (Wfs20Factory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/wfs/2.0");
  ...
  public CreatedOrModifiedFeatureType createCreatedOrModifiedFeatureType() {
    CreatedOrModifiedFeatureTypeImpl createdOrModifiedFeatureType =
        new CreatedOrModifiedFeatureTypeImpl();
  ...
  public CreateStoredQueryResponseType createCreateStoredQueryResponseType() {
    CreateStoredQueryResponseTypeImpl createStoredQueryResponseType =
        new CreateStoredQueryResponseTypeImpl();
  ...
  public DescribeStoredQueriesResponseType createDescribeStoredQueriesResponseType() {
    DescribeStoredQueriesResponseTypeImpl describeStoredQueriesResponseType =
        new DescribeStoredQueriesResponseTypeImpl();
  ...
  public ListStoredQueriesResponseType createListStoredQueriesResponseType() {
    ListStoredQueriesResponseTypeImpl listStoredQueriesResponseType =
        new ListStoredQueriesResponseTypeImpl();
  ...
  public SimpleFeatureCollectionType createSimpleFeatureCollectionType() {
    SimpleFeatureCollectionTypeImpl simpleFeatureCollectionType =
        new SimpleFeatureCollectionTypeImpl();
  ...
  public StoredQueryDescriptionType createStoredQueryDescriptionType() {
    StoredQueryDescriptionTypeImpl storedQueryDescriptionType =
        new StoredQueryDescriptionTypeImpl();
  ...
  public NonNegativeIntegerOrUnknownMember0 createNonNegativeIntegerOrUnknownMember0FromString(
    ...
    NonNegativeIntegerOrUnknownMember0 result =
        NonNegativeIntegerOrUnknownMember0.get(initialValue);
    if (result == null)
      throw new IllegalArgumentException(
          "The value '"
              + initialValue
   ...
   * @generated
   */
  public String convertNonNegativeIntegerOrUnknownMember0ToString(
   ...
   * @generated
   */
  public ResolveValueType createResolveValueTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public StateValueTypeMember0 createStateValueTypeMember0FromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public UpdateActionType createUpdateActionTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public Object createNonNegativeIntegerOrUnknownFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public String convertNonNegativeIntegerOrUnknownToString(
      EDataType eDataType, Object instanceValue) {
      ...
      try {
        String value =
            convertNonNegativeIntegerOrUnknownMember1ToString(
                Wfs20Package.Literals.NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER1, instanceValue);
        if (value != null) return value;
      } catch (Exception e) {
        // Keep trying other member types until all have failed.
      }
   ...
   * @generated
   */
  public NonNegativeIntegerOrUnknownMember0
   ...
   * @generated
   */
  public String convertNonNegativeIntegerOrUnknownMember0ObjectToString(
      EDataType eDataType, Object instanceValue) {
   ...
   * @generated
   */
  public BigInteger createNonNegativeIntegerOrUnknownMember1FromString(
      EDataType eDataType, String initialValue) {
    return (BigInteger)
   ...
   * @generated
   */
  public String convertNonNegativeIntegerOrUnknownMember1ToString(
      EDataType eDataType, Object instanceValue) {
  ...
  public String convertPositiveIntegerWithStarToString(EDataType eDataType, Object instanceValue) {
    ...
    if (Wfs20Package.Literals.STAR_STRING_TYPE.isInstance(instanceValue)) {
      try {
        String value =
            convertStarStringTypeToString(Wfs20Package.Literals.STAR_STRING_TYPE, instanceValue);
        if (value != null) return value;
      } catch (Exception e) {
        // Keep trying other member types until all have failed.
      }
   ...
   * @generated
   */
  public ResolveValueType createResolveValueTypeObjectFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public ResultTypeType createResultTypeTypeObjectFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public List<QName> createReturnFeatureTypesListTypeFromString(
      EDataType eDataType, String initialValue) {
    if (initialValue == null) return null;
    List<QName> result = new ArrayList<QName>();
    for (String item : split(initialValue)) {
      result.add(
          (QName) XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.QNAME, item));
    }
    return result;
  }
   ...
   * @generated
   */
  public String convertReturnFeatureTypesListTypeToString(
      EDataType eDataType, Object instanceValue) {
    if (instanceValue == null) return null;
   ...
   * @generated
   */
  public StarStringType createStarStringTypeObjectFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public StateValueTypeMember0 createStateValueTypeMember0ObjectFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public String convertStateValueTypeMember0ObjectToString(
      EDataType eDataType, Object instanceValue) {
   ...
   * @generated
   */
  public UpdateActionType createUpdateActionTypeObjectFromString(
      EDataType eDataType, String initialValue) {
