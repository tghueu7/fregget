 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getDefaultCRS <em>Default CRS</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getOtherCRS <em>Other CRS</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getNoCRS <em>No CRS</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getOutputFormats <em>Output Formats</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getWGS84BoundingBox <em>WGS84 Bounding
 *       Box</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getMetadataURL <em>Metadata URL</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl#getExtendedDescription <em>Extended
 *       Description</em>}
 * </ul>
 *
 * @generated
...
public class FeatureTypeTypeImpl extends EObjectImpl implements FeatureTypeType {
  ...
  /**
   * The cached value of the '{@link #getOutputFormats() <em>Output Formats</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getWGS84BoundingBox() <em>WGS84 Bounding Box</em>}'
  ...
  /**
   * The cached value of the '{@link #getMetadataURL() <em>Metadata URL</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getExtendedDescription() <em>Extended Description</em>}'
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.FEATURE_TYPE_TYPE__NAME, oldName, name));
  }
  ...
  public EList<TitleType> getTitle() {
    if (title == null) {
      title =
          new EObjectContainmentEList<TitleType>(
              TitleType.class, this, Wfs20Package.FEATURE_TYPE_TYPE__TITLE);
    }
    return title;
  }
  ...
  public EList<AbstractType> getAbstract() {
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<AbstractType>(
              AbstractType.class, this, Wfs20Package.FEATURE_TYPE_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public EList<KeywordsType> getKeywords() {
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList<KeywordsType>(
              KeywordsType.class, this, Wfs20Package.FEATURE_TYPE_TYPE__KEYWORDS);
    }
    return keywords;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_TYPE_TYPE__DEFAULT_CRS,
              oldDefaultCRS,
              defaultCRS));
  }
  ...
  public EList<String> getOtherCRS() {
    if (otherCRS == null) {
      otherCRS =
          new EDataTypeEList<String>(String.class, this, Wfs20Package.FEATURE_TYPE_TYPE__OTHER_CRS);
    }
    return otherCRS;
  }
  ...
  public NotificationChain basicSetNoCRS(NoCRSType newNoCRS, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.FEATURE_TYPE_TYPE__NO_CRS, oldNoCRS, newNoCRS);
  ...
  public void setNoCRS(NoCRSType newNoCRS) {
    if (newNoCRS != noCRS) {
      ...
      if (noCRS != null)
        msgs =
            ((InternalEObject) noCRS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__NO_CRS,
                    null,
                    msgs);
      if (newNoCRS != null)
        msgs =
            ((InternalEObject) newNoCRS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__NO_CRS,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.FEATURE_TYPE_TYPE__NO_CRS, newNoCRS, newNoCRS));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetOutputFormats(
      OutputFormatListType newOutputFormats, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_TYPE_TYPE__OUTPUT_FORMATS,
              oldOutputFormats,
              newOutputFormats);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setOutputFormats(OutputFormatListType newOutputFormats) {
    if (newOutputFormats != outputFormats) {
      ...
      if (outputFormats != null)
        msgs =
            ((InternalEObject) outputFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__OUTPUT_FORMATS,
                    null,
                    msgs);
      if (newOutputFormats != null)
        msgs =
            ((InternalEObject) newOutputFormats)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__OUTPUT_FORMATS,
                    null,
  ...
  public EList<WGS84BoundingBoxType> getWGS84BoundingBox() {
    if (wGS84BoundingBox == null) {
      wGS84BoundingBox =
          new EObjectContainmentEList<WGS84BoundingBoxType>(
              WGS84BoundingBoxType.class, this, Wfs20Package.FEATURE_TYPE_TYPE__WGS84_BOUNDING_BOX);
    }
  ...
  public EList<MetadataURLType> getMetadataURL() {
    if (metadataURL == null) {
      metadataURL =
          new EObjectContainmentEList<MetadataURLType>(
              MetadataURLType.class, this, Wfs20Package.FEATURE_TYPE_TYPE__METADATA_URL);
    }
    return metadataURL;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetExtendedDescription(
      ExtendedDescriptionType newExtendedDescription, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION,
              oldExtendedDescription,
  ...
  public void setExtendedDescription(ExtendedDescriptionType newExtendedDescription) {
    if (newExtendedDescription != extendedDescription) {
      ...
      if (extendedDescription != null)
        msgs =
            ((InternalEObject) extendedDescription)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION,
                    null,
                    msgs);
      if (newExtendedDescription != null)
        msgs =
            ((InternalEObject) newExtendedDescription)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION,
                    null,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wfs20Package.FEATURE_TYPE_TYPE__DEFAULT_CRS:
        return DEFAULT_CRS_EDEFAULT == null
            ? defaultCRS != null
            : !DEFAULT_CRS_EDEFAULT.equals(defaultCRS);
      case Wfs20Package.FEATURE_TYPE_TYPE__OTHER_CRS:
