 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl#getTotalInserted <em>Total
 *       Inserted</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl#getTotalUpdated <em>Total
 *       Updated</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl#getTotalReplaced <em>Total
 *       Replaced</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl#getTotalDeleted <em>Total
 *       Deleted</em>}
 * </ul>
 *
 * @generated
...
public class TransactionSummaryTypeImpl extends EObjectImpl implements TransactionSummaryType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED,
              oldTotalInserted,
              totalInserted));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED,
              oldTotalUpdated,
              totalUpdated));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_REPLACED,
              oldTotalReplaced,
              totalReplaced));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED,
              oldTotalDeleted,
              totalDeleted));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED:
        return TOTAL_INSERTED_EDEFAULT == null
            ? totalInserted != null
            : !TOTAL_INSERTED_EDEFAULT.equals(totalInserted);
      case Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED:
        return TOTAL_UPDATED_EDEFAULT == null
            ? totalUpdated != null
            : !TOTAL_UPDATED_EDEFAULT.equals(totalUpdated);
      case Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_REPLACED:
        return TOTAL_REPLACED_EDEFAULT == null
            ? totalReplaced != null
            : !TOTAL_REPLACED_EDEFAULT.equals(totalReplaced);
      case Wfs20Package.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED:
        return TOTAL_DELETED_EDEFAULT == null
            ? totalDeleted != null
            : !TOTAL_DELETED_EDEFAULT.equals(totalDeleted);
    }
