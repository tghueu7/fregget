 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ElementTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.impl.ElementTypeImpl#getValueList <em>Value List</em>}
 *   <li>{@link net.opengis.wfs20.impl.ElementTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs20.impl.ElementTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class ElementTypeImpl extends EObjectImpl implements ElementType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.ELEMENT_TYPE__METADATA,
              oldMetadata,
              newMetadata);
      ...
      if (metadata != null)
        msgs =
            ((InternalEObject) metadata)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Wfs20Package.ELEMENT_TYPE__METADATA, null, msgs);
      if (newMetadata != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.ELEMENT_TYPE__VALUE_LIST,
              oldValueList,
              newValueList);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (valueList != null)
        msgs =
            ((InternalEObject) valueList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.ELEMENT_TYPE__VALUE_LIST,
                    null,
                    msgs);
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.ELEMENT_TYPE__NAME, oldName, name));
  }
  ...
  public void setType(QName newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.ELEMENT_TYPE__TYPE, oldType, type));
  }
