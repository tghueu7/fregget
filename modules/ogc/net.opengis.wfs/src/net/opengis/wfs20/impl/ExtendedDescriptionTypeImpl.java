 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ExtendedDescriptionTypeImpl#getElement <em>Element</em>}
 * </ul>
 *
 * @generated
 */
public class ExtendedDescriptionTypeImpl extends EObjectImpl implements ExtendedDescriptionType {
  ...
  public EList<ElementType> getElement() {
    if (element == null) {
      element =
          new EObjectContainmentEList<ElementType>(
              ElementType.class, this, Wfs20Package.EXTENDED_DESCRIPTION_TYPE__ELEMENT);
    }
    return element;
  }
