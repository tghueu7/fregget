 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl#isIsPrivate <em>Is Private</em>}
 *   <li>{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl#getLanguage <em>Language</em>}
 *   <li>{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl#getReturnFeatureTypes <em>Return
 *       Feature Types</em>}
 *   <li>{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl#getValue <em>Value</em>}
 * </ul>
 *
 * @generated
 */
public class QueryExpressionTextTypeImpl extends EObjectImpl implements QueryExpressionTextType {
  ...
  /**
   * The default value of the '{@link #getReturnFeatureTypes() <em>Return Feature Types</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getReturnFeatureTypes() <em>Return Feature Types</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__IS_PRIVATE,
              oldIsPrivate,
              isPrivate,
              !oldIsPrivateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__LANGUAGE,
              oldLanguage,
              language));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__RETURN_FEATURE_TYPES,
              oldReturnFeatureTypes,
              returnFeatureTypes));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__VALUE,
              oldValue,
              value));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__RETURN_FEATURE_TYPES:
        return RETURN_FEATURE_TYPES_EDEFAULT == null
            ? returnFeatureTypes != null
            : !RETURN_FEATURE_TYPES_EDEFAULT.equals(returnFeatureTypes);
      case Wfs20Package.QUERY_EXPRESSION_TEXT_TYPE__VALUE:
  ...
  public String toString() {
    ...
    if (isPrivateESet) result.append(isPrivate);
