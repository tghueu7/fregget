 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getAbstractQueryExpression
 *       <em>Abstract Query Expression</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getCount <em>Count</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getResolve <em>Resolve</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getResolveDepth <em>Resolve
 *       Depth</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getResolvePath <em>Resolve
 *       Path</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getResolveTimeout <em>Resolve
 *       Timeout</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getResultType <em>Result Type</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getStartIndex <em>Start Index</em>}
 *   <li>{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl#getValueReference <em>Value
 *       Reference</em>}
 * </ul>
 *
 * @generated
...
public class GetPropertyValueTypeImpl extends BaseRequestTypeImpl implements GetPropertyValueType {
  /**
   * The cached value of the '{@link #getAbstractQueryExpression() <em>Abstract Query
   * Expression</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public AbstractQueryExpressionType getAbstractQueryExpression() {
    if (abstractQueryExpression != null && abstractQueryExpression.eIsProxy()) {
      ...
      abstractQueryExpression =
          (AbstractQueryExpressionType) eResolveProxy(oldAbstractQueryExpression);
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  Wfs20Package.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION,
                  oldAbstractQueryExpression,
                  abstractQueryExpression));
      }
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__COUNT,
              oldCount,
              count));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE,
              oldResolve,
              resolve,
              !oldResolveESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH,
              oldResolveDepth,
              resolveDepth));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_PATH,
              oldResolvePath,
              resolvePath));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT,
              oldResolveTimeout,
              resolveTimeout,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESULT_TYPE,
              oldResultType,
              resultType,
              !oldResultTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__START_INDEX,
              oldStartIndex,
              startIndex,
              !oldStartIndexESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.GET_PROPERTY_VALUE_TYPE__VALUE_REFERENCE,
              oldValueReference,
              valueReference));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE:
        return isSetResolve();
      case Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH:
        return RESOLVE_DEPTH_EDEFAULT == null
            ? resolveDepth != null
            : !RESOLVE_DEPTH_EDEFAULT.equals(resolveDepth);
      case Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_PATH:
        return RESOLVE_PATH_EDEFAULT == null
            ? resolvePath != null
            : !RESOLVE_PATH_EDEFAULT.equals(resolvePath);
      case Wfs20Package.GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT:
      ...
      case Wfs20Package.GET_PROPERTY_VALUE_TYPE__VALUE_REFERENCE:
        return VALUE_REFERENCE_EDEFAULT == null
            ? valueReference != null
            : !VALUE_REFERENCE_EDEFAULT.equals(valueReference);
    }
