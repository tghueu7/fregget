 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.TupleTypeImpl#getMember <em>Member</em>}
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends EObjectImpl implements TupleType {
  ...
  public EList<MemberPropertyType> getMember() {
    if (member == null) {
      member =
          new EObjectContainmentEList<MemberPropertyType>(
              MemberPropertyType.class, this, Wfs20Package.TUPLE_TYPE__MEMBER);
    }
    return member;
  }
