 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureTypeImpl#getAbstractQueryExpressionGroup
 *       <em>Abstract Query Expression Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureTypeImpl#getAbstractQueryExpression <em>Abstract
 *       Query Expression</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureTypeImpl#getExpiry <em>Expiry</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureTypeImpl#getLockAction <em>Lock Action</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureTypeImpl#getLockId <em>Lock Id</em>}
 * </ul>
 *
 * @generated
 */
public class LockFeatureTypeImpl extends BaseRequestTypeImpl implements LockFeatureType {
  ...
  public FeatureMap getAbstractQueryExpressionGroup() {
    if (abstractQueryExpressionGroup == null) {
      abstractQueryExpressionGroup =
          new BasicFeatureMap(
              this, Wfs20Package.LOCK_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP);
    }
  ...
  public EList<AbstractQueryExpressionType> getAbstractQueryExpression() {
    return getAbstractQueryExpressionGroup()
        .list(Wfs20Package.Literals.LOCK_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.LOCK_FEATURE_TYPE__EXPIRY,
              oldExpiry,
              expiry,
              !oldExpiryESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.LOCK_FEATURE_TYPE__LOCK_ACTION,
              oldLockAction,
              lockAction,
              !oldLockActionESet));
  }
  ...
  public void setLockId(String newLockId) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.LOCK_FEATURE_TYPE__LOCK_ID, oldLockId, lockId));
  }
