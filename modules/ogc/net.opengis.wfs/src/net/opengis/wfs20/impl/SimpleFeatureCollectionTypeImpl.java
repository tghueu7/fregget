 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.SimpleFeatureCollectionTypeImpl#getBoundedBy <em>Bounded
 *       By</em>}
 *   <li>{@link net.opengis.wfs20.impl.SimpleFeatureCollectionTypeImpl#getMember <em>Member</em>}
 * </ul>
 *
 * @generated
 */
public class SimpleFeatureCollectionTypeImpl extends EObjectImpl
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.SIMPLE_FEATURE_COLLECTION_TYPE__BOUNDED_BY,
              oldBoundedBy,
              newBoundedBy);
  ...
  public EList<FeatureCollection> getMember() {
    if (member == null) {
      member =
          new EDataTypeUniqueEList<FeatureCollection>(
              FeatureCollection.class, this, Wfs20Package.SIMPLE_FEATURE_COLLECTION_TYPE__MEMBER);
    }
    return member;
  }
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case Wfs20Package.SIMPLE_FEATURE_COLLECTION_TYPE__BOUNDED_BY:
        setBoundedBy(
            newValue instanceof EnvelopePropertyType ? (EnvelopePropertyType) newValue : null);
        return;
      case Wfs20Package.SIMPLE_FEATURE_COLLECTION_TYPE__MEMBER:
        getMember().clear();
