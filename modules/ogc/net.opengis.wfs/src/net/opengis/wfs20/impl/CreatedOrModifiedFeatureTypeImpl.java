 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.CreatedOrModifiedFeatureTypeImpl#getResourceId <em>Resource
 *       Id</em>}
 *   <li>{@link net.opengis.wfs20.impl.CreatedOrModifiedFeatureTypeImpl#getHandle <em>Handle</em>}
 * </ul>
 *
 * @generated
 */
public class CreatedOrModifiedFeatureTypeImpl extends EObjectImpl
    implements CreatedOrModifiedFeatureType {
  /**
  ...
  public EList<FeatureId> getResourceId() {
    if (resourceId == null) {
      resourceId =
          new EDataTypeUniqueEList<FeatureId>(
              FeatureId.class, this, Wfs20Package.CREATED_OR_MODIFIED_FEATURE_TYPE__RESOURCE_ID);
    }
    return resourceId;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.CREATED_OR_MODIFIED_FEATURE_TYPE__HANDLE,
              oldHandle,
              handle));
  }
