 ...
 * <ul>
 *   <li>{@link
 *       net.opengis.wfs20.impl.DescribeStoredQueriesResponseTypeImpl#getStoredQueryDescription
 *       <em>Stored Query Description</em>}
 * </ul>
 *
 * @generated
 */
public class DescribeStoredQueriesResponseTypeImpl extends EObjectImpl
    implements DescribeStoredQueriesResponseType {
  /**
   * The cached value of the '{@link #getStoredQueryDescription() <em>Stored Query
   * Description</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<StoredQueryDescriptionType> getStoredQueryDescription() {
    if (storedQueryDescription == null) {
      storedQueryDescription =
          new EObjectContainmentEList<StoredQueryDescriptionType>(
              StoredQueryDescriptionType.class,
              this,
              Wfs20Package.DESCRIBE_STORED_QUERIES_RESPONSE_TYPE__STORED_QUERY_DESCRIPTION);
    }
    ...
    switch (featureID) {
      case Wfs20Package.DESCRIBE_STORED_QUERIES_RESPONSE_TYPE__STORED_QUERY_DESCRIPTION:
        ...
        getStoredQueryDescription()
            .addAll((Collection<? extends StoredQueryDescriptionType>) newValue);
        return;
    }
