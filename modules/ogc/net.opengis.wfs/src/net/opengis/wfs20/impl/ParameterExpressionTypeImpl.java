 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class ParameterExpressionTypeImpl extends EObjectImpl implements ParameterExpressionType {
    ...
    if (title == null) {
      title =
          new EObjectContainmentEList<TitleType>(
              TitleType.class, this, Wfs20Package.PARAMETER_EXPRESSION_TYPE__TITLE);
    }
    return title;
  }
    ...
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<AbstractType>(
              AbstractType.class, this, Wfs20Package.PARAMETER_EXPRESSION_TYPE__ABSTRACT);
    }
    return abstract_;
  }
    ...
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList<MetadataType>(
              MetadataType.class, this, Wfs20Package.PARAMETER_EXPRESSION_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.PARAMETER_EXPRESSION_TYPE__NAME, oldName, name));
  }
  ...
  public void setType(QName newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.PARAMETER_EXPRESSION_TYPE__TYPE, oldType, type));
  }
