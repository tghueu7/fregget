 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.ListStoredQueriesResponseTypeImpl#getStoredQuery <em>Stored
 *       Query</em>}
 * </ul>
 *
 * @generated
 */
public class ListStoredQueriesResponseTypeImpl extends EObjectImpl
    implements ListStoredQueriesResponseType {
  /**
   * The cached value of the '{@link #getStoredQuery() <em>Stored Query</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<StoredQueryListItemType> getStoredQuery() {
    if (storedQuery == null) {
      storedQuery =
          new EObjectContainmentEList<StoredQueryListItemType>(
              StoredQueryListItemType.class,
              this,
              Wfs20Package.LIST_STORED_QUERIES_RESPONSE_TYPE__STORED_QUERY);
    }
    return storedQuery;
  }
