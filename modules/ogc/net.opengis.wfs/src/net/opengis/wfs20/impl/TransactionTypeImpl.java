 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getAbstractTransactionActionGroup
 *       <em>Abstract Transaction Action Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getAbstractTransactionAction <em>Abstract
 *       Transaction Action</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getReleaseAction <em>Release Action</em>}
 *   <li>{@link net.opengis.wfs20.impl.TransactionTypeImpl#getSrsName <em>Srs Name</em>}
 * </ul>
 *
 * @generated
 */
public class TransactionTypeImpl extends BaseRequestTypeImpl implements TransactionType {
    ...
    return (FeatureMap)
        getGroup()
            .<FeatureMap.Entry>list(
                Wfs20Package.Literals.TRANSACTION_TYPE__ABSTRACT_TRANSACTION_ACTION_GROUP);
  }
  ...
  public EList<AbstractTransactionActionType> getAbstractTransactionAction() {
    return getAbstractTransactionActionGroup()
        .list(Wfs20Package.Literals.TRANSACTION_TYPE__ABSTRACT_TRANSACTION_ACTION);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.TRANSACTION_TYPE__LOCK_ID, oldLockId, lockId));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_TYPE__RELEASE_ACTION,
              oldReleaseAction,
              releaseAction,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.TRANSACTION_TYPE__SRS_NAME,
              oldSrsName,
              srsName));
  }
