 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.AdditionalObjectsTypeImpl#getValueCollection <em>Value
 *       Collection</em>}
 *   <li>{@link net.opengis.wfs20.impl.AdditionalObjectsTypeImpl#getSimpleFeatureCollectionGroup
 *       <em>Simple Feature Collection Group</em>}
 *   <li>{@link net.opengis.wfs20.impl.AdditionalObjectsTypeImpl#getSimpleFeatureCollection
 *       <em>Simple Feature Collection</em>}
 * </ul>
 *
 * @generated
 */
public class AdditionalObjectsTypeImpl extends EObjectImpl implements AdditionalObjectsType {
  /**
   * The cached value of the '{@link #getValueCollection() <em>Value Collection</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSimpleFeatureCollectionGroup() <em>Simple Feature
   * Collection Group</em>}' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.ADDITIONAL_OBJECTS_TYPE__VALUE_COLLECTION,
              oldValueCollection,
              newValueCollection);
  ...
  public void setValueCollection(ValueCollectionType newValueCollection) {
    if (newValueCollection != valueCollection) {
      ...
      if (valueCollection != null)
        msgs =
            ((InternalEObject) valueCollection)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.ADDITIONAL_OBJECTS_TYPE__VALUE_COLLECTION,
                    null,
                    msgs);
      if (newValueCollection != null)
        msgs =
            ((InternalEObject) newValueCollection)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wfs20Package.ADDITIONAL_OBJECTS_TYPE__VALUE_COLLECTION,
                    null,
  ...
  public FeatureMap getSimpleFeatureCollectionGroup() {
    if (simpleFeatureCollectionGroup == null) {
      simpleFeatureCollectionGroup =
          new BasicFeatureMap(
              this, Wfs20Package.ADDITIONAL_OBJECTS_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP);
    }
  ...
  public SimpleFeatureCollectionType getSimpleFeatureCollection() {
    return (SimpleFeatureCollectionType)
        getSimpleFeatureCollectionGroup()
            .get(Wfs20Package.Literals.ADDITIONAL_OBJECTS_TYPE__SIMPLE_FEATURE_COLLECTION, true);
  }
  ...
  public NotificationChain basicSetSimpleFeatureCollection(
    ...
    return ((FeatureMap.Internal) getSimpleFeatureCollectionGroup())
        .basicAdd(
            Wfs20Package.Literals.ADDITIONAL_OBJECTS_TYPE__SIMPLE_FEATURE_COLLECTION,
