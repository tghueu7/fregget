 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.FeatureTypeListTypeImpl#getFeatureType <em>Feature Type</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureTypeListTypeImpl extends EObjectImpl implements FeatureTypeListType {
  ...
  public EList<FeatureTypeType> getFeatureType() {
    if (featureType == null) {
      featureType =
          new EObjectContainmentEList<FeatureTypeType>(
              FeatureTypeType.class, this, Wfs20Package.FEATURE_TYPE_LIST_TYPE__FEATURE_TYPE);
    }
    return featureType;
  }
