 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.CreateStoredQueryTypeImpl#getStoredQueryDefinition <em>Stored
 *       Query Definition</em>}
 * </ul>
 *
 * @generated
 */
public class CreateStoredQueryTypeImpl extends BaseRequestTypeImpl
    implements CreateStoredQueryType {
  /**
   * The cached value of the '{@link #getStoredQueryDefinition() <em>Stored Query Definition</em>}'
    ...
    if (storedQueryDefinition == null) {
      storedQueryDefinition =
          new EObjectContainmentEList<StoredQueryDescriptionType>(
              ...
              this,
              Wfs20Package.CREATE_STORED_QUERY_TYPE__STORED_QUERY_DEFINITION);
    }
