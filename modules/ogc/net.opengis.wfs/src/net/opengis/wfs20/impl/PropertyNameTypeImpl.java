 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.PropertyNameTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wfs20.impl.PropertyNameTypeImpl#getResolve <em>Resolve</em>}
 *   <li>{@link net.opengis.wfs20.impl.PropertyNameTypeImpl#getResolveDepth <em>Resolve Depth</em>}
 *   <li>{@link net.opengis.wfs20.impl.PropertyNameTypeImpl#getResolvePath <em>Resolve Path</em>}
 *   <li>{@link net.opengis.wfs20.impl.PropertyNameTypeImpl#getResolveTimeout <em>Resolve
 *       Timeout</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.PROPERTY_NAME_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.PROPERTY_NAME_TYPE__RESOLVE,
              oldResolve,
              resolve,
              !oldResolveESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.PROPERTY_NAME_TYPE__RESOLVE_DEPTH,
              oldResolveDepth,
              resolveDepth,
              !oldResolveDepthESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.PROPERTY_NAME_TYPE__RESOLVE_PATH,
              oldResolvePath,
              resolvePath));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.PROPERTY_NAME_TYPE__RESOLVE_TIMEOUT,
              oldResolveTimeout,
              resolveTimeout,
