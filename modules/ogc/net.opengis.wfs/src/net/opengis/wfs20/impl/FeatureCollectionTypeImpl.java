 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getAdditionalObjects <em>Additional
 *       Objects</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getTruncatedResponse <em>Truncated
 *       Response</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getNext <em>Next</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getNumberMatched <em>Number
 *       Matched</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getNumberReturned <em>Number
 *       Returned</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getPrevious <em>Previous</em>}
 *   <li>{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl#getTimeStamp <em>Time Stamp</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureCollectionTypeImpl extends SimpleFeatureCollectionTypeImpl
    implements FeatureCollectionType {
  /**
   * The cached value of the '{@link #getAdditionalObjects() <em>Additional Objects</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS,
              oldAdditionalObjects,
  ...
  public void setAdditionalObjects(AdditionalObjectsType newAdditionalObjects) {
    if (newAdditionalObjects != additionalObjects) {
      ...
      if (additionalObjects != null)
        msgs =
            ((InternalEObject) additionalObjects)
                .eInverseRemove(
                    this,
      ...
      if (newAdditionalObjects != null)
        msgs =
            ((InternalEObject) newAdditionalObjects)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__LOCK_ID,
              oldLockId,
              lockId));
  }
  ...
  public void setNext(String newNext) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wfs20Package.FEATURE_COLLECTION_TYPE__NEXT, oldNext, next));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__NUMBER_MATCHED,
              oldNumberMatched,
              numberMatched));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__NUMBER_RETURNED,
              oldNumberReturned,
              numberReturned));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__PREVIOUS,
              oldPrevious,
              previous));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.FEATURE_COLLECTION_TYPE__TIME_STAMP,
              oldTimeStamp,
              timeStamp));
  }
