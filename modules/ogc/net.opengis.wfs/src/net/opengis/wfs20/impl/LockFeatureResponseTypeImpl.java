 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureResponseTypeImpl#getFeaturesLocked <em>Features
 *       Locked</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureResponseTypeImpl#getFeaturesNotLocked <em>Features
 *       Not Locked</em>}
 *   <li>{@link net.opengis.wfs20.impl.LockFeatureResponseTypeImpl#getLockId <em>Lock Id</em>}
 * </ul>
 *
 * @generated
 */
public class LockFeatureResponseTypeImpl extends EObjectImpl implements LockFeatureResponseType {
  /**
   * The cached value of the '{@link #getFeaturesLocked() <em>Features Locked</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getFeaturesNotLocked() <em>Features Not Locked</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__FEATURES_LOCKED,
              oldFeaturesLocked,
              newFeaturesLocked);
  ...
  public void setFeaturesLocked(FeaturesLockedType newFeaturesLocked) {
    if (newFeaturesLocked != featuresLocked) {
      ...
      if (featuresLocked != null)
        msgs =
            ((InternalEObject) featuresLocked)
                .eInverseRemove(
                    this,
      ...
      if (newFeaturesLocked != null)
        msgs =
            ((InternalEObject) newFeaturesLocked)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__FEATURES_LOCKED,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__FEATURES_NOT_LOCKED,
              oldFeaturesNotLocked,
  ...
  public void setFeaturesNotLocked(FeaturesNotLockedType newFeaturesNotLocked) {
    if (newFeaturesNotLocked != featuresNotLocked) {
      ...
      if (featuresNotLocked != null)
        msgs =
            ((InternalEObject) featuresNotLocked)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__FEATURES_NOT_LOCKED,
      ...
      if (newFeaturesNotLocked != null)
        msgs =
            ((InternalEObject) newFeaturesNotLocked)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__FEATURES_NOT_LOCKED,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wfs20Package.LOCK_FEATURE_RESPONSE_TYPE__LOCK_ID,
              oldLockId,
              lockId));
  }
