 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.ReplaceType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.wfs20.ReplaceType#getFilter <em>Filter</em>}
 *   <li>{@link net.opengis.wfs20.ReplaceType#getInputFormat <em>Input Format</em>}
 *   <li>{@link net.opengis.wfs20.ReplaceType#getSrsName <em>Srs Name</em>}
 * </ul>
 *
...
public interface ReplaceType extends AbstractTransactionActionType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ReplaceType#getFilter <em>Filter</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ReplaceType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.ReplaceType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.ReplaceType#getInputFormat <em>Input
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ReplaceType#getSrsName <em>Srs Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
