 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.ListStoredQueriesResponseType#getStoredQuery <em>Stored
 *       Query</em>}
 * </ul>
 *
...
public interface ListStoredQueriesResponseType extends EObject {
  /**
   * Returns the value of the '<em><b>Stored Query</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wfs20.StoredQueryListItemType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Stored Query</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='StoredQuery'
