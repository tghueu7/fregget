 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.PropertyNameType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wfs20.PropertyNameType#getResolve <em>Resolve</em>}
 *   <li>{@link net.opengis.wfs20.PropertyNameType#getResolveDepth <em>Resolve Depth</em>}
 *   <li>{@link net.opengis.wfs20.PropertyNameType#getResolvePath <em>Resolve Path</em>}
 *   <li>{@link net.opengis.wfs20.PropertyNameType#getResolveTimeout <em>Resolve Timeout</em>}
 * </ul>
 *
...
public interface PropertyNameType extends EObject {
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.QName" extendedMetaData="name=':0'
   *     kind='simple'"
   * @generated
   */
  QName getValue();
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyNameType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolve <em>Resolve</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolve
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolve
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveDepth <em>Resolve
   * Depth</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveDepth <em>Resolve
   * Depth</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveDepth
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolvePath <em>Resolve
   * Path</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveTimeout <em>Resolve
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveTimeout
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.PropertyNameType#getResolveTimeout
