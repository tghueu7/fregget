 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.LockFeatureResponseType#getFeaturesLocked <em>Features
 *       Locked</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureResponseType#getFeaturesNotLocked <em>Features Not
 *       Locked</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureResponseType#getLockId <em>Lock Id</em>}
 * </ul>
 *
...
public interface LockFeatureResponseType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Features Locked</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureResponseType#getFeaturesLocked
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Features Not Locked</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureResponseType#getFeaturesNotLocked
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureResponseType#getLockId <em>Lock
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
