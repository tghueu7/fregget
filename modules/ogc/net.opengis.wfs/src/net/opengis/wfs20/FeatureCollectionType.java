 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getAdditionalObjects <em>Additional
 *       Objects</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getTruncatedResponse <em>Truncated
 *       Response</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getNext <em>Next</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getNumberMatched <em>Number Matched</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getNumberReturned <em>Number Returned</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getPrevious <em>Previous</em>}
 *   <li>{@link net.opengis.wfs20.FeatureCollectionType#getTimeStamp <em>Time Stamp</em>}
 * </ul>
 *
...
public interface FeatureCollectionType extends SimpleFeatureCollectionType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='additionalObjects'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getAdditionalObjects
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getTruncatedResponse
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Lock Id</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getLockId <em>Lock
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getNext <em>Next</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getNumberMatched
   * <em>Number Matched</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getNumberReturned
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getPrevious
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.FeatureCollectionType#getTimeStamp <em>Time
   * Stamp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
