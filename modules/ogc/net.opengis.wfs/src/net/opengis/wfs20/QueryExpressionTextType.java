 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.QueryExpressionTextType#isIsPrivate <em>Is Private</em>}
 *   <li>{@link net.opengis.wfs20.QueryExpressionTextType#getLanguage <em>Language</em>}
 *   <li>{@link net.opengis.wfs20.QueryExpressionTextType#getReturnFeatureTypes <em>Return Feature
 *       Types</em>}
 *   <li>{@link net.opengis.wfs20.QueryExpressionTextType#getValue <em>Value</em>}
 * </ul>
 *
...
public interface QueryExpressionTextType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Is Private</b></em>' attribute. The default value is <code>
   * "false"</code>.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Is Private</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#isIsPrivate <em>Is
   * Private</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#isIsPrivate <em>Is
   * Private</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#isIsPrivate
   * <em>Is Private</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#getLanguage
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Return Feature Types</em>' attribute isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#getReturnFeatureTypes
   * <em>Return Feature Types</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.QueryExpressionTextType#getValue
