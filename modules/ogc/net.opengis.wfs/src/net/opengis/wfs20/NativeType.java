 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.NativeType#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wfs20.NativeType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.wfs20.NativeType#isSafeToIgnore <em>Safe To Ignore</em>}
 *   <li>{@link net.opengis.wfs20.NativeType#getVendorId <em>Vendor Id</em>}
 * </ul>
 *
...
public interface NativeType extends AbstractTransactionActionType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Safe To Ignore</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.NativeType#isSafeToIgnore <em>Safe To
   * Ignore</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.NativeType#isSafeToIgnore <em>Safe To
   * Ignore</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.NativeType#isSafeToIgnore <em>Safe
   * To Ignore</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Vendor Id</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.NativeType#getVendorId <em>Vendor Id</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
