 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.DescribeStoredQueriesResponseType#getStoredQueryDescription
...
public interface DescribeStoredQueriesResponseType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Stored Query Description</em>' containment reference list isn't
   * clear, there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Stored Query Description</em>' containment reference list.
   * @see
   *     net.opengis.wfs20.Wfs20Package#getDescribeStoredQueriesResponseType_StoredQueryDescription()
   * @model containment="true" extendedMetaData="kind='element' name='StoredQueryDescription'
