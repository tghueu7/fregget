 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.TransactionType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.wfs20.TransactionType#getAbstractTransactionActionGroup <em>Abstract
 *       Transaction Action Group</em>}
 *   <li>{@link net.opengis.wfs20.TransactionType#getAbstractTransactionAction <em>Abstract
 *       Transaction Action</em>}
 *   <li>{@link net.opengis.wfs20.TransactionType#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs20.TransactionType#getReleaseAction <em>Release Action</em>}
 *   <li>{@link net.opengis.wfs20.TransactionType#getSrsName <em>Srs Name</em>}
 * </ul>
 *
...
public interface TransactionType extends BaseRequestType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Transaction Action Group</em>' attribute list isn't
   ...
   *     name='AbstractTransactionAction:group' namespace='##targetNamespace' group='#group:3'"
   * @generated
   */
   ...
   * list. The list contents are of type {@link net.opengis.wfs20.AbstractTransactionActionType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Transaction Action</em>' containment reference list
   ...
   *     extendedMetaData="kind='element' name='AbstractTransactionAction'
   *     namespace='##targetNamespace' group='AbstractTransactionAction:group'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionType#getLockId <em>Lock Id</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <code>"ALL"</code>. The literals are from the enumeration {@link
   * net.opengis.wfs20.AllSomeType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Release Action</em>' attribute isn't clear, there really should
   ...
   * @model default="ALL" unsettable="true" extendedMetaData="kind='attribute' name='releaseAction'"
   * @generated
   */
  AllSomeType getReleaseAction();

  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionType#getReleaseAction <em>Release
   * Action</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.TransactionType#getReleaseAction <em>Release
   * Action</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.TransactionType#getReleaseAction
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionType#getSrsName <em>Srs Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
