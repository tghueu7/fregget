 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getQueryExpressionText <em>Query
 *       Expression Text</em>}
 *   <li>{@link net.opengis.wfs20.StoredQueryDescriptionType#getId <em>Id</em>}
 * </ul>
 *
...
public interface StoredQueryDescriptionType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Metadata'
   ...
   * contents are of type {@link net.opengis.wfs20.ParameterExpressionType}.
   * <!-- begin-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Query Expression Text</em>' containment reference list isn't
   ...
   *     name='QueryExpressionText' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.StoredQueryDescriptionType#getId <em>Id</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
