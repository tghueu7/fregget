 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.AbstractType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wfs20.AbstractType#getLang <em>Lang</em>}
 * </ul>
 *
...
public interface AbstractType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.AbstractType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Lang</b></em>' attribute. The default value is <code>"en"
   * </code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.AbstractType#getLang <em>Lang</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.AbstractType#getLang <em>Lang</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
