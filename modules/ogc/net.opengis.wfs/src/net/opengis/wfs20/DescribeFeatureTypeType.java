 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.DescribeFeatureTypeType#getTypeName <em>Type Name</em>}
 *   <li>{@link net.opengis.wfs20.DescribeFeatureTypeType#getOutputFormat <em>Output Format</em>}
 * </ul>
 *
...
public interface DescribeFeatureTypeType extends BaseRequestType {
   ...
   * type {@link javax.xml.namespace.QName}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Type Name</em>' attribute list isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.DescribeFeatureTypeType#getOutputFormat
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.DescribeFeatureTypeType#getOutputFormat
   * <em>Output Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wfs20.DescribeFeatureTypeType#getOutputFormat <em>Output Format</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
