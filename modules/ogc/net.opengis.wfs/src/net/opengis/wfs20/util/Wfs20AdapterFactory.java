...
public class Wfs20AdapterFactory extends AdapterFactoryImpl {
  ...
  protected Wfs20Switch<Adapter> modelSwitch =
      new Wfs20Switch<Adapter>() {
        ...
        @Override
        public Adapter caseAbstractAdhocQueryExpressionType(
            AbstractAdhocQueryExpressionType object) {
   ...
   * net.opengis.wfs20.AbstractTransactionActionType <em>Abstract Transaction Action Type</em>} '.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.AbstractType
   * <em>Abstract Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ActionResultsType
   * <em>Action Results Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.AdditionalObjectsType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.AdditionalValuesType
   * <em>Additional Values Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.BaseRequestType <em>Base
   * Request Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.CreatedOrModifiedFeatureType <em>Created Or Modified Feature Type</em>} '.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.CreateStoredQueryResponseType <em>Create Stored Query Response Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.CreateStoredQueryType
   * <em>Create Stored Query Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.DeleteType <em>Delete
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.DescribeFeatureTypeType
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.DescribeStoredQueriesResponseType <em>Describe Stored Queries Response
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.DescribeStoredQueriesType <em>Describe Stored Queries Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.DocumentRoot
   * <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.DropStoredQueryType
   * <em>Drop Stored Query Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ElementType <em>Element
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.EmptyType <em>Empty
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.EnvelopePropertyType
   * <em>Envelope Property Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ExecutionStatusType
   * <em>Execution Status Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ExtendedDescriptionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.FeatureCollectionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.FeaturesLockedType
   * <em>Features Locked Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.FeaturesNotLockedType
   * <em>Features Not Locked Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.FeatureTypeListType
   * <em>Feature Type List Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.FeatureTypeType
   * <em>Feature Type Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.GetCapabilitiesType
   * <em>Get Capabilities Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.GetFeatureType <em>Get
   * Feature Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.GetFeatureWithLockType
   * <em>Get Feature With Lock Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.GetPropertyValueType
   * <em>Get Property Value Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.InsertType <em>Insert
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.ListStoredQueriesResponseType <em>List Stored Queries Response Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ListStoredQueriesType
   * <em>List Stored Queries Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.LockFeatureResponseType
   * <em>Lock Feature Response Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.LockFeatureType <em>Lock
   * Feature Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.MemberPropertyType
   * <em>Member Property Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.MetadataURLType
   * <em>Metadata URL Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.NativeType <em>Native
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.NoCRSType <em>No CRS
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.OutputFormatListType
   * <em>Output Format List Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ParameterExpressionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ParameterType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.PropertyNameType
   * <em>Property Name Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.PropertyType
   * <em>Property Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.QueryExpressionTextType
   * <em>Query Expression Text Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.QueryType <em>Query
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ReplaceType <em>Replace
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.SimpleFeatureCollectionType <em>Simple Feature Collection Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType <em>Stored Query Description Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.StoredQueryListItemType
   * <em>Stored Query List Item Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.StoredQueryType
   * <em>Stored Query Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TitleType <em>Title
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TransactionResponseType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TransactionSummaryType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TransactionType
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TruncatedResponseType
   * <em>Truncated Response Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.TupleType <em>Tuple
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.UpdateType <em>Update
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ValueCollectionType
   * <em>Value Collection Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ValueListType <em>Value
   * List Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.ValueReferenceType
   * <em>Value Reference Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.WFSCapabilitiesType
   * <em>WFS Capabilities Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.wfs20.WSDLType <em>WSDL
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.ows11.GetCapabilitiesType
   * <em>Get Capabilities Type</em>}'.
   * <!--
   * begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.fes20.AbstractQueryExpressionType <em>Abstract Query Expression Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link
   * net.opengis.fes20.AbstractAdhocQueryExpressionType <em>Abstract Adhoc Query Expression
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link net.opengis.ows11.CapabilitiesBaseType
