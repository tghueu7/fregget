 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.TransactionSummaryType#getTotalInserted <em>Total Inserted</em>}
 *   <li>{@link net.opengis.wfs20.TransactionSummaryType#getTotalUpdated <em>Total Updated</em>}
 *   <li>{@link net.opengis.wfs20.TransactionSummaryType#getTotalReplaced <em>Total Replaced</em>}
 *   <li>{@link net.opengis.wfs20.TransactionSummaryType#getTotalDeleted <em>Total Deleted</em>}
 * </ul>
 *
...
public interface TransactionSummaryType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionSummaryType#getTotalInserted
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionSummaryType#getTotalUpdated
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Total Replaced</em>' attribute isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionSummaryType#getTotalReplaced
   * <em>Total Replaced</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionSummaryType#getTotalDeleted
