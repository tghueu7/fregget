 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.DescribeStoredQueriesType#getStoredQueryId <em>Stored Query
 *       Id</em>}
 * </ul>
 *
...
public interface DescribeStoredQueriesType extends BaseRequestType {
  /**
   * Returns the value of the '<em><b>Stored Query Id</b></em>' attribute list. The list contents
   * are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Stored Query Id</em>' attribute list isn't clear, there really
