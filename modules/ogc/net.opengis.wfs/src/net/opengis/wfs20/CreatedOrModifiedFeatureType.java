 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.CreatedOrModifiedFeatureType#getResourceId <em>Resource Id</em>}
 *   <li>{@link net.opengis.wfs20.CreatedOrModifiedFeatureType#getHandle <em>Handle</em>}
 * </ul>
 *
...
public interface CreatedOrModifiedFeatureType extends EObject {
  /**
   * Returns the value of the '<em><b>Resource Id</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.fes20.ResourceIdType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Resource Id</em>' containment reference list isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.CreatedOrModifiedFeatureType#getHandle
