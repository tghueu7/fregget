 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.InsertType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.wfs20.InsertType#getInputFormat <em>Input Format</em>}
 *   <li>{@link net.opengis.wfs20.InsertType#getSrsName <em>Srs Name</em>}
 * </ul>
 *
...
public interface InsertType extends AbstractTransactionActionType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.InsertType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.InsertType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.InsertType#getInputFormat <em>Input
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.InsertType#getSrsName <em>Srs Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
