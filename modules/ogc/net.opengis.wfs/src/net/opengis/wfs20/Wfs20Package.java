 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This XML Schema Document includes and imports, directly or indirectly, all the XML Schemas
 * defined by the Web Feature Service (WFS) Implementation Specification.
 *
 * <p>WFS is an OGC Standard. Copyright (c) 2010 Open Geospatial Consortium. All Rights Reserved. To
 ...
 * </div> </div>
 *
 * <p>This XML Schema document includes and imports, directly or indirectly, all the XML Schema
 * defined by the Filter Encoding Standard.
 *
 * <p>Filter Encoding is an OGC Standard. Copyright (c) 2010 Open Geospatial Consortium, Inc. All
 * Rights Reserved. To obtain additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
 * <p>Filter Encoding is an OGC Standard. Copyright (c) 2010 Open Geospatial Consortium, Inc. All
 * Rights Reserved. To obtain additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
 ...
 * Rights Reserved. To obtain additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
 * <p>This XML Schema defines OGC query filter capabilities documents.
 *
 * <p>Filter Encoding is an OGC Standard. Copyright (c) 2010 Open Geospatial Consortium, Inc. All
 * Rights Reserved. To obtain additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
 * <p>This XML Schema Document includes and imports, directly and indirectly, all the XML Schemas
 * defined by the OWS Common Implemetation Specification.
 *
 * <p>OWS is an OGC Standard. Copyright (c) 2006,2010 Open Geospatial Consortium, Inc. All Rights
 ...
 * Reserved. To obtain additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
 * <p>GML 3.0 candidate xlinks schema. Copyright (c) 2001 OGC, All Rights Reserved.
 *
 ...
 * @model kind="package" annotation="urn:opengis:specification:gml:schema-xlinks:v3.0c2
...
public interface Wfs20Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.AbstractTransactionActionTypeImpl
   * <em>Abstract Transaction Action Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.AbstractTypeImpl <em>Abstract
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ActionResultsTypeImpl <em>Action
   * Results Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.AdditionalObjectsTypeImpl
   * <em>Additional Objects Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.AdditionalValuesTypeImpl
   * <em>Additional Values Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.BaseRequestTypeImpl <em>Base Request
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.CreatedOrModifiedFeatureTypeImpl
   * <em>Created Or Modified Feature Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ExecutionStatusTypeImpl <em>Execution
   * Status Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.CreateStoredQueryResponseTypeImpl
   * <em>Create Stored Query Response Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.CreateStoredQueryTypeImpl <em>Create
   * Stored Query Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DeleteTypeImpl <em>Delete Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DescribeFeatureTypeTypeImpl
   * <em>Describe Feature Type Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DescribeStoredQueriesResponseTypeImpl
   * <em>Describe Stored Queries Response Type</em>} ' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The number of structural features of the '<em>Describe Stored Queries Response Type</em>'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DescribeStoredQueriesTypeImpl
   * <em>Describe Stored Queries Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DocumentRootImpl <em>Document
   * Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The feature id for the '<em><b>Describe Stored Queries Response</b></em>' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.DropStoredQueryTypeImpl <em>Drop
   * Stored Query Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ElementTypeImpl <em>Element
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.EmptyTypeImpl <em>Empty Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.EnvelopePropertyTypeImpl <em>Envelope
   * Property Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ExtendedDescriptionTypeImpl
   * <em>Extended Description Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.SimpleFeatureCollectionTypeImpl
   * <em>Simple Feature Collection Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl <em>Feature
   * Collection Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS =
      SIMPLE_FEATURE_COLLECTION_TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE =
      SIMPLE_FEATURE_COLLECTION_TYPE_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.FeaturesLockedTypeImpl <em>Features
   * Locked Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.FeaturesNotLockedTypeImpl
   * <em>Features Not Locked Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.FeatureTypeListTypeImpl <em>Feature
   * Type List Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl <em>Feature Type
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.GetCapabilitiesTypeImpl <em>Get
   ...
   * @ordered
   */
  int GET_CAPABILITIES_TYPE__EXTENDED_PROPERTIES =
      Ows11Package.GET_CAPABILITIES_TYPE__EXTENDED_PROPERTIES;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.GetFeatureTypeImpl <em>Get Feature
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.GetFeatureWithLockTypeImpl <em>Get
   * Feature With Lock Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int GET_FEATURE_WITH_LOCK_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP =
      GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP;
   ...
   * @ordered
   */
  int GET_FEATURE_WITH_LOCK_TYPE__ABSTRACT_QUERY_EXPRESSION =
      GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl <em>Get
   * Property Value Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.InsertTypeImpl <em>Insert Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ListStoredQueriesResponseTypeImpl
   * <em>List Stored Queries Response Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ListStoredQueriesTypeImpl <em>List
   * Stored Queries Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.LockFeatureResponseTypeImpl <em>Lock
   * Feature Response Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.LockFeatureTypeImpl <em>Lock Feature
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.MemberPropertyTypeImpl <em>Member
   * Property Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.MetadataURLTypeImpl <em>Metadata URL
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.NativeTypeImpl <em>Native Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.NoCRSTypeImpl <em>No CRS Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.OutputFormatListTypeImpl <em>Output
   * Format List Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl
   * <em>Parameter Expression Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ParameterTypeImpl <em>Parameter
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.PropertyNameTypeImpl <em>Property
   * Name Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.PropertyTypeImpl <em>Property
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl <em>Query
   * Expression Text Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.QueryTypeImpl <em>Query Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
   ...
   * @ordered
   */
  int QUERY_TYPE__ABSTRACT_PROJECTION_CLAUSE =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ABSTRACT_PROJECTION_CLAUSE;
   ...
   * @ordered
   */
  int QUERY_TYPE__ABSTRACT_SELECTION_CLAUSE =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ABSTRACT_SELECTION_CLAUSE;
   ...
   * @ordered
   */
  int QUERY_TYPE__ABSTRACT_SORTING_CLAUSE =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ABSTRACT_SORTING_CLAUSE;
   ...
   * @ordered
   */
  int QUERY_TYPE__FEATURE_VERSION =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int QUERY_TYPE__PROPERTY_NAMES =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int QUERY_TYPE_FEATURE_COUNT =
      Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE_FEATURE_COUNT + 5;

  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ReplaceTypeImpl <em>Replace
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl
   * <em>Stored Query Description Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.StoredQueryListItemTypeImpl
   * <em>Stored Query List Item Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.StoredQueryTypeImpl <em>Stored Query
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   ...
   * @ordered
   */
  int STORED_QUERY_TYPE_FEATURE_COUNT =
      Fes20Package.ABSTRACT_QUERY_EXPRESSION_TYPE_FEATURE_COUNT + 2;

  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TitleTypeImpl <em>Title Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl
   * <em>Transaction Response Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl
   * <em>Transaction Summary Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TransactionTypeImpl <em>Transaction
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TruncatedResponseTypeImpl
   * <em>Truncated Response Type</em>}' class.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.TupleTypeImpl <em>Tuple Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.UpdateTypeImpl <em>Update Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl <em>Value
   * Collection Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ValueListTypeImpl <em>Value List
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.ValueReferenceTypeImpl <em>Value
   * Reference Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.WFSCapabilitiesTypeImpl <em>WFS
   * Capabilities Type</em>}' class.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  int WFS_CAPABILITIES_TYPE__SERVICE_IDENTIFICATION =
      Ows11Package.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION;
   ...
   * @ordered
   */
  int WFS_CAPABILITIES_TYPE__SERVICE_PROVIDER =
   ...
   * @ordered
   */
  int WFS_CAPABILITIES_TYPE__OPERATIONS_METADATA =
      Ows11Package.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA;
   ...
   * @ordered
   */
  int WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST =
      Ows11Package.CAPABILITIES_BASE_TYPE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES =
      Ows11Package.CAPABILITIES_BASE_TYPE_FEATURE_COUNT + 2;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.impl.WSDLTypeImpl <em>WSDL Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0 <em>Non
   * Negative Integer Or Unknown Member0</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.ResolveValueType <em>Resolve Value
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.ResultTypeType <em>Result Type Type</em>}'
   * enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.StarStringType <em>Star String Type</em>}'
   * enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.StateValueTypeMember0 <em>State Value Type
   * Member0</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wfs20.UpdateActionType <em>Update Action
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.AbstractTransactionActionType
   * <em>Abstract Transaction Action Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wfs20.AbstractTransactionActionType#getHandle <em>Handle</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.AbstractType <em>Abstract
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.AbstractType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.AbstractType#getLang
   * <em>Lang</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ActionResultsType <em>Action
   * Results Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   ...
   * net.opengis.wfs20.ActionResultsType#getFeature <em>Feature</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.AdditionalObjectsType
   * <em>Additional Objects Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wfs20.AdditionalObjectsType#getValueCollection <em>Value Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wfs20.AdditionalObjectsType#getSimpleFeatureCollectionGroup <em>Simple Feature
   * Collection Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.AdditionalValuesType <em>Additional
   * Values Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.AdditionalValuesType#getValueCollection <em>Value Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Value Collection</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.AdditionalValuesType#getSimpleFeatureCollectionGroup <em>Simple Feature
   * Collection Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.AdditionalValuesType#getSimpleFeatureCollection <em>Simple Feature
   * Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.BaseRequestType <em>Base Request
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.BaseRequestType#getHandle
   * <em>Handle</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.BaseRequestType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.BaseRequestType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.BaseRequestType#getBaseUrl
   * <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.BaseRequestType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.CreatedOrModifiedFeatureType
   * <em>Created Or Modified Feature Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.CreatedOrModifiedFeatureType#getResourceId <em>Resource Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.CreatedOrModifiedFeatureType#getHandle <em>Handle</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.CreateStoredQueryResponseType
   * <em>Create Stored Query Response Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.CreateStoredQueryType <em>Create
   * Stored Query Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.CreateStoredQueryType#getStoredQueryDefinition <em>Stored Query
   * Definition</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.DeleteType#getFilter
   * <em>Filter</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.DeleteType#getTypeName
   * <em>Type Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.DescribeFeatureTypeType
   * <em>Describe Feature Type Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.DescribeFeatureTypeType#getTypeName <em>Type Name</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.DescribeFeatureTypeType#getOutputFormat <em>Output Format</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.DescribeStoredQueriesResponseType
   * <em>Describe Stored Queries Response Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list ' {@link
   * net.opengis.wfs20.DescribeStoredQueriesResponseType#getStoredQueryDescription <em>Stored Query
   * Description</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.DescribeStoredQueriesType
   * <em>Describe Stored Queries Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.DescribeStoredQueriesType#getStoredQueryId <em>Stored Query Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.DocumentRoot#getMixed
   * <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wfs20.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wfs20.DocumentRoot#getXSISchemaLocation
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getAbstract <em>Abstract</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getAbstractTransactionAction <em>Abstract Transaction
   * Action</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getAdditionalObjects <em>Additional Objects</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getAdditionalValues <em>Additional Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getBoundedBy <em>Bounded By</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getCreateStoredQuery <em>Create Stored Query</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getCreateStoredQueryResponse <em>Create Stored Query
   * Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDelete <em>Delete</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDescribeFeatureType <em>Describe Feature Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDescribeStoredQueries <em>Describe Stored Queries</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDescribeStoredQueriesResponse <em>Describe Stored Queries
   * Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Describe Stored Queries
   *     Response</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDropStoredQuery <em>Drop Stored Query</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getDropStoredQueryResponse <em>Drop Stored Query
   * Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getElement <em>Element</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getFeatureCollection <em>Feature Collection</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getSimpleFeatureCollection <em>Simple Feature Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Simple Feature Collection</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getFeatureTypeList <em>Feature Type List</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getGetFeature <em>Get Feature</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getGetFeatureWithLock <em>Get Feature With Lock</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getGetPropertyValue <em>Get Property Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getInsert <em>Insert</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getListStoredQueries <em>List Stored Queries</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getListStoredQueriesResponse <em>List Stored Queries
   * Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getLockFeature <em>Lock Feature</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getLockFeatureResponse <em>Lock Feature Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getMember <em>Member</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getNative <em>Native</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getProperty <em>Property</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getPropertyName <em>Property Name</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getQuery <em>Query</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getReplace <em>Replace</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getStoredQuery <em>Stored Query</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getTitle <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getTransaction <em>Transaction</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getTransactionResponse <em>Transaction Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getTruncatedResponse <em>Truncated Response</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getTuple <em>Tuple</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getUpdate <em>Update</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getValueCollection <em>Value Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Value Collection</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getValueList <em>Value List</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.DocumentRoot#getWFSCapabilities <em>WFS Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.DropStoredQueryType <em>Drop Stored
   * Query Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.DropStoredQueryType#getId
   * <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ElementType <em>Element
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.ElementType#getMetadata <em>Metadata</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.ElementType#getValueList <em>Value List</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ElementType#getName
   * <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ElementType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.EnvelopePropertyType <em>Envelope
   * Property Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.EnvelopePropertyType#getAny <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ExecutionStatusType <em>Execution
   * Status Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ExecutionStatusType#getStatus <em>Status</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ExtendedDescriptionType
   * <em>Extended Description Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ExtendedDescriptionType#getElement <em>Element</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.FeatureCollectionType <em>Feature
   * Collection Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.FeatureCollectionType#getAdditionalObjects <em>Additional Objects</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Additional Objects</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.FeatureCollectionType#getTruncatedResponse <em>Truncated Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Truncated Response</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getLockId <em>Lock Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getNext <em>Next</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getNumberMatched <em>Number Matched</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getNumberReturned <em>Number Returned</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getPrevious <em>Previous</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureCollectionType#getTimeStamp <em>Time Stamp</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.FeaturesLockedType <em>Features
   * Locked Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.FeaturesLockedType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.FeaturesLockedType#getResourceId <em>Resource Id</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.FeaturesNotLockedType <em>Features
   * Not Locked Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.FeaturesNotLockedType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.FeaturesNotLockedType#getResourceId <em>Resource Id</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.FeatureTypeListType <em>Feature
   * Type List Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeListType#getFeatureType <em>Feature Type</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.FeatureTypeType <em>Feature Type
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.FeatureTypeType#getName
   * <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeType#getTitle <em>Title</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeType#getAbstract <em>Abstract</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeType#getKeywords <em>Keywords</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.FeatureTypeType#getDefaultCRS <em>Default CRS</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.FeatureTypeType#getOtherCRS
   * <em>Other CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.FeatureTypeType#getNoCRS <em>No CRS</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.FeatureTypeType#getOutputFormats <em>Output Formats</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeType#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.FeatureTypeType#getMetadataURL <em>Metadata URL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.FeatureTypeType#getExtendedDescription <em>Extended Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.GetCapabilitiesType <em>Get
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Service</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.GetFeatureType <em>Get Feature
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.GetFeatureType#getCount
   * <em>Count</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getOutputFormat <em>Output Format</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.GetFeatureType#getResolve
   * <em>Resolve</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getResultType <em>Result Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getStartIndex <em>Start Index</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.GetFeatureType#getMetadata
   * <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureType#getFormatOptions <em>Format Options</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.GetFeatureType#getViewParams <em>View Params</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.GetFeatureType#getAbstractQueryExpressionGroup <em>Abstract Query Expression
   * Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.GetFeatureType#getAbstractQueryExpression <em>Abstract Query
   * Expression</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Abstract Query
   *     Expression</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.GetFeatureWithLockType <em>Get
   * Feature With Lock Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureWithLockType#getExpiry <em>Expiry</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetFeatureWithLockType#getLockAction <em>Lock Action</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.GetPropertyValueType <em>Get
   * Property Value Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wfs20.GetPropertyValueType#getAbstractQueryExpression <em>Abstract Query
   * Expression</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getCount <em>Count</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Count</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getOutputFormat <em>Output Format</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getResolve <em>Resolve</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Resolve</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getResolveDepth <em>Resolve Depth</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getResolvePath <em>Resolve Path</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getResolveTimeout <em>Resolve Timeout</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getResultType <em>Result Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getStartIndex <em>Start Index</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.GetPropertyValueType#getValueReference <em>Value Reference</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.InsertType#getAny
   * <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.InsertType#getInputFormat
   * <em>Input Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.InsertType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ListStoredQueriesResponseType
   * <em>List Stored Queries Response Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ListStoredQueriesResponseType#getStoredQuery <em>Stored Query</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ListStoredQueriesType <em>List
   * Stored Queries Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.LockFeatureResponseType <em>Lock
   * Feature Response Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.LockFeatureResponseType#getFeaturesLocked <em>Features Locked</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.LockFeatureResponseType#getFeaturesNotLocked <em>Features Not Locked</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.LockFeatureResponseType#getLockId <em>Lock Id</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.LockFeatureType <em>Lock Feature
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.LockFeatureType#getAbstractQueryExpressionGroup <em>Abstract Query Expression
   * Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.LockFeatureType#getAbstractQueryExpression <em>Abstract Query
   * Expression</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.LockFeatureType#getExpiry
   * <em>Expiry</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.LockFeatureType#getLockAction <em>Lock Action</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.LockFeatureType#getLockId
   * <em>Lock Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.MemberPropertyType <em>Member
   * Property Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.MemberPropertyType#getMixed <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute list '<em>Mixed</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.MemberPropertyType#getAny <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.MemberPropertyType#getTuple <em>Tuple</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.MemberPropertyType#getSimpleFeatureCollectionGroup <em>Simple Feature
   * Collection Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.MemberPropertyType#getSimpleFeatureCollection <em>Simple Feature
   * Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.MemberPropertyType#getActuate <em>Actuate</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.MemberPropertyType#getArcrole <em>Arcrole</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getRole
   * <em>Role</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getShow
   * <em>Show</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getState
   * <em>State</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getTitle
   * <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MemberPropertyType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.MetadataURLType <em>Metadata URL
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getAbout
   * <em>About</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getActuate
   * <em>Actuate</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getArcrole
   * <em>Arcrole</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getRole
   * <em>Role</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getShow
   * <em>Show</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getTitle
   * <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.MetadataURLType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.NativeType#getMixed
   * <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.NativeType#getAny
   * <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.NativeType#isSafeToIgnore
   * <em>Safe To Ignore</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.NativeType#getVendorId
   * <em>Vendor Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.OutputFormatListType <em>Output
   * Format List Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.OutputFormatListType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.OutputFormatListType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ParameterExpressionType
   * <em>Parameter Expression Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ParameterExpressionType#getTitle <em>Title</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ParameterExpressionType#getAbstract <em>Abstract</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Abstract</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ParameterExpressionType#getMetadata <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ParameterExpressionType#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Name</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ParameterExpressionType#getType <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Type</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ParameterType <em>Parameter
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ParameterType#getName
   * <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ParameterType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.PropertyNameType <em>Property Name
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.PropertyNameType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.PropertyNameType#getResolve
   * <em>Resolve</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.PropertyNameType#getResolveDepth <em>Resolve Depth</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.PropertyNameType#getResolvePath <em>Resolve Path</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.PropertyNameType#getResolveTimeout <em>Resolve Timeout</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.PropertyType <em>Property
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the reference '{@link
   * net.opengis.wfs20.PropertyType#getValueReference <em>Value Reference</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.PropertyType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.QueryExpressionTextType <em>Query
   * Expression Text Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.QueryExpressionTextType#isIsPrivate <em>Is Private</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.QueryExpressionTextType#getLanguage <em>Language</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.QueryExpressionTextType#getReturnFeatureTypes <em>Return Feature
   * Types</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.QueryExpressionTextType#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Value</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.QueryType#getFeatureVersion
   * <em>Feature Version</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.QueryType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.QueryType#getFilter
   * <em>Filter</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.QueryType#getPropertyNames <em>Property Names</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.QueryType#getSortBy
   * <em>Sort By</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ReplaceType <em>Replace
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.ReplaceType#getAny
   * <em>Any</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ReplaceType#getFilter
   * <em>Filter</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ReplaceType#getInputFormat
   * <em>Input Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ReplaceType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.SimpleFeatureCollectionType
   * <em>Simple Feature Collection Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.SimpleFeatureCollectionType#getBoundedBy <em>Bounded By</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Bounded By</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.SimpleFeatureCollectionType#getMember <em>Member</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.StoredQueryDescriptionType
   * <em>Stored Query Description Type</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getTitle <em>Title</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getAbstract <em>Abstract</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Abstract</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getMetadata <em>Metadata</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Metadata</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getParameter <em>Parameter</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getQueryExpressionText <em>Query Expression
   * Text</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.StoredQueryDescriptionType#getId <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Id</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.StoredQueryListItemType <em>Stored
   * Query List Item Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryListItemType#getTitle <em>Title</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.StoredQueryListItemType#getReturnFeatureType <em>Return Feature Type</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.StoredQueryListItemType#getId <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.StoredQueryType <em>Stored Query
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.StoredQueryType#getParameter <em>Parameter</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.StoredQueryType#getId
   * <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.TitleType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.TitleType#getLang
   * <em>Lang</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.TransactionResponseType
   * <em>Transaction Response Type</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.TransactionResponseType#getTransactionSummary <em>Transaction Summary</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.TransactionResponseType#getInsertResults <em>Insert Results</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.TransactionResponseType#getUpdateResults <em>Update Results</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.TransactionResponseType#getReplaceResults <em>Replace Results</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionResponseType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.TransactionSummaryType
   * <em>Transaction Summary Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionSummaryType#getTotalInserted <em>Total Inserted</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionSummaryType#getTotalUpdated <em>Total Updated</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionSummaryType#getTotalReplaced <em>Total Replaced</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionSummaryType#getTotalDeleted <em>Total Deleted</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.TransactionType <em>Transaction
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.TransactionType#getGroup <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute list '<em>Group</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.TransactionType#getAbstractTransactionActionGroup <em>Abstract Transaction
   * Action Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.TransactionType#getAbstractTransactionAction <em>Abstract Transaction
   * Action</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Abstract Transaction
   *     Action</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.TransactionType#getLockId
   * <em>Lock Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.TransactionType#getReleaseAction <em>Release Action</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.TransactionType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.TruncatedResponseType <em>Truncated
   * Response Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.TruncatedResponseType#getExceptionReport <em>Exception Report</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.TupleType#getMember <em>Member</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.UpdateType#getProperty <em>Property</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.UpdateType#getFilter
   * <em>Filter</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.UpdateType#getInputFormat
   * <em>Input Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.UpdateType#getSrsName
   * <em>Srs Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.UpdateType#getTypeName
   * <em>Type Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ValueCollectionType <em>Value
   * Collection Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wfs20.ValueCollectionType#getMember <em>Member</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.ValueCollectionType#getAdditionalValues <em>Additional Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Additional Values</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.ValueCollectionType#getTruncatedResponse <em>Truncated Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Truncated Response</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ValueCollectionType#getNext
   * <em>Next</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ValueCollectionType#getNumberMatched <em>Number Matched</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ValueCollectionType#getNumberReturned <em>Number Returned</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ValueCollectionType#getPrevious <em>Previous</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ValueCollectionType#getTimeStamp <em>Time Stamp</em>}'.
   * <!-- begin-user-doc
   * -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ValueListType <em>Value List
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wfs20.ValueListType#getGroup
   * <em>Group</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wfs20.ValueListType#getValue <em>Value</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.ValueReferenceType <em>Value
   * Reference Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.ValueReferenceType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wfs20.ValueReferenceType#getAction <em>Action</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wfs20.WFSCapabilitiesType <em>WFS
   * Capabilities Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.WFSCapabilitiesType#getWSDL <em>WSDL</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.WFSCapabilitiesType#getFeatureTypeList <em>Feature Type List</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Feature Type List</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wfs20.WFSCapabilitiesType#getFilterCapabilities <em>Filter Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getActuate
   * <em>Actuate</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getArcrole
   * <em>Arcrole</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getRole
   * <em>Role</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getShow
   * <em>Show</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getTitle
   * <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wfs20.WSDLType#getType
   * <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.AllSomeType <em>All Some
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0
   * <em>Non Negative Integer Or Unknown Member0</em>} '.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.ResolveValueType <em>Resolve Value
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.ResultTypeType <em>Result Type
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.StarStringType <em>Star String
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.StateValueTypeMember0 <em>State
   * Value Type Member0</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wfs20.UpdateActionType <em>Update Action
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.AllSomeType <em>All Some Type
   * Object</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Non Negative Integer Or
   * Unknown</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData= "name='nonNegativeIntegerOrUnknown'
   *     memberTypes='nonNegativeIntegerOrUnknown_._member_._0
   *     nonNegativeIntegerOrUnknown_._member_._1'"
   * @generated
   */
   ...
   * net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0 <em>Non Negative Integer Or Unknown
   * Member0 Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for data type '<em>Non Negative Integer Or Unknown Member0
   *     Object</em>'.
   * @see net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0
   * @model instanceClass="net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0"
   *     extendedMetaData="name='nonNegativeIntegerOrUnknown_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.math.BigInteger <em>Non Negative Integer Or
   * Unknown Member1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   *     extendedMetaData="name='nonNegativeIntegerOrUnknown_._member_._1'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.Object <em>Positive Integer With
   * Star</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData="name='positiveIntegerWithStar'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.ResolveValueType <em>Resolve
   * Value Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.ResultTypeType <em>Result Type
   * Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for data type '{@link java.util.List <em>Return Feature Types List
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   ...
   * @see java.util.List
   * @model instanceClass="java.util.List" extendedMetaData="name='ReturnFeatureTypesListType'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.StarStringType <em>Star String
   * Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
   ...
   * @see java.lang.Object
   * @model instanceClass="java.lang.Object" extendedMetaData="name='StateValueType'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.StateValueTypeMember0 <em>State
   * Value Type Member0 Object</em>}'.
   * <!--
   * begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   *     extendedMetaData="name='StateValueType_._member_._0:Object'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>State Value Type
   * Member1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='StateValueType_._member_._1'
   *     baseType='http://www.eclipse.org/emf/2003/XMLType#string' pattern='other:\\w{2,}'"
   * @generated
   */
  EDataType getStateValueTypeMember1();

  /**
   * Returns the meta object for data type '{@link net.opengis.wfs20.UpdateActionType <em>Update
   * Action Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link org.geotools.feature.FeatureCollection
   * <em>Feature Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link org.opengis.filter.expression.PropertyName
   * <em>Property Name</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * Returns the meta object for data type '{@link org.opengis.filter.identity.FeatureId <em>Feature
   * Id</em>}'.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  interface Literals {
     ...
     * net.opengis.wfs20.impl.AbstractTransactionActionTypeImpl <em>Abstract Transaction Action
     * Type</em>} ' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute ABSTRACT_TRANSACTION_ACTION_TYPE__HANDLE =
        eINSTANCE.getAbstractTransactionActionType_Handle();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.AbstractTypeImpl <em>Abstract
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ActionResultsTypeImpl
     * <em>Action Results Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.AdditionalObjectsTypeImpl
     * <em>Additional Objects Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Value Collection</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference ADDITIONAL_OBJECTS_TYPE__VALUE_COLLECTION =
        eINSTANCE.getAdditionalObjectsType_ValueCollection();

    /**
     * The meta object literal for the '<em><b>Simple Feature Collection Group</b></em>' attribute
     * list feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EAttribute ADDITIONAL_OBJECTS_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP =
        eINSTANCE.getAdditionalObjectsType_SimpleFeatureCollectionGroup();

    /**
     * The meta object literal for the '<em><b>Simple Feature Collection</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference ADDITIONAL_OBJECTS_TYPE__SIMPLE_FEATURE_COLLECTION =
        eINSTANCE.getAdditionalObjectsType_SimpleFeatureCollection();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.AdditionalValuesTypeImpl
     * <em>Additional Values Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    EReference ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION =
        eINSTANCE.getAdditionalValuesType_ValueCollection();
     ...
     * @generated
     */
    EAttribute ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP =
        eINSTANCE.getAdditionalValuesType_SimpleFeatureCollectionGroup();
     ...
     * @generated
     */
    EReference ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION =
        eINSTANCE.getAdditionalValuesType_SimpleFeatureCollection();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.BaseRequestTypeImpl <em>Base
     * Request Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute BASE_REQUEST_TYPE__EXTENDED_PROPERTIES =
        eINSTANCE.getBaseRequestType_ExtendedProperties();

    /**
     * The meta object literal for the '{@link
     * net.opengis.wfs20.impl.CreatedOrModifiedFeatureTypeImpl <em>Created Or Modified Feature
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute CREATED_OR_MODIFIED_FEATURE_TYPE__RESOURCE_ID =
        eINSTANCE.getCreatedOrModifiedFeatureType_ResourceId();
     ...
     * @generated
     */
    EAttribute CREATED_OR_MODIFIED_FEATURE_TYPE__HANDLE =
        eINSTANCE.getCreatedOrModifiedFeatureType_Handle();

    /**
     * The meta object literal for the '{@link
     * net.opengis.wfs20.impl.CreateStoredQueryResponseTypeImpl <em>Create Stored Query Response
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.CreateStoredQueryTypeImpl
     * <em>Create Stored Query Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Stored Query Definition</b></em>' containment
     ...
     * @generated
     */
    EReference CREATE_STORED_QUERY_TYPE__STORED_QUERY_DEFINITION =
        eINSTANCE.getCreateStoredQueryType_StoredQueryDefinition();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.DeleteTypeImpl <em>Delete
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.DescribeFeatureTypeTypeImpl
     * <em>Describe Feature Type Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute DESCRIBE_FEATURE_TYPE_TYPE__TYPE_NAME =
        eINSTANCE.getDescribeFeatureTypeType_TypeName();
     ...
     * @generated
     */
    EAttribute DESCRIBE_FEATURE_TYPE_TYPE__OUTPUT_FORMAT =
        eINSTANCE.getDescribeFeatureTypeType_OutputFormat();

    /**
     * The meta object literal for the '{@link
     * net.opengis.wfs20.impl.DescribeStoredQueriesResponseTypeImpl <em>Describe Stored Queries
     * Response Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wfs20.impl.DescribeStoredQueriesResponseTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Stored Query Description</b></em>' containment
     * reference list feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DESCRIBE_STORED_QUERIES_RESPONSE_TYPE__STORED_QUERY_DESCRIPTION =
        eINSTANCE.getDescribeStoredQueriesResponseType_StoredQueryDescription();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.DescribeStoredQueriesTypeImpl
     * <em>Describe Stored Queries Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute DESCRIBE_STORED_QUERIES_TYPE__STORED_QUERY_ID =
        eINSTANCE.getDescribeStoredQueriesType_StoredQueryId();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.DocumentRootImpl <em>Document
     * Root</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Abstract Transaction Action</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__ABSTRACT_TRANSACTION_ACTION =
        eINSTANCE.getDocumentRoot_AbstractTransactionAction();

    /**
     * The meta object literal for the '<em><b>Additional Objects</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Additional Values</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Create Stored Query</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Create Stored Query Response</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__CREATE_STORED_QUERY_RESPONSE =
        eINSTANCE.getDocumentRoot_CreateStoredQueryResponse();
    ...
    /**
     * The meta object literal for the '<em><b>Describe Feature Type</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__DESCRIBE_FEATURE_TYPE =
        eINSTANCE.getDocumentRoot_DescribeFeatureType();

    /**
     * The meta object literal for the '<em><b>Describe Stored Queries</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__DESCRIBE_STORED_QUERIES =
        eINSTANCE.getDocumentRoot_DescribeStoredQueries();

    /**
     * The meta object literal for the '<em><b>Describe Stored Queries Response</b></em>'
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__DESCRIBE_STORED_QUERIES_RESPONSE =
        eINSTANCE.getDocumentRoot_DescribeStoredQueriesResponse();

    /**
     * The meta object literal for the '<em><b>Drop Stored Query</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Drop Stored Query Response</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__DROP_STORED_QUERY_RESPONSE =
        eINSTANCE.getDocumentRoot_DropStoredQueryResponse();
    ...
    /**
     * The meta object literal for the '<em><b>Feature Collection</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__SIMPLE_FEATURE_COLLECTION =
        eINSTANCE.getDocumentRoot_SimpleFeatureCollection();

    /**
     * The meta object literal for the '<em><b>Feature Type List</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Get Feature With Lock</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__GET_FEATURE_WITH_LOCK =
        eINSTANCE.getDocumentRoot_GetFeatureWithLock();

    /**
     * The meta object literal for the '<em><b>Get Property Value</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>List Stored Queries</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>List Stored Queries Response</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__LIST_STORED_QUERIES_RESPONSE =
        eINSTANCE.getDocumentRoot_ListStoredQueriesResponse();
    ...
    /**
     * The meta object literal for the '<em><b>Lock Feature Response</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__LOCK_FEATURE_RESPONSE =
    ...
    /**
     * The meta object literal for the '<em><b>Property Name</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
    ...
    /**
     * The meta object literal for the '<em><b>Transaction Response</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference DOCUMENT_ROOT__TRANSACTION_RESPONSE =
        eINSTANCE.getDocumentRoot_TransactionResponse();

    /**
     * The meta object literal for the '<em><b>Truncated Response</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>WFS Capabilities</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.DropStoredQueryTypeImpl
     * <em>Drop Stored Query Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ElementTypeImpl <em>Element
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.EmptyTypeImpl <em>Empty
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.EnvelopePropertyTypeImpl
     * <em>Envelope Property Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ExecutionStatusTypeImpl
     * <em>Execution Status Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ExtendedDescriptionTypeImpl
     * <em>Extended Description Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.FeatureCollectionTypeImpl
     * <em>Feature Collection Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS =
        eINSTANCE.getFeatureCollectionType_AdditionalObjects();
     ...
     * @generated
     */
    EReference FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE =
        eINSTANCE.getFeatureCollectionType_TruncatedResponse();
     ...
     * @generated
     */
    EAttribute FEATURE_COLLECTION_TYPE__NUMBER_MATCHED =
        eINSTANCE.getFeatureCollectionType_NumberMatched();
     ...
     * @generated
     */
    EAttribute FEATURE_COLLECTION_TYPE__NUMBER_RETURNED =
        eINSTANCE.getFeatureCollectionType_NumberReturned();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.FeaturesLockedTypeImpl
     * <em>Features Locked Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.FeaturesNotLockedTypeImpl
     * <em>Features Not Locked Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    EAttribute FEATURES_NOT_LOCKED_TYPE__RESOURCE_ID =
        eINSTANCE.getFeaturesNotLockedType_ResourceId();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.FeatureTypeListTypeImpl
     * <em>Feature Type List Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Feature Type</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference FEATURE_TYPE_LIST_TYPE__FEATURE_TYPE =
        eINSTANCE.getFeatureTypeListType_FeatureType();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.FeatureTypeTypeImpl
     * <em>Feature Type Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Abstract</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
    ...
    /**
     * The meta object literal for the '<em><b>Keywords</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
    ...
    /**
     * The meta object literal for the '<em><b>Output Formats</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference FEATURE_TYPE_TYPE__WGS84_BOUNDING_BOX =
        eINSTANCE.getFeatureTypeType_WGS84BoundingBox();

    /**
     * The meta object literal for the '<em><b>Metadata URL</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Extended Description</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION =
        eINSTANCE.getFeatureTypeType_ExtendedDescription();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.GetCapabilitiesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.GetFeatureTypeImpl <em>Get
     * Feature Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Abstract Query Expression Group</b></em>' attribute
     * list feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EAttribute GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP =
        eINSTANCE.getGetFeatureType_AbstractQueryExpressionGroup();

    /**
     * The meta object literal for the '<em><b>Abstract Query Expression</b></em>' containment
     * reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference GET_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION =
        eINSTANCE.getGetFeatureType_AbstractQueryExpression();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.GetFeatureWithLockTypeImpl
     * <em>Get Feature With Lock Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute GET_FEATURE_WITH_LOCK_TYPE__LOCK_ACTION =
        eINSTANCE.getGetFeatureWithLockType_LockAction();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.GetPropertyValueTypeImpl
     * <em>Get Property Value Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Abstract Query Expression</b></em>' reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION =
        eINSTANCE.getGetPropertyValueType_AbstractQueryExpression();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__OUTPUT_FORMAT =
        eINSTANCE.getGetPropertyValueType_OutputFormat();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH =
        eINSTANCE.getGetPropertyValueType_ResolveDepth();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__RESOLVE_PATH =
        eINSTANCE.getGetPropertyValueType_ResolvePath();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT =
        eINSTANCE.getGetPropertyValueType_ResolveTimeout();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__RESULT_TYPE =
        eINSTANCE.getGetPropertyValueType_ResultType();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__START_INDEX =
        eINSTANCE.getGetPropertyValueType_StartIndex();
     ...
     * @generated
     */
    EAttribute GET_PROPERTY_VALUE_TYPE__VALUE_REFERENCE =
        eINSTANCE.getGetPropertyValueType_ValueReference();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.InsertTypeImpl <em>Insert
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link
     * net.opengis.wfs20.impl.ListStoredQueriesResponseTypeImpl <em>List Stored Queries Response
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Stored Query</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference LIST_STORED_QUERIES_RESPONSE_TYPE__STORED_QUERY =
        eINSTANCE.getListStoredQueriesResponseType_StoredQuery();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ListStoredQueriesTypeImpl
     * <em>List Stored Queries Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.LockFeatureResponseTypeImpl
     * <em>Lock Feature Response Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wfs20.impl.LockFeatureResponseTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Features Locked</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference LOCK_FEATURE_RESPONSE_TYPE__FEATURES_LOCKED =
        eINSTANCE.getLockFeatureResponseType_FeaturesLocked();

    /**
     * The meta object literal for the '<em><b>Features Not Locked</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference LOCK_FEATURE_RESPONSE_TYPE__FEATURES_NOT_LOCKED =
        eINSTANCE.getLockFeatureResponseType_FeaturesNotLocked();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.LockFeatureTypeImpl <em>Lock
     * Feature Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    EAttribute LOCK_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP =
        eINSTANCE.getLockFeatureType_AbstractQueryExpressionGroup();
     ...
     * @generated
     */
    EReference LOCK_FEATURE_TYPE__ABSTRACT_QUERY_EXPRESSION =
        eINSTANCE.getLockFeatureType_AbstractQueryExpression();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.MemberPropertyTypeImpl
     * <em>Member Property Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute MEMBER_PROPERTY_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP =
        eINSTANCE.getMemberPropertyType_SimpleFeatureCollectionGroup();
     ...
     * @generated
     */
    EReference MEMBER_PROPERTY_TYPE__SIMPLE_FEATURE_COLLECTION =
        eINSTANCE.getMemberPropertyType_SimpleFeatureCollection();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.MetadataURLTypeImpl
     * <em>Metadata URL Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.NativeTypeImpl <em>Native
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.NoCRSTypeImpl <em>No CRS
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.OutputFormatListTypeImpl
     * <em>Output Format List Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ParameterExpressionTypeImpl
     * <em>Parameter Expression Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    EReference PARAMETER_EXPRESSION_TYPE__ABSTRACT =
        eINSTANCE.getParameterExpressionType_Abstract();
     ...
     * @generated
     */
    EReference PARAMETER_EXPRESSION_TYPE__METADATA =
        eINSTANCE.getParameterExpressionType_Metadata();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ParameterTypeImpl
     * <em>Parameter Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wfs20.impl.ParameterTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.PropertyNameTypeImpl
     * <em>Property Name Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.PropertyTypeImpl <em>Property
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.QueryExpressionTextTypeImpl
     * <em>Query Expression Text Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wfs20.impl.QueryExpressionTextTypeImpl
     ...
     * @generated
     */
    EAttribute QUERY_EXPRESSION_TEXT_TYPE__IS_PRIVATE =
        eINSTANCE.getQueryExpressionTextType_IsPrivate();
     ...
     * @generated
     */
    EAttribute QUERY_EXPRESSION_TEXT_TYPE__LANGUAGE =
        eINSTANCE.getQueryExpressionTextType_Language();
     ...
     * @generated
     */
    EAttribute QUERY_EXPRESSION_TEXT_TYPE__RETURN_FEATURE_TYPES =
        eINSTANCE.getQueryExpressionTextType_ReturnFeatureTypes();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.QueryTypeImpl <em>Query
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ReplaceTypeImpl <em>Replace
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link
     * net.opengis.wfs20.impl.SimpleFeatureCollectionTypeImpl <em>Simple Feature Collection
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference SIMPLE_FEATURE_COLLECTION_TYPE__BOUNDED_BY =
        eINSTANCE.getSimpleFeatureCollectionType_BoundedBy();
     ...
     * @generated
     */
    EAttribute SIMPLE_FEATURE_COLLECTION_TYPE__MEMBER =
        eINSTANCE.getSimpleFeatureCollectionType_Member();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.StoredQueryDescriptionTypeImpl
     * <em>Stored Query Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference STORED_QUERY_DESCRIPTION_TYPE__TITLE =
        eINSTANCE.getStoredQueryDescriptionType_Title();
     ...
     * @generated
     */
    EReference STORED_QUERY_DESCRIPTION_TYPE__ABSTRACT =
        eINSTANCE.getStoredQueryDescriptionType_Abstract();
     ...
     * @generated
     */
    EReference STORED_QUERY_DESCRIPTION_TYPE__METADATA =
        eINSTANCE.getStoredQueryDescriptionType_Metadata();
     ...
     * @generated
     */
    EReference STORED_QUERY_DESCRIPTION_TYPE__PARAMETER =
        eINSTANCE.getStoredQueryDescriptionType_Parameter();

    /**
     * The meta object literal for the '<em><b>Query Expression Text</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference STORED_QUERY_DESCRIPTION_TYPE__QUERY_EXPRESSION_TEXT =
        eINSTANCE.getStoredQueryDescriptionType_QueryExpressionText();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.StoredQueryListItemTypeImpl
     * <em>Stored Query List Item Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute STORED_QUERY_LIST_ITEM_TYPE__RETURN_FEATURE_TYPE =
        eINSTANCE.getStoredQueryListItemType_ReturnFeatureType();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.StoredQueryTypeImpl <em>Stored
     * Query Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TitleTypeImpl <em>Title
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TransactionResponseTypeImpl
     * <em>Transaction Response Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Transaction Summary</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference TRANSACTION_RESPONSE_TYPE__TRANSACTION_SUMMARY =
        eINSTANCE.getTransactionResponseType_TransactionSummary();

    /**
     * The meta object literal for the '<em><b>Insert Results</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference TRANSACTION_RESPONSE_TYPE__INSERT_RESULTS =
        eINSTANCE.getTransactionResponseType_InsertResults();

    /**
     * The meta object literal for the '<em><b>Update Results</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference TRANSACTION_RESPONSE_TYPE__UPDATE_RESULTS =
        eINSTANCE.getTransactionResponseType_UpdateResults();

    /**
     * The meta object literal for the '<em><b>Replace Results</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference TRANSACTION_RESPONSE_TYPE__REPLACE_RESULTS =
        eINSTANCE.getTransactionResponseType_ReplaceResults();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TransactionSummaryTypeImpl
     * <em>Transaction Summary Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    EAttribute TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED =
        eINSTANCE.getTransactionSummaryType_TotalInserted();
     ...
     * @generated
     */
    EAttribute TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED =
        eINSTANCE.getTransactionSummaryType_TotalUpdated();
     ...
     * @generated
     */
    EAttribute TRANSACTION_SUMMARY_TYPE__TOTAL_REPLACED =
        eINSTANCE.getTransactionSummaryType_TotalReplaced();
     ...
     * @generated
     */
    EAttribute TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED =
        eINSTANCE.getTransactionSummaryType_TotalDeleted();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TransactionTypeImpl
     * <em>Transaction Type</em>}' class.
     * <!-- begin-user-doc
     * -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Abstract Transaction Action Group</b></em>' attribute
     * list feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EAttribute TRANSACTION_TYPE__ABSTRACT_TRANSACTION_ACTION_GROUP =
        eINSTANCE.getTransactionType_AbstractTransactionActionGroup();
     ...
     * @generated
     */
    EReference TRANSACTION_TYPE__ABSTRACT_TRANSACTION_ACTION =
        eINSTANCE.getTransactionType_AbstractTransactionAction();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TruncatedResponseTypeImpl
     * <em>Truncated Response Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em><b>Exception Report</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc
     * -->
     ...
     * @generated
     */
    EReference TRUNCATED_RESPONSE_TYPE__EXCEPTION_REPORT =
        eINSTANCE.getTruncatedResponseType_ExceptionReport();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.TupleTypeImpl <em>Tuple
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.UpdateTypeImpl <em>Update
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ValueCollectionTypeImpl
     * <em>Value Collection Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference VALUE_COLLECTION_TYPE__ADDITIONAL_VALUES =
        eINSTANCE.getValueCollectionType_AdditionalValues();
     ...
     * @generated
     */
    EReference VALUE_COLLECTION_TYPE__TRUNCATED_RESPONSE =
        eINSTANCE.getValueCollectionType_TruncatedResponse();
     ...
     * @generated
     */
    EAttribute VALUE_COLLECTION_TYPE__NUMBER_MATCHED =
        eINSTANCE.getValueCollectionType_NumberMatched();
     ...
     * @generated
     */
    EAttribute VALUE_COLLECTION_TYPE__NUMBER_RETURNED =
        eINSTANCE.getValueCollectionType_NumberReturned();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ValueListTypeImpl <em>Value
     * List Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.ValueReferenceTypeImpl
     * <em>Value Reference Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.WFSCapabilitiesTypeImpl
     * <em>WFS Capabilities Type</em>}' class.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST =
        eINSTANCE.getWFSCapabilitiesType_FeatureTypeList();

    /**
     * The meta object literal for the '<em><b>Filter Capabilities</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EReference WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES =
        eINSTANCE.getWFSCapabilitiesType_FilterCapabilities();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.impl.WSDLTypeImpl <em>WSDL
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.AllSomeType <em>All Some
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * <em>Non Negative Integer Or Unknown Member0</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wfs20.NonNegativeIntegerOrUnknownMember0
     ...
     * @generated
     */
    EEnum NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER0 =
        eINSTANCE.getNonNegativeIntegerOrUnknownMember0();

    /**
     * The meta object literal for the '{@link net.opengis.wfs20.ResolveValueType <em>Resolve Value
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.ResultTypeType <em>Result Type
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.StarStringType <em>Star String
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.StateValueTypeMember0 <em>State
     * Value Type Member0</em>}' enum.
     * <!--
     * begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wfs20.UpdateActionType <em>Update Action
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
    ...
    /**
     * The meta object literal for the '<em>Non Negative Integer Or Unknown Member0 Object</em>'
     * data type.
     * <!-- begin-user-doc -->
     * <!--
     * end-user-doc -->
     ...
     * @generated
     */
    EDataType NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER0_OBJECT =
        eINSTANCE.getNonNegativeIntegerOrUnknownMember0Object();
     ...
     * @generated
     */
    EDataType NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER1 =
        eINSTANCE.getNonNegativeIntegerOrUnknownMember1();
