 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.TransactionResponseType#getTransactionSummary <em>Transaction
 *       Summary</em>}
 *   <li>{@link net.opengis.wfs20.TransactionResponseType#getInsertResults <em>Insert Results</em>}
 *   <li>{@link net.opengis.wfs20.TransactionResponseType#getUpdateResults <em>Update Results</em>}
 *   <li>{@link net.opengis.wfs20.TransactionResponseType#getReplaceResults <em>Replace
 *       Results</em>}
 *   <li>{@link net.opengis.wfs20.TransactionResponseType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface TransactionResponseType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Transaction Summary</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getTransactionSummary
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Insert Results</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='InsertResults'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getInsertResults
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Update Results</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='UpdateResults'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getUpdateResults
   * <em>Update Results</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Replace Results</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ReplaceResults'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getReplaceResults
   * <em>Replace Results</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getVersion
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.TransactionResponseType#getVersion
   * <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.TransactionResponseType#getVersion
