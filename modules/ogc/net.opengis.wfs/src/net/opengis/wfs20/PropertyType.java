 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.PropertyType#getValueReference <em>Value Reference</em>}
 *   <li>{@link net.opengis.wfs20.PropertyType#getValue <em>Value</em>}
 * </ul>
 *
...
public interface PropertyType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Value Reference</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyType#getValueReference <em>Value
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.PropertyType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
