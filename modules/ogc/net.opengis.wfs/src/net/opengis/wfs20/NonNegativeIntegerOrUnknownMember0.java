 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Non Negative Integer Or Unknown
...
public enum NonNegativeIntegerOrUnknownMember0 implements Enumerator {
  ...
  /**
   * A public read-only list of all the '<em><b>Non Negative Integer Or Unknown Member0</b></em>'
   * enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static final List<NonNegativeIntegerOrUnknownMember0> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Non Negative Integer Or Unknown Member0</b></em>' literal with the
