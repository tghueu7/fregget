 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.CreateStoredQueryType#getStoredQueryDefinition <em>Stored Query
 *       Definition</em>}
 * </ul>
 *
...
public interface CreateStoredQueryType extends BaseRequestType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Stored Query Definition</em>' containment reference list isn't
   ...
   * @model containment="true" extendedMetaData="kind='element' name='StoredQueryDefinition'
