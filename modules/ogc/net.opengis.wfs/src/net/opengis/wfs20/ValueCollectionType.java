 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getMember <em>Member</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getAdditionalValues <em>Additional
 *       Values</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getTruncatedResponse <em>Truncated
 *       Response</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getNext <em>Next</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getNumberMatched <em>Number Matched</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getNumberReturned <em>Number Returned</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getPrevious <em>Previous</em>}
 *   <li>{@link net.opengis.wfs20.ValueCollectionType#getTimeStamp <em>Time Stamp</em>}
 * </ul>
 *
...
public interface ValueCollectionType extends EObject {
   ...
   * are of type {@link net.opengis.wfs20.MemberPropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Member</em>' containment reference list isn't clear, there really
   ...
   * @model containment="true" extendedMetaData="kind='element' name='additionalValues'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getAdditionalValues
   * <em>Additional Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='truncatedResponse'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getTruncatedResponse
   * <em>Truncated Response</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Next</em>' attribute isn't clear, there really should be more of
   * a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getNext <em>Next</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Number Matched</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getNumberMatched <em>Number
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Number Returned</em>' attribute isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getNumberReturned
   * <em>Number Returned</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Previous</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getPrevious
   * <em>Previous</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Time Stamp</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ValueCollectionType#getTimeStamp <em>Time
   * Stamp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
