 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.UpdateType#getProperty <em>Property</em>}
 *   <li>{@link net.opengis.wfs20.UpdateType#getFilter <em>Filter</em>}
 *   <li>{@link net.opengis.wfs20.UpdateType#getInputFormat <em>Input Format</em>}
 *   <li>{@link net.opengis.wfs20.UpdateType#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.wfs20.UpdateType#getTypeName <em>Type Name</em>}
 * </ul>
 *
...
public interface UpdateType extends AbstractTransactionActionType {
   ...
   * contents are of type {@link net.opengis.wfs20.PropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Property</em>' containment reference list isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Property</em>' containment reference list.
   * @see net.opengis.wfs20.Wfs20Package#getUpdateType_Property()
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Property'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.UpdateType#getFilter <em>Filter</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Input Format</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.UpdateType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.UpdateType#getInputFormat <em>Input
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.UpdateType#getInputFormat <em>Input
   * Format</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.UpdateType#getSrsName <em>Srs Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.UpdateType#getTypeName <em>Type Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
