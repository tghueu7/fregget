 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getTuple <em>Tuple</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getSimpleFeatureCollectionGroup <em>Simple
 *       Feature Collection Group</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getSimpleFeatureCollection <em>Simple Feature
 *       Collection</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getState <em>State</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs20.MemberPropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface MemberPropertyType extends EObject {
   ...
   *     volatile="true" derived="true" extendedMetaData="kind='elementWildcard' wildcards='##other'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getTuple <em>Tuple</em>}'
   ...
   * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false" transient="true"
   *     volatile="true" derived="true" extendedMetaData="kind='group'
   *     name='SimpleFeatureCollection:group' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getSimpleFeatureCollection
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.MemberPropertyType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getHref <em>Href</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getRole <em>Role</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.MemberPropertyType#getShow
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>State</em>' attribute isn't clear, there really should be more of
   * a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.wfs20.StateValueType" extendedMetaData="kind='attribute'
   *     name='state'"
   * @generated
   */
  Object getState();
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getState <em>State</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.MemberPropertyType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.MemberPropertyType#getType
