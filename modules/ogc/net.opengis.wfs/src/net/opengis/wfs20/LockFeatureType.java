 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.LockFeatureType#getAbstractQueryExpressionGroup <em>Abstract Query
 *       Expression Group</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureType#getAbstractQueryExpression <em>Abstract Query
 *       Expression</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureType#getExpiry <em>Expiry</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureType#getLockAction <em>Lock Action</em>}
 *   <li>{@link net.opengis.wfs20.LockFeatureType#getLockId <em>Lock Id</em>}
 * </ul>
 *
...
public interface LockFeatureType extends BaseRequestType {
  ...
  /**
   * Returns the value of the '<em><b>Expiry</b></em>' attribute. The default value is <code>"300"
   * </code>.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Expiry</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureType#getExpiry <em>Expiry</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.LockFeatureType#getExpiry <em>Expiry</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.LockFeatureType#getExpiry
   ...
   * "ALL"</code>. The literals are from the enumeration {@link net.opengis.wfs20.AllSomeType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Lock Action</em>' attribute isn't clear, there really should be
   ...
   * @model default="ALL" unsettable="true" extendedMetaData="kind='attribute' name='lockAction'"
   * @generated
   */
  AllSomeType getLockAction();

  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureType#getLockAction <em>Lock
   * Action</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs20.LockFeatureType#getLockAction <em>Lock
   * Action</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs20.LockFeatureType#getLockAction
   * <em>Lock Action</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.LockFeatureType#getLockId <em>Lock Id</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
