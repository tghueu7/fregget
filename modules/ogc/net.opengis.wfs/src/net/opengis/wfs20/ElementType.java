 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.ElementType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs20.ElementType#getValueList <em>Value List</em>}
 *   <li>{@link net.opengis.wfs20.ElementType#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs20.ElementType#getType <em>Type</em>}
 * </ul>
 *
...
public interface ElementType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Metadata'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ElementType#getMetadata <em>Metadata</em>}'
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='ValueList'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.ElementType#getValueList <em>Value List</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
