 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs20.WFSCapabilitiesType#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wfs20.WFSCapabilitiesType#getFeatureTypeList <em>Feature Type List</em>}
 *   <li>{@link net.opengis.wfs20.WFSCapabilitiesType#getFilterCapabilities <em>Filter
 *       Capabilities</em>}
 * </ul>
 *
...
public interface WFSCapabilitiesType extends CapabilitiesBaseType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>WSDL</em>' containment reference isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.WFSCapabilitiesType#getWSDL <em>WSDL</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.WFSCapabilitiesType#getFeatureTypeList
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Filter_Capabilities'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs20.WFSCapabilitiesType#getFilterCapabilities
   * <em>Filter Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
