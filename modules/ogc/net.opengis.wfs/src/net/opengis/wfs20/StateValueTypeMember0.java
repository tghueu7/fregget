...
public enum StateValueTypeMember0 implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Valid</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Superseded</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Retired</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Future</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #FUTURE
  ...
  /**
   * Returns the '<em><b>State Value Type Member0</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>State Value Type Member0</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
