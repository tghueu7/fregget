 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A GetGmlObjectType element contains exactly one GmlObjectId. The value of the gml:id attribute on
 * that GmlObjectId is used as a unique key to retrieve the complex element with a gml:id attribute
 * with the same value.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.GetGmlObjectType#getGmlObjectId <em>Gml Object Id</em>}
 *   <li>{@link net.opengis.wfs.GetGmlObjectType#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.wfs.GetGmlObjectType#getTraverseXlinkDepth <em>Traverse Xlink
 *       Depth</em>}
 *   <li>{@link net.opengis.wfs.GetGmlObjectType#getTraverseXlinkExpiry <em>Traverse Xlink
 *       Expiry</em>}
 * </ul>
 *
...
public interface GetGmlObjectType extends BaseRequestType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Gml Object Id</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.GetGmlObjectType#getGmlObjectId <em>Gml Object
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model default="GML3" unique="false" unsettable="true"
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.GetGmlObjectType#getOutputFormat <em>Output
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wfs.GetGmlObjectType#getOutputFormat <em>Output
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wfs.GetGmlObjectType#getOutputFormat
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This attribute indicates the depth to which nested property XLink linking element locator
   * attribute (href) XLinks are traversed and resolved if possible. A value of "1" indicates that
   * one linking element locator attribute (href) XLink will be traversed and the referenced element
   * returned if possible, but nested property XLink linking element locator attribute (href) XLinks
   * in the returned element are not traversed. A value of " " indicates that all nested property
   * XLink linking element locator attribute (href) XLinks will be traversed and the referenced
   * elements returned if possible. The range of valid values for this attribute consists of
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.GetGmlObjectType#getTraverseXlinkDepth
   * <em>Traverse Xlink Depth</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The traverseXlinkExpiry attribute value is specified in minutes. It indicates how long a Web
   * Feature Service should wait to receive a response to a nested GetGmlObject request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.GetGmlObjectType#getTraverseXlinkExpiry
   * <em>Traverse Xlink Expiry</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
