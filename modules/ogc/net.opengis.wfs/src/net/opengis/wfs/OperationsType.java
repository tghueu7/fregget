 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.OperationsType#getOperation <em>Operation</em>}
 * </ul>
 *
...
public interface OperationsType extends EObject {
  /**
   * Returns the value of the '<em><b>Operation</b></em>' attribute list. The list contents are of
   * type {@link net.opengis.wfs.OperationType}. The literals are from the enumeration {@link
   * net.opengis.wfs.OperationType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Operation</em>' attribute list isn't clear, there really should
