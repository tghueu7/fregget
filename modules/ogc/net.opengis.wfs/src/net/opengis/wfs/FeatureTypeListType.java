 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.FeatureTypeListType#getOperations <em>Operations</em>}
 *   <li>{@link net.opengis.wfs.FeatureTypeListType#getFeatureType <em>Feature Type</em>}
 * </ul>
 *
...
public interface FeatureTypeListType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.FeatureTypeListType#getOperations
  ...
  /**
   * Returns the value of the '<em><b>Feature Type</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wfs.FeatureTypeType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Type</em>' containment reference list isn't clear, there
