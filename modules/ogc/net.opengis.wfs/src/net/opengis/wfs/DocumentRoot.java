 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getDelete <em>Delete</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getDescribeFeatureType <em>Describe Feature Type</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getFeatureCollection <em>Feature Collection</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getFeatureTypeList <em>Feature Type List</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getGetFeature <em>Get Feature</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getGetFeatureWithLock <em>Get Feature With Lock</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getGetGmlObject <em>Get Gml Object</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getInsert <em>Insert</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getLockFeature <em>Lock Feature</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getLockFeatureResponse <em>Lock Feature Response</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getNative <em>Native</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getProperty <em>Property</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getPropertyName <em>Property Name</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getQuery <em>Query</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getServesGMLObjectTypeList <em>Serves GML Object Type
 *       List</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getSupportsGMLObjectTypeList <em>Supports GML Object
 *       Type List</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getTransaction <em>Transaction</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getTransactionResponse <em>Transaction Response</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getUpdate <em>Update</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getWfsCapabilities <em>Wfs Capabilities</em>}
 *   <li>{@link net.opengis.wfs.DocumentRoot#getXlinkPropertyName <em>Xlink Property Name</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The Delete element is used to indicate that one or more feature instances should be removed
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getDelete <em>Delete</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The DescribeFeatureType element is used to request that a Web Feature Service generate a
   * document describing one or more feature types.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getDescribeFeatureType <em>Describe
   * Feature Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This element is a container for the response to a GetFeature or GetFeatureWithLock
   * (WFS-transaction.xsd) request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getFeatureCollection <em>Feature
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getFeatureTypeList <em>Feature Type
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getGetCapabilities <em>Get
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The GetFeature element is used to request that a Web Feature Service return feature type
   * instances of one or more feature types.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getGetFeature <em>Get Feature</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This is the root element for the GetFeatureWithLock request. The GetFeatureWithLock operation
   * performs identically to a GetFeature request except that the GetFeatureWithLock request locks
   * all the feature instances in the result set and returns a lock identifier to a client
   * application in the response. The lock identifier is returned to the client application using
   * the lockId attribute define on the wfs:FeatureCollection element.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getGetFeatureWithLock <em>Get
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The GetGmlObject element is used to request that a Web Feature Service return an element with a
   * gml:id attribute value specified by an ogc:GmlObjectId.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getGetGmlObject <em>Get Gml
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The Insert element is used to indicate that the Web Feature Service should create a new
   * instance of a feature type. The feature instance is specified using GML3 and one or more
   * feature instances to be created can be contained inside the Insert element.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getInsert <em>Insert</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This is the root element for a LockFeature request. The LockFeature request can be used to lock
   * one or more feature instances.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getLockFeature <em>Lock
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The LockFeatureResponse element contains a report about the completion status of a LockFeature
   * request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getLockFeatureResponse <em>Lock
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The LockId element contains the value of the lock identifier obtained by a client application
   * from a previous GetFeatureWithLock or LockFeature request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getLockId <em>Lock Id</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Many times, a Web Feature Service interacts with a repository that may have special vendor
   * specific capabilities. The native element allows vendor specific command to be passed to the
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getNative <em>Native</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The Property element is used to specify the new value of a feature property inside an Update
   * element.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getProperty <em>Property</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The Property element is used to specify one or more properties of a feature whose values are to
   * be retrieved by a Web Feature Service.
   *
   * <p>While a Web Feature Service should endeavour to satisfy the exact request specified, in some
   * instance this may not be possible. Specifically, a Web Feature Service must generate a valid
   * GML3 response to a Query operation. The schema used to generate the output may include
   * properties that are mandatory. In order that the output validates, these mandatory properties
   * must be specified in the request. If they are not, a Web Feature Service may add them
   * automatically to the Query before processing it. Thus a client application should, in general,
   * be prepared to receive more properties than it requested.
   *
   * <p>Of course, using the DescribeFeatureType request, a client application can determine which
   * properties are mandatory and request them in the first place.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getPropertyName <em>Property
   * Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The Query element is used to describe a single query. One or more Query elements can be
   * specified inside a GetFeature element so that multiple queries can be executed in one request.
   * The output from the various queries are combined in a wfs:FeatureCollection element to form the
   * response document.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getQuery <em>Query</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='ServesGMLObjectTypeList'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getServesGMLObjectTypeList
   * <em>Serves GML Object Type List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * List of GML Object types that WFS is capable of serving, either directly, or as validly derived
   ...
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='SupportsGMLObjectTypeList'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getSupportsGMLObjectTypeList
   * <em>Supports GML Object Type List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @param value the new value of the '<em>Supports GML Object Type List</em>' containment
   *     reference.
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This is the root element for a Transaction request. A transaction request allows insert, update
   * and delete operations to be performed to create, change or remove feature instances.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getTransaction
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The TransactionResponse element contains a report about the completion status of a Transaction
   * operation.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getTransactionResponse
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getUpdate <em>Update</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getWfsCapabilities <em>Wfs
   * Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This element may be used in place of an wfs:PropertyName element in a wfs:Query element in a
   * wfs:GetFeature element to selectively request the traversal of nested XLinks in the returned
   * element for the named property. This element may not be used in other requests --
   * GetFeatureWithLock, LockFeature, Insert, Update, Delete -- in this version of the WFS
   * specification.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.DocumentRoot#getXlinkPropertyName <em>Xlink
   * Property Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
