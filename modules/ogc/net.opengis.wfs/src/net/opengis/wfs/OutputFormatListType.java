 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.OutputFormatListType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.wfs.OutputFormatListType#getFormat <em>Format</em>}
 * </ul>
 *
...
public interface OutputFormatListType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Format</em>' attribute list isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   *     transient="true" volatile="true" derived="true" many="true"
