 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Identifier Generation Option
...
public final class IdentifierGenerationOptionType extends AbstractEnumerator {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The UseExsiting value indicates that WFS should not generate a new feature identifier for the
   * feature being inserted into the repositry. Instead, the WFS should use the identifier encoded
   * if the feature. If a duplicate exists then the WFS should raise an exception.
   * <!-- end-model-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The ReplaceDuplicate value indicates that WFS should not generate a new feature identifier for
   * the feature being inserted into the repositry. Instead, the WFS should use the identifier
   * encoded if the feature. If a duplicate exists then the WFS should replace the existing feature
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The GenerateNew value indicates that WFS should generate a new unique feature identifier for
   * the feature being inserted into the repositry.
   * <!-- end-model-doc -->
   *
  ...
  public static final IdentifierGenerationOptionType USE_EXISTING_LITERAL =
      new IdentifierGenerationOptionType(USE_EXISTING, "UseExisting", "UseExisting");
  ...
  public static final IdentifierGenerationOptionType REPLACE_DUPLICATE_LITERAL =
      new IdentifierGenerationOptionType(REPLACE_DUPLICATE, "ReplaceDuplicate", "ReplaceDuplicate");
  ...
  public static final IdentifierGenerationOptionType GENERATE_NEW_LITERAL =
      new IdentifierGenerationOptionType(GENERATE_NEW, "GenerateNew", "GenerateNew");
  ...
  /**
   * A public read-only list of all the '<em><b>Identifier Generation Option Type</b></em>'
   * enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Identifier Generation Option Type</b></em>' literal with the specified
   * literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
