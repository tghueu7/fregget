 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This type defines a container for the response to a GetFeature or GetFeatureWithLock request. If
 * the request is GetFeatureWithLock, the lockId attribute must be populated. The lockId attribute
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.FeatureCollectionType#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs.FeatureCollectionType#getTimeStamp <em>Time Stamp</em>}
 *   <li>{@link net.opengis.wfs.FeatureCollectionType#getNumberOfFeatures <em>Number Of
 *       Features</em>}
 *   <li>{@link net.opengis.wfs.FeatureCollectionType#getFeature <em>Feature</em>}
 * </ul>
 *
...
public interface FeatureCollectionType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.FeatureCollectionType#getLockId <em>Lock
   * Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.FeatureCollectionType#getTimeStamp <em>Time
   * Stamp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.FeatureCollectionType#getNumberOfFeatures
   * <em>Number Of Features</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
