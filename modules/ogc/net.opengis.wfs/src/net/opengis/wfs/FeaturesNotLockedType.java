 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.FeaturesNotLockedType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.wfs.FeaturesNotLockedType#getFeatureId <em>Feature Id</em>}
 * </ul>
 *
...
public interface FeaturesNotLockedType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Feature Id</b></em>' attribute list. The list contents are of
   * type {@link java.lang.Object}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Id</em>' attribute list isn't clear, there really should
