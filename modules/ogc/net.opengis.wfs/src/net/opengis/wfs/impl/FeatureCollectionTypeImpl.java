 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getLockId <em>Lock Id</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getTimeStamp <em>Time Stamp</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getNumberOfFeatures <em>Number Of
 *       Features</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getFeature <em>Feature</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureCollectionTypeImpl extends EObjectImpl implements FeatureCollectionType {
  ...
  /**
   * The default value of the '{@link #getNumberOfFeatures() <em>Number Of Features</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.FEATURE_COLLECTION_TYPE__LOCK_ID,
              oldLockId,
              lockId));
  }
    ...
    if (feature == null) {
      feature =
          new EDataTypeUniqueEList(
              FeatureCollection.class, this, WfsPackage.FEATURE_COLLECTION_TYPE__FEATURE);
    }
    return feature;
  }
