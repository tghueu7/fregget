 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.TransactionResultsTypeImpl#getHandle <em>Handle</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionResultsTypeImpl#getAction <em>Action</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.TRANSACTION_RESULTS_TYPE__HANDLE,
              oldHandle,
              handle));
  }
    ...
    if (action == null) {
      action =
          new EObjectContainmentEList(
              ActionType.class, this, WfsPackage.TRANSACTION_RESULTS_TYPE__ACTION);
    }
    return action;
  }
