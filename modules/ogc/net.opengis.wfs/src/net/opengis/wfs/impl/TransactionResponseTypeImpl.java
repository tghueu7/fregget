 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.TransactionResponseTypeImpl#getTransactionSummary
 *       <em>Transaction Summary</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionResponseTypeImpl#getTransactionResults
 *       <em>Transaction Results</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionResponseTypeImpl#getInsertResults <em>Insert
 *       Results</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionResponseTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class TransactionResponseTypeImpl extends EObjectImpl implements TransactionResponseType {
  ...
  /**
   * The cached value of the '{@link #getTransactionResults() <em>Transaction Results</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetTransactionResults(
      TransactionResultsType newTransactionResults, NotificationChain msgs) {
  ...
  public void setTransactionResults(TransactionResultsType newTransactionResults) {
    if (newTransactionResults != transactionResults) {
      ...
      if (transactionResults != null)
        msgs =
            ((InternalEObject) transactionResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - WfsPackage.TRANSACTION_RESPONSE_TYPE__TRANSACTION_RESULTS,
      ...
      if (newTransactionResults != null)
        msgs =
            ((InternalEObject) newTransactionResults)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - WfsPackage.TRANSACTION_RESPONSE_TYPE__TRANSACTION_RESULTS,
      ...
      if (insertResults != null)
        msgs =
            ((InternalEObject) insertResults)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.TRANSACTION_RESPONSE_TYPE__INSERT_RESULTS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.TRANSACTION_RESPONSE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
