 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.LockFeatureTypeImpl#getLock <em>Lock</em>}
 *   <li>{@link net.opengis.wfs.impl.LockFeatureTypeImpl#getExpiry <em>Expiry</em>}
 *   <li>{@link net.opengis.wfs.impl.LockFeatureTypeImpl#getLockAction <em>Lock Action</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.LOCK_FEATURE_TYPE__EXPIRY,
              oldExpiry,
              expiry,
              !oldExpiryESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.LOCK_FEATURE_TYPE__LOCK_ACTION,
              oldLockAction,
              lockAction,
              !oldLockActionESet));
  }
