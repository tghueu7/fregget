 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.InsertElementTypeImpl#getFeature <em>Feature</em>}
 *   <li>{@link net.opengis.wfs.impl.InsertElementTypeImpl#getHandle <em>Handle</em>}
 *   <li>{@link net.opengis.wfs.impl.InsertElementTypeImpl#getIdgen <em>Idgen</em>}
 *   <li>{@link net.opengis.wfs.impl.InsertElementTypeImpl#getInputFormat <em>Input Format</em>}
 *   <li>{@link net.opengis.wfs.impl.InsertElementTypeImpl#getSrsName <em>Srs Name</em>}
 * </ul>
 *
 * @generated
 */
public class InsertElementTypeImpl extends EObjectImpl implements InsertElementType {
   ...
   * @ordered
   */
  protected static final IdentifierGenerationOptionType IDGEN_EDEFAULT =
  ...
  public EList getFeature() {
    if (feature == null) {
      feature =
          new EDataTypeUniqueEList(Object.class, this, WfsPackage.INSERT_ELEMENT_TYPE__FEATURE);
    }
    return feature;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.INSERT_ELEMENT_TYPE__HANDLE, oldHandle, handle));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.INSERT_ELEMENT_TYPE__IDGEN,
              oldIdgen,
              idgen,
              !oldIdgenESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.INSERT_ELEMENT_TYPE__SRS_NAME,
              oldSrsName,
              srsName));
  }
  ...
  public String toString() {
    ...
    result.append(handle);
    result.append(", idgen: ");
    if (idgenESet) result.append(idgen);
