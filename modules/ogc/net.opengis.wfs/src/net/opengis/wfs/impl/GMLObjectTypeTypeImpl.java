 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeTypeImpl#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeTypeImpl#getOutputFormats <em>Output Formats</em>}
 * </ul>
 *
 * @generated
 */
public class GMLObjectTypeTypeImpl extends EObjectImpl implements GMLObjectTypeType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.GML_OBJECT_TYPE_TYPE__NAME, oldName, name));
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.GML_OBJECT_TYPE_TYPE__TITLE, oldTitle, title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GML_OBJECT_TYPE_TYPE__ABSTRACT,
              oldAbstract,
              abstract_));
  }
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, WfsPackage.GML_OBJECT_TYPE_TYPE__KEYWORDS);
    }
    return keywords;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GML_OBJECT_TYPE_TYPE__OUTPUT_FORMATS,
              oldOutputFormats,
              newOutputFormats);
      ...
      if (outputFormats != null)
        msgs =
            ((InternalEObject) outputFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.GML_OBJECT_TYPE_TYPE__OUTPUT_FORMATS,
                    null,
                    msgs);
