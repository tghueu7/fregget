 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.TransactionSummaryTypeImpl#getTotalInserted <em>Total
 *       Inserted</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionSummaryTypeImpl#getTotalUpdated <em>Total
 *       Updated</em>}
 *   <li>{@link net.opengis.wfs.impl.TransactionSummaryTypeImpl#getTotalDeleted <em>Total
 *       Deleted</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED,
              oldTotalInserted,
              totalInserted));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED,
              oldTotalUpdated,
              totalUpdated));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED,
              oldTotalDeleted,
              totalDeleted));
  }
