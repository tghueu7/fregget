 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getQuery <em>Query</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getMaxFeatures <em>Max Features</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getResultType <em>Result Type</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getTraverseXlinkDepth <em>Traverse Xlink
 *       Depth</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getTraverseXlinkExpiry <em>Traverse Xlink
 *       Expiry</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getFormatOptions <em>Format Options</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getStartIndex <em>Start Index</em>}
 *   <li>{@link net.opengis.wfs.impl.GetFeatureTypeImpl#getViewParams <em>View Params</em>}
 * </ul>
 *
 * @generated
 */
public class GetFeatureTypeImpl extends BaseRequestTypeImpl implements GetFeatureType {
  ...
  /**
   * The default value of the '{@link #getTraverseXlinkDepth() <em>Traverse Xlink Depth</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The cached value of the '{@link #getTraverseXlinkDepth() <em>Traverse Xlink Depth</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  /**
   * The default value of the '{@link #getTraverseXlinkExpiry() <em>Traverse Xlink Expiry</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!--
   * end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getTraverseXlinkExpiry() <em>Traverse Xlink Expiry</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc
   * -->
  ...
  public EList getQuery() {
    if (query == null) {
      query =
          new EObjectContainmentEList(QueryType.class, this, WfsPackage.GET_FEATURE_TYPE__QUERY);
    }
    return query;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__MAX_FEATURES,
              oldMaxFeatures,
              maxFeatures));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat,
              !oldOutputFormatESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__RESULT_TYPE,
              oldResultType,
              resultType,
              !oldResultTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__TRAVERSE_XLINK_DEPTH,
              oldTraverseXlinkDepth,
              traverseXlinkDepth));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__TRAVERSE_XLINK_EXPIRY,
              oldTraverseXlinkExpiry,
              traverseXlinkExpiry));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__FORMAT_OPTIONS,
              oldFormatOptions,
              formatOptions));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__METADATA,
              oldMetadata,
              metadata));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.GET_FEATURE_TYPE__START_INDEX,
              oldStartIndex,
              startIndex));
  }
  ...
  public EList getViewParams() {
    if (viewParams == null) {
      viewParams =
          (EList) new EDataTypeEList(Map.class, this, WfsPackage.GET_FEATURE_TYPE__VIEW_PARAMS);
    }
    return viewParams;
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case WfsPackage.GET_FEATURE_TYPE__MAX_FEATURES:
        return MAX_FEATURES_EDEFAULT == null
            ? maxFeatures != null
      ...
      case WfsPackage.GET_FEATURE_TYPE__START_INDEX:
        return START_INDEX_EDEFAULT == null
            ? startIndex != null
            : !START_INDEX_EDEFAULT.equals(startIndex);
      case WfsPackage.GET_FEATURE_TYPE__VIEW_PARAMS:
