...
public class WfsFactoryImpl extends EFactoryImpl implements WfsFactory {
  ...
  public static WfsFactory init() {
    try {
      WfsFactory theWfsFactory =
          (WfsFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/wfs");
   ...
   * @generated
   */
  public FilterCapabilities createFilterCapabilitiesFromString(
      EDataType eDataType, String initialValue) {
