 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.GMLObjectTypeListTypeImpl#getGMLObjectType <em>GML Object
 *       Type</em>}
 * </ul>
 *
 * @generated
...
public class GMLObjectTypeListTypeImpl extends EObjectImpl implements GMLObjectTypeListType {
  /**
   * The cached value of the '{@link #getGMLObjectType() <em>GML Object Type</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (gMLObjectType == null) {
      gMLObjectType =
          new EObjectContainmentEList(
              GMLObjectTypeType.class, this, WfsPackage.GML_OBJECT_TYPE_LIST_TYPE__GML_OBJECT_TYPE);
    }
