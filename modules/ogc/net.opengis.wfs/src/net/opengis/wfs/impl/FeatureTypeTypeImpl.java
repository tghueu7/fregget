 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getKeywords <em>Keywords</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getDefaultSRS <em>Default SRS</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getOtherSRS <em>Other SRS</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getNoSRS <em>No SRS</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getOperations <em>Operations</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getOutputFormats <em>Output Formats</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getWGS84BoundingBox <em>WGS84 Bounding
 *       Box</em>}
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getMetadataURL <em>Metadata URL</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureTypeTypeImpl extends EObjectImpl implements FeatureTypeType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.FEATURE_TYPE_TYPE__NAME, oldName, name));
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.FEATURE_TYPE_TYPE__TITLE, oldTitle, title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.FEATURE_TYPE_TYPE__ABSTRACT,
              oldAbstract,
              abstract_));
  }
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, WfsPackage.FEATURE_TYPE_TYPE__KEYWORDS);
    }
    return keywords;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.FEATURE_TYPE_TYPE__DEFAULT_SRS,
              oldDefaultSRS,
              defaultSRS));
  }
  ...
  public NotificationChain basicSetNoSRS(NoSRSType newNoSRS, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.FEATURE_TYPE_TYPE__NO_SRS, oldNoSRS, newNoSRS);
  ...
  public void setNoSRS(NoSRSType newNoSRS) {
    if (newNoSRS != noSRS) {
      ...
      if (noSRS != null)
        msgs =
            ((InternalEObject) noSRS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.FEATURE_TYPE_TYPE__NO_SRS,
                    null,
                    msgs);
      if (newNoSRS != null)
        msgs =
            ((InternalEObject) newNoSRS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.FEATURE_TYPE_TYPE__NO_SRS,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, WfsPackage.FEATURE_TYPE_TYPE__NO_SRS, newNoSRS, newNoSRS));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetOperations(
      OperationsType newOperations, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.FEATURE_TYPE_TYPE__OPERATIONS,
              oldOperations,
              newOperations);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setOperations(OperationsType newOperations) {
    if (newOperations != operations) {
      ...
      if (operations != null)
        msgs =
            ((InternalEObject) operations)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.FEATURE_TYPE_TYPE__OPERATIONS,
                    null,
                    msgs);
      if (newOperations != null)
        msgs =
            ((InternalEObject) newOperations)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.FEATURE_TYPE_TYPE__OPERATIONS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.FEATURE_TYPE_TYPE__OUTPUT_FORMATS,
              oldOutputFormats,
              newOutputFormats);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (outputFormats != null)
        msgs =
            ((InternalEObject) outputFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.FEATURE_TYPE_TYPE__OUTPUT_FORMATS,
                    null,
                    msgs);
  ...
  public EList getWGS84BoundingBox() {
    if (wGS84BoundingBox == null) {
      wGS84BoundingBox =
          new EObjectContainmentEList(
              WGS84BoundingBoxType.class, this, WfsPackage.FEATURE_TYPE_TYPE__WGS84_BOUNDING_BOX);
    }
  ...
  public EList getMetadataURL() {
    if (metadataURL == null) {
      metadataURL =
          new EObjectContainmentEList(
              MetadataURLType.class, this, WfsPackage.FEATURE_TYPE_TYPE__METADATA_URL);
    }
    return metadataURL;
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case WfsPackage.FEATURE_TYPE_TYPE__DEFAULT_SRS:
        return DEFAULT_SRS_EDEFAULT == null
            ? defaultSRS != null
            : !DEFAULT_SRS_EDEFAULT.equals(defaultSRS);
      case WfsPackage.FEATURE_TYPE_TYPE__OTHER_SRS:
