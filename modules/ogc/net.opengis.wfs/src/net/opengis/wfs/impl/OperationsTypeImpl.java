 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.OperationsTypeImpl#getOperation <em>Operation</em>}
 * </ul>
 *
 * @generated
 */
public class OperationsTypeImpl extends EObjectImpl implements OperationsType {
  ...
  public EList getOperation() {
    if (operation == null) {
      operation =
          new EDataTypeEList(OperationType.class, this, WfsPackage.OPERATIONS_TYPE__OPERATION);
    }
    return operation;
  }
