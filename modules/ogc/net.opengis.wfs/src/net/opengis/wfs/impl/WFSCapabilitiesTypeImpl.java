 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.WFSCapabilitiesTypeImpl#getFeatureTypeList <em>Feature Type
 *       List</em>}
 *   <li>{@link net.opengis.wfs.impl.WFSCapabilitiesTypeImpl#getServesGMLObjectTypeList <em>Serves
 *       GML Object Type List</em>}
 *   <li>{@link net.opengis.wfs.impl.WFSCapabilitiesTypeImpl#getSupportsGMLObjectTypeList
 *       <em>Supports GML Object Type List</em>}
 *   <li>{@link net.opengis.wfs.impl.WFSCapabilitiesTypeImpl#getFilterCapabilities <em>Filter
 *       Capabilities</em>}
 * </ul>
 *
 * @generated
 */
public class WFSCapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl
    implements WFSCapabilitiesType {
  /**
   * The cached value of the '{@link #getFeatureTypeList() <em>Feature Type List</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getServesGMLObjectTypeList() <em>Serves GML Object Type
  ...
  /**
   * The cached value of the '{@link #getSupportsGMLObjectTypeList() <em>Supports GML Object Type
   * List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getFilterCapabilities() <em>Filter Capabilities</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getFilterCapabilities() <em>Filter Capabilities</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST,
              oldFeatureTypeList,
              newFeatureTypeList);
  ...
  public void setFeatureTypeList(FeatureTypeListType newFeatureTypeList) {
    if (newFeatureTypeList != featureTypeList) {
      ...
      if (featureTypeList != null)
        msgs =
            ((InternalEObject) featureTypeList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST,
                    null,
                    msgs);
      if (newFeatureTypeList != null)
        msgs =
            ((InternalEObject) newFeatureTypeList)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - WfsPackage.WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.WFS_CAPABILITIES_TYPE__SERVES_GML_OBJECT_TYPE_LIST,
              oldServesGMLObjectTypeList,
  ...
  public void setServesGMLObjectTypeList(GMLObjectTypeListType newServesGMLObjectTypeList) {
    if (newServesGMLObjectTypeList != servesGMLObjectTypeList) {
      ...
      if (servesGMLObjectTypeList != null)
        msgs =
            ((InternalEObject) servesGMLObjectTypeList)
                .eInverseRemove(
                    this,
      ...
      if (newServesGMLObjectTypeList != null)
        msgs =
            ((InternalEObject) newServesGMLObjectTypeList)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - WfsPackage.WFS_CAPABILITIES_TYPE__SERVES_GML_OBJECT_TYPE_LIST,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.WFS_CAPABILITIES_TYPE__SUPPORTS_GML_OBJECT_TYPE_LIST,
              oldSupportsGMLObjectTypeList,
  ...
  public void setSupportsGMLObjectTypeList(GMLObjectTypeListType newSupportsGMLObjectTypeList) {
    if (newSupportsGMLObjectTypeList != supportsGMLObjectTypeList) {
      ...
      if (supportsGMLObjectTypeList != null)
        msgs =
            ((InternalEObject) supportsGMLObjectTypeList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - WfsPackage.WFS_CAPABILITIES_TYPE__SUPPORTS_GML_OBJECT_TYPE_LIST,
      ...
      if (newSupportsGMLObjectTypeList != null)
        msgs =
            ((InternalEObject) newSupportsGMLObjectTypeList)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - WfsPackage.WFS_CAPABILITIES_TYPE__SUPPORTS_GML_OBJECT_TYPE_LIST,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              WfsPackage.WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES,
              oldFilterCapabilities,
              filterCapabilities));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case WfsPackage.WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES:
        return FILTER_CAPABILITIES_EDEFAULT == null
            ? filterCapabilities != null
            : !FILTER_CAPABILITIES_EDEFAULT.equals(filterCapabilities);
    }
