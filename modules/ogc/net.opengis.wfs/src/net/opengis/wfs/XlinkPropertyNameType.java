 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wfs.XlinkPropertyNameType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wfs.XlinkPropertyNameType#getTraverseXlinkDepth <em>Traverse Xlink
 *       Depth</em>}
 *   <li>{@link net.opengis.wfs.XlinkPropertyNameType#getTraverseXlinkExpiry <em>Traverse Xlink
 *       Expiry</em>}
 * </ul>
 *
...
public interface XlinkPropertyNameType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.XlinkPropertyNameType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.XlinkPropertyNameType#getTraverseXlinkDepth
  ...
  /**
   * Sets the value of the '{@link net.opengis.wfs.XlinkPropertyNameType#getTraverseXlinkExpiry
