...
public final class ResultTypeType extends AbstractEnumerator {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that a complete response should be generated by the WFS. That is, all response
   * feature instances should be returned to the client.
   * <!-- end-model-doc -->
   *
   * @see #RESULTS_LITERAL
   * @model name="results"
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that an empty response should be generated with the "numberOfFeatures" attribute set
   * (i.e. no feature instances should be returned). In this manner a client may determine the
   * number of feature instances that a GetFeature request will return without having to actually
  ...
  public static final ResultTypeType RESULTS_LITERAL =
      new ResultTypeType(RESULTS, "results", "results");
