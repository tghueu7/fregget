 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Operation Type</b></em>', and utility
...
public final class OperationType extends AbstractEnumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Insert</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Update</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #UPDATE_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Delete</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #DELETE_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Query</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Lock</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #LOCK_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Get Gml Object</b></em>' literal object isn't clear, there really
  ...
  public static final OperationType GET_GML_OBJECT_LITERAL =
      new OperationType(GET_GML_OBJECT, "GetGmlObject", "GetGmlObject");
