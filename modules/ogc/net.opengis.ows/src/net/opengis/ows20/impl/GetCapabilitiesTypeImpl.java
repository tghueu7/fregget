 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getAcceptVersions <em>Accept
 *       Versions</em>}
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getAcceptFormats <em>Accept
 *       Formats</em>}
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getAcceptLanguages <em>Accept
 *       Languages</em>}
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.ows20.impl.GetCapabilitiesTypeImpl#getBaseUrl <em>Base Url</em>}
 * </ul>
 *
 * @generated
 */
public class GetCapabilitiesTypeImpl extends EObjectImpl implements GetCapabilitiesType {
  /**
   * The cached value of the '{@link #getAcceptVersions() <em>Accept Versions</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAcceptFormats() <em>Accept Formats</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAcceptLanguages() <em>Accept Languages</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
              oldAcceptVersions,
              newAcceptVersions);
  ...
  public void setAcceptVersions(AcceptVersionsType newAcceptVersions) {
    if (newAcceptVersions != acceptVersions) {
      ...
      if (acceptVersions != null)
        msgs =
            ((InternalEObject) acceptVersions)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
                    null,
                    msgs);
      if (newAcceptVersions != null)
        msgs =
            ((InternalEObject) newAcceptVersions)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_CAPABILITIES_TYPE__SECTIONS,
              oldSections,
              newSections);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSections(SectionsType newSections) {
    if (newSections != sections) {
      ...
      if (sections != null)
        msgs =
            ((InternalEObject) sections)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__SECTIONS,
                    null,
                    msgs);
      if (newSections != null)
        msgs =
            ((InternalEObject) newSections)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__SECTIONS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_FORMATS,
              oldAcceptFormats,
              newAcceptFormats);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAcceptFormats(AcceptFormatsType newAcceptFormats) {
    if (newAcceptFormats != acceptFormats) {
      ...
      if (acceptFormats != null)
        msgs =
            ((InternalEObject) acceptFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_FORMATS,
                    null,
                    msgs);
      if (newAcceptFormats != null)
        msgs =
            ((InternalEObject) newAcceptFormats)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_FORMATS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetAcceptLanguages(
      AcceptLanguagesType newAcceptLanguages, NotificationChain msgs) {
  ...
  public void setAcceptLanguages(AcceptLanguagesType newAcceptLanguages) {
    if (newAcceptLanguages != acceptLanguages) {
      ...
      if (acceptLanguages != null)
        msgs =
            ((InternalEObject) acceptLanguages)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_LANGUAGES,
                    null,
                    msgs);
      if (newAcceptLanguages != null)
        msgs =
            ((InternalEObject) newAcceptLanguages)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.GET_CAPABILITIES_TYPE__ACCEPT_LANGUAGES,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_CAPABILITIES_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Ows20Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE:
        return UPDATE_SEQUENCE_EDEFAULT == null
            ? updateSequence != null
