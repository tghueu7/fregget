 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.IdentificationTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.ows20.impl.IdentificationTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.ows20.impl.IdentificationTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.ows20.impl.IdentificationTypeImpl#getAvailableCRSGroup <em>Available CRS
 *       Group</em>}
 *   <li>{@link net.opengis.ows20.impl.IdentificationTypeImpl#getAvailableCRS <em>Available
 *       CRS</em>}
 * </ul>
 *
 * @generated
 */
public class IdentificationTypeImpl extends BasicIdentificationTypeImpl
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Ows20Package.IDENTIFICATION_TYPE__BOUNDING_BOX_GROUP);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.IDENTIFICATION_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat));
  }
  ...
  public FeatureMap getAvailableCRSGroup() {
    if (availableCRSGroup == null) {
      availableCRSGroup =
          new BasicFeatureMap(this, Ows20Package.IDENTIFICATION_TYPE__AVAILABLE_CRS_GROUP);
    }
  ...
  public String getAvailableCRS() {
    return (String)
        getAvailableCRSGroup().get(Ows20Package.Literals.IDENTIFICATION_TYPE__AVAILABLE_CRS, true);
  }
  ...
  public void setAvailableCRS(String newAvailableCRS) {
    ((FeatureMap.Internal) getAvailableCRSGroup())
        .set(Ows20Package.Literals.IDENTIFICATION_TYPE__AVAILABLE_CRS, newAvailableCRS);
  }
