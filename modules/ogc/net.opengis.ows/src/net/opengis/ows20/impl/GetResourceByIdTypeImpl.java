 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.GetResourceByIdTypeImpl#getResourceID <em>Resource ID</em>}
 *   <li>{@link net.opengis.ows20.impl.GetResourceByIdTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.ows20.impl.GetResourceByIdTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.ows20.impl.GetResourceByIdTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class GetResourceByIdTypeImpl extends EObjectImpl implements GetResourceByIdType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_RESOURCE_BY_ID_TYPE__RESOURCE_ID,
              oldResourceID,
              resourceID));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_RESOURCE_BY_ID_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_RESOURCE_BY_ID_TYPE__SERVICE,
              oldService,
              service));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.GET_RESOURCE_BY_ID_TYPE__VERSION,
              oldVersion,
              version));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Ows20Package.GET_RESOURCE_BY_ID_TYPE__RESOURCE_ID:
        return RESOURCE_ID_EDEFAULT == null
            ? resourceID != null
            : !RESOURCE_ID_EDEFAULT.equals(resourceID);
      case Ows20Package.GET_RESOURCE_BY_ID_TYPE__OUTPUT_FORMAT:
