 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.KeywordsTypeImpl#getKeyword <em>Keyword</em>}
 *   <li>{@link net.opengis.ows20.impl.KeywordsTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class KeywordsTypeImpl extends EObjectImpl implements KeywordsType {
    ...
    if (keyword == null) {
      keyword =
          new EObjectContainmentEList<LanguageStringType>(
              LanguageStringType.class, this, Ows20Package.KEYWORDS_TYPE__KEYWORD);
    }
    return keyword;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.KEYWORDS_TYPE__TYPE, oldType, newType);
  ...
  public void setType(CodeType newType) {
    if (newType != type) {
      ...
      if (type != null)
        msgs =
            ((InternalEObject) type)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.KEYWORDS_TYPE__TYPE, null, msgs);
      if (newType != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.KEYWORDS_TYPE__TYPE, newType, newType));
  }
