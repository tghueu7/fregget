...
public class Ows20PackageImpl extends EPackageImpl implements Ows20Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Ows20Package#eINSTANCE} when that field is
  ...
  public static Ows20Package init() {
    ...
    Ows20PackageImpl theOws20Package =
        (Ows20PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ows20PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Ows20PackageImpl());
  ...
  public void createPackageContents() {
    ...
    createEReference(
        additionalParametersBaseTypeEClass, ADDITIONAL_PARAMETERS_BASE_TYPE__ADDITIONAL_PARAMETER);

    additionalParametersTypeEClass = createEClass(ADDITIONAL_PARAMETERS_TYPE);
    createEReference(
        additionalParametersTypeEClass, ADDITIONAL_PARAMETERS_TYPE__ADDITIONAL_PARAMETER1);
    ...
    createEReference(
        ...
        DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__WGS84_BOUNDING_BOX);
    createEReference(
        datasetDescriptionSummaryBaseTypeEClass, DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__IDENTIFIER);
    createEAttribute(
        datasetDescriptionSummaryBaseTypeEClass,
        DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__BOUNDING_BOX_GROUP);
    createEReference(
        datasetDescriptionSummaryBaseTypeEClass,
        DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__BOUNDING_BOX);
    createEAttribute(
        datasetDescriptionSummaryBaseTypeEClass,
        DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__METADATA_GROUP);
    createEReference(
        datasetDescriptionSummaryBaseTypeEClass, DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__METADATA);
    createEReference(
        datasetDescriptionSummaryBaseTypeEClass,
        DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY);
    ...
    createEAttribute(
        responsiblePartySubsetTypeEClass, RESPONSIBLE_PARTY_SUBSET_TYPE__INDIVIDUAL_NAME);
    createEAttribute(
        responsiblePartySubsetTypeEClass, RESPONSIBLE_PARTY_SUBSET_TYPE__POSITION_NAME);
    ...
    createEAttribute(
        serviceIdentificationTypeEClass, SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION);
    ...
    createEAttribute(
        serviceIdentificationTypeEClass, SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS);
  ...
  public void initializePackageContents() {
    ...
    initEClass(
        ...
        AbstractReferenceBaseType.class,
    ...
    initEReference(
        ...
        this.getAdditionalParameterType(),
        null,
        "additionalParameter",
        null,
        1,
    ...
    initEReference(
        ...
        this.getServiceIdentificationType(),
        null,
    ...
    initEReference(
        ...
        this.getOperationsMetadataType(),
        null,
        "operationsMetadata",
        null,
        0,
    ...
    initEReference(
        ...
        this.getDatasetDescriptionSummaryBaseType(),
        null,
    ...
    initEReference(
        ...
        this.getAbstractReferenceBaseType(),
        null,
    ...
    initEReference(
        ...
        this.getAdditionalParametersType(),
        null,
    ...
    initEClass(
        ...
        ResponsiblePartySubsetType.class,
    ...
    initEReference(
        ...
        this.getResponsiblePartySubsetType(),
        null,
        "serviceContact",
        null,
        1,
    ...
    initEDataType(
        mimeTypeEDataType, String.class, "MimeType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
    ...
    initEDataType(
        ...
        RangeClosureType.class,
        "RangeClosureTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        hrefTypeEDataType, String.class, "HrefType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        roleTypeEDataType, String.class, "RoleType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        titleAttrType_1EDataType,
        String.class,
        "TitleAttrType_1",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        arcroleType_2EDataType,
        String.class,
        "ArcroleType_2",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        titleAttrType_2EDataType,
        String.class,
        "TitleAttrType_2",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        actuateTypeEDataType,
        ActuateType.class,
        "ActuateType",
        IS_SERIALIZABLE,
        !IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(rangeClosureTypeEEnum, source, new String[] {"name", "rangeClosure_._type"});
    addAnnotation(
        mimeTypeEDataType,
        source,
        new String[] {
