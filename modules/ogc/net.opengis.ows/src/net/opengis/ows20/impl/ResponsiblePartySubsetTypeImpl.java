 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ResponsiblePartySubsetTypeImpl#getIndividualName
 *       <em>Individual Name</em>}
 *   <li>{@link net.opengis.ows20.impl.ResponsiblePartySubsetTypeImpl#getPositionName <em>Position
 *       Name</em>}
 *   <li>{@link net.opengis.ows20.impl.ResponsiblePartySubsetTypeImpl#getContactInfo <em>Contact
 *       Info</em>}
 *   <li>{@link net.opengis.ows20.impl.ResponsiblePartySubsetTypeImpl#getRole <em>Role</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RESPONSIBLE_PARTY_SUBSET_TYPE__INDIVIDUAL_NAME,
              oldIndividualName,
              individualName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RESPONSIBLE_PARTY_SUBSET_TYPE__POSITION_NAME,
              oldPositionName,
              positionName));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RESPONSIBLE_PARTY_SUBSET_TYPE__CONTACT_INFO,
              oldContactInfo,
              newContactInfo);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RESPONSIBLE_PARTY_SUBSET_TYPE__ROLE,
              oldRole,
              newRole);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (role != null)
        msgs =
            ((InternalEObject) role)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.RESPONSIBLE_PARTY_SUBSET_TYPE__ROLE,
                    null,
                    msgs);
      if (newRole != null)
        msgs =
