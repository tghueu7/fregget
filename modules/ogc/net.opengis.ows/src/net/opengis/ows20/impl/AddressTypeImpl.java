 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getDeliveryPoint <em>Delivery Point</em>}
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getCity <em>City</em>}
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getAdministrativeArea <em>Administrative
 *       Area</em>}
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getCountry <em>Country</em>}
 *   <li>{@link net.opengis.ows20.impl.AddressTypeImpl#getElectronicMailAddress <em>Electronic Mail
 *       Address</em>}
 * </ul>
 *
 * @generated
...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
  ...
  /**
   * The default value of the '{@link #getAdministrativeArea() <em>Administrative Area</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAdministrativeArea() <em>Administrative Area</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getElectronicMailAddress() <em>Electronic Mail Address</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getElectronicMailAddress() <em>Electronic Mail Address</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDRESS_TYPE__DELIVERY_POINT,
              oldDeliveryPoint,
              deliveryPoint));
  }
  ...
  public void setCity(String newCity) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.ADDRESS_TYPE__CITY, oldCity, city));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDRESS_TYPE__ADMINISTRATIVE_AREA,
              oldAdministrativeArea,
              administrativeArea));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDRESS_TYPE__POSTAL_CODE,
              oldPostalCode,
              postalCode));
  }
  ...
  public void setCountry(String newCountry) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.ADDRESS_TYPE__COUNTRY, oldCountry, country));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS,
              oldElectronicMailAddress,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Ows20Package.ADDRESS_TYPE__DELIVERY_POINT:
        return DELIVERY_POINT_EDEFAULT == null
            ? deliveryPoint != null
            : !DELIVERY_POINT_EDEFAULT.equals(deliveryPoint);
      case Ows20Package.ADDRESS_TYPE__CITY:
        return CITY_EDEFAULT == null ? city != null : !CITY_EDEFAULT.equals(city);
      case Ows20Package.ADDRESS_TYPE__ADMINISTRATIVE_AREA:
        return ADMINISTRATIVE_AREA_EDEFAULT == null
            ? administrativeArea != null
            : !ADMINISTRATIVE_AREA_EDEFAULT.equals(administrativeArea);
      case Ows20Package.ADDRESS_TYPE__POSTAL_CODE:
        return POSTAL_CODE_EDEFAULT == null
            ? postalCode != null
            : !POSTAL_CODE_EDEFAULT.equals(postalCode);
      case Ows20Package.ADDRESS_TYPE__COUNTRY:
        return COUNTRY_EDEFAULT == null ? country != null : !COUNTRY_EDEFAULT.equals(country);
      case Ows20Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS:
        return ELECTRONIC_MAIL_ADDRESS_EDEFAULT == null
            ? electronicMailAddress != null
            : !ELECTRONIC_MAIL_ADDRESS_EDEFAULT.equals(electronicMailAddress);
    }
