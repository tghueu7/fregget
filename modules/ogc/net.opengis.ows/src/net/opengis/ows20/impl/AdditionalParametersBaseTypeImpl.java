 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.AdditionalParametersBaseTypeImpl#getAdditionalParameter
 *       <em>Additional Parameter</em>}
 * </ul>
 *
 * @generated
 */
public class AdditionalParametersBaseTypeImpl extends MetadataTypeImpl
    implements AdditionalParametersBaseType {
  /**
   * The cached value of the '{@link #getAdditionalParameter() <em>Additional Parameter</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDITIONAL_PARAMETERS_BASE_TYPE__ADDITIONAL_PARAMETER,
              oldAdditionalParameter,
  ...
  public void setAdditionalParameter(AdditionalParameterType newAdditionalParameter) {
    if (newAdditionalParameter != additionalParameter) {
      ...
      if (additionalParameter != null)
        msgs =
            ((InternalEObject) additionalParameter)
                .eInverseRemove(
                    this,
      ...
      if (newAdditionalParameter != null)
        msgs =
            ((InternalEObject) newAdditionalParameter)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Ows20Package.ADDITIONAL_PARAMETERS_BASE_TYPE__ADDITIONAL_PARAMETER,
