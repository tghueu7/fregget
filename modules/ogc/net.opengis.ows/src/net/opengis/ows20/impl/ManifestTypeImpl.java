 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ManifestTypeImpl#getReferenceGroup <em>Reference Group</em>}
 * </ul>
 *
 * @generated
 */
public class ManifestTypeImpl extends BasicIdentificationTypeImpl implements ManifestType {
  /**
   * The cached value of the '{@link #getReferenceGroup() <em>Reference Group</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<ReferenceGroupType> getReferenceGroup() {
    if (referenceGroup == null) {
      referenceGroup =
          new EObjectContainmentEList<ReferenceGroupType>(
              ReferenceGroupType.class, this, Ows20Package.MANIFEST_TYPE__REFERENCE_GROUP);
    }
