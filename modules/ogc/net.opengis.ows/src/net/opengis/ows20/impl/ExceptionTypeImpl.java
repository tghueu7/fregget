 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ExceptionTypeImpl#getExceptionText <em>Exception Text</em>}
 *   <li>{@link net.opengis.ows20.impl.ExceptionTypeImpl#getExceptionCode <em>Exception Code</em>}
 *   <li>{@link net.opengis.ows20.impl.ExceptionTypeImpl#getLocator <em>Locator</em>}
 * </ul>
 *
 * @generated
 */
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.EXCEPTION_TYPE__EXCEPTION_TEXT,
              oldExceptionText,
              exceptionText));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.EXCEPTION_TYPE__EXCEPTION_CODE,
              oldExceptionCode,
              exceptionCode));
  }
  ...
  public void setLocator(String newLocator) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.EXCEPTION_TYPE__LOCATOR, oldLocator, locator));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Ows20Package.EXCEPTION_TYPE__EXCEPTION_TEXT:
        return EXCEPTION_TEXT_EDEFAULT == null
            ? exceptionText != null
            : !EXCEPTION_TEXT_EDEFAULT.equals(exceptionText);
      case Ows20Package.EXCEPTION_TYPE__EXCEPTION_CODE:
        return EXCEPTION_CODE_EDEFAULT == null
            ? exceptionCode != null
