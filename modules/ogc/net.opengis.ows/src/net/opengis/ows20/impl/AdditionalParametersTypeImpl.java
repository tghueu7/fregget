 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.AdditionalParametersTypeImpl#getAdditionalParameter1
 *       <em>Additional Parameter1</em>}
 * </ul>
 *
 * @generated
 */
public class AdditionalParametersTypeImpl extends AdditionalParametersBaseTypeImpl
    implements AdditionalParametersType {
  /**
   * The cached value of the '{@link #getAdditionalParameter1() <em>Additional Parameter1</em>}'
  ...
  public EList<AdditionalParameterType> getAdditionalParameter1() {
    if (additionalParameter1 == null) {
      additionalParameter1 =
          new EObjectContainmentEList<AdditionalParameterType>(
              AdditionalParameterType.class,
              this,
              Ows20Package.ADDITIONAL_PARAMETERS_TYPE__ADDITIONAL_PARAMETER1);
    }
