...
public class Ows20FactoryImpl extends EFactoryImpl implements Ows20Factory {
  ...
  public static Ows20Factory init() {
    try {
      Ows20Factory theOws20Factory =
          (Ows20Factory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/ows/2.0");
  ...
  public AdditionalParametersBaseType createAdditionalParametersBaseType() {
    AdditionalParametersBaseTypeImpl additionalParametersBaseType =
        new AdditionalParametersBaseTypeImpl();
