 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getDCP <em>DCP</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getMetadataGroup <em>Metadata Group</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class OperationTypeImpl extends EObjectImpl implements OperationType {
  ...
  public EList<DCPType> getDCP() {
    if (dCP == null) {
      dCP =
          new EObjectContainmentEList<DCPType>(
              DCPType.class, this, Ows20Package.OPERATION_TYPE__DCP);
    }
    return dCP;
  }
    ...
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList<DomainType>(
              DomainType.class, this, Ows20Package.OPERATION_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList<DomainType> getConstraint() {
    if (constraint == null) {
      constraint =
          new EObjectContainmentEList<DomainType>(
              DomainType.class, this, Ows20Package.OPERATION_TYPE__CONSTRAINT);
    }
    return constraint;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.OPERATION_TYPE__NAME, oldName, name));
  }
