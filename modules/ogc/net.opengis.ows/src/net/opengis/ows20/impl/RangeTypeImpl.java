 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.RangeTypeImpl#getMinimumValue <em>Minimum Value</em>}
 *   <li>{@link net.opengis.ows20.impl.RangeTypeImpl#getMaximumValue <em>Maximum Value</em>}
 *   <li>{@link net.opengis.ows20.impl.RangeTypeImpl#getSpacing <em>Spacing</em>}
 *   <li>{@link net.opengis.ows20.impl.RangeTypeImpl#getRangeClosure <em>Range Closure</em>}
 * </ul>
 *
 * @generated
 */
public class RangeTypeImpl extends EObjectImpl implements RangeType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RANGE_TYPE__MINIMUM_VALUE,
              oldMinimumValue,
              newMinimumValue);
      ...
      if (minimumValue != null)
        msgs =
            ((InternalEObject) minimumValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.RANGE_TYPE__MINIMUM_VALUE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RANGE_TYPE__MAXIMUM_VALUE,
              oldMaximumValue,
              newMaximumValue);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (maximumValue != null)
        msgs =
            ((InternalEObject) maximumValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.RANGE_TYPE__MAXIMUM_VALUE,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetSpacing(ValueType newSpacing, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.RANGE_TYPE__SPACING, oldSpacing, newSpacing);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setSpacing(ValueType newSpacing) {
    if (newSpacing != spacing) {
      ...
      if (spacing != null)
        msgs =
            ((InternalEObject) spacing)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.RANGE_TYPE__SPACING, null, msgs);
      if (newSpacing != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.RANGE_TYPE__SPACING, newSpacing, newSpacing));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.RANGE_TYPE__RANGE_CLOSURE,
              oldRangeClosure,
              rangeClosure,
              !oldRangeClosureESet));
  }
