 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ReferenceTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.ows20.impl.ReferenceTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.ows20.impl.ReferenceTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.ows20.impl.ReferenceTypeImpl#getMetadataGroup <em>Metadata Group</em>}
 *   <li>{@link net.opengis.ows20.impl.ReferenceTypeImpl#getMetadata <em>Metadata</em>}
 * </ul>
 *
 * @generated
 */
public class ReferenceTypeImpl extends AbstractReferenceBaseTypeImpl implements ReferenceType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.REFERENCE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.REFERENCE_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public EList<LanguageStringType> getAbstract() {
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<LanguageStringType>(
              LanguageStringType.class, this, Ows20Package.REFERENCE_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public void setFormat(String newFormat) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.REFERENCE_TYPE__FORMAT, oldFormat, format));
  }
