 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ServiceReferenceTypeImpl#getRequestMessage <em>Request
 *       Message</em>}
 *   <li>{@link net.opengis.ows20.impl.ServiceReferenceTypeImpl#getRequestMessageReference
 *       <em>Request Message Reference</em>}
 * </ul>
 *
 * @generated
 */
public class ServiceReferenceTypeImpl extends ReferenceTypeImpl implements ServiceReferenceType {
  /**
   * The cached value of the '{@link #getRequestMessage() <em>Request Message</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getRequestMessageReference() <em>Request Message
  ...
  /**
   * The cached value of the '{@link #getRequestMessageReference() <em>Request Message
   * Reference</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetRequestMessage(
      EObject newRequestMessage, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE,
              oldRequestMessage,
              newRequestMessage);
  ...
  public void setRequestMessage(EObject newRequestMessage) {
    if (newRequestMessage != requestMessage) {
      ...
      if (requestMessage != null)
        msgs =
            ((InternalEObject) requestMessage)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE,
                    null,
                    msgs);
      if (newRequestMessage != null)
        msgs =
            ((InternalEObject) newRequestMessage)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE_REFERENCE,
              oldRequestMessageReference,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Ows20Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE_REFERENCE:
        return REQUEST_MESSAGE_REFERENCE_EDEFAULT == null
            ? requestMessageReference != null
            : !REQUEST_MESSAGE_REFERENCE_EDEFAULT.equals(requestMessageReference);
    }
