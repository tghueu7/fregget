 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.DescriptionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.ows20.impl.DescriptionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.ows20.impl.DescriptionTypeImpl#getKeywords <em>Keywords</em>}
 * </ul>
 *
 * @generated
 */
public class DescriptionTypeImpl extends EObjectImpl implements DescriptionType {
    ...
    if (title == null) {
      title =
          new EObjectContainmentEList<LanguageStringType>(
              LanguageStringType.class, this, Ows20Package.DESCRIPTION_TYPE__TITLE);
    }
    return title;
  }
  ...
  public EList<LanguageStringType> getAbstract() {
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList<LanguageStringType>(
              LanguageStringType.class, this, Ows20Package.DESCRIPTION_TYPE__ABSTRACT);
    }
    return abstract_;
  }
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList<KeywordsType>(
              KeywordsType.class, this, Ows20Package.DESCRIPTION_TYPE__KEYWORDS);
    }
    return keywords;
  }
