 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getServiceIdentification <em>Service
 *       Identification</em>}
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getServiceProvider <em>Service
 *       Provider</em>}
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getOperationsMetadata <em>Operations
 *       Metadata</em>}
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getLanguages <em>Languages</em>}
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.ows20.impl.CapabilitiesBaseTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class CapabilitiesBaseTypeImpl extends EObjectImpl implements CapabilitiesBaseType {
  /**
   * The cached value of the '{@link #getServiceIdentification() <em>Service Identification</em>}'
  ...
  /**
   * The cached value of the '{@link #getServiceProvider() <em>Service Provider</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getOperationsMetadata() <em>Operations Metadata</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public void setServiceIdentification(ServiceIdentificationType newServiceIdentification) {
    if (newServiceIdentification != serviceIdentification) {
      ...
      if (serviceIdentification != null)
        msgs =
            ((InternalEObject) serviceIdentification)
                .eInverseRemove(
                    this,
      ...
      if (newServiceIdentification != null)
        msgs =
            ((InternalEObject) newServiceIdentification)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Ows20Package.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER,
              oldServiceProvider,
              newServiceProvider);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setServiceProvider(ServiceProviderType newServiceProvider) {
    if (newServiceProvider != serviceProvider) {
      ...
      if (serviceProvider != null)
        msgs =
            ((InternalEObject) serviceProvider)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER,
                    null,
                    msgs);
      if (newServiceProvider != null)
        msgs =
            ((InternalEObject) newServiceProvider)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER,
                    null,
  ...
  public void setOperationsMetadata(OperationsMetadataType newOperationsMetadata) {
    if (newOperationsMetadata != operationsMetadata) {
      ...
      if (operationsMetadata != null)
        msgs =
            ((InternalEObject) operationsMetadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Ows20Package.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA,
      ...
      if (newOperationsMetadata != null)
        msgs =
            ((InternalEObject) newOperationsMetadata)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Ows20Package.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CAPABILITIES_BASE_TYPE__LANGUAGES,
              oldLanguages,
              newLanguages);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setLanguages(LanguagesType newLanguages) {
    if (newLanguages != languages) {
      ...
      if (languages != null)
        msgs =
            ((InternalEObject) languages)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CAPABILITIES_BASE_TYPE__LANGUAGES,
                    null,
                    msgs);
      if (newLanguages != null)
        msgs =
            ((InternalEObject) newLanguages)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CAPABILITIES_BASE_TYPE__LANGUAGES,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CAPABILITIES_BASE_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CAPABILITIES_BASE_TYPE__VERSION,
              oldVersion,
              version));
  }
