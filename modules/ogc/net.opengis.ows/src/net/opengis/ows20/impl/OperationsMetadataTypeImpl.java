 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.OperationsMetadataTypeImpl#getOperation <em>Operation</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationsMetadataTypeImpl#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationsMetadataTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows20.impl.OperationsMetadataTypeImpl#getExtendedCapabilities
...
public class OperationsMetadataTypeImpl extends EObjectImpl implements OperationsMetadataType {
  ...
  public EList<OperationType> getOperation() {
    if (operation == null) {
      operation =
          new EObjectContainmentEList<OperationType>(
              OperationType.class, this, Ows20Package.OPERATIONS_METADATA_TYPE__OPERATION);
    }
    return operation;
  }
  ...
  public EList<DomainType> getParameter() {
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList<DomainType>(
              DomainType.class, this, Ows20Package.OPERATIONS_METADATA_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList<DomainType> getConstraint() {
    if (constraint == null) {
      constraint =
          new EObjectContainmentEList<DomainType>(
              DomainType.class, this, Ows20Package.OPERATIONS_METADATA_TYPE__CONSTRAINT);
    }
    return constraint;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.OPERATIONS_METADATA_TYPE__EXTENDED_CAPABILITIES,
