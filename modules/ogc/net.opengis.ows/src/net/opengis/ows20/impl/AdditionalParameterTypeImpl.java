 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.AdditionalParameterTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.ows20.impl.AdditionalParameterTypeImpl#getValue <em>Value</em>}
 * </ul>
 *
 * @generated
 */
public class AdditionalParameterTypeImpl extends EObjectImpl implements AdditionalParameterType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.ADDITIONAL_PARAMETER_TYPE__NAME,
              oldName,
              newName);
  ...
  public void setName(CodeType newName) {
    if (newName != name) {
      ...
      if (name != null)
        msgs =
            ((InternalEObject) name)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.ADDITIONAL_PARAMETER_TYPE__NAME,
                    null,
                    msgs);
      if (newName != null)
        msgs =
            ((InternalEObject) newName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.ADDITIONAL_PARAMETER_TYPE__NAME,
                    null,
    ...
    if (value == null) {
      value =
          new EObjectContainmentEList<EObject>(
              EObject.class, this, Ows20Package.ADDITIONAL_PARAMETER_TYPE__VALUE);
    }
    return value;
  }
