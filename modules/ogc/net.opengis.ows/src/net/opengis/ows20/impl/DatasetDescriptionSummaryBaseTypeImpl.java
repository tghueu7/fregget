 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getWGS84BoundingBox
 *       <em>WGS84 Bounding Box</em>}
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getIdentifier
 *       <em>Identifier</em>}
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getBoundingBoxGroup
 *       <em>Bounding Box Group</em>}
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getBoundingBox
 *       <em>Bounding Box</em>}
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getMetadataGroup
 *       <em>Metadata Group</em>}
 *   <li>{@link net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getMetadata
 *       <em>Metadata</em>}
 *   <li>{@link
 *       net.opengis.ows20.impl.DatasetDescriptionSummaryBaseTypeImpl#getDatasetDescriptionSummary
 *       <em>Dataset Description Summary</em>}
 * </ul>
 *
 * @generated
 */
public class DatasetDescriptionSummaryBaseTypeImpl extends DescriptionTypeImpl
  ...
  /**
   * The cached value of the '{@link #getDatasetDescriptionSummary() <em>Dataset Description
   * Summary</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (wGS84BoundingBox == null) {
      wGS84BoundingBox =
          new EObjectContainmentEList<WGS84BoundingBoxType>(
              ...
              this,
              Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__WGS84_BOUNDING_BOX);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(
              this, Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__BOUNDING_BOX_GROUP);
    }
  ...
  public EList<BoundingBoxType> getBoundingBox() {
    return getBoundingBoxGroup()
        .list(Ows20Package.Literals.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__BOUNDING_BOX);
  }
  ...
  public FeatureMap getMetadataGroup() {
    if (metadataGroup == null) {
      metadataGroup =
          new BasicFeatureMap(
              this, Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__METADATA_GROUP);
    }
  ...
  public EList<MetadataType> getMetadata() {
    return getMetadataGroup()
        .list(Ows20Package.Literals.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__METADATA);
  }
  ...
  public EList<DatasetDescriptionSummaryBaseType> getDatasetDescriptionSummary() {
    if (datasetDescriptionSummary == null) {
      datasetDescriptionSummary =
          new EObjectContainmentEList<DatasetDescriptionSummaryBaseType>(
              DatasetDescriptionSummaryBaseType.class,
              this,
              Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY);
    }
    ...
    switch (featureID) {
      ...
      case Ows20Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY:
        ...
        getDatasetDescriptionSummary()
            .addAll((Collection<? extends DatasetDescriptionSummaryBaseType>) newValue);
        return;
    }
