 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ServiceIdentificationTypeImpl#getServiceType <em>Service
 *       Type</em>}
 *   <li>{@link net.opengis.ows20.impl.ServiceIdentificationTypeImpl#getServiceTypeVersion
 *       <em>Service Type Version</em>}
 *   <li>{@link net.opengis.ows20.impl.ServiceIdentificationTypeImpl#getProfile <em>Profile</em>}
 *   <li>{@link net.opengis.ows20.impl.ServiceIdentificationTypeImpl#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.ows20.impl.ServiceIdentificationTypeImpl#getAccessConstraints <em>Access
 *       Constraints</em>}
 * </ul>
 *
 * @generated
...
public class ServiceIdentificationTypeImpl extends DescriptionTypeImpl
  ...
  /**
   * The cached value of the '{@link #getServiceType() <em>Service Type</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getServiceTypeVersion() <em>Service Type Version</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getServiceTypeVersion() <em>Service Type Version</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
              oldServiceType,
              newServiceType);
  ...
  public void setServiceType(CodeType newServiceType) {
    if (newServiceType != serviceType) {
      ...
      if (serviceType != null)
        msgs =
            ((InternalEObject) serviceType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
                    null,
                    msgs);
      if (newServiceType != null)
        msgs =
            ((InternalEObject) newServiceType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION,
              oldServiceTypeVersion,
              serviceTypeVersion));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_IDENTIFICATION_TYPE__PROFILE,
              oldProfile,
              profile));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_IDENTIFICATION_TYPE__FEES,
              oldFees,
              fees));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS,
              oldAccessConstraints,
              accessConstraints));
  }
