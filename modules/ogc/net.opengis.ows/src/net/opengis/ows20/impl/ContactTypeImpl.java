 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.impl.ContactTypeImpl#getPhone <em>Phone</em>}
 *   <li>{@link net.opengis.ows20.impl.ContactTypeImpl#getAddress <em>Address</em>}
 *   <li>{@link net.opengis.ows20.impl.ContactTypeImpl#getOnlineResource <em>Online Resource</em>}
 *   <li>{@link net.opengis.ows20.impl.ContactTypeImpl#getHoursOfService <em>Hours Of Service</em>}
 *   <li>{@link net.opengis.ows20.impl.ContactTypeImpl#getContactInstructions <em>Contact
 *       Instructions</em>}
 * </ul>
 *
 * @generated
...
public class ContactTypeImpl extends EObjectImpl implements ContactType {
  ...
  /**
   * The cached value of the '{@link #getOnlineResource() <em>Online Resource</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getContactInstructions() <em>Contact Instructions</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getContactInstructions() <em>Contact Instructions</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.CONTACT_TYPE__PHONE, oldPhone, newPhone);
  ...
  public void setPhone(TelephoneType newPhone) {
    if (newPhone != phone) {
      ...
      if (phone != null)
        msgs =
            ((InternalEObject) phone)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__PHONE, null, msgs);
      if (newPhone != null)
        msgs =
            ((InternalEObject) newPhone)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__PHONE, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.CONTACT_TYPE__PHONE, newPhone, newPhone));
  }
  ...
  public NotificationChain basicSetAddress(AddressType newAddress, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.CONTACT_TYPE__ADDRESS, oldAddress, newAddress);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setAddress(AddressType newAddress) {
    if (newAddress != address) {
      ...
      if (address != null)
        msgs =
            ((InternalEObject) address)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__ADDRESS, null, msgs);
      if (newAddress != null)
        msgs =
            ((InternalEObject) newAddress)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__ADDRESS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows20Package.CONTACT_TYPE__ADDRESS, newAddress, newAddress));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CONTACT_TYPE__ONLINE_RESOURCE,
              oldOnlineResource,
              newOnlineResource);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setOnlineResource(OnlineResourceType newOnlineResource) {
    if (newOnlineResource != onlineResource) {
      ...
      if (onlineResource != null)
        msgs =
            ((InternalEObject) onlineResource)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__ONLINE_RESOURCE,
                    null,
                    msgs);
      if (newOnlineResource != null)
        msgs =
            ((InternalEObject) newOnlineResource)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows20Package.CONTACT_TYPE__ONLINE_RESOURCE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CONTACT_TYPE__HOURS_OF_SERVICE,
              oldHoursOfService,
              hoursOfService));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows20Package.CONTACT_TYPE__CONTACT_INSTRUCTIONS,
              oldContactInstructions,
              contactInstructions));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Ows20Package.CONTACT_TYPE__HOURS_OF_SERVICE:
        return HOURS_OF_SERVICE_EDEFAULT == null
            ? hoursOfService != null
