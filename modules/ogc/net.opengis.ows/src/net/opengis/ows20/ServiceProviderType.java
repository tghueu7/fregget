 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.ServiceProviderType#getProviderName <em>Provider Name</em>}
 *   <li>{@link net.opengis.ows20.ServiceProviderType#getProviderSite <em>Provider Site</em>}
 *   <li>{@link net.opengis.ows20.ServiceProviderType#getServiceContact <em>Service Contact</em>}
 * </ul>
 *
...
public interface ServiceProviderType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceProviderType#getProviderName
   * <em>Provider Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ProviderSite'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceProviderType#getProviderSite
   * <em>Provider Site</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Information for contacting the service provider. The OnlineResource element within this
   * ServiceContact element should not be used to reference a web site of the service provider.
   * <!-- end-model-doc -->
   *
   ...
   *     name='ServiceContact' namespace='##targetNamespace'"
   * @generated
   */
  ResponsiblePartySubsetType getServiceContact();

  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceProviderType#getServiceContact
   * <em>Service Contact</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
