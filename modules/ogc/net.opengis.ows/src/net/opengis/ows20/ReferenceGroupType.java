 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Logical group of one or more references to remote and/or local resources, allowing including
 * metadata about that group. A Group can be used instead of a Manifest that can only contain one
 * group.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.ReferenceGroupType#getAbstractReferenceBaseGroup <em>Abstract
 *       Reference Base Group</em>}
 *   <li>{@link net.opengis.ows20.ReferenceGroupType#getAbstractReferenceBase <em>Abstract Reference
 *       Base</em>}
 * </ul>
 *
...
public interface ReferenceGroupType extends BasicIdentificationType {
  /**
   * Returns the value of the '<em><b>Abstract Reference Base Group</b></em>' attribute list. The
   * list contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Reference Base Group</em>' attribute list isn't clear,
   ...
   *     many="true" extendedMetaData="kind='group' name='AbstractReferenceBase:group'
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Reference Base</em>' containment reference list isn't
   ...
   *     namespace='##targetNamespace' group='AbstractReferenceBase:group'"
   * @generated
   */
