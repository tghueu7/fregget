 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.ServiceIdentificationType#getServiceType <em>Service Type</em>}
 *   <li>{@link net.opengis.ows20.ServiceIdentificationType#getServiceTypeVersion <em>Service Type
 *       Version</em>}
 *   <li>{@link net.opengis.ows20.ServiceIdentificationType#getProfile <em>Profile</em>}
 *   <li>{@link net.opengis.ows20.ServiceIdentificationType#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.ows20.ServiceIdentificationType#getAccessConstraints <em>Access
 *       Constraints</em>}
 * </ul>
 *
...
public interface ServiceIdentificationType extends DescriptionType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A service type name from a registry of services. For example, the values of the codeSpace URI
   * and name and code string may be "OGC" and "catalogue." This type name is normally used for
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='ServiceType'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceIdentificationType#getServiceType
   * <em>Service Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of one or more versions of this service type implemented by this server. This
   * information is not adequate for version negotiation, and shall not be used for that purpose.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceIdentificationType#getServiceTypeVersion
   * <em>Service Type Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of identifiers of Application Profiles that are implemented by this server. This
   * element should be included for each specified application profile implemented by this server.
   * The identifier value should be specified by each Application Profile. If this element is
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceIdentificationType#getProfile
   * <em>Profile</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceIdentificationType#getFees
   * <em>Fees</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of access constraints applied to assure the protection of privacy or
   * intellectual property, and any other restrictions on retrieving or using data from or otherwise
   * using this server. The reserved value NONE (case insensitive) shall be used to mean no access
   * constraints are imposed. When this element is omitted, no meaning is implied.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.ServiceIdentificationType#getAccessConstraints
   * <em>Access Constraints</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
