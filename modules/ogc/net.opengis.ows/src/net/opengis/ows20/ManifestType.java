 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.ManifestType#getReferenceGroup <em>Reference Group</em>}
 * </ul>
 *
...
public interface ManifestType extends BasicIdentificationType {
  /**
   * Returns the value of the '<em><b>Reference Group</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.ows20.ReferenceGroupType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Reference Group</em>' containment reference list isn't clear,
   ...
   *     name='ReferenceGroup' namespace='##targetNamespace'"
   * @generated
   */
