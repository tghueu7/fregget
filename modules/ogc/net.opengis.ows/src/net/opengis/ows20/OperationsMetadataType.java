 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.OperationsMetadataType#getOperation <em>Operation</em>}
 *   <li>{@link net.opengis.ows20.OperationsMetadataType#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows20.OperationsMetadataType#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows20.OperationsMetadataType#getExtendedCapabilities <em>Extended
 *       Capabilities</em>}
 * </ul>
 *
...
public interface OperationsMetadataType extends EObject {
  /**
   * Returns the value of the '<em><b>Operation</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.ows20.OperationType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" lower="2" extendedMetaData="kind='element' name='Operation'
   ...
   * to this server. The list of required and optional constraints shall be specified in the
   * Implementation Specification for this service.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ExtendedCapabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.OperationsMetadataType#getExtendedCapabilities
