 ...
 * Each Section value shall contain an allowed section name as specified by each OWS specification.
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.SectionsType#getSection <em>Section</em>}
 * </ul>
 *
...
public interface SectionsType extends EObject {
  /**
   * Returns the value of the '<em><b>Section</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Section</em>' attribute list isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Section</em>' attribute list.
   * @see net.opengis.ows20.Ows20Package#getSectionsType_Section()
   * @model unique="false" extendedMetaData="kind='element' name='Section'
