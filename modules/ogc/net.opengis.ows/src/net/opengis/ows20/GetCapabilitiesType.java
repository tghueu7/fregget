 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getAcceptLanguages <em>Accept Languages</em>}
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.ows20.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}
 * </ul>
 *
...
public interface GetCapabilitiesType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getAcceptVersions
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getSections
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getAcceptFormats <em>Accept
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered list of languages desired by the client for all human readable text in the response, in
   * order of preference. For every element, the first matching language available from the server
   ...
   * @model containment="true" extendedMetaData="kind='element' name='AcceptLanguages'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getAcceptLanguages
   * <em>Accept Languages</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.GetCapabilitiesType#getBaseUrl <em>Base
   * Url</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
