 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.OperationType#getDCP <em>DCP</em>}
 *   <li>{@link net.opengis.ows20.OperationType#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows20.OperationType#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows20.OperationType#getMetadataGroup <em>Metadata Group</em>}
 *   <li>{@link net.opengis.ows20.OperationType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows20.OperationType#getName <em>Name</em>}
 * </ul>
 *
...
public interface OperationType extends EObject {
  /**
   * Returns the value of the '<em><b>DCP</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.ows20.DCPType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='DCP'
   ...
   * contents are of type {@link net.opengis.ows20.DomainType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * other one for this operation. The list of required and optional parameter domain limitations
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Optional unordered list of valid domain constraints on non-parameter quantities that each apply
   * to this operation. If one of these Constraint elements has the same "name" attribute as a
   * Constraint element in the OperationsMetadata element, this Constraint element shall override
   * the other one for this operation. The list of required and optional constraints for this
   * operation shall be specified in the Implementation Specification for this service.
   * <!-- end-model-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Optional unordered list of additional metadata about this operation and its' implementation. A
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.OperationType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
