 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.IdentificationType#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.ows20.IdentificationType#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.ows20.IdentificationType#getOutputFormat <em>Output Format</em>}
 *   <li>{@link net.opengis.ows20.IdentificationType#getAvailableCRSGroup <em>Available CRS
 *       Group</em>}
 *   <li>{@link net.opengis.ows20.IdentificationType#getAvailableCRS <em>Available CRS</em>}
 * </ul>
 *
...
public interface IdentificationType extends BasicIdentificationType {
   ...
   * @model unique="false" dataType="net.opengis.ows20.MimeType" extendedMetaData="kind='element'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.IdentificationType#getOutputFormat <em>Output
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.IdentificationType#getAvailableCRS
