 ...
 * xlink:simpleAttrs shall be included. Either at least one of the attributes in xlink:simpleAttrs
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows20.MetadataType#getAbstractMetaDataGroup <em>Abstract Meta Data
 *       Group</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getAbstractMetaData <em>Abstract Meta Data</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getAbout <em>About</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.ows20.MetadataType#getType <em>Type</em>}
 * </ul>
 *
...
public interface MetadataType extends EObject {
  /**
   * Returns the value of the '<em><b>Abstract Meta Data Group</b></em>' attribute list. The list
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.MetadataType#getAbout <em>About</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.MetadataType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.ows20.MetadataType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.ows20.MetadataType#getActuate
   ...
   * @model dataType="net.opengis.ows20.ArcroleType_1" extendedMetaData="kind='attribute'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.MetadataType#getArcrole <em>Arcrole</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.ows20.HrefType_1" extendedMetaData="kind='attribute' name='href'
   ...
   * @model dataType="net.opengis.ows20.RoleType_1" extendedMetaData="kind='attribute' name='role'
   *     namespace='http://www.w3.org/1999/xlink'"
   * @generated
   */
  String getRole();
  ...
  /**
   * Unsets the value of the '{@link net.opengis.ows20.MetadataType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.ows20.MetadataType#getShow <em>Show</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.ows20.TitleAttrType_1" extendedMetaData="kind='attribute'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows20.MetadataType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.ows20.MetadataType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.ows20.MetadataType#getType <em>Type</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
