 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Prioritized sequence of one or more specification versions accepted by client, with preferred
 * versions listed first. See Version negotiation subclause for more information.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.AcceptVersionsType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface AcceptVersionsType extends EObject {
  /**
   * Returns the value of the '<em><b>Version</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Version</em>' attribute list isn't clear, there really should be
