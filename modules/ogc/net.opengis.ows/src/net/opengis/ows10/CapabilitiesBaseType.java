 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.CapabilitiesBaseType#getServiceIdentification <em>Service
 *       Identification</em>}
 *   <li>{@link net.opengis.ows10.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}
 *   <li>{@link net.opengis.ows10.CapabilitiesBaseType#getOperationsMetadata <em>Operations
 *       Metadata</em>}
 *   <li>{@link net.opengis.ows10.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.ows10.CapabilitiesBaseType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface CapabilitiesBaseType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Service Identification</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CapabilitiesBaseType#getServiceIdentification
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Service Provider</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CapabilitiesBaseType#getServiceProvider
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Operations Metadata</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CapabilitiesBaseType#getOperationsMetadata
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Update Sequence</em>' attribute isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CapabilitiesBaseType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CapabilitiesBaseType#getVersion
