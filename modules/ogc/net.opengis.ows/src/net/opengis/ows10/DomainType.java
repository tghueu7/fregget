 ...
 * non-parameter quantity may not be explicitly represented in the server software. (Informative: An
 * example is the outputFormat parameter of a WFS. Each WFS server should provide a Parameter
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.DomainType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.ows10.DomainType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows10.DomainType#getName <em>Name</em>}
 * </ul>
 *
...
public interface DomainType extends EObject {
   ...
   * values in the list. The allowed set of values and the allowed server restrictions on that set
   * of values shall be specified in the Implementation Specification for this service.
   * <!-- end-model-doc -->
   *
   ...
   * Specification for this service. (Informative: This metadata might specify the meanings of the
   * valid values.)
   * <!-- end-model-doc -->
   *
