 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.ServiceIdentificationType#getServiceType <em>Service Type</em>}
 *   <li>{@link net.opengis.ows10.ServiceIdentificationType#getServiceTypeVersion <em>Service Type
 *       Version</em>}
 *   <li>{@link net.opengis.ows10.ServiceIdentificationType#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.ows10.ServiceIdentificationType#getAccessConstraints <em>Access
 *       Constraints</em>}
 * </ul>
 *
...
public interface ServiceIdentificationType extends DescriptionType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ServiceIdentificationType#getServiceType
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ServiceIdentificationType#getServiceTypeVersion
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ServiceIdentificationType#getFees
   ...
   * constraints are imposed. If this element is omitted, no meaning is implied.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ServiceIdentificationType#getAccessConstraints
