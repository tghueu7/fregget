 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.AcceptVersionsTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class AcceptVersionsTypeImpl extends EObjectImpl implements AcceptVersionsType {
  ...
  public EList getVersion() {
    if (version == null) {
      version =
          new EDataTypeUniqueEList(String.class, this, Ows10Package.ACCEPT_VERSIONS_TYPE__VERSION);
    }
    return version;
  }
