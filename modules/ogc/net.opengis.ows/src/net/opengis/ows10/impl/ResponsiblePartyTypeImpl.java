 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual
 *       Name</em>}
 *   <li>{@link net.opengis.ows10.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation
 *       Name</em>}
 *   <li>{@link net.opengis.ows10.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position
 *       Name</em>}
 *   <li>{@link net.opengis.ows10.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact
 *       Info</em>}
 *   <li>{@link net.opengis.ows10.impl.ResponsiblePartyTypeImpl#getRole <em>Role</em>}
 * </ul>
 *
 * @generated
 */
public class ResponsiblePartyTypeImpl extends EObjectImpl implements ResponsiblePartyType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME,
              oldIndividualName,
              individualName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME,
              oldOrganisationName,
              organisationName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME,
              oldPositionName,
              positionName));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO,
              oldContactInfo,
              newContactInfo);
      ...
      if (contactInfo != null)
        msgs =
            ((InternalEObject) contactInfo)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetRole(CodeType newRole, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.RESPONSIBLE_PARTY_TYPE__ROLE, oldRole, newRole);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setRole(CodeType newRole) {
    if (newRole != role) {
      ...
      if (role != null)
        msgs =
            ((InternalEObject) role)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.RESPONSIBLE_PARTY_TYPE__ROLE,
                    null,
                    msgs);
      if (newRole != null)
        msgs =
            ((InternalEObject) newRole)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.RESPONSIBLE_PARTY_TYPE__ROLE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.RESPONSIBLE_PARTY_TYPE__ROLE, newRole, newRole));
  }
