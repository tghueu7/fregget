 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.ServiceProviderTypeImpl#getProviderName <em>Provider
 *       Name</em>}
 *   <li>{@link net.opengis.ows10.impl.ServiceProviderTypeImpl#getProviderSite <em>Provider
 *       Site</em>}
 *   <li>{@link net.opengis.ows10.impl.ServiceProviderTypeImpl#getServiceContact <em>Service
 *       Contact</em>}
 * </ul>
 *
 * @generated
...
public class ServiceProviderTypeImpl extends EObjectImpl implements ServiceProviderType {
  ...
  /**
   * The cached value of the '{@link #getProviderSite() <em>Provider Site</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getServiceContact() <em>Service Contact</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_NAME,
              oldProviderName,
              providerName));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetProviderSite(
      OnlineResourceType newProviderSite, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
              oldProviderSite,
              newProviderSite);
  ...
  public void setProviderSite(OnlineResourceType newProviderSite) {
    if (newProviderSite != providerSite) {
      ...
      if (providerSite != null)
        msgs =
            ((InternalEObject) providerSite)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
                    null,
                    msgs);
      if (newProviderSite != null)
        msgs =
            ((InternalEObject) newProviderSite)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetServiceContact(
      ResponsiblePartySubsetType newServiceContact, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
              oldServiceContact,
              newServiceContact);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setServiceContact(ResponsiblePartySubsetType newServiceContact) {
    if (newServiceContact != serviceContact) {
      ...
      if (serviceContact != null)
        msgs =
            ((InternalEObject) serviceContact)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
                    null,
                    msgs);
      if (newServiceContact != null)
        msgs =
            ((InternalEObject) newServiceContact)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
                    null,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_NAME:
        return PROVIDER_NAME_EDEFAULT == null
            ? providerName != null
            : !PROVIDER_NAME_EDEFAULT.equals(providerName);
      case Ows10Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE:
