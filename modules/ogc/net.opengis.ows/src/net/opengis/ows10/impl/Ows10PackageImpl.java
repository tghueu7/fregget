...
public class Ows10PackageImpl extends EPackageImpl implements Ows10Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Ows10Package#eINSTANCE} when that field is
  ...
  public static Ows10Package init() {
    if (isInited)
      return (Ows10Package) EPackage.Registry.INSTANCE.getEPackage(Ows10Package.eNS_URI);

    // Obtain or create and register package
    Ows10PackageImpl theOws10Package =
        (Ows10PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ows10PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Ows10PackageImpl());
