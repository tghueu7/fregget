 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.TelephoneTypeImpl#getVoice <em>Voice</em>}
 *   <li>{@link net.opengis.ows10.impl.TelephoneTypeImpl#getFacsimile <em>Facsimile</em>}
 * </ul>
 *
 * @generated
 */
public class TelephoneTypeImpl extends EObjectImpl implements TelephoneType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.TELEPHONE_TYPE__VOICE, oldVoice, voice));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.TELEPHONE_TYPE__FACSIMILE,
              oldFacsimile,
              facsimile));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Ows10Package.TELEPHONE_TYPE__FACSIMILE:
        return FACSIMILE_EDEFAULT == null
            ? facsimile != null
            : !FACSIMILE_EDEFAULT.equals(facsimile);
    }
