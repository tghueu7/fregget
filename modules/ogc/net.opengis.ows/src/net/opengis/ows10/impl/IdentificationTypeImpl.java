 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getAvailableCRSGroup <em>Available CRS
 *       Group</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getAvailableCRS <em>Available
 *       CRS</em>}
 *   <li>{@link net.opengis.ows10.impl.IdentificationTypeImpl#getMetadata <em>Metadata</em>}
 * </ul>
 *
 * @generated
 */
public class IdentificationTypeImpl extends DescriptionTypeImpl implements IdentificationType {
  ...
  /**
   * The cached value of the '{@link #getAvailableCRSGroup() <em>Available CRS Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.IDENTIFICATION_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.IDENTIFICATION_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Ows10Package.IDENTIFICATION_TYPE__BOUNDING_BOX_GROUP);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.IDENTIFICATION_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat));
  }
  ...
  public FeatureMap getAvailableCRSGroup() {
    if (availableCRSGroup == null) {
      availableCRSGroup =
          new BasicFeatureMap(this, Ows10Package.IDENTIFICATION_TYPE__AVAILABLE_CRS_GROUP);
    }
  ...
  public String getAvailableCRS() {
    return (String)
        getAvailableCRSGroup()
            .get(Ows10Package.eINSTANCE.getIdentificationType_AvailableCRS(), true);
  }
  ...
  public void setAvailableCRS(String newAvailableCRS) {
    ((FeatureMap.Internal) getAvailableCRSGroup())
        .set(Ows10Package.eINSTANCE.getIdentificationType_AvailableCRS(), newAvailableCRS);
  }
    ...
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Ows10Package.IDENTIFICATION_TYPE__METADATA);
    }
    return metadata;
  }
