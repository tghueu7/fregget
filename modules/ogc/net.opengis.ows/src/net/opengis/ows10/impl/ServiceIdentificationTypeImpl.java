 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.ServiceIdentificationTypeImpl#getServiceType <em>Service
 *       Type</em>}
 *   <li>{@link net.opengis.ows10.impl.ServiceIdentificationTypeImpl#getServiceTypeVersion
 *       <em>Service Type Version</em>}
 *   <li>{@link net.opengis.ows10.impl.ServiceIdentificationTypeImpl#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.ows10.impl.ServiceIdentificationTypeImpl#getAccessConstraints <em>Access
 *       Constraints</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
              oldServiceType,
              newServiceType);
      ...
      if (serviceType != null)
        msgs =
            ((InternalEObject) serviceType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_IDENTIFICATION_TYPE__FEES,
              oldFees,
              fees));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS,
