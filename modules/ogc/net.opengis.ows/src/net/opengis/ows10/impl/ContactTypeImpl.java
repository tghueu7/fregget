 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.ContactTypeImpl#getPhone <em>Phone</em>}
 *   <li>{@link net.opengis.ows10.impl.ContactTypeImpl#getAddress <em>Address</em>}
 *   <li>{@link net.opengis.ows10.impl.ContactTypeImpl#getOnlineResource <em>Online Resource</em>}
 *   <li>{@link net.opengis.ows10.impl.ContactTypeImpl#getHoursOfService <em>Hours Of Service</em>}
 *   <li>{@link net.opengis.ows10.impl.ContactTypeImpl#getContactInstructions <em>Contact
 *       Instructions</em>}
 * </ul>
 *
 * @generated
...
public class ContactTypeImpl extends EObjectImpl implements ContactType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.CONTACT_TYPE__PHONE, oldPhone, newPhone);
  ...
  public void setPhone(TelephoneType newPhone) {
    if (newPhone != phone) {
      ...
      if (phone != null)
        msgs =
            ((InternalEObject) phone)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows10Package.CONTACT_TYPE__PHONE, null, msgs);
      if (newPhone != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.CONTACT_TYPE__PHONE, newPhone, newPhone));
  }
  ...
  public NotificationChain basicSetAddress(AddressType newAddress, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.CONTACT_TYPE__ADDRESS, oldAddress, newAddress);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setAddress(AddressType newAddress) {
    if (newAddress != address) {
      ...
      if (address != null)
        msgs =
            ((InternalEObject) address)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows10Package.CONTACT_TYPE__ADDRESS, null, msgs);
      if (newAddress != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.CONTACT_TYPE__ADDRESS, newAddress, newAddress));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.CONTACT_TYPE__ONLINE_RESOURCE,
              oldOnlineResource,
              newOnlineResource);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (onlineResource != null)
        msgs =
            ((InternalEObject) onlineResource)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.CONTACT_TYPE__ONLINE_RESOURCE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.CONTACT_TYPE__HOURS_OF_SERVICE,
              oldHoursOfService,
              hoursOfService));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.CONTACT_TYPE__CONTACT_INSTRUCTIONS,
