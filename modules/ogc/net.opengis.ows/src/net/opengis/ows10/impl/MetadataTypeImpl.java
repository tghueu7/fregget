 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.MetadataTypeImpl#getAbstractMetaDataGroup <em>Abstract Meta
 *       Data Group</em>}
 *   <li>{@link net.opengis.ows10.impl.MetadataTypeImpl#getAbstractMetaData <em>Abstract Meta
 *       Data</em>}
 *   <li>{@link net.opengis.ows10.impl.MetadataTypeImpl#getAbout <em>About</em>}
 * </ul>
 *
 * @generated
 */
public class MetadataTypeImpl extends EObjectImpl implements MetadataType {
  ...
  public FeatureMap getAbstractMetaDataGroup() {
    if (abstractMetaDataGroup == null) {
      abstractMetaDataGroup =
          new BasicFeatureMap(this, Ows10Package.METADATA_TYPE__ABSTRACT_META_DATA_GROUP);
    }
  ...
  public EObject getAbstractMetaData() {
    return (EObject)
        getAbstractMetaDataGroup()
            .get(Ows10Package.eINSTANCE.getMetadataType_AbstractMetaData(), true);
  }
  ...
  public NotificationChain basicSetAbstractMetaData(
    ...
    return ((FeatureMap.Internal) getAbstractMetaDataGroup())
        .basicAdd(
            Ows10Package.eINSTANCE.getMetadataType_AbstractMetaData(), newAbstractMetaData, msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.METADATA_TYPE__ABOUT, oldAbout, about));
  }
