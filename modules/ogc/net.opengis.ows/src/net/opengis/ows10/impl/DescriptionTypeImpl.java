 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.DescriptionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.ows10.impl.DescriptionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.ows10.impl.DescriptionTypeImpl#getKeywords <em>Keywords</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.DESCRIPTION_TYPE__TITLE, oldTitle, title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.DESCRIPTION_TYPE__ABSTRACT,
              oldAbstract,
              abstract_));
  }
    ...
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, Ows10Package.DESCRIPTION_TYPE__KEYWORDS);
    }
    return keywords;
  }
