 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getAcceptVersions <em>Accept
 *       Versions</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getAcceptFormats <em>Accept
 *       Formats</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getUpdateSequence <em>Update
 *       Sequence</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getNamespace <em>Namespace</em>}
 *   <li>{@link net.opengis.ows10.impl.GetCapabilitiesTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
              oldAcceptVersions,
              newAcceptVersions);
      ...
      if (acceptVersions != null)
        msgs =
            ((InternalEObject) acceptVersions)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__SECTIONS,
              oldSections,
              newSections);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (sections != null)
        msgs =
            ((InternalEObject) sections)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.GET_CAPABILITIES_TYPE__SECTIONS,
                    null,
                    msgs);
      if (newSections != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__ACCEPT_FORMATS,
              oldAcceptFormats,
              newAcceptFormats);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (acceptFormats != null)
        msgs =
            ((InternalEObject) acceptFormats)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows10Package.GET_CAPABILITIES_TYPE__ACCEPT_FORMATS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE,
              oldUpdateSequence,
              updateSequence));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.GET_CAPABILITIES_TYPE__NAMESPACE,
              oldNamespace,
              namespace));
  }
