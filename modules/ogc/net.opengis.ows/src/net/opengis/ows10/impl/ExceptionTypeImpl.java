 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.ExceptionTypeImpl#getExceptionText <em>Exception Text</em>}
 *   <li>{@link net.opengis.ows10.impl.ExceptionTypeImpl#getExceptionCode <em>Exception Code</em>}
 *   <li>{@link net.opengis.ows10.impl.ExceptionTypeImpl#getLocator <em>Locator</em>}
 * </ul>
 *
 * @generated
 */
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
  ...
  public EList getExceptionText() {
    if (exceptionText == null) {
      exceptionText =
          new EDataTypeUniqueEList(String.class, this, Ows10Package.EXCEPTION_TYPE__EXCEPTION_TEXT);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.EXCEPTION_TYPE__EXCEPTION_CODE,
              oldExceptionCode,
              exceptionCode));
  }
  ...
  public void setLocator(String newLocator) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.EXCEPTION_TYPE__LOCATOR, oldLocator, locator));
  }
