 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.OperationsMetadataTypeImpl#getOperation <em>Operation</em>}
 *   <li>{@link net.opengis.ows10.impl.OperationsMetadataTypeImpl#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows10.impl.OperationsMetadataTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows10.impl.OperationsMetadataTypeImpl#getExtendedCapabilities
...
public class OperationsMetadataTypeImpl extends EObjectImpl implements OperationsMetadataType {
    ...
    if (operation == null) {
      operation =
          new EObjectContainmentEList(
              OperationType.class, this, Ows10Package.OPERATIONS_METADATA_TYPE__OPERATION);
    }
    return operation;
  }
  ...
  public EList getParameter() {
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList(
              DomainType.class, this, Ows10Package.OPERATIONS_METADATA_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList getConstraint() {
    if (constraint == null) {
      constraint =
          new EObjectContainmentEList(
              DomainType.class, this, Ows10Package.OPERATIONS_METADATA_TYPE__CONSTRAINT);
    }
    return constraint;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.OPERATIONS_METADATA_TYPE__EXTENDED_CAPABILITIES,
