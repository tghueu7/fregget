 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.DomainTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.ows10.impl.DomainTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows10.impl.DomainTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class DomainTypeImpl extends EObjectImpl implements DomainType {
  ...
  public EList getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(MetadataType.class, this, Ows10Package.DOMAIN_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.DOMAIN_TYPE__NAME, oldName, name));
  }
