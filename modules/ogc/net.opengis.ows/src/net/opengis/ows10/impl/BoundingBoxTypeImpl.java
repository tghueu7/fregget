 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.impl.BoundingBoxTypeImpl#getLowerCorner <em>Lower Corner</em>}
 *   <li>{@link net.opengis.ows10.impl.BoundingBoxTypeImpl#getUpperCorner <em>Upper Corner</em>}
 *   <li>{@link net.opengis.ows10.impl.BoundingBoxTypeImpl#getCrs <em>Crs</em>}
 *   <li>{@link net.opengis.ows10.impl.BoundingBoxTypeImpl#getDimensions <em>Dimensions</em>}
 * </ul>
 *
 * @generated
 */
public class BoundingBoxTypeImpl extends EObjectImpl implements BoundingBoxType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.BOUNDING_BOX_TYPE__LOWER_CORNER,
              oldLowerCorner,
              lowerCorner));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.BOUNDING_BOX_TYPE__UPPER_CORNER,
              oldUpperCorner,
              upperCorner));
  }
  ...
  public void setCrs(String newCrs) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows10Package.BOUNDING_BOX_TYPE__CRS, oldCrs, crs));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows10Package.BOUNDING_BOX_TYPE__DIMENSIONS,
              oldDimensions,
              dimensions));
  }
