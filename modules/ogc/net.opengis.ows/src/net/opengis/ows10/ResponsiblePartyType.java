 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Identification of, and means of communication with, person responsible for the server. At least
 * one of IndividualName, OrganisationName, or PositionName shall be included.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}
 *   <li>{@link net.opengis.ows10.ResponsiblePartyType#getOrganisationName <em>Organisation
 *       Name</em>}
 *   <li>{@link net.opengis.ows10.ResponsiblePartyType#getPositionName <em>Position Name</em>}
 *   <li>{@link net.opengis.ows10.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}
 *   <li>{@link net.opengis.ows10.ResponsiblePartyType#getRole <em>Role</em>}
 * </ul>
 *
...
public interface ResponsiblePartyType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ResponsiblePartyType#getIndividualName
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Organisation Name</em>' attribute isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ResponsiblePartyType#getOrganisationName
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ResponsiblePartyType#getPositionName
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ResponsiblePartyType#getContactInfo <em>Contact
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Role'
   *     namespace='##targetNamespace'"
   * @generated
   */
  CodeType getRole();
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.ResponsiblePartyType#getRole <em>Role</em>}'
