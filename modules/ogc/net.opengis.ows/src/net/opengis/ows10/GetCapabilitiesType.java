 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getSections <em>Sections</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getNamespace <em>Namespace</em>}
 *   <li>{@link net.opengis.ows10.GetCapabilitiesType#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
...
public interface GetCapabilitiesType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getAcceptVersions
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getSections
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getAcceptFormats <em>Accept
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getBaseUrl <em>Base
   * Url</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getNamespace
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.GetCapabilitiesType#getExtendedProperties
