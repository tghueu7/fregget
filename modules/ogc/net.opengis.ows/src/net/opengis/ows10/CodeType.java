 ...
 * organisation who assigned the value, or the dictionary from which it is taken. Type copied from
 * basicTypes.xsd of GML 3 with documentation edited, for possible use outside the
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.CodeType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.ows10.CodeType#getCodeSpace <em>Code Space</em>}
 * </ul>
 *
...
public interface CodeType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.CodeType#getCodeSpace <em>Code Space</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
