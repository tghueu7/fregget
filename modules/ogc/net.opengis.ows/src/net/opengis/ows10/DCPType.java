 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows10.DCPType#getHTTP <em>HTTP</em>}
 * </ul>
 *
...
public interface DCPType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='HTTP'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows10.DCPType#getHTTP <em>HTTP</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
