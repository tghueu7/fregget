 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.OperationType#getDCP <em>DCP</em>}
 *   <li>{@link net.opengis.ows11.OperationType#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows11.OperationType#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows11.OperationType#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows11.OperationType#getName <em>Name</em>}
 * </ul>
 *
...
public interface OperationType extends EObject {
   ...
   * are of type {@link net.opengis.ows11.DCPType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * contents are of type {@link net.opengis.ows11.DomainType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model type="net.opengis.ows11.DomainType" containment="true" extendedMetaData="kind='element'
   ...
   * @model type="net.opengis.ows11.DomainType" containment="true" extendedMetaData="kind='element'
   *     name='Constraint' namespace='##targetNamespace'"
   * @generated
   */
  EList getConstraint();
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.OperationType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
