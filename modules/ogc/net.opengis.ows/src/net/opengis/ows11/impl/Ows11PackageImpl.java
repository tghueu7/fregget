...
public class Ows11PackageImpl extends EPackageImpl implements Ows11Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Ows11Package#eINSTANCE} when that field is
  ...
  public static Ows11Package init() {
    if (isInited)
      return (Ows11Package) EPackage.Registry.INSTANCE.getEPackage(Ows11Package.eNS_URI);

    // Obtain or create and register package
    Ows11PackageImpl theOws11Package =
        (Ows11PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ows11PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Ows11PackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getGetCapabilitiesType_Namespace(),
        theXMLTypePackage.getString(),
        "namespace",
        null,
        0,
