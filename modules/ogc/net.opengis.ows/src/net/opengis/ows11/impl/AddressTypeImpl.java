 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getDeliveryPoint <em>Delivery Point</em>}
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getCity <em>City</em>}
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getAdministrativeArea <em>Administrative
 *       Area</em>}
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getCountry <em>Country</em>}
 *   <li>{@link net.opengis.ows11.impl.AddressTypeImpl#getElectronicMailAddress <em>Electronic Mail
 *       Address</em>}
 * </ul>
 *
 * @generated
...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
  ...
  public EList getDeliveryPoint() {
    if (deliveryPoint == null) {
      deliveryPoint =
          new EDataTypeEList(String.class, this, Ows11Package.ADDRESS_TYPE__DELIVERY_POINT);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.ADDRESS_TYPE__CITY, oldCity, city));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ADDRESS_TYPE__ADMINISTRATIVE_AREA,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ADDRESS_TYPE__POSTAL_CODE,
              oldPostalCode,
              postalCode));
  }
  ...
  public void setCountry(String newCountry) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.ADDRESS_TYPE__COUNTRY, oldCountry, country));
  }
  ...
  public EList getElectronicMailAddress() {
    if (electronicMailAddress == null) {
      electronicMailAddress =
          new EDataTypeEList(
              String.class, this, Ows11Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS);
    }
