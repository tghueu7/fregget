 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ServiceReferenceTypeImpl#getRequestMessage <em>Request
 *       Message</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceReferenceTypeImpl#getRequestMessageReference
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE,
              oldRequestMessage,
              newRequestMessage);
      ...
      if (requestMessage != null)
        msgs =
            ((InternalEObject) requestMessage)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE_REFERENCE,
