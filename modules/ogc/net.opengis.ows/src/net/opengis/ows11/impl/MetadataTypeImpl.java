 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.MetadataTypeImpl#getAbstractMetaDataGroup <em>Abstract Meta
 *       Data Group</em>}
 *   <li>{@link net.opengis.ows11.impl.MetadataTypeImpl#getAbstractMetaData <em>Abstract Meta
 *       Data</em>}
 *   <li>{@link net.opengis.ows11.impl.MetadataTypeImpl#getAbout <em>About</em>}
 *   <li>{@link net.opengis.ows11.impl.MetadataTypeImpl#getTitle <em>Title</em>}
 * </ul>
 *
 * @generated
 */
public class MetadataTypeImpl extends EObjectImpl implements MetadataType {
  ...
  public FeatureMap getAbstractMetaDataGroup() {
    if (abstractMetaDataGroup == null) {
      abstractMetaDataGroup =
          new BasicFeatureMap(this, Ows11Package.METADATA_TYPE__ABSTRACT_META_DATA_GROUP);
    }
  ...
  public EObject getAbstractMetaData() {
    return (EObject)
        getAbstractMetaDataGroup()
            .get(Ows11Package.Literals.METADATA_TYPE__ABSTRACT_META_DATA, true);
  }
  ...
  public NotificationChain basicSetAbstractMetaData(
    ...
    return ((FeatureMap.Internal) getAbstractMetaDataGroup())
        .basicAdd(
            Ows11Package.Literals.METADATA_TYPE__ABSTRACT_META_DATA, newAbstractMetaData, msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.METADATA_TYPE__ABOUT, oldAbout, about));
  }
  ...
  public void setTitle(String newTitle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.METADATA_TYPE__TITLE, oldTitle, title));
  }
