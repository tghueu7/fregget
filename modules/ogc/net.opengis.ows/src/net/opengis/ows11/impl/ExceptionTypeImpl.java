 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ExceptionTypeImpl#getExceptionText <em>Exception Text</em>}
 *   <li>{@link net.opengis.ows11.impl.ExceptionTypeImpl#getExceptionCode <em>Exception Code</em>}
 *   <li>{@link net.opengis.ows11.impl.ExceptionTypeImpl#getLocator <em>Locator</em>}
 * </ul>
 *
 * @generated
 */
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
  ...
  public EList getExceptionText() {
    if (exceptionText == null) {
      exceptionText =
          new EDataTypeEList(String.class, this, Ows11Package.EXCEPTION_TYPE__EXCEPTION_TEXT);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.EXCEPTION_TYPE__EXCEPTION_CODE,
              oldExceptionCode,
              exceptionCode));
  }
  ...
  public void setLocator(String newLocator) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.EXCEPTION_TYPE__LOCATOR, oldLocator, locator));
  }
