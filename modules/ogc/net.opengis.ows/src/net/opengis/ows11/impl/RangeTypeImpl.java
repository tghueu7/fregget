 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.RangeTypeImpl#getMinimumValue <em>Minimum Value</em>}
 *   <li>{@link net.opengis.ows11.impl.RangeTypeImpl#getMaximumValue <em>Maximum Value</em>}
 *   <li>{@link net.opengis.ows11.impl.RangeTypeImpl#getSpacing <em>Spacing</em>}
 *   <li>{@link net.opengis.ows11.impl.RangeTypeImpl#getRangeClosure <em>Range Closure</em>}
 * </ul>
 *
 * @generated
 */
public class RangeTypeImpl extends EObjectImpl implements RangeType {
  /**
   * The cached value of the '{@link #getMinimumValue() <em>Minimum Value</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getMaximumValue() <em>Maximum Value</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.RANGE_TYPE__MINIMUM_VALUE,
              oldMinimumValue,
              newMinimumValue);
  ...
  public void setMinimumValue(ValueType newMinimumValue) {
    if (newMinimumValue != minimumValue) {
      ...
      if (minimumValue != null)
        msgs =
            ((InternalEObject) minimumValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__MINIMUM_VALUE,
                    null,
                    msgs);
      if (newMinimumValue != null)
        msgs =
            ((InternalEObject) newMinimumValue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__MINIMUM_VALUE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.RANGE_TYPE__MAXIMUM_VALUE,
              oldMaximumValue,
              newMaximumValue);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setMaximumValue(ValueType newMaximumValue) {
    if (newMaximumValue != maximumValue) {
      ...
      if (maximumValue != null)
        msgs =
            ((InternalEObject) maximumValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__MAXIMUM_VALUE,
                    null,
                    msgs);
      if (newMaximumValue != null)
        msgs =
            ((InternalEObject) newMaximumValue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__MAXIMUM_VALUE,
                    null,
  ...
  public NotificationChain basicSetSpacing(ValueType newSpacing, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.RANGE_TYPE__SPACING, oldSpacing, newSpacing);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setSpacing(ValueType newSpacing) {
    if (newSpacing != spacing) {
      ...
      if (spacing != null)
        msgs =
            ((InternalEObject) spacing)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__SPACING, null, msgs);
      if (newSpacing != null)
        msgs =
            ((InternalEObject) newSpacing)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Ows11Package.RANGE_TYPE__SPACING, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.RANGE_TYPE__SPACING, newSpacing, newSpacing));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.RANGE_TYPE__RANGE_CLOSURE,
              oldRangeClosure,
              rangeClosure,
              !oldRangeClosureESet));
  }
