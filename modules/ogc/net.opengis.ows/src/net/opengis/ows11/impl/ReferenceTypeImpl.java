 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ReferenceTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.ows11.impl.ReferenceTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.ows11.impl.ReferenceTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.ows11.impl.ReferenceTypeImpl#getMetadata <em>Metadata</em>}
 * </ul>
 *
 * @generated
 */
public class ReferenceTypeImpl extends AbstractReferenceBaseTypeImpl implements ReferenceType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.REFERENCE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.REFERENCE_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList(
              LanguageStringType.class, this, Ows11Package.REFERENCE_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public void setFormat(String newFormat) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.REFERENCE_TYPE__FORMAT, oldFormat, format));
  }
  ...
  public EList getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Ows11Package.REFERENCE_TYPE__METADATA);
    }
    return metadata;
  }
