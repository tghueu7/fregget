 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.IdentificationTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.ows11.impl.IdentificationTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.ows11.impl.IdentificationTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.ows11.impl.IdentificationTypeImpl#getAvailableCRSGroup <em>Available CRS
 *       Group</em>}
 *   <li>{@link net.opengis.ows11.impl.IdentificationTypeImpl#getAvailableCRS <em>Available
 *       CRS</em>}
 * </ul>
 *
 * @generated
...
public class IdentificationTypeImpl extends BasicIdentificationTypeImpl
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, Ows11Package.IDENTIFICATION_TYPE__BOUNDING_BOX_GROUP);
    }
  ...
  public EList getOutputFormat() {
    if (outputFormat == null) {
      outputFormat =
          new EDataTypeEList(String.class, this, Ows11Package.IDENTIFICATION_TYPE__OUTPUT_FORMAT);
    }
    return outputFormat;
  }
  ...
  public FeatureMap getAvailableCRSGroup() {
    if (availableCRSGroup == null) {
      availableCRSGroup =
          new BasicFeatureMap(this, Ows11Package.IDENTIFICATION_TYPE__AVAILABLE_CRS_GROUP);
    }
