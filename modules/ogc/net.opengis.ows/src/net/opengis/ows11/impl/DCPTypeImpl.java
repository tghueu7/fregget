 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.DCPTypeImpl#getHTTP <em>HTTP</em>}
 * </ul>
 *
 * @generated
 */
public class DCPTypeImpl extends EObjectImpl implements DCPType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.DCP_TYPE__HTTP, oldHTTP, newHTTP);
  ...
  public void setHTTP(HTTPType newHTTP) {
    if (newHTTP != hTTP) {
      ...
      if (hTTP != null)
        msgs =
            ((InternalEObject) hTTP)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Ows11Package.DCP_TYPE__HTTP, null, msgs);
      if (newHTTP != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.DCP_TYPE__HTTP, newHTTP, newHTTP));
  }
