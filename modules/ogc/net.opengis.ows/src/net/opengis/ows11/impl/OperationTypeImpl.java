 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.OperationTypeImpl#getDCP <em>DCP</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationTypeImpl#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class OperationTypeImpl extends EObjectImpl implements OperationType {
    ...
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList(
              DomainType.class, this, Ows11Package.OPERATION_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList getConstraint() {
    if (constraint == null) {
      constraint =
          new EObjectContainmentEList(
              DomainType.class, this, Ows11Package.OPERATION_TYPE__CONSTRAINT);
    }
    return constraint;
  }
  ...
  public EList getMetadata() {
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Ows11Package.OPERATION_TYPE__METADATA);
    }
    return metadata;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Ows11Package.OPERATION_TYPE__NAME, oldName, name));
  }
