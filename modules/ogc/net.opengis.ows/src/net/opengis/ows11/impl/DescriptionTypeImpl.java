 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.DescriptionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.ows11.impl.DescriptionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.ows11.impl.DescriptionTypeImpl#getKeywords <em>Keywords</em>}
 * </ul>
 *
 * @generated
 */
public class DescriptionTypeImpl extends EObjectImpl implements DescriptionType {
    ...
    if (title == null) {
      title =
          new EObjectContainmentEList(
              LanguageStringType.class, this, Ows11Package.DESCRIPTION_TYPE__TITLE);
    }
    return title;
  }
  ...
  public EList getAbstract() {
    if (abstract_ == null) {
      abstract_ =
          new EObjectContainmentEList(
              LanguageStringType.class, this, Ows11Package.DESCRIPTION_TYPE__ABSTRACT);
    }
    return abstract_;
  }
  ...
  public EList getKeywords() {
    if (keywords == null) {
      keywords =
          new EObjectContainmentEList(
              KeywordsType.class, this, Ows11Package.DESCRIPTION_TYPE__KEYWORDS);
    }
    return keywords;
  }
