 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ServiceIdentificationTypeImpl#getServiceType <em>Service
 *       Type</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceIdentificationTypeImpl#getServiceTypeVersion
 *       <em>Service Type Version</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceIdentificationTypeImpl#getProfile <em>Profile</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceIdentificationTypeImpl#getFees <em>Fees</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceIdentificationTypeImpl#getAccessConstraints <em>Access
 *       Constraints</em>}
 * </ul>
 *
 * @generated
...
public class ServiceIdentificationTypeImpl extends DescriptionTypeImpl
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
              oldServiceType,
              newServiceType);
      ...
      if (serviceType != null)
        msgs =
            ((InternalEObject) serviceType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE,
                    null,
                    msgs);
  ...
  public EList getServiceTypeVersion() {
    if (serviceTypeVersion == null) {
      serviceTypeVersion =
          new EDataTypeEList(
              String.class, this, Ows11Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION);
    }
  ...
  public EList getProfile() {
    if (profile == null) {
      profile =
          new EDataTypeEList(String.class, this, Ows11Package.SERVICE_IDENTIFICATION_TYPE__PROFILE);
    }
    return profile;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_IDENTIFICATION_TYPE__FEES,
              oldFees,
              fees));
  }
  ...
  public EList getAccessConstraints() {
    if (accessConstraints == null) {
      accessConstraints =
          new EDataTypeEList(
              String.class, this, Ows11Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS);
    }
