...
public class Ows11FactoryImpl extends EFactoryImpl implements Ows11Factory {
  ...
  public static Ows11Factory init() {
    try {
      Ows11Factory theOws11Factory =
          (Ows11Factory) EPackage.Registry.INSTANCE.getEFactory("http://www.opengis.net/ows/1.1");
  ...
  public DatasetDescriptionSummaryBaseType createDatasetDescriptionSummaryBaseType() {
    DatasetDescriptionSummaryBaseTypeImpl datasetDescriptionSummaryBaseType =
        new DatasetDescriptionSummaryBaseTypeImpl();
   ...
   * @generated
   */
  public RangeClosureType createRangeClosureTypeFromString(
   ...
   * @generated
   */
  public RangeClosureType createRangeClosureTypeObjectFromString(
      EDataType eDataType, String initialValue) {
