 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ServiceProviderTypeImpl#getProviderName <em>Provider
 *       Name</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceProviderTypeImpl#getProviderSite <em>Provider
 *       Site</em>}
 *   <li>{@link net.opengis.ows11.impl.ServiceProviderTypeImpl#getServiceContact <em>Service
 *       Contact</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_PROVIDER_TYPE__PROVIDER_NAME,
              oldProviderName,
              providerName));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
              oldProviderSite,
              newProviderSite);
      ...
      if (providerSite != null)
        msgs =
            ((InternalEObject) providerSite)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
              oldServiceContact,
              newServiceContact);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (serviceContact != null)
        msgs =
            ((InternalEObject) serviceContact)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Ows11Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
                    null,
                    msgs);
