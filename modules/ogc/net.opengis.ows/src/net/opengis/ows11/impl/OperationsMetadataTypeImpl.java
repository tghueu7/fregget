 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.OperationsMetadataTypeImpl#getOperation <em>Operation</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationsMetadataTypeImpl#getParameter <em>Parameter</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationsMetadataTypeImpl#getConstraint <em>Constraint</em>}
 *   <li>{@link net.opengis.ows11.impl.OperationsMetadataTypeImpl#getExtendedCapabilities
...
public class OperationsMetadataTypeImpl extends EObjectImpl implements OperationsMetadataType {
  ...
  /**
   * The default value of the '{@link #getExtendedCapabilities() <em>Extended Capabilities</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (operation == null) {
      operation =
          new EObjectContainmentEList(
              OperationType.class, this, Ows11Package.OPERATIONS_METADATA_TYPE__OPERATION);
    }
    return operation;
  }
  ...
  public EList getParameter() {
    if (parameter == null) {
      parameter =
          new EObjectContainmentEList(
              DomainType.class, this, Ows11Package.OPERATIONS_METADATA_TYPE__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList getConstraint() {
    if (constraint == null) {
      constraint =
          new EObjectContainmentEList(
              DomainType.class, this, Ows11Package.OPERATIONS_METADATA_TYPE__CONSTRAINT);
    }
    return constraint;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.OPERATIONS_METADATA_TYPE__EXTENDED_CAPABILITIES,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Ows11Package.OPERATIONS_METADATA_TYPE__EXTENDED_CAPABILITIES:
        return EXTENDED_CAPABILITIES_EDEFAULT == null
            ? extendedCapabilities != null
            : !EXTENDED_CAPABILITIES_EDEFAULT.equals(extendedCapabilities);
    }
