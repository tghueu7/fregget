 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.ows11.impl.AbstractReferenceBaseTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class AbstractReferenceBaseTypeImpl extends EObjectImpl
    implements AbstractReferenceBaseType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__ACTUATE,
              oldActuate,
              actuate));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__HREF,
              oldHref,
              href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__ROLE,
              oldRole,
              role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__SHOW,
              oldShow,
              show));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.ABSTRACT_REFERENCE_BASE_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
