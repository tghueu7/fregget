 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.GetResourceByIdTypeImpl#getResourceID <em>Resource ID</em>}
 *   <li>{@link net.opengis.ows11.impl.GetResourceByIdTypeImpl#getOutputFormat <em>Output
 *       Format</em>}
 *   <li>{@link net.opengis.ows11.impl.GetResourceByIdTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.ows11.impl.GetResourceByIdTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class GetResourceByIdTypeImpl extends EObjectImpl implements GetResourceByIdType {
  ...
  public EList getResourceID() {
    if (resourceID == null) {
      resourceID =
          new EDataTypeEList(String.class, this, Ows11Package.GET_RESOURCE_BY_ID_TYPE__RESOURCE_ID);
    }
    return resourceID;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.GET_RESOURCE_BY_ID_TYPE__OUTPUT_FORMAT,
              oldOutputFormat,
              outputFormat));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.GET_RESOURCE_BY_ID_TYPE__SERVICE,
              oldService,
              service));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Ows11Package.GET_RESOURCE_BY_ID_TYPE__VERSION,
              oldVersion,
              version));
  }
