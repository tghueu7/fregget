 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ReferenceGroupTypeImpl#getAbstractReferenceBaseGroup
 *       <em>Abstract Reference Base Group</em>}
 *   <li>{@link net.opengis.ows11.impl.ReferenceGroupTypeImpl#getAbstractReferenceBase <em>Abstract
 *       Reference Base</em>}
 * </ul>
 *
 * @generated
 */
public class ReferenceGroupTypeImpl extends BasicIdentificationTypeImpl
    implements ReferenceGroupType {
  /**
   * The cached value of the '{@link #getAbstractReferenceBaseGroup() <em>Abstract Reference Base
  ...
  public FeatureMap getAbstractReferenceBaseGroup() {
    if (abstractReferenceBaseGroup == null) {
      abstractReferenceBaseGroup =
          new BasicFeatureMap(
              this, Ows11Package.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE_GROUP);
    }
  ...
  public EList getAbstractReferenceBase() {
    return getAbstractReferenceBaseGroup()
        .list(Ows11Package.Literals.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE);
  }
