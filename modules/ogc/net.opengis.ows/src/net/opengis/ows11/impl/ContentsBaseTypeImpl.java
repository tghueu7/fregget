 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.impl.ContentsBaseTypeImpl#getDatasetDescriptionSummary <em>Dataset
 *       Description Summary</em>}
 *   <li>{@link net.opengis.ows11.impl.ContentsBaseTypeImpl#getOtherSource <em>Other Source</em>}
 * </ul>
 *
 * @generated
 */
public class ContentsBaseTypeImpl extends EObjectImpl implements ContentsBaseType {
  ...
  public EList getOtherSource() {
    if (otherSource == null) {
      otherSource =
          new EObjectContainmentEList(
              MetadataType.class, this, Ows11Package.CONTENTS_BASE_TYPE__OTHER_SOURCE);
    }
    return otherSource;
  }
