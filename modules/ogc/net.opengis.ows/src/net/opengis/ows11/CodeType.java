 ...
 * reference a dictionary, thesaurus, or authority for the name or code, such as the organisation
 * who assigned the value, or the dictionary from which it is taken. Type copied from basicTypes.xsd
 * of GML 3 with documentation edited, for possible use outside the ServiceIdentification section of
 * a service metadata document.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.CodeType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.ows11.CodeType#getCodeSpace <em>Code Space</em>}
 * </ul>
 *
...
public interface CodeType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CodeType#getCodeSpace <em>Code Space</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
