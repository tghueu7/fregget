 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getAllowedValues <em>Allowed Values</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getAnyValue <em>Any Value</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getNoValues <em>No Values</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getValuesReference <em>Values Reference</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getDefaultValue <em>Default Value</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getMeaning <em>Meaning</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getUOM <em>UOM</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getReferenceSystem <em>Reference System</em>}
 *   <li>{@link net.opengis.ows11.UnNamedDomainType#getMetadata <em>Metadata</em>}
 * </ul>
 *
...
public interface UnNamedDomainType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getAllowedValues <em>Allowed
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getAnyValue <em>Any
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getNoValues <em>No
   * Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getValuesReference <em>Values
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getDefaultValue <em>Default
   * Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getMeaning <em>Meaning</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getDataType <em>Data
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getUOM <em>UOM</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.UnNamedDomainType#getReferenceSystem
