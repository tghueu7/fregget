 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.AddressType#getDeliveryPoint <em>Delivery Point</em>}
 *   <li>{@link net.opengis.ows11.AddressType#getCity <em>City</em>}
 *   <li>{@link net.opengis.ows11.AddressType#getAdministrativeArea <em>Administrative Area</em>}
 *   <li>{@link net.opengis.ows11.AddressType#getPostalCode <em>Postal Code</em>}
 *   <li>{@link net.opengis.ows11.AddressType#getCountry <em>Country</em>}
 *   <li>{@link net.opengis.ows11.AddressType#getElectronicMailAddress <em>Electronic Mail
 *       Address</em>}
 * </ul>
 *
...
public interface AddressType extends EObject {
  /**
   * Returns the value of the '<em><b>Delivery Point</b></em>' attribute list. The list contents are
   ...
   *     name='City' namespace='##targetNamespace'"
   * @generated
   */
  String getCity();
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element'
   *     name='AdministrativeArea' namespace='##targetNamespace'"
   * @generated
   */
  String getAdministrativeArea();

  /**
   * Sets the value of the '{@link net.opengis.ows11.AddressType#getAdministrativeArea
   * <em>Administrative Area</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element'
   *     name='PostalCode' namespace='##targetNamespace'"
   * @generated
   */
  String getPostalCode();

  /**
   * Sets the value of the '{@link net.opengis.ows11.AddressType#getPostalCode <em>Postal
   * Code</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element'
   *     name='Country' namespace='##targetNamespace'"
   * @generated
   */
  String getCountry();

  /**
   * Sets the value of the '{@link net.opengis.ows11.AddressType#getCountry <em>Country</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Electronic Mail Address</b></em>' attribute list. The list
   ...
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
   *     extendedMetaData="kind='element' name='ElectronicMailAddress'
