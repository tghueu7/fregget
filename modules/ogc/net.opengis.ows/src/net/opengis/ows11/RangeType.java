 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A range of values of a numeric parameter. This range can be continuous or discrete, defined by a
 * fixed spacing between adjacent valid values. If the MinimumValue or MaximumValue is not included,
 * there is no value limit in that direction. Inclusion of the specified minimum and maximum values
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.RangeType#getMinimumValue <em>Minimum Value</em>}
 *   <li>{@link net.opengis.ows11.RangeType#getMaximumValue <em>Maximum Value</em>}
 *   <li>{@link net.opengis.ows11.RangeType#getSpacing <em>Spacing</em>}
 *   <li>{@link net.opengis.ows11.RangeType#getRangeClosure <em>Range Closure</em>}
 * </ul>
 *
...
public interface RangeType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='MinimumValue'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.RangeType#getMinimumValue <em>Minimum
   ...
   * @model containment="true" extendedMetaData="kind='element' name='MaximumValue'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.RangeType#getMaximumValue <em>Maximum
   * Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Shall be included when the allowed values are NOT continuous in this range. Shall not be
   * included when the allowed values are continuous in this range.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Spacing'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.RangeType#getSpacing <em>Spacing</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.RangeType#getRangeClosure <em>Range
  ...
  /**
   * Unsets the value of the '{@link net.opengis.ows11.RangeType#getRangeClosure <em>Range
   * Closure</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.ows11.RangeType#getRangeClosure <em>Range
   * Closure</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
