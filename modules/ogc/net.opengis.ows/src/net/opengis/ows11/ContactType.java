 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.ContactType#getPhone <em>Phone</em>}
 *   <li>{@link net.opengis.ows11.ContactType#getAddress <em>Address</em>}
 *   <li>{@link net.opengis.ows11.ContactType#getOnlineResource <em>Online Resource</em>}
 *   <li>{@link net.opengis.ows11.ContactType#getHoursOfService <em>Hours Of Service</em>}
 *   <li>{@link net.opengis.ows11.ContactType#getContactInstructions <em>Contact Instructions</em>}
 * </ul>
 *
...
public interface ContactType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ContactType#getPhone <em>Phone</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ContactType#getAddress <em>Address</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * The xlink:href attribute in the xlink:simpleLink attribute group shall be used to reference
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ContactType#getOnlineResource <em>Online
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ContactType#getHoursOfService <em>Hours Of
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ContactType#getContactInstructions <em>Contact
