 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.CapabilitiesBaseType#getServiceIdentification <em>Service
 *       Identification</em>}
 *   <li>{@link net.opengis.ows11.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}
 *   <li>{@link net.opengis.ows11.CapabilitiesBaseType#getOperationsMetadata <em>Operations
 *       Metadata</em>}
 *   <li>{@link net.opengis.ows11.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}
 *   <li>{@link net.opengis.ows11.CapabilitiesBaseType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface CapabilitiesBaseType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CapabilitiesBaseType#getServiceIdentification
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CapabilitiesBaseType#getServiceProvider
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CapabilitiesBaseType#getOperationsMetadata
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CapabilitiesBaseType#getUpdateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.CapabilitiesBaseType#getVersion
