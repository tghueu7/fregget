 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.AllowedValuesType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.ows11.AllowedValuesType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.ows11.AllowedValuesType#getRange <em>Range</em>}
 * </ul>
 *
...
public interface AllowedValuesType extends EObject {
   ...
   * are of type {@link net.opengis.ows11.ValueType}.
   * <!-- begin-user-doc -->
   *
   ...
   * @model type="net.opengis.ows11.ValueType" containment="true" transient="true" volatile="true"
   *     derived="true" extendedMetaData="kind='element' name='Value' namespace='##targetNamespace'
   *     group='#group:0'"
   * @generated
   */
  EList getValue();
  ...
  /**
   * Returns the value of the '<em><b>Range</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.ows11.RangeType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Range</em>' containment reference list isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model type="net.opengis.ows11.RangeType" containment="true" transient="true" volatile="true"
   *     derived="true" extendedMetaData="kind='element' name='Range' namespace='##targetNamespace'
   *     group='#group:0'"
   * @generated
   */
  EList getRange();
