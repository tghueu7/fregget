 ...
 * xlink:simpleLink shall be included. Either at least one of the attributes in xlink:simpleLink or
 * a substitute for the AbstractMetaData element shall be included, but not both. An Implementation
 * Specification can restrict the contents of this element to always be a reference or always
 * contain metadata. (Informative: This element was adapted from the metaDataProperty element in GML
 * 3.0.)
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.MetadataType#getAbstractMetaDataGroup <em>Abstract Meta Data
 *       Group</em>}
 *   <li>{@link net.opengis.ows11.MetadataType#getAbstractMetaData <em>Abstract Meta Data</em>}
 *   <li>{@link net.opengis.ows11.MetadataType#getAbout <em>About</em>}
 *   <li>{@link net.opengis.ows11.MetadataType#getTitle <em>Title</em>}
 * </ul>
 *
...
public interface MetadataType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.MetadataType#getAbout <em>About</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.MetadataType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
