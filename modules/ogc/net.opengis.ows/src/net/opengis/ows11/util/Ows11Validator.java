...
public class Ows11Validator extends EObjectValidator {
  ...
  protected boolean validate(
      int classifierID, Object value, DiagnosticChain diagnostics, Map context) {
    switch (classifierID) {
  ...
  public boolean validateAcceptVersionsType(
      AcceptVersionsType acceptVersionsType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateAddressType(
      AddressType addressType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateAnyValueType(
      AnyValueType anyValueType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateCapabilitiesBaseType(
      CapabilitiesBaseType capabilitiesBaseType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateContentsBaseType(
      ContentsBaseType contentsBaseType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateManifestType(
      ManifestType manifestType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateNoValuesType(
      NoValuesType noValuesType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateOperationsMetadataType(
      OperationsMetadataType operationsMetadataType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateReferenceType(
      ReferenceType referenceType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateServiceReferenceType(
      ServiceReferenceType serviceReferenceType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateTelephoneType(
      TelephoneType telephoneType, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateRangeClosureType(
      RangeClosureType rangeClosureType, DiagnosticChain diagnostics, Map context) {
    return true;
  }
  ...
  public boolean validateMimeType_Pattern(
      String mimeType, DiagnosticChain diagnostics, Map context) {
    return validatePattern(
        Ows11Package.Literals.MIME_TYPE,
        mimeType,
  ...
  public boolean validatePositionType_ItemType(
      List positionType, DiagnosticChain diagnostics, Map context) {
    boolean result = true;
    for (Iterator i = positionType.iterator(); i.hasNext() && (result || diagnostics != null); ) {
      Object item = i.next();
      if (XMLTypePackage.Literals.DOUBLE.isInstance(item)) {
        result &=
            xmlTypeValidator.validateDouble(((Double) item).doubleValue(), diagnostics, context);
      } else {
        result = false;
  ...
  public boolean validatePositionType2D(
      List positionType2D, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validatePositionType2D_MinLength(
    ...
    if (!result && diagnostics != null)
      reportMinLengthViolation(
          Ows11Package.Literals.POSITION_TYPE2_D, positionType2D, length, 2, diagnostics, context);
    return result;
  }
  ...
  public boolean validateUpdateSequenceType(
      String updateSequenceType, DiagnosticChain diagnostics, Map context) {
    return true;
  }
  ...
  public boolean validateVersionType_Pattern(
      String versionType, DiagnosticChain diagnostics, Map context) {
    return validatePattern(
        Ows11Package.Literals.VERSION_TYPE,
        versionType,
  ...
  public boolean validateVersionType1(
      String versionType1, DiagnosticChain diagnostics, Map context) {
  ...
  public boolean validateVersionType1_Pattern(
      String versionType1, DiagnosticChain diagnostics, Map context) {
    return validatePattern(
        Ows11Package.Literals.VERSION_TYPE1,
        versionType1,
