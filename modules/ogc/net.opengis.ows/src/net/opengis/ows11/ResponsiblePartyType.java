 ...
 *
 * <ul>
 *   <li>{@link net.opengis.ows11.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}
 *   <li>{@link net.opengis.ows11.ResponsiblePartyType#getOrganisationName <em>Organisation
 *       Name</em>}
 *   <li>{@link net.opengis.ows11.ResponsiblePartyType#getPositionName <em>Position Name</em>}
 *   <li>{@link net.opengis.ows11.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}
 *   <li>{@link net.opengis.ows11.ResponsiblePartyType#getRole <em>Role</em>}
 * </ul>
 *
...
public interface ResponsiblePartyType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ResponsiblePartyType#getIndividualName
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ResponsiblePartyType#getOrganisationName
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ResponsiblePartyType#getPositionName
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ResponsiblePartyType#getContactInfo <em>Contact
  ...
  /**
   * Sets the value of the '{@link net.opengis.ows11.ResponsiblePartyType#getRole <em>Role</em>}'
