 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * <description>This XML Schema Document encodes the WPS GetCapabilities operation
 * response.</description> <copyright>Copyright (c) 2007 OGC, All Rights Reserved. For conditions,
 * see OGC Software Notice http://www.opengeospatial.org/ogc/software</copyright>
 *
 * <p><description>Location of a WSDL document.</description> <copyright>Copyright (c) 2007 OGC, All
 * Rights Reserved. For conditions, see OGC Software Notice
 * http://www.opengeospatial.org/ogc/software</copyright>
 *
 * <p>GML 3.0 candidate xlinks schema. Copyright (c) 2001 OGC, All Rights Reserved.
 *
 * <p><description>Brief description of a Process, designed for Process discovery. </description>
 * <copyright>Copyright (c) 2007 OGC, All Rights Reserved. For conditions, see OGC Software Notice
 * http://www.opengeospatial.org/ogc/software</copyright>
 *
 * <p><description>This XML Schema Document encodes elements and types that are shared by multiple
 * WPS operations.</description> <copyright>Copyright (c) 2007 OGC, All Rights Reserved. For
 * conditions, see OGC Software Notice http://www.opengeospatial.org/ogc/software</copyright>
 *
 * <p>This XML Schema Document includes and imports, directly and indirectly, all the XML Schemas
 * defined by the OWS Common Implemetation Specification. Copyright (c) 2006 Open Geospatial
 * Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the GetResourceByID
 * operation request message. This typical operation is specified as a base for profiling in
 * specific OWS specifications. For information on the allowed changes and limitations in such
 * profiling, see Subclause 9.4.1 of the OWS Common specification. Copyright (c) 2006 Open
 * Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the parts of
 * the MD_DataIdentification class of ISO 19115 (OGC Abstract Specification Topic 11) which are
 * expected to be used for most datasets. This Schema also encodes the parts of this class that are
 * expected to be useful for other metadata. Both may be used within the Contents section of OWS
 * service metadata (Capabilities) documents. Copyright (c) 2006 Open Geospatial Consortium, Inc.
 * All Rights Reserved. This XML Schema Document encodes various parameters and parameter types that
 * can be used in OWS operation requests and responses. Copyright (c) 2006 Open Geospatial
 * Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the parts of ISO 19115
 * used by the common "ServiceIdentification" and "ServiceProvider" sections of the GetCapabilities
 * operation response, known as the service metadata XML document. The parts encoded here are the
 * MD_Keywords, CI_ResponsibleParty, and related classes. The UML package prefixes were omitted from
 * XML names, and the XML element names were all capitalized, for consistency with other OWS
 * Schemas. This document also provides a simple coding of text in multiple languages, simplified
 * from Annex J of ISO 19115. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights
 * Reserved.
 *
 * <p>See http://www.w3.org/XML/1998/namespace.html and http://www.w3.org/TR/REC-xml for information
 ...
 * Consortium or its subgroups. The following names are currently defined in this namespace and
 * should not be used with conflicting semantics by any Working Group, specification, or document
 * instance:
 *
 * <p>base (as an attribute name): denotes an attribute whose value provides a URI to be used as the
 * base for interpreting any relative URIs in the scope of the element on which it appears; its
 * value is inherited. This name is reserved by virtue of its definition in the XML Base
 * specification.
 *
 * <p>id (as an attribute name): denotes an attribute whose value should be interpreted as if
 * declared to be of type ID. This name is reserved by virtue of its definition in the xml:id
 * specification.
 *
 * <p>lang (as an attribute name): denotes an attribute whose value is a language code for the
 * natural language of the content of any element; its value is inherited. This name is reserved by
 * virtue of its definition in the XML specification.
 *
 * <p>space (as an attribute name): denotes an attribute whose value is a keyword indicating what
 * whitespace processing discipline is intended for the content of the element; its value is
 * inherited. This name is reserved by virtue of its definition in the XML specification.
 *
 * <p>Father (in any context at all): denotes Jon Bosak, the chair of the original XML Working
 * Group. This name is reserved by the following decision of the W3C XML Plenary and XML
 * Coordination groups:
 *
 ...
 *
 * <p>&lt;type . . .&gt; . . . &lt;attributeGroup ref="xml:specialAttrs"/&gt;
 *
 * <p>will define a type which will schema-validate an instance element with any of those attributes
 * In keeping with the XML Schema WG's standard versioning policy, this schema document will persist
 * at http://www.w3.org/2007/08/xml.xsd. At the date of issue it can also be found at
 * http://www.w3.org/2001/xml.xsd. The schema document at that URI may however change in the future,
 * in order to remain compatible with the latest version of XML Schema itself, or with the XML
 * namespace itself. In other words, if the XML Schema or XML namespaces change, the version of this
 * document at http://www.w3.org/2001/xml.xsd will change accordingly; the version at
 ...
 * for example, to specify a specific value for the "service" attribute. Copyright (c) 2006 Open
 * Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the common
 * "ServiceIdentification" section of the GetCapabilities operation response, known as the
 * Capabilities XML document. This section encodes the SV_ServiceIdentification class of ISO 19119
 * (OGC Abstract Specification Topic 12). Copyright (c) 2006 Open Geospatial Consortium, Inc. All
 * Rights Reserved. This XML Schema Document encodes the common "ServiceProvider" section of the
 * GetCapabilities operation response, known as the Capabilities XML document. This section encodes
 * the SV_ServiceProvider class of ISO 19119 (OGC Abstract Specification Topic 12). Copyright (c)
 * 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document encodes the
 * basic contents of the "OperationsMetadata" section of the GetCapabilities operation response,
 * also known as the Capabilities XML document. Copyright (c) 2006 Open Geospatial Consortium, Inc.
 * All Rights Reserved. This XML Schema Document encodes the allowed values (or domain) of a
 * quantity, often for an input or output parameter to an OWS. Such a parameter is sometimes called
 * a variable, quantity, literal, or typed literal. Such a parameter can use one of many data types,
 * including double, integer, boolean, string, or URI. The allowed values can also be encoded for a
 * quantity that is not explicit or not transferred, but is constrained by a server implementation.
 * Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML Schema Document
 * encodes the Exception Report response to all OWS operations. Copyright (c) 2006 Open Geospatial
 ...
 * specific OWS. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This XML
 * Schema Document specifies types and elements for input and output of operation data, allowing
 * including multiple data items with each data item either included or referenced. The contents of
 * each type and element specified here can be restricted and/or extended for each use in a specific
 * OWS specification. Copyright (c) 2006 Open Geospatial Consortium, Inc. All Rights Reserved. This
 * XML Schema Document specifies types and elements for document or resource references and for
 * package manifests that contain multiple references. The contents of each type and element
 ...
 *     appinfo='xlinks.xsd v3.0b2 2001-07'" annotation="http://www.w3.org/XML/1998/namespace
 *     lang='en'"
 * @generated
 */
public interface Wps10Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.BodyReferenceTypeImpl <em>Body
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ComplexDataCombinationsTypeImpl
   * <em>Complex Data Combinations Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ComplexDataCombinationTypeImpl
   * <em>Complex Data Combination Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ComplexDataDescriptionTypeImpl
   * <em>Complex Data Description Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ComplexDataTypeImpl <em>Complex Data
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.CRSsTypeImpl <em>CR Ss Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DataInputsTypeImpl <em>Data Inputs
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DataInputsType1Impl <em>Data Inputs
   * Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DataTypeImpl <em>Data Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DefaultTypeImpl <em>Default
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DefaultType1Impl <em>Default
   * Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DefaultType2Impl <em>Default
   * Type2</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.RequestBaseTypeImpl <em>Request Base
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DescribeProcessTypeImpl <em>Describe
   * Process Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DescriptionTypeImpl <em>Description
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl <em>Output
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DocumentOutputDefinitionTypeImpl
   * <em>Document Output Definition Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.DocumentRootImpl <em>Document
   * Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ResponseBaseTypeImpl <em>Response
   * Base Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl <em>Execute
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ExecuteTypeImpl <em>Execute
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl <em>Get
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.HeaderTypeImpl <em>Header Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.InputDescriptionTypeImpl <em>Input
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.InputReferenceTypeImpl <em>Input
   * Reference Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.InputTypeImpl <em>Input Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.LanguagesTypeImpl <em>Languages
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.LanguagesType1Impl <em>Languages
   * Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.LiteralDataTypeImpl <em>Literal Data
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.LiteralOutputTypeImpl <em>Literal
   * Output Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.LiteralInputTypeImpl <em>Literal
   * Input Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.OutputDataTypeImpl <em>Output Data
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.OutputDefinitionsTypeImpl <em>Output
   * Definitions Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.OutputDescriptionTypeImpl <em>Output
   * Description Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.OutputReferenceTypeImpl <em>Output
   * Reference Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessBriefTypeImpl <em>Process
   * Brief Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessDescriptionsTypeImpl
   * <em>Process Descriptions Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl
   * <em>Process Description Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessFailedTypeImpl <em>Process
   * Failed Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessOfferingsTypeImpl <em>Process
   * Offerings Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessOutputsTypeImpl <em>Process
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessOutputsType1Impl <em>Process
   * Outputs Type1</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ProcessStartedTypeImpl <em>Process
   * Started Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl <em>Response
   * Document Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ResponseFormTypeImpl <em>Response
   * Form Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.StatusTypeImpl <em>Status Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.SupportedComplexDataTypeImpl
   * <em>Supported Complex Data Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.SupportedComplexDataInputTypeImpl
   * <em>Supported Complex Data Input Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int SUPPORTED_COMPLEX_DATA_INPUT_TYPE__MAXIMUM_MEGABYTES =
      SUPPORTED_COMPLEX_DATA_TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SUPPORTED_COMPLEX_DATA_INPUT_TYPE_FEATURE_COUNT =
      SUPPORTED_COMPLEX_DATA_TYPE_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.SupportedCRSsTypeImpl <em>Supported
   * CR Ss Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.SupportedUOMsTypeImpl <em>Supported
   * UO Ms Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.UOMsTypeImpl <em>UO Ms Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.ValuesReferenceTypeImpl <em>Values
   * Reference Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl <em>WPS
   * Capabilities Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int WPS_CAPABILITIES_TYPE__SERVICE_IDENTIFICATION =
   ...
   * @ordered
   */
  int WPS_CAPABILITIES_TYPE__SERVICE_PROVIDER =
   ...
   * @ordered
   */
  int WPS_CAPABILITIES_TYPE__OPERATIONS_METADATA =
   ...
   * @ordered
   */
  int WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS =
      Ows11Package.CAPABILITIES_BASE_TYPE_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wps10.impl.WSDLTypeImpl <em>WSDL Type</em>}'
   * class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.BodyReferenceType <em>Body
   * Reference Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.BodyReferenceType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ComplexDataCombinationsType
   * <em>Complex Data Combinations Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wps10.ComplexDataCombinationsType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ComplexDataCombinationType
   * <em>Complex Data Combination Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wps10.ComplexDataCombinationType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ComplexDataDescriptionType
   * <em>Complex Data Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wps10.ComplexDataDescriptionType#getMimeType <em>Mime Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ComplexDataDescriptionType#getEncoding <em>Encoding</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ComplexDataDescriptionType#getSchema <em>Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ComplexDataType <em>Complex Data
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ComplexDataType#getEncoding
   * <em>Encoding</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ComplexDataType#getMimeType
   * <em>Mime Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ComplexDataType#getSchema
   * <em>Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wps10.ComplexDataType#getData <em>Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.CRSsType#getCRS
   * <em>CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DataInputsType <em>Data Inputs
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.DataInputsType#getInput <em>Input</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DataInputsType1 <em>Data Inputs
   * Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.DataInputsType1#getInput <em>Input</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Input</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DataType#getComplexData <em>Complex Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DataType#getLiteralData <em>Literal Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DataType#getBoundingBoxData <em>Bounding Box Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DefaultType <em>Default
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.DefaultType#getCRS
   * <em>CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DefaultType1 <em>Default
   * Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the reference '{@link net.opengis.wps10.DefaultType1#getUOM
   * <em>UOM</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DefaultType2 <em>Default
   * Type2</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.DefaultType2#getLanguage
   * <em>Language</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DescribeProcessType <em>Describe
   * Process Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.DescribeProcessType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DescriptionType <em>Description
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DescriptionType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DescriptionType#getTitle <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DescriptionType#getAbstract <em>Abstract</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.DescriptionType#getMetadata <em>Metadata</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DocumentOutputDefinitionType
   * <em>Document Output Definition Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentOutputDefinitionType#getTitle <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Title</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentOutputDefinitionType#getAbstract <em>Abstract</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Abstract</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.DocumentOutputDefinitionType#isAsReference <em>As Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wps10.DocumentRoot#getMixed
   * <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wps10.DocumentRoot#getXMLNSPrefixMap
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wps10.DocumentRoot#getXSISchemaLocation
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getCapabilities <em>Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getDescribeProcess <em>Describe Process</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getExecute <em>Execute</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getExecuteResponse <em>Execute Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getLanguages <em>Languages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getProcessDescriptions <em>Process Descriptions</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getProcessOfferings <em>Process Offerings</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.DocumentRoot#getWSDL <em>WSDL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.DocumentRoot#getProcessVersion <em>Process Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ExecuteResponseType <em>Execute
   * Response Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteResponseType#getProcess <em>Process</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteResponseType#getStatus <em>Status</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteResponseType#getDataInputs <em>Data Inputs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteResponseType#getOutputDefinitions <em>Output Definitions</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteResponseType#getProcessOutputs <em>Process Outputs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ExecuteResponseType#getServiceInstance <em>Service Instance</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ExecuteResponseType#getStatusLocation <em>Status Location</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ExecuteType <em>Execute
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteType#getDataInputs <em>Data Inputs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Data Inputs</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ExecuteType#getResponseForm <em>Response Form</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.GetCapabilitiesType <em>Get
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.GetCapabilitiesType#getLanguage <em>Language</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Language</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.GetCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.GetCapabilitiesType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.HeaderType#getKey
   * <em>Key</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.HeaderType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.InputDescriptionType <em>Input
   * Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputDescriptionType#getComplexData <em>Complex Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Complex Data</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputDescriptionType#getLiteralData <em>Literal Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Literal Data</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputDescriptionType#getBoundingBoxData <em>Bounding Box Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Bounding Box Data</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputDescriptionType#getMaxOccurs <em>Max Occurs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputDescriptionType#getMinOccurs <em>Min Occurs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.InputReferenceType <em>Input
   * Reference Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.InputReferenceType#getHeader <em>Header</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.InputReferenceType#getBody
   * <em>Body</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputReferenceType#getBodyReference <em>Body Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputReferenceType#getEncoding <em>Encoding</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Encoding</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.InputReferenceType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputReferenceType#getMethod <em>Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputReferenceType#getMimeType <em>Mime Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Mime Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.InputReferenceType#getSchema <em>Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Schema</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputType#getTitle <em>Title</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Title</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputType#getAbstract <em>Abstract</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Abstract</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputType#getReference <em>Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.InputType#getData <em>Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.LanguagesType <em>Languages
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wps10.LanguagesType#getLanguage <em>Language</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.LanguagesType1 <em>Languages
   * Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LanguagesType1#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LanguagesType1#getSupported <em>Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.LiteralDataType <em>Literal Data
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.LiteralDataType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.LiteralDataType#getDataType
   * <em>Data Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.LiteralDataType#getUom
   * <em>Uom</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.LiteralInputType <em>Literal Input
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LiteralInputType#getAllowedValues <em>Allowed Values</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LiteralInputType#getAnyValue <em>Any Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LiteralInputType#getValuesReference <em>Values Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.LiteralInputType#getDefaultValue <em>Default Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.LiteralOutputType <em>Literal
   * Output Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LiteralOutputType#getDataType <em>Data Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.LiteralOutputType#getUOMs <em>UO Ms</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.OutputDataType <em>Output Data
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDataType#getReference <em>Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Reference</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDataType#getData <em>Data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Data</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.OutputDefinitionsType <em>Output
   * Definitions Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.OutputDefinitionsType#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.OutputDefinitionType <em>Output
   * Definition Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDefinitionType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputDefinitionType#getEncoding <em>Encoding</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Encoding</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputDefinitionType#getMimeType <em>Mime Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Mime Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputDefinitionType#getSchema <em>Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Schema</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.OutputDefinitionType#getUom
   * <em>Uom</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.OutputDescriptionType <em>Output
   * Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDescriptionType#getComplexOutput <em>Complex Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDescriptionType#getLiteralOutput <em>Literal Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.OutputDescriptionType#getBoundingBoxOutput <em>Bounding Box Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.OutputReferenceType <em>Output
   * Reference Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputReferenceType#getEncoding <em>Encoding</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Encoding</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.OutputReferenceType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputReferenceType#getMimeType <em>Mime Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Mime Type</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.OutputReferenceType#getSchema <em>Schema</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Schema</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessBriefType <em>Process Brief
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ProcessBriefType#getProfile
   * <em>Profile</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ProcessBriefType#getWSDL <em>WSDL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>WSDL</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ProcessBriefType#getProcessVersion <em>Process Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Process Version</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessDescriptionsType <em>Process
   * Descriptions Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.ProcessDescriptionsType#getProcessDescription <em>Process Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessDescriptionType <em>Process
   * Description Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ProcessDescriptionType#getDataInputs <em>Data Inputs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Data Inputs</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ProcessDescriptionType#getProcessOutputs <em>Process Outputs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Process Outputs</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ProcessDescriptionType#isStatusSupported <em>Status Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessFailedType <em>Process
   * Failed Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ProcessFailedType#getExceptionReport <em>Exception Report</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessOfferingsType <em>Process
   * Offerings Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.ProcessOfferingsType#getProcess <em>Process</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessOutputsType <em>Process
   * Outputs Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.ProcessOutputsType#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Output</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessOutputsType1 <em>Process
   * Outputs Type1</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.ProcessOutputsType1#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Output</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ProcessStartedType <em>Process
   * Started Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ProcessStartedType#getValue
   * <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ProcessStartedType#getPercentCompleted <em>Percent Completed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.RequestBaseType <em>Request Base
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.RequestBaseType#getLanguage
   * <em>Language</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.RequestBaseType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.RequestBaseType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.RequestBaseType#getBaseUrl
   * <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.RequestBaseType#getExtendedProperties <em>Extended Properties</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Extended Properties</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ResponseBaseType <em>Response Base
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ResponseBaseType#getLang
   * <em>Lang</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ResponseBaseType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.ResponseBaseType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ResponseDocumentType <em>Response
   * Document Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wps10.ResponseDocumentType#getOutput <em>Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Output</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ResponseDocumentType#isLineage <em>Lineage</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ResponseDocumentType#isStatus <em>Status</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ResponseDocumentType#isStoreExecuteResponse <em>Store Execute
   * Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ResponseFormType <em>Response Form
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ResponseFormType#getResponseDocument <em>Response Document</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.ResponseFormType#getRawDataOutput <em>Raw Data Output</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.StatusType#getProcessAccepted <em>Process Accepted</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.StatusType#getProcessStarted <em>Process Started</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.StatusType#getProcessPaused <em>Process Paused</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.StatusType#getProcessSucceeded <em>Process Succeeded</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.StatusType#getProcessFailed <em>Process Failed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.StatusType#getCreationTime
   * <em>Creation Time</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.SupportedComplexDataInputType
   * <em>Supported Complex Data Input Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.SupportedComplexDataInputType#getMaximumMegabytes <em>Maximum
   * Megabytes</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.SupportedComplexDataType
   * <em>Supported Complex Data Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedComplexDataType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Default</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedComplexDataType#getSupported <em>Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.SupportedCRSsType <em>Supported CR
   * Ss Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedCRSsType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Default</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedCRSsType#getSupported <em>Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported</em>'.
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.SupportedUOMsType <em>Supported UO
   * Ms Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedUOMsType#getDefault <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Default</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.SupportedUOMsType#getSupported <em>Supported</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Supported</em>'.
  ...
  /**
   * Returns the meta object for the reference list '{@link net.opengis.wps10.UOMsType#getUOM
   * <em>UOM</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.ValuesReferenceType <em>Values
   * Reference Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ValuesReferenceType#getReference <em>Reference</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.ValuesReferenceType#getValuesForm <em>Values Form</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wps10.WPSCapabilitiesType <em>WPS
   * Capabilities Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.WPSCapabilitiesType#getProcessOfferings <em>Process Offerings</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Process Offerings</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.WPSCapabilitiesType#getLanguages <em>Languages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Languages</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wps10.WPSCapabilitiesType#getWSDL <em>WSDL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>WSDL</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.WPSCapabilitiesType#getLang
   * <em>Lang</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wps10.WPSCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Service</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wps10.WSDLType#getHref
   * <em>Href</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wps10.MethodType <em>Method Type
   * Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link java.math.BigInteger <em>Percent Completed
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger" extendedMetaData="name='percentCompleted_._type'
   *     baseType='http://www.eclipse.org/emf/2003/XMLType#integer' minInclusive='0'
   *     maxInclusive='99'"
   * @generated
   */
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.BodyReferenceTypeImpl <em>Body
     * Reference Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * net.opengis.wps10.impl.ComplexDataCombinationsTypeImpl <em>Complex Data Combinations
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference COMPLEX_DATA_COMBINATIONS_TYPE__FORMAT =
        eINSTANCE.getComplexDataCombinationsType_Format();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ComplexDataCombinationTypeImpl
     * <em>Complex Data Combination Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference COMPLEX_DATA_COMBINATION_TYPE__FORMAT =
        eINSTANCE.getComplexDataCombinationType_Format();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ComplexDataDescriptionTypeImpl
     * <em>Complex Data Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute COMPLEX_DATA_DESCRIPTION_TYPE__MIME_TYPE =
        eINSTANCE.getComplexDataDescriptionType_MimeType();
     ...
     * @generated
     */
    EAttribute COMPLEX_DATA_DESCRIPTION_TYPE__ENCODING =
        eINSTANCE.getComplexDataDescriptionType_Encoding();
     ...
     * @generated
     */
    EAttribute COMPLEX_DATA_DESCRIPTION_TYPE__SCHEMA =
        eINSTANCE.getComplexDataDescriptionType_Schema();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ComplexDataTypeImpl
     * <em>Complex Data Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ComplexDataTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.CRSsTypeImpl <em>CR Ss
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DataInputsTypeImpl <em>Data
     * Inputs Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.DataInputsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DataInputsType1Impl <em>Data
     * Inputs Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.DataInputsType1Impl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DataTypeImpl <em>Data
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Bounding Box Data</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DefaultTypeImpl <em>Default
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DefaultType1Impl <em>Default
     * Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DefaultType2Impl <em>Default
     * Type2</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DescribeProcessTypeImpl
     * <em>Describe Process Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.DescribeProcessTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Identifier</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DescriptionTypeImpl
    ...
    /**
     * The meta object literal for the '{@link
     * net.opengis.wps10.impl.DocumentOutputDefinitionTypeImpl <em>Document Output Definition
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE =
        eINSTANCE.getDocumentOutputDefinitionType_Title();
     ...
     * @generated
     */
    EReference DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT =
        eINSTANCE.getDocumentOutputDefinitionType_Abstract();
     ...
     * @generated
     */
    EAttribute DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE =
        eINSTANCE.getDocumentOutputDefinitionType_AsReference();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.DocumentRootImpl <em>Document
     * Root</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Describe Process</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Execute Response</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Process Descriptions</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference DOCUMENT_ROOT__PROCESS_DESCRIPTIONS =
        eINSTANCE.getDocumentRoot_ProcessDescriptions();

    /**
     * The meta object literal for the '<em><b>Process Offerings</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl
     * <em>Execute Response Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ExecuteResponseTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Output Definitions</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference EXECUTE_RESPONSE_TYPE__OUTPUT_DEFINITIONS =
        eINSTANCE.getExecuteResponseType_OutputDefinitions();

    /**
     * The meta object literal for the '<em><b>Process Outputs</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference EXECUTE_RESPONSE_TYPE__PROCESS_OUTPUTS =
        eINSTANCE.getExecuteResponseType_ProcessOutputs();
     ...
     * @generated
     */
    EAttribute EXECUTE_RESPONSE_TYPE__SERVICE_INSTANCE =
        eINSTANCE.getExecuteResponseType_ServiceInstance();
     ...
     * @generated
     */
    EAttribute EXECUTE_RESPONSE_TYPE__STATUS_LOCATION =
        eINSTANCE.getExecuteResponseType_StatusLocation();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ExecuteTypeImpl <em>Execute
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Response Form</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.HeaderTypeImpl <em>Header
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.InputDescriptionTypeImpl
     * <em>Input Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.InputDescriptionTypeImpl
     ...
     * @generated
     */
    EReference INPUT_DESCRIPTION_TYPE__COMPLEX_DATA =
        eINSTANCE.getInputDescriptionType_ComplexData();
     ...
     * @generated
     */
    EReference INPUT_DESCRIPTION_TYPE__LITERAL_DATA =
        eINSTANCE.getInputDescriptionType_LiteralData();
     ...
     * @generated
     */
    EReference INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA =
        eINSTANCE.getInputDescriptionType_BoundingBoxData();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.InputReferenceTypeImpl
     * <em>Input Reference Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.InputReferenceTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Body Reference</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference INPUT_REFERENCE_TYPE__BODY_REFERENCE =
        eINSTANCE.getInputReferenceType_BodyReference();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.InputTypeImpl <em>Input
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.LanguagesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.LanguagesType1Impl
     * <em>Languages Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.LanguagesType1Impl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.LiteralDataTypeImpl
     * <em>Literal Data Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.LiteralDataTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.LiteralInputTypeImpl
     * <em>Literal Input Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.LiteralInputTypeImpl
     ...
     * @generated
     */
    EReference LITERAL_INPUT_TYPE__VALUES_REFERENCE =
        eINSTANCE.getLiteralInputType_ValuesReference();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.LiteralOutputTypeImpl
     * <em>Literal Output Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.LiteralOutputTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.OutputDataTypeImpl <em>Output
     * Data Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.OutputDefinitionsTypeImpl
     * <em>Output Definitions Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.OutputDefinitionsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl
     * <em>Output Definition Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.OutputDefinitionTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.OutputDescriptionTypeImpl
     * <em>Output Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.OutputDescriptionTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Complex Output</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference OUTPUT_DESCRIPTION_TYPE__COMPLEX_OUTPUT =
        eINSTANCE.getOutputDescriptionType_ComplexOutput();

    /**
     * The meta object literal for the '<em><b>Literal Output</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference OUTPUT_DESCRIPTION_TYPE__LITERAL_OUTPUT =
        eINSTANCE.getOutputDescriptionType_LiteralOutput();

    /**
     * The meta object literal for the '<em><b>Bounding Box Output</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference OUTPUT_DESCRIPTION_TYPE__BOUNDING_BOX_OUTPUT =
        eINSTANCE.getOutputDescriptionType_BoundingBoxOutput();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.OutputReferenceTypeImpl
     * <em>Output Reference Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.OutputReferenceTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessBriefTypeImpl
     * <em>Process Brief Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessBriefTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessDescriptionsTypeImpl
     * <em>Process Descriptions Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Process Description</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference PROCESS_DESCRIPTIONS_TYPE__PROCESS_DESCRIPTION =
        eINSTANCE.getProcessDescriptionsType_ProcessDescription();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl
     * <em>Process Description Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference PROCESS_DESCRIPTION_TYPE__DATA_INPUTS =
        eINSTANCE.getProcessDescriptionType_DataInputs();
     ...
     * @generated
     */
    EReference PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS =
        eINSTANCE.getProcessDescriptionType_ProcessOutputs();
     ...
     * @generated
     */
    EAttribute PROCESS_DESCRIPTION_TYPE__STATUS_SUPPORTED =
        eINSTANCE.getProcessDescriptionType_StatusSupported();
     ...
     * @generated
     */
    EAttribute PROCESS_DESCRIPTION_TYPE__STORE_SUPPORTED =
        eINSTANCE.getProcessDescriptionType_StoreSupported();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessFailedTypeImpl
     * <em>Process Failed Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessFailedTypeImpl
     ...
     * @generated
     */
    EReference PROCESS_FAILED_TYPE__EXCEPTION_REPORT =
        eINSTANCE.getProcessFailedType_ExceptionReport();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessOfferingsTypeImpl
     * <em>Process Offerings Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessOfferingsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessOutputsTypeImpl
     * <em>Process Outputs Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessOutputsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessOutputsType1Impl
     * <em>Process Outputs Type1</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessOutputsType1Impl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ProcessStartedTypeImpl
     * <em>Process Started Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ProcessStartedTypeImpl
     ...
     * @generated
     */
    EAttribute PROCESS_STARTED_TYPE__PERCENT_COMPLETED =
        eINSTANCE.getProcessStartedType_PercentCompleted();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.RequestBaseTypeImpl
     ...
     * @generated
     */
    EAttribute REQUEST_BASE_TYPE__EXTENDED_PROPERTIES =
        eINSTANCE.getRequestBaseType_ExtendedProperties();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ResponseBaseTypeImpl
     * <em>Response Base Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ResponseBaseTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl
     * <em>Response Document Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ResponseDocumentTypeImpl
     ...
     * @generated
     */
    EAttribute RESPONSE_DOCUMENT_TYPE__STORE_EXECUTE_RESPONSE =
        eINSTANCE.getResponseDocumentType_StoreExecuteResponse();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ResponseFormTypeImpl
     * <em>Response Form Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.ResponseFormTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Response Document</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT =
        eINSTANCE.getResponseFormType_ResponseDocument();

    /**
     * The meta object literal for the '<em><b>Raw Data Output</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.StatusTypeImpl <em>Status
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Process Started</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Process Paused</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Process Failed</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link
     * net.opengis.wps10.impl.SupportedComplexDataInputTypeImpl <em>Supported Complex Data Input
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EAttribute SUPPORTED_COMPLEX_DATA_INPUT_TYPE__MAXIMUM_MEGABYTES =
        eINSTANCE.getSupportedComplexDataInputType_MaximumMegabytes();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.SupportedComplexDataTypeImpl
     * <em>Supported Complex Data Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference SUPPORTED_COMPLEX_DATA_TYPE__DEFAULT =
        eINSTANCE.getSupportedComplexDataType_Default();
     ...
     * @generated
     */
    EReference SUPPORTED_COMPLEX_DATA_TYPE__SUPPORTED =
        eINSTANCE.getSupportedComplexDataType_Supported();

    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.SupportedCRSsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.SupportedUOMsTypeImpl
     * <em>Supported UO Ms Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.SupportedUOMsTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.UOMsTypeImpl <em>UO Ms
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.ValuesReferenceTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl
     * <em>WPS Capabilities Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wps10.impl.WPSCapabilitiesTypeImpl
     ...
     * @generated
     */
    EReference WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS =
        eINSTANCE.getWPSCapabilitiesType_ProcessOfferings();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.impl.WSDLTypeImpl <em>WSDL
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wps10.MethodType <em>Method Type</em>}'
     * enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
