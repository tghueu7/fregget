 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.SupportedCRSsType#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.SupportedCRSsType#getSupported <em>Supported</em>}
 * </ul>
 *
...
public interface SupportedCRSsType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies the default CRS that will be used unless the Execute operation request specifies
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.SupportedCRSsType#getDefault <em>Default</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of references to all of the CRSs supported for this Input/Output. The default
   * CRS shall be included in this list.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.SupportedCRSsType#getSupported
