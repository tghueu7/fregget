 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.SupportedComplexDataInputType#getMaximumMegabytes <em>Maximum
 *       Megabytes</em>}
 * </ul>
 *
...
public interface SupportedComplexDataInputType extends SupportedComplexDataType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The maximum file size, in megabytes, of this input. If the input exceeds this size, the server
   * will return an error instead of processing the inputs.
   * <!-- end-model-doc -->
   *
