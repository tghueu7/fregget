 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ExecuteType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wps10.ExecuteType#getDataInputs <em>Data Inputs</em>}
 *   <li>{@link net.opengis.wps10.ExecuteType#getResponseForm <em>Response Form</em>}
 * </ul>
 *
...
public interface ExecuteType extends RequestBaseType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ExecuteType#getIdentifier <em>Identifier</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * List of input (or parameter) values provided to the process, including each of the Inputs
   * needed to execute the process. It is possible to have no inputs provided only when all the
   * inputs are predetermined fixed resources. In all other cases, at least one input is required.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ExecuteType#getDataInputs <em>Data
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Defines the response type of the WPS, either raw data or XML document. If absent, the response
   * shall be a response document which includes all outputs encoded in the response.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ResponseForm'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ExecuteType#getResponseForm <em>Response
   * Form</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
