 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ProcessStartedType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wps10.ProcessStartedType#getPercentCompleted <em>Percent Completed</em>}
 * </ul>
 *
...
public interface ProcessStartedType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A human-readable text string whose contents are left open to definition by each WPS server, but
   * is expected to include any messages the server may wish to let the clients know. Such
   * information could include how much longer the process may take to execute, or any warning
   * conditions that may have been encountered to date. The client may display this text to a human
   * user.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessStartedType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Percentage of process that has been completed, where 0 means the process has just started, and
   * 99 means the process is almost complete. This value is expected to be accurate to within ten
   * percent.
   * <!-- end-model-doc -->
   *
   ...
   * @model dataType="net.opengis.wps10.PercentCompletedType" extendedMetaData="kind='attribute'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessStartedType#getPercentCompleted
   * <em>Percent Completed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
