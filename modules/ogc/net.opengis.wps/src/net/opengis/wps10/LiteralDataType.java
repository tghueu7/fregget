 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * One simple literal value (such as an integer or real number) that is embedded in the Execute
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.LiteralDataType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wps10.LiteralDataType#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.wps10.LiteralDataType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface LiteralDataType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LiteralDataType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies the data type of this literal input or output. This dataType should be included for
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LiteralDataType#getDataType <em>Data
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies the unit of measure of this literal input or output. This unit of measure should be
   * referenced for any numerical value that has units (e.g., "meters", but not a more complete
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LiteralDataType#getUom <em>Uom</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
