...
public class Wps10Validator extends EObjectValidator {
  ...
  protected boolean validate(
    ...
    switch (classifierID) {
      ...
      case Wps10Package.COMPLEX_DATA_COMBINATIONS_TYPE:
        return validateComplexDataCombinationsType(
            (ComplexDataCombinationsType) value, diagnostics, context);
      case Wps10Package.COMPLEX_DATA_COMBINATION_TYPE:
        return validateComplexDataCombinationType(
            (ComplexDataCombinationType) value, diagnostics, context);
      case Wps10Package.COMPLEX_DATA_DESCRIPTION_TYPE:
        return validateComplexDataDescriptionType(
            (ComplexDataDescriptionType) value, diagnostics, context);
      ...
      case Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE:
        return validateDocumentOutputDefinitionType(
            (DocumentOutputDefinitionType) value, diagnostics, context);
      ...
      case Wps10Package.PROCESS_DESCRIPTIONS_TYPE:
        return validateProcessDescriptionsType(
            (ProcessDescriptionsType) value, diagnostics, context);
      ...
      case Wps10Package.SUPPORTED_COMPLEX_DATA_INPUT_TYPE:
        return validateSupportedComplexDataInputType(
            (SupportedComplexDataInputType) value, diagnostics, context);
      case Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE:
        return validateSupportedComplexDataType(
            (SupportedComplexDataType) value, diagnostics, context);
   ...
   * @generated
   */
  public boolean validateBodyReferenceType(
      BodyReferenceType bodyReferenceType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateComplexDataCombinationsType(
   ...
   * @generated
   */
  public boolean validateComplexDataCombinationType(
   ...
   * @generated
   */
  public boolean validateComplexDataDescriptionType(
   ...
   * @generated
   */
  public boolean validateComplexDataType(
   ...
   * @generated
   */
  public boolean validateDataInputsType1(
   ...
   * @generated
   */
  public boolean validateDefaultType(
   ...
   * @generated
   */
  public boolean validateDefaultType1(
      DefaultType1 defaultType1, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateDefaultType2(
   ...
   * @generated
   */
  public boolean validateDescribeProcessType(
   ...
   * @generated
   */
  public boolean validateDocumentOutputDefinitionType(
   ...
   * @generated
   */
  public boolean validateExecuteResponseType(
   ...
   * @generated
   */
  public boolean validateExecuteType(
   ...
   * @generated
   */
  public boolean validateHeaderType(
      HeaderType headerType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateInputDescriptionType(
      InputDescriptionType inputDescriptionType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateInputReferenceType(
   ...
   * @generated
   */
  public boolean validateLanguagesType1(
   ...
   * @generated
   */
  public boolean validateLiteralDataType(
   ...
   * @generated
   */
  public boolean validateLiteralOutputType(
   ...
   * @generated
   */
  public boolean validateOutputDataType(
   ...
   * @generated
   */
  public boolean validateOutputDefinitionType(
  ...
  public boolean validateOutputDescriptionType(
      OutputDescriptionType outputDescriptionType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateOutputReferenceType(
   ...
   * @generated
   */
  public boolean validateProcessBriefType(
   ...
   * @generated
   */
  public boolean validateProcessDescriptionType(
      ProcessDescriptionType processDescriptionType, DiagnosticChain diagnostics, Map context) {
   ...
   * @generated
   */
  public boolean validateProcessFailedType(
   ...
   * @generated
   */
  public boolean validateProcessOfferingsType(
   ...
   * @generated
   */
  public boolean validateProcessOutputsType(
   ...
   * @generated
   */
  public boolean validateProcessOutputsType1(
   ...
   * @generated
   */
  public boolean validateProcessStartedType(
   ...
   * @generated
   */
  public boolean validateResponseBaseType(
   ...
   * @generated
   */
  public boolean validateResponseDocumentType(
   ...
   * @generated
   */
  public boolean validateSupportedComplexDataInputType(
   ...
   * @generated
   */
  public boolean validateSupportedComplexDataType(
   ...
   * @generated
   */
  public boolean validateSupportedCRSsType(
   ...
   * @generated
   */
  public boolean validateSupportedUOMsType(
   ...
   * @generated
   */
  public boolean validateWPSCapabilitiesType(
   ...
   * @generated
   */
  public boolean validateMethodType(
      MethodType methodType, DiagnosticChain diagnostics, Map context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateMethodTypeObject(
   ...
   * @generated
   */
  public boolean validatePercentCompletedType(
      BigInteger percentCompletedType, DiagnosticChain diagnostics, Map context) {
    boolean result = validatePercentCompletedType_Min(percentCompletedType, diagnostics, context);
    if (result || diagnostics != null)
      result &= validatePercentCompletedType_Max(percentCompletedType, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validatePercentCompletedType_Min(
      BigInteger percentCompletedType, DiagnosticChain diagnostics, Map context) {
    boolean result = percentCompletedType.compareTo(PERCENT_COMPLETED_TYPE__MIN__VALUE) >= 0;
    if (!result && diagnostics != null)
      reportMinViolation(
          Wps10Package.Literals.PERCENT_COMPLETED_TYPE,
          percentCompletedType,
   ...
   * @generated
   */
  public boolean validatePercentCompletedType_Max(
      BigInteger percentCompletedType, DiagnosticChain diagnostics, Map context) {
