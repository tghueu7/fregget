 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.InputType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wps10.InputType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wps10.InputType#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wps10.InputType#getReference <em>Reference</em>}
 *   <li>{@link net.opengis.wps10.InputType#getData <em>Data</em>}
 * </ul>
 *
...
public interface InputType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputType#getIdentifier <em>Identifier</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputType#getTitle <em>Title</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputType#getAbstract <em>Abstract</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Reference'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputType#getReference <em>Reference</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Data'
   *     namespace='##targetNamespace'"
   * @generated
   */
  DataType getData();
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputType#getData <em>Data</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
