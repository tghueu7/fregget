 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}
 *   <li>{@link net.opengis.wps10.GetCapabilitiesType#getLanguage <em>Language</em>}
 *   <li>{@link net.opengis.wps10.GetCapabilitiesType#getService <em>Service</em>}
 *   <li>{@link net.opengis.wps10.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.wps10.GetCapabilitiesType#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
...
public interface GetCapabilitiesType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getAcceptVersions
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getLanguage
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getService
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getService
   * <em>Service</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getService
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getBaseUrl <em>Base
   * Url</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.GetCapabilitiesType#getExtendedProperties
