 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.StatusType#getProcessAccepted <em>Process Accepted</em>}
 *   <li>{@link net.opengis.wps10.StatusType#getProcessStarted <em>Process Started</em>}
 *   <li>{@link net.opengis.wps10.StatusType#getProcessPaused <em>Process Paused</em>}
 *   <li>{@link net.opengis.wps10.StatusType#getProcessSucceeded <em>Process Succeeded</em>}
 *   <li>{@link net.opengis.wps10.StatusType#getProcessFailed <em>Process Failed</em>}
 *   <li>{@link net.opengis.wps10.StatusType#getCreationTime <em>Creation Time</em>}
 * </ul>
 *
...
public interface StatusType extends EObject {
   ...
   * started to execute. The contents of this human-readable text string is left open to definition
   * by each server implementation, but is expected to include any messages the server may wish to
   * let the clients know. Such information could include how long the queue is, or any warning
   * conditions that may have been encountered. The client may display this text to a human user.
   * <!-- end-model-doc -->
   *
   ...
   *     name='ProcessAccepted' namespace='##targetNamespace'"
   * @generated
   */
  String getProcessAccepted();

  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getProcessAccepted <em>Process
   * Accepted</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ProcessStarted'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getProcessStarted <em>Process
   * Started</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that this process has been accepted by the server, and processing has started but
   * subsequently been paused by the server.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ProcessPaused'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getProcessPaused <em>Process
   * Paused</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * include any messages the server may wish to let the clients know, such as how long the process
   * took to execute, or any warning conditions that may have been encountered. The client may
   * display this text string to a human user. The client should make use of the presence of this
   * element to trigger automated or manual access to the results of the process. If manual access
   * is intended, the client should use the presence of this element to present the results as
   * downloadable links to the user.
   * <!-- end-model-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element'
   *     name='ProcessSucceeded' namespace='##targetNamespace'"
   * @generated
   */
  String getProcessSucceeded();

  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getProcessSucceeded <em>Process
   * Succeeded</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ProcessFailed'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getProcessFailed <em>Process
   * Failed</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The time (UTC) that the process finished. If the process is still executing or awaiting
   * execution, this element shall contain the creation time of this document.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.StatusType#getCreationTime <em>Creation
   * Time</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
