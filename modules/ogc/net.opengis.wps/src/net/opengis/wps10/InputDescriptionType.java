 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Description of an input to a process. In this use, the DescriptionType shall describe this
 * process input.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.InputDescriptionType#getComplexData <em>Complex Data</em>}
 *   <li>{@link net.opengis.wps10.InputDescriptionType#getLiteralData <em>Literal Data</em>}
 *   <li>{@link net.opengis.wps10.InputDescriptionType#getBoundingBoxData <em>Bounding Box
 *       Data</em>}
 *   <li>{@link net.opengis.wps10.InputDescriptionType#getMaxOccurs <em>Max Occurs</em>}
 *   <li>{@link net.opengis.wps10.InputDescriptionType#getMinOccurs <em>Min Occurs</em>}
 * </ul>
 *
...
public interface InputDescriptionType extends DescriptionType {
   ...
   * provides a list of Formats, Encodings, and Schemas supported for this Input. The value of this
   * ComplexData structure can be input either embedded in the Execute request or remotely
   * accessible to the server. The client can select from among the identified combinations of
   * Formats, Encodings, and Schemas to specify the form of the Input. This allows for complete
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ComplexData'"
   * @generated
   */
  SupportedComplexDataInputType getComplexData();

  /**
   * Sets the value of the '{@link net.opengis.wps10.InputDescriptionType#getComplexData <em>Complex
   * Data</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that this Input shall be a simple numeric value or character string that is embedded
   * in the execute request, and describes the possible values.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LiteralData'"
   * @generated
   */
  LiteralInputType getLiteralData();

  /**
   * Sets the value of the '{@link net.opengis.wps10.InputDescriptionType#getLiteralData <em>Literal
   * Data</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that this Input shall be a BoundingBox data structure that is embedded in the execute
   * request, and provides a list of the Coordinate Reference System support for this Bounding Box.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='BoundingBoxData'"
   * @generated
   */
  SupportedCRSsType getBoundingBoxData();

  /**
   * Sets the value of the '{@link net.opengis.wps10.InputDescriptionType#getBoundingBoxData
   * <em>Bounding Box Data</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * If "1" then this parameter may appear only once in an Execute request. If greater than "1",
   * then this input parameter may appear that many times in an Execute request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputDescriptionType#getMaxOccurs <em>Max
   * Occurs</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The minimum number of times that values for this parameter are required in an Execute request.
   * If "0", this data input is optional. If greater than "0" then this process input is required.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.InputDescriptionType#getMinOccurs <em>Min
   * Occurs</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
