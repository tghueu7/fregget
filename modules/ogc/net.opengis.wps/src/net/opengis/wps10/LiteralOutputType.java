 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.LiteralOutputType#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.wps10.LiteralOutputType#getUOMs <em>UO Ms</em>}
 * </ul>
 *
...
public interface LiteralOutputType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LiteralOutputType#getDataType <em>Data
   ...
   * @model containment="true" extendedMetaData="kind='element' name='UOMs'"
   * @generated
   */
  SupportedUOMsType getUOMs();

  /**
   * Sets the value of the '{@link net.opengis.wps10.LiteralOutputType#getUOMs <em>UO Ms</em>}'
