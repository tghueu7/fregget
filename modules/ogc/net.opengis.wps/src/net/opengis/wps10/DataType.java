 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.DataType#getComplexData <em>Complex Data</em>}
 *   <li>{@link net.opengis.wps10.DataType#getLiteralData <em>Literal Data</em>}
 *   <li>{@link net.opengis.wps10.DataType#getBoundingBoxData <em>Bounding Box Data</em>}
 * </ul>
 *
...
public interface DataType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies this input or output value as a complex data structure encoded in XML (e.g., using
   * GML), and provides that complex data structure. For an input, this element may be used by a
   * client for any process input coded as ComplexData in the ProcessDescription. For an output,
   * this element shall be used by a server when "store" in the Execute request is "false".
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DataType#getComplexData <em>Complex Data</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies this input or output data as literal data of a simple quantity (e.g., one number),
   * and provides that data.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DataType#getLiteralData <em>Literal Data</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies this input or output data as an ows:BoundingBox data structure, and provides that
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DataType#getBoundingBoxData <em>Bounding Box
