 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.DescribeProcessType#getIdentifier <em>Identifier</em>}
 * </ul>
 *
...
public interface DescribeProcessType extends RequestBaseType {
   ...
   * detailed descriptions. This element shall be repeated for each process for which a description
   * is requested. These Identifiers are unordered, but the WPS shall return the process
