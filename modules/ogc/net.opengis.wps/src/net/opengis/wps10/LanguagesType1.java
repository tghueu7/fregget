 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.LanguagesType1#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.LanguagesType1#getSupported <em>Supported</em>}
 * </ul>
 *
...
public interface LanguagesType1 extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Identifies the default language that will be used unless the operation request specifies
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LanguagesType1#getDefault <em>Default</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of references to all of the languages supported by this service. The default
   * language shall be included in this list.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.LanguagesType1#getSupported
