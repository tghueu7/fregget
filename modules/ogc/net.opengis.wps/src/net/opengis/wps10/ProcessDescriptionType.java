 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ProcessDescriptionType#getDataInputs <em>Data Inputs</em>}
 *   <li>{@link net.opengis.wps10.ProcessDescriptionType#getProcessOutputs <em>Process Outputs</em>}
 *   <li>{@link net.opengis.wps10.ProcessDescriptionType#isStatusSupported <em>Status
 *       Supported</em>}
 *   <li>{@link net.opengis.wps10.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}
 * </ul>
 *
...
public interface ProcessDescriptionType extends ProcessBriefType {
   ...
   * fixed resources. In this case, those resources shall be identified in the ows:Abstract element
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#getDataInputs <em>Data
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#getProcessOutputs
  ...
  /**
   * Returns the value of the '<em><b>Status Supported</b></em>' attribute. The default value is
   * <code>"false"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates if ongoing status information can be provided for this process. If "true", the Status
   * element of the stored Execute response document shall be kept up to date. If "false" then the
   * Status element shall not be updated until processing is complete. By default, status
   * information is not provided for this process.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#isStatusSupported
   * <em>Status Supported</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#isStatusSupported
   * <em>Status Supported</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Store Supported</b></em>' attribute. The default value is
   * <code>"false"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * include "asReference" equals "true" for any complex output, directing that the output of the
   * process be stored so that the client can retrieve it as required. By default for this process,
   * storage is not supported and all outputs are returned encoded in the Execute response.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#isStoreSupported
   * <em>Store Supported</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wps10.ProcessDescriptionType#isStoreSupported
   * <em>Store Supported</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.wps10.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}' attribute
   * is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
