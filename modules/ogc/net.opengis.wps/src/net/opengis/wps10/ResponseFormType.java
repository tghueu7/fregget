 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ResponseFormType#getResponseDocument <em>Response Document</em>}
 *   <li>{@link net.opengis.wps10.ResponseFormType#getRawDataOutput <em>Raw Data Output</em>}
 * </ul>
 *
...
public interface ResponseFormType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ResponseDocument'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ResponseFormType#getResponseDocument
   * <em>Response Document</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indicates that the output shall be returned directly as raw data, without a WPS response
   * document.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='RawDataOutput'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ResponseFormType#getRawDataOutput <em>Raw Data
   * Output</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
