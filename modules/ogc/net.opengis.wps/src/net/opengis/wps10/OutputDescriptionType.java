 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Description of a process Output. In this use, the DescriptionType shall describe this process
 * output.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.OutputDescriptionType#getComplexOutput <em>Complex Output</em>}
 *   <li>{@link net.opengis.wps10.OutputDescriptionType#getLiteralOutput <em>Literal Output</em>}
 *   <li>{@link net.opengis.wps10.OutputDescriptionType#getBoundingBoxOutput <em>Bounding Box
 *       Output</em>}
 * </ul>
 *
...
public interface OutputDescriptionType extends DescriptionType {
   ...
   * output either embedded in the execute operation response or remotely accessible to the client.
   * When this output form is indicated, the process produces only a single output, and "store" is
   * "false, the output shall be returned directly, without being embedded in the XML document that
   * is otherwise provided by execute operation response. This element also provides a list of
   * format, encoding, and schema combinations supported for this output. The client can select from
   * among the identified combinations of formats, encodings, and schemas to specify the form of the
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ComplexOutput'"
   * @generated
   */
  SupportedComplexDataType getComplexOutput();

  /**
   * Sets the value of the '{@link net.opengis.wps10.OutputDescriptionType#getComplexOutput
   * <em>Complex Output</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LiteralOutput'"
   * @generated
   */
  LiteralOutputType getLiteralOutput();

  /**
   * Sets the value of the '{@link net.opengis.wps10.OutputDescriptionType#getLiteralOutput
   * <em>Literal Output</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * CRSs supported in these Bounding Boxes. This element shall be included when this process output
   ...
   * @model containment="true" extendedMetaData="kind='element' name='BoundingBoxOutput'"
   * @generated
   */
  SupportedCRSsType getBoundingBoxOutput();

  /**
   * Sets the value of the '{@link net.opengis.wps10.OutputDescriptionType#getBoundingBoxOutput
   * <em>Bounding Box Output</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
