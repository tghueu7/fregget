 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ProcessDescriptionsType#getProcessDescription <em>Process
 *       Description</em>}
 * </ul>
 *
...
public interface ProcessDescriptionsType extends ResponseBaseType {
  /**
   * Returns the value of the '<em><b>Process Description</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wps10.ProcessDescriptionType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered list of one or more full Process descriptions, listed in the order in which they were
   * requested in the DescribeProcess operation request.
   * <!-- end-model-doc -->
   *
