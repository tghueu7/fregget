 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getCapabilities <em>Capabilities</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getDescribeProcess <em>Describe Process</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getExecute <em>Execute</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getExecuteResponse <em>Execute Response</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getLanguages <em>Languages</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getProcessDescriptions <em>Process Descriptions</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getProcessOfferings <em>Process Offerings</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wps10.DocumentRoot#getProcessVersion <em>Process Version</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * WPS GetCapabilities operation response. This document provides clients with service metadata
   * about a specific service instance, including metadata about the processes that can be executed.
   * Since the server does not implement the updateSequence and Sections parameters, the server
   * shall always return the complete Capabilities document, without the updateSequence parameter.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getCapabilities
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getDescribeProcess <em>Describe
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * WPS Execute operation request, to execute one identified Process. If a process is to be run
   * multiple times, each run shall be submitted as a separate Execute request.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getExecute <em>Execute</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * WPS Execute operation response. By default, this XML document is delivered to the client in
   * response to an Execute request. If "status" is "false" in the Execute operation request, this
   * document is normally returned when process execution has been completed. If "status" in the
   * Execute request is "true", this response shall be returned as soon as the Execute request has
   * been accepted for processing. In this case, the same XML document is also made available as a
   * web-accessible resource from the URL identified in the statusLocation, and the WPS server shall
   * repopulate it once the process has completed. It may repopulate it on an ongoing basis while
   * the process is executing. However, the response to an Execute request will not include this
   * element in the special case where the output is a single complex value result and the Execute
   * request indicates that "store" is "false". Instead, the server shall return the complex result
   * (e.g., GIF image or GML) directly, without encoding it in the ExecuteResponse. If processing
   * fails in this special case, the normal ExecuteResponse shall be sent, with the error condition
   * indicated. This option is provided to simplify the programming required for simple clients and
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getExecuteResponse <em>Execute
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getGetCapabilities <em>Get
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getLanguages <em>Languages</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getProcessDescriptions <em>Process
   * Descriptions</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getProcessOfferings <em>Process
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getWSDL <em>WSDL</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * clarification about the process to be used. It is possible that a WPS supports a process with
   * different versions due to reasons such as modifications of process algorithms. Notice that this
   * is the version identifier for the process, not the version of the WPS interface. The
   * processVersion is informative only. Version negotiation for processVersion is not available.
   * Requests to Execute a process do not include a processVersion identifier.
   * <!-- end-model-doc -->
   *
   ...
   *     name='processVersion' namespace='##targetNamespace'"
   * @generated
   */
  String getProcessVersion();

  /**
   * Sets the value of the '{@link net.opengis.wps10.DocumentRoot#getProcessVersion <em>Process
