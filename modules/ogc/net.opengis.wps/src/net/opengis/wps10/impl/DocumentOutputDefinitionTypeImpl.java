 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.DocumentOutputDefinitionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentOutputDefinitionTypeImpl#getAbstract
 *       <em>Abstract</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentOutputDefinitionTypeImpl#isAsReference <em>As
 *       Reference</em>}
 * </ul>
 *
 * @generated
 */
public class DocumentOutputDefinitionTypeImpl extends OutputDefinitionTypeImpl
    implements DocumentOutputDefinitionType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE,
              oldTitle,
              newTitle);
      ...
      if (title != null)
        msgs =
            ((InternalEObject) title)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE,
                    null,
                    msgs);
      if (newTitle != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT,
              oldAbstract,
              newAbstract);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (abstract_ != null)
        msgs =
            ((InternalEObject) abstract_)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT,
                    null,
                    msgs);
      if (newAbstract != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE,
              oldAsReference,
              asReference,
              !oldAsReferenceESet));
  }
