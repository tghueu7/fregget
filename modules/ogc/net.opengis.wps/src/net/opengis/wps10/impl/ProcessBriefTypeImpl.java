 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ProcessBriefTypeImpl#getProfile <em>Profile</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessBriefTypeImpl#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessBriefTypeImpl#getProcessVersion <em>Process
 *       Version</em>}
 * </ul>
 *
 * @generated
...
public class ProcessBriefTypeImpl extends DescriptionTypeImpl implements ProcessBriefType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_BRIEF_TYPE__PROFILE,
              oldProfile,
              profile));
  }
  ...
  public NotificationChain basicSetWSDL(WSDLType newWSDL, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.PROCESS_BRIEF_TYPE__WSDL, oldWSDL, newWSDL);
  ...
  public void setWSDL(WSDLType newWSDL) {
    if (newWSDL != wSDL) {
      ...
      if (wSDL != null)
        msgs =
            ((InternalEObject) wSDL)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.PROCESS_BRIEF_TYPE__WSDL,
                    null,
                    msgs);
      if (newWSDL != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.PROCESS_BRIEF_TYPE__WSDL, newWSDL, newWSDL));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_BRIEF_TYPE__PROCESS_VERSION,
              oldProcessVersion,
              processVersion));
  }
