 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.DataInputsType1Impl#getInput <em>Input</em>}
 * </ul>
 *
 * @generated
 */
public class DataInputsType1Impl extends EObjectImpl implements DataInputsType1 {
  ...
  public EList getInput() {
    if (input == null) {
      input =
          new EObjectContainmentEList(InputType.class, this, Wps10Package.DATA_INPUTS_TYPE1__INPUT);
    }
    return input;
  }
