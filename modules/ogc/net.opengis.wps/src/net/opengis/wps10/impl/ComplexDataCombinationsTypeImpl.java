 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ComplexDataCombinationsTypeImpl#getFormat <em>Format</em>}
 * </ul>
 *
 * @generated
 */
public class ComplexDataCombinationsTypeImpl extends EObjectImpl
    implements ComplexDataCombinationsType {
  /**
    ...
    if (format == null) {
      format =
          new EObjectContainmentEList(
              ...
              this,
              Wps10Package.COMPLEX_DATA_COMBINATIONS_TYPE__FORMAT);
    }
    return format;
  }
