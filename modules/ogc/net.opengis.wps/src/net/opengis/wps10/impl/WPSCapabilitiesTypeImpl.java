 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl#getProcessOfferings <em>Process
 *       Offerings</em>}
 *   <li>{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl#getLanguages <em>Languages</em>}
 *   <li>{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl#getLang <em>Lang</em>}
 *   <li>{@link net.opengis.wps10.impl.WPSCapabilitiesTypeImpl#getService <em>Service</em>}
 * </ul>
 *
 * @generated
 */
public class WPSCapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl
    implements WPSCapabilitiesType {
  /**
   * The cached value of the '{@link #getProcessOfferings() <em>Process Offerings</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS,
              oldProcessOfferings,
              newProcessOfferings);
  ...
  public void setProcessOfferings(ProcessOfferingsType newProcessOfferings) {
    if (newProcessOfferings != processOfferings) {
      ...
      if (processOfferings != null)
        msgs =
            ((InternalEObject) processOfferings)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS,
                    null,
                    msgs);
      if (newProcessOfferings != null)
        msgs =
            ((InternalEObject) newProcessOfferings)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.WPS_CAPABILITIES_TYPE__LANGUAGES,
              oldLanguages,
              newLanguages);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (languages != null)
        msgs =
            ((InternalEObject) languages)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.WPS_CAPABILITIES_TYPE__LANGUAGES,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetWSDL(WSDLType newWSDL, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.WPS_CAPABILITIES_TYPE__WSDL, oldWSDL, newWSDL);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setWSDL(WSDLType newWSDL) {
    if (newWSDL != wSDL) {
      ...
      if (wSDL != null)
        msgs =
            ((InternalEObject) wSDL)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.WPS_CAPABILITIES_TYPE__WSDL,
                    null,
                    msgs);
      if (newWSDL != null)
        msgs =
            ((InternalEObject) newWSDL)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.WPS_CAPABILITIES_TYPE__WSDL,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.WPS_CAPABILITIES_TYPE__WSDL, newWSDL, newWSDL));
  }
  ...
  public void setLang(String newLang) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.WPS_CAPABILITIES_TYPE__LANG, oldLang, lang));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.WPS_CAPABILITIES_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
