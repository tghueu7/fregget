 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.OutputDescriptionTypeImpl#getComplexOutput <em>Complex
 *       Output</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDescriptionTypeImpl#getLiteralOutput <em>Literal
 *       Output</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDescriptionTypeImpl#getBoundingBoxOutput <em>Bounding
 *       Box Output</em>}
 * </ul>
 *
 * @generated
 */
public class OutputDescriptionTypeImpl extends DescriptionTypeImpl
    implements OutputDescriptionType {
  /**
   * The cached value of the '{@link #getComplexOutput() <em>Complex Output</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getLiteralOutput() <em>Literal Output</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getBoundingBoxOutput() <em>Bounding Box Output</em>}'
   ...
   * @generated
   */
  public NotificationChain basicSetComplexOutput(
      SupportedComplexDataType newComplexOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DESCRIPTION_TYPE__COMPLEX_OUTPUT,
              oldComplexOutput,
              newComplexOutput);
  ...
  public void setComplexOutput(SupportedComplexDataType newComplexOutput) {
    if (newComplexOutput != complexOutput) {
      ...
      if (complexOutput != null)
        msgs =
            ((InternalEObject) complexOutput)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.OUTPUT_DESCRIPTION_TYPE__COMPLEX_OUTPUT,
                    null,
                    msgs);
      if (newComplexOutput != null)
        msgs =
            ((InternalEObject) newComplexOutput)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.OUTPUT_DESCRIPTION_TYPE__COMPLEX_OUTPUT,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetLiteralOutput(
      LiteralOutputType newLiteralOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DESCRIPTION_TYPE__LITERAL_OUTPUT,
              oldLiteralOutput,
              newLiteralOutput);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setLiteralOutput(LiteralOutputType newLiteralOutput) {
    if (newLiteralOutput != literalOutput) {
      ...
      if (literalOutput != null)
        msgs =
            ((InternalEObject) literalOutput)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.OUTPUT_DESCRIPTION_TYPE__LITERAL_OUTPUT,
                    null,
                    msgs);
      if (newLiteralOutput != null)
        msgs =
            ((InternalEObject) newLiteralOutput)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.OUTPUT_DESCRIPTION_TYPE__LITERAL_OUTPUT,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetBoundingBoxOutput(
      SupportedCRSsType newBoundingBoxOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DESCRIPTION_TYPE__BOUNDING_BOX_OUTPUT,
              oldBoundingBoxOutput,
              newBoundingBoxOutput);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setBoundingBoxOutput(SupportedCRSsType newBoundingBoxOutput) {
    if (newBoundingBoxOutput != boundingBoxOutput) {
      ...
      if (boundingBoxOutput != null)
        msgs =
            ((InternalEObject) boundingBoxOutput)
                .eInverseRemove(
                    this,
      ...
      if (newBoundingBoxOutput != null)
        msgs =
            ((InternalEObject) newBoundingBoxOutput)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Wps10Package.OUTPUT_DESCRIPTION_TYPE__BOUNDING_BOX_OUTPUT,
