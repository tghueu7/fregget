 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ComplexDataCombinationTypeImpl#getFormat <em>Format</em>}
 * </ul>
 *
 * @generated
 */
public class ComplexDataCombinationTypeImpl extends EObjectImpl
    implements ComplexDataCombinationType {
  /**
   ...
   * @generated
   */
  public NotificationChain basicSetFormat(
      ComplexDataDescriptionType newFormat, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.COMPLEX_DATA_COMBINATION_TYPE__FORMAT,
              oldFormat,
              newFormat);
      ...
      if (format != null)
        msgs =
            ((InternalEObject) format)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.COMPLEX_DATA_COMBINATION_TYPE__FORMAT,
                    null,
                    msgs);
      if (newFormat != null)
        msgs =
