 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ValuesReferenceTypeImpl#getReference <em>Reference</em>}
 *   <li>{@link net.opengis.wps10.impl.ValuesReferenceTypeImpl#getValuesForm <em>Values Form</em>}
 * </ul>
 *
 * @generated
 */
public class ValuesReferenceTypeImpl extends EObjectImpl implements ValuesReferenceType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.VALUES_REFERENCE_TYPE__REFERENCE,
              oldReference,
              reference));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.VALUES_REFERENCE_TYPE__VALUES_FORM,
              oldValuesForm,
              valuesForm));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wps10Package.VALUES_REFERENCE_TYPE__VALUES_FORM:
        return VALUES_FORM_EDEFAULT == null
            ? valuesForm != null
            : !VALUES_FORM_EDEFAULT.equals(valuesForm);
    }
