 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.SupportedComplexDataTypeImpl#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.impl.SupportedComplexDataTypeImpl#getSupported <em>Supported</em>}
 * </ul>
 *
 * @generated
 */
public class SupportedComplexDataTypeImpl extends EObjectImpl implements SupportedComplexDataType {
  ...
  public NotificationChain basicSetDefault(
      ComplexDataCombinationType newDefault, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE__DEFAULT,
              oldDefault,
              newDefault);
      ...
      if (default_ != null)
        msgs =
            ((InternalEObject) default_)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE__DEFAULT,
                    null,
                    msgs);
      if (newDefault != null)
        msgs =
   ...
   * @generated
   */
  public NotificationChain basicSetSupported(
      ComplexDataCombinationsType newSupported, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE__SUPPORTED,
              oldSupported,
              newSupported);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSupported(ComplexDataCombinationsType newSupported) {
    if (newSupported != supported) {
      ...
      if (supported != null)
        msgs =
            ((InternalEObject) supported)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE__SUPPORTED,
                    null,
                    msgs);
      if (newSupported != null)
        msgs =
            ((InternalEObject) newSupported)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.SUPPORTED_COMPLEX_DATA_TYPE__SUPPORTED,
                    null,
