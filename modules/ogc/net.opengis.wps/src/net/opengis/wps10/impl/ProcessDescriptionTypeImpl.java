 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl#getDataInputs <em>Data
 *       Inputs</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl#getProcessOutputs <em>Process
 *       Outputs</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl#isStatusSupported <em>Status
 *       Supported</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessDescriptionTypeImpl#isStoreSupported <em>Store
 *       Supported</em>}
 * </ul>
 *
 * @generated
 */
public class ProcessDescriptionTypeImpl extends ProcessBriefTypeImpl
  ...
  public NotificationChain basicSetDataInputs(
      DataInputsType newDataInputs, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS,
              oldDataInputs,
              newDataInputs);
      ...
      if (dataInputs != null)
        msgs =
            ((InternalEObject) dataInputs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetProcessOutputs(
      ProcessOutputsType newProcessOutputs, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS,
              oldProcessOutputs,
              newProcessOutputs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (processOutputs != null)
        msgs =
            ((InternalEObject) processOutputs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_DESCRIPTION_TYPE__STATUS_SUPPORTED,
              oldStatusSupported,
              statusSupported,
              !oldStatusSupportedESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_DESCRIPTION_TYPE__STORE_SUPPORTED,
              oldStoreSupported,
              storeSupported,
              !oldStoreSupportedESet));
  }
  ...
  public String toString() {
    ...
    if (storeSupportedESet) result.append(storeSupported);
    else result.append("<unset>");
    result.append(')');
