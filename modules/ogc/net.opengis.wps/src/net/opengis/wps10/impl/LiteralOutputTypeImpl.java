 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.LiteralOutputTypeImpl#getDataType <em>Data Type</em>}
 *   <li>{@link net.opengis.wps10.impl.LiteralOutputTypeImpl#getUOMs <em>UO Ms</em>}
 * </ul>
 *
 * @generated
 */
public class LiteralOutputTypeImpl extends EObjectImpl implements LiteralOutputType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LITERAL_OUTPUT_TYPE__DATA_TYPE,
              oldDataType,
              newDataType);
      ...
      if (dataType != null)
        msgs =
            ((InternalEObject) dataType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_OUTPUT_TYPE__DATA_TYPE,
                    null,
                    msgs);
      if (newDataType != null)
        msgs =
  ...
  public NotificationChain basicSetUOMs(SupportedUOMsType newUOMs, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.LITERAL_OUTPUT_TYPE__UO_MS, oldUOMs, newUOMs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setUOMs(SupportedUOMsType newUOMs) {
    if (newUOMs != uOMs) {
      ...
      if (uOMs != null)
        msgs =
            ((InternalEObject) uOMs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_OUTPUT_TYPE__UO_MS,
                    null,
                    msgs);
      if (newUOMs != null)
        msgs =
            ((InternalEObject) newUOMs)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_OUTPUT_TYPE__UO_MS,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.LITERAL_OUTPUT_TYPE__UO_MS, newUOMs, newUOMs));
  }
