 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getProcess <em>Process</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getStatus <em>Status</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getDataInputs <em>Data Inputs</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getOutputDefinitions <em>Output
 *       Definitions</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getProcessOutputs <em>Process
 *       Outputs</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getServiceInstance <em>Service
 *       Instance</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteResponseTypeImpl#getStatusLocation <em>Status
 *       Location</em>}
 * </ul>
 *
 * @generated
...
public class ExecuteResponseTypeImpl extends ResponseBaseTypeImpl implements ExecuteResponseType {
  ...
  /**
   * The cached value of the '{@link #getOutputDefinitions() <em>Output Definitions</em>}'
  ...
  /**
   * The cached value of the '{@link #getProcessOutputs() <em>Process Outputs</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__PROCESS,
              oldProcess,
              newProcess);
  ...
  public void setProcess(ProcessBriefType newProcess) {
    if (newProcess != process) {
      ...
      if (process != null)
        msgs =
            ((InternalEObject) process)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__PROCESS,
                    null,
                    msgs);
      if (newProcess != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__STATUS,
              oldStatus,
              newStatus);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (status != null)
        msgs =
            ((InternalEObject) status)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__STATUS,
                    null,
                    msgs);
      if (newStatus != null)
        msgs =
   ...
   * @generated
   */
  public NotificationChain basicSetDataInputs(
      DataInputsType1 newDataInputs, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__DATA_INPUTS,
              oldDataInputs,
              newDataInputs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setDataInputs(DataInputsType1 newDataInputs) {
    if (newDataInputs != dataInputs) {
      ...
      if (dataInputs != null)
        msgs =
            ((InternalEObject) dataInputs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__DATA_INPUTS,
                    null,
                    msgs);
      if (newDataInputs != null)
        msgs =
            ((InternalEObject) newDataInputs)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__DATA_INPUTS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetOutputDefinitions(
      OutputDefinitionsType newOutputDefinitions, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__OUTPUT_DEFINITIONS,
              oldOutputDefinitions,
              newOutputDefinitions);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setOutputDefinitions(OutputDefinitionsType newOutputDefinitions) {
    if (newOutputDefinitions != outputDefinitions) {
      ...
      if (outputDefinitions != null)
        msgs =
            ((InternalEObject) outputDefinitions)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__OUTPUT_DEFINITIONS,
                    null,
                    msgs);
      if (newOutputDefinitions != null)
        msgs =
            ((InternalEObject) newOutputDefinitions)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__OUTPUT_DEFINITIONS,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetProcessOutputs(
      ProcessOutputsType1 newProcessOutputs, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__PROCESS_OUTPUTS,
              oldProcessOutputs,
              newProcessOutputs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setProcessOutputs(ProcessOutputsType1 newProcessOutputs) {
    if (newProcessOutputs != processOutputs) {
      ...
      if (processOutputs != null)
        msgs =
            ((InternalEObject) processOutputs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__PROCESS_OUTPUTS,
                    null,
                    msgs);
      if (newProcessOutputs != null)
        msgs =
            ((InternalEObject) newProcessOutputs)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_RESPONSE_TYPE__PROCESS_OUTPUTS,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__SERVICE_INSTANCE,
              oldServiceInstance,
              serviceInstance));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_RESPONSE_TYPE__STATUS_LOCATION,
              oldStatusLocation,
              statusLocation));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wps10Package.EXECUTE_RESPONSE_TYPE__SERVICE_INSTANCE:
        return SERVICE_INSTANCE_EDEFAULT == null
            ? serviceInstance != null
            : !SERVICE_INSTANCE_EDEFAULT.equals(serviceInstance);
      case Wps10Package.EXECUTE_RESPONSE_TYPE__STATUS_LOCATION:
        return STATUS_LOCATION_EDEFAULT == null
            ? statusLocation != null
            : !STATUS_LOCATION_EDEFAULT.equals(statusLocation);
    }
