 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ProcessStartedTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.wps10.impl.ProcessStartedTypeImpl#getPercentCompleted <em>Percent
 *       Completed</em>}
 * </ul>
 *
 * @generated
...
public class ProcessStartedTypeImpl extends EObjectImpl implements ProcessStartedType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.PROCESS_STARTED_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.PROCESS_STARTED_TYPE__PERCENT_COMPLETED,
              oldPercentCompleted,
              percentCompleted));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wps10Package.PROCESS_STARTED_TYPE__PERCENT_COMPLETED:
        return PERCENT_COMPLETED_EDEFAULT == null
            ? percentCompleted != null
            : !PERCENT_COMPLETED_EDEFAULT.equals(percentCompleted);
    }
