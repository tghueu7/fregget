 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.SupportedUOMsTypeImpl#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.impl.SupportedUOMsTypeImpl#getSupported <em>Supported</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.SUPPORTED_UO_MS_TYPE__DEFAULT,
              oldDefault,
              newDefault);
      ...
      if (default_ != null)
        msgs =
            ((InternalEObject) default_)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.SUPPORTED_UO_MS_TYPE__DEFAULT,
                    null,
                    msgs);
      if (newDefault != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.SUPPORTED_UO_MS_TYPE__SUPPORTED,
              oldSupported,
              newSupported);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (supported != null)
        msgs =
            ((InternalEObject) supported)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.SUPPORTED_UO_MS_TYPE__SUPPORTED,
                    null,
                    msgs);
