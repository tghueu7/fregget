 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl#getAcceptVersions <em>Accept
 *       Versions</em>}
 *   <li>{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl#getLanguage <em>Language</em>}
 *   <li>{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl#getBaseUrl <em>Base Url</em>}
 *   <li>{@link net.opengis.wps10.impl.GetCapabilitiesTypeImpl#getExtendedProperties <em>Extended
 *       Properties</em>}
 * </ul>
 *
 * @generated
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
              oldAcceptVersions,
              newAcceptVersions);
      ...
      if (acceptVersions != null)
        msgs =
            ((InternalEObject) acceptVersions)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.GET_CAPABILITIES_TYPE__ACCEPT_VERSIONS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.GET_CAPABILITIES_TYPE__LANGUAGE,
              oldLanguage,
              language));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.GET_CAPABILITIES_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.GET_CAPABILITIES_TYPE__BASE_URL,
              oldBaseUrl,
              baseUrl));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.GET_CAPABILITIES_TYPE__EXTENDED_PROPERTIES,
