 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.LiteralInputTypeImpl#getAllowedValues <em>Allowed
 *       Values</em>}
 *   <li>{@link net.opengis.wps10.impl.LiteralInputTypeImpl#getAnyValue <em>Any Value</em>}
 *   <li>{@link net.opengis.wps10.impl.LiteralInputTypeImpl#getValuesReference <em>Values
 *       Reference</em>}
 *   <li>{@link net.opengis.wps10.impl.LiteralInputTypeImpl#getDefaultValue <em>Default Value</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LITERAL_INPUT_TYPE__ALLOWED_VALUES,
              oldAllowedValues,
              newAllowedValues);
      ...
      if (allowedValues != null)
        msgs =
            ((InternalEObject) allowedValues)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_INPUT_TYPE__ALLOWED_VALUES,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LITERAL_INPUT_TYPE__ANY_VALUE,
              oldAnyValue,
              newAnyValue);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (anyValue != null)
        msgs =
            ((InternalEObject) anyValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_INPUT_TYPE__ANY_VALUE,
                    null,
                    msgs);
      if (newAnyValue != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LITERAL_INPUT_TYPE__VALUES_REFERENCE,
              oldValuesReference,
              newValuesReference);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (valuesReference != null)
        msgs =
            ((InternalEObject) valuesReference)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LITERAL_INPUT_TYPE__VALUES_REFERENCE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LITERAL_INPUT_TYPE__DEFAULT_VALUE,
              oldDefaultValue,
              defaultValue));
  }
