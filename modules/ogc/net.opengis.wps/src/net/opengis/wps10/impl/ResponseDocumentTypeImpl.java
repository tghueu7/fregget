 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl#getOutput <em>Output</em>}
 *   <li>{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl#isLineage <em>Lineage</em>}
 *   <li>{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl#isStatus <em>Status</em>}
 *   <li>{@link net.opengis.wps10.impl.ResponseDocumentTypeImpl#isStoreExecuteResponse <em>Store
 *       Execute Response</em>}
 * </ul>
 *
 * @generated
...
public class ResponseDocumentTypeImpl extends EObjectImpl implements ResponseDocumentType {
  ...
  /**
   * The default value of the '{@link #isStoreExecuteResponse() <em>Store Execute Response</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #isStoreExecuteResponse() <em>Store Execute Response</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (output == null) {
      output =
          new EObjectContainmentEList(
              ...
              this,
              Wps10Package.RESPONSE_DOCUMENT_TYPE__OUTPUT);
    }
    return output;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.RESPONSE_DOCUMENT_TYPE__LINEAGE,
              oldLineage,
              lineage,
              !oldLineageESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.RESPONSE_DOCUMENT_TYPE__STATUS,
              oldStatus,
              status,
              !oldStatusESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.RESPONSE_DOCUMENT_TYPE__STORE_EXECUTE_RESPONSE,
              oldStoreExecuteResponse,
              storeExecuteResponse,
              !oldStoreExecuteResponseESet));
  }
  ...
  public String toString() {
    ...
    if (lineageESet) result.append(lineage);
    else result.append("<unset>");
    result.append(", status: ");
    if (statusESet) result.append(status);
    else result.append("<unset>");
    result.append(", storeExecuteResponse: ");
    if (storeExecuteResponseESet) result.append(storeExecuteResponse);
    else result.append("<unset>");
    result.append(')');
