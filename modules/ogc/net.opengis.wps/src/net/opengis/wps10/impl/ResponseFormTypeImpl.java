 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ResponseFormTypeImpl#getResponseDocument <em>Response
 *       Document</em>}
 *   <li>{@link net.opengis.wps10.impl.ResponseFormTypeImpl#getRawDataOutput <em>Raw Data
 *       Output</em>}
 * </ul>
 *
 * @generated
...
public class ResponseFormTypeImpl extends EObjectImpl implements ResponseFormType {
  /**
   * The cached value of the '{@link #getResponseDocument() <em>Response Document</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getRawDataOutput() <em>Raw Data Output</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetResponseDocument(
      ResponseDocumentType newResponseDocument, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT,
              oldResponseDocument,
              newResponseDocument);
  ...
  public void setResponseDocument(ResponseDocumentType newResponseDocument) {
    if (newResponseDocument != responseDocument) {
      ...
      if (responseDocument != null)
        msgs =
            ((InternalEObject) responseDocument)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT,
                    null,
                    msgs);
      if (newResponseDocument != null)
        msgs =
            ((InternalEObject) newResponseDocument)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetRawDataOutput(
      OutputDefinitionType newRawDataOutput, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT,
              oldRawDataOutput,
              newRawDataOutput);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRawDataOutput(OutputDefinitionType newRawDataOutput) {
    if (newRawDataOutput != rawDataOutput) {
      ...
      if (rawDataOutput != null)
        msgs =
            ((InternalEObject) rawDataOutput)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT,
                    null,
                    msgs);
      if (newRawDataOutput != null)
        msgs =
            ((InternalEObject) newRawDataOutput)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT,
                    null,
