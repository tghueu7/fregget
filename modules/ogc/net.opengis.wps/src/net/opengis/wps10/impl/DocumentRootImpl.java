 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema
 *       Location</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getCapabilities <em>Capabilities</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getDescribeProcess <em>Describe
 *       Process</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getExecute <em>Execute</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getExecuteResponse <em>Execute
 *       Response</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getGetCapabilities <em>Get
 *       Capabilities</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getLanguages <em>Languages</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getProcessDescriptions <em>Process
 *       Descriptions</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getProcessOfferings <em>Process
 *       Offerings</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wps10.impl.DocumentRootImpl#getProcessVersion <em>Process Version</em>}
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    if (xMLNSPrefixMap == null) {
      xMLNSPrefixMap =
          new EcoreEMap(
              ...
              this,
              Wps10Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
    }
    ...
    if (xSISchemaLocation == null) {
      xSISchemaLocation =
          new EcoreEMap(
              ...
              EStringToStringMapEntryImpl.class,
              this,
              Wps10Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
    }
  ...
  public WPSCapabilitiesType getCapabilities() {
    return (WPSCapabilitiesType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__CAPABILITIES, true);
  }
  ...
  public NotificationChain basicSetCapabilities(
      WPSCapabilitiesType newCapabilities, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__CAPABILITIES, newCapabilities, msgs);
  }
  ...
  public void setCapabilities(WPSCapabilitiesType newCapabilities) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__CAPABILITIES, newCapabilities);
  }
  ...
  public DescribeProcessType getDescribeProcess() {
    return (DescribeProcessType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__DESCRIBE_PROCESS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetDescribeProcess(
      DescribeProcessType newDescribeProcess, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__DESCRIBE_PROCESS, newDescribeProcess, msgs);
  }
  ...
  public void setDescribeProcess(DescribeProcessType newDescribeProcess) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__DESCRIBE_PROCESS, newDescribeProcess);
  }
  ...
  public NotificationChain basicSetExecute(ExecuteType newExecute, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__EXECUTE, newExecute, msgs);
  }
  ...
  public void setExecute(ExecuteType newExecute) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__EXECUTE, newExecute);
  }
  ...
  public ExecuteResponseType getExecuteResponse() {
    return (ExecuteResponseType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__EXECUTE_RESPONSE, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetExecuteResponse(
      ExecuteResponseType newExecuteResponse, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__EXECUTE_RESPONSE, newExecuteResponse, msgs);
  }
  ...
  public void setExecuteResponse(ExecuteResponseType newExecuteResponse) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__EXECUTE_RESPONSE, newExecuteResponse);
  }
  ...
  public GetCapabilitiesType getGetCapabilities() {
    return (GetCapabilitiesType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, true);
  }
  ...
  public NotificationChain basicSetGetCapabilities(
    ...
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, newGetCapabilities, msgs);
  }
  ...
  public void setGetCapabilities(GetCapabilitiesType newGetCapabilities) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__GET_CAPABILITIES, newGetCapabilities);
  }
  ...
  public NotificationChain basicSetLanguages(LanguagesType1 newLanguages, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__LANGUAGES, newLanguages, msgs);
  }
  ...
  public void setLanguages(LanguagesType1 newLanguages) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__LANGUAGES, newLanguages);
  }
  ...
  public ProcessDescriptionsType getProcessDescriptions() {
    return (ProcessDescriptionsType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_DESCRIPTIONS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetProcessDescriptions(
      ProcessDescriptionsType newProcessDescriptions, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_DESCRIPTIONS,
  ...
  public void setProcessDescriptions(ProcessDescriptionsType newProcessDescriptions) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_DESCRIPTIONS, newProcessDescriptions);
  }
  ...
  public ProcessOfferingsType getProcessOfferings() {
    return (ProcessOfferingsType)
        getMixed().get(Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_OFFERINGS, true);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetProcessOfferings(
      ProcessOfferingsType newProcessOfferings, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(
            Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_OFFERINGS, newProcessOfferings, msgs);
  }
  ...
  public void setProcessOfferings(ProcessOfferingsType newProcessOfferings) {
    ((FeatureMap.Internal) getMixed())
        .set(Wps10Package.Literals.DOCUMENT_ROOT__PROCESS_OFFERINGS, newProcessOfferings);
  }
  ...
  public NotificationChain basicSetWSDL(WSDLType newWSDL, NotificationChain msgs) {
    return ((FeatureMap.Internal) getMixed())
        .basicAdd(Wps10Package.Literals.DOCUMENT_ROOT__WSDL, newWSDL, msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DOCUMENT_ROOT__PROCESS_VERSION,
              oldProcessVersion,
              processVersion));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wps10Package.DOCUMENT_ROOT__WSDL:
        return getWSDL() != null;
      case Wps10Package.DOCUMENT_ROOT__PROCESS_VERSION:
        return PROCESS_VERSION_EDEFAULT == null
            ? processVersion != null
            : !PROCESS_VERSION_EDEFAULT.equals(processVersion);
    }
