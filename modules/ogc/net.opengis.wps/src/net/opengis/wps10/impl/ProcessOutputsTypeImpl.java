 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ProcessOutputsTypeImpl#getOutput <em>Output</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (output == null) {
      output =
          new EObjectContainmentEList(
              OutputDescriptionType.class, this, Wps10Package.PROCESS_OUTPUTS_TYPE__OUTPUT);
    }
    return output;
  }
