 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getHeader <em>Header</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getBody <em>Body</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getBodyReference <em>Body
 *       Reference</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getEncoding <em>Encoding</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getMethod <em>Method</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getMimeType <em>Mime Type</em>}
 *   <li>{@link net.opengis.wps10.impl.InputReferenceTypeImpl#getSchema <em>Schema</em>}
 * </ul>
 *
 * @generated
 */
public class InputReferenceTypeImpl extends EObjectImpl implements InputReferenceType {
  ...
  /**
   * The cached value of the '{@link #getBodyReference() <em>Body Reference</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (header == null) {
      header =
          new EObjectContainmentEList(
              HeaderType.class, this, Wps10Package.INPUT_REFERENCE_TYPE__HEADER);
    }
    return header;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.INPUT_REFERENCE_TYPE__BODY, oldBody, body));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetBodyReference(
      BodyReferenceType newBodyReference, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_REFERENCE_TYPE__BODY_REFERENCE,
              oldBodyReference,
              newBodyReference);
  ...
  public void setBodyReference(BodyReferenceType newBodyReference) {
    if (newBodyReference != bodyReference) {
      ...
      if (bodyReference != null)
        msgs =
            ((InternalEObject) bodyReference)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_REFERENCE_TYPE__BODY_REFERENCE,
                    null,
                    msgs);
      if (newBodyReference != null)
        msgs =
            ((InternalEObject) newBodyReference)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_REFERENCE_TYPE__BODY_REFERENCE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_REFERENCE_TYPE__ENCODING,
              oldEncoding,
              encoding));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.INPUT_REFERENCE_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_REFERENCE_TYPE__METHOD,
              oldMethod,
              method,
              !oldMethodESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_REFERENCE_TYPE__MIME_TYPE,
              oldMimeType,
              mimeType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_REFERENCE_TYPE__SCHEMA,
              oldSchema,
              schema));
  }
