 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl#getEncoding <em>Encoding</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl#getMimeType <em>Mime Type</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl#getSchema <em>Schema</em>}
 *   <li>{@link net.opengis.wps10.impl.OutputDefinitionTypeImpl#getUom <em>Uom</em>}
 * </ul>
 *
 * @generated
 */
public class OutputDefinitionTypeImpl extends EObjectImpl implements OutputDefinitionType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DEFINITION_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.OUTPUT_DEFINITION_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DEFINITION_TYPE__ENCODING,
              oldEncoding,
              encoding));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DEFINITION_TYPE__MIME_TYPE,
              oldMimeType,
              mimeType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.OUTPUT_DEFINITION_TYPE__SCHEMA,
              oldSchema,
              schema));
  }
  ...
  public void setUom(String newUom) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.OUTPUT_DEFINITION_TYPE__UOM, oldUom, uom));
  }
