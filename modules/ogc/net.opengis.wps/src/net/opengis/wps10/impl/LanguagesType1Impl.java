 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.LanguagesType1Impl#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.impl.LanguagesType1Impl#getSupported <em>Supported</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LANGUAGES_TYPE1__DEFAULT,
              oldDefault,
              newDefault);
      ...
      if (default_ != null)
        msgs =
            ((InternalEObject) default_)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LANGUAGES_TYPE1__DEFAULT,
                    null,
                    msgs);
      if (newDefault != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.LANGUAGES_TYPE1__SUPPORTED,
              oldSupported,
              newSupported);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (supported != null)
        msgs =
            ((InternalEObject) supported)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.LANGUAGES_TYPE1__SUPPORTED,
                    null,
                    msgs);
