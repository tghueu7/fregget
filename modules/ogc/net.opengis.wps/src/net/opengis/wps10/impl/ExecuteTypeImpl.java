 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.ExecuteTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteTypeImpl#getDataInputs <em>Data Inputs</em>}
 *   <li>{@link net.opengis.wps10.impl.ExecuteTypeImpl#getResponseForm <em>Response Form</em>}
 * </ul>
 *
 * @generated
 */
public class ExecuteTypeImpl extends RequestBaseTypeImpl implements ExecuteType {
  ...
  /**
   * The cached value of the '{@link #getResponseForm() <em>Response Form</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_TYPE__DATA_INPUTS,
              oldDataInputs,
              newDataInputs);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (dataInputs != null)
        msgs =
            ((InternalEObject) dataInputs)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_TYPE__DATA_INPUTS,
                    null,
                    msgs);
   ...
   * @generated
   */
  public NotificationChain basicSetResponseForm(
      ResponseFormType newResponseForm, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.EXECUTE_TYPE__RESPONSE_FORM,
              oldResponseForm,
              newResponseForm);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setResponseForm(ResponseFormType newResponseForm) {
    if (newResponseForm != responseForm) {
      ...
      if (responseForm != null)
        msgs =
            ((InternalEObject) responseForm)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_TYPE__RESPONSE_FORM,
                    null,
                    msgs);
      if (newResponseForm != null)
        msgs =
            ((InternalEObject) newResponseForm)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.EXECUTE_TYPE__RESPONSE_FORM,
                    null,
