 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.SupportedComplexDataInputTypeImpl#getMaximumMegabytes
 *       <em>Maximum Megabytes</em>}
 * </ul>
 *
 * @generated
 */
public class SupportedComplexDataInputTypeImpl extends SupportedComplexDataTypeImpl
    implements SupportedComplexDataInputType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.SUPPORTED_COMPLEX_DATA_INPUT_TYPE__MAXIMUM_MEGABYTES,
              oldMaximumMegabytes,
              maximumMegabytes));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wps10Package.SUPPORTED_COMPLEX_DATA_INPUT_TYPE__MAXIMUM_MEGABYTES:
        return MAXIMUM_MEGABYTES_EDEFAULT == null
            ? maximumMegabytes != null
            : !MAXIMUM_MEGABYTES_EDEFAULT.equals(maximumMegabytes);
    }
