 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.DataTypeImpl#getComplexData <em>Complex Data</em>}
 *   <li>{@link net.opengis.wps10.impl.DataTypeImpl#getLiteralData <em>Literal Data</em>}
 *   <li>{@link net.opengis.wps10.impl.DataTypeImpl#getBoundingBoxData <em>Bounding Box Data</em>}
 * </ul>
 *
 * @generated
 */
public class DataTypeImpl extends EObjectImpl implements DataType {
  ...
  public NotificationChain basicSetComplexData(
      ComplexDataType newComplexData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DATA_TYPE__COMPLEX_DATA,
              oldComplexData,
              newComplexData);
      ...
      if (complexData != null)
        msgs =
            ((InternalEObject) complexData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DATA_TYPE__COMPLEX_DATA,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetLiteralData(
      LiteralDataType newLiteralData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DATA_TYPE__LITERAL_DATA,
              oldLiteralData,
              newLiteralData);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (literalData != null)
        msgs =
            ((InternalEObject) literalData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DATA_TYPE__LITERAL_DATA,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetBoundingBoxData(
      BoundingBoxType newBoundingBoxData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DATA_TYPE__BOUNDING_BOX_DATA,
              oldBoundingBoxData,
              newBoundingBoxData);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (boundingBoxData != null)
        msgs =
            ((InternalEObject) boundingBoxData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DATA_TYPE__BOUNDING_BOX_DATA,
                    null,
                    msgs);
