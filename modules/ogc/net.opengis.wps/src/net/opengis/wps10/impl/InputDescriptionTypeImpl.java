 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.InputDescriptionTypeImpl#getComplexData <em>Complex
 *       Data</em>}
 *   <li>{@link net.opengis.wps10.impl.InputDescriptionTypeImpl#getLiteralData <em>Literal
 *       Data</em>}
 *   <li>{@link net.opengis.wps10.impl.InputDescriptionTypeImpl#getBoundingBoxData <em>Bounding Box
 *       Data</em>}
 *   <li>{@link net.opengis.wps10.impl.InputDescriptionTypeImpl#getMaxOccurs <em>Max Occurs</em>}
 *   <li>{@link net.opengis.wps10.impl.InputDescriptionTypeImpl#getMinOccurs <em>Min Occurs</em>}
 * </ul>
 *
 * @generated
 */
public class InputDescriptionTypeImpl extends DescriptionTypeImpl implements InputDescriptionType {
  /**
   * The cached value of the '{@link #getComplexData() <em>Complex Data</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getLiteralData() <em>Literal Data</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getBoundingBoxData() <em>Bounding Box Data</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetComplexData(
      SupportedComplexDataInputType newComplexData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA,
              oldComplexData,
              newComplexData);
  ...
  public void setComplexData(SupportedComplexDataInputType newComplexData) {
    if (newComplexData != complexData) {
      ...
      if (complexData != null)
        msgs =
            ((InternalEObject) complexData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA,
                    null,
                    msgs);
      if (newComplexData != null)
        msgs =
            ((InternalEObject) newComplexData)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetLiteralData(
      LiteralInputType newLiteralData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_DESCRIPTION_TYPE__LITERAL_DATA,
              oldLiteralData,
              newLiteralData);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setLiteralData(LiteralInputType newLiteralData) {
    if (newLiteralData != literalData) {
      ...
      if (literalData != null)
        msgs =
            ((InternalEObject) literalData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__LITERAL_DATA,
                    null,
                    msgs);
      if (newLiteralData != null)
        msgs =
            ((InternalEObject) newLiteralData)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__LITERAL_DATA,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetBoundingBoxData(
      SupportedCRSsType newBoundingBoxData, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA,
              oldBoundingBoxData,
              newBoundingBoxData);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setBoundingBoxData(SupportedCRSsType newBoundingBoxData) {
    if (newBoundingBoxData != boundingBoxData) {
      ...
      if (boundingBoxData != null)
        msgs =
            ((InternalEObject) boundingBoxData)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA,
                    null,
                    msgs);
      if (newBoundingBoxData != null)
        msgs =
            ((InternalEObject) newBoundingBoxData)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_DESCRIPTION_TYPE__MAX_OCCURS,
              oldMaxOccurs,
              maxOccurs));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.INPUT_DESCRIPTION_TYPE__MIN_OCCURS,
              oldMinOccurs,
              minOccurs));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Wps10Package.INPUT_DESCRIPTION_TYPE__MAX_OCCURS:
        return MAX_OCCURS_EDEFAULT == null
            ? maxOccurs != null
            : !MAX_OCCURS_EDEFAULT.equals(maxOccurs);
      case Wps10Package.INPUT_DESCRIPTION_TYPE__MIN_OCCURS:
        return MIN_OCCURS_EDEFAULT == null
            ? minOccurs != null
