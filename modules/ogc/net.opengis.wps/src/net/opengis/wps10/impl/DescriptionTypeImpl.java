 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.DescriptionTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wps10.impl.DescriptionTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.wps10.impl.DescriptionTypeImpl#getAbstract <em>Abstract</em>}
 *   <li>{@link net.opengis.wps10.impl.DescriptionTypeImpl#getMetadata <em>Metadata</em>}
 * </ul>
 *
 * @generated
 */
public class DescriptionTypeImpl extends EObjectImpl implements DescriptionType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DESCRIPTION_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DESCRIPTION_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetTitle(LanguageStringType newTitle, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.DESCRIPTION_TYPE__TITLE, oldTitle, newTitle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setTitle(LanguageStringType newTitle) {
    if (newTitle != title) {
      ...
      if (title != null)
        msgs =
            ((InternalEObject) title)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DESCRIPTION_TYPE__TITLE,
                    null,
                    msgs);
      if (newTitle != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Wps10Package.DESCRIPTION_TYPE__TITLE, newTitle, newTitle));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.DESCRIPTION_TYPE__ABSTRACT,
              oldAbstract,
              newAbstract);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (abstract_ != null)
        msgs =
            ((InternalEObject) abstract_)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.DESCRIPTION_TYPE__ABSTRACT,
                    null,
                    msgs);
      if (newAbstract != null)
        msgs =
    ...
    if (metadata == null) {
      metadata =
          new EObjectContainmentEList(
              MetadataType.class, this, Wps10Package.DESCRIPTION_TYPE__METADATA);
    }
    return metadata;
  }
