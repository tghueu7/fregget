...
public class Wps10PackageImpl extends EPackageImpl implements Wps10Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Wps10Package#eINSTANCE} when that field is
  ...
  public static Wps10Package init() {
    if (isInited)
      return (Wps10Package) EPackage.Registry.INSTANCE.getEPackage(Wps10Package.eNS_URI);

    // Obtain or create and register package
    Wps10PackageImpl theWps10Package =
        (Wps10PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wps10PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Wps10PackageImpl());
  ...
  public void createPackageContents() {
    ...
    createEAttribute(
        documentOutputDefinitionTypeEClass, DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE);
    ...
    createEAttribute(
        supportedComplexDataInputTypeEClass, SUPPORTED_COMPLEX_DATA_INPUT_TYPE__MAXIMUM_MEGABYTES);
  ...
  public void initializePackageContents() {
    ...
    initEClass(
        ...
        ComplexDataCombinationsType.class,
    ...
    initEReference(
        ...
        this.getComplexDataDescriptionType(),
        null,
        "format",
        null,
        1,
    ...
    initEClass(
        ...
        ComplexDataCombinationType.class,
    ...
    initEClass(
        ...
        ComplexDataDescriptionType.class,
    ...
    initEReference(
        ...
        theOws11Package.getLanguageStringType(),
        null,
        "title",
        null,
        1,
    ...
    initEReference(
        ...
        this.getProcessDescriptionsType(),
        null,
        "processDescriptions",
        null,
        0,
    ...
    initEReference(
        ...
        theOws11Package.getAcceptVersionsType(),
        null,
        "acceptVersions",
        null,
        0,
    ...
    initEReference(
        ...
        this.getSupportedComplexDataInputType(),
        null,
        "complexData",
        null,
        0,
    ...
    initEReference(
        ...
        theOws11Package.getAllowedValuesType(),
        null,
        "allowedValues",
        null,
        0,
    ...
    initEReference(
        ...
        theOws11Package.getAnyValueType(),
        null,
        "anyValue",
        null,
        0,
    ...
    initEReference(
        ...
        this.getDocumentOutputDefinitionType(),
        null,
        "output",
        null,
        1,
    ...
    initEReference(
        ...
        this.getSupportedComplexDataType(),
        null,
        "complexOutput",
        null,
        0,
    ...
    initEReference(
        ...
        this.getProcessDescriptionType(),
        null,
        "processDescription",
        null,
        1,
    ...
    initEReference(
        ...
        theOws11Package.getExceptionReportType(),
        null,
        "exceptionReport",
        null,
        1,
    ...
    initEAttribute(
        ...
        theOws11Package.getVersionType1(),
        "version",
        "1.0.0",
        1,
        1,
    ...
    initEClass(
        ...
        SupportedComplexDataType.class,
    ...
    initEReference(
        ...
        this.getComplexDataCombinationType(),
        null,
        "default",
        null,
        1,
    ...
    initEReference(
        ...
        this.getComplexDataCombinationsType(),
        null,
        "supported",
        null,
        1,
    ...
    initEClass(
        unitEClass, Unit.class, "Unit", IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(methodTypeEEnum, source, new String[] {"name", "method_._type"});
    addAnnotation(
        methodTypeObjectEDataType,
        source,
        new String[] {
