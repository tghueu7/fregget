 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getProcessAccepted <em>Process Accepted</em>}
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getProcessStarted <em>Process Started</em>}
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getProcessPaused <em>Process Paused</em>}
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getProcessSucceeded <em>Process
 *       Succeeded</em>}
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getProcessFailed <em>Process Failed</em>}
 *   <li>{@link net.opengis.wps10.impl.StatusTypeImpl#getCreationTime <em>Creation Time</em>}
 * </ul>
 *
 * @generated
 */
public class StatusTypeImpl extends EObjectImpl implements StatusType {
  ...
  /**
   * The cached value of the '{@link #getProcessStarted() <em>Process Started</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getProcessPaused() <em>Process Paused</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getProcessFailed() <em>Process Failed</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__PROCESS_ACCEPTED,
              oldProcessAccepted,
              processAccepted));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetProcessStarted(
      ProcessStartedType newProcessStarted, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__PROCESS_STARTED,
              oldProcessStarted,
              newProcessStarted);
  ...
  public void setProcessStarted(ProcessStartedType newProcessStarted) {
    if (newProcessStarted != processStarted) {
      ...
      if (processStarted != null)
        msgs =
            ((InternalEObject) processStarted)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_STARTED,
                    null,
                    msgs);
      if (newProcessStarted != null)
        msgs =
            ((InternalEObject) newProcessStarted)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_STARTED,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetProcessPaused(
      ProcessStartedType newProcessPaused, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__PROCESS_PAUSED,
              oldProcessPaused,
              newProcessPaused);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setProcessPaused(ProcessStartedType newProcessPaused) {
    if (newProcessPaused != processPaused) {
      ...
      if (processPaused != null)
        msgs =
            ((InternalEObject) processPaused)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_PAUSED,
                    null,
                    msgs);
      if (newProcessPaused != null)
        msgs =
            ((InternalEObject) newProcessPaused)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_PAUSED,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__PROCESS_SUCCEEDED,
              oldProcessSucceeded,
              processSucceeded));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetProcessFailed(
      ProcessFailedType newProcessFailed, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__PROCESS_FAILED,
              oldProcessFailed,
              newProcessFailed);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setProcessFailed(ProcessFailedType newProcessFailed) {
    if (newProcessFailed != processFailed) {
      ...
      if (processFailed != null)
        msgs =
            ((InternalEObject) processFailed)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_FAILED,
                    null,
                    msgs);
      if (newProcessFailed != null)
        msgs =
            ((InternalEObject) newProcessFailed)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Wps10Package.STATUS_TYPE__PROCESS_FAILED,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Wps10Package.STATUS_TYPE__CREATION_TIME,
              oldCreationTime,
              creationTime));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Wps10Package.STATUS_TYPE__PROCESS_ACCEPTED:
        return PROCESS_ACCEPTED_EDEFAULT == null
            ? processAccepted != null
            : !PROCESS_ACCEPTED_EDEFAULT.equals(processAccepted);
      case Wps10Package.STATUS_TYPE__PROCESS_STARTED:
        return processStarted != null;
      case Wps10Package.STATUS_TYPE__PROCESS_PAUSED:
        return processPaused != null;
      case Wps10Package.STATUS_TYPE__PROCESS_SUCCEEDED:
        return PROCESS_SUCCEEDED_EDEFAULT == null
            ? processSucceeded != null
            : !PROCESS_SUCCEEDED_EDEFAULT.equals(processSucceeded);
      case Wps10Package.STATUS_TYPE__PROCESS_FAILED:
