 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ValuesReferenceType#getReference <em>Reference</em>}
 *   <li>{@link net.opengis.wps10.ValuesReferenceType#getValuesForm <em>Values Form</em>}
 * </ul>
 *
...
public interface ValuesReferenceType extends EObject {
   ...
   *     name='reference' namespace='http://www.opengis.net/ows/1.1'"
   * @generated
   */
  String getReference();

  /**
   * Sets the value of the '{@link net.opengis.wps10.ValuesReferenceType#getReference
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Reference to a description of the mimetype, encoding, and schema used for this set of values
   * and ranges.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ValuesReferenceType#getValuesForm <em>Values
   * Form</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
