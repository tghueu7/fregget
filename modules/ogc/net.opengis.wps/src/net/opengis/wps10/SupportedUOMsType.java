 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.SupportedUOMsType#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wps10.SupportedUOMsType#getSupported <em>Supported</em>}
 * </ul>
 *
...
public interface SupportedUOMsType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Reference to the default UOM supported for this input or output, if UoM is applicable. The
   * process shall expect input in or produce output in this UOM unless the Execute request
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.SupportedUOMsType#getDefault <em>Default</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of references to all of the UOMs supported for this input or output, if UOM is
   * applicable. The default UOM shall be included in this list.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.SupportedUOMsType#getSupported
