 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.UOMsType#getUOM <em>UOM</em>}
 * </ul>
 *
...
public interface UOMsType extends EObject {
  /**
   * Returns the value of the '<em><b>UOM</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.ows11.DomainMetadataType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
