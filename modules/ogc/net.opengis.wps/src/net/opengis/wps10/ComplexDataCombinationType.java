 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Identifies the default Format, Encoding, and Schema supported for this input or output. The
 * process shall expect input in or produce output in this combination of Format/Encoding/Schema
 * unless the Execute request specifies otherwise..
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ComplexDataCombinationType#getFormat <em>Format</em>}
 * </ul>
 *
...
public interface ComplexDataCombinationType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.ComplexDataCombinationType#getFormat
   * <em>Format</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
