 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.ProcessOfferingsType#getProcess <em>Process</em>}
 * </ul>
 *
...
public interface ProcessOfferingsType extends EObject {
  /**
   * Returns the value of the '<em><b>Process</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wps10.ProcessBriefType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of one or more brief descriptions of all the processes offered by this WPS
   * server.
   * <!-- end-model-doc -->
   *
