 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wps10.WPSCapabilitiesType#getProcessOfferings <em>Process
 *       Offerings</em>}
 *   <li>{@link net.opengis.wps10.WPSCapabilitiesType#getLanguages <em>Languages</em>}
 *   <li>{@link net.opengis.wps10.WPSCapabilitiesType#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wps10.WPSCapabilitiesType#getLang <em>Lang</em>}
 *   <li>{@link net.opengis.wps10.WPSCapabilitiesType#getService <em>Service</em>}
 * </ul>
 *
...
public interface WPSCapabilitiesType extends CapabilitiesBaseType {
   ...
   *     name='ProcessOfferings' namespace='##targetNamespace'"
   * @generated
   */
  ProcessOfferingsType getProcessOfferings();

  /**
   * Sets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getProcessOfferings
   * <em>Process Offerings</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Languages'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getLanguages
   ...
   * @model containment="true" extendedMetaData="kind='element' name='WSDL'
   *     namespace='##targetNamespace'"
   * @generated
   */
  WSDLType getWSDL();
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getWSDL <em>WSDL</em>}'
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Attempting to install the relevant ISO 2- and 3-letter codes as the enumerated possible values
   * is probably never going to be a realistic possibility. See RFC 3066 at
   ...
   *
   * <p>The union allows for the 'un-declaration' of xml:lang with the empty string.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getLang <em>Lang</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Service</b></em>' attribute. The default value is <code>"WPS"
   * </code>.
   * <!-- begin-user-doc -->
   *
   ...
   * @model default="WPS" unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.String"
  ...
  /**
   * Sets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getService
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getService
   * <em>Service</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wps10.WPSCapabilitiesType#getService
