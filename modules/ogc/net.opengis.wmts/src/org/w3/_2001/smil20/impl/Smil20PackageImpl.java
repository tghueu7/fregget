...
public class Smil20PackageImpl extends EPackageImpl implements Smil20Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link Smil20Package#eINSTANCE} when that field is
  ...
  public static Smil20Package init() {
    if (isInited)
      return (Smil20Package) EPackage.Registry.INSTANCE.getEPackage(Smil20Package.eNS_URI);

    // Obtain or create and register package
    Smil20PackageImpl theSmil20Package =
        (Smil20PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Smil20PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new Smil20PackageImpl());
  ...
  public void initializePackageContents() {
    ...
    LanguagePackage theLanguagePackage =
        (LanguagePackage) EPackage.Registry.INSTANCE.getEPackage(LanguagePackage.eNS_URI);
    ...
    initEReference(
        ...
        theLanguagePackage.getAnimateType(),
        null,
        "animate",
        null,
        0,
    ...
    initEReference(
        ...
        theLanguagePackage.getAnimateColorType(),
        null,
        "animateColor",
        null,
        0,
    ...
    initEReference(
        ...
        theLanguagePackage.getAnimateMotionType(),
        null,
        "animateMotion",
        null,
        0,
    ...
    initEEnum(
        syncBehaviorDefaultTypeEEnum, SyncBehaviorDefaultType.class, "SyncBehaviorDefaultType");
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(accumulateTypeEEnum, source, new String[] {"name", "accumulate_._type"});
    addAnnotation(
        accumulateTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(additiveTypeEEnum, source, new String[] {"name", "additive_._type"});
    addAnnotation(
        additiveTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(attributeTypeTypeEEnum, source, new String[] {"name", "attributeType_._type"});
    addAnnotation(
        attributeTypeTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(calcModeTypeEEnum, source, new String[] {"name", "calcMode_._type"});
    addAnnotation(
        calcModeTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(fillDefaultTypeEEnum, source, new String[] {"name", "fillDefaultType"});
    addAnnotation(
        fillDefaultTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(fillTimingAttrsTypeEEnum, source, new String[] {"name", "fillTimingAttrsType"});
    addAnnotation(
        fillTimingAttrsTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(restartDefaultTypeEEnum, source, new String[] {"name", "restartDefaultType"});
    addAnnotation(
        restartDefaultTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(restartTimingTypeEEnum, source, new String[] {"name", "restartTimingType"});
    addAnnotation(
        restartTimingTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(
        syncBehaviorDefaultTypeEEnum, source, new String[] {"name", "syncBehaviorDefaultType"});
    addAnnotation(
        syncBehaviorDefaultTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(syncBehaviorTypeEEnum, source, new String[] {"name", "syncBehaviorType"});
    addAnnotation(
        syncBehaviorTypeObjectEDataType,
        source,
        new String[] {
