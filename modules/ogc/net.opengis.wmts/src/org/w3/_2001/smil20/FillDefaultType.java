 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fill Default Type</b></em>', and
...
public enum FillDefaultType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Remove</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Freeze</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #FREEZE
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Hold</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Auto</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #AUTO
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Inherit</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #INHERIT
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Transition</b></em>' literal object isn't clear, there really
  ...
  private static final FillDefaultType[] VALUES_ARRAY =
      new FillDefaultType[] {
        REMOVE, FREEZE, HOLD, AUTO, INHERIT, TRANSITION,
      };
   ...
   * @generated
   */
  public static final List<FillDefaultType> VALUES =
