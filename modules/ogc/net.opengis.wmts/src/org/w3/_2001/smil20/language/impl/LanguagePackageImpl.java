...
public class LanguagePackageImpl extends EPackageImpl implements LanguagePackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link LanguagePackage#eINSTANCE} when that field is
  ...
  public static LanguagePackage init() {
    ...
    LanguagePackageImpl theLanguagePackage =
        (LanguagePackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LanguagePackageImpl
  ...
  public void initializePackageContents() {
    ...
    Smil20Package theSmil20Package =
        (Smil20Package) EPackage.Registry.INSTANCE.getEPackage(Smil20Package.eNS_URI);
    ...
    initEAttribute(
        ...
        theSmil20Package.getCalcModeType(),
        "calcMode",
        "linear",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getFillTimingAttrsType(),
        "fill",
        "default",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getFillDefaultType(),
        "fillDefault",
        "inherit",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getNonNegativeDecimalType(),
        "repeatCount",
        null,
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getRestartTimingType(),
        "restart",
        "default",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getRestartDefaultType(),
        "restartDefault",
        "inherit",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getSyncBehaviorType(),
        "syncBehavior",
        "default",
        0,
        1,
    ...
    initEAttribute(
        ...
        theSmil20Package.getSyncBehaviorDefaultType(),
        "syncBehaviorDefault",
        "inherit",
        0,
        1,
