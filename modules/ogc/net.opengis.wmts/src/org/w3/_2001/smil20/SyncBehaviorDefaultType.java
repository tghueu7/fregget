...
public enum SyncBehaviorDefaultType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Can Slip</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Locked</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #LOCKED
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Independent</b></em>' literal object isn't clear, there really
  ...
  private static final SyncBehaviorDefaultType[] VALUES_ARRAY =
      new SyncBehaviorDefaultType[] {
        CAN_SLIP, LOCKED, INDEPENDENT, INHERIT,
      };
   ...
   * @generated
   */
  public static final List<SyncBehaviorDefaultType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Sync Behavior Default Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Sync Behavior Default Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
