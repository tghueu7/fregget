 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.LinearRingType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getPointProperty <em>Point Property</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.LinearRingType#getCoord <em>Coord</em>}
 * </ul>
 *
...
public interface LinearRingType extends AbstractRingType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LinearRingType#getPosList <em>Pos List</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LinearRingType#getCoordinates
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Deprecated with GML version 3.0 and included for backwards compatibility with GML 2. Use "pos"
   * elements instead.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='coord'
   *     namespace='##targetNamespace'"
   * @generated
   */
