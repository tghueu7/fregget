 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.SurfacePatchArrayPropertyType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.SurfacePatchArrayPropertyType#getSurfacePatchGroup <em>Surface
 *       Patch Group</em>}
 *   <li>{@link net.opengis.gml311.SurfacePatchArrayPropertyType#getSurfacePatch <em>Surface
 *       Patch</em>}
 * </ul>
 *
...
public interface SurfacePatchArrayPropertyType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Surface Patch Group</b></em>' attribute list. The list
   ...
   *     name='_SurfacePatch:group' namespace='##targetNamespace' group='#group:0'"
   * @generated
   */
  FeatureMap getSurfacePatchGroup();

  /**
   * Returns the value of the '<em><b>Surface Patch</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractSurfacePatchType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "_SurfacePatch" element is the abstract head of the substituition group for all surface
