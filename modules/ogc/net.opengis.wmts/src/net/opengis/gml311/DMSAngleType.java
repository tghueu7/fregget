 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.DMSAngleType#getDegrees <em>Degrees</em>}
 *   <li>{@link net.opengis.gml311.DMSAngleType#getDecimalMinutes <em>Decimal Minutes</em>}
 *   <li>{@link net.opengis.gml311.DMSAngleType#getMinutes <em>Minutes</em>}
 *   <li>{@link net.opengis.gml311.DMSAngleType#getSeconds <em>Seconds</em>}
 * </ul>
 *
...
public interface DMSAngleType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='degrees'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DMSAngleType#getDegrees <em>Degrees</em>}'
   ...
   * @model dataType="net.opengis.gml311.DecimalMinutesType" extendedMetaData="kind='element'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DMSAngleType#getDecimalMinutes <em>Decimal
   ...
   * @model dataType="net.opengis.gml311.ArcMinutesType" extendedMetaData="kind='element'
   *     name='minutes' namespace='##targetNamespace'"
   * @generated
   */
  BigInteger getMinutes();

  /**
   * Sets the value of the '{@link net.opengis.gml311.DMSAngleType#getMinutes <em>Minutes</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.gml311.ArcSecondsType" extendedMetaData="kind='element'
   *     name='seconds' namespace='##targetNamespace'"
   * @generated
   */
  BigDecimal getSeconds();

  /**
   * Sets the value of the '{@link net.opengis.gml311.DMSAngleType#getSeconds <em>Seconds</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
