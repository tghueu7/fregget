 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * [complexType of] The style descriptor for topologies of a feature. Describes individual topology
 * elements styles.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TopologyStyleType#getSymbol <em>Symbol</em>}
 *   <li>{@link net.opengis.gml311.TopologyStyleType#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.TopologyStyleType#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.TopologyStyleType#getTopologyProperty <em>Topology Property</em>}
 *   <li>{@link net.opengis.gml311.TopologyStyleType#getTopologyType <em>Topology Type</em>}
 * </ul>
 *
...
public interface TopologyStyleType extends BaseStyleDescriptorType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='symbol'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopologyStyleType#getSymbol <em>Symbol</em>}'
   ...
   *     name='style' namespace='##targetNamespace'"
   * @generated
   */
  String getStyle();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TopologyStyleType#getStyle <em>Style</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopologyStyleType#getLabelStyle <em>Label
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Topology Property</em>' attribute isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopologyStyleType#getTopologyProperty
   * <em>Topology Property</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Topology Type</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopologyStyleType#getTopologyType <em>Topology
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
