 ...
 * gravity may not be straightforward. By implication, ellipsoidal heights (h) cannot be captured in
 * a vertical coordinate reference system. Ellipsoidal heights cannot exist independently, but only
 * as an inseparable part of a 3D coordinate tuple defined in a geographic 3D coordinate reference
 * system.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.VerticalCRSType#getUsesVerticalCS <em>Uses Vertical CS</em>}
 *   <li>{@link net.opengis.gml311.VerticalCRSType#getUsesVerticalDatum <em>Uses Vertical
 *       Datum</em>}
 * </ul>
 *
...
public interface VerticalCRSType extends AbstractReferenceSystemType {
   ...
   *     name='usesVerticalCS' namespace='##targetNamespace'"
   * @generated
   */
  VerticalCSRefType getUsesVerticalCS();

  /**
   * Sets the value of the '{@link net.opengis.gml311.VerticalCRSType#getUsesVerticalCS <em>Uses
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='usesVerticalDatum' namespace='##targetNamespace'"
   * @generated
   */
  VerticalDatumRefType getUsesVerticalDatum();

  /**
   * Sets the value of the '{@link net.opengis.gml311.VerticalCRSType#getUsesVerticalDatum <em>Uses
