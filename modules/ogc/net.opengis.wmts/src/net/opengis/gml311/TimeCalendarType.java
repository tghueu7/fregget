 ...
 * position to a resolution of one day. A single calendar may reference more than one calendar era.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeCalendarType#getReferenceFrame <em>Reference Frame</em>}
 * </ul>
 *
...
public interface TimeCalendarType extends AbstractTimeReferenceSystemType {
  /**
   * Returns the value of the '<em><b>Reference Frame</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TimeCalendarEraPropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   *     name='referenceFrame' namespace='##targetNamespace'"
   * @generated
   */
