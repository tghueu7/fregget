 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeometricComplexType#getElement <em>Element</em>}
 * </ul>
 *
...
public interface GeometricComplexType extends AbstractGeometryType {
   ...
   * contents are of type {@link net.opengis.gml311.GeometricPrimitivePropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Element</em>' containment reference list isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Element</em>' containment reference list.
   * @see net.opengis.gml311.Gml311Package#getGeometricComplexType_Element()
   * @model containment="true" required="true" extendedMetaData="kind='element' name='element'
