 ...
 * not include any spaces, so xsd:Name is used instead of xsd:string. If a codeSpace attribute is
 * present, then its value is a reference to a Reference System for the value, a dictionary or code
 * list.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CodeListType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.CodeListType#getCodeSpace <em>Code Space</em>}
 * </ul>
 *
...
public interface CodeListType extends EObject {
   ...
   * @model dataType="net.opengis.gml311.NameList" many="false" extendedMetaData="name=':0'
   *     kind='simple'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.CodeListType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.CodeListType#getCodeSpace <em>Code
   * Space</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
