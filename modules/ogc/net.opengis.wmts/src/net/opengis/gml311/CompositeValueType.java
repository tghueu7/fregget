 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Aggregate value built from other Values using the Composite pattern. It contains zero or an
 * arbitrary number of valueComponent elements, and zero or one valueComponents elements. It may be
 * used for strongly coupled aggregates (vectors, tensors) or for arbitrary collections of values.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CompositeValueType#getValueComponent <em>Value Component</em>}
 *   <li>{@link net.opengis.gml311.CompositeValueType#getValueComponents <em>Value Components</em>}
 * </ul>
 *
...
public interface CompositeValueType extends AbstractGMLType {
  /**
   * Returns the value of the '<em><b>Value Component</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.ValuePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='valueComponent'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='valueComponents'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.CompositeValueType#getValueComponents
   * <em>Value Components</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
