 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getFeatureStyle <em>Feature Style</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getAbout <em>About</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getRemoteSchema <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.FeatureStylePropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface FeatureStylePropertyType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='FeatureStyle'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getFeatureStyle
   * <em>Feature Style</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getAbout
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getHref
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getRemoteSchema
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getRole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getShow
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getShow
   * <em>Show</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getShow
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getTitle
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getType
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getType
   * <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FeatureStylePropertyType#getType
