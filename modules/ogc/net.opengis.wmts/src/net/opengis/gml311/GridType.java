 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * An unrectified grid, which is a network composed of two or more sets of equally spaced parallel
 * lines in which the members of each set intersect the members of the other sets at right angles.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GridType#getLimits <em>Limits</em>}
 *   <li>{@link net.opengis.gml311.GridType#getAxisName <em>Axis Name</em>}
 *   <li>{@link net.opengis.gml311.GridType#getDimension <em>Dimension</em>}
 * </ul>
 *
...
public interface GridType extends AbstractGeometryType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Limits</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='limits'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridType#getLimits <em>Limits</em>}'
  ...
  /**
   * Returns the value of the '<em><b>Axis Name</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Axis Name</em>' attribute list isn't clear, there really should
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridType#getDimension <em>Dimension</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
