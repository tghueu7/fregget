 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for operation parameter objects, simplifying and restricting the DefinitionType as
 * needed.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationParameterBaseType#getParameterName <em>Parameter
 *       Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getOperationParameterBaseType()
 * @model abstract="true" extendedMetaData="name='OperationParameterBaseType' kind='elementOnly'"
 * @generated
 */
public interface OperationParameterBaseType extends AbstractGeneralOperationParameterType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='parameterName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationParameterBaseType#getParameterName
   * <em>Parameter Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
