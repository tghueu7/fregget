 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A geodetic datum defines the precise location and orientation in 3-dimensional space of a defined
 * ellipsoid (or sphere) that approximates the shape of the earth, or of a Cartesian coordinate
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeodeticDatumType#getUsesPrimeMeridian <em>Uses Prime
 *       Meridian</em>}
 *   <li>{@link net.opengis.gml311.GeodeticDatumType#getUsesEllipsoid <em>Uses Ellipsoid</em>}
 * </ul>
 *
...
public interface GeodeticDatumType extends AbstractDatumType {
   ...
   *     name='usesPrimeMeridian' namespace='##targetNamespace'"
   * @generated
   */
  PrimeMeridianRefType getUsesPrimeMeridian();

  /**
   * Sets the value of the '{@link net.opengis.gml311.GeodeticDatumType#getUsesPrimeMeridian
   * <em>Uses Prime Meridian</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='usesEllipsoid'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeodeticDatumType#getUsesEllipsoid <em>Uses
