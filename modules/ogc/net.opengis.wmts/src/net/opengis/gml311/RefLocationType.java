 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.RefLocationType#getAffinePlacement <em>Affine Placement</em>}
 * </ul>
 *
...
public interface RefLocationType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "refLocation" is an affine mapping that places the curve defined by the Fresnel Integrals
   ...
   *     name='AffinePlacement' namespace='##targetNamespace'"
   * @generated
   */
  AffinePlacementType getAffinePlacement();

  /**
   * Sets the value of the '{@link net.opengis.gml311.RefLocationType#getAffinePlacement <em>Affine
