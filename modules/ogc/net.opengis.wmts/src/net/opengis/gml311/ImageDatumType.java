 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * An image datum defines the origin of an image coordinate reference system, and is used in a local
 * context only. For more information, see OGC Abstract Specification Topic 2.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ImageDatumType#getPixelInCell <em>Pixel In Cell</em>}
 * </ul>
 *
...
public interface ImageDatumType extends AbstractDatumType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='pixelInCell'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ImageDatumType#getPixelInCell <em>Pixel In
