 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Aeshetic Criteria Type</b></em>', and
...
public enum AesheticCriteriaType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINCROSSINGS</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINAREA</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINBENDS</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MINBENDS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MAXBENDS</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MAXBENDS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>UNIFORMBENDS</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #UNIFORMBENDS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINSLOPES</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MINSLOPES
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINEDGELENGTH</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MINEDGELENGTH
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MAXEDGELENGTH</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MAXEDGELENGTH
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>UNIFORMEDGELENGTH</b></em>' literal object isn't clear, there
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MAXANGULARRESOLUTION</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MINASPECTRATIO</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MINASPECTRATIO
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>MAXSYMMETRIES</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MAXSYMMETRIES
  ...
  public static AesheticCriteriaType get(int value) {
    switch (value) {
      ...
      case MAXBENDS_VALUE:
        return MAXBENDS;
      case UNIFORMBENDS_VALUE:
        return UNIFORMBENDS;
      case MINSLOPES_VALUE:
        return MINSLOPES;
      case MINEDGELENGTH_VALUE:
        return MINEDGELENGTH;
      case MAXEDGELENGTH_VALUE:
        return MAXEDGELENGTH;
      case UNIFORMEDGELENGTH_VALUE:
        return UNIFORMEDGELENGTH;
      case MAXANGULARRESOLUTION_VALUE:
        return MAXANGULARRESOLUTION;
      case MINASPECTRATIO_VALUE:
        return MINASPECTRATIO;
      case MAXSYMMETRIES_VALUE:
