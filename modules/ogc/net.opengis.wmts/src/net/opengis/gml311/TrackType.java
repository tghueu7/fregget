 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The track of a moving object is a sequence of specialized timeslices that indicate the status of
 * the object.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TrackType#getMovingObjectStatus <em>Moving Object Status</em>}
 * </ul>
 *
...
public interface TrackType extends HistoryPropertyType {
  /**
   * Returns the value of the '<em><b>Moving Object Status</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.gml311.MovingObjectStatusType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Moving Object Status</em>' containment reference list isn't
   ...
   *     name='MovingObjectStatus' namespace='##targetNamespace'"
   * @generated
   */
