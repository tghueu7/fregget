 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for operation method objects, simplifying and restricting the DefinitionType as
 * needed.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationMethodBaseType#getMethodName <em>Method Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getOperationMethodBaseType()
 * @model abstract="true" extendedMetaData="name='OperationMethodBaseType' kind='elementOnly'"
 * @generated
 */
public interface OperationMethodBaseType extends DefinitionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='methodName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationMethodBaseType#getMethodName
   * <em>Method Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
