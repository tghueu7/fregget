 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimePeriodType#getBeginPosition <em>Begin Position</em>}
 *   <li>{@link net.opengis.gml311.TimePeriodType#getBegin <em>Begin</em>}
 *   <li>{@link net.opengis.gml311.TimePeriodType#getEndPosition <em>End Position</em>}
 *   <li>{@link net.opengis.gml311.TimePeriodType#getEnd <em>End</em>}
 *   <li>{@link net.opengis.gml311.TimePeriodType#getDuration <em>Duration</em>}
 *   <li>{@link net.opengis.gml311.TimePeriodType#getTimeInterval <em>Time Interval</em>}
 * </ul>
 *
...
public interface TimePeriodType extends AbstractTimeGeometricPrimitiveType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Begin Position</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='beginPosition'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getBeginPosition <em>Begin
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Begin</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" extendedMetaData="kind='element' name='begin'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getBegin <em>Begin</em>}'
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>End Position</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='endPosition'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getEndPosition <em>End
   * Position</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='end'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getEnd <em>End</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Duration" extendedMetaData="kind='element'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getDuration <em>Duration</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='timeInterval'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimePeriodType#getTimeInterval <em>Time
