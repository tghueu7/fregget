 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GridCoverageType#getGridDomain <em>Grid Domain</em>}
 * </ul>
 *
...
public interface GridCoverageType extends AbstractDiscreteCoverageType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='gridDomain'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridCoverageType#getGridDomain <em>Grid
