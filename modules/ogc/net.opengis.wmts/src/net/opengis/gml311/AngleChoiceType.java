 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AngleChoiceType#getAngle <em>Angle</em>}
 *   <li>{@link net.opengis.gml311.AngleChoiceType#getDmsAngle <em>Dms Angle</em>}
 * </ul>
 *
...
public interface AngleChoiceType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='angle'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AngleChoiceType#getAngle <em>Angle</em>}'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='dmsAngle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AngleChoiceType#getDmsAngle <em>Dms
