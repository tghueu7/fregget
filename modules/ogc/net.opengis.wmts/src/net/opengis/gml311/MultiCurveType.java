 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiCurveType#getCurveMember <em>Curve Member</em>}
 *   <li>{@link net.opengis.gml311.MultiCurveType#getCurveMembers <em>Curve Members</em>}
 * </ul>
 *
...
public interface MultiCurveType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Curve Member</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.CurvePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='curveMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='curveMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurveType#getCurveMembers <em>Curve
