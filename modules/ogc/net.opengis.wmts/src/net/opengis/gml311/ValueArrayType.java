 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A Value Array is used for homogeneous arrays of primitive and aggregate values. The member values
 * may be scalars, composites, arrays or lists. ValueArray has the same content model as
 ...
 * implicitly inherited by all the members if desired. Note that a_ScalarValueList is preferred for
 * arrays of Scalar Values since this is a more efficient encoding.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ValueArrayType#getCodeSpace <em>Code Space</em>}
 *   <li>{@link net.opengis.gml311.ValueArrayType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface ValueArrayType extends CompositeValueType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Code Space</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ValueArrayType#getCodeSpace <em>Code
   * Space</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ValueArrayType#getUom <em>Uom</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
