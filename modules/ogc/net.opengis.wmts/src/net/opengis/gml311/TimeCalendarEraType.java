 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * In every calendar, years are numbered relative to the date of a reference event that defines a
 * calendar era. In this implementation, we omit the back-pointer "datingSystem".
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeCalendarEraType#getReferenceEvent <em>Reference Event</em>}
 *   <li>{@link net.opengis.gml311.TimeCalendarEraType#getReferenceDate <em>Reference Date</em>}
 *   <li>{@link net.opengis.gml311.TimeCalendarEraType#getJulianReference <em>Julian Reference</em>}
 *   <li>{@link net.opengis.gml311.TimeCalendarEraType#getEpochOfUse <em>Epoch Of Use</em>}
 * </ul>
 *
...
public interface TimeCalendarEraType extends DefinitionType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Name or description of a mythical or historic event which fixes the position of the base scale
   * of the calendar era.
   * <!-- end-model-doc -->
   *
   ...
   *     name='referenceEvent' namespace='##targetNamespace'"
   * @generated
   */
  StringOrRefType getReferenceEvent();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCalendarEraType#getReferenceEvent
   * <em>Reference Event</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Reference Date</b></em>' attribute. The default value is
   * <code>"0001-01-01"</code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Date of the referenceEvent expressed as a date in the given calendar. In most calendars, this
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCalendarEraType#getReferenceDate
   * <em>Reference Date</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TimeCalendarEraType#getReferenceDate
   * <em>Reference Date</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.gml311.TimeCalendarEraType#getReferenceDate <em>Reference Date</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Julian date that corresponds to the reference date. The Julian day numbering system is a
   * temporal coordinate system that has an origin earlier than any known calendar, at noon on 1
   * January 4713 BC in the Julian proleptic calendar. The Julian day number is an integer value;
   * the Julian date is a decimal value that allows greater resolution. Transforming calendar dates
   * to and from Julian dates provides a relatively simple basis for transforming dates from one
   * calendar to another.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCalendarEraType#getJulianReference
   * <em>Julian Reference</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='epochOfUse'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCalendarEraType#getEpochOfUse <em>Epoch Of
   * Use</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
