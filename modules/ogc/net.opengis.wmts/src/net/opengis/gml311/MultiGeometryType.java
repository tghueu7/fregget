 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiGeometryType#getGeometryMember <em>Geometry Member</em>}
 *   <li>{@link net.opengis.gml311.MultiGeometryType#getGeometryMembers <em>Geometry Members</em>}
 * </ul>
 *
...
public interface MultiGeometryType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Geometry Member</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.GeometryPropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='geometryMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='geometryMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiGeometryType#getGeometryMembers
   * <em>Geometry Members</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
