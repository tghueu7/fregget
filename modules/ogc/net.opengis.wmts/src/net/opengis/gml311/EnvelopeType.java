 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.EnvelopeType#getLowerCorner <em>Lower Corner</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getUpperCorner <em>Upper Corner</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getCoord <em>Coord</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getAxisLabels <em>Axis Labels</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getSrsDimension <em>Srs Dimension</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.EnvelopeType#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
...
public interface EnvelopeType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Lower Corner</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='lowerCorner'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getLowerCorner <em>Lower
   * Corner</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Upper Corner</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='upperCorner'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getUpperCorner <em>Upper
   * Corner</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Coord</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.gml311.CoordType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" upper="2" extendedMetaData="kind='element' name='coord'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Deprecated with GML version 3.1. Use the explicit properties "lowerCorner" and "upperCorner"
   * instead.
   * <!-- end-model-doc -->
   *
   * @return the value of the '<em>Pos</em>' containment reference list.
   * @see net.opengis.gml311.Gml311Package#getEnvelopeType_Pos()
   * @model containment="true" upper="2" extendedMetaData="kind='element' name='pos'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Deprecated with GML version 3.1.0. Use the explicit properties "lowerCorner" and "upperCorner"
   * instead.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getCoordinates
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered list of labels for all the axes of this CRS. The gml:axisAbbrev value should be used
   * for these axis labels, after spaces and forbiddden characters are removed. When the srsName
   * attribute is included, this attribute is optional. When the srsName attribute is omitted, this
   ...
   * @model dataType="net.opengis.gml311.NCNameList" many="false" extendedMetaData="kind='attribute'
   *     name='axisLabels'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getAxisLabels <em>Axis
   * Labels</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "srsDimension" is the length of coordinate sequence (the number of entries in the list).
   * This dimension is specified by the coordinate reference system. When the srsName attribute is
   * omitted, this attribute shall be omitted.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getSrsDimension <em>Srs
   * Dimension</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * description exists at the location the URI points to. If no srsName attribute is given, the CRS
   * must be specified as part of the larger context this geometry element is part of, e.g. a
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getSrsName <em>Srs Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered list of unit of measure (uom) labels for all the axes of this CRS. The value of the
   * string in the gml:catalogSymbol should be used for this uom labels, after spaces and forbiddden
   * characters are removed. When the axisLabels attribute is included, this attribute shall also be
   * included. When the axisLabels attribute is omitted, this attribute shall also be omitted.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EnvelopeType#getUomLabels <em>Uom
   * Labels</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
