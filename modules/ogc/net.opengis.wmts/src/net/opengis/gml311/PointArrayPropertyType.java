 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PointArrayPropertyType#getPoint <em>Point</em>}
 * </ul>
 *
...
public interface PointArrayPropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Point</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.gml311.PointType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Point</em>' containment reference list isn't clear, there really
