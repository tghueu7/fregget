 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TemporalCRSType#getUsesTemporalCS <em>Uses Temporal CS</em>}
 *   <li>{@link net.opengis.gml311.TemporalCRSType#getUsesTemporalDatum <em>Uses Temporal
 *       Datum</em>}
 * </ul>
 *
...
public interface TemporalCRSType extends AbstractReferenceSystemType {
   ...
   *     name='usesTemporalCS' namespace='##targetNamespace'"
   * @generated
   */
  TemporalCSRefType getUsesTemporalCS();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TemporalCRSType#getUsesTemporalCS <em>Uses
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='usesTemporalDatum' namespace='##targetNamespace'"
   * @generated
   */
  TemporalDatumRefType getUsesTemporalDatum();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TemporalCRSType#getUsesTemporalDatum <em>Uses
