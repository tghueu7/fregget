 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ImageCRSType#getUsesCartesianCS <em>Uses Cartesian CS</em>}
 *   <li>{@link net.opengis.gml311.ImageCRSType#getUsesObliqueCartesianCS <em>Uses Oblique Cartesian
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.ImageCRSType#getUsesImageDatum <em>Uses Image Datum</em>}
 * </ul>
 *
...
public interface ImageCRSType extends AbstractReferenceSystemType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ImageCRSType#getUsesCartesianCS <em>Uses
   ...
   * @model containment="true" extendedMetaData="kind='element' name='usesObliqueCartesianCS'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ImageCRSType#getUsesObliqueCartesianCS
   ...
   *     name='usesImageDatum' namespace='##targetNamespace'"
   * @generated
   */
  ImageDatumRefType getUsesImageDatum();

  /**
   * Sets the value of the '{@link net.opengis.gml311.ImageCRSType#getUsesImageDatum <em>Uses Image
