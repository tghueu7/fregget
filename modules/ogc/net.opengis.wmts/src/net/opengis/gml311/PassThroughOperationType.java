 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PassThroughOperationType#getModifiedCoordinate <em>Modified
 *       Coordinate</em>}
 *   <li>{@link net.opengis.gml311.PassThroughOperationType#getUsesOperation <em>Uses
 *       Operation</em>}
 * </ul>
 *
...
public interface PassThroughOperationType extends AbstractCoordinateOperationType {
  /**
   * Returns the value of the '<em><b>Modified Coordinate</b></em>' attribute list. The list
   * contents are of type {@link java.math.BigInteger}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='usesOperation'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PassThroughOperationType#getUsesOperation
   * <em>Uses Operation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
