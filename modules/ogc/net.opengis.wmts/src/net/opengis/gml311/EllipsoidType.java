 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * An ellipsoid is a geometric figure that can be used to describe the approximate shape of the
 * earth. In mathematical terms, it is a surface formed by the rotation of an ellipse about its
 * minor axis.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.EllipsoidType#getEllipsoidID <em>Ellipsoid ID</em>}
 *   <li>{@link net.opengis.gml311.EllipsoidType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.EllipsoidType#getSemiMajorAxis <em>Semi Major Axis</em>}
 *   <li>{@link net.opengis.gml311.EllipsoidType#getSecondDefiningParameter <em>Second Defining
 *       Parameter</em>}
 * </ul>
 *
...
public interface EllipsoidType extends EllipsoidBaseType {
  /**
   * Returns the value of the '<em><b>Ellipsoid ID</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alternative identifications of this ellipsoid. The first ellipsoidID, if any, is
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ellipsoidID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EllipsoidType#getRemarks <em>Remarks</em>}'
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='semiMajorAxis'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EllipsoidType#getSemiMajorAxis <em>Semi Major
   ...
   *     name='secondDefiningParameter' namespace='##targetNamespace'"
   * @generated
   */
  SecondDefiningParameterType getSecondDefiningParameter();

  /**
   * Sets the value of the '{@link net.opengis.gml311.EllipsoidType#getSecondDefiningParameter
