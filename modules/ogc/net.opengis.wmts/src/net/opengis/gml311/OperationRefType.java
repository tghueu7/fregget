 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Association to an abstract operation, either referencing or containing the definition of that
 * operation.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationRefType#getOperationGroup <em>Operation Group</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getOperation <em>Operation</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getRemoteSchema <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.OperationRefType#getType <em>Type</em>}
 * </ul>
 *
...
public interface OperationRefType extends EObject {
  /**
   * Returns the value of the '<em><b>Operation Group</b></em>' attribute list. The list contents
   ...
   *     extendedMetaData="kind='element' name='_Operation' namespace='##targetNamespace'
   *     group='_Operation:group'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.OperationRefType#getActuate
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.OperationRefType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getArcrole <em>Arcrole</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getHref <em>Href</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getRemoteSchema <em>Remote
   * Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getRole <em>Role</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.OperationRefType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.OperationRefType#getShow
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationRefType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.OperationRefType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.OperationRefType#getType
