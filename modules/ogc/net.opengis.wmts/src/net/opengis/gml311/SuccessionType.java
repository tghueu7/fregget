 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Succession Type</b></em>', and
 * utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Feature succession is a semantic relationship derived from evaluation of observer, and Feature
 * Substitution, Feature Division and Feature Fusion are defined as associations between previous
 * features and next features in the temporal context. Successions shall be represented in either
 * following two ways. * define a temporal topological complex element as a feature element * define
 * an association same as temporal topological complex between features.
 * <!-- end-model-doc -->
 *
...
public enum SuccessionType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Substitution</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Division</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Fusion</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #FUSION
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Initiation</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #INITIATION
  ...
  private static final SuccessionType[] VALUES_ARRAY =
      new SuccessionType[] {
        SUBSTITUTION, DIVISION, FUSION, INITIATION,
      };
