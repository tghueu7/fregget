 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeTopologyComplexType#getPrimitive <em>Primitive</em>}
 * </ul>
 *
...
public interface TimeTopologyComplexType extends AbstractTimeComplexType {
  /**
   * Returns the value of the '<em><b>Primitive</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TimeTopologyPrimitivePropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Primitive</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='primitive'
