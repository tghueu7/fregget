 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CompoundCRSType#getIncludesCRS <em>Includes CRS</em>}
 * </ul>
 *
...
public interface CompoundCRSType extends AbstractReferenceSystemType {
  /**
   * Returns the value of the '<em><b>Includes CRS</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.CoordinateReferenceSystemRefType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered sequence of associations to all the component coordinate reference systems included in
   ...
   * @model containment="true" lower="2" extendedMetaData="kind='element' name='includesCRS'
