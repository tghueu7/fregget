 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TopoPrimitiveArrayAssociationType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.TopoPrimitiveArrayAssociationType#getTopoPrimitiveGroup <em>Topo
 *       Primitive Group</em>}
 *   <li>{@link net.opengis.gml311.TopoPrimitiveArrayAssociationType#getTopoPrimitive <em>Topo
 *       Primitive</em>}
 * </ul>
 *
...
public interface TopoPrimitiveArrayAssociationType extends EObject {
   ...
   *     name='_TopoPrimitive:group' namespace='##targetNamespace' group='#group:0'"
   * @generated
   */
  FeatureMap getTopoPrimitiveGroup();

  /**
   * Returns the value of the '<em><b>Topo Primitive</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractTopoPrimitiveType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Substitution group branch for Topo Primitives, used by TopoPrimitiveArrayAssociationType
