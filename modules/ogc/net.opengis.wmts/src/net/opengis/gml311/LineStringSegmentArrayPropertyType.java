 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.LineStringSegmentArrayPropertyType#getLineStringSegment <em>Line
 *       String Segment</em>}
 * </ul>
 *
...
public interface LineStringSegmentArrayPropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Line String Segment</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.gml311.LineStringSegmentType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Line String Segment</em>' containment reference list isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LineStringSegment'
