 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A value in the time domain is measured relative to a temporal reference system. Common types of
 * reference systems include calendars, ordinal temporal reference systems, and temporal coordinate
 * systems (time elapsed since some epoch, e.g. UNIX time).
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractTimeReferenceSystemType#getDomainOfValidity <em>Domain Of
 *       Validity</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractTimeReferenceSystemType()
 * @model abstract="true" extendedMetaData="name='AbstractTimeReferenceSystemType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractTimeReferenceSystemType extends DefinitionType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Domain Of Validity</em>' attribute isn't clear, there really
   ...
   *     name='domainOfValidity' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * net.opengis.gml311.AbstractTimeReferenceSystemType#getDomainOfValidity <em>Domain Of
   * Validity</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
