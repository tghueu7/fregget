 ...
 * Constraints: At least one of the elements "description", "boundingBox", "boundingPolygon",
 * "verticalExtent", and temporalExtent" must be included, but more that one can be included when
 * appropriate. Furthermore, more than one "boundingBox", "boundingPolygon", "verticalExtent",
 * and/or temporalExtent" element can be included, with more than one meaning the union of the
 * individual domains.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ExtentType#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.gml311.ExtentType#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.gml311.ExtentType#getBoundingPolygon <em>Bounding Polygon</em>}
 *   <li>{@link net.opengis.gml311.ExtentType#getVerticalExtent <em>Vertical Extent</em>}
 *   <li>{@link net.opengis.gml311.ExtentType#getTemporalExtent <em>Temporal Extent</em>}
 * </ul>
 *
...
public interface ExtentType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ExtentType#getDescription
   ...
   * contents are of type {@link net.opengis.gml311.EnvelopeType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of bounding boxes (or envelopes) whose union describes the spatial domain of
   * this object.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='boundingBox'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Bounding Polygon</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.gml311.PolygonType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='boundingPolygon'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Vertical Extent</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.EnvelopeType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='verticalExtent'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Temporal Extent</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TimePeriodType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='temporalExtent'
   *     namespace='##targetNamespace'"
   * @generated
   */
