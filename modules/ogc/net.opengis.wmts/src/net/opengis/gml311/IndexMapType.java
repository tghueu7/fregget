 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Exends GridFunctionType with a lookUpTable. This contains a list of indexes of members within the
 * rangeSet corresponding with the members of the domainSet. The domainSet is traversed in list
 * order if it is enumerated explicitly, or in the order specified by a SequenceRule if the domain
 * is an implicit set. The length of the lookUpTable corresponds with the length of the subset of
 * the domainSet for which the coverage is defined.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.IndexMapType#getLookUpTable <em>Look Up Table</em>}
 * </ul>
 *
...
public interface IndexMapType extends GridFunctionType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Look Up Table</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.IndexMapType#getLookUpTable <em>Look Up
   * Table</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
