...
public enum QueryGrammarEnumeration implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Xpath</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Xquery</b></em>' literal object isn't clear, there really should
   ...
   * @generated
   */
  public static final List<QueryGrammarEnumeration> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Query Grammar Enumeration</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Query Grammar Enumeration</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
