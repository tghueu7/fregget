 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeometryStyleType#getSymbol <em>Symbol</em>}
 *   <li>{@link net.opengis.gml311.GeometryStyleType#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.GeometryStyleType#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.GeometryStyleType#getGeometryProperty <em>Geometry Property</em>}
 *   <li>{@link net.opengis.gml311.GeometryStyleType#getGeometryType <em>Geometry Type</em>}
 * </ul>
 *
...
public interface GeometryStyleType extends BaseStyleDescriptorType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometryStyleType#getSymbol <em>Symbol</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometryStyleType#getStyle <em>Style</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometryStyleType#getLabelStyle <em>Label
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Geometry Property</em>' attribute isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometryStyleType#getGeometryProperty
   * <em>Geometry Property</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Geometry Type</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometryStyleType#getGeometryType <em>Geometry
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
