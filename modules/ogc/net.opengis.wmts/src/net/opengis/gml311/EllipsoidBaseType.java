 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.EllipsoidBaseType#getEllipsoidName <em>Ellipsoid Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getEllipsoidBaseType()
 * @model abstract="true" extendedMetaData="name='EllipsoidBaseType' kind='elementOnly'"
 * @generated
 */
public interface EllipsoidBaseType extends DefinitionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='ellipsoidName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EllipsoidBaseType#getEllipsoidName
   * <em>Ellipsoid Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
