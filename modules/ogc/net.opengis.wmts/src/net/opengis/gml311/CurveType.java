 ...
 * length in terms of the coordinate system. A curve is composed of one or more curve segments. Each
 * curve segment within a curve may be defined using a different interpolation method. The curve
 * segments are connected to one another, with the end point of each segment except the last being
 * the start point of the next segment in the segment list. The orientation of the curve is
 * positive.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CurveType#getSegments <em>Segments</em>}
 * </ul>
 *
...
public interface CurveType extends AbstractCurveType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='segments'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.CurveType#getSegments <em>Segments</em>}'
