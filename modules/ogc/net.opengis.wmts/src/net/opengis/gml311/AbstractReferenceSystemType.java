 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractReferenceSystemType#getSrsID <em>Srs ID</em>}
 *   <li>{@link net.opengis.gml311.AbstractReferenceSystemType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.AbstractReferenceSystemType#getValidArea <em>Valid Area</em>}
 *   <li>{@link net.opengis.gml311.AbstractReferenceSystemType#getScope <em>Scope</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractReferenceSystemType()
 * @model abstract="true" extendedMetaData="name='AbstractReferenceSystemType' kind='elementOnly'"
 * @generated
 */
public interface AbstractReferenceSystemType extends AbstractReferenceSystemBaseType {
  /**
   * Returns the value of the '<em><b>Srs ID</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alterative identifications of this reference system. The first srsID, if any, is
   ...
   * @model containment="true" extendedMetaData="kind='element' name='srsID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractReferenceSystemType#getRemarks
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractReferenceSystemType#getValidArea
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractReferenceSystemType#getScope
