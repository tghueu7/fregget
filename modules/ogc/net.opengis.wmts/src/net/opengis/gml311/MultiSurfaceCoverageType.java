 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A discrete coverage type whose domain is defined by a collection of surface patches (includes
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiSurfaceCoverageType#getMultiSurfaceDomain <em>Multi Surface
 *       Domain</em>}
 * </ul>
 *
...
public interface MultiSurfaceCoverageType extends AbstractDiscreteCoverageType {
   ...
   *     name='multiSurfaceDomain' namespace='##targetNamespace'"
   * @generated
   */
  MultiSurfaceDomainType getMultiSurfaceDomain();

  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiSurfaceCoverageType#getMultiSurfaceDomain
   * <em>Multi Surface Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
