 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractGeometryType#getAxisLabels <em>Axis Labels</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeometryType#getGid <em>Gid</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeometryType#getSrsDimension <em>Srs Dimension</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeometryType#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeometryType#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractGeometryType()
 * @model abstract="true" extendedMetaData="name='AbstractGeometryType' kind='elementOnly'"
 * @generated
 */
public interface AbstractGeometryType extends AbstractGMLType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractGeometryType#getAxisLabels <em>Axis
   * Labels</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * should not be used anymore and may be deleted in future versions of GML without further notice.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractGeometryType#getGid <em>Gid</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractGeometryType#getSrsDimension <em>Srs
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractGeometryType#getSrsName <em>Srs
   * Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractGeometryType#getUomLabels <em>Uom
   * Labels</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
