 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Represents a coordinate tuple in one, two, or three dimensions. Deprecated with GML 3.0 and
 * replaced by DirectPositionType.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CoordType#getX <em>X</em>}
 *   <li>{@link net.opengis.gml311.CoordType#getY <em>Y</em>}
 *   <li>{@link net.opengis.gml311.CoordType#getZ <em>Z</em>}
 * </ul>
 *
...
public interface CoordType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>X</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Y</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Decimal" extendedMetaData="kind='element'
   *     name='Y' namespace='##targetNamespace'"
   * @generated
   */
  BigDecimal getY();
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Z</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Decimal" extendedMetaData="kind='element'
   *     name='Z' namespace='##targetNamespace'"
   * @generated
   */
  BigDecimal getZ();
