 ...
 * coordinate reference system. Many but not all coordinate operations (from CRS A to CRS B) also
 * uniquely define the inverse operation (from CRS B to CRS A). In some cases, the operation method
 * algorithm for the inverse operation is the same as for the forward algorithm, but the signs of
 * some operation parameter values must be reversed. In other cases, different algorithms are
 * required for the forward and inverse operations, but the same operation parameter values are
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getCoordinateOperationID
 *       <em>Coordinate Operation ID</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getOperationVersion <em>Operation
 *       Version</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getValidArea <em>Valid Area</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getScope <em>Scope</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getPositionalAccuracyGroup
 *       <em>Positional Accuracy Group</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getPositionalAccuracy
 *       <em>Positional Accuracy</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getSourceCRS <em>Source CRS</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationType#getTargetCRS <em>Target CRS</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractCoordinateOperationType()
 * @model abstract="true" extendedMetaData="name='AbstractCoordinateOperationType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractCoordinateOperationType extends AbstractCoordinateOperationBaseType {
   ...
   * coordinateOperationID, if any, is normally the primary identification code, and any others are
   * aliases.
   * <!-- end-model-doc -->
   *
   * @return the value of the '<em>Coordinate Operation ID</em>' containment reference list.
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractCoordinateOperationType_CoordinateOperationID()
   * @model containment="true" extendedMetaData="kind='element' name='coordinateOperationID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateOperationType#getRemarks
   ...
   * net.opengis.gml311.AbstractCoordinateOperationType#getOperationVersion <em>Operation
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateOperationType#getValidArea
   * <em>Valid Area</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateOperationType#getScope
   * <em>Scope</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Positional Accuracy Group</b></em>' attribute list. The list
   * contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered set of estimates of the impact of this coordinate operation on point position
   * accuracy. Gives position error estimates for target coordinates of this coordinate operation,
   * assuming no errors in source coordinates.
   * <!-- end-model-doc -->
   *
   * @return the value of the '<em>Positional Accuracy Group</em>' attribute list.
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractCoordinateOperationType_PositionalAccuracyGroup()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
   *     extendedMetaData="kind='group' name='_positionalAccuracy:group'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Positional Accuracy</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.gml311.AbstractPositionalAccuracyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered set of estimates of the impact of this coordinate operation on point position
   ...
   *     group='_positionalAccuracy:group'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='sourceCRS'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateOperationType#getSourceCRS
   * <em>Source CRS</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='targetCRS'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateOperationType#getTargetCRS
   * <em>Target CRS</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
