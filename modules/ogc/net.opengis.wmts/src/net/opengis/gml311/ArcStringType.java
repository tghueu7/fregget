 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ArcStringType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getPointProperty <em>Point Property</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getInterpolation <em>Interpolation</em>}
 *   <li>{@link net.opengis.gml311.ArcStringType#getNumArc <em>Num Arc</em>}
 * </ul>
 *
...
public interface ArcStringType extends AbstractCurveSegmentType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcStringType#getPosList <em>Pos List</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcStringType#getCoordinates
   ...
   * "circularArc3Points"</code>. The literals are from the enumeration {@link
   ...
   * @model default="circularArc3Points" unsettable="true" extendedMetaData="kind='attribute'
   *     name='interpolation'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcStringType#getInterpolation
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.ArcStringType#getInterpolation
   * <em>Interpolation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.ArcStringType#getInterpolation
   ...
   * control points in the arc string must be 2 * numArc + 1.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcStringType#getNumArc <em>Num Arc</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
