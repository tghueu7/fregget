 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiSolidCoverageType#getMultiSolidDomain <em>Multi Solid
 *       Domain</em>}
 * </ul>
 *
...
public interface MultiSolidCoverageType extends AbstractDiscreteCoverageType {
   ...
   *     name='multiSolidDomain' namespace='##targetNamespace'"
   * @generated
   */
  MultiSolidDomainType getMultiSolidDomain();

  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiSolidCoverageType#getMultiSolidDomain
   * <em>Multi Solid Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
