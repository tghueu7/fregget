 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A temporal coordinate system is based on a continuous interval scale defined in terms of a single
 * time interval.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeCoordinateSystemType#getOriginPosition <em>Origin
 *       Position</em>}
 *   <li>{@link net.opengis.gml311.TimeCoordinateSystemType#getOrigin <em>Origin</em>}
 *   <li>{@link net.opengis.gml311.TimeCoordinateSystemType#getInterval <em>Interval</em>}
 * </ul>
 *
...
public interface TimeCoordinateSystemType extends AbstractTimeReferenceSystemType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Origin Position</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='originPosition'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCoordinateSystemType#getOriginPosition
   * <em>Origin Position</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Origin</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" extendedMetaData="kind='element' name='origin'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCoordinateSystemType#getOrigin
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='interval'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeCoordinateSystemType#getInterval
   * <em>Interval</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
