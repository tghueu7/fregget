 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * An entry in a dictionary of definitions that contains a GML object which references a remote
 * definition object. This entry is expected to be convenient in allowing multiple elements in one
 * XML document to contain short (abbreviated XPointer) references, which are resolved to an
 * external definition provided in a Dictionary element in the same XML document. Specialized
 * descendents of this dictionaryEntry might be restricted in an application schema to allow only
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.IndirectEntryType#getDefinitionProxy <em>Definition Proxy</em>}
 * </ul>
 *
...
public interface IndirectEntryType extends EObject {
   ...
   *     name='DefinitionProxy' namespace='##targetNamespace'"
   * @generated
   */
  DefinitionProxyType getDefinitionProxy();

  /**
   * Sets the value of the '{@link net.opengis.gml311.IndirectEntryType#getDefinitionProxy
   * <em>Definition Proxy</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
