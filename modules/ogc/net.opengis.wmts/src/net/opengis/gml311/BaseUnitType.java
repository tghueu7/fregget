 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Definition of a unit of measure which is a base unit from the system of units. A base unit cannot
 * be derived by combination of other base units within this system. Sometimes known as "fundamental
 * unit".
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.BaseUnitType#getUnitsSystem <em>Units System</em>}
 * </ul>
 *
...
public interface BaseUnitType extends UnitDefinitionType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Units System</em>' containment reference isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='unitsSystem'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.BaseUnitType#getUnitsSystem <em>Units
