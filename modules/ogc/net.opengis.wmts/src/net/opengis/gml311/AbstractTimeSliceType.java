 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A timeslice encapsulates the time-varying properties of a dynamic feature--it must be extended to
 * represent a timestamped projection of a feature. The dataSource property describes how the
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractTimeSliceType#getValidTime <em>Valid Time</em>}
 *   <li>{@link net.opengis.gml311.AbstractTimeSliceType#getDataSource <em>Data Source</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractTimeSliceType()
 * @model abstract="true" extendedMetaData="name='AbstractTimeSliceType' kind='elementOnly'"
 * @generated
 */
public interface AbstractTimeSliceType extends AbstractGMLType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractTimeSliceType#getValidTime <em>Valid
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractTimeSliceType#getDataSource <em>Data
