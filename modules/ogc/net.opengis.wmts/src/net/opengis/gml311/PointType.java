 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PointType#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.PointType#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.PointType#getCoord <em>Coord</em>}
 * </ul>
 *
...
public interface PointType extends AbstractGeometricPrimitiveType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PointType#getPos <em>Pos</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Deprecated with GML version 3.1.0 for coordinates with ordinate values that are numbers. Use
   * "pos" instead. The "coordinates" element shall only be used for coordinates with ordinates that
   * require a string representation, e.g. DMS representations.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PointType#getCoordinates
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PointType#getCoord <em>Coord</em>}'
