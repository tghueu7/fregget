 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiPointCoverageType#getMultiPointDomain <em>Multi Point
 *       Domain</em>}
 * </ul>
 *
...
public interface MultiPointCoverageType extends AbstractDiscreteCoverageType {
   ...
   *     name='multiPointDomain' namespace='##targetNamespace'"
   * @generated
   */
  MultiPointDomainType getMultiPointDomain();

  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiPointCoverageType#getMultiPointDomain
   * <em>Multi Point Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
