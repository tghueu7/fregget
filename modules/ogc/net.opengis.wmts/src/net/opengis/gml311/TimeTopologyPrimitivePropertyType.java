 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A time topology primitive property can either hold any time topology complex element eor carry an
 * XLink reference to a remote time topology complex element (where remote includes elements located
 * elsewhere in the same document). Note that either the reference or the contained element must be
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getTimeTopologyPrimitiveGroup
 *       <em>Time Topology Primitive Group</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getTimeTopologyPrimitive
 *       <em>Time Topology Primitive</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface TimeTopologyPrimitivePropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Time Topology Primitive Group</b></em>' attribute list. The
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getTimeTopologyPrimitivePropertyType_TimeTopologyPrimitiveGroup()
   * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
   *     extendedMetaData="kind='group' name='_TimeTopologyPrimitive:group'
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getTimeTopologyPrimitivePropertyType_TimeTopologyPrimitive()
   * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='_TimeTopologyPrimitive'
   *     namespace='##targetNamespace' group='_TimeTopologyPrimitive:group'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.gml311.TimeTopologyPrimitivePropertyType#getActuate <em>Actuate</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getHref
   ...
   * net.opengis.gml311.TimeTopologyPrimitivePropertyType#getRemoteSchema <em>Remote Schema</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getRole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getShow
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getShow
   * <em>Show</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.gml311.TimeTopologyPrimitivePropertyType#getShow <em>Show</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getTitle
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getType
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TimeTopologyPrimitivePropertyType#getType
   * <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.gml311.TimeTopologyPrimitivePropertyType#getType <em>Type</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
