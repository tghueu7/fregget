 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Convenience property for generalised location. A representative location for plotting or
 * analysis. Often augmented by one or more additional geometry properties with more specific
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getGeometryGroup <em>Geometry Group</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getGeometry <em>Geometry</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getLocationKeyWord <em>Location Key
 *       Word</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getLocationString <em>Location String</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getNull <em>Null</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getRemoteSchema <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.LocationPropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface LocationPropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Geometry Group</b></em>' attribute list. The list contents are
   ...
   *     extendedMetaData="kind='element' name='_Geometry' namespace='##targetNamespace'
   *     group='_Geometry:group'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LocationKeyWord'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getLocationKeyWord
   * <em>Location Key Word</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LocationString'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getLocationString
   * <em>Location String</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getNull <em>Null</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.LocationPropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.LocationPropertyType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getHref <em>Href</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getRemoteSchema
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getRole <em>Role</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.LocationPropertyType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.LocationPropertyType#getShow
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LocationPropertyType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.LocationPropertyType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.LocationPropertyType#getType
