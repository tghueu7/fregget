 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeographicCRSType#getUsesEllipsoidalCS <em>Uses Ellipsoidal
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.GeographicCRSType#getUsesGeodeticDatum <em>Uses Geodetic
 *       Datum</em>}
 * </ul>
 *
...
public interface GeographicCRSType extends AbstractReferenceSystemType {
   ...
   *     name='usesEllipsoidalCS' namespace='##targetNamespace'"
   * @generated
   */
  EllipsoidalCSRefType getUsesEllipsoidalCS();

  /**
   * Sets the value of the '{@link net.opengis.gml311.GeographicCRSType#getUsesEllipsoidalCS
   * <em>Uses Ellipsoidal CS</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeographicCRSType#getUsesGeodeticDatum
