 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getMultiCurve <em>Multi Curve</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getRemoteSchema <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.MultiCurvePropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface MultiCurvePropertyType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='MultiCurve'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getMultiCurve <em>Multi
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getHref <em>Href</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getRemoteSchema
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getRole <em>Role</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getShow
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getShow
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getTitle
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getType
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.MultiCurvePropertyType#getType
