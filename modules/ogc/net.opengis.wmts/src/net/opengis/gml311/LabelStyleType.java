 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.LabelStyleType#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.LabelStyleType#getLabel <em>Label</em>}
 * </ul>
 *
...
public interface LabelStyleType extends BaseStyleDescriptorType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Style</em>' attribute isn't clear, there really should be more of
   * a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LabelStyleType#getStyle <em>Style</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Label</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='label'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LabelStyleType#getLabel <em>Label</em>}'
