 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Sequence Rule Names</b></em>', and
 * utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * List of codes (adopted from ISO 19123 Annex C) that identifies the rule for traversing a grid to
 * correspond with the sequence of members of the rangeSet.
 * <!-- end-model-doc -->
 *
...
public enum SequenceRuleNames implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Boustrophedonic</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Cantor Diagonal</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #CANTOR_DIAGONAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Spiral</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #SPIRAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Morton</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MORTON
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Hilbert</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #HILBERT
  ...
  public static SequenceRuleNames get(int value) {
    switch (value) {
      case LINEAR_VALUE:
        return LINEAR;
      case BOUSTROPHEDONIC_VALUE:
        return BOUSTROPHEDONIC;
      case CANTOR_DIAGONAL_VALUE:
