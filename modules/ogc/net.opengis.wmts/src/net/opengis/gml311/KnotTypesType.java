 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Knot Types Type</b></em>', and
 ...
 * quasi-uniform iff they are of multiplicity (degree + 1) at the ends, of multiplicity 1 elsewhere,
 * and they differ by a positive constant from the preceding knot.
 * <!-- end-model-doc -->
 *
...
public enum KnotTypesType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Uniform</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Quasi Uniform</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Piecewise Bezier</b></em>' literal object isn't clear, there
  ...
  private static final KnotTypesType[] VALUES_ARRAY =
      new KnotTypesType[] {
        UNIFORM, QUASI_UNIFORM, PIECEWISE_BEZIER,
      };
  ...
  public static KnotTypesType get(int value) {
    switch (value) {
      case UNIFORM_VALUE:
        return UNIFORM;
      case QUASI_UNIFORM_VALUE:
        return QUASI_UNIFORM;
      case PIECEWISE_BEZIER_VALUE:
