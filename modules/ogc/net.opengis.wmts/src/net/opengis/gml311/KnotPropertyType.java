 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.KnotPropertyType#getKnot <em>Knot</em>}
 * </ul>
 *
...
public interface KnotPropertyType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Knot</em>' containment reference isn't clear, there really should
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Knot'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.KnotPropertyType#getKnot <em>Knot</em>}'
