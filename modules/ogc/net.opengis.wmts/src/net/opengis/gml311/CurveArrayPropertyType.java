 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CurveArrayPropertyType#getCurveGroup <em>Curve Group</em>}
 *   <li>{@link net.opengis.gml311.CurveArrayPropertyType#getCurve <em>Curve</em>}
 * </ul>
 *
...
public interface CurveArrayPropertyType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Curve</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.gml311.AbstractCurveType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "_Curve" element is the abstract head of the substituition group for all (continuous) curve
