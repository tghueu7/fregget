 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A polyhedral surface is a surface composed of polygon surfaces connected along their common
 * boundary curves. This differs from the surface type only in the restriction on the types of
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PolyhedralSurfaceType#getPolygonPatches <em>Polygon Patches</em>}
 * </ul>
 *
...
public interface PolyhedralSurfaceType extends SurfaceType {
   ...
   *     name='polygonPatches' namespace='##targetNamespace'"
   * @generated
   */
  PolygonPatchArrayPropertyType getPolygonPatches();

  /**
   * Sets the value of the '{@link net.opengis.gml311.PolyhedralSurfaceType#getPolygonPatches
   * <em>Polygon Patches</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
