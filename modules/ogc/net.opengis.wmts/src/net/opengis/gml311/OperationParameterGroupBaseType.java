 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for operation parameter group objects, simplifying and restricting the
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationParameterGroupBaseType#getGroupName <em>Group Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getOperationParameterGroupBaseType()
 * @model abstract="true" extendedMetaData="name='OperationParameterGroupBaseType'
 *     kind='elementOnly'"
 * @generated
 */
public interface OperationParameterGroupBaseType extends AbstractGeneralOperationParameterType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='groupName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationParameterGroupBaseType#getGroupName
   * <em>Group Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
