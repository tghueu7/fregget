 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.DirectionVectorType#getVector <em>Vector</em>}
 *   <li>{@link net.opengis.gml311.DirectionVectorType#getHorizontalAngle <em>Horizontal Angle</em>}
 *   <li>{@link net.opengis.gml311.DirectionVectorType#getVerticalAngle <em>Vertical Angle</em>}
 * </ul>
 *
...
public interface DirectionVectorType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='vector'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DirectionVectorType#getVector
   * <em>Vector</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Horizontal Angle</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='horizontalAngle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DirectionVectorType#getHorizontalAngle
   * <em>Horizontal Angle</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Vertical Angle</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='verticalAngle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DirectionVectorType#getVerticalAngle
   * <em>Vertical Angle</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
