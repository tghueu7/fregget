 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getFeatureConstraint <em>Feature
 *       Constraint</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getGeometryStyle <em>Geometry Style</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getTopologyStyle <em>Topology Style</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getBaseType <em>Base Type</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getFeatureType <em>Feature Type</em>}
 *   <li>{@link net.opengis.gml311.FeatureStyleType#getQueryGrammar <em>Query Grammar</em>}
 * </ul>
 *
...
public interface FeatureStyleType extends AbstractGMLType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Constraint</em>' attribute isn't clear, there really
   ...
   *     name='featureConstraint' namespace='##targetNamespace'"
   * @generated
   */
  String getFeatureConstraint();

  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStyleType#getFeatureConstraint
   * <em>Feature Constraint</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Geometry Style</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.GeometryStylePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * <!-- end-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='geometryStyle'
  ...
  /**
   * Returns the value of the '<em><b>Topology Style</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TopologyStylePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * <!-- end-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='labelStyle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStyleType#getLabelStyle <em>Label
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Base Type</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStyleType#getBaseType <em>Base
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Type</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStyleType#getFeatureType <em>Feature
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Query Grammar</b></em>' attribute. The literals are from the
   * enumeration {@link net.opengis.gml311.QueryGrammarEnumeration}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Query Grammar</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model unsettable="true" extendedMetaData="kind='attribute' name='queryGrammar'"
   * @generated
   */
  QueryGrammarEnumeration getQueryGrammar();

  /**
   * Sets the value of the '{@link net.opengis.gml311.FeatureStyleType#getQueryGrammar <em>Query
   * Grammar</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.FeatureStyleType#getQueryGrammar <em>Query
   * Grammar</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FeatureStyleType#getQueryGrammar
   * <em>Query Grammar</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
