 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PrimeMeridianType#getMeridianID <em>Meridian ID</em>}
 *   <li>{@link net.opengis.gml311.PrimeMeridianType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.PrimeMeridianType#getGreenwichLongitude <em>Greenwich
 *       Longitude</em>}
 * </ul>
 *
...
public interface PrimeMeridianType extends PrimeMeridianBaseType {
  /**
   * Returns the value of the '<em><b>Meridian ID</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alternative identifications of this prime meridian. The first meridianID, if any, is
   ...
   * @model containment="true" extendedMetaData="kind='element' name='meridianID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PrimeMeridianType#getRemarks
   ...
   *     name='greenwichLongitude' namespace='##targetNamespace'"
   * @generated
   */
  AngleChoiceType getGreenwichLongitude();

  /**
   * Sets the value of the '{@link net.opengis.gml311.PrimeMeridianType#getGreenwichLongitude
