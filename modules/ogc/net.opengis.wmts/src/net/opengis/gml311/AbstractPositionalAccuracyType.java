 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractPositionalAccuracyType#getMeasureDescription <em>Measure
 *       Description</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractPositionalAccuracyType()
 * @model abstract="true" extendedMetaData="name='AbstractPositionalAccuracyType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractPositionalAccuracyType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='measureDescription'
   ...
   * net.opengis.gml311.AbstractPositionalAccuracyType#getMeasureDescription <em>Measure
