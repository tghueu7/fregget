 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.RelatedTimeType#getRelativePosition <em>Relative Position</em>}
 * </ul>
 *
...
public interface RelatedTimeType extends TimePrimitivePropertyType {
  /**
   * Returns the value of the '<em><b>Relative Position</b></em>' attribute. The literals are from
   * the enumeration {@link net.opengis.gml311.RelativePositionType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Relative Position</em>' attribute isn't clear, there really
   ...
   * @model unsettable="true" extendedMetaData="kind='attribute' name='relativePosition'"
   * @generated
   */
  RelativePositionType getRelativePosition();

  /**
   * Sets the value of the '{@link net.opengis.gml311.RelatedTimeType#getRelativePosition
   * <em>Relative Position</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.RelatedTimeType#getRelativePosition
   * <em>Relative Position</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.RelatedTimeType#getRelativePosition
   * <em>Relative Position</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
