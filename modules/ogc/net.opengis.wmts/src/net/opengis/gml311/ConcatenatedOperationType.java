 ...
 * constrained by the requirement that the source coordinate reference system of step (n+1) must be
 * the same as the target coordinate reference system of step (n). The source coordinate reference
 * system of the first step and the target coordinate reference system of the last step are the
 * source and target coordinate reference system associated with the concatenated operation. Instead
 * of a forward operation, an inverse operation may be used for one or more of the operation steps
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ConcatenatedOperationType#getUsesSingleOperation <em>Uses Single
 *       Operation</em>}
 * </ul>
 *
...
public interface ConcatenatedOperationType extends AbstractCoordinateOperationType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Ordered sequence of associations to the two or more single operations used by this concatenated
   * operation.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" lower="2" extendedMetaData="kind='element' name='usesSingleOperation'
