 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiPointType#getPointMember <em>Point Member</em>}
 *   <li>{@link net.opengis.gml311.MultiPointType#getPointMembers <em>Point Members</em>}
 * </ul>
 *
...
public interface MultiPointType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Point Member</b></em>' containment reference list. The list
   ...
   * @model containment="true" extendedMetaData="kind='element' name='pointMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='pointMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiPointType#getPointMembers <em>Point
