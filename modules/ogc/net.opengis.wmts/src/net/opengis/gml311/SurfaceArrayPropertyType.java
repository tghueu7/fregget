 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.SurfaceArrayPropertyType#getSurfaceGroup <em>Surface Group</em>}
 *   <li>{@link net.opengis.gml311.SurfaceArrayPropertyType#getSurface <em>Surface</em>}
 * </ul>
 *
...
public interface SurfaceArrayPropertyType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Surface</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractSurfaceType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "_Surface" element is the abstract head of the substituition group for all (continuous)
