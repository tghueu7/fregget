 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.RingPropertyType#getRing <em>Ring</em>}
 * </ul>
 *
...
public interface RingPropertyType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Ring</em>' containment reference isn't clear, there really should
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Ring'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.RingPropertyType#getRing <em>Ring</em>}'
