 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeInstantType#getTimePosition <em>Time Position</em>}
 * </ul>
 *
...
public interface TimeInstantType extends AbstractTimeGeometricPrimitiveType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='timePosition'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeInstantType#getTimePosition <em>Time
