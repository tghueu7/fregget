 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiPolygonType#getPolygonMember <em>Polygon Member</em>}
 * </ul>
 *
...
public interface MultiPolygonType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Polygon Member</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.PolygonPropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='polygonMember'
