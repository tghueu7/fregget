 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CurveTypeImpl#getSegments <em>Segments</em>}
 * </ul>
 *
 * @generated
 */
public class CurveTypeImpl extends AbstractCurveTypeImpl implements CurveType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.CURVE_TYPE__SEGMENTS, oldSegments, newSegments);
  ...
  public void setSegments(CurveSegmentArrayPropertyType newSegments) {
    if (newSegments != segments) {
      ...
      if (segments != null)
        msgs =
            ((InternalEObject) segments)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.CURVE_TYPE__SEGMENTS, null, msgs);
      if (newSegments != null)
        msgs =
            ((InternalEObject) newSegments)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.CURVE_TYPE__SEGMENTS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CURVE_TYPE__SEGMENTS,
              newSegments,
              newSegments));
  }
