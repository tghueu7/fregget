 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RefLocationTypeImpl#getAffinePlacement <em>Affine
 *       Placement</em>}
 * </ul>
 *
 * @generated
...
public class RefLocationTypeImpl extends MinimalEObjectImpl.Container implements RefLocationType {
  /**
   * The cached value of the '{@link #getAffinePlacement() <em>Affine Placement</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.REF_LOCATION_TYPE__AFFINE_PLACEMENT,
              oldAffinePlacement,
              newAffinePlacement);
  ...
  public void setAffinePlacement(AffinePlacementType newAffinePlacement) {
    if (newAffinePlacement != affinePlacement) {
      ...
      if (affinePlacement != null)
        msgs =
            ((InternalEObject) affinePlacement)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.REF_LOCATION_TYPE__AFFINE_PLACEMENT,
                    null,
                    msgs);
      if (newAffinePlacement != null)
        msgs =
            ((InternalEObject) newAffinePlacement)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.REF_LOCATION_TYPE__AFFINE_PLACEMENT,
                    null,
