 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiLineStringTypeImpl#getLineStringMember <em>Line String
 *       Member</em>}
 * </ul>
 *
 * @generated
 */
public class MultiLineStringTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiLineStringType {
  /**
   * The cached value of the '{@link #getLineStringMember() <em>Line String Member</em>}'
  ...
  public EList<LineStringPropertyType> getLineStringMember() {
    if (lineStringMember == null) {
      lineStringMember =
          new EObjectContainmentEList<LineStringPropertyType>(
              LineStringPropertyType.class,
              this,
              Gml311Package.MULTI_LINE_STRING_TYPE__LINE_STRING_MEMBER);
    }
