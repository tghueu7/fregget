 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ConcatenatedOperationTypeImpl#getUsesSingleOperation
 *       <em>Uses Single Operation</em>}
 * </ul>
 *
 * @generated
 */
public class ConcatenatedOperationTypeImpl extends AbstractCoordinateOperationTypeImpl
    implements ConcatenatedOperationType {
  /**
   * The cached value of the '{@link #getUsesSingleOperation() <em>Uses Single Operation</em>}'
  ...
  public EList<SingleOperationRefType> getUsesSingleOperation() {
    if (usesSingleOperation == null) {
      usesSingleOperation =
          new EObjectContainmentEList<SingleOperationRefType>(
              SingleOperationRefType.class,
              this,
              Gml311Package.CONCATENATED_OPERATION_TYPE__USES_SINGLE_OPERATION);
    }
