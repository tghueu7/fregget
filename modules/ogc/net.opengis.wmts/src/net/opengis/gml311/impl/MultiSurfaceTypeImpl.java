 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiSurfaceTypeImpl#getSurfaceMember <em>Surface
 *       Member</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiSurfaceTypeImpl#getSurfaceMembers <em>Surface
 *       Members</em>}
 * </ul>
 *
 * @generated
 */
public class MultiSurfaceTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiSurfaceType {
  /**
   * The cached value of the '{@link #getSurfaceMember() <em>Surface Member</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSurfaceMembers() <em>Surface Members</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<SurfacePropertyType> getSurfaceMember() {
    if (surfaceMember == null) {
      surfaceMember =
          new EObjectContainmentEList<SurfacePropertyType>(
              SurfacePropertyType.class, this, Gml311Package.MULTI_SURFACE_TYPE__SURFACE_MEMBER);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_SURFACE_TYPE__SURFACE_MEMBERS,
              oldSurfaceMembers,
              newSurfaceMembers);
  ...
  public void setSurfaceMembers(SurfaceArrayPropertyType newSurfaceMembers) {
    if (newSurfaceMembers != surfaceMembers) {
      ...
      if (surfaceMembers != null)
        msgs =
            ((InternalEObject) surfaceMembers)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_SURFACE_TYPE__SURFACE_MEMBERS,
                    null,
                    msgs);
      if (newSurfaceMembers != null)
        msgs =
            ((InternalEObject) newSurfaceMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_SURFACE_TYPE__SURFACE_MEMBERS,
                    null,
