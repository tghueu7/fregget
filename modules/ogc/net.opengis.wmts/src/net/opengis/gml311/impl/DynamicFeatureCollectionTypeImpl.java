 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureCollectionTypeImpl#getValidTime <em>Valid
 *       Time</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureCollectionTypeImpl#getHistoryGroup <em>History
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureCollectionTypeImpl#getHistory
 *       <em>History</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureCollectionTypeImpl#getDataSource <em>Data
 *       Source</em>}
 * </ul>
 *
 * @generated
 */
public class DynamicFeatureCollectionTypeImpl extends FeatureCollectionTypeImpl
    implements DynamicFeatureCollectionType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DYNAMIC_FEATURE_COLLECTION_TYPE__VALID_TIME,
              oldValidTime,
              newValidTime);
  ...
  public FeatureMap getHistoryGroup() {
    if (historyGroup == null) {
      historyGroup =
          new BasicFeatureMap(this, Gml311Package.DYNAMIC_FEATURE_COLLECTION_TYPE__HISTORY_GROUP);
    }
    return historyGroup;
  }
  ...
  public HistoryPropertyType getHistory() {
    return (HistoryPropertyType)
        getHistoryGroup()
            .get(Gml311Package.eINSTANCE.getDynamicFeatureCollectionType_History(), true);
  }
  ...
  public NotificationChain basicSetHistory(HistoryPropertyType newHistory, NotificationChain msgs) {
    return ((FeatureMap.Internal) getHistoryGroup())
        .basicAdd(
            Gml311Package.eINSTANCE.getDynamicFeatureCollectionType_History(), newHistory, msgs);
  }
  ...
  public void setHistory(HistoryPropertyType newHistory) {
    ((FeatureMap.Internal) getHistoryGroup())
        .set(Gml311Package.eINSTANCE.getDynamicFeatureCollectionType_History(), newHistory);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DYNAMIC_FEATURE_COLLECTION_TYPE__DATA_SOURCE,
              oldDataSource,
              newDataSource);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
