 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.VectorTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.VectorTypeImpl#getAxisLabels <em>Axis Labels</em>}
 *   <li>{@link net.opengis.gml311.impl.VectorTypeImpl#getSrsDimension <em>Srs Dimension</em>}
 *   <li>{@link net.opengis.gml311.impl.VectorTypeImpl#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.impl.VectorTypeImpl#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
 * @generated
 */
public class VectorTypeImpl extends MinimalEObjectImpl.Container implements VectorType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.VECTOR_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VECTOR_TYPE__AXIS_LABELS,
              oldAxisLabels,
              axisLabels));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VECTOR_TYPE__SRS_DIMENSION,
              oldSrsDimension,
              srsDimension));
  }
  ...
  public void setSrsName(String newSrsName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.VECTOR_TYPE__SRS_NAME, oldSrsName, srsName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VECTOR_TYPE__UOM_LABELS,
              oldUomLabels,
              uomLabels));
  }
