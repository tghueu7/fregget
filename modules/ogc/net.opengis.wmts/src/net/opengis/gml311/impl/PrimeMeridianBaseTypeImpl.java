 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PrimeMeridianBaseTypeImpl#getMeridianName <em>Meridian
 *       Name</em>}
 * </ul>
 *
 * @generated
 */
public abstract class PrimeMeridianBaseTypeImpl extends DefinitionTypeImpl
    implements PrimeMeridianBaseType {
  /**
   * The cached value of the '{@link #getMeridianName() <em>Meridian Name</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PRIME_MERIDIAN_BASE_TYPE__MERIDIAN_NAME,
              oldMeridianName,
              newMeridianName);
  ...
  public void setMeridianName(CodeType newMeridianName) {
    if (newMeridianName != meridianName) {
      ...
      if (meridianName != null)
        msgs =
            ((InternalEObject) meridianName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PRIME_MERIDIAN_BASE_TYPE__MERIDIAN_NAME,
                    null,
                    msgs);
      if (newMeridianName != null)
        msgs =
            ((InternalEObject) newMeridianName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PRIME_MERIDIAN_BASE_TYPE__MERIDIAN_NAME,
                    null,
