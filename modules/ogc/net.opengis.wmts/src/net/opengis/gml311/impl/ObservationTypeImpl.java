 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ObservationTypeImpl#getValidTime <em>Valid Time</em>}
 *   <li>{@link net.opengis.gml311.impl.ObservationTypeImpl#getUsing <em>Using</em>}
 *   <li>{@link net.opengis.gml311.impl.ObservationTypeImpl#getTargetGroup <em>Target Group</em>}
 *   <li>{@link net.opengis.gml311.impl.ObservationTypeImpl#getTarget <em>Target</em>}
 *   <li>{@link net.opengis.gml311.impl.ObservationTypeImpl#getResultOf <em>Result Of</em>}
 * </ul>
 *
 * @generated
 */
public class ObservationTypeImpl extends AbstractFeatureTypeImpl implements ObservationType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OBSERVATION_TYPE__VALID_TIME,
              oldValidTime,
              newValidTime);
  ...
  public void setValidTime(TimePrimitivePropertyType newValidTime) {
    if (newValidTime != validTime) {
      ...
      if (validTime != null)
        msgs =
            ((InternalEObject) validTime)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__VALID_TIME,
                    null,
                    msgs);
      if (newValidTime != null)
        msgs =
            ((InternalEObject) newValidTime)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__VALID_TIME,
                    null,
  ...
  public NotificationChain basicSetUsing(FeaturePropertyType newUsing, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.OBSERVATION_TYPE__USING, oldUsing, newUsing);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setUsing(FeaturePropertyType newUsing) {
    if (newUsing != using) {
      ...
      if (using != null)
        msgs =
            ((InternalEObject) using)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__USING,
                    null,
                    msgs);
      if (newUsing != null)
        msgs =
            ((InternalEObject) newUsing)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__USING,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.OBSERVATION_TYPE__USING, newUsing, newUsing));
  }
  ...
  public TargetPropertyType getTarget() {
    return (TargetPropertyType)
        getTargetGroup().get(Gml311Package.eINSTANCE.getObservationType_Target(), true);
  }
  ...
  public NotificationChain basicSetTarget(TargetPropertyType newTarget, NotificationChain msgs) {
    return ((FeatureMap.Internal) getTargetGroup())
        .basicAdd(Gml311Package.eINSTANCE.getObservationType_Target(), newTarget, msgs);
  }
  ...
  public void setTarget(TargetPropertyType newTarget) {
    ((FeatureMap.Internal) getTargetGroup())
        .set(Gml311Package.eINSTANCE.getObservationType_Target(), newTarget);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OBSERVATION_TYPE__RESULT_OF,
              oldResultOf,
              newResultOf);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setResultOf(AssociationType newResultOf) {
    if (newResultOf != resultOf) {
      ...
      if (resultOf != null)
        msgs =
            ((InternalEObject) resultOf)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__RESULT_OF,
                    null,
                    msgs);
      if (newResultOf != null)
        msgs =
            ((InternalEObject) newResultOf)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OBSERVATION_TYPE__RESULT_OF,
                    null,
