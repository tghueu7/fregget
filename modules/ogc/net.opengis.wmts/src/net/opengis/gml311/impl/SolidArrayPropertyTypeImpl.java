 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SolidArrayPropertyTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.SolidArrayPropertyTypeImpl#getSolidGroup <em>Solid
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.SolidArrayPropertyTypeImpl#getSolid <em>Solid</em>}
 * </ul>
 *
 * @generated
 */
public class SolidArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements SolidArrayPropertyType {
  /**
  ...
  public FeatureMap getSolidGroup() {
    return (FeatureMap)
        getGroup()
            .<FeatureMap.Entry>list(Gml311Package.eINSTANCE.getSolidArrayPropertyType_SolidGroup());
  }
