 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ParameterValueGroupTypeImpl#getIncludesValue <em>Includes
 *       Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueGroupTypeImpl#getValuesOfGroup <em>Values Of
 *       Group</em>}
 * </ul>
 *
 * @generated
 */
public class ParameterValueGroupTypeImpl extends AbstractGeneralParameterValueTypeImpl
    implements ParameterValueGroupType {
  /**
   * The cached value of the '{@link #getIncludesValue() <em>Includes Value</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getValuesOfGroup() <em>Values Of Group</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<AbstractGeneralParameterValueType> getIncludesValue() {
    if (includesValue == null) {
      includesValue =
          new EObjectContainmentEList<AbstractGeneralParameterValueType>(
              AbstractGeneralParameterValueType.class,
              this,
              Gml311Package.PARAMETER_VALUE_GROUP_TYPE__INCLUDES_VALUE);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_GROUP_TYPE__VALUES_OF_GROUP,
              oldValuesOfGroup,
              newValuesOfGroup);
  ...
  public void setValuesOfGroup(OperationParameterGroupRefType newValuesOfGroup) {
    if (newValuesOfGroup != valuesOfGroup) {
      ...
      if (newValuesOfGroup != null)
        msgs =
            ((InternalEObject) newValuesOfGroup)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.PARAMETER_VALUE_GROUP_TYPE__VALUES_OF_GROUP,
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case Gml311Package.PARAMETER_VALUE_GROUP_TYPE__INCLUDES_VALUE:
        ...
        getIncludesValue()
            .addAll((Collection<? extends AbstractGeneralParameterValueType>) newValue);
        return;
      case Gml311Package.PARAMETER_VALUE_GROUP_TYPE__VALUES_OF_GROUP:
