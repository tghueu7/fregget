 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GridTypeImpl#getLimits <em>Limits</em>}
 *   <li>{@link net.opengis.gml311.impl.GridTypeImpl#getAxisName <em>Axis Name</em>}
 *   <li>{@link net.opengis.gml311.impl.GridTypeImpl#getDimension <em>Dimension</em>}
 * </ul>
 *
 * @generated
 */
public class GridTypeImpl extends AbstractGeometryTypeImpl implements GridType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GRID_TYPE__LIMITS, oldLimits, newLimits);
  ...
  public void setLimits(GridLimitsType newLimits) {
    if (newLimits != limits) {
      ...
      if (limits != null)
        msgs =
            ((InternalEObject) limits)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_TYPE__LIMITS, null, msgs);
      if (newLimits != null)
        msgs =
            ((InternalEObject) newLimits)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_TYPE__LIMITS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GRID_TYPE__LIMITS, newLimits, newLimits));
  }
  ...
  public void setDimension(BigInteger newDimension) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GRID_TYPE__DIMENSION, oldDimension, dimension));
  }
