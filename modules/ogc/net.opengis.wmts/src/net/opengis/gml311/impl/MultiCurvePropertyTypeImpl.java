 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getMultiCurve <em>Multi
 *       Curve</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiCurvePropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class MultiCurvePropertyTypeImpl extends MinimalEObjectImpl.Container
    implements MultiCurvePropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__MULTI_CURVE,
              oldMultiCurve,
              newMultiCurve);
  ...
  public void setMultiCurve(MultiCurveType newMultiCurve) {
    if (newMultiCurve != multiCurve) {
      ...
      if (multiCurve != null)
        msgs =
            ((InternalEObject) multiCurve)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_CURVE_PROPERTY_TYPE__MULTI_CURVE,
                    null,
                    msgs);
      if (newMultiCurve != null)
        msgs =
            ((InternalEObject) newMultiCurve)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_CURVE_PROPERTY_TYPE__MULTI_CURVE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__HREF,
              oldHref,
              href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__ROLE,
              oldRole,
              role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
