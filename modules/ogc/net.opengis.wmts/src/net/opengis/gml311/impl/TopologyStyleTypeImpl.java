 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopologyStyleTypeImpl#getSymbol <em>Symbol</em>}
 *   <li>{@link net.opengis.gml311.impl.TopologyStyleTypeImpl#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.impl.TopologyStyleTypeImpl#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.impl.TopologyStyleTypeImpl#getTopologyProperty <em>Topology
 *       Property</em>}
 *   <li>{@link net.opengis.gml311.impl.TopologyStyleTypeImpl#getTopologyType <em>Topology
 *       Type</em>}
 * </ul>
 *
 * @generated
 */
public class TopologyStyleTypeImpl extends BaseStyleDescriptorTypeImpl
    implements TopologyStyleType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPOLOGY_STYLE_TYPE__SYMBOL,
              oldSymbol,
              newSymbol);
  ...
  public void setSymbol(SymbolType newSymbol) {
    if (newSymbol != symbol) {
      ...
      if (symbol != null)
        msgs =
            ((InternalEObject) symbol)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPOLOGY_STYLE_TYPE__SYMBOL,
                    null,
                    msgs);
      if (newSymbol != null)
        msgs =
            ((InternalEObject) newSymbol)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPOLOGY_STYLE_TYPE__SYMBOL,
                    null,
  ...
  public void setStyle(String newStyle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TOPOLOGY_STYLE_TYPE__STYLE, oldStyle, style));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPOLOGY_STYLE_TYPE__LABEL_STYLE,
              oldLabelStyle,
              newLabelStyle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (labelStyle != null)
        msgs =
            ((InternalEObject) labelStyle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPOLOGY_STYLE_TYPE__LABEL_STYLE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPOLOGY_STYLE_TYPE__TOPOLOGY_PROPERTY,
              oldTopologyProperty,
              topologyProperty));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPOLOGY_STYLE_TYPE__TOPOLOGY_TYPE,
              oldTopologyType,
              topologyType));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.TOPOLOGY_STYLE_TYPE__TOPOLOGY_PROPERTY:
        return TOPOLOGY_PROPERTY_EDEFAULT == null
            ? topologyProperty != null
            : !TOPOLOGY_PROPERTY_EDEFAULT.equals(topologyProperty);
      case Gml311Package.TOPOLOGY_STYLE_TYPE__TOPOLOGY_TYPE:
        return TOPOLOGY_TYPE_EDEFAULT == null
            ? topologyType != null
            : !TOPOLOGY_TYPE_EDEFAULT.equals(topologyType);
    }
