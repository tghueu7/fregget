 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractTimeReferenceSystemTypeImpl#getDomainOfValidity
 *       <em>Domain Of Validity</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTimeReferenceSystemTypeImpl extends DefinitionTypeImpl
    implements AbstractTimeReferenceSystemType {
  /**
   * The default value of the '{@link #getDomainOfValidity() <em>Domain Of Validity</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_TIME_REFERENCE_SYSTEM_TYPE__DOMAIN_OF_VALIDITY,
              oldDomainOfValidity,
              domainOfValidity));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Gml311Package.ABSTRACT_TIME_REFERENCE_SYSTEM_TYPE__DOMAIN_OF_VALIDITY:
        return DOMAIN_OF_VALIDITY_EDEFAULT == null
            ? domainOfValidity != null
            : !DOMAIN_OF_VALIDITY_EDEFAULT.equals(domainOfValidity);
    }
