 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#isPlanar <em>Planar</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#isDirected <em>Directed</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#isGrid <em>Grid</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getMinDistance <em>Min Distance</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getMinAngle <em>Min Angle</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getGraphType <em>Graph Type</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getDrawingType <em>Drawing Type</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getLineType <em>Line Type</em>}
 *   <li>{@link net.opengis.gml311.impl.GraphStyleTypeImpl#getAestheticCriteria <em>Aesthetic
 *       Criteria</em>}
 * </ul>
 *
 * @generated
...
public class GraphStyleTypeImpl extends BaseStyleDescriptorTypeImpl implements GraphStyleType {
  ...
  /**
   * The cached value of the '{@link #getAestheticCriteria() <em>Aesthetic Criteria</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__PLANAR,
              oldPlanar,
              planar,
              !oldPlanarESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__DIRECTED,
              oldDirected,
              directed,
              !oldDirectedESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__GRID,
              oldGrid,
              grid,
              !oldGridESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__MIN_DISTANCE,
              oldMinDistance,
              minDistance,
              !oldMinDistanceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__MIN_ANGLE,
              oldMinAngle,
              minAngle,
              !oldMinAngleESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__GRAPH_TYPE,
              oldGraphType,
              graphType,
              !oldGraphTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__DRAWING_TYPE,
              oldDrawingType,
              drawingType,
              !oldDrawingTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRAPH_STYLE_TYPE__LINE_TYPE,
              oldLineType,
              lineType,
              !oldLineTypeESet));
  }
  ...
  public EList<AesheticCriteriaType> getAestheticCriteria() {
    if (aestheticCriteria == null) {
      aestheticCriteria =
          new EDataTypeEList<AesheticCriteriaType>(
              AesheticCriteriaType.class, this, Gml311Package.GRAPH_STYLE_TYPE__AESTHETIC_CRITERIA);
    }
  ...
  public String toString() {
    ...
    if (planarESet) result.append(planar);
    else result.append("<unset>");
    result.append(", directed: ");
    if (directedESet) result.append(directed);
    else result.append("<unset>");
    result.append(", grid: ");
    if (gridESet) result.append(grid);
    else result.append("<unset>");
    result.append(", minDistance: ");
    if (minDistanceESet) result.append(minDistance);
    else result.append("<unset>");
    result.append(", minAngle: ");
    if (minAngleESet) result.append(minAngle);
    else result.append("<unset>");
    result.append(", graphType: ");
    if (graphTypeESet) result.append(graphType);
    else result.append("<unset>");
    result.append(", drawingType: ");
    if (drawingTypeESet) result.append(drawingType);
    else result.append("<unset>");
    result.append(", lineType: ");
    if (lineTypeESet) result.append(lineType);
    else result.append("<unset>");
