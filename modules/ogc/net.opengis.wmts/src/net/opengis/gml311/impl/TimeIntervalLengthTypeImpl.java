 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeIntervalLengthTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeIntervalLengthTypeImpl#getFactor <em>Factor</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeIntervalLengthTypeImpl#getRadix <em>Radix</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeIntervalLengthTypeImpl#getUnit <em>Unit</em>}
 * </ul>
 *
 * @generated
 */
public class TimeIntervalLengthTypeImpl extends MinimalEObjectImpl.Container
    implements TimeIntervalLengthType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_INTERVAL_LENGTH_TYPE__VALUE,
              oldValue,
              value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_INTERVAL_LENGTH_TYPE__FACTOR,
              oldFactor,
              factor));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_INTERVAL_LENGTH_TYPE__RADIX,
              oldRadix,
              radix));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_INTERVAL_LENGTH_TYPE__UNIT,
              oldUnit,
              unit));
  }
