 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ControlPointTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.ControlPointTypeImpl#getGeometricPositionGroup <em>Geometric
 *       Position Group</em>}
 *   <li>{@link net.opengis.gml311.impl.ControlPointTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.ControlPointTypeImpl#getPointProperty <em>Point
 *       Property</em>}
 * </ul>
 *
 * @generated
...
public class ControlPointTypeImpl extends MinimalEObjectImpl.Container implements ControlPointType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTROL_POINT_TYPE__POS_LIST,
              oldPosList,
              newPosList);
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CONTROL_POINT_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
  ...
  public FeatureMap getGeometricPositionGroup() {
    if (geometricPositionGroup == null) {
      geometricPositionGroup =
          new BasicFeatureMap(this, Gml311Package.CONTROL_POINT_TYPE__GEOMETRIC_POSITION_GROUP);
    }
  ...
  public EList<PointPropertyType> getPointProperty() {
    return getGeometricPositionGroup()
        .list(Gml311Package.eINSTANCE.getControlPointType_PointProperty());
  }
