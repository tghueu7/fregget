 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ClothoidTypeImpl#getRefLocation <em>Ref Location</em>}
 *   <li>{@link net.opengis.gml311.impl.ClothoidTypeImpl#getScaleFactor <em>Scale Factor</em>}
 *   <li>{@link net.opengis.gml311.impl.ClothoidTypeImpl#getStartParameter <em>Start Parameter</em>}
 *   <li>{@link net.opengis.gml311.impl.ClothoidTypeImpl#getEndParameter <em>End Parameter</em>}
 * </ul>
 *
 * @generated
 */
public class ClothoidTypeImpl extends AbstractCurveSegmentTypeImpl implements ClothoidType {
  /**
   * The cached value of the '{@link #getRefLocation() <em>Ref Location</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetRefLocation(
      RefLocationType newRefLocation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CLOTHOID_TYPE__REF_LOCATION,
              oldRefLocation,
              newRefLocation);
  ...
  public void setRefLocation(RefLocationType newRefLocation) {
    if (newRefLocation != refLocation) {
      ...
      if (refLocation != null)
        msgs =
            ((InternalEObject) refLocation)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CLOTHOID_TYPE__REF_LOCATION,
                    null,
                    msgs);
      if (newRefLocation != null)
        msgs =
            ((InternalEObject) newRefLocation)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CLOTHOID_TYPE__REF_LOCATION,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CLOTHOID_TYPE__SCALE_FACTOR,
              oldScaleFactor,
              scaleFactor));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CLOTHOID_TYPE__START_PARAMETER,
              oldStartParameter,
              startParameter,
              !oldStartParameterESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CLOTHOID_TYPE__END_PARAMETER,
              oldEndParameter,
              endParameter,
              !oldEndParameterESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.CLOTHOID_TYPE__SCALE_FACTOR:
        return SCALE_FACTOR_EDEFAULT == null
            ? scaleFactor != null
            : !SCALE_FACTOR_EDEFAULT.equals(scaleFactor);
      case Gml311Package.CLOTHOID_TYPE__START_PARAMETER:
  ...
  public String toString() {
    ...
    if (startParameterESet) result.append(startParameter);
    else result.append("<unset>");
    result.append(", endParameter: ");
    if (endParameterESet) result.append(endParameter);
    else result.append("<unset>");
    result.append(')');
