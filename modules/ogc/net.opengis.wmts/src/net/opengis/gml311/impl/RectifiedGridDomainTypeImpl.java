 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RectifiedGridDomainTypeImpl#getRectifiedGrid <em>Rectified
 *       Grid</em>}
 * </ul>
 *
 * @generated
 */
public class RectifiedGridDomainTypeImpl extends DomainSetTypeImpl
    implements RectifiedGridDomainType {
  /**
   * The cached value of the '{@link #getRectifiedGrid() <em>Rectified Grid</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.RECTIFIED_GRID_DOMAIN_TYPE__RECTIFIED_GRID,
              oldRectifiedGrid,
              newRectifiedGrid);
  ...
  public void setRectifiedGrid(RectifiedGridType newRectifiedGrid) {
    if (newRectifiedGrid != rectifiedGrid) {
      ...
      if (newRectifiedGrid != null)
        msgs =
            ((InternalEObject) newRectifiedGrid)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.RECTIFIED_GRID_DOMAIN_TYPE__RECTIFIED_GRID,
