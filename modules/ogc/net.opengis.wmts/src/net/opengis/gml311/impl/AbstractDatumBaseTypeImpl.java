 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumBaseTypeImpl#getDatumName <em>Datum Name</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractDatumBaseTypeImpl extends DefinitionTypeImpl
    implements AbstractDatumBaseType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_DATUM_BASE_TYPE__DATUM_NAME,
              oldDatumName,
              newDatumName);
  ...
  public void setDatumName(CodeType newDatumName) {
    if (newDatumName != datumName) {
      ...
      if (datumName != null)
        msgs =
            ((InternalEObject) datumName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_BASE_TYPE__DATUM_NAME,
                    null,
                    msgs);
      if (newDatumName != null)
        msgs =
            ((InternalEObject) newDatumName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_BASE_TYPE__DATUM_NAME,
                    null,
