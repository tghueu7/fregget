 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractPositionalAccuracyTypeImpl#getMeasureDescription
 *       <em>Measure Description</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractPositionalAccuracyTypeImpl extends MinimalEObjectImpl.Container
    implements AbstractPositionalAccuracyType {
  /**
   * The cached value of the '{@link #getMeasureDescription() <em>Measure Description</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_POSITIONAL_ACCURACY_TYPE__MEASURE_DESCRIPTION,
              oldMeasureDescription,
  ...
  public void setMeasureDescription(CodeType newMeasureDescription) {
    if (newMeasureDescription != measureDescription) {
      ...
      if (measureDescription != null)
        msgs =
            ((InternalEObject) measureDescription)
                .eInverseRemove(
                    this,
      ...
      if (newMeasureDescription != null)
        msgs =
            ((InternalEObject) newMeasureDescription)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ABSTRACT_POSITIONAL_ACCURACY_TYPE__MEASURE_DESCRIPTION,
