 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DirectedObservationTypeImpl#getDirection <em>Direction</em>}
 * </ul>
 *
 * @generated
 */
public class DirectedObservationTypeImpl extends ObservationTypeImpl
    implements DirectedObservationType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_OBSERVATION_TYPE__DIRECTION,
              oldDirection,
              newDirection);
  ...
  public void setDirection(DirectionPropertyType newDirection) {
    if (newDirection != direction) {
      ...
      if (direction != null)
        msgs =
            ((InternalEObject) direction)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTED_OBSERVATION_TYPE__DIRECTION,
                    null,
                    msgs);
      if (newDirection != null)
        msgs =
            ((InternalEObject) newDirection)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTED_OBSERVATION_TYPE__DIRECTION,
                    null,
