 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeClockTypeImpl#getReferenceEvent <em>Reference
 *       Event</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeClockTypeImpl#getReferenceTime <em>Reference Time</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeClockTypeImpl#getUtcReference <em>Utc Reference</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeClockTypeImpl#getDateBasis <em>Date Basis</em>}
 * </ul>
 *
 * @generated
 */
public class TimeClockTypeImpl extends AbstractTimeReferenceSystemTypeImpl
    implements TimeClockType {
  /**
  ...
  /**
   * The cached value of the '{@link #getDateBasis() <em>Date Basis</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CLOCK_TYPE__REFERENCE_EVENT,
              oldReferenceEvent,
              newReferenceEvent);
      ...
      if (referenceEvent != null)
        msgs =
            ((InternalEObject) referenceEvent)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_CLOCK_TYPE__REFERENCE_EVENT,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CLOCK_TYPE__REFERENCE_TIME,
              oldReferenceTime,
              referenceTime));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CLOCK_TYPE__UTC_REFERENCE,
              oldUtcReference,
              utcReference));
  }
  ...
  public EList<TimeCalendarPropertyType> getDateBasis() {
    if (dateBasis == null) {
      dateBasis =
          new EObjectContainmentEList<TimeCalendarPropertyType>(
              TimeCalendarPropertyType.class, this, Gml311Package.TIME_CLOCK_TYPE__DATE_BASIS);
    }
    return dateBasis;
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.TIME_CLOCK_TYPE__REFERENCE_TIME:
        return REFERENCE_TIME_EDEFAULT == null
            ? referenceTime != null
            : !REFERENCE_TIME_EDEFAULT.equals(referenceTime);
      case Gml311Package.TIME_CLOCK_TYPE__UTC_REFERENCE:
        return UTC_REFERENCE_EDEFAULT == null
            ? utcReference != null
            : !UTC_REFERENCE_EDEFAULT.equals(utcReference);
      case Gml311Package.TIME_CLOCK_TYPE__DATE_BASIS:
