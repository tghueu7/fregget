 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getGeometryGroup <em>Geometry
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getGeometry <em>Geometry</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getLocationKeyWord <em>Location Key
 *       Word</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getLocationString <em>Location
 *       String</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getNull <em>Null</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.LocationPropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class LocationPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements LocationPropertyType {
  /**
  ...
  /**
   * The cached value of the '{@link #getLocationKeyWord() <em>Location Key Word</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getLocationString() <em>Location String</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getGeometryGroup() {
    if (geometryGroup == null) {
      geometryGroup =
          new BasicFeatureMap(this, Gml311Package.LOCATION_PROPERTY_TYPE__GEOMETRY_GROUP);
    }
  ...
  public AbstractGeometryType getGeometry() {
    return (AbstractGeometryType)
        getGeometryGroup().get(Gml311Package.eINSTANCE.getLocationPropertyType_Geometry(), true);
  }
  ...
  public NotificationChain basicSetGeometry(
    ...
    return ((FeatureMap.Internal) getGeometryGroup())
        .basicAdd(Gml311Package.eINSTANCE.getLocationPropertyType_Geometry(), newGeometry, msgs);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__LOCATION_KEY_WORD,
              oldLocationKeyWord,
              newLocationKeyWord);
  ...
  public void setLocationKeyWord(CodeType newLocationKeyWord) {
    if (newLocationKeyWord != locationKeyWord) {
      ...
      if (locationKeyWord != null)
        msgs =
            ((InternalEObject) locationKeyWord)
                .eInverseRemove(
                    this,
      ...
      if (newLocationKeyWord != null)
        msgs =
            ((InternalEObject) newLocationKeyWord)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.LOCATION_PROPERTY_TYPE__LOCATION_KEY_WORD,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__LOCATION_STRING,
              oldLocationString,
              newLocationString);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setLocationString(StringOrRefType newLocationString) {
    if (newLocationString != locationString) {
      ...
      if (locationString != null)
        msgs =
            ((InternalEObject) locationString)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LOCATION_PROPERTY_TYPE__LOCATION_STRING,
                    null,
                    msgs);
      if (newLocationString != null)
        msgs =
            ((InternalEObject) newLocationString)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LOCATION_PROPERTY_TYPE__LOCATION_STRING,
                    null,
  ...
  public void setNull(Object newNull) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LOCATION_PROPERTY_TYPE__NULL, oldNull, null_));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LOCATION_PROPERTY_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LOCATION_PROPERTY_TYPE__ROLE, oldRole, role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LOCATION_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
