 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeEdgeTypeImpl#getStart <em>Start</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeEdgeTypeImpl#getEnd <em>End</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeEdgeTypeImpl#getExtent <em>Extent</em>}
 * </ul>
 *
 * @generated
 */
public class TimeEdgeTypeImpl extends AbstractTimeTopologyPrimitiveTypeImpl
    implements TimeEdgeType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__START, oldStart, newStart);
  ...
  public void setStart(TimeNodePropertyType newStart) {
    if (newStart != start) {
      ...
      if (start != null)
        msgs =
            ((InternalEObject) start)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_EDGE_TYPE__START, null, msgs);
      if (newStart != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__START, newStart, newStart));
  }
  ...
  public NotificationChain basicSetEnd(TimeNodePropertyType newEnd, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__END, oldEnd, newEnd);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newEnd != end) {
      ...
      if (end != null)
        msgs =
            ((InternalEObject) end)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_EDGE_TYPE__END, null, msgs);
      if (newEnd != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__END, newEnd, newEnd));
  }
  ...
  public NotificationChain basicSetExtent(
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__EXTENT, oldExtent, newExtent);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setExtent(TimePeriodPropertyType newExtent) {
    if (newExtent != extent) {
      ...
      if (extent != null)
        msgs =
            ((InternalEObject) extent)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_EDGE_TYPE__EXTENT,
                    null,
                    msgs);
      if (newExtent != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_EDGE_TYPE__EXTENT, newExtent, newExtent));
  }
