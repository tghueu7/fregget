 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeCalendarTypeImpl#getReferenceFrame <em>Reference
 *       Frame</em>}
 * </ul>
 *
 * @generated
 */
public class TimeCalendarTypeImpl extends AbstractTimeReferenceSystemTypeImpl
    implements TimeCalendarType {
  /**
   * The cached value of the '{@link #getReferenceFrame() <em>Reference Frame</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TimeCalendarEraPropertyType> getReferenceFrame() {
    if (referenceFrame == null) {
      referenceFrame =
          new EObjectContainmentEList<TimeCalendarEraPropertyType>(
              TimeCalendarEraPropertyType.class,
              this,
              Gml311Package.TIME_CALENDAR_TYPE__REFERENCE_FRAME);
    }
