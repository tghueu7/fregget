 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractRingPropertyTypeImpl#getRingGroup <em>Ring
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractRingPropertyTypeImpl#getRing <em>Ring</em>}
 * </ul>
 *
 * @generated
 */
public class AbstractRingPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements AbstractRingPropertyType {
  /**
  ...
  public AbstractRingType getRing() {
    return (AbstractRingType)
        getRingGroup().get(Gml311Package.eINSTANCE.getAbstractRingPropertyType_Ring(), true);
  }
  ...
  public NotificationChain basicSetRing(AbstractRingType newRing, NotificationChain msgs) {
    return ((FeatureMap.Internal) getRingGroup())
        .basicAdd(Gml311Package.eINSTANCE.getAbstractRingPropertyType_Ring(), newRing, msgs);
  }
