 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PolygonTypeImpl#getExteriorGroup <em>Exterior Group</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonTypeImpl#getInteriorGroup <em>Interior Group</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonTypeImpl#getInterior <em>Interior</em>}
 * </ul>
 *
 * @generated
 */
public class PolygonTypeImpl extends AbstractSurfaceTypeImpl implements PolygonType {
  ...
  public AbstractRingPropertyType getExterior() {
    return (AbstractRingPropertyType)
        getExteriorGroup().get(Gml311Package.eINSTANCE.getPolygonType_Exterior(), true);
  }
  ...
  public NotificationChain basicSetExterior(
    ...
    return ((FeatureMap.Internal) getExteriorGroup())
        .basicAdd(Gml311Package.eINSTANCE.getPolygonType_Exterior(), newExterior, msgs);
  }
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    ((FeatureMap.Internal) getExteriorGroup())
        .set(Gml311Package.eINSTANCE.getPolygonType_Exterior(), newExterior);
  }
