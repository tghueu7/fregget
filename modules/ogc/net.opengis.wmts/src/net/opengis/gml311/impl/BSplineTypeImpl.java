 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getPointProperty <em>Point Property</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getDegree <em>Degree</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getKnot <em>Knot</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getInterpolation <em>Interpolation</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#isIsPolynomial <em>Is Polynomial</em>}
 *   <li>{@link net.opengis.gml311.impl.BSplineTypeImpl#getKnotType <em>Knot Type</em>}
 * </ul>
 *
 * @generated
 */
public class BSplineTypeImpl extends AbstractCurveSegmentTypeImpl implements BSplineType {
  ...
  protected static final CurveInterpolationType INTERPOLATION_EDEFAULT =
      CurveInterpolationType.POLYNOMIAL_SPLINE;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.BSPLINE_TYPE__POS_LIST, oldPosList, newPosList);
    ...
    if (newPosList != posList) {
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.BSPLINE_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BSPLINE_TYPE__POS_LIST,
              newPosList,
              newPosList));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BSPLINE_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.BSPLINE_TYPE__COORDINATES,
                    null,
                    msgs);
  ...
  public void setDegree(BigInteger newDegree) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.BSPLINE_TYPE__DEGREE, oldDegree, degree));
  }
  ...
  public EList<KnotPropertyType> getKnot() {
    if (knot == null) {
      knot =
          new EObjectContainmentEList<KnotPropertyType>(
              KnotPropertyType.class, this, Gml311Package.BSPLINE_TYPE__KNOT);
    }
    return knot;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BSPLINE_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BSPLINE_TYPE__IS_POLYNOMIAL,
              oldIsPolynomial,
              isPolynomial,
              !oldIsPolynomialESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BSPLINE_TYPE__KNOT_TYPE,
              oldKnotType,
              knotType,
              !oldKnotTypeESet));
  }
  ...
  public String toString() {
    ...
    if (isPolynomialESet) result.append(isPolynomial);
    else result.append("<unset>");
    result.append(", knotType: ");
    if (knotTypeESet) result.append(knotType);
    else result.append("<unset>");
    result.append(')');
