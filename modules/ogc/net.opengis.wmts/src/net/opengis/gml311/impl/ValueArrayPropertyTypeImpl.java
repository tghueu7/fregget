 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getBoolean <em>Boolean</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCategory <em>Category</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getQuantity <em>Quantity</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCount <em>Count</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getBooleanList <em>Boolean
 *       List</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCategoryList <em>Category
 *       List</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getQuantityList <em>Quantity
 *       List</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCountList <em>Count List</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCategoryExtent <em>Category
 *       Extent</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getQuantityExtent <em>Quantity
 *       Extent</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCountExtent <em>Count
 *       Extent</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCompositeValueGroup
 *       <em>Composite Value Group</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getCompositeValue <em>Composite
 *       Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getObjectGroup <em>Object
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getObject <em>Object</em>}
 *   <li>{@link net.opengis.gml311.impl.ValueArrayPropertyTypeImpl#getNull <em>Null</em>}
 * </ul>
 *
 * @generated
 */
public class ValueArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements ValueArrayPropertyType {
  /**
    ...
    return (FeatureMap)
        getValue()
            .<FeatureMap.Entry>list(
                Gml311Package.eINSTANCE.getValueArrayPropertyType_CompositeValueGroup());
  }
  ...
  public EList<CompositeValueType> getCompositeValue() {
    return getCompositeValueGroup()
        .list(Gml311Package.eINSTANCE.getValueArrayPropertyType_CompositeValue());
  }
  ...
  public FeatureMap getObjectGroup() {
    return (FeatureMap)
        getValue()
            .<FeatureMap.Entry>list(
                Gml311Package.eINSTANCE.getValueArrayPropertyType_ObjectGroup());
  }
