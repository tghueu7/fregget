 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoCurvePropertyTypeImpl#getTopoCurve <em>Topo Curve</em>}
 * </ul>
 *
 * @generated
 */
public class TopoCurvePropertyTypeImpl extends MinimalEObjectImpl.Container
    implements TopoCurvePropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_CURVE_PROPERTY_TYPE__TOPO_CURVE,
              oldTopoCurve,
              newTopoCurve);
  ...
  public void setTopoCurve(TopoCurveType newTopoCurve) {
    if (newTopoCurve != topoCurve) {
      ...
      if (topoCurve != null)
        msgs =
            ((InternalEObject) topoCurve)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_CURVE_PROPERTY_TYPE__TOPO_CURVE,
                    null,
                    msgs);
      if (newTopoCurve != null)
        msgs =
            ((InternalEObject) newTopoCurve)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_CURVE_PROPERTY_TYPE__TOPO_CURVE,
                    null,
