 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PointTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.PointTypeImpl#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.PointTypeImpl#getCoord <em>Coord</em>}
 * </ul>
 *
 * @generated
 */
public class PointTypeImpl extends AbstractGeometricPrimitiveTypeImpl implements PointType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.POINT_TYPE__POS, oldPos, newPos);
    ...
    if (newPos != pos) {
      ...
      if (pos != null)
        msgs =
            ((InternalEObject) pos)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.POINT_TYPE__POS, null, msgs);
      if (newPos != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.POINT_TYPE__POS, newPos, newPos));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.POINT_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.POINT_TYPE__COORDINATES,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetCoord(CoordType newCoord, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.POINT_TYPE__COORD, oldCoord, newCoord);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setCoord(CoordType newCoord) {
    if (newCoord != coord) {
      ...
      if (coord != null)
        msgs =
            ((InternalEObject) coord)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.POINT_TYPE__COORD, null, msgs);
      if (newCoord != null)
        msgs =
            ((InternalEObject) newCoord)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.POINT_TYPE__COORD, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.POINT_TYPE__COORD, newCoord, newCoord));
  }
