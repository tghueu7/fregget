 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ImageDatumTypeImpl#getPixelInCell <em>Pixel In Cell</em>}
 * </ul>
 *
 * @generated
 */
public class ImageDatumTypeImpl extends AbstractDatumTypeImpl implements ImageDatumType {
  /**
   * The cached value of the '{@link #getPixelInCell() <em>Pixel In Cell</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.IMAGE_DATUM_TYPE__PIXEL_IN_CELL,
              oldPixelInCell,
              newPixelInCell);
  ...
  public void setPixelInCell(PixelInCellType newPixelInCell) {
    if (newPixelInCell != pixelInCell) {
      ...
      if (pixelInCell != null)
        msgs =
            ((InternalEObject) pixelInCell)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IMAGE_DATUM_TYPE__PIXEL_IN_CELL,
                    null,
                    msgs);
      if (newPixelInCell != null)
        msgs =
            ((InternalEObject) newPixelInCell)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IMAGE_DATUM_TYPE__PIXEL_IN_CELL,
                    null,
