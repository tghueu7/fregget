 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getGeocentricCRS <em>Geocentric
 *       CRS</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSRefTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class GeocentricCRSRefTypeImpl extends MinimalEObjectImpl.Container
    implements GeocentricCRSRefType {
  /**
   * The cached value of the '{@link #getGeocentricCRS() <em>Geocentric CRS</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__GEOCENTRIC_CRS,
              oldGeocentricCRS,
              newGeocentricCRS);
  ...
  public void setGeocentricCRS(GeocentricCRSType newGeocentricCRS) {
    if (newGeocentricCRS != geocentricCRS) {
      ...
      if (geocentricCRS != null)
        msgs =
            ((InternalEObject) geocentricCRS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_REF_TYPE__GEOCENTRIC_CRS,
                    null,
                    msgs);
      if (newGeocentricCRS != null)
        msgs =
            ((InternalEObject) newGeocentricCRS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_REF_TYPE__GEOCENTRIC_CRS,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GEOCENTRIC_CRS_REF_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GEOCENTRIC_CRS_REF_TYPE__ROLE, oldRole, role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_REF_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
