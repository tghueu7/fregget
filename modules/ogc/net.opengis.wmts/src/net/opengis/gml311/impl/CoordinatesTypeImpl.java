 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CoordinatesTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinatesTypeImpl#getCs <em>Cs</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinatesTypeImpl#getDecimal <em>Decimal</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinatesTypeImpl#getTs <em>Ts</em>}
 * </ul>
 *
 * @generated
 */
public class CoordinatesTypeImpl extends MinimalEObjectImpl.Container implements CoordinatesType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.COORDINATES_TYPE__VALUE, oldValue, value));
  }
  ...
  public void setCs(String newCs) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.COORDINATES_TYPE__CS, oldCs, cs, !oldCsESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.UNSET,
              Gml311Package.COORDINATES_TYPE__CS,
              oldCs,
              CS_EDEFAULT,
              oldCsESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATES_TYPE__DECIMAL,
              oldDecimal,
              decimal,
              !oldDecimalESet));
  }
  ...
  public void setTs(String newTs) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.COORDINATES_TYPE__TS, oldTs, ts, !oldTsESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.UNSET,
              Gml311Package.COORDINATES_TYPE__TS,
              oldTs,
              TS_EDEFAULT,
              oldTsESet));
  }
  ...
  public String toString() {
    ...
    result.append(value);
    result.append(", cs: ");
    if (csESet) result.append(cs);
    else result.append("<unset>");
    result.append(", decimal: ");
    if (decimalESet) result.append(decimal);
    else result.append("<unset>");
    result.append(", ts: ");
    if (tsESet) result.append(ts);
    else result.append("<unset>");
    result.append(')');
