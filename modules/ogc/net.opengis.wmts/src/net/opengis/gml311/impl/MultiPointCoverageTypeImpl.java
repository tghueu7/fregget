 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiPointCoverageTypeImpl#getMultiPointDomain <em>Multi
 *       Point Domain</em>}
 * </ul>
 *
 * @generated
 */
public class MultiPointCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements MultiPointCoverageType {
  /**
   * The cached value of the '{@link #getMultiPointDomain() <em>Multi Point Domain</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_POINT_COVERAGE_TYPE__MULTI_POINT_DOMAIN,
              oldMultiPointDomain,
              newMultiPointDomain);
  ...
  public void setMultiPointDomain(MultiPointDomainType newMultiPointDomain) {
    if (newMultiPointDomain != multiPointDomain) {
      ...
      if (multiPointDomain != null)
        msgs =
            ((InternalEObject) multiPointDomain)
                .eInverseRemove(
                    this,
      ...
      if (newMultiPointDomain != null)
        msgs =
            ((InternalEObject) newMultiPointDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.MULTI_POINT_COVERAGE_TYPE__MULTI_POINT_DOMAIN,
