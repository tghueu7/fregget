 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PointArrayPropertyTypeImpl#getPoint <em>Point</em>}
 * </ul>
 *
 * @generated
 */
public class PointArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements PointArrayPropertyType {
  /**
  ...
  public EList<PointType> getPoint() {
    if (point == null) {
      point =
          new EObjectContainmentEList<PointType>(
              PointType.class, this, Gml311Package.POINT_ARRAY_PROPERTY_TYPE__POINT);
    }
    return point;
  }
