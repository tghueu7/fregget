 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#getMaximalComplex <em>Maximal
 *       Complex</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#getSuperComplex <em>Super Complex</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#getSubComplex <em>Sub Complex</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#getTopoPrimitiveMember <em>Topo
 *       Primitive Member</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#getTopoPrimitiveMembers <em>Topo
 *       Primitive Members</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoComplexTypeImpl#isIsMaximal <em>Is Maximal</em>}
 * </ul>
 *
 * @generated
 */
public class TopoComplexTypeImpl extends AbstractTopologyTypeImpl implements TopoComplexType {
  /**
   * The cached value of the '{@link #getMaximalComplex() <em>Maximal Complex</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSuperComplex() <em>Super Complex</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSubComplex() <em>Sub Complex</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTopoPrimitiveMember() <em>Topo Primitive Member</em>}'
  ...
  /**
   * The cached value of the '{@link #getTopoPrimitiveMembers() <em>Topo Primitive Members</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_COMPLEX_TYPE__MAXIMAL_COMPLEX,
              oldMaximalComplex,
              newMaximalComplex);
  ...
  public void setMaximalComplex(TopoComplexMemberType newMaximalComplex) {
    if (newMaximalComplex != maximalComplex) {
      ...
      if (maximalComplex != null)
        msgs =
            ((InternalEObject) maximalComplex)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_COMPLEX_TYPE__MAXIMAL_COMPLEX,
                    null,
                    msgs);
      if (newMaximalComplex != null)
        msgs =
            ((InternalEObject) newMaximalComplex)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_COMPLEX_TYPE__MAXIMAL_COMPLEX,
                    null,
  ...
  public EList<TopoComplexMemberType> getSuperComplex() {
    if (superComplex == null) {
      superComplex =
          new EObjectContainmentEList<TopoComplexMemberType>(
              TopoComplexMemberType.class, this, Gml311Package.TOPO_COMPLEX_TYPE__SUPER_COMPLEX);
    }
    return superComplex;
  }
  ...
  public EList<TopoComplexMemberType> getSubComplex() {
    if (subComplex == null) {
      subComplex =
          new EObjectContainmentEList<TopoComplexMemberType>(
              TopoComplexMemberType.class, this, Gml311Package.TOPO_COMPLEX_TYPE__SUB_COMPLEX);
    }
    return subComplex;
  }
  ...
  public EList<TopoPrimitiveMemberType> getTopoPrimitiveMember() {
    if (topoPrimitiveMember == null) {
      topoPrimitiveMember =
          new EObjectContainmentEList<TopoPrimitiveMemberType>(
              TopoPrimitiveMemberType.class,
              this,
              Gml311Package.TOPO_COMPLEX_TYPE__TOPO_PRIMITIVE_MEMBER);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_COMPLEX_TYPE__TOPO_PRIMITIVE_MEMBERS,
              oldTopoPrimitiveMembers,
  ...
  public void setTopoPrimitiveMembers(TopoPrimitiveArrayAssociationType newTopoPrimitiveMembers) {
    if (newTopoPrimitiveMembers != topoPrimitiveMembers) {
      ...
      if (topoPrimitiveMembers != null)
        msgs =
            ((InternalEObject) topoPrimitiveMembers)
                .eInverseRemove(
                    this,
      ...
      if (newTopoPrimitiveMembers != null)
        msgs =
            ((InternalEObject) newTopoPrimitiveMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.TOPO_COMPLEX_TYPE__TOPO_PRIMITIVE_MEMBERS,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_COMPLEX_TYPE__IS_MAXIMAL,
              oldIsMaximal,
              isMaximal,
              !oldIsMaximalESet));
  }
  ...
  public String toString() {
    ...
    if (isMaximalESet) result.append(isMaximal);
