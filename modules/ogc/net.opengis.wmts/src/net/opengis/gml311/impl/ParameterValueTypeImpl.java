 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getDmsAngleValue <em>Dms Angle
 *       Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getStringValue <em>String Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getIntegerValue <em>Integer
 *       Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#isBooleanValue <em>Boolean
 *       Value</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getValueList <em>Value List</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getIntegerValueList <em>Integer Value
 *       List</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getValueFile <em>Value File</em>}
 *   <li>{@link net.opengis.gml311.impl.ParameterValueTypeImpl#getValueOfParameter <em>Value Of
 *       Parameter</em>}
 * </ul>
 *
 * @generated
 */
public class ParameterValueTypeImpl extends AbstractGeneralParameterValueTypeImpl
  ...
  /**
   * The cached value of the '{@link #getDmsAngleValue() <em>Dms Angle Value</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getValueOfParameter() <em>Value Of Parameter</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__VALUE,
              oldValue,
              newValue);
      ...
      if (value != null)
        msgs =
            ((InternalEObject) value)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__VALUE,
                    null,
                    msgs);
      if (newValue != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__DMS_ANGLE_VALUE,
              oldDmsAngleValue,
              newDmsAngleValue);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setDmsAngleValue(DMSAngleType newDmsAngleValue) {
    if (newDmsAngleValue != dmsAngleValue) {
      ...
      if (dmsAngleValue != null)
        msgs =
            ((InternalEObject) dmsAngleValue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__DMS_ANGLE_VALUE,
                    null,
                    msgs);
      if (newDmsAngleValue != null)
        msgs =
            ((InternalEObject) newDmsAngleValue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__DMS_ANGLE_VALUE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__STRING_VALUE,
              oldStringValue,
              stringValue));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__INTEGER_VALUE,
              oldIntegerValue,
              integerValue));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__BOOLEAN_VALUE,
              oldBooleanValue,
              booleanValue,
              !oldBooleanValueESet));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__VALUE_LIST,
              oldValueList,
              newValueList);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setValueList(MeasureListType newValueList) {
    if (newValueList != valueList) {
      ...
      if (valueList != null)
        msgs =
            ((InternalEObject) valueList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__VALUE_LIST,
                    null,
                    msgs);
      if (newValueList != null)
        msgs =
            ((InternalEObject) newValueList)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__VALUE_LIST,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__INTEGER_VALUE_LIST,
              oldIntegerValueList,
              integerValueList));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__VALUE_FILE,
              oldValueFile,
              valueFile));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER,
              oldValueOfParameter,
              newValueOfParameter);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setValueOfParameter(OperationParameterRefType newValueOfParameter) {
    if (newValueOfParameter != valueOfParameter) {
      ...
      if (valueOfParameter != null)
        msgs =
            ((InternalEObject) valueOfParameter)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER,
                    null,
                    msgs);
      if (newValueOfParameter != null)
        msgs =
            ((InternalEObject) newValueOfParameter)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER,
                    null,
    ...
    switch (featureID) {
      ...
      case Gml311Package.PARAMETER_VALUE_TYPE__INTEGER_VALUE_LIST:
        return INTEGER_VALUE_LIST_EDEFAULT == null
            ...
            : !INTEGER_VALUE_LIST_EDEFAULT.equals(integerValueList);
      case Gml311Package.PARAMETER_VALUE_TYPE__VALUE_FILE:
        return VALUE_FILE_EDEFAULT == null
            ? valueFile != null
            : !VALUE_FILE_EDEFAULT.equals(valueFile);
      case Gml311Package.PARAMETER_VALUE_TYPE__VALUE_OF_PARAMETER:
  ...
  public String toString() {
    ...
    if (booleanValueESet) result.append(booleanValue);
