 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.IdentifierTypeImpl#getNameGroup <em>Name Group</em>}
 *   <li>{@link net.opengis.gml311.impl.IdentifierTypeImpl#getName <em>Name</em>}
 *   <li>{@link net.opengis.gml311.impl.IdentifierTypeImpl#getVersion <em>Version</em>}
 *   <li>{@link net.opengis.gml311.impl.IdentifierTypeImpl#getRemarks <em>Remarks</em>}
 * </ul>
 *
 * @generated
 */
public class IdentifierTypeImpl extends MinimalEObjectImpl.Container implements IdentifierType {
  ...
  public NotificationChain basicSetName(CodeType newName, NotificationChain msgs) {
    return ((FeatureMap.Internal) getNameGroup())
        .basicAdd(Gml311Package.eINSTANCE.getIdentifierType_Name(), newName, msgs);
  }
  ...
  public void setName(CodeType newName) {
    ((FeatureMap.Internal) getNameGroup())
        .set(Gml311Package.eINSTANCE.getIdentifierType_Name(), newName);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.IDENTIFIER_TYPE__VERSION, oldVersion, version));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.IDENTIFIER_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IDENTIFIER_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
