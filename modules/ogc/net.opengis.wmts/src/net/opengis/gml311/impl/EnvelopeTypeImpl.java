 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getLowerCorner <em>Lower Corner</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getUpperCorner <em>Upper Corner</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getCoord <em>Coord</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getAxisLabels <em>Axis Labels</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getSrsDimension <em>Srs Dimension</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeTypeImpl#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
 * @generated
 */
public class EnvelopeTypeImpl extends MinimalEObjectImpl.Container implements EnvelopeType {
  /**
   * The cached value of the '{@link #getLowerCorner() <em>Lower Corner</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUpperCorner() <em>Upper Corner</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetLowerCorner(
      DirectPositionType newLowerCorner, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__LOWER_CORNER,
              oldLowerCorner,
              newLowerCorner);
  ...
  public void setLowerCorner(DirectPositionType newLowerCorner) {
    if (newLowerCorner != lowerCorner) {
      ...
      if (lowerCorner != null)
        msgs =
            ((InternalEObject) lowerCorner)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENVELOPE_TYPE__LOWER_CORNER,
                    null,
                    msgs);
      if (newLowerCorner != null)
        msgs =
            ((InternalEObject) newLowerCorner)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENVELOPE_TYPE__LOWER_CORNER,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetUpperCorner(
      DirectPositionType newUpperCorner, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__UPPER_CORNER,
              oldUpperCorner,
              newUpperCorner);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUpperCorner(DirectPositionType newUpperCorner) {
    if (newUpperCorner != upperCorner) {
      ...
      if (upperCorner != null)
        msgs =
            ((InternalEObject) upperCorner)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENVELOPE_TYPE__UPPER_CORNER,
                    null,
                    msgs);
      if (newUpperCorner != null)
        msgs =
            ((InternalEObject) newUpperCorner)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENVELOPE_TYPE__UPPER_CORNER,
                    null,
  ...
  public EList<CoordType> getCoord() {
    if (coord == null) {
      coord =
          new EObjectContainmentEList<CoordType>(
              CoordType.class, this, Gml311Package.ENVELOPE_TYPE__COORD);
    }
    return coord;
  }
  ...
  public EList<DirectPositionType> getPos() {
    if (pos == null) {
      pos =
          new EObjectContainmentEList<DirectPositionType>(
              DirectPositionType.class, this, Gml311Package.ENVELOPE_TYPE__POS);
    }
    return pos;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENVELOPE_TYPE__COORDINATES,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__AXIS_LABELS,
              oldAxisLabels,
              axisLabels));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__SRS_DIMENSION,
              oldSrsDimension,
              srsDimension));
  }
  ...
  public void setSrsName(String newSrsName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ENVELOPE_TYPE__SRS_NAME, oldSrsName, srsName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_TYPE__UOM_LABELS,
              oldUomLabels,
              uomLabels));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.ENVELOPE_TYPE__AXIS_LABELS:
        return AXIS_LABELS_EDEFAULT == null
            ? axisLabels != null
            : !AXIS_LABELS_EDEFAULT.equals(axisLabels);
      case Gml311Package.ENVELOPE_TYPE__SRS_DIMENSION:
        return SRS_DIMENSION_EDEFAULT == null
            ? srsDimension != null
            : !SRS_DIMENSION_EDEFAULT.equals(srsDimension);
      case Gml311Package.ENVELOPE_TYPE__SRS_NAME:
        return SRS_NAME_EDEFAULT == null ? srsName != null : !SRS_NAME_EDEFAULT.equals(srsName);
      case Gml311Package.ENVELOPE_TYPE__UOM_LABELS:
        return UOM_LABELS_EDEFAULT == null
            ? uomLabels != null
            : !UOM_LABELS_EDEFAULT.equals(uomLabels);
    }
