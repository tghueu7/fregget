 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SequenceRuleTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.SequenceRuleTypeImpl#getOrder <em>Order</em>}
 * </ul>
 *
 * @generated
 */
public class SequenceRuleTypeImpl extends MinimalEObjectImpl.Container implements SequenceRuleType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SEQUENCE_RULE_TYPE__VALUE,
              oldValue,
              value,
              !oldValueESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SEQUENCE_RULE_TYPE__ORDER,
              oldOrder,
              order,
              !oldOrderESet));
  }
  ...
  public String toString() {
    ...
    result.append(", order: ");
    if (orderESet) result.append(order);
    else result.append("<unset>");
    result.append(')');
