 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CompositeValueTypeImpl#getValueComponent <em>Value
 *       Component</em>}
 *   <li>{@link net.opengis.gml311.impl.CompositeValueTypeImpl#getValueComponents <em>Value
 *       Components</em>}
 * </ul>
 *
 * @generated
...
public class CompositeValueTypeImpl extends AbstractGMLTypeImpl implements CompositeValueType {
  /**
   * The cached value of the '{@link #getValueComponent() <em>Value Component</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getValueComponents() <em>Value Components</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<ValuePropertyType> getValueComponent() {
    if (valueComponent == null) {
      valueComponent =
          new EObjectContainmentEList<ValuePropertyType>(
              ValuePropertyType.class, this, Gml311Package.COMPOSITE_VALUE_TYPE__VALUE_COMPONENT);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COMPOSITE_VALUE_TYPE__VALUE_COMPONENTS,
              oldValueComponents,
              newValueComponents);
  ...
  public void setValueComponents(ValueArrayPropertyType newValueComponents) {
    if (newValueComponents != valueComponents) {
      ...
      if (valueComponents != null)
        msgs =
            ((InternalEObject) valueComponents)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COMPOSITE_VALUE_TYPE__VALUE_COMPONENTS,
                    null,
                    msgs);
      if (newValueComponents != null)
        msgs =
            ((InternalEObject) newValueComponents)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COMPOSITE_VALUE_TYPE__VALUE_COMPONENTS,
                    null,
