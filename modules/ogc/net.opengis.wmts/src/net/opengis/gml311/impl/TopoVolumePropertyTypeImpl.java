 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoVolumePropertyTypeImpl#getTopoVolume <em>Topo
 *       Volume</em>}
 * </ul>
 *
 * @generated
 */
public class TopoVolumePropertyTypeImpl extends MinimalEObjectImpl.Container
    implements TopoVolumePropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_VOLUME_PROPERTY_TYPE__TOPO_VOLUME,
              oldTopoVolume,
              newTopoVolume);
  ...
  public void setTopoVolume(TopoVolumeType newTopoVolume) {
    if (newTopoVolume != topoVolume) {
      ...
      if (topoVolume != null)
        msgs =
            ((InternalEObject) topoVolume)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_VOLUME_PROPERTY_TYPE__TOPO_VOLUME,
                    null,
                    msgs);
      if (newTopoVolume != null)
        msgs =
            ((InternalEObject) newTopoVolume)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_VOLUME_PROPERTY_TYPE__TOPO_VOLUME,
                    null,
