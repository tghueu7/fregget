 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiSolidTypeImpl#getSolidMember <em>Solid Member</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiSolidTypeImpl#getSolidMembers <em>Solid Members</em>}
 * </ul>
 *
 * @generated
 */
public class MultiSolidTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiSolidType {
  /**
   * The cached value of the '{@link #getSolidMember() <em>Solid Member</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSolidMembers() <em>Solid Members</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<SolidPropertyType> getSolidMember() {
    if (solidMember == null) {
      solidMember =
          new EObjectContainmentEList<SolidPropertyType>(
              SolidPropertyType.class, this, Gml311Package.MULTI_SOLID_TYPE__SOLID_MEMBER);
    }
    return solidMember;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_SOLID_TYPE__SOLID_MEMBERS,
              oldSolidMembers,
              newSolidMembers);
  ...
  public void setSolidMembers(SolidArrayPropertyType newSolidMembers) {
    if (newSolidMembers != solidMembers) {
      ...
      if (solidMembers != null)
        msgs =
            ((InternalEObject) solidMembers)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_SOLID_TYPE__SOLID_MEMBERS,
                    null,
                    msgs);
      if (newSolidMembers != null)
        msgs =
            ((InternalEObject) newSolidMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_SOLID_TYPE__SOLID_MEMBERS,
                    null,
