 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.IndexMapTypeImpl#getLookUpTable <em>Look Up Table</em>}
 * </ul>
 *
 * @generated
 */
public class IndexMapTypeImpl extends GridFunctionTypeImpl implements IndexMapType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.INDEX_MAP_TYPE__LOOK_UP_TABLE,
              oldLookUpTable,
              lookUpTable));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Gml311Package.INDEX_MAP_TYPE__LOOK_UP_TABLE:
        return LOOK_UP_TABLE_EDEFAULT == null
            ? lookUpTable != null
            : !LOOK_UP_TABLE_EDEFAULT.equals(lookUpTable);
    }
