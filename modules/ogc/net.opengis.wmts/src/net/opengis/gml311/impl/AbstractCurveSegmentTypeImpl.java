 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractCurveSegmentTypeImpl#getNumDerivativeInterior
 *       <em>Num Derivative Interior</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCurveSegmentTypeImpl#getNumDerivativesAtEnd <em>Num
 *       Derivatives At End</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCurveSegmentTypeImpl#getNumDerivativesAtStart
 *       <em>Num Derivatives At Start</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCurveSegmentTypeImpl extends MinimalEObjectImpl.Container
    implements AbstractCurveSegmentType {
  /**
   * The default value of the '{@link #getNumDerivativeInterior() <em>Num Derivative Interior</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getNumDerivativeInterior() <em>Num Derivative Interior</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getNumDerivativesAtEnd() <em>Num Derivatives At End</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getNumDerivativesAtEnd() <em>Num Derivatives At End</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getNumDerivativesAtStart() <em>Num Derivatives At
   * Start</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getNumDerivativesAtStart() <em>Num Derivatives At Start</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVE_INTERIOR,
              oldNumDerivativeInterior,
              numDerivativeInterior,
              !oldNumDerivativeInteriorESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              ...
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVE_INTERIOR,
              oldNumDerivativeInterior,
              NUM_DERIVATIVE_INTERIOR_EDEFAULT,
              oldNumDerivativeInteriorESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVES_AT_END,
              oldNumDerivativesAtEnd,
              numDerivativesAtEnd,
              !oldNumDerivativesAtEndESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              ...
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVES_AT_END,
              oldNumDerivativesAtEnd,
              NUM_DERIVATIVES_AT_END_EDEFAULT,
              oldNumDerivativesAtEndESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVES_AT_START,
              oldNumDerivativesAtStart,
              numDerivativesAtStart,
              !oldNumDerivativesAtStartESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              ...
              Gml311Package.ABSTRACT_CURVE_SEGMENT_TYPE__NUM_DERIVATIVES_AT_START,
              oldNumDerivativesAtStart,
              NUM_DERIVATIVES_AT_START_EDEFAULT,
              oldNumDerivativesAtStartESet));
  }
  ...
  public String toString() {
    ...
    if (numDerivativeInteriorESet) result.append(numDerivativeInterior);
    else result.append("<unset>");
    result.append(", numDerivativesAtEnd: ");
    if (numDerivativesAtEndESet) result.append(numDerivativesAtEnd);
    else result.append("<unset>");
    result.append(", numDerivativesAtStart: ");
    if (numDerivativesAtStartESet) result.append(numDerivativesAtStart);
    else result.append("<unset>");
    result.append(')');
