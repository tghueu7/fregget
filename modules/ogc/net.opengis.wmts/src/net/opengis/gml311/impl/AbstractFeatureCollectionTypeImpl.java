 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractFeatureCollectionTypeImpl#getFeatureMember
 *       <em>Feature Member</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractFeatureCollectionTypeImpl#getFeatureMembers
 *       <em>Feature Members</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractFeatureCollectionTypeImpl extends AbstractFeatureTypeImpl
    implements AbstractFeatureCollectionType {
  /**
   * The cached value of the '{@link #getFeatureMember() <em>Feature Member</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getFeatureMembers() <em>Feature Members</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<FeaturePropertyType> getFeatureMember() {
    if (featureMember == null) {
      featureMember =
          new EObjectContainmentEList<FeaturePropertyType>(
              FeaturePropertyType.class,
              this,
              Gml311Package.ABSTRACT_FEATURE_COLLECTION_TYPE__FEATURE_MEMBER);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_FEATURE_COLLECTION_TYPE__FEATURE_MEMBERS,
              oldFeatureMembers,
              newFeatureMembers);
  ...
  public void setFeatureMembers(FeatureArrayPropertyType newFeatureMembers) {
    if (newFeatureMembers != featureMembers) {
      ...
      if (featureMembers != null)
        msgs =
            ((InternalEObject) featureMembers)
                .eInverseRemove(
                    this,
      ...
      if (newFeatureMembers != null)
        msgs =
            ((InternalEObject) newFeatureMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ABSTRACT_FEATURE_COLLECTION_TYPE__FEATURE_MEMBERS,
