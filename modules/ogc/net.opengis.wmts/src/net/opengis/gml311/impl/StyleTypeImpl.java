 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.StyleTypeImpl#getFeatureStyle <em>Feature Style</em>}
 *   <li>{@link net.opengis.gml311.impl.StyleTypeImpl#getGraphStyle <em>Graph Style</em>}
 * </ul>
 *
 * @generated
 */
public class StyleTypeImpl extends AbstractStyleTypeImpl implements StyleType {
  ...
  public EList<FeatureStylePropertyType> getFeatureStyle() {
    if (featureStyle == null) {
      featureStyle =
          new EObjectContainmentEList<FeatureStylePropertyType>(
              FeatureStylePropertyType.class, this, Gml311Package.STYLE_TYPE__FEATURE_STYLE);
    }
    return featureStyle;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.STYLE_TYPE__GRAPH_STYLE,
              oldGraphStyle,
              newGraphStyle);
      ...
      if (graphStyle != null)
        msgs =
            ((InternalEObject) graphStyle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.STYLE_TYPE__GRAPH_STYLE,
                    null,
                    msgs);
