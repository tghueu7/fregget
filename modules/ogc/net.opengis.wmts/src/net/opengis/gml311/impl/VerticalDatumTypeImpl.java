 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.VerticalDatumTypeImpl#getVerticalDatumType <em>Vertical
 *       Datum Type</em>}
 * </ul>
 *
 * @generated
...
public class VerticalDatumTypeImpl extends AbstractDatumTypeImpl implements VerticalDatumType {
  /**
   * The cached value of the '{@link #getVerticalDatumType() <em>Vertical Datum Type</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VERTICAL_DATUM_TYPE__VERTICAL_DATUM_TYPE,
              oldVerticalDatumType,
  ...
  public void setVerticalDatumType(VerticalDatumTypeType newVerticalDatumType) {
    if (newVerticalDatumType != verticalDatumType) {
      ...
      if (verticalDatumType != null)
        msgs =
            ((InternalEObject) verticalDatumType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_DATUM_TYPE__VERTICAL_DATUM_TYPE,
                    null,
                    msgs);
      if (newVerticalDatumType != null)
        msgs =
            ((InternalEObject) newVerticalDatumType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_DATUM_TYPE__VERTICAL_DATUM_TYPE,
                    null,
