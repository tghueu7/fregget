 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CurveSegmentArrayPropertyTypeImpl#getCurveSegmentGroup
 *       <em>Curve Segment Group</em>}
 *   <li>{@link net.opengis.gml311.impl.CurveSegmentArrayPropertyTypeImpl#getCurveSegment <em>Curve
 *       Segment</em>}
 * </ul>
 *
 * @generated
 */
public class CurveSegmentArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements CurveSegmentArrayPropertyType {
  /**
   * The cached value of the '{@link #getCurveSegmentGroup() <em>Curve Segment Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getCurveSegmentGroup() {
    if (curveSegmentGroup == null) {
      curveSegmentGroup =
          new BasicFeatureMap(
              this, Gml311Package.CURVE_SEGMENT_ARRAY_PROPERTY_TYPE__CURVE_SEGMENT_GROUP);
    }
  ...
  public EList<AbstractCurveSegmentType> getCurveSegment() {
    return getCurveSegmentGroup()
        .list(Gml311Package.eINSTANCE.getCurveSegmentArrayPropertyType_CurveSegment());
  }
