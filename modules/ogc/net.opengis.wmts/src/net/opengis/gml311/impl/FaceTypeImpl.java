 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.FaceTypeImpl#getDirectedEdge <em>Directed Edge</em>}
 *   <li>{@link net.opengis.gml311.impl.FaceTypeImpl#getDirectedTopoSolid <em>Directed Topo
 *       Solid</em>}
 *   <li>{@link net.opengis.gml311.impl.FaceTypeImpl#getSurfaceProperty <em>Surface Property</em>}
 * </ul>
 *
 * @generated
 */
public class FaceTypeImpl extends AbstractTopoPrimitiveTypeImpl implements FaceType {
  /**
   * The cached value of the '{@link #getDirectedEdge() <em>Directed Edge</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getDirectedTopoSolid() <em>Directed Topo Solid</em>}'
  ...
  /**
   * The cached value of the '{@link #getSurfaceProperty() <em>Surface Property</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<DirectedEdgePropertyType> getDirectedEdge() {
    if (directedEdge == null) {
      directedEdge =
          new EObjectContainmentEList<DirectedEdgePropertyType>(
              DirectedEdgePropertyType.class, this, Gml311Package.FACE_TYPE__DIRECTED_EDGE);
    }
    return directedEdge;
  }
  ...
  public EList<DirectedTopoSolidPropertyType> getDirectedTopoSolid() {
    if (directedTopoSolid == null) {
      directedTopoSolid =
          new EObjectContainmentEList<DirectedTopoSolidPropertyType>(
              DirectedTopoSolidPropertyType.class,
              this,
              Gml311Package.FACE_TYPE__DIRECTED_TOPO_SOLID);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FACE_TYPE__SURFACE_PROPERTY,
              oldSurfaceProperty,
              newSurfaceProperty);
  ...
  public void setSurfaceProperty(SurfacePropertyType newSurfaceProperty) {
    if (newSurfaceProperty != surfaceProperty) {
      ...
      if (surfaceProperty != null)
        msgs =
            ((InternalEObject) surfaceProperty)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FACE_TYPE__SURFACE_PROPERTY,
                    null,
                    msgs);
      if (newSurfaceProperty != null)
        msgs =
            ((InternalEObject) newSurfaceProperty)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FACE_TYPE__SURFACE_PROPERTY,
                    null,
    ...
    switch (featureID) {
      ...
      case Gml311Package.FACE_TYPE__DIRECTED_TOPO_SOLID:
        ...
        getDirectedTopoSolid()
            .addAll((Collection<? extends DirectedTopoSolidPropertyType>) newValue);
        return;
      case Gml311Package.FACE_TYPE__SURFACE_PROPERTY:
