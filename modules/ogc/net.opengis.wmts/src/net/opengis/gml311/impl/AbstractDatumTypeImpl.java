 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getDatumID <em>Datum ID</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getAnchorPoint <em>Anchor Point</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getRealizationEpoch <em>Realization
 *       Epoch</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getValidArea <em>Valid Area</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractDatumTypeImpl#getScope <em>Scope</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractDatumTypeImpl extends AbstractDatumBaseTypeImpl
    implements AbstractDatumType {
  /**
  ...
  /**
   * The cached value of the '{@link #getAnchorPoint() <em>Anchor Point</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (datumID == null) {
      datumID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.ABSTRACT_DATUM_TYPE__DATUM_ID);
    }
    return datumID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_DATUM_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_DATUM_TYPE__ANCHOR_POINT,
              oldAnchorPoint,
              newAnchorPoint);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAnchorPoint(CodeType newAnchorPoint) {
    if (newAnchorPoint != anchorPoint) {
      ...
      if (anchorPoint != null)
        msgs =
            ((InternalEObject) anchorPoint)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_TYPE__ANCHOR_POINT,
                    null,
                    msgs);
      if (newAnchorPoint != null)
        msgs =
            ((InternalEObject) newAnchorPoint)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_TYPE__ANCHOR_POINT,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_DATUM_TYPE__REALIZATION_EPOCH,
              oldRealizationEpoch,
              realizationEpoch));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_DATUM_TYPE__VALID_AREA,
              oldValidArea,
              newValidArea);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (validArea != null)
        msgs =
            ((InternalEObject) validArea)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_DATUM_TYPE__VALID_AREA,
                    null,
                    msgs);
  ...
  public void setScope(String newScope) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ABSTRACT_DATUM_TYPE__SCOPE, oldScope, scope));
  }
    ...
    switch (featureID) {
      ...
      case Gml311Package.ABSTRACT_DATUM_TYPE__REALIZATION_EPOCH:
        return REALIZATION_EPOCH_EDEFAULT == null
            ...
            : !REALIZATION_EPOCH_EDEFAULT.equals(realizationEpoch);
      case Gml311Package.ABSTRACT_DATUM_TYPE__VALID_AREA:
