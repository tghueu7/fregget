 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoPointPropertyTypeImpl#getTopoPoint <em>Topo Point</em>}
 * </ul>
 *
 * @generated
 */
public class TopoPointPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements TopoPointPropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_POINT_PROPERTY_TYPE__TOPO_POINT,
              oldTopoPoint,
              newTopoPoint);
  ...
  public void setTopoPoint(TopoPointType newTopoPoint) {
    if (newTopoPoint != topoPoint) {
      ...
      if (topoPoint != null)
        msgs =
            ((InternalEObject) topoPoint)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_POINT_PROPERTY_TYPE__TOPO_POINT,
                    null,
                    msgs);
      if (newTopoPoint != null)
        msgs =
            ((InternalEObject) newTopoPoint)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_POINT_PROPERTY_TYPE__TOPO_POINT,
                    null,
