 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ConversionToPreferredUnitTypeImpl#getFactor <em>Factor</em>}
 *   <li>{@link net.opengis.gml311.impl.ConversionToPreferredUnitTypeImpl#getFormula
 *       <em>Formula</em>}
 * </ul>
 *
 * @generated
 */
public class ConversionToPreferredUnitTypeImpl extends UnitOfMeasureTypeImpl
    implements ConversionToPreferredUnitType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONVERSION_TO_PREFERRED_UNIT_TYPE__FACTOR,
              oldFactor,
              factor,
              !oldFactorESet));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONVERSION_TO_PREFERRED_UNIT_TYPE__FORMULA,
              oldFormula,
              newFormula);
  ...
  public String toString() {
    ...
    if (factorESet) result.append(factor);
