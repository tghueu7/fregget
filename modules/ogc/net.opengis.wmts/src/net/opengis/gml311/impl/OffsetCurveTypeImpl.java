 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OffsetCurveTypeImpl#getOffsetBase <em>Offset Base</em>}
 *   <li>{@link net.opengis.gml311.impl.OffsetCurveTypeImpl#getDistance <em>Distance</em>}
 *   <li>{@link net.opengis.gml311.impl.OffsetCurveTypeImpl#getRefDirection <em>Ref Direction</em>}
 * </ul>
 *
 * @generated
 */
public class OffsetCurveTypeImpl extends AbstractCurveSegmentTypeImpl implements OffsetCurveType {
   ...
   * @generated
   */
  public NotificationChain basicSetOffsetBase(
      CurvePropertyType newOffsetBase, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OFFSET_CURVE_TYPE__OFFSET_BASE,
              oldOffsetBase,
              newOffsetBase);
  ...
  public void setOffsetBase(CurvePropertyType newOffsetBase) {
    if (newOffsetBase != offsetBase) {
      ...
      if (offsetBase != null)
        msgs =
            ((InternalEObject) offsetBase)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__OFFSET_BASE,
                    null,
                    msgs);
      if (newOffsetBase != null)
        msgs =
            ((InternalEObject) newOffsetBase)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__OFFSET_BASE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OFFSET_CURVE_TYPE__DISTANCE,
              oldDistance,
              newDistance);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setDistance(LengthType newDistance) {
    if (newDistance != distance) {
      ...
      if (distance != null)
        msgs =
            ((InternalEObject) distance)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__DISTANCE,
                    null,
                    msgs);
      if (newDistance != null)
        msgs =
            ((InternalEObject) newDistance)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__DISTANCE,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetRefDirection(
      VectorType newRefDirection, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OFFSET_CURVE_TYPE__REF_DIRECTION,
              oldRefDirection,
              newRefDirection);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRefDirection(VectorType newRefDirection) {
    if (newRefDirection != refDirection) {
      ...
      if (refDirection != null)
        msgs =
            ((InternalEObject) refDirection)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__REF_DIRECTION,
                    null,
                    msgs);
      if (newRefDirection != null)
        msgs =
            ((InternalEObject) newRefDirection)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OFFSET_CURVE_TYPE__REF_DIRECTION,
                    null,
