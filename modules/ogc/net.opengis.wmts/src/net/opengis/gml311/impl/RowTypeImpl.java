 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RowTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.RowTypeImpl#getGeometricPositionGroup <em>Geometric Position
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.RowTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.RowTypeImpl#getPointProperty <em>Point Property</em>}
 * </ul>
 *
 * @generated
 */
public class RowTypeImpl extends MinimalEObjectImpl.Container implements RowType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ROW_TYPE__POS_LIST, oldPosList, newPosList);
  ...
  public void setPosList(DirectPositionListType newPosList) {
    if (newPosList != posList) {
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.ROW_TYPE__POS_LIST, null, msgs);
      if (newPosList != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ROW_TYPE__POS_LIST, newPosList, newPosList));
  }
  ...
  public FeatureMap getGeometricPositionGroup() {
    if (geometricPositionGroup == null) {
      geometricPositionGroup =
          new BasicFeatureMap(this, Gml311Package.ROW_TYPE__GEOMETRIC_POSITION_GROUP);
    }
