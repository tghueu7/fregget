 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TrianglePatchArrayPropertyTypeImpl#getTriangle
 *       <em>Triangle</em>}
 * </ul>
 *
 * @generated
 */
public class TrianglePatchArrayPropertyTypeImpl extends SurfacePatchArrayPropertyTypeImpl
    implements TrianglePatchArrayPropertyType {
  /**
  ...
  public EList<TriangleType> getTriangle() {
    if (triangle == null) {
      triangle =
          new EObjectContainmentEList<TriangleType>(
              TriangleType.class, this, Gml311Package.TRIANGLE_PATCH_ARRAY_PROPERTY_TYPE__TRIANGLE);
    }
    return triangle;
  }
