 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getPointProperty <em>Point
 *       Property</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getCoordinates
 *       <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.LineStringSegmentTypeImpl#getInterpolation
 *       <em>Interpolation</em>}
 * </ul>
 *
 * @generated
 */
public class LineStringSegmentTypeImpl extends AbstractCurveSegmentTypeImpl
    implements LineStringSegmentType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LINE_STRING_SEGMENT_TYPE__POS_LIST,
              oldPosList,
              newPosList);
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LINE_STRING_SEGMENT_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LINE_STRING_SEGMENT_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LINE_STRING_SEGMENT_TYPE__COORDINATES,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LINE_STRING_SEGMENT_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
