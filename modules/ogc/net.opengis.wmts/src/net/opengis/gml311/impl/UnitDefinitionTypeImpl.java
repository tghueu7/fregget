 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.UnitDefinitionTypeImpl#getQuantityType <em>Quantity
 *       Type</em>}
 *   <li>{@link net.opengis.gml311.impl.UnitDefinitionTypeImpl#getCatalogSymbol <em>Catalog
 *       Symbol</em>}
 * </ul>
 *
 * @generated
...
public class UnitDefinitionTypeImpl extends DefinitionTypeImpl implements UnitDefinitionType {
  /**
   * The cached value of the '{@link #getQuantityType() <em>Quantity Type</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getCatalogSymbol() <em>Catalog Symbol</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.UNIT_DEFINITION_TYPE__QUANTITY_TYPE,
              oldQuantityType,
              newQuantityType);
  ...
  public void setQuantityType(StringOrRefType newQuantityType) {
    if (newQuantityType != quantityType) {
      ...
      if (quantityType != null)
        msgs =
            ((InternalEObject) quantityType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.UNIT_DEFINITION_TYPE__QUANTITY_TYPE,
                    null,
                    msgs);
      if (newQuantityType != null)
        msgs =
            ((InternalEObject) newQuantityType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.UNIT_DEFINITION_TYPE__QUANTITY_TYPE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.UNIT_DEFINITION_TYPE__CATALOG_SYMBOL,
              oldCatalogSymbol,
              newCatalogSymbol);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setCatalogSymbol(CodeType newCatalogSymbol) {
    if (newCatalogSymbol != catalogSymbol) {
      ...
      if (catalogSymbol != null)
        msgs =
            ((InternalEObject) catalogSymbol)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.UNIT_DEFINITION_TYPE__CATALOG_SYMBOL,
                    null,
                    msgs);
      if (newCatalogSymbol != null)
        msgs =
            ((InternalEObject) newCatalogSymbol)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.UNIT_DEFINITION_TYPE__CATALOG_SYMBOL,
                    null,
