 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getBeginPosition <em>Begin Position</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getBegin <em>Begin</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getEndPosition <em>End Position</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getEnd <em>End</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getDuration <em>Duration</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePeriodTypeImpl#getTimeInterval <em>Time Interval</em>}
 * </ul>
 *
 * @generated
 */
public class TimePeriodTypeImpl extends AbstractTimeGeometricPrimitiveTypeImpl
    implements TimePeriodType {
  /**
   * The cached value of the '{@link #getBeginPosition() <em>Begin Position</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getEndPosition() <em>End Position</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTimeInterval() <em>Time Interval</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetBeginPosition(
      TimePositionType newBeginPosition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
              oldBeginPosition,
              newBeginPosition);
  ...
  public void setBeginPosition(TimePositionType newBeginPosition) {
    if (newBeginPosition != beginPosition) {
      ...
      if (beginPosition != null)
        msgs =
            ((InternalEObject) beginPosition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
                    null,
                    msgs);
      if (newBeginPosition != null)
        msgs =
            ((InternalEObject) newBeginPosition)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__BEGIN_POSITION,
                    null,
  ...
  public NotificationChain basicSetBegin(TimeInstantPropertyType newBegin, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_PERIOD_TYPE__BEGIN, oldBegin, newBegin);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setBegin(TimeInstantPropertyType newBegin) {
    if (newBegin != begin) {
      ...
      if (begin != null)
        msgs =
            ((InternalEObject) begin)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__BEGIN,
                    null,
                    msgs);
      if (newBegin != null)
        msgs =
            ((InternalEObject) newBegin)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__BEGIN,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_PERIOD_TYPE__BEGIN, newBegin, newBegin));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetEndPosition(
      TimePositionType newEndPosition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_PERIOD_TYPE__END_POSITION,
              oldEndPosition,
              newEndPosition);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setEndPosition(TimePositionType newEndPosition) {
    if (newEndPosition != endPosition) {
      ...
      if (endPosition != null)
        msgs =
            ((InternalEObject) endPosition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__END_POSITION,
                    null,
                    msgs);
      if (newEndPosition != null)
        msgs =
            ((InternalEObject) newEndPosition)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__END_POSITION,
                    null,
  ...
  public NotificationChain basicSetEnd(TimeInstantPropertyType newEnd, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_PERIOD_TYPE__END, oldEnd, newEnd);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newEnd != end) {
      ...
      if (end != null)
        msgs =
            ((InternalEObject) end)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__END, null, msgs);
      if (newEnd != null)
        msgs =
            ((InternalEObject) newEnd)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__END, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_PERIOD_TYPE__END, newEnd, newEnd));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_PERIOD_TYPE__DURATION,
              oldDuration,
              duration));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_PERIOD_TYPE__TIME_INTERVAL,
              oldTimeInterval,
              newTimeInterval);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTimeInterval(TimeIntervalLengthType newTimeInterval) {
    if (newTimeInterval != timeInterval) {
      ...
      if (timeInterval != null)
        msgs =
            ((InternalEObject) timeInterval)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__TIME_INTERVAL,
                    null,
                    msgs);
      if (newTimeInterval != null)
        msgs =
            ((InternalEObject) newTimeInterval)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_PERIOD_TYPE__TIME_INTERVAL,
                    null,
