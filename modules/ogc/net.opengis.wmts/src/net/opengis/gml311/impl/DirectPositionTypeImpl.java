 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DirectPositionTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionTypeImpl#getAxisLabels <em>Axis Labels</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionTypeImpl#getSrsDimension <em>Srs
 *       Dimension</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionTypeImpl#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionTypeImpl#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
 * @generated
 */
public class DirectPositionTypeImpl extends MinimalEObjectImpl.Container
    implements DirectPositionType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.DIRECT_POSITION_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_TYPE__AXIS_LABELS,
              oldAxisLabels,
              axisLabels));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_TYPE__SRS_DIMENSION,
              oldSrsDimension,
              srsDimension));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_TYPE__SRS_NAME,
              oldSrsName,
              srsName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_TYPE__UOM_LABELS,
              oldUomLabels,
              uomLabels));
  }
