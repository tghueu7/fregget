 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TriangleTypeImpl#getExteriorGroup <em>Exterior Group</em>}
 *   <li>{@link net.opengis.gml311.impl.TriangleTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.impl.TriangleTypeImpl#getInterpolation <em>Interpolation</em>}
 * </ul>
 *
 * @generated
 */
public class TriangleTypeImpl extends AbstractSurfacePatchTypeImpl implements TriangleType {
  ...
  public AbstractRingPropertyType getExterior() {
    return (AbstractRingPropertyType)
        getExteriorGroup().get(Gml311Package.eINSTANCE.getTriangleType_Exterior(), true);
  }
  ...
  public NotificationChain basicSetExterior(
    ...
    return ((FeatureMap.Internal) getExteriorGroup())
        .basicAdd(Gml311Package.eINSTANCE.getTriangleType_Exterior(), newExterior, msgs);
  }
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    ((FeatureMap.Internal) getExteriorGroup())
        .set(Gml311Package.eINSTANCE.getTriangleType_Exterior(), newExterior);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TRIANGLE_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
