 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiCurveCoverageTypeImpl#getMultiCurveDomain <em>Multi
 *       Curve Domain</em>}
 * </ul>
 *
 * @generated
 */
public class MultiCurveCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements MultiCurveCoverageType {
  /**
   * The cached value of the '{@link #getMultiCurveDomain() <em>Multi Curve Domain</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_CURVE_COVERAGE_TYPE__MULTI_CURVE_DOMAIN,
              oldMultiCurveDomain,
              newMultiCurveDomain);
  ...
  public void setMultiCurveDomain(MultiCurveDomainType newMultiCurveDomain) {
    if (newMultiCurveDomain != multiCurveDomain) {
      ...
      if (multiCurveDomain != null)
        msgs =
            ((InternalEObject) multiCurveDomain)
                .eInverseRemove(
                    this,
      ...
      if (newMultiCurveDomain != null)
        msgs =
            ((InternalEObject) newMultiCurveDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.MULTI_CURVE_COVERAGE_TYPE__MULTI_CURVE_DOMAIN,
