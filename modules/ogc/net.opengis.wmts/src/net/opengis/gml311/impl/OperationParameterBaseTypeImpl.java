 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OperationParameterBaseTypeImpl#getParameterName
 *       <em>Parameter Name</em>}
 * </ul>
 *
 * @generated
 */
public abstract class OperationParameterBaseTypeImpl
    extends AbstractGeneralOperationParameterTypeImpl implements OperationParameterBaseType {
  /**
   * The cached value of the '{@link #getParameterName() <em>Parameter Name</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME,
              oldParameterName,
              newParameterName);
  ...
  public void setParameterName(CodeType newParameterName) {
    if (newParameterName != parameterName) {
      ...
      if (newParameterName != null)
        msgs =
            ((InternalEObject) newParameterName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.OPERATION_PARAMETER_BASE_TYPE__PARAMETER_NAME,
