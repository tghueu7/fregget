 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TrackTypeImpl#getMovingObjectStatus <em>Moving Object
 *       Status</em>}
 * </ul>
 *
 * @generated
...
public class TrackTypeImpl extends HistoryPropertyTypeImpl implements TrackType {
  /**
   * The cached value of the '{@link #getMovingObjectStatus() <em>Moving Object Status</em>}'
  ...
  public EList<MovingObjectStatusType> getMovingObjectStatus() {
    if (movingObjectStatus == null) {
      movingObjectStatus =
          new EObjectContainmentEList<MovingObjectStatusType>(
              MovingObjectStatusType.class, this, Gml311Package.TRACK_TYPE__MOVING_OBJECT_STATUS);
    }
