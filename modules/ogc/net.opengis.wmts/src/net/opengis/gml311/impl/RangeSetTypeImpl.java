 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getValueArray <em>Value Array</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getScalarValueList <em>Scalar Value
 *       List</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getBooleanList <em>Boolean List</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getCategoryList <em>Category List</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getQuantityList <em>Quantity List</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getCountList <em>Count List</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getDataBlock <em>Data Block</em>}
 *   <li>{@link net.opengis.gml311.impl.RangeSetTypeImpl#getFile <em>File</em>}
 * </ul>
 *
 * @generated
 */
public class RangeSetTypeImpl extends MinimalEObjectImpl.Container implements RangeSetType {
  /**
   * The cached value of the '{@link #getValueArray() <em>Value Array</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getScalarValueList() <em>Scalar Value List</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<ValueArrayType> getValueArray() {
    if (valueArray == null) {
      valueArray =
          new EObjectContainmentEList<ValueArrayType>(
              ValueArrayType.class, this, Gml311Package.RANGE_SET_TYPE__VALUE_ARRAY);
    }
    return valueArray;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.RANGE_SET_TYPE__DATA_BLOCK,
              oldDataBlock,
              newDataBlock);
  ...
  public void setDataBlock(DataBlockType newDataBlock) {
    if (newDataBlock != dataBlock) {
      ...
      if (dataBlock != null)
        msgs =
            ((InternalEObject) dataBlock)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.RANGE_SET_TYPE__DATA_BLOCK,
                    null,
                    msgs);
      if (newDataBlock != null)
        msgs =
            ((InternalEObject) newDataBlock)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.RANGE_SET_TYPE__DATA_BLOCK,
                    null,
  ...
  public NotificationChain basicSetFile(FileType newFile, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.RANGE_SET_TYPE__FILE, oldFile, newFile);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setFile(FileType newFile) {
    if (newFile != file) {
      ...
      if (file != null)
        msgs =
            ((InternalEObject) file)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.RANGE_SET_TYPE__FILE, null, msgs);
      if (newFile != null)
        msgs =
            ((InternalEObject) newFile)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.RANGE_SET_TYPE__FILE, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.RANGE_SET_TYPE__FILE, newFile, newFile));
  }
