 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeodeticDatumTypeImpl#getUsesPrimeMeridian <em>Uses Prime
 *       Meridian</em>}
 *   <li>{@link net.opengis.gml311.impl.GeodeticDatumTypeImpl#getUsesEllipsoid <em>Uses
 *       Ellipsoid</em>}
 * </ul>
 *
 * @generated
...
public class GeodeticDatumTypeImpl extends AbstractDatumTypeImpl implements GeodeticDatumType {
  /**
   * The cached value of the '{@link #getUsesPrimeMeridian() <em>Uses Prime Meridian</em>}'
  ...
  /**
   * The cached value of the '{@link #getUsesEllipsoid() <em>Uses Ellipsoid</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEODETIC_DATUM_TYPE__USES_PRIME_MERIDIAN,
              oldUsesPrimeMeridian,
  ...
  public void setUsesPrimeMeridian(PrimeMeridianRefType newUsesPrimeMeridian) {
    if (newUsesPrimeMeridian != usesPrimeMeridian) {
      ...
      if (usesPrimeMeridian != null)
        msgs =
            ((InternalEObject) usesPrimeMeridian)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEODETIC_DATUM_TYPE__USES_PRIME_MERIDIAN,
                    null,
                    msgs);
      if (newUsesPrimeMeridian != null)
        msgs =
            ((InternalEObject) newUsesPrimeMeridian)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEODETIC_DATUM_TYPE__USES_PRIME_MERIDIAN,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEODETIC_DATUM_TYPE__USES_ELLIPSOID,
              oldUsesEllipsoid,
              newUsesEllipsoid);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUsesEllipsoid(EllipsoidRefType newUsesEllipsoid) {
    if (newUsesEllipsoid != usesEllipsoid) {
      ...
      if (usesEllipsoid != null)
        msgs =
            ((InternalEObject) usesEllipsoid)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEODETIC_DATUM_TYPE__USES_ELLIPSOID,
                    null,
                    msgs);
      if (newUsesEllipsoid != null)
        msgs =
            ((InternalEObject) newUsesEllipsoid)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEODETIC_DATUM_TYPE__USES_ELLIPSOID,
                    null,
