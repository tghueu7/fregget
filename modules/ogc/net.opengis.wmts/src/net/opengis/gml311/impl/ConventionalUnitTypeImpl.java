 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ConventionalUnitTypeImpl#getConversionToPreferredUnit
 *       <em>Conversion To Preferred Unit</em>}
 *   <li>{@link net.opengis.gml311.impl.ConventionalUnitTypeImpl#getRoughConversionToPreferredUnit
 *       <em>Rough Conversion To Preferred Unit</em>}
 *   <li>{@link net.opengis.gml311.impl.ConventionalUnitTypeImpl#getDerivationUnitTerm
 *       <em>Derivation Unit Term</em>}
 * </ul>
 *
 * @generated
 */
public class ConventionalUnitTypeImpl extends UnitDefinitionTypeImpl
    implements ConventionalUnitType {
  /**
   * The cached value of the '{@link #getConversionToPreferredUnit() <em>Conversion To Preferred
  ...
  /**
   * The cached value of the '{@link #getRoughConversionToPreferredUnit() <em>Rough Conversion To
   * Preferred Unit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getDerivationUnitTerm() <em>Derivation Unit Term</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONVENTIONAL_UNIT_TYPE__CONVERSION_TO_PREFERRED_UNIT,
              oldConversionToPreferredUnit,
  ...
  public void setConversionToPreferredUnit(
    ...
    if (newConversionToPreferredUnit != conversionToPreferredUnit) {
      ...
      if (conversionToPreferredUnit != null)
        msgs =
            ((InternalEObject) conversionToPreferredUnit)
                .eInverseRemove(
                    this,
      ...
      if (newConversionToPreferredUnit != null)
        msgs =
            ((InternalEObject) newConversionToPreferredUnit)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.CONVENTIONAL_UNIT_TYPE__CONVERSION_TO_PREFERRED_UNIT,
  ...
  public NotificationChain basicSetRoughConversionToPreferredUnit(
    ...
    ConversionToPreferredUnitType oldRoughConversionToPreferredUnit =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONVENTIONAL_UNIT_TYPE__ROUGH_CONVERSION_TO_PREFERRED_UNIT,
              oldRoughConversionToPreferredUnit,
  ...
  public void setRoughConversionToPreferredUnit(
    ...
    if (newRoughConversionToPreferredUnit != roughConversionToPreferredUnit) {
      ...
      if (roughConversionToPreferredUnit != null)
        msgs =
            ((InternalEObject) roughConversionToPreferredUnit)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.CONVENTIONAL_UNIT_TYPE__ROUGH_CONVERSION_TO_PREFERRED_UNIT,
      ...
      if (newRoughConversionToPreferredUnit != null)
        msgs =
            ((InternalEObject) newRoughConversionToPreferredUnit)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.CONVENTIONAL_UNIT_TYPE__ROUGH_CONVERSION_TO_PREFERRED_UNIT,
  ...
  public EList<DerivationUnitTermType> getDerivationUnitTerm() {
    if (derivationUnitTerm == null) {
      derivationUnitTerm =
          new EObjectContainmentEList<DerivationUnitTermType>(
              DerivationUnitTermType.class,
              this,
              Gml311Package.CONVENTIONAL_UNIT_TYPE__DERIVATION_UNIT_TERM);
    }
