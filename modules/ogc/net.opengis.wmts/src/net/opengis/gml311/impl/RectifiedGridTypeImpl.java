 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RectifiedGridTypeImpl#getOrigin <em>Origin</em>}
 *   <li>{@link net.opengis.gml311.impl.RectifiedGridTypeImpl#getOffsetVector <em>Offset
 *       Vector</em>}
 * </ul>
 *
 * @generated
...
public class RectifiedGridTypeImpl extends GridTypeImpl implements RectifiedGridType {
  ...
  /**
   * The cached value of the '{@link #getOffsetVector() <em>Offset Vector</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.RECTIFIED_GRID_TYPE__ORIGIN,
              oldOrigin,
              newOrigin);
      ...
      if (origin != null)
        msgs =
            ((InternalEObject) origin)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.RECTIFIED_GRID_TYPE__ORIGIN,
                    null,
                    msgs);
      if (newOrigin != null)
        msgs =
    ...
    if (offsetVector == null) {
      offsetVector =
          new EObjectContainmentEList<VectorType>(
              VectorType.class, this, Gml311Package.RECTIFIED_GRID_TYPE__OFFSET_VECTOR);
    }
    return offsetVector;
  }
