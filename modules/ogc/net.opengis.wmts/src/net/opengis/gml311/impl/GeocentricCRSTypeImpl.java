 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSTypeImpl#getUsesCartesianCS <em>Uses Cartesian
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSTypeImpl#getUsesSphericalCS <em>Uses Spherical
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.impl.GeocentricCRSTypeImpl#getUsesGeodeticDatum <em>Uses Geodetic
 *       Datum</em>}
 * </ul>
 *
 * @generated
 */
public class GeocentricCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements GeocentricCRSType {
  /**
   * The cached value of the '{@link #getUsesCartesianCS() <em>Uses Cartesian CS</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesSphericalCS() <em>Uses Spherical CS</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesGeodeticDatum() <em>Uses Geodetic Datum</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_TYPE__USES_CARTESIAN_CS,
              oldUsesCartesianCS,
              newUsesCartesianCS);
  ...
  public void setUsesCartesianCS(CartesianCSRefType newUsesCartesianCS) {
    if (newUsesCartesianCS != usesCartesianCS) {
      ...
      if (usesCartesianCS != null)
        msgs =
            ((InternalEObject) usesCartesianCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_CARTESIAN_CS,
                    null,
                    msgs);
      if (newUsesCartesianCS != null)
        msgs =
            ((InternalEObject) newUsesCartesianCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_CARTESIAN_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_TYPE__USES_SPHERICAL_CS,
              oldUsesSphericalCS,
              newUsesSphericalCS);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUsesSphericalCS(SphericalCSRefType newUsesSphericalCS) {
    if (newUsesSphericalCS != usesSphericalCS) {
      ...
      if (usesSphericalCS != null)
        msgs =
            ((InternalEObject) usesSphericalCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_SPHERICAL_CS,
                    null,
                    msgs);
      if (newUsesSphericalCS != null)
        msgs =
            ((InternalEObject) newUsesSphericalCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_SPHERICAL_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOCENTRIC_CRS_TYPE__USES_GEODETIC_DATUM,
              oldUsesGeodeticDatum,
  ...
  public void setUsesGeodeticDatum(GeodeticDatumRefType newUsesGeodeticDatum) {
    if (newUsesGeodeticDatum != usesGeodeticDatum) {
      ...
      if (usesGeodeticDatum != null)
        msgs =
            ((InternalEObject) usesGeodeticDatum)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_GEODETIC_DATUM,
                    null,
                    msgs);
      if (newUsesGeodeticDatum != null)
        msgs =
            ((InternalEObject) newUsesGeodeticDatum)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOCENTRIC_CRS_TYPE__USES_GEODETIC_DATUM,
                    null,
