 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getFeatureConstraint <em>Feature
 *       Constraint</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getGeometryStyle <em>Geometry
 *       Style</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getTopologyStyle <em>Topology
 *       Style</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getBaseType <em>Base Type</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getFeatureType <em>Feature Type</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureStyleTypeImpl#getQueryGrammar <em>Query Grammar</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureStyleTypeImpl extends AbstractGMLTypeImpl implements FeatureStyleType {
  /**
   * The default value of the '{@link #getFeatureConstraint() <em>Feature Constraint</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getFeatureConstraint() <em>Feature Constraint</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getGeometryStyle() <em>Geometry Style</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTopologyStyle() <em>Topology Style</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FEATURE_STYLE_TYPE__FEATURE_CONSTRAINT,
              oldFeatureConstraint,
              featureConstraint));
  }
  ...
  public EList<GeometryStylePropertyType> getGeometryStyle() {
    if (geometryStyle == null) {
      geometryStyle =
          new EObjectContainmentEList<GeometryStylePropertyType>(
              GeometryStylePropertyType.class,
              this,
              Gml311Package.FEATURE_STYLE_TYPE__GEOMETRY_STYLE);
    }
  ...
  public EList<TopologyStylePropertyType> getTopologyStyle() {
    if (topologyStyle == null) {
      topologyStyle =
          new EObjectContainmentEList<TopologyStylePropertyType>(
              TopologyStylePropertyType.class,
              this,
              Gml311Package.FEATURE_STYLE_TYPE__TOPOLOGY_STYLE);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FEATURE_STYLE_TYPE__LABEL_STYLE,
              oldLabelStyle,
              newLabelStyle);
  ...
  public void setLabelStyle(LabelStylePropertyType newLabelStyle) {
    if (newLabelStyle != labelStyle) {
      ...
      if (labelStyle != null)
        msgs =
            ((InternalEObject) labelStyle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FEATURE_STYLE_TYPE__LABEL_STYLE,
                    null,
                    msgs);
      if (newLabelStyle != null)
        msgs =
            ((InternalEObject) newLabelStyle)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FEATURE_STYLE_TYPE__LABEL_STYLE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FEATURE_STYLE_TYPE__BASE_TYPE,
              oldBaseType,
              baseType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FEATURE_STYLE_TYPE__FEATURE_TYPE,
              oldFeatureType,
              featureType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FEATURE_STYLE_TYPE__QUERY_GRAMMAR,
              oldQueryGrammar,
              queryGrammar,
              !oldQueryGrammarESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Gml311Package.FEATURE_STYLE_TYPE__FEATURE_CONSTRAINT:
        return FEATURE_CONSTRAINT_EDEFAULT == null
            ? featureConstraint != null
            : !FEATURE_CONSTRAINT_EDEFAULT.equals(featureConstraint);
      case Gml311Package.FEATURE_STYLE_TYPE__GEOMETRY_STYLE:
      ...
      case Gml311Package.FEATURE_STYLE_TYPE__FEATURE_TYPE:
        return FEATURE_TYPE_EDEFAULT == null
            ? featureType != null
            : !FEATURE_TYPE_EDEFAULT.equals(featureType);
      case Gml311Package.FEATURE_STYLE_TYPE__QUERY_GRAMMAR:
  ...
  public String toString() {
    ...
    if (queryGrammarESet) result.append(queryGrammar);
