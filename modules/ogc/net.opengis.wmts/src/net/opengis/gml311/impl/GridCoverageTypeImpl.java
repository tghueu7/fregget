 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GridCoverageTypeImpl#getGridDomain <em>Grid Domain</em>}
 * </ul>
 *
 * @generated
 */
public class GridCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements GridCoverageType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRID_COVERAGE_TYPE__GRID_DOMAIN,
              oldGridDomain,
              newGridDomain);
  ...
  public void setGridDomain(GridDomainType newGridDomain) {
    if (newGridDomain != gridDomain) {
      ...
      if (gridDomain != null)
        msgs =
            ((InternalEObject) gridDomain)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_COVERAGE_TYPE__GRID_DOMAIN,
                    null,
                    msgs);
      if (newGridDomain != null)
        msgs =
            ((InternalEObject) newGridDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_COVERAGE_TYPE__GRID_DOMAIN,
                    null,
