 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CodeOrNullListTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.CodeOrNullListTypeImpl#getCodeSpace <em>Code Space</em>}
 * </ul>
 *
 * @generated
 */
public class CodeOrNullListTypeImpl extends MinimalEObjectImpl.Container
    implements CodeOrNullListType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CODE_OR_NULL_LIST_TYPE__VALUE,
              oldValue,
              value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CODE_OR_NULL_LIST_TYPE__CODE_SPACE,
              oldCodeSpace,
              codeSpace));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.CODE_OR_NULL_LIST_TYPE__CODE_SPACE:
        return CODE_SPACE_EDEFAULT == null
            ? codeSpace != null
            : !CODE_SPACE_EDEFAULT.equals(codeSpace);
    }
