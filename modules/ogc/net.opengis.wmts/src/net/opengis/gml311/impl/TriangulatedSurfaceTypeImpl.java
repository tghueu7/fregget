 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TriangulatedSurfaceTypeImpl#getTrianglePatches <em>Triangle
 *       Patches</em>}
 * </ul>
 *
 * @generated
 */
public class TriangulatedSurfaceTypeImpl extends SurfaceTypeImpl
    implements TriangulatedSurfaceType {
  /**
   * The cached value of the '{@link #getTrianglePatches() <em>Triangle Patches</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TRIANGULATED_SURFACE_TYPE__TRIANGLE_PATCHES,
              oldTrianglePatches,
              newTrianglePatches);
  ...
  public void setTrianglePatches(TrianglePatchArrayPropertyType newTrianglePatches) {
    if (newTrianglePatches != trianglePatches) {
      ...
      if (trianglePatches != null)
        msgs =
            ((InternalEObject) trianglePatches)
                .eInverseRemove(
                    this,
      ...
      if (newTrianglePatches != null)
        msgs =
            ((InternalEObject) newTrianglePatches)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.TRIANGULATED_SURFACE_TYPE__TRIANGLE_PATCHES,
