 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getSpatialResolution <em>Spatial
 *       Resolution</em>}
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getStyleVariation <em>Style
 *       Variation</em>}
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getAnimate <em>Animate</em>}
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getAnimateMotion <em>Animate
 *       Motion</em>}
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getAnimateColor <em>Animate
 *       Color</em>}
 *   <li>{@link net.opengis.gml311.impl.BaseStyleDescriptorTypeImpl#getSet <em>Set</em>}
 * </ul>
 *
 * @generated
 */
public class BaseStyleDescriptorTypeImpl extends AbstractGMLTypeImpl
    implements BaseStyleDescriptorType {
  /**
   * The cached value of the '{@link #getSpatialResolution() <em>Spatial Resolution</em>}'
  ...
  /**
   * The cached value of the '{@link #getStyleVariation() <em>Style Variation</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAnimateMotion() <em>Animate Motion</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAnimateColor() <em>Animate Color</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetSpatialResolution(
      ScaleType newSpatialResolution, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__SPATIAL_RESOLUTION,
              oldSpatialResolution,
              newSpatialResolution);
  ...
  public void setSpatialResolution(ScaleType newSpatialResolution) {
    if (newSpatialResolution != spatialResolution) {
      ...
      if (spatialResolution != null)
        msgs =
            ((InternalEObject) spatialResolution)
                .eInverseRemove(
                    this,
      ...
      if (newSpatialResolution != null)
        msgs =
            ((InternalEObject) newSpatialResolution)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__SPATIAL_RESOLUTION,
  ...
  public EList<StyleVariationType> getStyleVariation() {
    if (styleVariation == null) {
      styleVariation =
          new EObjectContainmentEList<StyleVariationType>(
              StyleVariationType.class,
              this,
              Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__STYLE_VARIATION);
    }
  ...
  public EList<AnimateType> getAnimate() {
    if (animate == null) {
      animate =
          new EObjectContainmentEList<AnimateType>(
              AnimateType.class, this, Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__ANIMATE);
    }
    return animate;
  }
  ...
  public EList<AnimateMotionType> getAnimateMotion() {
    if (animateMotion == null) {
      animateMotion =
          new EObjectContainmentEList<AnimateMotionType>(
              AnimateMotionType.class,
              this,
              Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__ANIMATE_MOTION);
    }
  ...
  public EList<AnimateColorType> getAnimateColor() {
    if (animateColor == null) {
      animateColor =
          new EObjectContainmentEList<AnimateColorType>(
              AnimateColorType.class,
              this,
              Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__ANIMATE_COLOR);
    }
    return animateColor;
  }
  ...
  public EList<SetType> getSet() {
    if (set == null) {
      set =
          new EObjectContainmentEList<SetType>(
              SetType.class, this, Gml311Package.BASE_STYLE_DESCRIPTOR_TYPE__SET);
    }
    return set;
  }
