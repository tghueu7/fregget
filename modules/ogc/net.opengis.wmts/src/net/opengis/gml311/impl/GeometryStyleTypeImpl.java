 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeometryStyleTypeImpl#getSymbol <em>Symbol</em>}
 *   <li>{@link net.opengis.gml311.impl.GeometryStyleTypeImpl#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.impl.GeometryStyleTypeImpl#getLabelStyle <em>Label Style</em>}
 *   <li>{@link net.opengis.gml311.impl.GeometryStyleTypeImpl#getGeometryProperty <em>Geometry
 *       Property</em>}
 *   <li>{@link net.opengis.gml311.impl.GeometryStyleTypeImpl#getGeometryType <em>Geometry
 *       Type</em>}
 * </ul>
 *
 * @generated
 */
public class GeometryStyleTypeImpl extends BaseStyleDescriptorTypeImpl
    implements GeometryStyleType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOMETRY_STYLE_TYPE__SYMBOL,
              oldSymbol,
              newSymbol);
      ...
      if (symbol != null)
        msgs =
            ((InternalEObject) symbol)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOMETRY_STYLE_TYPE__SYMBOL,
                    null,
                    msgs);
      if (newSymbol != null)
        msgs =
  ...
  public void setStyle(String newStyle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GEOMETRY_STYLE_TYPE__STYLE, oldStyle, style));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOMETRY_STYLE_TYPE__LABEL_STYLE,
              oldLabelStyle,
              newLabelStyle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (labelStyle != null)
        msgs =
            ((InternalEObject) labelStyle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOMETRY_STYLE_TYPE__LABEL_STYLE,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOMETRY_STYLE_TYPE__GEOMETRY_PROPERTY,
              oldGeometryProperty,
              geometryProperty));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOMETRY_STYLE_TYPE__GEOMETRY_TYPE,
              oldGeometryType,
              geometryType));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.GEOMETRY_STYLE_TYPE__GEOMETRY_PROPERTY:
        return GEOMETRY_PROPERTY_EDEFAULT == null
            ? geometryProperty != null
            : !GEOMETRY_PROPERTY_EDEFAULT.equals(geometryProperty);
      case Gml311Package.GEOMETRY_STYLE_TYPE__GEOMETRY_TYPE:
        return GEOMETRY_TYPE_EDEFAULT == null
            ? geometryType != null
            : !GEOMETRY_TYPE_EDEFAULT.equals(geometryType);
    }
