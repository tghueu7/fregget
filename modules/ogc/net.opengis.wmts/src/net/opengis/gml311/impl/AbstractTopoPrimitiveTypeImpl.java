 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractTopoPrimitiveTypeImpl#getIsolated <em>Isolated</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractTopoPrimitiveTypeImpl#getContainer
 *       <em>Container</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTopoPrimitiveTypeImpl extends AbstractTopologyTypeImpl
    implements AbstractTopoPrimitiveType {
  /**
  ...
  public EList<IsolatedPropertyType> getIsolated() {
    if (isolated == null) {
      isolated =
          new EObjectContainmentEList<IsolatedPropertyType>(
              IsolatedPropertyType.class,
              this,
              Gml311Package.ABSTRACT_TOPO_PRIMITIVE_TYPE__ISOLATED);
    }
    return isolated;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER,
              oldContainer,
              newContainer);
      ...
      if (container != null)
        msgs =
            ((InternalEObject) container)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_TOPO_PRIMITIVE_TYPE__CONTAINER,
                    null,
                    msgs);
