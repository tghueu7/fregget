 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PrimeMeridianTypeImpl#getMeridianID <em>Meridian ID</em>}
 *   <li>{@link net.opengis.gml311.impl.PrimeMeridianTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.PrimeMeridianTypeImpl#getGreenwichLongitude <em>Greenwich
 *       Longitude</em>}
 * </ul>
 *
 * @generated
...
public class PrimeMeridianTypeImpl extends PrimeMeridianBaseTypeImpl implements PrimeMeridianType {
  /**
   * The cached value of the '{@link #getMeridianID() <em>Meridian ID</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getGreenwichLongitude() <em>Greenwich Longitude</em>}'
    ...
    if (meridianID == null) {
      meridianID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.PRIME_MERIDIAN_TYPE__MERIDIAN_ID);
    }
    return meridianID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PRIME_MERIDIAN_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PRIME_MERIDIAN_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PRIME_MERIDIAN_TYPE__GREENWICH_LONGITUDE,
              oldGreenwichLongitude,
  ...
  public void setGreenwichLongitude(AngleChoiceType newGreenwichLongitude) {
    if (newGreenwichLongitude != greenwichLongitude) {
      ...
      if (greenwichLongitude != null)
        msgs =
            ((InternalEObject) greenwichLongitude)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PRIME_MERIDIAN_TYPE__GREENWICH_LONGITUDE,
                    null,
                    msgs);
      if (newGreenwichLongitude != null)
        msgs =
            ((InternalEObject) newGreenwichLongitude)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.PRIME_MERIDIAN_TYPE__GREENWICH_LONGITUDE,
                    null,
