 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EnvelopeWithTimePeriodTypeImpl#getTimePosition <em>Time
 *       Position</em>}
 *   <li>{@link net.opengis.gml311.impl.EnvelopeWithTimePeriodTypeImpl#getFrame <em>Frame</em>}
 * </ul>
 *
 * @generated
 */
public class EnvelopeWithTimePeriodTypeImpl extends EnvelopeTypeImpl
    implements EnvelopeWithTimePeriodType {
  /**
   * The cached value of the '{@link #getTimePosition() <em>Time Position</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TimePositionType> getTimePosition() {
    if (timePosition == null) {
      timePosition =
          new EObjectContainmentEList<TimePositionType>(
              TimePositionType.class,
              this,
              Gml311Package.ENVELOPE_WITH_TIME_PERIOD_TYPE__TIME_POSITION);
    }
    return timePosition;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENVELOPE_WITH_TIME_PERIOD_TYPE__FRAME,
              oldFrame,
              frame,
              !oldFrameESet));
  }
