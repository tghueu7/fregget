 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TinTypeImpl#getStopLines <em>Stop Lines</em>}
 *   <li>{@link net.opengis.gml311.impl.TinTypeImpl#getBreakLines <em>Break Lines</em>}
 *   <li>{@link net.opengis.gml311.impl.TinTypeImpl#getMaxLength <em>Max Length</em>}
 *   <li>{@link net.opengis.gml311.impl.TinTypeImpl#getControlPoint <em>Control Point</em>}
 * </ul>
 *
 * @generated
 */
public class TinTypeImpl extends TriangulatedSurfaceTypeImpl implements TinType {
  /**
   * The cached value of the '{@link #getStopLines() <em>Stop Lines</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getBreakLines() <em>Break Lines</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getControlPoint() <em>Control Point</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<LineStringSegmentArrayPropertyType> getStopLines() {
    if (stopLines == null) {
      stopLines =
          new EObjectContainmentEList<LineStringSegmentArrayPropertyType>(
              LineStringSegmentArrayPropertyType.class, this, Gml311Package.TIN_TYPE__STOP_LINES);
    }
    return stopLines;
  }
  ...
  public EList<LineStringSegmentArrayPropertyType> getBreakLines() {
    if (breakLines == null) {
      breakLines =
          new EObjectContainmentEList<LineStringSegmentArrayPropertyType>(
              LineStringSegmentArrayPropertyType.class, this, Gml311Package.TIN_TYPE__BREAK_LINES);
    }
    return breakLines;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIN_TYPE__MAX_LENGTH,
              oldMaxLength,
              newMaxLength);
  ...
  public void setMaxLength(LengthType newMaxLength) {
    if (newMaxLength != maxLength) {
      ...
      if (maxLength != null)
        msgs =
            ((InternalEObject) maxLength)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIN_TYPE__MAX_LENGTH, null, msgs);
      if (newMaxLength != null)
        msgs =
            ((InternalEObject) newMaxLength)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.TIN_TYPE__MAX_LENGTH, null, msgs);
   ...
   * @generated
   */
  public NotificationChain basicSetControlPoint(
      ControlPointType newControlPoint, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIN_TYPE__CONTROL_POINT,
              oldControlPoint,
              newControlPoint);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setControlPoint(ControlPointType newControlPoint) {
    if (newControlPoint != controlPoint) {
      ...
      if (controlPoint != null)
        msgs =
            ((InternalEObject) controlPoint)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIN_TYPE__CONTROL_POINT,
                    null,
                    msgs);
      if (newControlPoint != null)
        msgs =
            ((InternalEObject) newControlPoint)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIN_TYPE__CONTROL_POINT,
                    null,
