 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CovarianceElementTypeImpl#getRowIndex <em>Row Index</em>}
 *   <li>{@link net.opengis.gml311.impl.CovarianceElementTypeImpl#getColumnIndex <em>Column
 *       Index</em>}
 *   <li>{@link net.opengis.gml311.impl.CovarianceElementTypeImpl#getCovariance <em>Covariance</em>}
 * </ul>
 *
 * @generated
 */
public class CovarianceElementTypeImpl extends MinimalEObjectImpl.Container
    implements CovarianceElementType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COVARIANCE_ELEMENT_TYPE__ROW_INDEX,
              oldRowIndex,
              rowIndex));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COVARIANCE_ELEMENT_TYPE__COLUMN_INDEX,
              oldColumnIndex,
              columnIndex));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COVARIANCE_ELEMENT_TYPE__COVARIANCE,
              oldCovariance,
              covariance,
              !oldCovarianceESet));
  }
    ...
    switch (featureID) {
      ...
      case Gml311Package.COVARIANCE_ELEMENT_TYPE__COLUMN_INDEX:
        return COLUMN_INDEX_EDEFAULT == null
            ? columnIndex != null
            : !COLUMN_INDEX_EDEFAULT.equals(columnIndex);
      case Gml311Package.COVARIANCE_ELEMENT_TYPE__COVARIANCE:
  ...
  public String toString() {
    ...
    if (covarianceESet) result.append(covariance);
