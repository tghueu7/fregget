 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DictionaryTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.DictionaryTypeImpl#getDictionaryEntryGroup <em>Dictionary
 *       Entry Group</em>}
 *   <li>{@link net.opengis.gml311.impl.DictionaryTypeImpl#getDictionaryEntry <em>Dictionary
 *       Entry</em>}
 *   <li>{@link net.opengis.gml311.impl.DictionaryTypeImpl#getIndirectEntry <em>Indirect Entry</em>}
 * </ul>
 *
 * @generated
 */
public class DictionaryTypeImpl extends DefinitionTypeImpl implements DictionaryType {
    ...
    return (FeatureMap)
        getGroup()
            .<FeatureMap.Entry>list(
                Gml311Package.eINSTANCE.getDictionaryType_DictionaryEntryGroup());
  }
  ...
  public EList<DictionaryEntryType> getDictionaryEntry() {
    return getDictionaryEntryGroup()
        .list(Gml311Package.eINSTANCE.getDictionaryType_DictionaryEntry());
  }
