 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GridDomainTypeImpl#getGrid <em>Grid</em>}
 * </ul>
 *
 * @generated
 */
public class GridDomainTypeImpl extends DomainSetTypeImpl implements GridDomainType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GRID_DOMAIN_TYPE__GRID, oldGrid, newGrid);
  ...
  public void setGrid(GridType newGrid) {
    if (newGrid != grid) {
      ...
      if (grid != null)
        msgs =
            ((InternalEObject) grid)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_DOMAIN_TYPE__GRID,
                    null,
                    msgs);
      if (newGrid != null)
        msgs =
            ((InternalEObject) newGrid)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_DOMAIN_TYPE__GRID,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.GRID_DOMAIN_TYPE__GRID, newGrid, newGrid));
  }
