 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EngineeringCRSTypeImpl#getUsesCS <em>Uses CS</em>}
 *   <li>{@link net.opengis.gml311.impl.EngineeringCRSTypeImpl#getUsesEngineeringDatum <em>Uses
 *       Engineering Datum</em>}
 * </ul>
 *
 * @generated
 */
public class EngineeringCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements EngineeringCRSType {
  /**
  ...
  /**
   * The cached value of the '{@link #getUsesEngineeringDatum() <em>Uses Engineering Datum</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENGINEERING_CRS_TYPE__USES_CS,
              oldUsesCS,
              newUsesCS);
  ...
  public void setUsesCS(CoordinateSystemRefType newUsesCS) {
    if (newUsesCS != usesCS) {
      ...
      if (usesCS != null)
        msgs =
            ((InternalEObject) usesCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENGINEERING_CRS_TYPE__USES_CS,
                    null,
                    msgs);
      if (newUsesCS != null)
        msgs =
            ((InternalEObject) newUsesCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ENGINEERING_CRS_TYPE__USES_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ENGINEERING_CRS_TYPE__USES_ENGINEERING_DATUM,
              oldUsesEngineeringDatum,
  ...
  public void setUsesEngineeringDatum(EngineeringDatumRefType newUsesEngineeringDatum) {
    if (newUsesEngineeringDatum != usesEngineeringDatum) {
      ...
      if (usesEngineeringDatum != null)
        msgs =
            ((InternalEObject) usesEngineeringDatum)
                .eInverseRemove(
                    this,
      ...
      if (newUsesEngineeringDatum != null)
        msgs =
            ((InternalEObject) newUsesEngineeringDatum)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ENGINEERING_CRS_TYPE__USES_ENGINEERING_DATUM,
