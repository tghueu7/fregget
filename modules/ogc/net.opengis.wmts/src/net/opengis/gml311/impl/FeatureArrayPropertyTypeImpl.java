 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.FeatureArrayPropertyTypeImpl#getFeatureGroup <em>Feature
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.FeatureArrayPropertyTypeImpl#getFeature <em>Feature</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements FeatureArrayPropertyType {
  /**
  ...
  public FeatureMap getFeatureGroup() {
    if (featureGroup == null) {
      featureGroup =
          new BasicFeatureMap(this, Gml311Package.FEATURE_ARRAY_PROPERTY_TYPE__FEATURE_GROUP);
    }
    return featureGroup;
  }
