 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateSystemTypeImpl#getCsID <em>Cs ID</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateSystemTypeImpl#getRemarks
 *       <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateSystemTypeImpl#getUsesAxis <em>Uses
 *       Axis</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCoordinateSystemTypeImpl extends AbstractCoordinateSystemBaseTypeImpl
    implements AbstractCoordinateSystemType {
  /**
    ...
    if (csID == null) {
      csID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.ABSTRACT_COORDINATE_SYSTEM_TYPE__CS_ID);
    }
    return csID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_SYSTEM_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_COORDINATE_SYSTEM_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
  ...
  public EList<CoordinateSystemAxisRefType> getUsesAxis() {
    if (usesAxis == null) {
      usesAxis =
          new EObjectContainmentEList<CoordinateSystemAxisRefType>(
              CoordinateSystemAxisRefType.class,
              this,
              Gml311Package.ABSTRACT_COORDINATE_SYSTEM_TYPE__USES_AXIS);
    }
    return usesAxis;
  }
