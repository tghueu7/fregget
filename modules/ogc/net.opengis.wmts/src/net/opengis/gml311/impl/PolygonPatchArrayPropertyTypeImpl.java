 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchArrayPropertyTypeImpl#getPolygonPatch
 *       <em>Polygon Patch</em>}
 * </ul>
 *
 * @generated
 */
public class PolygonPatchArrayPropertyTypeImpl extends SurfacePatchArrayPropertyTypeImpl
    implements PolygonPatchArrayPropertyType {
  /**
   * The cached value of the '{@link #getPolygonPatch() <em>Polygon Patch</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<PolygonPatchType> getPolygonPatch() {
    if (polygonPatch == null) {
      polygonPatch =
          new EObjectContainmentEList<PolygonPatchType>(
              PolygonPatchType.class,
              this,
              Gml311Package.POLYGON_PATCH_ARRAY_PROPERTY_TYPE__POLYGON_PATCH);
    }
    return polygonPatch;
  }
