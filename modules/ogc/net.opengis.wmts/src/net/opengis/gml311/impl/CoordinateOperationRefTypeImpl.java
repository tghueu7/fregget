 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getCoordinateOperationGroup
 *       <em>Coordinate Operation Group</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getCoordinateOperation
 *       <em>Coordinate Operation</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateOperationRefTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class CoordinateOperationRefTypeImpl extends MinimalEObjectImpl.Container
    implements CoordinateOperationRefType {
  /**
   * The cached value of the '{@link #getCoordinateOperationGroup() <em>Coordinate Operation
  ...
  public FeatureMap getCoordinateOperationGroup() {
    if (coordinateOperationGroup == null) {
      coordinateOperationGroup =
          new BasicFeatureMap(
              this, Gml311Package.COORDINATE_OPERATION_REF_TYPE__COORDINATE_OPERATION_GROUP);
    }
  ...
  public AbstractCoordinateOperationType getCoordinateOperation() {
    return (AbstractCoordinateOperationType)
        getCoordinateOperationGroup()
            .get(Gml311Package.eINSTANCE.getCoordinateOperationRefType_CoordinateOperation(), true);
  }
  ...
  public NotificationChain basicSetCoordinateOperation(
    ...
    return ((FeatureMap.Internal) getCoordinateOperationGroup())
        .basicAdd(
            Gml311Package.eINSTANCE.getCoordinateOperationRefType_CoordinateOperation(),
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__HREF,
              oldHref,
              href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__ROLE,
              oldRole,
              role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_OPERATION_REF_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
