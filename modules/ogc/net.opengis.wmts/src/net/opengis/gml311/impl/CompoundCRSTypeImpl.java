 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CompoundCRSTypeImpl#getIncludesCRS <em>Includes CRS</em>}
 * </ul>
 *
 * @generated
 */
public class CompoundCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements CompoundCRSType {
  /**
   * The cached value of the '{@link #getIncludesCRS() <em>Includes CRS</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<CoordinateReferenceSystemRefType> getIncludesCRS() {
    if (includesCRS == null) {
      includesCRS =
          new EObjectContainmentEList<CoordinateReferenceSystemRefType>(
              CoordinateReferenceSystemRefType.class,
              this,
              Gml311Package.COMPOUND_CRS_TYPE__INCLUDES_CRS);
    }
    return includesCRS;
  }
