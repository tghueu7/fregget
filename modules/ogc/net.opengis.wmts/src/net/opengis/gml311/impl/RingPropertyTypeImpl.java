 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RingPropertyTypeImpl#getRing <em>Ring</em>}
 * </ul>
 *
 * @generated
 */
public class RingPropertyTypeImpl extends MinimalEObjectImpl.Container implements RingPropertyType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.RING_PROPERTY_TYPE__RING, oldRing, newRing);
  ...
  public void setRing(RingType newRing) {
    if (newRing != ring) {
      ...
      if (ring != null)
        msgs =
            ((InternalEObject) ring)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.RING_PROPERTY_TYPE__RING,
                    null,
                    msgs);
      if (newRing != null)
        msgs =
            ((InternalEObject) newRing)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.RING_PROPERTY_TYPE__RING,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.RING_PROPERTY_TYPE__RING, newRing, newRing));
  }
