 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getFace <em>Face</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getTopoSolid <em>Topo Solid</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.ContainerPropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class ContainerPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements ContainerPropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__FACE,
              oldFace,
              newFace);
  ...
  public void setFace(FaceType newFace) {
    if (newFace != face) {
      ...
      if (face != null)
        msgs =
            ((InternalEObject) face)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CONTAINER_PROPERTY_TYPE__FACE,
                    null,
                    msgs);
      if (newFace != null)
        msgs =
            ((InternalEObject) newFace)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CONTAINER_PROPERTY_TYPE__FACE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__TOPO_SOLID,
              oldTopoSolid,
              newTopoSolid);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (topoSolid != null)
        msgs =
            ((InternalEObject) topoSolid)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CONTAINER_PROPERTY_TYPE__TOPO_SOLID,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.CONTAINER_PROPERTY_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.CONTAINER_PROPERTY_TYPE__ROLE, oldRole, role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CONTAINER_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
