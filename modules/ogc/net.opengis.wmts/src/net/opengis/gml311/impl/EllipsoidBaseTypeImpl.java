 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EllipsoidBaseTypeImpl#getEllipsoidName <em>Ellipsoid
 *       Name</em>}
 * </ul>
 *
 * @generated
 */
public abstract class EllipsoidBaseTypeImpl extends DefinitionTypeImpl
    implements EllipsoidBaseType {
  /**
   * The cached value of the '{@link #getEllipsoidName() <em>Ellipsoid Name</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ELLIPSOID_BASE_TYPE__ELLIPSOID_NAME,
              oldEllipsoidName,
              newEllipsoidName);
  ...
  public void setEllipsoidName(CodeType newEllipsoidName) {
    if (newEllipsoidName != ellipsoidName) {
      ...
      if (ellipsoidName != null)
        msgs =
            ((InternalEObject) ellipsoidName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ELLIPSOID_BASE_TYPE__ELLIPSOID_NAME,
                    null,
                    msgs);
      if (newEllipsoidName != null)
        msgs =
            ((InternalEObject) newEllipsoidName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ELLIPSOID_BASE_TYPE__ELLIPSOID_NAME,
                    null,
