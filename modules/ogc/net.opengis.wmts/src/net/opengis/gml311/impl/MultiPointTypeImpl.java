 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiPointTypeImpl#getPointMember <em>Point Member</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiPointTypeImpl#getPointMembers <em>Point Members</em>}
 * </ul>
 *
 * @generated
 */
public class MultiPointTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiPointType {
  /**
   * The cached value of the '{@link #getPointMember() <em>Point Member</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getPointMembers() <em>Point Members</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<PointPropertyType> getPointMember() {
    if (pointMember == null) {
      pointMember =
          new EObjectContainmentEList<PointPropertyType>(
              PointPropertyType.class, this, Gml311Package.MULTI_POINT_TYPE__POINT_MEMBER);
    }
    return pointMember;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_POINT_TYPE__POINT_MEMBERS,
              oldPointMembers,
              newPointMembers);
  ...
  public void setPointMembers(PointArrayPropertyType newPointMembers) {
    if (newPointMembers != pointMembers) {
      ...
      if (pointMembers != null)
        msgs =
            ((InternalEObject) pointMembers)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_POINT_TYPE__POINT_MEMBERS,
                    null,
                    msgs);
      if (newPointMembers != null)
        msgs =
            ((InternalEObject) newPointMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_POINT_TYPE__POINT_MEMBERS,
                    null,
