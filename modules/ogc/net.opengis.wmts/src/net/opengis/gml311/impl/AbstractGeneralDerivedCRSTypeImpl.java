 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractGeneralDerivedCRSTypeImpl#getBaseCRS <em>Base
 *       CRS</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractGeneralDerivedCRSTypeImpl#getDefinedByConversion
 *       <em>Defined By Conversion</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractGeneralDerivedCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements AbstractGeneralDerivedCRSType {
  /**
  ...
  /**
   * The cached value of the '{@link #getDefinedByConversion() <em>Defined By Conversion</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_GENERAL_DERIVED_CRS_TYPE__BASE_CRS,
              oldBaseCRS,
              newBaseCRS);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_GENERAL_DERIVED_CRS_TYPE__DEFINED_BY_CONVERSION,
              oldDefinedByConversion,
  ...
  public void setDefinedByConversion(GeneralConversionRefType newDefinedByConversion) {
    if (newDefinedByConversion != definedByConversion) {
      ...
      if (definedByConversion != null)
        msgs =
            ((InternalEObject) definedByConversion)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ABSTRACT_GENERAL_DERIVED_CRS_TYPE__DEFINED_BY_CONVERSION,
      ...
      if (newDefinedByConversion != null)
        msgs =
            ((InternalEObject) newDefinedByConversion)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ABSTRACT_GENERAL_DERIVED_CRS_TYPE__DEFINED_BY_CONVERSION,
