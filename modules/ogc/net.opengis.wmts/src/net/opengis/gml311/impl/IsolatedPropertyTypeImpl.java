 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getNode <em>Node</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getEdge <em>Edge</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.IsolatedPropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class IsolatedPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements IsolatedPropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ISOLATED_PROPERTY_TYPE__NODE, oldNode, newNode);
  ...
  public void setNode(NodeType newNode) {
    if (newNode != node) {
      ...
      if (node != null)
        msgs =
            ((InternalEObject) node)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ISOLATED_PROPERTY_TYPE__NODE,
                    null,
                    msgs);
      if (newNode != null)
        msgs =
            ((InternalEObject) newNode)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ISOLATED_PROPERTY_TYPE__NODE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__NODE,
              newNode,
              newNode));
  }
  ...
  public NotificationChain basicSetEdge(EdgeType newEdge, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ISOLATED_PROPERTY_TYPE__EDGE, oldEdge, newEdge);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setEdge(EdgeType newEdge) {
    if (newEdge != edge) {
      ...
      if (edge != null)
        msgs =
            ((InternalEObject) edge)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ISOLATED_PROPERTY_TYPE__EDGE,
                    null,
                    msgs);
      if (newEdge != null)
        msgs =
            ((InternalEObject) newEdge)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ISOLATED_PROPERTY_TYPE__EDGE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__EDGE,
              newEdge,
              newEdge));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
  ...
  public void setHref(String newHref) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ISOLATED_PROPERTY_TYPE__HREF, oldHref, href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
  ...
  public void setRole(String newRole) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ISOLATED_PROPERTY_TYPE__ROLE, oldRole, role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ISOLATED_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
