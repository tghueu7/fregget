 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getLocationGroup <em>Location
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getLocation <em>Location</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getSpeed <em>Speed</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getBearing <em>Bearing</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getAcceleration
 *       <em>Acceleration</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getElevation <em>Elevation</em>}
 *   <li>{@link net.opengis.gml311.impl.MovingObjectStatusTypeImpl#getStatus <em>Status</em>}
 * </ul>
 *
 * @generated
 */
public class MovingObjectStatusTypeImpl extends AbstractTimeSliceTypeImpl
  ...
  /**
   * The cached value of the '{@link #getAcceleration() <em>Acceleration</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getLocationGroup() {
    if (locationGroup == null) {
      locationGroup =
          new BasicFeatureMap(this, Gml311Package.MOVING_OBJECT_STATUS_TYPE__LOCATION_GROUP);
    }
  ...
  public LocationPropertyType getLocation() {
    return (LocationPropertyType)
        getLocationGroup().get(Gml311Package.eINSTANCE.getMovingObjectStatusType_Location(), true);
  }
  ...
  public NotificationChain basicSetLocation(
    ...
    return ((FeatureMap.Internal) getLocationGroup())
        .basicAdd(Gml311Package.eINSTANCE.getMovingObjectStatusType_Location(), newLocation, msgs);
  }
  ...
  public void setLocation(LocationPropertyType newLocation) {
    ((FeatureMap.Internal) getLocationGroup())
        .set(Gml311Package.eINSTANCE.getMovingObjectStatusType_Location(), newLocation);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MOVING_OBJECT_STATUS_TYPE__SPEED,
              oldSpeed,
              newSpeed);
  ...
  public void setSpeed(MeasureType newSpeed) {
    if (newSpeed != speed) {
      ...
      if (speed != null)
        msgs =
            ((InternalEObject) speed)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__SPEED,
                    null,
                    msgs);
      if (newSpeed != null)
        msgs =
            ((InternalEObject) newSpeed)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__SPEED,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetBearing(
      DirectionPropertyType newBearing, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MOVING_OBJECT_STATUS_TYPE__BEARING,
              oldBearing,
              newBearing);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setBearing(DirectionPropertyType newBearing) {
    if (newBearing != bearing) {
      ...
      if (bearing != null)
        msgs =
            ((InternalEObject) bearing)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__BEARING,
                    null,
                    msgs);
      if (newBearing != null)
        msgs =
            ((InternalEObject) newBearing)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__BEARING,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetAcceleration(
      MeasureType newAcceleration, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MOVING_OBJECT_STATUS_TYPE__ACCELERATION,
              oldAcceleration,
              newAcceleration);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAcceleration(MeasureType newAcceleration) {
    if (newAcceleration != acceleration) {
      ...
      if (acceleration != null)
        msgs =
            ((InternalEObject) acceleration)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__ACCELERATION,
                    null,
                    msgs);
      if (newAcceleration != null)
        msgs =
            ((InternalEObject) newAcceleration)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__ACCELERATION,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MOVING_OBJECT_STATUS_TYPE__ELEVATION,
              oldElevation,
              newElevation);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setElevation(MeasureType newElevation) {
    if (newElevation != elevation) {
      ...
      if (elevation != null)
        msgs =
            ((InternalEObject) elevation)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__ELEVATION,
                    null,
                    msgs);
      if (newElevation != null)
        msgs =
            ((InternalEObject) newElevation)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__ELEVATION,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MOVING_OBJECT_STATUS_TYPE__STATUS,
              oldStatus,
              newStatus);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setStatus(StringOrRefType newStatus) {
    if (newStatus != status) {
      ...
      if (status != null)
        msgs =
            ((InternalEObject) status)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__STATUS,
                    null,
                    msgs);
      if (newStatus != null)
        msgs =
            ((InternalEObject) newStatus)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MOVING_OBJECT_STATUS_TYPE__STATUS,
                    null,
