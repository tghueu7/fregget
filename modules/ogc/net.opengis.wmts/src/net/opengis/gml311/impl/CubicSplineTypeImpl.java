 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getPointProperty <em>Point
 *       Property</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getVectorAtStart <em>Vector At
 *       Start</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getVectorAtEnd <em>Vector At End</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getDegree <em>Degree</em>}
 *   <li>{@link net.opengis.gml311.impl.CubicSplineTypeImpl#getInterpolation <em>Interpolation</em>}
 * </ul>
 *
 * @generated
 */
public class CubicSplineTypeImpl extends AbstractCurveSegmentTypeImpl implements CubicSplineType {
  ...
  /**
   * The cached value of the '{@link #getVectorAtStart() <em>Vector At Start</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getVectorAtEnd() <em>Vector At End</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  protected static final CurveInterpolationType INTERPOLATION_EDEFAULT =
      CurveInterpolationType.CUBIC_SPLINE;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__POS_LIST,
              oldPosList,
              newPosList);
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__COORDINATES,
                    null,
                    msgs);
   ...
   * @generated
   */
  public NotificationChain basicSetVectorAtStart(
      VectorType newVectorAtStart, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_START,
              oldVectorAtStart,
              newVectorAtStart);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setVectorAtStart(VectorType newVectorAtStart) {
    if (newVectorAtStart != vectorAtStart) {
      ...
      if (vectorAtStart != null)
        msgs =
            ((InternalEObject) vectorAtStart)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_START,
                    null,
                    msgs);
      if (newVectorAtStart != null)
        msgs =
            ((InternalEObject) newVectorAtStart)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_START,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_END,
              oldVectorAtEnd,
              newVectorAtEnd);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setVectorAtEnd(VectorType newVectorAtEnd) {
    if (newVectorAtEnd != vectorAtEnd) {
      ...
      if (vectorAtEnd != null)
        msgs =
            ((InternalEObject) vectorAtEnd)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_END,
                    null,
                    msgs);
      if (newVectorAtEnd != null)
        msgs =
            ((InternalEObject) newVectorAtEnd)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.CUBIC_SPLINE_TYPE__VECTOR_AT_END,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__DEGREE,
              oldDegree,
              degree,
              !oldDegreeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CUBIC_SPLINE_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
  ...
  public String toString() {
    ...
    if (degreeESet) result.append(degree);
