 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiSurfaceCoverageTypeImpl#getMultiSurfaceDomain <em>Multi
 *       Surface Domain</em>}
 * </ul>
 *
 * @generated
 */
public class MultiSurfaceCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements MultiSurfaceCoverageType {
  /**
   * The cached value of the '{@link #getMultiSurfaceDomain() <em>Multi Surface Domain</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_SURFACE_COVERAGE_TYPE__MULTI_SURFACE_DOMAIN,
              oldMultiSurfaceDomain,
  ...
  public void setMultiSurfaceDomain(MultiSurfaceDomainType newMultiSurfaceDomain) {
    if (newMultiSurfaceDomain != multiSurfaceDomain) {
      ...
      if (multiSurfaceDomain != null)
        msgs =
            ((InternalEObject) multiSurfaceDomain)
                .eInverseRemove(
                    this,
      ...
      if (newMultiSurfaceDomain != null)
        msgs =
            ((InternalEObject) newMultiSurfaceDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.MULTI_SURFACE_COVERAGE_TYPE__MULTI_SURFACE_DOMAIN,
