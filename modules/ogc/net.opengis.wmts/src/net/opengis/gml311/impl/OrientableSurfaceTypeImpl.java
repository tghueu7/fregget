 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OrientableSurfaceTypeImpl#getBaseSurface <em>Base
 *       Surface</em>}
 *   <li>{@link net.opengis.gml311.impl.OrientableSurfaceTypeImpl#getOrientation
 *       <em>Orientation</em>}
 * </ul>
 *
 * @generated
 */
public class OrientableSurfaceTypeImpl extends AbstractSurfaceTypeImpl
    implements OrientableSurfaceType {
  /**
   * The cached value of the '{@link #getBaseSurface() <em>Base Surface</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ORIENTABLE_SURFACE_TYPE__BASE_SURFACE,
              oldBaseSurface,
              newBaseSurface);
  ...
  public void setBaseSurface(SurfacePropertyType newBaseSurface) {
    if (newBaseSurface != baseSurface) {
      ...
      if (baseSurface != null)
        msgs =
            ((InternalEObject) baseSurface)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ORIENTABLE_SURFACE_TYPE__BASE_SURFACE,
                    null,
                    msgs);
      if (newBaseSurface != null)
        msgs =
            ((InternalEObject) newBaseSurface)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ORIENTABLE_SURFACE_TYPE__BASE_SURFACE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ORIENTABLE_SURFACE_TYPE__ORIENTATION,
              oldOrientation,
              orientation,
              !oldOrientationESet));
  }
