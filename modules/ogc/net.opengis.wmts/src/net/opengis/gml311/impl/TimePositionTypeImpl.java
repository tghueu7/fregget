 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimePositionTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePositionTypeImpl#getCalendarEraName <em>Calendar Era
 *       Name</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePositionTypeImpl#getFrame <em>Frame</em>}
 *   <li>{@link net.opengis.gml311.impl.TimePositionTypeImpl#getIndeterminatePosition
 *       <em>Indeterminate Position</em>}
 * </ul>
 *
 * @generated
 */
public class TimePositionTypeImpl extends MinimalEObjectImpl.Container implements TimePositionType {
  ...
  /**
   * The default value of the '{@link #getIndeterminatePosition() <em>Indeterminate Position</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  protected static final TimeIndeterminateValueType INDETERMINATE_POSITION_EDEFAULT =
      TimeIndeterminateValueType.AFTER;

  /**
   * The cached value of the '{@link #getIndeterminatePosition() <em>Indeterminate Position</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_POSITION_TYPE__VALUE, oldValue, value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_POSITION_TYPE__CALENDAR_ERA_NAME,
              oldCalendarEraName,
              calendarEraName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_POSITION_TYPE__FRAME,
              oldFrame,
              frame,
              !oldFrameESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_POSITION_TYPE__INDETERMINATE_POSITION,
              oldIndeterminatePosition,
              indeterminatePosition,
              !oldIndeterminatePositionESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.TIME_POSITION_TYPE__CALENDAR_ERA_NAME:
        return CALENDAR_ERA_NAME_EDEFAULT == null
            ? calendarEraName != null
            : !CALENDAR_ERA_NAME_EDEFAULT.equals(calendarEraName);
      case Gml311Package.TIME_POSITION_TYPE__FRAME:
        return isSetFrame();
      case Gml311Package.TIME_POSITION_TYPE__INDETERMINATE_POSITION:
  ...
  public String toString() {
    ...
    if (indeterminatePositionESet) result.append(indeterminatePosition);
    else result.append("<unset>");
    result.append(')');
