 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiSolidCoverageTypeImpl#getMultiSolidDomain <em>Multi
 *       Solid Domain</em>}
 * </ul>
 *
 * @generated
 */
public class MultiSolidCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements MultiSolidCoverageType {
  /**
   * The cached value of the '{@link #getMultiSolidDomain() <em>Multi Solid Domain</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_SOLID_COVERAGE_TYPE__MULTI_SOLID_DOMAIN,
              oldMultiSolidDomain,
              newMultiSolidDomain);
  ...
  public void setMultiSolidDomain(MultiSolidDomainType newMultiSolidDomain) {
    if (newMultiSolidDomain != multiSolidDomain) {
      ...
      if (multiSolidDomain != null)
        msgs =
            ((InternalEObject) multiSolidDomain)
                .eInverseRemove(
                    this,
      ...
      if (newMultiSolidDomain != null)
        msgs =
            ((InternalEObject) newMultiSolidDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.MULTI_SOLID_COVERAGE_TYPE__MULTI_SOLID_DOMAIN,
