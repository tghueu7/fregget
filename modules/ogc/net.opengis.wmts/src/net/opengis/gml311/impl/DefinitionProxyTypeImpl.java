 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DefinitionProxyTypeImpl#getDefinitionRef <em>Definition
 *       Ref</em>}
 * </ul>
 *
 * @generated
...
public class DefinitionProxyTypeImpl extends DefinitionTypeImpl implements DefinitionProxyType {
  /**
   * The cached value of the '{@link #getDefinitionRef() <em>Definition Ref</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DEFINITION_PROXY_TYPE__DEFINITION_REF,
              oldDefinitionRef,
              newDefinitionRef);
  ...
  public void setDefinitionRef(ReferenceType newDefinitionRef) {
    if (newDefinitionRef != definitionRef) {
      ...
      if (definitionRef != null)
        msgs =
            ((InternalEObject) definitionRef)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DEFINITION_PROXY_TYPE__DEFINITION_REF,
                    null,
                    msgs);
      if (newDefinitionRef != null)
        msgs =
            ((InternalEObject) newDefinitionRef)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DEFINITION_PROXY_TYPE__DEFINITION_REF,
                    null,
