 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractFeatureTypeImpl#getBoundedBy <em>Bounded By</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractFeatureTypeImpl#getLocationGroup <em>Location
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractFeatureTypeImpl#getLocation <em>Location</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractFeatureTypeImpl extends AbstractGMLTypeImpl
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_FEATURE_TYPE__BOUNDED_BY,
              oldBoundedBy,
              newBoundedBy);
  ...
  public void setBoundedBy(BoundingShapeType newBoundedBy) {
    if (newBoundedBy != boundedBy) {
      ...
      if (boundedBy != null)
        msgs =
            ((InternalEObject) boundedBy)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_FEATURE_TYPE__BOUNDED_BY,
                    null,
                    msgs);
      if (newBoundedBy != null)
        msgs =
            ((InternalEObject) newBoundedBy)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_FEATURE_TYPE__BOUNDED_BY,
                    null,
  ...
  public FeatureMap getLocationGroup() {
    if (locationGroup == null) {
      locationGroup =
          new BasicFeatureMap(this, Gml311Package.ABSTRACT_FEATURE_TYPE__LOCATION_GROUP);
    }
  ...
  public LocationPropertyType getLocation() {
    return (LocationPropertyType)
        getLocationGroup().get(Gml311Package.eINSTANCE.getAbstractFeatureType_Location(), true);
  }
  ...
  public NotificationChain basicSetLocation(
    ...
    return ((FeatureMap.Internal) getLocationGroup())
        .basicAdd(Gml311Package.eINSTANCE.getAbstractFeatureType_Location(), newLocation, msgs);
  }
  ...
  public void setLocation(LocationPropertyType newLocation) {
    ((FeatureMap.Internal) getLocationGroup())
        .set(Gml311Package.eINSTANCE.getAbstractFeatureType_Location(), newLocation);
  }
