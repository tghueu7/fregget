 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractCoverageTypeImpl#getDomainSetGroup <em>Domain Set
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoverageTypeImpl#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoverageTypeImpl#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoverageTypeImpl#getDimension <em>Dimension</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCoverageTypeImpl extends AbstractFeatureTypeImpl
    implements AbstractCoverageType {
  /**
   * The cached value of the '{@link #getDomainSetGroup() <em>Domain Set Group</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getDomainSetGroup() {
    if (domainSetGroup == null) {
      domainSetGroup =
          new BasicFeatureMap(this, Gml311Package.ABSTRACT_COVERAGE_TYPE__DOMAIN_SET_GROUP);
    }
  ...
  public DomainSetType getDomainSet() {
    return (DomainSetType)
        getDomainSetGroup().get(Gml311Package.eINSTANCE.getAbstractCoverageType_DomainSet(), true);
  }
  ...
  public NotificationChain basicSetDomainSet(DomainSetType newDomainSet, NotificationChain msgs) {
    return ((FeatureMap.Internal) getDomainSetGroup())
        .basicAdd(Gml311Package.eINSTANCE.getAbstractCoverageType_DomainSet(), newDomainSet, msgs);
  }
  ...
  public void setDomainSet(DomainSetType newDomainSet) {
    ((FeatureMap.Internal) getDomainSetGroup())
        .set(Gml311Package.eINSTANCE.getAbstractCoverageType_DomainSet(), newDomainSet);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COVERAGE_TYPE__RANGE_SET,
              oldRangeSet,
              newRangeSet);
      ...
      if (rangeSet != null)
        msgs =
            ((InternalEObject) rangeSet)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_COVERAGE_TYPE__RANGE_SET,
                    null,
                    msgs);
      if (newRangeSet != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COVERAGE_TYPE__DIMENSION,
              oldDimension,
              dimension));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.ABSTRACT_COVERAGE_TYPE__DIMENSION:
        return DIMENSION_EDEFAULT == null
            ? dimension != null
            : !DIMENSION_EDEFAULT.equals(dimension);
    }
