 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeometricComplexTypeImpl#getElement <em>Element</em>}
 * </ul>
 *
 * @generated
 */
public class GeometricComplexTypeImpl extends AbstractGeometryTypeImpl
    implements GeometricComplexType {
  /**
  ...
  public EList<GeometricPrimitivePropertyType> getElement() {
    if (element == null) {
      element =
          new EObjectContainmentEList<GeometricPrimitivePropertyType>(
              GeometricPrimitivePropertyType.class,
              this,
              Gml311Package.GEOMETRIC_COMPLEX_TYPE__ELEMENT);
    }
    return element;
  }
