 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CompositeCurveTypeImpl#getCurveMember <em>Curve Member</em>}
 * </ul>
 *
 * @generated
 */
public class CompositeCurveTypeImpl extends AbstractCurveTypeImpl implements CompositeCurveType {
  /**
   * The cached value of the '{@link #getCurveMember() <em>Curve Member</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<CurvePropertyType> getCurveMember() {
    if (curveMember == null) {
      curveMember =
          new EObjectContainmentEList<CurvePropertyType>(
              CurvePropertyType.class, this, Gml311Package.COMPOSITE_CURVE_TYPE__CURVE_MEMBER);
    }
    return curveMember;
  }
