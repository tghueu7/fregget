 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GridFunctionTypeImpl#getSequenceRule <em>Sequence Rule</em>}
 *   <li>{@link net.opengis.gml311.impl.GridFunctionTypeImpl#getStartPoint <em>Start Point</em>}
 * </ul>
 *
 * @generated
 */
public class GridFunctionTypeImpl extends MinimalEObjectImpl.Container implements GridFunctionType {
  /**
   * The cached value of the '{@link #getSequenceRule() <em>Sequence Rule</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetSequenceRule(
      SequenceRuleType newSequenceRule, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRID_FUNCTION_TYPE__SEQUENCE_RULE,
              oldSequenceRule,
              newSequenceRule);
  ...
  public void setSequenceRule(SequenceRuleType newSequenceRule) {
    if (newSequenceRule != sequenceRule) {
      ...
      if (sequenceRule != null)
        msgs =
            ((InternalEObject) sequenceRule)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_FUNCTION_TYPE__SEQUENCE_RULE,
                    null,
                    msgs);
      if (newSequenceRule != null)
        msgs =
            ((InternalEObject) newSequenceRule)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_FUNCTION_TYPE__SEQUENCE_RULE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRID_FUNCTION_TYPE__START_POINT,
              oldStartPoint,
              startPoint));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.GRID_FUNCTION_TYPE__START_POINT:
        return START_POINT_EDEFAULT == null
            ? startPoint != null
            : !START_POINT_EDEFAULT.equals(startPoint);
    }
