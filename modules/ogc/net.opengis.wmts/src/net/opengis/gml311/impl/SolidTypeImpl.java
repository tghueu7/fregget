 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SolidTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.impl.SolidTypeImpl#getInterior <em>Interior</em>}
 * </ul>
 *
 * @generated
 */
public class SolidTypeImpl extends AbstractSolidTypeImpl implements SolidType {
  ...
  public NotificationChain basicSetExterior(
      SurfacePropertyType newExterior, NotificationChain msgs) {
    SurfacePropertyType oldExterior = exterior;
    exterior = newExterior;
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.SOLID_TYPE__EXTERIOR, oldExterior, newExterior);
    ...
    if (newExterior != exterior) {
      ...
      if (exterior != null)
        msgs =
            ((InternalEObject) exterior)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.SOLID_TYPE__EXTERIOR, null, msgs);
      if (newExterior != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SOLID_TYPE__EXTERIOR,
              newExterior,
              newExterior));
  }
    ...
    if (interior == null) {
      interior =
          new EObjectContainmentEList<SurfacePropertyType>(
              SurfacePropertyType.class, this, Gml311Package.SOLID_TYPE__INTERIOR);
    }
    return interior;
  }
