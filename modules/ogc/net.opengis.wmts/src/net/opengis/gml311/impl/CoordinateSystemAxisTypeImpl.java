 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CoordinateSystemAxisTypeImpl#getAxisID <em>Axis ID</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateSystemAxisTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateSystemAxisTypeImpl#getAxisAbbrev <em>Axis
 *       Abbrev</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateSystemAxisTypeImpl#getAxisDirection <em>Axis
 *       Direction</em>}
 *   <li>{@link net.opengis.gml311.impl.CoordinateSystemAxisTypeImpl#getUom <em>Uom</em>}
 * </ul>
 *
 * @generated
 */
public class CoordinateSystemAxisTypeImpl extends CoordinateSystemAxisBaseTypeImpl
    implements CoordinateSystemAxisType {
  /**
  ...
  /**
   * The cached value of the '{@link #getAxisDirection() <em>Axis Direction</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (axisID == null) {
      axisID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_ID);
    }
    return axisID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_ABBREV,
              oldAxisAbbrev,
              newAxisAbbrev);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAxisAbbrev(CodeType newAxisAbbrev) {
    if (newAxisAbbrev != axisAbbrev) {
      ...
      if (axisAbbrev != null)
        msgs =
            ((InternalEObject) axisAbbrev)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_ABBREV,
                    null,
                    msgs);
      if (newAxisAbbrev != null)
        msgs =
            ((InternalEObject) newAxisAbbrev)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_ABBREV,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_DIRECTION,
              oldAxisDirection,
              newAxisDirection);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAxisDirection(CodeType newAxisDirection) {
    if (newAxisDirection != axisDirection) {
      ...
      if (newAxisDirection != null)
        msgs =
            ((InternalEObject) newAxisDirection)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__AXIS_DIRECTION,
  ...
  public void setUom(String newUom) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.COORDINATE_SYSTEM_AXIS_TYPE__UOM, oldUom, uom));
  }
