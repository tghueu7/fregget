 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.VerticalCRSTypeImpl#getUsesVerticalCS <em>Uses Vertical
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.impl.VerticalCRSTypeImpl#getUsesVerticalDatum <em>Uses Vertical
 *       Datum</em>}
 * </ul>
 *
 * @generated
 */
public class VerticalCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements VerticalCRSType {
  /**
   * The cached value of the '{@link #getUsesVerticalCS() <em>Uses Vertical CS</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesVerticalDatum() <em>Uses Vertical Datum</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_CS,
              oldUsesVerticalCS,
              newUsesVerticalCS);
  ...
  public void setUsesVerticalCS(VerticalCSRefType newUsesVerticalCS) {
    if (newUsesVerticalCS != usesVerticalCS) {
      ...
      if (usesVerticalCS != null)
        msgs =
            ((InternalEObject) usesVerticalCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_CS,
                    null,
                    msgs);
      if (newUsesVerticalCS != null)
        msgs =
            ((InternalEObject) newUsesVerticalCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_DATUM,
              oldUsesVerticalDatum,
  ...
  public void setUsesVerticalDatum(VerticalDatumRefType newUsesVerticalDatum) {
    if (newUsesVerticalDatum != usesVerticalDatum) {
      ...
      if (usesVerticalDatum != null)
        msgs =
            ((InternalEObject) usesVerticalDatum)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_DATUM,
                    null,
                    msgs);
      if (newUsesVerticalDatum != null)
        msgs =
            ((InternalEObject) newUsesVerticalDatum)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.VERTICAL_CRS_TYPE__USES_VERTICAL_DATUM,
                    null,
