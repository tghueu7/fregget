 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeographicCRSTypeImpl#getUsesEllipsoidalCS <em>Uses
 *       Ellipsoidal CS</em>}
 *   <li>{@link net.opengis.gml311.impl.GeographicCRSTypeImpl#getUsesGeodeticDatum <em>Uses Geodetic
 *       Datum</em>}
 * </ul>
 *
 * @generated
 */
public class GeographicCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements GeographicCRSType {
  /**
   * The cached value of the '{@link #getUsesEllipsoidalCS() <em>Uses Ellipsoidal CS</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOGRAPHIC_CRS_TYPE__USES_ELLIPSOIDAL_CS,
              oldUsesEllipsoidalCS,
  ...
  public void setUsesEllipsoidalCS(EllipsoidalCSRefType newUsesEllipsoidalCS) {
    if (newUsesEllipsoidalCS != usesEllipsoidalCS) {
      ...
      if (usesEllipsoidalCS != null)
        msgs =
            ((InternalEObject) usesEllipsoidalCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOGRAPHIC_CRS_TYPE__USES_ELLIPSOIDAL_CS,
                    null,
                    msgs);
      if (newUsesEllipsoidalCS != null)
        msgs =
            ((InternalEObject) newUsesEllipsoidalCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOGRAPHIC_CRS_TYPE__USES_ELLIPSOIDAL_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEOGRAPHIC_CRS_TYPE__USES_GEODETIC_DATUM,
      ...
      if (usesGeodeticDatum != null)
        msgs =
            ((InternalEObject) usesGeodeticDatum)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEOGRAPHIC_CRS_TYPE__USES_GEODETIC_DATUM,
                    null,
                    msgs);
