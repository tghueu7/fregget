 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GeodesicStringTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.GeodesicStringTypeImpl#getGeometricPositionGroup
 *       <em>Geometric Position Group</em>}
 *   <li>{@link net.opengis.gml311.impl.GeodesicStringTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.GeodesicStringTypeImpl#getPointProperty <em>Point
 *       Property</em>}
 *   <li>{@link net.opengis.gml311.impl.GeodesicStringTypeImpl#getInterpolation
 *       <em>Interpolation</em>}
 * </ul>
 *
 * @generated
 */
public class GeodesicStringTypeImpl extends AbstractCurveSegmentTypeImpl
    implements GeodesicStringType {
  /**
  ...
  /**
   * The cached value of the '{@link #getGeometricPositionGroup() <em>Geometric Position
  ...
  protected static final CurveInterpolationType INTERPOLATION_EDEFAULT =
      CurveInterpolationType.GEODESIC;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEODESIC_STRING_TYPE__POS_LIST,
              oldPosList,
              newPosList);
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GEODESIC_STRING_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
  ...
  public FeatureMap getGeometricPositionGroup() {
    if (geometricPositionGroup == null) {
      geometricPositionGroup =
          new BasicFeatureMap(this, Gml311Package.GEODESIC_STRING_TYPE__GEOMETRIC_POSITION_GROUP);
    }
  ...
  public EList<PointPropertyType> getPointProperty() {
    return getGeometricPositionGroup()
        .list(Gml311Package.eINSTANCE.getGeodesicStringType_PointProperty());
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GEODESIC_STRING_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
