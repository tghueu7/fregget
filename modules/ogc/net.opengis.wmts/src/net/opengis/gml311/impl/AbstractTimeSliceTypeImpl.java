 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractTimeSliceTypeImpl#getValidTime <em>Valid Time</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractTimeSliceTypeImpl#getDataSource <em>Data
 *       Source</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTimeSliceTypeImpl extends AbstractGMLTypeImpl
    implements AbstractTimeSliceType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_TIME_SLICE_TYPE__VALID_TIME,
              oldValidTime,
              newValidTime);
      ...
      if (validTime != null)
        msgs =
            ((InternalEObject) validTime)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_TIME_SLICE_TYPE__VALID_TIME,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_TIME_SLICE_TYPE__DATA_SOURCE,
              oldDataSource,
              newDataSource);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (dataSource != null)
        msgs =
            ((InternalEObject) dataSource)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_TIME_SLICE_TYPE__DATA_SOURCE,
                    null,
                    msgs);
