 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SurfaceTypeImpl#getPatchesGroup <em>Patches Group</em>}
 *   <li>{@link net.opengis.gml311.impl.SurfaceTypeImpl#getPatches <em>Patches</em>}
 * </ul>
 *
 * @generated
 */
public class SurfaceTypeImpl extends AbstractSurfaceTypeImpl implements SurfaceType {
  ...
  public SurfacePatchArrayPropertyType getPatches() {
    return (SurfacePatchArrayPropertyType)
        getPatchesGroup().get(Gml311Package.eINSTANCE.getSurfaceType_Patches(), true);
  }
  ...
  public NotificationChain basicSetPatches(
    ...
    return ((FeatureMap.Internal) getPatchesGroup())
        .basicAdd(Gml311Package.eINSTANCE.getSurfaceType_Patches(), newPatches, msgs);
  }
  ...
  public void setPatches(SurfacePatchArrayPropertyType newPatches) {
    ((FeatureMap.Internal) getPatchesGroup())
        .set(Gml311Package.eINSTANCE.getSurfaceType_Patches(), newPatches);
  }
