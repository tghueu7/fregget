 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CoverageFunctionTypeImpl#getMappingRule <em>Mapping
 *       Rule</em>}
 *   <li>{@link net.opengis.gml311.impl.CoverageFunctionTypeImpl#getGridFunctionGroup <em>Grid
 *       Function Group</em>}
 *   <li>{@link net.opengis.gml311.impl.CoverageFunctionTypeImpl#getGridFunction <em>Grid
 *       Function</em>}
 * </ul>
 *
 * @generated
 */
public class CoverageFunctionTypeImpl extends MinimalEObjectImpl.Container
    implements CoverageFunctionType {
  /**
   * The cached value of the '{@link #getMappingRule() <em>Mapping Rule</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getGridFunctionGroup() <em>Grid Function Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.COVERAGE_FUNCTION_TYPE__MAPPING_RULE,
              oldMappingRule,
              newMappingRule);
  ...
  public void setMappingRule(StringOrRefType newMappingRule) {
    if (newMappingRule != mappingRule) {
      ...
      if (mappingRule != null)
        msgs =
            ((InternalEObject) mappingRule)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COVERAGE_FUNCTION_TYPE__MAPPING_RULE,
                    null,
                    msgs);
      if (newMappingRule != null)
        msgs =
            ((InternalEObject) newMappingRule)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.COVERAGE_FUNCTION_TYPE__MAPPING_RULE,
                    null,
  ...
  public FeatureMap getGridFunctionGroup() {
    if (gridFunctionGroup == null) {
      gridFunctionGroup =
          new BasicFeatureMap(this, Gml311Package.COVERAGE_FUNCTION_TYPE__GRID_FUNCTION_GROUP);
    }
  ...
  public GridFunctionType getGridFunction() {
    return (GridFunctionType)
        getGridFunctionGroup()
            .get(Gml311Package.eINSTANCE.getCoverageFunctionType_GridFunction(), true);
  }
  ...
  public NotificationChain basicSetGridFunction(
    ...
    return ((FeatureMap.Internal) getGridFunctionGroup())
        .basicAdd(
            Gml311Package.eINSTANCE.getCoverageFunctionType_GridFunction(), newGridFunction, msgs);
  }
  ...
  public void setGridFunction(GridFunctionType newGridFunction) {
    ((FeatureMap.Internal) getGridFunctionGroup())
        .set(Gml311Package.eINSTANCE.getCoverageFunctionType_GridFunction(), newGridFunction);
  }
