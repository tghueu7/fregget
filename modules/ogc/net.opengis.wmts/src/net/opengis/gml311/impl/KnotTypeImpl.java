 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.KnotTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.KnotTypeImpl#getMultiplicity <em>Multiplicity</em>}
 *   <li>{@link net.opengis.gml311.impl.KnotTypeImpl#getWeight <em>Weight</em>}
 * </ul>
 *
 * @generated
 */
public class KnotTypeImpl extends MinimalEObjectImpl.Container implements KnotType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.KNOT_TYPE__VALUE,
              oldValue,
              value,
              !oldValueESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.KNOT_TYPE__MULTIPLICITY,
              oldMultiplicity,
              multiplicity));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.KNOT_TYPE__WEIGHT,
              oldWeight,
              weight,
              !oldWeightESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case Gml311Package.KNOT_TYPE__VALUE:
        return isSetValue();
      case Gml311Package.KNOT_TYPE__MULTIPLICITY:
        return MULTIPLICITY_EDEFAULT == null
            ? multiplicity != null
            : !MULTIPLICITY_EDEFAULT.equals(multiplicity);
      case Gml311Package.KNOT_TYPE__WEIGHT:
        return isSetWeight();
    }
  ...
  public String toString() {
    ...
    if (weightESet) result.append(weight);
    else result.append("<unset>");
    result.append(')');
