 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.FormulaTypeImpl#getA <em>A</em>}
 *   <li>{@link net.opengis.gml311.impl.FormulaTypeImpl#getB <em>B</em>}
 *   <li>{@link net.opengis.gml311.impl.FormulaTypeImpl#getC <em>C</em>}
 *   <li>{@link net.opengis.gml311.impl.FormulaTypeImpl#getD <em>D</em>}
 * </ul>
 *
 * @generated
 */
public class FormulaTypeImpl extends MinimalEObjectImpl.Container implements FormulaType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FORMULA_TYPE__A, oldA, a, !oldAESet));
  }
  ...
  public void unsetA() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.UNSET, Gml311Package.FORMULA_TYPE__A, oldA, A_EDEFAULT, oldAESet));
  }
  ...
  public void setB(double newB) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FORMULA_TYPE__B, oldB, b, !oldBESet));
  }
  ...
  public void unsetB() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.UNSET, Gml311Package.FORMULA_TYPE__B, oldB, B_EDEFAULT, oldBESet));
  }
  ...
  public void setC(double newC) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FORMULA_TYPE__C, oldC, c, !oldCESet));
  }
  ...
  public void unsetC() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.UNSET, Gml311Package.FORMULA_TYPE__C, oldC, C_EDEFAULT, oldCESet));
  }
  ...
  public void setD(double newD) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FORMULA_TYPE__D, oldD, d, !oldDESet));
  }
  ...
  public void unsetD() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.UNSET, Gml311Package.FORMULA_TYPE__D, oldD, D_EDEFAULT, oldDESet));
  }
  ...
  public String toString() {
    ...
    result.append(" (a: ");
    if (aESet) result.append(a);
    else result.append("<unset>");
    result.append(", b: ");
    if (bESet) result.append(b);
    else result.append("<unset>");
    result.append(", c: ");
    if (cESet) result.append(c);
    else result.append("<unset>");
    result.append(", d: ");
    if (dESet) result.append(d);
    else result.append("<unset>");
    result.append(')');
