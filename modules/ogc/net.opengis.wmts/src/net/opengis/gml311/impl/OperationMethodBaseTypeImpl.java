 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OperationMethodBaseTypeImpl#getMethodName <em>Method
 *       Name</em>}
 * </ul>
 *
 * @generated
 */
public abstract class OperationMethodBaseTypeImpl extends DefinitionTypeImpl
    implements OperationMethodBaseType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_METHOD_BASE_TYPE__METHOD_NAME,
              oldMethodName,
              newMethodName);
  ...
  public void setMethodName(CodeType newMethodName) {
    if (newMethodName != methodName) {
      ...
      if (methodName != null)
        msgs =
            ((InternalEObject) methodName)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_METHOD_BASE_TYPE__METHOD_NAME,
                    null,
                    msgs);
      if (newMethodName != null)
        msgs =
            ((InternalEObject) newMethodName)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_METHOD_BASE_TYPE__METHOD_NAME,
                    null,
