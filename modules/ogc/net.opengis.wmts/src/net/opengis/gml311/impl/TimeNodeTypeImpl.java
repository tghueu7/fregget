 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeNodeTypeImpl#getPreviousEdge <em>Previous Edge</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeNodeTypeImpl#getNextEdge <em>Next Edge</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeNodeTypeImpl#getPosition <em>Position</em>}
 * </ul>
 *
 * @generated
 */
public class TimeNodeTypeImpl extends AbstractTimeTopologyPrimitiveTypeImpl
    implements TimeNodeType {
  /**
   * The cached value of the '{@link #getPreviousEdge() <em>Previous Edge</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TimeEdgePropertyType> getPreviousEdge() {
    if (previousEdge == null) {
      previousEdge =
          new EObjectContainmentEList<TimeEdgePropertyType>(
              TimeEdgePropertyType.class, this, Gml311Package.TIME_NODE_TYPE__PREVIOUS_EDGE);
    }
    return previousEdge;
  }
  ...
  public EList<TimeEdgePropertyType> getNextEdge() {
    if (nextEdge == null) {
      nextEdge =
          new EObjectContainmentEList<TimeEdgePropertyType>(
              TimeEdgePropertyType.class, this, Gml311Package.TIME_NODE_TYPE__NEXT_EDGE);
    }
    return nextEdge;
  }
  ...
  public NotificationChain basicSetPosition(
      TimeInstantPropertyType newPosition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_NODE_TYPE__POSITION,
              oldPosition,
              newPosition);
  ...
  public void setPosition(TimeInstantPropertyType newPosition) {
    if (newPosition != position) {
      ...
      if (position != null)
        msgs =
            ((InternalEObject) position)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_NODE_TYPE__POSITION,
                    null,
                    msgs);
      if (newPosition != null)
        msgs =
            ((InternalEObject) newPosition)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_NODE_TYPE__POSITION,
                    null,
