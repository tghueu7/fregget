 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractReferenceSystemTypeImpl#getSrsID <em>Srs ID</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractReferenceSystemTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractReferenceSystemTypeImpl#getValidArea <em>Valid
 *       Area</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractReferenceSystemTypeImpl#getScope <em>Scope</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractReferenceSystemTypeImpl extends AbstractReferenceSystemBaseTypeImpl
    implements AbstractReferenceSystemType {
  /**
    ...
    if (srsID == null) {
      srsID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.ABSTRACT_REFERENCE_SYSTEM_TYPE__SRS_ID);
    }
    return srsID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_REFERENCE_SYSTEM_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ABSTRACT_REFERENCE_SYSTEM_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_REFERENCE_SYSTEM_TYPE__VALID_AREA,
              oldValidArea,
              newValidArea);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_REFERENCE_SYSTEM_TYPE__SCOPE,
              oldScope,
              scope));
  }
