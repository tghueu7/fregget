 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeInstantTypeImpl#getTimePosition <em>Time Position</em>}
 * </ul>
 *
 * @generated
 */
public class TimeInstantTypeImpl extends AbstractTimeGeometricPrimitiveTypeImpl
    implements TimeInstantType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_INSTANT_TYPE__TIME_POSITION,
              oldTimePosition,
              newTimePosition);
  ...
  public void setTimePosition(TimePositionType newTimePosition) {
    if (newTimePosition != timePosition) {
      ...
      if (timePosition != null)
        msgs =
            ((InternalEObject) timePosition)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_INSTANT_TYPE__TIME_POSITION,
                    null,
                    msgs);
      if (newTimePosition != null)
        msgs =
            ((InternalEObject) newTimePosition)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_INSTANT_TYPE__TIME_POSITION,
                    null,
