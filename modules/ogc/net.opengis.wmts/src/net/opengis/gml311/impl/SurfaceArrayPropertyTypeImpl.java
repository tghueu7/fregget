 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SurfaceArrayPropertyTypeImpl#getSurfaceGroup <em>Surface
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.SurfaceArrayPropertyTypeImpl#getSurface <em>Surface</em>}
 * </ul>
 *
 * @generated
 */
public class SurfaceArrayPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements SurfaceArrayPropertyType {
  /**
  ...
  public FeatureMap getSurfaceGroup() {
    if (surfaceGroup == null) {
      surfaceGroup =
          new BasicFeatureMap(this, Gml311Package.SURFACE_ARRAY_PROPERTY_TYPE__SURFACE_GROUP);
    }
    return surfaceGroup;
  }
