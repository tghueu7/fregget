 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.SecondDefiningParameterTypeImpl#getInverseFlattening
 *       <em>Inverse Flattening</em>}
 *   <li>{@link net.opengis.gml311.impl.SecondDefiningParameterTypeImpl#getSemiMinorAxis <em>Semi
 *       Minor Axis</em>}
 *   <li>{@link net.opengis.gml311.impl.SecondDefiningParameterTypeImpl#getIsSphere <em>Is
 *       Sphere</em>}
 * </ul>
 *
 * @generated
 */
public class SecondDefiningParameterTypeImpl extends MinimalEObjectImpl.Container
    implements SecondDefiningParameterType {
  /**
   * The cached value of the '{@link #getInverseFlattening() <em>Inverse Flattening</em>}'
  ...
  /**
   * The cached value of the '{@link #getSemiMinorAxis() <em>Semi Minor Axis</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SECOND_DEFINING_PARAMETER_TYPE__INVERSE_FLATTENING,
              oldInverseFlattening,
  ...
  public void setInverseFlattening(MeasureType newInverseFlattening) {
    if (newInverseFlattening != inverseFlattening) {
      ...
      if (inverseFlattening != null)
        msgs =
            ((InternalEObject) inverseFlattening)
                .eInverseRemove(
                    this,
      ...
      if (newInverseFlattening != null)
        msgs =
            ((InternalEObject) newInverseFlattening)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.SECOND_DEFINING_PARAMETER_TYPE__INVERSE_FLATTENING,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SECOND_DEFINING_PARAMETER_TYPE__SEMI_MINOR_AXIS,
              oldSemiMinorAxis,
              newSemiMinorAxis);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSemiMinorAxis(MeasureType newSemiMinorAxis) {
    if (newSemiMinorAxis != semiMinorAxis) {
      ...
      if (newSemiMinorAxis != null)
        msgs =
            ((InternalEObject) newSemiMinorAxis)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.SECOND_DEFINING_PARAMETER_TYPE__SEMI_MINOR_AXIS,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.SECOND_DEFINING_PARAMETER_TYPE__IS_SPHERE,
              oldIsSphere,
              isSphere,
              !oldIsSphereESet));
  }
  ...
  public String toString() {
    ...
    if (isSphereESet) result.append(isSphere);
