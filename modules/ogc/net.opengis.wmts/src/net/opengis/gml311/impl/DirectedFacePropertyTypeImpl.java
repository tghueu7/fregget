 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getFace <em>Face</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getOrientation
 *       <em>Orientation</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectedFacePropertyTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class DirectedFacePropertyTypeImpl extends MinimalEObjectImpl.Container
    implements DirectedFacePropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__FACE,
              oldFace,
              newFace);
      ...
      if (face != null)
        msgs =
            ((InternalEObject) face)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__FACE,
                    null,
                    msgs);
      if (newFace != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__HREF,
              oldHref,
              href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__ORIENTATION,
              oldOrientation,
              orientation,
              !oldOrientationESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__ROLE,
              oldRole,
              role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTED_FACE_PROPERTY_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
