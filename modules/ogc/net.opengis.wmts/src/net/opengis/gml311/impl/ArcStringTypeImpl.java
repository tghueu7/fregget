 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getPointProperty <em>Point Property</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getInterpolation <em>Interpolation</em>}
 *   <li>{@link net.opengis.gml311.impl.ArcStringTypeImpl#getNumArc <em>Num Arc</em>}
 * </ul>
 *
 * @generated
 */
public class ArcStringTypeImpl extends AbstractCurveSegmentTypeImpl implements ArcStringType {
  ...
  protected static final CurveInterpolationType INTERPOLATION_EDEFAULT =
      CurveInterpolationType.CIRCULAR_ARC3_POINTS;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ARC_STRING_TYPE__POS_LIST,
              oldPosList,
              newPosList);
      ...
      if (posList != null)
        msgs =
            ((InternalEObject) posList)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_TYPE__POS_LIST,
                    null,
                    msgs);
      if (newPosList != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ARC_STRING_TYPE__COORDINATES,
              oldCoordinates,
              newCoordinates);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (coordinates != null)
        msgs =
            ((InternalEObject) coordinates)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_TYPE__COORDINATES,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ARC_STRING_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
  ...
  public void setNumArc(BigInteger newNumArc) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ARC_STRING_TYPE__NUM_ARC, oldNumArc, numArc));
  }
