 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CovarianceMatrixTypeImpl#getUnitOfMeasure <em>Unit Of
 *       Measure</em>}
 *   <li>{@link net.opengis.gml311.impl.CovarianceMatrixTypeImpl#getIncludesElement <em>Includes
 *       Element</em>}
 * </ul>
 *
 * @generated
 */
public class CovarianceMatrixTypeImpl extends AbstractPositionalAccuracyTypeImpl
    implements CovarianceMatrixType {
  /**
   * The cached value of the '{@link #getUnitOfMeasure() <em>Unit Of Measure</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getIncludesElement() <em>Includes Element</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<UnitOfMeasureType> getUnitOfMeasure() {
    if (unitOfMeasure == null) {
      unitOfMeasure =
          new EObjectContainmentEList<UnitOfMeasureType>(
              UnitOfMeasureType.class, this, Gml311Package.COVARIANCE_MATRIX_TYPE__UNIT_OF_MEASURE);
    }
  ...
  public EList<CovarianceElementType> getIncludesElement() {
    if (includesElement == null) {
      includesElement =
          new EObjectContainmentEList<CovarianceElementType>(
              CovarianceElementType.class,
              this,
              Gml311Package.COVARIANCE_MATRIX_TYPE__INCLUDES_ELEMENT);
    }
