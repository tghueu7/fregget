 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EdgeTypeImpl#getDirectedNode <em>Directed Node</em>}
 *   <li>{@link net.opengis.gml311.impl.EdgeTypeImpl#getDirectedFace <em>Directed Face</em>}
 *   <li>{@link net.opengis.gml311.impl.EdgeTypeImpl#getCurveProperty <em>Curve Property</em>}
 * </ul>
 *
 * @generated
 */
public class EdgeTypeImpl extends AbstractTopoPrimitiveTypeImpl implements EdgeType {
  /**
   * The cached value of the '{@link #getDirectedNode() <em>Directed Node</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getDirectedFace() <em>Directed Face</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getCurveProperty() <em>Curve Property</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<DirectedNodePropertyType> getDirectedNode() {
    if (directedNode == null) {
      directedNode =
          new EObjectContainmentEList<DirectedNodePropertyType>(
              DirectedNodePropertyType.class, this, Gml311Package.EDGE_TYPE__DIRECTED_NODE);
    }
    return directedNode;
  }
  ...
  public EList<DirectedFacePropertyType> getDirectedFace() {
    if (directedFace == null) {
      directedFace =
          new EObjectContainmentEList<DirectedFacePropertyType>(
              DirectedFacePropertyType.class, this, Gml311Package.EDGE_TYPE__DIRECTED_FACE);
    }
    return directedFace;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.EDGE_TYPE__CURVE_PROPERTY,
              oldCurveProperty,
              newCurveProperty);
  ...
  public void setCurveProperty(CurvePropertyType newCurveProperty) {
    if (newCurveProperty != curveProperty) {
      ...
      if (curveProperty != null)
        msgs =
            ((InternalEObject) curveProperty)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.EDGE_TYPE__CURVE_PROPERTY,
                    null,
                    msgs);
      if (newCurveProperty != null)
        msgs =
            ((InternalEObject) newCurveProperty)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.EDGE_TYPE__CURVE_PROPERTY,
                    null,
