 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeCalendarEraTypeImpl#getReferenceEvent <em>Reference
 *       Event</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeCalendarEraTypeImpl#getReferenceDate <em>Reference
 *       Date</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeCalendarEraTypeImpl#getJulianReference <em>Julian
 *       Reference</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeCalendarEraTypeImpl#getEpochOfUse <em>Epoch Of Use</em>}
 * </ul>
 *
 * @generated
 */
public class TimeCalendarEraTypeImpl extends DefinitionTypeImpl implements TimeCalendarEraType {
  /**
   * The cached value of the '{@link #getReferenceEvent() <em>Reference Event</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  protected static final XMLGregorianCalendar REFERENCE_DATE_EDEFAULT =
      (XMLGregorianCalendar)
          XMLTypeFactory.eINSTANCE.createFromString(
              XMLTypePackage.eINSTANCE.getDate(), "0001-01-01");
   ...
   * @generated
   */
  public NotificationChain basicSetReferenceEvent(
      StringOrRefType newReferenceEvent, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CALENDAR_ERA_TYPE__REFERENCE_EVENT,
              oldReferenceEvent,
              newReferenceEvent);
  ...
  public void setReferenceEvent(StringOrRefType newReferenceEvent) {
    if (newReferenceEvent != referenceEvent) {
      ...
      if (referenceEvent != null)
        msgs =
            ((InternalEObject) referenceEvent)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_CALENDAR_ERA_TYPE__REFERENCE_EVENT,
                    null,
                    msgs);
      if (newReferenceEvent != null)
        msgs =
            ((InternalEObject) newReferenceEvent)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_CALENDAR_ERA_TYPE__REFERENCE_EVENT,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CALENDAR_ERA_TYPE__REFERENCE_DATE,
              oldReferenceDate,
              referenceDate,
              !oldReferenceDateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CALENDAR_ERA_TYPE__JULIAN_REFERENCE,
              oldJulianReference,
              julianReference));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetEpochOfUse(
      TimePeriodPropertyType newEpochOfUse, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_CALENDAR_ERA_TYPE__EPOCH_OF_USE,
              oldEpochOfUse,
              newEpochOfUse);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setEpochOfUse(TimePeriodPropertyType newEpochOfUse) {
    if (newEpochOfUse != epochOfUse) {
      ...
      if (epochOfUse != null)
        msgs =
            ((InternalEObject) epochOfUse)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_CALENDAR_ERA_TYPE__EPOCH_OF_USE,
                    null,
                    msgs);
      if (newEpochOfUse != null)
        msgs =
            ((InternalEObject) newEpochOfUse)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_CALENDAR_ERA_TYPE__EPOCH_OF_USE,
                    null,
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.TIME_CALENDAR_ERA_TYPE__JULIAN_REFERENCE:
        return JULIAN_REFERENCE_EDEFAULT == null
            ? julianReference != null
            : !JULIAN_REFERENCE_EDEFAULT.equals(julianReference);
      case Gml311Package.TIME_CALENDAR_ERA_TYPE__EPOCH_OF_USE:
  ...
  public String toString() {
    ...
    if (referenceDateESet) result.append(referenceDate);
