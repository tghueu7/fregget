 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.EllipsoidTypeImpl#getEllipsoidID <em>Ellipsoid ID</em>}
 *   <li>{@link net.opengis.gml311.impl.EllipsoidTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.EllipsoidTypeImpl#getSemiMajorAxis <em>Semi Major Axis</em>}
 *   <li>{@link net.opengis.gml311.impl.EllipsoidTypeImpl#getSecondDefiningParameter <em>Second
...
public class EllipsoidTypeImpl extends EllipsoidBaseTypeImpl implements EllipsoidType {
  /**
   * The cached value of the '{@link #getEllipsoidID() <em>Ellipsoid ID</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSemiMajorAxis() <em>Semi Major Axis</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSecondDefiningParameter() <em>Second Defining
    ...
    if (ellipsoidID == null) {
      ellipsoidID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.ELLIPSOID_TYPE__ELLIPSOID_ID);
    }
    return ellipsoidID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ELLIPSOID_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ELLIPSOID_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ELLIPSOID_TYPE__SEMI_MAJOR_AXIS,
              oldSemiMajorAxis,
              newSemiMajorAxis);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSemiMajorAxis(MeasureType newSemiMajorAxis) {
    if (newSemiMajorAxis != semiMajorAxis) {
      ...
      if (semiMajorAxis != null)
        msgs =
            ((InternalEObject) semiMajorAxis)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ELLIPSOID_TYPE__SEMI_MAJOR_AXIS,
                    null,
                    msgs);
      if (newSemiMajorAxis != null)
        msgs =
            ((InternalEObject) newSemiMajorAxis)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ELLIPSOID_TYPE__SEMI_MAJOR_AXIS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ELLIPSOID_TYPE__SECOND_DEFINING_PARAMETER,
              oldSecondDefiningParameter,
  ...
  public void setSecondDefiningParameter(SecondDefiningParameterType newSecondDefiningParameter) {
    if (newSecondDefiningParameter != secondDefiningParameter) {
      ...
      if (secondDefiningParameter != null)
        msgs =
            ((InternalEObject) secondDefiningParameter)
                .eInverseRemove(
                    this,
      ...
      if (newSecondDefiningParameter != null)
        msgs =
            ((InternalEObject) newSecondDefiningParameter)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.ELLIPSOID_TYPE__SECOND_DEFINING_PARAMETER,
