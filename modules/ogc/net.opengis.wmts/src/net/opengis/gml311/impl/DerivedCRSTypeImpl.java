 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DerivedCRSTypeImpl#getDerivedCRSType <em>Derived CRS
 *       Type</em>}
 *   <li>{@link net.opengis.gml311.impl.DerivedCRSTypeImpl#getUsesCS <em>Uses CS</em>}
 * </ul>
 *
 * @generated
 */
public class DerivedCRSTypeImpl extends AbstractGeneralDerivedCRSTypeImpl
    implements DerivedCRSType {
  /**
   * The cached value of the '{@link #getDerivedCRSType() <em>Derived CRS Type</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DERIVED_CRS_TYPE__DERIVED_CRS_TYPE,
              oldDerivedCRSType,
              newDerivedCRSType);
  ...
  public void setDerivedCRSType(DerivedCRSTypeType newDerivedCRSType) {
    if (newDerivedCRSType != derivedCRSType) {
      ...
      if (derivedCRSType != null)
        msgs =
            ((InternalEObject) derivedCRSType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DERIVED_CRS_TYPE__DERIVED_CRS_TYPE,
                    null,
                    msgs);
      if (newDerivedCRSType != null)
        msgs =
            ((InternalEObject) newDerivedCRSType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DERIVED_CRS_TYPE__DERIVED_CRS_TYPE,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DERIVED_CRS_TYPE__USES_CS,
              oldUsesCS,
              newUsesCS);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (usesCS != null)
        msgs =
            ((InternalEObject) usesCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DERIVED_CRS_TYPE__USES_CS,
                    null,
                    msgs);
      if (newUsesCS != null)
        msgs =
