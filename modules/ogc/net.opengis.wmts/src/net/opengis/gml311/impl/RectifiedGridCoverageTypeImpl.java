 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RectifiedGridCoverageTypeImpl#getRectifiedGridDomain
 *       <em>Rectified Grid Domain</em>}
 * </ul>
 *
 * @generated
 */
public class RectifiedGridCoverageTypeImpl extends AbstractDiscreteCoverageTypeImpl
    implements RectifiedGridCoverageType {
  /**
   * The cached value of the '{@link #getRectifiedGridDomain() <em>Rectified Grid Domain</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.RECTIFIED_GRID_COVERAGE_TYPE__RECTIFIED_GRID_DOMAIN,
              oldRectifiedGridDomain,
  ...
  public void setRectifiedGridDomain(RectifiedGridDomainType newRectifiedGridDomain) {
    if (newRectifiedGridDomain != rectifiedGridDomain) {
      ...
      if (rectifiedGridDomain != null)
        msgs =
            ((InternalEObject) rectifiedGridDomain)
                .eInverseRemove(
                    this,
      ...
      if (newRectifiedGridDomain != null)
        msgs =
            ((InternalEObject) newRectifiedGridDomain)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.RECTIFIED_GRID_COVERAGE_TYPE__RECTIFIED_GRID_DOMAIN,
