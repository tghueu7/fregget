 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getAxisLabels <em>Axis
 *       Labels</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getCount <em>Count</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getSrsDimension <em>Srs
 *       Dimension</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getSrsName <em>Srs Name</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectPositionListTypeImpl#getUomLabels <em>Uom Labels</em>}
 * </ul>
 *
 * @generated
 */
public class DirectPositionListTypeImpl extends MinimalEObjectImpl.Container
    implements DirectPositionListType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__VALUE,
              oldValue,
              value));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__AXIS_LABELS,
              oldAxisLabels,
              axisLabels));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__COUNT,
              oldCount,
              count));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_DIMENSION,
              oldSrsDimension,
              srsDimension));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_NAME,
              oldSrsName,
              srsName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECT_POSITION_LIST_TYPE__UOM_LABELS,
              oldUomLabels,
              uomLabels));
  }
