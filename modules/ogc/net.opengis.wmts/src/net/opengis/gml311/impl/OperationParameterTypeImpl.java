 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OperationParameterTypeImpl#getParameterID <em>Parameter
 *       ID</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationParameterTypeImpl#getRemarks <em>Remarks</em>}
 * </ul>
 *
 * @generated
 */
public class OperationParameterTypeImpl extends OperationParameterBaseTypeImpl
    implements OperationParameterType {
  /**
   * The cached value of the '{@link #getParameterID() <em>Parameter ID</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (parameterID == null) {
      parameterID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.OPERATION_PARAMETER_TYPE__PARAMETER_ID);
    }
    return parameterID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_PARAMETER_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_PARAMETER_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
