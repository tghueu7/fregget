 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.BagTypeImpl#getMember <em>Member</em>}
 *   <li>{@link net.opengis.gml311.impl.BagTypeImpl#getMembers <em>Members</em>}
 * </ul>
 *
 * @generated
 */
public class BagTypeImpl extends AbstractGMLTypeImpl implements BagType {
  ...
  public EList<AssociationType> getMember() {
    if (member == null) {
      member =
          new EObjectContainmentEList<AssociationType>(
              AssociationType.class, this, Gml311Package.BAG_TYPE__MEMBER);
    }
    return member;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.BAG_TYPE__MEMBERS, oldMembers, newMembers);
  ...
  public void setMembers(ArrayAssociationType newMembers) {
    if (newMembers != members) {
      ...
      if (members != null)
        msgs =
            ((InternalEObject) members)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.BAG_TYPE__MEMBERS, null, msgs);
      if (newMembers != null)
        msgs =
            ((InternalEObject) newMembers)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.BAG_TYPE__MEMBERS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.BAG_TYPE__MEMBERS, newMembers, newMembers));
  }
