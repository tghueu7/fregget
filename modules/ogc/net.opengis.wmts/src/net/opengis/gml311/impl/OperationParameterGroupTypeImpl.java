 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OperationParameterGroupTypeImpl#getGroupID <em>Group
 *       ID</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationParameterGroupTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationParameterGroupTypeImpl#getMaximumOccurs <em>Maximum
 *       Occurs</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationParameterGroupTypeImpl#getIncludesParameter
 *       <em>Includes Parameter</em>}
 * </ul>
 *
 * @generated
 */
public class OperationParameterGroupTypeImpl extends OperationParameterGroupBaseTypeImpl
    implements OperationParameterGroupType {
  /**
  ...
  /**
   * The cached value of the '{@link #getIncludesParameter() <em>Includes Parameter</em>}'
    ...
    if (groupID == null) {
      groupID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__GROUP_ID);
    }
    return groupID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__MAXIMUM_OCCURS,
              oldMaximumOccurs,
              maximumOccurs));
  }
    ...
    if (includesParameter == null) {
      includesParameter =
          new EObjectContainmentEList<AbstractGeneralOperationParameterRefType>(
              ...
              this,
              Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__INCLUDES_PARAMETER);
    }
    ...
    switch (featureID) {
      ...
      case Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__MAXIMUM_OCCURS:
        return MAXIMUM_OCCURS_EDEFAULT == null
            ? maximumOccurs != null
            : !MAXIMUM_OCCURS_EDEFAULT.equals(maximumOccurs);
      case Gml311Package.OPERATION_PARAMETER_GROUP_TYPE__INCLUDES_PARAMETER:
