 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AffinePlacementTypeImpl#getLocation <em>Location</em>}
 *   <li>{@link net.opengis.gml311.impl.AffinePlacementTypeImpl#getRefDirection <em>Ref
 *       Direction</em>}
 *   <li>{@link net.opengis.gml311.impl.AffinePlacementTypeImpl#getInDimension <em>In
 *       Dimension</em>}
 *   <li>{@link net.opengis.gml311.impl.AffinePlacementTypeImpl#getOutDimension <em>Out
 *       Dimension</em>}
 * </ul>
 *
 * @generated
 */
public class AffinePlacementTypeImpl extends MinimalEObjectImpl.Container
    implements AffinePlacementType {
  /**
  ...
  /**
   * The cached value of the '{@link #getRefDirection() <em>Ref Direction</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public NotificationChain basicSetLocation(
      DirectPositionType newLocation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.AFFINE_PLACEMENT_TYPE__LOCATION,
              oldLocation,
              newLocation);
      ...
      if (location != null)
        msgs =
            ((InternalEObject) location)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.AFFINE_PLACEMENT_TYPE__LOCATION,
                    null,
                    msgs);
      if (newLocation != null)
        msgs =
    ...
    if (refDirection == null) {
      refDirection =
          new EObjectContainmentEList<VectorType>(
              VectorType.class, this, Gml311Package.AFFINE_PLACEMENT_TYPE__REF_DIRECTION);
    }
    return refDirection;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.AFFINE_PLACEMENT_TYPE__IN_DIMENSION,
              oldInDimension,
              inDimension));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.AFFINE_PLACEMENT_TYPE__OUT_DIMENSION,
              oldOutDimension,
              outDimension));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.AFFINE_PLACEMENT_TYPE__IN_DIMENSION:
        return IN_DIMENSION_EDEFAULT == null
            ? inDimension != null
            : !IN_DIMENSION_EDEFAULT.equals(inDimension);
      case Gml311Package.AFFINE_PLACEMENT_TYPE__OUT_DIMENSION:
        return OUT_DIMENSION_EDEFAULT == null
            ? outDimension != null
            : !OUT_DIMENSION_EDEFAULT.equals(outDimension);
    }
