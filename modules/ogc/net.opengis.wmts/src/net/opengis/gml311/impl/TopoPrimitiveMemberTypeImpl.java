 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getTopoPrimitiveGroup <em>Topo
 *       Primitive Group</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getTopoPrimitive <em>Topo
 *       Primitive</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.impl.TopoPrimitiveMemberTypeImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class TopoPrimitiveMemberTypeImpl extends MinimalEObjectImpl.Container
    implements TopoPrimitiveMemberType {
  /**
   * The cached value of the '{@link #getTopoPrimitiveGroup() <em>Topo Primitive Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getTopoPrimitiveGroup() {
    if (topoPrimitiveGroup == null) {
      topoPrimitiveGroup =
          new BasicFeatureMap(this, Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__TOPO_PRIMITIVE_GROUP);
    }
  ...
  public AbstractTopoPrimitiveType getTopoPrimitive() {
    return (AbstractTopoPrimitiveType)
        getTopoPrimitiveGroup()
            .get(Gml311Package.eINSTANCE.getTopoPrimitiveMemberType_TopoPrimitive(), true);
  }
  ...
  public NotificationChain basicSetTopoPrimitive(
    ...
    return ((FeatureMap.Internal) getTopoPrimitiveGroup())
        .basicAdd(
            Gml311Package.eINSTANCE.getTopoPrimitiveMemberType_TopoPrimitive(),
            newTopoPrimitive,
            msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__ACTUATE,
              oldActuate,
              actuate,
              !oldActuateESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__ARCROLE,
              oldArcrole,
              arcrole));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__HREF,
              oldHref,
              href));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__REMOTE_SCHEMA,
              oldRemoteSchema,
              remoteSchema));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__ROLE,
              oldRole,
              role));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__SHOW,
              oldShow,
              show,
              !oldShowESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__TITLE,
              oldTitle,
              title));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_PRIMITIVE_MEMBER_TYPE__TYPE,
              oldType,
              type,
              !oldTypeESet));
  }
