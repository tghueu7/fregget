 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.BoundingShapeTypeImpl#getEnvelopeGroup <em>Envelope
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.BoundingShapeTypeImpl#getEnvelope <em>Envelope</em>}
 *   <li>{@link net.opengis.gml311.impl.BoundingShapeTypeImpl#getNull <em>Null</em>}
 * </ul>
 *
 * @generated
 */
public class BoundingShapeTypeImpl extends MinimalEObjectImpl.Container
    implements BoundingShapeType {
  /**
  ...
  public EnvelopeType getEnvelope() {
    return (EnvelopeType)
        getEnvelopeGroup().get(Gml311Package.eINSTANCE.getBoundingShapeType_Envelope(), true);
  }
  ...
  public NotificationChain basicSetEnvelope(EnvelopeType newEnvelope, NotificationChain msgs) {
    return ((FeatureMap.Internal) getEnvelopeGroup())
        .basicAdd(Gml311Package.eINSTANCE.getBoundingShapeType_Envelope(), newEnvelope, msgs);
  }
  ...
  public void setEnvelope(EnvelopeType newEnvelope) {
    ((FeatureMap.Internal) getEnvelopeGroup())
        .set(Gml311Package.eINSTANCE.getBoundingShapeType_Envelope(), newEnvelope);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.BOUNDING_SHAPE_TYPE__NULL, oldNull, null_));
  }
