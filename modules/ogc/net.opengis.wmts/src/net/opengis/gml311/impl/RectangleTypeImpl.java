 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.RectangleTypeImpl#getExteriorGroup <em>Exterior Group</em>}
 *   <li>{@link net.opengis.gml311.impl.RectangleTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.impl.RectangleTypeImpl#getInterpolation <em>Interpolation</em>}
 * </ul>
 *
 * @generated
 */
public class RectangleTypeImpl extends AbstractSurfacePatchTypeImpl implements RectangleType {
  ...
  public AbstractRingPropertyType getExterior() {
    return (AbstractRingPropertyType)
        getExteriorGroup().get(Gml311Package.eINSTANCE.getRectangleType_Exterior(), true);
  }
  ...
  public NotificationChain basicSetExterior(
    ...
    return ((FeatureMap.Internal) getExteriorGroup())
        .basicAdd(Gml311Package.eINSTANCE.getRectangleType_Exterior(), newExterior, msgs);
  }
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    ((FeatureMap.Internal) getExteriorGroup())
        .set(Gml311Package.eINSTANCE.getRectangleType_Exterior(), newExterior);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.RECTANGLE_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
