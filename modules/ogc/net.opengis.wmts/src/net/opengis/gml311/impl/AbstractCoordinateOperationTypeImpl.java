 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getCoordinateOperationID
 *       <em>Coordinate Operation ID</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getRemarks
 *       <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getOperationVersion
 *       <em>Operation Version</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getValidArea <em>Valid
 *       Area</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getScope <em>Scope</em>}
 *   <li>{@link
 *       net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getPositionalAccuracyGroup
 *       <em>Positional Accuracy Group</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getPositionalAccuracy
 *       <em>Positional Accuracy</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getSourceCRS <em>Source
 *       CRS</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractCoordinateOperationTypeImpl#getTargetCRS <em>Target
 *       CRS</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCoordinateOperationTypeImpl
    extends AbstractCoordinateOperationBaseTypeImpl implements AbstractCoordinateOperationType {
  /**
   * The cached value of the '{@link #getCoordinateOperationID() <em>Coordinate Operation ID</em>}'
  ...
  /**
   * The cached value of the '{@link #getPositionalAccuracyGroup() <em>Positional Accuracy
  ...
  public EList<IdentifierType> getCoordinateOperationID() {
    if (coordinateOperationID == null) {
      coordinateOperationID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class,
              this,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__COORDINATE_OPERATION_ID);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__OPERATION_VERSION,
              oldOperationVersion,
              operationVersion));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__VALID_AREA,
              oldValidArea,
              newValidArea);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__SCOPE,
              oldScope,
              scope));
  }
  ...
  public FeatureMap getPositionalAccuracyGroup() {
    if (positionalAccuracyGroup == null) {
      positionalAccuracyGroup =
          new BasicFeatureMap(
              this, Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__POSITIONAL_ACCURACY_GROUP);
    }
  ...
  public EList<AbstractPositionalAccuracyType> getPositionalAccuracy() {
    return getPositionalAccuracyGroup()
        .list(Gml311Package.eINSTANCE.getAbstractCoordinateOperationType_PositionalAccuracy());
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__SOURCE_CRS,
              oldSourceCRS,
              newSourceCRS);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__TARGET_CRS,
              oldTargetCRS,
              newTargetCRS);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    ...
    switch (featureID) {
      ...
      case Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__OPERATION_VERSION:
        return OPERATION_VERSION_EDEFAULT == null
            ...
            : !OPERATION_VERSION_EDEFAULT.equals(operationVersion);
      case Gml311Package.ABSTRACT_COORDINATE_OPERATION_TYPE__VALID_AREA:
