 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiPolygonTypeImpl#getPolygonMember <em>Polygon
 *       Member</em>}
 * </ul>
 *
 * @generated
 */
public class MultiPolygonTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiPolygonType {
  /**
   * The cached value of the '{@link #getPolygonMember() <em>Polygon Member</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<PolygonPropertyType> getPolygonMember() {
    if (polygonMember == null) {
      polygonMember =
          new EObjectContainmentEList<PolygonPropertyType>(
              PolygonPropertyType.class, this, Gml311Package.MULTI_POLYGON_TYPE__POLYGON_MEMBER);
    }
