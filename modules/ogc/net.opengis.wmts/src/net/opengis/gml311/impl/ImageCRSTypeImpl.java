 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ImageCRSTypeImpl#getUsesCartesianCS <em>Uses Cartesian
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.impl.ImageCRSTypeImpl#getUsesObliqueCartesianCS <em>Uses Oblique
 *       Cartesian CS</em>}
 *   <li>{@link net.opengis.gml311.impl.ImageCRSTypeImpl#getUsesImageDatum <em>Uses Image
 *       Datum</em>}
 * </ul>
 *
 * @generated
...
public class ImageCRSTypeImpl extends AbstractReferenceSystemTypeImpl implements ImageCRSType {
  ...
  /**
   * The cached value of the '{@link #getUsesObliqueCartesianCS() <em>Uses Oblique Cartesian
  ...
  /**
   * The cached value of the '{@link #getUsesImageDatum() <em>Uses Image Datum</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.IMAGE_CRS_TYPE__USES_CARTESIAN_CS,
              oldUsesCartesianCS,
              newUsesCartesianCS);
      ...
      if (usesCartesianCS != null)
        msgs =
            ((InternalEObject) usesCartesianCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IMAGE_CRS_TYPE__USES_CARTESIAN_CS,
                    null,
                    msgs);
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.IMAGE_CRS_TYPE__USES_OBLIQUE_CARTESIAN_CS,
              oldUsesObliqueCartesianCS,
  ...
  public void setUsesObliqueCartesianCS(ObliqueCartesianCSRefType newUsesObliqueCartesianCS) {
    if (newUsesObliqueCartesianCS != usesObliqueCartesianCS) {
      ...
      if (usesObliqueCartesianCS != null)
        msgs =
            ((InternalEObject) usesObliqueCartesianCS)
                .eInverseRemove(
                    this,
      ...
      if (newUsesObliqueCartesianCS != null)
        msgs =
            ((InternalEObject) newUsesObliqueCartesianCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.IMAGE_CRS_TYPE__USES_OBLIQUE_CARTESIAN_CS,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.IMAGE_CRS_TYPE__USES_IMAGE_DATUM,
              oldUsesImageDatum,
              newUsesImageDatum);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUsesImageDatum(ImageDatumRefType newUsesImageDatum) {
    if (newUsesImageDatum != usesImageDatum) {
      ...
      if (usesImageDatum != null)
        msgs =
            ((InternalEObject) usesImageDatum)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IMAGE_CRS_TYPE__USES_IMAGE_DATUM,
                    null,
                    msgs);
      if (newUsesImageDatum != null)
        msgs =
            ((InternalEObject) newUsesImageDatum)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.IMAGE_CRS_TYPE__USES_IMAGE_DATUM,
                    null,
