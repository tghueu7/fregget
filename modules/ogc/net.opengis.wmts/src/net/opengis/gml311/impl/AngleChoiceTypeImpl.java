 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AngleChoiceTypeImpl#getAngle <em>Angle</em>}
 *   <li>{@link net.opengis.gml311.impl.AngleChoiceTypeImpl#getDmsAngle <em>Dms Angle</em>}
 * </ul>
 *
 * @generated
 */
public class AngleChoiceTypeImpl extends MinimalEObjectImpl.Container implements AngleChoiceType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ANGLE_CHOICE_TYPE__ANGLE, oldAngle, newAngle);
  ...
  public void setAngle(MeasureType newAngle) {
    if (newAngle != angle) {
      ...
      if (angle != null)
        msgs =
            ((InternalEObject) angle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ANGLE_CHOICE_TYPE__ANGLE,
                    null,
                    msgs);
      if (newAngle != null)
        msgs =
            ((InternalEObject) newAngle)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ANGLE_CHOICE_TYPE__ANGLE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ANGLE_CHOICE_TYPE__ANGLE, newAngle, newAngle));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ANGLE_CHOICE_TYPE__DMS_ANGLE,
              oldDmsAngle,
              newDmsAngle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setDmsAngle(DMSAngleType newDmsAngle) {
    if (newDmsAngle != dmsAngle) {
      ...
      if (dmsAngle != null)
        msgs =
            ((InternalEObject) dmsAngle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ANGLE_CHOICE_TYPE__DMS_ANGLE,
                    null,
                    msgs);
      if (newDmsAngle != null)
        msgs =
            ((InternalEObject) newDmsAngle)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ANGLE_CHOICE_TYPE__DMS_ANGLE,
                    null,
