 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TemporalCRSTypeImpl#getUsesTemporalCS <em>Uses Temporal
 *       CS</em>}
 *   <li>{@link net.opengis.gml311.impl.TemporalCRSTypeImpl#getUsesTemporalDatum <em>Uses Temporal
 *       Datum</em>}
 * </ul>
 *
 * @generated
 */
public class TemporalCRSTypeImpl extends AbstractReferenceSystemTypeImpl
    implements TemporalCRSType {
  /**
   * The cached value of the '{@link #getUsesTemporalCS() <em>Uses Temporal CS</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesTemporalDatum() <em>Uses Temporal Datum</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_CS,
              oldUsesTemporalCS,
              newUsesTemporalCS);
  ...
  public void setUsesTemporalCS(TemporalCSRefType newUsesTemporalCS) {
    if (newUsesTemporalCS != usesTemporalCS) {
      ...
      if (usesTemporalCS != null)
        msgs =
            ((InternalEObject) usesTemporalCS)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_CS,
                    null,
                    msgs);
      if (newUsesTemporalCS != null)
        msgs =
            ((InternalEObject) newUsesTemporalCS)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_CS,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_DATUM,
              oldUsesTemporalDatum,
  ...
  public void setUsesTemporalDatum(TemporalDatumRefType newUsesTemporalDatum) {
    if (newUsesTemporalDatum != usesTemporalDatum) {
      ...
      if (usesTemporalDatum != null)
        msgs =
            ((InternalEObject) usesTemporalDatum)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_DATUM,
                    null,
                    msgs);
      if (newUsesTemporalDatum != null)
        msgs =
            ((InternalEObject) newUsesTemporalDatum)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TEMPORAL_CRS_TYPE__USES_TEMPORAL_DATUM,
                    null,
