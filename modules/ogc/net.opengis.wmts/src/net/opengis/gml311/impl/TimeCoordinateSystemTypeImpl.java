 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeCoordinateSystemTypeImpl#getOriginPosition <em>Origin
 *       Position</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeCoordinateSystemTypeImpl#getOrigin <em>Origin</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeCoordinateSystemTypeImpl#getInterval <em>Interval</em>}
 * </ul>
 *
 * @generated
 */
public class TimeCoordinateSystemTypeImpl extends AbstractTimeReferenceSystemTypeImpl
    implements TimeCoordinateSystemType {
  /**
   * The cached value of the '{@link #getOriginPosition() <em>Origin Position</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetOriginPosition(
      TimePositionType newOriginPosition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__ORIGIN_POSITION,
              oldOriginPosition,
              newOriginPosition);
  ...
  public void setOriginPosition(TimePositionType newOriginPosition) {
    if (newOriginPosition != originPosition) {
      ...
      if (originPosition != null)
        msgs =
            ((InternalEObject) originPosition)
                .eInverseRemove(
                    this,
      ...
      if (newOriginPosition != null)
        msgs =
            ((InternalEObject) newOriginPosition)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__ORIGIN_POSITION,
   ...
   * @generated
   */
  public NotificationChain basicSetOrigin(
      TimeInstantPropertyType newOrigin, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__ORIGIN,
              oldOrigin,
              newOrigin);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setOrigin(TimeInstantPropertyType newOrigin) {
    if (newOrigin != origin) {
      ...
      if (origin != null)
        msgs =
            ((InternalEObject) origin)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__ORIGIN,
                    null,
                    msgs);
      if (newOrigin != null)
        msgs =
            ((InternalEObject) newOrigin)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__ORIGIN,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetInterval(
      TimeIntervalLengthType newInterval, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__INTERVAL,
              oldInterval,
              newInterval);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setInterval(TimeIntervalLengthType newInterval) {
    if (newInterval != interval) {
      ...
      if (interval != null)
        msgs =
            ((InternalEObject) interval)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__INTERVAL,
                    null,
                    msgs);
      if (newInterval != null)
        msgs =
            ((InternalEObject) newInterval)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_COORDINATE_SYSTEM_TYPE__INTERVAL,
                    null,
