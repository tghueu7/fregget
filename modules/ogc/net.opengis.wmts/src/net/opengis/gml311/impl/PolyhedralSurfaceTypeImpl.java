 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PolyhedralSurfaceTypeImpl#getPolygonPatches <em>Polygon
 *       Patches</em>}
 * </ul>
 *
 * @generated
...
public class PolyhedralSurfaceTypeImpl extends SurfaceTypeImpl implements PolyhedralSurfaceType {
  /**
   * The cached value of the '{@link #getPolygonPatches() <em>Polygon Patches</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.POLYHEDRAL_SURFACE_TYPE__POLYGON_PATCHES,
              oldPolygonPatches,
              newPolygonPatches);
  ...
  public void setPolygonPatches(PolygonPatchArrayPropertyType newPolygonPatches) {
    if (newPolygonPatches != polygonPatches) {
      ...
      if (polygonPatches != null)
        msgs =
            ((InternalEObject) polygonPatches)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.POLYHEDRAL_SURFACE_TYPE__POLYGON_PATCHES,
                    null,
                    msgs);
      if (newPolygonPatches != null)
        msgs =
            ((InternalEObject) newPolygonPatches)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.POLYHEDRAL_SURFACE_TYPE__POLYGON_PATCHES,
                    null,
