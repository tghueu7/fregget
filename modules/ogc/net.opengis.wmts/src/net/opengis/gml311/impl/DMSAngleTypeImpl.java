 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DMSAngleTypeImpl#getDegrees <em>Degrees</em>}
 *   <li>{@link net.opengis.gml311.impl.DMSAngleTypeImpl#getDecimalMinutes <em>Decimal Minutes</em>}
 *   <li>{@link net.opengis.gml311.impl.DMSAngleTypeImpl#getMinutes <em>Minutes</em>}
 *   <li>{@link net.opengis.gml311.impl.DMSAngleTypeImpl#getSeconds <em>Seconds</em>}
 * </ul>
 *
 * @generated
 */
public class DMSAngleTypeImpl extends MinimalEObjectImpl.Container implements DMSAngleType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DMS_ANGLE_TYPE__DEGREES,
              oldDegrees,
              newDegrees);
  ...
  public void setDegrees(DegreesType newDegrees) {
    if (newDegrees != degrees) {
      ...
      if (degrees != null)
        msgs =
            ((InternalEObject) degrees)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DMS_ANGLE_TYPE__DEGREES,
                    null,
                    msgs);
      if (newDegrees != null)
        msgs =
            ((InternalEObject) newDegrees)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DMS_ANGLE_TYPE__DEGREES,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DMS_ANGLE_TYPE__DECIMAL_MINUTES,
              oldDecimalMinutes,
              decimalMinutes));
  }
  ...
  public void setMinutes(BigInteger newMinutes) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.DMS_ANGLE_TYPE__MINUTES, oldMinutes, minutes));
  }
  ...
  public void setSeconds(BigDecimal newSeconds) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.DMS_ANGLE_TYPE__SECONDS, oldSeconds, seconds));
  }
    ...
    switch (featureID) {
      ...
      case Gml311Package.DMS_ANGLE_TYPE__DECIMAL_MINUTES:
        return DECIMAL_MINUTES_EDEFAULT == null
            ? decimalMinutes != null
            : !DECIMAL_MINUTES_EDEFAULT.equals(decimalMinutes);
      case Gml311Package.DMS_ANGLE_TYPE__MINUTES:
