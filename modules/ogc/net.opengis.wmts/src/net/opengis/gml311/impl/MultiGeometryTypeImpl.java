 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.MultiGeometryTypeImpl#getGeometryMember <em>Geometry
 *       Member</em>}
 *   <li>{@link net.opengis.gml311.impl.MultiGeometryTypeImpl#getGeometryMembers <em>Geometry
 *       Members</em>}
 * </ul>
 *
 * @generated
 */
public class MultiGeometryTypeImpl extends AbstractGeometricAggregateTypeImpl
    implements MultiGeometryType {
  /**
   * The cached value of the '{@link #getGeometryMember() <em>Geometry Member</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getGeometryMembers() <em>Geometry Members</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<GeometryPropertyType> getGeometryMember() {
    if (geometryMember == null) {
      geometryMember =
          new EObjectContainmentEList<GeometryPropertyType>(
              GeometryPropertyType.class, this, Gml311Package.MULTI_GEOMETRY_TYPE__GEOMETRY_MEMBER);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.MULTI_GEOMETRY_TYPE__GEOMETRY_MEMBERS,
              oldGeometryMembers,
              newGeometryMembers);
  ...
  public void setGeometryMembers(GeometryArrayPropertyType newGeometryMembers) {
    if (newGeometryMembers != geometryMembers) {
      ...
      if (geometryMembers != null)
        msgs =
            ((InternalEObject) geometryMembers)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_GEOMETRY_TYPE__GEOMETRY_MEMBERS,
                    null,
                    msgs);
      if (newGeometryMembers != null)
        msgs =
            ((InternalEObject) newGeometryMembers)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.MULTI_GEOMETRY_TYPE__GEOMETRY_MEMBERS,
                    null,
