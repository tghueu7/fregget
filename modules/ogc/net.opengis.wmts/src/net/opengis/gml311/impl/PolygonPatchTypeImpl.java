 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchTypeImpl#getExteriorGroup <em>Exterior
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchTypeImpl#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchTypeImpl#getInteriorGroup <em>Interior
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchTypeImpl#getInterior <em>Interior</em>}
 *   <li>{@link net.opengis.gml311.impl.PolygonPatchTypeImpl#getInterpolation
 *       <em>Interpolation</em>}
 * </ul>
 *
 * @generated
...
public class PolygonPatchTypeImpl extends AbstractSurfacePatchTypeImpl implements PolygonPatchType {
   ...
   * @ordered
   */
  protected static final SurfaceInterpolationType INTERPOLATION_EDEFAULT =
      SurfaceInterpolationType.PLANAR;
  ...
  public AbstractRingPropertyType getExterior() {
    return (AbstractRingPropertyType)
        getExteriorGroup().get(Gml311Package.eINSTANCE.getPolygonPatchType_Exterior(), true);
  }
  ...
  public NotificationChain basicSetExterior(
    ...
    return ((FeatureMap.Internal) getExteriorGroup())
        .basicAdd(Gml311Package.eINSTANCE.getPolygonPatchType_Exterior(), newExterior, msgs);
  }
  ...
  public void setExterior(AbstractRingPropertyType newExterior) {
    ((FeatureMap.Internal) getExteriorGroup())
        .set(Gml311Package.eINSTANCE.getPolygonPatchType_Exterior(), newExterior);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.POLYGON_PATCH_TYPE__INTERPOLATION,
              oldInterpolation,
              interpolation,
