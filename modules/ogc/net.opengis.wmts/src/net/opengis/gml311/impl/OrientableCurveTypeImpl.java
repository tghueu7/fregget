 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OrientableCurveTypeImpl#getBaseCurve <em>Base Curve</em>}
 *   <li>{@link net.opengis.gml311.impl.OrientableCurveTypeImpl#getOrientation <em>Orientation</em>}
 * </ul>
 *
 * @generated
 */
public class OrientableCurveTypeImpl extends AbstractCurveTypeImpl implements OrientableCurveType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ORIENTABLE_CURVE_TYPE__BASE_CURVE,
              oldBaseCurve,
              newBaseCurve);
  ...
  public void setBaseCurve(CurvePropertyType newBaseCurve) {
    if (newBaseCurve != baseCurve) {
      ...
      if (baseCurve != null)
        msgs =
            ((InternalEObject) baseCurve)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ORIENTABLE_CURVE_TYPE__BASE_CURVE,
                    null,
                    msgs);
      if (newBaseCurve != null)
        msgs =
            ((InternalEObject) newBaseCurve)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.ORIENTABLE_CURVE_TYPE__BASE_CURVE,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ORIENTABLE_CURVE_TYPE__ORIENTATION,
              oldOrientation,
              orientation,
              !oldOrientationESet));
  }
