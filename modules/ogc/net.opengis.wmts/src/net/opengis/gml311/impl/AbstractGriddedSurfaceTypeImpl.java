 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractGriddedSurfaceTypeImpl#getRow <em>Row</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractGriddedSurfaceTypeImpl#getRows <em>Rows</em>}
 *   <li>{@link net.opengis.gml311.impl.AbstractGriddedSurfaceTypeImpl#getColumns <em>Columns</em>}
 * </ul>
 *
 * @generated
 */
public class AbstractGriddedSurfaceTypeImpl extends AbstractParametricCurveSurfaceTypeImpl
    implements AbstractGriddedSurfaceType {
  /**
  ...
  public EList<RowType> getRow() {
    if (row == null) {
      row =
          new EObjectContainmentEList<RowType>(
              RowType.class, this, Gml311Package.ABSTRACT_GRIDDED_SURFACE_TYPE__ROW);
    }
    return row;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_GRIDDED_SURFACE_TYPE__ROWS,
              oldRows,
              rows));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_GRIDDED_SURFACE_TYPE__COLUMNS,
              oldColumns,
              columns));
  }
