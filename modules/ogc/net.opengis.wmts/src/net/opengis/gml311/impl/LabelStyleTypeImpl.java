 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.LabelStyleTypeImpl#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.gml311.impl.LabelStyleTypeImpl#getLabel <em>Label</em>}
 * </ul>
 *
 * @generated
 */
public class LabelStyleTypeImpl extends BaseStyleDescriptorTypeImpl implements LabelStyleType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LABEL_STYLE_TYPE__STYLE, oldStyle, style));
  }
  ...
  public NotificationChain basicSetLabel(LabelType newLabel, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LABEL_STYLE_TYPE__LABEL, oldLabel, newLabel);
  ...
  public void setLabel(LabelType newLabel) {
    if (newLabel != label) {
      ...
      if (label != null)
        msgs =
            ((InternalEObject) label)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LABEL_STYLE_TYPE__LABEL,
                    null,
                    msgs);
      if (newLabel != null)
        msgs =
            ((InternalEObject) newLabel)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LABEL_STYLE_TYPE__LABEL,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.LABEL_STYLE_TYPE__LABEL, newLabel, newLabel));
  }
