 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getRelatedTime <em>Related Time</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getStart <em>Start</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getEnd <em>End</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getExtent <em>Extent</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getMember <em>Member</em>}
 *   <li>{@link net.opengis.gml311.impl.TimeOrdinalEraTypeImpl#getGroup <em>Group</em>}
 * </ul>
 *
 * @generated
 */
public class TimeOrdinalEraTypeImpl extends DefinitionTypeImpl implements TimeOrdinalEraType {
  /**
   * The cached value of the '{@link #getRelatedTime() <em>Related Time</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<RelatedTimeType> getRelatedTime() {
    if (relatedTime == null) {
      relatedTime =
          new EObjectContainmentEList<RelatedTimeType>(
              RelatedTimeType.class, this, Gml311Package.TIME_ORDINAL_ERA_TYPE__RELATED_TIME);
    }
    return relatedTime;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_ORDINAL_ERA_TYPE__START,
              oldStart,
              newStart);
  ...
  public void setStart(TimeNodePropertyType newStart) {
    if (newStart != start) {
      ...
      if (start != null)
        msgs =
            ((InternalEObject) start)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__START,
                    null,
                    msgs);
      if (newStart != null)
        msgs =
            ((InternalEObject) newStart)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__START,
                    null,
  ...
  public NotificationChain basicSetEnd(TimeNodePropertyType newEnd, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_ORDINAL_ERA_TYPE__END, oldEnd, newEnd);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setEnd(TimeNodePropertyType newEnd) {
    if (newEnd != end) {
      ...
      if (end != null)
        msgs =
            ((InternalEObject) end)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__END,
                    null,
                    msgs);
      if (newEnd != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.TIME_ORDINAL_ERA_TYPE__END, newEnd, newEnd));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetExtent(
      TimePeriodPropertyType newExtent, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_ORDINAL_ERA_TYPE__EXTENT,
              oldExtent,
              newExtent);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setExtent(TimePeriodPropertyType newExtent) {
    if (newExtent != extent) {
      ...
      if (extent != null)
        msgs =
            ((InternalEObject) extent)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__EXTENT,
                    null,
                    msgs);
      if (newExtent != null)
        msgs =
            ((InternalEObject) newExtent)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__EXTENT,
                    null,
  ...
  public EList<TimeOrdinalEraPropertyType> getMember() {
    if (member == null) {
      member =
          new EObjectContainmentEList<TimeOrdinalEraPropertyType>(
              TimeOrdinalEraPropertyType.class, this, Gml311Package.TIME_ORDINAL_ERA_TYPE__MEMBER);
    }
    return member;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TIME_ORDINAL_ERA_TYPE__GROUP,
              oldGroup,
              newGroup);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setGroup(ReferenceType newGroup) {
    if (newGroup != group) {
      ...
      if (group != null)
        msgs =
            ((InternalEObject) group)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__GROUP,
                    null,
                    msgs);
      if (newGroup != null)
        msgs =
            ((InternalEObject) newGroup)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TIME_ORDINAL_ERA_TYPE__GROUP,
                    null,
