 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.GridLimitsTypeImpl#getGridEnvelope <em>Grid Envelope</em>}
 * </ul>
 *
 * @generated
 */
public class GridLimitsTypeImpl extends MinimalEObjectImpl.Container implements GridLimitsType {
  /**
   * The cached value of the '{@link #getGridEnvelope() <em>Grid Envelope</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetGridEnvelope(
      GridEnvelopeType newGridEnvelope, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.GRID_LIMITS_TYPE__GRID_ENVELOPE,
              oldGridEnvelope,
              newGridEnvelope);
  ...
  public void setGridEnvelope(GridEnvelopeType newGridEnvelope) {
    if (newGridEnvelope != gridEnvelope) {
      ...
      if (gridEnvelope != null)
        msgs =
            ((InternalEObject) gridEnvelope)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_LIMITS_TYPE__GRID_ENVELOPE,
                    null,
                    msgs);
      if (newGridEnvelope != null)
        msgs =
            ((InternalEObject) newGridEnvelope)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.GRID_LIMITS_TYPE__GRID_ENVELOPE,
                    null,
