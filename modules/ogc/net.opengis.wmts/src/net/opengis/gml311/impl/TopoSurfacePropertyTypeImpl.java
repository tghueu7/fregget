 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TopoSurfacePropertyTypeImpl#getTopoSurface <em>Topo
 *       Surface</em>}
 * </ul>
 *
 * @generated
 */
public class TopoSurfacePropertyTypeImpl extends MinimalEObjectImpl.Container
    implements TopoSurfacePropertyType {
  /**
   * The cached value of the '{@link #getTopoSurface() <em>Topo Surface</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TOPO_SURFACE_PROPERTY_TYPE__TOPO_SURFACE,
              oldTopoSurface,
              newTopoSurface);
  ...
  public void setTopoSurface(TopoSurfaceType newTopoSurface) {
    if (newTopoSurface != topoSurface) {
      ...
      if (topoSurface != null)
        msgs =
            ((InternalEObject) topoSurface)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_SURFACE_PROPERTY_TYPE__TOPO_SURFACE,
                    null,
                    msgs);
      if (newTopoSurface != null)
        msgs =
            ((InternalEObject) newTopoSurface)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TOPO_SURFACE_PROPERTY_TYPE__TOPO_SURFACE,
                    null,
