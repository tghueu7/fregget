 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.PassThroughOperationTypeImpl#getModifiedCoordinate
 *       <em>Modified Coordinate</em>}
 *   <li>{@link net.opengis.gml311.impl.PassThroughOperationTypeImpl#getUsesOperation <em>Uses
 *       Operation</em>}
 * </ul>
 *
 * @generated
 */
public class PassThroughOperationTypeImpl extends AbstractCoordinateOperationTypeImpl
    implements PassThroughOperationType {
  /**
   * The cached value of the '{@link #getModifiedCoordinate() <em>Modified Coordinate</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesOperation() <em>Uses Operation</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (modifiedCoordinate == null) {
      modifiedCoordinate =
          new EDataTypeEList<BigInteger>(
              BigInteger.class,
              this,
              Gml311Package.PASS_THROUGH_OPERATION_TYPE__MODIFIED_COORDINATE);
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.PASS_THROUGH_OPERATION_TYPE__USES_OPERATION,
              oldUsesOperation,
              newUsesOperation);
  ...
  public void setUsesOperation(OperationRefType newUsesOperation) {
    if (newUsesOperation != usesOperation) {
      ...
      if (newUsesOperation != null)
        msgs =
            ((InternalEObject) newUsesOperation)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Gml311Package.PASS_THROUGH_OPERATION_TYPE__USES_OPERATION,
