 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ExtentTypeImpl#getDescription <em>Description</em>}
 *   <li>{@link net.opengis.gml311.impl.ExtentTypeImpl#getBoundingBox <em>Bounding Box</em>}
 *   <li>{@link net.opengis.gml311.impl.ExtentTypeImpl#getBoundingPolygon <em>Bounding Polygon</em>}
 *   <li>{@link net.opengis.gml311.impl.ExtentTypeImpl#getVerticalExtent <em>Vertical Extent</em>}
 *   <li>{@link net.opengis.gml311.impl.ExtentTypeImpl#getTemporalExtent <em>Temporal Extent</em>}
 * </ul>
 *
 * @generated
 */
public class ExtentTypeImpl extends MinimalEObjectImpl.Container implements ExtentType {
  ...
  /**
   * The cached value of the '{@link #getBoundingPolygon() <em>Bounding Polygon</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getVerticalExtent() <em>Vertical Extent</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalExtent() <em>Temporal Extent</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.EXTENT_TYPE__DESCRIPTION,
              oldDescription,
              newDescription);
      ...
      if (description != null)
        msgs =
            ((InternalEObject) description)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.EXTENT_TYPE__DESCRIPTION,
                    null,
                    msgs);
  ...
  public EList<EnvelopeType> getBoundingBox() {
    if (boundingBox == null) {
      boundingBox =
          new EObjectContainmentEList<EnvelopeType>(
              EnvelopeType.class, this, Gml311Package.EXTENT_TYPE__BOUNDING_BOX);
    }
    return boundingBox;
  }
  ...
  public EList<PolygonType> getBoundingPolygon() {
    if (boundingPolygon == null) {
      boundingPolygon =
          new EObjectContainmentEList<PolygonType>(
              PolygonType.class, this, Gml311Package.EXTENT_TYPE__BOUNDING_POLYGON);
    }
  ...
  public EList<EnvelopeType> getVerticalExtent() {
    if (verticalExtent == null) {
      verticalExtent =
          new EObjectContainmentEList<EnvelopeType>(
              EnvelopeType.class, this, Gml311Package.EXTENT_TYPE__VERTICAL_EXTENT);
    }
  ...
  public EList<TimePeriodType> getTemporalExtent() {
    if (temporalExtent == null) {
      temporalExtent =
          new EObjectContainmentEList<TimePeriodType>(
              TimePeriodType.class, this, Gml311Package.EXTENT_TYPE__TEMPORAL_EXTENT);
    }
