 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.KnotPropertyTypeImpl#getKnot <em>Knot</em>}
 * </ul>
 *
 * @generated
 */
public class KnotPropertyTypeImpl extends MinimalEObjectImpl.Container implements KnotPropertyType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.KNOT_PROPERTY_TYPE__KNOT, oldKnot, newKnot);
  ...
  public void setKnot(KnotType newKnot) {
    if (newKnot != knot) {
      ...
      if (knot != null)
        msgs =
            ((InternalEObject) knot)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.KNOT_PROPERTY_TYPE__KNOT,
                    null,
                    msgs);
      if (newKnot != null)
        msgs =
            ((InternalEObject) newKnot)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.KNOT_PROPERTY_TYPE__KNOT,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.KNOT_PROPERTY_TYPE__KNOT, newKnot, newKnot));
  }
