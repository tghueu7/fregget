 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.FileTypeImpl#getRangeParameters <em>Range Parameters</em>}
 *   <li>{@link net.opengis.gml311.impl.FileTypeImpl#getFileName <em>File Name</em>}
 *   <li>{@link net.opengis.gml311.impl.FileTypeImpl#getFileStructure <em>File Structure</em>}
 *   <li>{@link net.opengis.gml311.impl.FileTypeImpl#getMimeType <em>Mime Type</em>}
 *   <li>{@link net.opengis.gml311.impl.FileTypeImpl#getCompression <em>Compression</em>}
 * </ul>
 *
 * @generated
 */
public class FileTypeImpl extends MinimalEObjectImpl.Container implements FileType {
  /**
   * The cached value of the '{@link #getRangeParameters() <em>Range Parameters</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  protected static final FileValueModelType FILE_STRUCTURE_EDEFAULT =
      FileValueModelType.RECORD_INTERLEAVED;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FILE_TYPE__RANGE_PARAMETERS,
              oldRangeParameters,
              newRangeParameters);
  ...
  public void setRangeParameters(RangeParametersType newRangeParameters) {
    if (newRangeParameters != rangeParameters) {
      ...
      if (rangeParameters != null)
        msgs =
            ((InternalEObject) rangeParameters)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FILE_TYPE__RANGE_PARAMETERS,
                    null,
                    msgs);
      if (newRangeParameters != null)
        msgs =
            ((InternalEObject) newRangeParameters)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.FILE_TYPE__RANGE_PARAMETERS,
                    null,
  ...
  public void setFileName(String newFileName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FILE_TYPE__FILE_NAME, oldFileName, fileName));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FILE_TYPE__FILE_STRUCTURE,
              oldFileStructure,
              fileStructure,
              !oldFileStructureESet));
  }
  ...
  public void setMimeType(String newMimeType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.FILE_TYPE__MIME_TYPE, oldMimeType, mimeType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.FILE_TYPE__COMPRESSION,
              oldCompression,
              compression));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Gml311Package.FILE_TYPE__COMPRESSION:
        return COMPRESSION_EDEFAULT == null
            ? compression != null
            : !COMPRESSION_EDEFAULT.equals(compression);
    }
  ...
  public String toString() {
    ...
    if (fileStructureESet) result.append(fileStructure);
