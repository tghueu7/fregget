 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getValidTime <em>Valid Time</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getHistoryGroup <em>History
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getHistory <em>History</em>}
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getDataSource <em>Data Source</em>}
 * </ul>
 *
 * @generated
 */
public class DynamicFeatureTypeImpl extends AbstractFeatureTypeImpl implements DynamicFeatureType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME,
              oldValidTime,
              newValidTime);
      ...
      if (validTime != null)
        msgs =
            ((InternalEObject) validTime)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME,
                    null,
                    msgs);
  ...
  public HistoryPropertyType getHistory() {
    return (HistoryPropertyType)
        getHistoryGroup().get(Gml311Package.eINSTANCE.getDynamicFeatureType_History(), true);
  }
  ...
  public NotificationChain basicSetHistory(HistoryPropertyType newHistory, NotificationChain msgs) {
    return ((FeatureMap.Internal) getHistoryGroup())
        .basicAdd(Gml311Package.eINSTANCE.getDynamicFeatureType_History(), newHistory, msgs);
  }
  ...
  public void setHistory(HistoryPropertyType newHistory) {
    ((FeatureMap.Internal) getHistoryGroup())
        .set(Gml311Package.eINSTANCE.getDynamicFeatureType_History(), newHistory);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE,
              oldDataSource,
              newDataSource);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (dataSource != null)
        msgs =
            ((InternalEObject) dataSource)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE,
                    null,
                    msgs);
