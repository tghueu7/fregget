 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.LinearRingPropertyTypeImpl#getLinearRing <em>Linear
 *       Ring</em>}
 * </ul>
 *
 * @generated
 */
public class LinearRingPropertyTypeImpl extends MinimalEObjectImpl.Container
    implements LinearRingPropertyType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.LINEAR_RING_PROPERTY_TYPE__LINEAR_RING,
              oldLinearRing,
              newLinearRing);
  ...
  public void setLinearRing(LinearRingType newLinearRing) {
    if (newLinearRing != linearRing) {
      ...
      if (linearRing != null)
        msgs =
            ((InternalEObject) linearRing)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LINEAR_RING_PROPERTY_TYPE__LINEAR_RING,
                    null,
                    msgs);
      if (newLinearRing != null)
        msgs =
            ((InternalEObject) newLinearRing)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.LINEAR_RING_PROPERTY_TYPE__LINEAR_RING,
                    null,
