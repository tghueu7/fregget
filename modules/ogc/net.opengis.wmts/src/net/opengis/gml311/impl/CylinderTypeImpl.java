 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.CylinderTypeImpl#getHorizontalCurveType <em>Horizontal Curve
 *       Type</em>}
 *   <li>{@link net.opengis.gml311.impl.CylinderTypeImpl#getVerticalCurveType <em>Vertical Curve
 *       Type</em>}
 * </ul>
 *
 * @generated
...
public class CylinderTypeImpl extends AbstractGriddedSurfaceTypeImpl implements CylinderType {
  /**
   * The default value of the '{@link #getHorizontalCurveType() <em>Horizontal Curve Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getHorizontalCurveType() <em>Horizontal Curve Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getVerticalCurveType() <em>Vertical Curve Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getVerticalCurveType() <em>Vertical Curve Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public void setHorizontalCurveType(CurveInterpolationType newHorizontalCurveType) {
    ...
    horizontalCurveType =
        newHorizontalCurveType == null ? HORIZONTAL_CURVE_TYPE_EDEFAULT : newHorizontalCurveType;
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CYLINDER_TYPE__HORIZONTAL_CURVE_TYPE,
              oldHorizontalCurveType,
              horizontalCurveType,
              !oldHorizontalCurveTypeESet));
  }
  ...
  public void setVerticalCurveType(CurveInterpolationType newVerticalCurveType) {
    ...
    verticalCurveType =
        newVerticalCurveType == null ? VERTICAL_CURVE_TYPE_EDEFAULT : newVerticalCurveType;
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.CYLINDER_TYPE__VERTICAL_CURVE_TYPE,
              oldVerticalCurveType,
              verticalCurveType,
              !oldVerticalCurveTypeESet));
  }
  ...
  public String toString() {
    ...
    if (horizontalCurveTypeESet) result.append(horizontalCurveType);
    else result.append("<unset>");
    result.append(", verticalCurveType: ");
    if (verticalCurveTypeESet) result.append(verticalCurveType);
    else result.append("<unset>");
    result.append(')');
