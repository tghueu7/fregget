 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.IndirectEntryTypeImpl#getDefinitionProxy <em>Definition
 *       Proxy</em>}
 * </ul>
 *
 * @generated
 */
public class IndirectEntryTypeImpl extends MinimalEObjectImpl.Container
    implements IndirectEntryType {
  /**
   * The cached value of the '{@link #getDefinitionProxy() <em>Definition Proxy</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.INDIRECT_ENTRY_TYPE__DEFINITION_PROXY,
              oldDefinitionProxy,
              newDefinitionProxy);
  ...
  public void setDefinitionProxy(DefinitionProxyType newDefinitionProxy) {
    if (newDefinitionProxy != definitionProxy) {
      ...
      if (definitionProxy != null)
        msgs =
            ((InternalEObject) definitionProxy)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.INDIRECT_ENTRY_TYPE__DEFINITION_PROXY,
                    null,
                    msgs);
      if (newDefinitionProxy != null)
        msgs =
            ((InternalEObject) newDefinitionProxy)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.INDIRECT_ENTRY_TYPE__DEFINITION_PROXY,
                    null,
