 ...
 *
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract General Operation Parameter
 * Type</b></em>'.
 * <!-- end-user-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.AbstractGeneralOperationParameterTypeImpl#getMinimumOccurs
 *       <em>Minimum Occurs</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractGeneralOperationParameterTypeImpl extends DefinitionTypeImpl
    implements AbstractGeneralOperationParameterType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.ABSTRACT_GENERAL_OPERATION_PARAMETER_TYPE__MINIMUM_OCCURS,
              oldMinimumOccurs,
              minimumOccurs));
  }
    ...
    switch (featureID) {
      case Gml311Package.ABSTRACT_GENERAL_OPERATION_PARAMETER_TYPE__MINIMUM_OCCURS:
        return MINIMUM_OCCURS_EDEFAULT == null
            ? minimumOccurs != null
            : !MINIMUM_OCCURS_EDEFAULT.equals(minimumOccurs);
    }
