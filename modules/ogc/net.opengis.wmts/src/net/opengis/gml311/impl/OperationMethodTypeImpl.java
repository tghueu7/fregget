 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getMethodID <em>Method ID</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getMethodFormula <em>Method
 *       Formula</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getSourceDimensions <em>Source
 *       Dimensions</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getTargetDimensions <em>Target
 *       Dimensions</em>}
 *   <li>{@link net.opengis.gml311.impl.OperationMethodTypeImpl#getUsesParameter <em>Uses
 *       Parameter</em>}
 * </ul>
 *
 * @generated
 */
public class OperationMethodTypeImpl extends OperationMethodBaseTypeImpl
    implements OperationMethodType {
  /**
  ...
  /**
   * The cached value of the '{@link #getMethodFormula() <em>Method Formula</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUsesParameter() <em>Uses Parameter</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (methodID == null) {
      methodID =
          new EObjectContainmentEList<IdentifierType>(
              IdentifierType.class, this, Gml311Package.OPERATION_METHOD_TYPE__METHOD_ID);
    }
    return methodID;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_METHOD_TYPE__REMARKS,
              oldRemarks,
              newRemarks);
      ...
      if (remarks != null)
        msgs =
            ((InternalEObject) remarks)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_METHOD_TYPE__REMARKS,
                    null,
                    msgs);
      if (newRemarks != null)
        msgs =
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_METHOD_TYPE__METHOD_FORMULA,
              oldMethodFormula,
              newMethodFormula);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setMethodFormula(CodeType newMethodFormula) {
    if (newMethodFormula != methodFormula) {
      ...
      if (methodFormula != null)
        msgs =
            ((InternalEObject) methodFormula)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_METHOD_TYPE__METHOD_FORMULA,
                    null,
                    msgs);
      if (newMethodFormula != null)
        msgs =
            ((InternalEObject) newMethodFormula)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.OPERATION_METHOD_TYPE__METHOD_FORMULA,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_METHOD_TYPE__SOURCE_DIMENSIONS,
              oldSourceDimensions,
              sourceDimensions));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.OPERATION_METHOD_TYPE__TARGET_DIMENSIONS,
              oldTargetDimensions,
              targetDimensions));
  }
  ...
  public EList<AbstractGeneralOperationParameterRefType> getUsesParameter() {
    if (usesParameter == null) {
      usesParameter =
          new EObjectContainmentEList<AbstractGeneralOperationParameterRefType>(
              AbstractGeneralOperationParameterRefType.class,
              this,
              Gml311Package.OPERATION_METHOD_TYPE__USES_PARAMETER);
    }
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case Gml311Package.OPERATION_METHOD_TYPE__USES_PARAMETER:
        ...
        getUsesParameter()
            .addAll((Collection<? extends AbstractGeneralOperationParameterRefType>) newValue);
        return;
    }
    ...
    switch (featureID) {
      ...
      case Gml311Package.OPERATION_METHOD_TYPE__SOURCE_DIMENSIONS:
        return SOURCE_DIMENSIONS_EDEFAULT == null
            ...
            : !SOURCE_DIMENSIONS_EDEFAULT.equals(sourceDimensions);
      case Gml311Package.OPERATION_METHOD_TYPE__TARGET_DIMENSIONS:
        return TARGET_DIMENSIONS_EDEFAULT == null
            ? targetDimensions != null
            : !TARGET_DIMENSIONS_EDEFAULT.equals(targetDimensions);
      case Gml311Package.OPERATION_METHOD_TYPE__USES_PARAMETER:
