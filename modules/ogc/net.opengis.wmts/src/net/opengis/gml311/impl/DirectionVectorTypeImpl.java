 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DirectionVectorTypeImpl#getVector <em>Vector</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectionVectorTypeImpl#getHorizontalAngle <em>Horizontal
 *       Angle</em>}
 *   <li>{@link net.opengis.gml311.impl.DirectionVectorTypeImpl#getVerticalAngle <em>Vertical
 *       Angle</em>}
 * </ul>
 *
 * @generated
 */
public class DirectionVectorTypeImpl extends MinimalEObjectImpl.Container
  ...
  /**
   * The cached value of the '{@link #getHorizontalAngle() <em>Horizontal Angle</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getVerticalAngle() <em>Vertical Angle</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTION_VECTOR_TYPE__VECTOR,
              oldVector,
              newVector);
  ...
  public void setVector(VectorType newVector) {
    if (newVector != vector) {
      ...
      if (vector != null)
        msgs =
            ((InternalEObject) vector)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__VECTOR,
                    null,
                    msgs);
      if (newVector != null)
        msgs =
            ((InternalEObject) newVector)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__VECTOR,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetHorizontalAngle(
      AngleType newHorizontalAngle, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTION_VECTOR_TYPE__HORIZONTAL_ANGLE,
              oldHorizontalAngle,
              newHorizontalAngle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setHorizontalAngle(AngleType newHorizontalAngle) {
    if (newHorizontalAngle != horizontalAngle) {
      ...
      if (horizontalAngle != null)
        msgs =
            ((InternalEObject) horizontalAngle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__HORIZONTAL_ANGLE,
                    null,
                    msgs);
      if (newHorizontalAngle != null)
        msgs =
            ((InternalEObject) newHorizontalAngle)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__HORIZONTAL_ANGLE,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetVerticalAngle(
      AngleType newVerticalAngle, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.DIRECTION_VECTOR_TYPE__VERTICAL_ANGLE,
              oldVerticalAngle,
              newVerticalAngle);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setVerticalAngle(AngleType newVerticalAngle) {
    if (newVerticalAngle != verticalAngle) {
      ...
      if (verticalAngle != null)
        msgs =
            ((InternalEObject) verticalAngle)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__VERTICAL_ANGLE,
                    null,
                    msgs);
      if (newVerticalAngle != null)
        msgs =
            ((InternalEObject) newVerticalAngle)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.DIRECTION_VECTOR_TYPE__VERTICAL_ANGLE,
                    null,
