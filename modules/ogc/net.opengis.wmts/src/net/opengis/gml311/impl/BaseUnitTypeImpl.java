 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.BaseUnitTypeImpl#getUnitsSystem <em>Units System</em>}
 * </ul>
 *
 * @generated
 */
public class BaseUnitTypeImpl extends UnitDefinitionTypeImpl implements BaseUnitType {
  /**
   * The cached value of the '{@link #getUnitsSystem() <em>Units System</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetUnitsSystem(
      ReferenceType newUnitsSystem, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.BASE_UNIT_TYPE__UNITS_SYSTEM,
              oldUnitsSystem,
              newUnitsSystem);
  ...
  public void setUnitsSystem(ReferenceType newUnitsSystem) {
    if (newUnitsSystem != unitsSystem) {
      ...
      if (unitsSystem != null)
        msgs =
            ((InternalEObject) unitsSystem)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.BASE_UNIT_TYPE__UNITS_SYSTEM,
                    null,
                    msgs);
      if (newUnitsSystem != null)
        msgs =
            ((InternalEObject) newUnitsSystem)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.BASE_UNIT_TYPE__UNITS_SYSTEM,
                    null,
