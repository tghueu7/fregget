 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TimeTopologyComplexTypeImpl#getPrimitive <em>Primitive</em>}
 * </ul>
 *
 * @generated
 */
public class TimeTopologyComplexTypeImpl extends AbstractTimeComplexTypeImpl
    implements TimeTopologyComplexType {
  /**
  ...
  public EList<TimeTopologyPrimitivePropertyType> getPrimitive() {
    if (primitive == null) {
      primitive =
          new EObjectContainmentEList<TimeTopologyPrimitivePropertyType>(
              TimeTopologyPrimitivePropertyType.class,
              this,
              Gml311Package.TIME_TOPOLOGY_COMPLEX_TYPE__PRIMITIVE);
    }
    return primitive;
  }
