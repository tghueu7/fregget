 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.TransformationTypeImpl#getUsesMethod <em>Uses Method</em>}
 *   <li>{@link net.opengis.gml311.impl.TransformationTypeImpl#getUsesValue <em>Uses Value</em>}
 * </ul>
 *
 * @generated
 */
public class TransformationTypeImpl extends AbstractGeneralTransformationTypeImpl
  ...
  /**
   * The cached value of the '{@link #getUsesValue() <em>Uses Value</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Gml311Package.TRANSFORMATION_TYPE__USES_METHOD,
              oldUsesMethod,
              newUsesMethod);
  ...
  public void setUsesMethod(OperationMethodRefType newUsesMethod) {
    if (newUsesMethod != usesMethod) {
      ...
      if (usesMethod != null)
        msgs =
            ((InternalEObject) usesMethod)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TRANSFORMATION_TYPE__USES_METHOD,
                    null,
                    msgs);
      if (newUsesMethod != null)
        msgs =
            ((InternalEObject) newUsesMethod)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Gml311Package.TRANSFORMATION_TYPE__USES_METHOD,
                    null,
  ...
  public EList<ParameterValueType> getUsesValue() {
    if (usesValue == null) {
      usesValue =
          new EObjectContainmentEList<ParameterValueType>(
              ParameterValueType.class, this, Gml311Package.TRANSFORMATION_TYPE__USES_VALUE);
    }
    return usesValue;
  }
