 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ArrayTypeImpl#getMembers <em>Members</em>}
 * </ul>
 *
 * @generated
 */
public class ArrayTypeImpl extends AbstractGMLTypeImpl implements ArrayType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ARRAY_TYPE__MEMBERS, oldMembers, newMembers);
  ...
  public void setMembers(ArrayAssociationType newMembers) {
    if (newMembers != members) {
      ...
      if (members != null)
        msgs =
            ((InternalEObject) members)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Gml311Package.ARRAY_TYPE__MEMBERS, null, msgs);
      if (newMembers != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Gml311Package.ARRAY_TYPE__MEMBERS, newMembers, newMembers));
  }
