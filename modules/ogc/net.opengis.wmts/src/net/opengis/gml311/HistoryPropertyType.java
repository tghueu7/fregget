 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.HistoryPropertyType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.HistoryPropertyType#getTimeSliceGroup <em>Time Slice Group</em>}
 *   <li>{@link net.opengis.gml311.HistoryPropertyType#getTimeSlice <em>Time Slice</em>}
 * </ul>
 *
...
public interface HistoryPropertyType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Time Slice Group</b></em>' attribute list. The list contents
   * are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Time Slice Group</em>' attribute list isn't clear, there really
   ...
   *     many="true" transient="true" volatile="true" derived="true" extendedMetaData="kind='group'
   *     name='_TimeSlice:group' namespace='##targetNamespace' group='#group:0'"
   * @generated
   */
  FeatureMap getTimeSliceGroup();

  /**
   * Returns the value of the '<em><b>Time Slice</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractTimeSliceType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Time Slice</em>' containment reference list isn't clear, there
   ...
   *     namespace='##targetNamespace' group='_TimeSlice:group'"
   * @generated
   */
