 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Paremeters of a simple formula by which a value using this unit of measure can be converted to
 * the corresponding value using the preferred unit of measure. The formula element contains
 * elements a, b, c and d, whose values use the XML Schema type "double". These values are used in
 * the formula y = (a + bx) / (c + dx), where x is a value using this unit, and y is the
 * corresponding value using the preferred unit. The elements a and d are optional, and if values
 * are not provided, those parameters are considered to be zero. If values are not provided for both
 * a and d, the formula is equivalent to a fraction with numerator and denominator parameters.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.FormulaType#getA <em>A</em>}
 *   <li>{@link net.opengis.gml311.FormulaType#getB <em>B</em>}
 *   <li>{@link net.opengis.gml311.FormulaType#getC <em>C</em>}
 *   <li>{@link net.opengis.gml311.FormulaType#getD <em>D</em>}
 * </ul>
 *
...
public interface FormulaType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>A</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FormulaType#getA <em>A</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>B</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FormulaType#getB <em>B</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>C</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FormulaType#getC <em>C</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>D</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.FormulaType#getD <em>D</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
