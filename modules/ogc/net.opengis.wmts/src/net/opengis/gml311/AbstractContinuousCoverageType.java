 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A continuous coverage as defined in ISO 19123 is a coverage that can return different values for
 * the same feature attribute at different direct positions within a single spatiotemporal object in
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractContinuousCoverageType#getCoverageFunction <em>Coverage
 *       Function</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractContinuousCoverageType()
 * @model abstract="true" extendedMetaData="name='AbstractContinuousCoverageType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractContinuousCoverageType extends AbstractCoverageType {
   ...
   * net.opengis.gml311.AbstractContinuousCoverageType#getCoverageFunction <em>Coverage
