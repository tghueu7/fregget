 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Represents a triangle as a surface with an outer boundary consisting of a linear ring. Note that
 * this is a polygon (subtype) with no inner boundaries. The number of points in the linear ring
 * must be four.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TriangleType#getExteriorGroup <em>Exterior Group</em>}
 *   <li>{@link net.opengis.gml311.TriangleType#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.TriangleType#getInterpolation <em>Interpolation</em>}
 * </ul>
 *
...
public interface TriangleType extends AbstractSurfacePatchType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Constraint: The Ring shall be a LinearRing and must form a triangle, the first and the last
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TriangleType#getExterior <em>Exterior</em>}'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TriangleType#getInterpolation
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TriangleType#getInterpolation
   * <em>Interpolation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.TriangleType#getInterpolation
