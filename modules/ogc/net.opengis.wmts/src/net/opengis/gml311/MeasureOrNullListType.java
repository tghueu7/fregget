 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * List of numbers with a uniform scale. A member of the list may be a typed null. The value of uom
 * (Units Of Measure) attribute is a reference to a Reference System for the amount, either a ratio
 * or position scale.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MeasureOrNullListType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.MeasureOrNullListType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface MeasureOrNullListType extends EObject {
   ...
   * @model dataType="net.opengis.gml311.DoubleOrNullList" many="false" extendedMetaData="name=':0'
   *     kind='simple'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MeasureOrNullListType#getValue
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MeasureOrNullListType#getUom <em>Uom</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
