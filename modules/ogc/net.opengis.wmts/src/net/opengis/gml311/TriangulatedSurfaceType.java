 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A triangulated surface is a polyhedral surface that is composed only of triangles. There is no
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TriangulatedSurfaceType#getTrianglePatches <em>Triangle
 *       Patches</em>}
 * </ul>
 *
...
public interface TriangulatedSurfaceType extends SurfaceType {
   ...
   *     name='trianglePatches' namespace='##targetNamespace'"
   * @generated
   */
  TrianglePatchArrayPropertyType getTrianglePatches();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TriangulatedSurfaceType#getTrianglePatches
   * <em>Triangle Patches</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
