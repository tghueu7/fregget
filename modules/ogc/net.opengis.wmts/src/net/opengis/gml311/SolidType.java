 ...
 * surface (a list of orientable surfaces) connected in a topological cycle (an object whose
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.SolidType#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.SolidType#getInterior <em>Interior</em>}
 * </ul>
 *
...
public interface SolidType extends AbstractSolidType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Boundaries of solids are similar to surface boundaries. In normal 3-dimensional Euclidean
   * space, one (composite) surface is distinguished as the exterior. In the more general case, this
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SolidType#getExterior <em>Exterior</em>}'
   ...
   * contents are of type {@link net.opengis.gml311.SurfacePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='interior'
   *     namespace='##targetNamespace'"
   * @generated
   */
