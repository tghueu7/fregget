 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * [complexType of] Predefined concrete value of the top-level property. Encapsulates all other
 * styling information.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.StyleType#getFeatureStyle <em>Feature Style</em>}
 *   <li>{@link net.opengis.gml311.StyleType#getGraphStyle <em>Graph Style</em>}
 * </ul>
 *
...
public interface StyleType extends AbstractStyleType {
  /**
   * Returns the value of the '<em><b>Feature Style</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.FeatureStylePropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * <!-- end-model-doc -->
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='featureStyle'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.StyleType#getGraphStyle <em>Graph Style</em>}'
