 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Abstract General Operation Parameter Ref
 * Type</b></em>'.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Association to an operation parameter or group, either referencing or containing the definition
 * of that parameter or group.
 * <!-- end-model-doc -->
 *
 ...
 * <ul>
 *   <li>{@link
 *       net.opengis.gml311.AbstractGeneralOperationParameterRefType#getGeneralOperationParameterGroup
 *       <em>General Operation Parameter Group</em>}
 *   <li>{@link
 *       net.opengis.gml311.AbstractGeneralOperationParameterRefType#getGeneralOperationParameter
 *       <em>General Operation Parameter</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getActuate
 *       <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getArcrole
 *       <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getRemoteSchema
 *       <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.AbstractGeneralOperationParameterRefType#getType <em>Type</em>}
 * </ul>
 *
...
public interface AbstractGeneralOperationParameterRefType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>General Operation Parameter Group</em>' attribute list isn't
   * clear, there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>General Operation Parameter Group</em>' attribute list.
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractGeneralOperationParameterRefType_GeneralOperationParameterGroup()
   * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
   *     extendedMetaData="kind='group' name='_GeneralOperationParameter:group'
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractGeneralOperationParameterRefType_GeneralOperationParameter()
   * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='_GeneralOperationParameter'
   *     namespace='##targetNamespace' group='_GeneralOperationParameter:group'"
   * @generated
   */
   ...
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getArcrole <em>Arcrole</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getHref <em>Href</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractGeneralOperationParameterRefType_RemoteSchema()
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getRemoteSchema <em>Remote
   * Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getRole <em>Role</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getShow <em>Show</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link
   * net.opengis.gml311.AbstractGeneralOperationParameterRefType#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
