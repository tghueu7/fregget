 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A container for an array of solids. The elements are always contained in the array property,
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.SolidArrayPropertyType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.gml311.SolidArrayPropertyType#getSolidGroup <em>Solid Group</em>}
 *   <li>{@link net.opengis.gml311.SolidArrayPropertyType#getSolid <em>Solid</em>}
 * </ul>
 *
...
public interface SolidArrayPropertyType extends EObject {
   ...
   *     name='_Solid:group' namespace='##targetNamespace' group='#group:0'"
   * @generated
   */
  FeatureMap getSolidGroup();

  /**
   * Returns the value of the '<em><b>Solid</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.gml311.AbstractSolidType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "_Solid" element is the abstract head of the substituition group for all (continuous) solid
