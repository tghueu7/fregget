 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for reference system objects, simplifying and restricting the DefinitionType as
 * needed.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractReferenceSystemBaseType#getSrsName <em>Srs Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractReferenceSystemBaseType()
 * @model abstract="true" extendedMetaData="name='AbstractReferenceSystemBaseType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractReferenceSystemBaseType extends DefinitionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='srsName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractReferenceSystemBaseType#getSrsName
   * <em>Srs Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
