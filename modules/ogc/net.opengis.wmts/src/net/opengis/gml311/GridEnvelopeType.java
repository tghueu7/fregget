 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Provides grid coordinate values for the diametrically opposed corners of an envelope that bounds
 * a section of grid. The value of a single coordinate is the number of offsets from the origin of
 * the grid in the direction of a specific axis.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GridEnvelopeType#getLow <em>Low</em>}
 *   <li>{@link net.opengis.gml311.GridEnvelopeType#getHigh <em>High</em>}
 * </ul>
 *
...
public interface GridEnvelopeType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Low</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridEnvelopeType#getLow <em>Low</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>High</em>' attribute isn't clear, there really should be more of
   * a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridEnvelopeType#getHigh <em>High</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
