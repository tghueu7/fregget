 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractFeatureCollectionType#getFeatureMember <em>Feature
 *       Member</em>}
 *   <li>{@link net.opengis.gml311.AbstractFeatureCollectionType#getFeatureMembers <em>Feature
 *       Members</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractFeatureCollectionType()
 * @model abstract="true" extendedMetaData="name='AbstractFeatureCollectionType' kind='elementOnly'"
 * @generated
 */
public interface AbstractFeatureCollectionType extends AbstractFeatureType {
  /**
   * Returns the value of the '<em><b>Feature Member</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.FeaturePropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Member</em>' containment reference list isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='featureMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='featureMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * net.opengis.gml311.AbstractFeatureCollectionType#getFeatureMembers <em>Feature Members</em>}'
