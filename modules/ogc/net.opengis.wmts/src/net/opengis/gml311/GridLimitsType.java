 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GridLimitsType#getGridEnvelope <em>Grid Envelope</em>}
 * </ul>
 *
...
public interface GridLimitsType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Grid Envelope</em>' containment reference isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='GridEnvelope'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridLimitsType#getGridEnvelope <em>Grid
