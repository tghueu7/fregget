 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PriorityLocationPropertyType#getPriority <em>Priority</em>}
 * </ul>
 *
...
public interface PriorityLocationPropertyType extends LocationPropertyType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Priority</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PriorityLocationPropertyType#getPriority
