 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Number with a scale. The value of uom (Units Of Measure) attribute is a reference to a Reference
 * System for the amount, either a ratio or position scale.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MeasureType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.gml311.MeasureType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface MeasureType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MeasureType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.MeasureType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.MeasureType#getValue
