 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CompositeSolidType#getSolidMember <em>Solid Member</em>}
 * </ul>
 *
...
public interface CompositeSolidType extends AbstractSolidType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This element references or contains one solid in the composite solid. The solids are
   * contiguous. NOTE: This definition allows for a nested structure, i.e. a CompositeSolid may use,
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='solidMember'
