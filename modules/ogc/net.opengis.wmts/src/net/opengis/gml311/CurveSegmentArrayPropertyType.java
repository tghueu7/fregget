 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CurveSegmentArrayPropertyType#getCurveSegmentGroup <em>Curve
 *       Segment Group</em>}
 *   <li>{@link net.opengis.gml311.CurveSegmentArrayPropertyType#getCurveSegment <em>Curve
 *       Segment</em>}
 * </ul>
 *
...
public interface CurveSegmentArrayPropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Curve Segment Group</b></em>' attribute list. The list
  ...
  /**
   * Returns the value of the '<em><b>Curve Segment</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractCurveSegmentType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * The "_CurveSegment" element is the abstract head of the substituition group for all curve
