 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Increment Order</b></em>', and
 * utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The enumeration value here indicates the incrementation order to be used on the first 2 axes,
 * i.e. "+x-y" means that the points on the first axis are to be traversed from lowest to highest
 * and the points on the second axis are to be traversed from highest to lowest. The points on all
 * other axes (if any) beyond the first 2 are assumed to increment from lowest to highest.
 * <!-- end-model-doc -->
 *
...
public enum IncrementOrder implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>XY</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>YX</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #YX
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>XY1</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #XY1
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>XY2</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #XY2
