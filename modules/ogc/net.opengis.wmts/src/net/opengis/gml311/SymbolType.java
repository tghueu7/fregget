 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.SymbolType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getAbout <em>About</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getRemoteSchema <em>Remote Schema</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getSymbolType <em>Symbol Type</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getTransform <em>Transform</em>}
 *   <li>{@link net.opengis.gml311.SymbolType#getType <em>Type</em>}
 * </ul>
 *
...
public interface SymbolType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getAbout <em>About</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.SymbolType#getActuate <em>Actuate</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.SymbolType#getActuate
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getArcrole <em>Arcrole</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getRemoteSchema <em>Remote
   * Schema</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.SymbolType#getShow <em>Show</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.SymbolType#getShow <em>Show</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Symbol Type</b></em>' attribute. The literals are from the
   * enumeration {@link net.opengis.gml311.SymbolTypeEnumeration}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Symbol Type</em>' attribute isn't clear, there really should be
   ...
   * @model unsettable="true" required="true" extendedMetaData="kind='attribute' name='symbolType'"
   * @generated
   */
  SymbolTypeEnumeration getSymbolType();

  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getSymbolType <em>Symbol
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.SymbolType#getSymbolType <em>Symbol
   * Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.SymbolType#getSymbolType <em>Symbol
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getTitle <em>Title</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.SymbolType#getTransform <em>Transform</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.SymbolType#getType <em>Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.SymbolType#getType <em>Type</em>}'
   * attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
