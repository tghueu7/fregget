 ...
 * CRSs on moving platforms such as road vehicles, vessels, aircraft, or spacecraft. For further
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.EngineeringCRSType#getUsesCS <em>Uses CS</em>}
 *   <li>{@link net.opengis.gml311.EngineeringCRSType#getUsesEngineeringDatum <em>Uses Engineering
 *       Datum</em>}
 * </ul>
 *
...
public interface EngineeringCRSType extends AbstractReferenceSystemType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='usesCS'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.EngineeringCRSType#getUsesCS <em>Uses
   ...
   *     name='usesEngineeringDatum' namespace='##targetNamespace'"
   * @generated
   */
  EngineeringDatumRefType getUsesEngineeringDatum();

  /**
   * Sets the value of the '{@link net.opengis.gml311.EngineeringCRSType#getUsesEngineeringDatum
   * <em>Uses Engineering Datum</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
