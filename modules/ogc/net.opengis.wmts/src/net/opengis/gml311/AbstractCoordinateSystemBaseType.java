 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for coordinate system objects, simplifying and restricting the DefinitionType as
 * needed.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractCoordinateSystemBaseType#getCsName <em>Cs Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractCoordinateSystemBaseType()
 * @model abstract="true" extendedMetaData="name='AbstractCoordinateSystemBaseType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractCoordinateSystemBaseType extends DefinitionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='csName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoordinateSystemBaseType#getCsName
   * <em>Cs Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
