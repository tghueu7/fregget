 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PolygonPatchType#getExteriorGroup <em>Exterior Group</em>}
 *   <li>{@link net.opengis.gml311.PolygonPatchType#getExterior <em>Exterior</em>}
 *   <li>{@link net.opengis.gml311.PolygonPatchType#getInteriorGroup <em>Interior Group</em>}
 *   <li>{@link net.opengis.gml311.PolygonPatchType#getInterior <em>Interior</em>}
 *   <li>{@link net.opengis.gml311.PolygonPatchType#getInterpolation <em>Interpolation</em>}
 * </ul>
 *
...
public interface PolygonPatchType extends AbstractSurfacePatchType {
  /**
   * Returns the value of the '<em><b>Exterior Group</b></em>' attribute list. The list contents are
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PolygonPatchType#getExterior
   * <em>Exterior</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Interior Group</b></em>' attribute list. The list contents are
   * of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Interior</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractRingPropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A boundary of a surface consists of a number of rings. The "interior" rings seperate the
   ...
   * "planar"</code>. The literals are from the enumeration {@link
   ...
   * patch. Currently only planar surface patches are defined in GML 3, the attribute is fixed to
   * "planar", i.e. the interpolation method shall return points on a single plane. The boundary of
   ...
   * @model default="planar" unsettable="true" extendedMetaData="kind='attribute'
   *     name='interpolation'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.PolygonPatchType#getInterpolation
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.PolygonPatchType#getInterpolation
   * <em>Interpolation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.PolygonPatchType#getInterpolation
