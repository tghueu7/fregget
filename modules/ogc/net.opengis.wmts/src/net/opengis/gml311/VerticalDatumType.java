 ...
 * used as a zero-height surface, including its position with respect to the Earth for any of the
 * height types recognized by this standard. There are several types of Vertical Datums, and each
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.VerticalDatumType#getVerticalDatumType <em>Vertical Datum
 *       Type</em>}
 * </ul>
 *
...
public interface VerticalDatumType extends AbstractDatumType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='verticalDatumType'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.VerticalDatumType#getVerticalDatumType
   * <em>Vertical Datum Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
