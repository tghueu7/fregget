 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TopoComplexType#getMaximalComplex <em>Maximal Complex</em>}
 *   <li>{@link net.opengis.gml311.TopoComplexType#getSuperComplex <em>Super Complex</em>}
 *   <li>{@link net.opengis.gml311.TopoComplexType#getSubComplex <em>Sub Complex</em>}
 *   <li>{@link net.opengis.gml311.TopoComplexType#getTopoPrimitiveMember <em>Topo Primitive
 *       Member</em>}
 *   <li>{@link net.opengis.gml311.TopoComplexType#getTopoPrimitiveMembers <em>Topo Primitive
 *       Members</em>}
 *   <li>{@link net.opengis.gml311.TopoComplexType#isIsMaximal <em>Is Maximal</em>}
 * </ul>
 *
...
public interface TopoComplexType extends AbstractTopologyType {
   ...
   *     name='maximalComplex' namespace='##targetNamespace'"
   * @generated
   */
  TopoComplexMemberType getMaximalComplex();

  /**
   * Sets the value of the '{@link net.opengis.gml311.TopoComplexType#getMaximalComplex <em>Maximal
  ...
  /**
   * Returns the value of the '<em><b>Super Complex</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TopoComplexMemberType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Super Complex</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='superComplex'
  ...
  /**
   * Returns the value of the '<em><b>Sub Complex</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TopoComplexMemberType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Sub Complex</em>' containment reference list isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='subComplex'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Topo Primitive Member</em>' containment reference list isn't
   ...
   * @model containment="true" extendedMetaData="kind='element' name='topoPrimitiveMember'
   *     namespace='##targetNamespace'"
   * @generated
   */
   ...
   * @model containment="true" extendedMetaData="kind='element' name='topoPrimitiveMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopoComplexType#getTopoPrimitiveMembers
   * <em>Topo Primitive Members</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Is Maximal</b></em>' attribute. The default value is <code>
   * "false"</code>.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Is Maximal</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopoComplexType#isIsMaximal <em>Is
   * Maximal</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.TopoComplexType#isIsMaximal <em>Is
   * Maximal</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.TopoComplexType#isIsMaximal <em>Is
   * Maximal</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
