 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TrianglePatchArrayPropertyType#getTriangle <em>Triangle</em>}
 * </ul>
 *
...
public interface TrianglePatchArrayPropertyType extends SurfacePatchArrayPropertyType {
  /**
   * Returns the value of the '<em><b>Triangle</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TriangleType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Triangle</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Triangle'
