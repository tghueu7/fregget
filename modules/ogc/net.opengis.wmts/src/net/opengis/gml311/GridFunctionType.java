 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Defines how values in the domain are mapped to the range set. The start point and the sequencing
 * rule are specified here.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GridFunctionType#getSequenceRule <em>Sequence Rule</em>}
 *   <li>{@link net.opengis.gml311.GridFunctionType#getStartPoint <em>Start Point</em>}
 * </ul>
 *
...
public interface GridFunctionType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='sequenceRule'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GridFunctionType#getSequenceRule <em>Sequence
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Index position of the first grid post, which must lie somwhere in the GridEnvelope. If absent,
   * the startPoint is equal to the value of gridEnvelope::low from the grid definition.
   * <!-- end-model-doc -->
   *
   ...
   *     name='startPoint' namespace='##targetNamespace'"
   * @generated
   */
  List<BigInteger> getStartPoint();

  /**
   * Sets the value of the '{@link net.opengis.gml311.GridFunctionType#getStartPoint <em>Start
   * Point</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
