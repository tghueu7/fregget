 ...
 * other types of parameter values are possible. This complexType is expected to be used or extended
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationParameterType#getParameterID <em>Parameter ID</em>}
 *   <li>{@link net.opengis.gml311.OperationParameterType#getRemarks <em>Remarks</em>}
 * </ul>
 *
...
public interface OperationParameterType extends OperationParameterBaseType {
  /**
   * Returns the value of the '<em><b>Parameter ID</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alternative identifications of this operation parameter. The first parameterID, if any,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='parameterID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationParameterType#getRemarks
