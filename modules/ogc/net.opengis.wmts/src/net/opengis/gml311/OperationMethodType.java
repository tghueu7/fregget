 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationMethodType#getMethodID <em>Method ID</em>}
 *   <li>{@link net.opengis.gml311.OperationMethodType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.OperationMethodType#getMethodFormula <em>Method Formula</em>}
 *   <li>{@link net.opengis.gml311.OperationMethodType#getSourceDimensions <em>Source
 *       Dimensions</em>}
 *   <li>{@link net.opengis.gml311.OperationMethodType#getTargetDimensions <em>Target
 *       Dimensions</em>}
 *   <li>{@link net.opengis.gml311.OperationMethodType#getUsesParameter <em>Uses Parameter</em>}
 * </ul>
 *
...
public interface OperationMethodType extends OperationMethodBaseType {
  /**
   * Returns the value of the '<em><b>Method ID</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alternative identifications of this operation method. The first methodID, if any, is
   ...
   * @model containment="true" extendedMetaData="kind='element' name='methodID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationMethodType#getRemarks
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='methodFormula'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationMethodType#getMethodFormula
   * <em>Method Formula</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationMethodType#getSourceDimensions
   * <em>Source Dimensions</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationMethodType#getTargetDimensions
   * <em>Target Dimensions</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Uses Parameter</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.AbstractGeneralOperationParameterRefType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of associations to the set of operation parameters and parameter groups used by
   ...
   * @model containment="true" extendedMetaData="kind='element' name='usesParameter'
   *     namespace='##targetNamespace'"
   * @generated
   */
