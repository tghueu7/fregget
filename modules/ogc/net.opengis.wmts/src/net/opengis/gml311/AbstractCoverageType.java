 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Abstract element which acts as the head of a substitution group for coverages. Note that a
 * coverage is a GML feature.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractCoverageType#getDomainSetGroup <em>Domain Set Group</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoverageType#getDomainSet <em>Domain Set</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoverageType#getRangeSet <em>Range Set</em>}
 *   <li>{@link net.opengis.gml311.AbstractCoverageType#getDimension <em>Dimension</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractCoverageType()
 * @model abstract="true" extendedMetaData="name='AbstractCoverageType' kind='elementOnly'"
 * @generated
 */
public interface AbstractCoverageType extends AbstractFeatureType {
  /**
   * Returns the value of the '<em><b>Domain Set Group</b></em>' attribute list. The list contents
   * are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Domain Set Group</em>' attribute list isn't clear, there really
   ...
   *     group='domainSet:group'"
   * @generated
   */
  DomainSetType getDomainSet();

  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoverageType#getDomainSet <em>Domain
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoverageType#getRangeSet <em>Range
   * Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Dimension</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractCoverageType#getDimension
   * <em>Dimension</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
