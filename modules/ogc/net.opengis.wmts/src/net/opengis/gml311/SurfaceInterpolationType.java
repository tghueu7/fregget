...
public enum SurfaceInterpolationType implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>None</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Planar</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Spherical</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Tin</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #TIN
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Parametric Curve</b></em>' literal object isn't clear, there
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Triangulated Spline</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Surface Interpolation Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Surface Interpolation Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public static SurfaceInterpolationType get(int value) {
    switch (value) {
      ...
      case TRIANGULATED_SPLINE_VALUE:
