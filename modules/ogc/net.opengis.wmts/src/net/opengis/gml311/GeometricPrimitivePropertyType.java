 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getGeometricPrimitiveGroup
 *       <em>Geometric Primitive Group</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getGeometricPrimitive
 *       <em>Geometric Primitive</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getActuate <em>Actuate</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getArcrole <em>Arcrole</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getHref <em>Href</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getRemoteSchema <em>Remote
 *       Schema</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getRole <em>Role</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getShow <em>Show</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getTitle <em>Title</em>}
 *   <li>{@link net.opengis.gml311.GeometricPrimitivePropertyType#getType <em>Type</em>}
 * </ul>
 *
...
public interface GeometricPrimitivePropertyType extends EObject {
  /**
   * Returns the value of the '<em><b>Geometric Primitive Group</b></em>' attribute list. The list
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getGeometricPrimitivePropertyType_GeometricPrimitiveGroup()
   * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
   *     extendedMetaData="kind='group' name='_GeometricPrimitive:group'
   ...
   *     extendedMetaData="kind='element' name='_GeometricPrimitive' namespace='##targetNamespace'
   *     group='_GeometricPrimitive:group'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getActuate
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getActuate
   * <em>Actuate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.gml311.GeometricPrimitivePropertyType#getActuate <em>Actuate</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getArcrole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getHref
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getRemoteSchema
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getRole
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getShow
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getShow
   * <em>Show</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.gml311.GeometricPrimitivePropertyType#getShow <em>Show</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getTitle
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getType
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.GeometricPrimitivePropertyType#getType
   * <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link
   * net.opengis.gml311.GeometricPrimitivePropertyType#getType <em>Type</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
