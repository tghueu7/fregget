 ...
 * but in such a way that the distortion that is inherent to the approximation is carefully
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ProjectedCRSType#getUsesCartesianCS <em>Uses Cartesian CS</em>}
 * </ul>
 *
...
public interface ProjectedCRSType extends AbstractGeneralDerivedCRSType {
   ...
   *     name='usesCartesianCS' namespace='##targetNamespace'"
   * @generated
   */
  CartesianCSRefType getUsesCartesianCS();

  /**
   * Sets the value of the '{@link net.opengis.gml311.ProjectedCRSType#getUsesCartesianCS <em>Uses
