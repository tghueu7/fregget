 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Definition of one unit term for a derived unit of measure. This unit term references another unit
 * of measure (uom) and provides an integer exponent applied to that unit in defining the compound
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.DerivationUnitTermType#getExponent <em>Exponent</em>}
 * </ul>
 *
...
public interface DerivationUnitTermType extends UnitOfMeasureType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Exponent</em>' attribute isn't clear, there really should be more
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DerivationUnitTermType#getExponent
   * <em>Exponent</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
