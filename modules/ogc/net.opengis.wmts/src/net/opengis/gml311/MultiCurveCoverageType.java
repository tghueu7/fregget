 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiCurveCoverageType#getMultiCurveDomain <em>Multi Curve
 *       Domain</em>}
 * </ul>
 *
...
public interface MultiCurveCoverageType extends AbstractDiscreteCoverageType {
   ...
   *     name='multiCurveDomain' namespace='##targetNamespace'"
   * @generated
   */
  MultiCurveDomainType getMultiCurveDomain();

  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiCurveCoverageType#getMultiCurveDomain
   * <em>Multi Curve Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
