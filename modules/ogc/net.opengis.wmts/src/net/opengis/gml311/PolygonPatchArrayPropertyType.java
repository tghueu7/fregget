 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.PolygonPatchArrayPropertyType#getPolygonPatch <em>Polygon
 *       Patch</em>}
 * </ul>
 *
...
public interface PolygonPatchArrayPropertyType extends SurfacePatchArrayPropertyType {
  /**
   * Returns the value of the '<em><b>Polygon Patch</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.PolygonPatchType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Polygon Patch</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='PolygonPatch'
