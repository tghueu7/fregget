 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Label is mixed -- composed of text and XPath expressions used to extract the useful information
 * from the feature.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.LabelType#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.gml311.LabelType#getLabelExpression <em>Label Expression</em>}
 *   <li>{@link net.opengis.gml311.LabelType#getTransform <em>Transform</em>}
 * </ul>
 *
...
public interface LabelType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Label Expression</b></em>' attribute list. The list contents
   * are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Label Expression</em>' attribute list isn't clear, there really
   ...
   *     volatile="true" derived="true" extendedMetaData="kind='element' name='LabelExpression'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.LabelType#getTransform <em>Transform</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
