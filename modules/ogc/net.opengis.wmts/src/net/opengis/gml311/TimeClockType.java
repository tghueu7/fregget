 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * A clock provides a basis for defining temporal position within a day. A clock must be used with a
 * calendar in order to provide a complete description of a temporal position within a specific day.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TimeClockType#getReferenceEvent <em>Reference Event</em>}
 *   <li>{@link net.opengis.gml311.TimeClockType#getReferenceTime <em>Reference Time</em>}
 *   <li>{@link net.opengis.gml311.TimeClockType#getUtcReference <em>Utc Reference</em>}
 *   <li>{@link net.opengis.gml311.TimeClockType#getDateBasis <em>Date Basis</em>}
 * </ul>
 *
...
public interface TimeClockType extends AbstractTimeReferenceSystemType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Name or description of an event, such as solar noon or sunrise, which fixes the position of the
   * base scale of the clock.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeClockType#getReferenceEvent <em>Reference
   * Event</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * time of day associated with the reference event expressed as a time of day in the given clock.
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeClockType#getReferenceTime <em>Reference
   * Time</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TimeClockType#getUtcReference <em>Utc
  ...
  /**
   * Returns the value of the '<em><b>Date Basis</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.TimeCalendarPropertyType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Date Basis</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='dateBasis'
