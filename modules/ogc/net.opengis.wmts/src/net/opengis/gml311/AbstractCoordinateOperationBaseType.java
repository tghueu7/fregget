 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Basic encoding for coordinate operation objects, simplifying and restricting the DefinitionType
 * as needed.
 * <!-- end-model-doc -->
 *
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractCoordinateOperationBaseType#getCoordinateOperationName
 *       <em>Coordinate Operation Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractCoordinateOperationBaseType()
 * @model abstract="true" extendedMetaData="name='AbstractCoordinateOperationBaseType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractCoordinateOperationBaseType extends DefinitionType {
   ...
   * @see
   *     net.opengis.gml311.Gml311Package#getAbstractCoordinateOperationBaseType_CoordinateOperationName()
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='coordinateOperationName' namespace='##targetNamespace'"
   * @generated
   */
   ...
   * net.opengis.gml311.AbstractCoordinateOperationBaseType#getCoordinateOperationName
