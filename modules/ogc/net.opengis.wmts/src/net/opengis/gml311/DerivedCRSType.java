 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.DerivedCRSType#getDerivedCRSType <em>Derived CRS Type</em>}
 *   <li>{@link net.opengis.gml311.DerivedCRSType#getUsesCS <em>Uses CS</em>}
 * </ul>
 *
...
public interface DerivedCRSType extends AbstractGeneralDerivedCRSType {
   ...
   *     name='derivedCRSType' namespace='##targetNamespace'"
   * @generated
   */
  DerivedCRSTypeType getDerivedCRSType();

  /**
   * Sets the value of the '{@link net.opengis.gml311.DerivedCRSType#getDerivedCRSType <em>Derived
   * CRS Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DerivedCRSType#getUsesCS <em>Uses CS</em>}'
