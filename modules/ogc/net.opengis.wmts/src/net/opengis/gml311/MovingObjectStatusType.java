 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This type encapsulates various dynamic properties of moving objects (points, lines, regions). It
 * is useful for dealing with features whose geometry or topology changes over time.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getLocationGroup <em>Location Group</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getLocation <em>Location</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getSpeed <em>Speed</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getBearing <em>Bearing</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getAcceleration <em>Acceleration</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getElevation <em>Elevation</em>}
 *   <li>{@link net.opengis.gml311.MovingObjectStatusType#getStatus <em>Status</em>}
 * </ul>
 *
...
public interface MovingObjectStatusType extends AbstractTimeSliceType {
  /**
   * Returns the value of the '<em><b>Location Group</b></em>' attribute list. The list contents are
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getLocation
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Speed</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" extendedMetaData="kind='element' name='speed'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getSpeed
   * <em>Speed</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Bearing</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='bearing'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getBearing
   * <em>Bearing</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Acceleration</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='acceleration'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getAcceleration
   * <em>Acceleration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Elevation</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='elevation'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getElevation
   * <em>Elevation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='status'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MovingObjectStatusType#getStatus
   * <em>Status</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
