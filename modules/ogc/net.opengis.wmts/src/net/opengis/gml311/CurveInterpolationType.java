...
public enum CurveInterpolationType implements Enumerator {
  ...
  CIRCULAR_ARC_CENTER_POINT_WITH_RADIUS(
      4, "circularArcCenterPointWithRadius", "circularArcCenterPointWithRadius"),
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Linear</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Geodesic</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #GEODESIC
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Circular Arc3 Points</b></em>' literal object isn't clear, there
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Circular Arc2 Point With Bulge</b></em>' literal object isn't
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Circular Arc Center Point With Radius</b></em>' literal object
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Elliptical</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Clothoid</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #CLOTHOID
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Conic</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Polynomial Spline</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Cubic Spline</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #CUBIC_SPLINE
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Rational Spline</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #RATIONAL_SPLINE
  ...
  /**
   * Returns the '<em><b>Curve Interpolation Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Curve Interpolation Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public static CurveInterpolationType get(int value) {
    switch (value) {
      ...
      case GEODESIC_VALUE:
        return GEODESIC;
      case CIRCULAR_ARC3_POINTS_VALUE:
        return CIRCULAR_ARC3_POINTS;
      case CIRCULAR_ARC2_POINT_WITH_BULGE_VALUE:
        return CIRCULAR_ARC2_POINT_WITH_BULGE;
      case CIRCULAR_ARC_CENTER_POINT_WITH_RADIUS_VALUE:
        return CIRCULAR_ARC_CENTER_POINT_WITH_RADIUS;
      case ELLIPTICAL_VALUE:
        return ELLIPTICAL;
      case CLOTHOID_VALUE:
        return CLOTHOID;
      case CONIC_VALUE:
        return CONIC;
      case POLYNOMIAL_SPLINE_VALUE:
        return POLYNOMIAL_SPLINE;
      case CUBIC_SPLINE_VALUE:
        return CUBIC_SPLINE;
      case RATIONAL_SPLINE_VALUE:
