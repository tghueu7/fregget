 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The function or rule which defines the map from members of the domainSet to the range. More
 * functions will be added to this list
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.CoverageFunctionType#getMappingRule <em>Mapping Rule</em>}
 *   <li>{@link net.opengis.gml311.CoverageFunctionType#getGridFunctionGroup <em>Grid Function
 *       Group</em>}
 *   <li>{@link net.opengis.gml311.CoverageFunctionType#getGridFunction <em>Grid Function</em>}
 * </ul>
 *
...
public interface CoverageFunctionType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='MappingRule'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.CoverageFunctionType#getMappingRule
   * <em>Mapping Rule</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Grid Function Group</b></em>' attribute list. The list
   * contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Grid Function Group</em>' attribute list isn't clear, there
   ...
   *     group='GridFunction:group'"
   * @generated
   */
  GridFunctionType getGridFunction();

  /**
   * Sets the value of the '{@link net.opengis.gml311.CoverageFunctionType#getGridFunction <em>Grid
