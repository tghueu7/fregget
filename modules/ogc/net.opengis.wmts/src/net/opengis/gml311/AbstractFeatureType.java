 ...
 * description inherited from AbstractGMLType, plus boundedBy. A concrete feature type must derive
 * from this type and specify additional properties in an application schema. A feature must possess
 * an identifying attribute ('id' - 'fid' has been deprecated).
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}
 *   <li>{@link net.opengis.gml311.AbstractFeatureType#getLocationGroup <em>Location Group</em>}
 *   <li>{@link net.opengis.gml311.AbstractFeatureType#getLocation <em>Location</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractFeatureType()
 * @model abstract="true" extendedMetaData="name='AbstractFeatureType' kind='elementOnly'"
 * @generated
 */
public interface AbstractFeatureType extends AbstractGMLType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='boundedBy'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractFeatureType#getBoundedBy <em>Bounded
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractFeatureType#getLocation
