 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.TopoVolumePropertyType#getTopoVolume <em>Topo Volume</em>}
 * </ul>
 *
...
public interface TopoVolumePropertyType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='TopoVolume'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.TopoVolumePropertyType#getTopoVolume <em>Topo
