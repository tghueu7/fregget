 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The definition of a group of parameters used by an operation method. This complexType is expected
 * to be used or extended for all applicable operation methods, without defining
 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.OperationParameterGroupType#getGroupID <em>Group ID</em>}
 *   <li>{@link net.opengis.gml311.OperationParameterGroupType#getRemarks <em>Remarks</em>}
 *   <li>{@link net.opengis.gml311.OperationParameterGroupType#getMaximumOccurs <em>Maximum
 *       Occurs</em>}
 *   <li>{@link net.opengis.gml311.OperationParameterGroupType#getIncludesParameter <em>Includes
 *       Parameter</em>}
 * </ul>
 *
...
public interface OperationParameterGroupType extends OperationParameterGroupBaseType {
  /**
   * Returns the value of the '<em><b>Group ID</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.IdentifierType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Set of alternative identifications of this operation parameter group. The first groupID, if
   ...
   * @model containment="true" extendedMetaData="kind='element' name='groupID'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationParameterGroupType#getRemarks
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.OperationParameterGroupType#getMaximumOccurs
   * <em>Maximum Occurs</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Includes Parameter</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.gml311.AbstractGeneralOperationParameterRefType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Unordered list of associations to the set of operation parameters that are members of this
   * group.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" lower="2" extendedMetaData="kind='element' name='includesParameter'
   *     namespace='##targetNamespace'"
   * @generated
   */
