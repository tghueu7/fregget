 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractDatumBaseType#getDatumName <em>Datum Name</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractDatumBaseType()
 * @model abstract="true" extendedMetaData="name='AbstractDatumBaseType' kind='elementOnly'"
 * @generated
 */
public interface AbstractDatumBaseType extends DefinitionType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='datumName'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractDatumBaseType#getDatumName <em>Datum
