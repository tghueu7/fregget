 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.GeocentricCRSType#getUsesCartesianCS <em>Uses Cartesian CS</em>}
 *   <li>{@link net.opengis.gml311.GeocentricCRSType#getUsesSphericalCS <em>Uses Spherical CS</em>}
 *   <li>{@link net.opengis.gml311.GeocentricCRSType#getUsesGeodeticDatum <em>Uses Geodetic
 *       Datum</em>}
 * </ul>
 *
...
public interface GeocentricCRSType extends AbstractReferenceSystemType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='usesCartesianCS'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeocentricCRSType#getUsesCartesianCS <em>Uses
   ...
   * @model containment="true" extendedMetaData="kind='element' name='usesSphericalCS'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.GeocentricCRSType#getUsesSphericalCS <em>Uses
   ...
   *     name='usesGeodeticDatum' namespace='##targetNamespace'"
   * @generated
   */
  GeodeticDatumRefType getUsesGeodeticDatum();

  /**
   * Sets the value of the '{@link net.opengis.gml311.GeocentricCRSType#getUsesGeodeticDatum
   * <em>Uses Geodetic Datum</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
