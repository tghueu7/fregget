 ...
 * radius and the bearing at start and end. This represenation can be used only in 2D.
 * <!-- end-model-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getPos <em>Pos</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getPointProperty <em>Point Property</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getPointRep <em>Point Rep</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getPosList <em>Pos List</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getCoordinates <em>Coordinates</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getRadius <em>Radius</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getStartAngle <em>Start Angle</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getEndAngle <em>End Angle</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getInterpolation <em>Interpolation</em>}
 *   <li>{@link net.opengis.gml311.ArcByCenterPointType#getNumArc <em>Num Arc</em>}
 * </ul>
 *
...
public interface ArcByCenterPointType extends AbstractCurveSegmentType {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='pos'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getPos <em>Pos</em>}'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='pointProperty'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getPointProperty
   * <em>Point Property</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='pointRep'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getPointRep <em>Point
   * Rep</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getPosList <em>Pos
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getCoordinates
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='radius'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getRadius
   * <em>Radius</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='startAngle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getStartAngle <em>Start
   * Angle</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='endAngle'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getEndAngle <em>End
   * Angle</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * "circularArcCenterPointWithRadius"</code>. The literals are from the enumeration {@link
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getInterpolation
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getInterpolation
   * <em>Interpolation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.gml311.ArcByCenterPointType#getInterpolation <em>Interpolation</em>}' attribute is
   * set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Num Arc</b></em>' attribute. The default value is <code>"1"
   * </code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   *     required="true" extendedMetaData="kind='attribute' name='numArc'"
   * @generated
   */
  BigInteger getNumArc();

  /**
   * Sets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getNumArc <em>Num
   * Arc</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getNumArc <em>Num
   * Arc</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.gml311.ArcByCenterPointType#getNumArc
   * <em>Num Arc</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
