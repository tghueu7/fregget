 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.ObservationType#getValidTime <em>Valid Time</em>}
 *   <li>{@link net.opengis.gml311.ObservationType#getUsing <em>Using</em>}
 *   <li>{@link net.opengis.gml311.ObservationType#getTargetGroup <em>Target Group</em>}
 *   <li>{@link net.opengis.gml311.ObservationType#getTarget <em>Target</em>}
 *   <li>{@link net.opengis.gml311.ObservationType#getResultOf <em>Result Of</em>}
 * </ul>
 *
...
public interface ObservationType extends AbstractFeatureType {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='validTime'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ObservationType#getValidTime <em>Valid
   ...
   * @model containment="true" extendedMetaData="kind='element' name='using'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ObservationType#getUsing <em>Using</em>}'
  ...
  /**
   * Returns the value of the '<em><b>Target Group</b></em>' attribute list. The list contents are
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ObservationType#getTarget <em>Target</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='resultOf'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.ObservationType#getResultOf <em>Result
