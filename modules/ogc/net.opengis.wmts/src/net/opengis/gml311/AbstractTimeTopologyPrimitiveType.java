 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.AbstractTimeTopologyPrimitiveType#getComplex <em>Complex</em>}
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getAbstractTimeTopologyPrimitiveType()
 * @model abstract="true" extendedMetaData="name='AbstractTimeTopologyPrimitiveType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractTimeTopologyPrimitiveType extends AbstractTimePrimitiveType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Complex</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" extendedMetaData="kind='element' name='complex'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.AbstractTimeTopologyPrimitiveType#getComplex
   * <em>Complex</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
