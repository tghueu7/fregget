 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.DataBlockType#getRangeParameters <em>Range Parameters</em>}
 *   <li>{@link net.opengis.gml311.DataBlockType#getTupleList <em>Tuple List</em>}
 *   <li>{@link net.opengis.gml311.DataBlockType#getDoubleOrNullTupleList <em>Double Or Null Tuple
 *       List</em>}
 * </ul>
 *
...
public interface DataBlockType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DataBlockType#getRangeParameters <em>Range
   ...
   * @model containment="true" extendedMetaData="kind='element' name='tupleList'
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DataBlockType#getTupleList <em>Tuple
   ...
   *     extendedMetaData="kind='element' name='doubleOrNullTupleList'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.DataBlockType#getDoubleOrNullTupleList
