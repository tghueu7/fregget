 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiSurfaceType#getSurfaceMember <em>Surface Member</em>}
 *   <li>{@link net.opengis.gml311.MultiSurfaceType#getSurfaceMembers <em>Surface Members</em>}
 * </ul>
 *
...
public interface MultiSurfaceType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Surface Member</b></em>' containment reference list. The list
   ...
   * @model containment="true" extendedMetaData="kind='element' name='surfaceMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='surfaceMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiSurfaceType#getSurfaceMembers <em>Surface
