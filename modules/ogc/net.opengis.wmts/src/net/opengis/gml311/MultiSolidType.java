 ...
 *
 * <ul>
 *   <li>{@link net.opengis.gml311.MultiSolidType#getSolidMember <em>Solid Member</em>}
 *   <li>{@link net.opengis.gml311.MultiSolidType#getSolidMembers <em>Solid Members</em>}
 * </ul>
 *
...
public interface MultiSolidType extends AbstractGeometricAggregateType {
  /**
   * Returns the value of the '<em><b>Solid Member</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.gml311.SolidPropertyType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='solidMember'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='solidMembers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.gml311.MultiSolidType#getSolidMembers <em>Solid
