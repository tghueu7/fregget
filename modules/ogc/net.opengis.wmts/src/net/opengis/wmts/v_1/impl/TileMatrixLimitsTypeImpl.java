 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl#getTileMatrix <em>Tile
 *       Matrix</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl#getMinTileRow <em>Min Tile
 *       Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl#getMaxTileRow <em>Max Tile
 *       Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl#getMinTileCol <em>Min Tile
 *       Col</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl#getMaxTileCol <em>Max Tile
 *       Col</em>}
 * </ul>
 *
 * @generated
 */
public class TileMatrixLimitsTypeImpl extends MinimalEObjectImpl.Container
    implements TileMatrixLimitsType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__TILE_MATRIX,
              oldTileMatrix,
              tileMatrix));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_ROW,
              oldMinTileRow,
              minTileRow));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_ROW,
              oldMaxTileRow,
              maxTileRow));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_COL,
              oldMinTileCol,
              minTileCol));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_COL,
              oldMaxTileCol,
              maxTileCol));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_ROW:
        return MIN_TILE_ROW_EDEFAULT == null
            ? minTileRow != null
            : !MIN_TILE_ROW_EDEFAULT.equals(minTileRow);
      case wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_ROW:
        return MAX_TILE_ROW_EDEFAULT == null
            ? maxTileRow != null
            : !MAX_TILE_ROW_EDEFAULT.equals(maxTileRow);
      case wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MIN_TILE_COL:
        return MIN_TILE_COL_EDEFAULT == null
            ? minTileCol != null
            : !MIN_TILE_COL_EDEFAULT.equals(minTileCol);
      case wmtsv_1Package.TILE_MATRIX_LIMITS_TYPE__MAX_TILE_COL:
        return MAX_TILE_COL_EDEFAULT == null
            ? maxTileCol != null
            : !MAX_TILE_COL_EDEFAULT.equals(maxTileCol);
    }
