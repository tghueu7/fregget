 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetLimitsTypeImpl#getTileMatrixLimits <em>Tile
 *       Matrix Limits</em>}
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetLimitsTypeImpl extends MinimalEObjectImpl.Container
    implements TileMatrixSetLimitsType {
  /**
   * The cached value of the '{@link #getTileMatrixLimits() <em>Tile Matrix Limits</em>}'
  ...
  public EList<TileMatrixLimitsType> getTileMatrixLimits() {
    if (tileMatrixLimits == null) {
      tileMatrixLimits =
          new EObjectContainmentEList<TileMatrixLimitsType>(
              TileMatrixLimitsType.class,
              this,
              wmtsv_1Package.TILE_MATRIX_SET_LIMITS_TYPE__TILE_MATRIX_LIMITS);
    }
