 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.URLTemplateTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.URLTemplateTypeImpl#getResourceType <em>Resource
 *       Type</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.URLTemplateTypeImpl#getTemplate <em>Template</em>}
 * </ul>
 *
 * @generated
 */
public class URLTemplateTypeImpl extends MinimalEObjectImpl.Container implements URLTemplateType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.URL_TEMPLATE_TYPE__FORMAT, oldFormat, format));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.URL_TEMPLATE_TYPE__RESOURCE_TYPE,
              oldResourceType,
              resourceType,
              !oldResourceTypeESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.URL_TEMPLATE_TYPE__TEMPLATE,
              oldTemplate,
              template));
  }
  ...
  public String toString() {
    ...
    if (resourceTypeESet) result.append(resourceType);
