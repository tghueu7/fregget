 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getInfoFormat <em>Info Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getDimension <em>Dimension</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getTileMatrixSetLink <em>Tile Matrix Set
 *       Link</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LayerTypeImpl#getResourceURL <em>Resource URL</em>}
 * </ul>
 *
 * @generated
 */
public class LayerTypeImpl extends DatasetDescriptionSummaryBaseTypeImpl implements LayerType {
  ...
  /**
   * The cached value of the '{@link #getTileMatrixSetLink() <em>Tile Matrix Set Link</em>}'
  ...
  /**
   * The cached value of the '{@link #getResourceURL() <em>Resource URL</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<StyleType> getStyle() {
    if (style == null) {
      style =
          new EObjectContainmentEList<StyleType>(
              StyleType.class, this, wmtsv_1Package.LAYER_TYPE__STYLE);
    }
    return style;
  }
  ...
  public EList<String> getInfoFormat() {
    if (infoFormat == null) {
      infoFormat =
          new EDataTypeEList<String>(String.class, this, wmtsv_1Package.LAYER_TYPE__INFO_FORMAT);
    }
    return infoFormat;
  }
  ...
  public EList<DimensionType> getDimension() {
    if (dimension == null) {
      dimension =
          new EObjectContainmentEList<DimensionType>(
              DimensionType.class, this, wmtsv_1Package.LAYER_TYPE__DIMENSION);
    }
    return dimension;
  }
  ...
  public EList<TileMatrixSetLinkType> getTileMatrixSetLink() {
    if (tileMatrixSetLink == null) {
      tileMatrixSetLink =
          new EObjectContainmentEList<TileMatrixSetLinkType>(
              TileMatrixSetLinkType.class, this, wmtsv_1Package.LAYER_TYPE__TILE_MATRIX_SET_LINK);
    }
  ...
  public EList<URLTemplateType> getResourceURL() {
    if (resourceURL == null) {
      resourceURL =
          new EObjectContainmentEList<URLTemplateType>(
              URLTemplateType.class, this, wmtsv_1Package.LAYER_TYPE__RESOURCE_URL);
    }
    return resourceURL;
  }
