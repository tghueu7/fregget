 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetLinkTypeImpl#getTileMatrixSet <em>Tile Matrix
 *       Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetLinkTypeImpl#getTileMatrixSetLimits <em>Tile
 *       Matrix Set Limits</em>}
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetLinkTypeImpl extends MinimalEObjectImpl.Container
    implements TileMatrixSetLinkType {
  /**
  ...
  /**
   * The cached value of the '{@link #getTileMatrixSetLimits() <em>Tile Matrix Set Limits</em>}'
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET,
              oldTileMatrixSet,
              tileMatrixSet));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS,
              oldTileMatrixSetLimits,
  ...
  public void setTileMatrixSetLimits(TileMatrixSetLimitsType newTileMatrixSetLimits) {
    if (newTileMatrixSetLimits != tileMatrixSetLimits) {
      ...
      if (tileMatrixSetLimits != null)
        msgs =
            ((InternalEObject) tileMatrixSetLimits)
                .eInverseRemove(
                    this,
      ...
      if (newTileMatrixSetLimits != null)
        msgs =
            ((InternalEObject) newTileMatrixSetLimits)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - wmtsv_1Package.TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS,
