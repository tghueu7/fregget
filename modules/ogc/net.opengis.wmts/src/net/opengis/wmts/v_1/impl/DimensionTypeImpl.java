 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#getUOM <em>UOM</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#getUnitSymbol <em>Unit Symbol</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#isCurrent <em>Current</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl#getValue <em>Value</em>}
 * </ul>
 *
 * @generated
 */
public class DimensionTypeImpl extends DescriptionTypeImpl implements DimensionType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.DIMENSION_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.DIMENSION_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetUOM(DomainMetadataType newUOM, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.DIMENSION_TYPE__UOM, oldUOM, newUOM);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newUOM != uOM) {
      ...
      if (uOM != null)
        msgs =
            ((InternalEObject) uOM)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - wmtsv_1Package.DIMENSION_TYPE__UOM, null, msgs);
      if (newUOM != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.DIMENSION_TYPE__UOM, newUOM, newUOM));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.DIMENSION_TYPE__UNIT_SYMBOL,
              oldUnitSymbol,
              unitSymbol));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.DIMENSION_TYPE__DEFAULT,
              oldDefault,
              default_));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.DIMENSION_TYPE__CURRENT,
              oldCurrent,
              current,
              !oldCurrentESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.DIMENSION_TYPE__UOM:
        return uOM != null;
      case wmtsv_1Package.DIMENSION_TYPE__UNIT_SYMBOL:
        return UNIT_SYMBOL_EDEFAULT == null
            ? unitSymbol != null
            : !UNIT_SYMBOL_EDEFAULT.equals(unitSymbol);
      case wmtsv_1Package.DIMENSION_TYPE__DEFAULT:
  ...
  public String toString() {
    ...
    if (currentESet) result.append(current);
