 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getLayer <em>Layer</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getDimensionNameValue <em>Dimension Name
 *       Value</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getTileMatrixSet <em>Tile Matrix Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getTileMatrix <em>Tile Matrix</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getTileRow <em>Tile Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getTileCol <em>Tile Col</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class GetTileTypeImpl extends MinimalEObjectImpl.Container implements GetTileType {
  ...
  /**
   * The cached value of the '{@link #getDimensionNameValue() <em>Dimension Name Value</em>}'
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_TILE_TYPE__LAYER, oldLayer, layer));
  }
  ...
  public void setStyle(String newStyle) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_TILE_TYPE__STYLE, oldStyle, style));
  }
  ...
  public void setFormat(String newFormat) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_TILE_TYPE__FORMAT, oldFormat, format));
  }
  ...
  public EList<DimensionNameValueType> getDimensionNameValue() {
    if (dimensionNameValue == null) {
      dimensionNameValue =
          new EObjectContainmentEList<DimensionNameValueType>(
              DimensionNameValueType.class,
              this,
              wmtsv_1Package.GET_TILE_TYPE__DIMENSION_NAME_VALUE);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_TILE_TYPE__TILE_MATRIX_SET,
              oldTileMatrixSet,
              tileMatrixSet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_TILE_TYPE__TILE_MATRIX,
              oldTileMatrix,
              tileMatrix));
  }
  ...
  public void setTileRow(BigInteger newTileRow) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_TILE_TYPE__TILE_ROW, oldTileRow, tileRow));
  }
  ...
  public void setTileCol(BigInteger newTileCol) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_TILE_TYPE__TILE_COL, oldTileCol, tileCol));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_TILE_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_TILE_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.GET_TILE_TYPE__TILE_MATRIX_SET:
        return TILE_MATRIX_SET_EDEFAULT == null
            ? tileMatrixSet != null
            : !TILE_MATRIX_SET_EDEFAULT.equals(tileMatrixSet);
      case wmtsv_1Package.GET_TILE_TYPE__TILE_MATRIX:
        return TILE_MATRIX_EDEFAULT == null
            ? tileMatrix != null
            : !TILE_MATRIX_EDEFAULT.equals(tileMatrix);
      case wmtsv_1Package.GET_TILE_TYPE__TILE_ROW:
