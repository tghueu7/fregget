 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getScaleDenominator <em>Scale Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getTopLeftCorner <em>Top Left Corner</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getTileWidth <em>Tile Width</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getTileHeight <em>Tile Height</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getMatrixWidth <em>Matrix Width</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixType#getMatrixHeight <em>Matrix Height</em>}
 * </ul>
 *
...
public interface TileMatrixType extends DescriptionType {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Tile matrix identifier. Typically an abreviation of the ScaleDenominator value or its
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getIdentifier
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getScaleDenominator <em>Scale
   * Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getScaleDenominator
   * <em>Scale Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @see #isSetScaleDenominator()
   ...
   * net.opengis.wmts.v_1.TileMatrixType#getScaleDenominator <em>Scale Denominator</em>}' attribute
   * is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Position in CRS coordinates of the top-left corner of this tile matrix. This are the precise
   * coordinates of the top left corner of top left pixel of the 0,0 tile in SupportedCRS
   * coordinates of this TileMatrixSet.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getTopLeftCorner <em>Top Left
   * Corner</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getTileWidth <em>Tile
   * Width</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getTileHeight <em>Tile
   * Height</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getMatrixWidth <em>Matrix
   * Width</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixType#getMatrixHeight <em>Matrix
   * Height</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
