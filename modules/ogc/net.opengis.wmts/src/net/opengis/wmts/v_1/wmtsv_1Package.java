 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This XML Schema Document initially was intended to encode SOAP response for a WMTS GetTile
 * request but in the future it might be used and part of a WMTS service (or even in any OWS
 * service) that needs a binary encoding.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 * <p>This XML Schema Document includes all WMTS schemas and is useful for SOAP messages.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 * <p>This XML Schema Document defines XML WMTS GetTile request that can be used in SOAP encodings.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 * <p>This XML Schema Document defines the XML WMTS GetCapabilites request that can be used in SOAP
 * encodings.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 * <p>This XML Schema Document encodes the WMTS GetCapabilities operations response message.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 * <p>This XML Schema Document encodes XML WMTS GetTile request that can be used in SOAP encodings.
 *
 * <p>WMTS is an OGC Standard. Copyright (c) 2009,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/.
 *
 ...
 *
 * <p>OWS is an OGC Standard. Copyright (c) 2006,2010 Open Geospatial Consortium. To obtain
 * additional rights of use, visit http://www.opengeospatial.org/legal/ .
 *
...
public interface wmtsv_1Package extends EPackage {
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.BinaryPayloadTypeImpl <em>Binary
   * Payload Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl
   ...
   * @ordered
   */
  int CAPABILITIES_TYPE__SERVICE_METADATA_URL =
      Ows11Package.CAPABILITIES_BASE_TYPE_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.ContentsTypeImpl <em>Contents
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  int CONTENTS_TYPE__DATASET_DESCRIPTION_SUMMARY =
      Ows11Package.CONTENTS_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY;
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.DimensionNameValueTypeImpl
   * <em>Dimension Name Value Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl <em>Dimension
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.DocumentRootImpl <em>Document
   * Root</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl
   * <em>Feature Info Response Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.GetCapabilitiesTypeImpl <em>Get
   ...
   * @ordered
   */
  int GET_CAPABILITIES_TYPE_OPERATION_COUNT =
      Ows11Package.GET_CAPABILITIES_TYPE_OPERATION_COUNT + 0;

  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl <em>Get
   * Feature Info Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl <em>Get Tile
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.LayerTypeImpl <em>Layer
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @ordered
   */
  int LAYER_TYPE__WGS84_BOUNDING_BOX =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__WGS84_BOUNDING_BOX;
   ...
   * @ordered
   */
  int LAYER_TYPE__BOUNDING_BOX_GROUP =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__BOUNDING_BOX_GROUP;
   ...
   * @ordered
   */
  int LAYER_TYPE__DATASET_DESCRIPTION_SUMMARY =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY;
   ...
   * @ordered
   */
  int LAYER_TYPE__INFO_FORMAT =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int LAYER_TYPE__TILE_MATRIX_SET_LINK =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int LAYER_TYPE__RESOURCE_URL =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE_FEATURE_COUNT + 5;
   ...
   * @ordered
   */
  int LAYER_TYPE_FEATURE_COUNT =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE_FEATURE_COUNT + 6;
   ...
   * @ordered
   */
  int LAYER_TYPE_OPERATION_COUNT =
      Ows11Package.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE_OPERATION_COUNT + 0;

  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl <em>Legend URL
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.StyleTypeImpl <em>Style
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TextPayloadTypeImpl <em>Text
   * Payload Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.ThemesTypeImpl <em>Themes
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.ThemeTypeImpl <em>Theme
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl <em>Tile
   * Matrix Limits Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetLimitsTypeImpl
   * <em>Tile Matrix Set Limits Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetLinkTypeImpl <em>Tile
   * Matrix Set Link Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl <em>Tile
   * Matrix Set Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl <em>Tile Matrix
   * Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.impl.URLTemplateTypeImpl <em>URL
   * Template Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.GetCapabilitiesValueType <em>Get
   * Capabilities Value Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.GetFeatureInfoValueType <em>Get Feature
   * Info Value Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.GetTileValueType <em>Get Tile Value
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.RequestServiceType <em>Request Service
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.ResourceTypeType <em>Resource Type
   * Type</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The meta object id for the '{@link net.opengis.wmts.v_1.VersionType <em>Version Type</em>}'
   * enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.BinaryPayloadType <em>Binary
   * Payload Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wmts.v_1.BinaryPayloadType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.BinaryPayloadType#getBinaryContent <em>Binary Content</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.CapabilitiesType
   * <em>Capabilities Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wmts.v_1.CapabilitiesType#getContents <em>Contents</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wmts.v_1.CapabilitiesType#getThemes <em>Themes</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.CapabilitiesType#getWSDL <em>WSDL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.CapabilitiesType#getServiceMetadataURL <em>Service Metadata URL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.ContentsType <em>Contents
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.ContentsType#getTileMatrixSet <em>Tile Matrix Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.DimensionNameValueType
   * <em>Dimension Name Value Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.DimensionNameValueType#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.DimensionNameValueType#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.DimensionType <em>Dimension
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DimensionType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DimensionType#getUOM <em>UOM</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.DimensionType#getUnitSymbol <em>Unit Symbol</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.DimensionType#getDefault
   * <em>Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.DimensionType#isCurrent
   * <em>Current</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * net.opengis.wmts.v_1.DimensionType#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.DocumentRoot <em>Document
   * Root</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getMixed <em>Mixed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the map '{@link net.opengis.wmts.v_1.DocumentRoot#getXMLNSPrefixMap
   ...
   * net.opengis.wmts.v_1.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getBinaryPayload <em>Binary Payload</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getCapabilities <em>Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getDimension <em>Dimension</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getDimensionNameValue <em>Dimension Name Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getFeatureInfoResponse <em>Feature Info Response</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getGetFeatureInfo <em>Get Feature Info</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getGetTile <em>Get Tile</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getLayer <em>Layer</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getLegendURL <em>Legend URL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getStyle <em>Style</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTextPayload <em>Text Payload</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTheme <em>Theme</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getThemes <em>Themes</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTileMatrix <em>Tile Matrix</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTileMatrixLimits <em>Tile Matrix Limits</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSet <em>Tile Matrix Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLimits <em>Tile Matrix Set Limits</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLink <em>Tile Matrix Set Link</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.FeatureInfoResponseType
   * <em>Feature Info Response Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wmts.v_1.FeatureInfoResponseType#getFeatureCollectionGroup <em>Feature Collection
   * Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.FeatureInfoResponseType#getFeatureCollection <em>Feature
   * Collection</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.FeatureInfoResponseType#getTextPayload <em>Text Payload</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Text Payload</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.FeatureInfoResponseType#getBinaryPayload <em>Binary Payload</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Binary Payload</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.FeatureInfoResponseType#getAnyContent <em>Any Content</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.GetCapabilitiesType <em>Get
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetCapabilitiesType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.GetFeatureInfoType <em>Get
   * Feature Info Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.GetFeatureInfoType#getGetTile <em>Get Tile</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Get Tile</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getJ
   * <em>J</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getI
   * <em>I</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetFeatureInfoType#getInfoFormat <em>Info Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetFeatureInfoType#getService <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Service</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetFeatureInfoType#getVersion <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.GetTileType <em>Get Tile
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getLayer
   * <em>Layer</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getStyle
   * <em>Style</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getFormat
   * <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.GetTileType#getDimensionNameValue <em>Dimension Name Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetTileType#getTileMatrixSet <em>Tile Matrix Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.GetTileType#getTileMatrix <em>Tile Matrix</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getTileRow
   * <em>Tile Row</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getTileCol
   * <em>Tile Col</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getService
   * <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.GetTileType#getVersion
   * <em>Version</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.LayerType#getStyle <em>Style</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link net.opengis.wmts.v_1.LayerType#getFormat
   * <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wmts.v_1.LayerType#getInfoFormat <em>Info Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.LayerType#getDimension <em>Dimension</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.LayerType#getTileMatrixSetLink <em>Tile Matrix Set Link</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.LayerType#getResourceURL <em>Resource URL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.LegendURLType <em>Legend URL
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.LegendURLType#getFormat
   * <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.LegendURLType#getHeight
   * <em>Height</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.LegendURLType#getMaxScaleDenominator <em>Max Scale Denominator</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.LegendURLType#getMinScaleDenominator <em>Min Scale Denominator</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.LegendURLType#getWidth
   * <em>Width</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.StyleType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.StyleType#getLegendURL <em>Legend URL</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link net.opengis.wmts.v_1.StyleType#isIsDefault
   * <em>Is Default</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TextPayloadType <em>Text Payload
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TextPayloadType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Format</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TextPayloadType#getTextContent <em>Text Content</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.ThemesType <em>Themes
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.ThemesType#getTheme <em>Theme</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.ThemeType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.ThemeType#getTheme <em>Theme</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference list '<em>Theme</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wmts.v_1.ThemeType#getLayerRef <em>Layer Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TileMatrixLimitsType <em>Tile
   * Matrix Limits Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixLimitsType#getTileMatrix <em>Tile Matrix</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Tile Matrix</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileRow <em>Min Tile Row</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileRow <em>Max Tile Row</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileCol <em>Min Tile Col</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileCol <em>Max Tile Col</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TileMatrixSetLimitsType <em>Tile
   * Matrix Set Limits Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.TileMatrixSetLimitsType#getTileMatrixLimits <em>Tile Matrix Limits</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TileMatrixSetLinkType <em>Tile
   * Matrix Set Link Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSet <em>Tile Matrix Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Tile Matrix Set</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSetLimits <em>Tile Matrix Set
   * Limits</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TileMatrixSetType <em>Tile
   * Matrix Set Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getBoundingBoxGroup <em>Bounding Box Group</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getBoundingBox <em>Bounding Box</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getSupportedCRS <em>Supported CRS</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getWellKnownScaleSet <em>Well Known Scale Set</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference list '{@link
   * net.opengis.wmts.v_1.TileMatrixSetType#getTileMatrix <em>Tile Matrix</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.TileMatrixType <em>Tile Matrix
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the containment reference '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the containment reference '<em>Identifier</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getScaleDenominator <em>Scale Denominator</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getTopLeftCorner <em>Top Left Corner</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getTileWidth <em>Tile Width</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getTileHeight <em>Tile Height</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getMatrixWidth <em>Matrix Width</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.TileMatrixType#getMatrixHeight <em>Matrix Height</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for class '{@link net.opengis.wmts.v_1.URLTemplateType <em>URL Template
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.URLTemplateType#getFormat <em>Format</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Format</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.URLTemplateType#getResourceType <em>Resource Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link
   * net.opengis.wmts.v_1.URLTemplateType#getTemplate <em>Template</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.GetCapabilitiesValueType <em>Get
   * Capabilities Value Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.GetFeatureInfoValueType <em>Get
   * Feature Info Value Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.GetTileValueType <em>Get Tile
   * Value Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.RequestServiceType <em>Request
   * Service Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.ResourceTypeType <em>Resource
   * Type Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for enum '{@link net.opengis.wmts.v_1.VersionType <em>Version
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Accepted Formats
   * Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='AcceptedFormatsType'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.GetCapabilitiesValueType
   * <em>Get Capabilities Value Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   *     extendedMetaData="name='GetCapabilitiesValueType:Object'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.GetFeatureInfoValueType
   * <em>Get Feature Info Value Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.GetTileValueType <em>Get
   * Tile Value Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.RequestServiceType
   * <em>Request Service Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.ResourceTypeType
   * <em>Resource Type Type Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='SectionsType'
   *     baseType='http://www.eclipse.org/emf/2003/XMLType#string'
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='template_._type'
   *     baseType='http://www.eclipse.org/emf/2003/XMLType#string'
  ...
  /**
   * Returns the meta object for data type '{@link net.opengis.wmts.v_1.VersionType <em>Version Type
   * Object</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.BinaryPayloadTypeImpl
     * <em>Binary Payload Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.BinaryPayloadTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl
     * <em>Capabilities Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Service Metadata URL</b></em>' containment reference
     * list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference CAPABILITIES_TYPE__SERVICE_METADATA_URL =
        eINSTANCE.getCapabilitiesType_ServiceMetadataURL();

    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.ContentsTypeImpl
     * <em>Contents Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.ContentsTypeImpl
    ...
    /**
     * The meta object literal for the '<em><b>Tile Matrix Set</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.DimensionNameValueTypeImpl
     * <em>Dimension Name Value Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.DimensionTypeImpl
     * <em>Dimension Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.DimensionTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.DocumentRootImpl
    ...
    /**
     * The meta object literal for the '<em><b>Binary Payload</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Dimension Name Value</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Feature Info Response</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference DOCUMENT_ROOT__FEATURE_INFO_RESPONSE =
        eINSTANCE.getDocumentRoot_FeatureInfoResponse();
    ...
    /**
     * The meta object literal for the '<em><b>Get Feature Info</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Tile Matrix Limits</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Tile Matrix Set</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Tile Matrix Set Limits</b></em>' containment
     * reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EReference DOCUMENT_ROOT__TILE_MATRIX_SET_LIMITS =
        eINSTANCE.getDocumentRoot_TileMatrixSetLimits();

    /**
     * The meta object literal for the '<em><b>Tile Matrix Set Link</b></em>' containment reference
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl
     * <em>Feature Info Response Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Feature Collection Group</b></em>' attribute list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    EAttribute FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION_GROUP =
        eINSTANCE.getFeatureInfoResponseType_FeatureCollectionGroup();
     ...
     * @generated
     */
    EReference FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION =
        eINSTANCE.getFeatureInfoResponseType_FeatureCollection();
     ...
     * @generated
     */
    EReference FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD =
        eINSTANCE.getFeatureInfoResponseType_TextPayload();
     ...
     * @generated
     */
    EReference FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD =
        eINSTANCE.getFeatureInfoResponseType_BinaryPayload();
     ...
     * @generated
     */
    EReference FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT =
        eINSTANCE.getFeatureInfoResponseType_AnyContent();

    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.GetCapabilitiesTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl
     * <em>Get Feature Info Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.GetTileTypeImpl <em>Get
     * Tile Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.LayerTypeImpl <em>Layer
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Dimension</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Resource URL</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl
     * <em>Legend URL Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.LegendURLTypeImpl
     ...
     * @generated
     */
    EAttribute LEGEND_URL_TYPE__MAX_SCALE_DENOMINATOR =
        eINSTANCE.getLegendURLType_MaxScaleDenominator();
     ...
     * @generated
     */
    EAttribute LEGEND_URL_TYPE__MIN_SCALE_DENOMINATOR =
        eINSTANCE.getLegendURLType_MinScaleDenominator();
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.StyleTypeImpl <em>Style
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Legend URL</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TextPayloadTypeImpl
     * <em>Text Payload Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.TextPayloadTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.ThemesTypeImpl <em>Themes
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.ThemeTypeImpl <em>Theme
     * Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl
     * <em>Tile Matrix Limits Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.TileMatrixLimitsTypeImpl
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_LIMITS_TYPE__TILE_MATRIX =
        eINSTANCE.getTileMatrixLimitsType_TileMatrix();
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_LIMITS_TYPE__MIN_TILE_ROW =
        eINSTANCE.getTileMatrixLimitsType_MinTileRow();
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_LIMITS_TYPE__MAX_TILE_ROW =
        eINSTANCE.getTileMatrixLimitsType_MaxTileRow();
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_LIMITS_TYPE__MIN_TILE_COL =
        eINSTANCE.getTileMatrixLimitsType_MinTileCol();
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_LIMITS_TYPE__MAX_TILE_COL =
        eINSTANCE.getTileMatrixLimitsType_MaxTileCol();

    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetLimitsTypeImpl
     * <em>Tile Matrix Set Limits Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    EReference TILE_MATRIX_SET_LIMITS_TYPE__TILE_MATRIX_LIMITS =
        eINSTANCE.getTileMatrixSetLimitsType_TileMatrixLimits();

    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetLinkTypeImpl
     * <em>Tile Matrix Set Link Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.TileMatrixSetLinkTypeImpl
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET =
        eINSTANCE.getTileMatrixSetLinkType_TileMatrixSet();
     ...
     * @generated
     */
    EReference TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS =
        eINSTANCE.getTileMatrixSetLinkType_TileMatrixSetLimits();

    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl
     * <em>Tile Matrix Set Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_SET_TYPE__BOUNDING_BOX_GROUP =
        eINSTANCE.getTileMatrixSetType_BoundingBoxGroup();
     ...
     * @generated
     */
    EAttribute TILE_MATRIX_SET_TYPE__WELL_KNOWN_SCALE_SET =
        eINSTANCE.getTileMatrixSetType_WellKnownScaleSet();

    /**
     * The meta object literal for the '<em><b>Tile Matrix</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl <em>Tile
     * Matrix Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.impl.TileMatrixTypeImpl
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.impl.URLTemplateTypeImpl <em>URL
     * Template Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.GetCapabilitiesValueType <em>Get
     * Capabilities Value Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.GetFeatureInfoValueType <em>Get
     * Feature Info Value Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.GetFeatureInfoValueType
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.GetTileValueType <em>Get Tile
     * Value Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.RequestServiceType <em>Request
     * Service Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see net.opengis.wmts.v_1.RequestServiceType
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.ResourceTypeType <em>Resource
     * Type Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link net.opengis.wmts.v_1.VersionType <em>Version
     * Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
