 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.BinaryPayloadType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.BinaryPayloadType#getBinaryContent <em>Binary Content</em>}
 * </ul>
 *
...
public interface BinaryPayloadType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * MIMEType format of the PayloadContent once base64 decodified.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.BinaryPayloadType#getFormat
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Binary content encoded in base64. It could be useful to enclose it in a CDATA element to avoid
   * XML parsing.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.BinaryPayloadType#getBinaryContent
   * <em>Binary Content</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
