 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSet <em>Tile Matrix
 *       Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSetLimits <em>Tile Matrix
 *       Set Limits</em>}
 * </ul>
 *
...
public interface TileMatrixSetLinkType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSet
   * <em>Tile Matrix Set</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Indices limits for this tileMatrixSet. The absence of this element means that tile row and tile
   * col indices are only limited by 0 and the corresponding tileMatrixSet maximum definitions.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='TileMatrixSetLimits'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixSetLinkType#getTileMatrixSetLimits
   * <em>Tile Matrix Set Limits</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
