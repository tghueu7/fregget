 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getInfoFormat <em>Info Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getDimension <em>Dimension</em>}
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getTileMatrixSetLink <em>Tile Matrix Set Link</em>}
 *   <li>{@link net.opengis.wmts.v_1.LayerType#getResourceURL <em>Resource URL</em>}
 * </ul>
 *
...
public interface LayerType extends DatasetDescriptionSummaryBaseType {
  /**
   * Returns the value of the '<em><b>Style</b></em>' containment reference list. The list contents
   * are of type {@link net.opengis.wmts.v_1.StyleType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Style'
  ...
  /**
   * Returns the value of the '<em><b>Format</b></em>' attribute list. The list contents are of type
  ...
  /**
   * Returns the value of the '<em><b>Info Format</b></em>' attribute list. The list contents are of
   * type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Supported valid output MIME types for a FeatureInfo. If there isn't any, The server do not
   * support FeatureInfo requests for this layer.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Dimension</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wmts.v_1.DimensionType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Dimension'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Tile Matrix Set Link</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wmts.v_1.TileMatrixSetLinkType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   *     name='TileMatrixSetLink' namespace='##targetNamespace'"
   * @generated
   */
  EList<TileMatrixSetLinkType> getTileMatrixSetLink();

  /**
   * Returns the value of the '<em><b>Resource URL</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.wmts.v_1.URLTemplateType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ResourceURL'
   *     namespace='##targetNamespace'"
   * @generated
   */
