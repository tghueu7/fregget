 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.ContentsTypeImpl#getTileMatrixSet <em>Tile Matrix
 *       Set</em>}
 * </ul>
 *
 * @generated
...
public class ContentsTypeImpl extends ContentsBaseTypeImpl implements ContentsType {
  /**
   * The cached value of the '{@link #getTileMatrixSet() <em>Tile Matrix Set</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TileMatrixSetType> getTileMatrixSet() {
    if (tileMatrixSet == null) {
      tileMatrixSet =
          new EObjectContainmentEList<TileMatrixSetType>(
              TileMatrixSetType.class, this, wmtsv_1Package.CONTENTS_TYPE__TILE_MATRIX_SET);
    }
