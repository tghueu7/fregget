 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getGetTile <em>Get Tile</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getJ <em>J</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getI <em>I</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getInfoFormat <em>Info Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getService <em>Service</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetFeatureInfoType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface GetFeatureInfoType extends EObject {
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='GetTile'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getGetTile <em>Get
   * Tile</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getJ <em>J</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getI <em>I</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Output MIME type format of the retrieved information
   * <!-- end-model-doc -->
   *
   ...
   *     name='InfoFormat' namespace='##targetNamespace'"
   * @generated
   */
  String getInfoFormat();

  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getInfoFormat <em>Info
   * Format</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getService
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getService
   * <em>Service</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getService
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getVersion
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getVersion
   * <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wmts.v_1.GetFeatureInfoType#getVersion
