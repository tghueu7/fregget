...
public class wmtsv_1FactoryImpl extends EFactoryImpl implements wmtsv_1Factory {
  ...
  public static wmtsv_1Factory init() {
    try {
      wmtsv_1Factory thewmtsv_1Factory =
          (wmtsv_1Factory) EPackage.Registry.INSTANCE.getEFactory(wmtsv_1Package.eNS_URI);
   ...
   * @generated
   */
  public GetCapabilitiesValueType createGetCapabilitiesValueTypeFromString(
   ...
   * @generated
   */
  public GetFeatureInfoValueType createGetFeatureInfoValueTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public GetTileValueType createGetTileValueTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public RequestServiceType createRequestServiceTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public ResourceTypeType createResourceTypeTypeFromString(
      EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public GetCapabilitiesValueType createGetCapabilitiesValueTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createGetCapabilitiesValueTypeFromString(
        wmtsv_1Package.Literals.GET_CAPABILITIES_VALUE_TYPE, initialValue);
  }
   ...
   * @generated
   */
  public String convertGetCapabilitiesValueTypeObjectToString(
      EDataType eDataType, Object instanceValue) {
    return convertGetCapabilitiesValueTypeToString(
        wmtsv_1Package.Literals.GET_CAPABILITIES_VALUE_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public GetFeatureInfoValueType createGetFeatureInfoValueTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createGetFeatureInfoValueTypeFromString(
        wmtsv_1Package.Literals.GET_FEATURE_INFO_VALUE_TYPE, initialValue);
  }
   ...
   * @generated
   */
  public String convertGetFeatureInfoValueTypeObjectToString(
      EDataType eDataType, Object instanceValue) {
    return convertGetFeatureInfoValueTypeToString(
        wmtsv_1Package.Literals.GET_FEATURE_INFO_VALUE_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public GetTileValueType createGetTileValueTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createGetTileValueTypeFromString(
        wmtsv_1Package.Literals.GET_TILE_VALUE_TYPE, initialValue);
  }
  ...
  public String convertGetTileValueTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertGetTileValueTypeToString(
        wmtsv_1Package.Literals.GET_TILE_VALUE_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public RequestServiceType createRequestServiceTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createRequestServiceTypeFromString(
        wmtsv_1Package.Literals.REQUEST_SERVICE_TYPE, initialValue);
  }
  ...
  public String convertRequestServiceTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertRequestServiceTypeToString(
        wmtsv_1Package.Literals.REQUEST_SERVICE_TYPE, instanceValue);
  }
   ...
   * @generated
   */
  public ResourceTypeType createResourceTypeTypeObjectFromString(
      EDataType eDataType, String initialValue) {
    return createResourceTypeTypeFromString(
        wmtsv_1Package.Literals.RESOURCE_TYPE_TYPE, initialValue);
  }
  ...
  public String convertResourceTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
    return convertResourceTypeTypeToString(
        wmtsv_1Package.Literals.RESOURCE_TYPE_TYPE, instanceValue);
  }
