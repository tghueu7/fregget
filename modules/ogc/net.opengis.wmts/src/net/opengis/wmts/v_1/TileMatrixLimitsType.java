 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getTileMatrix <em>Tile Matrix</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileRow <em>Min Tile Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileRow <em>Max Tile Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileCol <em>Min Tile Col</em>}
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileCol <em>Max Tile Col</em>}
 * </ul>
 *
...
public interface TileMatrixLimitsType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getTileMatrix <em>Tile
   * Matrix</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Minimum tile row index valid for this layer. From 0 to maxTileRow
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileRow <em>Min
   * Tile Row</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Maximim tile row index valid for this layer. From minTileRow to matrixWidth-1 of the tileMatrix
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileRow <em>Max
   * Tile Row</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Minimum tile column index valid for this layer. From 0 to maxTileCol
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMinTileCol <em>Min
   * Tile Col</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Maximim tile column index valid for this layer. From minTileCol to tileHeight-1 of the
   * tileMatrix section of this tileMatrixSet.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TileMatrixLimitsType#getMaxTileCol <em>Max
   * Tile Col</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
