 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getGetTile <em>Get Tile</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getJ <em>J</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getI <em>I</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getInfoFormat <em>Info Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getService <em>Service</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.GetFeatureInfoTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class GetFeatureInfoTypeImpl extends MinimalEObjectImpl.Container
    implements GetFeatureInfoType {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_FEATURE_INFO_TYPE__GET_TILE,
              oldGetTile,
              newGetTile);
  ...
  public void setGetTile(GetTileType newGetTile) {
    if (newGetTile != getTile) {
      ...
      if (getTile != null)
        msgs =
            ((InternalEObject) getTile)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.GET_FEATURE_INFO_TYPE__GET_TILE,
                    null,
                    msgs);
      if (newGetTile != null)
        msgs =
            ((InternalEObject) newGetTile)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.GET_FEATURE_INFO_TYPE__GET_TILE,
                    null,
  ...
  public void setJ(BigInteger newJ) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_FEATURE_INFO_TYPE__J, oldJ, j));
  }
  ...
  public void setI(BigInteger newI) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.GET_FEATURE_INFO_TYPE__I, oldI, i));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_FEATURE_INFO_TYPE__INFO_FORMAT,
              oldInfoFormat,
              infoFormat));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_FEATURE_INFO_TYPE__SERVICE,
              oldService,
              service,
              !oldServiceESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.GET_FEATURE_INFO_TYPE__VERSION,
              oldVersion,
              version,
              !oldVersionESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.GET_FEATURE_INFO_TYPE__INFO_FORMAT:
        return INFO_FORMAT_EDEFAULT == null
            ? infoFormat != null
            : !INFO_FORMAT_EDEFAULT.equals(infoFormat);
      case wmtsv_1Package.GET_FEATURE_INFO_TYPE__SERVICE:
        return isSetService();
      case wmtsv_1Package.GET_FEATURE_INFO_TYPE__VERSION:
        return isSetVersion();
