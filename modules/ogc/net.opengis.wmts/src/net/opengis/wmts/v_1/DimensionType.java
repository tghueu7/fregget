 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#getUOM <em>UOM</em>}
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#getUnitSymbol <em>Unit Symbol</em>}
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#getDefault <em>Default</em>}
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#isCurrent <em>Current</em>}
 *   <li>{@link net.opengis.wmts.v_1.DimensionType#getValue <em>Value</em>}
 * </ul>
 *
...
public interface DimensionType extends DescriptionType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DimensionType#getIdentifier
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DimensionType#getUOM <em>UOM</em>}'
   ...
   *     name='UnitSymbol' namespace='##targetNamespace'"
   * @generated
   */
  String getUnitSymbol();

  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DimensionType#getUnitSymbol <em>Unit
   * Symbol</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Default value that will be used if a tile request does not specify a value or uses the keyword
   * 'default'.
   * <!-- end-model-doc -->
   *
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element'
   *     name='Default' namespace='##targetNamespace'"
   * @generated
   */
  String getDefault();

  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DimensionType#getDefault <em>Default</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * A value of 1 (or 'true') indicates (a) that temporal data are normally kept current and (b)
   * that the request value of this dimension accepts the keyword 'current'.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DimensionType#isCurrent <em>Current</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.DimensionType#isCurrent <em>Current</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wmts.v_1.DimensionType#isCurrent
   * <em>Current</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
