 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getFeatureCollectionGroup <em>Feature
 *       Collection Group</em>}
 *   <li>{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getFeatureCollection <em>Feature
 *       Collection</em>}
 *   <li>{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getTextPayload <em>Text Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getBinaryPayload <em>Binary
 *       Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getAnyContent <em>Any Content</em>}
 * </ul>
 *
...
public interface FeatureInfoResponseType extends EObject {
  /**
   * Returns the value of the '<em><b>Feature Collection Group</b></em>' attribute list. The list
   * contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This allows to define any FeatureCollection that is a substitutionGroup of gml:_GML and use it
   * here. A Geography Markup Language GML Simple Features Profile level 0 response format is
   * strongly recommended as a FeatureInfo response.
   * <!-- end-model-doc -->
   *
   ...
   *     extendedMetaData="kind='group' name='_FeatureCollection:group'
   ...
   *     extendedMetaData="kind='element' name='_FeatureCollection'
   *     namespace='http://www.opengis.net/gml'
   ...
   * @model containment="true" extendedMetaData="kind='element' name='TextPayload'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getTextPayload
   * <em>Text Payload</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This allows to include any binary format. Binary formats are not common response for a
   * GeFeatureInfo requests but possible for some imaginative implementations.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='BinaryPayload'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getBinaryPayload
   * <em>Binary Payload</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * This allows to include any XML content that it is not any of the previous ones.
   * <!-- end-model-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='AnyContent'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.FeatureInfoResponseType#getAnyContent
   * <em>Any Content</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
