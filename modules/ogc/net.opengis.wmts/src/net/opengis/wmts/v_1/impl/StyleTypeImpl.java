 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.StyleTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.StyleTypeImpl#getLegendURL <em>Legend URL</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.StyleTypeImpl#isIsDefault <em>Is Default</em>}
 * </ul>
 *
 * @generated
 */
public class StyleTypeImpl extends DescriptionTypeImpl implements StyleType {
  ...
  /**
   * The cached value of the '{@link #getLegendURL() <em>Legend URL</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.STYLE_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.STYLE_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public EList<LegendURLType> getLegendURL() {
    if (legendURL == null) {
      legendURL =
          new EObjectContainmentEList<LegendURLType>(
              LegendURLType.class, this, wmtsv_1Package.STYLE_TYPE__LEGEND_URL);
    }
    return legendURL;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.STYLE_TYPE__IS_DEFAULT,
              oldIsDefault,
              isDefault,
              !oldIsDefaultESet));
  }
  ...
  public String toString() {
    ...
    if (isDefaultESet) result.append(isDefault);
