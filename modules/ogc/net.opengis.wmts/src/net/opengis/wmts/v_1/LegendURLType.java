 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.LegendURLType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.LegendURLType#getHeight <em>Height</em>}
 *   <li>{@link net.opengis.wmts.v_1.LegendURLType#getMaxScaleDenominator <em>Max Scale
 *       Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.LegendURLType#getMinScaleDenominator <em>Min Scale
 *       Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.LegendURLType#getWidth <em>Width</em>}
 * </ul>
 *
...
public interface LegendURLType extends OnlineResourceType {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getFormat <em>Format</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getHeight <em>Height</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getMaxScaleDenominator <em>Max
   * Scale Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getMaxScaleDenominator
   * <em>Max Scale Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @see #isSetMaxScaleDenominator()
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getMinScaleDenominator <em>Min
   * Scale Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getMinScaleDenominator
   * <em>Min Scale Denominator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @see #isSetMinScaleDenominator()
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.LegendURLType#getWidth <em>Width</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
