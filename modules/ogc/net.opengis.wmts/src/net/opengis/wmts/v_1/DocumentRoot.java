 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getBinaryPayload <em>Binary Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getCapabilities <em>Capabilities</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getDimension <em>Dimension</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getDimensionNameValue <em>Dimension Name
 *       Value</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getFeatureInfoResponse <em>Feature Info
 *       Response</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getGetFeatureInfo <em>Get Feature Info</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getGetTile <em>Get Tile</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getLayer <em>Layer</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getLegendURL <em>Legend URL</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTextPayload <em>Text Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTheme <em>Theme</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getThemes <em>Themes</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrix <em>Tile Matrix</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixLimits <em>Tile Matrix Limits</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSet <em>Tile Matrix Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLimits <em>Tile Matrix Set
 *       Limits</em>}
 *   <li>{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLink <em>Tile Matrix Set
 *       Link</em>}
 * </ul>
 *
...
public interface DocumentRoot extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Binary Payload</em>' containment reference isn't clear, there
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getBinaryPayload <em>Binary
   * Payload</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * XML defines the WMTS GetCapabilities operation response. ServiceMetadata document provides
   * clients with service metadata about a specific service instance, including metadata about the
   * tightly-coupled data served. If the server does not implement the updateSequence parameter, the
   * server SHALL always return the complete Capabilities document, without the updateSequence
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getCapabilities
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getDimension
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Dimension Name Value</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getDimensionNameValue
   * <em>Dimension Name Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Feature Info Response</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getFeatureInfoResponse
   * <em>Feature Info Response</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getGetCapabilities <em>Get
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Get Feature Info</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getGetFeatureInfo <em>Get
   * Feature Info</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Get Tile</em>' containment reference isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getGetTile <em>Get Tile</em>}'
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Layer</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getLayer <em>Layer</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Zero or more LegendURL elements may be provided, providing an image(s) of a legend relevant to
   * each Style of a Layer. The Format element indicates the MIME type of the legend.
   * minScaleDenominator and maxScaleDenominator attributes may be provided to indicate to the
   * client which scale(s) (inclusive) the legend image is appropriate for. (If provided, these
   * values must exactly match the scale denominators of available TileMatrixes.) width and height
   * attributes may be provided to assist client applications in laying out space to display the
   * legend.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getLegendURL <em>Legend
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Style</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getStyle <em>Style</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Text Payload</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTextPayload <em>Text
   * Payload</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Theme</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTheme <em>Theme</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Provides a set of hierarchical themes that the client can use to categorize the layers by.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getThemes <em>Themes</em>}'
   * containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrix <em>Tile
   * Matrix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixLimits <em>Tile
   * Matrix Limits</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSet <em>Tile
   * Matrix Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLimits <em>Tile
   * Matrix Set Limits</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.DocumentRoot#getTileMatrixSetLink <em>Tile
   * Matrix Set Link</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
