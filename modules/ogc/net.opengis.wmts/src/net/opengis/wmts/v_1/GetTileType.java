 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getLayer <em>Layer</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getStyle <em>Style</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getDimensionNameValue <em>Dimension Name
 *       Value</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getTileMatrixSet <em>Tile Matrix Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getTileMatrix <em>Tile Matrix</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getTileRow <em>Tile Row</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getTileCol <em>Tile Col</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getService <em>Service</em>}
 *   <li>{@link net.opengis.wmts.v_1.GetTileType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface GetTileType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getLayer <em>Layer</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getStyle <em>Style</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.ows11.MimeType" required="true" extendedMetaData="kind='element'
   *     name='Format' namespace='##targetNamespace'"
   * @generated
   */
  String getFormat();

  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getFormat <em>Format</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Dimension Name Value</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wmts.v_1.DimensionNameValueType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   ...
   * @model containment="true" extendedMetaData="kind='element' name='DimensionNameValue'
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getTileMatrixSet <em>Tile Matrix
   * Set</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getTileMatrix <em>Tile
   * Matrix</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getTileRow <em>Tile Row</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getTileCol <em>Tile Col</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Service</b></em>' attribute. The default value is <code>"WMTS"
   * </code>.
   * <!-- begin-user-doc -->
   *
   ...
   * @model default="WMTS" unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.String"
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getService <em>Service</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getService <em>Service</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wmts.v_1.GetTileType#getService
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getVersion <em>Version</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.wmts.v_1.GetTileType#getVersion <em>Version</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.wmts.v_1.GetTileType#getVersion
