 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.ThemeTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.ThemeTypeImpl#getTheme <em>Theme</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.ThemeTypeImpl#getLayerRef <em>Layer Ref</em>}
 * </ul>
 *
 * @generated
 */
public class ThemeTypeImpl extends DescriptionTypeImpl implements ThemeType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.THEME_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.THEME_TYPE__IDENTIFIER,
                    null,
                    msgs);
  ...
  public EList<ThemeType> getTheme() {
    if (theme == null) {
      theme =
          new EObjectContainmentEList<ThemeType>(
              ThemeType.class, this, wmtsv_1Package.THEME_TYPE__THEME);
    }
    return theme;
  }
  ...
  public EList<String> getLayerRef() {
    if (layerRef == null) {
      layerRef =
          new EDataTypeEList<String>(String.class, this, wmtsv_1Package.THEME_TYPE__LAYER_REF);
    }
    return layerRef;
  }
