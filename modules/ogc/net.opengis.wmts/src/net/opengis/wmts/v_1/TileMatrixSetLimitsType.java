 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.TileMatrixSetLimitsType#getTileMatrixLimits <em>Tile Matrix
 *       Limits</em>}
 * </ul>
 *
...
public interface TileMatrixSetLimitsType extends EObject {
  /**
   * Returns the value of the '<em><b>Tile Matrix Limits</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.wmts.v_1.TileMatrixLimitsType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Metadata describing the limits of the TileMatrixSet indices. Multiplicity must be the
   * multiplicity of TileMatrix in this TileMatrixSet.
   * <!-- end-model-doc -->
   *
   ...
   *     name='TileMatrixLimits' namespace='##targetNamespace'"
   * @generated
   */
