 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getBoundingBoxGroup <em>Bounding Box
 *       Group</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getBoundingBox <em>Bounding
 *       Box</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getSupportedCRS <em>Supported
 *       CRS</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getWellKnownScaleSet <em>Well Known
 *       Scale Set</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixSetTypeImpl#getTileMatrix <em>Tile Matrix</em>}
 * </ul>
 *
 * @generated
 */
public class TileMatrixSetTypeImpl extends DescriptionTypeImpl implements TileMatrixSetType {
  ...
  /**
   * The cached value of the '{@link #getBoundingBoxGroup() <em>Bounding Box Group</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getWellKnownScaleSet() <em>Well Known Scale Set</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getWellKnownScaleSet() <em>Well Known Scale Set</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTileMatrix() <em>Tile Matrix</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_SET_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
  ...
  public void setIdentifier(CodeType newIdentifier) {
    if (newIdentifier != identifier) {
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.TILE_MATRIX_SET_TYPE__IDENTIFIER,
                    null,
                    msgs);
      if (newIdentifier != null)
        msgs =
            ((InternalEObject) newIdentifier)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.TILE_MATRIX_SET_TYPE__IDENTIFIER,
                    null,
  ...
  public FeatureMap getBoundingBoxGroup() {
    if (boundingBoxGroup == null) {
      boundingBoxGroup =
          new BasicFeatureMap(this, wmtsv_1Package.TILE_MATRIX_SET_TYPE__BOUNDING_BOX_GROUP);
    }
  ...
  public BoundingBoxType getBoundingBox() {
    return (BoundingBoxType)
        getBoundingBoxGroup().get(wmtsv_1Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, true);
  }
  ...
  public NotificationChain basicSetBoundingBox(
    ...
    return ((FeatureMap.Internal) getBoundingBoxGroup())
        .basicAdd(wmtsv_1Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, newBoundingBox, msgs);
  }
  ...
  public void setBoundingBox(BoundingBoxType newBoundingBox) {
    ((FeatureMap.Internal) getBoundingBoxGroup())
        .set(wmtsv_1Package.Literals.TILE_MATRIX_SET_TYPE__BOUNDING_BOX, newBoundingBox);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_SET_TYPE__SUPPORTED_CRS,
              oldSupportedCRS,
              supportedCRS));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_SET_TYPE__WELL_KNOWN_SCALE_SET,
              oldWellKnownScaleSet,
              wellKnownScaleSet));
  }
  ...
  public EList<TileMatrixType> getTileMatrix() {
    if (tileMatrix == null) {
      tileMatrix =
          new EObjectContainmentEList<TileMatrixType>(
              TileMatrixType.class, this, wmtsv_1Package.TILE_MATRIX_SET_TYPE__TILE_MATRIX);
    }
    return tileMatrix;
  }
    ...
    switch (featureID) {
      ...
      case wmtsv_1Package.TILE_MATRIX_SET_TYPE__SUPPORTED_CRS:
        return SUPPORTED_CRS_EDEFAULT == null
            ? supportedCRS != null
            : !SUPPORTED_CRS_EDEFAULT.equals(supportedCRS);
      case wmtsv_1Package.TILE_MATRIX_SET_TYPE__WELL_KNOWN_SCALE_SET:
        return WELL_KNOWN_SCALE_SET_EDEFAULT == null
            ? wellKnownScaleSet != null
            : !WELL_KNOWN_SCALE_SET_EDEFAULT.equals(wellKnownScaleSet);
      case wmtsv_1Package.TILE_MATRIX_SET_TYPE__TILE_MATRIX:
