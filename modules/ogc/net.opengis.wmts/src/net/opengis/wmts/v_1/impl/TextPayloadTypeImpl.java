 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TextPayloadTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TextPayloadTypeImpl#getTextContent <em>Text Content</em>}
 * </ul>
 *
 * @generated
 */
public class TextPayloadTypeImpl extends MinimalEObjectImpl.Container implements TextPayloadType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.TEXT_PAYLOAD_TYPE__FORMAT, oldFormat, format));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TEXT_PAYLOAD_TYPE__TEXT_CONTENT,
              oldTextContent,
              textContent));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.TEXT_PAYLOAD_TYPE__TEXT_CONTENT:
        return TEXT_CONTENT_EDEFAULT == null
            ? textContent != null
            : !TEXT_CONTENT_EDEFAULT.equals(textContent);
    }
