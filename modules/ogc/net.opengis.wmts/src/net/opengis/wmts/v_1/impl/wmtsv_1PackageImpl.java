...
public class wmtsv_1PackageImpl extends EPackageImpl implements wmtsv_1Package {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link wmtsv_1Package#eINSTANCE} when that field is
  ...
  public static wmtsv_1Package init() {
    if (isInited)
      return (wmtsv_1Package) EPackage.Registry.INSTANCE.getEPackage(wmtsv_1Package.eNS_URI);

    // Obtain or create and register package
    wmtsv_1PackageImpl thewmtsv_1Package =
        (wmtsv_1PackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof wmtsv_1PackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new wmtsv_1PackageImpl());
    ...
    Gml311PackageImpl theGml311Package =
        (Gml311PackageImpl)
            (EPackage.Registry.INSTANCE.getEPackage(Gml311Package.eNS_URI)
                    instanceof Gml311PackageImpl
                ? EPackage.Registry.INSTANCE.getEPackage(Gml311Package.eNS_URI)
  ...
  public void createPackageContents() {
    ...
    createEAttribute(
        featureInfoResponseTypeEClass, FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION_GROUP);
    ...
    createEReference(
        tileMatrixSetLimitsTypeEClass, TILE_MATRIX_SET_LIMITS_TYPE__TILE_MATRIX_LIMITS);
    ...
    createEReference(
        tileMatrixSetLinkTypeEClass, TILE_MATRIX_SET_LINK_TYPE__TILE_MATRIX_SET_LIMITS);
  ...
  public void initializePackageContents() {
    ...
    Gml311Package theGml311Package =
        (Gml311Package) EPackage.Registry.INSTANCE.getEPackage(Gml311Package.eNS_URI);
    ...
    initEReference(
        ...
        theOws11Package.getOnlineResourceType(),
        null,
        "wSDL",
        null,
        0,
    ...
    initEReference(
        ...
        theOws11Package.getDomainMetadataType(),
        null,
        "uOM",
        null,
        0,
    ...
    initEReference(
        ...
        this.getDimensionNameValueType(),
        null,
        "dimensionNameValue",
        null,
        0,
    ...
    initEReference(
        ...
        this.getFeatureInfoResponseType(),
        null,
        "featureInfoResponse",
        null,
        0,
    ...
    initEReference(
        ...
        this.getTileMatrixSetLimitsType(),
        null,
        "tileMatrixSetLimits",
        null,
        0,
    ...
    initEReference(
        ...
        theGml311Package.getAbstractFeatureCollectionType(),
        null,
        "featureCollection",
        null,
        0,
    ...
    initEAttribute(
        ...
        theOws11Package.getServiceType(),
        "service",
        "WMTS",
        1,
        1,
    ...
    initEReference(
        ...
        theOws11Package.getBoundingBoxType(),
        null,
        "boundingBox",
        null,
        0,
    ...
    initEAttribute(
        ...
        theOws11Package.getPositionType(),
        "topLeftCorner",
        null,
        1,
        1,
    ...
    initEEnum(
        getCapabilitiesValueTypeEEnum, GetCapabilitiesValueType.class, "GetCapabilitiesValueType");
    addEEnumLiteral(getCapabilitiesValueTypeEEnum, GetCapabilitiesValueType.GET_CAPABILITIES);

    initEEnum(
        getFeatureInfoValueTypeEEnum, GetFeatureInfoValueType.class, "GetFeatureInfoValueType");
    ...
    initEDataType(
        ...
        GetCapabilitiesValueType.class,
        "GetCapabilitiesValueTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        getFeatureInfoValueTypeObjectEDataType,
        GetFeatureInfoValueType.class,
        "GetFeatureInfoValueTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        getTileValueTypeObjectEDataType,
        GetTileValueType.class,
        "GetTileValueTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        requestServiceTypeObjectEDataType,
        RequestServiceType.class,
        "RequestServiceTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        resourceTypeTypeObjectEDataType,
        ResourceTypeType.class,
        "ResourceTypeTypeObject",
        IS_SERIALIZABLE,
        IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(
        getCapabilitiesValueTypeEEnum, source, new String[] {"name", "GetCapabilitiesValueType"});
    addAnnotation(
        getCapabilitiesValueTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(
        getFeatureInfoValueTypeEEnum, source, new String[] {"name", "GetFeatureInfoValueType"});
    addAnnotation(
        getFeatureInfoValueTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(getTileValueTypeEEnum, source, new String[] {"name", "GetTileValueType"});
    addAnnotation(
        getTileValueTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(requestServiceTypeEEnum, source, new String[] {"name", "RequestServiceType"});
    addAnnotation(
        requestServiceTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(resourceTypeTypeEEnum, source, new String[] {"name", "resourceType_._type"});
    addAnnotation(
        resourceTypeTypeObjectEDataType,
        source,
        new String[] {
    ...
    addAnnotation(
        ...
        new String[] {
          ...
          "baseType", "http://www.eclipse.org/emf/2003/XMLType#string",
          "pattern",
              "([A-Za-z0-9\\-_\\.!~\\*\'\\(\\);/\\?:@\\+:$,#\\{\\}=&]|%25[A-Fa-f0-9][A-Fa-f0-9])+"
        });
    addAnnotation(
        textPayloadTypeEClass,
        source,
    ...
    addAnnotation(versionTypeEEnum, source, new String[] {"name", "VersionType"});
    addAnnotation(
        versionTypeObjectEDataType,
        source,
        new String[] {
