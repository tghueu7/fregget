 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl#getFeatureCollectionGroup
 *       <em>Feature Collection Group</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl#getFeatureCollection
 *       <em>Feature Collection</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl#getTextPayload <em>Text
 *       Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl#getBinaryPayload <em>Binary
 *       Payload</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.FeatureInfoResponseTypeImpl#getAnyContent <em>Any
 *       Content</em>}
 * </ul>
 *
 * @generated
 */
public class FeatureInfoResponseTypeImpl extends MinimalEObjectImpl.Container
    implements FeatureInfoResponseType {
  /**
   * The cached value of the '{@link #getFeatureCollectionGroup() <em>Feature Collection
  ...
  /**
   * The cached value of the '{@link #getTextPayload() <em>Text Payload</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getBinaryPayload() <em>Binary Payload</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getFeatureCollectionGroup() {
    if (featureCollectionGroup == null) {
      featureCollectionGroup =
          new BasicFeatureMap(
              this, wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION_GROUP);
    }
  ...
  public AbstractFeatureCollectionType getFeatureCollection() {
    return (AbstractFeatureCollectionType)
        getFeatureCollectionGroup()
            .get(wmtsv_1Package.Literals.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION, true);
  }
  ...
  public NotificationChain basicSetFeatureCollection(
    ...
    return ((FeatureMap.Internal) getFeatureCollectionGroup())
        .basicAdd(
            wmtsv_1Package.Literals.FEATURE_INFO_RESPONSE_TYPE__FEATURE_COLLECTION,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD,
              oldTextPayload,
              newTextPayload);
  ...
  public void setTextPayload(TextPayloadType newTextPayload) {
    if (newTextPayload != textPayload) {
      ...
      if (newTextPayload != null)
        msgs =
            ((InternalEObject) newTextPayload)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__TEXT_PAYLOAD,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD,
              oldBinaryPayload,
              newBinaryPayload);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setBinaryPayload(BinaryPayloadType newBinaryPayload) {
    if (newBinaryPayload != binaryPayload) {
      ...
      if (newBinaryPayload != null)
        msgs =
            ((InternalEObject) newBinaryPayload)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__BINARY_PAYLOAD,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT,
              oldAnyContent,
              newAnyContent);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setAnyContent(EObject newAnyContent) {
    if (newAnyContent != anyContent) {
      ...
      if (anyContent != null)
        msgs =
            ((InternalEObject) anyContent)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT,
                    null,
                    msgs);
      if (newAnyContent != null)
        msgs =
            ((InternalEObject) newAnyContent)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.FEATURE_INFO_RESPONSE_TYPE__ANY_CONTENT,
                    null,
