 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl#getHeight <em>Height</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl#getMaxScaleDenominator <em>Max Scale
 *       Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl#getMinScaleDenominator <em>Min Scale
 *       Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.LegendURLTypeImpl#getWidth <em>Width</em>}
 * </ul>
 *
 * @generated
 */
public class LegendURLTypeImpl extends OnlineResourceTypeImpl implements LegendURLType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.LEGEND_URL_TYPE__FORMAT, oldFormat, format));
  }
  ...
  public void setHeight(BigInteger newHeight) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.LEGEND_URL_TYPE__HEIGHT, oldHeight, height));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.LEGEND_URL_TYPE__MAX_SCALE_DENOMINATOR,
              oldMaxScaleDenominator,
              maxScaleDenominator,
              !oldMaxScaleDenominatorESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.LEGEND_URL_TYPE__MIN_SCALE_DENOMINATOR,
              oldMinScaleDenominator,
              minScaleDenominator,
              !oldMinScaleDenominatorESet));
  }
  ...
  public void setWidth(BigInteger newWidth) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, wmtsv_1Package.LEGEND_URL_TYPE__WIDTH, oldWidth, width));
  }
  ...
  public String toString() {
    ...
    if (maxScaleDenominatorESet) result.append(maxScaleDenominator);
    else result.append("<unset>");
    result.append(", minScaleDenominator: ");
    if (minScaleDenominatorESet) result.append(minScaleDenominator);
    else result.append("<unset>");
    result.append(", width: ");
    result.append(width);
    result.append(')');
