 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getIdentifier <em>Identifier</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getScaleDenominator <em>Scale
 *       Denominator</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getTopLeftCorner <em>Top Left
 *       Corner</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getTileWidth <em>Tile Width</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getTileHeight <em>Tile Height</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getMatrixWidth <em>Matrix Width</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.TileMatrixTypeImpl#getMatrixHeight <em>Matrix Height</em>}
 * </ul>
 *
 * @generated
 */
public class TileMatrixTypeImpl extends DescriptionTypeImpl implements TileMatrixType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__IDENTIFIER,
              oldIdentifier,
              newIdentifier);
      ...
      if (identifier != null)
        msgs =
            ((InternalEObject) identifier)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.TILE_MATRIX_TYPE__IDENTIFIER,
                    null,
                    msgs);
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__SCALE_DENOMINATOR,
              oldScaleDenominator,
              scaleDenominator,
              !oldScaleDenominatorESet));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__TOP_LEFT_CORNER,
              oldTopLeftCorner,
              topLeftCorner));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__TILE_WIDTH,
              oldTileWidth,
              tileWidth));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__TILE_HEIGHT,
              oldTileHeight,
              tileHeight));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__MATRIX_WIDTH,
              oldMatrixWidth,
              matrixWidth));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.TILE_MATRIX_TYPE__MATRIX_HEIGHT,
              oldMatrixHeight,
              matrixHeight));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case wmtsv_1Package.TILE_MATRIX_TYPE__TOP_LEFT_CORNER:
        return TOP_LEFT_CORNER_EDEFAULT == null
            ? topLeftCorner != null
            : !TOP_LEFT_CORNER_EDEFAULT.equals(topLeftCorner);
      case wmtsv_1Package.TILE_MATRIX_TYPE__TILE_WIDTH:
        return TILE_WIDTH_EDEFAULT == null
            ? tileWidth != null
            : !TILE_WIDTH_EDEFAULT.equals(tileWidth);
      case wmtsv_1Package.TILE_MATRIX_TYPE__TILE_HEIGHT:
        return TILE_HEIGHT_EDEFAULT == null
            ? tileHeight != null
            : !TILE_HEIGHT_EDEFAULT.equals(tileHeight);
      case wmtsv_1Package.TILE_MATRIX_TYPE__MATRIX_WIDTH:
        return MATRIX_WIDTH_EDEFAULT == null
            ? matrixWidth != null
            : !MATRIX_WIDTH_EDEFAULT.equals(matrixWidth);
      case wmtsv_1Package.TILE_MATRIX_TYPE__MATRIX_HEIGHT:
        return MATRIX_HEIGHT_EDEFAULT == null
            ? matrixHeight != null
            : !MATRIX_HEIGHT_EDEFAULT.equals(matrixHeight);
    }
  ...
  public String toString() {
    ...
    if (scaleDenominatorESet) result.append(scaleDenominator);
