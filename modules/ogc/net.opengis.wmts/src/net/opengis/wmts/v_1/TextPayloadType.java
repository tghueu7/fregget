 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.TextPayloadType#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.TextPayloadType#getTextContent <em>Text Content</em>}
 * </ul>
 *
...
public interface TextPayloadType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TextPayloadType#getFormat <em>Format</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Text string like HTML, XHTML, XML or TXT. HTML and TXT data has to be enclosed in a CDATA
   * element to avoid XML parsing.
   * <!-- end-model-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.wmts.v_1.TextPayloadType#getTextContent <em>Text
