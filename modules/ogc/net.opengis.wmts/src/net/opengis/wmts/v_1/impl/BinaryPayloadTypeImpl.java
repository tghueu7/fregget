 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.BinaryPayloadTypeImpl#getFormat <em>Format</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.BinaryPayloadTypeImpl#getBinaryContent <em>Binary
 *       Content</em>}
 * </ul>
 *
 * @generated
 */
public class BinaryPayloadTypeImpl extends MinimalEObjectImpl.Container
    implements BinaryPayloadType {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.BINARY_PAYLOAD_TYPE__FORMAT,
              oldFormat,
              format));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.BINARY_PAYLOAD_TYPE__BINARY_CONTENT,
              oldBinaryContent,
              binaryContent));
  }
