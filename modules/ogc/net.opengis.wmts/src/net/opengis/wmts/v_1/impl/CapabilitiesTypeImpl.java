 ...
 *
 * <ul>
 *   <li>{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl#getContents <em>Contents</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl#getThemes <em>Themes</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl#getWSDL <em>WSDL</em>}
 *   <li>{@link net.opengis.wmts.v_1.impl.CapabilitiesTypeImpl#getServiceMetadataURL <em>Service
 *       Metadata URL</em>}
 * </ul>
 *
 * @generated
...
public class CapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl implements CapabilitiesType {
  ...
  /**
   * The cached value of the '{@link #getServiceMetadataURL() <em>Service Metadata URL</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              wmtsv_1Package.CAPABILITIES_TYPE__CONTENTS,
              oldContents,
              newContents);
  ...
  public void setContents(ContentsType newContents) {
    if (newContents != contents) {
      ...
      if (contents != null)
        msgs =
            ((InternalEObject) contents)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.CAPABILITIES_TYPE__CONTENTS,
                    null,
                    msgs);
      if (newContents != null)
        msgs =
            ((InternalEObject) newContents)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - wmtsv_1Package.CAPABILITIES_TYPE__CONTENTS,
                    null,
  ...
  public EList<ThemesType> getThemes() {
    if (themes == null) {
      themes =
          new EObjectContainmentEList<ThemesType>(
              ThemesType.class, this, wmtsv_1Package.CAPABILITIES_TYPE__THEMES);
    }
    return themes;
  }
  ...
  public EList<OnlineResourceType> getWSDL() {
    if (wSDL == null) {
      wSDL =
          new EObjectContainmentEList<OnlineResourceType>(
              OnlineResourceType.class, this, wmtsv_1Package.CAPABILITIES_TYPE__WSDL);
    }
    return wSDL;
  }
    ...
    if (serviceMetadataURL == null) {
      serviceMetadataURL =
          new EObjectContainmentEList<OnlineResourceType>(
              ...
              this,
              wmtsv_1Package.CAPABILITIES_TYPE__SERVICE_METADATA_URL);
    }
