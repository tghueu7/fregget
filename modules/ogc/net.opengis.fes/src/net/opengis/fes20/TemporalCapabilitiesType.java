 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.TemporalCapabilitiesType#getTemporalOperands <em>Temporal
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.TemporalCapabilitiesType#getTemporalOperators <em>Temporal
 *       Operators</em>}
 * </ul>
 *
...
public interface TemporalCapabilitiesType extends EObject, TemporalCapabilities {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Operands</em>' containment reference isn't clear, there
   ...
   *     name='TemporalOperands' namespace='##targetNamespace'"
   * @generated
   */
  TemporalOperandsType getTemporalOperands();

  /**
   * Sets the value of the '{@link net.opengis.fes20.TemporalCapabilitiesType#getTemporalOperands
   * <em>Temporal Operands</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Operators</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='TemporalOperators' namespace='##targetNamespace'"
   * @generated
   */
  TemporalOperatorsType getTemporalOperators();

  /**
   * Sets the value of the '{@link net.opengis.fes20.TemporalCapabilitiesType#getTemporalOperators
   * <em>Temporal Operators</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
