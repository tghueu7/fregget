 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.SortPropertyType#getValueReference <em>Value Reference</em>}
 *   <li>{@link net.opengis.fes20.SortPropertyType#getSortOrder <em>Sort Order</em>}
 * </ul>
 *
...
public interface SortPropertyType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.SortPropertyType#getValueReference <em>Value
  ...
  /**
   * Returns the value of the '<em><b>Sort Order</b></em>' attribute. The literals are from the
   * enumeration {@link net.opengis.fes20.SortOrderType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Sort Order</em>' attribute isn't clear, there really should be
   ...
   * @model unsettable="true" extendedMetaData="kind='element' name='SortOrder'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.SortPropertyType#getSortOrder <em>Sort
   * Order</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.fes20.SortPropertyType#getSortOrder <em>Sort
   * Order</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.fes20.SortPropertyType#getSortOrder
   * <em>Sort Order</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
