 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.PropertyIsBetweenType#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsBetweenType#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsBetweenType#getLowerBoundary <em>Lower Boundary</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsBetweenType#getUpperBoundary <em>Upper Boundary</em>}
 * </ul>
 *
...
public interface PropertyIsBetweenType extends ComparisonOpsType {
   ...
   * @model containment="true" required="true" transient="true" changeable="false" volatile="true"
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Lower Boundary</em>' containment reference isn't clear, there
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='LowerBoundary'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.PropertyIsBetweenType#getLowerBoundary
   * <em>Lower Boundary</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Upper Boundary</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='UpperBoundary'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.PropertyIsBetweenType#getUpperBoundary
   * <em>Upper Boundary</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
