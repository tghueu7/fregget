 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.SpatialCapabilitiesType#getGeometryOperands <em>Geometry
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.SpatialCapabilitiesType#getSpatialOperators <em>Spatial
 *       Operators</em>}
 * </ul>
 *
...
public interface SpatialCapabilitiesType extends EObject, SpatialCapabilities {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Geometry Operands</em>' containment reference isn't clear, there
   ...
   *     name='GeometryOperands' namespace='##targetNamespace'"
   * @generated
   */
  GeometryOperandsType getGeometryOperands2();

  /**
   * Sets the value of the '{@link net.opengis.fes20.SpatialCapabilitiesType#getGeometryOperands
   * <em>Geometry Operands</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial Operators</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='SpatialOperators' namespace='##targetNamespace'"
   * @generated
   */
  SpatialOperatorsType getSpatialOperators();

  /**
   * Sets the value of the '{@link net.opengis.fes20.SpatialCapabilitiesType#getSpatialOperators
   * <em>Spatial Operators</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
