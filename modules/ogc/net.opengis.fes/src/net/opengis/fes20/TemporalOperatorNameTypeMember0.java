 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Temporal Operator Name Type
...
public enum TemporalOperatorNameTypeMember0 implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>After</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Before</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Begins</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #BEGINS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Begun By</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #BEGUN_BY
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>TContains</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>During</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #DURING
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>TEquals</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #TEQUALS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>TOverlaps</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #TOVERLAPS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Meets</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MEETS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Overlapped By</b></em>' literal object isn't clear, there really
   * should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #OVERLAPPED_BY
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Met By</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #MET_BY
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Ends</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #ENDS
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Ended By</b></em>' literal object isn't clear, there really should
   * be more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #ENDED_BY
  ...
  /**
   * A public read-only list of all the '<em><b>Temporal Operator Name Type Member0</b></em>'
   * enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Temporal Operator Name Type Member0</b></em>' literal with the specified
   * literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public static TemporalOperatorNameTypeMember0 get(int value) {
    switch (value) {
      ...
      case BEGUN_BY_VALUE:
        return BEGUN_BY;
      case TCONTAINS_VALUE:
        return TCONTAINS;
      case DURING_VALUE:
        return DURING;
      case TEQUALS_VALUE:
        return TEQUALS;
      case TOVERLAPS_VALUE:
        return TOVERLAPS;
      case MEETS_VALUE:
        return MEETS;
      case OVERLAPPED_BY_VALUE:
