 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.TemporalOperatorType#getTemporalOperands <em>Temporal
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.TemporalOperatorType#getName <em>Name</em>}
 * </ul>
 *
...
public interface TemporalOperatorType extends EObject {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='TemporalOperands'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.TemporalOperatorType#getTemporalOperands
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.TemporalOperatorType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
