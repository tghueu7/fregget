 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Version Action Tokens</b></em>', and
...
public enum VersionActionTokens implements Enumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>FIRST</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>LAST</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #LAST
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>PREVIOUS</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>NEXT</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #NEXT
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>ALL</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #ALL
   ...
   * @generated
   */
  public static final List<VersionActionTokens> VALUES =
