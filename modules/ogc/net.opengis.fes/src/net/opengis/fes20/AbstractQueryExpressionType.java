 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.AbstractQueryExpressionType#getHandle <em>Handle</em>}
 * </ul>
 *
 * @see net.opengis.fes20.Fes20Package#getAbstractQueryExpressionType()
 * @model abstract="true" extendedMetaData="name='AbstractQueryExpressionType' kind='empty'"
 * @generated
 */
public interface AbstractQueryExpressionType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.AbstractQueryExpressionType#getHandle
