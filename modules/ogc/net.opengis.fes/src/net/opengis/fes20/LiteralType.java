 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.LiteralType#getMixed <em>Mixed</em>}
 *   <li>{@link net.opengis.fes20.LiteralType#getAny <em>Any</em>}
 *   <li>{@link net.opengis.fes20.LiteralType#getType <em>Type</em>}
 * </ul>
 *
...
public interface LiteralType extends EObject {
   ...
   *     volatile="true" derived="true" extendedMetaData="kind='elementWildcard' wildcards='##any'
   *     name=':1' processing='strict'"
   * @generated
   */
  FeatureMap getAny();
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.QName" extendedMetaData="kind='attribute'
   *     name='type'"
   * @generated
   */
  QName getType();
