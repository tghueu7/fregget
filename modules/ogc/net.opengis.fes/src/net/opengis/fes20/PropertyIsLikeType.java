 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.PropertyIsLikeType#getExpressionGroup <em>Expression Group</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsLikeType#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsLikeType#getEscapeChar <em>Escape Char</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsLikeType#getSingleChar <em>Single Char</em>}
 *   <li>{@link net.opengis.fes20.PropertyIsLikeType#getWildCard <em>Wild Card</em>}
 * </ul>
 *
...
public interface PropertyIsLikeType extends ComparisonOpsType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Escape Char</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.PropertyIsLikeType#getEscapeChar <em>Escape
   * Char</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Single Char</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.PropertyIsLikeType#getSingleChar <em>Single
   * Char</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Wild Card</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.PropertyIsLikeType#getWildCard <em>Wild
   * Card</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
