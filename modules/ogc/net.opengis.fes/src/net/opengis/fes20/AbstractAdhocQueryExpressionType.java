 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.AbstractAdhocQueryExpressionType#getAbstractProjectionClause
 *       <em>Abstract Projection Clause</em>}
 *   <li>{@link net.opengis.fes20.AbstractAdhocQueryExpressionType#getAbstractSelectionClause
 *       <em>Abstract Selection Clause</em>}
 *   <li>{@link net.opengis.fes20.AbstractAdhocQueryExpressionType#getAbstractSortingClause
 *       <em>Abstract Sorting Clause</em>}
 *   <li>{@link net.opengis.fes20.AbstractAdhocQueryExpressionType#getAliases <em>Aliases</em>}
 *   <li>{@link net.opengis.fes20.AbstractAdhocQueryExpressionType#getTypeNames <em>Type Names</em>}
 * </ul>
 *
 * @see net.opengis.fes20.Fes20Package#getAbstractAdhocQueryExpressionType()
 * @model abstract="true" extendedMetaData="name='AbstractAdhocQueryExpressionType'
 *     kind='elementOnly'"
 * @generated
 */
public interface AbstractAdhocQueryExpressionType extends AbstractQueryExpressionType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Abstract Projection Clause</em>' containment reference list isn't
   * clear, there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Abstract Projection Clause</em>' containment reference list.
   * @see
   *     net.opengis.fes20.Fes20Package#getAbstractAdhocQueryExpressionType_AbstractProjectionClause()
   * @model
   * @generated NOT
   */
   ...
   * @see
   *     net.opengis.fes20.Fes20Package#getAbstractAdhocQueryExpressionType_AbstractSelectionClause()
   * @model
   */
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Aliases</em>' attribute isn't clear, there really should be more
