 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.TemporalOperandsType#getTemporalOperand <em>Temporal Operand</em>}
 * </ul>
 *
...
public interface TemporalOperandsType extends EObject {
  /**
   * Returns the value of the '<em><b>Temporal Operand</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.TemporalOperandType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Operand</em>' containment reference list isn't clear,
   ...
   *     name='TemporalOperand' namespace='##targetNamespace'"
   * @generated
   */
