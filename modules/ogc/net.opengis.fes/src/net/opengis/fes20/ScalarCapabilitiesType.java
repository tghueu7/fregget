 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.ScalarCapabilitiesType#getLogicalOperators <em>Logical
 *       Operators</em>}
 *   <li>{@link net.opengis.fes20.ScalarCapabilitiesType#getComparisonOperators <em>Comparison
 *       Operators</em>}
 * </ul>
 *
...
public interface ScalarCapabilitiesType extends EObject, ScalarCapabilities {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='LogicalOperators'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ScalarCapabilitiesType#getLogicalOperators
   * <em>Logical Operators</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Comparison Operators</em>' containment reference isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='ComparisonOperators'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ScalarCapabilitiesType#getComparisonOperators
   * <em>Comparison Operators</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
