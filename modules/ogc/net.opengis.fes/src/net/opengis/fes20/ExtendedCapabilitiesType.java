 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.ExtendedCapabilitiesType#getAdditionalOperators <em>Additional
 *       Operators</em>}
 * </ul>
 *
...
public interface ExtendedCapabilitiesType extends EObject {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Additional Operators</em>' containment reference isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='AdditionalOperators'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ExtendedCapabilitiesType#getAdditionalOperators
   * <em>Additional Operators</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
