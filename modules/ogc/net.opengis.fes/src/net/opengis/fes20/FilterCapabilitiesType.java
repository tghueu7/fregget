 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getConformance <em>Conformance</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getIdCapabilities <em>Id Capabilities</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getScalarCapabilities <em>Scalar
 *       Capabilities</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getSpatialCapabilities <em>Spatial
 *       Capabilities</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getTemporalCapabilities <em>Temporal
 *       Capabilities</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getFunctions <em>Functions</em>}
 *   <li>{@link net.opengis.fes20.FilterCapabilitiesType#getExtendedCapabilities <em>Extended
 *       Capabilities</em>}
 * </ul>
 *
...
public interface FilterCapabilitiesType extends EObject, FilterCapabilities {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Conformance</em>' containment reference isn't clear, there really
   ...
   * @model containment="true" required="true" extendedMetaData="kind='element' name='Conformance'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getConformance
   * <em>Conformance</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Id Capabilities</em>' containment reference isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Id_Capabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getIdCapabilities <em>Id
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Scalar Capabilities</em>' containment reference isn't clear,
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Scalar_Capabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getScalarCapabilities
   * <em>Scalar Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial Capabilities</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Spatial_Capabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getSpatialCapabilities
   * <em>Spatial Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Capabilities</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Temporal_Capabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getTemporalCapabilities
   * <em>Temporal Capabilities</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Functions'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getFunctions
   * <em>Functions</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Extended Capabilities</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Extended_Capabilities'
   *     namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.FilterCapabilitiesType#getExtendedCapabilities
