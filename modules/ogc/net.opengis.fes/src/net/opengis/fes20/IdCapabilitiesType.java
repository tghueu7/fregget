 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.IdCapabilitiesType#getResourceIdentifier <em>Resource
 *       Identifier</em>}
 * </ul>
 *
...
public interface IdCapabilitiesType extends EObject, IdCapabilities {
  /**
   * Returns the value of the '<em><b>Resource Identifier</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.ResourceIdentifierType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Resource Identifier</em>' containment reference list isn't clear,
   ...
   *     name='ResourceIdentifier' namespace='##targetNamespace'"
   * @generated
   */
