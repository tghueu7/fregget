 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.ComparisonOperatorsType#getGroup <em>Group</em>}
 *   <li>{@link net.opengis.fes20.ComparisonOperatorsType#getComparisonOperator <em>Comparison
 *       Operator</em>}
 * </ul>
 *
...
public interface ComparisonOperatorsType extends EObject, ComparisonOperators {
  ...
  /**
   * Returns the value of the '<em><b>Comparison Operator</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.ComparisonOperatorType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Comparison Operator</em>' containment reference list isn't clear,
