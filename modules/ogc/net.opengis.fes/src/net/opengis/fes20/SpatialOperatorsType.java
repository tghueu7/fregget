 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.SpatialOperatorsType#getSpatialOperator <em>Spatial Operator</em>}
 * </ul>
 *
...
public interface SpatialOperatorsType extends EObject, SpatialOperators {
  /**
   * Returns the value of the '<em><b>Spatial Operator</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.SpatialOperatorType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Spatial Operator</em>' containment reference list isn't clear,
   ...
   *     name='SpatialOperator' namespace='##targetNamespace'"
   * @generated
   */
