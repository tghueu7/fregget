 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.PropertyIsNilTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsNilTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsNilTypeImpl#getNilReason <em>Nil Reason</em>}
 * </ul>
 *
 * @generated
 */
public class PropertyIsNilTypeImpl extends ComparisonOpsTypeImpl implements PropertyIsNilType {
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.PROPERTY_IS_NIL_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.PROPERTY_IS_NIL_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.PROPERTY_IS_NIL_TYPE__EXPRESSION, newExpression, msgs);
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_NIL_TYPE__NIL_REASON,
              oldNilReason,
              nilReason));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Fes20Package.PROPERTY_IS_NIL_TYPE__NIL_REASON:
        return NIL_REASON_EDEFAULT == null
            ? nilReason != null
            : !NIL_REASON_EDEFAULT.equals(nilReason);
    }
