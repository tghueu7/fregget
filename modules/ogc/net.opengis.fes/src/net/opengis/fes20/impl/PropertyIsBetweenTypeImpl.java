 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.PropertyIsBetweenTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsBetweenTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsBetweenTypeImpl#getLowerBoundary <em>Lower
 *       Boundary</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsBetweenTypeImpl#getUpperBoundary <em>Upper
 *       Boundary</em>}
 * </ul>
 *
 * @generated
 */
public class PropertyIsBetweenTypeImpl extends ComparisonOpsTypeImpl
    implements PropertyIsBetweenType {
  /**
   * The cached value of the '{@link #getExpressionGroup() <em>Expression Group</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getLowerBoundary() <em>Lower Boundary</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUpperBoundary() <em>Upper Boundary</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.PROPERTY_IS_BETWEEN_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.PROPERTY_IS_BETWEEN_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.PROPERTY_IS_BETWEEN_TYPE__EXPRESSION, newExpression, msgs);
  }
   ...
   * @generated
   */
  public NotificationChain basicSetLowerBoundary(
      LowerBoundaryType newLowerBoundary, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_BETWEEN_TYPE__LOWER_BOUNDARY,
              oldLowerBoundary,
              newLowerBoundary);
  ...
  public void setLowerBoundary(LowerBoundaryType newLowerBoundary) {
    if (newLowerBoundary != lowerBoundary) {
      ...
      if (lowerBoundary != null)
        msgs =
            ((InternalEObject) lowerBoundary)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.PROPERTY_IS_BETWEEN_TYPE__LOWER_BOUNDARY,
                    null,
                    msgs);
      if (newLowerBoundary != null)
        msgs =
            ((InternalEObject) newLowerBoundary)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.PROPERTY_IS_BETWEEN_TYPE__LOWER_BOUNDARY,
                    null,
   ...
   * @generated
   */
  public NotificationChain basicSetUpperBoundary(
      UpperBoundaryType newUpperBoundary, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_BETWEEN_TYPE__UPPER_BOUNDARY,
              oldUpperBoundary,
              newUpperBoundary);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setUpperBoundary(UpperBoundaryType newUpperBoundary) {
    if (newUpperBoundary != upperBoundary) {
      ...
      if (upperBoundary != null)
        msgs =
            ((InternalEObject) upperBoundary)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.PROPERTY_IS_BETWEEN_TYPE__UPPER_BOUNDARY,
                    null,
                    msgs);
      if (newUpperBoundary != null)
        msgs =
            ((InternalEObject) newUpperBoundary)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.PROPERTY_IS_BETWEEN_TYPE__UPPER_BOUNDARY,
                    null,
