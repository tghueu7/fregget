 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.TemporalOperatorsTypeImpl#getTemporalOperator <em>Temporal
 *       Operator</em>}
 * </ul>
 *
 * @generated
...
public class TemporalOperatorsTypeImpl extends EObjectImpl implements TemporalOperatorsType {
  /**
   * The cached value of the '{@link #getTemporalOperator() <em>Temporal Operator</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TemporalOperator> getOperators() {
    if (temporalOperator == null) {
      temporalOperator =
          new EObjectContainmentEList<TemporalOperator>(
              TemporalOperatorType.class,
              this,
              Fes20Package.TEMPORAL_OPERATORS_TYPE__TEMPORAL_OPERATOR);
    }
