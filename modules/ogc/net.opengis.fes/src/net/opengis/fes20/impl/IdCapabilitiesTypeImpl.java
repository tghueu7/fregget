 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.IdCapabilitiesTypeImpl#getResourceIdentifier <em>Resource
 *       Identifier</em>}
 * </ul>
 *
 * @generated
...
public class IdCapabilitiesTypeImpl extends EObjectImpl implements IdCapabilitiesType {
  /**
   * The cached value of the '{@link #getResourceIdentifier() <em>Resource Identifier</em>}'
  ...
  public EList<ResourceIdentifierType> getResourceIdentifier() {
    if (resourceIdentifier == null) {
      resourceIdentifier =
          new EObjectContainmentEList<ResourceIdentifierType>(
              ResourceIdentifierType.class,
              this,
              Fes20Package.ID_CAPABILITIES_TYPE__RESOURCE_IDENTIFIER);
    }
