 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getFilterPredicates <em>Filter
 *       Predicates</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getComparisonOpsGroup <em>Comparison
 *       Ops Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getComparisonOps <em>Comparison
 *       Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getSpatialOpsGroup <em>Spatial Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getSpatialOps <em>Spatial Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getTemporalOpsGroup <em>Temporal Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getTemporalOps <em>Temporal Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getLogicOpsGroup <em>Logic Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getLogicOps <em>Logic Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getExtensionOpsGroup <em>Extension Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getExtensionOps <em>Extension Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getFunction <em>Function</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getIdGroup <em>Id Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryLogicOpTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class BinaryLogicOpTypeImpl extends LogicOpsTypeImpl implements BinaryLogicOpType {
  /**
   * The cached value of the '{@link #getFilterPredicates() <em>Filter Predicates</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getFilterPredicates() {
    if (filterPredicates == null) {
      filterPredicates =
          new BasicFeatureMap(this, Fes20Package.BINARY_LOGIC_OP_TYPE__FILTER_PREDICATES);
    }
    ...
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(
                Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__COMPARISON_OPS_GROUP);
  }
  ...
  public FeatureMap getSpatialOpsGroup() {
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__SPATIAL_OPS_GROUP);
  }
  ...
  public FeatureMap getTemporalOpsGroup() {
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__TEMPORAL_OPS_GROUP);
  }
  ...
  public FeatureMap getLogicOpsGroup() {
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__LOGIC_OPS_GROUP);
  }
  ...
  public FeatureMap getExtensionOpsGroup() {
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(
                Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__EXTENSION_OPS_GROUP);
  }
  ...
  public FeatureMap getIdGroup() {
    return (FeatureMap)
        getFilterPredicates()
            .<FeatureMap.Entry>list(Fes20Package.Literals.BINARY_LOGIC_OP_TYPE__ID_GROUP);
  }
