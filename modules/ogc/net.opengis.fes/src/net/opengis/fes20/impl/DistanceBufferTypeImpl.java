 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.DistanceBufferTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.DistanceBufferTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.DistanceBufferTypeImpl#getAny <em>Any</em>}
 *   <li>{@link net.opengis.fes20.impl.DistanceBufferTypeImpl#getDistance <em>Distance</em>}
 * </ul>
 *
 * @generated
 */
public class DistanceBufferTypeImpl extends SpatialOpsTypeImpl implements DistanceBufferType {
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.DISTANCE_BUFFER_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.DISTANCE_BUFFER_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.DISTANCE_BUFFER_TYPE__EXPRESSION, newExpression, msgs);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.DISTANCE_BUFFER_TYPE__DISTANCE,
              oldDistance,
              newDistance);
      ...
      if (distance != null)
        msgs =
            ((InternalEObject) distance)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.DISTANCE_BUFFER_TYPE__DISTANCE,
                    null,
                    msgs);
      if (newDistance != null)
        msgs =
