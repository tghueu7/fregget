 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ResourceIdentifierTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.fes20.impl.ResourceIdentifierTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class ResourceIdentifierTypeImpl extends EObjectImpl implements ResourceIdentifierType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.RESOURCE_IDENTIFIER_TYPE__METADATA,
              oldMetadata,
              newMetadata);
      ...
      if (metadata != null)
        msgs =
            ((InternalEObject) metadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.RESOURCE_IDENTIFIER_TYPE__METADATA,
                    null,
                    msgs);
      if (newMetadata != null)
        msgs =
  ...
  public void setName(QName newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.RESOURCE_IDENTIFIER_TYPE__NAME, oldName, name));
  }
