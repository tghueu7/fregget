 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.SpatialCapabilitiesTypeImpl#getGeometryOperands <em>Geometry
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.impl.SpatialCapabilitiesTypeImpl#getSpatialOperators <em>Spatial
 *       Operators</em>}
 * </ul>
 *
 * @generated
...
public class SpatialCapabilitiesTypeImpl extends EObjectImpl implements SpatialCapabilitiesType {
  /**
   * The cached value of the '{@link #getGeometryOperands() <em>Geometry Operands</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSpatialOperators() <em>Spatial Operators</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @generated
   */
  public NotificationChain basicSetGeometryOperands(
      GeometryOperandsType newGeometryOperands, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS,
              oldGeometryOperands,
              newGeometryOperands);
  ...
  public void setGeometryOperands(GeometryOperandsType newGeometryOperands) {
    if (newGeometryOperands != geometryOperands) {
      ...
      if (geometryOperands != null)
        msgs =
            ((InternalEObject) geometryOperands)
                .eInverseRemove(
                    this,
      ...
      if (newGeometryOperands != null)
        msgs =
            ((InternalEObject) newGeometryOperands)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS,
   ...
   * @generated
   */
  public NotificationChain basicSetSpatialOperators(
      SpatialOperatorsType newSpatialOperators, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS,
              oldSpatialOperators,
              newSpatialOperators);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setSpatialOperators(SpatialOperatorsType newSpatialOperators) {
    if (newSpatialOperators != spatialOperators) {
      ...
      if (spatialOperators != null)
        msgs =
            ((InternalEObject) spatialOperators)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS,
      ...
      if (newSpatialOperators != null)
        msgs =
            ((InternalEObject) newSpatialOperators)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS,
  ...
  public Collection<GeometryOperand> getGeometryOperands() {
    ...
    if (getGeometryOperands2() != null) {
      for (GeometryOperandType go : getGeometryOperands2().getGeometryOperand()) {
        geometryOperands.add(
            GeometryOperand.get(go.getName().getNamespaceURI(), go.getName().getLocalPart()));
      }
    }
    return geometryOperands;
  }
