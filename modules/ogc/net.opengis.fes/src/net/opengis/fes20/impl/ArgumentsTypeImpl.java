 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ArgumentsTypeImpl#getArgument <em>Argument</em>}
 * </ul>
 *
 * @generated
 */
public class ArgumentsTypeImpl extends EObjectImpl implements ArgumentsType {
  ...
  public EList<ArgumentType> getArgument() {
    if (argument == null) {
      argument =
          new EObjectContainmentEList<ArgumentType>(
              ArgumentType.class, this, Fes20Package.ARGUMENTS_TYPE__ARGUMENT);
    }
    return argument;
  }
