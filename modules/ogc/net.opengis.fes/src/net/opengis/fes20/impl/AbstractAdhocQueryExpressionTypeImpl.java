 ...
 * <ul>
 *   <li>{@link
 *       net.opengis.fes20.impl.AbstractAdhocQueryExpressionTypeImpl#getAbstractProjectionClause
 *       <em>Abstract Projection Clause</em>}
 *   <li>{@link
 *       net.opengis.fes20.impl.AbstractAdhocQueryExpressionTypeImpl#getAbstractSelectionClause
 *       <em>Abstract Selection Clause</em>}
 *   <li>{@link net.opengis.fes20.impl.AbstractAdhocQueryExpressionTypeImpl#getAbstractSortingClause
 *       <em>Abstract Sorting Clause</em>}
 *   <li>{@link net.opengis.fes20.impl.AbstractAdhocQueryExpressionTypeImpl#getAliases
 *       <em>Aliases</em>}
 *   <li>{@link net.opengis.fes20.impl.AbstractAdhocQueryExpressionTypeImpl#getTypeNames <em>Type
 *       Names</em>}
 * </ul>
 *
 * @generated
 */
public abstract class AbstractAdhocQueryExpressionTypeImpl extends AbstractQueryExpressionTypeImpl
    implements AbstractAdhocQueryExpressionType {
  /**
   * The cached value of the '{@link #getAbstractProjectionClause() <em>Abstract Projection
   * Clause</em>}' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getAbstractSelectionClause() <em>Abstract Selection
   * Clause</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAbstractSelectionClause() <em>Abstract Selection
   * Clause</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The default value of the '{@link #getAbstractSortingClause() <em>Abstract Sorting Clause</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getAbstractSortingClause() <em>Abstract Sorting Clause</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<Object> getAbstractProjectionClause() {
    if (abstractProjectionClause == null) {
      abstractProjectionClause =
          new EDataTypeUniqueEList<Object>(
              Object.class,
              this,
    ...
    if (aliases == null) {
      aliases =
          new EDataTypeUniqueEList<String>(
              String.class, this, Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ALIASES);
    }
    return aliases;
  }
  ...
  public EList<Object> getTypeNames() {
    if (typeNames == null) {
      typeNames =
          new EDataTypeEList<Object>(
              Object.class, this, Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__TYPE_NAMES);
    }
    return typeNames;
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ABSTRACT_SELECTION_CLAUSE:
        return ABSTRACT_SELECTION_CLAUSE_EDEFAULT == null
            ? abstractSelectionClause != null
            : !ABSTRACT_SELECTION_CLAUSE_EDEFAULT.equals(abstractSelectionClause);
      case Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ABSTRACT_SORTING_CLAUSE:
        return ABSTRACT_SORTING_CLAUSE_EDEFAULT == null
            ? abstractSortingClause != null
            : !ABSTRACT_SORTING_CLAUSE_EDEFAULT.equals(abstractSortingClause);
      case Fes20Package.ABSTRACT_ADHOC_QUERY_EXPRESSION_TYPE__ALIASES:
