 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.TemporalCapabilitiesTypeImpl#getTemporalOperands <em>Temporal
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.impl.TemporalCapabilitiesTypeImpl#getTemporalOperators
...
public class TemporalCapabilitiesTypeImpl extends EObjectImpl implements TemporalCapabilitiesType {
  /**
   * The cached value of the '{@link #getTemporalOperands() <em>Temporal Operands</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalOperators() <em>Temporal Operators</em>}'
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalOperands(
      TemporalOperandsType newTemporalOperands, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.TEMPORAL_CAPABILITIES_TYPE__TEMPORAL_OPERANDS,
              oldTemporalOperands,
              newTemporalOperands);
  ...
  public void setTemporalOperands(TemporalOperandsType newTemporalOperands) {
    if (newTemporalOperands != temporalOperands) {
      ...
      if (temporalOperands != null)
        msgs =
            ((InternalEObject) temporalOperands)
                .eInverseRemove(
                    this,
      ...
      if (newTemporalOperands != null)
        msgs =
            ((InternalEObject) newTemporalOperands)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.TEMPORAL_CAPABILITIES_TYPE__TEMPORAL_OPERANDS,
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalOperators(
      TemporalOperatorsType newTemporalOperators, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.TEMPORAL_CAPABILITIES_TYPE__TEMPORAL_OPERATORS,
              oldTemporalOperators,
              newTemporalOperators);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setTemporalOperators(TemporalOperatorsType newTemporalOperators) {
    if (newTemporalOperators != temporalOperators) {
      ...
      if (temporalOperators != null)
        msgs =
            ((InternalEObject) temporalOperators)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.TEMPORAL_CAPABILITIES_TYPE__TEMPORAL_OPERATORS,
      ...
      if (newTemporalOperators != null)
        msgs =
            ((InternalEObject) newTemporalOperators)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.TEMPORAL_CAPABILITIES_TYPE__TEMPORAL_OPERATORS,
