 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getComparisonOpsGroup <em>Comparison Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getComparisonOps <em>Comparison Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getSpatialOpsGroup <em>Spatial Ops Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getSpatialOps <em>Spatial Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getTemporalOpsGroup <em>Temporal Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getTemporalOps <em>Temporal Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getLogicOpsGroup <em>Logic Ops Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getLogicOps <em>Logic Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getExtensionOpsGroup <em>Extension Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getExtensionOps <em>Extension Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getFunction <em>Function</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getIdGroup <em>Id Group</em>}
 *   <li>{@link net.opengis.fes20.impl.FilterTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class FilterTypeImpl extends AbstractSelectionClauseTypeImpl implements FilterType {
  ...
  public FeatureMap getComparisonOpsGroup() {
    if (comparisonOpsGroup == null) {
      comparisonOpsGroup =
          new BasicFeatureMap(this, Fes20Package.FILTER_TYPE__COMPARISON_OPS_GROUP);
    }
  ...
  public ComparisonOpsType getComparisonOps() {
    return (ComparisonOpsType)
        getComparisonOpsGroup().get(Fes20Package.Literals.FILTER_TYPE__COMPARISON_OPS, true);
  }
  ...
  public NotificationChain basicSetComparisonOps(
    ...
    return ((FeatureMap.Internal) getComparisonOpsGroup())
        .basicAdd(Fes20Package.Literals.FILTER_TYPE__COMPARISON_OPS, newComparisonOps, msgs);
  }
  ...
  public SpatialOpsType getSpatialOps() {
    return (SpatialOpsType)
        getSpatialOpsGroup().get(Fes20Package.Literals.FILTER_TYPE__SPATIAL_OPS, true);
  }
  ...
  public NotificationChain basicSetSpatialOps(
    ...
    return ((FeatureMap.Internal) getSpatialOpsGroup())
        .basicAdd(Fes20Package.Literals.FILTER_TYPE__SPATIAL_OPS, newSpatialOps, msgs);
  }
  ...
  public TemporalOpsType getTemporalOps() {
    return (TemporalOpsType)
        getTemporalOpsGroup().get(Fes20Package.Literals.FILTER_TYPE__TEMPORAL_OPS, true);
  }
  ...
  public NotificationChain basicSetTemporalOps(
    ...
    return ((FeatureMap.Internal) getTemporalOpsGroup())
        .basicAdd(Fes20Package.Literals.FILTER_TYPE__TEMPORAL_OPS, newTemporalOps, msgs);
  }
  ...
  public LogicOpsType getLogicOps() {
    return (LogicOpsType)
        getLogicOpsGroup().get(Fes20Package.Literals.FILTER_TYPE__LOGIC_OPS, true);
  }
  ...
  public NotificationChain basicSetLogicOps(LogicOpsType newLogicOps, NotificationChain msgs) {
    return ((FeatureMap.Internal) getLogicOpsGroup())
        .basicAdd(Fes20Package.Literals.FILTER_TYPE__LOGIC_OPS, newLogicOps, msgs);
  }
  ...
  public ExtensionOpsType getExtensionOps() {
    return (ExtensionOpsType)
        getExtensionOpsGroup().get(Fes20Package.Literals.FILTER_TYPE__EXTENSION_OPS, true);
  }
  ...
  public NotificationChain basicSetExtensionOps(
    ...
    return ((FeatureMap.Internal) getExtensionOpsGroup())
        .basicAdd(Fes20Package.Literals.FILTER_TYPE__EXTENSION_OPS, newExtensionOps, msgs);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.FILTER_TYPE__FUNCTION, oldFunction, newFunction);
    ...
    if (newFunction != function) {
      ...
      if (function != null)
        msgs =
            ((InternalEObject) function)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - Fes20Package.FILTER_TYPE__FUNCTION, null, msgs);
      if (newFunction != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.FILTER_TYPE__FUNCTION,
              newFunction,
              newFunction));
  }
