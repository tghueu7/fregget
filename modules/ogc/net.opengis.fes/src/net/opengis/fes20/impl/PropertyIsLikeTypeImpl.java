 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.PropertyIsLikeTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsLikeTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsLikeTypeImpl#getEscapeChar <em>Escape Char</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsLikeTypeImpl#getSingleChar <em>Single Char</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsLikeTypeImpl#getWildCard <em>Wild Card</em>}
 * </ul>
 *
 * @generated
 */
public class PropertyIsLikeTypeImpl extends ComparisonOpsTypeImpl implements PropertyIsLikeType {
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.PROPERTY_IS_LIKE_TYPE__EXPRESSION_GROUP);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_LIKE_TYPE__ESCAPE_CHAR,
              oldEscapeChar,
              escapeChar));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_LIKE_TYPE__SINGLE_CHAR,
              oldSingleChar,
              singleChar));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.PROPERTY_IS_LIKE_TYPE__WILD_CARD,
              oldWildCard,
              wildCard));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Fes20Package.PROPERTY_IS_LIKE_TYPE__ESCAPE_CHAR:
        return ESCAPE_CHAR_EDEFAULT == null
            ? escapeChar != null
            : !ESCAPE_CHAR_EDEFAULT.equals(escapeChar);
      case Fes20Package.PROPERTY_IS_LIKE_TYPE__SINGLE_CHAR:
        return SINGLE_CHAR_EDEFAULT == null
            ? singleChar != null
            : !SINGLE_CHAR_EDEFAULT.equals(singleChar);
      case Fes20Package.PROPERTY_IS_LIKE_TYPE__WILD_CARD:
