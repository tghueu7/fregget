 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ResourceIdTypeImpl#getEndDate <em>End Date</em>}
 *   <li>{@link net.opengis.fes20.impl.ResourceIdTypeImpl#getPreviousRid <em>Previous Rid</em>}
 *   <li>{@link net.opengis.fes20.impl.ResourceIdTypeImpl#getRid <em>Rid</em>}
 *   <li>{@link net.opengis.fes20.impl.ResourceIdTypeImpl#getStartDate <em>Start Date</em>}
 *   <li>{@link net.opengis.fes20.impl.ResourceIdTypeImpl#getVersion <em>Version</em>}
 * </ul>
 *
 * @generated
 */
public class ResourceIdTypeImpl extends AbstractIdTypeImpl implements ResourceIdType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.RESOURCE_ID_TYPE__END_DATE,
              oldEndDate,
              endDate));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.RESOURCE_ID_TYPE__PREVIOUS_RID,
              oldPreviousRid,
              previousRid));
  }
  ...
  public void setRid(String newRid) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.RESOURCE_ID_TYPE__RID, oldRid, rid));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.RESOURCE_ID_TYPE__START_DATE,
              oldStartDate,
              startDate));
  }
  ...
  public void setVersion(Object newVersion) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.RESOURCE_ID_TYPE__VERSION, oldVersion, version));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      ...
      case Fes20Package.RESOURCE_ID_TYPE__PREVIOUS_RID:
        return PREVIOUS_RID_EDEFAULT == null
            ? previousRid != null
            : !PREVIOUS_RID_EDEFAULT.equals(previousRid);
      case Fes20Package.RESOURCE_ID_TYPE__RID:
