 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.AvailableFunctionTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.fes20.impl.AvailableFunctionTypeImpl#getReturns <em>Returns</em>}
 *   <li>{@link net.opengis.fes20.impl.AvailableFunctionTypeImpl#getArguments <em>Arguments</em>}
 *   <li>{@link net.opengis.fes20.impl.AvailableFunctionTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class AvailableFunctionTypeImpl extends EObjectImpl implements AvailableFunctionType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.AVAILABLE_FUNCTION_TYPE__METADATA,
              oldMetadata,
              newMetadata);
  ...
  public void setMetadata(MetadataType newMetadata) {
    if (newMetadata != metadata) {
      ...
      if (metadata != null)
        msgs =
            ((InternalEObject) metadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.AVAILABLE_FUNCTION_TYPE__METADATA,
                    null,
                    msgs);
      if (newMetadata != null)
        msgs =
            ((InternalEObject) newMetadata)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.AVAILABLE_FUNCTION_TYPE__METADATA,
                    null,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.AVAILABLE_FUNCTION_TYPE__RETURNS,
              oldReturns,
              returns));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.AVAILABLE_FUNCTION_TYPE__ARGUMENTS,
              oldArguments,
              newArguments);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setArguments(ArgumentsType newArguments) {
    if (newArguments != arguments) {
      ...
      if (arguments != null)
        msgs =
            ((InternalEObject) arguments)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.AVAILABLE_FUNCTION_TYPE__ARGUMENTS,
                    null,
                    msgs);
      if (newArguments != null)
        msgs =
            ((InternalEObject) newArguments)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.AVAILABLE_FUNCTION_TYPE__ARGUMENTS,
                    null,
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.AVAILABLE_FUNCTION_TYPE__NAME, oldName, name));
  }
