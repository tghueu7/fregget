 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.SortPropertyTypeImpl#getValueReference <em>Value
 *       Reference</em>}
 *   <li>{@link net.opengis.fes20.impl.SortPropertyTypeImpl#getSortOrder <em>Sort Order</em>}
 * </ul>
 *
 * @generated
 */
public class SortPropertyTypeImpl extends EObjectImpl implements SortPropertyType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SORT_PROPERTY_TYPE__VALUE_REFERENCE,
              oldValueReference,
              valueReference));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SORT_PROPERTY_TYPE__SORT_ORDER,
              oldSortOrder,
              sortOrder,
              !oldSortOrderESet));
  }
  ...
  public String toString() {
    ...
    if (sortOrderESet) result.append(sortOrder);
