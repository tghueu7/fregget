 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.SpatialOperatorsTypeImpl#getSpatialOperator <em>Spatial
 *       Operator</em>}
 * </ul>
 *
 * @generated
...
public class SpatialOperatorsTypeImpl extends EObjectImpl implements SpatialOperatorsType {
  /**
   * The cached value of the '{@link #getSpatialOperator() <em>Spatial Operator</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<SpatialOperator> getOperators() {
    if (spatialOperator == null) {
      spatialOperator =
          new EObjectContainmentEList<SpatialOperator>(
              SpatialOperatorType.class,
              this,
              Fes20Package.SPATIAL_OPERATORS_TYPE__SPATIAL_OPERATOR);
    }
