 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.BinarySpatialOpTypeImpl#getValueReference <em>Value
 *       Reference</em>}
 *   <li>{@link net.opengis.fes20.impl.BinarySpatialOpTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinarySpatialOpTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.BinarySpatialOpTypeImpl#getAny <em>Any</em>}
 * </ul>
 *
 * @generated
 */
public class BinarySpatialOpTypeImpl extends SpatialOpsTypeImpl implements BinarySpatialOpType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.BINARY_SPATIAL_OP_TYPE__VALUE_REFERENCE,
              oldValueReference,
              valueReference));
  }
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.BINARY_SPATIAL_OP_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.BINARY_SPATIAL_OP_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.BINARY_SPATIAL_OP_TYPE__EXPRESSION, newExpression, msgs);
  }
