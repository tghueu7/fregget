 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.SpatialOperatorTypeImpl#getGeometryOperands <em>Geometry
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.impl.SpatialOperatorTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class SpatialOperatorTypeImpl extends EObjectImpl implements SpatialOperatorType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SPATIAL_OPERATOR_TYPE__GEOMETRY_OPERANDS,
              oldGeometryOperands,
              newGeometryOperands);
      ...
      if (geometryOperands != null)
        msgs =
            ((InternalEObject) geometryOperands)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.SPATIAL_OPERATOR_TYPE__GEOMETRY_OPERANDS,
                    null,
                    msgs);
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.SPATIAL_OPERATOR_TYPE__NAME, oldName, name));
  }
