 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.BBOXTypeImpl#getExpressionGroup <em>Expression Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BBOXTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.BBOXTypeImpl#getAny <em>Any</em>}
 * </ul>
 *
 * @generated
 */
public class BBOXTypeImpl extends SpatialOpsTypeImpl implements BBOXType {
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.BBOX_TYPE__EXPRESSION, newExpression, msgs);
  }
