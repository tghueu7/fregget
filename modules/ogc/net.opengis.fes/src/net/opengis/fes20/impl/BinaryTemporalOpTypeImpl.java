 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.BinaryTemporalOpTypeImpl#getValueReference <em>Value
 *       Reference</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryTemporalOpTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryTemporalOpTypeImpl#getExpression <em>Expression</em>}
 *   <li>{@link net.opengis.fes20.impl.BinaryTemporalOpTypeImpl#getAny <em>Any</em>}
 * </ul>
 *
 * @generated
 */
public class BinaryTemporalOpTypeImpl extends TemporalOpsTypeImpl implements BinaryTemporalOpType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.BINARY_TEMPORAL_OP_TYPE__VALUE_REFERENCE,
              oldValueReference,
              valueReference));
  }
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.BINARY_TEMPORAL_OP_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.BINARY_TEMPORAL_OP_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.BINARY_TEMPORAL_OP_TYPE__EXPRESSION, newExpression, msgs);
  }
