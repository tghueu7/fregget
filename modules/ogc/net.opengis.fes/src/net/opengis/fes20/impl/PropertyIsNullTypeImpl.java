 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.PropertyIsNullTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.PropertyIsNullTypeImpl#getExpression <em>Expression</em>}
 * </ul>
 *
 * @generated
 */
public class PropertyIsNullTypeImpl extends ComparisonOpsTypeImpl implements PropertyIsNullType {
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.PROPERTY_IS_NULL_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.PROPERTY_IS_NULL_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.PROPERTY_IS_NULL_TYPE__EXPRESSION, newExpression, msgs);
  }
