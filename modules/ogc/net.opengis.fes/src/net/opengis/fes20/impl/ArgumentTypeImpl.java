 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ArgumentTypeImpl#getMetadata <em>Metadata</em>}
 *   <li>{@link net.opengis.fes20.impl.ArgumentTypeImpl#getType <em>Type</em>}
 *   <li>{@link net.opengis.fes20.impl.ArgumentTypeImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class ArgumentTypeImpl extends EObjectImpl implements ArgumentType {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.ARGUMENT_TYPE__METADATA,
              oldMetadata,
              newMetadata);
      ...
      if (metadata != null)
        msgs =
            ((InternalEObject) metadata)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.ARGUMENT_TYPE__METADATA,
                    null,
                    msgs);
      if (newMetadata != null)
        msgs =
  ...
  public void setType(QName newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.ARGUMENT_TYPE__TYPE, oldType, type));
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, Fes20Package.ARGUMENT_TYPE__NAME, oldName, name));
  }
