 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.AdditionalOperatorsTypeImpl#getOperator <em>Operator</em>}
 * </ul>
 *
 * @generated
 */
public class AdditionalOperatorsTypeImpl extends EObjectImpl implements AdditionalOperatorsType {
  ...
  public EList<ExtensionOperatorType> getOperator() {
    if (operator == null) {
      operator =
          new EObjectContainmentEList<ExtensionOperatorType>(
              ExtensionOperatorType.class, this, Fes20Package.ADDITIONAL_OPERATORS_TYPE__OPERATOR);
    }
    return operator;
  }
