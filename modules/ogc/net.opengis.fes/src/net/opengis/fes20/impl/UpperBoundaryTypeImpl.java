 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.UpperBoundaryTypeImpl#getExpressionGroup <em>Expression
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UpperBoundaryTypeImpl#getExpression <em>Expression</em>}
 * </ul>
 *
 * @generated
 */
public class UpperBoundaryTypeImpl extends EObjectImpl implements UpperBoundaryType {
  ...
  public FeatureMap getExpressionGroup() {
    if (expressionGroup == null) {
      expressionGroup =
          new BasicFeatureMap(this, Fes20Package.UPPER_BOUNDARY_TYPE__EXPRESSION_GROUP);
    }
  ...
  public EObject getExpression() {
    return (EObject)
        getExpressionGroup().get(Fes20Package.Literals.UPPER_BOUNDARY_TYPE__EXPRESSION, true);
  }
  ...
  public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
    return ((FeatureMap.Internal) getExpressionGroup())
        .basicAdd(Fes20Package.Literals.UPPER_BOUNDARY_TYPE__EXPRESSION, newExpression, msgs);
  }
