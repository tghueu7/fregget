 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getComparisonOpsGroup <em>Comparison Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getComparisonOps <em>Comparison
 *       Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getSpatialOpsGroup <em>Spatial Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getSpatialOps <em>Spatial Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getTemporalOpsGroup <em>Temporal Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getTemporalOps <em>Temporal Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getLogicOpsGroup <em>Logic Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getLogicOps <em>Logic Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getExtensionOpsGroup <em>Extension Ops
 *       Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getExtensionOps <em>Extension Ops</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getFunction <em>Function</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getIdGroup <em>Id Group</em>}
 *   <li>{@link net.opengis.fes20.impl.UnaryLogicOpTypeImpl#getId <em>Id</em>}
 * </ul>
 *
 * @generated
 */
public class UnaryLogicOpTypeImpl extends LogicOpsTypeImpl implements UnaryLogicOpType {
  /**
   * The cached value of the '{@link #getComparisonOpsGroup() <em>Comparison Ops Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getSpatialOpsGroup() <em>Spatial Ops Group</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalOpsGroup() <em>Temporal Ops Group</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getExtensionOpsGroup() <em>Extension Ops Group</em>}'
   * attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public FeatureMap getComparisonOpsGroup() {
    if (comparisonOpsGroup == null) {
      comparisonOpsGroup =
          new BasicFeatureMap(this, Fes20Package.UNARY_LOGIC_OP_TYPE__COMPARISON_OPS_GROUP);
    }
  ...
  public ComparisonOpsType getComparisonOps() {
    return (ComparisonOpsType)
        getComparisonOpsGroup()
            .get(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__COMPARISON_OPS, true);
  }
  ...
  public NotificationChain basicSetComparisonOps(
    ...
    return ((FeatureMap.Internal) getComparisonOpsGroup())
        .basicAdd(
            Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__COMPARISON_OPS, newComparisonOps, msgs);
  }
  ...
  public FeatureMap getSpatialOpsGroup() {
    if (spatialOpsGroup == null) {
      spatialOpsGroup =
          new BasicFeatureMap(this, Fes20Package.UNARY_LOGIC_OP_TYPE__SPATIAL_OPS_GROUP);
    }
  ...
  public SpatialOpsType getSpatialOps() {
    return (SpatialOpsType)
        getSpatialOpsGroup().get(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__SPATIAL_OPS, true);
  }
  ...
  public NotificationChain basicSetSpatialOps(
    ...
    return ((FeatureMap.Internal) getSpatialOpsGroup())
        .basicAdd(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__SPATIAL_OPS, newSpatialOps, msgs);
  }
  ...
  public FeatureMap getTemporalOpsGroup() {
    if (temporalOpsGroup == null) {
      temporalOpsGroup =
          new BasicFeatureMap(this, Fes20Package.UNARY_LOGIC_OP_TYPE__TEMPORAL_OPS_GROUP);
    }
  ...
  public TemporalOpsType getTemporalOps() {
    return (TemporalOpsType)
        getTemporalOpsGroup().get(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__TEMPORAL_OPS, true);
  }
  ...
  public NotificationChain basicSetTemporalOps(
    ...
    return ((FeatureMap.Internal) getTemporalOpsGroup())
        .basicAdd(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__TEMPORAL_OPS, newTemporalOps, msgs);
  }
  ...
  public LogicOpsType getLogicOps() {
    return (LogicOpsType)
        getLogicOpsGroup().get(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__LOGIC_OPS, true);
  }
  ...
  public NotificationChain basicSetLogicOps(LogicOpsType newLogicOps, NotificationChain msgs) {
    return ((FeatureMap.Internal) getLogicOpsGroup())
        .basicAdd(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__LOGIC_OPS, newLogicOps, msgs);
  }
  ...
  public FeatureMap getExtensionOpsGroup() {
    if (extensionOpsGroup == null) {
      extensionOpsGroup =
          new BasicFeatureMap(this, Fes20Package.UNARY_LOGIC_OP_TYPE__EXTENSION_OPS_GROUP);
    }
  ...
  public ExtensionOpsType getExtensionOps() {
    return (ExtensionOpsType)
        getExtensionOpsGroup().get(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__EXTENSION_OPS, true);
  }
  ...
  public NotificationChain basicSetExtensionOps(
    ...
    return ((FeatureMap.Internal) getExtensionOpsGroup())
        .basicAdd(Fes20Package.Literals.UNARY_LOGIC_OP_TYPE__EXTENSION_OPS, newExtensionOps, msgs);
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.UNARY_LOGIC_OP_TYPE__FUNCTION,
              oldFunction,
              newFunction);
  ...
  public void setFunction(FunctionType newFunction) {
    if (newFunction != function) {
      ...
      if (function != null)
        msgs =
            ((InternalEObject) function)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.UNARY_LOGIC_OP_TYPE__FUNCTION,
                    null,
                    msgs);
      if (newFunction != null)
        msgs =
            ((InternalEObject) newFunction)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - Fes20Package.UNARY_LOGIC_OP_TYPE__FUNCTION,
                    null,
