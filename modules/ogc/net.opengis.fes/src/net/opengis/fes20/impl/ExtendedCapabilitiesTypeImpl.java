 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ExtendedCapabilitiesTypeImpl#getAdditionalOperators
 *       <em>Additional Operators</em>}
 * </ul>
 *
 * @generated
 */
public class ExtendedCapabilitiesTypeImpl extends EObjectImpl implements ExtendedCapabilitiesType {
  /**
   * The cached value of the '{@link #getAdditionalOperators() <em>Additional Operators</em>}'
   ...
   * @generated
   */
  public NotificationChain basicSetAdditionalOperators(
      AdditionalOperatorsType newAdditionalOperators, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.EXTENDED_CAPABILITIES_TYPE__ADDITIONAL_OPERATORS,
              oldAdditionalOperators,
  ...
  public void setAdditionalOperators(AdditionalOperatorsType newAdditionalOperators) {
    if (newAdditionalOperators != additionalOperators) {
      ...
      if (additionalOperators != null)
        msgs =
            ((InternalEObject) additionalOperators)
                .eInverseRemove(
                    this,
      ...
      if (newAdditionalOperators != null)
        msgs =
            ((InternalEObject) newAdditionalOperators)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.EXTENDED_CAPABILITIES_TYPE__ADDITIONAL_OPERATORS,
