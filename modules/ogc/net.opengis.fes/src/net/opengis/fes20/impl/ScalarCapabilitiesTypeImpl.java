 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.ScalarCapabilitiesTypeImpl#getLogicalOperators <em>Logical
 *       Operators</em>}
 *   <li>{@link net.opengis.fes20.impl.ScalarCapabilitiesTypeImpl#getComparisonOperators
...
public class ScalarCapabilitiesTypeImpl extends EObjectImpl implements ScalarCapabilitiesType {
  /**
   * The cached value of the '{@link #getLogicalOperators() <em>Logical Operators</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getComparisonOperators() <em>Comparison Operators</em>}'
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SCALAR_CAPABILITIES_TYPE__LOGICAL_OPERATORS,
              oldLogicalOperators,
              newLogicalOperators);
  ...
  public void setLogicalOperators(LogicalOperatorsType newLogicalOperators) {
    if (newLogicalOperators != logicalOperators) {
      ...
      if (logicalOperators != null)
        msgs =
            ((InternalEObject) logicalOperators)
                .eInverseRemove(
                    this,
      ...
      if (newLogicalOperators != null)
        msgs =
            ((InternalEObject) newLogicalOperators)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SCALAR_CAPABILITIES_TYPE__LOGICAL_OPERATORS,
   ...
   * @generated
   */
  public NotificationChain basicSetComparisonOperators(
      ComparisonOperatorsType newComparisonOperators, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              Fes20Package.SCALAR_CAPABILITIES_TYPE__COMPARISON_OPERATORS,
              oldComparisonOperators,
              newComparisonOperators);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setComparisonOperators(ComparisonOperatorsType newComparisonOperators) {
    if (newComparisonOperators != comparisonOperators) {
      ...
      if (comparisonOperators != null)
        msgs =
            ((InternalEObject) comparisonOperators)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SCALAR_CAPABILITIES_TYPE__COMPARISON_OPERATORS,
      ...
      if (newComparisonOperators != null)
        msgs =
            ((InternalEObject) newComparisonOperators)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - Fes20Package.SCALAR_CAPABILITIES_TYPE__COMPARISON_OPERATORS,
