 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.AvailableFunctionsTypeImpl#getFunction <em>Function</em>}
 * </ul>
 *
 * @generated
 */
public class AvailableFunctionsTypeImpl extends EObjectImpl implements AvailableFunctionsType {
  ...
  public EList<AvailableFunctionType> getFunction() {
    if (function == null) {
      function =
          new EObjectContainmentEList<AvailableFunctionType>(
              AvailableFunctionType.class, this, Fes20Package.AVAILABLE_FUNCTIONS_TYPE__FUNCTION);
    }
    return function;
  }
