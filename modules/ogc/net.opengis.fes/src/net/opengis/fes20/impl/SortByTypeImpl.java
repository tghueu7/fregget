 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.SortByTypeImpl#getSortProperty <em>Sort Property</em>}
 * </ul>
 *
 * @generated
 */
public class SortByTypeImpl extends EObjectImpl implements SortByType {
  /**
   * The cached value of the '{@link #getSortProperty() <em>Sort Property</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<SortPropertyType> getSortProperty() {
    if (sortProperty == null) {
      sortProperty =
          new EObjectContainmentEList<SortPropertyType>(
              SortPropertyType.class, this, Fes20Package.SORT_BY_TYPE__SORT_PROPERTY);
    }
    return sortProperty;
  }
