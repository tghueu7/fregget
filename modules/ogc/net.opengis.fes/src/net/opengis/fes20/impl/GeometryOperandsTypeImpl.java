 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.GeometryOperandsTypeImpl#getGeometryOperand <em>Geometry
 *       Operand</em>}
 * </ul>
 *
 * @generated
...
public class GeometryOperandsTypeImpl extends EObjectImpl implements GeometryOperandsType {
  /**
   * The cached value of the '{@link #getGeometryOperand() <em>Geometry Operand</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<GeometryOperandType> getGeometryOperand() {
    if (geometryOperand == null) {
      geometryOperand =
          new EObjectContainmentEList<GeometryOperandType>(
              GeometryOperandType.class,
              this,
              Fes20Package.GEOMETRY_OPERANDS_TYPE__GEOMETRY_OPERAND);
    }
