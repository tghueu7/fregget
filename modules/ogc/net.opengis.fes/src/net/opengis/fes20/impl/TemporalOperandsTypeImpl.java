 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.impl.TemporalOperandsTypeImpl#getTemporalOperand <em>Temporal
 *       Operand</em>}
 * </ul>
 *
 * @generated
...
public class TemporalOperandsTypeImpl extends EObjectImpl implements TemporalOperandsType {
  /**
   * The cached value of the '{@link #getTemporalOperand() <em>Temporal Operand</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<TemporalOperandType> getTemporalOperand() {
    if (temporalOperand == null) {
      temporalOperand =
          new EObjectContainmentEList<TemporalOperandType>(
              TemporalOperandType.class,
              this,
              Fes20Package.TEMPORAL_OPERANDS_TYPE__TEMPORAL_OPERAND);
    }
