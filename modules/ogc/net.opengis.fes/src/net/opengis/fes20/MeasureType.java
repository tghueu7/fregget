 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.MeasureType#getValue <em>Value</em>}
 *   <li>{@link net.opengis.fes20.MeasureType#getUom <em>Uom</em>}
 * </ul>
 *
...
public interface MeasureType extends EObject {
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.MeasureType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Unsets the value of the '{@link net.opengis.fes20.MeasureType#getValue <em>Value</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns whether the value of the '{@link net.opengis.fes20.MeasureType#getValue
