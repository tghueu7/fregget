 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.TemporalOperatorsType#getTemporalOperator <em>Temporal
 *       Operator</em>}
 * </ul>
 *
...
public interface TemporalOperatorsType extends EObject, TemporalOperators {
  /**
   * Returns the value of the '<em><b>Temporal Operator</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.TemporalOperatorType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Temporal Operator</em>' containment reference list isn't clear,
   ...
   *     name='TemporalOperator' namespace='##targetNamespace'"
   * @generated
   */
