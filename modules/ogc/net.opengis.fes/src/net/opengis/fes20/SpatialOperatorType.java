 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.SpatialOperatorType#getGeometryOperands <em>Geometry
 *       Operands</em>}
 *   <li>{@link net.opengis.fes20.SpatialOperatorType#getName <em>Name</em>}
 * </ul>
 *
...
public interface SpatialOperatorType extends EObject, SpatialOperator {
   ...
   * @model containment="true" extendedMetaData="kind='element' name='GeometryOperands'
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.SpatialOperatorType#getGeometryOperands
   ...
   * @model dataType="net.opengis.fes20.SpatialOperatorNameType" extendedMetaData="kind='attribute'
   *     name='name'"
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.SpatialOperatorType#getName <em>Name</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
