 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Comparison Operator Name Type
 * Member0</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 *
...
public enum ComparisonOperatorNameTypeMember0 implements Enumerator {
  ...
  PROPERTY_IS_LESS_THAN_OR_EQUAL_TO(
      4, "PropertyIsLessThanOrEqualTo", "PropertyIsLessThanOrEqualTo"),
  ...
  PROPERTY_IS_GREATER_THAN_OR_EQUAL_TO(
      5, "PropertyIsGreaterThanOrEqualTo", "PropertyIsGreaterThanOrEqualTo"),
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Equal To</b></em>' literal object isn't clear, there
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Not Equal To</b></em>' literal object isn't clear,
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Less Than</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Greater Than</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Less Than Or Equal To</b></em>' literal object isn't
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Greater Than Or Equal To</b></em>' literal object
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Like</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Null</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Nil</b></em>' literal object isn't clear, there really
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Property Is Between</b></em>' literal object isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * A public read-only list of all the '<em><b>Comparison Operator Name Type Member0</b></em>'
   * enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the '<em><b>Comparison Operator Name Type Member0</b></em>' literal with the specified
   * literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public static ComparisonOperatorNameTypeMember0 get(int value) {
    switch (value) {
      case PROPERTY_IS_EQUAL_TO_VALUE:
        return PROPERTY_IS_EQUAL_TO;
      case PROPERTY_IS_NOT_EQUAL_TO_VALUE:
        return PROPERTY_IS_NOT_EQUAL_TO;
      case PROPERTY_IS_LESS_THAN_VALUE:
        return PROPERTY_IS_LESS_THAN;
      case PROPERTY_IS_GREATER_THAN_VALUE:
        return PROPERTY_IS_GREATER_THAN;
      case PROPERTY_IS_LESS_THAN_OR_EQUAL_TO_VALUE:
        return PROPERTY_IS_LESS_THAN_OR_EQUAL_TO;
      case PROPERTY_IS_GREATER_THAN_OR_EQUAL_TO_VALUE:
        return PROPERTY_IS_GREATER_THAN_OR_EQUAL_TO;
      case PROPERTY_IS_LIKE_VALUE:
        return PROPERTY_IS_LIKE;
      case PROPERTY_IS_NULL_VALUE:
        return PROPERTY_IS_NULL;
      case PROPERTY_IS_NIL_VALUE:
        return PROPERTY_IS_NIL;
      case PROPERTY_IS_BETWEEN_VALUE:
