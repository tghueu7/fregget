 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.AdditionalOperatorsType#getOperator <em>Operator</em>}
 * </ul>
 *
...
public interface AdditionalOperatorsType extends EObject {
  /**
   * Returns the value of the '<em><b>Operator</b></em>' containment reference list. The list
   * contents are of type {@link net.opengis.fes20.ExtensionOperatorType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Operator</em>' containment reference list isn't clear, there
   ...
   * @model containment="true" extendedMetaData="kind='element' name='Operator'
