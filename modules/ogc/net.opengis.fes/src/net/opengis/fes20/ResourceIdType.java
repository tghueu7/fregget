 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.ResourceIdType#getEndDate <em>End Date</em>}
 *   <li>{@link net.opengis.fes20.ResourceIdType#getPreviousRid <em>Previous Rid</em>}
 *   <li>{@link net.opengis.fes20.ResourceIdType#getRid <em>Rid</em>}
 *   <li>{@link net.opengis.fes20.ResourceIdType#getStartDate <em>Start Date</em>}
 *   <li>{@link net.opengis.fes20.ResourceIdType#getVersion <em>Version</em>}
 * </ul>
 *
...
public interface ResourceIdType extends AbstractIdType {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>End Date</em>' attribute isn't clear, there really should be more
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.DateTime" extendedMetaData="kind='attribute'
   *     name='endDate'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ResourceIdType#getEndDate <em>End Date</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Previous Rid</em>' attribute isn't clear, there really should be
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ResourceIdType#getPreviousRid <em>Previous
   * Rid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Rid</em>' attribute isn't clear, there really should be more of a
   * description here...
   * <!-- end-user-doc -->
   *
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Start Date</em>' attribute isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ResourceIdType#getStartDate <em>Start
   * Date</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @model dataType="net.opengis.fes20.VersionType" extendedMetaData="kind='attribute'
   *     name='version'"
   * @generated
   */
  Object getVersion();
  ...
  /**
   * Sets the value of the '{@link net.opengis.fes20.ResourceIdType#getVersion <em>Version</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
