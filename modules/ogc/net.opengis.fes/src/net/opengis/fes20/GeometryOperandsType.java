 ...
 *
 * <ul>
 *   <li>{@link net.opengis.fes20.GeometryOperandsType#getGeometryOperand <em>Geometry Operand</em>}
 * </ul>
 *
...
public interface GeometryOperandsType extends EObject {
  /**
   * Returns the value of the '<em><b>Geometry Operand</b></em>' containment reference list. The
   * list contents are of type {@link net.opengis.fes20.GeometryOperandType}.
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Geometry Operand</em>' containment reference list isn't clear,
   ...
   *     name='GeometryOperand' namespace='##targetNamespace'"
   * @generated
   */
