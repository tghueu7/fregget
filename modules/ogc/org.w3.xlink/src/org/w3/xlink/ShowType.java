 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Show Type</b></em>', and utility
...
public final class ShowType extends AbstractEnumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>New</b></em>' literal object isn't clear, there really should be
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Replace</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Embed</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #EMBED_LITERAL
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>Other</b></em>' literal object isn't clear, there really should be
   * more of a description here...
   * <!-- end-user-doc -->
   *
   * @see #OTHER_LITERAL
  ...
  private static final ShowType[] VALUES_ARRAY =
      new ShowType[] {
        NEW_LITERAL, REPLACE_LITERAL, EMBED_LITERAL, OTHER_LITERAL, NONE_LITERAL,
      };
