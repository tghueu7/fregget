 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Actuate Type</b></em>', and utility
...
public final class ActuateType extends AbstractEnumerator {
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>On Load</b></em>' literal object isn't clear, there really should
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of '<em><b>On Request</b></em>' literal object isn't clear, there really
  ...
  public static final ActuateType ON_REQUEST_LITERAL =
      new ActuateType(ON_REQUEST, "onRequest", "onRequest");
  ...
  private static final ActuateType[] VALUES_ARRAY =
      new ActuateType[] {
        ON_LOAD_LITERAL, ON_REQUEST_LITERAL, OTHER_LITERAL, NONE_LITERAL,
      };
