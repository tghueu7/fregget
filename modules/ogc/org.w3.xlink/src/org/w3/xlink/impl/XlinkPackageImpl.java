...
public class XlinkPackageImpl extends EPackageImpl implements XlinkPackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link XlinkPackage#eINSTANCE} when that field is
  ...
  public static XlinkPackage init() {
    ...
    XlinkPackageImpl theXlinkPackage =
        (XlinkPackageImpl)
            (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof XlinkPackageImpl
                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new XlinkPackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        fromTypeEDataType, String.class, "FromType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
    ...
    initEDataType(
        ...
        !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
        toTypeEDataType, String.class, "ToType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
    initEDataType(
  ...
  protected void createExtendedMetaDataAnnotations() {
    ...
    addAnnotation(actuateTypeEEnum, source, new String[] {"name", "actuateType"});
    addAnnotation(showTypeEEnum, source, new String[] {"name", "showType"});
    addAnnotation(typeTypeEEnum, source, new String[] {"name", "typeType"});
    addAnnotation(
        actuateTypeObjectEDataType,
        source,
        new String[] {
