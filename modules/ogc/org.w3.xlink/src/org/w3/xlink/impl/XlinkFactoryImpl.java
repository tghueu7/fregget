...
public class XlinkFactoryImpl extends EFactoryImpl implements XlinkFactory {
  ...
  public static XlinkFactory init() {
    try {
      XlinkFactory theXlinkFactory =
          (XlinkFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.w3.org/1999/xlink");
  ...
  public String createFromTypeFromString(EDataType eDataType, String initialValue) {
    return (String)
        XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.NC_NAME, initialValue);
  }
