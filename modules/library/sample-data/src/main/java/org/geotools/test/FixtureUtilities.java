...
public class FixtureUtilities {
  ...
  /**
   * Return the directory containing GeoTools test fixture configuration files. This is ".geotools"
   ...
   *
   * <p>If a fixture configuration file is not found, a notice is printed to standard output stating
   ...
   * services such as fixture caching and connection testing provided by {@link OnlineTestCase} and
