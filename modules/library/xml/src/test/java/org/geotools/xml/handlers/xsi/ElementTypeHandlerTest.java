...
public class ElementTypeHandlerTest {
    ...
    /**
     * Test that the presence of both {@code ref} and {@code name} attributes results in a 
     * {@link SAXException} with the expected message.
     */
    @Test
    ...
    /**
     * Test that the presence of both {@code ref} and {@code type} attributes results in a 
     * {@link SAXException} with the expected message.
     */
    @Test
