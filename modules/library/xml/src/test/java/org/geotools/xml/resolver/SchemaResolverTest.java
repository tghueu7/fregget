...
public class SchemaResolverTest {
  ...
  public void exampleHttp() {
    String path =
        SchemaResolver.getSimpleHttpResourcePath("http://schemas.example.org/exampleml/exml.xsd");
  ...
  public void exampleHttps() {
    String path =
        SchemaResolver.getSimpleHttpResourcePath("https://schemas.example.org/exampleml/exml.xsd");
    Assert.assertEquals("/org/example/schemas/exampleml/exml.xsd", path);
  }
  ...
  public void ftpReturnsNull() {
    Assert.assertNull(
        SchemaResolver.getSimpleHttpResourcePath("ftp://schemas.example.org/exampleml/exml.xsd"));
  }
