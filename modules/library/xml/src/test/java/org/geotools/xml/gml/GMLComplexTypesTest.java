...
public class GMLComplexTypesTest {
    ...
    public void testEncodeFeatureWithNullAttributes() throws Exception {
        ...
        MultiPolygon multiPolygon = geomBuilder.multiPolygon(geomBuilder.polygon(0, 0, 0, 1, 1, 
                1, 0, 0));
        ...
        when(element_mpolygon.getType()).thenReturn(GMLComplexTypes.MultiPolygonPropertyType
                .getInstance());
