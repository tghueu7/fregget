...
public interface Element extends ElementGrouping {
  ...
  /**
   * Returns the element declaration's name in the Schema document, and element name in the instance
   * document.
   */
  ...
  /**
   * This returns a reference to an element representing this element's substitution group. This is
   * of particular importance when resolving an instance document's value.
   */
