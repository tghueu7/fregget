...
public class XMLHandlerHints implements Map<String, Object> {
     ...
     */
    public static final String FILTER_COMPLIANCE_STRICTNESS = "org.geotools.xml.filter" +
     ...
     *  </code></pre>
     * <p>
     * <p><b>IMPORTANT:</b> If this compliance level is used and a non-strict FilterFactory is 
     * used to create
     * the filter then the original filter must be ran on the retrieved feature because this hint
     * will sometimes
