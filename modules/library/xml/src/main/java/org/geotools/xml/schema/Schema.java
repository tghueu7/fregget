...
public interface Schema extends Factory {
  ...
  /**
   * This method is intended to provide a list of public AttributeGroups defined by this Schema. The
   * definition of 'public AttributeGroups' should be interpreted as the set of AttributeGroups
   ...
   * definition of 'public Attributes' should be interpreted as the set of Attributes available when
   ...
   * the mask are represented as constants at the head of this file. As defined in the XML Schema
   * specification, element and type blocks should only be extended to include this block if one is
   * not specified.
   *
   * @return Block Mask
   */
   ...
   * definition of 'public ComplexTypes' should be interpreted as the set of ComplexTypes available
   ...
   * the mask are represented as constants at the head of this file. As defined in the XML Schema
   * specification, element and type final values should only be extended to include this final
  ...
  /**
   * This returns the intended use name of the Schema (kinda like an ID, for a better definition see
