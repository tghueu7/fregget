...
public class GTXML {
   ...
   * org.geotools.wfs.v1_1.WFSConfiguration; you need to indicate which name you want parsed out as
   * a FetureType.
   *
  ...
  public static FeatureType parseFeatureType(
      Configuration configuration, QName name, CoordinateReferenceSystem crs) throws IOException {
