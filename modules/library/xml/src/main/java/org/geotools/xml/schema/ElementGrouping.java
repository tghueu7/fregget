...
public interface ElementGrouping {
  /**
   * ElementGrouping mask to determine the type of ElementGrouping represented. This is intended to
   * reduce the use of the instanceof operand, increasing performance.
   */
