...
/**
 * <p>
 * Feature Buffer ... acts as a  FeatureReader<SimpleFeatureType, SimpleFeature> by making itself
 * as a seperate
...
public class FCBuffer extends Thread implements FeatureReader<SimpleFeatureType, SimpleFeature> {
    ...
    public static FeatureReader<SimpleFeatureType, SimpleFeature> getFeatureReader(URI document, 
                                                                                   int capacity,
                                                                                   int timeout, 
                                                                                   SimpleFeatureType ft) throws SAXException {
        ...
        if (fc.getFeatureType() != null && fc.getFeatureType().getGeometryDescriptor() != null &&
