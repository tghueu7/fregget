...
public interface Choice extends ElementGrouping {
  ...
  /**
   * This method returns a list of children which repreensts the options for the element which this
   * choice is representing in an XML Schema. Although the list is semantically a set, we encourage
   * you to add elements to the list as they apear, to allow Schema writers to optimize the search
   * order.
   */
