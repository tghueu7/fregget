...
public class FilterComplexTypes {
    public final static String CACHE_SERVICE_EXCEPTIONS = "FilterComplexTypes" +
            ".CACHE_SERVICE_EXCEPTIONS";
...
//            }
    ...
    public static class FunctionType extends FilterComplexType {
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if (hints != null && hints.containsKey(FilterSchema.FILTER_CAP_KEY)) {
                ...
                if ((fc.getScalarOps() & FilterCapabilities.FUNCTIONS) != FilterCapabilities
                        .FUNCTIONS) {
                    return false;
                }
            }
            ...
            switch (Filters.getExpressionType(me)) {
                case org.geotools.filter.ExpressionType.LITERAL_GEOMETRY:
                    ...
                    if (me.getValue() instanceof Geometry) {
                        GMLSchema.getInstance().getElements()[29].getType().encode(GMLSchema
                                        .getInstance()
                                        .getElements()[29],
    ...
    public static class PropertyNameType extends FilterComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value,
            ...
            try {
                ...
                throw new SAXException("Illegal xpath for property name " + element, 
                        expressionRequired);
            }
    ...
    public static class SortByType extends FilterComplexType {
        ...
        private static Sequence seq = new SequenceGT(elems);
        private static Attribute[] attrs = new Attribute[]{
                new FilterAttribute("sortOrder", SortOrderType.getInstance(), Attribute.OPTIONAL,
                        "DESC", null, false)
        };
         ...
         */
        public boolean canEncode(Element element, Object value, Map hints) {
            return element != null && element.getType().equals(this) && value != null && value 
                    instanceof PropertyName[];
        }
        ...
        public void encode(Element element, Object value, PrintHandler output,
            ...
            if (hints != null && hints.containsKey(SortOrderType.SORT_ORDER_KEY)) {
                if (hints.get(SortOrderType.SORT_ORDER_KEY) == SortOrderType.SORT_ORDER_ASC) {
                    ...
                    ai.addAttribute(FilterSchema.NAMESPACE.toString(), "sortOrder", null, 
                            "string", "ASC");
                }
            }
            output.startElement(element.getNamespace(), element.getName(), ai);
    ...
    public static class SortOrderType implements SimpleType {
         ...
         * java.lang.Object, java.util.Map)
         */
        public AttributeValue toAttribute(Attribute attribute, Object value, Map hints) throws 
         ...
         * .Attribute, java.lang.Object, java.util.Map)
         */
         ...
         */
        public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map 
                hints) throws OperationNotSupportedException {
            throw new OperationNotSupportedException();
        }
