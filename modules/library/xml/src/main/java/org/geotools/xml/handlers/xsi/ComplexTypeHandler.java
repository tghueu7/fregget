...
public class ComplexTypeHandler extends XSIElementHandler {
            ...
            if (child instanceof SimpleContentHandler) {
                ...
                if (cch.getChild() instanceof ExtensionHandler) {
                    ...
                    if (ct != null && ext.getChild() != null) {
                        ...
                        ElementGrouping extensionChild = ((ElementGroupingHandler) ext.getChild()
                        ).compress(parent);
                        dct.child = loadNewEG(extensionBaseType, extensionChild, parent); // note
                        // should override element def only ... not spot
                    } else {
                        if (ct != null)
     ...
     */
    private ElementGrouping loadNewEG(ElementGrouping extensionBaseType, ElementGrouping 
            extensionChild,
    ...
    private static class DefaultComplexType implements ComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value,
                               final Attributes attrs, Map hints) throws 
