...
class EmfAppSchemaParser {
   ...
   * distinct from {@code gml:location}, or {@code gml:location} if no additional geometric property
   * is found. Note: this code is borrowed and adapted from {@link ParserHandler#startDocument()}
   *
   ...
   *     type.
   * @param crs the CRS to be assigned to the geometric attributes in the parsed feature type. This
   *     information shall be provided here as the schema itself has no knowledge of the CRS used.
   * @return
   * @throws IOException
   */
  ...
  public static SimpleFeatureType parse(
      URL schemaLocation, QName featureName, CoordinateReferenceSystem crs) throws IOException {
