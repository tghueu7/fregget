 ...
 * supported by porting the <a href="http://svn.geotools
 * .org/geotools/branches/2.4.x/modules/unsupported/community-schemas/community-schema-ds/src
 * /main/java/org/geotools/data/complex/config/EmfAppSchemaReader.java"
...
class EmfAppSchemaParser {
     ...
     * @return
     */
    public static SimpleFeatureType parse(Configuration configuration, XSDElementDeclaration 
            elementDecl,
                                          CoordinateReferenceSystem crs) throws IOException {
