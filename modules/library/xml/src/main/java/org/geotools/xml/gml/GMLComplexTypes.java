...
public class GMLComplexTypes {
    ...
    if (g.getUserData() != null) {
      ...
      if (g.getUserData() instanceof String) {
        ...
        try {
          ...
          logger.log(
              Level.WARNING, "Could not encode the srsName for geometry, no EPSG code found", ex);
        }
      }
    } else {
      //            if (g.getSRID() != 0) {
    ...
    if (g.getNumInteriorRing() > 0) {
      for (int i = 0; i < g.getNumInteriorRing(); i++)
        ((GMLSchema.getInstance()).getElements()[36])
            .getType()
            .encode(
                (GMLSchema.getInstance()).getElements()[36], g.getInteriorRingN(i), output, null);
    }
  ...
  /**
   * Many complexTypes have Choices as part of their definition. Instances of this class are used to
  ...
  /**
   * Many complexTypes have Sequences as part of their definition. Instances of this class are used
   * to represent these sequences.
   *
   * @author dzwiers
   */
  ...
  /**
   * This class represents an GeometryAssociationType within the GML Schema. This includes both the
   * data and parsing functionality associated with an GeometryAssociationType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class GeometryAssociationType extends GMLComplexType {
    ...
    private static final Element[] elems = {
      new GMLElement(
          "_Geometry", GMLComplexTypes.AbstractGeometryType.getInstance(), 0, 1, true, null),
    };
    ...
    public boolean canEncode(Element element, Object value, Map hints) {
      ComplexType t =
          (element.getType() instanceof ComplexType) ? (ComplexType) element.getType() : null;
  ...
  /**
   * This class represents an PointMemberType within the GML Schema. This includes both the data and
   * parsing functionality associated with an PointMemberType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class PointMemberType extends GMLComplexType {
    ...
    private static final Element[] elements = {
      new GMLElement(
          ...
          false,
          new GMLElement(
              "_Geometry", GMLComplexTypes.AbstractGeometryType.getInstance(), 1, 1, true, null)),
    };
  ...
  /**
   * This class represents an LineStringType within the GML Schema. This includes both the data and
   * parsing functionality associated with an LineStringType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an LinearRingType within the GML Schema. This includes both the data and
   * parsing functionality associated with an LinearRingType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an BoxType within the GML Schema. This includes both the data and parsing
   * functionality associated with an BoxType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class PolygonType extends GMLComplexType {
    ...
    private static final Element[] elements = {
      new GMLElement(
          "outerBoundaryIs", GMLComplexTypes.LinearRingMemberType.getInstance(), 1, 1, false, null),
      new GMLElement(
          "innerBoundaryIs",
  ...
  /**
   * This class represents an MultiPointType within the GML Schema. This includes both the data and
   * parsing functionality associated with an MultiPointType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an MultiLineStringType within the GML Schema. This includes both the data
   * and parsing functionality associated with an MultiLineStringType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an CoordinatesType within the GML Schema. This includes both the data and
   * parsing functionality associated with an CoordinatesType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an AbstractFeatureType within the GML Schema. This includes both the data
   * and parsing functionality associated with an AbstractFeatureType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class AbstractFeatureType extends GMLComplexType {
    ...
    private static final Element[] elements = {
      ...
      new GMLElement(
          "boundedBy", GMLComplexTypes.BoundingShapeType.getInstance(), 0, 1, false, null) {
        public boolean isNillable() {
          return true;
        }
      },
    ...
    public SimpleFeature getFeature(
        Element element, ElementValue[] value, Attributes attrs, Map hints, SimpleFeatureType ft)
        throws SAXException {
      if (ft == null)
        ft =
            (SimpleFeatureType)
     ...
     * HACK !!!
     *
     * <p>not found ... is it the same name as the FT (ie ... is this part of the consequences of
     * GT's featureType model)?
     */
    ...
    private int searchByName(ElementValue[] value, SimpleFeatureType ft, int i, int j) {
      for (int k = 0; k < ft.getAttributeCount() && j == -1; k++) {
        ...
        if ((ft.getDescriptor(k).getLocalName() == null && value[i].getElement().getName() == null)
            || ft.getDescriptor(k).getLocalName().equals(value[i].getElement().getName())) j = k;
      }
      return j;
    }
  ...
  public static class AbstractFeatureCollectionsBaseType extends AbstractFeatureType {
    ...
    private static final Element[] elements1 = {
      ...
      new GMLElement("name", XSISimpleTypes.String.getInstance(), 0, 1, false, null),
      new GMLElement(
          "boundedBy", GMLComplexTypes.BoundingShapeType.getInstance(), 1, 1, false, null),
    };
  ...
  public static class FeatureAssociationType extends GMLComplexType {
    ...
    private static final Element[] elements = {
      new GMLElement(
          "_Feature", GMLComplexTypes.AbstractFeatureType.getInstance(), 0, 1, true, null),
    };
    ...
    public SimpleFeature getValue(
        Element element, ElementValue[] value, Attributes attrs, Map hints) throws SAXException {
      if ((value == null) || (value.length != 1)) {
        throw new SAXException("must be one feature " + value.length);
      }

      logger.finest(
          (value[0].getValue() == null) ? "null" : value[0].getValue().getClass().getName());
    ...
    public void encode(Element element, Object value, PrintHandler output, Map hints)
      ...
      if (element == null) {
        ...
        AbstractFeatureType.getInstance()
            .encode(
                element.findChildElement(((SimpleFeature) value).getFeatureType().getTypeName()),
                value,
                output,
                hints);
        output.endElement(element.getNamespace(), element.getName());
  ...
  /**
   * This class represents an PolygonPropertyType within the GML Schema. This includes both the data
   * and parsing functionality associated with an PolygonPropertyType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  /**
   * This class represents an MultiLineStringPropertyType within the GML Schema. This includes both
   * the data and parsing functionality associated with an MultiLineStringPropertyType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class MultiLineStringPropertyType extends GMLComplexType {
    ...
    public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
      ...
      //            }
      //            throw new SAXException("Expected value was a MultiLineString, instead it was a:
      // "+value2.getClass());
    }
  ...
  /**
   * This class represents an MultiPolygonPropertyType within the GML Schema. This includes both the
   * data and parsing functionality associated with an MultiPolygonPropertyType.
   *
   * @author dzwiers
   * @see GMLComplexType
   * @see ComplexType
  ...
  public static class MultiPolygonPropertyType extends GMLComplexType {
    ...
    public Object getValue(Element element, ElementValue[] value, Attributes attrs, Map hints)
      ...
      //            }
      //            throw new SAXException("Expected value was a MultiPolygon, instead it was a:
      // "+value2.getClass());
      ...
      if (attrs[i] != null) {
        ...
        if ((geometryAttribute == null) && attrs[i] instanceof GeometryDescriptor) {
          if (!attrs[i]
              ...
              .equalsIgnoreCase(
                  AbstractFeatureType.getInstance().getChildElements()[2].getName())) {
  ...
  private static AttributeDescriptor getAttribute(String name, Choice eg) {
    ...
    // nillable should really be nillable, but in gt2.X nillable in an attribute is equivalent to
    // minOccurs == 0 as well
