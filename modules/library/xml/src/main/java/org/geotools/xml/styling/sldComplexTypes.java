...
public class sldComplexTypes {
  ...
  static class _GraphicStroke extends sldComplexType {
    ...
    private static final ElementGrouping child =
        new SequenceGT(
            null, new ElementGrouping[] {new sldElement("Graphic", null, null, 1, 1)}, 1, 1);
    ...
    private static final Element[] elems =
        new Element[] {
          ...
          new sldElement(
              ...
              1),
          new sldElement(
              "Extent", sldComplexTypes._Extent.getInstance(), null, 0, Element.UNBOUNDED)
        };
  ...
  static class _FeatureTypeStyle extends sldComplexType {
    ...
    private static final Element[] elems =
        new Element[] {
          ...
          new sldElement(
              "Abstract", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance(), null, 0, 1),
          new sldElement(
              "FeatureTypeName",
              org.geotools.xml.xsi.XSISimpleTypes.String
                  .getInstance() /* simpleType name is string */,
