...
public class sldComplexTypes2 {
    ...
    static class _LayerFeatureConstraints extends sldComplexType {
         ...
         * .geotools.xml.schema.ElementValue[], org.xml.sax.Attributes, java.util.Map)
         */
    ...
    static class _LinePlacement extends sldComplexType {
         ...
         * .geotools.xml.schema.ElementValue[], org.xml.sax.Attributes, java.util.Map)
         */
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map 
                hints) {
    ...
    static class _LineSymbolizer extends sldComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map 
                hints) {
            LineSymbolizer symbol = StyleFactoryFinder.createStyleFactory()
    ...
    static class _NamedLayer extends sldComplexType {
        ...
        private static ElementGrouping child = new SequenceGT(
                ...
                new ElementGrouping[]{elems[0], elems[1],
                        new ChoiceGT(null, 0, Integer.MAX_VALUE, new ElementGrouping[]{elems[2], 
                                elems[3]})},
                1, 1);
    ...
    static class _NamedStyle extends sldComplexType {
        ...
        private static Element[] elems = new Element[]{new sldElement(
                "Name",
                org.geotools.xml.xsi.XSISimpleTypes.String.getInstance()/* simpleType name is 
                string */,
                null, 1, 1)};
        ...
        private static ElementGrouping child = new SequenceGT(null,
                new ElementGrouping[]{new sldElement("Name",
                        org.geotools.xml.xsi.XSISimpleTypes.String.getInstance(), null, 1, 1)}, 
                1, 1);
    ...
    static class _Parameter extends sldComplexType {
        ...
        private static Attribute[] attrs = new Attribute[]{
                new AttributeGT(null, "name",
                        sldSchema.NAMESPACE, org.geotools.xml.xsi.XSISimpleTypes.String
                        .getInstance(),
        ...
        private static final ElementGrouping child = new SequenceGT(null,
                new ElementGrouping[]{new sldElement("expression",
                        ...
                        null, 1, 1)}, 0, Element.UNBOUNDED);
        private static final Element[] elems = new Element[]{new sldElement("expression",
                org.geotools.xml.filter.FilterComplexTypes.ExpressionType.getInstance(), null, 1,
                1)};
    ...
    static class _PointSymbolizer extends sldComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map hints)
                throws OperationNotSupportedException {
            PointSymbolizer symbol = StyleFactoryFinder.createStyleFactory()
    ...
    static class _PolygonSymbolizer extends sldComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map hints)
                throws OperationNotSupportedException {
            PolygonSymbolizer symbol = StyleFactoryFinder.createStyleFactory()
    ...
    static class _RasterSymbolizer extends sldComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map hints)
                throws OperationNotSupportedException {
            RasterSymbolizer symbol = StyleFactoryFinder.createStyleFactory()
    ...
    static class _Rule extends sldComplexType {
        ...
        private static Element[] elems = new Element[]{
                ...
                new sldElement("Title", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance(),
                        null, 0, 1),
                new sldElement("Abstract", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance
                        (), null, 0, 1),
    ...
    static class _StyledLayerDescriptor extends sldComplexType {
        ...
        private static ElementGrouping child = new SequenceGT(
                new ElementGrouping[]{
                        ...
                        elems[1],
                        elems[2],
                        new ChoiceGT(null, 0, Integer.MAX_VALUE, new ElementGrouping[]{elems[3], 
                                elems[4]})
                });
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map hints)
                throws OperationNotSupportedException, SAXException {
            StyledLayerDescriptor sld = StyleFactoryFinder.createStyleFactory()
    ...
    static class SelectedChannelType extends sldComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value, Attributes attrs1, Map 
                hints) {
            org.geotools.styling.SelectedChannelType symbol = new org.geotools.styling
