...
public class FilterOpsComplexTypes {
    ...
    protected static void encodeFilter(org.opengis.filter.Filter filter, PrintHandler output, Map
     hints) throws OperationNotSupportedException, IOException {
        if (filter instanceof BinaryLogicOperator) {
            ...
            FilterType.elems[COMPARE_TYPE].getType().encode(FilterType.elems[COMPARE_TYPE], 
            filter, output,
                    hints);
            ...
            FilterType.elems[FID_TYPE].getType().encode(FilterType.elems[FID_TYPE], filter, 
            output, hints);
        } else if (filter instanceof BinarySpatialOperator) {
            FilterType.elems[SPATIAL_TYPE].getType().encode(FilterType.elems[SPATIAL_TYPE], 
            filter, output,
                    hints);
    ...
    public static class ComparisonOpsType extends FilterComplexType implements org.geotools
    .filter.FilterType {
    ...
    public static class LogicOpsType extends FilterComplexType
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if ((hints != null)
                ...
                if ((fc.getScalarOps() & FilterCapabilities.LOGICAL) != FilterCapabilities
                .LOGICAL) {
                    return false;
                }
            }
    ...
    public static class FilterType extends FilterComplexType
        ...
        public Object getValue(Element element, ElementValue[] value,
            ...
            try {
                ...
                List<org.opengis.filter.Filter> filters = new ArrayList<org.opengis.filter
                .Filter>();
                Set ids = new HashSet();
                boolean isOnlyFids = true;
                for (int i = 0; i < value.length; i++) {
                    org.opengis.filter.Filter value2 = (org.opengis.filter.Filter) value[i]
                    .getValue();
        ...
        public void encode(Element element, Object value, PrintHandler output,
            ...
            if (element != null) {
                output.startElement(element.getNamespace(), element.getName(),
                        null);
//            }else{
//                output.startElement(getNamespace(), FilterSchema.getInstance().getElements()[2]
// .getName(),
//                    null);
            }
...
//            }else{
//                output.endElement(getNamespace(), FilterSchema.getInstance().getElements()[2]
// .getName());
            }
        }
        ...
        private FilterEncodingPreProcessor getFilterEncodingPreProcessor(Map hints) {
            if (hints != null && hints.containsKey(XMLHandlerHints.FILTER_COMPLIANCE_STRICTNESS))
                return new FilterEncodingPreProcessor((Integer) hints.get(XMLHandlerHints
    ...
    public static class BinaryComparisonOpType extends FilterComplexType
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if ((hints != null)
                ...
                if ((fc.getScalarOps()
                        & (FilterCapabilities.SIMPLE_COMPARISONS
                        | FilterCapabilities.SIMPLE_ARITHMETIC)) != (FilterCapabilities
                        .SIMPLE_COMPARISONS
    ...
    public static class PropertyIsLikeType extends FilterComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value,
            ...
            try {
                ...
                return factory.like(expr, (String) pattern.getValue(), wildCard, singleChar, 
                escape);
            } catch (ClassCastException expressionRequired) {
                throw new SAXException("Illegal filter for " + element, expressionRequired);
            } catch (IllegalFilterException e) {
    ...
    public static class PropertyIsNullType extends FilterComplexType {
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if ((hints != null)
                ...
                if ((fc.getScalarOps() & FilterCapabilities.NULL_CHECK) != FilterCapabilities
                .NULL_CHECK) {
                    return false;
                }
            }
    ...
    public static class PropertyIsBetweenType extends FilterComplexType {
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if ((hints != null)
                ...
                if ((fc.getScalarOps() & FilterCapabilities.BETWEEN) != FilterCapabilities
                .BETWEEN) {
                    return false;
                }
            }
        ...
        public void encode(Element element, Object value, PrintHandler output,
            ...
            if ((type1 == org.geotools.filter.ExpressionType.LITERAL_STRING)
                ...
                if ((type2 == org.geotools.filter.ExpressionType.LITERAL_STRING)
                    ...
                    throw new OperationNotSupportedException(
                            "Either the left or right expr must be a literal for the property " +
                             "name l="
                                    + type1 + " r=" + type2);
                }
            }
    ...
    public static class BBOXType extends FilterComplexType {
        ...
        //		</xsd:complexContent>
        //		</xsd:complexType>
        private static final Element OGC_PROPERTY_NAME = new FilterElement("PropertyName", 
            ...
            try {
                ...
                if (geometry2 instanceof Literal) {
                    ...
                    if (literal instanceof Geometry) {
                        ...
                        return factory.bbox(geometry1, env.getMinX(), env.getMinY(), env.getMaxX
                        (), env.getMaxY(), null);
                    }
                }
         ...
         */
        public Class getInstanceType() {
            return Filter.class; // was GeometryFilter.class but use of Disjoint.not() limits 
            // this to Filte
        }
        ...
        public boolean canEncode(Element element, Object value, Map hints) {
            if ((hints != null)
                ...
                if ((fc.getSpatialOps() & FilterCapabilities.SPATIAL_BBOX) != FilterCapabilities
                .SPATIAL_BBOX) {
                    return false;
                }
            }
    ...
    public static class DistanceBufferType extends FilterComplexType {
        ...
        public void encode(Element element, Object value, PrintHandler output,
            ...
            if (Filters.getExpressionType(lf.getExpression1()) == org.geotools.filter
            .ExpressionType.ATTRIBUTE) {
                elems[0].getType().encode(elems[0], lf.getExpression1(),
                        output, hints); // prop name
                elems[1].getType().encode(elems[1], lf.getExpression2().evaluate(null, Geometry
                .class),
                        output, hints); // geom
                elems[2].getType().encode(elems[2], lf, output, hints); // distancetype
            } else {
                if (Filters.getExpressionType(lf.getExpression2()) == org.geotools.filter
                .ExpressionType.ATTRIBUTE) {
                    elems[0].getType().encode(elems[0], lf.getExpression2(),
                            output, hints); // prop name
                    elems[1].getType().encode(elems[1], lf.getExpression1().evaluate(null, 
                    Geometry.class),
                            output, hints); // geom
                    elems[2].getType().encode(elems[2], lf, output, hints); // distancetype
                } else {
    ...
    public static class DistanceType extends FilterComplexType {
        ...
        public void encode(Element element, Object value, PrintHandler output,
            ...
            if (Filters.getExpressionType(distanceFilter.getExpression1()) == ExpressionType
            .LITERAL_GEOMETRY) {
    ...
    public static class BinaryLogicOpType extends FilterComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value,
            ...
            try {
                ArrayList<org.opengis.filter.Filter> children = new ArrayList<org.opengis.filter
                .Filter>(value.length);
