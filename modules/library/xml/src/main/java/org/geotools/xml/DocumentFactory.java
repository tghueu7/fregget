...
public class DocumentFactory {
   ...
   * This key may also affect data validation within the parse routines. The inherent safety of the
   * resulting objects is weekend by turning this param to false.
   */
  ...
  /**
   * Parses the instance data provided. This method assumes that the XML document is fully described
   * using XML Schemas. Failure to be fully described as Schemas will result in errors, as opposed
   * to a vid parse.
   *
   * @param desiredDocument
   * @param hints May be null.
