 ...
 * <li>{@link XMLHandlerHints#SAX_PARSER_FACTORY} - supply factory used by 
 * {@link #getParser(Map)}</li>
 * </ul>
 *
...
public class DocumentFactory {
     ...
     */
    public static Object getInstance(URI desiredDocument, Map<String, Object> hints) throws 
            SAXException {
     ...
     */
    public static Object getInstance(URI desiredDocument, @SuppressWarnings("rawtypes") Map 
            hints, Level level)
            throws SAXException {
