...
public class GMLSchema implements Schema {
  ...
  private static final Element[] loadElements() {
    ...
    elements1[26] =
        new GMLElement(
            ...
            elements1[11]); // gml:MultiPolygonPropertyType
    elements1[28] =
        new GMLElement("name", XSISimpleTypes.String.getInstance(), 1, 1, false, null); // xs:string
    elements1[27] =
        new GMLElement(
            "description", XSISimpleTypes.String.getInstance(), 1, 1, false, null); // xs:string
    elements1[29] =
        new GMLElement(
            "_Geometry",
    ...
    elements1[BOX] =
        new GMLElement(
            "Box", GMLComplexTypes.BoxType.getInstance(), 1, 1, false, null); // gml:BoxType
    elements1[42] =
        new GMLElement(
            "MultiGeometry",
            GMLComplexTypes.GeometryCollectionType.getInstance(),
    ...
    elements1[46] =
        new GMLElement(
            "coord", GMLComplexTypes.CoordType.getInstance(), 1, 1, false, null); // gml:CoordType
    elements1[47] =
        new GMLElement(
            "coordinates",
  ...
  static class GMLElement implements Element {
    ...
    /**
     * Configures the Element for this particular GML instance. The following params match schema
     * definition attributes found in an element declaration. Those missing have been hard coded for
     * the gml Schema.
     *
     * @param name
     * @param type
     ...
     */
    public GMLElement(
        String name, Type type, int min, int max, boolean abstracT, Element substitutionGroup) {
