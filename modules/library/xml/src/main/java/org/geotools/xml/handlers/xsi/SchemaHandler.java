...
public class SchemaHandler extends XSIElementHandler {
     ...
     */
    public int hashCode() {
        return LOCALNAME.hashCode() * ((id == null) ? 1 : id.hashCode()) * ((version == null) ? 1
                : version.hashCode())
     ...
     */
    public void startElement(String namespaceURI1, String localName, Attributes atts) throws 
            SAXException {
        // targetNamespace
    ...
    protected Schema compress(URI thisURI) throws SAXException {
        ...
        if (this.imports != null) {
            ...
            while (it.hasNext()) {
                ...
                if (obj instanceof ImportHandler) {
                    ...
                    Schema cs = SchemaFactory.getInstance(imp.getNamespace(), incURI, logger
                            .getLevel());
        ...
        attributeGroups = attributes = complexTypes = simpleTypes = elements = groups = imports =
                includes = redefines = null;
    ...
    protected SimpleType lookUpSimpleType(String qname) {
        ...
        Iterator it;
        if ((this.prefix == null && prefix1 == null) || (this.prefix != null && this.prefix
                .equals(prefix1))) {
            if (schema != null)
    ...
    private static class SchemaComparator implements Comparator {
        ...
        private int compareAttribute(Attribute arg0, Attribute arg1) {
            ...
            if (arg1 == null)
                return -1;
            int i = arg0.getName() == null ? arg1.getName() == null ? 0 : 1 : arg0.getName()
                    .compareTo(arg1.getName());
            if (i != 0)
                return i;
            i = arg0.getNamespace() == null ? arg1.getNamespace() == null ? 0 : 1 : 
                    arg0.getNamespace().compareTo(
                    arg1.getNamespace());
            if (i != 0)
                return i;
        ...
        private int compareAttributeGroup(AttributeGroup arg0, AttributeGroup arg1) {
            ...
            if (i != 0)
                return i;
            i = arg0.getAnyAttributeNameSpace() == null ? arg1.getAnyAttributeNameSpace() == null
                    ? 0 : 1 : arg0
        ...
        private int compareImport(Schema arg0, Schema arg1) {
            ...
            if (arg1 == null)
                return -1;
            int i = arg0.getTargetNamespace() == null ? arg1.getTargetNamespace() == null ? 0 : 1
                    : arg0
                    .getTargetNamespace().compareTo(arg1.getTargetNamespace());
            if (i != 0)
                return i;
            i = arg0.getURI() == null ? arg1.getURI() == null ? 0 : 1 : arg0.getURI().compareTo
                    (arg1.getURI());
            if (i != 0)
                return i;
        ...
        private int compareFacet(Facet arg0, Facet arg1) {
            ...
            i = arg0.getValue() == null ? arg1.getValue() == null ? 0 : 1 : arg0.getValue()
