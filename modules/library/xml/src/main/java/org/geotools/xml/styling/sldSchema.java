      ...
      elements =
          new Element[] {
            ...
            new sldElement(
                ...
                new sldElement(
                    "Symbolizer", sldComplexTypes2.SymbolizerType.getInstance(), null, 1, 1),
                1,
                1),
            new sldElement(
                "ColorMapEntry", sldComplexTypes._ColorMapEntry.getInstance(), null, 1, 1),
            new sldElement(
                "GreenChannel", sldComplexTypes2.SelectedChannelType.getInstance(), null, 1, 1),
            new sldElement(
                "LATEST_ON_TOP", sldComplexTypes._LATEST_ON_TOP.getInstance(), null, 1, 1),
            new sldElement(
            ...
            new sldElement(
                ...
                1),
            new sldElement(
                "ChannelSelection", sldComplexTypes._ChannelSelection.getInstance(), null, 1, 1),
            ...
            new sldElement(
                ...
                1),
            new sldElement(
                "Name", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance() /*
                                                                                     * simpleType
                                                                                     * name is
                                                                                     * string
                                                                                     */, null, 1, 1),
            new sldElement(
                ...
                1),
            new sldElement(
                "BlueChannel", sldComplexTypes2.SelectedChannelType.getInstance(), null, 1, 1),
            ...
            new sldElement(
                "PointPlacement", sldComplexTypes2._PointPlacement.getInstance(), null, 1, 1),
            new sldElement(
                "Rotation", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            new sldElement(
                "OnlineResource", sldComplexTypes2._OnlineResource.getInstance(), null, 1, 1),
            ...
            new sldElement(
                ...
                1),
            new sldElement(
                "EARLIEST_ON_TOP", sldComplexTypes._EARLIEST_ON_TOP.getInstance(), null, 1, 1),
            ...
            new sldElement(
                "GraphicStroke", sldComplexTypes._GraphicStroke.getInstance(), null, 1, 1),
            new sldElement(
                "ContrastEnhancement",
                ...
                1),
            new sldElement(
                "FeatureTypeStyle", sldComplexTypes._FeatureTypeStyle.getInstance(), null, 1, 1),
            new sldElement(
                "Format",
                org.geotools.xml.xsi.XSISimpleTypes.String
                    .getInstance() /* simpleType name is string */,
                ...
                1),
            new sldElement(
                "DisplacementY", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            new sldElement(
                "DisplacementX", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            ...
            new sldElement(
                ...
                1),
            new sldElement(
                "LabelPlacement", sldComplexTypes._LabelPlacement.getInstance(), null, 1, 1),
            new sldElement(
            ...
            new sldElement(
                "ExternalGraphic", sldComplexTypes._ExternalGraphic.getInstance(), null, 1, 1),
            new sldElement("NamedStyle", sldComplexTypes2._NamedStyle.getInstance(), null, 1, 1),
            new sldElement(
                "AnchorPointY", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            ...
            new sldElement(
                "OverlapBehavior", sldComplexTypes2._OverlapBehavior.getInstance(), null, 1, 1),
            ...
            new sldElement(
                "ShadedRelief", sldComplexTypes2._ShadedRelief.getInstance(), null, 1, 1),
            new sldElement(
                "SourceChannelName",
                org.geotools.xml.xsi.XSISimpleTypes.String
                    .getInstance() /* simpleType name is string */,
            ...
            new sldElement(
                "GrayChannel", sldComplexTypes2.SelectedChannelType.getInstance(), null, 1, 1),
            new sldElement("Rule", sldComplexTypes2._Rule.getInstance(), null, 1, 1),
            new sldElement(
                "RedChannel", sldComplexTypes2.SelectedChannelType.getInstance(), null, 1, 1),
            new sldElement("GraphicFill", sldComplexTypes._GraphicFill.getInstance(), null, 1, 1),
            new sldElement(
                "LegendGraphic", sldComplexTypes2._LegendGraphic.getInstance(), null, 1, 1),
            ...
            new sldElement(
                ...
                1),
            new sldElement(
                "LinePlacement", sldComplexTypes2._LinePlacement.getInstance(), null, 1, 1),
            ...
            new sldElement(
                "Opacity", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            new sldElement("Radius", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1),
            new sldElement(
                "AnchorPointX", sldComplexTypes2.ParameterValueType.getInstance(), null, 1, 1)
          };
    }
    return elements;
  }
