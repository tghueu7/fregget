...
public interface ComplexType extends Type {
   ...
   * particularily useful, as the parent will have the first attempt to create a real (non Object[])
   * value of the element. For more information see getValue.
   *
  ...
  /**
   * This methos represents the potential 'anyAttribute' declaration's namespace attribute which may
   * occur within a complex type definition.
   */
  ...
  /**
   * Specifies a mask which denotes which substitution mechanisms may be used for this complex type
   * definition.
   *
  ...
  /**
   * This method is used to publish whether this complexType is at the root of an inheritance tree,
   * or a leaf within an inheritance tree. This method should return true when the complexType is
   * not a root of an inheritance tree.
   */
