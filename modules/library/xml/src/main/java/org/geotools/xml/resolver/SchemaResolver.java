 ...
 * Catalog</a> (with URI resolution semantics), which maps URLs to arbitrary filesystem locations
 * .</li>
 * <p>
...
public class SchemaResolver {
     ...
     */
    private Map<String, String> resolvedLocationToOriginalLocationMap = new 
     ...
     * @param context  an absolute URL specifying the context schema of a relative location, or 
     *                 null if
     *                 none
     ...
     *                  path. If
     *                  this is set to true then the query portion is converted to an MD5 message
     *                  digest
