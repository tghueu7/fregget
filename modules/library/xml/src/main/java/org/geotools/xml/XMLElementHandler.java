...
public abstract class XMLElementHandler implements Serializable {
  ...
  /**
   * handles SAX end Element events. This matches the end of the element declaration in the document
   * ... and responds to the event generated by the SAX parser. This is an opportunity to complete
   ...
   * method should be used to complete a SAX parse of a document for which the Schema is known, and
   * parsed.
   *
   * @param namespaceURI
   * @param localName
