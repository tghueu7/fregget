...
public class SchemaCatalog {
   ...
   * returns by default.
   *
   * <p>Care must be taken to use only private {@link Catalog} instances if there will ever be more
   * than one OASIS Catalog used in a single class loader (i.e. a single maven test run), otherwise
   * {@link Catalog} contents will be an amalgam of the entries of both OASIS Catalog files, with
   * likely unintended or incorrect results. See GEOT-2497.
   *
