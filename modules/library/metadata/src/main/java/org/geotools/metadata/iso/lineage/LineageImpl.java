...
public class LineageImpl extends MetadataEntity implements Lineage {
  ...
  /**
   * General explanation of the data producers knowledge about the lineage of a dataset. Should be
   * provided only if {@linkplain ScopeImpl#getLevel scope level} is {@linkplain ScopeCode#DATASET
   * dataset} or {@linkplain ScopeCode#SERIES series}.
   */
   ...
   * dataset. Should be provided only if {@linkplain ScopeImpl#getLevel scope level} is {@linkplain
