...
public class PositionalAccuracyImpl extends ElementImpl implements PositionalAccuracy {
   ...
   * {@linkplain org.geotools.referencing.datum.BursaWolfParameters Bursa Wolf parameters} have been
   * found. Such datum shifts are approximative and may have 1 kilometer error. This
   ...
   * factory} only if it was created with {@link org.geotools.factory.Hints#LENIENT_DATUM_SHIFT} set
