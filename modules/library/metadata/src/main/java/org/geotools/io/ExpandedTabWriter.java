...
public class ExpandedTabWriter extends FilterWriter {
  ...
  /**
   * Constructs a filter which replaces tab characters ({@code '\t'}) by spaces. Tab widths default
   * to 8 characters.
   *
  ...
  /**
   * Constructs a filter which replaces tab characters ({@code '\t'}) by spaces, using the specified
   * tab width.
   *
   * @param out A writer object to provide the underlying stream.
