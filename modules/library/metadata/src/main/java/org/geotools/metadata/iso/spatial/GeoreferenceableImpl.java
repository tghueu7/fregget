 ...
 * @since 2.1
 */
public class GeoreferenceableImpl extends GridSpatialRepresentationImpl implements 
        Georeferenceable {
    /**
    ...
    public GeoreferenceableImpl(final int numberOfDimensions,
        ...
        super(numberOfDimensions, axisDimensionsProperties, cellGeometry, 
     ...
     */
    public synchronized void setOrientationParameterDescription(final InternationalString 
                                                                        newValue) {
        checkWritePermission();
