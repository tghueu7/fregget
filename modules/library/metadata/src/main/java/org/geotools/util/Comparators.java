...
public final class Comparators {
  ...
  /**
   * The comparator to be returned by {@link #forLists} and {@linkplain #forSet}. Can not be public
   * because of parameterized types - we need a method for casting to the expected type. This is the
   * same trick than {@link java.util.Collections#emptySet} for example.
   */
   ...
   * than</cite> the other, the result of that comparaison is returned. Otherwise the second element
   * are compared, and so on until either non-equal elements are found, or end-of-list are reached.
   * In the later case, the shortest list is considered <cite>less than</cite> the longuest one.
   *
