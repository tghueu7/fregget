...
public class DigitalTransferOptionsImpl extends MetadataEntity implements DigitalTransferOptions {
  ...
  /**
   * Estimated size of a unit in the specified transfer format, expressed in megabytes. The transfer
   * size is &gt; 0.0. Returns {@code null} if the transfer size is unknown.
   */
