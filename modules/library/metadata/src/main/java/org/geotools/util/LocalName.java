...
public class LocalName extends org.geotools.util.GenericName implements org.opengis.util.LocalName {
  ...
  /**
   * The sequence of local name for this {@linkplain GenericName generic name}. Since this object is
   * itself a locale name, this list is always a singleton containing only {@code this}. It will be
   * built only when first needed.
   */
   ...
   * qualified name must be {@linkplain NameSpace#isGlobal global}. This method never returns {@code
   * null}.
   *
   * @since 2.3
   */
