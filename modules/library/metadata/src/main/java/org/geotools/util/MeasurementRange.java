...
public class MeasurementRange<T extends Number & Comparable<? super T>> extends NumberRange<T> {
  ...
  /**
   * Converts this range to the specified units. If this measurement range has null units, then the
   * specified target units are simply assigned to the returned range with no other changes.
   *
