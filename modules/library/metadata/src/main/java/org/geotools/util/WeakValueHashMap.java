...
public class WeakValueHashMap<K, V> extends AbstractMap<K, V> {
  ...
  private final class Entry extends WeakReference<V> implements Map.Entry<K, V> {
    ...
    /**
     * Index for this element in {@link #table}. This index must be updated at every {@link #rehash}
     * call.
     */
    int index;
   ...
   * early table reduction. When the garbage collector collected a lot of elements, we will wait at
   * least 20 seconds before rehashing {@link #table}. Too early table reduction leads to many
  ...
  /**
   * Checks if this {@code WeakValueHashMap} is valid. This method counts the number of elements and
   ...
   * which make debugging more difficult). The set is otherwise unchanged, which should help to get
   * similar behaviour as if assertions hasn't been turned on.
   */
  ...
  /**
   * Returns a set view of the mappings contained in this map. Each element in this set is a {@link
   * java.util.Map.Entry}. The current implementation thrown {@link UnsupportedOperationException}.
   *
