...
public class ScopedName extends org.geotools.util.GenericName
   ...
   * {@linkplain InternationalString#toString(Locale) toString}(null)</code> method will be used in
   * order to fetch an unlocalized name. Otherwise, the <code>
  ...
  /**
   * Returns the head of this scoped name. This is the first elements in the sequence of {@linkplain
   * #getParsedNames parsed names}. The head element must exists in the same {@linkplain NameSpace
   * name space} than this scoped name. In other words, the following relationship must holds:
   *
   * <p>
   *
   * <ul>
