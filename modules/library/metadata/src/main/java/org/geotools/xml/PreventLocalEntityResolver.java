...
public class PreventLocalEntityResolver implements EntityResolver2, Serializable {
  ...
  /**
   * Tells the parser to resolve the systemId against the baseURI and read the entity text from that
   * resulting absolute URI. Note that because the older {@link DefaultHandler#resolveEntity
