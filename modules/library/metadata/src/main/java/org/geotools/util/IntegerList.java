...
public class IntegerList extends AbstractList<Integer>
   ...
   * @param initialCapacity The initial capacity.
   * @param maximalValue The maximal value to be allowed, inclusive.
   * @param fill If {@code true}, the initial {@linkplain #size} is set to the initial capacity with
   *     all values set to 0.
   */
  ...
  /**
   * Returns the maximal value that can be stored in this list. May be slighly higher than the value
