...
final class MetadataEntity implements InvocationHandler {
   ...
   *
   * @param identifier The identifier used in order to locate the record for this metadata entity in
   *     the database. This is usually the primary key in the table which contains this entity.
