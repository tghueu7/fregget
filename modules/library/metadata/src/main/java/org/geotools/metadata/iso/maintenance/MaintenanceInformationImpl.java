...
public class MaintenanceInformationImpl extends MetadataEntity implements MaintenanceInformation {
  ...
  /**
   * Frequency with which changes and additions are made to the resource after the initial resource
   * is completed.
   */
  ...
  /**
   * Returns identification of, and means of communicating with, person(s) and organization(s) with
   * responsibility for maintaining the metadata.
   *
   * @since 2.4
   */
