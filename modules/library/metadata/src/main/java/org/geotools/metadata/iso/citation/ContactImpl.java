...
public class ContactImpl extends MetadataEntity implements Contact {
  ...
  /**
   * Contact informations for the <A HREF="http://www.opengis.org">OpenGIS consortium</A>. "OpenGIS
  ...
  /**
   * Return on-line information that can be used to contact the individual or organization. Returns
   * {@code null} if none.
   */
