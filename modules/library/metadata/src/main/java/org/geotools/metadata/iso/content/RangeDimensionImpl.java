...
public class RangeDimensionImpl extends MetadataEntity implements RangeDimension {
  ...
  /**
   * Returns the number that uniquely identifies instances of bands of wavelengths on which a sensor
   * operates. @TODO: needs to annotate the package org.geotools.util before.
   */
