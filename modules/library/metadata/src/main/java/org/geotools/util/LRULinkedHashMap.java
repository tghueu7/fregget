...
public final class LRULinkedHashMap<K, V> extends LinkedHashMap<K, V> {
  ...
  /**
   * Constructs a {@code LRULinkedHashMap} with all entries from the specified map. The {@linkplain
   * #getMaximumSize maximum size} is set to the given {@linkplain Map#size map size}.
   *
   ...
   * #maximumSize} first entries at construction time, but super-class constructor is more efficient
   * for maps with less than {@code maximumSize}. We assume that this is the most typical case.
   */
