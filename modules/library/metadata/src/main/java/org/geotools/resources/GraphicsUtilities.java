...
public final class GraphicsUtilities {
   ...
   * when an exception has occurred inside a {@link java.awt.Component#paint} method and we want to
   * write it rather than leaving an empty window.
   *
   * @param exception Exception whose trace we want to write.
   * @param graphics Graphics context in which to write exception. The graphics context should be in
   *     its initial state (default affine transform, default colour, etc...)
  ...
  /**
   * Returns an exception trace. All tabs will have been replaced by 4 white spaces. This method was
   * used to be a private one in {@link org.geotools.gui.swing.ExceptionMonitor}. Do not rely on it.
   */
