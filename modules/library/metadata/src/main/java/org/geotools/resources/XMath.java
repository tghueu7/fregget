...
public final class XMath {
   ...
   * maximum of 4 ulps. If there is no small change that remove at least {@code n} fraction digits,
   * then the value is returned unchanged. This method is used for hiding rounding errors, like in
   ...
   * @return The fixed value, or the unchanged {@code value} if there is no small change that remove
   *     at least {@code n} fraction digits.
   * @deprecated Moved to {@link org.geotools.math.XMath}.
   */
  @Deprecated
   ...
   * equivalent to a call to <code>{@linkplain Double#toString(double) Double#toString}(value)
   ...
   * {@code 0xffffffff}. The standard {@link Float#NaN} has bit fields {@code 0x7fc00000}.
   *
   ...
   *
   * @param type The type to test (may be {@code null}).
   * @return {@code true} if {@code type} is the class {@link Long}, {@link Integer}, {@link Short}
   *     or {@link Byte}.
   * @deprecated Moved to {@link Classes}.
   */
  @Deprecated
   ...
   * @throws NumberFormatException if the string value is not parseable as a number of the specified
   *     type.
   * @since 2.4
   * @deprecated Moved to {@link Classes}.
   */
