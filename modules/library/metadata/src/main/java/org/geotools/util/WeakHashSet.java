...
public class WeakHashSet<E> extends AbstractSet<E> implements CheckedCollection<E> {
  ...
  /**
   * Returns a view of this set as an array. Elements will be in an arbitrary order. Note that this
   * array contains strong reference. Consequently, no object reclamation will occurs as long as a
   * reference to this array is hold.
   */
  @Override
