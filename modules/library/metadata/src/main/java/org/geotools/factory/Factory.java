...
public interface Factory {
   ...
   * this factory to customize its use. This map is <strong>not</strong> guaranteed to contains all
   * the hints supplied by the user; it may be only a subset. Consequently, hints provided here are
   * usually not suitable for creating new factories, unless the implementation make some additional
   * garantees (e.g. {@link FactoryUsingVolatileDependencies}).
   *
   ...
   * it is recommended to limit the set to only the hints used by this particular factory instance.
   * A minimal set will helps {@link FactoryRegistry} to compare only hints that matter and avoid
   * the creation of unnecessary instances of this factory.
   *
   ...
   * </code></pre>
   *
   * @return The map of hints, or an {@linkplain java.util.Collections#EMPTY_MAP empty map} if none.
   */
