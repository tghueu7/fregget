...
public class MetadataExtensionInformationImpl extends MetadataEntity
  ...
  /**
   * Provides information about a new metadata element, not found in ISO 19115, which is required to
  ...
  public synchronized void setExtendedElementInformation(
    ...
    extendedElementInformation =
        copyCollection(newValues, extendedElementInformation, ExtendedElementInformation.class);
  }
}
