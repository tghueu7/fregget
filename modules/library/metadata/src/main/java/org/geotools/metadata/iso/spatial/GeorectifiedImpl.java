...
public class GeorectifiedImpl extends GridSpatialRepresentationImpl implements Georectified {
  ...
  /**
   * Set indication of whether or not geographic position points are available to test the accuracy
   * of the georeferenced grid data.
   */
  ...
  public synchronized void setTransformationDimensionMapping(
    ...
    transformationDimensionMapping =
        copyCollection(newValues, transformationDimensionMapping, InternationalString.class);
  }
}
