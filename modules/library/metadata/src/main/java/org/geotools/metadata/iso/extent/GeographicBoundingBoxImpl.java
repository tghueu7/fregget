...
public class GeographicBoundingBoxImpl extends GeographicExtentImpl
   ...
   * envelope CRS when possible. This is because geographic bounding box are only approximative and
   * the ISO specification do not mandates a particular CRS, so we avoid transformations that are
  ...
  public GeographicBoundingBoxImpl(final Envelope envelope) throws TransformException {
    ...
    if (constructor == null) {
      ...
      constructor =
          getMethod("copy", new Class[] {Envelope.class, GeographicBoundingBoxImpl.class});
    }
    try {
   ...
   * is rather (<var>x</var><sub>min</sub>, <var>y</var><sub>min</sub>, <var>x</var><sub>max</sub>,
  ...
  /**
   * Returns the western-most coordinate of the limit of the dataset extent. The value is expressed
  ...
  /**
   * Returns the eastern-most coordinate of the limit of the dataset extent. The value is expressed
   * in longitude in decimal degrees (positive east).
   *
  ...
  /**
   * Returns the southern-most coordinate of the limit of the dataset extent. The value is expressed
  ...
  /**
   * Set the southern-most coordinate of the limit of the dataset extent. The value is expressed in
   * latitude in decimal degrees (positive north).
   *
  ...
  /**
   * Set the northern-most, coordinate of the limit of the dataset extent. The value is expressed in
   * latitude in decimal degrees (positive north).
   *
  ...
  /**
   * Adds a geographic bounding box to this box. If the {@linkplain #getInclusion inclusion} status
   * is the same for this box and the box to be added, then the resulting bounding box is the union
   * of the two boxes. If the {@linkplain #getInclusion inclusion} status are opposite
  ...
  /**
   * Sets this bounding box to the intersection of this box with the specified one. The {@linkplain
   * #getInclusion inclusion} status must be the same for both boxes.
   *
  ...
  public static String toString(
    ...
    if (toString == null) {
      ...
      toString =
          getMethod(
              "toString", new Class[] {GeographicBoundingBox.class, String.class, Locale.class});
    }
    try {
