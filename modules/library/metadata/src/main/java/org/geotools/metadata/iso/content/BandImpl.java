...
public class BandImpl extends RangeDimensionImpl implements Band {
  ...
  /**
   * Units in which sensor wavelengths are expressed. Should be non-null if {@linkplain #getMinValue
   * min value} or {@linkplain #getMaxValue max value} are provided.
   */
  private Unit units;
  ...
  /**
   * Returns the units in which sensor wavelengths are expressed. Should be non-null if {@linkplain
  ...
  /**
   * Returns the maximum number of significant bits in the uncompressed representation for the value
  ...
  /**
   * Set the maximum number of significant bits in the uncompressed representation for the value in
   * each band of each pixel.
   */
