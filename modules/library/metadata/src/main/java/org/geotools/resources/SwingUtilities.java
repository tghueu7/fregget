...
public final class SwingUtilities {
   ...
   *   <li>If {@code owner} or one of its parent is a {@link Frame} or a {@link Dialog}, then {@code
   *       panel} is added into a {@link JDialog}.
   ...
   *     registered to whatever kind of frame this method will constructs. In the special case where
   *     this method constructs an {@linkplain JInternalFrame internal frame} and the {@code
   *     listener} is not an instance of {@link javax.swing.event.InternalFrameListener}, then this
   ...
   * @param dialog The dialog content to show.
   * @param title The title string for the dialog.
   * @param reset Action to execute when user press "Reset", or {@code null} if there is no "Reset"
   *     button. If {@code reset} is an instance of {@link Action}, the button label will be set
