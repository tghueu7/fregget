...
public final class NameFactory {
  ...
  /**
   * Constructs a generic name from an array of local names and the default separator character. If
   * any of the specified names is an {@link InternationalString}, then the <code>
