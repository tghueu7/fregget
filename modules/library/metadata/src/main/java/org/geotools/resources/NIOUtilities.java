...
public final class NIOUtilities {
  ...
  /**
   * Sets the maximum byte buffer cache size, in bytes (set to 0 to only use soft references in the
   * case, a positive value will make the cache use hard references up to the max cache size)
   *
   * @param maxCacheSize
   */
