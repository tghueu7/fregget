...
public class ImageDescriptionImpl extends CoverageDescriptionImpl implements ImageDescription {
   ...
   * the optical line of sight with the Earths surface. For images from a scanning device, refer to
   * the centre pixel of the image.
   */
  ...
  /**
   * Image distributors code that identifies the level of radiometric and geometric processing that
   * has been applied.
   */
  private Identifier processingLevelCode;

  /**
   * Count of the number the number of lossy compression cycles performed on the image. {@code null}
   ...
   * intersection of the optical line of sight with the Earths surface. For images from a scanning
   * device, refer to the centre pixel of the image.
   */
  ...
  /**
   * Returns the illumination azimuth measured in degrees clockwise from true north at the time the
  ...
  /**
   * Returns theiIndication of whether or not the radiometric calibration information for generating
  ...
  /**
   * Set the indication of whether or not the radiometric calibration information for generating the
   * radiometrically calibrated standard data product is available.
   */
  ...
  /**
   * Set the indication of whether or not constants are available which allow for camera calibration
   * corrections.
   */
