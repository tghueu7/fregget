...
public class ExtentImpl extends MetadataEntity implements Extent {
  ...
  /**
   * Convenience method returning a single geographic bounding box from the specified extent. If no
   * bounding box was found, then this method returns {@code null}. If more than one box is found,
   * then boxes are {@linkplain GeographicBoundingBoxImpl#add added} together.
   *
   * @since 2.2
   */
