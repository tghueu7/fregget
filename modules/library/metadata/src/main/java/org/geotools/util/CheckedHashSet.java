...
public class CheckedHashSet<E> extends LinkedHashSet<E> implements CheckedCollection<E>, Cloneable {
   ...
   * this collection got the {@linkplain #getLock lock} and before any operation that may change the
   * content. The default implementation does nothing (i.e. this collection is modifiable).
