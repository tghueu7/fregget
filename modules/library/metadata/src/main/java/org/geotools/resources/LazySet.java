...
public final class LazySet<E> extends AbstractSet<E> {
  ...
  /**
   * Construct a set to be filled using the specified iterator. Iteration in the given iterator will
  ...
  /**
   * Returns an iterator over the elements contained in this set. This is not the same iterator than
   * the one given to the constructor.
   */
