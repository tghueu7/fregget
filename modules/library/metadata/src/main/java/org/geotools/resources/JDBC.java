...
public final class JDBC {
   ...
   * Otherwise, it attempts to load the specified driver and returns a log record initialized with a
   * message at the {@link Level#CONFIG CONFIG} level on success, or at the {@link Level#WARNING
