...
public final class ObjectCaches {
   ...
   *
   * <p>This functionality is used to tie two ObjectCache implementations together (allowing them to
   * collaborate while focusing on different use cases). The real world example of chaining is in
