...
public abstract class DerivedSet<B, E> extends AbstractSet<E>
  ...
  /**
   * Transforms a value in the {@linkplain #base} set to a value in this set. If there is no mapping
   * in the derived set for the specified element, then this method returns {@code null}.
   *
   ...
   * @throws UnsupportedOperationException if the {@linkplain #base} set doesn't supports the {@code
   *     add} operation.
   */
  @Override
