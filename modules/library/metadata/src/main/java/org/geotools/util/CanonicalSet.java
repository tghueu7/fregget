...
public class CanonicalSet<E> extends WeakHashSet<E> {
  ...
  /**
   * Returns an object equals to the specified object, if present. If this set doesn't contains any
   * object equals to {@code object}, then this method returns {@code null}.
   *
   ...
   * @return An element equals to the given one if already presents in the set, or the given {@code
   *     object} otherwise.
   */
  ...
  /**
   * Iteratively call {@link #unique(Object)} for an array of objects. This method is equivalents to
   * the following code:
   *
   * <blockquote>
   *
