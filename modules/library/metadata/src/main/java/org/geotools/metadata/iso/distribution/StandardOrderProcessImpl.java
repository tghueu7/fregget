...
public class StandardOrderProcessImpl extends MetadataEntity implements StandardOrderProcess {
  ...
  /**
   * Returns fees and terms for retrieving the resource. Include monetary units (as specified in ISO
   * 4217).
   */
  ...
  public synchronized Date getPlannedAvailableDateTime() {
    return (plannedAvailableDateTime != Long.MIN_VALUE) ? new Date(plannedAvailableDateTime) : null;
  }
