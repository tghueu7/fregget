...
public class ResolutionImpl extends MetadataEntity implements Resolution {
  ...
  /**
   * Level of detail expressed as the scale of a comparable hardcopy map or chart. This value should
   * be between 0 and 1. Only one of {@linkplain #getEquivalentScale equivalent scale} and
