...
public class ExtendedElementInformationImpl extends MetadataEntity
  ...
  /**
   * Condition under which the extended element is mandatory. Non-null value only if the {@linkplain
   * #getObligation obligation} is {@linkplain Obligation#CONDITIONAL conditional}.
   */
  ...
  /**
   * Sets the {@code xmlMarshalling} flag to {@code true}, since the marshalling process is going to
   * be done. This method is automatically called by JAXB, when the marshalling begins.
   *
