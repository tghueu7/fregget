...
public class CitationImpl extends MetadataEntity implements Citation {
  ...
  /**
   * Short name or other language name by which the cited information is known. Example: "DCW" as an
  ...
  /**
   * Date of the edition in millisecondes ellapsed sine January 1st, 1970, or {@link Long#MIN_VALUE}
   * if none.
   */
  ...
  /**
   * Adds the specified identifier as a CRS authority factory. This is used as a convenience method
   * for the creation of constants, and for making sure that all of them use the same identifier
   * type.
   */
  ...
  /**
   * Returns the short name or other language name by which the cited information is known. Example:
  ...
  /**
   * Returns the unique identifier for the resource. Example: Universal Product Code (UPC), National
   * Stock Number (NSN).
   */
  ...
  /**
   * Returns the name and position information for an individual or organization that is responsible
  ...
  /**
   * Set the name and position information for an individual or organization that is responsible for
   * the resource. Returns an empty string if there is none.
   */
  ...
  /**
   * Set the information about the series, or aggregate dataset, of which the dataset is a part. Set
  ...
  /**
   * Set other information required to complete the citation that is not recorded elsewhere. Set to
   * {@code null} if none.
   */
