...
public class FactoryCreator extends FactoryRegistry {
   ...
   * is created and returned. This creation step is the only difference between this method and the
   * {@linkplain FactoryRegistry#getServiceProvider super-class method}.
   *
   ...
   * @throws FactoryNotFoundException if no factory was found, and the specified hints don't provide
   *     suffisient information for creating a new factory.
