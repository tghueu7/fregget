...
public final class XArray {
    ...
    private static <T> T doResize(final T array, final int length) {
        ...
        if (current != length) {
            @SuppressWarnings("unchecked") final T newArray = (T) Array.newInstance(array
    ...
    private static <T> T doRemove(final T array, final int index, final int length) {
        ...
        @SuppressWarnings("unchecked") final T newArray = (T) Array.newInstance(array.getClass()
                .getComponentType(), arrayLength -= length);
    ...
    private static <T> Object doInsert(final T src, final int src_pos,
        ...
        @SuppressWarnings("unchecked") final T newArray = (T) Array.newInstance(dst.getClass()
                .getComponentType(), dstLength + length);
