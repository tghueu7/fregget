...
public class OnLineResourceImpl extends MetadataEntity implements OnLineResource {
  ...
  /**
   * The online resources for the <A HREF="http://www.opengis.org">OpenGIS consortium</A>. "OpenGIS
   ...
   * Service</A> specification. The download link may change in future Geotools versions in order to
   * point toward the latest specification.
   *
   * @since 2.2
   */
  ...
  /**
   * Creates an on line resource initialized to the given URI. This method is private for now since,
   * if this constructor was public, some users may expect a string argument to be for the
  ...
  /**
   * Returns the detailed text description of what the online resource is/does. Returns {@code null}
   * if none.
   */
