...
public class FrequencySortedSet<E> extends AbstractSet<E>
  ...
  /**
   * Adds the specified element to this set. Returns {@code true} if this set changed as a result of
   * this operation. Changes in element order are not notified by the returned value.
   *
  ...
  /**
   * Removes the specified element from this set, no matter how many time it has been added. Returns
   * {@code true} if this set changed as a result of this operation.
   *
  ...
  private final class Iter implements Iterator<E> {
    /**
     * A copy of {@link FrequencySortedSet#sorted} at the time this iterator has been created. Used
     * because the {@code sorted} array is set to {@code null} when {@link #remove()} is invoked.
     */
   ...
   *       more than one element were added with the same frequency, this is the first one that has
  ...
  /**
   * Sorts the elements in frequency order, if not already done. The sorted array will contains all
   * elements without duplicated values, with the less frequent element first and the most frequent
   * last (or the converse if this set has been created for reverse order). If some elements appear
   * at the same frequency, then their ordering will be preserved.
   */
   ...
   *
   * <p>This method is final because the {@code FrequencySortedSet} implementation makes assumptions
   * on the comparator that would not hold if this method were overrided.
   */
   ...
   * FrequencySortedSet} with default ordering, this method returns a positive number if {@code o1}
   * has been added more frequently to this set than {@code o2}, a negative number if {@code o1} has
   * been added less frequently than {@code o2}, and 0 otherwise. For {@code FrequencySortedSet}
