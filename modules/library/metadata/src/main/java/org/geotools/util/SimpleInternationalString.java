...
public class SimpleInternationalString extends AbstractInternationalString implements Serializable {
  ...
  /**
   * If the specified string is null or an instance of {@link AbstractInternationalString}, returns
   * it unchanged. Otherwise, wraps the string value in a {@code SimpleInternationalString}.
   *
