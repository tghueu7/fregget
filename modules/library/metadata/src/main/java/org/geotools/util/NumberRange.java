...
public class NumberRange<T extends Number & Comparable<? super T>> extends Range<T> {
    ...
    private static Class<? extends Number> getElementClass(final Range<?> range)
         ...
         * ClassCastException.
         */
        @SuppressWarnings("unchecked") final Class<? extends Number> result = (Class<? extends 
                Number>) type;
        return result;
    }
    ...
    public boolean contains(Comparable<?> value) throws IllegalArgumentException {
         ...
         */
        @SuppressWarnings("unchecked") final boolean contains = castTo((Class) type).containsNC(
                (Comparable) number);
        return contains;
    }
     ...
     * returned.
     *
     * @param inclusive {@code true} for the minimum value inclusive, or {@code false}
     ...
     * returned.
     *
     * @param inclusive {@code true} for the maximum value inclusive, or {@code false}
