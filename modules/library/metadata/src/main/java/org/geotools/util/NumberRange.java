...
public class NumberRange<T extends Number & Comparable<? super T>> extends Range<T> {
  ...
  /**
   * Constructs an inclusive range of {@link Comparable} objects. This constructor is used by {@link
   * RangeSet#newRange} only.
   *
   ...
   * instance. This method is overriden by {@link MeasurementRange} only in the way described above.
   *
   * @param type The class to cast to. Must be one of {@link Byte}, {@link Short}, {@link Integer},
   *     {@link Long}, {@link Float} or {@link Double}.
  ...
  /**
   * Returns the {@linkplain #getMinimum() minimum value} with the specified inclusive or exclusive
   * state. If this range is unbounded, then {@link Double#NEGATIVE_INFINITY} is returned.
   *
   * @param inclusive {@code true} for the minimum value inclusive, or {@code false} for the minimum
   *     value exclusive.
  ...
  /**
   * Returns the {@linkplain #getMaximum() maximum value} with the specified inclusive or exclusive
   * state. If this range is unbounded, then {@link Double#POSITIVE_INFINITY} is returned.
   *
   * @param inclusive {@code true} for the maximum value inclusive, or {@code false} for the maximum
   *     value exclusive.
