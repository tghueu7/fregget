...
public class ElementImpl extends MetadataEntity implements Element {
  ...
  /**
   * Date or range of dates on which a data quality measure was applied. The array length is 1 for a
   * single date, or 2 for a range. Returns {@code null} if this information is not available.
   */
  ...
  /**
   * Set the date or range of dates on which a data quality measure was applied. The collection size
   * is 1 for a single date, or 2 for a range.
   *
   * @since 2.4
   */
  ...
  /**
   * Set the value (or set of values) obtained from applying a data quality measure or the out come
   * of evaluating the obtained value (or set of values) against a specified acceptable conformance
   * quality level.
   *
   * @since 2.4
   */
