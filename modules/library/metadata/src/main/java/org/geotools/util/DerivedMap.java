...
public abstract class DerivedMap<BK, K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  /**
   * Returns the value to which this map maps the specified key. The default implementation invokes
   ...
   *     for key.
   * @throws UnsupportedOperationException if the {@linkplain #base} map doesn't supports the {@code
   *     put} operation.
   */
  @Override
