...
public final class CanonicalSetTest {
  /**
   * Tests the {@link CanonicalSet} using strong references. The tested {@link CanonicalSet} should
   * behave like a standard {@link Set} object.
   */
  @Test
  ...
  /**
   * Test the {@link CanonicalSet} using weak references. In this test, we have to keep in mind than
   * some elements in <code>weakSet</code> may disaspear at any time!
   */
  @Test
