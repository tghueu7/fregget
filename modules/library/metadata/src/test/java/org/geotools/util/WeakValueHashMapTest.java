...
public final class WeakValueHashMapTest {
  ...
  /**
   * Tests the {@link WeakValueHashMap} using strong references. The tested {@link WeakValueHashMap}
    ...
    for (int pass = 0; pass < 4; pass++) {
      ...
      for (int i = 0; i < SAMPLE_SIZE; i++) {
        ...
        if (false) {
          ...
          assertEquals(
              "containsValue:", strongMap.containsValue(value), weakMap.containsValue(value));
        }
  ...
  /**
   * Tests the {@link WeakValueHashMap} using weak references. In this test, we have to keep in mind
   * than some elements in {@code weakMap} may disaspear at any time.
   */
  @Test
