...
public final class CitationsTest {
  /**
   * Tests the {@link AbstractMetadata#toString()} method first, since debugging will relying a lot
   * on this method for the remaining of the test suite.
   */
  @Test
  ...
  public void testPositionalAccuracy() {
    ...
    assertNotSame(
        PositionalAccuracyImpl.DATUM_SHIFT_APPLIED, PositionalAccuracyImpl.DATUM_SHIFT_OMITTED);
