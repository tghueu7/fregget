...
public final class GeoToolsTest {
  ...
  public void testMyHints() {
    ...
    try {
      ...
      text = hints.toString().trim();
      assertTrue(
          text.matches("Hints:\\s+System defaults:\\s+FORCE_LONGITUDE_FIRST_AXIS_ORDER = false"));
    } finally {
  ...
  public void testEntityResolver() {
    ...
    resolver =
        GeoTools.instantiate(null, EntityResolver.class, PreventLocalEntityResolver.INSTANCE);
    assertTrue(resolver instanceof PreventLocalEntityResolver);
    ...
    try {
      ...
      System.getProperties()
          .put(GeoTools.ENTITY_RESOLVER, "org.geotools.factory.PlaceholderEntityResolver");
      Hints.scanSystemProperties();
