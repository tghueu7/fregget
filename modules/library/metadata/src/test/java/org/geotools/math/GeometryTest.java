...
public final class GeometryTest {
    ...
    public void testPlaneFit() {
        ...
        final double[] P1 = new double[]{100 * rd.nextDouble() + 25, 100 * rd.nextDouble() + 25, 
                Math.rint(100 * rd.nextDouble() + 40)};
        final double[] P2 = new double[]{100 * rd.nextDouble() + 25, 100 * rd.nextDouble() + 25, 
                Math.rint(100 * rd.nextDouble() + 40)};
        final double[] P3 = new double[]{100 * rd.nextDouble() + 25, 100 * rd.nextDouble() + 25, 
                Math.rint(100 * rd.nextDouble() + 40)};
