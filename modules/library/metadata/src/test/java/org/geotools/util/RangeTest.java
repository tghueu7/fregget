...
public final class RangeTest {
     ...
     */
    private final Range<Integer> NON_NEGATIVE = new Range<Integer>(Integer.class, 0, true, null, 
            true);
     ...
     */
    private final Range<Integer> NON_POSITIVE = new Range<Integer>(Integer.class, null, true, 0, 
            true);
    ...
    public void testIntersects() {
        assertEquals("(0,1]", new Range<Integer>(Integer.class, 0, false, 1, true), UNIT
                .intersect(POSITIVE));
        assertEquals("[-1,0)", new Range<Integer>(Integer.class, -1, true, 0, false), UNIT
                .intersect(NEGATIVE));
        ...
        assertTrue("positive does not include NEGATIVE so result is empty", POSITIVE.intersect
                (NEGATIVE).isEmpty());
        assertTrue("positive does not include ZERO so result is empty", ZERO.intersect(POSITIVE)
                .isEmpty());
        assertTrue("negative does not include ZERO so result is empty", ZERO.intersect(NEGATIVE)
                .isEmpty());
    }
