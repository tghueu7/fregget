...
public final class FactoryRegistryTest {
    ...
    private FactoryRegistry getRegistry(final boolean creator,
        ...
        @SuppressWarnings("unchecked") final Set<Class<?>> categories = (Set) Collections
                .singleton(DummyFactory.class);
        ...
        assertTrue(registry.setOrdering(DummyFactory.class, (DummyFactory) factory1, 
                (DummyFactory) factory2));
        assertTrue(registry.setOrdering(DummyFactory.class, (DummyFactory) factory2, 
                (DummyFactory) factory3));
        assertTrue(registry.setOrdering(DummyFactory.class, (DummyFactory) factory1, 
                (DummyFactory) factory3));

        final List<?> factories = registry.getFactories(DummyFactory.class, null, null).collect
                (toList());
    ...
    public void testCreateProvider() {
        ...
        factory = registry.getFactory(DummyFactory.class, null, hints, key);
        assertSame("An instance of Factory #5 should have been created.", factory5.getClass(), 
                factory.getClass());
        ...
        factory = registry.getFactory(DummyFactory.class, null, hints, key);
        assertEquals("An instance of Factory #4 should have been created.", DummyFactory
                .Example4.class, factory.getClass());
    }
     ...
     */
    @Test
    public void testLookupWithSameFactoryInTwoClassLoaders() throws MalformedURLException, 
