...
public interface DummyFactory extends InternalFactory {
  ...
  /**
   * Dummy factory implementation #4. {@link FactoryRegistryTest} will not register this factory in
   * same time than other ones.
   */
  ...
  /**
   * Dummy factory implementation #5. {@link FactoryRegistryTest} will not register this factory in
   * same time than other ones. This factory is the only one to accept hints.
   */
