...
public class GeometryBuilder {
  ...
  /**
   * Creates a 2D LinearRing. If the supplied coordinate list is not closed, a closing coordinate is
   * added.
   *
   * @param ord
   * @return a LinearRing
  ...
  /**
   * Creates a 3D LinearRing. If the supplied coordinate list is not closed, a closing coordinate is
   * added.
   *
   * @param ord the XYZ ordinates
   * @return a LinearRing
  ...
  /**
   * Creates a Polygon with a hole from an exterior ring and an interior ring supplied by the rings
   * of Polygons.
   *
   * @param shell the exterior ring
   * @param hole the interior ring
