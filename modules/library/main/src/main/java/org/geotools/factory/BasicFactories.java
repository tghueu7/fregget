...
public class BasicFactories {
  ...
  /**
   * Returns the {@linkplain GeometryFactory geometry factory} equiped to build geometries using the
   * given {@linkplain CoordinateReferenceSystem coordinate reference system}.
   *
   * <p><strong>NOTE:</strong> This method is not yet supported in Geotools. The default
   * implementation thrown an exception in all case.
   *
