...
public class SLDInlineFeatureParser {
   ...
   * <gml:Point srsName="http://www.opengis.net/gml/srs/epsg.xml#4326"> <gml:coordinates decimal="."
   * cs="," ts=" ">-73.983597,40.736308</gml:coordinates> </gml:Point> </tiger:wkb_geometry>
   * <tiger:laname>Cabrini Medical Center</tiger:laname> </tiger:point_landmark> <gml:featureMember>
   * </FeatureCollection>
   *
  ...
  private SimpleFeatureType makeFeatureType(Node root, boolean isCollection) throws Exception {
    ...
    // next node under featureMember what we want.  Unless its a boundedBy, in which case we dont
    // want it.
  ...
  /**
   * simple way of getting epsg #. We cache them so that we dont have to keep reading the DB or the
   * epsg.properties file. I cannot image a system with more than a dozen CRSs in it...
   *
   * @param epsg
   */
