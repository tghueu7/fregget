...
public abstract class DefaultTemporalPrimitive extends DefaultTemporalObject
   ...
   * TM_RelativePosition and are based on the 13 temporal relationships identified by Allen (1983).
   *
  ...
  public RelativePosition relativePosition(TemporalPrimitive other) {
    if (this instanceof Instant && other instanceof Instant) {
      ...
      if (timeobject.getPosition().getDate().before(instantOther.getPosition().getDate())) {
        ...
        return (timeobject.getPosition().getDate().compareTo(instantOther.getPosition().getDate())
                == 0)
          ...
          if (this instanceof Period && other instanceof Period) {
            ...
            if (timeobject
              ...
              if (timeobject
                      ...
                      .getPosition()
                      .getDate()
                      .compareTo(instantarg.getBeginning().getPosition().getDate())
                  == 0) {
                ...
                if (timeobject
                    ...
                    && timeobject
                        ...
                        .getPosition()
                        .getDate()
                        .after(instantarg.getBeginning().getPosition().getDate())
                    && timeobject
                        .getEnding()
                        .getPosition()
                        .getDate()
                        .before(instantarg.getEnding().getPosition().getDate())) {
                  ...
                  if (timeobject
                    ...
                    if (timeobject
                        ...
                        && timeobject
                            ...
                            .getPosition()
                            .getDate()
                            .after(instantarg.getEnding().getPosition().getDate())) {
                        ...
                        if (timeobject
                          ...
                          if (timeobject
                              ...
                              && timeobject
                                      ...
                                      .getPosition()
                                      .getDate()
                                      .compareTo(instantarg.getEnding().getPosition().getDate())
                                  == 0) {
