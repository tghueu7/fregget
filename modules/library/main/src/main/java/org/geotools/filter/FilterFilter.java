...
public class FilterFilter extends XMLFilterImpl implements GMLHandlerJTS {
     ...
     * @param schema The schema that the filter will be used against.
     */
    public FilterFilter(FilterHandler parent, SimpleFeatureType schema, boolean 
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if (localName.equals("Filter")) {
            ...
            //DJB: Found "UpperBoundary" and "LowerBoundary" - these are completely ignored by 
            // this parser!!!
            ...
            if ((filterType == -1) && !((localName.equals("UpperBoundary")) || (localName.equals
                    ("LowerBoundary")) || (localName.equals("Distance")))) {
                if (!(localName.endsWith("Member"))) //from CITE tests
                    throw new SAXException("Attempted to construct illegal filter - I dont " +
                            "understand the tag: " + qName + ".  HINT: tags are case-sensitive!");
            }
    ...
    /**
     * Calling this method should be the first thing done by 
