...
public class WKTParser {
   ...
   * @param primitiveFactory A <code>PrimitiveFactory</code> created with the same crs and precision
   *     as above
   * @param positionFactory A <code>PositionFactory</code> created with the same crs and precision
   *     as above
   * @param aggregateFactory A <Code>AggregateFactory</code> created with the same crs and precision
   *     as above
   */
  public WKTParser(
