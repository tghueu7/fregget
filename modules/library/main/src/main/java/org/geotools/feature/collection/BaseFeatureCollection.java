...
public abstract class BaseFeatureCollection<T extends FeatureType, F extends Feature>
   ...
   *
   * <p>Note that {@link FeatureIterator<F>#close()} is available to clean up after any resource use
   * required during traversal.
   */
   ...
   *
   * <p>This method only supports SimpleFeature at present, consider use of FeatureSource.features(
   * Query ).
   *
