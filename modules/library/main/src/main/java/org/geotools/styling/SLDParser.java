...
public class SLDParser {
  ...
  /**
   * Many elements in an SLD extends ParameterValueType (allowing for the definition of Expressions)
   * - this method will try and produce an expression for the provided node.
   *
   * <p>As an example:
   *
   * <ul>
   ...
   * </ul>
   *
   * From the SLD 1.0 spec: "ParameterValueType" uses WFS-Filter expressions to give values for SLD
   * graphic parameters. A "mixed" element-content model is used with textual substitution for
   * values.
   */
