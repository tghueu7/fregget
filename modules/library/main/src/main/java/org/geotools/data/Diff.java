...
public class Diff {
  ...
  /**
   * Unmodifiable view of modified features. It is imperative that the user manually synchronize on
  ...
  /**
   * Unmodifiable view of added features. It is imperative that the user manually synchronize on the
   ...
   *
   * <p>This class is used by TransactionStateDiff as a placeholder to represent features that have
   * been removed. The concept is generally useful and may wish to be taken out as a separate class
   * (used for example to represent deleted rows in a shapefile).
   */
