...
public class CapabilitiesFilterSplitter implements FilterVisitor, ExpressionVisitor {
   ...
   * @param transactionAccessor If the transaction is handled on the client and not the server then
   *     different filters must be sent to the server. This class provides a generic way of
  ...
  /**
   * @see FilterVisitor#visit(PropertyIsBetween, Object) NOTE: This method is extra documented as an
   *     example of how all the other methods are implemented. If you want to know how this class
   *     works read this method first!
   * @param filter the {@link Filter} to visit
   */
