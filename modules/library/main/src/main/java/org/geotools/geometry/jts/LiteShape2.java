...
public final class LiteShape2 implements Shape, Cloneable {
     ...
     *                      set to true if the geometry need to be generalized during
     *                      rendering
     * @param clone         - if clone is false the original geometry may be modified directly, 
     *                      if true it will be
     ...
     */
    public LiteShape2(Geometry geom, MathTransform mathTransform,
                      Decimator decimator, boolean generalize, boolean clone) throws 
            TransformException,
            FactoryException {
        if (geom != null) {
            if (!clone && geom.getFactory().getCoordinateSequenceFactory() instanceof 
        ...
        if (decimator != null) {
            ...
            if (mathTransform != null && !mathTransform.isIdentity() && generalize && geometry !=
                    null) {
    ...
    public PathIterator getPathIterator(AffineTransform at) {
        ...
        if (this.geometry instanceof Polygon) {
            ...
            pi = new GeomCollectionIterator((GeometryCollection) geometry, at, generalize, 
                    maxDistance);
        }
        return pi;
    }
