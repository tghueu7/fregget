...
public abstract class PackedCSBuilder implements CSBuilder {
    ...
    public static class Double extends PackedCSBuilder {
        ...
        /**
         * @see org.geotools.geometry.coordinatesequence.CSBuilder#setOrdinate(com.vividsolutions
         * .jts.geom.CoordinateSequence, double, int, int)
         */
        public void setOrdinate(CoordinateSequence sequence, double value, int ordinateIndex, int
                coordinateIndex) {
