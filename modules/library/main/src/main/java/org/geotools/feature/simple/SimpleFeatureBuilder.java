...
public class SimpleFeatureBuilder extends FeatureBuilder<FeatureType, Feature> {
   ...
   *
   * <p>This method is a short-hand convenience which creates a builder instance internally and adds
   ...
   * instance should be instantiated directly.
   *
   * <p>This method is a short-hand convenience which creates a builder instance and initializes it
   * with the attributes from the specified feature.
   */
   ...
   *
   * <p>This method is scary, expensive and will result in a deep copy of Geometry which may take a
   * significant amount of memory/time to perform.
   *
   ...
   *
   * <p>If the feature type contains attributes in which the original feature does not have a value
   * for, the value in the resulting feature is set to <code>null</code>.
   *
