...
public class ConcatenateFunction extends FunctionImpl {
     ...
     * a consistent spot.
     */
    public static final FunctionName NAME = functionName("Concatenate", "result:String", 
            "text:String:2,");
    ...
    public Object evaluate(Object feature) {
        ...
        for (Expression expression : (List<Expression>) getParameters()) {
            try {
                ...
                LOGGER.log(Level.FINE, "Failed to concatenate string in Concatenate function", 
                        couldNotCompute);
            }
        }
