...
public class FunctionImpl extends ExpressionAbstract implements Function {
  ...
  /**
   * FunctionName description for FilterCapabilities, may be provided by subclass in constructor, or
   * will be lazily created based on name and number of arguments.
   */
  ...
  /**
   * Creates a String representation of this Function with the function name and the arguments. The
   * String created should be good for most subclasses
   */
  ...
  /**
   * Convenience method for creating a function name from a set of strings describing the return and
   * argument parameters of the function.
   *
