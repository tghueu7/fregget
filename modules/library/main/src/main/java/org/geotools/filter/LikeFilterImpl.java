...
public class LikeFilterImpl extends AbstractFilter implements PropertyIsLike {
    ...
    public String getSQL92LikePattern() throws IllegalArgumentException {
        if (escape.length() != 1) {
            throw new IllegalArgumentException("Like Pattern --> escape char should be of length " +
                    "exactly 1");
        }
        if (wildcardSingle.length() != 1) {
            throw new IllegalArgumentException("Like Pattern --> wildcardSingle char should be of" +
                    " length exactly 1");
        }
        if (wildcardMulti.length() != 1) {
            throw new IllegalArgumentException("Like Pattern --> wildcardMulti char should be of " +
                    "length exactly 1");
        }
    ...
    public LikeFilterImpl(org.opengis.filter.expression.Expression expr, String pattern, String 
            wildcardMulti,
