...
public class SimpleFeatureTypeBuilder {
   ...
   *
   * <p>The supplied coordinate reference is a "default" only used if geometric attributes are later
  ...
  /**
   * The fallback coordinate reference system that will be applied to any geometric attributes added
   * to the type without their own coordinate reference system specified.
   */
