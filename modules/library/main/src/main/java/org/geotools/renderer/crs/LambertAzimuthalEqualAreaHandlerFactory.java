  ...
  public ProjectionHandler getHandler(
    ...
    if (mapProjection instanceof LambertAzimuthalEqualArea) {
      ...
      double latitudeOfCenter =
          params
              .parameter(LambertAzimuthalEqualArea.Provider.LATITUDE_OF_CENTRE.getName().getCode())
              .doubleValue();
      double longitudeOfCenter =
          params
              .parameter(LambertAzimuthalEqualArea.Provider.LONGITUDE_OF_CENTRE.getName().getCode())
              .doubleValue();
