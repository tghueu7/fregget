...
public final class TransformedShape extends AffineTransform implements Shape {
  ...
  /**
   * Invoked when an inverse transform was required but the transform is not invertible. This error
   * should not happen. However, even if it happen, it will not prevent the application to work
   * since <code>contains(...)</code> method may conservatively return <code>false</code>. We will
   * just log a warning message and continue.
   */
