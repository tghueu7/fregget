...
//        copy.setSemanticTypeIdentifiers((String[]) fts.getSemanticTypeIdentifiers().clone());
        ...
        if (STRICT && !copy.equals(fts)) {
            throw new IllegalStateException("Was unable to duplicate provided FeatureTypeStyle:" 
                    + fts);
        }
    ...
    private ExternalMark copy(org.geotools.styling.ExternalMark other) {
        if (other == null) {
            ...
            return sf.externalMark(other.getOnlineResource(), other.getFormat(), other
                    .getMarkIndex());
        }
    }
    ...
    public void visit(LineSymbolizer line) {
        ...
        if (STRICT && !copy.equals(line)) {
            throw new IllegalStateException("Was unable to duplicate provided LineSymbolizer:" + 
                    line);
        }
        pages.push(copy);
    }
    ...
    public void visit(PolygonSymbolizer poly) {
        ...
        if (STRICT && !copy.equals(poly)) {
            throw new IllegalStateException("Was unable to duplicate provided PolygonSymbolizer:"
                    + poly);
        }
        pages.push(copy);
    }
    ...
    public void visit(TextSymbolizer text) {
        ...
        if (STRICT && !copy.equals(text)) {
            throw new IllegalStateException("Was unable to duplicate provided TextSymbolizer:" + 
                    text);
        }
        pages.push(copy);
    }
    ...
    public void visit(ExternalGraphic exgr) {
        ...
        if (STRICT && !copy.equals(exgr)) {
            throw new IllegalStateException("Was unable to duplicate provided ExternalGraphic:" +
                    exgr);
        }
        pages.push(copy);
    }
    ...
    public void visit(PointPlacement pp) {
        ...
        if (STRICT && !copy.equals(pp)) {
            throw new IllegalStateException("Was unable to duplicate provided PointPlacement:" + 
                    pp);
        }
        pages.push(copy);
    }
    ...
    public void visit(FeatureTypeConstraint ftc) {
        ...
        if (STRICT && !copy.equals(ftc)) {
            throw new IllegalStateException("Was unable to duplicate provided " +
    ...
    public void visit(ColorMap colorMap) {
        ...
        if (STRICT && !copy.equals(colorMap)) {
            throw new IllegalStateException("Was unable to duplicate provided ColorMap:" + 
                    colorMap);
        }
        pages.push(copy);
    }
    ...
    public void visit(ColorMapEntry colorMapEntry) {
        ...
        if (STRICT && !copy.equals(colorMapEntry)) {
            throw new IllegalStateException("Was unable to duplicate provided ColorMapEntry:" + 
                    colorMapEntry);
        }
        pages.push(copy);
    }
    ...
    public void visit(ImageOutline outline) {
        ...
        if (STRICT && !copy.equals(outline)) {
            throw new IllegalStateException("Was unable to duplicate provided ImageOutline:" + 
                    outline);
        }
        pages.push(copy);
    ...
    public void visit(ChannelSelection cs) {
        ...
        if (STRICT && !copy.equals(cs)) {
            throw new IllegalStateException("Was unable to duplicate provided ChannelSelection:" 
                    + cs);
        }
        pages.push(copy);
    ...
    public void visit(OverlapBehavior ob) {
        ...
        if (behavior.equalsIgnoreCase(OverlapBehavior.AVERAGE_RESCTRICTION)) {
            ...
            throw new IllegalStateException("Was unable to duplicate provided OverlapBehavior:" +
                    ob);
        }
    }

    public void visit(SelectedChannelType sct) {
        final SelectedChannelType copy = sf.createSelectedChannelType(sct.getChannelName(), copy
                (sct.getContrastEnhancement()));
