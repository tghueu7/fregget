...
public class DefaultPeriodDuration extends DefaultDuration implements PeriodDuration {
  ...
  /**
   * A positive integer, followed by the character "M", which indicated the number of months in the
   * period.
   */
  ...
  /**
   * A positive integer, followed by the character "M", which indicated the number of minutes in the
   * period.
   */
  ...
  /**
   * A positive integer, followed by the character "S", which indicated the number of seconds in the
   * period.
   */
  ...
  public long getTimeInMillis() {
    ...
    if ((periodDescription.indexOf('M') != -1 && (periodDescription.indexOf('T') == -1))
      ...
      int nbMonth =
          Integer.parseInt(periodDescription.substring(0, periodDescription.indexOf('M')));
