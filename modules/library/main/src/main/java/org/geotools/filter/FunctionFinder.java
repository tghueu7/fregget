...
public class FunctionFinder {
   ...
   */
  public Function findFunction(
      String name, List<org.opengis.filter.expression.Expression> parameters, Literal fallback) {
   ...
   */
  public Function findFunction(
      Name name, List<org.opengis.filter.expression.Expression> parameters, Literal fallback) {
    // try name as is
