...
public class StyleFactoryImpl extends AbstractStyleFactory
  ...
  public Rule createRule(
    ...
    Rule r =
        new RuleImpl(symbolizers, desc, legends, name, filter, isElseFilter, maxScale, minScale);
  ...
  public Fill createFill(
    ...
    // would be nice to check if this was within bounds but we have to wait until use since it may
  ...
  public Stroke getDefaultStroke() {
    try {
      Stroke stroke =
          createStroke(filterFactory.literal("#000000"), filterFactory.literal(new Integer(1)));
