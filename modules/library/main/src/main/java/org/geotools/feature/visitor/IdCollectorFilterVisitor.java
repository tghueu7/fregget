 ...
 * <p>
 * Example:<code>Set<String> fids = (Set<String>) filter.accept( IdCollectorFilterVisitor
 * .ID_COLLECTOR, new HashSet() );</code>
 *
 * @source $URL$
 */
public class IdCollectorFilterVisitor extends DefaultFilterVisitor {
    ...
    public static final IdCollectorFilterVisitor IDENTIFIER_COLLECTOR = new 
            IdCollectorFilterVisitor(false);
