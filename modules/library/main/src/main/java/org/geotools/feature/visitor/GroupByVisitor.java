...
public class GroupByVisitor implements FeatureCalc, FeatureAttributeVisitor {
  ...
  public CalcResult getResult() {
    ...
    // create the result, if no feature was visited this will be an empty result that can be safely
    // merged
  ...
  public static class GroupByResult implements CalcResult {
    ...
    public boolean isCompatible(CalcResult newResult) {
      ...
      // compatible only if the aggregation visitor is the same and the group by attributes are the
      // same
