...
public class SimplifyingFilterVisitor extends DuplicatingFilterVisitor {
   ...
   * structurally valid and hence can be send down to the backend with confidence it will not cause
   * trouble, the most common one being filtering by pk number even if the type name prefix does not
   * match.
   */
