...
public class FilterTransformer extends TransformerBase {
    ...
    public static class FilterTranslator extends TranslatorSupport implements org.opengis.filter
            .FilterVisitor, org.opengis.filter.expression.ExpressionVisitor {
        ...
        public Object visit(PropertyIsNil filter, Object extraData) {
            ...
            if (filter.getNilReason() != null) {
                atts.addAttribute("", "nilReason", "nilReason", "", filter.getNilReason()
                        .toString());
            }
        ...
        public void encode(Object o) throws IllegalArgumentException {
            if (o instanceof Filter) {
                ...
                throw new IllegalArgumentException("Cannot encode " + (o == null ? "null" : o
                        .getClass().getName()) + " should be Filter or Expression");
            }
        }
