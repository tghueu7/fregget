...
public class Capabilities {
  ...
  static {
    ...
    logicalNames.put(
        And.class, "And"); // not an operator name, see scalarCapabilities.hasLogicalOperators()
    logicalNames.put(
        Or.class, "Or"); // not an operator name, see scalarCapabilities.hasLogicalOperators()
    logicalNames.put(
        Not.class, "Not"); // not an operator name, see scalarCapabilities.hasLogicalOperators()
  }
  ...
  static {
    ...
    filterNames.put(
        Id.class,
        "Id"); // not an operator name, see idCapabilities.hasFID() or idCapabilities.hasEID()
  }
   ...
   *
   * <p>The returned name can be used to check the FilterCapabilities to see if it type is supported
