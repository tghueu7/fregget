    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDisatnce3D argument #0 - " +
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDisatnce3D argument #1 - " +
                            "expected type Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDisatnce3D argument #2 - " +
