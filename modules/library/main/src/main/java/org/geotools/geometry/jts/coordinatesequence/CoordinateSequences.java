...
public class CoordinateSequences extends com.vividsolutions.jts.geom.CoordinateSequences {
    ...
    public static boolean isCCW(CoordinateSequence ring) {
         ...
         */
        if (equals2D(ring, iPrev, hiIndex) || equals2D(ring, iNext, hiIndex) || equals2D(ring, 
                iPrev, iNext))
            return false;
    ...
    public static boolean equalsND(Geometry g1, Geometry g2) {
        ...
        // ok, 2d equal, it means they have the same list of geometries and coordinate sequences,
        // in the same order
