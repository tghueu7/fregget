...
public class CoordinateWriter {
    ...
    public CoordinateWriter(int numDecimals, String tupleDelim, String coordDelim, boolean 
            useDummyZ) {
        this(numDecimals, tupleDelim, coordDelim, useDummyZ, 0);
    }

    public CoordinateWriter(int numDecimals, String tupleDelim, String coordDelim, boolean 
            useDummyZ, double zValue) {
     ...
     * <ul>
     * <li>dimension: is from your CoordinateReferenceSystem; it is the number of axis used by 
     * the coordinate
     ...
     */
    public CoordinateWriter(int numDecimals, String tupleDelim, String coordDelim, boolean useZ, 
        ...
        if ((coordDelim != null) && coordDelim.length() == 0) {
            throw new IllegalArgumentException("Coordinate delimeter cannot be null or zero " +
                    "length");
        }
        D = dimension;
    ...
    public void writeCoordinates(CoordinateSequence c, ContentHandler output)
        ...
        for (int i = 0, n = coordCount; i < n; i++) {
            ...
            boolean zAvailable = coordSeqDimension > 2 && !Double.isNaN(c.getOrdinate(i, 2)) && 
