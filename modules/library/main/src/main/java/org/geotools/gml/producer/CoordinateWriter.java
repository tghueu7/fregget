...
public class CoordinateWriter {
  ...
  public CoordinateWriter(
      int numDecimals, String tupleDelim, String coordDelim, boolean useDummyZ, double zValue) {
   ...
   *       coordinate
   *   <li>useZ: is used to force the use of 3 dimensions (if needed the z value below will be used
   *       for 2D data)
