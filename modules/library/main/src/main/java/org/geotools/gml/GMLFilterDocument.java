...
public class GMLFilterDocument extends org.xml.sax.helpers.XMLFilterImpl {
  ...
  public void startElement(
      ...
      throws SAXException {
    LOGGER.entering(
        "GMLFilterDocument", "startElement", new Object[] {namespaceURI, localName, qName, atts});
   ...
   * internal methods to set the current state of the coordinates reader appropriately.
   *
   * <p>Modified by Sean Geoghegan. When we reach the end of a coord or coordinate element, then the
   ...
   *
   * <p>One of the more annoying features of GML (from a SAX parsing perspective) is the dual coord
   * and coordinate representation of coordinates. To further complicate the matter, delimiters for
   * the coordinates element are quite flexible. This class hides all that nasty complexity beneath
   * a benign exterior and greatly reduces the complexity of the GMLFilterDocument code.
   */
