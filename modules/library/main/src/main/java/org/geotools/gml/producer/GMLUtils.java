...
final class GMLUtils {
  ...
  /**
   * Parses the passed string, and encodes the special characters (used in xml for special purposes)
   * with the appropriate codes. e.g. right bracket char is changed to '&lt;'
   *
