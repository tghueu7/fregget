...
/**
 * Experimental  FeatureReader<SimpleFeatureType, SimpleFeature> that always takes the first 
 * column of the
 ...
 * would just like to have the  FeatureReader<SimpleFeatureType, SimpleFeature> increment one for
 * each feature,
