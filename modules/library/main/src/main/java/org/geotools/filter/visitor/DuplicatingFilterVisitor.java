...
public class DuplicatingFilterVisitor implements FilterVisitor, ExpressionVisitor {
    ...
    public Object visit(PropertyIsGreaterThanOrEqualTo filter, Object extraData) {
        Expression expr1 = visit(filter.getExpression1(), extraData);
        Expression expr2 = visit(filter.getExpression2(), extraData);
        return getFactory(extraData).greaterOrEqual(expr1, expr2, filter.isMatchingCase(), filter
                .getMatchAction());
    }
    ...
    public Object visit(PropertyIsLessThanOrEqualTo filter, Object extraData) {
        Expression expr1 = visit(filter.getExpression1(), extraData);
        Expression expr2 = visit(filter.getExpression2(), extraData);
        return getFactory(extraData).lessOrEqual(expr1, expr2, filter.isMatchingCase(), filter
                .getMatchAction());
    }
    ...
    public Object visit(BBOX filter, Object extraData) {
        ...
        if (!(filter instanceof BBOX3D)) {
            ...
            return getFactory(extraData).bbox(propertyName, minx, miny, maxx, maxy, srs, filter
                    .getMatchAction());
        }
    ...
    public Object visit(PropertyName expression, Object extraData) {
        ...
        return getFactory(extraData).property(expression.getPropertyName(), expression
                .getNamespaceContext());
    }
