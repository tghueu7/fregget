...
public class FilterFunction_equalTo extends FunctionExpressionImpl {
    ...
    public static FunctionName NAME = new FunctionNameImpl("equalTo",
            parameter("equalTo", Boolean.class, "equal to",
                    "Can be used to compare for equality two numbers, two strings, two dates, and" +
                            " so on."),
    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function equalTo argument #0 - expected type " +
                            "Object");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function equalTo argument #1 - expected type " +
                            "Object");
        }
