...
public final class FeatureComparators {
  ...
  /**
   * Create a Comparator which compares Features by the attribute at the given index. The attribute
   * at the index MUST be Comparable. This will probably not work for heterogenous collections,
   * UNLESS the classes at the given index are the same.
   *
