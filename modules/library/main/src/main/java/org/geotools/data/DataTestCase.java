...
public class DataTestCase extends TestCase {
  ...
  protected void dataSetUp() throws Exception {
    ...
    roadType =
        DataUtilities.createType(namespace + ".road", "id:0,geom:LineString,name:String,uuid:UUID");
    ...
    roadFeatures[0] =
        SimpleFeatureBuilder.build(
            roadType,
            new Object[] {
              new Integer(1), line(new int[] {1, 1, 2, 2, 4, 2, 5, 1}), "r1", UUID.randomUUID()
            },
            "road.rd1");
    ...
    roadFeatures[1] =
        SimpleFeatureBuilder.build(
            roadType,
            new Object[] {
              new Integer(2), line(new int[] {3, 0, 3, 2, 3, 3, 3, 4}), "r2", UUID.randomUUID()
            },
            "road.rd2");
    ...
    roadFeatures[2] =
        SimpleFeatureBuilder.build(
            roadType,
            new Object[] {
              new Integer(3), line(new int[] {3, 2, 4, 2, 5, 3}), "r3", UUID.randomUUID()
            },
            "road.rd3");
    ...
    Id create =
        ff.id(new HashSet(Arrays.asList(ff.featureId("road.rd1"), ff.featureId("road.rd2"))));
    ...
    newRoad =
        SimpleFeatureBuilder.build(
            roadType,
            new Object[] {new Integer(4), line(new int[] {1, 2, 2, 3}), "r4", UUID.randomUUID()},
            "road.rd4");
    ...
    riverFeatures[1] =
        SimpleFeatureBuilder.build(
            riverType,
            new Object[] {
              new Integer(2), lines(new int[][] {{4, 6, 4, 8, 6, 10}}), "rv2", new Double(3.0)
            },
            "river.rv2");
    ...
    newRiver =
        SimpleFeatureBuilder.build(
            riverType,
            new Object[] {
              new Integer(3), lines(new int[][] {{9, 5, 11, 5, 13, 3}}), "rv3", new Double(1.5)
            },
            "river.rv3");

    lakeType =
        DataUtilities.createType(namespace + ".lake", "id:0,geom:Polygon:nillable,name:String");
    ...
    lakeFeatures[0] =
        SimpleFeatureBuilder.build(
            lakeType,
            new Object[] {
              new Integer(0), polygon(new int[] {12, 6, 14, 8, 16, 6, 16, 4, 14, 4, 12, 6}), "muddy"
            },
            "lake.lk1");
    ...
    invalidGeomType =
        DataUtilities.createType(namespace + ".invalid", "id:0,geom:Polygon:nillable,name:String");
    ...
    invalidGeomFeatures[0] =
        SimpleFeatureBuilder.build(
            invalidGeomType,
            new Object[] {
              new Integer(0), polygon(new int[] {12, 6, 14, 8, 16, 6, 12, 8, 12, 6}), "notvalid"
            },
            "invalid.inv1");
    invalidGeomBounds = new ReferencedEnvelope();

    buildingType =
        DataUtilities.createType(namespace + ".building", "id:0,geom:Polygon:nillable,name:String");
  ...
  /**
   * Creates a line from the specified (<var>x</var>,<var>y</var>) coordinates. The coordinates are
  ...
  /**
   * Creates a ring from the specified (<var>x</var>,<var>y</var>) coordinates. The coordinates are
   * stored in a flat array.
   */
