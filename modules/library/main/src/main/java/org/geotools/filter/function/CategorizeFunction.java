    ...
    public CategorizeFunction(List<Expression> parameters, Literal fallback) {
        ...
        if (parameters.size() % 2 != 0) {
            ...
            if (PRECEDING.equalsIgnoreCase(lastValue)) {
                ...
                throw new IllegalArgumentException("The valid structure of a categorize function " +
                        "call is " +
                        "\"lookup, value, [threshold, value]*, [succeeding|preceding]\", " +
                        "yet there is a odd number of parameters and the last value is not " +
                        "succeeding nor preceeding");
            }
        }
