...
public class Schema {
    ...
    public Filter getRestrictions(SimpleFeatureType featureType, String name) {
        ...
        List restrictions = restriction(featureType, name, Collections.singletonList(Filter
                .INCLUDE));
    ...
    private AttributeDescriptor override(AttributeDescriptor type, AttributeDescriptor override) {
        ...
        List restrictions = override(type.getType().getRestrictions(), override.getType()
                .getRestrictions());
        ...
        return new AttributeDescriptorImpl(
                new AttributeTypeImpl(new NameImpl(name), javaType, false, false, restrictions, 
                        null, null),
