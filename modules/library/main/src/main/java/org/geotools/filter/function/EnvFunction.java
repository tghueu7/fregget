...
public class EnvFunction extends FunctionExpressionImpl {
  ...
  /**
   * Add a named value to the local (to this thread) lookup table. If the name is already present in
   * the table it will be assigned the new value.
   *
   * @param name the name
  ...
  /**
   * {@inheritDoc} This method is overriden to ignore the fallback value and log a warning message.
   * If you want to set a default value it can be provided as a second argument when calling the
   * function. See the class description for details.
   */
  @Override
