...
public class FilterFunction_int2ddouble extends FunctionExpressionImpl {
    ...
    public static FunctionName NAME = new FunctionNameImpl("int2ddouble", Double.class, parameter
            ("int", Integer.class));
    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function int2ddouble argument #0 - expected type" +
                            " int");
        }
