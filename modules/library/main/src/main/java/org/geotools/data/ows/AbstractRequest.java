...
public abstract class AbstractRequest implements Request {
   ...
   *
   * <p>If properties isn't <code>null</code>, it will use them instead of creating a new Properties
   * object.
   *
   * <p>This constructor will strip all the query parameters off of onlineResource and put them in
   * the properties map. This allows clients to provide their own parameters and have them saved and
   * used along with the OWS specific ones.
   *
   * <p>However, certain parameters will be over-written by individual requests themselves. Examples
   * of such parameters include, but are not limited to:
   *
   * <ul>
   *   <li>WMTVER
   *   <li>REQUEST
