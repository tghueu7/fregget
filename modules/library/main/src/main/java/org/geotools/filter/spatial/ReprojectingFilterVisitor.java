...
public class ReprojectingFilterVisitor extends DuplicatingFilterVisitor {
  ...
  public Object visit(PropertyIsEqualTo filter, Object extraData) {
    return new BinaryComparisonTransformer() {
      ...
      Object cloneFilter(
          BinaryComparisonOperator bso, Object extraData, Expression ex1, Expression ex2) {
  ...
  private abstract class GeometryFilterTransformer {
    Object transform(final BinarySpatialOperator filter, Object extraData) {
      ...
      Expression ex1 =
          (Expression) filter.getExpression1().accept(ReprojectingFilterVisitor.this, extraData);
  ...
  /**
   * Makes sure that the result of a function gets reprojected to the specified CRS, should it be a
   * Geometry
   *
