...
public class SLDTransformer extends TransformerBase {
  ...
  /**
   * Construct a new instance of <code>SLDTransformer</code> with the additional namespace mappings
   * contained in <code>nsBindings</code>.
   *
   * <p>The designated collection contains mappings of {@link URI} to associated prefix (string) to
   * emit in the generated XML element.
   */
  ...
  static class SLDTranslator extends TranslatorSupport implements StyleVisitor {
     ...
     * element.
     *
     * <p>For Example OverlapBehaviour is represented as an expression but v 1.0.0 specifications do
     * not define it as an expression. (&ltAVERAGE/&gt)
     */
