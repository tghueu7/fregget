    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function strSubstring argument #0 - expected " +
                            "type String");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function strSubstring argument #1 - expected " +
                            "type int");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function strSubstring argument #2 - expected " +
                            "type int");
        }
