...
public interface Request {
  ...
  /**
   * Once the properties of the request are configured, this will return the URL that points to the
   * server and contains all of the appropriate name/value parameters.
   *
   ...
   * POST. If this returns true, performPostOutput() will be called during the connection, allowing
   * the data to be written out to the server.
   *
  ...
  /**
   * This is called during the connection to the server, allowing this request to write out data to
   * the server by using the provided outputStream.
   *
