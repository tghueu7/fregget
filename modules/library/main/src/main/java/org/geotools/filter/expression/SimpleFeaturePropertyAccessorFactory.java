...
public class SimpleFeaturePropertyAccessorFactory implements PropertyAccessorFactory {
  ...
  /**
   * Based on definition of valid xml element name at http://www.w3.org/TR/xml/#NT-Name, eventually
   * inclusive of namespace, plus an optional [1] at the end and no @ anywhere in the string
   */
