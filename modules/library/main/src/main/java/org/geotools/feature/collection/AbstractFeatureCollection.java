 ...
 * <ul>
 * <li>{@link #features()}: makes use of {@link DelegateSimpleFeatureIterator} (if needed) to 
 * wrap your iterator up as a SimpleFeatureIterator for
 * public use.</li>
 * </ul>
...
public abstract class AbstractFeatureCollection implements SimpleFeatureCollection {
     ...
     * <p>
     * You are asked to perform the following check when finished with the iterator:<pre> if( e 
     * instanceof FeatureIterator ){
    ...
    public void accepts(org.opengis.feature.FeatureVisitor visitor, org.opengis.util
