...
public class ListenerList {
  ...
  /**
   * The list of listeners. Initially <code>null</code> but initialized to an array of size capacity
   * the first time a listener is added. Maintains invariant: listeners != null IFF size != 0
   */
