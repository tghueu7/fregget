  ...
  public ProjectionHandler getHandler(
    ...
    if (mapProjection instanceof LambertConformal || mapProjection instanceof EquidistantConic) {
      ...
      double centralMeridian =
          params.parameter(AbstractProvider.CENTRAL_MERIDIAN.getName().getCode()).doubleValue();
      double minLat, maxLat;

      double latitudeOrigin;
      if (mapProjection instanceof LambertConformal1SP) {
        latitudeOrigin =
            params.parameter(AbstractProvider.LATITUDE_OF_ORIGIN.getName().getCode()).doubleValue();
      } else {
        double stdParallel1 =
            params
        ...
        double stdParallel2 =
            params
                .parameter(AbstractProvider.STANDARD_PARALLEL_2.getName().getCode())
                .doubleValue();
