...
class FilterNameTypeMapping {
  ...
  public static Map loadComparisonFilterMap() {
    ...
    comparisonsMap.put(
        "Simple_Comparisons", new FilterCapabilities(FilterCapabilities.SIMPLE_COMPARISONS));
  ...
  public static Map loadFilterTypeToFilterCapabilitiesMap() {
    ...
    conversionMap.put(
        new Short(FilterType.LOGIC_AND), new FilterCapabilities(FilterCapabilities.LOGIC_AND));
    conversionMap.put(
        new Short(FilterType.LOGIC_NOT), new FilterCapabilities(FilterCapabilities.LOGIC_NOT));
    conversionMap.put(
        new Short(FilterType.LOGIC_OR), new FilterCapabilities(FilterCapabilities.LOGIC_OR));
    conversionMap.put(
