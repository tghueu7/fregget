...
public class DefaultTemporalCoordinateSystem extends DefaultTemporalReferenceSystem
   ...
   * of those units of measure for time specified by ISO 31-1, or a multiple of one of those units,
   * as specified by ISO 1000.
   */
  ...
  /**
   * Returns the equivalent Date in the Gregorian calendar and UTC of a coordinate value defined in
   * this temporal coordinate system.
   *
   * @param c_value
   * @return
   */
