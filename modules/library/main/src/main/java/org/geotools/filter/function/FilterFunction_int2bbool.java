...
public class FilterFunction_int2bbool extends FunctionExpressionImpl {
    ...
    public static FunctionName NAME = new FunctionNameImpl("int2bbool", Boolean.class, parameter
            ("int", Integer.class));
    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function int2bbool argument #0 - expected type " +
                            "int");
        }
