...
public class SLD {
   ...
   * {@linkplain #color(org.geotools.styling.PointSymbolizer)}.
   *
   * <p>If you are using something fun like symbols you will need to do your own thing.
   *
   * @param symbolizer Point symbolizer information.
   ...
   * will be replaced with modified copies. All symbolizers associated with all rules are modified.
   *
   * @param style the Style object to be updated
   ...
   *
   * <p>This method will update the Style in place; some of the rules & symbolizers will be replace
   * with modified copies. All symbolizes associated with all rules are updated.
   *
   * @param style the Style object to be updated
  ...
  public static Style createPointStyle(
    ...
    Mark mark =
        sf.createMark(ff.literal(wellKnownName), stroke, fill, ff.literal(size), ff.literal(0));
