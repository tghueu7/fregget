...
public abstract class GeometryFilterImpl extends BinaryComparisonAbstract
   ...
   * as this filter. Checks to make sure the filter types are the same as well as the left and right
   * geometries.
   *
   ...
   *     Expression1)
   * @param right the geometry on the right of the equations (the geometry obtained from evaluating
   *     Expression2)
