...
public class ForceCoordinateSystemFeatureResults extends AbstractFeatureCollection {
    ...
    public ForceCoordinateSystemFeatureResults(FeatureCollection<SimpleFeatureType, 
    ...
    public ForceCoordinateSystemFeatureResults(FeatureCollection<SimpleFeatureType, 
            SimpleFeature> results,
                                               CoordinateReferenceSystem forcedCS, boolean 
                                                       forceOnlyMissing) throws IOException, 
            SchemaException {
