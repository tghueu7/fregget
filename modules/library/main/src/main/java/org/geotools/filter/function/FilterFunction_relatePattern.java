    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function relatePattern argument #0 - expected " +
                            "type Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function relatePattern argument #1 - expected " +
                            "type Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function relatePattern argument #2 - expected " +
                            "type String");
        }
