...
public class WKTReader2 extends WKTReader {
  ...
  /**
   * Handles mixed line string notation - either LineString (the default) or CircularCurve. Isolated
   * as a seperate method as I think we will need to call this from the polygon code.
   *
    ...
    while (nextWord.equals(COMMA)) {
      ...
      if (nextWord.equals(L_PAREN)) {
        ...
        LineString lineString =
            geometryFactory.createLineString(coords.toArray(new Coordinate[coords.size()]));
  ...
  /**
   * This method will read a LineString, CircularString or CompoundCurve and return the result as a
   * LinearRing.
   *
   * @return LinearRing
   *     <p>This method expects either "EMPTY", "(", "CIRCULARSTRING", or "COMPOIUNDCURVE" to start
   *     out with.
   * @throws IOException
   * @throws ParseException
   */
