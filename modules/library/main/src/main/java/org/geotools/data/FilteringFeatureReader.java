...
/**
 * Basic support for a  FeatureReader<SimpleFeatureType, SimpleFeature> that does filtering.  I 
 * think that
 ...
 * @source $URL$
 */
public class FilteringFeatureReader<T extends FeatureType, F extends Feature> implements 
