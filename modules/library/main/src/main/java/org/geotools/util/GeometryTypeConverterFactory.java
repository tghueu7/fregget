        ...
        public <T> T convert(Object source, Class<T> target) throws Exception {
          ...
          if (MultiCurvedGeometry.class.isAssignableFrom(target)) {
            ...
            if (converted.isEmpty()) {
              ...
              result =
                  new CompoundCurve(
                      Arrays.asList(converted), converted.getFactory(), Double.MAX_VALUE);
            }
          }
          if (result != null) {
      ...
      return new Converter() {
        ...
        public Object convert(Object source, Class target) throws Exception {
          ...
          if (source instanceof Geometry) {
            ...
            //  - else we firtsly convert the geometry to a <geometry> and then we create a
            // multi<geometry> with the obtained element
            if (MultiPoint.class.isAssignableFrom(target)) {
              ...
              if (sourceGeometry.isEmpty()) lineStrings = new LineString[0];
                ...
                lineStrings =
                    new LineString[] {(LineString) this.convert(source, LineString.class)};
            ...
            // target is a linestring: we return the linestring connecting all the geometry
            // coordinates
              ...
              if (sourceGeometry.isEmpty()) destGeometry = gFac.createLineString(new Coordinate[0]);
                ...
                destGeometry =
                    gFac.createLineString(
                        getLineStringCoordinates(((Geometry) source).getCoordinates()));
              }
            }
            // target is a polygon: we return a polygon connecting all the coordinates of the given
            // geometry
              ...
              if (sourceGeometry.isEmpty()) destGeometry = gFac.createLineString(new Coordinate[0]);
                ...
                destGeometry =
                    gFac.createPolygon(gFac.createLinearRing(coords), new LinearRing[] {});
              }
            }
