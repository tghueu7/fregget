...
public class DefaultPosition implements Position {
  ...
  /**
   * This constructor replace the constructor with further DateTime object which will be included in
   * the futur version of jdk (jdk7). example of datetime argument: format specified by the ISO8601
   * yyyy-mm-DDTHH:MM:SSZ - example : 2003-02-13T12:28:00.000GMT-08:00.
   *
   * @param dateTime
  ...
  /**
   * {@linkplain TemporalPosition} and its subtypes shall be used for describing temporal positions
   * referenced to other reference systems, and may be used for temporal positions referenced to any
   * calendar or clock, including the Gregorian calendar and UTC.
   *
