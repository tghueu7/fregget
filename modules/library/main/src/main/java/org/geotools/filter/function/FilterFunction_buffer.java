...
public class FilterFunction_buffer extends FunctionExpressionImpl implements
    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function buffer argument #0 - expected type " +
                            "Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function buffer argument #1 - expected type " +
                            "double");
        }
    ...
    public ReferencedEnvelope invert(ReferencedEnvelope renderingEnvelope) {
        ...
        Envelope bufferedEnvelope = JTS.toGeometry((Envelope) renderingEnvelope).buffer(buffer)
                .getEnvelopeInternal();
        return new ReferencedEnvelope(bufferedEnvelope, renderingEnvelope
