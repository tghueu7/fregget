 ...
 * @source $URL$
 */
public class DefaultOrdinalReferenceSystem extends DefaultTemporalReferenceSystem implements 
    ...
    public DefaultOrdinalReferenceSystem(ReferenceIdentifier name, Extent domainOfValidity, 
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + (this.ordinalEraSequence != null ? this.ordinalEraSequence.hashCode() 
                : 0);
        return hash;
    }
