...
public class FilterFactoryImpl implements Factory, org.opengis.filter.FilterFactory2 {
    ...
    public PropertyIsLike like(Expression expr, String pattern,
                               String wildcard, String singleChar, String escape, boolean 
                                       matchCase) {
    ...
    public BBOX bbox(Expression geometry, double minx, double miny, double maxx, double maxy, 
                     String srs) {
        return bbox(geometry, minx, miny, maxx, maxy, srs, MatchAction.ANY);
    }


    public BBOX bbox(Expression e, double minx, double miny, double maxx, double maxy, String 
            srs, MatchAction matchAction) {
    ...
    public DWithin dwithin(Expression geometry1, Expression geometry2, double distance, String 
            units) {
    ...
    public Intersects intersects(Expression geometry1, Expression geometry2, MatchAction 
            matchAction) {
    ...
    public Function function(String name, Expression arg1) {
        Function function = functionFinder.findFunction(name, Arrays.asList(new 
                Expression[]{arg1}));
        return function;
    }
     ...
     */
    public Function function(String name, List<org.opengis.filter.expression.Expression> 
    ...
    public Literal literal(boolean b) {
        return b ? new LiteralExpressionImpl(Boolean.TRUE) : new LiteralExpressionImpl(Boolean
                .FALSE);
    }
...
//    public org.geotools.filter.Filter and( org.geotools.filter.Filter filter1, org.geotools
...
//    }
//
//    public org.geotools.filter.Filter or( org.geotools.filter.Filter filter1, org.geotools
// .filter.Filter filter2 ) {
...
//    }
    ...
    public <T> Parameter<T> parameter(String name, Class<T> type, InternationalString title,
                                      InternationalString description, boolean required, int 
                                              minOccurs, int maxOccurs, T defaultValue) {
