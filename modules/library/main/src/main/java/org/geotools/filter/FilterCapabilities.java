...
public class FilterCapabilities {
     ...
     */
    public static final long SIMPLE_COMPARISONS = COMPARE_EQUALS | COMPARE_GREATER_THAN | 
            COMPARE_GREATER_THAN_EQUAL | COMPARE_LESS_THAN | COMPARE_LESS_THAN_EQUAL | 
            COMPARE_NOT_EQUALS;
    ...
    static {
        ...
        intTypeToOpenGisTypeMap.put(new Long(SIMPLE_ARITHMETIC), new Class[]{Add.class, Subtract
                .class, Multiply.class, Divide.class});
        ...
        intTypeToOpenGisTypeMap.put(new Long(COMPARE_GREATER_THAN_EQUAL), 
                PropertyIsGreaterThanOrEqualTo.class);
        intTypeToOpenGisTypeMap.put(new Long(COMPARE_LESS_THAN), PropertyIsLessThan.class);
        intTypeToOpenGisTypeMap.put(new Long(COMPARE_LESS_THAN_EQUAL), 
    ...
    /**
     * Adds a new support type to capabilities.  For 2.2 only function expression support is 
     * added this way.
    ...
    public FilterCapabilities convertFilterTypeToMask(short type) {
        ...
        Object object = FilterNameTypeMapping.filterTypeToFilterCapabilitiesMap.get(new Short
                (type));
     ...
     *                                  function is recursive a null in a logic filter will also 
     *                                  cause
     *                                  an error.
     */
    ...
    public long getScalarOps() {
        return ops & (SIMPLE_ARITHMETIC | SIMPLE_COMPARISONS | FID | FUNCTIONS | LIKE | LOGICAL |
                NULL_CHECK | BETWEEN);
    }
