...
public class DefaultTemporalPosition implements TemporalPosition {
  ...
  /**
   * When this attribute is used with a subtype of {@code TemporalPosition}, it provides a qualifier
    ...
    if (frame == null) {
      frame =
          new DefaultTemporalReferenceSystem(
              new NamedIdentifier(
                  Citations.CRS, new SimpleInternationalString("Gregorian calendar")),
              null);
    }
    return frame;
  }
  ...
  public int hashCode() {
    ...
    hash =
        37 * hash
            + (this.indeterminatePosition != null ? this.indeterminatePosition.hashCode() : 0);
    return hash;
  }
