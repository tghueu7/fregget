...
public interface CSBuilder {
   ...
   * @param dimensions - the dimension of the coordinates in the coordinate sequence, may be ignored
   *     if the coordinate sequence does not support variabile dimensions
   */
