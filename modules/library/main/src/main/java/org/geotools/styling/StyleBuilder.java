...
public class StyleBuilder {
     ...
     * @param rotation         - an Expression representing the rotation from the top of the page
     *                        of the
     *                         graphic
     * @return the graphic created
     */
     ...
     * create a SimpleFeature type styler see the SLD Spec for more details of scaleDenominators
     *
     * @param typeName            - The feature typeName you want to draw (use "Feature" as a 
     *                            wild card to match all)
     * @param symbolizer          - the symbolizer to use
     * @param minScaleDenominator - the minimim scale to draw the feature at
     * @param maxScaleDenominator - the maximum scale to draw the feature at
     * @return the new feature type styler
    ...
    public Style buildClassifiedStyle(
        ...
        LOGGER.fine(
                "added upper class " + breaks[colors.length - 2] + "  " + colors[colors.length - 
                        1]);
     ...
     * @param colors     The colors that will be associated to the categories, break points, or 
     *                   isolated values
    ...
    public ColorMap createColorMap(String[] labels, double[] quantities, Color[] colors, int type) {
        ...
        if ((labels == null) || (quantities == null) || (colors == null) || (labels.length != 
                quantities.length) || (quantities.length != colors.length)) {
            throw new IllegalArgumentException("Labels, quantities and colors arrays should be " +
