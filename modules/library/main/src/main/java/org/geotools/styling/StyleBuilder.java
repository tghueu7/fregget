...
public class StyleBuilder {
   ...
   * @param color an Expression representing the color of the line
   * @param width an Expression representing the width of the line
   * @param opacity an Expression representing opacity the opacity or <I>see throughness</I> of the
   *     line, 0 - is transparent, 1 is completely drawn
   * @return the stroke created
   */
  ...
  /**
   * Creates a default text symbolizer. Warning: there is no definition of a default text symbolizer
   * in the SLD standard, this is provided just for convenience and uniformity with the other
   * symbolizers
   *
   ...
   * create a SimpleFeature type styler see the SLD Spec for more details of scaleDenominators
   *
   * @param typeName - The feature typeName you want to draw (use "Feature" as a wild card to match
   *     all)
   * @param symbolizer - the symbolizer to use
   * @param minScaleDenominator - the minimim scale to draw the feature at
   * @param maxScaleDenominator - the maximum scale to draw the feature at
  ...
  public Style createStyle(
    ...
    FeatureTypeStyle fts =
        createFeatureTypeStyle(typeName, symbolizer, minScaleDenominator, maxScaleDenominator);
