...
public class StandardDeviationVisitor implements FeatureCalc, FeatureAttributeVisitor {
  ...
  /**
   * Constructor left for backwards compatibility. The current algorithm uses a on line computation
   * that does not require the average to be calculated in advance
   *
   * @param expr
   * @param average
