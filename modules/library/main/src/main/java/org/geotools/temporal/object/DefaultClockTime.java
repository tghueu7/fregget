...
public class DefaultClockTime extends DefaultTemporalPosition implements ClockTime {
    ...
    public DefaultClockTime(TemporalReferenceSystem frame, IndeterminateValue 
            indeterminatePosition, Number[] clockTime) {
     ...
     * unit used at the next lower level, and so on. All but the last number in the sequence 
     * shall be
