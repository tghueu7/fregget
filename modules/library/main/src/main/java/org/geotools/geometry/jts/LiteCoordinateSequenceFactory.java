...
public class LiteCoordinateSequenceFactory implements CoordinateSequenceFactory {
   ...
   *
   * <p>This method first checks if <tt>cs</tt> is an instanceof {@link LiteCoordinateSequence}, if
   * it is, itself is returned. If not, <tt>cs</tt> is cloned into a new {@link
