...
public class LiteShape implements Shape, Cloneable {
  ...
  public PathIterator getPathIterator(AffineTransform at) {
    ...
    if (this.geometry instanceof Polygon) {
      ...
      if (combined == affineTransform)
        lineIterator.init(
            (LineString) geometry, combined, generalize, (float) maxDistance, xScale, yScale);
   ...
   * used to perform more accurate computations of geometric intersection for any <code>Shape</code>
