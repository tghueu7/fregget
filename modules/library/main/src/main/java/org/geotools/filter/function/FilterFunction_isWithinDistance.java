    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDistance argument #0 - expected" +
                            " type Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDistance argument #1 - expected" +
                            " type Geometry");
        }
        ...
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function isWithinDistance argument #2 - expected" +
                            " type double");
        }
