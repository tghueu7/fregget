...
public class PostPreProcessFilterSplittingVisitor implements FilterVisitor, ExpressionVisitor {
    ...
    /**
     * Operates similar to postStack.  When a update is determined to affect an attribute 
     * expression the update
     ...
     *
     * @param fcs                 The FilterCapabilties that describes what Filters/Expressions 
     ...
     *                            then different filters
     *                            must be sent to the server.  This class provides a generic way 
     *                            of obtaining the information from the transaction.
     */
    public PostPreProcessFilterSplittingVisitor(FilterCapabilities fcs, SimpleFeatureType parent,
    ...
    /**
     * Gets the filter that cannot be sent to the server and must be post-processed on the client
     * by geotools.
     *
     * @return the filter that cannot be sent to the server and must be post-processed on the 
     * client by geotools.
     */
