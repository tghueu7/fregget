...
public class FunctionNameImpl extends OperatorImpl implements FunctionName {
   ...
   *
   * <ul>
   *   <li>Use a postivie number to indicate the number of arguments. Example: add( number1, number2
   *       ) = 2
   *   <li>Use a negative number to indicate a minimum number: Example: concat( str1, str2,... ) has
   *       -2
   * </ul>
   */
