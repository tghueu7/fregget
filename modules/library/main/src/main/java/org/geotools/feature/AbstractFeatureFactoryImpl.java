...
public abstract class AbstractFeatureFactoryImpl implements FeatureFactory {
    ...
    /**
     * Whether the features to be built should be self validating on construction and value 
     * setting, or not.
    ...
    public SimpleFeature createSimpleFeature(Object[] array,
        ...
        if (type.isAbstract()) {
            throw new IllegalArgumentException("Cannot create an feature of an abstract " +
                    "FeatureType " + type.getTypeName());
        }
