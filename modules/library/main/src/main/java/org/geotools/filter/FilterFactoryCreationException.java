...
public class FilterFactoryCreationException extends java.lang.Exception {
  /**
   * Constructs an instance of <code>StyleFactoryCreationException</code> with the specified detail
   * message.
   *
  ...
  /**
   * Constructs an instance of <code>FilterFactoryCreationException</code> with the specified detail
