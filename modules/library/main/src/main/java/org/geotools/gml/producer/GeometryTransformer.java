...
public class GeometryTransformer extends TransformerBase {
    ...
    public static class GeometryTranslator extends TranslatorSupport {
        ...
        public GeometryTranslator(ContentHandler handler, String prefix, String nsUri, int 
                numDecimals) {
        ...
        public GeometryTranslator(ContentHandler handler, int numDecimals, boolean 
                isDummyZEnabled) {
            this(handler, "gml", GMLUtils.GML_URL, numDecimals, isDummyZEnabled);
        }

        public GeometryTranslator(ContentHandler handler, String prefix, String nsUri, int 
                numDecimals, boolean isDummyZEnabled) {
            this(handler, prefix, nsUri);
         ...
         * @param dimension       If this value is 3; the coordinate.z will be used rather than 
         *                        dummyZ
         *                        since 2.4.1
         */
        public GeometryTranslator(ContentHandler handler, String prefix, String nsUri, int 
                numDecimals, boolean isDummyZEnabled, int dimension) {
            this(handler, prefix, nsUri);
        ...
        protected void encodeNullBounds() {
            ...
            {
                System.out.println("got exception while writing null boundedby:" + e
                        .getLocalizedMessage());
                e.printStackTrace();
            }
            end("null");
