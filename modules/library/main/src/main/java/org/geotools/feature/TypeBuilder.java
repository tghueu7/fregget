...
public class TypeBuilder {
  ...
  /**
   * Create an AssociationDesctiptor, define relationships between ComplexAttribtues (in particular
   * FeatureCollection to members).
   *
   * <p>Example:
   *
   * <pre><code>
   ...
   *
   * <p>You can use this method to map the AttributeType used when addAttribute( String name, Class
   * binding ) is called.
   *
   * @param binding
   * @param type
  ...
  public TypeBuilder association(Name name, AssociationType type) {
    AssociationDescriptor descriptor =
        getTypeFactory()
            .createAssociationDescriptor(type, name, getMinOccurs(), getMaxOccurs(), isNillable());
   ...
   *
   * <p>You can use this method to perform collection opperations before construction. This is most
   ...
   * </ul>
   *
   * The collection class used here should be matched by content described by this type. Explicitly
   * a FeatureType with <code>getProperties() instanceof Set</code> indicates that Features of that
   * FeatureType should maintain a Set of properties where order is not significant.
   *
   ...
   * "default".
   *
   * <p>Considered moving this to the type interface but it would be in appropriate as the user may
