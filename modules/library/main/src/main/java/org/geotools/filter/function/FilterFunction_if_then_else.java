    ...
    public Object evaluate(Object feature) {
        ...
        } catch (Exception e) // probably a type error
        {
            throw new IllegalArgumentException(
                    "Filter Function problem for function if_then_else argument #0 - expected " +
                            "type boolean");
        }
        if (select) {
            try { // attempt to get value and perform conversion
            ...
            {
                throw new IllegalArgumentException(
                        "Filter Function problem for function if_then_else argument #1 - expected" +
                                " type Object");
            }
        } else {
            try { // attempt to get value and perform conversion
            ...
            {
                throw new IllegalArgumentException(
                        "Filter Function problem for function if_then_else argument #2 - expected" +
                                " type Object");
            }
        }
    }
