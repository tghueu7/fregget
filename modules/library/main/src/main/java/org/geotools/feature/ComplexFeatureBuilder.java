            ...
            if (numberOfProperties < minOccurs) {
                ...
                // they're only present on the AttributeDescriptors...
                    ...
                    throw new IllegalStateException(
                            String.format(
                                    "Failed to build feature '%s'; its property '%s' requires at " +
                                            "least %s occurrence(s) but number of occurrences was" +
                                            " %s.",
    ...
    public void append(Name name, Property value) {
        ...
        if (value != null) {
            ...
            if (!providedClass.equals(expectedClass)
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The value provided contains an object of '%s' but the method " +
                                        "expects an object of '%s'.",
        ...
        if (values.containsKey(name)) {
            ...
            if (valueList.size() == maxOccurs) {
                throw new IndexOutOfBoundsException(
                        String.format(
                                "You can't add another object with the name of '%s' because you " +
                                        "already have the maximum number (%s) allowed by the " +
                                        "property descriptor.",
                                name, maxOccurs));
            }
        } else {
