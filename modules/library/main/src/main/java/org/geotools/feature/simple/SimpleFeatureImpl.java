...
public class SimpleFeatureImpl implements SimpleFeature {
     ...
     * @param validating
     */
    public SimpleFeatureImpl(Object[] values, SimpleFeatureType featureType, FeatureId id, 
                             boolean validating) {
        ...
        if (featureType instanceof SimpleFeatureTypeImpl) {
            ...
            synchronized (featureType) {
                ...
                if (cache instanceof Map) {
                    ...
                    Map<String, Integer> generatedIndex = SimpleFeatureTypeImpl.buildIndex
                            (featureType);
    ...
    public void setAttribute(int index, Object value)
        ...
        // first do conversion
        Object converted = Converters.convert(value, getFeatureType().getDescriptor(index)
                .getType().getBinding());
    ...
    public Property getProperty(String name) {
        ...
        if (idx == null) {
            ...
            if (descriptor instanceof GeometryDescriptor) {
                return new GeometryAttributeImpl(values[index], (GeometryDescriptor) descriptor, 
                        null);
            } else {
            ...
            if (values[i] == null) {
                ...
                if (values[i] instanceof Geometry) {
                    if (!(otherAtt instanceof Geometry)) {
                        return false;
                    } else if (!CoordinateSequences.equalsND((Geometry) values[i], (Geometry) 
                            otherAtt)) {
                        return false;
                    }
