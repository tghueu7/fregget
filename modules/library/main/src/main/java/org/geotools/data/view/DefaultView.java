...
public class DefaultView implements SimpleFeatureSource {
    ...
    protected DefaultQuery makeDefinitionQuery(Query query) throws IOException {
        ...
        try {
            ...
            DefaultQuery defaultQuery = new DefaultQuery(typeName, namespace, filter, 
                    maxFeatures, propNames, handle);
     ...
     * @throws DataSourceException If the filter could not meet the limitations of
     *                             definitionQuery
     */
