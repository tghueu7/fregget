...
public interface ClientTransactionAccessor {
   ...
   *     {@link Filter#EXCLUDE} if the attribute path is not supported/encodable to the backend (and
   *     hence any filter including it shall only be evaluated at runtime), or {@code null} if no
   *     behavior change is to be applied.
   */
