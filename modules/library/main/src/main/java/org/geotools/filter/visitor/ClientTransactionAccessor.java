...
public interface ClientTransactionAccessor {
    ...
    /**
     * Returns all the filters indicating deleted feature ANDed together.  This is used to tell 
     * the server what features
     * to NOT return.
     *
     ...
     * (and hence any filter including it shall only be evaluated at runtime), or {@code null} if
     * no behavior
