...
public abstract class CompareFilterImpl extends BinaryComparisonAbstract {
  ...
  protected CompareFilterImpl(
      org.opengis.filter.expression.Expression e1, org.opengis.filter.expression.Expression e2) {
    this(e1, e2, true);
  }
   ...
   * as this filter. Checks to make sure the filter types are the same as well as both of the
   * values.
   *
