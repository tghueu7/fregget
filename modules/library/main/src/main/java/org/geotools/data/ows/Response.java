...
public abstract class Response {
  ...
  /**
   * Returns the InputStream that contains the response from the server. The contents of this stream
   * vary according to the type of request that was made, and whether it was successful or not.
   *
