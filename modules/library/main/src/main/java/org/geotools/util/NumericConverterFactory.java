        ...
        public <T> T convert(Object source, Class<T> target) throws Exception {
            ...
            if (source instanceof Number) {
                ...
                if (BigDecimal.class.equals(target)) {
                    ...
                    if (c == Float.class || c == Integer.class || c == Short.class || c == Byte
                            .class) {
                        return (T) Float.valueOf(number.floatValue());
                        //return (T) new Float(source.toString());
                    }
                } else if (BigInteger.class.equals(target)) {
                    if (BigInteger.class.isAssignableFrom(c) || c == Long.class || c == Integer
                            .class
                    ...
                    if (c == Long.class || c == Integer.class || c == Short.class || c == Byte
                            .class) {
