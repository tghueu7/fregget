...
public class LiteralExpressionImpl extends DefaultExpression implements Literal {
   ...
   * as this expression. Checks to make sure the expression types are the same as well as the
   * literals.
   *
   ...
   * @task REVISIT: missmatched types now considered not equal. This may be a problem when comparing
