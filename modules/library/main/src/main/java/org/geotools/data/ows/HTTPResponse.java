...
public interface HTTPResponse {
  ...
  /**
   * Returns the HTTP response content byte stream, automatically recognizing gzip encoded responses
   * and returning an uncompressing stream if that's the case.
   *
  ...
  /**
   * @return the response charset parsed out of the content type response header, if any, or {@code
   *     null} otherwise.
   */
