...
public class FilterCapabilitiesImpl implements FilterCapabilities {
    ...
    public FilterCapabilitiesImpl(FilterCapabilities copy) {
        ...
        this.id = copy.getIdCapabilities() == null ? null : new IdCapabilitiesImpl(copy
                .getIdCapabilities());
    ...
    private static SpatialCapabiltiesImpl toSpatialCapabiltiesImpl(SpatialCapabilities 
                                                                           spatialCapabilities) {
