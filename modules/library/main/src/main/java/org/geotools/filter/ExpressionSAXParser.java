...
public class ExpressionSAXParser {
  ...
  /**
   * If the message from the SAX characters function should be read. For example when the expression
   * is expecting character values.
   */
   ...
   * @task TODO: this function is a mess, but it's mostly due to filters being loosely coupled with
   *     schemas, so we have to make a lot of guesses.
   * @task TODO: Revisit stripping leading characters. Needed now to get things working, and may be
