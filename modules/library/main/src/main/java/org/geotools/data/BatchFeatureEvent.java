...
public class BatchFeatureEvent extends FeatureEvent {
  ...
  /**
   * This is a weak hash set as we don't need to track changes on FeatureIds that are not being used
   ...
   * code is holding on to these Identifiers waiting to see what the final value will be we are not
   * going to hold onto these for you.
   *
