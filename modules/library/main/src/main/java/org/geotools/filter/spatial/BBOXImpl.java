...
public class BBOXImpl extends AbstractPreparedGeometryFilter implements BBOX {
    ...
    public BBOXImpl(Expression name, double minx, double miny, double maxx, double maxy, String 
            srs) {
        this(name,
    ...
    public BBOXImpl(Expression name, double minx, double miny, double maxx, double maxy,
        ...
        this(name,
                new LiteralExpressionImpl(boundingPolygon(buildEnvelope(minx, maxx, miny, maxy, 
                        srs))),
                matchAction);
        this.srs = srs;
    }
    ...
    private static ReferencedEnvelope buildEnvelope(double minx, double maxx, double miny, double
            maxy, String srs) {
