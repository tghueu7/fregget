...
public class DefaultFeatureLockFactory extends FeatureLockFactory {
   ...
   * 'good enough' although not provable as per security systems. The method used will probably have
   * to be changed later, the api is what is important right now.
   *
