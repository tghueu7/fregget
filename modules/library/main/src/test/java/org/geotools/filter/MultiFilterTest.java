...
public class MultiFilterTest {
    ...
    public void testCompareNumberOperators_All() {
        ...
        filter = fac.between(e1, new LiteralExpressionImpl(34), new LiteralExpressionImpl(300), 
                MatchAction.ALL);
        assertFalse(filter.evaluate(null));

        filter = fac.between(e1, new LiteralExpressionImpl(34), new LiteralExpressionImpl
                (10000000), MatchAction.ALL);
        assertTrue(filter.evaluate(null));
    }
    ...
    public void testCompareNumberOperators_One() {
        ...
        filter = fac.between(e1, new LiteralExpressionImpl(34), new LiteralExpressionImpl(36), 
                MatchAction.ONE);
        assertTrue(filter.evaluate(null));
    }
    ...
    public void testGeometries_One() {
        ...
        filter = fac.equal(new LiteralExpressionImpl(list), new LiteralExpressionImpl(geom4), 
                MatchAction.ONE);
        assertTrue(filter.evaluate(null));
    ...
    public void testGeometries_All() {
        ...
        filter = fac.intersects(new LiteralExpressionImpl(geom1), new LiteralExpressionImpl(list)
                , MatchAction.ALL);
        assertTrue(filter.evaluate(null));
