...
public class FilterFunction_offsetTest {
    ...
    public void testInvert() {
        ...
        Function function = ff.function("offset", ff.property("the_geom"), ff.literal(1), ff
                .literal(2));
        ...
        ReferencedEnvelope expected = new ReferencedEnvelope(-1, 0, -2, -1, DefaultGeographicCRS
                .WGS84);
