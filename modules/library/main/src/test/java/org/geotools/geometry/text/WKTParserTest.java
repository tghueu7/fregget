...
public class WKTParserTest extends TestCase {
    // TODO: POLYGON ((280 380, 280 200, 60 200, 60 380, 180 220, 280 380),(40 160, 260 160, 240 
    // 60, 20 80, 40 160))
    WKTParser parser;
    ...
    public void testLine2() throws Exception {
        String WKT = "LINESTRING (80 360, 520 360, 520 40, 120 40, 120 300, 460 300, 460 100, 200" +
                " 100, 200 240, 400 240, 400 140, 560 0)";
