...
public class AttributeBuilderTest {
        ...
        try {
            ...
            ExceptionChecker
                    .assertExceptionMessage(
                            iae,
                            "Could not locate attribute: urn:org:example:INVALID_NAME in type: " +
                                    "urn:org:example:MineNameType");
        }
    }
    ...
    public void build_typeIsMineNameTypeAndAddedDataIsValid_buildsAComplexAttributeImpl() {
        ...
        // Assert
        Assert.assertEquals(
                "ComplexAttributeImpl:MineNameType=[AttributeImpl:isPreferred<boolean id=test_id " +
                        "1>=true, AttributeImpl:mineName<string id=test_id>=Sharlston Colliery]",
                MineName.toString());
    }
}
