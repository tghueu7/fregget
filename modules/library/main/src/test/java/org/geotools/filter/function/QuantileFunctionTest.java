...
public class QuantileFunctionTest extends FunctionTestSupport {
    ...
    public void testSingleBin() throws Exception {
        ...
        SimpleFeatureType dataType = DataUtilities.createType("classification.test1", "id:0," +
                "value:int");
        ...
        org.opengis.filter.expression.Expression function = ff.function("Quantile", ff.property
                ("value"), ff.literal(5));
