...
public class FilteringFeatureReaderTest extends DataTestCase {
    ...
    public void testFilteringFeatureReaderALL() throws IOException {
        ...
        reader = new FilteringFeatureReader<SimpleFeatureType, SimpleFeature>(DataUtilities
                .reader(roadFeatures), Filter.EXCLUDE);
        try {
    ...
    public void testFilteringFeatureReaderNONE() throws IOException {
        FeatureReader<SimpleFeatureType, SimpleFeature> reader;
        reader = new FilteringFeatureReader<SimpleFeatureType, SimpleFeature>(DataUtilities
                .reader(roadFeatures), Filter.INCLUDE);
        try {
    ...
    void assertContents(SimpleFeature expected[], FeatureReader<SimpleFeatureType, SimpleFeature>
