...
public class GroupByVisitorTest {
    ...
    SimpleFeature[] buildingFeatures =
        new SimpleFeature[] {
          SimpleFeatureBuilder.build(
              buildingType,
              new Object[] {
                1, "SCHOOL_A", "SCHOOL", "FLOWING_WATER", 50.0, wktParser.read("POINT(-5 -5)")
              },
              null),
          SimpleFeatureBuilder.build(
              buildingType,
          ...
          SimpleFeatureBuilder.build(
              buildingType,
              new Object[] {
                7, "FABRIC_A", "FABRIC", "FLOWING_WATER", 500.0, wktParser.read("POINT(-5 5)")
              },
              null),
          SimpleFeatureBuilder.build(
              buildingType,
  ...
  public void testMergingGroupByResults() throws Exception {
        ...
        DataUtilities.collection(
            new SimpleFeature[] {
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    1, "SCHOOL_C", "SCHOOL", "NUCLEAR", 100.0, wktParser.read("POINT(-15 -15)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    1, "SCHOOL_C", "SCHOOL", "FUEL", 15.0, wktParser.read("POINT(-15 -15)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    2, "FABRIC_C", "FABRIC", "NUCLEAR", 250.0, wktParser.read("POINT(-25 -25)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    2, "FABRIC_C", "FABRIC", "WIND", 75.0, wktParser.read("POINT(-25 -25)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    2, "HOUSE_C", "HOUSE", "WIND", 10.0, wktParser.read("POINT(-35 -35)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    2, "HOUSE_C", "HOUSE", "DARK_MATTER", 850.0, wktParser.read("POINT(-35 -35)")
                  },
                  null),
              SimpleFeatureBuilder.build(
                  buildingType,
                  new Object[] {
                    2, "THEATER_A", "THEATER", "WIND", 200.0, wktParser.read("POINT(-45 -45)")
                  },
                  null)
            });
    // we visit the first feature collection calculating the energy consumption average by building
    // type
    GroupByVisitor visitorA =
        executeVisitor(
            featureCollectionA, "energy_consumption", "Average", new String[] {"building_type"});
    checkResults(
        visitorA.getResult(),
        new Object[][] {
          new Object[] {"SCHOOL", 30.0},
    ...
    // we visit the second feature collection calculating the energy consumption average by building
    // type
    GroupByVisitor visitorB =
        executeVisitor(
            featureCollectionB, "energy_consumption", "Average", new String[] {"building_type"});
    checkResults(
        visitorB.getResult(),
        new Object[][] {
  ...
  private void testVisitor(
      ...
      throws Exception {
    testVisitor(
        aggregateAttribute, aggregateVisitor, new String[] {groupByAttribute}, expectedResults);
  }
