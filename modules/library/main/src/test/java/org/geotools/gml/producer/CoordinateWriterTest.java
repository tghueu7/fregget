...
public class CoordinateWriterTest extends TestCase {
    ...
    public void test2DCoordSeq() throws Exception {
        CoordinateSequence coords = new CoordinateArraySequence(coords2D(new int[]{1, 1, 4, 4, 0,
                4, 1, 1}));
    ...
    public void test3DCoordSeq() throws Exception {
        CoordinateSequence coords = new CoordinateArraySequence(coords3D(new int[]{1, 1, 3, 4, 4,
                2, 0, 4, 2, 1, 1, 3}));
