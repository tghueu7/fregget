...
public class ListFeatureCollectionTest {
    ...
    public void threeDimensionalFeatureBounds() {
        ...
        SimpleFeature f1 = SimpleFeatureBuilder.build(type, new Object[]{"testFeature1", gf
                .createPoint(new Coordinate(10, 20, 30))}, null);
        SimpleFeature f2 = SimpleFeatureBuilder.build(type, new Object[]{"testFeature2", gf
                .createPoint(new Coordinate(10, 10, 60))}, null);
        SimpleFeature f3 = SimpleFeatureBuilder.build(type, new Object[]{"testFeature2", gf
                .createPoint(new Coordinate(1, 10, 6))}, null);
