...
public class SimpleFeatureImplTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        schema = DataUtilities.createType("buildings", "the_geom:Geometry,name:String," +
                "ADDRESS:String");
        feature = SimpleFeatureBuilder.build(schema, new Object[]{null, "ABC", "Random Road, " +
                "12"}, "building.1");
        wkt = new WKTReader();
    }
    ...
    public void testGeometryPropertyType() {
        assertTrue("expected GeometryAttribute, got " + feature.getProperty("the_geom").getClass
                        ().getName(),
    ...
    public void testSetValue() {
        ...
        SimpleFeature myFeature = SimpleFeatureBuilder.build(schema, new Object[]{null, null, 
                null}, "building.2");
    ...
    public void testCompare2D() throws ParseException {
        SimpleFeature f1 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2)")
                , "ABC", "Random Road, 12"}, "building.1");
        SimpleFeature f2 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2)")
                , "ABC", "Random Road, 12"}, "building.1");
        SimpleFeature f3 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(3 4)")
                , "ABC", "Random Road, 12"}, "building.1");
        assertEquals(f1, f2);
    ...
    public void testCompare3D() throws ParseException {
        SimpleFeature f1 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2)")
                , "ABC", "Random Road, 12"}, "building.1");
        SimpleFeature f2 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2 " +
                "15)"), "ABC", "Random Road, 12"}, "building.1");
        SimpleFeature f3 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2 " +
                "18)"), "ABC", "Random Road, 12"}, "building.1");
        SimpleFeature f4 = SimpleFeatureBuilder.build(schema, new Object[]{wkt.read("POINT(1 2 " +
                "18)"), "ABC", "Random Road, 12"}, "building.1");
