...
public class LiteShapeTest extends TestCase {
    ...
    public void testCloning() throws TransformException, FactoryException {
        ...
        LiteShape2 ltCloning = new LiteShape2(ls, ProjectiveTransform.create(AffineTransform
                .getScaleInstance(10, 10)), new Decimator(4, 4), true);
        assertTrue(ls.equalsExact(copy));

        LiteShape2 ltNotCloning = new LiteShape2(ls, ProjectiveTransform.create(AffineTransform
                .getScaleInstance(10, 10)), new Decimator(4, 4), true, false);
