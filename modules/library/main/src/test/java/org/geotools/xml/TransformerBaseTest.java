...
public class TransformerBaseTest extends TestCase {
    ...
    public void testUnbufferedUsageNoErrors() throws FileNotFoundException, TransformerException {
        String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><test:integers " +
                "xmlns=\"http://geotools.org/test\" xmlns:test=\"http://geotools" +
                ".org/test\"><test:integer>1</test:integer><test:integer>2</test:integer><test" +
                ":integer>3</test:integer><test:integer>4</test:integer><test:integer>5</test" +
                ":integer><test:integer>6</test:integer><test:integer>7</test:integer><test" +
                ":integer>8</test:integer><test:integer>9</test:integer><test:integer>10</test" +
    ...
    public void testUnbufferedUsageOneError() throws FileNotFoundException, TransformerException {
        ...
        try {
            ...
            String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><test:integers " +
                    "xmlns=\"http://geotools.org/test\" xmlns:test=\"http://geotools" +
                    ".org/test\"><test:integer>1</test:integer><test:integer>2</test:integer" +
                    "><test:integer>3</test:integer><test:integer>4</test:integer><test:integer>5" +
                    "</test:integer><test:integer>6</test:integer><test:integer>7</test:integer" +
                    "><test:integer>8</test:integer><test:integer>9</test:integer><test:integer" +
                    ">10</test:integer>";
    ...
    public void testBufferedUsageOneError() throws FileNotFoundException, TransformerException {
        ...
        try {
            ...
            String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><test:integers " +
                    ...
                    "><test:integer>3</test:integer><test:integer>4</test:integer><test:integer>5" +
                    "</test:integer><test:integer>6</test:integer><test:integer>7</test:integer" +
                    "><test:integer>8</test:integer><test:integer>9</test:integer>";
            String actual = w.toString();
            assertEquals(expected, actual);
        }
    }

    public void testBufferedUsageIgnoringOneError() throws FileNotFoundException, 
        ...
        String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><test:integers " +
                ...
                ":integer>3</test:integer><test:integer>4</test:integer><test:integer>5</test" +
                ":integer><test:integer>6</test:integer><test:integer>7</test:integer><test" +
                ":integer>8</test:integer><test:integer>9</test:integer></test:integers>";
        String actual = tx.transform(10);
        assertEquals(expected, actual);
    }

    public void testBufferedUsageIgnoringMultipleErrors() throws FileNotFoundException, 
            TransformerException {
        ExampleTransformer tx = new ExampleTransformer(1, 2, true);
        String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><test:integers " +
                "xmlns=\"http://geotools.org/test\" xmlns:test=\"http://geotools" +
                ".org/test\"><test:integer>1</test:integer><test:integer>3</test:integer><test" +
                ":integer>5</test:integer><test:integer>7</test:integer><test:integer>9</test" +
                ":integer></test:integers>";
        String actual = tx.transform(10);
        assertEquals(expected, actual);
    }
