...
public class EqualIntervalFunctionTest extends FunctionTestSupport {
    ...
    private static final org.opengis.filter.FilterFactory ff = CommonFactoryFinder
    ...
    public static junit.framework.Test suite() {
        junit.framework.TestSuite suite = new junit.framework.TestSuite(EqualIntervalFunctionTest
                .class);
        return suite;
    }
    ...
    public void testInstance() {
        Function equInt = ff.function("EqualInterval", org.opengis.filter.expression.Expression
                .NIL);
    ...
    /**
     * Test of setNumberOfClasses method, of class org.geotools.filter.functions
    ...
    public void testSetClasses() throws Exception {
        ...
        EqualIntervalFunction func = (EqualIntervalFunction) ff.function("EqualInterval", 
                property, literal);
    ...
    public void testEvaulateWithStrings() throws Exception {
        org.opengis.filter.expression.Expression function = ff.function("EqualInterval", ff
                .property("group"), ff.literal(5));
        Classifier classifier = (Classifier) function.evaluate(featureCollection);
        assertNotNull(classifier);

        Classifier classifier2 = (Classifier) function.evaluate(featureCollection, Classifier
                .class);
