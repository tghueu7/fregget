...
public class StringFunctionTest {
  ...
  public void testParseLong() {
    assertEquals(
        Long.MAX_VALUE, ff.function("parseLong", ff.literal(Long.MAX_VALUE + "")).evaluate(null));
  ...
  public void testStrSubstring() throws Exception {
    ...
    assertEquals(
        "",
        ff.function("strSubstring", ff.literal(""), ff.literal(0), ff.literal(0)).evaluate(null));
  ...
  public void testStrSubstringStart() throws Exception {
    ...
    assertNull(ff.function("strSubstringStart", ff.literal("ABCD"), ff.literal(-1)).evaluate(null));
    assertNull(ff.function("strSubstringStart", ff.literal("ABCD"), ff.literal(5)).evaluate(null));
    // test empty string input
    assertEquals(
    ...
    // test non-empty substrings
    assertEquals(
        "ABCD", ff.function("strSubstringStart", ff.literal("ABCD"), ff.literal(0)).evaluate(null));
    assertEquals(
        "CD", ff.function("strSubstringStart", ff.literal("ABCD"), ff.literal(2)).evaluate(null));
    assertEquals(
