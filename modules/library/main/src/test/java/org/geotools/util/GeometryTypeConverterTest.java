...
public class GeometryTypeConverterTest extends TestCase {
    ...
    protected Converter getConverter(Geometry source, Class<?> target) {
        ...
        fail("Cannot get ConverterFactory for " + source.getClass().getName() + " -> " + target
                .getClass().getName() + " conversion");
        return null;
    }
    ...
    public void testData() throws Exception {
        for (String test : tests) {
            ...
            assertEquals("Test rows should have the form \"source:target:expected:description\"",
                    4, parts.length);
