...
public class FilterFunction_Test extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    assertEquals("Literal Expression 0.0", new Double(1.0), literal_1.evaluate(null, Double.class));
    assertEquals(
        "Literal Expression pi", new Double(Math.PI), literal_pi.evaluate(null, Double.class));
    assertEquals(
  ...
  public void testsin() {
    try {
      ...
      if (Double.isNaN(good0)) {
        assertTrue(
            "sin of (1.0):", Double.isNaN(((Double) sinFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "sin of (1.0):",
            (double) Math.sin(1.0),
      ...
      if (Double.isNaN(good2)) {
        assertTrue(
            "sin of (2.0):", Double.isNaN(((Double) sinFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "sin of (2.0):",
            (double) Math.sin(2.0),
  ...
  public void testcos() {
    try {
      ...
      if (Double.isNaN(good0)) {
        assertTrue(
            "cos of (1.0):", Double.isNaN(((Double) cosFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "cos of (1.0):",
            (double) Math.cos(1.0),
      ...
      if (Double.isNaN(good2)) {
        assertTrue(
            "cos of (2.0):", Double.isNaN(((Double) cosFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "cos of (2.0):",
            (double) Math.cos(2.0),
  ...
  public void testtan() {
    try {
      ...
      if (Double.isNaN(good0)) {
        assertTrue(
            "tan of (1.0):", Double.isNaN(((Double) tanFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "tan of (1.0):",
            (double) Math.tan(1.0),
      ...
      if (Double.isNaN(good2)) {
        assertTrue(
            "tan of (2.0):", Double.isNaN(((Double) tanFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "tan of (2.0):",
            (double) Math.tan(2.0),
  ...
  public void testsqrt() {
    try {
      FilterFunction_sqrt sqrt =
          (FilterFunction_sqrt) ff.function("sqrt", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testmin() {
    try {
      FilterFunction_min min =
          (FilterFunction_min) ff.function("min", new org.opengis.filter.expression.Expression[2]);
  ...
  public void testmax() {
    try {
      FilterFunction_max max =
          (FilterFunction_max) ff.function("max", new org.opengis.filter.expression.Expression[2]);
  ...
  public void testacos() {
    try {
      FilterFunction_acos acos =
          (FilterFunction_acos) ff.function("acos", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testatan() {
    try {
      FilterFunction_atan atan =
          (FilterFunction_atan) ff.function("atan", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testceil() {
    try {
      FilterFunction_ceil ceil =
          (FilterFunction_ceil) ff.function("ceil", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testexp() {
    try {
      ...
      if (Double.isNaN(good0)) {
        assertTrue(
            "exp of (1.0):", Double.isNaN(((Double) expFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "exp of (1.0):",
            (double) Math.exp(1.0),
      ...
      if (Double.isNaN(good2)) {
        assertTrue(
            "exp of (2.0):", Double.isNaN(((Double) expFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "exp of (2.0):",
            (double) Math.exp(2.0),
  ...
  public void testfloor() {
    try {
      FilterFunction_floor floor =
          (FilterFunction_floor) ff.function("floor", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testlog() {
    try {
      FilterFunction_log log =
          (FilterFunction_log) ff.function("log", org.opengis.filter.expression.Expression.NIL);
      ...
      if (Double.isNaN(good0)) {
        assertTrue(
            "log of (1.0):", Double.isNaN(((Double) logFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "log of (1.0):",
            (double) Math.log(1.0),
      ...
      if (Double.isNaN(good2)) {
        assertTrue(
            "log of (2.0):", Double.isNaN(((Double) logFunction.evaluate(null)).doubleValue()));
      } else {
        assertEquals(
            "log of (2.0):",
            (double) Math.log(2.0),
  ...
  public void testrint() {
    try {
      FilterFunction_rint rint =
          (FilterFunction_rint) ff.function("rint", org.opengis.filter.expression.Expression.NIL);
  ...
  public void testround() {
    try {
      FilterFunction_round round =
          (FilterFunction_round) ff.function("round", org.opengis.filter.expression.Expression.NIL);
