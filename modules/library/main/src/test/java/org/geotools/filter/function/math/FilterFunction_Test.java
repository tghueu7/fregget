...
public class FilterFunction_Test extends TestCase {
    ...
    public void testsin() {
        try {
            FilterFunction_sin sin = (FilterFunction_sin) ff.function("sin", org.opengis.filter
    ...
    public void testcos() {
        try {
            ...
            FilterFunction_cos cos = (FilterFunction_cos) ff.function("cos", org.opengis.filter
                    .expression.Expression.NIL);
    ...
    public void testabs() {
        try {
            FilterFunction_abs abs = (FilterFunction_abs) ff.function("abs", org.opengis.filter
                    .expression.Expression.NIL);
    ...
    public void testabs_2() {
        try {
            FilterFunction_abs_4 abs_4 = (FilterFunction_abs_4) ff.function("abs_4", org.opengis
    ...
    public void testabs_3() {
        try {
            FilterFunction_abs_3 abs_3 = (FilterFunction_abs_3) ff.function("abs_3", org.opengis
                    .filter.expression.Expression.NIL);
    ...
    public void testabs_4() {
        try {
            FilterFunction_abs_2 abs_2 = (FilterFunction_abs_2) ff.function("abs_2", org.opengis
                    .filter.expression.Expression.NIL);
    ...
    public void testIEEEremainder() {
        try {
            FilterFunction_IEEEremainder IEEEremainder = (FilterFunction_IEEEremainder) ff
                    .function("IEEEremainder",
                    org.opengis.filter.expression.Expression.NIL,
                    org.opengis.filter.expression.Expression.NIL);
            assertEquals("Name is, ", "IEEEremainder", IEEEremainder.getName());
            assertEquals("Number of arguments, ", 2, IEEEremainder.getFunctionName()
                    .getArgumentCount());
    ...
    public void testround() {
        try {
            FilterFunction_round round = (FilterFunction_round) ff.function("round", org.opengis
                    .filter.expression.Expression.NIL);
    ...
    public void testround_2() {
        try {
            FilterFunction_round_2 round_2 = (FilterFunction_round_2) ff.function("round_2", org
                    .opengis.filter.expression.Expression.NIL);
