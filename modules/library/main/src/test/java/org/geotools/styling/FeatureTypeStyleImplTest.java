...
public class FeatureTypeStyleImplTest extends TestCase {
    ...
    public void testCloneMethod() throws Exception {
        ...
        assertTrue("orig: semanticTypeIdentifiers must not be null", original
                .semanticTypeIdentifiers() != null);
        assertTrue("orig: three semanticTypeIdentifiers expected", original
                .semanticTypeIdentifiers().size() == 3);
        ...
        assertTrue("clone: rules collection should have been cloned", clone.rules() != original
                .rules());
        ...
        assertTrue("clone: semanticTypeIdentifiers collection should have been cloned", clone
                .featureTypeNames() != original.featureTypeNames());
        assertTrue("clone: semanticTypeIdentifiers must not be null", clone
                .semanticTypeIdentifiers() != null);
        assertTrue("clone: three semanticTypeIdentifiers expected", clone.semanticTypeIdentifiers
                ().size() == 3);
        assertTrue("clone: semanticTypeIdentifiers collection should have been cloned", clone
                .semanticTypeIdentifiers() != original.semanticTypeIdentifiers());
    }
}
