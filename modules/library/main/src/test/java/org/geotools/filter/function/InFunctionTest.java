...
public class InFunctionTest extends FunctionTestSupport {
  ...
  public void testDoubleMissing() {
    ...
    Function func =
        ff.function(
            FUNCTION_NAME, exp, ff.literal(2.499999), ff.literal("2.500001"), ff.literal(2));
    Object result = func.evaluate(feature);
    assertEquals(false, result);
  }
  ...
  public void testStringMissing() {
    ...
    Function func =
        ff.function(
            FUNCTION_NAME, exp, ff.literal("Group1"), ff.literal("Group2"), ff.literal("Group3"));
    Object result = func.evaluate(feature);
    assertEquals(false, result);
  }
  ...
  public void testMixedType() {
    PropertyName exp = ff.property("group");
    Expression[] args =
        new Expression[] {exp, ff.literal(1), ff.literal(2.5), ff.literal("Group1"), ff.literal(4)};
