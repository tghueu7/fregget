...
public class ColorFunctionsTest {
  ...
  public void testSaturateRelative() {
    Function function =
        FF.function("saturate", FF.literal("#80e619"), FF.literal("10%"), FF.literal("relative"));
    Color result = (Color) function.evaluate(null);
  ...
  public void testDesaturateRelative() {
    Function function =
        FF.function("desaturate", FF.literal("#80e619"), FF.literal("10%"), FF.literal("relative"));
    Color result = (Color) function.evaluate(null);
  ...
  public void testContrastDarkLigthReference() {
    Function function =
        FF.function(
            "contrast", FF.literal("#222222"), FF.literal("#101010"), FF.literal("#dddddd"));
    Color result = (Color) function.evaluate(null);
