...
public class StandardDeviationFunctionTest extends FunctionTestSupport {
    ...
    public static junit.framework.Test suite() {
        junit.framework.TestSuite suite = new junit.framework.TestSuite
                (StandardDeviationFunctionTest.class);

        return suite;
    }

    public void testInstance() {
        Function stdDev = ff.function("StandardDeviation", ff.literal(FeatureCollections
                .newCollection()));
        assertNotNull(stdDev);
    }

    public void testGetName() {
        Function equInt = ff.function("StandardDeviation", ff.literal(FeatureCollections
                .newCollection()));
    ...
    public void testSetNumberOfClasses() throws Exception {
        ...
        StandardDeviationFunction func = (StandardDeviationFunction) ff.function
                ("StandardDeviation", exp, classes);
    ...
    public void testGetValue() throws Exception {
        ...
        final Classifier classifer = standardDeviation.evaluate(featureCollection, Classifier
                .class);
