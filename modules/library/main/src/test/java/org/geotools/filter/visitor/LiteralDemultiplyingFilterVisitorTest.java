...
public class LiteralDemultiplyingFilterVisitorTest {
    ...
    public void testBinaryComparisonFilter() throws IllegalFilterException {
        ...
        Filter expected = fac.or(new ArrayList<Filter>(Arrays.asList(fac.greater(property, 
                literal1, true, MatchAction.ANY), fac.greater(property, literal2, true, 
                MatchAction.ANY), fac.greater(property, literal3, true, MatchAction.ANY))));
        ...
        expected = fac.and(new ArrayList<Filter>(Arrays.asList(fac.greater(property, literal1, 
                true, MatchAction.ALL), fac.greater(property, literal2, true, MatchAction.ALL), 
    ...
    public void testBinarySpatialFilter() throws IllegalFilterException {
        ...
        Filter expected = fac.or(new ArrayList<Filter>(Arrays.asList(fac.beyond(property, 
                literal1, 5, "x", MatchAction.ANY), fac.beyond(property, literal2, 5, "x", 
                MatchAction.ANY), fac.beyond(property, literal3, 5, "x", MatchAction.ANY))));
        ...
        expected = fac.and(new ArrayList<Filter>(Arrays.asList(fac.beyond(property, literal1, 5, 
                "x", MatchAction.ANY), fac.beyond(property, literal2, 5, "x", MatchAction.ANY), 
    ...
    public void testBinaryTemporalFilter() throws IllegalFilterException {
        ...
        Filter expected = fac.or(new ArrayList<Filter>(Arrays.asList(fac.after(property, 
                literal1, MatchAction.ANY), fac.after(property, literal2, MatchAction.ANY), fac
                .after(property, literal3, MatchAction.ANY))));
        ...
        expected = fac.and(new ArrayList<Filter>(Arrays.asList(fac.after(property, literal1, 
                MatchAction.ALL), fac.after(property, literal2, MatchAction.ALL), fac.after
                (property, literal3, MatchAction.ALL))));
