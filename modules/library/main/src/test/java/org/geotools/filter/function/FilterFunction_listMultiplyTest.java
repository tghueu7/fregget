...
public class FilterFunction_listMultiplyTest {
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < dashArrays.length; i++) {
            testFeatures[i] = SimpleFeatureBuilder.build(dataType,
                    new Object[]{i + 1, fac.createPoint(new Coordinate(i, i)), dashArrays[i]}, 
                    "obj:" + i);
        }
    }
    ...
    public void testEvaluate() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2), ff.literal("1 2 3"));
    ...
    public void testEvaluate2() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2.5), ff.literal("1 2 3"));
        Object evaluate = func.evaluate(null);
        assertTrue(evaluate instanceof String);
    ...
    public void testEvaluateNull() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2.5), ff.literal((String) null));
        Object evaluate = func.evaluate(null);
        assertNull(evaluate);
    }
    ...
    public void testEvaluate4() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(1), ff.literal("1 2 3"));
        Object evaluate = func.evaluate(null);
        assertTrue(evaluate instanceof String);
    ...
    public void testEvaluateNullDasharray() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2.5), null);
        Object evaluate = func.evaluate(null);
        assertNull(evaluate);
    }
    ...
    public void testEvaluateEmptyDasharray() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2.5), ff.literal(""));
        Object evaluate = func.evaluate(null);
        assertNull(evaluate);
    }
    ...
    public void testEvaluateSingleValue() {
        FilterFunction_listMultiply func = (FilterFunction_listMultiply) ff.function
                ("listMultiply", ff.literal(2), ff.literal(" 1"));
        Object evaluate = func.evaluate(null);
        assertTrue(evaluate instanceof String);
