...
public class WKTReader2Test {
    ...
    public void verifyWKT() throws Exception {
        String WKT = "LINESTRING (60 380, 60 20, 200 400, 280 20, 360 400, 420 20, 500 400, 580 " +
                "20, 620 400)";
    ...
    public void circularString() throws Exception {
        String WKT = "CIRCULARSTRING(220268.439465645 150415.359530563, 220227.333322076 " +
                "150505.561285879, 220227.353105332 150406.434743975)";
        ...
        WKT = "CIRCULARSTRING(143.62025166838282 -30.037497356076827, 142.92857147299705 " +
                "-32.75101196874403, 145.96132309891922 -34.985671061528784, 149.57565307617188 " +
                "-33.41153335571289, 149.41972407584802 -29.824672680573517, 146.1209416055467 " +
        ...
        WKT = "CIRCULARSTRING(143.62025166838282 -30.037497356076827, 142.92857147299705 " +
                "-32.75101196874403, 143.62025166838282 -30.037497356076827)";
        geometry = reader.read(WKT);
    ...
    public void compoundCurve() throws Exception {
        String WKT = "COMPOUNDCURVE((153.72942375 -27.21757040, 152.29285719 -29.23940482, " +
                "154.74034096 -30.51635287),CIRCULARSTRING(154.74034096 -30.51635287, " +
                "154.74034096 -30.51635287, 152.39926953 -32.16574411, 155.11278414 -34.08116619," +
        ...
        WKT = "COMPOUNDCURVE((153.72942375 -27.21757040, 152.29285719 -29.23940482, 154.74034096 " +
                "-30.51635287))";
        geometry = reader.read(WKT);
        assertNotNull(geometry);

        WKT = "COMPOUNDCURVE(CIRCULARSTRING(154.74034096 -30.51635287, 154.74034096 -30.51635287," +
    ...
    public void curvePolygon() throws Exception {
        ...
        WKT = "CURVEPOLYGON(CIRCULARSTRING(143.62025166838282 -30.037497356076827, " +
                "142.92857147299705 -32.75101196874403, 143.62025166838282 -30.037497356076827))";
        geometry = reader.read(WKT);
        ...
        WKT = "CURVEPOLYGON((144.84399355252685 -31.26123924022086, 144.20551952601693 " +
        ...
        WKT = "CURVEPOLYGON(" +
                "CIRCULARSTRING(143.62025166838282 -30.037497356076827, 142.92857147299705 " +
                "-32.75101196874403, 145.96132309891922 -34.985671061528784, 149.57565307617188 " +
                "-33.41153335571289, 149.41972407584802 -29.824672680573517, 146.1209416055467 " +
                "-30.19711586270431, 143.62025166838282 -30.037497356076827)," +
                "(144.84399355252685 -31.26123924022086, 144.20551952601693 -32.27215644886158, " +
                "145.55230712890625 -33.49203872680664, 147.97080993652344 -32.03618621826172, " +
                "146.38697244992585 -31.47406391572417, 144.84399355252685 -31.26123924022086))";
        ...
        WKT = "CURVEPOLYGON(COMPOUNDCURVE(CIRCULARSTRING(0 0,2 0, 2 1, 2 3, 4 3),(4 3, 4 5, 1 4, " +
    ...
    public void testParseMulticurve() throws Exception {
        ...
        WKT = "MULTICURVE((100 100, 120 120), COMPOUNDCURVE(CIRCULARSTRING(0 0, 2 0, 2 1, 2 3, 4 " +
                "3),(4 3, 4 5, 1 4, 0 0)))";
        ml = (MultiLineString) reader.read(WKT);
        assertEquals(2, ml.getNumGeometries());
        assertTrue(ml.getGeometryN(0).getClass() == LineString.class);
    ...
    public void testMultiSurfaceStraightPolygon() throws Exception {
        String wkt = "MULTISURFACE (((0 0, 1 0, 1 4, 0 0)), CURVEPOLYGON (COMPOUNDCURVE " +
                "(CIRCULARSTRING (0 2, 7 5, 2 10), (2 10, 0 2)), COMPOUNDCURVE (CIRCULARSTRING (3" +
                " 9, 6 5, 3 2), (3 2, 3 9))))";
    ...
    public void testMultiSurfaceStraightPolygon2() throws Exception {
        String wkt = "MULTISURFACE (CURVEPOLYGON (COMPOUNDCURVE (CIRCULARSTRING (0 2, 7 5, 2 10)," +
                " (2 10, 0 2)), COMPOUNDCURVE (CIRCULARSTRING (3 9, 6 5, 3 2), (3 2, 3 9))), ((0 " +
                "0, 1 0, 1 4, 0 0)))";
        Geometry geometry = new WKTReader2().read(wkt);
        // System.out.println(geometry);
        MultiSurface ms = (MultiSurface) geometry;
    ...
    public void testMultiSurfaceEmpty() throws Exception {
        String wkt = "MULTISURFACE (EMPTY, CURVEPOLYGON (COMPOUNDCURVE (CIRCULARSTRING (0 2, 7 5," +
                " 2 10), (2 10, 0 2)), COMPOUNDCURVE (CIRCULARSTRING (3 9, 6 5, 3 2), (3 2, 3 9))" +
                "), ((0 0, 1 0, 1 4, 0 0)))";
        Geometry geometry = new WKTReader2().read(wkt);
        // System.out.println(geometry);
        MultiSurface ms = (MultiSurface) geometry;
