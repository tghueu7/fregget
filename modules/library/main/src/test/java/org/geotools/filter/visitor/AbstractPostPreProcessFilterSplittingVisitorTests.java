...
public class AbstractPostPreProcessFilterSplittingVisitorTests extends TestCase {
    ...
    protected PostPreProcessFilterSplittingVisitor newVisitor(FilterCapabilities supportedCaps) 
        ...
        return new PostPreProcessFilterSplittingVisitor(supportedCaps,
                DataUtilities.createType(typeName, geomAtt + ":Point," + nameAtt + ":String," + 
                        numAtt + ":int"),
                accessor);
    }

    protected PropertyIsEqualTo createPropertyIsEqualToFilter(String attr, String value) throws 
    ...
    class MockGeometryImpl implements Geometry {
        ...
        public Geometry transform(CoordinateReferenceSystem arg0, MathTransform arg1) throws 
                TransformException {
            // TODO Auto-generated method stub
            return null;
        }
