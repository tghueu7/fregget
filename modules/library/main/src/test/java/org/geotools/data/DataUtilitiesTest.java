...
public class DataUtilitiesTest extends DataTestCase {
  ...
  public void testCreate() throws Exception {
    ...
    SimpleFeature feature2 =
        DataUtilities.createFeature(featureType, "2|John Hudson\\|Hapless Victim|POINT(6 2)");
  ...
  public void testCreateSubTypePreservesDefaultGeometryProperty() throws Exception {
    ...
    SimpleFeatureType after =
        DataUtilities.createSubType(before, new String[] {"name", "the_geom1", "the_geom3"});
  ...
  public void testCreateSubTypeWithPropertyNotMatchingAnAttributeDescriptor() throws Exception {
    ...
    SimpleFeatureType before =
        DataUtilities.createType("cities", "the_geom:Point:srid=4326,name:String");
    SimpleFeatureType after =
        DataUtilities.createSubType(before, new String[] {"the_geom", "name", "not_existing"});
  ...
  public void testMixQueries() throws Exception {
    ...
    firstQuery =
        new DefaultQuery(
            "typeName", Filter.EXCLUDE, 100, new String[] {"att1", "att2", "att3"}, "handle");
    secondQuery =
        new DefaultQuery(
            "typeName", Filter.EXCLUDE, 20, new String[] {"att1", "att2", "att4"}, "handle2");
    ...
    secondQuery =
        new DefaultQuery("typeName", filter2, 20, new String[] {"att1", "att2", "att4"}, "handle2");
  ...
  public void testAddMandatoryProperties() {
    AttributeType at =
        new AttributeTypeImpl(
            new NameImpl("String"), String.class, false, false, Collections.EMPTY_LIST, null, null);
