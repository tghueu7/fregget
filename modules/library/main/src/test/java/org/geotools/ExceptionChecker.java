...
public final class ExceptionChecker {
   ...
   * @throws Exception Throws the original exception back if the message DOES match. This means you
   *     still need to have the annotation: Test(expected = ***Exception.class)
   */
