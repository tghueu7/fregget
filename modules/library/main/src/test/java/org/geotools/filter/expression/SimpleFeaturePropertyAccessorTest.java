...
public class SimpleFeaturePropertyAccessorTest extends TestCase {
    ...
    public void testGet() {
        ...
        assertEquals("fid", SimpleFeaturePropertyAccessorFactory.FID_ACCESS.get(feature, "@id", 
                null));
        assertEquals("fid", SimpleFeaturePropertyAccessorFactory.FID_ACCESS.get(feature, 
                "@gml:id", null));
        assertFalse(accessor.canHandle(feature, "illegal", null));
