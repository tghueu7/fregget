...
public class FilterFunction_isWithinDistance3DTest extends TestCase {
    ...
    public void testDistance3D() {
        ...
        Feature f = SimpleFeatureBuilder.build(type, new Object[]{"testFeature1", gf.createPoint
        ...
        Function exp = ff.function("isWithinDistance3D", ff.property("geom"), literal_geom, 
                literal_num);
