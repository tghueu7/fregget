...
public class FeatureTypeTest extends DataTestCase {
  ...
  /**
   * Test FeatureTypes.getAncestors() by constructing three levels of derived types and testing that
   * the expected ancestors are returned at each level in reverse order.
   *
