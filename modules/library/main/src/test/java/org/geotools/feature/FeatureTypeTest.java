...
public class FeatureTypeTest extends DataTestCase {
    ...
    public void testAbstractType() throws Exception {
        ...
        //assertTrue("extends gml feature", FeatureTypes.isDecendedFrom(abstractType, new URI
        // ("http://www.opengis.net/gml"),"Feature"));
        //assertTrue("extends gml feature", FeatureTypes.isDecendedFrom(abstractType2, new URI
        // ("http://www.opengis.net/gml"),"Feature"));
        assertTrue("abstractType2 --|> abstractType", FeatureTypes.isDecendedFrom(abstractType2, 
                abstractType));
        assertFalse("abstractType2 !--|> abstractType", FeatureTypes.isDecendedFrom(abstractType,
                abstractType2));
