...
public class NumericConverterFactoryTest extends TestCase {
  ...
  public void testSafeConversion() throws Exception {
    ...
    assertEquals(BigInteger.valueOf(1111), convertSafe(new Short((short) 1111), BigInteger.class));
    assertEquals(BigInteger.valueOf(12345), convertSafe(new Integer(12345), BigInteger.class));
    assertEquals(BigInteger.valueOf(1234567), convertSafe(new Integer(1234567), BigInteger.class));
    assertEquals(
        BigInteger.valueOf(12345678), convertSafe(BigInteger.valueOf(12345678), BigInteger.class));
    assertNull(convertSafe(new Double(128.1), Long.class));
    assertNull(convertSafe(new BigDecimal(128.1), Long.class));
    assertNull(convertSafe(new Float(128.1), Long.class));
    ...
    assertEquals(
        new BigDecimal(12345678), convertSafe(BigInteger.valueOf(12345678), BigDecimal.class));
    assertEquals(
