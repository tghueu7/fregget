 ...
 * @source $URL$
 */
public class PostPreProcessFilterSplittingVisitorTest extends 
        AbstractPostPreProcessFilterSplittingVisitorTests {
    ...
    public void testComplicatedOrFilter() throws Exception {
        ...
        visitor = new PostPreProcessFilterSplittingVisitor(simpleLogicalCaps, null, new 
