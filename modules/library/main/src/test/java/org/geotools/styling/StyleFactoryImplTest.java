...
public class StyleFactoryImplTest extends TestCase {
  ...
  public void testCreateStroke() {
    ...
    Stroke s =
        styleFactory.createStroke(filterFactory.literal("#000000"), filterFactory.literal(2.0));
  ...
  public void testCreateGraphic() {
    ...
    Graphic g =
        styleFactory.createGraphic(externalGraphics, marks, symbols, opacity, size, rotation);
