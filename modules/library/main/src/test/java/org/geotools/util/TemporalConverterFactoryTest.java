...
public class TemporalConverterFactoryTest extends TestCase {
  ...
  /**
   * When converting from Calendar to Date from ArcSDE we run into a problem where the Dates are out
   * by a very small number. Basically we need to look at the Calendar and see if it represents an
   * *entire* day.
   *
   * @throws Exception
   */
  ...
  public void testCalendarToDate() throws Exception {
    ...
    Date date =
        (Date)
            factory.createConverter(Calendar.class, Date.class, null).convert(calendar, Date.class);
    assertNotNull(date);
    assertEquals(calendar.getTime(), date);
  }
  ...
  public void testCalendarToTime() throws Exception {
    ...
    Time time =
        (Time)
            factory.createConverter(Calendar.class, Time.class, null).convert(calendar, Time.class);
    assertNotNull(time);
  ...
  public void testCalendarToTimestamp() throws Exception {
    ...
    Timestamp timeStamp =
        (Timestamp)
            factory
                .createConverter(Calendar.class, Timestamp.class, null)
  ...
  public void testDateToTime() throws Exception {
    ...
    Time time =
        (Time) factory.createConverter(Date.class, Time.class, null).convert(date, Time.class);
    assertNotNull(time);
    // need to remove the date part
  ...
  public void testDateToTimestamp() throws Exception {
    ...
    Timestamp timeStamp =
        (Timestamp)
            factory
                .createConverter(Date.class, Timestamp.class, null)
  ...
  public void testTimestampToCalendar() throws Exception {
    ...
    Calendar calendar =
        (Calendar)
            factory
                .createConverter(Timestamp.class, Calendar.class, null)
  ...
  public void testXMLGregorianCalendarToDate() throws Exception {
    ...
    Date date =
        factory
            .createConverter(XMLGregorianCalendar.class, Date.class, null)
  ...
  public void testDateToXMLGregorianCalendar() throws Exception {
    ...
    XMLGregorianCalendar gc =
        factory
            .createConverter(Date.class, XMLGregorianCalendar.class, null)
  ...
  public void testTimeZoneToString() throws Exception {
    ...
    assertEquals(
        TimeZone.getDefault().getID(), converter.convert(TimeZone.getDefault(), String.class));
