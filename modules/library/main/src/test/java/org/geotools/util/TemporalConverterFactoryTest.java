...
public class TemporalConverterFactoryTest extends TestCase {
    ...
    public static void pause() {
        long pause = System.currentTimeMillis() + 15; // 15 is about the resolution of a system 
        // clock
    ...
    public void testCalendarToTimestamp() throws Exception {
        ...
        Timestamp timeStamp = (Timestamp) factory.createConverter(Calendar.class, Timestamp
                .class, null)
    ...
    public void testTimestampToCalendar() throws Exception {
        ...
        Calendar calendar = (Calendar) factory.createConverter(Timestamp.class, Calendar.class, 
                null)
    ...
    public void testXMLGregorianCalendarToCalendar() throws Exception {
        XMLGregorianCalendar gc = DatatypeFactory.newInstance().newXMLGregorianCalendar
                ("1981-06-20T12:00:00");
        assertNotNull(factory.createConverter(XMLGregorianCalendar.class, Calendar.class, null));

        Calendar calendar = (Calendar) factory.createConverter(XMLGregorianCalendar.class, 
                Calendar.class, null)
    ...
    public void testCalendarToXMLGregorianCalendar() throws Exception {
        ...
        XMLGregorianCalendar gc = factory.createConverter(Calendar.class, XMLGregorianCalendar
                .class, null)
    ...
    public void testDateToXMLGregorianCalendar() throws Exception {
        ...
        XMLGregorianCalendar gc = factory.createConverter(Date.class, XMLGregorianCalendar.class,
                null)
    ...
    public void testTimeZoneToString() throws Exception {
        ...
        assertEquals(TimeZone.getDefault().getID(), converter.convert(TimeZone.getDefault(), 
                String.class));
