...
public class RescaleStyleVisitorTest {
    ...
    public void testRescaleGraphicFillStrokes() {
        ...
        Graphic graphic = sb.createGraphic(null, sb.createMark("square", null, sb.createStroke(1)
        ), null);
        ...
        assertEquals(expectedAnchorPointX, actualAnchorPoint.getAnchorPointX().evaluate(null, 
                Double.class), 0d);
        assertEquals(expectedAnchorPointY, actualAnchorPoint.getAnchorPointY().evaluate(null, 
                Double.class), 0d);
