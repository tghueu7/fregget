...
public class RescaleStyleVisitorTest {
  ...
  public void testRescaleGraphicFillStrokes() {
    ...
    assertEquals(
        expectedAnchorPointX, actualAnchorPoint.getAnchorPointX().evaluate(null, Double.class), 0d);
    assertEquals(
        expectedAnchorPointY, actualAnchorPoint.getAnchorPointY().evaluate(null, Double.class), 0d);
