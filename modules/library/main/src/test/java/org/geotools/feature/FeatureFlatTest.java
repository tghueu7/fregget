...
public class FeatureFlatTest extends TestCase {
    ...
    public void testRetrieve() {
        ...
        assertTrue("byte retrieval and match", ((Byte) testFeature.getAttribute("testByte"))
                .equals(new Byte("10")));
        assertTrue(
        ...
        assertTrue("long retrieval and match", ((Long) testFeature.getAttribute("testLong"))
...
//        }
    ...
    public void testModify() throws IllegalAttributeException {
        ...
        assertEquals("match modified (string) attribute", testFeature.getAttribute("testString"),
                newData);

        GeometryFactory gf = new GeometryFactory();
        Point newGeom = gf.createPoint(new Coordinate(3, 4));
        testFeature.setAttribute("testGeometry", newGeom);
        assertEquals("match modified (geometry) attribute", testFeature.getAttribute
                ("testGeometry"), newGeom);
...
//        assertTrue(((Geometry)testFeature.getDefaultGeometry()).getEnvelopeInternal().equals
