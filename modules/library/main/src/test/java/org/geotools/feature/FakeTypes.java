...
public class FakeTypes {
    ...
    public static class Mine {
        ...
        // (1)
        public static final AttributeDescriptor ISPREFERRED_DESCRIPTOR = new 
        ...
        public static ArrayList<PropertyDescriptor> MINENAMETYPE_SCHEMA = new 
        ...
        public static ArrayList<PropertyDescriptor> MINENAMEPROPERTYTYPE_SCHEMA = new 
                ArrayList<PropertyDescriptor>() {
            {
                add(MINENAME_DESCRIPTOR);
            }
        ...
        // (6)
        public static final AttributeDescriptor MINEmineNAME_DESCRIPTOR = new 
                AttributeDescriptorImpl(
        ...
        public static ArrayList<PropertyDescriptor> MINETYPE_SCHEMA = new 
                ArrayList<PropertyDescriptor>() {
            {
        ...
        public static final FeatureType MINETYPE_TYPE = new FeatureTypeImpl(
                /* name: */NAME_MineType,
                /* properties: */MINETYPE_SCHEMA, // This is only a subset of mine information, 
                // the real one has some other details but they've been omitted
                // here.
                /* defaultGeometry: */null,
                /* isAbstract: */false,
                /* restrictions: */Collections.<Filter>emptyList(),
                /* superType: */ANYTYPE_TYPE, // In real life it's actually a MiningFeatureType 
