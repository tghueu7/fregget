...
public interface MultiLevelROI {
     ...
     * @param readType   {@link ReadType} object indicating how the image file must be read. This
     *                                  may be useful for raster ROIs
    ...
    /**
     * This method returns a {@link Geometry} object containing the ROI footprint or, at least, 
     * its bounding box
     *
