  ...
  Transparent(true) {
    ...
    public RenderedImage postProcessMosaic(
      ...
      if (imageWorker.getRenderedImage().getColorModel().hasAlpha()) {
        ...
        RenderedImage alpha =
            new ImageWorker(imageWorker.getRenderedImage()).retainLastBand().getRenderedImage();
    ...
    public RenderedImage postProcessBlankResponse(RenderedImage finalImage, RenderingHints hints) {
      ...
      if (!imageWorker.getRenderedImage().getColorModel().hasAlpha()) {
        ...
        RenderedImage alpha =
            imageWorker2.retainFirstBand().multiplyConst(new double[] {0.0}).getRenderedImage();
