...
public abstract class AbstractOperation implements Operation, Serializable {
  ...
  /**
   * Returns the description of the processing operation. If there is no description, returns {@code
   * null}. The default implementation returns the {@linkplain #descriptor} remarks.
   *
  ...
  /**
   * Returns the vendor name of the processing operation implementation. The default implementation
   * returns "Geotools 2".
   *
