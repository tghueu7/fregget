...
public class ImageAssert {
  ...
  /**
   * Makes the test interactive, showing a Swing dialog with before/after and a choice to overwrite
   * the expected image
   */
  ...
  /**
   * Checks the image in the reference file and the actual image are equals from a human perception
   * p.o.v
   *
   * @param expectedFile
   * @param actualImage
   ...
   */
  public static void assertEquals(
      File expectedImage, RenderedImage actualImage, int threshold, Mode mode) throws IOException {
