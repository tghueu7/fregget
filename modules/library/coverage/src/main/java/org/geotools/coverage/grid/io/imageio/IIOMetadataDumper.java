...
public final class IIOMetadataDumper {
  ...
  /**
   * Constructor for a {@link IIOMetadataDumper} accepting an {@link IIOMetadataNode}. It has no way
   * to choose the format of the metadata to parse since this choice has been already done
   * previously.
   *
   * @param rootNode
   */
   ...
   *
   * <p>This method causes a new generation of the string representation if the format is different
   * from the one stored.
   *
