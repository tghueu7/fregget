...
public class MultiLevelROIGeometryProvider implements MultiLevelROIProvider {
  ...
  /**
   * The optional granuleBounds to be used as a default value when there is no need to do ROI lookup
   * against specific features. Specify that when dealing with single granules store
   */
