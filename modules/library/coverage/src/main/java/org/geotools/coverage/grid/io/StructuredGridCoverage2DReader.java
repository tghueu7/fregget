...
public interface StructuredGridCoverage2DReader extends GridCoverage2DReader {
   ...
   *
   * @param defaultCoverage Default target coverage, to be used in case the sources being harvested
   *     are not structured ones. The parameter is optional, in case it's missing the reader will
   *     use the first coverage as the default target.
