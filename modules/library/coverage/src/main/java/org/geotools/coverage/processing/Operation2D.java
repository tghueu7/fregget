...
public abstract class Operation2D extends AbstractOperation {
   ...
   * will reuse the same coordinate reference system, envelope and qualitative categories than this
   * primary source.
   *
  ...
  /**
   * Convenience constant for the first source {@link GridCoverage2D}. The parameter name is {@code
   * "Source"} (as specified in OGC implementation specification) and the alias is {@code "source0"}
   * (for compatibility with <cite>Java Advanced Imaging</cite>).
   */
