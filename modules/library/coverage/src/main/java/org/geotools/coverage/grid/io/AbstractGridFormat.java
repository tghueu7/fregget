...
public abstract class AbstractGridFormat implements Format {
     ...
     * matching area.
     */
    public static final DefaultParameterDescriptor<GridGeometry2D> READ_GRIDGEOMETRY2D = new 
            DefaultParameterDescriptor<GridGeometry2D>(
            "ReadGridGeometry2D", GridGeometry2D.class, null, null);

    /**
     * This {@link GeneralParameterValue} can be provided to the
     * {@link GridCoverageReader}s through the
     * {@link GridCoverageReader#write(GeneralParameterValue[])} method in order to monitor a 
     * writing process
     */
    public static final DefaultParameterDescriptor<ProgressListener> PROGRESS_LISTENER = new 
            DefaultParameterDescriptor<ProgressListener>(
     ...
     */
    public static final DefaultParameterDescriptor<Boolean> USE_JAI_IMAGEREAD = new 
     ...
     */
    public static final DefaultParameterDescriptor<OverviewPolicy> OVERVIEW_POLICY = new 
            DefaultParameterDescriptor<OverviewPolicy>(
     ...
     */
    public static final ParameterDescriptor<DecimationPolicy> DECIMATION_POLICY = new 
            DefaultParameterDescriptor<DecimationPolicy>(
     ...
     */
    public static final DefaultParameterDescriptor<int[]> BANDS = new 
            DefaultParameterDescriptor<int[]>(
     ...
     */
    public static final ParameterDescriptor<Color> INPUT_TRANSPARENT_COLOR = new 
     ...
     */
    public static final ParameterDescriptor<List> TIME = DefaultParameterDescriptor.create
     ...
     */
    public static final ParameterDescriptor<Interpolation> INTERPOLATION = new 
            DefaultParameterDescriptor<Interpolation>(
            "Interpolation", Interpolation.class, null, DEFAULT_INTERPOLATION);

    /**
     * Control the footprint management.
     */
    public static final ParameterDescriptor<String> FOOTPRINT_BEHAVIOR = new 
            DefaultParameterDescriptor<String>(
            "FootprintBehavior", String.class, FootprintBehavior.valuesAsStrings(), 
     ...
     *
     * @param source The source object to parse. *
     * @param hints  The {@link Hints} to use when trying to instantiate this
     *               reader.
     * @return A reader for this {@link Format} or null.
     */
