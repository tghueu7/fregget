...
public class IntersectUtils {
  ...
  /**
   * Flatten all first-level (i.e. non recursively) bundles (GeometryCollections and MultiPolygons)
   * into a GeometryCollection. <br>
   * Valid structures:
   *
   * <UL>
   *   <LI>null -> null
   ...
   * </UL>
   *
   * @throws IllegalArgumentException when encountering illegal Geometries; message is the Geometry
   *     class name.
   * @param geometry
   * @return
   */
