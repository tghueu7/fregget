...
public abstract class BaseStatisticsOperationJAI extends
     ...
     */
    public static final ParameterDescriptor<Double> SPATIAL_SUBSAMPLING_X = new 
     ...
     */
    public static final ParameterDescriptor<Double> SPATIAL_SUBSAMPLING_Y = new 
            DefaultParameterDescriptor<Double>(
    ...
    public BaseStatisticsOperationJAI(String name, OperationDescriptor operationDescriptor) {
        super(getOperationDescriptor(JAIExt.getOperationName(name)), new 
