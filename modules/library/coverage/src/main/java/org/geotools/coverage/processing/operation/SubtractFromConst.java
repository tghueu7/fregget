 ...
 * <CODE>"{@linkplain SubtractFromConstDescriptor SubtractFromConst}"</CODE><BR>
...
public class SubtractFromConst extends OperationJAI {
    ...
    public SubtractFromConst() {
        super("SubtractFromConst", getOperationDescriptor(JAIExt.getOperationName
                ("SubtractFromConst")));
    }
