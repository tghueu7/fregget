...
public final class GeoTiffGCSCodes {
  ...
  /**
   * GeogAngularUnitsGeoKey Key ID = 2054 Type = SHORT (code) Values = Section 6.3.1.4 Codes Allows
   * the definition of geocentric CS Linear units for user-defined GCS and for ellipsoids. GeoKey
   * Requirements for "user-defined" units: GeogCitationGeoKey GeogAngularUnitSizeGeoKey
   */
  ...
  /**
   * GeogCitationGeoKey Key ID = 2049 Type = ASCII Values = text General citation and reference for
   * all Geographic CS parameters.
   */
   ...
   * http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.3 This key may be used to specify
   * the coded ellipsoid used in the geodetic datum of the Geographic Coordinate System. GeoKey
   * Requirements for User-Defined Ellipsoid: GeogCitationGeoKey [GeogSemiMajorAxisGeoKey,
   ...
   * http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.2 This key may be used to specify
   * the horizontal datum, defining the size, position and orientation of the reference ellipsoid
   * used in user-defined geographic coordinate systems. GeoKey Requirements for User-Defined
   ...
   * the inverse of user-defined Ellipsoid's flattening parameter (f). The eccentricity-squared e^2
   * of the ellipsoid is related to the non-inverted f by: e^2 = 2f - f^2 Note: if the ellipsoid is
   * spherical the inverse-flattening becomes infinite; use the GeogSemiMinorAxisGeoKey instead, and
   ...
   * http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.2.1 This key may be used to specify
   * the code for the geographic coordinate system used to map lat-long to a specific ellipsoid over
   * the earth. GeoKey Requirements for User-Defined geographic CS: GeogCitationGeoKey
   * GeogGeodeticDatumGeoKey GeogAngularUnitsGeoKey (if not degrees) GeogPrimeMeridianGeoKey (if not
   * Greenwich)
   */
   ...
   * provided to give an ASCII reference to published documentation on the overall configuration of
   * this GeoTIFFWritingUtilities file.
   */
