...
public class GeneralGridCoordinates implements GridCoordinates, Serializable {
   ...
   *     this {@code GeneralGridCoordinates} object.
   */
  ...
  /**
   * An immutable {@link GridCoordinates}. This is sometime useful for creating a single instance to
   * be shared by many objects without the cost of cloning. This class is final in order to prevent
   * subclasses from making it mutable again.
   *
   * @since 2.5
   * @source $URL$
   * @version $Id$
  ...
  public static final class Immutable extends GeneralGridCoordinates {
     ...
     * {@link GeneralGridEnvelope} only, to be invoked only right after construction and before the
     * instance goes public. This method should not be public since it breaks the immutability
     * contract.
     */
