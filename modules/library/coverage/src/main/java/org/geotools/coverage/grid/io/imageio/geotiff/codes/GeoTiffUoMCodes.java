...
public final class GeoTiffUoMCodes {
   ...
   * radar-return), CCD-voltages, etc. For this reason there will be a single, unique range for each
   * kind of unit, broken down into the following currently defined ranges: Ranges: 0 = undefined [
   * 1, 2000] = Obsolete GeoTIFFWritingUtilities codes [2001, 8999] = Reserved by
