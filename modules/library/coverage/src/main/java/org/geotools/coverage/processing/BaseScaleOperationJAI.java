...
public abstract class BaseScaleOperationJAI extends OperationJAI {
    ...
    protected GridCoverage2D deriveGridCoverage(GridCoverage2D[] sources, Parameters parameters) {
        ...
        // honored.
        // /////////////////////////////////////////////////////////////////////
        RenderingHints targetHints = parameters.hints != null ? parameters.hints : ImageUtilities
        ...
        if ((layout.getValidMask() & (ImageLayout.TILE_WIDTH_MASK
                ...
                | ImageLayout.TILE_GRID_X_OFFSET_MASK | ImageLayout.TILE_GRID_Y_OFFSET_MASK)) == 
                0) {
        ...
        final boolean asPhotographicStrategy = sourceImage.getColorModel() instanceof 
                IndexColorModel;
        ...
        try {
            ...
            finalTransform = ConcatenatedTransform.create(tr, sourceCoverage.getGridGeometry()
                    .getGridToCRS2D());
        } catch (Exception e) {
        ...
        final Map<String, ?> properties = getProperties(image, parameters.crs, name, 
                finalTransform, sources, parameters);
        ...
        final GridCoverage2D result = getFactory(parameters.hints)
                .create(name,        // The grid coverage name
                        ...
                        (GridSampleDimension[]) (asPhotographicStrategy ? null
                                : sourceCoverage.getSampleDimensions().clone()),  // The sample 
                        // dimensions
