...
public class Operations {
  ...
  /**
   * Replaces {@link Float#NaN NaN} values by the weighted average of neighbors values. This method
   * uses the default padding and validity threshold.
   *
   * @param source The source coverage.
   * @throws CoverageProcessingException if the operation can't be applied.
   ...
   * @param validityThreshold The minimal number of valid values required for computing the average.
   *     The {@code NaN} value will be replaced by the average only if the number of valid value is
   *     greater than or equals to this threshold. The default value is 4.
   * @throws CoverageProcessingException if the operation can't be applied.
   * @see org.geotools.coverage.processing.operation.NodataFilter
   */
   ...
   * elements are fallback to be used if the primary interpolation returns a {@code NaN} value. See
  ...
  public Coverage resample(
      final GridCoverage source, final Envelope envelope, final Interpolation interpolationType)
      throws CoverageProcessingException {
  ...
  /**
   * Applies a process operation with default parameters. This is a helper method for implementation
  ...
  /**
   * Applies a process operation with four parameters. This is a helper method for implementation of
   * various convenience methods in this class.
   *
   * @param operationName Name of the operation to be applied to the coverage.
   * @param source The source coverage.
  ...
  /**
   * Applies a process operation with five parameters. This is a helper method for implementation of
   * various convenience methods in this class.
   *
   * @param operationName Name of the operation to be applied to the coverage.
   * @param source The source coverage.
  ...
  /**
   * Applies a process operation with six parameters. This is a helper method for implementation of
   * various convenience methods in this class.
   *
   * @param operationName Name of the operation to be applied to the coverage.
   * @param source The source coverage.
