...
public final class TypeMap {
      ...
      new AbstractInternationalString() {
        public String toString(final Locale locale) {
          return Vocabulary.getResources(locale)
              .getString(
                  VocabularyKeys.DATA_TYPE_$2, Integer.valueOf(real ? 2 : signed ? 1 : 0), size);
        }
      };
  ...
  /**
   * Returns the sample dimension type for the specified sample model and band number. If the sample
   * model use an undefined data type, then this method returns {@code null}.
   *
      ...
      case DataBuffer.TYPE_SHORT:
        {
          switch (model.getSampleSize(band)) {
            ...
            case 5:
              return UNSIGNED_8BITS; // for BufferedImages TYPE_USHORT_555_RGB TYPE_USHORT_565_RGB
            case 8:
   ...
   * the specified type, then a wider type is choosen unless {@code allowWidening} is {@code false}.
   *
