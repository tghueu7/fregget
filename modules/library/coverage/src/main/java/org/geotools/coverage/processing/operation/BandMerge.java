...
public class BandMerge extends OperationJAI {
  ...
  /**
   * The parameter descriptor for the Source index to use for selecting the Affine Transformation to
   * use.
   */
  ...
  /**
   * Enum used for selecting an Affine Transformation to use for backward mapping the final coverage
   * pixel to the Model Space. The method "getTransformationList" returns a List of the
  ...
  public enum TransformList {
    ...
    /**
     * Returns a List of AffineTransformations objects to use for backward mapping the destination
     * image pixels into each source image
     *
     * @param list
     * @param index
     * @return
