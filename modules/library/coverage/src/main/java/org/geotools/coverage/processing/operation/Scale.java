  ...
  protected RenderedImage createRenderedImage(ParameterBlockJAI parameters, RenderingHints hints) {
    ...
    if (interpolation != null
      ...
      synchronized (lock) {
        ...
        /**
         * Disables the native acceleration for the "Scale" operation. In JAI 1.1.2, the "Scale"
         * operation on TYPE_FLOAT datatype with INTERP_BILINEAR interpolation cause an exception in
         * the native code of medialib, which halt the Java Virtual Machine. Using the pure Java
