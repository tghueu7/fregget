...
public class RangeSpecifier implements Serializable, Cloneable {
  ...
  /**
   * Set the target range to the specified values. Setting this property will clear the {@linkplain
   * #getSampleToGeophysics sample to geophysics transform}, since those properties are mutually
   * exclusive.
   *
