...
public class ColorInversionDescriptor extends OperationDescriptorImpl {
    ...
    public ColorInversionDescriptor() {
        super(new String[][]{
                        ...
                        {"Description",
                                "Produce a paletted imge from an RGB or RGBA image using a " +
                                        "provided palette."},
                ...
                // modes
                new String[]{"IndexColorModel", "quantizationColors", "alphaThreshold"}, // 
                // Parameter
                // names
                new Class[]{IndexColorModel.class, Integer.class, Integer.class,}, // Parameter
                // classes
                new Object[]{buildDefaultPalette(), new Integer(InverseColorMapRasterOp
                        .DEFAULT_QUANTIZATION_COLORS), new Integer(1),}, // Default
                // values
