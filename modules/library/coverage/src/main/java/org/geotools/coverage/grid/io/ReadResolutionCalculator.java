...
public class ReadResolutionCalculator {
  ...
  public ReadResolutionCalculator(
    ...
    this.requestedBBox = new ReferencedEnvelope((Envelope) requestedGridGeometry.getEnvelope2D());
   ...
   * corners of the requested area and the middle points and take the better one. This will provide
