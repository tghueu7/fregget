...
public final class PixelScale {
    ...
    public String toString() {
        ...
        buf.append("\tscaleX=").append(scaleX).append(" is set? ").append(isComponentSet(scaleX))
                .append("\n");
        buf.append("\tscaleY=").append(scaleY).append(" is set? ").append(isComponentSet(scaleY))
                .append("\n");
        buf.append("\tscaleZ=").append(scaleZ).append(" is set? ").append(isComponentSet(scaleZ))
                .append("\n");
        return buf.toString();
    }
