...
public class ColorReductionDescriptor extends OperationDescriptorImpl {
  ...
  /**
   * Returns {@code true} if this operation supports the specified mode, and is capable of handling
   * the given input source(s) for the specified mode.
   *
  ...
  /**
   * Returns {@code true} if the parameters are valids. This implementation check that the number of
   * bands in the source src1 is equals to the number of bands of source src2.
   *
   * @param modeName The mode name (usually "Rendered").
   * @param param The parameter block for the operation to performs.
   * @param message A buffer for formatting an error message if any.
