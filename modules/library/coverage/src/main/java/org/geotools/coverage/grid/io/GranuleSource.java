...
public interface GranuleSource {
  ...
  /**
   * Gets the number of the granules that would be returned by the given {@code Query}, taking into
   * account any settings for max features and start index set on the {@code Query}.
   *
   * @param q the {@link Query} to select granules
