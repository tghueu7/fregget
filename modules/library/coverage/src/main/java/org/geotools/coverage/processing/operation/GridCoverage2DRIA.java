...
public class GridCoverage2DRIA extends GeometricOpImage {
  ...
  /**
   * Returns the minimum bounding box of the region of the destination to which a particular <code>
   * Rectangle</code> of the specified source will be mapped.
   *
   ...
   * @return a <code>Rectangle</code> indicating the destination bounding box, or <code>null</code>
   ...
   * @return A reference to the <code>destRect</code> parameter if it is non-<code>null</code>, or a
   *     new <code>float</code> array otherwise.
   */
  public float[] warpSparseRect(
    ...
    if (destRect == null) {
      destRect =
          new float[((width + periodX - 1) / periodX) * ((height + periodY - 1) / periodY) * 2];
    }
