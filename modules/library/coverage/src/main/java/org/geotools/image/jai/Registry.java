...
public final class Registry {
   ...
   * Disabling the native acceleration (i.e using the pure Java version) is a convenient workaround
   * until Sun fix the bug.
   *
   * <p><strong>Implementation note:</strong> the current implementation assumes that factories for
