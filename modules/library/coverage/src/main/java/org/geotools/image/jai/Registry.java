...
public final class Registry {
     ...
     * an image with float data type, bilinear interpolation and an 
     * {@link javax.media.jai.ImageLayout}
    ...
    public synchronized static void setNativeAccelerationAllowed(final String operation,
        ...
        @SuppressWarnings("unchecked") final List<RenderedImageFactory> factories = registry
