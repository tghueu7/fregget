...
public final class CRS2GeoTiffMetadataAdapter {
     ...
     *
     * @param obj An <code>IdentifiedObject</code> to look for an EPSG code
     *            into.
    ...
    private void parseProjCRS(final ProjectedCRS projectedCRS,
        ...
        // key 3072
        metadata.addGeoShortParam(GeoTiffPCSCodes.ProjectedCSTypeGeoKey, GeoTiffConstants
                .GTUserDefinedGeoKey);
    ...
    private void parseProjection(final ProjectedCRS projectedCRS,
        ...
        // key 3074
        metadata.addGeoShortParam(GeoTiffPCSCodes.ProjectionGeoKey, GeoTiffConstants
                .GTUserDefinedGeoKey);
...
//			metadata.addGeoAscii(GeoTiffPCSCodes.PCSCitationGeoKey, name);
            ...
            for (GeneralParameterValue value : values) {
                if (value instanceof ParameterValue) {
                    ...
                    if (AbstractIdentifiedObject.nameMatches(value.getDescriptor(), 
                            "latitude_of_origin")) {
                        metadata.addGeoDoubleParam(
                                GeoTiffPCSCodes.ProjNatOriginLatGeoKey, (paramValue).doubleValue());
                    } else if (AbstractIdentifiedObject.nameMatches(value.getDescriptor(), 
                            "central_meridian")) {
                        metadata.addGeoDoubleParam(
                            ...
                            "scale_factor")) {
                        metadata.addGeoDoubleParam(
                                GeoTiffPCSCodes.ProjScaleAtNatOriginGeoKey, (paramValue)
                                        .doubleValue());
                    } else if (AbstractIdentifiedObject.nameMatches(value.getDescriptor(), 
                            "standard_parallel_1")) {
                        metadata.addGeoDoubleParam(
...
//                    metadata.addGeoAscii(GeoTiffPCSCodes.PCSCitationGeoKey, name);
            ...
            // params
            metadata.addGeoDoubleParam(GeoTiffPCSCodes.ProjCenterLongGeoKey, parameters.parameter
                    ("central_meridian").doubleValue());
    ...
    private void parseGeoGCS(DefaultGeographicCRS geographicCRS,
        ...
        metadata.addGeoShortParam(GeoTiffGCSCodes.GeographicTypeGeoKey, GeoTiffConstants
                .GTUserDefinedGeoKey);
    ...
    private void parseDatum(final DefaultGeodeticDatum datum,
        ...
        metadata.addGeoShortParam(GeoTiffGCSCodes.GeogGeodeticDatumGeoKey, GeoTiffConstants
                .GTUserDefinedGeoKey);
    ...
    private void parseSpheroid(final DefaultEllipsoid ellipsoid,
        ...
        metadata.addGeoShortParam(GeoTiffGCSCodes.GeogEllipsoidGeoKey, GeoTiffConstants
                .GTUserDefinedGeoKey);
        // setting the name
        metadata.addGeoAscii(GeoTiffGCSCodes.GeogCitationGeoKey, ellipsoid.getName().getCode());

        // setting semimajor axis
        metadata.addGeoDoubleParam(GeoTiffGCSCodes.GeogSemiMajorAxisGeoKey, ellipsoid
                .getSemiMajorAxis());

        // setting inverse flattening
        metadata.addGeoDoubleParam(GeoTiffGCSCodes.GeogInvFlatteningGeoKey, ellipsoid
    ...
    private void parsePrimem(final DefaultPrimeMeridian pm,
        ...
        if (GeoTiffIIOMetadataEncoder.isTiffUShort(code))
            ...
            // user defined
            metadata.addGeoShortParam(GeoTiffGCSCodes.GeogPrimeMeridianGeoKey, GeoTiffConstants
                    .GTUserDefinedGeoKey);
            ...
            // longitude
            metadata.addGeoDoubleParam(GeoTiffGCSCodes.GeogPrimeMeridianLongGeoKey, pm
     ...
     * @param unit     The contextual unit. Usually {@link SI#METRE} or
     *                 {@link SI#RADIAN}.
     * @param metadata
