...
public class Extrema extends BaseStatisticsOperationJAI {
   ...
   * for more info.
   *
   * @see OperationJAI#getProperties(RenderedImage, CoordinateReferenceSystem, InternationalString,
   *     MathTransform, GridCoverage2D[], org.geotools.coverage.processing.OperationJAI.Parameters),
   */
