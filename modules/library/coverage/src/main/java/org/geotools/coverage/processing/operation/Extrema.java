 ...
 * /ExtremaDescriptor.html">ExtremaDescriptor</a>
 * <p>
 * <p>
...
public class Extrema extends BaseStatisticsOperationJAI {
     ...
     * /operator/ExtremaDescriptor.html">ExtremaDescriptor</a>
     * for more info.
     *
    ...
    protected Map<String, ?> getProperties(RenderedImage data,
        ...
        if (data instanceof RenderedOp) {
            ...
            if (JAIExt.isJAIExtOperation(STATS)) {
                // get the properties
                Statistics[][] results = ((Statistics[][]) result.getProperty(Statistics
                        .STATS_PROPERTY));
                // Extracting the bins
