 ...
 * store.
 * <p>
 * Data access method take a <code>coverageName</code> supplied by 
 * {@link GridCoverageReader#getGridCoverageNames()} allowing
 * each data GridCoverage2D to be accessed independently.
 * <p>
 * In addition static keywords for use with 
 * {@link GridCoverageReader#getMetadataNames(String coverageName)} have been provided.
 *
...
public interface GridCoverage2DReader extends GridCoverageReader {
     ...
     * the coverage. This {@link URL} might be used to
     * obtain further information on the coverage that is not otherwise available through the 
     * {@link GridCoverage2D} API.
     */
    ...
    /**
     * Retrieves the {@link CoordinateReferenceSystem} associated to the default coverage for 
     * this {@link GridCoverage2DReader}.
     * <p>
     * <p>
     *
     * @return the {@link CoordinateReferenceSystem} mapped to the specified coverageName, or 
     * {@code null} if the provided coverageName does not map
     * to a real coverage.
     * @throws NullPointerException if the specified coverageName is <code>null</code>
     */
    ...
    /**
     * Retrieves the {@link CoordinateReferenceSystem} associated to this 
     * {@link GridCoverage2DReader} for the specified coverageName.
     * <p>
     * <p>
     *
    ...
    /**
     * Retrieves the {@link GridEnvelope} associated to the default coverage for this 
    ...
    /**
     * Retrieves the {@link MathTransform} associated to the default coverage for this 
     * {@link GridCoverage2DReader}.
     * <p>
     * <p>
     *
     ...
     *                   available read params for this
     *                   {@link GridCoverage2DReader} as specified by the {@link Format}
     * @return a {@link GridCoverage2D} for the underlying default coverage for this 
     * {@link GridCoverage2DReader} or <code>null</code> in case no
    ...
    /**
     * Return the {@link Set} of dynamic read parameters supported by this 
     * {@link GridCoverage2DReader} for the default coverage.
     *
     * @return the {@link Set} of dynamic read parameters supported by this 
     * {@link GridCoverage2DReader}.
    ...
    /**
     * Return the {@link Set} of dynamic read parameters supported by this 
     * {@link GridCoverage2DReader} for the specified coverage.
     *
     * @param coverageName the name of the coverage to work with
     * @return the {@link Set} of dynamic read parameters supported by this 
     * {@link GridCoverage2DReader}.
     * @throws IOException              in case an error occurs while creating the {@link Set} of
     * dynamic parameters.
     * @throws NullPointerException     if the specified coverageName is <code>null</code>
     * @throws IllegalArgumentException if the specified coverageName does not exist
     */
     ...
     * resolution
     * using the provided {@link OverviewPolicy}. This method works on the default coverage for 
     * this {@link GridCoverage2DReader}.
     *
     ...
     */
    double[] getReadingResolutions(OverviewPolicy policy, double[] requestedResolution) throws 
            IOException;

    /**
     * Return the resolution of the overview which would be picked out for the provided requested
     * resolution
     * using the provided {@link OverviewPolicy}. This method works on the specified coverage for
     * this {@link GridCoverage2DReader}.
     *
     * @param coverageName        the name of the coverage to work on.
     * @param policy              the {@link OverviewPolicy} to use during evaluation.
     ...
     * @throws IllegalArgumentException if the specified coverageName does not exist
     */
    double[] getReadingResolutions(String coverageName, OverviewPolicy policy, double[] 
            requestedResolution) throws IOException;
     ...
     * available, -1 if infinite are available, otherwise a
     * positive number.
     ...
     *
     * @param coverageName the name of the coverage for which we do want to get the 
     * {@link DatasetLayout}
     * @return a {@link DatasetLayout} object containing info about Overview number and Image masks.
     */
     ...
     * <p>
     * Throw an {@link IllegalArgumentException} in case the name is wrong and/or no such a 
     * coverage exists.
     *
     * @return an {@link ImageLayout} that is useful for actually knowing the {@link ColorModel},
     * the {@link SampleModel} as well as the tile grid for
     ...
     * coverage exists.
     *
     * @param coverageName the name of the coverage for which we want to know the 
     * {@link GridEnvelope}.
     * @return an {@link ImageLayout} that is useful for actually knowing the {@link ColorModel},
     * the {@link SampleModel} as well as the tile grid for
     * a certain coverage.
