...
public class GridProcessingTestBase extends GridCoverageTestBase {
  ...
  /**
   * Projects the specified coverage to the specified CRS using the specified hints. The result will
  ...
  /**
   * Performs an affine transformation on the provided coverage. The transformation is a translation
   * by 5 units along x and y axes. The result will be displayed in a window if {@link #SHOW} is set
   * to {@code true}.
   *
