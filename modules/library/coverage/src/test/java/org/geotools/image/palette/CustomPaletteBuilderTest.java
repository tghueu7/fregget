...
public class CustomPaletteBuilderTest extends Assert {
    ...
    public void testGrayColor() {
        ...
        assertTrue(indexed.getColorModel() instanceof IndexColorModel);
        IndexColorModel icm = (IndexColorModel) indexed.getColorModel();
        assertEquals(4, icm.getMapSize()); //Black background, white fill, light gray fill, dark 
        // gray fill = 4 colors
        ...
        pbj.addSource(
                new ImageWorker(image).
                        setRenderingHint(JAI.KEY_IMAGE_LAYOUT,
                                new ImageLayout(image).setTileGridXOffset(0).setTileGridYOffset
                                        (0).setTileHeight(64).setTileWidth(64)
