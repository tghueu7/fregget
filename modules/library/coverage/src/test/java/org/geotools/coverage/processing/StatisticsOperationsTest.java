...
public final class StatisticsOperationsTest extends GridProcessingTestBase {
  /**
   * Creates a raster of the given type. Because we use only one tile with one band, the code below
   * is pretty similar to the code we would have if we were just setting the values in a matrix.
   */
  ...
  public void testHistogram() {
    ...
    assertEquals(
        DataBuffer.TYPE_BYTE, sampleByteCoverage.getRenderedImage().getSampleModel().getDataType());
