...
public final class GridGeometryTest extends GridCoverageTestBase {
     ...
     */
    @Test
    public void testEnvelope() throws InvalidGridGeometryException, 
        ...
        final MathTransform transform = PixelTranslation.translate(gg.getGridToCRS2D(), 
        ...
        final GeneralGridEnvelope ge = new GeneralGridEnvelope(envelope, PixelInCell.CELL_CORNER,
                true);
    ...
    public void testPixelInCell() {
        ...
        GridGeometry2D gg = new GridGeometry2D(range, PixelInCell.CELL_CORNER, identity, null, 
                null);
        ...
        assertSame(gg.getGridToCRS(PixelInCell.CELL_CENTER), gg.getGridToCRS(PixelOrientation
                .CENTER));
    ...
    public void testWorldToGridPoint() throws Exception {
        ...
        ReferencedEnvelope bounds = new ReferencedEnvelope(new Envelope(minX, maxX, minY, maxY), 
