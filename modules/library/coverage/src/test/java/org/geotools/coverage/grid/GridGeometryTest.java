...
public final class GridGeometryTest extends GridCoverageTestBase {
  ...
  public void testEnvelope()
    ...
    final GridGeometry2D gg =
        new GridGeometry2D(
            new GeneralGridEnvelope(lower, upper, false), new GeneralEnvelope(minimum, maximum));
  ...
  public void testWorldToGridEnvelope() throws Exception {
    ...
    GridEnvelope2D expectedEnv =
        new GridEnvelope2D(
            gridBounds.x + 1, gridBounds.y + 1, gridBounds.width - 2, gridBounds.height - 2);
  ...
  public void testCanonicalFromOrthogonal() throws Exception {
    ...
    GridGeometry2D gg =
        new GridGeometry2D(
            new GridEnvelope2D(1000, 1000, 100, 100), (org.opengis.geometry.Envelope) bbox);
