...
public class CoverageTestBase {
  /**
   * {@code true} if the result of coverage operations should be displayed. This is sometime useful
   ...
   * Geotools 2 store geophysics values as {@code float} numbers, this {@code EPS} value must be of
   * the order of {@code float} relative precision, not {@code double}.
   */
   ...
   * @return The "grid to CRS" affine transform of the given coverage, or {@code null} if none or if
