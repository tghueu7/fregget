...
public class Viewer extends JPanel {
  ...
  /**
   * The main sample dimension, or {@code null} if none. Used by {@link #printPalette} for printing
   * categories.
   */
  ...
  /**
   * A convenience method showing a grid coverage. The application will be terminated when the user
   * close the frame.
   *
   * @param coverage The coverage to display.
   * @return The viewer, for information.
  ...
  /**
   * Format a unsigned byte to the specified output stream. The number will be right-justified in a
  ...
  /**
   * Format an integer to the specified output stream. The number will be right-justified in a cell
   * of 3 spaces width.
   *
   * @param The writer where to print the number.
   * @param value The number to format.
