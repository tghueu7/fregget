...
public class JTSTest extends JTSTestBase {
  ...
  public void testTransformToWGS84() throws Exception {
    ...
    Envelope envelope =
        new Envelope(130.875825803896, 130.898939990319, -16.4491956225999, -16.4338185791628);

    Envelope worldBounds2 = JTS.toGeographic(envelope, gda94);
    if (worldBounds2 instanceof BoundingBox) {
      assertEquals(
          DefaultGeographicCRS.WGS84, ((BoundingBox) worldBounds2).getCoordinateReferenceSystem());
    }
  }
  ...
  public void testToGeographicGeometry() throws Exception {
    ...
    GeometryFactory gf = new GeometryFactory();
    Point point =
        gf.createPoint(new Coordinate(-16.4463909341494, 130.882672103999, 97.009018073082));
