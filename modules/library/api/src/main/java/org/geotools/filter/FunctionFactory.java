 ...
 * <p>
 * The factory provides a list of {#link FunctionName} describing the available functions. Each 
 * FunctionName provides details
 * of the name, expected arguments and return type.
 * <p>
 * Individual functions can be created using a name from this list, along with the required 
 * number of arguments and a fallback value.
 * <p>
 * Prior to GeoTools 2.7 functions were made available as individual factories using 
