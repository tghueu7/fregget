...
public class CurvedGeometryFactory extends GeometryFactory {
   ...
   *
   * @param dimension Number of dimensions in the control point array. For the time being, any value
   *     other than 2 will cause a IllegalArgumentException
   */
  ...
  /**
   * Creates a {@link CircularString} or a {@link CircularRing} depending on whether the points are
   * forming a closed ring, or not
   *
   * @param dimension Number of dimensions in the control point array. For the time being, any value
   *     other than 2 will cause a IllegalArgumentException
   */
