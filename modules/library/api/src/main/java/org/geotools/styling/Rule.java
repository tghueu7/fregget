...
public interface Rule extends org.opengis.style.Rule {
  ...
  /**
   * The smallest value for scale denominator at which symbolizers contained by this rule should be
   * applied.
   *
   ...
   * set appropriately.
   *
   * @return An array of symbolizers to be applied, in sequence, to all of the features addressed by
   *     the FeatureTypeStyler which contains this rule.
