...
public interface GraphicLegend extends org.opengis.style.GraphicLegend {
   ...
   *
   * <p>If this value is null the natural size of the graphic will be used; or for graphics without
   * a natural size like SVG files 16x16 will be used.
   *
   * @param size
   */
   ...
   *
   * <p>This list may be directly edited; the items are considered in order from most preferred (say
   * an SVG file) to least preferred (a simple shape) with the intension that the system will make
   * use of the first entry which it is capabile of displaying.
   */
