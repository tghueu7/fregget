...
public class ReferencedEnvelope extends Envelope
   ...
   *
   * <p>NOTE: if the rectangle is empty, the resulting ReferencedEnvelope will not be. In case this
   * is needed use {@link #create(Rectangle2D, CoordinateReferenceSystem)
   ...
   * it cross the &plusmn;180ï¿½ longitude.
   *
