...
public interface Transaction extends Closeable {
   ...
   *
   * <p>This may be used to provide hints to DataStore implementations, it operates as a blackboard
   * for client, SimpleFeatureSource communication.
   */
   ...
   * </code></pre>
   *
   * <p>putState will call State.setTransaction( transaction ) to allow State a chance to configure
   * itself.
   *
   ...
   *
   * <p>FeatureSources will need to issue any changes notifications using a
   * FeatureEvent.FEATURES_CHANGED. This will need to be issued to all FeatureSources with the same
   * typeName and Transaction.
   *
   ...
   *
   * <p>All proceeding SimpleFeatureSource (for FeatureReader/Writer) operations may make use of the
   * provided property.
   */
   ...
   * DataStores can share common transaction state (example: Postgis DataStores sharing a connection
  ...
  public static interface State {
     ...
     *
     * <p>setTransaction is called with non null <code>transaction</code> when Transaction.State is
     * <code>putState</code> into a Transaction. This tranasction will be used to determine correct
     * event notification.
     *
