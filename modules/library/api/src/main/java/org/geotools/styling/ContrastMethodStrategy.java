...
public interface ContrastMethodStrategy {
  /**
   * Add a VendorOption that controls how this strategy operates. All VendorOptions are optional and
   * the strategy will operate using default values if missing.
   *
