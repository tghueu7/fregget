...
public interface TextSymbolizer2 extends TextSymbolizer {
  /**
   * The nonstandard-SLD graphic element supports putting little graphical-bits onto labels. Useful
   * for things like interstate road shields or labeled logos
   *
  ...
  /**
   * Abstract is used by text oriented renderers such as KML and RSS to specify an abstract (RSS) or
   * a snippet (KML)
   *
   * @return
   */
