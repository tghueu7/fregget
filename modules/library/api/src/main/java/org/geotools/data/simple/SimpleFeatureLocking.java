...
/**
 * Used to lock feature content to protect against other threads (or depending on the source of 
 * data other applications)
 ...
 * @source $URL$
 */
public interface SimpleFeatureLocking extends SimpleFeatureStore, 
