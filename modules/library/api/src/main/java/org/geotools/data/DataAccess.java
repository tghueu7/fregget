...
public interface DataAccess<T extends FeatureType, F extends Feature> {
   ...
   * service. Subclasses may return a specific ServiceInfo instance that has additional information
   * (such as FilterCapabilities).
   *
   * @return SeviceInfo
   */
  ServiceInfo getInfo();
   ...
   *
   * <p>A <code>DataStore</code> cannot be used after <code>dispose</code> has been called, neither
   * can any data access object it helped create, such as {@link FeatureReader}, {@link
