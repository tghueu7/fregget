...
public interface FeatureStore<T extends FeatureType, F extends Feature>
  ...
  /**
   * For backwards compatibility; please be careful that your descriptor is actually compatible with
   * the one declared.
   *
  ...
  /**
   * Deletes any existing features in the data source and then inserts new features provided by the
   * given reader. This is primarily used as a convenience method for file-based data sources.
   *
