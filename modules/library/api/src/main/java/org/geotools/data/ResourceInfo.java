...
public interface ResourceInfo {
  ...
  /**
   * Returns the bounds of the resource, expressed in the native coordinate reference system. IF the
   * bounds are unknown or undefined calling {@code isNull()} on the returned envelope will return
   * {@code true}.
   *
