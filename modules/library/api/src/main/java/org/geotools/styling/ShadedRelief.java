...
public interface ShadedRelief extends org.opengis.style.ShadedRelief {
  ...
  /**
   * The ReliefFactor gives the amount of exaggeration to use for the height of the ?hills.? A value
   * of around 55 (times) gives reasonable results for Earth-based DEMs. The default value is
   * system-dependent.
   *
