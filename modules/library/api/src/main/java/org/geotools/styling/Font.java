...
public interface Font extends org.opengis.style.Font {
   ...
   * public <T> T evaluate(Object object, Class<T> context) { // return Converters.convert(literal,
   * context); if( context.isInstance( literal) ){ return context.cast(literal); } return null; }
   * public Object getValue() { return literal; } }
   */
  interface Style {
