...
public interface FileDataStoreFactorySpi extends DataStoreFactorySpi {
   ...
   * @return Returns the typename of the datum specified (on occasion this may involve starting the
   *     parse as well to get the FeatureType -- may not be instantanious).
   * @throws IOException
   */
