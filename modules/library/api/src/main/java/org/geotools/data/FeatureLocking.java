...
public interface FeatureLocking<T extends FeatureType, F extends Feature>
   ...
   *
   * <p>To implement WFS parcial Locking retrieve your features with a query operation first before
   * trying to lock them individually. If you are not into WFS please don't ask what parcial locking
   * is.
   *
