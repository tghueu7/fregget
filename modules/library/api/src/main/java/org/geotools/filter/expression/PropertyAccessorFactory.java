...
public interface PropertyAccessorFactory {
     ...
     */
    public static final Key NAMESPACE_CONTEXT = new Hints.Key(org.xml.sax.helpers
     ...
     */
    PropertyAccessor createPropertyAccessor(Class<?> type, String xpath, Class<?> target, Hints 
            hints);
}
