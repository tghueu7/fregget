...
public enum Geometries {
  ...
  /**
   * Get the 'simple name'. Returns the same value as {@linkplain #getName()} except for MULTIPOINT,
   * MULTILINESTRING and MULTIPOLYGON, for which it returns the name without the 'Multi' prefix.
   *
