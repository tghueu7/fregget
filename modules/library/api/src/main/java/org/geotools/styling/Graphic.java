...
public interface Graphic
  ...
  /**
   * Provides a list of all the symbols which can be used to represent this graphic. A symbol is an
   * ExternalGraphic, Mark or any other object which implements the Symbol interface. These are
