 ...
 * {@link Expression#accept Expression.accept(...)}.
 * <p>
 * Please note that a generic visit( Expression ) entry point has not been provided, although 
 * Expression
 * forms a heirarchy for your convience it is not an open heirarchy. If you need to extend this 
 * system
 * please make use of {code Function}, this will allow extention while remaining standards 
 * complient.
 * </p>
 * <p>
