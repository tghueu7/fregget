...
public interface PropertyIsLike extends MultiValuedFilter {
   ...
   * the wild card characters to indicate that it should be matched literally in the content of the
   * feature's property. The default value for this property is the single character "'".
   */
  @XmlElement("escape")
  String getEscape();
