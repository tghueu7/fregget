...
public interface GridCoverageWriter {
   ...
   * @throws FileFormatNotCompatibleWithGridCoverageException if the grid coverage can't be exported
   *     in the {@linkplain #getFormat writer format}.
   ...
   * method when they know they will no longer be using this {@code GridCoverageWriter}. Otherwise,
   * the writer may continue to hold on to resources indefinitely.
   *
