...
public interface ComplexAttribute extends Attribute {
  ...
  /**
   * Override of {@link Property#getValue()} which returns the collection of {@link Property} which
   * make up the value of the complex attribute.
   */
   ...
   * @return The collection of properties which match the specified name, or an empty collection if
   *     no such properties match.
   */
