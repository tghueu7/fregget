 ...
 * spatial information in a dataset. The {@linkplain org.opengis.metadata.spatial
 * .SpatialRepresentation
 * spatial representation} entity is optional and can be specified as
 * {@linkplain org.opengis.metadata.spatial.GridSpatialRepresentation grid spatial representation
 * } and
