...
public interface Fill {
   ...
   * hexadecimal integers specify the red, green, and blue color intensities, repsectively. If null,
   * the default color is 50% gray, {@code "#808080"}.
   *
  ...
  /**
   * Indicates the opacity of the fill. This value must be a floating point number ranging from 0.0
   * to 1.0, where 0.0 means completely transparent and 1.0 means completely opaque. If null, the
   * default value is 1.0, completely opaque.
   *
