...
public final class PresentationForm extends CodeList<PresentationForm> {
  ...
  /**
   * Likeness of natural or man-made features, objects, and activities acquired through the sensing
   * of visual or any other segment of the electromagnetic spectrum by sensors, such as thermal
   * infrared, and high resolution radar and stored in digital format.
   */
   ...
   * Likeness of natural or man-made features, objects, and activities acquired through the sensing
   * of visual or any other segment of the electromagnetic spectrum by sensors, such as thermal
   * infrared, and high resolution radar and reproduced on paper, photographic material, or other
  ...
  /**
   * Representation of facts or figures systematically displayed, especially in columns, printed on
  ...
  /**
   * Returns the presentation form that matches the given string, or returns a new one if none match
   * it.
   *
