...
public interface ComplexType extends AttributeType {
   ...
   *
   * <p>This facility is used to "hide" an attribute from XPath searches, while the compelx contents
   * will still be navigated no additional nesting will be considered. It will be as if the content
   * were "folded" inline resulting in a flatter nesting structure.
   *
   ...
   * restrictions as to attribute order. All attributes are considered accessable by name (and order
