...
public interface ParametricCurveSurface extends SurfacePatch {
  /**
   * Indicates the type of surface curves used to traverse the surface horizontally with respect to
   * the parameter <var>s</var>.
   */
   ...
   * complex} to which this surface is included. These are, in general, calculated transient values.
   * The exceptions to this may occur at the extremes of the parameter space. The boundaries of the
   * parameter space support for the surface map normally to the boundaries of the target surfaces.
   * </font>
   *
   * </blockquote>
   *
