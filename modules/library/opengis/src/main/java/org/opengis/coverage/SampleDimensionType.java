...
public final class SampleDimensionType extends CodeList<SampleDimensionType> {
   ...
   *
   * @rename Renamed {@code CV_8BIT_U} as {@code UNSIGNED_8BITS} since we drop the prefix, but can't
   *     get a name starting with a digit.
   * @see #SIGNED_8BITS
   ...
   *
   * @rename Renamed {@code CV_16BIT_S} as {@code SIGNED_16BITS} since we drop the prefix, but can't
   *     get a name starting with a digit.
   * @see #UNSIGNED_16BITS
   ...
   *
   * @rename Renamed {@code CV_32BIT_S} as {@code SIGNED_32BITS} since we drop the prefix, but can't
   *     get a name starting with a digit.
   * @see #UNSIGNED_32BITS
