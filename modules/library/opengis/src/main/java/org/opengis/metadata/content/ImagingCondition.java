...
public final class ImagingCondition extends CodeList<ImagingCondition> {
  ...
  /**
   * Acute angle between the plane of the ecliptic (the plane of the Earth's orbit) and the plane of
  ...
  /**
   * Returns the imaging condition that matches the given string, or returns a new one if none match
   * it.
   *
