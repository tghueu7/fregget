...
public interface FeatureTypeStyle {
   ...
   * within a given canvas. It is not meant to be human-friendly. (The "title" property is meant to
   * be human friendly.)
   *
   ...
   * possibility to use a feature type style on a given list of features only, which is not possible
   * in OGC SE.
   *
   ...
   *
   * <p>In OGC Symbology Encoding define this method to return a single String, and ISO 19117 use a
   * Collection of String. We've choosen ISO because it is more logic that a featureTypeStyle can be
   * applied to multiple featuretypes and not limited to a single one.
   *
