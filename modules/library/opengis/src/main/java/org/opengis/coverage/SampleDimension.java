...
public interface SampleDimension {
  ...
  /**
   * The minimum value occurring in the sample dimension. If this value is not available, this value
   * can be determined from the {@link org.opengis.coverage.processing.GridAnalysis#getMinValue}
   * operation. This value can be empty if this value is not provided by the implementation.
   *
  ...
  /**
   * The maximum value occurring in the sample dimension. If this value is not available, this value
   * can be determined from the {@link org.opengis.coverage.processing.GridAnalysis#getMaxValue}
   * operation. This value can be empty if this value is not provided by the implementation.
   *
  ...
  /**
   * The unit information for this sample dimension. This interface typically is provided with grid
   * coverages which represent digital elevation data. This value will be {@code null} if no unit
   ...
   * typically used when the sample dimension represents elevation data. The default for this value
   * is 0.
   *
   * @return The offset.
   * @see #getScale
  ...
  /**
   * Scale is the value which is multiplied to grid values for this sample dimension. This attribute
   * is typically used when the sample dimension represents elevation data. The default for this
   * value is 1.
   *
