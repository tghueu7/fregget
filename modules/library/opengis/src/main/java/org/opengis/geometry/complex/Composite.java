...
public interface Composite extends Complex {
  /**
   * Returns a homogeneous collection of {@linkplain Primitive primitives} whose union would be the
   * core geometry of the composite. The complex would include all primitives in the generator and
   * all primitives on the boundary of these primitives, and so forth until {@linkplain
