...
public interface Primitive extends Geometry {
   ...
   * returned collection. The organization of the boundary set of a {@code Primitive} depends on the
   ...
   * TransfiniteSet&lt;DirectPosition&gt;} interpretation and its associated computational geometry,
   * and declare one {@code Primitive} to be "interior to" another.
   *
   ...
   * @todo Using a {@link Set} returns type allows the user to add or remove element in this set at
   *     his convenience. Is it the right interpretation of this specification?
   ...
   * several {@linkplain Complex complexes}. This association may not be navigable in this direction
  ...
  /**
   * Returns the owner of this primitive. This method is <em>optional</em> since the association in
   * ISO 19107 is navigable only from {@code Composite} to {@code Primitive}, not the other way.
   *
   * @return The owner of this primitive, or {@code null} if the association is not available or not
   ...
   *
   * <p>This method is mandatory for {@linkplain Curve curves} and {@link Surface surfaces}, and is
   * not allowed for {@linkplain Point Points} and {@linkplain Solid solids}. The later should
   * return {@code null}.
   *
