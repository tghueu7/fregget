...
public interface Solid extends Primitive {
   ...
   * <blockquote>
   *
   * <font size=2> <strong>NOTE:</strong> The exterior shell of a solid is defined only because the
   * embedding coordinate space is always a 3D Euclidean one. In general, a solid in a bounded
   ...
   * shall face away from the interior of the solid. Each {@linkplain Shell shell}, when viewed as a
   * composite surface, shall be a cycle.
   *
