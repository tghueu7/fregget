...
public interface Font {
   ...
   * are system-dependent. Any number of font-family SvgParameter elements may be given and they are
   * assumed to be in preferred order.
   *
  ...
  /**
   * The "font-style" SvgParameter element gives the style to use for a font. The allowed values are
  ...
  /**
   * The "font-size" SvgParameter element gives the size to use for the font in pixels. The default
   * is defined to be 10 pixels, though various systems may have restrictions on what sizes are
   * available.
   *
