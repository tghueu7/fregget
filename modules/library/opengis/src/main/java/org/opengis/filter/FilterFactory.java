...
public interface FilterFactory {
  /**
   * The FilterCapabilities data structure is used to describe the abilities of this FilterFactory,
   * it includes restrictions on the available spatial operations, scalar operations, lists the
   * supported functions, and describes what geometry literals are understood.
   *
   ...
   *
   * <p>Date range constructor for a feature id; none or one of {@code start} and {@code end} can be
   ...
   *
   * <p>This method is defined in strict accordance with the Filter 1.0 specification, you may find
   * the FilterFactory2.bbox(Expression, BoundingBox) to be easier to use.
   *
  ...
  /**
   * Check if all of a feature's geometry is more distant than the given distance from this object's
   * geometry.
   */
