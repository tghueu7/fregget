...
public interface TemporalFactory {
    ...
    /**
     * @param name            : This is a name that uniquely identifies the temporal reference 
     *                        system.
    ...
    /**
     * @param frame                 : This is the TM_ReferenceSystem associated with this 
     *                              TM_TemporalPosition,
     *                              if not specified, it is assumed to be an association to the 
     *                              Gregorian calendar and UTC.
     * @param indeterminatePosition : This attribute provides the only value for
     *                              TM_TemporalPosition unless a subtype of TM_TemporalPosition 
     ...
     *                              integeridentifies a specific instance of the unit used at the
     *                              highest level
     *                              of the calendar hierarchy, the second integer identifies a 
     *                              specific instance
     *                              of the unit used at the next lower level in the hierarchy, 
     *                              and so on.
     *                              The format defined in ISO 8601 for dates in the Gregorian 
     *                              calendar may be
     *                              used for any date that is composed of values for year, month 
     *                              and day.
     * @return CalendarDate
     */
    CalendarDate createCalendarDate(TemporalReferenceSystem frame, IndeterminateValue 
     ...
     *                        historic event which fixes the position of the base scale of the 
     *                        calendar era.
     * @param referenceDate   : provide the date of the reference referenceEvent
     *                        expressed as a date in the given calendar. In most calendars, this 
     *                        date is
     *                        the origin (i.e the first day) of the scale, but this is not always
     *                        true.
     ...
     *                        used as a basis for dating, the datatype for TM_Period.begin and 
     *                        Tm_Period.end shall be JulianDate.
     * @return CalendarEra
     */
     ...
     *                         event expressed as a time of day in the given clock, the reference
     *                         time
     *                         is usually the origin of the clock scale.
     * @param utcReference     : This is the 24-hour local or UTC time that corresponds to the 
     *                         reference time.
     * @return Clock
     */
    Clock createClock(ReferenceIdentifier name, Extent domainOfValidity, InternationalString 
            referenceEvent,
     ...
     * @return ClockTime
     */
    ClockTime createClockTime(TemporalReferenceSystem frame, IndeterminateValue 
            indeterminatePosition,
                              Number[] clockTime);
     ...
     * @param calendarDate          : This is a sequence of positive integers in which the first
     *                              integeridentifies a specific instance of the unit used at the
     *                              highest level of the calendar hierarchy,
     *                              the second integer identifies a specific instance of the unit
     *                              used at the next
     *                              lower level in the hierarchy, and so on. The format defined 
     *                              in ISO 8601 for
     *                              dates in the Gregorian calendar may be used for any date that
     *                              is composed
     ...
     * @return DateAndTime
     */
    DateAndTime createDateAndTime(TemporalReferenceSystem frame, IndeterminateValue 
            indeterminatePosition,
                                  InternationalString calendarEraName, int[] calendarDate, 
                                  Number[] clockTime);
     ...
     *                              as a multiple of the standard interval associated with the 
     *                              temporal coordinate system.
     * @return JulianDate
     */
    JulianDate createJulianDate(TemporalReferenceSystem frame, IndeterminateValue 
            indeterminatePosition,
     ...
     * @param beginning   : This is the temporal position at which the ordinal era began, if it 
     *                    is known.
     ...
     *                              TM_TemporalPosition unless a subtype of TM_TemporalPosition 
     *                              is used as the data type.
     * @param ordinalPosition       : This is a reference to the ordinal era in which the instant
     *                             occurs.
     * @return OrdinalPosition
     */
    OrdinalPosition createOrdinalPosition(TemporalReferenceSystem frame,
                                          IndeterminateValue indeterminatePosition, OrdinalEra 
                                                  ordinalPosition);
     ...
     *                          system.
     * @param domainOfValidity
     * @param ordinalEraSequence : An ordinal temporal reference system  consists of a set of 
     *                           ordinal eras.
    ...
    TemporalCoordinate createTemporalCoordinate(TemporalReferenceSystem frame,
                                                IndeterminateValue indeterminatePosition, Number 
                                                        coordinateValue);
     ...
     * @param interval         : The name of a single unit of measure used as the base interval 
     *                         for the scale.
     *                         it shall be one of those units of measure for time specified by 
     *                         ISO 31-1,
    ...
    TemporalCoordinateSystem createTemporalCoordinateSystem(ReferenceIdentifier name,
                                                            Extent domainOfValidity, Date origin,
