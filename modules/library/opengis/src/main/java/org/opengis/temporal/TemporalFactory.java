...
public interface TemporalFactory {
  ...
  /**
   * @param frame : This is the TM_ReferenceSystem associated with this TM_TemporalPosition, if not
   *     specified, it is assumed to be an association to the Gregorian calendar and UTC.
   ...
   *     integeridentifies a specific instance of the unit used at the highest level of the calendar
   *     hierarchy, the second integer identifies a specific instance of the unit used at the next
   *     lower level in the hierarchy, and so on. The format defined in ISO 8601 for dates in the
   *     Gregorian calendar may be used for any date that is composed of values for year, month and
   *     day.
   * @return CalendarDate
   */
   ...
   * @param referenceDate : provide the date of the reference referenceEvent expressed as a date in
   *     the given calendar. In most calendars, this date is the origin (i.e the first day) of the
   ...
   *     sunrise.
   * @param referenceTime : Provide the time of day associated with the reference event expressed as
   *     a time of day in the given clock, the reference time is usually the origin of the clock
   *     scale.
  ...
  /**
   * @param instant : This is the position of this TM_Instant, it shall be associated with a single
   ...
   * @param value : This is the length of the time interval as an integer multiple of one radix(exp
   *     -factor) of the specified unit.
   ...
   * @param indeterminatePosition : This attribute provides the only value for TM_TemporalPosition
   *     unless a subtype of TM_TemporalPosition is used as the data type.
   * @param coordinateValue : This is the distance from the scale origin expressed as a multiple of
   *     the standard interval associated with the temporal coordinate system.
   * @return JulianDate
   */
   ...
   *     it shall be one of those units of measure for time specified by ISO 31-1, or a multiple of
