...
public interface CoordinateOperationAuthorityFactory extends AuthorityFactory {
     ...
     * CoordinateReferenceSystem) CoordinateOperationFactory.createOperation}(sourceCRS, 
     * targetCRS)</code>
     * instead.
     *
    ...
    Set<CoordinateOperation> createFromCoordinateReferenceSystemCodes(String sourceCRS, String 
            targetCRS)
            throws NoSuchAuthorityCodeException, FactoryException;
}
