...
public interface PropertyType {
   ...
   *
   * <p>Note that this is not the same name as {@link Property#getName()}, which is the name of the
   * instance of the type, not the type itself.
   *
   ...
   *
   * <p>This method returns an empty set in the case of no restrictions and should not return <code>
   * null</code>.
   *
