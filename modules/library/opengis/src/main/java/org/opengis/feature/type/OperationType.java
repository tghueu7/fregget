...
public interface OperationType extends PropertyType {
   ...
   * an example a graph system could have an Edge that would have "related" operation returning that
   * was abstract, and a sub type road would define "related" based on touches, or "contains" or
   * "common vertex".
   */
  boolean isAbstract();
