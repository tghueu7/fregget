...
public interface PropertyDescriptor {
   ...
   *
   * <p>This value should never be <code>null</code>. The type contains information about the value
   * of the property such as its java class.
   */
   ...
   * name as <code>getType().getName()</code>. The former is the name of the instance, the latter is
   ...
   *
   * @return <code>true</code> if the property is allowed to be <code>null</code>, otherwise <code>
   *     false</code>.
   */
  boolean isNillable();
