...
public enum ComplianceLevel {
   ...
   * (when)?" and "A point of contact to learn more about or order the dataset (who)?". Using the
   * recommended {@linkplain Obligation#OPTIONAL optional} elements in addition to the {@linkplain
   * Obligation#MANDATORY mandatory} elements will increase interoperability, allowing users to
   * understand without ambiguity the geographic data and the related metadata provided by either
