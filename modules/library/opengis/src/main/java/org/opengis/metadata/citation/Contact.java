...
public interface Contact {
   ...
   * {@code null} if none.
   *
   * @return Physical and email address at which the organization or individual may be contacted, or
   *     {@code null}.
   */
  ...
  /**
   * On-line information that can be used to contact the individual or organization. Returns {@code
   * null} if none.
   *
   ...
   * {@code null} if none.
   *
   * @return Supplemental instructions on how or when to contact the individual or organization, or
   *     {@code null}.
   */
