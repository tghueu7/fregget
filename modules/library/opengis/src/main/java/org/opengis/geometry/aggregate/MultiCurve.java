...
public interface MultiCurve extends MultiPrimitive {
  /**
   * Returns the set containing the {@linkplain OrientableCurve orientable curves} that compose this
   * {@code MultiCurve}. The set may be modified if this geometry {@linkplain #isMutable is
   * mutable}.
   *
  ...
  /**
   * Returns the accumulated length of all {@linkplain OrientableCurve orientable curves} contained
   * in this {@code MultiCurve}.
   *
