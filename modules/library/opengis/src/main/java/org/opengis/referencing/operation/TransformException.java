...
public class TransformException extends Exception {
   ...
   * untransformable coordinates with {@linkplain Double#NaN NaN} values. This information is useful
   * in the context of concatenated transforms. May be {@code null} if unknown.
   *
