...
public interface NameFactory {
     ...
     * </font></blockquote>
     *
     * @param name          The name of the namespace to be returned. This argument can be 
     *                      created using
     *                      <code>{@linkplain #createGenericName createGenericName}(null, 
     *                      parsedNames)</code>.
     * @param headSeparator The separator to insert between the namespace and the {@linkplain 
     * GenericName#head
     *                      head}. For HTTP namespace, it is {@code "://"}. For URN namespace, it
     *                      is typically
     *                      {@code ":"}.
     * @param separator     The separator to insert between 
     * {@linkplain GenericName#getParsedNames parsed names}
     *                      in that namespace. For HTTP namespace, it is {@code "."}. For URN 
     *                      namespace, it is
     *                      typically {@code ":"}.
     ...
     * can use an arbitrary {@linkplain Locale locale} (typically {@link Locale#ENGLISH ENGLISH},
     * but not necessarly) for the unlocalized string to be returned by 
     ...
     * {@link ScopedName}.
     *
     * @param scope       The {@linkplain GenericName#scope scope} of the generic name to be 
     *                    created,
     *                    or {@code null} for a global namespace.
