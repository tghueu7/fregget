...
public interface NameSpace {
    ...
    /**
     * Represents the identifier of this namespace. If the {@linkplain #isGlobal global} 
     * attribute is
     * {@code true}, indicating that this is a top level {@code NameSpace}, then the name should 
     * be a
