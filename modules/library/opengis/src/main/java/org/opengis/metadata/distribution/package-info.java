 ...
 * contain
 * mandatory and optional elements. {@linkplain org.opengis.metadata.distribution
 * .DigitalTransferOptions
 * Digital transfer options} contains the 
 * {@linkplain org.opengis.metadata.distribution.Medium medium}
 * used for the distribution of a dataset. 
