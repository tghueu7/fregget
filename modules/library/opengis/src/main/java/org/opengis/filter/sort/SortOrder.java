...
public final class SortOrder extends CodeList<SortOrder> {
   ...
   * keyword.
   *
   * <p>We have chosen to use the full names {@link #ASCENDING} and {@link #DESCENDING} for our code
   * list. The original XML schema matches the SQL convention of {@code ASC} and {@code DESC}.
   */
  public String toSQL() {
    return sqlKeyword;
  }
