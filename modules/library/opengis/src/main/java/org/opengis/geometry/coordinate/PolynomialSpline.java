...
public interface PolynomialSpline extends SplineCurve {
  ...
  /**
   * The values used for the initial derivative (up to {@linkplain #getDegree degree} - 2) used for
   * interpolation in this {@code PolynomialSpline} at the start point of the spline.
   *
