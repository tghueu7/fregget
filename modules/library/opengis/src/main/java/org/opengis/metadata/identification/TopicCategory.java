...
public final class TopicCategory extends CodeList<TopicCategory> {
   ...
   *
   * <p>Examples: wildlife, vegetation, biological sciences, ecology, wilderness, sealife, wetlands,
   * habitat
   */
   ...
   *
   * <p>Examples: production, labour, revenue, commerce, industry, tourism and ecotourism, forestry,
   * fisheries, commercial or subsistence hunting, exploration and exploitation of resources such as
   ...
   *
   * <p>Examples: rivers and glaciers, salt lakes, water utilization plans, dams, currents, floods,
   * water quality, hydrographic charts.
   */
