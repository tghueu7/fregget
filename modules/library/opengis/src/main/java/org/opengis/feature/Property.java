...
public interface Property {
   ...
   *
   * <p>This value may be <code>null</code>. In this case <code>getDescriptor().isNillable()</code>
   ...
   *
   * <p>The descriptor provides information about the property with respect to its containing entity
   * (more often then not a {@link Feature} or {@link ComplexAttribute}.
   *
