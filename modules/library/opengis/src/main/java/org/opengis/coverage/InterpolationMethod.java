...
public class InterpolationMethod extends CodeList<InterpolationMethod> {
     ...
     * attribute
     * value associated with the nearest domain object in the domain of the coverage. Nearest 
     * neighbour
     * interpolation extends a discrete coverage to a step function defined on the convex hull of
     * the
     * domain objects in the domain of the coverage. Nearest neighbour interpolation is the only 
     * interpolation
    ...
    public static final InterpolationMethod NEAREST_NEIGHBOUR = new InterpolationMethod
            ("NEAREST_NEIGHBOUR");
     ...
     * connecting any two point value pairs. It may also be used to interpolate feature attribute
     * values
     * at positions along a curve of any form, if the positions are described by values of an 
     * arc-length
     * parameter.
     * <p>
     ...
     * <var>v</var><sub>s</sub>)
     * ((<var>p</var><sub>i</sub> - <var>p</var><sub>s</sub>)/(<var>p</var><sub>t</sub> - 
     * <var>p<var><sub>s</sub>))
     * </blockquote>
     */
     ...
     */
    @UML(identifier = "Quadratic interpolation", obligation = CONDITIONAL, specification = 
            ISO_19123)
     ...
     * of position within the grid cell.
     */
    @UML(identifier = "Biquadratic interpolation", obligation = CONDITIONAL, specification = 
            ISO_19123)
     ...
     */
    @UML(identifier = "Lost area interpolation", obligation = CONDITIONAL, specification = 
            ISO_19123)
     ...
     */
    @UML(identifier = "Barycentric interpolation", obligation = CONDITIONAL, specification = 
            ISO_19123)
