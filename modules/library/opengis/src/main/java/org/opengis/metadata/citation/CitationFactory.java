...
public interface CitationFactory extends Factory {
   ...
   * the dataset. Only one of {@code individualName}, {@code organisationName} and {@code
   * positionName} should be provided.
   *
   * @param individualName Name of the responsible person- surname, given name, title separated by a
   *     delimiter.
   ...
   *
   * @param voice Telephone number by which individuals can speak to the responsible organization or
   *     individual.
