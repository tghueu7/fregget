...
public interface CitationFactory extends Factory {
     ...
     *
     * @param deliveryPoints          Address line for the location (as described in ISO 11180, 
     *                                Annex A).
     ...
     *
     * @param phone               Telephone numbers at which the organization or individual may 
     *                            be contacted.
     * @param address             Physical and email address at which the organization or 
     *                            individual may be contacted.
     * @param onLineResource      On-line information that can be used to contact the individual 
     *                            or organization.
     * @param hoursOfService      Time period (including time zone) when individuals can contact 
     *                            the organization or individual.
     * @param contactInstructions Supplemental instructions on how or when to contact the 
     ...
     * with the dataset.
     * Only one of {@code individualName}, {@code organisationName} and {@code positionName} 
     * should be provided.
     *
     * @param individualName   Name of the responsible person- surname, given name, title 
     ...
     *
     * @param voice     Telephone number by which individuals can speak to the responsible 
     *                  organization or individual.
     * @param facsimile Telephone number of a facsimile machine for the responsible organization 
     *                  or individual.
