...
public final class Version {
  ...
  /**
   * @param index a positive integer > 0, representing the 1 based index of the requested feature in
   *     its version history.
   */
   ...
   * The token FIRST shall select the first version of a resource. The token LATEST shall select the
   * most recent version of a resource. The PREVIOUS and NEXT tokens shall select the previous or
   * next version of a resource relative to the version specified using the rid attribute. The token
   * ALL shall select all available version of a resource.
   *
   ...
   * shall be selected. The first version of a resource shall be numbered 1. If N exceeds the number
   * of versions available, the latest version of the resource shall be selected.
   *
