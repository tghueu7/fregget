...
public interface ExternalMark {
   ...
   *
   * <p>Both OnlineResource and InlineContent can't be null and both can't be set at the same time.
   *
  ...
  /**
   * Returns an integer value that can used for accessing a particular Font character in a TTF file
   * or a catalog for example.
   *
   * @return integer
   */
