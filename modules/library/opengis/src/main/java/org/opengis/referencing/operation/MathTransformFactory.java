...
public interface MathTransformFactory extends Factory {
     ...
     * For example some implementations use 
     * {@linkplain java.lang.ThreadLocal thread local variables},
     ...
     * to a derived CS. This convenience method 
     * {@linkplain #createConcatenatedTransform concatenates}
     * the parameterized transform with any other transform required for performing units changes
     * and
     ...
     * <P>Cartographic projection transforms are used by 
     * {@linkplain ProjectedCRS projected coordinate reference systems}
     * to map geographic coordinates (e.g. <var>longitude</var> and <var>latitude</var>) into 
     * (<var>x</var>,<var>y</var>)
     * coordinates. These (<var>x</var>,<var>y</var>) coordinates can be imagined to lie on a 
     * plane, such as a paper map
     * or a screen. All cartographic projection transforms created through this method will have 
     * the following properties:</P>
     * <UL>
     * <LI>Converts from (<var>longitude</var>,<var>latitude</var>) coordinates to (<var>x</var>,
     * <var>y</var>).</LI>
     ...
     * reference systems have different properties. For example, in Europe some projected CRSs 
     * use grads instead of degrees,
     * and often the {@linkplain ProjectedCRS#getBaseCRS base geographic CRS} is 
     * (<var>latitude</var>, <var>longitude</var>)
     * instead of (<var>longitude</var>, <var>latitude</var>). This means that the cartographic 
     * projected transform is often
     * used as a single step in a series of transforms, where the other steps change units and 
     * swap ordinates.</P>
     *
     ...
     * @see #getAvailableMethods
     */
    @UML(identifier = "createParameterizedTransform", obligation = MANDATORY, specification = 
            OGC_01009)
     ...
     * @throws FactoryException if the object creation failed.
     */
    @UML(identifier = "createConcatenatedTransform", obligation = MANDATORY, specification = 
            OGC_01009)
     ...
     * @throws FactoryException if the object creation failed.
     */
    @UML(identifier = "createPassThroughTransform", obligation = MANDATORY, specification = 
            OGC_01009)
