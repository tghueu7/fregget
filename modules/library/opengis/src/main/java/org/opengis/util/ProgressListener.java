...
public interface ProgressListener {
   ...
   * assumed that if the task is {@code null} applications may simply report that the process is "in
   * progress" or "working" as represented in the current locale.
   *
  ...
  /**
   * Sets the description of the current task being performed. This method is usually invoked before
   * any progress begins. However, it is legal to invoke this method at any time during the
  ...
  /**
   * Sets the description for the lenghtly operation to be reported. This method is usually invoked
  ...
  /**
   * Notifies this listener of progress in the lengthly operation. Progress are reported as a value
   * between 0 and 100 inclusive. Values out of bounds will be clamped.
   *
  ...
  /**
   * Notifies this listener that the operation has finished. The progress indicator will shows 100%
   * or disappears, at implementor choice. If warning messages were pending, they will be displayed
   * now.
   */
  void complete();
  ...
  /**
   * Reports a warning. This warning may be {@linkplain java.util.logger.Logger logged}, printed to
   * the {@linkplain System#err standard error stream}, appears in a windows or be ignored, at
   * implementor choice.
   *
   ...
   *     This is typically the line number where the error occured in the {@code source} file or the
   *     feature ID of the feature that produced the message
