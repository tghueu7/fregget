...
public interface BSplineSurface extends GriddedSurface {
  ...
  /**
   * Returns two sequences of distinct knots used to define the B-spline basis functions for the two
   * parameters. Recall that the knot data type holds information on knot multiplicity.
   *
