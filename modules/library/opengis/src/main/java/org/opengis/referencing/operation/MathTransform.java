...
public interface MathTransform {
     ...
     *                            at the first failure, wile some other implementations will fill
     *                            the untransformable
     *                            points with {@linkplain Double#NaN NaN} values, continue and 
     *                            throw the exception
     *                            only at end. Implementations that fall in the later case should
     *                            set the {@linkplain
     *                            TransformException#getLastCompletedTransform last completed 
     *                            transform} to {@code this}.
     */
     ...
     * <p>
     * <pre>
     * [ y<sub>0</sub> ]     [ e<sub>00</sub>  e<sub>01</sub>  e<sub>02</sub>  e<sub>03</sub> ] [
     * x<sub>0</sub> ]
     * [ y<sub>1</sub> ]  =  [ e<sub>10</sub>  e<sub>11</sub>  e<sub>12</sub>  e<sub>13</sub> ] [
     * x<sub>1</sub> ]
     * [ y<sub>2</sub> ]     [ e<sub>20</sub>  e<sub>21</sub>  e<sub>22</sub>  e<sub>23</sub> ] [
     * x<sub>2</sub> ]
     ...
     *
     * @return The <A HREF="../doc-files/WKT.html"><cite>Well Known Text</cite> (WKT)</A> for 
     * this object.
