...
public interface PositionFactory {
   ...
   * maintained by the {@link DirectPosition} instances. This information both helps operations stop
   * when the correct level of detail is reached, and ensure the result will be valid when rounded
   ...
   * There will be no further reference to the position instance.
   *
