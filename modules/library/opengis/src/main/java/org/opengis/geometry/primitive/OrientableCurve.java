...
public interface OrientableCurve extends OrientablePrimitive {
  /**
   * Returns an ordered pair of points, which are the start point and end point of the curve. If the
   * curve is closed, then the boundary shall be empty.
   *
   ...
   *
   * @return The owner of this orientable curve, or {@code null} if the association is not available
