...
public interface StyleFactory {
   ...
   *
   * <p>This is used to produce high quality output by allowing you to directly draw each symbol by
   * supplying your own Icon implementation.
   *
   * @param inline
   * @param replacements
   * @return
  ...
  /**
   * Create font entry; note this captures a list of font families in the preferred order, with the
   * rendering engine choosing the first entry in the list available to the runtime environment.
   *
  ...
  RasterSymbolizer rasterSymbolizer(
      ...
      Symbolizer outline);
  /**
   * Used to represent a symbolizer intended for a vendor specific rendering process. This facility
   * should be used to control subject matter that is beyond the scope of the traditional symbology
   * encoding data structure (subject matter like wind barbs or extra deegrees of freedom like
   * temporal symbolizers are good examples of the use of this facility).
   *
   * @param name handle used to refer to this symbolizer (machine readible)
