...
public enum Specification {
  ...
  /**
   * ISO 19108, Temporal Schema. This is the specification for package {@link org.opengis.temporal}
   * and sub-packages.
   */
  ISO_19108,
   ...
   * {@link org.opengis.referencing} and sub-packages.
   *
   * @see #OGC_01009
  ...
  /**
   * Coordinate Transformation Services implementation specification. This is the specification used
   * as a complement of {@linkplain #ISO_19111 ISO 19111} when an aspect was not defined in the ISO
   * specification.
   *
   * @see #ISO_19111
  ...
  /**
   * Web Feature Service implementation specification. This is the specification for package {@link
   * org.opengis.feature} and sub-packages.
   *
   ...
   * {@link org.opengis.observation.sampling}.
   *
   * @see <A HREF="http://www.opengeospatial.org/standards/bp#05-087r4">Download from OGC</A>
   * @todo Need to update the hyperlink.
   */
