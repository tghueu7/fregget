...
/**
 * {@linkplain org.opengis.referencing.ReferenceSystem Reference systems}. The following is 
 * adapted from
 ...
 * Object {@linkplain org.opengis.referencing.IdentifiedObject#getName primary names} have a data
 * type
 * {@link org.opengis.metadata.Identifier} whilst 
 * {@linkplain org.opengis.referencing.IdentifiedObject#getAlias aliases}
 * have a data type {@link org.opengis.util.GenericName}.</P>
 * <p>
 * <P ALIGN="justify">Another attribute is 
 * {@linkplain org.opengis.referencing.IdentifiedObject#getIdentifiers identifiers}.
 * This is a unique code used to reference an object in a given place. For example, an external 
 * geodetic register might
 * give the NAD83 datum a unique code of "6269". Identifiers have a data type of 
 * {@link org.opengis.metadata.Identifier}.
 * In addition to the use of an identifier as a reference to a definition in a remote register, 
