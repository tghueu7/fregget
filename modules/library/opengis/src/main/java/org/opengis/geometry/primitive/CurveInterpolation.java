...
public final class CurveInterpolation extends CodeList<CurveInterpolation> {
  ...
  /**
   * The interpolation mechanism shall return {@linkplain DirectPosition direct positions} on a
   * geodesic curve between each consecutive pair of control points. A geodesic curve is a curve of
   * shortest length. The geodesic shall be determined in the coordinate reference system of the
   * {@linkplain Curve curve} in which the {@linkplain CurveSegment curve segment} is used.
   */
  ...
  /**
   * For each set of three consecutive control points, the middle one being an even offset from the
   * beginning of the sequence of control points, the interpolation mechanism shall return
   ...
   * negative for rightward. This form shall only be used in 2 dimensions because of the restricted
   * nature of the definition technique.
   */
  @UML(
   ...
   * control point through the middle control points in order to the fourth control point. If the 4
   * control points are co-linear, the arc becomes a straight line. If the 4 control points are on
   * the same circle, the arc becomes a circular one.
   */
  ...
  /**
   * The control points are ordered as in a line-string, but they are spanned by a polynomial spline
   * function. Normally, the degree of continuity is determined by the degree of the polynomials
   * chosen.
   */
   ...
   * (quotient of polynomials) spline function. Normally, the degree of continuity is determined by
   * the degree of the polynomials chosen.
   */
