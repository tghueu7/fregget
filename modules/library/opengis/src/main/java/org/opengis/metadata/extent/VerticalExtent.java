...
public interface VerticalExtent {
     ...
     * @departure ISO 19115 specifies a generic {@linkplain org.opengis.referencing.crs
     * .CoordinateReferenceSystem
     * Coordinate Reference System} instead than the more restrictive {@linkplain VerticalCRS 
     * Vertical
     * CRS}. It may be because ISO 19111 does not allows vertical CRS to express height above the
     * ellipsoid,
     * so the full three-dimensional 
