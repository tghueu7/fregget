...
public interface InternationalString extends CharSequence, Comparable<InternationalString> {
   ...
   * may or may not be the {@linkplain Locale#getDefault() system default}. If the default locale is
   * the {@linkplain Locale#getDefault() system default} (a recommended practice), then invoking
