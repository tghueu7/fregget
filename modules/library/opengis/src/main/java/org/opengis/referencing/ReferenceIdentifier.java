...
public interface ReferenceIdentifier extends Identifier {
  ...
  /**
   * Version identifier for the namespace, as specified by the code authority. When appropriate, the
   * edition is identified by the effective date, coded using ISO 8601 date format.
   *
