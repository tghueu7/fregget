...
public final class CharacterSet extends CodeList<CharacterSet> {
  ...
  /**
   * ISO/IEC 8859-10, Information technology. 8-bit single-byte coded graphic character sets - Part
  ...
  /**
   * ISO/IEC 8859-11, Information technology. 8-bit single-byte coded graphic character sets - Part
   * 11: Latin/Thai alphabet.
   */
  ...
  /**
   * ISO/IEC 8859-13, Information technology. 8-bit single-byte coded graphic character sets - Part
   * 13: Latin alphabet No. 7.
   */
  ...
  /**
   * ISO/IEC 8859-14, Information technology. 8-bit single-byte coded graphic character sets - Part
  ...
  /**
   * ISO/IEC 8859-15, Information technology. 8-bit single-byte coded graphic character sets - Part
   * 15: Latin alphabet No. 9.
   */
  ...
  /**
   * ISO/IEC 8859-16, Information technology. 8-bit single-byte coded graphic character sets - Part
   * 16: Latin alphabet No. 10.
   */
  ...
  /**
   * Constructs an enum with identical name and charset. This is needed for {@link CodeList#valueOf}
   * reflection.
   */
