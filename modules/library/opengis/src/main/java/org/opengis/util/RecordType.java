...
public interface RecordType {
  ...
  /**
   * Returns the dictionary of all (<var>name</var>, <var>type</var>) pairs in this record type. The
   * dictionary shall be {@linkplain java.util.Collections#unmodifiableMap unmodifiable}.
   *
