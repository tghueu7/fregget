 ...
 * ({@linkplain org.opengis.metadata.content.CoverageDescription coverage description}). Both 
 * description
 * entities are subclasses of the {@linkplain org.opengis.metadata.content.ContentInformation 
 * content
 * information} entity. 
 * {@linkplain org.opengis.metadata.content.CoverageDescription Coverage description}
 * may be subclassed as 
 * {@linkplain org.opengis.metadata.content.ImageDescription image description}.</P>
 *
