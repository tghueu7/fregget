...
public interface CRSFactory extends ObjectFactory {
     ...
     * @param properties         Name and other properties to give to the new object.
     *                           Available properties are {@linkplain ObjectFactory listed there}.
     * @param baseCRS            Coordinate reference system to base the projection on. The 
     *                           number of axes
     *                           must matches the 
     *                           {@linkplain OperationMethod#getSourceDimensions source dimensions}
     ...
     *                           must matches
     *                           the 
     *                           {@linkplain OperationMethod#getTargetDimensions target dimensions} of the conversion
     *                           from base.
     * @return The coordinate reference system for the given properties.
     * @throws FactoryException if the object creation failed.
