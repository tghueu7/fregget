...
public interface CRSFactory extends ObjectFactory {
   ...
   * "{@linkplain Conversion#getMathTransform base to derived}" transform, at user's choice. If a
   * transform is provided, this method may or may not use it at implementation choice. Otherwise it
   ...
   *     {@linkplain OperationMethod#getTargetDimensions target dimensions} of the conversion from
   *     base.
   * @return The coordinate reference system for the given properties.
   * @throws FactoryException if the object creation failed.
   ...
   * performing {@linkplain CoordinateSystemAxis#getUnit unit} conversions and change of {@linkplain
   * CoordinateSystem#getAxis axis} order; those operations shall be inferred by this constructor by
   ...
   * @param properties Name and other properties to give to the new object. Available properties are
   *     {@linkplain ObjectFactory listed there}.
   * @param baseCRS Geographic coordinate reference system to base the projection on. The number of
   *     axes must matches the {@linkplain OperationMethod#getSourceDimensions source dimensions} of
