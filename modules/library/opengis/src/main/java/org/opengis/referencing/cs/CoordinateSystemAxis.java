...
public interface CoordinateSystemAxis extends IdentifiedObject {
   ...
   * up} or {@linkplain AxisDirection#DOWN down}. Within any set of coordinate system axes, only one
   * of each pair of terms can be used. For earth-fixed coordinate reference systems, this direction
   * is often approximate and intended to provide a human interpretable meaning to the axis. When a
   * geodetic datum is used, the precise directions of the axes may therefore vary slightly from
