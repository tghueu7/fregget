 ...
 * <p>
 * <code>{@linkplain #getSchemaName()}.{@linkplain LocalName#scope scope()}
 * .{@linkplain NameSpace#name name()}</code>.
 *
...
public interface RecordSchema {
    ...
    /**
     * Looks up the provided type name and returns the associated record type. If the type name 
     * is not
     * defined within this schema, then this method returns {@code null}. This is functionnaly 
     * equivalent
