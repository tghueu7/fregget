...
public interface FilterFactory2 extends FilterFactory {
    ...
    <T> Parameter<T> parameter(String name, Class<T> type, InternationalString title,
                               InternationalString description, boolean required, int minOccurs, 
                               int maxOccurs,
                               T defaultValue);
     ...
     * @param nargs    number of arguments, use a negative number to indicate a minimum if the 
     *                 function
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * Checks if the geometry expression overlaps the specified bounding box.
     */
    BBOX bbox(Expression geometry, double minx, double miny, double maxx, double maxy, String 
     ...
     * </p>
     *
     * @param geometry Expression used to access a Geometry, in order to check for interaction 
     *                 with bounds
