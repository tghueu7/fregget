...
public interface AggregateFactory {
   ...
   * point instances will have consequences in the geometric behaviour of the {@code MultiPoint} and
   * vice versa.
   *
   ...
   * curve instances will have consequences in the geometric behaviour of the {@code MultiCurve} and
   * vice versa.
   *
   ...
   * The created {@code MultiSurface} will hold only references to the given surfaces, e.g. changes
   * in the surface instances will have consequences in the geometric behaviour of the {@code
   * MultiSurface} and vice versa.
   *
