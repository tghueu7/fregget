...
public interface RepresentativeFraction {
  ...
  /**
   * Returns a hash value for this representative fraction. {@code RepresentativeFraction} is a data
   * object - {@code hashcode} is defined according to {@link #getDenominator}.
   *
   * <p>Implementations should match the following:
   *
   * <blockquote>
