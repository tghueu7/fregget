...
public interface CoordinateOperationFactory extends ObjectFactory {
     ...
     * </ul>
     * <p>
     * <b>Example:</b> A transformation between two {@linkplain org.opengis.referencing.crs
     * .GeographicCRS
     ...
     * {@linkplain org.opengis.referencing.crs.CRSFactory#createProjectedCRS projected CRS} 
     * constructors.
     * <p>
     ...
     * <tr>
     * <td nowrap>&nbsp;{@value org.opengis.referencing.operation
     * .CoordinateOperation#POSITIONAL_ACCURACY_KEY}&nbsp;</td>
     * <td nowrap>&nbsp;<code>{@linkplain org.opengis.metadata.quality.PositionalAccuracy
     * }[]</code>&nbsp;</td>
     * <td nowrap>&nbsp;{@link CoordinateOperation#getPositionalAccuracy}</td>
     * </tr>
     * <tr>
     * <td nowrap>&nbsp;{@value org.opengis.referencing.operation
     * .CoordinateOperation#VALID_AREA_KEY}&nbsp;</td>
