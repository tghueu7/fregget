 ...
 * size="-1">{@linkplain #head head}</font></td><td></td>
 * <td bgcolor="palegoldenrod" colspan="5"><font 
 * size="-1">{@linkplain ScopedName#tail tail}</font></td>
 * <td rowspan="3"></td>
 * <td rowspan="3" bgcolor="beige" align="left">{@linkplain NameSpace#isGlobal global}</td>
 * <td rowspan="3" bgcolor="beige" align="right">{@literal {"org", "opengis", "util", 
 * "Record"}}</td>
 * </tr>
 * <tr align="center">
 * <td bgcolor="wheat" colspan="5"><font 
 * size="-1">{@linkplain ScopedName#path path}</font></td><td></td>
 ...
 * <tr align="center">
 * <td bgcolor="palegoldenrod" colspan="1" rowspan="3"><font 
 * size="-1">{@linkplain #scope scope}</font></td><td rowspan="3"></td>
 ...
 * <tr><td colspan="7" height="3"></td></tr>
 * <tr align="center">
 * <td bgcolor="palegoldenrod" colspan="3" rowspan="3"><font size="-1">scope</font></td><td 
 * rowspan="3"></td>
 * <td bgcolor="palegoldenrod" colspan="1"><font size="-1">head</font></td><td></td>
 ...
 * <tr><td colspan="7" height="3"></td></tr>
 * <tr align="center">
 * <td bgcolor="palegoldenrod" colspan="5" rowspan="3"><font size="-1">scope</font></td><td 
 * rowspan="3"></td>
...
public interface GenericName extends Comparable<GenericName> {
    ...
    /**
     * Indicates the number of levels specified by this name. The depth is the 
     * {@linkplain List#size size}
     * of the list returned by the {@link #getParsedNames} method. As such it is a derived 
     * parameter. For
     * any {@link LocalName}, it is always one. For a {@link ScopedName} it is some number 
     * greater than or
     * equal to 2.
     * <p>
     ...
     * list containing {@code {"org", "opengis", "util", "Record"}} elements in that iteration 
     * order.
     ...
     * <p>
     * <li><code>push(</code><var>foo</var><code> : LocalName)
     * .{@linkplain ScopedName#tail tail()}</code>
     ...
     * </ul>
     * <p>
     * This method is similar in purpose to <code>{@linkplain javax.naming.Name#addAll(int, javax
     * .naming.Name)
