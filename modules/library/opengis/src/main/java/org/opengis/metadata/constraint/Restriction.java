...
public final class Restriction extends CodeList<Restriction> {
  ...
  /**
   * Exclusive right to the publication, production, or sale of the rights to a literary, dramatic,
  ...
  /**
   * Rights to financial benefit from and control of distribution of non-tangible property that is a
