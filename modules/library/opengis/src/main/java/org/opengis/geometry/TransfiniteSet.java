...
public interface TransfiniteSet {
  /**
   * Returns {@code true} if this {@code TransfiniteSet} contains another {@code TransfiniteSet}. If
   * the passed {@code TransfiniteSet} is a {@linkplain org.opengis.geometry.primitive.Point point},
   * then this operation is the equivalent of a set-element test for the {@linkplain DirectPosition
   * direct position} of that point within this {@code TransfiniteSet}.
   *
   * <blockquote>
   *
   * <font size=2> <strong>NOTE:</strong> {@code contains} is strictly a set theoretic containment,
   ...
   * another unless a dimension is skipped. </font>
   *
   * </blockquote>
   *
  ...
  /**
   * Returns {@code true} if this {@code TransfiniteSet} intersects another {@code TransfiniteSet}.
   * Withing a {@linkplain org.opengis.geometry.complex.Complex complex}, the {@linkplain
   * org.opengis.geometry.primitive.Primitive primitives} do not intersect one another. In general,
   ...
   * org.opengis.geometry.primitive.Curve curves} do not intersect if they share a common end point
   * because {@linkplain org.opengis.geometry.primitive.Primitive primitives} are considered to be
   * open (do not contain their boundary). If two {@linkplain
  ...
  /**
   * Returns {@code true} if this {@code TransfiniteSet} is equal to another {@code TransfiniteSet}.
   * Two different instances of {@code TransfiniteSet} are equal if they return the same boolean
   * value for the operation {@link #contains(DirectPosition) contains} for every tested {@linkplain
   * DirectPosition direct position} within the valid range of the coordinate reference system
   ...
   * quite different, representations. This test may be limited to the resolution of the coordinate
   * system or the accuracy of the data. Implementations may define a tolerance that returns {@code
   * true} if the two {@code TransfiniteSet} have the same dimension and each direct position in
   * this {@code TransfiniteSet} is within a tolerance distance of a direct position in the passed
   * {@code TransfiniteSet} and vice versa. </font>
   *
   * </blockquote>
   *
