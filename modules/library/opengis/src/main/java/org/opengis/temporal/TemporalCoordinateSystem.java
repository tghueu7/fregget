...
public interface TemporalCoordinateSystem extends TemporalReferenceSystem {
  /**
   * Position of the origin of the scale on which the temporal coordinate system is based expressed
   * as a date in the Gregorian calendar and time of day in UTC.
   */
  @UML(identifier = "origin", obligation = MANDATORY, specification = ISO_19108)
  Date getOrigin();

  /**
   * Identifies the base interval for this temporal coordinate system as a unit of measure specified
   * by ISO 31-1, or a multiple of one of those units, as specified by ISO 1000.
   */
