...
public interface PointPlacement extends LabelPlacement {
   ...
   *
   * <p>This will often be used to avoid over-plotting a graphic symbol marking a city or some such
   * feature. The displacements are in units of pixels above and to the right of the point. A system
   * may reflect this displacement about the X and/or Y axes to de-conflict labels. The default
