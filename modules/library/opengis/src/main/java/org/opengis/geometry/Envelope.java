...
public interface Envelope {
   ...
   * shall be the same as {@linkplain #getLowerCorner lower corner} and {@linkplain #getUpperCorner
   * upper corner} CRS.
   *
  ...
  /**
   * The length of coordinate sequence (the number of entries) in this envelope. Mandatory even when
   * the {@linkplain #getCoordinateReferenceSystem coordinate reference system} is unknown.
   *
   ...
   * should be equals (minus rounding error) to:
   *
   * <blockquote>
   *
   * <code>
