...
public interface PointArray extends List<Position> {
  ...
  /**
   * Returns the Coordinate Reference System in which the coordinates are given. May be {@code null}
   * if this particular {@code PointArray} is included in a larger object with such a reference to a
   ...
   * in the {@code PointArray}, and vice-versa. Consequently, the same {@code DirectPosition} object
   * can be reused for fetching many points from this array. Example:
   *
   * <blockquote>
   *
   * <pre>
