...
public interface Halo {
   ...
   * floating-point number. The radius is taken from the outside edge of a font glyph to extend the
   * area of coverage of the glyph (and the inside edge of “holes” in the glyphs). The halo of a
   * text label is considered to be a single shape. The default radius is one pixel. Negative values
   * are not allowed.
   *
