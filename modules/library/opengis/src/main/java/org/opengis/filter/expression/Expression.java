...
public interface Expression {
   ...
   * structures. As example it can be used to represent the default stroke color in a LineSymbolizer
   * Stroke structure.
   */
   ...
   *
   * <p>The {@code context} parameter is used to control the type of the result of the expression. A
   * particular expression may not be able to evaluate to an instance of {@code context}. Therefore
   * to be safe calling code should do a null check on the return value of this method, and call
   * {@link #evaluate(Object)} if neccessary. Example:
   *
   * <pre>
   *  Object input = ...;
   ...
   * </pre>
   *
   * <p>Implementations that can not return a result as an instance of {@code context} should return
   * {@code null}.
   *
   ...
   * @return Evaluates the given expression based on the content of the given object an an instance
   *     of {@code context}.
   */
  @Extension
