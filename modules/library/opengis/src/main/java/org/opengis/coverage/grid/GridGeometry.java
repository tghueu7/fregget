...
public interface GridGeometry {
   ...
   * not always) zero. A grid with 512 cells typically have a minimum coordinate of 0 and maximum of
  ...
  /**
   * Returns the conversion from grid coordinates to real world earth coordinates. The transform is
   * often an affine transform. The coordinate reference system of the real world coordinates is
   * given by the {@link org.opengis.coverage.Coverage#getCoordinateReferenceSystem} method and maps
   * to {@linkplain PixelInCell#CELL_CENTER pixel center}.
   *
