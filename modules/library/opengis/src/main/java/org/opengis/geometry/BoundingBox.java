...
public interface BoundingBox extends Envelope {
   ...
   * {@linkplain #getMinimum getMinimum}(0)</code>. There is no guarantee that this axis is oriented
   ...
   * {@linkplain #getMaximum getMaximum}(0)</code>. There is no guarantee that this axis is oriented
   * toward {@linkplain AxisDirection#EAST East}.
   *
   ...
   * {@linkplain #getMinimum getMinimum}(1)</code>. There is no guarantee that this axis is oriented
   ...
   * {@linkplain #getMaximum getMaximum}(1)</code>. There is no guarantee that this axis is oriented
   * toward {@linkplain AxisDirection#NORTH North}.
   *
  ...
  /**
   * Provides the difference between {@linkplain #getMinX minimum} and {@linkplain #getMaxX maximum}
   * ordinate along the first axis. This is equivalent to <code>{@linkplain #getLength getLength}(0)
   * </code>. There is no guarantee that this axis is oriented toward {@linkplain AxisDirection#EAST
   * East}.
   *
  ...
  /**
   * Provides the difference between {@linkplain #getMinX minimum} and {@linkplain #getMaxX maximum}
   * ordinate along the second axis. This is equivalent to <code>
  ...
  /**
   * Includes the provided coordinates, expanding as necessary. Note that there is no guarantee that
   * the (<var>x</var>, <var>x</var>) values are oriented toward ({@linkplain AxisDirection#EAST
   * East}, {@linkplain AxisDirection#NORTH North}), since it depends on the {@linkplain
   * #getCoordinateReferenceSystem envelope CRS}.
   *
   ...
   * #getMinimum minimum} and {@linkplain #getMaximum maximum} ordinate values toward some specific
   * axis directions, typically {@linkplain AxisDirection#EAST East} and {@linkplain
   ...
   * transformations in their context. For example {@linkplain Canvas} store precomputed {@linkplain
   * Canvas#getObjectiveToDisplayTransform objective to display transforms}.
   *
