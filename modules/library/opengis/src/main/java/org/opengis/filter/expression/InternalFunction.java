...
public interface InternalFunction extends Function {
   ...
   *
   * <p>This is so because InternalFunctions do not participate on the standard SPI lookup mechanism
   ...
   *
   * <p>Note however implementations are free to return {@code this} if the actual function instance
