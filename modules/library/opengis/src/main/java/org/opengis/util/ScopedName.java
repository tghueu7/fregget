...
public interface ScopedName extends GenericName {
   ...
   * encapsulates the domain logic which formats the {@linkplain #getParsedNames parsed names} into
   * a legal string representation of the name. There will be variants on this theme. XML
