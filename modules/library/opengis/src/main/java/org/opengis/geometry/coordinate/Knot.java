...
public interface Knot {
   ...
   * nondecreasing sequence. That is, each knot's value in the sequence shall be equal to or greater
   * than the previous knot's value. The use of equal consecutive knots is normally handled using
   * the multiplicity.
   */
