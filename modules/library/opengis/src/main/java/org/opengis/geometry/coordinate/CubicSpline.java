...
public interface CubicSpline extends PolynomialSpline {
  /**
   * The interpolation mechanism for a {@code CubicSpline} is {@link CurveInterpolation#CUBIC_SPLINE
   * CUBIC_SPLINE}.
   */
  ...
  /**
   * The values used for the initial derivative. The restriction on {@code vectorAtStart} and {@code
