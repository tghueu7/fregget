...
public interface Name {
   ...
   * their own lookup mechanism through which they can use this URI. The namespace URI does serve to
   * make this name unique and is checked as part of the equals operation.
   *
   * @since GeoAPI 2.1
   */
   ...
   *
   * <ul>
   *   <li>GenericName.depth(): this concept is not interesting, we assume a namespace would be able
   *       to navigate through contained namespace on its own based on this local part.
   ...
   * </ul>
   *
   * Both return: "gopher://localhost/example/name" as they indicate the same entry in the namespace
   * system (such as a Registry or JNDI naming service).
   *
