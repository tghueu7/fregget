...
public interface ParameterDescriptor<T> extends GeneralParameterDescriptor {
   ...
   *
   * <p>When the getValueClass() is an array or Collection getMinimumValue may be used to constrain
   ...
   * #getValueClass parameter type}, then this method returns {@code null}.
   *
   * <p>When the getValueClass() is an array or Collection getMaximumValue may be used to constratin
   * the contained elements.
   *
   * @return The minimum parameter value (often an instance of {@link Double}), or {@code null}.
   */
