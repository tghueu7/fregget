...
public interface LineSymbolizer extends Symbolizer {
  ...
  /**
   * PerpendicularOffset allows to draw lines in parallel to the original geometry. For complex line
   * strings these parallel lines have to be constructed so that the distance between original
   * geometry and drawn line stays equal. This construction can result in drawn lines that are
