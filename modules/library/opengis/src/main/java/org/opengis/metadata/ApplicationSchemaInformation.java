...
public interface ApplicationSchemaInformation {
     ...
     */
    @UML(identifier = "softwareDevelopmentFileFormat", obligation = OPTIONAL, specification = 
            ISO_19115)
     ...
     */
    @Deprecated
    @UML(identifier = "featureCatalogueSupplement", obligation = OPTIONAL, specification = 
            ISO_19115)
