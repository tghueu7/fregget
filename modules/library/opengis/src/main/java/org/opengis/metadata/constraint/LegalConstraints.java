...
public interface LegalConstraints extends Constraints {
   ...
   * should returns a non-empty value only if {@linkplain #getAccessConstraints access constraints}
   * or {@linkplain #getUseConstraints use constraints} declares {@linkplain
