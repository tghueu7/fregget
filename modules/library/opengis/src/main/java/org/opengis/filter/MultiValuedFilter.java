...
public interface MultiValuedFilter extends Filter {
     ...
     * When one or more of the operands evaluates to multiple values rather than a single value, 
     * which
     ...
     * ONE - only if exactly one of the possible combinations match, the result is true 
     * (aggregated XOR)
     *
     * @author Niels Charlier, Curtin University of Technology
     */
