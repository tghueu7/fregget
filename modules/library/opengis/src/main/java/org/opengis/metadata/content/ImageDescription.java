...
public interface ImageDescription extends CoverageDescription {
   ...
   *
   * @return Whether or not the radiometric calibration information is available, or {@code null} if
   *     unknown.
   */
  @UML(
   ...
   *
   * @return Whether or not Calibration Reseau information is available, or {@code null} if unknown.
   */
  @UML(
   ...
   *
   * @return Whether or not lens aberration correction information is available, or {@code null} if
   *     unknown.
   */
  @UML(
