...
public interface GeneralDerivedCRS extends SingleCRS {
   ...
   * @rename {@code definedByConversion} may be a precise description of the association, but may be
   *     confusing as a method name since it doesn't said which CRS is the source or which one is
   *     the target. OGC document 01-009 used {@code toBase()} method name. By analogy with 01-009,
   *     this new interface specifies a method name which contains the {@code FromBase} words.
   */
