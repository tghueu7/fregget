...
public final class AxisDirection extends CodeList<AxisDirection> {
     ...
     * <th nowrap width='50%'>&nbsp;&nbsp;Absolute value&nbsp;&nbsp;</th>
     * </tr>
     * <tr><td width='50%'>&nbsp;{@link #DISPLAY_RIGHT}</td> <td width='50%'>&nbsp;
     * {@link #DISPLAY_RIGHT}</td> </tr>
     * <tr><td width='50%'>&nbsp;{@link #DISPLAY_LEFT}</td>  <td width='50%'>&nbsp;
     * {@link #DISPLAY_RIGHT}</td> </tr>
     * <tr><td width='50%'>&nbsp;{@link #DISPLAY_UP}</td>    <td width='50%'>&nbsp;
     * {@link #DISPLAY_UP}</td>    </tr>
     * <tr><td width='50%'>&nbsp;{@link #DISPLAY_DOWN}</td>  <td width='50%'>&nbsp;
     * {@link #DISPLAY_UP}</td>    </tr>
     * <tr><td width='50%'>&nbsp;{@link #FUTURE}</td>        <td width='50%'>&nbsp;
     * {@link #FUTURE}</td>        </tr>
     * <tr><td width='50%'>&nbsp;{@link #PAST}</td>          <td width='50%'>&nbsp;
     * {@link #FUTURE}</td>        </tr>
     * </table></td></tr>
     * <tr align="center"><td width='50%'>{@link #OTHER}</td><td 
     * width='50%'>{@link #OTHER}</td></tr>
     * </table>
     *
