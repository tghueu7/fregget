...
public final class AxisDirection extends CodeList<AxisDirection> {
   ...
   * the geodetic datum. In an engineering CRS, north may be defined with respect to an engineering
   * object rather than a geographical direction.
   */
  ...
  /**
   * Axis positive direction is &pi;/2 radians clockwise from north. This is usually used for Grid X
  ...
  /**
   * Axis positive direction is 3&pi;/2 radians clockwise from north. This is usually used for Grid
   ...
   * North} is {@linkplain #SOUTH South}, and the opposite direction of {@linkplain #SOUTH South} is
   * {@linkplain #NORTH North}. The same applies to {@linkplain #EAST East}-{@linkplain #WEST West},
   * {@linkplain #UP Up}-{@linkplain #DOWN Down} and {@linkplain #FUTURE Future}-{@linkplain #PAST
   * Past}, <cite>etc.</cite> If this axis direction has no opposite, then this method returns
   * {@code null}.
   *
   ...
   * {@code Math.abs(int)} method in that "negative" directions like ({@link #SOUTH}, {@link #WEST},
   * {@link #DOWN}, {@link #PAST}) are changed for their "positive" counterparts ({@link #NORTH},
   * {@link #EAST}, {@link #UP}, {@link #FUTURE}). More specifically, the following conversion table
   * is applied: <br>
   * &nbsp;
   *
