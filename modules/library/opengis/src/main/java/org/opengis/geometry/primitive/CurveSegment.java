...
public interface CurveSegment extends GenericCurve {
    ...
    /**
     * Returns an ordered array of point values that lie on the 
     * {@linkplain CurveSegment curve segment}.
     * In most cases, these will be related to control points used in the construction of the 
     * segment.
     ...
     * {@linkplain Point points} and thus the boundary may contain transient 
     * {@linkplain Point points}.
     * <p>
     * <blockquote><font size=2>
     ...
     * be cycles in themselves. The most likely scenario is that all of the points used will be 
     * transients
     * (constructed to support the return value), except for the start point and end point of the
     * aggregated
     * {@linkplain Curve curve}. These two positions, in the case where the 
     * {@linkplain Curve curve} is
     * involved in a {@linkplain org.opengis.geometry.complex.Complex complex}, will be 
     * represented as
     * {@linkplain Point points} in the same 
