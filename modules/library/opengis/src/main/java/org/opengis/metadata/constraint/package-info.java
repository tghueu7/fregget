 ...
 * may be specified as 
 * {@linkplain org.opengis.metadata.constraint.LegalConstraints legal constraints}
 ...
 * } elements have
 * a value of 
 * "{@linkplain org.opengis.metadata.constraint.Restriction#OTHER_RESTRICTIONS other restrictions
 * }".</P>
 *
