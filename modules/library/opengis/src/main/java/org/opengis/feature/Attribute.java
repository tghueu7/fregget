...
public interface Attribute extends Property {
   ...
   *
   * <p>Please note this method checks the value only - it should have the correct java binding, it
   * should only be null if isNillable is true; and if a value is provided it should satisfy all of
