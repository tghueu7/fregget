...
public final class SurfaceInterpolation extends CodeList<SurfaceInterpolation> {
  ...
  /**
   * The interpolation method shall return points on a single plane. The boundary in this case shall
   * be contained within that plane.
   */
  ...
  /**
   * The control points are organized into an irregular 2-dimensional grid and each cell within this
   * grid is spanned by a polynomial spline function.
   */
  ...
  /**
   * The control points are organized into an irregular 2-dimensional grid and each cell within this
   * grid is spanned by a rational (quotient of polynomials) spline function.
   */
