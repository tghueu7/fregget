...
public interface ArcString extends CurveSegment {
   ...
   * {@linkplain Position positions} in the sequence determines the first arc. Any three consecutive
   * {@linkplain Position positions} beginning with an odd offset, determine another arc in the
   * string.
   *
