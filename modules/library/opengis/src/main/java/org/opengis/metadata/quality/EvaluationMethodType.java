...
public final class EvaluationMethodType extends CodeList<EvaluationMethodType> {
   ...
   * where all data required is internal to the dataset being evaluated.
   */
  ...
  /**
   * Returns the evaluation method type that matches the given string, or returns a new one if none
   * match it.
   *
