...
public abstract class AbstractFilterBuilder {
    ...
    public PropertyIsLike buildLikeFilter(boolean matchCase) throws CQLException {
        ...
        try {
            ...
            throw new CQLException("Exception building LikeFilter: " + ife.getMessage(), this
                    .cqlSource);
        }
    }
    ...
    public PropertyIsBetween buildBetween() throws CQLException {
        try {
            ...
            throw new CQLException("Exception building CompareFilter: " + ife.getMessage(), this
                    .cqlSource);
        }
    }
    ...
    public PropertyIsEqualTo buildPropertyExists() throws CQLException {
        ...
        org.opengis.filter.expression.Expression[] args = new org.opengis.filter.expression
                .Expression[1];
    ...
    private Literal asLiteralTemporal(String strDate, String strTime, String timeZoneOffset)
        ...
        } else { // the time zone offset wasn't specified then the time zone is that provided by 
            // the host
    ...
    public String buildIdentifier(final int nodeIdentifier) throws CQLException {
        ...
        try {
            ...
            assert arrayParts.size() >= 1 : "postcondition: the list of identifier part must have" +
    ...
    public BinarySpatialOperator buildSpatialEqualFilter() throws CQLException {
        ...
        FilterFactory2 ff = (FilterFactory2) filterFactory; // TODO this cast must be removed. It
        // depends of Geometry implementation 
    ...
    public PropertyIsGreaterThanOrEqualTo buildPropertyIsGTEFirstDate()
        ...
        org.opengis.filter.expression.Expression property = (org.opengis.filter.expression
                .Expression) resultStack
                .popExpression();
    ...
    public Literal buildGeometry(final IToken geometry) throws CQLException {
        try {
            ...
            throw new CQLException("Error building WKT Geometry: " + e.getMessage(), geometry, e,
                    this.cqlSource);
        }
    }
    ...
    public Or buildBeforeOrDuring() throws CQLException {
        ...
        // makes the after filter
        Before right = this.filterFactory.before(property, filterFactory.literal(period
                .getBeginning()));
