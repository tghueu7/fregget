...
final class FilterToECQL implements FilterVisitor {
     ...
     * <p>
     * This visitor checks for {@link #isInFilter(Or)} and is willing to output ECQL of the form 
     ...
     */
    private boolean isFunctionTrue(PropertyIsEqualTo filter, String operation, int 
            numberOfArguments) {
    ...
    static private UnsupportedOperationException ecqlUnsupported(final String filterName) {
        return new UnsupportedOperationException("The" + filterName + " has not an ECQL " +
                "expression");
    }
