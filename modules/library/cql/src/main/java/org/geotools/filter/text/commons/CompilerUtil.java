...
public final class CompilerUtil {
  ...
  /**
   * Returns the filter resultant of the parsing process of predicate expression. Makes Expressions
   * for the predicate
   *
  ...
  public static List<Filter> parseFilterList(
      final Language language, String predicate, FilterFactory filterFactory) throws CQLException {
