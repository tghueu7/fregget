...
class FilterToCQL implements FilterVisitor {
   ...
   *
   * <p>In general this is a bad situtation which we ask people to represent with Filter.INCLUDES or
   * Filter.EXCLUDES depending on what behaviour they want to see happen - in this case literally
   * <code>null</code> was provided.
   *
   * <p>
   */
