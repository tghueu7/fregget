 ...
 * </p>
 * <p>
 * TODO This module should use the new geometry API, more info in http://docs.codehaus
 * .org/display/GEOTOOLS/GeomeryFactoryFinder+Proposal
 *
    ...
    private Object build(Node cqlNode) throws CQLException {
        switch (cqlNode.getType()) {
            ...
            case JJTCOMPOUND_ATTRIBUTE_NODE:
                return this.builder.buildCompoundAttribute(JJTSIMPLE_ATTRIBUTE_NODE, 
