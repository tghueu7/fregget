...
public class ECQL {
   ...
   * @return a {@link Filter} equivalent to the constraint specified in <code>ecqlExpression</code>.
   */
  ...
  /**
   * Parses the input string, which has to be a list of ECQL predicates separated by "<code>;</code>
   * " into a {@link List} of {@link Filter}, using the provided FilterFactory.
   *
