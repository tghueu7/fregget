...
public class ECQLCompiler extends ECQLParser implements org.geotools.filter.text.commons.ICompiler {
    ...
    public void compileFilter() throws CQLException {
        try {
            ...
            throw new CQLException(e.getMessage(), getTokenInPosition(0), e.getCause(), this
                    .source);
        }
    }
     ...
     *
     * @return List<Filter>
     * @throws CQLException if a ClassCastException occurs while casting a built item to
     *                      a Filter.
     */
