 ...
 * @version $Id$
 * @source $URL:
 * http://svn.geotools.org/geotools/trunk/gt/modules/library/cql/src/main/java/org/geotools/text
 * /filter/cql2/DurationUtil.java $
 * @since 2.5
 */
final class DurationUtil {
     ...
     * return date value.
     */
    private static Date computeDateFromDurationDate(final Date date, final String duration, int 
            sign) {
