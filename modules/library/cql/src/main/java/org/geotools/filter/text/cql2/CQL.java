...
public class CQL {
   ...
   *
   * @param cqlPredicate a string containing a query predicate in OGC CQL format.
   * @param filterFactory the {@link FilterFactory} to use for the creation of the Filter. If it is
   *     null the method finds the default implementation.
  ...
  /**
   * Parses the input string in OGC CQL format into an Expression, using the systems default {@link
   * FilterFactory} implementation.
   *
  ...
  /**
   * Parses the input string in OGC CQL format into an {@link Expression}, using the provided {@link
   * FilterFactory}.
   *
   * @param cqlExpression a string containing a OGC CQL expression.
   * @param filterFactory the {@link FilterFactory} to use for the creation of the Expression. If it
  ...
  public static List<Filter> toFilterList(
      final String cqlSequencePredicate, final FilterFactory filterFactory) throws CQLException {
