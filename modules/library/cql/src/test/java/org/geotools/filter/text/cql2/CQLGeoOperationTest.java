...
public class CQLGeoOperationTest {
    ...
    public void Intersects() throws CQLException {
        ...
        //test bug GEOT-1980
        resultFilter = CompilerUtil.parseFilter(language, "INTERSECTS(GEOLOC, POINT(615358 " +
                "312185))");
    ...
    public void relate() throws CQLException {
        ...
        resultFilter = (PropertyIsEqualTo) CompilerUtil.parseFilter(language, "RELATE(the_geom, " +
                "LINESTRING (-134.921387 58.687767, -135.303391 59.092838), T*****FF*)");
    ...
    private void testRelatePatten(final String pattern) throws CQLException {
        ...
        resultFilter = (PropertyIsEqualTo) CompilerUtil.parseFilter(language, "RELATE(the_geom, " +
                "LINESTRING (-134.921387 58.687767, -135.303391 59.092838), " + pattern + ")");
    ...
    public void relateBadLongitudInPattern() throws CQLException {
        CQL.toFilter("RELATE(geometry, LINESTRING (-134.921387 58.687767, -135.303391 59.092838)," +
                " **1******T)");
    }
    ...
    public void invalidGeoOperation() throws CQLException {
        CompilerUtil.parseFilter(this.language, "INTERSECT(ATTR1, POINT(1 2))"); // should be 
        // "intersects"
    }
    ...
    public void within() throws CQLException {
        ...
        Filter resultFilter = CompilerUtil.parseFilter(language, "WITHIN(ATTR1, POLYGON((1 2, 1 " +
                "10, 5 10, 1 2)) )");
