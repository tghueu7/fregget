 ...
 *
 *  &lt;simple attribute name &gt; ::=  &lt;identifier&gt;| &lt;double quote&gt; &lt;any 
 *  character&gt; &lt;double quote&gt;
 *
 *  &lt;compound attribute name &gt; ::=  &lt;identifier &gt; &lt;period &gt; [{ &lt;identifier 
 *  &gt; &lt;period &gt;}...] &lt;simple attribute name &gt;
 *
...
public class CQLAttributeNameTest {
    ...
    private void testAttributeBetweenDoubleQuotes(final String attSample) throws CQLException {
        ...
        result = (PropertyIsLike) CompilerUtil.parseFilter(this.language, attSample + " LIKE " +
                "'abc%'");
