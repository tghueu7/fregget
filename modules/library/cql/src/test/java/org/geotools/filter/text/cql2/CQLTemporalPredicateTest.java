...
public class CQLTemporalPredicateTest {
  ...
  public void before() throws Exception {
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_BEFORE_PERIOD_BETWEEN_DATES);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_BEFORE_PERIOD_DATE_AND_DAYS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_BEFORE_PERIOD_YMD_HMS_DATE);
  ...
  public void beforeOrDuring() throws Exception {
    ...
    resultFilter =
        CompilerUtil.parseFilter(
            this.language, FilterCQLSample.FILTER_BEFORE_OR_DURING_PERIOD_BETWEEN_DATES);

    Assert.assertNotNull("Filter expected", resultFilter);

    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_BEFORE_OR_DURING_PERIOD_BETWEEN_DATES);
    ...
    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_BEFORE_OR_DURING_PERIOD_YMD_HMS_DATE);
    ...
    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_BEFORE_OR_DURING_PERIOD_DATE_YMD_HMS);
  ...
  public void duringOrAfter() throws Exception {
    ...
    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_DURING_OR_AFTER_PERIOD_BETWEEN_DATES);
    ...
    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_DURING_OR_AFTER_PERIOD_YMD_HMS_DATE);
    ...
    expected =
        FilterCQLSample.getSample(FilterCQLSample.FILTER_DURING_OR_AFTER_PERIOD_DATE_YMD_HMS);
  ...
  public void during() throws Exception {
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_DURING_PERIOD_DATE_YMD_HMS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_DURING_PERIOD_YMD_HMS_DATE);
  ...
  public void after() throws Exception {
    ...
    // ATTR1 BEFORE 2006-11-31T01:30:00Z/2006-12-31T01:30:00Z
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_BETWEEN_DATES);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_DAYS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_MONTH);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_YEARS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_HOURS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_MINUTES);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_SECONDS);
    ...
    resultFilter =
        CompilerUtil.parseFilter(this.language, FilterCQLSample.FILTER_AFTER_PERIOD_DATE_YMD_HMS);
