...
public class CQLTemporalPredicateTest {
    ...
    public void before() throws Exception {
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_DATE_MILLIS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_BETWEEN_DATES);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_BETWEEN_DATES_MILLIS);

        Assert.assertNotNull("Filter expected", resultFilter);

        expected = FilterCQLSample.getSample(FilterCQLSample
                .FILTER_BEFORE_PERIOD_BETWEEN_DATES_MILLIS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_DATE_AND_DAYS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_DATE_AND_YEARS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_DATE_AND_MONTHS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_PERIOD_YMD_HMS_DATE);
    ...
    public void badTime() throws CQLException {
        ...
        Assert.fail("CQLException is expected. The \"date-time\" rule require a time preceded by " +
                "\"T\"");
    }
    ...
    public void dateTime() throws Exception {
        ...
        Filter resultFilter = CompilerUtil.parseFilter(this.language, "ZONE_VALID_FROM BEFORE " +
                cqlDateTime);
    ...
    public void beforeOrDuring() throws Exception {
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_OR_DURING_PERIOD_YMD_HMS_DATE);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_BEFORE_OR_DURING_PERIOD_DATE_YMD_HMS);
    ...
    public void duringOrAfter() throws Exception {
        ...
        Assert.assertEquals("greater than or equal the first date of period ", expected, 
                resultFilter);
        ...
        Assert.assertEquals("greater than or equal the first date (is calculated subtract period " +
                        "to last date) of period",
    ...
    public void during() throws Exception {
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_DURING_PERIOD_BETWEEN_DATES);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_DURING_PERIOD_DATE_YMD_HMS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_DURING_PERIOD_YMD_HMS_DATE);
    ...
    public void after() throws Exception {
        ...
        // ATTR1 BEFORE 2006-11-31T01:30:00Z/2006-12-31T01:30:00Z
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_BETWEEN_DATES);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_MONTH);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_YEARS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_YEARS_MONTH);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_HOURS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_MINUTES);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_SECONDS);
        ...
        resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_AFTER_PERIOD_DATE_YMD_HMS);
     ...
     * Test for issue
     * <p>
     * http://jira.codehaus.org/browse/GEOT-2157?page=com.atlassian.jira.plugin.system
     * .issuetabpanels:comment-tabpanel&focusedCommentId=154661#action_154661
     * <p>
    ...
    public void issueCOT2157() throws Exception {
        ...
        Runnable cqlRunner = new Runnable() {
            public void run() {
                final String predicate = "( ZONE_VALID_FROM BEFORE 2008-09-15T00:00:00Z AND ( " +
                        "ZONE_VALID_TO IS NULL OR ZONE_VALID_TO AFTER 2008-09-15T00:00:00Z))";
                try {
    ...
    public void equal() throws Exception {
        ...
        Filter resultFilter = CompilerUtil.parseFilter(this.language, FilterCQLSample
                .FILTER_EQUAL_DATETIME);
        Assert.assertNotNull("not null expected", resultFilter);
