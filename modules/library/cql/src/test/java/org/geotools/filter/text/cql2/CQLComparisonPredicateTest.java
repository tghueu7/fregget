...
public class CQLComparisonPredicateTest {
    ...
    public void attributeName() throws Exception {
        ...
        Assert.assertTrue("PropertyIsLessThan filter was expected", actual instanceof 
                PropertyIsLessThan);
    ...
    public void longLiteral() throws Exception {
        ...
        eqFilter = (PropertyIsEqualTo) filter;
        Assert.assertEquals("attr", ((PropertyName) eqFilter.getExpression1()).getPropertyName());
        Assert.assertEquals(Long.parseLong(expectedValue), ((Literal) eqFilter.getExpression2())
                .getValue());
    }
    ...
    public void bracketRoundtripFilter() throws Exception {
        ...
        Filter f1 = CompilerUtil.parseFilter(this.language, "[[[ X < 4 ] AND NOT [ Y < 4 ]] AND [" +
                " Z < 4 ]]");
        ...
        Filter f3 = CompilerUtil.parseFilter(this.language, "[([ X < 4 ] AND NOT [ Y < 4 ]) AND [" +
                " Z < 4 ]]");
