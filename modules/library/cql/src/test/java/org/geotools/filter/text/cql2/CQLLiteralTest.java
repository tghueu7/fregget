...
public class CQLLiteralTest {
    ...
    public void geometryLiterals() throws Exception {
        ...
        // Point":" <time-second> "Z"
        result = (BinarySpatialOperator) CompilerUtil.parseFilter(this.language, "WITHIN(ATTR1, " +
                "POINT(1 2))");
        ...
        // MultiPolygon
        result = (BinarySpatialOperator) CompilerUtil.parseFilter(this.language,
                "WITHIN(ATTR1, MULTIPOLYGON( ((10 10, 10 20, 20 20, 20 15, 10 10)),((60 60, 70 " +
                        "70, 80 60, 60 60 )) ) )");
    ...
    public void clashLongLiteralandDE9IM() throws Exception {
        ...
        }
        {
            ...
            resultFilter = (PropertyIsEqualTo) CompilerUtil.parseFilter(language, "RELATE" +
                    "(the_geom, LINESTRING (-134.921387 58.687767, -135.303391 59.092838), " +
                    "201000002)");
