...
final class FilterECQLSample {
    protected static final FilterFactory FACTORY = CommonFactoryFinder.getFilterFactory((Hints) 
            null);
    ...
    public static final String FUNCTION_BETWEEN_LITERALS = "area( the_geom ) BETWEEN 10000 AND " +
            "30000";

    public static final String FUNCTION_BETWEEN_FUNCTIONS = "area( the_geom ) BETWEEN abs(10000) " +
            "AND abs(30000)";
    ...
    static {
        ...
        // (1+3) > (4-5)
        Subtract simpleSubtractExpression = FACTORY.subtract(FACTORY.literal(4), FACTORY.literal
                (5));
