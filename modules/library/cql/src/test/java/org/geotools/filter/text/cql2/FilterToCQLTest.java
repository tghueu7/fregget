...
public class FilterToCQLTest {
    ...
    public void testBeforeAndAfter() throws Exception {
        ...
        cqlTest("dateAttr AFTER 2006-10-10T01:30:00+00:00 AND dateAttr BEFORE " +
                "2010-12-31T01:30:00+00:00");
    }
    ...
    public void testAttributeContainsQuote() throws Exception {
        ...
        Assert.assertEquals("the\"geom", ((PropertyName) (((Intersects) filter).getExpression1())
        ).getPropertyName());
