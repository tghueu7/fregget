...
public final class ECQLTest {
    ...
    public void relateGeoOperation() throws CQLException {
        PropertyIsEqualTo filter = assertFilter("RELATE(geometry,LINESTRING (-134.921387 " +
                "58.687767, -135.303391 59.092838),T*****FF*)", PropertyIsEqualTo.class);
    ...
    public void dwithinGeometry() throws Exception {
        assertFilter("DWITHIN(buffer(the_geom,5), POINT (1 2), 10.0, kilometers)", 
                DistanceBufferOperator.class);
    }

    @Test
    public void dwithinReferencedGeometry() throws Exception {
        assertFilter("DWITHIN(buffer(the_geom,5), SRID=3857;POINT (1 2), 10.0, kilometers)", 
    ...
    private <F extends Expression> F assertExpression(String ecql, Class<F> expected) throws 
            CQLException {
    ...
    private <F extends Filter> F assertFilter(String ecql, String expected, Class<F> type) throws
            CQLException {
        Filter filter = ECQL.toFilter(ecql);
    ...
    public void likePredicate() throws Exception {
        ...
        PropertyIsLike like = assertFilter("strToUpperCase(anAttribute) LIKE '%BB%'", 
    ...
    public void filterListToECQLWithRefencedGeometries() throws Exception {
        ...
        String expectedECQL = "INTERSECTS(the_geom, SRID=4326;POINT (1 2)); INTERSECTS(abcd, " +
                "SRID=4962;POINT (0 0))";
        List<Filter> list = ECQL.toFilterList(expectedECQL);
    ...
    public void testDivideEncode() throws Exception {
        ...
        final Filter javaFilter = filterFactory2.less(
                filterFactory2.divide(filterFactory2.property("population"), 
                        filterFactory2.literal(2)),
