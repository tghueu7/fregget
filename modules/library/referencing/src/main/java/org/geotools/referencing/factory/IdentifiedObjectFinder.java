...
public class IdentifiedObjectFinder {
     ...
     * @see #createFromNames
     */
    final IdentifiedObject createFromIdentifiers(final IdentifiedObject object) throws 
            FactoryException {
    ...
    final IdentifiedObject createFromCodes(final IdentifiedObject object, boolean specific) 
        ...
        final Set/*<String>*/ codes = specific ? getSpecificCodeCandidates(object) : 
                getCodeCandidates(object);
        for (final Iterator it = codes.iterator(); it.hasNext(); ) {
            ...
            try {
                ...
                LOGGER.log(Level.FINEST, "Could not create '" + code + "':" + problemCode, 
                        problemCode);
                continue;
            }
