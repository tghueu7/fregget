...
public class AffineTransform2D extends XAffineTransform
  ...
  /**
   * Constructs a new {@code AffineTransform2D} from 6 values representing the 6 specifiable entries
  ...
  /**
   * Throws an {@link UnsupportedOperationException} when a mutable method is invoked, since {@code
