...
public class TransformedDirectPosition extends GeneralDirectPosition {
   ...
   * default CRS is assumed equals to {@linkplain #getCoordinateReferenceSystem this position CRS}.
   */
  ...
  /**
   * Creates a new position which will contains the result of coordinate transformations from {@code
   * sourceCRS} to {@code targetCRS}. The {@linkplain #getCoordinateReferenceSystem CRS associated
   * with this position} will be initially set to {@code targetCRS}.
   *
   ...
   *     argument may be {@code null}, in which case it is assumed the same than {@code targetCRS}.
   * @param targetCRS The {@linkplain #getCoordinateReferenceSystem CRS associated with this
   *     position}. Used for every {@linkplain #transform coordinate transformations} until the next
   *     call to {@link #setCoordinateReferenceSystem setCoordinateReferenceSystem} or {@link
   ...
   * This method never returns {@code this}, so the returned point usually doesn't need to be
   * cloned.
   *
