...
public interface LinearTransform extends MathTransform {
  ...
  /**
   * Tests whether this transform does not move any points, by using the provided {@code tolerance}
   * value. The signification of <cite>tolerance value</cite> is the same than in the following
   * pseudo-code:
   *
   * <blockquote>
   *
