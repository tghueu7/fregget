...
public class CoordinateOperationFactoryUsingWKT extends DeferredAuthorityFactory
   ...
   *
   * <ul>
   *   <li>If a value is set for the {@value GeoTools#CRS_AUTHORITY_EXTRA_DIRECTORY} system property
   *       key, then the {@value #FILENAME} file will be searched in this directory.
