...
public class MatrixParameterDescriptors extends DefaultParameterDescriptorGroup {
   ...
   * "elt_"} is the {@linkplain #prefix} for all matrix elements, and <var>row</var> and
  ...
  /**
   * Returns the parameter in this group for a matrix element at the specified index. row and column
   * indices are 0 based. Indices must be lower that the {@linkplain
  ...
  /**
   * Implementation of the {@link #descriptors()} method. Returns the parameters in this group for a
