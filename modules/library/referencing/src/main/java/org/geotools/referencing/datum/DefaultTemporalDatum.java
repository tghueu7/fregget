...
public class DefaultTemporalDatum extends AbstractDatum implements TemporalDatum {
  ...
  /**
   * Datum for time measured since May 24, 1968 at 00:00 UTC. This epoch was introduced by NASA for
  ...
  /**
   * Datum for time measured since December 31, 1899 at 12:00 UTC. A <cite>Dublin Julian day</cite>
  ...
  /**
   * Constructs a temporal datum from a set of properties. The properties map is given unchanged to
   ...
   * #getRemarks remarks} and the like are not taken in account. In other words, two temporal datums
