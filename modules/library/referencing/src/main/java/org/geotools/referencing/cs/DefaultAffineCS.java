...
public class DefaultAffineCS extends AbstractCS implements AffineCS {
   ...
   * given unchanged to the {@linkplain AbstractCS#AbstractCS(Map,CoordinateSystemAxis[])
  ...
  /**
   * Returns {@code true} if the specified axis direction is allowed for this coordinate system. The
   * default implementation accepts all directions except temporal ones (i.e. {@link
  ...
  /**
   * Returns {@code true} if the specified unit is compatible with {@linkplain SI#METER meters}. In
   * addition, this method also accepts {@link Unit#ONE}, which is used for coordinates in a grid.
