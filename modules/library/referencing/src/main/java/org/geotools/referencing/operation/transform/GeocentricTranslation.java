...
public class GeocentricTranslation extends ProjectiveTransform {
  ...
  /**
   * Creates a new geocentric affine transform. If the parameters don't contain rotation terms, then
   * this transform will be of kind "<cite>Geocentric translations</cite>". Otherwise, it will be of
   * kind "<cite>Position Vector 7-param. transformation</cite>".
   *
   ...
   * base class is the provider for the "<cite>Geocentric translations</cite>" operation (EPSG code
   * 9603). The translation terms are the same for the 2 derived operations, "<cite>Position Vector
   * 7-param. transformation</cite>" and "<cite>Coordinate Frame rotation</cite>".
   *
   * @version $Id$
   * @author Martin Desruisseaux (IRD)
   * @since 2.2
  ...
  public static class Provider extends MathTransformProvider {
     ...
     * default value is modified, then the handling of the 3D cases in {@link MolodenskiTransform}
     * must be adjusted.
     */
    static final int DEFAULT_DIMENSION = 2;

    /**
     * The number of source geographic dimension (2 or 3). This is a Geotools-specific argument. If
     * presents, an {@code "Ellipsoid_To_Geocentric"} transform will be concatenated before the
    ...
    /**
     * The number of target geographic dimension (2 or 3). This is a Geotools-specific argument. If
     * presents, a {@code "Geocentric_To_Ellipsoid"} transform will be concatenated after the
     * geocentric translation.
     */
    ...
    /**
     * The operation parameter descriptor for the "src_semi_major" optional parameter value. This is
     * a Geotools-specific argument. If presents, an {@code "Ellipsoid_To_Geocentric"} transform
     * will be concatenated before the geocentric translation. Valid values range from 0 to
     * infinity.
     */
    ...
    /**
     * The operation parameter descriptor for the "src_semi_minor" optional parameter value. This is
     * a Geotools-specific argument. If presents, an {@code "Ellipsoid_To_Geocentric"} transform
     * will be concatenated before the geocentric translation. Valid values range from 0 to
     * infinity.
     */
    ...
    /**
     * The operation parameter descriptor for the "tgt_semi_major" optional parameter value. This is
     * a Geotools-specific argument. If presents, a {@code "Geocentric_To_Ellipsoid"} transform will
     * be concatenated after the geocentric translation. Valid values range from 0 to infinity.
     */
    ...
    /**
     * The operation parameter descriptor for the "tgt_semi_minor" optional parameter value. This is
     * a Geotools-specific argument. If presents, a {@code "Geocentric_To_Ellipsoid"} transform will
     * be concatenated after the geocentric translation. Valid values range from 0 to infinity.
     */
    ...
    /**
     * The operation parameter descriptor for the <cite>X-axis translation</cite> ("dx") parameter
     * value. Valid values range from -infinity to infinity. Units are meters.
     */
    ...
    /**
     * The operation parameter descriptor for the <cite>Y-axis translation</cite> ("dy") parameter
     * value. Valid values range from -infinity to infinity. Units are meters.
     */
    ...
    /**
     * The operation parameter descriptor for the <cite>Z-axis translation</cite> ("dz") parameter
     * value. Valid values range from -infinity to infinity. Units are meters.
     */
      ...
      switch (dimension) {
        ...
        default:
          throw new IllegalArgumentException(
              Errors.format(ErrorKeys.ILLEGAL_ARGUMENT_$2, dim.getName().getCode(), dimension));
      }
  ...
  public static class ProviderSevenParam extends Provider {
    ...
    /**
     * The operation parameter descriptor for the <cite>Scale difference</cite> ("ppm") parameter
     * value. Valid values range from -infinity to infinity. Units are parts per million.
     */
