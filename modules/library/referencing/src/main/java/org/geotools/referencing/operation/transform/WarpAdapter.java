...
final class WarpAdapter extends Warp {
  ...
  /**
   * The <strong>inverse</strong> of the transform to apply for projecting an image. This transform
   * maps destination pixels to source pixels.
   */
  ...
  /**
   * Computes the source pixel positions for a given rectangular destination region, subsampled with
   * an integral period.
   */
