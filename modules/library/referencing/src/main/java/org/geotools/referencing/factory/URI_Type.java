...
final class URI_Type {
     ...
     * <a href="http://www.opengis.net/register/ogc-na/def-type">OGC Naming Authority register of
     * def types</a>.</p>
     */
    private static final URI_Type[] TYPES = {
            ...
            new URI_Type("coordinateOperation", CoordinateOperationAuthorityFactory.class), // 
            // deprecated
