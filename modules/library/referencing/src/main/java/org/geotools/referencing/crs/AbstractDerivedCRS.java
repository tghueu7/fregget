...
public class AbstractDerivedCRS extends AbstractSingleCRS implements GeneralDerivedCRS {
     ...
     * {@link org.geotools.referencing.operation.AbstractCoordinateOperation#equals} methods
     * .</STRONG>
     *
    ...
    AbstractDerivedCRS(final Map<String, ?> properties,
        ...
        this.conversionFromBase = (Conversion) DefaultOperation.create(
                ...
                /* transform  */ baseToDerived,
                /* method     */ method,
                /* type       */ (this instanceof ProjectedCRS) ? Projection.class : Conversion
                        .class);
    }
    ...
    public boolean equals(final AbstractIdentifiedObject object, final boolean compareMetadata) {
        ...
        if (super.equals(object, compareMetadata)) {
            ...
            if (equals(this.baseCRS, that.baseCRS, compareMetadata)) {
                 ...
                 * from
                 * the AbstractCoordinateOperation super-class) that is set to this 
                 * AbstractDerivedCRS.
                 */
    ...
    public int hashCode() {
         ...
         * be enough.
         */
        return (int) serialVersionUID ^ baseCRS.hashCode() ^ conversionFromBase.getName()
                .hashCode();
    }
