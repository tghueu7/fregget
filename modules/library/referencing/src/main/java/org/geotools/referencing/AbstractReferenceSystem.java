...
public class AbstractReferenceSystem extends AbstractIdentifiedObject implements ReferenceSystem {
  ...
  /**
   * Constructs a reference system from a set of properties. The properties given in argument follow
  ...
  /**
   * Description of domain of usage, or limitations of usage, for which this (coordinate) reference
   * system object is valid. Returns {@code null} if not available.
   */
