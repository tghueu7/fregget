...
public class AllAuthoritiesFactory extends ManyAuthoritiesFactory {
  /**
   * An instance of {@code AllAuthoritiesFactory} with the {@linkplain GenericName#DEFAULT_SEPARATOR
  ...
  /**
   * Returns the factories to be used by {@link ManyAuthoritiesFactory}. If the registered factories
   * changed since the last time this method has been invoked, then this method recreate the set.
   */
  @Override
