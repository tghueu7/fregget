...
public class DefaultVerticalCS extends AbstractCS implements VerticalCS {
  ...
  /**
   * Constructs a coordinate system with the same properties than the specified axis. The inherited
   ...
   * default implementation accepts only vertical directions (i.e. {@link AxisDirection#UP UP} and
   * {@link AxisDirection#DOWN DOWN}).
   */
  @Override
