...
public class DefaultEllipsoidalCS extends AbstractCS implements EllipsoidalCS {
   ...
   * DefaultCoordinateSystemAxis#GEODETIC_LATITUDE geodetic latitude}</var> axis in decimal degrees.
   */
   ...
   * default implementation accepts only the following directions: {@link AxisDirection#NORTH
