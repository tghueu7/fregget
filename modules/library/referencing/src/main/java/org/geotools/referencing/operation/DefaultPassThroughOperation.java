...
public class DefaultPassThroughOperation extends DefaultSingleOperation
  ...
  /**
   * Constructs a single operation from a set of properties. The properties given in argument follow
   * the same rules than for the {@link AbstractCoordinateOperation} constructor. Affected ordinates
  ...
  /**
   * Constructs a single operation from a set of properties and the given transform. The properties
   * given in argument follow the same rules than for the {@link AbstractCoordinateOperation}
   * constructor.
   *
   * @param properties Set of properties. Should contains at least {@code "name"}.
   * @param sourceCRS The source CRS.
