...
public class DefaultImageDatum extends AbstractDatum implements ImageDatum {
  ...
  /**
   * Returns a hash value for this image datum. {@linkplain #getName Name}, {@linkplain #getRemarks
   * remarks} and the like are not taken in account. In other words, two image datums will return
