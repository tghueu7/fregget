...
public class ReferencingFactory extends AbstractFactory implements Factory {
   ...
   * method should not returns indirect dependencies. Elements should be instance of {@link Factory}
   * or {@link FactoryException} if a particular dependency can't be obtained.
   *
