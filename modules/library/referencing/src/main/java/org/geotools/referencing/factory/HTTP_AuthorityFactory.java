...
public class HTTP_AuthorityFactory extends AuthorityFactoryAdapter
   ...
   * Hints#FORCE_LONGITUDE_FIRST_AXIS_ORDER FORCE_LONGITUDE_FIRST_AXIS_ORDER} hint with value {@link
   * Boolean#FALSE FALSE}.
   *
   ...
   * {@linkplain AuthorityFactoryAdapter#AuthorityFactoryAdapter(AuthorityFactory) super class
   * constructor}.
   */
  ...
  /**
   * Returns {@code false} if {@link Hints#FORCE_LONGITUDE_FIRST_AXIS_ORDER} should be set to {@link
   * Boolean#FALSE}. This method compares {@link Hints#FORCE_AXIS_ORDER_HONORING} with the specified
   * authority.
   *
  ...
  /**
   * Returns a factory from the specified hints. Used by {@link URN_AuthorityFactory} constructor as
   * well.
   */
