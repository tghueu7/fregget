...
public final class MatrixFactory {
   ...
   *     org.opengis.referencing.operation.MathTransform#getTargetDimensions target dimensions} + 1.
   * @param numCol For an affine transform, this is the number of {@linkplain
   *     org.opengis.referencing.operation.MathTransform#getSourceDimensions source dimensions} + 1.
   * @return An identity matrix of the given size.
   */
