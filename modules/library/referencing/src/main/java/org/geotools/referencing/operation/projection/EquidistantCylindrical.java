     ...
     * @version $Id$
     * @source $URL$
     * @see <A HREF="http://mathworld.wolfram.com/CylindricalEquidistantProjection
     * .html">Cylindrical Equidistant projection on MathWorld</A>
    ...
    public class EquidistantCylindrical extends MapProjection {
        ...
        protected EquidistantCylindrical(final ParameterValueGroup parameters)
            ...
            if (expected.contains(Provider.STANDARD_PARALLEL_1)) {
                standardParallel = abs(doubleValue(expected, Provider.STANDARD_PARALLEL_1, 
                        parameters));
        ...
        public static class Provider extends AbstractProvider {
            ...
            /**
             * The parameters group. Note the EPSG includes a "Latitude of natural origin" 
             * parameter instead
            ...
            protected MathTransform createMathTransform(final ParameterValueGroup parameters)
                ...
                if (!isSpherical(parameters)) {
                    LOGGER.log(Level.FINE, "GeoTools EquidistantCylindrical is defined only on " +
                            "the sphere, " +
                            "we're going to use spherical equations even if the projection is " +
                            "using an ellipsoid");
                }
