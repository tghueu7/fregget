...
public abstract class MathTransformProvider extends DefaultOperationMethod {
     ...
     * {@linkplain DefaultOperationMethod#DefaultOperationMethod(Map, int, int, 
    ...
    private static Map<String, Object> toMap(final IdentifiedObject parameters) {
        ...
        properties.put(IDENTIFIERS_KEY, parameters.getIdentifiers().toArray
     ...
     * @throws FactoryException               if the math transform can't be created for some 
     * other reason
    ...
    protected static ParameterDescriptor<Double> createDescriptor(
        ...
        return DefaultParameterDescriptor.create(toMap(identifiers), defaultValue, minimum, 
                maximum, unit, true);
    }
    ...
    protected static ParameterDescriptorGroup createDescriptorGroup(
            final ReferenceIdentifier[] identifiers, final GeneralParameterDescriptor[] 
            parameters) {
        ...
        for (final GeneralParameterValue value : values.values()) {
            ...
            if (value instanceof ParameterValueGroup) {
                ...
                if (descriptor instanceof ParameterDescriptorGroup) {
                    final ParameterValueGroup groups = (ParameterValueGroup) descriptor
                            .createValue();
     ...
     * {@link MathTransformProvider#createMathTransform createMathTransform}.
