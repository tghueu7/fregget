...
public class DirectPosition2D extends Point2D.Double
   ...
   * org.opengis.referencing.cs.AxisDirection#NORTH North}). Those parameter names simply match the
   * {@linkplain #x x} and {@linkplain #y y} fields. See the {@linkplain DirectPosition2D class
   * javadoc} for details.
   *
  ...
  /**
   * Constructs a 2D position from the specified ordinates in the specified CRS. Despite their name,
   * the (<var>x</var>,<var>y</var>) coordinates don't need to be oriented toward ({@linkplain
   * org.opengis.referencing.cs.AxisDirection#EAST East}, {@linkplain
   * org.opengis.referencing.cs.AxisDirection#NORTH North}). Those parameter names simply match the
   * {@linkplain #x x} and {@linkplain #y y} fields. The actual axis orientations are determined by
   * the specified CRS. See the {@linkplain DirectPosition2D class javadoc} for details.
   *
   * @param crs The coordinate reference system, or {@code null}.
   * @param x The <var>x</var> value.
   * @param y The <var>y</var> value.
   ...
   * if this particular {@code DirectPosition} is included in a larger object with such a reference
   * to a {@linkplain CoordinateReferenceSystem coordinate reference system}.
   *
  ...
  /**
   * Compares this point with the specified object for equality. If the given object implements the
   * {@link DirectPosition} interface, then the comparaison is performed as specified in its {@link
   * DirectPosition#equals} contract. Otherwise the comparaison is performed as specified in {@link
   * Point2D#equals}.
   *
  ...
  /**
   * Write this object to the specified stream. This method is necessary because the super-class is
   * not serializable.
   */
  ...
  /**
   * Read this object from the specified stream. This method is necessary because the super-class is
   * not serializable.
   */
