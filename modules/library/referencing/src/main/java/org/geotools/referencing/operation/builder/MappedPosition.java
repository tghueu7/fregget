...
public class MappedPosition implements Serializable {
  ...
  /**
   * Returns the source direct position. For performance reasons, the current implementation returns
   * a reference to the internal object. However users should avoid to modify directly the returned
   * position and use {@link #setSource} instead.
   */
  ...
  /**
   * Returns the target direct position. For performance reasons, the current implementation returns
   * a reference to the internal object. However users should avoid to modify directly the returned
   * position and use {@link #setTarget} instead.
   */
  ...
  /**
   * Returns an estimation of mapping accuracy in units of target CRS axis, or {@link Double#NaN} if
   * unknow.
   */
   ...
   * @param buffer An optionnaly pre-computed direct position to use as a buffer, or {@code null} if
   *     none. The content of this buffer will be overwritten.
