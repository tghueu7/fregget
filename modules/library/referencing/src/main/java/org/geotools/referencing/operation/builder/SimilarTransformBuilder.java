...
public class SimilarTransformBuilder extends ProjectiveTransformBuilder {
  /**
   * Creates SimilarTransformBuilder for the set of properties. The {@linkplain java.util.List List}
   * of {@linkplain org.geotools.referencing.operation.builder.MappedPosition MappedPosition} is
   * expected.
   *
