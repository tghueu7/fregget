...
public class DefaultGeographicCRS extends AbstractSingleCRS implements GeographicCRS {
   ...
   * (<var>longitude</var>,<var>latitude</var>) ordinates with longitude values increasing East and
   * latitude values increasing North. Angular units are decimal degrees and prime meridian is
   * Greenwich.
   */
