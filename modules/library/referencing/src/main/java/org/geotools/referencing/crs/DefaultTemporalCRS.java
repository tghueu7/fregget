...
public class DefaultTemporalCRS extends AbstractSingleCRS implements TemporalCRS {
  ...
  /**
   * Time measured in days since November 17, 1858 at 00:00 UTC. A <cite>Modified Julian day</cite>
   * (MJD) is defined relative to <cite>Julian day</cite> (JD) as {@code MJD = JD − 2400000.5}.
   *
