...
public class DefaultVerticalDatum extends AbstractDatum implements VerticalDatum {
  ...
  /**
   * Mapping between {@linkplain VerticalDatumType vertical datum type} and the numeric values used
   * in legacy specification (OGC 01-009).
   */
  ...
  /**
   * Constructs a vertical datum from a set of properties. The properties map is given unchanged to
   ...
   * #getRemarks remarks} and the like are not taken in account. In other words, two vertical datums
