...
public final class DirectionAlongMeridian implements Comparable, Serializable {
   ...
   * in decimal degrees. This method returns a value between -180° and +180°, or {@link Double#NaN
   * NaN} if the {@linkplain #baseDirection base directions} don't match. A positive angle denote a
   * right-handed system.
   *
   ...
   * ordering used for the majority of coordinate systems in the EPSG database, i.e. the ordering of
   * a right-handed coordinate system. Examples of ordered pairs that we should get (extracted from
   * the EPSG database):
   *
   * <table>
