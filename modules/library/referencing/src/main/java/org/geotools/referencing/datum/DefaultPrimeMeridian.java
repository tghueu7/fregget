...
public class DefaultPrimeMeridian extends AbstractIdentifiedObject implements PrimeMeridian {
  ...
  /**
   * Constructs a prime meridian from a set of properties. The properties map is given unchanged to
   ...
   * getGreenwichLongitude(NonSI.DEGREE_ANGLE)}), regardless of the underlying angular units of this
   * prime meridian.
   *
   ...
   * #getRemarks remarks} and the like are not taken in account. In other words, two prime meridians
