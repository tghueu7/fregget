...
public class ExponentialTransform1D extends AbstractMathTransform
  ...
  /**
   * Concatenates in an optimized way a {@link LogarithmicTransform1D} {@code other} to this {@code
  ...
  public static class Provider extends MathTransformProvider {
    ...
    /**
     * The operation parameter descriptor for the {@link #base base} parameter value. Valid values
     * range from 0 to infinity. The default value is 10.
     */
    public static final ParameterDescriptor BASE = LogarithmicTransform1D.Provider.BASE;

    /**
     * The operation parameter descriptor for the {@link #scale scale} parameter value. Valid values
     * range is unrestricted. The default value is 1.
     */
    ...
    static final ParameterDescriptorGroup PARAMETERS =
        createDescriptorGroup(
            new NamedIdentifier[] {
              new NamedIdentifier(
                  Citations.GEOTOOLS, Vocabulary.formatInternational(VocabularyKeys.EXPONENTIAL))
            },
