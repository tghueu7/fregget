...
public class MathTransformParser extends AbstractParser {
  ...
  /**
   * Parses the next element (a {@link MathTransform}) in the specified <cite>Well Know Text</cite>
   * (WKT) tree.
   *
  ...
  /**
   * Returns the operation method for the last math transform parsed. This is used by {@link Parser}
   * in order to built {@link org.opengis.referencing.crs.DerivedCRS}.
   */
