...
public class RotatedPole extends MapProjection {
  ...
  protected Point2D transformNormalized(double x, double y, Point2D ptDst)
    ...
    x =
        toDegrees(atan((coslat * sinlon1) / (coslat * sinlatP * coslon1 + sinlat * coslatP)))
            / globalScale;
   ...
   * provider} for an {@linkplain org.geotools.referencing.operation.projection.RotatedPole Rotated
   * Pole} projection.
   *
   * @since 15.0
   * @version $Id$
