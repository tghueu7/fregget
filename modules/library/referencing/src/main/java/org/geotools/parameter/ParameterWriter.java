...
public class ParameterWriter extends FilterWriter {
  ...
  /**
   * Prints the elements of an operation to the {@linkplain System#out default output stream}. This
   * is a convenience method for <code>new
  ...
  /**
   * Prints the elements of a descriptor group to the {@linkplain System#out default output stream}.
  ...
  /**
   * Prints the elements of a parameter group to the {@linkplain System#out default output stream}.
   * This is a convenience method for <code>new
   ...
   * @param descriptor The parameter descriptor. Should be equals to {@code values.getDescriptor()}
   *     if {@code values} is non null.
   * @param values The parameter values, or {@code null} if none.
   * @throws IOException if an error occured will writing to the stream.
   */
  private void format(
      final String name, final ParameterDescriptorGroup group, final ParameterValueGroup values)
      throws IOException {
    /*
   ...
   * format(...)} methods. The default implementation format {@link Number}, {@link Date} and {@link
   * Angle} object according the {@linkplain #getLocale current locale}. This method can been
   * overridden if more objects need to be formatted in a special way.
   *
