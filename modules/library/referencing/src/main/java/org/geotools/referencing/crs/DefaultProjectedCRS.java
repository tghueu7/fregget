...
public class DefaultProjectedCRS extends AbstractDerivedCRS implements ProjectedCRS {
  ...
  /**
   * Constructs a projected CRS from a name. A {@linkplain DefaultOperationMethod default operation
   ...
   * default operation method} is inferred from the {@linkplain MathTransform math transform}. This
   ...
   * @param baseToDerived The transform from the base CRS to returned CRS.
   * @param derivedCS The coordinate system for the projected CRS. The number of axes must match the
   *     target dimension of the transform {@code baseToDerived}.
   * @throws MismatchedDimensionException if the source and target dimension of {@code
