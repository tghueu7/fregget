...
public class PolarStereographic extends Stereographic {
  ...
  /**
   * {@code true} if this projection is for the south pole, or {@code false} if it is for the north
   * pole.
   */
  ...
  /**
   * Transforms the specified (<var>x</var>,<var>y</var>) coordinates (units in radians) and stores
  ...
  static final class Spherical extends PolarStereographic {
    ...
    /**
     * A constant used in the transformations. This constant hides the {@code k0} constant from the
     * ellipsoidal case. The spherical and ellipsoidal {@code k0} are not computed in the same way,
     * and we preserve the ellipsoidal {@code k0} in {@link Stereographic} in order to allow
     * assertions to work.
     */
    private final double k0;
     ...
     *     {@link Boolean#TRUE}, or do not force (i.e. detect from other parameter values) if {@code
     *     null}.
     * @throws ParameterNotFoundException if a required parameter was not found.
     */
    Spherical(
   ...
   *
   * <p>Compared to the default {@link PolarStereographic} implementation, the series implementation
   * is a little bit faster at the expense of a little bit less accuracy. The default {@link
   * PolarStereographic} implementation is a derivated work of Proj4, and is therefor better tested.
   *
   * @version $Id$
   * @author Rueben Schulz
   */
  static final class Series extends PolarStereographic {
    ...
    /**
     * A constant used in the transformations. This constant hides the {@code k0} constant from the
     * USGS case. The EPSG and USGS {@code k0} are not computed in the same way, and we preserve the
     * USGS {@code k0} in order to allow assertions to work.
     */
    private final double k0;
    ...
    protected Point2D inverseTransformNormalized(double x, double y, Point2D ptDst)
      ...
      final double t =
          (rho / k0)
              * sqrt(
                  pow(1 + excentricity, 1 + excentricity) * pow(1 - excentricity, 1 - excentricity))
              / 2;
  ...
  public static final class ProviderB extends Stereographic.Provider {
    ...
    /**
     * The operation parameter descriptor for the {@code standardParallel} parameter value. Valid
     * values range is from -90 to 90°. The default value is 90°N.
     */
  ...
  public static final class ProviderSouth extends Stereographic.Provider {
    ...
    /**
     * The operation parameter descriptor for the {@code standardParallel} parameter value. Valid
     * values range is from -90 to 90°. The default value is 90°S.
     */
    public static final ParameterDescriptor STANDARD_PARALLEL =
        createDescriptor(
            new NamedIdentifier[] {
