...
final class DefaultAuthorityFactory extends ThreadedAuthorityFactory
  ...
  /**
   * Implementation of {@link CRS#getSupportedCodes}. Provided here in order to reduce the amount of
   * class loading when using {@link CRS} for other purpose than CRS decoding.
   */
