...
public final class PixelTranslation implements Serializable {
  ...
  /**
   * The translation among the <var>x</var> axis relative to pixel center. The value is typically in
   * the [-0.5 .. +0.5] range.
   */
  public final double dx;

  /**
   * The translation among the <var>y</var> axis relative to pixel center. The value is typically in
   * the [-0.5 .. +0.5] range.
   */
