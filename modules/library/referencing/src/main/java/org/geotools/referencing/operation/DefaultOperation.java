...
public class DefaultOperation extends DefaultSingleOperation implements Operation {
   ...
   *     {@linkplain Projection}.class</code>, etc. This method may create an instance of a subclass
   *     of {@code type}.
   ...
   *
   * @throws UnsupportedOperationException if the parameters values can't be determined for current
   *     math transform implementation.
   ...
   * @throws UnsupportedImplementationException if the math transform implementation do not provide
