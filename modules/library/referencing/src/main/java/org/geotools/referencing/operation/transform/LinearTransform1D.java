...
public class LinearTransform1D extends AbstractMathTransform
  ...
  /**
   * Constructs a new linear transform. This constructor is provided for subclasses only. Instances
   * should be created using the {@linkplain #create factory method}, which may returns optimized
   * implementations for some particular argument values.
   *
   ...
   * default {@link AbstractMathTransform#derivative} implementation in that no coordinate point is
   * required and {@link Double#NaN} may be a legal output value for some users.
   */
  @Override
