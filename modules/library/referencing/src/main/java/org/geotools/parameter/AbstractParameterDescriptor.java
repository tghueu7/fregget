...
public abstract class AbstractParameterDescriptor extends AbstractIdentifiedObject
  ...
  /**
   * Constructs a descriptor with the same values than the specified one. This copy constructor may
   * be used in order to wraps an arbitrary implementation into a Geotools one.
   *
   * @since 2.2
   */
   ...
   * @param minimumOccurs The {@linkplain #getMinimumOccurs minimum number of times} that values for
   *     this parameter group or parameter are required.
   * @param maximumOccurs The {@linkplain #getMaximumOccurs maximum number of times} that values for
   *     this parameter group or parameter are required. This value is used in order to check the
   *     range. For {@link org.opengis.parameter.ParameterValue}, it should always be 1.
   */
  ...
  /**
   * The minimum number of times that values for this parameter group or parameter are required. The
   * default value is one. A value of 0 means an optional parameter.
   *
   ...
   * For a {@linkplain DefaultParameterDescriptor single parameter}, the value is always 1. For a
