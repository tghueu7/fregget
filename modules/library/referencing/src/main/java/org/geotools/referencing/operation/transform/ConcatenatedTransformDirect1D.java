...
final class ConcatenatedTransformDirect1D extends ConcatenatedTransformDirect
  ...
  /**
   * The first math transform. This field is identical to {@link ConcatenatedTransform#transform1}.
   * Only the type is different.
   */
  private final MathTransform1D transform1;

  /**
   * The second math transform. This field is identical to {@link ConcatenatedTransform#transform1}.
   * Only the type is different.
   */
