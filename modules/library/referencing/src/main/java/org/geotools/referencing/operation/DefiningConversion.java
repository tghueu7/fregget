...
public class DefiningConversion extends DefaultConversion {
  ...
  /**
   * Convenience constructor for creating a defining conversion with a default operation method. The
   * operation method is assumed two-dimensional.
   *
  ...
  /**
   * Constructs a conversion from a math transform. The properties given in argument follow the same
