...
public abstract class DirectAuthorityFactory extends AbstractAuthorityFactory {
  ...
  /**
   * Tells if {@link ReferencingFactoryContainer#hints} has been invoked. It must be invoked exactly
   * once, but can't be invoked in the constructor because it causes a {@link StackOverflowError} in
   * some situations.
   */
