...
abstract class URI_Parser {
  ...
  /**
   * Returns the concatenation of the {@linkplain #authority} and the {@linkplain #code}, separated
   * by {@link #AUTHORITY_CODE_SEPARATOR}.
   */
   ...
   * is found, a warning is logged but no exception is thrown since it doesn't prevent the class to
