...
public final class BoundingBoxes {
   ...
   * transforms because {@link GeographicBoundingBox} are usually for approximative bounds (e.g. the
   * area of validity of some CRS). If a user wants accurate bounds, he should probably use an
