...
public class Angle implements Comparable<Angle>, Serializable {
   ...
   * by the string. The string should represents an angle in either fractional degrees (e.g. 45.5°)
   * or degrees with minutes and seconds (e.g. 45°30').
   *
  ...
  /**
   * Returns a shared instance of {@link AngleFormat}. The return type is {@link Format} in order to
