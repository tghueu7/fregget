...
public class ReferencingObjectFactory extends ReferencingFactory
     ...
     * <p>
     * <blockquote><pre>
     * {@linkplain DatumFactory} factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getDatumFactory getDatumFactory}null);
     * {@linkplain CSFactory}    factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getCSFactory    getCSFactory}(null);
     * {@linkplain CRSFactory}   factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getCRSFactory   getCRSFactory}(null);
     * </pre></blockquote>
     */
     ...
     * <blockquote><pre>
     * {@linkplain DatumFactory} factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getDatumFactory getDatumFactory}(hints);
     * {@linkplain CSFactory}    factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getCSFactory    getCSFactory}(hints);
     * {@linkplain CRSFactory}   factory = FactoryFinder
     * .{@linkplain ReferencingFactoryFinder#getCRSFactory   getCRSFactory}(hints);
     * </pre></blockquote>
     *
    ...
    public Ellipsoid createEllipsoid(Map<String, ?> properties,
                                     double semiMajorAxis, double semiMinorAxis, Unit<Length> 
    ...
    public PrimeMeridian createPrimeMeridian(Map<String, ?> properties,
                                             double longitude, Unit<Angle> angularUnit) throws 
            FactoryException {
    ...
    public CoordinateSystemAxis createCoordinateSystemAxis(Map<String, ?> properties,
                                                           String abbreviation, AxisDirection 
                                                                   direction, Unit<?> unit) 
            throws FactoryException {
    ...
    public CompoundCRS createCompoundCRS(Map<String, ?> properties,
                                         CoordinateReferenceSystem[] elements) throws 
            FactoryException {
        CompoundCRS crs;
        try {
    ...
    public ProjectedCRS createProjectedCRS(Map<String, ?> properties,
        ...
        if (existing != null && mtFactory instanceof DefaultMathTransformFactory) {
             ...
             * instances.
             */
            mt = ((DefaultMathTransformFactory) mtFactory).createBaseToDerived(baseCRS, existing,
                    derivedCS);
        } else {
            /*
     ...
     * datum-alias patch.
     */
    private void createParser(final DatumFactory datumFactory, final MathTransformFactory 
            mtFactory) {
