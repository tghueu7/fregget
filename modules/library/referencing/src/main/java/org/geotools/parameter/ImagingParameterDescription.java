...
final class ImagingParameterDescription extends AbstractInternationalString
  ...
  /**
   * If the specified name starts with the specified prefix, removes the prefix from the name. This
   * is used for removing the "org.geotools" part in operation name like "org.geotools.NodataFilter"
   * for example.
   */
