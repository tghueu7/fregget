...
public abstract class Abstract_URI_AuthorityFactory extends AuthorityFactoryAdapter
   ...
   * #createVersionedFactory} method may be invoked for that purpose. If no factory is provided for
   * that specific version, then the {@linkplain AuthorityFactoryAdapter#getDatumAuthorityFactory
   * default one} is used.
   *
   ...
   * #URI_AuthorityFactory(AuthorityFactory, String, Citation) construction time}.
   *
