...
class RubberSheetTransform extends AbstractMathTransform implements MathTransform2D {
  /**
   * Helper variable to hold triangle. It is use for optimalization of searching in TIN for triangle
   * containing points that are transformed.
   */
   ...
   * @todo This method doesn't meet the {@link MathTransform#toString} constract, which should uses
   *     Well Known Text (WKT) format as much as possible.
   */
  @Override
