...
final class Properties extends AbstractMap<String, Object> {
  ...
  /**
   * Returns the value to which this map maps the specified index. Returns null if the map contains
  ...
  /**
   * The keys to search for. <STRONG>The index of each element in this array must matches the index
   * searched by {@link #get(int)}.</STRONG>
   *
