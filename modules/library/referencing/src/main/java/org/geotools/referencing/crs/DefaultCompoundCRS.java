...
public class DefaultCompoundCRS extends AbstractCRS implements CompoundCRS {
   ...
   * given list, then it is returned in other to share the same list in both {@link #crs} and {@link
   * #singles} references.
   *
   ...
   * other compound CRS, all of them are expanded in an array of {@code SingleCRS} objects.
   *
  ...
  /**
   * Computes the {@link #singles} field from the given CRS list and returns {@code true} if it has
   * the same content.
   */
