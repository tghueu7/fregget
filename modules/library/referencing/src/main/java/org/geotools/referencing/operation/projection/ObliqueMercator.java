...
public class ObliqueMercator extends MapProjection {
   ...
   * #centralMeridian}, which is the meridian where the central line intersects the Earth equator on
   * aposphere.
   *
  ...
  public static class Provider extends AbstractProvider {
    ...
    /**
     * The operation parameter descriptor for the {@link #azimuth azimuth} parameter value. Valid
     * values range is from -360 to -270, -90 to 90, and 270 to 360 degrees. Default value is 0.
     */
  ...
  public static class Provider_TwoPoint extends Provider {
    ...
    /**
     * The operation parameter descriptor for the {@code latitudeOf1stPoint} parameter value. Valid
    ...
    /**
     * The operation parameter descriptor for the {@code longitudeOf1stPoint} parameter value. Valid
    ...
    /**
     * The operation parameter descriptor for the {@code latitudeOf2ndPoint} parameter value. Valid
     * values range is from -90 to 90°. Default value is 0.
     */
    ...
    /**
     * The operation parameter descriptor for the {@code longitudeOf2ndPoint} parameter value. Valid
     * values range is from -180 to 180°. Default value is 0.
     */
