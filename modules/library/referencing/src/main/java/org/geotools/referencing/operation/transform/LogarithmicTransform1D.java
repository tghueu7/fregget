...
public class LogarithmicTransform1D extends AbstractMathTransform
  ...
  public static class Provider extends MathTransformProvider {
    ...
    public static final ParameterDescriptor<Double> BASE =
        DefaultParameterDescriptor.create("base", 10, 0, Double.POSITIVE_INFINITY, Unit.ONE);
    ...
    static final ParameterDescriptorGroup PARAMETERS =
        createDescriptorGroup(
            new NamedIdentifier[] {
              new NamedIdentifier(
                  Citations.GEOTOOLS, Vocabulary.formatInternational(VocabularyKeys.LOGARITHMIC))
            },
