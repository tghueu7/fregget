...
public class NADCONTransform extends AbstractMathTransform
  ...
  /**
   * Longitude and latitude grid shift values. Values are organized from low to high longitude (low
   * x index to high) and low to high latitude (low y index to high).
   */
  private LocalizationGrid gridShift;

  /**
   * The {@link #gridShift} values as a {@code LocalizationGridTransform2D}. Used for interpolating
   * shift values.
   */
   ...
   * @throws FactoryException if there is a problem creating this math transform (ie file extentions
   *     are unknown or there is an error reading the grid files)
   */
  ...
  /**
   * Transforms nad83 values to nad27. Input and output values are in decimal degrees. This is done
   * by itteratively finding a nad27 value that shifts to the input nad83 value. The input nad83
   * value is used as the first approximation.
   *
   * @param srcPts the array containing the source point coordinates.
   * @param srcOff the offset to the first point to be transformed in the source array.
   * @param dstPts the array into which the transformed point coordinates are returned. May be the
  ...
  public static class Provider extends MathTransformProvider {
    ...
    /**
     * The operation parameter descriptor for the "Latitude_difference_file" parameter value. The
     * default value is "conus.las".
     */
    ...
    /**
     * The operation parameter descriptor for the "Longitude_difference_file" parameter value. The
     * default value is "conus.los".
     */
