 ...
 * <A HREF="http://www.remotesensing.org/geotiff/proj_list/guid7.html">http://www.remotesensing
 * .org/geotiff/proj_list/guid7.html</A></li>
 * </ul>
 * </p>
 *
 * @author Jan Jezek
 ...
 * @see <A HREF="http://www.posc.org/Epicentre.2_2/DataModel/ExamplesofUsage/eu_cs34e2.html
 * ">Krovak on POSC</A>
 * @since 2.4
 */
public class Krovak extends MapProjection {
     ...
     * @throws ParameterNotFoundException if a mandatory parameter is missing.
     */
    protected Krovak(final ParameterValueGroup parameters, boolean esriDefinition) throws 
        ...
        pseudoStandardParallel = doubleValue(expected, Provider.PSEUDO_STANDARD_PARALLEL, 
                parameters);
    ...
    private MathTransform createAffineTransform(double x_scale, double y_scale, double 
            xy_plane_rotation) {
        /**
    ...
    public static class Provider extends AbstractProvider {
        ...
        public static final ParameterDescriptor SCALE_FACTOR = createDescriptor(
                new NamedIdentifier[]{
                        ...
                        new NamedIdentifier(Citations.EPSG, "Scale factor on pseudo standard " +
                                "parallel"),
         ...
         */
        static final ParameterDescriptorGroup PARAMETERS_ESRI = createDescriptorGroup(new 
                        NamedIdentifier[]{
