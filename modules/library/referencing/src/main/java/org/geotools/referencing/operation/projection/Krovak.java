...
public class Krovak extends MapProjection {
  ...
  /**
   * Azimuth of the centre line passing through the centre of the projection. This is equals to the
  ...
  protected Krovak(final ParameterValueGroup parameters, boolean esriDefinition)
    ...
    /**
     * Check if there are parameters for axis swapping used by ESRI - if so then set variable so the
     * proper ParameterDescriptorGroup will be returned by getParameterDescriptors()
     */
  ...
  /**
   * Transforms the specified (<var>x</var>,<var>y</var>) coordinate and stores the result in {@code
   * ptDst}.
   */
  ...
  public static class Provider extends AbstractProvider {
     ...
     * parameter value. Valid values range is from -90 to 90. Default value is 49.5.
     */
    ...
    /**
     * The operation parameter descriptor for the pseudo {@linkplain #pseudoStandardParallel pseudo
     * standard parallel} parameter value. Valid values range is from -90 to 90. Default value is
     * 78.5.
     */
