...
public abstract class Stereographic extends MapProjection {
   ...
   * provider} for a {@linkplain Stereographic Stereographic} projections using USGS equations. This
   * is <strong>not</strong> the provider for EPSG 9809. For the later, use {@link
