...
public class NewZealandMapGrid extends MapProjection {
  ...
  public static class Provider extends AbstractProvider {
    ...
    /**
     * Creates a transform from the specified group of parameter values. This method doesn't check
     * for the spherical case, since the New Zealand Map Grid projection is used with the
