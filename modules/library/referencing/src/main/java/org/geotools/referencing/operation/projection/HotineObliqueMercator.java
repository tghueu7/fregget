...
public class HotineObliqueMercator extends ObliqueMercator {
   ...
   *     "two points" case in a future version if needed. Note that this limitation doesn't apply to
   *     projection created from the {@link Provider_TwoPoint}.
   */
  ...
  public static final class Provider_TwoPoint extends ObliqueMercator.Provider_TwoPoint {
    ...
    static final ParameterDescriptorGroup PARAMETERS =
        createDescriptorGroup(
            new NamedIdentifier[] {
              new NamedIdentifier(
                  Citations.ESRI, "Hotine_Oblique_Mercator_Two_Point_Natural_Origin"),
              new NamedIdentifier(Citations.GEOTOOLS, NAME)
            },
            new ParameterDescriptor[] {
