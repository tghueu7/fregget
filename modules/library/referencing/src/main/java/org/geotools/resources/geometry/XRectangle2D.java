...
public class XRectangle2D extends Rectangle2D implements Serializable {
   ...
   * argument in the {@link XRectangle2D} constructor for initializing a new {@code XRectangle2D} to
   * infinite bounds.
   */
  ...
  /**
   * Construct a rectangle with the specified location and dimension. This constructor uses the same
   * signature than {@link Rectangle2D} for consistency.
   */
   ...
   *
   * @param x the <var>x</var> coordinates to which to set the location of the upper left corner of
   *     this {@code Rectangle2D}
   * @param y the <var>y</var> coordinates to which to set the location of the upper left corner of
   *     this {@code Rectangle2D}
  ...
  /**
   * Tests if the interior of this {@code Rectangle2D} intersects the interior of a specified set of
   ...
   * @return {@code true} if this {@code Rectangle2D} intersects the interior of a specified set of
   ...
   * of a specified rectangle. This methods overrides the default {@link Rectangle2D} implementation
   * in order to work correctly with {@linkplain Double#POSITIVE_INFINITY infinites} and {@linkplain
   ...
   *
   * <ul>
   *   <li>This method doesn't test only if the <em>interiors</em> intersect. It tests for the edges
   *       as well.
   ...
   * least one rectangle may be the bounding box of a perfectly horizontal or vertical line; such a
   * bounding box has 0 width or height.
   *
   ...
   * This method might conservatively return {@code true} when there is a high probability that the
   * rectangle and the shape intersect, but the calculations to accurately determine this
   ...
   * {@linkplain Rectangle2D#isEmpty empty} according {@link Shape} contract). However, rectangle
   * with negative width or height are still considered as empty. <br>
   * <br>
   * This method is said <cite>inclusive</cite> because it try to mimic {@link
   * #intersectInclusive(Rectangle2D, Rectangle2D)} behavior, at least for rectangle with zero width
   * or height.
   *
   ...
   * @param width the width of the specified set of rectangular coordinates
   * @param height the height of the specified set of rectangular coordinates
   * @return {@code true} if this {@code Rectangle2D} entirely contains specified set of rectangular
   ...
   * edge of the {@code outter} rectangle. This method is similar to {@link #contains(Rectangle2D)}
   * except for the following points:
   *
   * <ul>
   *   <li>This method doesn't test only the <em>interiors</em> of {@code outter}. It tests for the
   *       edges as well.
   *   <li>This method tests also rectangle with zero {@linkplain Rectangle2D#getWidth width} or
   *       {@linkplain Rectangle2D#getHeight height} (which are {@linkplain Rectangle2D#isEmpty
   ...
   * @return {@code true} if the interior of {@code inner} is inside the interior and/or the edge of
   *     {@code outter}.
   ...
   * {@code Rectangle2D}. The resulting {@code Rectangle2D} is the smallest {@code Rectangle2D} that
   * contains both the original {@code Rectangle2D} and the specified point.
   *
   ...
   * for points on the right or bottom edges of a rectangle. Therefore, if the added point falls on
   * the left or bottom edge of the enlarged rectangle, {@code contains} returns {@code false} for
   * that point.
   */
  @Override
