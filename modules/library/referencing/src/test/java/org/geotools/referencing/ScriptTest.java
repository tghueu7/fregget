...
public final class ScriptTest {
   ...
   * have time to investigate. If you want to try and fix this please enable the service provider as
   * well by adding the org.geotools.referencing.operation.projection.Mollweide$WagnerVProvider line
   * into
