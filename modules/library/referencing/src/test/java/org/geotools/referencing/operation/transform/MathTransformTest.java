...
public final class MathTransformTest {
    ...
    public void testAffineTransform() throws FactoryException, TransformException {
        for (int pass = 0; pass < 10; pass++) {
            ...
            transform.rotate(Math.PI * random.nextDouble(), 100 * random.nextDouble(), 100 * 
                    random.nextDouble());
    ...
    public void testSubAffineTransform() throws FactoryException, TransformException {
        for (int pass = 0; pass < 5; pass++) {
            ...
            for (int i = 1; i <= dimension; i++) {
                ...
                final MathTransform transform = transforms[i - 1] = factory.createAffineTransform
                        (sub);
    ...
    public void testAffineTransformConcatenation() throws FactoryException, TransformException {
        ...
        for (int pass = 0; pass < 100; pass++) {
            ...
            for (int i = 0; i < transforms.length; i++) {
                ...
                String name = "transform[" + i + "](" + dimSource + " -> " + dimInterm + " -> " +
                        dimTarget + ')';
     ...
     */
    @Test
    public void testLogarithmicAndExponentialConcatenation() throws FactoryException, 
            TransformException {
        final int numPts = 200;
