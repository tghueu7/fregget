...
public final class PassthroughTransformTest extends TransformTestBase {
    ...
    private void runTest(final MathTransform sub) throws FactoryException, TransformException {
        ...
        assertEquals("Wrong number of source dimensions", sub.getSourceDimensions() + subLower + 
                1, passthrough.getSourceDimensions());
        assertEquals("Wrong number of target dimensions", sub.getTargetDimensions() + subLower + 
                1, passthrough.getTargetDimensions());
