...
public final class DirectCreationTest {
  ...
  /**
   * Helper method to test transform from a source to a target point. Coordinate points are (x,y) or
   * (long, lat)
   */
  ...
  public void testEquidistantCylindrical() throws FactoryException, TransformException {
    ...
    doTransform(
        new DirectPosition2D(-2.5, 51.37), new DirectPosition2D(-278298.73, 5718482.24), transform);
  }
  ...
  public void testMercator() throws FactoryException, TransformException {
    ...
    doTransform(
        new DirectPosition2D(120.0, -3.0), new DirectPosition2D(5009726.58, 569150.82), transform);
    ...
    doTransform(
        new DirectPosition2D(-75.0, 35.0), new DirectPosition2D(1.8325957, 0.6528366), transform);
    ...
    doTransform(
        new DirectPosition2D(53.0, 53.0), new DirectPosition2D(165704.29, 5171848.07), transform);
  ...
  public void testStereographic() throws FactoryException, TransformException {
    ...
    doTransform(
        new DirectPosition2D(10, -85), new DirectPosition2D(94393.99, 535334.89), transform);
    doTransform(
