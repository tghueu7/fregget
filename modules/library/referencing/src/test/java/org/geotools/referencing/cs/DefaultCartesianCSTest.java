...
public final class DefaultCartesianCSTest {
  ...
  public void testAxis() {
    ...
    try {
      cs =
          new DefaultCartesianCS(
              "Test", DefaultCoordinateSystemAxis.LONGITUDE, DefaultCoordinateSystemAxis.LATITUDE);
    ...
    try {
      cs =
          new DefaultCartesianCS(
              "Test", DefaultCoordinateSystemAxis.SOUTHING, DefaultCoordinateSystemAxis.NORTHING);
  ...
  private static DefaultCartesianCS create(final String x, final String y) {
    return create(
        DefaultCoordinateSystemAxis.getDirection(x), DefaultCoordinateSystemAxis.getDirection(y));
  }
  ...
  /**
   * Creates a cartesian CS using the provided test axis, invoke {@link AbstractCS#standard} with it
   * and compare with the expected axis.
   */
