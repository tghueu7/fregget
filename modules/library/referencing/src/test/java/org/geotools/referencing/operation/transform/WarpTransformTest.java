...
public final class WarpTransformTest {
     ...
     * (by the caller).
     */
    private static WarpPolynomial executeTest(final Formula formula, final int degree, final 
    float EPS)
    ...
    public void testAdapter() {
        ...
        final Random random = new Random(-854734760285695284L);
        for (int i = 0; i < 200; i++) {
            Point2D source = new Point2D.Double(random.nextDouble() * 100, random.nextDouble() * 
                    100);
