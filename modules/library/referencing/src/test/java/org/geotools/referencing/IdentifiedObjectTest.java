...
public final class IdentifiedObjectTest {
  /**
   * Tests {@link NamedIdentifier} attributes. Useful for making sure that the hash code enumerated
   * in the switch statement in the constructor have the correct value.
   */
  @Test
  public void testIdentifier() {
    ...
    assertEquals(
        "authority", "This is an authority", identifier.getAuthority().getTitle().toString());
    ...
    if (false) {
      ...
      assertEquals(
          "remarks", "Overrides remarks", identifier.getRemarks().toString(Locale.ENGLISH));
    }
