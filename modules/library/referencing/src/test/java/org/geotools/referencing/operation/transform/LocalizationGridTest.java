...
public final class LocalizationGridTest {
  ...
  /**
   * Set up common objects used for all tests. This implementation construct a default localization
   * grid.
   */
  @Before
  public void setUp() {
   ...
   * approximated coordinates. Since the affine transform is fitted using least-squares method, the
  ...
  /**
   * Test inverse transformation from "real world" coordinates to grid coordinates coordinate using
