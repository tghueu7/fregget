...
public final class GeodeticCalculatorTest {
  ...
  public void testParallel45() {
    ...
    final double[] DATA = {
      0.00, 0, 0, 11.25, 883, 884, 22.50, 1762, 1768, 33.75, 2632, 2652, 45.00, 3489, 3536, 56.25,
      4327, 4419, 67.50, 5140, 5303, 78.75, 5923, 6187, 90.00, 6667, 7071, 101.25, 7363, 7955,
      112.50, 8002, 8839, 123.75, 8573, 9723, 135.00, 9064, 10607, 146.25, 9463, 11490, 157.50,
      9758, 12374, 168.75, 9939, 13258, 180.00, 10000, 14142
    };
  ...
  /**
   * Tests orthrodromic distance on the equator. The main purpose of this method is actually to get
   * Java assertions to be run, which will compare the Geodetic Calculator results with the Default
