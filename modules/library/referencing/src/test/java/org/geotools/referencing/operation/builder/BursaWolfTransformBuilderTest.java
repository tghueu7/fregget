...
public final class BursaWolfTransformBuilderTest {
  ...
  public void testBursaWolfParamCalculaterXrotation() throws FactoryException, TransformException {
    ...
    vectors.add(
        new MappedPosition(new GeneralDirectPosition(R, 0, 0), new GeneralDirectPosition(R, 0, 0)));

    vectors.add(
        new MappedPosition(
            new GeneralDirectPosition(0, cos * R, -sin * R), new GeneralDirectPosition(0, R, 0)));

    vectors.add(
        new MappedPosition(
            new GeneralDirectPosition(0, sin * R, cos * R), new GeneralDirectPosition(0, 0, R)));
