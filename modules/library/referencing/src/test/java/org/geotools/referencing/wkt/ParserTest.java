...
public final class ParserTest {
    ...
    public void testHardCoded() throws ParseException {
        ...
        assertTrue(crs1.getConversionFromBase().getMathTransform().toWKT().startsWith
        ...
        assertFalse(wkt2.contains("semi_major"));
        assertFalse(wkt2.contains("semi_minor"));
        assertEquals("Transverse_Mercator", crs1.getConversionFromBase().getMethod().getName()
                .getCode());
        ...
        assertEquals("latitude_of_origin", 49.0, param.parameter("latitude_of_origin")
                .doubleValue(), 1E-8);
...
// TODO: The real projection is "Modified Portugues", but it is not yet implemented in Geotools.
                        ...
                        "39.66666666666666666666666666666666666667]," +
                        " PARAMETER[\"Central_Meridian\", " +
                        "-8.13190611111111111111111111111111111111]," +
    ...
    public void testCustomAxisLength() throws FactoryException, ParseException {
        ...
        ParameterValueGroup parameters = factory.getDefaultParameters
    ...
    private void testParsing(final AbstractParser parser, final String filename)
        ...
        while ((line = reader.readLine()) != null) {
            ...
            assertSame("Parsing twice returns different objects.", parsed, parser.parseObject
                    (line));
