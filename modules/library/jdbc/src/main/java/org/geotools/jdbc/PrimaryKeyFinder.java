...
public abstract class PrimaryKeyFinder {
  ...
  /**
   * Returns the {@link PrimaryKey}, or {@code null} if a specific type could not be determined (the
   * datastore will fall back on {@link NullPrimaryKey} in that case. It is advised to return
   *
   * @param schema
   * @param table
   * @param cx
