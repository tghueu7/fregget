...
public class DataSourceUtil {
     ...
     * @param username
     * @param password
     * @param validationQuery the validation query to be used for connection liveliness on
    ...
    public static ManageableDataSource buildDefaultDataSource(String url,
                                                              ...
                                                              String password,
                                                              String validationQuery) throws 
            DataSourceException {
        return buildDefaultDataSource(url, driverName, username, password, 10, 1, 
                validationQuery, false, 0);
    }
    ...
    public static ManageableDataSource buildDefaultDataSource(String url,
                                                              String driverName, String username,
                                                              String password,
                                                              int maxActive, int minIdle, String 
