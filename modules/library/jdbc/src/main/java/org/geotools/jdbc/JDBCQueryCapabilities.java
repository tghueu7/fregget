...
class JDBCQueryCapabilities extends QueryCapabilities {
   ...
   * corresponds to the name of one of the attribute types in the complete FeatureType, and that the
   * attribute is not a geometry.
   *
   * @param propertyName the expression holding the property name to check for sortability support
   * @param sortOrder the order, ascending or descending, to check for sortability support over the
   *     given property name.
