...
public abstract class JDBCDataStoreFactory implements DataStoreFactorySpi {
  ...
  /**
   * If different from one, the JDBCInsertFeatureWriter will buffer the features and insert them in
   * batches
   */
   ...
   *
   * <p>This method is provided with an instance of the datastore. In some cases subclasses may wish
   * to create a new instance of the datastore, for instance in order to wrap the original instance.
   * This is supported but the new datastore must be returned from this method. If not is such the
   ...
   *
   * <p>Subclasses may extend, but should not override. This implementation registers the following
   * parameters.
   *
   * <ul>
   *   <li>{@link #HOST}
   ...
   *
   * <p>Will return {@link JDBCCallbackFactory#NULL} if the factory with the specified name can't be
   * found.
   */
