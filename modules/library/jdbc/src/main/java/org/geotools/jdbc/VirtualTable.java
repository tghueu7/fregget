...
public class VirtualTable implements Serializable {
  ...
  /**
   * Builds a new virtual table stating its name, the query to be executed to work on it and a flag
   * to indicate if SQL special characters should be escaped.
   *
   * @param name
   * @param sql
   * @param escapeSql
  ...
  /**
   * Returns the virtual table primary key columns. It should refer to fields returned by the query,
   * if that is not true the behavior is undefined
   */
