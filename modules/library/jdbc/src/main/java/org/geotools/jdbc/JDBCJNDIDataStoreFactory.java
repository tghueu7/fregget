...
public abstract class JDBCJNDIDataStoreFactory extends JDBCDataStoreFactory {
  ...
  /**
   * Override which explicitly returns null, validation queries are not supported, my be part of the
  ...
  /**
   * Override which explicitly returns null since there is no jdbc url, the connection is identified
   * by the JNDI name.
   */
  @Override
