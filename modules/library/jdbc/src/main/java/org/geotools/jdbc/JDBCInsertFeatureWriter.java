 ...
 * @source $URL$
 */
public class JDBCInsertFeatureWriter extends JDBCFeatureReader implements 
    ...
    public JDBCInsertFeatureWriter(PreparedStatement ps, Connection cx, JDBCFeatureSource 
            featureSource, Query query)
