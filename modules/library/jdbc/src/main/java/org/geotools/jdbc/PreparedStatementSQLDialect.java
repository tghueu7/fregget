...
public abstract class PreparedStatementSQLDialect extends SQLDialect {
     ...
     * @param sql       The prepared sql statement buffer.
     */
    public final void prepareGeometryValue(Geometry g, int dimension, int srid, Class binding, 
                                           StringBuffer sql) {
    ...
    public abstract void setGeometryValue(Geometry g, int dimension, int srid,
                                          Class binding, PreparedStatement ps, int column) throws
            SQLException;
    ...
    protected <T> T convert(Object value, Class<T> binding) {
        ...
        if (!binding.isInstance(value)) {
            ...
            if (converted != null) {
                ...
                dataStore.getLogger().warning("Unable to convert " + value + " to " + binding
                        .getName());
            }
        }
        return (T) value;
