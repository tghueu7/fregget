...
public class FilterToSQL implements FilterVisitor, ExpressionVisitor {
     ...
     */
    protected static Logger LOGGER = org.geotools.util.logging.Logging.getLogger("org.geotools" +
            ".filter");
    ...
    /**
     * Makes the encoder translate in like functions into SQL (see also 
     * {@link InFunction#isInFunction(Expression)}
     *
     ...
     * @throws OpenGISFilterToOpenGISFilterToSQLEncoderException If filter type not supported, or
     * if there
     *                                                           were io problems.
     */
     ...
     * @throws RuntimeException for io exception with writer
     */
    protected void visitBinaryComparisonOperator(BinaryComparisonOperator filter, Object 
            extraData) throws RuntimeException {
     ...
     */
    protected Object visitBinaryTemporalOperator(BinaryTemporalOperator filter,
                                                 PropertyName property, Literal temporal, boolean
        ...
        if ((filter instanceof Begins || filter instanceof BegunBy || filter instanceof Ends ||
                filter instanceof EndedBy || filter instanceof During || filter instanceof 
                TContains) &&
                period == null) {
            if (period == null) {
        ...
        if ((filter instanceof BegunBy || filter instanceof EndedBy || filter instanceof 
                TContains) &&
                !swapped) {
    ...
    public Object visit(Function function, Object extraData) throws RuntimeException {
        ...
        if (inEncodingEnabled && InFunction.isInFunction(function)) {
            ...
            try {
                ...
                Parameter<?> lastArgument = arguments.isEmpty() ? null : arguments.get(arguments
                        .size() - 1);
                for (int i = 0; i < parameters.size(); i++) {
                    ...
                    if (arguments.size() <= i
                            && (lastArgument.getMaxOccurs() > 0 || lastArgument.getMaxOccurs() ==
                            -1)) {
     ...
     * @param extraData
     */
    protected void visitInFunction(Function function, boolean encodeAsExpression, boolean negate,
                                   Object extraData) {
        try {
