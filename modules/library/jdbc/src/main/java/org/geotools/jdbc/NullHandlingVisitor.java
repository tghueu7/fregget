...
class NullHandlingVisitor extends DuplicatingFilterVisitor {
  ...
  /**
   * Returns if a property can contain null values, or not. If we don't have the schema information,
   * or we don't know the property, we are going to assume the property is nillable to stay on the
   * safe side
   */
