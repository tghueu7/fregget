...
public class JNDIDataSourceFactory extends AbstractDataSourceFactorySpi {
    ...
    public DataSource createNewDataSource(Map params) throws IOException {
        ...
        try {
            return (DataSource) GeoTools.getInitialContext(GeoTools.getDefaultHints()).lookup
                    (refName);
        } catch (Exception e) {
    ...
    public String getDescription() {
        return "A JNDI based DataSource locator. Provide the JDNI location of a DataSource object" +
