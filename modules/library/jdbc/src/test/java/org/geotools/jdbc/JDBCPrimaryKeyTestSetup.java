...
public abstract class JDBCPrimaryKeyTestSetup extends JDBCDelegatingTestSetup {
  ...
  /**
   * Creates a table with a primary key column with an associated sequence, which has the following
   * schema:
   *
   ...
   *
   * <p>The table should be populated with the following data: "one" | NULL ; pkey1 = 1, pkey2 = 'x'
   * "two" | NULL ; pkey1 = 1, pkey2 = 'y' "three" | NULL ; pkey1 = 1, pkey2 = 'z'
   */
