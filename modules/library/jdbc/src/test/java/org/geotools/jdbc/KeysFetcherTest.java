...
public class KeysFetcherTest extends TestCase {
  public void testIncrement() throws IOException {
    ...
    assertEquals(
        BigInteger.valueOf(31), KeysFetcher.FromPreviousIntegral.increment(BigInteger.valueOf(30)));
    assertEquals(
        BigDecimal.valueOf(41), KeysFetcher.FromPreviousIntegral.increment(BigDecimal.valueOf(40)));
