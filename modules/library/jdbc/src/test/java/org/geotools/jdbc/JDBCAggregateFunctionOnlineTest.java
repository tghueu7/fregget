...
public abstract class JDBCAggregateFunctionOnlineTest extends JDBCTestSupport {
    ...
    public void testSumAreaWithGroupBy() throws Exception {
        ...
        GroupByVisitor v = new GroupByVisitorBuilder()
                ...
                .withGroupByAttributes(Collections.singleton(aname("name")), dataStore.getSchema
                        (tname("aggregate")))
                .build();
    ...
    public void testUniqueWithLimitOffset() throws Exception {
        ...
        if (!dataStore.getSQLDialect().isLimitOffsetSupported() || !dataStore.getSQLDialect()
                .isAggregatedSortSupported("distinct")) {
            return;
        }
    ...
    private void testNearest(String typeName, String attributeName, Object target, Object... 
            validResults) throws IOException {
        ...
        if (validResults.length == 0) {
            ...
            assertTrue("Could not match nearest " + nearestMatch + " among valid values " + 
                    Arrays.asList(validResults), found);
        }
    }
}
