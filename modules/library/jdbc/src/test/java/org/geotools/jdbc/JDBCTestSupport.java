...
public abstract class JDBCTestSupport extends OnlineTestCase {
  ...
  protected <F extends Feature> void assertFeatureIterator(
      int startIndex, int numberExpected, FeatureIterator<F> iter, FeatureAssertion assertion) {
    try {
  ...
  protected <F extends Feature> void assertFeatureIterator(
      int startIndex, int numberExpected, final Iterator<F> iterator, FeatureAssertion assertion) {
