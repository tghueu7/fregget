...
public abstract class JDBCGeographyOnlineTest extends JDBCTestSupport {
  ...
  public void testSchema() throws Exception {
    ...
    int epsg =
        CRS.lookupEpsgCode(
            ((GeometryDescriptor) ft.getDescriptor(aname("geo"))).getCoordinateReferenceSystem(),
            false);
  ...
  public void testBboxFilter() throws Exception {
    ...
    FeatureCollection features = dataStore.getFeatureSource(tname("geopoint")).getFeatures(bbox);
  ...
  public void testDistanceGreatCircle() throws Exception {
    ...
    LineString line =
        gf.createLineString(
            new Coordinate[] {new Coordinate(-122.33, 47.606), new Coordinate(0.0, 51.5)});
