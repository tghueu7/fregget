...
public class EscapeSqlTest extends TestCase {
    ...
    public void testSqlEscaping() throws Exception {
        ...
        String doubleQuote = vt.expandParameters(new Hints(
                Hints.VIRTUAL_TABLE_PARAMETERS, Collections.singletonMap("param1", "If you hear a" +
                " voice within you say \"you cannot paint,\" then by all means paint, and that " +
                "voice will be silenced.")));
        assertEquals("double quotes should be doubled", "If you hear a voice within you say " +
