...
public abstract class JDBCDataStoreAPITestSetup extends JDBCDelegatingTestSetup {
   ...
   *
   * <p>This feature type / table is created by one of the tests in teh suite, and not by this test
   * harness.
   */
   ...
   * );srid=4326 | "r1" 1 | LINESTRING( 3 0, 3 2, 3 3, 3 4 );srid=4326 | "r2" 2 | LINESTRING( 3 2, 4
   * 2, 5 3 );srid=4326 | "r3"
   */
   ...
   *
   * <p>The table should be populated with the following data: 0 | MULTILINESTRING((5 5, 7 4)(7 5, 9
   * 7, 13 7)(7 5, 9 3, 11 3));srid=4326 | "rv1" | 4.5 1 | MULTILINESTRING((4 6, 4 8, 6
   ...
   *
   * <p>The table should be populated with the following data: 0 | POLYGON((12 6, 14 8, 16 6, 16 4,
   * 14 4, 12 6));srid=4326 | "muddy"
   */
