...
public abstract class JDBCTestSetup {
   ...
   *
   * <p>Subclasses should override this is in case where databases can not respect case properly and
   * need to force either upper or lower case.
   */
   ...
   *
   * <p>This method is used for subclasses to make additional checks that determine if the test case
   * should be run or not. This method is only called if a connection can successfully be made to
   * the database.
   */
