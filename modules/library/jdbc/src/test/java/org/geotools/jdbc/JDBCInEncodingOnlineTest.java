...
public abstract class JDBCInEncodingOnlineTest extends JDBCTestSupport {
    ...
    public void testSimpleIn() throws IOException {
        ...
        Function function = ff.function("in", ff.property(aname("intProperty")), ff.literal("1"),
                ff.literal("2"));
    ...
    public void testSimpleIn3() throws IOException {
        FilterFactory ff = dataStore.getFilterFactory();
        Function function = ff.function("in3", ff.property(aname("intProperty")), ff.literal("1")
