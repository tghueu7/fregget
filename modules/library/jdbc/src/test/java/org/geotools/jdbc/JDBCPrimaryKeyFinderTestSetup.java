...
public abstract class JDBCPrimaryKeyFinderTestSetup extends JDBCDelegatingTestSetup {
    ...
    /**
     * Creates a view named 'assignedsinglepk' that selects all of the contents of 'plaintable' 
     * and registers
    ...
    /**
     * Creates a view named 'assignedmultipk' that selects all of the contents of 'plaintable' 
     * and registers
