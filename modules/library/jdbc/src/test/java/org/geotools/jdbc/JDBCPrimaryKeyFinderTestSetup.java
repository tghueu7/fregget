...
public abstract class JDBCPrimaryKeyFinderTestSetup extends JDBCDelegatingTestSetup {
   ...
   *
   * <p>The table should be populated with the following data: 1, 2, "one" | NULL 2, 3, "two" | NULL
   * 3, 4, "three" | NULL
   */
   ...
   *
   * <p>The table should be populated with the following data: "one" | NULL ; pkey = 1 "two" | NULL
   * ; pkey = 2 "three" | NULL ; pkey = 3
   */
