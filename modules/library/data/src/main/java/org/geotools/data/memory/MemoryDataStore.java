...
public class MemoryDataStore extends ContentDataStore {
   ...
   *
   * <p>This is an internal operation used for setting up MemoryDataStore - please use FeatureWriter
   * for general use.
   *
   ...
   *
   * <p>Technically this is accessing the MemoryState for {@link Transaction#AUTO_COMMIT}, which is
   * the definitive storage for the feature content.
   *
   * @param typeName
   ...
   *
   * <p>FeatureTypes are stored by typeName, an IOException will be thrown if the requested typeName
   * is already in use.
   *
