 ...
 * <p>
 * It is the responsibility of a FeatureStore to issue events to interested parties as content is
 * modified. The {@link ContentState} keeps track of
 ...
 * generated for new features. The
 * {@link BatchFeatureEvent} maintains a map of BEFORE/AFTER values allowing any interested party
 * to update their seleciton.
 * <p>
...
public class EventContentFeatureWriter implements FeatureWriter<SimpleFeatureType, SimpleFeature> {
     ...
     * <p>
     * <p>
     * Diff is not clear()ed as it is assumed that it belongs to a Transaction.State object and 
