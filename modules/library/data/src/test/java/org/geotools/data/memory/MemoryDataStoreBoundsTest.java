...
public class MemoryDataStoreBoundsTest extends DataTestCase {
  ...
  public void testGetBoundsFilter() throws Exception {
    ...
    assertEquals(
        roadFeatures[1].getBounds(), data.getFeatureSource("road").getFeatures(query).getBounds());
  }
  ...
  public void testReprojectEnvelopeCrsFromQuery() throws Exception {
    ...
    assertEquals(
        new ReferencedEnvelope(riverBounds, sourceCRS).transform(targetCRS, true), envelope);
  }
