...
public class MemoryDataStoreTest extends DataTestCase {
    ...
    public void testEmpty() throws Exception {
        ...
        FeatureSource<SimpleFeatureType, SimpleFeature> source = memory.getFeatureSource
                ("typename");
    ...
    /*
     * Test for void MemoryDataStore.addFeatures(FeatureCollection<SimpleFeatureType,
    ...
    public void testGetFeatureReader() throws IOException {
        FeatureReader<SimpleFeatureType, SimpleFeature> reader = data.getFeatureSource("road")
                .getReader();
    ...
    public void testGetFeatureReaderConcurancy() throws NoSuchElementException, IOException {
        FeatureReader<SimpleFeatureType, SimpleFeature> reader1 = data.getFeatureSource("road")
                .getReader();
        FeatureReader<SimpleFeatureType, SimpleFeature> reader2 = data.getFeatureSource("road")
                .getReader();
        FeatureReader<SimpleFeatureType, SimpleFeature> reader3 = data.getFeatureSource("river")
                .getReader();
    ...
    private void assertReaderOrderSame(SimpleFeature[] features, DataStore store) throws 
            IOException {
        FeatureReader<SimpleFeatureType, SimpleFeature> r1 = store.getFeatureReader(new Query
    ...
    void assertCovered(SimpleFeature[] features, FeatureReader<SimpleFeatureType, SimpleFeature> 
            reader)
    ...
    boolean covers(SimpleFeatureIterator reader, SimpleFeature[] array) throws 
    ...
    boolean coversLax(FeatureReader<SimpleFeatureType, SimpleFeature> reader, SimpleFeature[] 
            array) throws NoSuchElementException,
            IOException {
        SimpleFeature feature;
        int count = 0;
    ...
    boolean coversLax(SimpleFeatureIterator reader, SimpleFeature[] array) throws 
            NoSuchElementException,
            IOException {
        SimpleFeature feature;
        int count = 0;
    ...
    void dump(FeatureReader<SimpleFeatureType, SimpleFeature> reader) throws 
    ...
    public void testModifyInTransactionFidFilter() throws Exception {
        ...
        FeatureWriter<SimpleFeatureType, SimpleFeature> writer1 = data.getFeatureWriter("road", 
                rd1Filter, defaultTransaction);
        ...
        FeatureReader<SimpleFeatureType, SimpleFeature> reader = data.getFeatureReader(new Query
                ("road", rd1Filter), defaultTransaction);
        ...
        FeatureWriter<SimpleFeatureType, SimpleFeature> writer = data.getFeatureWriterAppend
                ("road", defaultTransaction);
    ...
    private void testTransformedFeatures(
        ...
        GeometryCoordinateSequenceTransformer transformer = new 
        ...
        while (i.hasNext() && j.hasNext()) {
            ...
            assertEquals(targetCRS, transformedFeature.getFeatureType()
            ...
            for (int k = 0; k < sourceFeature.getAttributes().size(); k++) {
                ...
                if (o instanceof Geometry) {
                    ...
                    Geometry transformedGeometry = (Geometry) transformedFeature.getAttributes()
                            .get(k);
    ...
    public void testGetFeatureStoreAddFeatures() throws IOException {
        FeatureReader<SimpleFeatureType, SimpleFeature> reader = DataUtilities.reader(new 
                SimpleFeature[]{newRoad,});
        SimpleFeatureStore road = (SimpleFeatureStore) data.getFeatureSource("road");
    ...
    public void testFeatureEvents() throws Exception {
        SimpleFeatureStore store1 = (SimpleFeatureStore) data.getFeatureSource(roadFeatures[0]
                .getFeatureType()
                .getTypeName());
        SimpleFeatureStore store2 = (SimpleFeatureStore) data.getFeatureSource(roadFeatures[0]
                .getFeatureType()
                .getTypeName());
    ...
    public void testLockFeatureInteraction() throws IOException {
        ...
        try {
            ...
            FeatureLocking<SimpleFeatureType, SimpleFeature> road1 = 
                    (FeatureLocking<SimpleFeatureType, SimpleFeature>) data.getFeatureSource
                            ("road");
            @SuppressWarnings("unchecked")
    ...
    public void testCallingAddFeaturesWithArrayTwiceAndExtentInitialCollection() throws 
            IOException {
        MemoryDataStore mds = new MemoryDataStore();
    ...
    public void testCallingAddFeaturesWithCollectionTwiceAndExtentInitialCollection() throws 
            IOException {
        MemoryDataStore mds = new MemoryDataStore();
