...
public class TransactionTest extends TestCase {
    ...
    public void testAddFeature() throws Exception {
        ...
        count(store, 3);
//        assertEquals("Number of known feature as obtained from getCount",3, store.getCount
// (Query.ALL));
    }
...
// (Query.ALL));
    ...
    private void count(SimpleFeatureStore store, int expected) throws IOException, 
