...
public class CompositeTest {
  ...
  public static Collection<Object[]> data() {
    ...
    result.add(
        new Object[] {"destination-over", AlphaComposite.getInstance(AlphaComposite.DST_OVER)});
    ...
    result.add(
        new Object[] {"destination-out", AlphaComposite.getInstance(AlphaComposite.DST_OUT)});
    result.add(new Object[] {"source-atop", AlphaComposite.getInstance(AlphaComposite.SRC_ATOP)});
    result.add(
        new Object[] {"destination-atop", AlphaComposite.getInstance(AlphaComposite.DST_ATOP)});
