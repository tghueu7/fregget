...
public class WKTMarkFactoryTest extends TestCase {
    ...
    public void testWellKnownTextLineString() {
        ...
        try {
            Literal exp = ff
                    .literal(WKTMarkFactory.WKT_PREFIX + "LINESTRING(0.0 0.25, 0.25 0.25, 0.5 " +
                            "0.75, 0.75 0.25, 1.00 0.25)");
    ...
    public void testWellKnownTextMultiLineString() {
        ...
        try {
            Literal exp = ff
                    .literal(WKTMarkFactory.WKT_PREFIX + "MULTILINESTRING((0.25 0.25, 0.5 0.75, " +
                            "0.75 0.25, 0.25 0.25), (0.25 0.75, 0.5 0.25, 0.75 0.75, 0.25 0.75))");
            wmf.getShape(null, exp, feature);
        } catch (Exception e) {
            assertTrue(false);
            return;
    ...
    public void testWellKnownTextPolygon() {
        ...
        try {
            Literal exp = ff
                    .literal(WKTMarkFactory.WKT_PREFIX + "POLYGON((0.25 0.25, 0.5 0.75, 0.75 " +
                            "0.25, 0.25 0.25))");
            wmf.getShape(null, exp, feature);
        } catch (Exception e) {
            assertTrue(false);
    ...
    public void testWellKnownTextCurve() {
        ...
        try {
            Literal exp = ff
                    .literal(WKTMarkFactory.WKT_PREFIX + "CURVEPOLYGON(COMPOUNDCURVE" +
