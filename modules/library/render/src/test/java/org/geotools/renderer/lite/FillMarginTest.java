...
public class FillMarginTest {
    ...
    public void testFillSLD10HighDPI() throws Exception {
        ...
        ImageAssert.assertEquals(new File("" +
                "./src/test/resources/org/geotools/renderer/lite/test-data/margin/expected" +
                "-dpi300.png"), image, 100);
    }
    ...
    public void testMarkMargin() throws Exception {
        ...
        ImageAssert.assertEquals(new File("" +
                "./src/test/resources/org/geotools/renderer/lite/test-data/margin/markmargin" +
                ".png"), image, 100);
    }
    ...
    public void testFillSingle() throws Exception {
        ...
        BufferedImage image = RendererBaseTest.showRender("MarginFill", renderer, TIME, bounds);
        ImageAssert.assertEquals(new File("" +
                "./src/test/resources/org/geotools/renderer/lite/test-data/margin/single-expected" +
                ".png"), image, 100);
    }
}
