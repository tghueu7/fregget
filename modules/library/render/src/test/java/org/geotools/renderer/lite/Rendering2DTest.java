...
public class Rendering2DTest extends TestCase {
    ...
    SimpleFeatureCollection createTestFeatureCollection(
        ...
        SimpleFeature lineFeature = SimpleFeatureBuilder.build(lineType, new Object[]{line, 
                "centerline"}, null);
        ...
        SimpleFeature pointFeature = SimpleFeatureBuilder.build(pointType, new Object[]{point, 
                "centre"}, null);
        ...
        SimpleFeature ringFeature = SimpleFeatureBuilder.build(lrType, new Object[]{ring, 
                "centerline"}, null);
        ...
        SimpleFeature collFeature = SimpleFeatureBuilder.build(collType, new Object[]{coll, 
                "collection"}, null);
    ...
    public void testRenderEmptyLine() throws SchemaException, IllegalAttributeException {
        ...
        SimpleFeatureType pointType = DataUtilities.createType("emptyLines", "geom:LineString," +
                "name:String");
        SimpleFeature f = SimpleFeatureBuilder.build(pointType, new Object[]{gf.createLineString(
                (Coordinate[]) null), "name"}, null);
    ...
    public void testRenderEmptyCollection() throws SchemaException, IllegalAttributeException {
        GeometryFactory gf = new GeometryFactory();
        StyleBuilder sb = new StyleBuilder();
        SimpleFeatureType pointType = DataUtilities.createType("emptyPolygon", 
                "geom:MultiPolygon,name:String");
        SimpleFeature f = SimpleFeatureBuilder.build(pointType, new Object[]{gf
                .createMultiPolygon((Polygon[]) null), "name"}, null);
        Style style = sb.createStyle(sb.createPolygonSymbolizer());

        renderEmptyGeometry(f, style);
    }

    public void testRenderCollectionWithEmptyItems() throws SchemaException, 
    ...
    public void testRenderPolygonEmptyRings() throws SchemaException, IllegalAttributeException {
        GeometryFactory gf = new GeometryFactory();
        StyleBuilder sb = new StyleBuilder();
        SimpleFeatureType pointType = DataUtilities.createType("emptyRings", "geom:MultiPolygon," +
                "name:String");
    ...
    public void testMixedEmptyMultiLine() throws SchemaException, IllegalAttributeException {
        GeometryFactory gf = new GeometryFactory();
        StyleBuilder sb = new StyleBuilder();
        SimpleFeatureType pointType = DataUtilities.createType("emptyRings", 
