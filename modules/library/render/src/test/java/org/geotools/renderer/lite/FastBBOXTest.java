...
public class FastBBOXTest {
  ...
  public void evaluate_envelopeOverlapsBBOX() throws Exception {
    FastBBOX fastBBOX =
        new FastBBOX(
            filterFactory.property("geometry"), new Envelope(0.8, 2, 0.8, 2), filterFactory);
  ...
  public void evaluate_envelopeIntersectsGeometry() throws Exception {
    FastBBOX fastBBOX =
        new FastBBOX(
            filterFactory.property("geometry"), new Envelope(0.5, 2, 0.5, 2), filterFactory);
    assertTrue(fastBBOX.evaluate(circle));
  }
  ...
  public void evaluate_envelopeDisjoint() throws Exception {
    FastBBOX fastBBOX =
        new FastBBOX(
            filterFactory.property("geometry"), new Envelope(1.1, 2, 1.1, 2), filterFactory);
