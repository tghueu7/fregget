...
public class RasterSymbolizerTest extends org.junit.Assert {
    ...
    private final static StyleFactory sf = CommonFactoryFinder.getStyleFactory(GeoTools
            .getDefaultHints());
    ...
    public void contrastEnhancementMethods() throws Exception {
        // the GridCoverage
        GeneralEnvelope envelope = new GeneralEnvelope(new double[]{-180, -90}, new double[]{180,
                90});
        ...
        GridCoverage2D gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        ...
                        envelope, new GridSampleDimension[]{new GridSampleDimension
                                ("test1BandByte_SLD")}, null, null);
        ...
        SubchainStyleVisitorCoverageProcessingAdapter rsh_SLD = new RasterSymbolizerHelper(gc, 
                null);
        ...
        gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        ...
                        new GeneralEnvelope(new double[]{-90, -180},
                                new double[]{90, 180}), new GridSampleDimension[]{new 
                                GridSampleDimension("test1BandByte_SLD")}, null, null);

        // the RasterSymbolizer Helper
        SubchainStyleVisitorCoverageProcessingAdapter rsh_StyleBuilder = new 
        ...
        gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        "name",
                        JAI.create("ImageRead", new File(TestData.url(this, "test_ushort.tif")
                                .toURI())),
                        new GeneralEnvelope(new double[]{-90, -180},
                                new double[]{90, 180}), new GridSampleDimension[]{new 
                                GridSampleDimension("test1BandByte_SLD")}, null, null);
        ...
        method_4.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
        ...
        gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        ...
                        new GeneralEnvelope(new double[]{-90, -180},
                                new double[]{90, 180}), new GridSampleDimension[]{new 
                                GridSampleDimension("dem")}, null, null);
        ...
        method_4f.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_STRETCH_TO_MINMAX_NAME));
        ...
        method_5.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
        ...
        method_5f.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_MINMAX_NAME));
        ...
        method_5g.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_MINMAX_NAME));
        ...
        //
        // ////////////////////////////////////////////////////////////////////
        RenderedImage source = new ImageWorker(new File(TestData.url(this, 
                "small_4bands_UInt16.tif").toURI())).retainBands(new int[]{2}).getRenderedImage();
        gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        "name",
                        source,
                        new GeneralEnvelope(new double[]{-90, -180},
                                new double[]{90, 180}), new GridSampleDimension[]{new 
                                GridSampleDimension("band")}, null, null);
        ...
        method_5c.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_MINMAX_NAME));
        ...
        method_6.setAlgorithm(sldBuilder.literalExpression(ContrastEnhancementType
        ...
        method_7.setAlgorithm(sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_ZERO_NAME));
        ...
        method_7f.setAlgorithm(sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_ZERO_NAME));
        ...
        method_7g.setAlgorithm(sldBuilder.literalExpression(ContrastEnhancementType
                .NORMALIZE_CLIP_TO_ZERO_NAME));
    ...
    @org.junit.Test
    public void bandFloat32_SLD() throws IOException, TransformerException, 
        ...
        GridCoverage2D gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        "name",
                        JAI.create("ImageRead", new File(TestData.url(this, 
                                "small_1band_Float32.tif").toURI())),
                        envelope, new GridSampleDimension[]{new GridSampleDimension
                                ("test1BandByte_SLD")}, null, null);
        // ////////////////////////////////////////////////////////////////////
        //
    ...
    @Test
    public void test1BandFloat32_ColorMap_SLD() throws IOException, TransformerException, 
            FactoryRegistryException, IllegalArgumentException, URISyntaxException {
        // the GridCoverage
        GeneralEnvelope envelope = new GeneralEnvelope(new double[]{-180, -90}, new double[]{180,
                90});
    ...
    @org.junit.Test
    public void bandsUInt16_SLD() throws IOException, TransformerException, 
            FactoryRegistryException, IllegalArgumentException, URISyntaxException {
        // the GridCoverage
    ...
    @org.junit.Test
    public void bandsByte_SLD() throws IOException, TransformerException, 
            FactoryRegistryException, IllegalArgumentException, URISyntaxException {
        // the GridCoverage
        GeneralEnvelope envelope = new GeneralEnvelope(new double[]{-180, -90}, new double[]{180,
                90});
        ...
        GridCoverage2D gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        "name",
                        JAI.create("ImageRead", new File(TestData.url(this, "small_3bands_Byte" +
                                ".tif").toURI())),
    ...
    @org.junit.Test
    public void bandsByte_ColorMap_SLD() throws IOException, TransformerException, 
            FactoryRegistryException, IllegalArgumentException, URISyntaxException {
        // the GridCoverage
        GeneralEnvelope envelope = new GeneralEnvelope(new double[]{-180, -90}, new double[]{180,
                90});
    ...
    @org.junit.Test
    public void BandByte_SLD() throws IOException, TransformerException, 
            FactoryRegistryException, IllegalArgumentException, URISyntaxException {
        // the GridCoverage
        GeneralEnvelope envelope = new GeneralEnvelope(new double[]{-180, -90}, new double[]{180,
                90});
        ...
        GridCoverage2D gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        "name",
                        JAI.create("ImageRead", new File(TestData.url(this, "small_1band_Byte" +
                                ".tif").toURI())),
                        envelope, new GridSampleDimension[]{new GridSampleDimension
                                ("test1BandByte_SLD")}, null, null);
    ...
    public void colorMapInterpolation() throws Exception {
        ...
        // bilinear
        RenderedImage image = renderer.renderImage(gc, rs, new InterpolationBilinear(), null, 
                256, 256);
        assertNotNull(image);
    ...
    public void dem() throws IOException, TransformerException {
        ...
        GridCoverage2D gc = CoverageFactoryFinder.getGridCoverageFactory(null)
                .create(
                        ...
                        envelope, new GridSampleDimension[]{new GridSampleDimension("dem")}, 
                        null, null);
        SubchainStyleVisitorCoverageProcessingAdapter rsh = new RasterSymbolizerHelper(gc, null);
        final RasterSymbolizer rs = extractRasterSymbolizer(sld);
        rsh.visit(rs);
    ...
    private static void testRasterSymbolizerHelper(final 
                                                   SubchainStyleVisitorCoverageProcessingAdapter 
                                                           rsh) {
        if (TestData.isInteractiveTest()) {
            ImageIOUtilities.visualize(((GridCoverage2D) rsh.getOutput()).getRenderedImage(), rsh
                    .getName()
                    .toString());
    ...
    public void contrastEnhancementInChannelSelection() throws IOException {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            method.addOption("algorithm", sldBuilder.literalExpression(ContrastEnhancementType
                    .NORMALIZE_STRETCH_TO_MINMAX_NAME));
        ...
        for (int i = 0; i < 3; i++) {
            ...
            assertTrue(Integer.toString((i) + 1).equalsIgnoreCase(postBandSelectionChannel
                    .getChannelName()));
            ...
            assertTrue(options.get("algorithm").equals(sldBuilder.literalExpression
