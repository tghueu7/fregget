...
public class LabelingTest extends TestCase {
  ...
  private SimpleFeature createLineFeature(
      ...
      AttributeDescriptor[] types)
      throws Exception {
    Coordinate[] c = new Coordinate[] {new Coordinate(startx, starty), new Coordinate(endx, endy)};
  ...
  private SimpleFeatureCollection createPolyFeatureCollection() throws Exception {
    ...
    data.addFeature(
        createPolyFeature(
            CENTERX + 5, CENTERY + 0, CENTERX + 10, CENTERY + 10, "LongLabel1", crs, geomFac));
    data.addFeature(
        createPolyFeature(
            CENTERX + 0, CENTERY + 0, CENTERX + 10, CENTERY + 10, "LongLabel2", crs, geomFac));
