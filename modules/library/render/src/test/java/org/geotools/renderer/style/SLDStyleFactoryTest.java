...
public class SLDStyleFactoryTest extends TestCase {
    ...
    public void testCreateDynamicMark() throws Exception {
        ...
        Shape expected = new TTFMarkFactory().getShape(null, ff.literal("ttf://Serif#0xF054"), 
                feature);
    ...
    public void testCreateDynamicExternalGraphics() throws Exception {
        ...
        BufferedImage expected = ImageIO.read(StreamingRenderer.class.getResource("test-data/draw" +
                ".png"));
    ...
    public void testResizeGraphicFill() throws Exception {
        ...
        ExternalGraphic eg = sf.createExternalGraphic(url + "icon64.png", "image/png");
        Graphic g = sf.createGraphic(new ExternalGraphic[]{eg}, null, null, null, ff.literal(20),
                null);
    ...
    public void testDefaultLineSymbolizerWithColor() throws Exception {
        ...
        DynamicLineStyle2D s2 = (DynamicLineStyle2D) sld.createDynamicLineStyle(feature, symb, 
                range);
        assertNotNull(s2);
    ...
    public void testUnknownFont() throws Exception {
        ...
        Font font = sf.createFont(ff.literal("notExistingFont"), ff.literal("italic"), ff.literal
                ("bold"), ff.literal(20));
        ts.setFont(font);
    ...
    public void testFallbackGraphicMark() throws Exception {
        PointSymbolizer symb = sf.createPointSymbolizer();
        ExternalGraphic eg = sf.createExternalGraphic("http://foo" +
                ".com/invalid_or_missing_image_url", null);
        symb.getGraphic().graphicalSymbols().add(eg);
    ...
    public void testKerningOnByDefault() throws Exception {
        TextSymbolizer ts = sf.createTextSymbolizer();
        ts.setFill(sf.createFill(null));
        Font font = sf.createFont(ff.literal("Serif"), ff.literal("italic"), ff.literal("bold"), 
                ff.literal(20));
        ts.setFont(font);
    ...
    public void testGEOT5878() {
        String wkt[] = {
                "Polygon ((6438348.98000000044703484 4962869.70000000018626451, " +
                        "6438348.88999999966472387 4962867.28000000026077032, " +
                        "6438343.53000000026077032 4962867.28000000026077032, " +
                        "6438343.53000000026077032 4962869.76999999955296516, " +
                        "6438343.61000000033527613 4962870.17999999970197678, " +
                        "6438348.90000000037252903 4962870.0400000000372529, " +
                        "6438348.98000000044703484 4962869.70000000018626451))",
                "Polygon ((6438339.7099999999627471 4962870.38999999966472387, " +
                        "6438339.94000000040978193 4962873.86000000033527613, " +
                        "6438346.65000000037252903 4962873.61000000033527613, " +
                        "6438346.62999999988824129 4962870.38999999966472387, " +
                        "6438339.7099999999627471 4962870.38999999966472387))"};
