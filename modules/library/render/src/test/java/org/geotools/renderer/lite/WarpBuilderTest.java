...
public class WarpBuilderTest {
    ...
    public void testUTM32N() throws FactoryException, TransformException {
        ...
        assertRowCols(new ReferencedEnvelope(9 - 40 , 9, 0, 40, WGS84), utm32n, screen, new int[] {32, 32});
        assertRowCols(new ReferencedEnvelope(9 - 20 , 9, 0, 20, WGS84), utm32n, screen, new int[] {8, 16});
        assertRowCols(new ReferencedEnvelope(9 - 10 , 9, 0, 10, WGS84), utm32n, screen, new int[] {4, 8});
        assertRowCols(new ReferencedEnvelope(9 - 5 , 9, 0, 5, WGS84), utm32n, screen, new int[] {2, 2});
        assertRowCols(new ReferencedEnvelope(9 - 2 , 9, 0, 2, WGS84), utm32n, screen, new int[] {1, 1});
    }
    ...
    public void testPolarStereo() throws FactoryException, TransformException {
        ...
        Rectangle screen = new Rectangle(0, 0, 512, 512);
        assertRowCols(new ReferencedEnvelope(-10, 10, -90, -85, WGS84), polar, screen, new int[] {16, 16});
        assertRowCols(new ReferencedEnvelope(-10, 10, -90, -70, WGS84), polar, screen, new int[] {32, 16});
        assertRowCols(new ReferencedEnvelope(-10, 10, -90, -45, WGS84), polar, screen, new int[] {64, 8});
        assertRowCols(new ReferencedEnvelope(-10, 10, -90, 0, WGS84), polar, screen, new int[] {128, 8});
        assertRowCols(new ReferencedEnvelope(80, 110, -90, 0, WGS84), polar, screen, new int[] {32, 32});
        assertRowCols(new ReferencedEnvelope(-110, -80, -90, 0, WGS84), polar, screen, new int[] {32, 32});
    }

    private void assertRowCols(ReferencedEnvelope sourceEnvelope, CoordinateReferenceSystem targetCRS, Rectangle screen, int[] expectedSplit) throws TransformException, FactoryException {
