...
public class LabelDisplacementModeTest extends TestCase {
  ...
  public void testDisplacementNotDiagonal() throws Exception {
    Style style =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementNotDiagonal.sld");
  ...
  public void testDisplacementStandardMultiLayer() throws Exception {
    Style style = RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementStandard.sld");
    Style style2 =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementStandardPoly.sld");
    BufferedImage image =
        renderLabels(
  ...
  public void testDisplacementNotDiagonalMultiLayer() throws Exception {
    Style style =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementNotDiagonal.sld");
    Style style2 =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementNotDiagonalPoly.sld");
    BufferedImage image =
        renderLabels(
            new SimpleFeatureSource[] {fs, fs2},
            new Style[] {style, style2},
  ...
  public void testDisplacementVerticalBoth() throws Exception {
    Style style =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementVerticalBoth.sld");
  ...
  public void testDisplacementVerticalBothMultiLayer() throws Exception {
    Style style =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementVerticalBoth.sld");
    Style style2 =
        RendererBaseTest.loadStyle(this, "displacementMode/textDisplacementVerticalBothPoly.sld");
    BufferedImage image =
        renderLabels(
            new SimpleFeatureSource[] {fs, fs2},
            new Style[] {style, style2},
  ...
  public void testDisplacementVerticalBothConflictDisabled() throws Exception {
    Style style =
        RendererBaseTest.loadStyle(
            this, "displacementMode/textDisplacementVerticalBoth_conflict_disabled.sld");
    BufferedImage image =
