...
public class WindBarbsFactoryTest extends Assert {
  ...
  public void testCustomBarbs() {
    ...
    this.exp =
        ff.literal(
            WindBarbsFactory.WINDBARBS_PREFIX + "default(2.999999999999)[kts]?zeroWindRadius=15");
    shp = (Shape) wbf.getShape(null, this.exp, this.feature);
    assertNotNull(shp);
    ...
    this.exp =
        ff.literal(
            WindBarbsFactory.WINDBARBS_PREFIX + "default(3)[kts]?emisphere=S&vectorLength=50");
    ...
    this.exp =
        ff.literal(
            WindBarbsFactory.WINDBARBS_PREFIX + "default(5)[kts]?hemisphere=S&vectorLength=50");
    ...
    // 50 KNOTS --> pennant
    this.exp =
        ff.literal(WindBarbsFactory.WINDBARBS_PREFIX + "default(50)[kts]?basePennantLength=10");
    shp = (Shape) wbf.getShape(null, this.exp, this.feature);
    assertNotNull(shp);
    assertTrue(shp instanceof Path2D);
    assertEquals(
    ...
    this.exp =
        ff.literal(
            WindBarbsFactory.WINDBARBS_PREFIX + "default(100)[kts]?hemisphere=s&vectorLength=30");
    shpS = (Shape) wbf.getShape(null, this.exp, this.feature);
    assertNotNull(shpS);
    assertTrue(shpS instanceof Path2D);
    shpS = WindBarbsFactory.SOUTHERN_EMISPHERE_FLIP.createTransformedShape(shpS); // flip and check
  ...
  public void testDefaultValid() {
    ...
    this.exp =
        ff.literal(
            WindBarbsFactory.WINDBARBS_PREFIX + "default(100)[kts]?vectorLength=30&hemisphere=s");
    shpS = (Shape) wbf.getShape(null, this.exp, this.feature);
    assertNotNull(shpS);
    assertTrue(shpS instanceof Path2D);
    shpS = WindBarbsFactory.SOUTHERN_EMISPHERE_FLIP.createTransformedShape(shpS); // flip and check
  ...
  public void testWellKnownTextLineString() {
    ...
    try {
      ...
      Shape shp = (Shape) wbf.getShape(null, this.exp, this.feature);
      System.out.println(WindBarbsFactoryTest.WKT_WRITER.write(JTS.toGeometry(shp)).toString());
