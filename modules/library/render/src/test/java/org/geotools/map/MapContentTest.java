...
public class MapContentTest {
  ...
  /**
   * Calling {@link MapContent#getViewport()} initially creates a new viewport instance with default
   * settings.
   */
  @Test
  ...
  public void crsIsNotAutoSetIfViewportHasExplicitCRS() {
    ...
    assertFalse(
        WORLD.getCoordinateReferenceSystem().equals(mapContent.getCoordinateReferenceSystem()));
  }
