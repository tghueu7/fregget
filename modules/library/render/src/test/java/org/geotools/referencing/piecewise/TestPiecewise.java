...
public class TestPiecewise {
  ...
  public void linearTransform() throws IOException, TransformException, TransformationException {
    ...
    // checks
    Assert.assertEquals(
        ((DefaultLinearPiecewiseTransform1DElement) e0).getOutputMinimum(), e0.transform(0), 0.0);
    Assert.assertEquals(
  ...
  public void passthroughTransform()
    ...
    Assert.assertEquals(
        p1.inverse().transform(new Position(657.5), null).getOrdinatePosition(), 657.5, 0.0);
