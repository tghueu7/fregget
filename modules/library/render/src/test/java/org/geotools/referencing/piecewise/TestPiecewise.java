...
public class TestPiecewise {
    ...
    public void linearTransform() throws IOException, TransformException, TransformationException {
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
     ...
     */
    @Test
    public void constantTransform() throws IOException, TransformException, it.geosolutions
            .jaiext.piecewise.NoninvertibleTransformException, TransformationException {
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform1 = new 
                DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                DefaultPiecewiseTransform1DElement[]{e0});
        ...
        transform = new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                DefaultPiecewiseTransform1DElement[]{e0});
    ...
    public void piecewiseLogarithm() throws IOException, TransformException, 
        ...
        final DefaultPiecewiseTransform1DElement mainElement = new 
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{zero, mainElement});
        ...
        transform =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{zero, mainElement, nodata});
    ...
    public void defaultTransform() throws IOException,
        ...
        t0 = DefaultPiecewiseTransform1DElement.create("t0", RangeFactory.create(0.0, true, 1.0, 
                true), RangeFactory.create(200, 201));
        Assert.assertFalse(t0.equals(DefaultPiecewiseTransform1DElement.create("t0", RangeFactory
                .create(0.0, true, 1.0, true), RangeFactory.create(200, 202))));
        Assert.assertEquals(t0.transform(0.5), 200.5, 0.0);
        Assert.assertEquals(t0.transform(
                new Position(0.5), null)
                .getOrdinatePosition(), 200.5, 0.0);
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{t1}, 12);
            ...
            transform = new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(
                    new DefaultPiecewiseTransform1DElement[]{
                            DefaultLinearPiecewiseTransform1DElement.create("",
                                    ...
                                    RangeFactory.create(Double.NEGATIVE_INFINITY, Double
                                            .POSITIVE_INFINITY))});
            Assert.assertTrue(false);
    ...
    public void passthroughTransform() throws IOException,
        ...
        //
        ////
        final DefaultPassthroughPiecewiseTransform1DElement p0 = new 
...
//			Assert.assertTrue(m.getElement(0, 0)==1);
        ...
        final DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> piecewise =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{p0}, 11);
        ...
        //
        ////
        final DefaultPassthroughPiecewiseTransform1DElement p1 = new 
                DefaultPassthroughPiecewiseTransform1DElement(
                "p1");
...
//			Assert.assertTrue(m1.getElement(0, 0)==1);
    ...
    public void lookupByte() throws IOException, TransformException {
        ...
        final DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> list =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{c0, c1, nodata});
    ...
    public void SWANLOGARITHMIC() throws IOException {
        ...
        ImageWorker w = new ImageWorker(image).setROI(new ROI(new ImageWorker(image).binarize(0)
                .getRenderedImage()));
        //final RenderedOp statistics = ExtremaDescriptor.create(image, new ROI(new ImageWorker
        // (image).binarize(0).getRenderedImage()),
                    ...
                    public double transform(double arg0) {
                        ...
                        return minimum[0] +
                                1.2 * Math.log(arg0 / minimum[0]) *
                                        ((maximum[0] - minimum[0]) / (Math.log(maximum[0] / 
                                                minimum[0]))
                                        );
                    }
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform =
                new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(new 
                        DefaultPiecewiseTransform1DElement[]{mainElement}, 0);
