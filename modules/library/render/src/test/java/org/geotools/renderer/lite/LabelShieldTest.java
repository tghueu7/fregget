...
public class LabelShieldTest {
    ...
    public void testPointShieldUnderTheLine() throws Exception {
        ...
        BufferedImage image = RendererBaseTest.showRender("Text under the line", renderer, TIME, 
                pointBounds);

        String refPath = "./src/test/resources/org/geotools/renderer/lite/test-data" +
                "/textLabelShieldUnderTheLine.png";
    ...
    public void testLabelShieldMultilineStretch() throws Exception {
        ...
        BufferedImage image = RendererBaseTest.showRender("Labels and shield", renderer, TIME,
                bounds);
        String refPath = "./src/test/resources/org/geotools/renderer/lite/test-data" +
                "/textLabelShieldMultilineStretch.png";
        ImageAssert.assertEquals(new File(refPath), image, 1200);
    }
