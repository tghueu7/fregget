...
public class RepeatedLabelTest {
    ...
    public void testLabelSquareBordersWithHoles() throws Exception {
        checkRepeatedLabelsPolygonBorder(squareHoles, "repeatedLabelsAlongLine", "polyHole", 
                null, 1000);
    }
    ...
    public void testLabelSquareBordersPositiveOffset() throws Exception {
        ...
        checkRepeatedLabelsPolygonBorder(square, "repeatedLabelsAlongLine", "poly-perp-offset", 
                visitor, 1000);
    }
    ...
    public void testLabelSquareBordersNegativeOffset() throws Exception {
        PerpendicularOffsetVisitor visitor = new PerpendicularOffsetVisitor(-10);
        checkRepeatedLabelsPolygonBorder(square, "repeatedLabelsAlongLine", 
                "poly-perp-negative-offset", visitor, 1000);
    }
    ...
    public void testLabelSquareBordersHolesPositiveOffset() throws Exception {
        ...
        checkRepeatedLabelsPolygonBorder(squareHoles, "repeatedLabelsAlongLine", 
                "poly-hole-perp-offset", visitor, 1000);
    }
    ...
    public void testLabelSquareBordersHoleNegativeOffset() throws Exception {
        PerpendicularOffsetVisitor visitor = new PerpendicularOffsetVisitor(-5);
        checkRepeatedLabelsPolygonBorder(squareHoles, "repeatedLabelsAlongLine", 
                "poly-hole-perp-negative-offset", visitor, 1000);
    }


    private void checkRepeatedLabelsPolygonBorder(SimpleFeatureSource features, String styleName,
                                                  String testImageSuffix, DuplicatingStyleVisitor
                                                          styleVisitor, int tolerance) throws 
            Exception {
        Style style = RendererBaseTest.loadStyle(this, styleName + ".sld");
