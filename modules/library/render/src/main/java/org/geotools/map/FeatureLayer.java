...
public class FeatureLayer extends StyleLayer {
   ...
   *
   * @return Query used to process content prior to display, or Query.ALL to indicate all content is
   *     used
   */
   ...
   * It is desirable to not include attributes at all but let the layer user (a renderer?) to decide
   * wich attributes are actually needed to perform its requiered operation.
   *
   * @param query
   */
