...
public interface ExternalGraphicFactory {
   ...
   * The <code>size</code> parameter defines the size of the image (so that vector based symbols can
   * be drawn at the specified size directly), or may be zero or negative if the size was not
