...
/**
 * Base implementation of a      {@link CoverageProcessingNode}      . <p> This implementation 
 * provides convenient methods for managing sinks and source for a      
 * {@link CoverageProcessingNode}      . The      {@link #getOutput()}      is used to get the 
 * output of this      {@link CoverageProcessingNode}      (a     
 * {@link CoverageProcessingException}      is thrown in case something bad happens while 
 * processing <p> Implementors must implement the abstract method      {@link #execute()}      
 * which is guaranteed to run in a critical section where the sources and sinks for this     
 * {@link CoverageProcessingNode}      will not be touched.
 *
...
public abstract class BaseCoverageProcessingNode implements
     ...
     */
    private final static CoverageProcessingCycleDetector cycleDetector = new 
            CoverageProcessingCycleDetector();
    ...
    /**
     * {@link GridCoverageFactory}     to build     {@link GridCoverage2D}     objects as output 
     * of this operation.
     *
     ...
     */
    private InternationalString name = Vocabulary.formatInternational(VocabularyKeys
     ...
     *
     * @param maxSources  maximum number of sources allowed for this node.
     * @param hints       instance of {@link Hints} class to control creation of
    ...
    private void checkExecuted() {
        ...
        if (!executed) {
            try {
                ...
                if (result == null)
                    error = new CoverageProcessingException("Something bad occurred while trying " +
     ...
     * {@link CoverageProcessingNode}  and also of all its sources. <p> In case something bad 
     * happens a  {@link CoverageProcessingException}  is thrown.
     *
     * @uml.property name="output"
     */
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode#addSink(org.geotools
     * .renderer.lite.gridcoverage2d.CoverageProcessingNode)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode#addSource(org
     * .geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode#removeSink(org
     * .geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode#removeSource(org
     * .geotools.renderer.lite.gridcoverage2d.CoverageProcessingNode)
     */
     ...
     *
     * @return the maximum number of sources we are allowed to set for this 
     * {@link CoverageProcessingNode}
     * @uml.property name="maximumNumberOfSources"
     */
