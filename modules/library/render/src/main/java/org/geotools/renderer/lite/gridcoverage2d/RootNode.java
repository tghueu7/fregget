...
/**
 * {@link RootNode}  implements a  {@link BaseCoverageProcessingNode}  which act as the rot for a
 * graph of  {@link CoverageProcessingNode} s
 *
...
//	private boolean adopt;
     ...
     *
     * @param coverage the {@link GridCoverage2D} that makes this
    ...
    public RootNode(GridCoverage2D coverage, Hints hints) {
        super(
                ...
                SimpleInternationalString
                        .wrap("Root node which does not have sources but simply wraps a " +
                                "GridCoverage2D"));
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d.BaseCoverageProcessingNode#addSource(org
