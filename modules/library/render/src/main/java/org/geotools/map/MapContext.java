...
public class MapContext extends MapContent {
     ...
     *
     * @param layers an array of MapLayer objects (may be empty or null) to be added to this context
     * @param crs    the coordindate reference system to be used with this context (may be null 
     *               and set
     *               later)
     */
     ...
     * layer with an available CRS.
     *
     * @param layers             an array of MapLayer objects (may be empty or null) to be added 
     *                           to this context
     * @param title              a title for this context (e.g. might be used by client-code that
     *                          is displaying the
     *                           context's layers); may be null or an empty string
     * @param contextAbstract    a short description of the context and its contents; may be null
     *                          or an empty
     *                           string
     * @param contactInformation can be used, for example, to record the creators or custodians 
     *                           of the data that
     *                           are, or will be, held by this context; may be null or an empty 
     *                           string
     * @param keywords           an optional array of key words pertaining to the data that are, 
     *                           or will be, held
     ...
     *                           or will be, held
     *                           by this context; may be null or a zero-length String array
     * @param crs                the coordindate reference system to be used with this context 
     *                           (may be null and set
     *                           later)
     */
    public MapContext(MapLayer[] layers, String title, String contextAbstract,
                      String contactInformation, String[] keywords, final 
    ...
    public ReferencedEnvelope getLayerBounds() throws IOException {
        ...
        CoordinateReferenceSystem mapCRS = viewport != null ? viewport
            ...
            if (dataBounds == null) {
                ...
                try {
                    ...
                    LOGGER
                            .log(
                                    Level.SEVERE,
                                    "Data source and map context coordinate system differ, yet it" +
                                            " was not possible to get a projected bounds " +
                                            "estimate...",
                                    e);
                    continue;
     ...
     * @throws IllegalArgumentException if the provided areaOfInterest is {@code null} or does 
     * not have a coordinate
     *                                  reference system
     */
