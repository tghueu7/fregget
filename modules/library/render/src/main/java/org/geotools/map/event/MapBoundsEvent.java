...
public class MapBoundsEvent extends EventObject {
   ...
   */
  public MapBoundsEvent(
      MapViewport source, Type type, ReferencedEnvelope oldBounds, ReferencedEnvelope newBounds) {
  ...
  /**
   * Get the new coordinate reference system. This is a convenience method equivalent to {@linkplain
   * #getNewAreaOfInterest()}.getCoordinateReferenceSystem()
   *
