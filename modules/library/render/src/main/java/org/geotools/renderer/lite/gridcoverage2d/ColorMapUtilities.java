...
class ColorMapUtilities {
  ...
  /**
   * Codes ARGB par d�faut. On utilise un exemplaire unique pour toutes les cr�ation d'objets {@link
  ...
  static void checkDimension(final DirectPosition point) {
    ...
    if (dim != 1) {
      throw new MismatchedDimensionException(
          Errors.format(
              ErrorKeys.MISMATCHED_DIMENSION_$2, Integer.valueOf(1), Integer.valueOf(dim)));
    }
  }
  /**
