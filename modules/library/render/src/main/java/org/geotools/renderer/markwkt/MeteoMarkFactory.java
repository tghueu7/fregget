...
public class MeteoMarkFactory implements MarkFactory {
  ...
  /**
   * Key for the extshape://arrow base line thickness (must be between 0, just border, and 1, which
   * turns the arrow into a irregular pentagon, "little house" like). Default value is 0.2
   */
  public static final String ARROW_THICKNESS_KEY = "t";

  /**
   * Key for the extshape://arrow location of the arrowhead base, a value of 0 turns the shape into
   * a triangle, a value of 1 into a rectangle. Default value is 0.5
   */
  ...
  private Shape buildDynamicArrow(String name) {
    ...
    for (Map.Entry<String, String> entry : params.entrySet()) {
      ...
      switch (key) {
        ...
        default:
          LOGGER.warning(
              "Unexpected key value pair " + key + "=" + svalue + " for extshape://arrow");
      }
    }
