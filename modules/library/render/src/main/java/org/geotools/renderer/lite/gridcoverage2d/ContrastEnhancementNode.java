...
class ContrastEnhancementNode extends StyleVisitorCoverageProcessingNodeAdapter
    ...
    public void visit(final ContrastEnhancement ce) {
            ...
            if (type != null && !type.equalsIgnoreCase("None")) {
                ...
                if (!SUPPORTED_HE_ALGORITHMS.contains(type.toUpperCase()))
                    throw new IllegalArgumentException(Errors.format(ErrorKeys
                            .OPERATION_NOT_FOUND_$1, type.toUpperCase()));
                this.contrastEnhancementMethod = parseContrastEnhancementMethod(contrastMethod, 
                        ce.getOptions());
            }
        }
        ...
        if (gamma != null) {
            ...
            if (number != null) {
                ...
                if (gammaValue < 0)
                    throw new IllegalArgumentException(Errors.format(ErrorKeys
                            .ILLEGAL_ARGUMENT_$2, "Gamma", number));
     ...
     * (non-Javadoc)
     *
     * @see org.geotools.renderer.lite.gridcoverage2d
        ...
        if (sources != null && !sources.isEmpty()) {
            ...
            if ((!Double.isNaN(gammaValue) &&
                ...
                if (intensity) {
                    ...
                    intensityWorker.setRenderingHints(rendHints).addBands(new 
                            RenderedImage[]{hChannel, sChannel}, false, null);
                ...
                if (intensityWorker.getNoData() != null) {
                    props.put(NoDataContainer.GC_NODATA, new NoDataContainer(intensityWorker
                            .getNoData()));
                }
    ...
    /**
     * Performs a contrast enhancement operation on the input image. Note that not all the 
     * contrast enhancement operations have been implemented in a
    ...
    private RenderedImage performContrastEnhancement(ImageWorker inputWorker, final Hints hints) {
        ...
        if (contrastEnhancementMethod != null) {
            ...
            ContrastEnhancementType ceType = ContrastEnhancementType.getType
                    (contrastEnhancementMethod);
