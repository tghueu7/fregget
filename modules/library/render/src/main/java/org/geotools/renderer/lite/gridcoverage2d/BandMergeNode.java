    ...
    protected GridCoverage execute() {
        ...
        if (sources != null && !sources.isEmpty()) {
            ...
            do {
                ...
                final GridCoverage2D currentSourceCoverage = (GridCoverage2D) currentSourceNode
                        .getOutput();
                ...
                if (op == null) {
                    ...
                    NoDataContainer container = CoverageUtilities.getNoDataProperty
                    ...
                    NoDataContainer container = CoverageUtilities.getNoDataProperty
                            (currentSourceCoverage);
                    w.addBand(currentSourceCoverage.getRenderedImage(), false, false, container 
                            != null ? container.getAsRange() : null);
                    // //
                    //
            ...
            final GridSampleDimension[] sd = new GridSampleDimension[op.getSampleModel()
                    .getNumBands()];
            for (int i = 0; i < sd.length; i++)
                sd[i] = new GridSampleDimension(TypeMap.getColorInterpretation(op.getColorModel()
                        , i).name());
