...
public class VendorOptionParser {
  ...
  /**
   * Extracts a integer from the vendor options map, returns it if found, returns the default value
   * if not
   *
   * @param symbolizer
   * @param optionName
  ...
  /**
   * Extracts a boolean from the vendor options map, returns it if found, returns the default value
   * if not
   *
   * @param symbolizer
   */
