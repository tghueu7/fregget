...
class LabelSplitter {
    ...
    private List<LineComponent> buildLineComponents(String text, Font font, LabelCacheItem labelItem,
            Graphics2D graphics, TextLayout layout) {
            ...
            for (int i = 0; i < parts.length; i++) {
                ...
                if(i < parts.length - 1) {
                    ...
                    LineComponent spacer = new LineComponent(SINGLE_CHAR_STRING,
                            layoutSentence(SINGLE_CHAR_STRING, labelItem, graphics, spacerFont), spacerLayout);
                    result.add(spacer);
                }
            }
            return result;
