...
public class LineStyle2D extends Style2D {
  ...
  /**
   * Returns the contour color for the {@linkplain org.geotools.renderer.geom.Polyline polyline} to
  ...
  /**
   * Sets the contour color for the {@linkplain org.geotools.renderer.geom.Polyline polyline} to be
   * rendered
   *
   * @param contour
   */
  ...
  /**
   * Returns the contour Composite for the {@linkplain org.geotools.renderer.geom.Polyline polyline}
  ...
  /**
   * Sets the contour Composite for the {@linkplain org.geotools.renderer.geom.Polyline polyline} to
