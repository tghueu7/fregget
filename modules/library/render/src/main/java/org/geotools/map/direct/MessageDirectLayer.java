...
public class MessageDirectLayer extends DirectLayer {
  ...
  /**
   * Message to be displayed. While it is perfectly alright to just use the getUserData() map we are
   * making use of an field here in order to verify the ability to fire events correctly when the
   * message is changed.
   */
