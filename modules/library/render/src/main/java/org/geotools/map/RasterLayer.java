...
public abstract class RasterLayer extends StyleLayer {
  ...
  /**
   * Supply a FeatureCollection indicating where the raster is located, we ask that the features use
   * the same coordinate reference system as your raster data and form an outline or foot print of
   ...
   * willing to render your raster content as an outline; for this to work they need this method to
   * supply a feature collection indicating where the content is located. The information may also
   * be used to determine if any of your raster content is on screen (and thus needs to be
   * rendered).
   *
