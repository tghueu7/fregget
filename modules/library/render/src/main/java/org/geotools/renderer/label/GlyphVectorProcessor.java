...
abstract class GlyphVectorProcessor {
  ...
  /**
   * Create a Straight GlyphVectorProcessor, pre-compute the affine transforms for each glyph along
   * a straight line.
   */
  ...
  /**
   * Create a Curved GlyphVectorProcessor, pre-compute the affine transforms for each glyph along a
   * curved line. Does not consider letter orientation (only letter position). (taken from
