...
public class LabelCacheItem implements Comparable<LabelCacheItem> {
  ...
  /**
   * Max angle between two subsequence characters in a curved label, in degrees. Good visual results
   * are obtained with an angle of less than 25 degrees.
   *
   * @return
   */
  ...
  /**
   * Sets conflict resolution for this label. When on, this label outline/bbox will be stored in the
   * conflict resolution map and will prevent every other label to be drawn in the same area
   *
