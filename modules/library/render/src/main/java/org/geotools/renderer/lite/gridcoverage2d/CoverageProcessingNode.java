...
public interface CoverageProcessingNode {
     ...
     *
     * @param source the {@link CoverageProcessingNode} to add to the {@link List}
     ...
     *
     * @param index the index at which we want to remove a source from the
     ...
     * for this {@link CoverageProcessingNode}.
     *
     * @param sources the {@link CoverageProcessingNode} to remove from the
     *                {@link List} of sources for this
     *                {@link CoverageProcessingNode}.
     ...
     * this {@link CoverageProcessingNode}.
     *
     * @param index the index at which we want to remove a sink from the
     *              {@link List} of sinks for this {@link CoverageProcessingNode}.
     * @return the {@link CoverageProcessingNode} we actually remove from the
     * sinks list.
     */
     ...
     * this {@link CoverageProcessingNode}.
     *
     * @param sink the {@link CoverageProcessingNode} to remove from the
     *             {@link List} of sinks for this {@link CoverageProcessingNode}.
     * @return <code>true</code> in case we remove something,
     * <code>false</code> otherwise.
     */
     ...
     *
     * @param force <code>true</code> to force disposal, <code>false</code> to
     *              suggest disposal.
     */
