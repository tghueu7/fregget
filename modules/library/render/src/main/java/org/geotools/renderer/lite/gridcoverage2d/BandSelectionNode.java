...
/**
 * This  {@link CoverageProcessingNode}  has been built for taking care of the band select 
 * operation within the context of applying SLD 1.0.
 *
...
class BandSelectionNode extends StyleVisitorCoverageProcessingNodeAdapter
            ...
            if (bandIndex != -1) {
                ...
                if (bandIndex < 1 || bandIndex > numSampleDimensions)
                    throw new IllegalArgumentException(
                            Errors.format(ErrorKeys.BAD_BAND_NUMBER_$1, Integer.valueOf
                                    (bandIndex)));
    ...
    /**
     * Retrieves the band index we use for this  {@link BandSelectionNode} . <p> <code>-1</code> 
     * warns about a possible error.
     *
