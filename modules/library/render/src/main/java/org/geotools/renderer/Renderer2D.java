...
public interface Renderer2D {
   ...
   * @param paintArea The bounds of the output area in output units (usually pixels). The upper left
   *     corner is (0,0) in most cases. However, a different value is allowed if some widget area
   *     must be preserved, for example a margin on the left and top size for painting a graduation.
   ...
   *     graphics.{@link Graphics2D#transform(AffineTransform) transform}(transform)</code>) before
