...
public class TTFMarkFactory implements MarkFactory {
    ...
    /**
     * The factory is completely stateless, this single instance can be safely used across 
     * multiple threads
     */
        ...
        if (!markUrl.matches("ttf://.+#.+")) {
            throw new IllegalArgumentException(
                    "Mark URL font found, but does not match the required "
                            + "structure font://<fontName>#<charNumber>, e.g., " +
                            "ttf://wingdigs#0x7B. You specified "
                            + markUrl);
        }
