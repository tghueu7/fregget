...
public class BlendComposite implements Composite {
  ...
  public enum BlendingMode {
    ...
    MULTIPLY("multiply") {
      ...
      public void perform(
        ...
        result[GREEN] =
            Math.min(255, ((sg * dg + sg * d1a + dg * s1a + UBYTE_MAX_VALUE) >> SHIFT8));
    ...
    DARKEN("darken") {
      ...
      public void perform(
        ...
        int d1a = UBYTE_MAX_VALUE - da;
        result[RED] =
            ((Math.min(sr * da, dr * sa) + sr * d1a + dr * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[GREEN] =
            ((Math.min(sg * da, dg * sa) + sg * d1a + dg * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[BLUE] =
            ((Math.min(sb * da, db * sa) + sb * d1a + db * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[ALPHA] = (sa + da - ((sa * da + UBYTE_MAX_VALUE) >> SHIFT8));
      }
    },
    LIGHTEN("lighten") {
      ...
      public void perform(
        ...
        int d1a = UBYTE_MAX_VALUE - da;
        result[RED] =
            ((Math.max(sr * da, dr * sa) + sr * d1a + dr * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[GREEN] =
            ((Math.max(sg * da, dg * sa) + sg * d1a + dg * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[BLUE] =
            ((Math.max(sb * da, db * sa) + sb * d1a + db * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[ALPHA] = (sa + da - ((sa * da + UBYTE_MAX_VALUE) >> SHIFT8));
      }
    },
      ...
      public void perform(
        ...
        result[RED] =
            (((srda + drsa <= sada)
                    ? sr * d1a + dr * s1a
                    : (sr > 0
                        ? sa * (srda + drsa - sada) / sr + sr * d1a + dr * s1a + UBYTE_MAX_VALUE
                        : 0))
                >> SHIFT8);
        result[GREEN] =
            (((sgda + dgsa <= sada)
                    ? sg * d1a + dg * s1a
                    : (sg > 0
                        ? sa * (sgda + dgsa - sada) / sg + sg * d1a + dg * s1a + UBYTE_MAX_VALUE
                        : 0))
                >> SHIFT8);
        result[BLUE] =
            (((sbda + dbsa <= sada)
                    ? sb * d1a + db * s1a
                    : (sb > 0
                        ? sa * (sbda + dbsa - sada) / sb + sb * d1a + db * s1a + UBYTE_MAX_VALUE
                        : 0))
                >> SHIFT8);
    ...
    SOFT_LIGHT("soft-light") {
      ...
      public void perform(
        ...
        //   Dca' = Dca.(Sa + (1 - Dca/Da).(2.Sca - Sa).(3 - 8.Dca/Da)) + Sca.(1 - Da) + Dca.(1 -
        // Sa)
        // otherwise
    ...
    EXCLUSION("exclusion") {
      ...
      public void perform(
        ...
        result[RED] =
            ((sr * da + dr * sa - 2 * sr * dr + sr * d1a + dr * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[GREEN] =
            ((sg * da + dg * sa - 2 * sg * dg + sg * d1a + dg * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[BLUE] =
            ((sb * da + db * sa - 2 * sb * db + sb * d1a + db * s1a + UBYTE_MAX_VALUE) >> SHIFT8);
        result[ALPHA] = (sa + da - ((sa * da + UBYTE_MAX_VALUE) >> SHIFT8));
      }
    };
  ...
  /**
   * <code>BlendComposite</code> object that implements the opaque COLOR_DODGE rule with an alpha of
   * 1.0f.
   *
  ...
  /**
   * <code>BlendComposite</code> object that implements the opaque COLOR_BURN rule with an alpha of
   * 1.0f.
   *
  ...
  /**
   * <code>BlendComposite</code> object that implements the opaque HARD_LIGHT rule with an alpha of
   * 1.0f.
   *
  ...
  /**
   * <code>BlendComposite</code> object that implements the opaque SOFT_LIGHT rule with an alpha of
   * 1.0f.
   *
  ...
  /**
   * <code>BlendComposite</code> object that implements the opaque DIFFERENCE rule with an alpha of
   * 1.0f.
   *
