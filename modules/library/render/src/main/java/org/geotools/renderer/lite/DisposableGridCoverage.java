...
/**
 * Internal wrapper used by streaming renderer to figure out if a GridCoverage2D should be 
 * disposed at
 * the end of processing, or not. Used when the coverage has been generated by a rendering
