...
public interface Renderer {
  ...
  /**
   * Renders the provided features using the specified style. The features should fill the viewport
   * but may well extend beyond it. Features should be cropped (if appropriate) to the specified
   * viewport.
   *
