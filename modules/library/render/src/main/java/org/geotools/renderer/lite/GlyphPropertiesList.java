...
public class GlyphPropertiesList {
    ...
    public void addProperty(String name, Class type, Object value) {
        if (type.isAssignableFrom(value.getClass())) {
            ...
            throw new RuntimeException("Wrong class for setting variable " + name + ".  Expected " +
                    "a " + type + " but received a " + value.getClass() + ".");
        }
    }
    ...
    public Class getPropertyType(String name) {
        ...
        if (index != -1) {
            ...
            throw new RuntimeException("Tried to get the class of a non-existent property: " + 
                    name);
        }
    }
    ...
    public void setPropertyValue(String name, Object value) {
        ...
        if (index != -1) {
            ...
            if (prop.getType().isAssignableFrom(value.getClass())) {
                ...
                throw new RuntimeException("Wrong class for setting variable " + name + ".  " +
                        "Expected a " + prop.getType() + " but received a " + value.getClass() + 
                        ".");
            }
        } else {
            throw new RuntimeException("Tried to set the value of a non-existent property: " + 
                    name);
        }
    }
}
