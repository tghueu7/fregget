...
public class PolygonStyle2D extends LineStyle2D {
  ...
  /**
   * Returns the filling color for the {@linkplain org.geotools.renderer.geom.Polygon polygon} to be
  ...
  /**
   * Returns the fill Composite for the {@linkplain org.geotools.renderer.geom.Polyline polyline} to
   * be rendered, or <code>null</code> if the contour is to be opaque
   *
  ...
  /**
   * Sets the fill Composite for the {@linkplain org.geotools.renderer.geom.Polyline polyline} to be
   * rendered. Set it to <code>null</code> if the contour is to be opaque
   *
   * @param fillComposite
   */
