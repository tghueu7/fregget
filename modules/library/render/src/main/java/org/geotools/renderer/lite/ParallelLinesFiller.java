...
public class ParallelLinesFiller {
    ...
    public static ParallelLinesFiller fromStipple(Shape shape) {
        ...
        for (Line2D segment : segments) {
            ...
            if (equals(x1, x2)) {
                ...
                } else if ((equals(x1, bx1) && equals(y1, by1) && equals(x2, bx2) && equals(y2, 
                        by2)) ||
                        (equals(x1, bx2) && equals(y1, by2)) && equals(x2, bx1) && equals(y2, 
                                by1)) {
                    lines.add(new Line(LineType.SLASH, 0));
                } else if ((equals(x1, bx1) && equals(y1, by2) && equals(x2, bx2) && equals(y2, 
                        by1)) ||
                        (equals(x1, bx2) && equals(y1, by1)) && equals(x2, bx1) && equals(y2, 
                                by2)) {
     ...
     * @param ls2d
     */
    public void fillRectangle(Rectangle2D bounds, StyledShapePainter painter, Graphics2D 
            graphics, LineStyle2D ls2d) {
        ...
        LineString stippleLine = geomFactory.createLineString(new Coordinate[]{stippleCoord1, 
                stippleCoord2});
        ...
        for (Line line : lines) {
            if (line.type == LineType.HORIZONTAL) {
                ...
                for (double y = bounds.getMinY() + line.initialOffset; y < bounds.getMaxY(); y +=
                        yStep) {
                ...
                for (double x = bounds.getMinX() + line.initialOffset; x < bounds.getMaxX(); x +=
                        xStep) {
