...
public class ValidationPlugInTester extends DataTestCase {
    ...
    public void testLineNoSelfIntersectFV_CorrectData() {
        ...
        try {
            processor.runFeatureTests("road", DataUtilities.collection(this.roadFeatures), 
    ...
    public void testLineNoSelfOverlapFV_CorrectData() {
        ...
        selfOverlappingValidatorRoads.setDescription("Tests to see if a road intersects itself, " +
                "which is bad!");
        ...
        try {
            processor.runFeatureTests("id", DataUtilities.collection(this.roadFeatures), 
                    roadValidationResults);
        } catch (Exception e1) {
            assertTrue(false);
        }
    ...
    public void testLineNoSelfOverlapFV_IncorrectData() {
        ...
        try {
            processor.runFeatureTests("datastoreId", DataUtilities.collection(new 
                    SimpleFeature[]{this.newRoad}), roadValidationResults);
        } catch (Exception e1) {
            assertTrue(false);
        }
    ...
    public void testLineIsSingleSegmentFV_IncorrectData() {
	 ...
	 /*
        ...
        try {
            processor.runFeatureTests("dataStoreId", DataUtilities.collection(this.roadFeatures),
                    roadValidationResults);
        } catch (Exception e1) {
            assertTrue(false);
        }
    ...
    public void testLinesIntersectIV_CorrectData() {
        ...
        noIntersectingLinesValidatorAll.setDescription("Tests to see if any line geometries " +
                "cross!");
