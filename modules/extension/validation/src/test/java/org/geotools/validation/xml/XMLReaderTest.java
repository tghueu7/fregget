...
public class XMLReaderTest extends TestCase {
    ...
    public void testReadTestSuite() {
        try {
            ...
            /*assertTrue("TestSuite Description read",("This test suite checks each road name to 
            see \n"+
            ...
            // multi line so cannot effectively test
            // assertTrue("Test Description read","Checks to see if the road name is in the list 
            // of possible names.".equals(test.getDescription()));
            ...
            // multi line so cannot effectively test
            //assertTrue("Arg. value : "+test.getArgs().get("LUTName"),test.getArgs()
            // .containsValue("RoadNameLUT.xls"));
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.toString());
        }
