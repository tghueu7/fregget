...
public class GazetteerNameValidationOnlineTest extends TestCase {
    ...
    public void XtestValidate() {
        class TestFeature implements SimpleFeature {
            ...
            //	used
            public void setAttribute(String xPath, Object attribute) throws 
        ...
        try {
            gnv.setGazetteer(new URL("http://cgdi-dev.geoconnections" +
                    ".org/cgi-bin/prototypes/cgdigaz/cgdigaz" +
                    ".cgi?version=1.0&request=GetPlacenameGeometry&wildcards=false&geomtype=bbox"));
        } catch (Exception e) {
        }
...
//		}
    ...
    public void testURLConnection() {
        ...
        try {
            URL gazetteerURL = new URL("http://cgdi-dev.geoconnections" +
                    ".org/cgi-bin/prototypes/cgdigaz/cgdigaz" +
                    ".cgi?version=1.0&request=GetPlacenameGeometry&wildcards=false&geomtype=bbox" +
                    "&placename=" + place);
...
//            gazetteerConnection.setConnectTimeout(100);
            ...
            InputStreamReader gazetteerInputStreamReader = new InputStreamReader
                    (gazetteerInputStream);
