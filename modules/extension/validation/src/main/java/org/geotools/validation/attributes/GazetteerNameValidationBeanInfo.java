...
public class GazetteerNameValidationBeanInfo extends DefaultFeatureValidationBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    ...
    try {
      pd[i] =
          createPropertyDescriptor("attributeName", GazetteerNameValidation.class, resourceBundle);
      pd[i].setExpert(false);
      pd[i + 1] =
          createPropertyDescriptor("gazetteer", GazetteerNameValidation.class, resourceBundle);
