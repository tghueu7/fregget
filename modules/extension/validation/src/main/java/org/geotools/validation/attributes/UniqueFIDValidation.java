...
public class UniqueFIDValidation extends DefaultIntegrityValidation {
   ...
   * Override validate.
   *
   * <p>Description ... This is supposed to go off and grab the necesary features from the database
   * using the envelope with the typeNames. But it doesn't yet. It just uses the ones passed in
   * through parameter layers.
   *
