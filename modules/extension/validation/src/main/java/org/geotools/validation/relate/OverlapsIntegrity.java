                ...
                try {
                    while (fr2 != null && fr2.hasNext()) {
                        ...
                        if (!usedIDs.contains(f2.getID())) {
                            ...
                            if (!f1.getID().equals(f2.getID()))    // if they are the same 
                                // feature, move onto the next one
                            {
                                if (g1.overlaps(g2) != expected || g1.contains(g2) != expected) {
                                    ...
                                    results.error(f1, getGeomTypeRefA() + "(" + f1.getID() + ")" 
                                            + " overlapped " + getGeomTypeRefB() + "(" + f2.getID
                                            () + ")");
                                    if (showPrintLines) {
                                        //System.out.println(f1.getDefaultGeometry()
                                        // .getGeometryType()+" "+getGeomTypeRefA()+"("+f1.getID
                                        // ()+")"+" overlapped "+getGeomTypeRefA()+"("+f2.getID()
