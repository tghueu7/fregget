...
public class CrossesIntegrity extends RelationIntegrity {
   ...
   * Geometry.crosses(Geometry) method. The DE-9IM intersection matrix for crosses is T*T****** (for
   * a point and a curve, a point and an area or a line and an area) 0******** (for two curves)
   * <b>Description:</b><br>
   *
   ...
   * the SimpleFeatureSource layers. Tests the results of the method call against the given expected
   ...
   * geometries in the SimpleFeatureSource layer. Tests the results of the method calls against the
   * given expected results. Returns true if the returned results and the expected results are true,
