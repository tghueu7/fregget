...
public class LineLineAbstractValidationBeanInfo extends DefaultIntegrityValidationBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    ...
    try {
      pd[i] =
          createPropertyDescriptor("lineTypeRef", LineLineAbstractValidation.class, resourceBundle);
      pd[i].setExpert(false);
      pd[i + 1] =
          createPropertyDescriptor(
              "restrictedLineTypeRef", LineLineAbstractValidation.class, resourceBundle);
