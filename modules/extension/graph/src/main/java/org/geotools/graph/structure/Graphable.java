...
public interface Graphable {
   ...
   * switch for the component which can be used for graph queries, graph traversals, or user defined
   * purposes.
   *
  ...
  /**
   * Marks the component as being visited/unvisited. The visited flag serves as a binary switch for
   * the component which can be used for graph queries, graph traversals, or user defined purposes.
   *
  ...
  /**
   * Returns the value of the counter for the component. Graph components have a counter associated
