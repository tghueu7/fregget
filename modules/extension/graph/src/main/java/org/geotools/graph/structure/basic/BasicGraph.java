...
public class BasicGraph implements Graph, Serializable {
   ...
   * between the nodes (edges) are already assumed to be formed. Only the references to the node and
  ...
  /**
   * Initializes the nodes in the graph by setting all visited flags to false and all visited counts
   * to zero.
   *
  ...
  /**
   * Initializes the edges in the graph by setting all visited flags to false and all visited counts
   * to zero.
   *
   * @see BasicGraphable#isVisited()
   * @see BasicGraphable#getCount()
