...
public class DelaunayEdge extends BasicEdge {
    ...
    public Triangle getOtherFace(Triangle t) {
        if (faceA.equals(t)) {
            ...
            throw new RuntimeException("DelaunayEdge.getOtherFace must receive as input one of " +
                    "the faces bordering that edge.");
        }
    }
    ...
    public void setOtherFace(Triangle newT, Triangle oldT) {
        if (faceA.equals(oldT)) {
            ...
            throw new RuntimeException("DelaunayEdge.setOtherFace must have either faceA or faceB" +
                    " as the oldT parameter.");
        }
    }

    public double getEuclideanDistance() {
        return ((XYNode) this.getNodeA()).getCoordinate().distance(((XYNode) this.getNodeB())
                .getCoordinate());
    }

    public boolean equals(Object o) {
        return ((o instanceof DelaunayEdge) &&
                ((this.getNodeA().equals(((DelaunayEdge) o).getNodeA()) && (this.getNodeB()
                        .equals(((DelaunayEdge) o).getNodeB()))) ||
                        (this.getNodeA().equals(((DelaunayEdge) o).getNodeB()) && (this.getNodeB
                                ().equals(((DelaunayEdge) o).getNodeA())))));
    }
