...
public interface Graph {
  ...
  /**
   * Signal to indicate that a graph component meets the requirements of a query against a graph and
   * that the query should continue.
   */
  public static final int PASS_AND_CONTINUE = 1;

  /**
   * Signal to indicate that a graph component meets the requirements of a query against a graph and
   * that the query should end.
   */
   ...
   *     Returns MEET_AND_STOP to signal that the node meest the query criteria and the query should
   *     stop.<br>
   ...
   *     should continue.<br>
   *     Returns MEET_AND_STOP to signal that the edge meest the query criteria and the query should
   *     stop.<br>
  ...
  /**
   * Returns all the nodes in the graph of a specified degree. The degree of a node is the number of
   * edges that are adjacent to the node.
   *
