...
public interface GraphBuilder {
  ...
  /**
   * Builds a new node for the graph. This method does not add the new node to the graph, this must
   * be done with the addNode(Node) method.
   *
  ...
  /**
   * Builds a new edge for the graph. This method does not add the new node to the graph, this must
   * be done with the addEdge(Edge) method.
   *
  ...
  /**
   * Returns a clone of the builder. A deep clone copies the underlying graph structure, a non deep
   * clone results in an empty builder
   *
