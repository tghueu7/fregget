...
public class OptDirectedLineGraphGenerator extends OptLineGraphGenerator {
  ...
  /**
   * Adds a line to the graph. Note that this method returns null since actual building of the graph
   * components is delayed until generate() is called.
   *
   * @param obj A LineSegment object.
   * @return null because the actual building of the graph components is delayed until generate() is
   *     called.
   */
