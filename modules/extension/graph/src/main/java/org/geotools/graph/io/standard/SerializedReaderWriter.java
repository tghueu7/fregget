...
public class SerializedReaderWriter extends AbstractReaderWriter implements FileReaderWriter {
  ...
  /**
   * Serializes the graph by writing each edge in the graph to an object output stream. If there any
   * nodes of degree 0 in the graph, then they are appended to the end of the object output stream.
   *
