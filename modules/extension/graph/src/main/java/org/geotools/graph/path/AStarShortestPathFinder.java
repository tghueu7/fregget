...
public class AStarShortestPathFinder implements GraphWalker {
  ...
  /**
   * Returns a path <B>from</B> the target <B>to</B> the source. If the desired path is the opposite
   * (from the source to the target), the <i>reverse</i> or the <i>riterator</i> methods from the
   * <b>Path<b> class can be used.
   *
   * @see Path#riterator()
   * @see Path#reverse()
