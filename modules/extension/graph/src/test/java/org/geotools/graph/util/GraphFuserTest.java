            ...
            public int visit(Graphable component) {
                ...
                assertTrue(
                        (id.equals("0") || id.equals(String.valueOf(nnodes - 1)))
                                || (id.equals(String.valueOf(cyc)) || id.equals(String.valueOf
                                (cyc + 1)))
                );
                return (0);
            }
            ...
            public int visit(Graphable component) {
                ...
                assertTrue(
                        (id0.equals("0") && id1.equals(String.valueOf(cyc))) ||
                                ...
                                (id0.equals(String.valueOf(cyc)) && id1.equals(String.valueOf(cyc
                                        + 1))) ||
                                (id0.equals(String.valueOf(cyc + 1)) && id1.equals(String.valueOf
                                        (cyc))) ||
                                (id0.equals(String.valueOf(cyc + 1)) && id1.equals(String.valueOf
                                        (nnodes - 1))) ||
                                (id0.equals(String.valueOf(nnodes - 1)) && id1.equals(String
                                        .valueOf(cyc + 1)))
                );
            ...
            public int visit(Graphable component) {
                ...
                assertTrue(
                        (id0.equals("0") && id1.equals(String.valueOf(cyc))) ||
                                ...
                                (id0.equals(String.valueOf(cyc)) && id1.equals(String.valueOf(cyc
                                        + 2))) ||
                                (id0.equals(String.valueOf(cyc + 2)) && id1.equals(String.valueOf
                                        (cyc))) ||
                                (id0.equals(String.valueOf(cyc + 2)) && id1.equals(String.valueOf
                                        (nnodes - 1))) ||
                                (id0.equals(String.valueOf(nnodes - 1)) && id1.equals(String
                ...
                new GraphFuser.EdgeMerger() {
                    public Object merge(List edges) {
                        ...
                        for (Iterator itr = edges.iterator(); itr.hasNext(); ) {
                            ...
                            if (
                                    edge.getNodeA().getDegree() != 2 || edge.getNodeB().getDegree
                                            () != 2
                                    ) ends.add(edge);
                        }
