...
public class GraphTestUtil {
  ...
  /**
   * Builds a graph with no bifurcations made up of a specified number of nodes. Nodes are numbered
   * from 0 to (# of nodes - 1).<br>
   * <br>
   * O----O----O--...--O----O----O
   *
   * @param builder Builder to use to construct graph.
   * @param nnodes Number of nodes in graph.
   * @return 2 element object array containing references to the end points of the graph. (The nodes
   *     of degree 1 at the end of the graph.
   */
