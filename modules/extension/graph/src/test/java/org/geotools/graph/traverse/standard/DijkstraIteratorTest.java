...
public class DijkstraIteratorTest extends TestCase {
   ...
   * <br>
   * Expected: 1. Every node should be visited in order. 2. Every node should have a cost associated
   * with == id 3. Every node should havea parent with id node id + 1
   */
  public void test_0() {
    int nnodes = 100;
   ...
   * <br>
   * Expected: After suspend: 1. Not every node should be visited After resume: 1. Every node should
   * be visited.
   */
  public void test_4() {
    int k = 4;
  ...
  /**
   * Create a balanced binary tree and do a normal traversal starting at root and then kill at right
   * right child of root, then resume <br>
   * <br>
   ...
   * <br>
   * Expected : 1. For nodes with id < (total # of nodes) / 2: a. parent should be node with id - 1
   * b. cost == id 2. For nodes with id > (total # of nodes) / 2; a. parent should be node with id +
   * 1 b. cost == total # of nodes - id
   */
  public void test_6() {
    int nnodes = 100;
