          ...
          new GraphVisitor() {
            public int visit(Graphable component) {
              ...
              if (st.countTokens() == 1) {
                ...
                String parent =
                    ((DirectedEdge) n.getInEdges().get(0)).getInNode().getObject().toString();
                String c0 =
                    ((DirectedEdge) n.getOutEdges().get(0)).getOutNode().getObject().toString();
                String c1 =
                    ((DirectedEdge) n.getOutEdges().get(1)).getOutNode().getObject().toString();
