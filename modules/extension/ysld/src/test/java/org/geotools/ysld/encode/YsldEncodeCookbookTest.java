...
public class YsldEncodeCookbookTest {
    ...
    public void testPointWithStroke() throws Exception {
        ...
        YamlMap mark = style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0)
    ...
    public void testPointWithGraphic() throws Exception {
        ...
        YamlMap eg = style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0)
    ...
    public void testPointWithRotation() throws Exception {
        ...
        YamlMap point = style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0).map("point");
    ...
    public void testPointWithTransparentTriangle() throws Exception {
        ...
        YamlMap mark =
                style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(0)
                        .map("point").seq("symbols").map(0).map("mark");
    ...
    public void testPointWithLabel() throws Exception {
        ...
        YamlMap text =
                style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(1)
                        .map("text");
    ...
    public void testPointWithStyledLabel() throws Exception {
        ...
        assertThat(text, yHasEntry("anchor", yTuple(numEqualTo(0.5, 0.0001), numEqualTo(0.0, 
                0.0001))));
    ...
    public void testLineWithCurvedLabel() throws Exception {
        ...
        YamlMap text = style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(1).map("text");
        assertEquals("${name}", text.str("label"));
        assertThat(text.get("fill-color"), isColor("000000"));
    ...
    public void testLineWithDashedline() throws Exception {
        ...
        YamlMap line = style.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0).map("line");
        assertThat(line.get("stroke-color"), isColor("0000FF"));
        assertEquals(3, line.integer("stroke-width").intValue());
    ...
    public void testPolygonSimple() throws Exception {
        ...
        YamlMap poly = obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0).map("polygon");
    ...
    public void testPolygonWithStyledLabel() throws Exception {
        ...
        assertEquals("point", text.str("placement"));
        assertThat(text, yHasEntry("anchor", yTuple(numEqualTo(0.5, 0.0001), numEqualTo(0.5, 
                0.0001))));
    ...
    public void testRasterWithAlphaChannel() throws Exception {
        ...
        YamlMap raster = obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers")
                .map(0).map("raster");

        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(0, yTuple(fakeString(equalTo("#008000")), lexEqualTo(""), numEqualTo(70)
                        , lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(1, yTuple(fakeString(equalTo("#008000")), numEqualTo(0), numEqualTo(256)
                        , lexEqualTo("")))
        );
    }
    ...
    public void testRasterWithBrightnessAndContrast() throws Exception {
        ...
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(1, yTuple(fakeString(equalTo("#663333")), lexEqualTo(""), numEqualTo
                        (256), lexEqualTo("")))
        );
    }
    ...
    public void testRasterWithDiscreteColors() throws Exception {
        ...
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(0, yTuple(fakeString(equalTo("#008000")), lexEqualTo(""), numEqualTo
                        (150), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(1, yTuple(fakeString(equalTo("#663333")), lexEqualTo(""), numEqualTo
    ...
    public void testRasterWithManyColorGradient() throws Exception {
        ...
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(0, yTuple(fakeString(equalTo("#000000")), lexEqualTo(""), numEqualTo(95)
                        , lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(1, yTuple(fakeString(equalTo("#0000FF")), lexEqualTo(""), numEqualTo
                        (110), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(2, yTuple(fakeString(equalTo("#00FF00")), lexEqualTo(""), numEqualTo
                        (135), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(3, yTuple(fakeString(equalTo("#FF0000")), lexEqualTo(""), numEqualTo
                        (160), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(4, yTuple(fakeString(equalTo("#FF00FF")), lexEqualTo(""), numEqualTo
                        (185), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(5, yTuple(fakeString(equalTo("#FFFF00")), lexEqualTo(""), numEqualTo
                        (210), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(6, yTuple(fakeString(equalTo("#00FFFF")), lexEqualTo(""), numEqualTo
                        (235), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(7, yTuple(fakeString(equalTo("#FFFFFF")), lexEqualTo(""), numEqualTo
                        (256), lexEqualTo("")))
        );
    }
    ...
    public void testRasterWithThreeColorGradient() throws Exception {
        ...
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(0, yTuple(fakeString(equalTo("#0000FF")), lexEqualTo(""), numEqualTo
                        (150), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(1, yTuple(fakeString(equalTo("#FFFF00")), lexEqualTo(""), numEqualTo
                        (200), lexEqualTo("")))
        );
        assertThat(raster.map("color-map").seq("entries"),
                yHasItem(2, yTuple(fakeString(equalTo("#FF0000")), lexEqualTo(""), numEqualTo
                        (250), lexEqualTo("")))
        );
    }
