  ...
  public void testPolygonWithDefaultLabel() throws Exception {
    ...
    YamlMap poly =
        obj.seq("feature-styles")
            ...
            .map("polygon");
    YamlMap text =
        obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(1).map("text");
  ...
  public void testRasterWithAlphaChannel() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            0,
            yTuple(
                fakeString(equalTo("#008000")), lexEqualTo(""), numEqualTo(70), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            1,
            yTuple(
                fakeString(equalTo("#008000")), numEqualTo(0), numEqualTo(256), lexEqualTo(""))));
  }
  ...
  public void testRasterWithBrightnessAndContrast() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            1,
            yTuple(
                fakeString(equalTo("#663333")), lexEqualTo(""), numEqualTo(256), lexEqualTo(""))));
  }
  ...
  public void testRasterWithDiscreteColors() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            0,
            yTuple(
                fakeString(equalTo("#008000")), lexEqualTo(""), numEqualTo(150), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            1,
  ...
  public void testRasterWithManyColorGradient() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            0,
            yTuple(
                fakeString(equalTo("#000000")), lexEqualTo(""), numEqualTo(95), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            1,
            yTuple(
                fakeString(equalTo("#0000FF")), lexEqualTo(""), numEqualTo(110), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            2,
            yTuple(
                fakeString(equalTo("#00FF00")), lexEqualTo(""), numEqualTo(135), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            3,
            yTuple(
                fakeString(equalTo("#FF0000")), lexEqualTo(""), numEqualTo(160), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            4,
            yTuple(
                fakeString(equalTo("#FF00FF")), lexEqualTo(""), numEqualTo(185), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            5,
            yTuple(
                fakeString(equalTo("#FFFF00")), lexEqualTo(""), numEqualTo(210), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            6,
            yTuple(
                fakeString(equalTo("#00FFFF")), lexEqualTo(""), numEqualTo(235), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            7,
            yTuple(
                fakeString(equalTo("#FFFFFF")), lexEqualTo(""), numEqualTo(256), lexEqualTo(""))));
  }
  ...
  public void testRasterWithThreeColorGradient() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            0,
            yTuple(
                fakeString(equalTo("#0000FF")), lexEqualTo(""), numEqualTo(150), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            1,
            yTuple(
                fakeString(equalTo("#FFFF00")), lexEqualTo(""), numEqualTo(200), lexEqualTo(""))));
    assertThat(
        raster.map("color-map").seq("entries"),
        yHasItem(
            2,
            yTuple(
                fakeString(equalTo("#FF0000")), lexEqualTo(""), numEqualTo(250), lexEqualTo(""))));
  }
