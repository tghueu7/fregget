...
public class YsldEncodeTest {
  ...
  public void testRenderingTransformationHeatmap() throws IOException {
    ...
    Function p4 =
        filterFactory.function(
            "parameter", filterFactory.literal("pixelsPerCell"), filterFactory.literal(10));
    Function p5 =
        filterFactory.function(
            "parameter",
  ...
  public void testRenderingTransformationSimplifyWithWMSParams() throws IOException {
    ...
    Function p2 =
        filterFactory.function(
            "parameter", filterFactory.literal("distance"), filterFactory.literal(10.0));
    Function p3 =
        filterFactory.function(
  ...
  public void testRenderingTransformationNested() throws IOException {
    ...
    Function p1_2 =
        filterFactory.function(
            "parameter", filterFactory.literal("valueAttr"), filterFactory.literal("foo"));
  ...
  public void testLabelShield() throws IOException {
    ...
    TextSymbolizer2 text =
        (TextSymbolizer2)
            sf.textSymbolizer(
                null, ff.property("geom"), null, null, ff.property("name"), null, null, null, null);
  ...
  public void testColorMapWithExpression() throws Exception {
    ...
    e2.setColor(filterFactory.literal("#0000EE"));
    e2.setQuantity(
        filterFactory.function("pow", filterFactory.literal(1.2d), filterFactory.literal(2.0d)));
    symb.getColorMap().addColorMapEntry(e1);
    symb.getColorMap().addColorMapEntry(e2);
    StyledLayerDescriptor sld = sld(symb);
  ...
  public void testScale() throws Exception {
    ...
    assertThat(
        ...
        yHasItem(
            0,
            yHasEntry("scale", yTuple(numEqualTo(5_000_000, 0.1), numEqualTo(10_000_000, 0.1)))));
    assertThat(
        result,
        yHasItem(
            1, yHasEntry("scale", yTuple(numEqualTo(2_000_000, 0.1), numEqualTo(5_000_000, 0.1)))));
  }
  ...
  public void testScaleMinMaxKeywords() throws Exception {
    ...
    assertThat(
        result,
        yHasItem(0, yHasEntry("scale", yTuple(numEqualTo(5_000_000, 0.1), equalTo("max")))));
    assertThat(
        result,
        yHasItem(1, yHasEntry("scale", yTuple(equalTo("min"), numEqualTo(5_000_000, 0.1)))));
  }
  ...
  public void testStrokeGraphic() throws Exception {
    ...
    YamlMap obj = new YamlMap(new Yaml().load(out.toString()));
    YamlMap lineMap =
        obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(0).map("line");
  ...
  public void testRGBBandSelectionWithContrast() throws Exception {
    ...
    ((org.geotools.styling.ContrastEnhancement) sel.getRGBChannels()[2].getContrastEnhancement())
  ...
  public void testTextSymbolizerPriority() throws Exception {
    ...
    YamlMap obj = new YamlMap(new Yaml().load(out.toString()));
    YamlMap text =
        obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(0).map("text");
  ...
  public void testSymbolizerVendorOption() throws Exception {
    ...
    YamlMap obj = new YamlMap(new Yaml().load(out.toString()));
    YamlMap result =
        obj.seq("feature-styles").map(0).seq("rules").map(0).seq("symbolizers").map(0).map("point");
