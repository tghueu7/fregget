...
public class YsldValidateTest {
  ...
  public void testFilter() throws Exception {
    ...
    MarkedYAMLException e = errors.get(0);
    // Note this is the start of the expression, a better version would find the error within the
    // CQL
  ...
  public void testAnchorValidateValues() throws Exception {
    ...
    assertThat(
        errors,
        contains(
            hasProperty("problemMark", problemOn(11)), hasProperty("problemMark", problemOn(13))));
  }
  ...
  public void testColourMapEntries() throws Exception {
    ...
    assertThat(
        errors,
        contains(
            hasProperty("problemMark", problemOn(10)), hasProperty("problemMark", problemOn(11))));
  }
