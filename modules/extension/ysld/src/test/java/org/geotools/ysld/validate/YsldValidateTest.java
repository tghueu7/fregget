...
public class YsldValidateTest {
    ...
    public void testExpression() throws Exception {
        ...
        for (String key : EXPRESSION_KEYS) {
            builder.append("      ").append(key).append(": ").append("${round([len] 1000)}")
                    .append("\n"); // Invalid
            builder.append("      ").append(key).append(": ").append("${round([len] / 1000)}")
                    .append("\n"); // Valid
        }
    ...
    public void testExtendedZoomContext() throws Exception {
        ...
        List<MarkedYAMLException> errors = validate(builder.toString(), Collections.singletonList
                (finder));
        assertThat(errors.size(), is(0));
    ...
    public void testColourMapEntries() throws Exception {
        ...
        builder.append("    - [\"${[something]}\", \"${[something]}\", \"${[something]}\", " +
                "null]\n");        // 9 OK
    ...
    List<MarkedYAMLException> validate(String ysld, List<ZoomContextFinder> ctxts) throws 
            IOException {
        //return dump(Ysld.validate(ysld));
