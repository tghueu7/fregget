...
public class RatioZoomContext extends ContinuousZoomContext implements ZoomContext {
    ...
    /**
     * Create a zoom context where zoom level 0 has a scale denominator of {@code initial}, and 
     * each subsequent level is {@code ratio} times that.
     *
     ...
     * @param ratio        ratio between the scale at consecutive zoom levels. Zoom level z+1 has
     *                    a scale ratio times that of z and a scale denominator
