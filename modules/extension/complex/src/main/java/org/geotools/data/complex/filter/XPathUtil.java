...
public class XPathUtil {
  ...
  public static class Step implements Cloneable {
    ...
    /**
     * Creates an xpath step for the given qualified name and index; and the given flag to indicate
     * if it it an "attribute" or "property" step.
     *
     ...
     * @param isXmlAttribute whether the step referers to an "attribute" or a "property" (like for
     ...
     * @param isXmlAttribute whether the step referers to an "attribute" or a "property" (like for
     *     attributes and elements in xml)
     * @param isIndexed whether or not the index is to be shown in the string representation even if
     *     index = 1
     * @throws NullPointerException if <code>name==null</code>
     * @throws IllegalArgumentException if <code>index &lt; 1</code>
     */
  ...
  private static QName deglose(
    ...
    if (prefixIdx == -1) {
      ...
      final String defaultNamespace =
          (isXmlAttribute
                  || localName.equals(
                      ComplexFeatureConstants.FEATURE_CHAINING_LINK_NAME.getLocalPart())
