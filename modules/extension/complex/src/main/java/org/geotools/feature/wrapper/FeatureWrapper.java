    ...
    try {
      ...
      for (Field field : clazz.getFields()) {
        ...
        if (xsdMapping != null) {
          ...
          String namespace =
              xsdMapping.namespace().equals("") ? defaultNamespace : xsdMapping.namespace();
          String separator =
              xsdMapping.separator().equals("") ? defaultSeparator : xsdMapping.separator();
          ...
          if (FeatureWrapper.class.isAssignableFrom(fieldType)) {
            ...
            if (FeatureWrapper.class.isAssignableFrom(collectionType)) {
              ...
              for (Property property : targetAttribute.getProperties(xsdName)) {
                collection.add(
                    wrap((ComplexAttribute) property, (Class<FeatureWrapper>) collectionType));
              }
            } else {
