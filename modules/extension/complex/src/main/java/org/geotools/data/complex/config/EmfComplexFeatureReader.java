 ...
 * </p>
 * <p>
 * Of particular interest might be the {@link ApplicationSchemaConfiguration} object, which 
 * allows to provide the location of the root xsd schema for
 * a given application schema.
 * </p>
 *
 * @author Gabriel Roldan
 * @version $Id$
 * @source $URL$ http://svn.geotools.org/geotools/branches/2.4.x/modules/unsupported/community
 * -schemas /community
...
public class EmfComplexFeatureReader {
    /**
     * The initial resolver has support for only file and classpath resolution. Anything more 
     * than a test should probably set this to something more
     * useful.
     */
    ...
    /**
     * Set resolver based on catalog. Use this for testing only, because it does not support 
     * cached downloads.
     *
     ...
     * {@link Configuration#getSchemaFileURL() schema location} into a
     * {@link SchemaIndex}.
     *
     ...
     * @param location  the physical location of the root xsd schema that comprises the 
     *                  application schema to parse.
     * @throws IOException if any non recoverable problem occurs while parsing the application 
     * schema pointed out by <code>location</code> or one of
     *                     its dependencies.
     */
