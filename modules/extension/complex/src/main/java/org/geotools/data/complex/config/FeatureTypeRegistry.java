...
public class FeatureTypeRegistry {
  ...
  /**
   * stack of currently being built type names, used by {@link #createType(Name, XSDTypeDefinition)}
   * to prevent recursive type definitions by proxy'ing a type that appears to be already being
