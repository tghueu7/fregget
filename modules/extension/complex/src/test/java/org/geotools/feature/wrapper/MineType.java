...
public class MineType extends FeatureWrapper {
    ...
    public ArrayList<MineNamePropertyType> MineNameProperties; // ArrayLists are allowed for 
    // multi-valued types.

    // You can use path to allow a lower-level value to be set in the current class. This might 
    // be useful if you don't want to have
