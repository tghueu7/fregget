...
public abstract class ComplexTestData {
  ...
  /**
   * Creates a representation of a gml:PointPropertyType association as an AttributeType. This would
   * be better done by obtaining the type from a registry, so we can have GML2TypeRegistry,
  ...
  /**
   * Similar to the feature type return by {@link createExample01MultiValuedComplexProperty} except
   * that there is no namespace uri specified.
   *
   * @param typeFactory
   * @return FeatureType
   */
