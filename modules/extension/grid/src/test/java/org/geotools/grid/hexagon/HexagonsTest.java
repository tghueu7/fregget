...
public class HexagonsTest extends HexagonTestBase {
    ...
    public void createGrid() throws Exception {
        final SimpleFeatureType TYPE = DataUtilities.createType("hextype", "hexagon:Polygon," +
                "id:Integer");
        ...
        SimpleFeatureSource gridSource = Hexagons.createGrid(bounds, SIDE_LEN, HexagonOrientation
                .FLAT, setter);
