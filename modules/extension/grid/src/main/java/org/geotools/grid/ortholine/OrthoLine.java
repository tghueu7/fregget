...
public class OrthoLine implements LineElement {
   ...
   */
  public OrthoLine(
      ReferencedEnvelope gridBounds, LineOrientation orientation, double ordinate, int level) {
  ...
  /**
   * {@inheritDoc} Note that this will be a degenerate rectangle with either 0 width, if the line is
   * vertical, or zero height, if horizontal.
   */
