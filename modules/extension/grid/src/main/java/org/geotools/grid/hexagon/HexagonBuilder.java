...
public class HexagonBuilder extends PolygonBuilder {
   ...
   * @throws IllegalArgumentException if either argument is {@code null} or if {@code el} is not an
   *     instance of {@code Hexagon} or if the neighbor position is not valid for the reference
