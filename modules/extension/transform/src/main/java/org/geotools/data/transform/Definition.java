...
public class Definition {
   ...
   * @param name The property name
   * @param source The expression generating the property
   * @param binding The property type. Optional, the store will try to figure out the type from the
   *     expression in case it's missing
   */
   ...
   * corresponding to this computed attribute, if any. Only a small set of expression are invertible
   * in general, and a smaller subset of that can be inverted by this method. Implementor can
   * override this method to provide a custom inversion logic.
   *
   * @return The inverse of this definition, or null if not invertible or if the inversion logic for
   *     the specified case is missing
   */
  ...
  /**
   * Computes the output attribute descriptor for this {@link Definition} given a sample feature of
   * the original feature type. The code will first attempt a static analysis on the original
