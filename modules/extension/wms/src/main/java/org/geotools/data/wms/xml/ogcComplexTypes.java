...
public class ogcComplexTypes {
  ...
  protected static class _Output extends ogcComplexType {
    ...
    private static Element[] elems =
        new Element[] {
          ...
          new ogcElement(
              "Transparent", org.geotools.xml.xsi.XSISimpleTypes.Boolean.getInstance(), null, 0, 1),
          new ogcElement(
              "BGcolor", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance(), null, 0, 1),
  ...
  protected static class _FeatureInfoSize extends ogcComplexType {
    ...
    private static ElementGrouping child =
        new SequenceGT(
            null, new ElementGrouping[] {new ogcElement("FeatureCount", null, null, 1, 1)}, 1, 1);
    ...
    private static Element[] elems =
        new Element[] {
          ...
          new ogcElement(
              ...
              1,
              1),
          new ogcElement("Output", ogcComplexTypes._FeatureInfoOutput.getInstance(), null, 1, 1),
          new ogcElement(
              "Exceptions",
              org.geotools.xml.xsi.XSISimpleTypes.String
                  .getInstance() /* simpleType name is string */,
