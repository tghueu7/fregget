...
public interface GetFeatureInfoRequest extends Request {
  ...
  /**
   * Sets the INFO_FORMAT parameter, which specifies the format of the GetFeatureInfoResponse. Valid
   * values are available in getInfoFormats()
   *
  ...
  /**
   * The point on the image (in pixels) to be queried. The image is represented by the GetMapRequest
