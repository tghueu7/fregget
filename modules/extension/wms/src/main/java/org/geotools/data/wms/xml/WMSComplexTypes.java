        ...
        public Object getValue(Element element, ElementValue[] value,
            ...
            for (int i = 0; i < value.length; i++) {
                ...
                if (sameName(elems[1], value[i])) {
                    ...
                    responsibleParty.setOrganisationName(new SimpleInternationalString
                    (organization));
                }
            }
...
//				}
    ...
    protected static class _UserDefinedSymbolizationType extends WMSComplexType {
        ...
        private static Element[] elems = new Element[]{
                new WMSElement("SupportedSLDVersion", XSISimpleTypes.String.getInstance(), 0, 
                Integer.MAX_VALUE)
        };
    ...
    protected static class _HTTPType extends WMSComplexType {
        ...
        public Object getValue(Element element, ElementValue[] value,
                               Attributes attrs, Map hints) throws SAXException,
                OperationNotSupportedException {
            org.geotools.data.ows.OperationType operationType = new org.geotools.data.ows
            .OperationType();
    ...
    protected static class _WMTException extends WMSComplexType {
        ...
        hints) throws SAXException, OperationNotSupportedException {
    ...
    protected static class _ServiceExceptionReport extends WMSComplexType {
        ...
        private static Element[] elems = new Element[]{
                new WMSElement("ServiceException", _ServiceException.getInstance(), 0, Integer
                .MAX_VALUE)
        };
