...
public class WMSComplexTypes {
  ...
  protected static class _KeywordListType extends WMSComplexType {
    ...
    private static Element[] elems =
        new Element[] {new WMSElement("Keyword", _KeywordType.getInstance(), 0, Integer.MAX_VALUE)};
  ...
  protected static class _CapabilityType extends WMSComplexType {
    ...
    private static Element[] elems =
        new Element[] {
          ...
          new WMSElement(
              "VendorSpecificCapabilities", _VendorSpecificCapabilitiesType.getInstance(), 0, 1),
          new WMSElement(
  ...
  protected static class _UserDefinedSymbolizationType extends WMSComplexType {
    ...
    private static Element[] elems =
        new Element[] {
          new WMSElement(
              "SupportedSLDVersion", XSISimpleTypes.String.getInstance(), 0, Integer.MAX_VALUE)
        };
  ...
  protected static class _GetType extends WMSComplexType {
    ...
    private static Element[] elems =
        new Element[] {new WMSElement("OnlineResource", _OnlineResourceType.getInstance(), 0, 1)};
  ...
  protected static class _ExceptionType extends WMSComplexType {
    ...
    private static Element[] elems =
        new Element[] {new WMSElement("Format", _FormatType.getInstance(), 1, Integer.MAX_VALUE)};
