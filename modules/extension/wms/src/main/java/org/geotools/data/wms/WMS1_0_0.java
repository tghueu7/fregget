 ...
 * <p>
 * WMS1_0_0 provides both name and version information that may be checked against a 
 * GetCapabilities document during
 * version negotiation.
 * </p>
 *
...
public class WMS1_0_0 extends WMSSpecification {
    ...
    static {
        ...
        exceptionMimeTypes.put("INIMAGE", "application/vnd.ogc.se_inimage"); //$NON-NLS-1$ 
        // $NON-NLS-2$
    ...
    static {
        ...
        formatMimeTypes.put("WebCGM", "image/cgm;Version=4;ProfileId=WebCGM"); //$NON-NLS-1$ 
        // $NON-NLS-2$
        ...
        formatMimeTypes.put("INIMAGE", "application/vnd.ogc.se_inimage"); //$NON-NLS-1$ 
        // $NON-NLS-2$
     ...
     * <p>
     * WebMapServer api uses mime type internally for format information (indeed WMS 1.0.0 is the
     * only WMS specifcation
    ...
    static public class GetFeatureInfoRequest extends AbstractGetFeatureInfoRequest {
         ...
         * @param request
         */
        public GetFeatureInfoRequest(URL onlineResource, org.geotools.data.wms.request
     ...
     */
    public DescribeLayerRequest createDescribeLayerRequest(URL onlineResource) throws 
     ...
     */
    public GetLegendGraphicRequest createGetLegendGraphicRequest(URL onlineResource) throws 
            UnsupportedOperationException {
     ...
     */
    public GetStylesRequest createGetStylesRequest(URL onlineResource) throws 
            UnsupportedOperationException {
     ...
     */
    public PutStylesRequest createPutStylesRequest(URL onlineResource) throws 
            UnsupportedOperationException {
