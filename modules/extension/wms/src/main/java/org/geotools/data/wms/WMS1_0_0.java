...
public class WMS1_0_0 extends WMSSpecification {
  ...
  /**
   * The WMS 1.0.0 specification uses a mapping of mimetypes to values to use as parameter values in
   * requests. This will take a parameter value and convert it to its according mime type.
   *
