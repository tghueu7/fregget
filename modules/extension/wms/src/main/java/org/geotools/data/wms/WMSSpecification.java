...
public abstract class WMSSpecification extends Specification {
  ...
  /**
   * Creates a DescribeLayer request which can be used to retrieve information about specific layers
   * on the Web Map Server.
   *
   ...
   * @throws UnsupportedOperationException if the version of the specification doesn't support this
   *     request
   */
