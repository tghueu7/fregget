...
public class WMSSchema implements Schema {
    ...
    static final Element[] elements = new Element[]{
            ...
            new WMSElement("VendorSpecificCapabilities", _VendorSpecificCapabilitiesType
                    .getInstance()),
    ...
    static class WMSAttribute extends AttributeGT {
        ...
        public WMSAttribute(String id, String name, URI namespace, SimpleType type, int use, 
