...
public class WMSSchema_StyleAbstractTest extends TestCase {
    ...
    public void testGetCapabilities() throws Exception {
        ...
        assertEquals("http://www.osgeo.org/sites/all/themes/osgeo/logo.png", 
        ...
        assertEquals(Layer_with_empty_Abstract_in_Style.getName(), 
                "Layer_with_empty_Abstract_in_Style");
        assertEquals(Layer_with_empty_Abstract_in_Style.getTitle(), "Layer with empty Abstract in" +
                " Style");
        assertEquals("http://www.osgeo.org/sites/all/themes/osgeo/logo.png", 
