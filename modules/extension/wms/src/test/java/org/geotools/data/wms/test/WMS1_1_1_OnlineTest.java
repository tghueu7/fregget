...
public class WMS1_1_1_OnlineTest extends WMS1_1_0_OnlineTest {
  ...
  public void testCreateParser() throws Exception {
    try {
      ...
      assertEquals(
          capabilities.getService().getOnlineResource(), new URL("http://terraservice.net/"));
      ...
      assertEquals(
          capabilities.getService().getContactInformation().getIndividualName(), "Some guy");
      assertEquals(
      ...
      assertEquals(
          utmGrid.getAbstract().toString(), "Display grid lines in Goldenrod on the DOQ image");
