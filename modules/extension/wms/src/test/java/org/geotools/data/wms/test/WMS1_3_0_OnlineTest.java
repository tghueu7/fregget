...
public class WMS1_3_0_OnlineTest extends WMS1_1_1_OnlineTest {
    ...
    public WMS1_3_0_OnlineTest() throws Exception {
        ...
        this.server = new URL("http://www2.demis.nl/mapserver/Request" +
                ".asp?Service=WMS&Version=1.3.0&Request=GetCapabilities");

        //TODO this server has changed - need to update the three commented out tests below - 
        // preferably, find a new server
        this.server2 = new URL("http://demo.cubewerx.com/demo/cubeserv/cubeserv" +
                ".cgi?CONFIG=main&REQUEST=GetCapabilities&VERSION=1.3.0");
    }
    ...
    public void testCreateParser() throws Exception {
        try {
            ...
            assertEquals(capabilities.getRequest().getGetFeatureInfo().getFormats().get(0), 
                    "text/xml");
            ...
            assertEquals(capabilities.getRequest().getGetFeatureInfo().getFormats().get(2), 
                    "text/html");
            assertEquals(capabilities.getRequest().getGetFeatureInfo().getFormats().get(3), 
                    "text/swf");
    ...
    public void testCreateGetFeatureInfoRequest() throws Exception {
        try {
            URL featureURL = new URL("http://demo.cubewerx.com/cipi12/cubeserv/cubeserv" +
                    ".cgi?service=wms&request=getcapabilities");
...
//        http://demo.cubewerx.com/cipi12/cubeserv/cubeserv
// .cgi?INFO_FORMAT=text/html&LAYERS=ETOPO2:Foundation&FORMAT=image/png&HEIGHT=400&J=200&REQUEST
// =GetFeatureInfo&I=200&BBOX=-34.12087,15.503481,1.8462441,
// 35.6043956&WIDTH=400&STYLES=&SRS=EPSG:4326&QUERY_LAYERS=ETOPO2:Foundation&VERSION=1.3.0
...
//        http://demo.cubewerx.com/demo/cubeserv/cubeserv
.cgi?CONFIG=main&REQUEST=DescribeLayer&SERVICE=wms&VERSION=1.3.0&LAYERS=BARRIERL_1M:Foundation,
POLBNDP_1M:Foundation,DQLINE_UTIL_1M:Foundation
            request.setLayers("BARRIERL_1M:Foundation,POLBNDP_1M:Foundation,
            DQLINE_UTIL_1M:Foundation");
            System.out.println(request.getFinalURL());
            ...
            assertEquals(layerDescs[0].getWfs(), new URL("http://demo.cubewerx
            .com/demo/cubeserv/cubeserv.cgi?CONFIG=main&SERVICE=WFS&DATASTORE=Foundation&"));
            assertEquals(layerDescs[1].getWfs(), new URL("http://demo.cubewerx
            .com/demo/cubeserv/cubeserv.cgi?CONFIG=main&SERVICE=WFS&DATASTORE=Foundation&"));
            assertEquals(layerDescs[2].getWfs(), new URL("http://demo.cubewerx
            .com/demo/cubeserv/cubeserv.cgi?CONFIG=main&SERVICE=WFS&DATASTORE=Foundation&"));
    ...
    public void testCreateGetLegendGraphicRequest() throws Exception {
        /*try{
            ...
            GetLegendGraphicResponse response = (GetLegendGraphicResponse) wms.issueRequest
            (request);
            assertNotNull(response);
...
//		http://demo.cubewerx.com/cipi12/cubeserv/cubeserv
// .cgi?LAYERS=BARRIERL_1M%3AFoundation%2CBNDTXT_1M%3AFoundation&
...
//		WIDTH=577&STYLES=%2C&SRS=EPSG%3A4269&VERSION=1.1.1
       /* try{
            ...
            request.setBBox("9.543194770812995,2.9407237508305797,119.99700164794902,
            59.50530305123241");
    ...
    protected WebMapServer getCustomWMS(URL featureURL) throws SAXException, URISyntaxException, 
            IOException {
