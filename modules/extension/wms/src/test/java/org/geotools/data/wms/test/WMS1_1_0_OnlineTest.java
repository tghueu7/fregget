...
public class WMS1_1_0_OnlineTest extends WMS1_0_0_OnlineTest {
    ...
    public WMS1_1_0_OnlineTest() throws Exception {
        server = new URL("http://www2.dmsolutions" +
...
/* TODO FIX
        try{
            ...
            assertEquals(layerDescs[1].getWfs(), new URL("http://dev1.dmsolutions
            .ca/cgi-bin/mswfs_gmap?"));
            assertEquals(layerDescs[4].getWfs(), new URL("http://dev1.dmsolutions
            .ca/cgi-bin/mswfs_gmap?"));
    ...
    public void testCreateParser() throws Exception {
        ...
        try {
            ...
            assertEquals(capabilities.getRequest().getGetMap().getGet(), new URL
                    ("http://dev1.dmsolutions.ca/cgi-bin/mswms_gmap?"));
            assertEquals(capabilities.getRequest().getGetMap().getPost(), new URL
                    ("http://dev1.dmsolutions.ca/cgi-bin/mswms_gmap?"));
