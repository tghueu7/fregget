 ...
 *     &lt;/EX_GeographicBoundingBox&gt;
 *     &lt;BoundingBox CRS="CRS:84" minx="-130.85168" miny="20.7052" maxx="-62.0054" 
 *     maxy="54.1141"/&gt;
 *     &lt;BoundingBox CRS="EPSG:4326" minx="20.7052" miny="-130.85168" maxx="54.1141" 
 *     maxy="-62.0054"/&gt;
 *     &lt;Style&gt;
 *     &lt;Name&gt;raster&lt;/Name&gt;
 ...
 *         &format=image%2Fpng&width=20&height=20&layer=Img_Sample"/&gt;
 *     &lt;/LegendURL&gt;
 *     &lt;/Style&gt;
 * &lt;/Layer&gt;
 * </code>
...
public class LocalGeoServerOnlineTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        //System.out.println("CRS configured to forceXY"+System.getProperty("org.geotools
        // .referencing.forceXY"));
    ...
    public void testGetStyle() throws Exception {
        ...
        if (contentType.getParameter("charset") != null)
            stream = new InputStreamReader(wmsResponse.getInputStream(), contentType.getParameter
                    ("charset"));
        else
