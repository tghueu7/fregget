...
public class AttributeMapping implements Serializable {
     ...
     *
     * @param targetAttributeSchemaElement name of the target element instance in the output 
     *                                     schema. Could be prefixed,
     *                                     in which case the prefix mapping has to be available 
