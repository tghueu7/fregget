...
public class AttributeMapping implements Serializable {
  ...
  /**
   * Name of the target element instance this attribute mapping applies to, or <code>null</code> if
   * its fully addressable by the FeatureType.
   *
   * <p>for example, the target FeatureType may define a property as GeometryAttributeType, but the
   * actual instance should be PointPropertyType.
   */
  private String targetAttributeSchemaElement;

  /**
   * If <code>true</code>, indicates that one instance of this attribute mapping must be created for
   * every repeating group of attributes. In other words, indicates whether this attribute
   * corresponds to a multivalued or a single valued attribute.
   */
  private boolean isMultiple;

  /**
   * If <code>true</code>, indicates that one this attribute should be encode if it contains null or
   * empty value.
   */
   ...
   * similar to isMultiple, except the values are concatenated as a big String inside the attribute.
   */
  ...
  /**
   * Set the input XPath expression where we are getting the features from a data access instead of
   * a data store.
   *
   ...
   *
   * @return <code>true</code> if this attribute corresponds to a multivalued property, <code>false
   *     </code> otherwise.
   */
   ...
   *
   * @param isList <code>true</code> if this attribute corresponds to a list valued property, <code>
   ...
   *
   * @return <code>true</code> if this attribute corresponds to a list valued property, <code>false
   *     </code> otherwise.
   */
