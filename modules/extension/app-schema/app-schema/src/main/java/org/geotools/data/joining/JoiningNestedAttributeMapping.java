...
public class JoiningNestedAttributeMapping extends NestedAttributeMapping {
  ...
  /**
   * Open an instance (cursor) for a specific caller. An instance holds a cursor and any additional
   * information to move through the features.
   *
   * @param caller
  ...
  /**
   * If we have decided not to build the parent feature, we need to skip all rows that were returned
   * to build it
   *
   * @param caller
   * @param foreignKeyValue
