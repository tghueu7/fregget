...
public class XMLConfigDigester {
  ...
  private static final Logger LOGGER =
      org.geotools.util.logging.Logging.getLogger(XMLConfigDigester.class.getPackage().getName());
  ...
  private void setSourceDataStoresRules(Digester digester) {
    ...
    digester.addObjectCreate(
        dataStores + "/DataStore/parameters", XMLConfigDigester.CONFIG_NS_URI, HashMap.class);
