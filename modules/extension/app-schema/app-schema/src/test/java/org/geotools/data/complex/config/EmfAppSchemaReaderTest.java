...
public class EmfAppSchemaReaderTest extends AppSchemaTestSupport {
    ...
    public void testParseSimpleFeatureType() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(type.getUserData().get(XSDTypeDefinition.class) instanceof 
    ...
    private void assertSimpleAttribute(AttributeDescriptor descriptor, Name name, Name typeName,
        ...
        Assert.assertTrue(descriptor.getUserData().get(XSDElementDeclaration.class) instanceof 
    ...
    public void testComplexFeatureType() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(8, ((ComplexFeatureTypeImpl) wq_plus_Type).getTypeDescriptors()
                    .size());
            ...
            Assert.assertTrue(wqPlusDescriptor.getUserData().get(XSDElementDeclaration.class) 
            ...
            Assert.assertTrue(descriptor.getUserData().get(XSDElementDeclaration.class) 
                    instanceof XSDElementDeclaration);
    ...
    public void findGml31Configuration() {
        ...
        Configuration gmlConfiguration = GmlFeatureTypeRegistryConfiguration.findGmlConfiguration
                (configuration);
    ...
    public void findGml32Configuration() {
        AppSchemaConfiguration configuration = new AppSchemaConfiguration(
                ...
                "https://www.seegrid.csiro" +
                        ".au/subversion/GeoSciML/branches/3.0.0_rc1_gml3.2/geosciml-core/3.0.0" +
                        "/xsd/geosciml-core.xsd",
                new SchemaResolver());
        Configuration gmlConfiguration = GmlFeatureTypeRegistryConfiguration.findGmlConfiguration
                (configuration);
        Assert.assertNotNull(gmlConfiguration);
