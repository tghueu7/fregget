...
public class InterpolationPropertiesTest extends AppSchemaTestSupport {
  ...
  public void setUp() throws Exception {
    ...
    System.setProperty(
        ...
        URLs.urlToFile(
                InterpolationProperties.class.getResource("/" + IDENTIFIER + ".file.properties"))
            .getPath());
  }

  /**
   * Test for {@link PropertyInterpolationUtils#interpolate(Properties, String)} that properties are
   * interpolated as expected. Note that this test includes multiple lines, and also opportunity for
   * excessive regex greed, which must be avoided.
   */
  @Test
  ...
  /**
   * Test for {@link PropertyInterpolationUtils#interpolate(Properties, String)} that interpolating
   * a nonexistent property is an error.
   */
  @Test
