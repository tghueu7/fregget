    ...
    public void testPolymorphism() throws Exception {
        ...
        try {
            ...
            AttributeExpressionImpl ex = new AttributeExpressionImpl
                    ("gsml:specification/gsml:GeologicUnit/gsml:preferredAge/gsml:GeologicEvent" +
                            "/gsml:eventAge/gsml:CGI_TermRange/gsml:upper/gsml:CGI_TermValue/gsml" +
                            ":value",
            ...
            ex = new AttributeExpressionImpl
                    ("gsml:specification/gsml:GeologicUnit/gsml:composition/gsml:CompositionPart" +
