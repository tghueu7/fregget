...
public class AppSchemaValidatorTest {
  ...
  public void validateErMineralOccurrenceWithErrors() {
    try {
      ...
      Assert.assertTrue(
          e.getMessage(),
          e.getMessage()
              .startsWith("Schema validation failures: 2" + System.getProperty("line.separator")));
    }
  }
   ...
   * reads a classpath resource into a string (using the default platform encoding) before applying
