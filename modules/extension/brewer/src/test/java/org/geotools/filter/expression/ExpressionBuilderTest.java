...
public class ExpressionBuilderTest {
    ...
    public void testFunction() {
        ...
        assertEquals(ff.function("abs", ff.literal(-2)), b.function().name("abs").param().literal
                (-2).build());
        assertEquals(ff.function("abs", ff.literal(-2)), b.function("abs").param().literal(-2)
                .build());
    ...
    public void testNestedFunction() {
        ...
        assertEquals(ff.function("min", ff.function("max", ff.property("a"), ff.property("b")), 
                ff.function("log", ff.property("c"))),
                b.function("min").param().function("max").property("a").property("b").end().param
                        ().function("log").property("c").end().build());

        assertEquals(ff.function("min", ff.function("max", ff.property("a"), ff.property("b")), 
                ff.function("log", ff.property("c"))),
                b.function("min").function("max").property("a").property("b").end().function
                        ("log").property("c").end().build());
    }
