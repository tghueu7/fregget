...
public class WebMercatorZoomLevel extends ZoomLevel {
  ...
  /**
   * The maximum tile-number: For example at zoom-level 2, the tilenames are in the following range:
   * 2/0/0 - 2/3/3 (zoom-level/x/y): zoom-level/2^(zoom-level)-1/2^(zoom-level)-1)
   */
