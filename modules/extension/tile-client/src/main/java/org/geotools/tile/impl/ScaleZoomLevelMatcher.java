...
public class ScaleZoomLevelMatcher {
  ...
  public static ScaleZoomLevelMatcher createMatcher(
      ReferencedEnvelope mapExtentMapCrs, double scale, TileService wmtSource) throws Exception {
   ...
   * center of the map-extent and by taking the mapCrs in account. "Best" scale is the scale where a
   * 256x256 tile has also this size when displayed in uDig.
   *
   * @param zoomLevel
   * @param service
   * @param tempScaleList
