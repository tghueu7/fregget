...
public abstract class TileFactory {
  ...
  /**
   * Finds the tile for a service at the given position and zoom level, which is immediately to the
   * right of the passed tile.
   *
  ...
  /**
   * Some clients, e.g. uDig, may produce numbers like -210° for the longitude, but we need a number
   * in the range -180 to 180, so instead of -210 we want 150.
   *
