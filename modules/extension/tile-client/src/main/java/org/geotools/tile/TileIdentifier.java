 ...
 * row and zoom level. The main responsibility of a
 * TileIdentifier is to translate the grid values (zoom, x, y) into a "code" using an algorithm 
 * which denotes the tile in a given server
 * implementation.
 * </p>
 * <p>
...
public abstract class TileIdentifier {
     ...
     * <p>
     * Most tile services offer zoom level in the range between 0 (whole world) to 22 (street 
     * level). The exact range depends on the service
     * implementation
     * </p>
     *
    ...
    /**
     * Arithmetic implementation of modulo, as the Java implementation of modulo can return 
     * negative values.
     * <p>
     * <pre>
     * arithmeticMod(-1, 8) = 7
     ...
     * </p>
     * <p>
     * The id is a file-friendly name (that is, should contains no special characters such as "
     * .", "/", etc. The id should be build from the code
     * (which also uniquely identifies a tile, but, in some service implementation may contain 
     * file-unfriendly characters (e.g. OpenStreetMap:
     * 5/16/10.png).
     * </p>
     * <p>
     * When building an id, you should use the service name as a prefix (e.g. for OpenStreetMap: 
     * "Mapnik", "CycleMap"; Bing Maps: "Road", "Hybrid";
     ...
     * </p>
     * <p>
     * The id is a string which uniquely identifies a tile. In some service implementations this 
     * is a quadkey (e.g. Bing Maps: "03123") or the
