...
public class KMLParsingTest extends KMLTestSupport {
    ...
    public void testParsePlacemark() throws Exception {
        ...
        assertTrue(placemark.getAttribute("description").toString().startsWith("Attached to the " +
                "ground"));
    ...
    public void testDecodeSchemalessExtendedData() throws Exception {
        ...
        for (SimpleFeature f : features) {
            ...
            // every features from the schemalessExtendedData.kml sample contain at least 1 
