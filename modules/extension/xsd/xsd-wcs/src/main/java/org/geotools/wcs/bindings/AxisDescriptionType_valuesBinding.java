 ...
 *                      &lt;annotation&gt;
 *                          &lt;documentation&gt;Ordered sequence of the parameter value(s) that 
 *                          the server will use for GetCoverage requests which omit a constraint 
 *                          on this parameter axis. (GetCoverage requests against a coverage 
 *                          offering whose AxisDescription has no default must specify a valid 
