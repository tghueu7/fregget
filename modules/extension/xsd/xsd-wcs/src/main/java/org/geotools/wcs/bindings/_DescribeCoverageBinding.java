 ...
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Name or identifier of this coverage. The same name value
 *                  shall not be used for any other coverages available from the same server. A 
 *                  client can obtain this name by a prior GetCapabilities request, or possibly 
 *                  from a third-party source. If this element is omitted, the server may return 
 *                  descriptions of every coverage offering available, or return a service 
