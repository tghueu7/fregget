 ...
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;The coverage offering (identified by its "name") that 
 *                  this request will draw from.&lt;/documentation&gt;
 *              &lt;/annotation&gt;
 *          &lt;/element&gt;
 ...
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Spatial interpolation method to be used in  resampling 
 *                  data from its original form to the requested CRS and/or grid size. Method 
 *                  shall be among those listed for the requested coverage in the 
 *                  DescribeCoverage response.&lt;/documentation&gt;
 *              &lt;/annotation&gt;
 *          &lt;/element&gt;
