 ...
 *      &lt;annotation&gt;
 *          &lt;documentation&gt;XML encoded WCS GetCapabilities operation response. The 
 *          Capabilities document provides clients with service metadata about a specific service
 *          instance, including metadata about the coverages served. &lt;/documentation&gt;
 *      &lt;/annotation&gt;
 *      &lt;sequence&gt;
 ...
 *              server, server shall not return this attribute. &lt;/documentation&gt;
 *          &lt;/annotation&gt;
 *      &lt;/attribute&gt;
 *  &lt;/complexType&gt;
 *
