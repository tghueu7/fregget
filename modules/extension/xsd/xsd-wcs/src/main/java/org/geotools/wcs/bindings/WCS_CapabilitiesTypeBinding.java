 ...
 *      &lt;annotation&gt;
 *          &lt;documentation&gt;Metadata for a WCS server, also known as Capabilities document. 
 *          Reply from a WCS that performed the GetCapabilities operation. &lt;/documentation&gt;
 *      &lt;/annotation&gt;
 *      &lt;sequence&gt;
 ...
 *          &lt;annotation&gt;
 *              &lt;documentation&gt;Service metadata (Capabilities) document version, having 
 *              values that are "increased" whenever any change is made in service metadata 
 *              document. Values are selected by each server, and are always opaque to clients. 
 *              When supported by server, server shall return this attribute. &lt;/documentation&gt;
 *          &lt;/annotation&gt;
 *      &lt;/attribute&gt;
 *  &lt;/complexType&gt;
 *
