 ...
 * &lt;annotation>
 * &lt;documentation>Complex data (such as an image), including a definition of the complex value
 * data structure (i.e., schema, format, and encoding).  May be an ows:Manifest data structure
 * .&lt;/documentation>
 * &lt;/annotation>
