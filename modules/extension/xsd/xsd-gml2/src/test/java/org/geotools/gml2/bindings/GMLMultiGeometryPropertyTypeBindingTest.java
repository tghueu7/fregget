...
public class GMLMultiGeometryPropertyTypeBindingTest extends AbstractGMLBindingTest {
  ...
  protected void setUp() throws Exception {
    ...
    association =
        createElement(GML.NAMESPACE, "myMultiGeometryProperty", GML.GEOMETRYPROPERTYTYPE, null);
    geometry =
        createElement(GML.NAMESPACE, "myGeometryCollection", GML.GEOMETRYCOLLECTIONTYPE, null);
  }
