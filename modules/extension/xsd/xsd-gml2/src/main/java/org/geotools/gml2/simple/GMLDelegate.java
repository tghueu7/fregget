...
public interface GMLDelegate {
  ...
  /**
   * Registers all the geometry encoders for this GML version in a map, by geometry class (different
   * versions support different types of geometries, e.g., GML3 supports also curved ones)
   *
   * @param encoders
   * @param encoder
   */
