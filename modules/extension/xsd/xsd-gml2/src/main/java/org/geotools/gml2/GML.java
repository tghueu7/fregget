...
public final class GML extends XSD {
     ...
     * @deprecated
     */
    public static final QName ABSTRACTFEATURECOLLECTIONBASETYPE = new QName("http://www.opengis" +
            ".net/gml",
     ...
     * @deprecated
     */
    public static final QName ABSTRACTGEOMETRYCOLLECTIONBASETYPE = new QName("http://www.opengis" +
            ".net/gml",
