  ...
  public List AbstractFeatureType_getProperties(
    ...
    if (type == null) {
      if (featureType instanceof SimpleFeatureType) {
        ...
        LOGGER.fine(
            "Could find type for " + typeName + " in the schema, generating type from feature.");
                            ...
                            new Function() {
                              ...
                              public Object apply(Object particle) {
                                XSDElementDeclaration attr =
                                    (XSDElementDeclaration) ((XSDParticle) particle).getContent();
          ...
          if (property instanceof ComplexAttribute) {
            ...
            if (value != null) {
              ...
              CoordinateReferenceSystem crs =
                  ((GeometryAttribute) property).getDescriptor().getCoordinateReferenceSystem();
              Map<Object, Object> userData = new HashMap<Object, Object>();
