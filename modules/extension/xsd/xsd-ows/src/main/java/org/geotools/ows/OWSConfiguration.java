...
public class OWSConfiguration extends Configuration {
    ...
    protected final void registerBindings(MutablePicoContainer container) {
        ...
        container.registerComponentInstance(OWS.WGS84BoundingBoxType, new 
                WGS84BoundingBoxTypeBinding(Ows10Factory.eINSTANCE, OWS.WGS84BoundingBoxType));
        container.registerComponentInstance(OWS.BoundingBoxType, new BoundingBoxTypeBinding
                (Ows10Factory.eINSTANCE, OWS.BoundingBoxType));
        container.registerComponentImplementation(OWS.CapabilitiesBaseType,
                CapabilitiesBaseTypeBinding.class);
        container.registerComponentInstance(OWS.CodeType, new SimpleContentComplexEMFBinding
                (Ows10Factory.eINSTANCE, OWS.CodeType));
        container.registerComponentImplementation(OWS.ContactType, ContactTypeBinding.class);
        container.registerComponentImplementation(OWS.DescriptionType, DescriptionTypeBinding
                .class);
        ...
        container.registerComponentInstance(OWS.KeywordsType, new ComplexEMFBinding(Ows10Factory
                .eINSTANCE, OWS.KeywordsType));
