...
public class OWSConfiguration extends Configuration {
  ...
  protected void registerBindings(Map bindings) {
    ...
    bindings.put(
        OWS.CodeType, new SimpleContentComplexEMFBinding(Ows11Factory.eINSTANCE, OWS.CodeType));
    ...
    bindings.put(
        OWS.ExceptionType, new ComplexEMFBinding(Ows11Factory.eINSTANCE, OWS.ExceptionType));
    ...
    bindings.put(
        OWS.TelephoneType, new ComplexEMFBinding(Ows11Factory.eINSTANCE, OWS.TelephoneType));
    ...
    bindings.put(
        OWS._ExceptionReport, new ComplexEMFBinding(Ows11Factory.eINSTANCE, OWS._ExceptionReport));
    ...
    bindings.put(
        OWS._ServiceProvider, new ComplexEMFBinding(Ows11Factory.eINSTANCE, OWS._ServiceProvider));

    bindings.put(OWS.UOM, new UnitBinding());
    bindings.put(
        OWS.ValueType, new SimpleContentComplexEMFBinding(Ows11Factory.eINSTANCE, OWS.ValueType));
