 ...
 *          parameter, surrounding all the associated data. This box is specialized for use with 
 *          the 2D WGS 84 coordinate reference system with decimal values of longitude and 
 *          latitude. &lt;/documentation&gt;
 *          &lt;documentation&gt;This type is adapted from the general BoundingBoxType, with 
 *          modified contents and documentation for use with the 2D WGS 84 coordinate reference 
 ...
 *                          values of longitude and latitude normally are the algebraic minimums 
 *                          within this bounding box. For more information, see Subclauses 10.4.5
 *                          and C.13. &lt;/documentation&gt;
 *                      &lt;/annotation&gt;
 *                  &lt;/element&gt;
 ...
 *                      useful. When included, this attribute shall reference the 2D WGS 84 
 *                      coordinate reference system with longitude before latitude and decimal 
 ...
 *                      a coordinate sequence in this use of the PositionType). This number is 
 *                      specified by the CRS definition, but can also be specified here. &lt;
 *                      /documentation&gt;
 *                  &lt;/annotation&gt;
 *              &lt;/attribute&gt;
 *          &lt;/restriction&gt;
