 ...
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Metadata for unordered list of all the (requests for) 
 *                  operations that this server interface implements. The list of required and 
 *                  optional operations implemented shall be specified in the Implementation 
 ...
 *          type="ows:DomainType"&gt;
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Optional unordered list of parameter valid domains that 
 *                  each apply to one or more operations which this server interface implements. 
 ...
 *                  non-parameter quantities that each apply to this server. The list of required
 *                  and optional constraints shall be specified in the Implementation 
 *                  Specification for this service. &lt;/documentation&gt;
 *              &lt;/annotation&gt;
 *          &lt;/element&gt;
