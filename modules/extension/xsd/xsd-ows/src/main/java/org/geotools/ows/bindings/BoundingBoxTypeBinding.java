 ...
 *          &lt;documentation&gt;This type is adapted from the EnvelopeType of GML 3.1, with 
 *          modified contents and documentation for encoding a MINIMUM size box SURROUNDING all 
 *          associated data. &lt;/documentation&gt;
 *      &lt;/annotation&gt;
 *      &lt;sequence&gt;
 *          &lt;element name="LowerCorner" type="ows:PositionType"&gt;
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Position of the bounding box corner at which the value 
 *                  of each coordinate normally is the algebraic minimum within this bounding box
 ...
 *                  10.2.5 and C.13. &lt;/documentation&gt;
 *              &lt;/annotation&gt;
 *          &lt;/element&gt;
 *          &lt;element name="UpperCorner" type="ows:PositionType"&gt;
 *              &lt;annotation&gt;
 *                  &lt;documentation&gt;Position of the bounding box corner at which the value 
 *                  of each coordinate normally is the algebraic maximum within this bounding box
 *                  . In some cases, this position is normally displayed at the bottom, such as 
 *                  the bottom right for some image coordinates. For more information, see 
 *                  Subclauses 10.2.5 and C.13. &lt;/documentation&gt;
 *              &lt;/annotation&gt;
 *          &lt;/element&gt;
 *      &lt;/sequence&gt;
 *      &lt;attribute name="crs" type="anyURI" use="optional"&gt;
 *          &lt;annotation&gt;
 *              &lt;documentation&gt;Usually references the definition of a CRS, as specified in 
 *              [OGC Topic 2]. Such a CRS definition can be XML encoded using the 
 *              gml:CoordinateReferenceSystemType in [GML 3.1]. For well known references, it is 
 *              not required that a CRS definition exist at the location the URI points to. If no
 ...
 *  the bounding box type. &lt;/documentation&gt;
 *          &lt;/annotation&gt;
 *      &lt;/attribute&gt;
 ...
 *              coordinate sequence in this use of the PositionType). This number is specified by
 *              the CRS definition, but can also be specified here. &lt;/documentation&gt;
 *          &lt;/annotation&gt;
 *      &lt;/attribute&gt;
 *  &lt;/complexType&gt;
 *
