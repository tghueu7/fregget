...
public class OperationsMetadataBindingTest extends OWSTestSupport {
    ...
    public void testParse() throws Exception {
        String xml = " <ows:OperationsMetadata xmlns:ows=\"http://www.opengis.net/ows\" " +
                "xmlns:xlink=\"http://www.w3.org/1999/xlink\">" +
                "  <ows:Operation name=\"GetCapabilities\">" +
                "   <ows:DCP>" +
                "    <ows:HTTP>" +
                "     <ows:Get xlink:href=\"http://arcgisserver:8399/arcgis/services/wijken" +
                "/MapServer/WFSServer?\" />" +
                "     <ows:Post xlink:href=\"http://arcgisserver:8399/arcgis/services/wijken" +
                "/MapServer/WFSServer\" />" +
                "    </ows:HTTP>" +
                "   </ows:DCP>" +
