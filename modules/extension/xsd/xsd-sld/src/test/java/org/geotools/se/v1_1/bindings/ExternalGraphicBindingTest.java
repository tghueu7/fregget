...
public class ExternalGraphicBindingTest extends SETestSupport {
    public void testOnlineResource() throws Exception {
        ...
        r.setAttributeNS(XLINK.NAMESPACE, "href", SETestSupport.class.getResource
                ("inlineContent-image.png").toString());
        ...
        assertEquals(SETestSupport.class.getResource("inlineContent-image.png"), externalGraphic
                .getLocation());
    ...
    public void testInlineContent() throws Exception {
        ...
        assertEquals("image/png", externalGraphic.getFormat());
        assertImagesEqual(getReferenceImage("inlineContent-image.png"), externalGraphic
                .getInlineContent());
