...
public class SEMockData {
    ...
    static Element stringPosition(Document document, Node parent) {
        ...
        element(SE.StringValue, document, strPosition).appendChild(document.createTextNode
                ("hello"));
    ...
    static Element stringLength(Document document, Node parent) {
        ...
        element(SE.StringValue, document, stringLength).appendChild(document.createTextNode
                ("hello"));
