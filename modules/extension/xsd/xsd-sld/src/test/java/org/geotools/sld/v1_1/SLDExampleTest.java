...
public class SLDExampleTest extends TestCase {
                        ...
                        <UserStyle>
                                ...
                                <se:FeatureTypeStyle>
                                        ...
                                        <se:Rule>
                                                ...
                                                <se:PolygonSymbolizer uom="http://www.opengis
                                                .net/sld/units/pixel">
                                                        <se:Name>MySymbol</se:Name>
                                                        <se:Description>
                                                                <se:Title>Example Symbol</se:Title>
                                                                <se:Abstract>This is just a 
                                                                simple example.</se:Abstract>
                                                        </se:Description>
                                                        <se:Geometry>
                                                        ...
                                                        <se:Fill>
                                                                <se:SvgParameter 
                                                                name="fill">#96C3F5</se:SvgParameter>
                                                        </se:Fill>
    ...
    public void testParseGraphicFill() throws Exception {
        ...
        PolygonSymbolizer ps = (PolygonSymbolizer) layer.getStyles()[0].featureTypeStyles().get
        ...
        assertEquals(new URI("http://maps.google.com/mapfiles/kml/pal2/icon4.png"), eg
    ...
    public void testParseSldWithExternalEntities() throws Exception {
        ...
        try {
            ...
            fail("parsing should fail with a FileNotFoundException because the parser try to " +
        ...
        try {
            InputStream location = getClass().getResourceAsStream(file);
            parser.parse(location);
            fail("parsing should fail with a MalformedURLException because the EntityResolver " +
                    "blocked entity resolution");
