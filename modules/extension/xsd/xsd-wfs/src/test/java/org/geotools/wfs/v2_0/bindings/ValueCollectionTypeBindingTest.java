...
public class ValueCollectionTypeBindingTest extends WFSTestSupport {
    ...
    public void testEncode() throws Exception {
        ...
        PropertyValueCollection valueCollection = new PropertyValueCollection(features, 
                featureType.getDescriptor("geom"), filterFac.property("geom"));
        ...
        vc = Wfs20Factory.eINSTANCE.createValueCollectionType();
        vc.getMember().add(new PropertyValueCollection(features, featureType.getDescriptor
                ("date"), filterFac.property("date")));
