...
public class TransactionTypeBindingTest extends WFSTestSupport {
    ...
    public void testParseInsert() throws Exception {
        String xml =
                "<wfs:Transaction " +
                        ...
                        "          <gml:exterior> " +
                        "            <gml:LinearRing> " +
                        "              <gml:posList>-30.93597221374512 117.6290588378906 " +
                        "-30.94830513000489 117.6447219848633 -30.95219421386719 " +
                        "117.6465530395508 -30.95219421386719 117.6431121826172 " +
                        "-30.94802856445312 117.6386108398438 -30.94799995422363 " +
                        "117.6314163208008 -30.946138381958 117.62850189209 -30.94430541992188 " +
                        "117.6295852661133 -30.93280601501464 117.6240539550781 " +
                        "-30.92869377136231 117.624641418457 -30.92386054992676 117.6201400756836" +
                        " -30.92111206054688 117.6206970214844 -30.92458343505859 " +
                        "117.6275863647461 -30.93597221374512 117.6290588378906</gml:posList> " +
                        " " +
                        "            </gml:LinearRing> " +
                        "          </gml:exterior> " +
                        "        </gml:Polygon> " +
                        ...
                        "            <gml:LinearRing> " +
                        " " +
                        "               <gml:posList>-30.92013931274414 117.6552810668945 " +
                        "-30.92383384704589 117.661361694336 -30.93005561828613 117.6666412353516" +
    ...
    public void testEncode() throws Exception {
        ...
        XMLAssert.assertXpathEvaluatesTo("myid", "//wfs:Update//fes:Filter/fes:ResourceId/@rid", 
                doc);
        XMLAssert.assertXpathExists("//wfs:Delete//fes:Filter/fes:ResourceId", doc);
        XMLAssert.assertXpathEvaluatesTo("myid2", "//wfs:Delete//fes:Filter/fes:ResourceId/@rid",
                doc);
