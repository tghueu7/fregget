...
public class GetFeatureTypeBindingTest extends WFSTestSupport {
    ...
    public void testParse1() throws Exception {
        ...
        assertEquals(
                new QName("http://www.someserver.com/myns", "InWaterA_1M"), q.getTypeNames().get
                        (0));
    ...
    public void testParse2() throws Exception {
        ...
        assertEquals(new QName("http://www.someserver.com/myns", "wkbGeom"), q.getPropertyNames()
                .get(0));
        assertEquals(new QName("http://www.someserver.com/myns", "tileId"), q.getPropertyNames()
                .get(1));
        assertEquals(new QName("http://www.someserver.com/myns", "facId"), q.getPropertyNames()
                .get(2));
    }
