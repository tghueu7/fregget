...
public class StoredQueryDescriptionTypeBindingTest extends WFSTestSupport {
    ...
    public void testParse() throws Exception {
        String xml =
                "   <wfs:StoredQueryDefinition id='myStoredQuery' xmlns:wfs='http://www.opengis" +
                        ".net/wfs/2.0' " +
                        "       xmlns:fes='http://www.opengis.net/fes/2.0' xmlns:gml='http://www" +
                        ".opengis.net/gml/3.2'>" +
        ...
        StoredQueryDescriptionType sqd = (StoredQueryDescriptionType) parse(WFS
    ...
    public void testEncode() throws Exception {
        ...
        qet.setReturnFeatureTypes(Arrays.asList(new QName("http://www.someserver.com/myns", 
                "Parks")));
        qet.setValue(xml);
