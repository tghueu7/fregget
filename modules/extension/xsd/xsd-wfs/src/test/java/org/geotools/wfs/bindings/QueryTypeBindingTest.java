...
public class QueryTypeBindingTest extends WFSTestSupport {
  ...
  public void testParse() throws Exception {
    ...
    assertTrue(
        (parsed == null) ? "null" : parsed.getClass().toString(), parsed instanceof QueryType);
   ...
   * test-data/QueryTypeBinding.xml</code> in the <code>org.geotools.wfs.bindings</code> package of
   * the test resources.
   *
   * @return
   */
