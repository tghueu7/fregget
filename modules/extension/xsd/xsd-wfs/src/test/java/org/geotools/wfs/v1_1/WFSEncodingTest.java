...
public class WFSEncodingTest {
    ...
    public void encodeUpdate() throws IOException, SAXException, TransformerException, 
        ...
        XMLAssert.assertXpathEvaluatesTo("mn:myproperty", "//wfs:Update/wfs:Property/wfs:Name", 
                doc);
        XMLAssert.assertXpathEvaluatesTo("myvalue", "//wfs:Update/wfs:Property/wfs:Value", doc);
        XMLAssert.assertXpathEvaluatesTo("someid", "//wfs:Update/ogc:Filter/ogc:FeatureId/@fid", 
                doc);
        ...
        //System.out.println(encoder.encodeAsString(update, WFS.Update));
        doc = encoder.encodeAsDOM(update, WFS.Update);
        XMLAssert.assertXpathEvaluatesTo("5.2", 
                "//wfs:Update/wfs:Property/wfs:Value/gml:Point/gml:coord/gml:X", doc);
        XMLAssert.assertXpathEvaluatesTo("7.5", 
                "//wfs:Update/wfs:Property/wfs:Value/gml:Point/gml:coord/gml:Y", doc);
    ...
    public void encodeInsert() throws IOException, SAXException, TransformerException, 
        ...
        AttributeDescriptor ad = ftf.createAttributeDescriptor(XSSchema.STRING_TYPE, new NameImpl
                ("dummyAttribute"), 0, 1, true, null);
        SimpleFeatureType ft = ftf.createSimpleFeatureType(new NameImpl("dummyFeatureType"), 
                Collections.singletonList(ad), null, false, null, null, null);
        ...
        XMLAssert.assertXpathEvaluatesTo("dummyId", "//wfs:Insert/wfs:dummyFeatureType/@gml:id", 
                doc);
        XMLAssert.assertXpathEvaluatesTo("dummyValue", 
                "//wfs:Insert/wfs:dummyFeatureType/wfs:dummyAttribute", doc);
    ...
    public void encodeDelete() throws IOException, SAXException, TransformerException, 
        ...
        XMLAssert.assertXpathEvaluatesTo("someid", "//wfs:Delete/ogc:Filter/ogc:FeatureId/@fid", 
                doc);
