 ...
 *              &lt;xsd:sequence&gt;
 *                  &lt;xsd:element minOccurs="0" name="AdditionalObjects" 
 *                  type="wfs:SimpleValueCollectionType"/&gt;
...
public class FeatureCollectionTypeBinding extends AbstractComplexEMFBinding {
    ...
    public FeatureCollectionTypeBinding(Wfs20Factory factory, Configuration configuration,
        ...
        if (configuration != null) {
            this.generateBounds = !configuration.getProperties().contains(GMLConfiguration
                    .NO_FEATURE_BOUNDS);
        }
    }
