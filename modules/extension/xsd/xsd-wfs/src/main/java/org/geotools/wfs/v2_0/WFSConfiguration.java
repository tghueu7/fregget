...
public class WFSConfiguration extends Configuration {
    ...
    protected void registerBindings(Map bindings) {
        ...
        //Types
//        container.registerComponentImplementation(WFS.AbstractTransactionActionType,
// AbstractTransactionActionTypeBinding.class);
...
//        container.registerComponentImplementation(WFS.BaseRequestType,BaseRequestTypeBinding
// .class);
...
//        container.registerComponentImplementation(WFS.ExtendedDescriptionType,
// ExtendedDescriptionTypeBinding.class);
...
//        container.registerComponentImplementation(WFS.nonNegativeIntegerOrUnknown,
// NonNegativeIntegerOrUnknownBinding.class);
...
//        container.registerComponentImplementation(WFS.positiveIntegerWithStar,
// PositiveIntegerWithStarBinding.class);
        ...
        bindings.put(WFS.ResolveValueType, new EnumSimpleBinding(ResolveValueType.class, WFS
                .ResolveValueType));
        bindings.put(WFS.ResultTypeType, new EnumSimpleBinding(ResultTypeType.class, WFS
                .ResultTypeType));
        bindings.put(WFS.ReturnFeatureTypesListType, ReturnFeatureTypesListTypeBinding.class);
//        container.registerComponentImplementation(WFS.SimpleFeatureCollectionType,
// SimpleFeatureCollectionTypeBinding.class);
...
//        container.registerComponentImplementation(WFS.StateValueType,StateValueTypeBinding.class);
        ...
        bindings.put(WFS.UpdateActionType, new EnumSimpleBinding(UpdateActionType.class, WFS
                .UpdateActionType));
...
//        container.registerComponentImplementation(WFS._additionalObjects,
// _additionalObjectsBinding.class);
//        container.registerComponentImplementation(WFS._additionalValues,
// _additionalValuesBinding.class);
...
//        container.registerComponentImplementation(WFS._truncatedResponse,
// _truncatedResponseBinding.class);
//        container.registerComponentImplementation(WFS.FeatureTypeType_NoCRS,
// FeatureTypeType_NoCRSBinding.class);
        bindings.put(WFS.PropertyType_ValueReference, ValueReferenceTypeBinding.class);
//        container.registerComponentImplementation(WFS.WFS_CapabilitiesType_WSDL,
// WFS_CapabilitiesType_WSDLBinding.class);

        bindings.put(WFS.ParameterType, ParameterTypeBinding.class);

        bindings.put(WFS.Abstract, new SimpleContentComplexEMFBinding(Wfs20Factory.eINSTANCE, new
                QName(WFS.NAMESPACE, "AbstractType")));
        bindings.put(WFS.DropStoredQuery, new ComplexEMFBinding(Wfs20Factory.eINSTANCE, WFS
                .DropStoredQuery, DropStoredQueryType.class));
        bindings.put(WFS.Title, new SimpleContentComplexEMFBinding(Wfs20Factory.eINSTANCE, new 
                QName(WFS.NAMESPACE, "TitleType")));
