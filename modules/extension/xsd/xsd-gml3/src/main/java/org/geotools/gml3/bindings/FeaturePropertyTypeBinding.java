...
public class FeaturePropertyTypeBinding extends AbstractComplexBinding {
  /**
   * id set in the document, used to check against duplicate gml:id. If an gml:id is already encoded
   * for an featureMember, the next occurrence will be encoded with xlink:href
   */
