...
public class GmlFeatureTypeRegistryConfiguration implements FeatureTypeRegistryConfiguration {
     ...
     * @return
     */
    private static boolean isDerivedFrom(final XSDTypeDefinition typeDefinition, final QName 
            baseTypeName) {
     ...
     * @return
     */
    private static boolean isDerivedFrom(XSDTypeDefinition typeDefinition, final Name 
            superTypeName) {
