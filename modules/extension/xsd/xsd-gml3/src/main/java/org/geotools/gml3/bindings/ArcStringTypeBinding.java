 ...
 *      &lt;annotation&gt;
 *          &lt;documentation&gt;An ArcString is a curve segment that uses three-point circular 
 *          arc interpolation.&lt;/documentation&gt;
 *      &lt;/annotation&gt;
 *      &lt;complexContent&gt;
 ...
 *  curve segment only. The number of direct positions in the list must be at least three.&lt;
 *  /documentation&gt;
 *                      &lt;/annotation&gt;
 ...
 *                  &lt;/choice&gt;
 *              &lt;/sequence&gt;
 *              &lt;attribute fixed="circularArc3Points" name="interpolation" 
 ...
 *  segment. For an ArcString the interpolation is fixed as "circularArc3Points".&lt;
 *  /documentation&gt;
 *                  &lt;/annotation&gt;
 *              &lt;/attribute&gt;
 *              &lt;attribute name="numArc" type="integer" use="optional"&gt;
 *                  &lt;annotation&gt;
 *                      &lt;documentation&gt;The number of arcs in the arc string can be 
 *                      explicitly stated in this attribute. The number of control points in the 
 *                      arc string must be 2 * numArc + 1.&lt;/documentation&gt;
 *                  &lt;/annotation&gt;
 *              &lt;/attribute&gt;
 *          &lt;/extension&gt;
 *      &lt;/complexContent&gt;
...
public class ArcStringTypeBinding extends AbstractComplexBinding implements Comparable {
    ...
    public ArcStringTypeBinding(GeometryFactory gFactory, CoordinateSequenceFactory csFactory, 
                                ArcParameters arcParameters) {
