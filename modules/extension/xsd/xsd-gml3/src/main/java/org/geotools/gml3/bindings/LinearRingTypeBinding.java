 ...
 *      &lt;annotation&gt;
 *          &lt;documentation&gt;A LinearRing is defined by four or more coordinate tuples, with 
 ...
 *  "pos" elements are control points that are only part of this ring, "pointProperty" elements 
 *  contain a point that may be referenced from other geometry elements or reference another 
 *  point defined outside of this ring (reuse of existing points).
 ...
 *  ring only. The number of direct positions in the list must be at least four.&lt;
 *  /documentation&gt;
 *                      &lt;/annotation&gt;
 ...
 *                          &lt;annotation&gt;
 *                              &lt;documentation&gt;Deprecated with GML version 3.0 and included
 *                              for backwards compatibility with GML 2. Use "pos" elements 
