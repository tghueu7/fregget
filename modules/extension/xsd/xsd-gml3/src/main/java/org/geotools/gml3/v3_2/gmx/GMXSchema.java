...
public class GMXSchema extends SchemaImpl {
        ...
        ComplexType builtType = new AbstractLazyComplexTypeImpl(
            ...
            public Collection<PropertyDescriptor> buildDescriptors() {
                ...
                descriptors.add(
                        new AttributeDescriptorImpl(
                                GCOSchema.CHARACTERSTRING_PROPERTYTYPE_TYPE,
                                new NameImpl("http://www.isotc211.org/2005/gmx", 
                                "fieldOfApplication"),
     ...
     *              &lt;xs:sequence&gt;
     *                  &lt;xs:element maxOccurs="unbounded" name="codelistItem" 
            ...
            public Collection<PropertyDescriptor> buildDescriptors() {
                ...
                descriptors.add(
                        new AttributeDescriptorImpl(
                                ...
                                new NameImpl("http://www.opengis.net/gml/3.2", 
     ...
     *          &lt;xs:extension base="gmx:AbstractCT_Catalogue_Type"&gt;
     *              &lt;xs:sequence&gt;
     *                  &lt;xs:element maxOccurs="unbounded" name="crs" 
     *                  type="gmx:CT_CRS_PropertyType"/&gt;
     *                  &lt;xs:element maxOccurs="unbounded" minOccurs="0"
     ...
     *          &lt;xs:extension base="gmx:AbstractCT_Catalogue_Type"&gt;
     *              &lt;xs:sequence&gt;
     *                  &lt;xs:element maxOccurs="unbounded" name="uomItem" 
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;XML attributes contraints: - 1) Id is mandatory - 2) 
     *          codeSpace (type xsd:anyURI) is mandatory&lt;/xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;Constraints: - 1) metadataProperty.card = 0 - 2) 
     *          dictionaryEntry.card = 0&lt;/xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     *          &lt;xs:extension base="gml:DictionaryType"&gt;
     *              &lt;xs:sequence&gt;
     *                  &lt;xs:element maxOccurs="unbounded" name="codeEntry" 
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:UomAlternativeExpression_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:CodeAlternativeExpression_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;Constraint: codeEntry.type = ML_CodeListDefinition&lt;
     *          /xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:ClAlternativeExpression_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:OperationMethodAlt_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:OperationParameterAlt_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
     ...
     *                  &lt;xs:element maxOccurs="unbounded"
     *                      name="alternativeExpression" 
     *                      type="gmx:PrimeMeridianAlt_PropertyType"/&gt;
     *              &lt;/xs:sequence&gt;
     *          &lt;/xs:extension&gt;
     *      &lt;/xs:complexContent&gt;
     *  &lt;/xs:complexType&gt;
