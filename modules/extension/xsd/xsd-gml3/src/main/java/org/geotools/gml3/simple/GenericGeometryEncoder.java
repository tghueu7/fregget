...
public class GenericGeometryEncoder extends GeometryEncoder<Geometry> {
    ...
    @Override
    public void encode(Geometry geometry, AttributesImpl atts, GMLWriter handler, String 
            parentId) throws Exception {
        ...
        if (geometry instanceof LineString) {
            ...
            MultiLineStringEncoder multiLineString = new MultiLineStringEncoder(encoder, 
                    gmlPrefix, gmlUri, true);
