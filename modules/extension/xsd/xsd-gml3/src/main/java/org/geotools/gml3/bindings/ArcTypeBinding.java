 ...
 * &lt;choice>
 * &lt;annotation>
 * &lt;documentation>GML supports two different ways to specify the control points of a curve 
 * segment.
 ...
 * curve segment only. The number of direct positions in the list must be three.&lt;/documentation>
 * &lt;/annotation>
 ...
 * backwards compatibility with GML 3.0.0.&lt;/documentation>
 * &lt;/annotation>
 * &lt;/element>
 * &lt;/choice>
...
public class ArcTypeBinding extends AbstractComplexBinding {
    ...
    public ArcTypeBinding(GeometryFactory gFactory, CoordinateSequenceFactory csFactory, 
                          ArcParameters arcParameters) {
