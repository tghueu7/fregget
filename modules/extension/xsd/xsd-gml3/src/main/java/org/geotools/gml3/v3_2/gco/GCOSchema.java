...
public class GCOSchema extends SchemaImpl {
            ...
            public Collection<PropertyDescriptor> buildDescriptors() {
                ...
                descriptors.add(
                        new AttributeDescriptorImpl(
                                ...
                                new NameImpl("http://www.isotc211.org/2005/gco", 
                                "AbstractGenericName"),
                                1, 1, false, null));
                descriptors.add(
                        new AttributeDescriptorImpl(
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;A MemberName is a LocalName that references either an 
     *          attribute slot in a record or  recordType or an attribute, operation, or 
     *          association role in an object instance or  type description in some form of 
     *          schema. The stored value "aName" is the returned value for the "aName()" 
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;A component of a multiplicity, consisting of an 
     *          non-negative lower bound, and a potentially infinite upper bound.&lt;
     *          /xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     *          &lt;xs:extension base="gco:AbstractObject_Type"&gt;
     ...
     *          Represented by a set of simple multiplicity ranges.&lt;/xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     *          &lt;xs:extension base="gco:AbstractObject_Type"&gt;
     *              &lt;xs:sequence&gt;
     ...
     *      &lt;xs:annotation&gt;
     *          &lt;xs:documentation&gt;A TypeName is a LocalName that references either a 
     *          recordType or object type in some form of schema. The stored value "aName" is the
      *          returned value for the "aName()" operation. This is the types name.  - For 
      *          parsing from types (or objects) the parsible name normally uses a "." navigation
       *          separator, so that it is of the form  [class].[member].[memberOfMember]. ...)
       *          &lt;/xs:documentation&gt;
     *      &lt;/xs:annotation&gt;
     *      &lt;xs:complexContent&gt;
     *          &lt;xs:extension base="gco:AbstractObject_Type"&gt;
