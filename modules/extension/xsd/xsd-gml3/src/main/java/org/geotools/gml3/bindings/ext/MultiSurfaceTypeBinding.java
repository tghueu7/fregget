...
public class MultiSurfaceTypeBinding extends org.geotools.gml3.bindings.MultiSurfaceTypeBinding
  ...
  /**
   * Implement comparable because MultiPolygonBinding, MultiSurfaceBinding and Surface are bound to
   * the same class, MultiPolygon. Since MultiPolygon is deprecated by gml3 and MultiSurface only
   * has children that are also mapped to MultiPolygons, Surface always wins.
   */
