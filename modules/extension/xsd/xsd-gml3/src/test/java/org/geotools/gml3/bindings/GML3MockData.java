...
public class GML3MockData {
    ...
    public static LineString lineStringLite2D() {
        return liteGF.createLineString(new Coordinate[]{new Coordinate(1, 2), new Coordinate(3, 
                4)});
    }
    ...
    public static Element lineStringWithPosList3D(Document document, Node parent, boolean 
            addSrsDimension) {
        Element lineString = element(qName("LineString"), document, parent);
        if (addSrsDimension) {
            lineString.setAttribute("srsDimension", "3");
    ...
    public static Element linearRingWithPos3D(Document document, Node parent, boolean 
            addSrsDimension) {
        Element linearRing = element(qName("LinearRing"), document, parent);
        if (addSrsDimension) {
    ...
    public static Element linearRingWithPosList3D(Document document, Node parent, boolean 
            addSrsDimension) {
        Element linearRing = element(qName("LinearRing"), document, parent);
        if (addSrsDimension) {
            linearRing.setAttribute("srsDimension", "3");
        ...
        linearRing.appendChild(posList);
        posList.appendChild(document.createTextNode("1.0 2.0 10.0 3.0 4.0 20.0 5.0 6.0 30.0 1.0 " +
                "2.0 10.0"));
    ...
    public static Element polygon(Document document, Node parent, QName name, boolean 
            withInterior) {
    ...
    public static Element polygonWithPos3D(Document document, Node parent, QName name, boolean 
            addSrsDimension) {
        Element polygon = element(name, document, parent);
        if (addSrsDimension) {
    ...
    public static Element polygonWithPosList(Document document, Node parent, QName name, boolean 
            withInterior) {
        Element polygon = element(name, document, parent);
    ...
    public static Element polygonWithPosList3D(Document document, Node parent, boolean 
            addSrsDimension) {
