...
public class GeometryCollectionEncoderTest extends GeometryEncoderTestSupport {
    ...
    public void testGeometryCollectionEncoder() throws ParseException, Exception {
        GeometryCollectionEncoder gce = new GeometryCollectionEncoder(gtEncoder, "gml", GML
                .NAMESPACE);
        ...
        assertEquals("feature.1.1", xpath.evaluate
                ("//gml:MultiGeometry/gml:geometryMember[1]/gml:LineString/@gml:id", doc));
        assertEquals("feature.1.2", xpath.evaluate
                ("//gml:MultiGeometry/gml:geometryMember[2]/gml:Point/@gml:id", doc));
        assertEquals("feature.1.3", xpath.evaluate
                ("//gml:MultiGeometry/gml:geometryMember[3]/gml:Point/@gml:id", doc));
    }
}
