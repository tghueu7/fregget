...
public class EnvelopeTypeBindingTest extends GML3TestSupport {
  public void testEncode() throws Exception {
    ...
    assertEquals(
        "urn:x-ogc:def:crs:EPSG:4326", dom.getDocumentElement().getAttributeNS(null, "srsName"));
  }
  ...
  public void testEncodeNull() throws Exception {
    ...
    assertEquals(1, dom.getElementsByTagNameNS(GML.NAMESPACE, GML.Null.getLocalPart()).getLength());
  }
}
