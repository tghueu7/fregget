...
public class MultiPointTest extends GeometryEncoderTestSupport {
  ...
  public void testEncodeMultiPoint() throws Exception {
    ...
    assertEquals(
        "points.1", xpath.evaluate("/gml:MultiPoint/gml:pointMember[1]/gml:Point/@gml:id", doc));
    assertEquals(
        "points.2", xpath.evaluate("/gml:MultiPoint/gml:pointMember[2]/gml:Point/@gml:id", doc));
  }
}
