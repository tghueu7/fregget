...
public class GMLParsingTest extends TestCase {
  ...
  public void testParseOgcHttpUrlSrsname() throws Exception {
    assertEquals(
        CRS.decode("EPSG:4326"), parsePointSrsname("http://www.opengis.net/gml/srs/epsg.xml#4326"));
  }
  ...
  public void testParseOgcHttpUriSrsname() throws Exception {
    assertEquals(
        CRS.decode("EPSG:4326"), parsePointSrsname("http://www.opengis.net/def/crs/EPSG/0/4326"));
  }
