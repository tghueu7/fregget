...
public class FilterTypeBindingTest extends FESTestSupport {
    ...
    public void testParse1() throws Exception {
        String xml =
                "<fes:Filter " +
                        ...
                        "            <gml:exterior> " +
                        "               <gml:LinearRing> " +
                        "                  <gml:posList>10 10 20 20 30 30 40 40 10 " +
                        "10</gml:posList> " +
                        "               </gml:LinearRing> " +
                        "            </gml:exterior> " +
                        "         </gml:Polygon> " +
    ...
    public void testParseGmlWithoutSchemaLocation() throws Exception {
        String xml =
                "<fes:Filter xmlns:gml='http://www.opengis.net/gml/3.2' xmlns:fes='http://www" +
                        ".opengis.net/fes/2.0'> " +
                        " <fes:BBOX> " +
    ...
    public void testParseExtendedOperator() throws Exception {
        ...
        String xml =
                "<fes:Filter " +
                        "xmlns:fes='http://www.opengis.net/fes/2.0' xmlns:myops='http://www" +
                        ".someserver.com/myops/1.0'> " +
                        "  <myops:strMatches> " +
        ...
        assertTrue(ch.get(0) instanceof PropertyIsEqualTo || ch.get(0) instanceof 
                PropertyIsBetween);
        assertTrue(ch.get(1) instanceof PropertyIsEqualTo || ch.get(1) instanceof 
                PropertyIsBetween);
