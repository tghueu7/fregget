...
public class FESConfiguration extends Configuration {
    ...
    protected final void registerBindings(MutablePicoContainer container) {
        //Types
//        container.registerComponentImplementation(FES.AbstractAdhocQueryExpressionType,
// AbstractAdhocQueryExpressionTypeBinding.class);
//        container.registerComponentImplementation(FES.AbstractIdType,AbstractIdTypeBinding.class);
//        container.registerComponentImplementation(FES.AbstractProjectionClauseType,
// AbstractProjectionClauseTypeBinding.class);
//        container.registerComponentImplementation(FES.AbstractQueryExpressionType,
// AbstractQueryExpressionTypeBinding.class);
//        container.registerComponentImplementation(FES.AbstractSelectionClauseType,
// AbstractSelectionClauseTypeBinding.class);
//        container.registerComponentImplementation(FES.AbstractSortingClauseType,
// AbstractSortingClauseTypeBinding.class);
//        container.registerComponentImplementation(FES.AliasesType,AliasesTypeBinding.class);
        ...
        container.registerComponentImplementation(FES.AvailableFunctionsType, 
                AvailableFunctionsTypeBinding.class);
        container.registerComponentImplementation(FES.AvailableFunctionType, 
                AvailableFunctionTypeBinding.class);
        container.registerComponentImplementation(FES.BBOXType, BBOXTypeBinding.class);
        container.registerComponentImplementation(FES.BinaryComparisonOpType, 
                BinaryComparisonOpTypeBinding.class);
        container.registerComponentImplementation(FES.BinaryLogicOpType, BinaryLogicOpTypeBinding
                .class);
        container.registerComponentImplementation(FES.BinarySpatialOpType, 
                BinarySpatialOpTypeBinding.class);
        container.registerComponentImplementation(FES.BinaryTemporalOpType, 
                BinaryTemporalOpTypeBinding.class);
//        container.registerComponentImplementation(FES.ComparisonOperatorNameType,
// ComparisonOperatorNameTypeBinding.class);
        container.registerComponentImplementation(FES.ComparisonOperatorsType, 
                ComparisonOperatorsTypeBinding.class);
        container.registerComponentImplementation(FES.ComparisonOperatorType, 
                ComparisonOperatorTypeBinding.class);
//        container.registerComponentImplementation(FES.ComparisonOpsType,
// ComparisonOpsTypeBinding.class);
        container.registerComponentImplementation(FES.ConformanceType, ConformanceTypeBinding
                .class);
        container.registerComponentImplementation(FES.DistanceBufferType, 
        ...
        container.registerComponentImplementation(FES.GeometryOperandsType, 
                GeometryOperandsTypeBinding.class);
        container.registerComponentImplementation(FES.Id_CapabilitiesType, 
...
//        container.registerComponentImplementation(FES.LowerBoundaryType,
// LowerBoundaryTypeBinding.class);
//        container.registerComponentImplementation(FES.MatchActionType,MatchActionTypeBinding
// .class);

//        container.registerComponentImplementation(FES.PropertyIsNilType,
// PropertyIsNilTypeBinding.class);

        container.registerComponentImplementation(FES.ResourceIdentifierType, 
                ResourceIdentifierTypeBinding.class);
        container.registerComponentImplementation(FES.ResourceIdType, ResourceIdTypeBinding.class);
        container.registerComponentImplementation(FES.Scalar_CapabilitiesType, 
...
//        container.registerComponentImplementation(FES.SchemaElement,SchemaElementBinding.class);
        ...
        container.registerComponentImplementation(FES.SortPropertyType, SortPropertyTypeBinding
                .class);
        container.registerComponentImplementation(FES.Spatial_CapabilitiesType, 
                Spatial_CapabilitiesTypeBinding.class);
//        container.registerComponentImplementation(FES.SpatialOperatorNameType,
// SpatialOperatorNameTypeBinding.class);
        container.registerComponentImplementation(FES.SpatialOperatorsType, 
                SpatialOperatorsTypeBinding.class);
        container.registerComponentImplementation(FES.SpatialOperatorType, 
                SpatialOperatorTypeBinding.class);
//        container.registerComponentImplementation(FES.SpatialOpsType,SpatialOpsTypeBinding.class);
//        container.registerComponentImplementation(FES.Temporal_CapabilitiesType,
// Temporal_CapabilitiesTypeBinding.class);
//        container.registerComponentImplementation(FES.TemporalOperandsType,
// TemporalOperandsTypeBinding.class);
//        container.registerComponentImplementation(FES.TemporalOperatorNameType,
// TemporalOperatorNameTypeBinding.class);
//        container.registerComponentImplementation(FES.TemporalOperatorsType,
// TemporalOperatorsTypeBinding.class);
//        container.registerComponentImplementation(FES.TemporalOperatorType,
// TemporalOperatorTypeBinding.class);
//        container.registerComponentImplementation(FES.TemporalOpsType,TemporalOpsTypeBinding
// .class);
//        container.registerComponentImplementation(FES.TypeNamesListType,
// TypeNamesListTypeBinding.class);
//        container.registerComponentImplementation(FES.TypeNamesType,TypeNamesTypeBinding.class);
//        container.registerComponentImplementation(FES.UnaryLogicOpType,UnaryLogicOpTypeBinding
// .class);
//        container.registerComponentImplementation(FES.UpperBoundaryType,
// UpperBoundaryTypeBinding.class);
//        container.registerComponentImplementation(FES.VersionActionTokens,
// VersionActionTokensBinding.class);
        container.registerComponentImplementation(FES.VersionType, VersionTypeBinding.class);
        container.registerComponentImplementation(FES._Filter_Capabilities, 
                Filter_CapabilitiesTypeBinding.class);
        container.registerComponentImplementation(FES._LogicalOperators, _LogicalOperatorsBinding
                .class);
        container.registerComponentImplementation(FES.GeometryOperandsType_GeometryOperand, 
                GeometryOperandsType_GeometryOperandBinding.class);
//        container.registerComponentImplementation(FES.TemporalOperandsType_TemporalOperand,
// TemporalOperandsType_TemporalOperandBinding.class);
        ...
        //comparison
        container.registerComponentImplementation(FES.PropertyIsEqualTo, PropertyIsEqualToBinding
                .class);
        container.registerComponentImplementation(FES.PropertyIsGreaterThan, 
                PropertyIsGreaterThanBinding.class);
        container.registerComponentImplementation(FES.PropertyIsGreaterThanOrEqualTo, 
                PropertyIsGreaterThanOrEqualToBinding.class);
        container.registerComponentImplementation(FES.PropertyIsLessThan, 
                PropertyIsLessThanBinding.class);
        container.registerComponentImplementation(FES.PropertyIsLessThanOrEqualTo, 
                PropertyIsLessThanOrEqualToBinding.class);
        container.registerComponentImplementation(FES.PropertyIsNotEqualTo, 
                PropertyIsNotEqualToBinding.class);
        container.registerComponentImplementation(FES.PropertyIsBetweenType, 
                PropertyIsBetweenTypeBinding.class);
        container.registerComponentImplementation(FES.PropertyIsLikeType, 
                PropertyIsLikeTypeBinding.class);
        container.registerComponentImplementation(FES.PropertyIsNullType, 
