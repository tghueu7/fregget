...
public class CSWRecordTest {
    ...
    public void testParseBriefRecord() throws Exception {
        BriefRecordType br = (BriefRecordType) parser.parse(getClass().getResourceAsStream
                ("BriefRecord.xml"));
    ...
    public void testParseSummaryRecord() throws Exception {
        SummaryRecordType sr = (SummaryRecordType) parser.parse(getClass().getResourceAsStream
                ("SummaryRecord.xml"));
        ...
        String abs = "IMAGE2000 product 1 individual orthorectified scenes. IMAGE2000 was " +
                "produced from ETM+ Landsat 7 satellite data and provides a consistent European " +
                "coverage of individual orthorectified scenes in national map projection systems.";
