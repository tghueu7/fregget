...
public class EMFUtils {
    ...
    public static boolean emfEquals(EObject e1, EObject e2) {
        ...
        for (EStructuralFeature sf : e1.eClass().getEAllStructuralFeatures()) {
            ...
            if (!equals) {
                System.out.println("Comparison failed on " + sf + " o1 has " + o1 + " while o2 " +
                        "has " + o2);
                return false;
            }
        }
    ...
    private static boolean objectEquals(Object o1, Object o2) {
        ...
        if (o1 == null && o2 != null || o1 != null && o2 == null) {
            ...
            EList l2 = (EList) o2;
            if (l1.size() != l2.size()) {
                System.out.println("The two lists do not have the same size, e1 has " + l1.size()
                        + " while o2 has " + l2.size());
                equals = false;
            } else {
