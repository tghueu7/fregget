...
public class CSWConfiguration extends Configuration {
  ...
  protected void registerBindings(Map bindings) {
    ...
    bindings.put(
        CSW.BriefRecordType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.BriefRecordType));
    bindings.put(
        CSW.CapabilitiesType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.CapabilitiesType));
    bindings.put(
        CSW.ConceptualSchemeType,
        new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.ConceptualSchemeType));
    bindings.put(
        CSW.DCMIRecordType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.DCMIRecordType));
    ...
    bindings.put(
        CSW.DomainValuesType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.DomainValuesType));
    bindings.put(
    ...
    bindings.put(
        CSW.ElementSetType, new EnumSimpleBinding(ElementSetType.class, CSW.ElementSetType));
    ...
    bindings.put(
        CSW.GetDomainType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetDomainType));
    bindings.put(
    ...
    bindings.put(
        CSW.GetRecordsType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetRecordsType));
    bindings.put(
    ...
    bindings.put(
        CSW.InsertResultType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.InsertResultType));
    bindings.put(CSW.InsertType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.InsertType));
    bindings.put(
        CSW.ListOfValuesType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.ListOfValuesType));
    bindings.put(
    ...
    bindings.put(
        CSW.RequestBaseType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.RequestBaseType));
    bindings.put(
    ...
    bindings.put(
        CSW.TransactionType, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.TransactionType));
     ...
     * bindings.put(CSW.AbstractQuery, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
     * CSW.AbstractQuery)); bindings.put(CSW.AbstractRecord, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.AbstractRecord));
     * bindings.put(CSW.Acknowledgement, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
     * CSW.Acknowledgement)); bindings.put(CSW.BriefRecord, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.BriefRecord)); bindings.put(CSW.Capabilities,
     * new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.Capabilities));
     ...
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetCapabilities)); bindings.put(CSW.GetDomain,
     * new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetDomain));
     * bindings.put(CSW.GetDomainResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
     * CSW.GetDomainResponse)); bindings.put(CSW.GetRecordById, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetRecordById));
     * bindings.put(CSW.GetRecordByIdResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
     * CSW.GetRecordByIdResponse)); bindings.put(CSW.GetRecords, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.GetRecords));
     * bindings.put(CSW.GetRecordsResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
     * CSW.GetRecordsResponse)); bindings.put(CSW.Harvest, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.Harvest)); bindings.put(CSW.HarvestResponse,
     * new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.HarvestResponse)); bindings.put(CSW.Query,
     * new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.Query)); bindings.put(CSW.Record, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.Record)); bindings.put(CSW.RecordProperty, new
     * ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.RecordProperty));
