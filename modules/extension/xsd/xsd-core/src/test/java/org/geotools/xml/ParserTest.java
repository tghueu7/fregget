...
public class ParserTest extends TestCase {
  public void testParse() throws Exception {
    ...
    List mails =
        (List) parser.parse(MLSchemaLocationResolver.class.getResourceAsStream("mails.xml"));
  ...
  public void testParseNull() throws Exception {
    ...
    parser.setValidating(true);
    List mails =
        (List) parser.parse(MLSchemaLocationResolver.class.getResourceAsStream("null-mail.xml"));
    ...
    Configuration cfg =
        new Configuration(xsd) {
          ...
          protected void registerBindings(Map bindings) {
            bindings.put(
                new QName("http://geotools.org/test", "MixedType"), new MixedTypeBinding(sb));
          }
