...
public class ParserTest extends TestCase {
    ...
    public void testValidate() throws Exception {
        ...
        parser.setFailOnValidationError(true);
        try {
            parser.validate(MLSchemaLocationResolver.class.getResourceAsStream("mails-invalid" +
                    ".xml"));
            fail("should have thrown an error with setFailOnValidationError set");
        } catch (SAXException e) {
        }
    ...
    public void testParseWithEntityResolver() throws Exception {
        ...
        try {
            parser.parse(MLSchemaLocationResolver.class.getResourceAsStream
        ...
        parser.parse(MLSchemaLocationResolver.class.getResourceAsStream("mails-external-entities" +
                ".xml"));
    }
