...
public interface DatatypeConverterInterface {
  ...
  /**
   * Parses the lexical representation of the given integer value (arbitrary precision) and converts
   * it into an instance of {@link java.math.BigInteger}.
   *
  ...
  /**
   * Parses the lexical representation of the given decimal value (arbitrary precision) and converts
   * it into an instance of {@link java.math.BigDecimal}.
   *
  ...
  /**
   * Parses the lexical representation of the given 32 bit floating point value and converts it into
   * a primitive <code>float</code> value.
   *
  ...
  /**
   * Parses the lexical representation of the given 64 bit floating point value and converts it into
   * a primitive <code>double</code> value.
   *
  ...
  /**
   * Parses the lexical representation of the given qualified name and converts it into an instance
   * of {@link javax.xml.namespace.QName}. The {@link javax.xml.namespace.QName} consists of a
  ...
  /**
   * Parses the lexical representation of the given dateTime value and converts it into an instance
   * of {@link java.util.Calendar}. Valid lexical representations of a dateTime value include
   *
   * <pre>
   *   YYYY-MM-DDThh:mm:ss
   ...
   * name. If the namespace URI is the current default namespace URI, then the prefix and the colon
   * may be omitted.
   *
