...
public abstract class XMLTestSupport extends TestCase {
   ...
   *
   * <p>This method is intended to be extended or overiden. This implementation registers the <code>
   * xsi,http://www.w3.org/2001/XMLSchema-instance</code> namespace.
   *
   ...
   *
   * <p>This mapping will be included in the "namespace context" of both the parser and the encoder.
   *
   ...
   *
   * @param name The qualified name of the element,attribute,or type the binding "binds" to, the key
   *     of the binding in the container.
   * @return The binding.
   */
