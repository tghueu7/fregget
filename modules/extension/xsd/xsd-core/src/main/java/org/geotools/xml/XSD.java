...
public abstract class XSD {
  ...
  /**
   * Returns the sbuset of {@link #getTypeSchema()} which maintains a unique java class to xml type
   * mapping.
   */
  ...
  /**
   * Transitively returns the type mapping profile for this schema and all schemas that this schema
   * depends on.
   */
