...
public class XSConfiguration extends Configuration {
    ...
    protected final void registerBindings(MutablePicoContainer container) {
        ...
        container.registerComponentImplementation(XS.LOCALSIMPLETYPE, XSLocalSimpleTypeBinding
                .class);
        ...
        container.registerComponentImplementation(XS.NEGATIVEINTEGER, XSNegativeIntegerBinding
                .class);
        ...
        container.registerComponentImplementation(XS.POSITIVEINTEGER, XSPositiveIntegerBinding
                .class);
        ...
        container.registerComponentImplementation(XS.RESTRICTIONTYPE, XSRestrictionTypeBinding
                .class);
        ...
        container.registerComponentImplementation(XS.TOPLEVELELEMENT, XSTopLevelElementBinding
                .class);
