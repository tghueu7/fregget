...
public class XSConfiguration extends Configuration {
  ...
  protected final void registerBindings(MutablePicoContainer container) {
    ...
    container.registerComponentImplementation(XS.LOCALCOMPLEXTYPE, XSLocalComplexTypeBinding.class);
    ...
    container.registerComponentImplementation(XS.NORMALIZEDSTRING, XSNormalizedStringBinding.class);
