...
public class DatatypeConverterImpl implements DatatypeConverterInterface {
    ...
    public QName parseQName(String arg0, NamespaceContext arg1) {
        ...
        switch (offset) {
            case -1:
                ...
                break;
            case 0:
                throw new IllegalArgumentException("Default prefix must be indicated by not using" +
                        " a colon: " + arg0);
            default:
    ...
    public long parseUnsignedInt(String arg0) {
        ...
        if (l < 0) {
            throw new IllegalArgumentException("Failed to parse UnsignedInt " + arg0 + ": result " +
                    "is negative");
        }
