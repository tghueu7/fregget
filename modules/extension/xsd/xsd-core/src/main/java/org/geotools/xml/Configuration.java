...
public abstract class Configuration {
  ...
  /**
   * Returns a schema location resolver instance used to override schema location uri's encountered
  ...
  /**
   * Returns a schema locator, used to create imported and included schemas when parsing an instance
   * document.
   *
   ...
   *
   * <p>This method is intended to provide the default bindings for a configuration and is intended
   * to be subclassed by client code. Client code should use {@link
   ...
   *
   * <p>The key of the <tt>bindings</tt> map is of type {@link QName}. The value can be class, or an
   * instance. In the case of a class, the binding will be instantiated by the parser at runtime. In
   * the instance case the binding will be used as is.
   */
   ...
   * Configures the root context to be used when parsing elements.
   *
   * <p>The context satisfies any dependencies needed by a binding. This is often a factory used to
   * create something.
   *
