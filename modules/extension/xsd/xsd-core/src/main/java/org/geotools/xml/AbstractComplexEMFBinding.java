...
public abstract class AbstractComplexEMFBinding extends AbstractComplexBinding {
  ...
  /**
   * Dynamically tries to determine the type of the object using emf naming conventions and the name
   * returned by {@link Binding#getTarget()}.
   *
   * <p>This implementation is a heuristic and is not guaranteed to work. Subclasses may override to
   ...
   * <param>node</param>. In the case that the name of a child element or attributes does not match
   * the name of a property on the object, subclasses may wish to extend this method and set the
   * property explicitly.
   */
