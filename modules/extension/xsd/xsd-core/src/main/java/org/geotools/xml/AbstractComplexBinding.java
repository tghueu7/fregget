...
public abstract class AbstractComplexBinding implements ComplexBinding {
   ...
   * null</code>.
   *
   * <p>Note that this method only needs to be implemented for schema types which are open-ended in
   * which the contents are not specifically specified by the schema.
   *
