...
public class SchemaLocationResolver implements XSDSchemaLocationResolver {
   ...
   *
   * <p>This value should be set in cases where an xml schema imports or includes schema files from
   * sub directories.
   */
   ...
   * files in.
   *
   * <p>The <tt>lookupDirectories</tt> parameter should be used in cases where a main schema imports
   ...
   *
   * <p>Resolution is performed by stripping the filename off of <param>location</param> and looking
   * up a resource located in the same package as the xsd.
   */
