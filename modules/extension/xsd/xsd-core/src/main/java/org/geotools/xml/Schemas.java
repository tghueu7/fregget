...
public class Schemas {
    private static final Logger LOGGER = org.geotools.util.logging.Logging.getLogger(Schemas
            .class.getPackage()
            .getName());
    ...
    public static final XSDSchema parse(String location, XSDSchemaLocator[] locators,
        ...
        return parse(location, (locators != null) ? Arrays.asList(locators) : Collections
                        .EMPTY_LIST,
    ...
    public static final XSDSchema parse(String location, ResourceSet resourceSet)
        ...
        XSDResourceImpl xsdMainResource = (XSDResourceImpl) resourceSet.createResource(URI
                .createURI(
                ".xsd"));
     ...
     */
    public static final XSDImport importSchema(XSDSchema schema, final XSDSchema importee) throws
            IOException {
                ...
                if (resolvedSchema != null) {
                    synchronized (Schemas.class) {
                        synchronized (resolvedSchema.eAdapters()) {
                            ...
                            for (XSDElementDeclaration dec : resolvedSchema
                                    .getElementDeclarations()) {
                                if (dec == null) {
                                    continue;
                                }
                                List<XSDElementDeclaration> toRemove = new 
                                        ArrayList<XSDElementDeclaration>();
                                for (XSDElementDeclaration subs : dec.getSubstitutionGroup()) {
                                    if (subs != null && subs.getContainer() != null && subs
                                            .getContainer().equals(schema)) {
                                        toRemove.add(subs);
                                    }
                                }
    ...
    public static final List validateImportsIncludes(String location, XSDSchemaLocator[] locators,
            ...
            throws IOException {
        return validateImportsIncludes(location, (locators != null) ? Arrays.asList(locators) : 
                        Collections.EMPTY_LIST,
                (resolvers != null) ? Arrays.asList(resolvers) : Collections.EMPTY_LIST);
    }

    public static final List validateImportsIncludes(String location, List locators, List 
            resolvers) throws IOException {
        ...
        SchemaImportIncludeValidator validator = new SchemaImportIncludeValidator(locators, 
                resolvers);
                ...
                if (schemaLocation != null) {
                    ...
                    for (Iterator l = locators.iterator(); l.hasNext(); ) {
                        ...
                        if (locator instanceof SchemaLocator) {
                            if (((SchemaLocator) locator).canHandle(null, namespace, 
                                    schemaLocation, null)) {
     ...
     */
    public static final List getChildElementParticles(XSDTypeDefinition type, boolean 
            includeParents) {
     ...
     * <p>
     * This method will handle the case in which the <code>parentTypeName == type.getTypeName()
     * </code>.
     ...
     * {@link #getAttributeDeclarations(XSDTypeDefinition) getAttributeDeclarations(element.getType()}
     * </p>
     *
     * @param element The element.
     ...
     * attribute of the element.
     */
    public static final List getAttributeDeclarations(XSDTypeDefinition type, boolean 
            includeParents) {
    ...
    static class SchemaLocationResolverAdapterFactory extends AdapterFactoryImpl {
        ...
        public SchemaLocationResolverAdapterFactory(List /*<XSDSchemaLocationResolver>*/ 
                                                            resolvers) {
