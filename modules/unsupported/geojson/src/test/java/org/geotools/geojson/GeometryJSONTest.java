...
public class GeometryJSONTest extends GeoJSONTestSupport {
    ...
    LineString line3d() {
        LineString l = gf.createLineString(array(new double[][]{{100.1, 0.1, 10.2}, {101.1, 1.1, 
                10.2}}));
        return l;
    }
    ...
    Polygon polygon3() {
        ...
        poly = gf.createPolygon(gf.createLinearRing(
                array(new double[][]{
                        {100.1, 0.1, 10.2}, {101.1, 0.1, 11.2}, {101.1, 1.1, 11.2}, {100.1, 1.1, 
                        10.2}, {100.1, 0.1, 10.2}})),
                new LinearRing[]{gf.createLinearRing(array(new double[][]{
                        {100.2, 0.2, 10.2}, {100.8, 0.2, 11.2}, {100.8, 0.8, 11.2}, {100.2, 0.8, 
                        10.2}, {100.2, 0.2, 10.2}}))});
        return poly;
    }
    ...
    MultiPoint multiPoint3d() {
        MultiPoint mpoint = gf.createMultiPoint(array(new double[][]{{100.1, 0.1, 10.2}, {101.1, 
                1.1, 11.2}}));
        return mpoint;
    }
    ...
    String multiPolygonText() {
        return strip(
                "{ 'type': 'MultiPolygon'," +
                        "    'coordinates': [" +
                        "      [[[102.1, 2.1], [103.1, 2.1], [103.1, 3.1], [102.1, 3.1], [102.1, " +
                        "2.1]]]," +
                        "      [[[100.1, 0.1], [101.1, 0.1], [101.1, 1.1], [100.1, 1.1], [100.1, " +
                        "0.1]]," +
    ...
    MultiPolygon multiPolygon() {
        MultiPolygon mpoly = gf.createMultiPolygon(new Polygon[]{
                gf.createPolygon(gf.createLinearRing(
                        array(new double[][]{{102.1, 2.1}, {103.1, 2.1}, {103.1, 3.1}, {102.1, 
                                3.1}, {102.1, 2.1}})), null),
                gf.createPolygon(gf.createLinearRing(
                        array(new double[][]{{100.1, 0.1}, {101.1, 0.1}, {101.1, 1.1}, {100.1, 
                                1.1}, {100.1, 0.1}})),
                        new LinearRing[]{gf.createLinearRing(
                                array(new double[][]{{100.2, 0.2}, {100.8, 0.2}, {100.8, 0.8}, 
                                        {100.2, 0.8}, {100.2, 0.2}}))})
        });
        return mpoly;
    }
    ...
    String multiPolygon3dText() {
        return strip(
                "{ 'type': 'MultiPolygon'," +
                        "    'coordinates': [" +
                        "      [[[102.1, 2.1, 10.2], [103.1, 2.1, 10.2], [103.1, 3.1, 10.2], " +
                        "[102.1, 3.1, 10.2], [102.1, 2.1, 10.2]]]," +
                        "      [[[100.1, 0.1, 10.2], [101.1, 0.1, 10.2], [101.1, 1.1, 10.2], " +
                        "[100.1, 1.1, 10.2], [100.1, 0.1, 10.2]]," +
                        "       [[100.2, 0.2, 10.2], [100.8, 0.2, 10.2], [100.8, 0.8, 10.2], " +
                        "[100.2, 0.8, 10.2], [100.2, 0.2, 10.2]]]" +
                        "      ]" +
                        "    }");
    }
    ...
    MultiPolygon multiPolygon3d() {
        MultiPolygon mpoly = gf.createMultiPolygon(new Polygon[]{
                gf.createPolygon(gf.createLinearRing(
                        array(new double[][]{{102.1, 2.1, 10.2}, {103.1, 2.1, 10.2}, {103.1, 3.1,
                                10.2}, {102.1, 3.1, 10.2}, {102.1, 2.1, 10.2}})), null),
                gf.createPolygon(gf.createLinearRing(
                        array(new double[][]{{100.1, 0.1, 10.2}, {101.1, 0.1, 10.2}, {101.1, 1.1,
                                10.2}, {100.1, 1.1, 10.2}, {100.1, 0.1, 10.2}})),
                        new LinearRing[]{gf.createLinearRing(
                                array(new double[][]{{100.2, 0.2, 10.2}, {100.8, 0.2, 10.2}, 
                                        {100.8, 0.8, 10.2}, {100.2, 0.8, 10.2}, {100.2, 0.2, 
                                        10.2}}))})
        });
        return mpoly;
    }
    ...
    public void testPointOrderParsing() throws Exception {
        String input1 = "{\n" + "  \"type\": \"Point\",\n" + "  \"coordinates\": [10, 10]\n" + "}";
        String input2 = "{\n" + "  \"coordinates\": [10, 10],\n" + "  \"type\": \"Point\"\n" + "}";
        org.geotools.geojson.geom.GeometryJSON geometryJSON = new org.geotools.geojson.geom
                .GeometryJSON();
     ...
     */
    private final void testKeyOrderInGeometryCollectionParsing_VerifyContents(GeometryCollection 
                                                                                      collection,
                                                                              Point expectedLastPoint) {
