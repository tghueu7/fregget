...
public abstract class MongoSchemaStoreTest<S extends MongoSchemaStore> {
    ...
    public void test_storeCRUD() throws FactoryException, IOException {
        ...
        try {
            ...
            FeatureTypeDBObjectTest.compareFeatureTypes(store.retrieveSchema(new NameImpl
                    ("dummy0")), dummy0, false);
            ...
            SimpleFeatureType dummy0_replace = FeatureTypeDBObjectTest.buildDummyFeatureType
                    ("dummy0");
            dummy0_replace.getUserData().put("dummyKey", "something different than what dummy0 " +
                    "contains");
