...
public abstract class MongoTestSupport extends OnlineTestCase {
    ...
    DB doConnect() throws Exception {
        MongoClientURI clientURI = new MongoClientURI(fixture.getProperty(MongoDataStoreFactory
                .DATASTORE_URI.key));
    ...
    protected Properties createExampleFixture() {
        ...
        fixture.put(MongoDataStoreFactory.DATASTORE_URI.key, 
                "mongodb://geotools:geotools@localhost:27017/geotools");
        fixture.put(MongoDataStoreFactory.SCHEMASTORE_URI.key, 
                "mongodb://geotools:geotools@localhost:27017/geotools");
