...
public class FeatureTypeDBObjectTest {
  ...
  static void compareFeatureTypes(
    ...
    if (strictGeometryClass) {
      ...
      assertThat(
          Geometry.class.isAssignableFrom(right.getGeometryDescriptor().getType().getBinding()),
          is(equalTo(true)));
      assertThat(
          Geometry.class.isAssignableFrom(left.getGeometryDescriptor().getType().getBinding()),
          is(equalTo(true)));
    }
