...
public class MongoDataStore extends ContentDataStore {
  ...
  public MongoDataStore(
    ...
    dataStoreDB =
        createDB(dataStoreClient, dataStoreClientURI.getDatabase(), !createDatabaseIfNeeded);
    if (dataStoreDB == null) {
      ...
      try {
        ...
        if (collectionNames.contains(candidateCollectionName)) {
          ...
          String geometryMapping =
              (String) candidateSchema.getDescriptor(geometryName).getUserData().get(KEY_mapping);
          ...
          LOGGER.log(
              ...
              new Object[] {
                name(candidateTypeName), dataStoreDB.getName(), candidateCollectionName
              });
        }
      } catch (IOException e) {
        LOGGER.log(
