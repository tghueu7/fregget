...
public class Template {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(name).append(description).append(drawingTool).append
                (prototype).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(description, rhs.description)
                .append(drawingTool, rhs.drawingTool).append(prototype, rhs.prototype).isEquals();
    }
