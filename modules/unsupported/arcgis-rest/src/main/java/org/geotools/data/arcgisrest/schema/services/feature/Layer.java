...
public class Layer {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(name).append(parentLayerId).append
                (defaultVisibility).append(subLayerIds).append(minScale).append(maxScale)
                .toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(name, rhs.name).append
                (parentLayerId, rhs.parentLayerId).append(defaultVisibility, rhs
                .defaultVisibility).append(subLayerIds, rhs.subLayerIds).append(minScale, rhs
                .minScale).append(maxScale, rhs.maxScale).isEquals();
    }
