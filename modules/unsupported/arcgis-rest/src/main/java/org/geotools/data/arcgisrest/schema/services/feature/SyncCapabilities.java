...
public class SyncCapabilities {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(supportsAsync).append
                (supportsRegisteringExistingData).append(supportsSyncDirectionControl).append
                (supportsPerLayerSync).append(supportsPerReplicaSync).append
                (supportsSyncModelNone).append(supportsRollbackOnFailure).append
                (supportsAttachmentsSyncDirection).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(supportsAsync, rhs.supportsAsync).append
                (supportsRegisteringExistingData, rhs.supportsRegisteringExistingData).append
                (supportsSyncDirectionControl, rhs.supportsSyncDirectionControl).append
                (supportsPerLayerSync, rhs.supportsPerLayerSync).append(supportsPerReplicaSync, 
                rhs.supportsPerReplicaSync).append(supportsSyncModelNone, rhs
                .supportsSyncModelNone).append(supportsRollbackOnFailure, rhs
                .supportsRollbackOnFailure).append(supportsAttachmentsSyncDirection, rhs
                .supportsAttachmentsSyncDirection).isEquals();
    }
