...
public class Layer {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(objectIdFieldName).append(globalIdFieldName).append
                (geometryType).append(spatialReference).append(fields).append(features)
                .toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(objectIdFieldName, rhs.objectIdFieldName).append
                (globalIdFieldName, rhs.globalIdFieldName).append(geometryType, rhs.geometryType)
                .append(spatialReference, rhs.spatialReference).append(fields, rhs.fields).append
                        (features, rhs.features).isEquals();
    }
