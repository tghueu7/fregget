...
public class EditorTrackingInfo {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(enableEditorTracking).append
                (enableOwnershipAccessControl).append(allowOthersToQuery).append
                (allowOthersToUpdate).append(allowOthersToDelete).append(allowAnonymousToUpdate)
                .append(allowAnonymousToDelete).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(enableEditorTracking, rhs.enableEditorTracking).append
                (enableOwnershipAccessControl, rhs.enableOwnershipAccessControl).append
                (allowOthersToQuery, rhs.allowOthersToQuery).append(allowOthersToUpdate, rhs
                .allowOthersToUpdate).append(allowOthersToDelete, rhs.allowOthersToDelete).append
                (allowAnonymousToUpdate, rhs.allowAnonymousToUpdate).append
                (allowAnonymousToDelete, rhs.allowAnonymousToDelete).isEquals();
    }
