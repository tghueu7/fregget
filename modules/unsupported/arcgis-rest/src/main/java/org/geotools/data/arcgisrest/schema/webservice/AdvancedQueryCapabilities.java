...
public class AdvancedQueryCapabilities {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(supportsPagination).append
                (supportsQueryRelatedPagination).append(supportsQueryWithDistance).append
                (supportsReturningQueryExtent).append(supportsStatistics).append(supportsOrderBy)
                .append(supportsDistinct).append(supportsQueryWithResultType).append
                        (supportsSqlExpression).append(supportsAdvancedQueryRelated).append
                        (supportsReturningGeometryCentroid).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(supportsPagination, rhs.supportsPagination).append
                (supportsQueryRelatedPagination, rhs.supportsQueryRelatedPagination).append
                (supportsQueryWithDistance, rhs.supportsQueryWithDistance).append
                (supportsReturningQueryExtent, rhs.supportsReturningQueryExtent).append
                (supportsStatistics, rhs.supportsStatistics).append(supportsOrderBy, rhs
                .supportsOrderBy).append(supportsDistinct, rhs.supportsDistinct).append
                (supportsQueryWithResultType, rhs.supportsQueryWithResultType).append
                (supportsSqlExpression, rhs.supportsSqlExpression).append
                (supportsAdvancedQueryRelated, rhs.supportsAdvancedQueryRelated).append
                (supportsReturningGeometryCentroid, rhs.supportsReturningGeometryCentroid)
                .isEquals();
    }
