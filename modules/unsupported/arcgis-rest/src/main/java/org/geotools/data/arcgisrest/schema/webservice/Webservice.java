...
public class Webservice {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(currentVersion).append(id).append(name).append(type)
                .append(serviceItemId).append(displayField).append(description).append
                        (copyrightText).append(defaultVisibility).append(editingInfo).append
                        (multiScaleGeometryInfo).append(relationships).append(isDataVersioned)
                .append(supportsCalculate).append(supportsTruncate).append
                        (supportsAttachmentsByUploadId).append
                        (supportsRollbackOnFailureParameter).append(supportsStatistics).append
                        (supportsAdvancedQueries).append(supportsValidateSql).append
                        (supportsCoordinatesQuantization).append(supportsApplyEditsWithGlobalIds)
                .append(supportsMultiScaleGeometry).append(advancedQueryCapabilities).append
                        (useStandardizedQueries).append(geometryType).append(minScale).append
                        (maxScale).append(extent).append(drawingInfo).append
                        (allowGeometryUpdates).append(hasAttachments).append(htmlPopupType)
                .append(hasM).append(hasZ).append(objectIdField).append(globalIdField).append
                        (typeIdField).append(fields).append(indexes).append(types).append
                        (templates).append(supportedQueryFormats).append(hasStaticData).append
                        (maxRecordCount).append(standardMaxRecordCount).append
                        (tileMaxRecordCount).append(maxRecordCountFactor).append(capabilities)
                .toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(currentVersion, rhs.currentVersion).append(id, rhs.id)
                .append(name, rhs.name).append(type, rhs.type).append(serviceItemId, rhs
                        .serviceItemId).append(displayField, rhs.displayField).append
                        (description, rhs.description).append(copyrightText, rhs.copyrightText)
                .append(defaultVisibility, rhs.defaultVisibility).append(editingInfo, rhs
                        .editingInfo).append(multiScaleGeometryInfo, rhs.multiScaleGeometryInfo)
                .append(relationships, rhs.relationships).append(isDataVersioned, rhs
                        .isDataVersioned).append(supportsCalculate, rhs.supportsCalculate).append
                        (supportsTruncate, rhs.supportsTruncate).append
                        (supportsAttachmentsByUploadId, rhs.supportsAttachmentsByUploadId).append
                        (supportsRollbackOnFailureParameter, rhs
                                .supportsRollbackOnFailureParameter).append(supportsStatistics, 
                        rhs.supportsStatistics).append(supportsAdvancedQueries, rhs
                        .supportsAdvancedQueries).append(supportsValidateSql, rhs
                        .supportsValidateSql).append(supportsCoordinatesQuantization, rhs
                        .supportsCoordinatesQuantization).append(supportsApplyEditsWithGlobalIds,
                        rhs.supportsApplyEditsWithGlobalIds).append(supportsMultiScaleGeometry, 
                        rhs.supportsMultiScaleGeometry).append(advancedQueryCapabilities, rhs
                        .advancedQueryCapabilities).append(useStandardizedQueries, rhs
                        .useStandardizedQueries).append(geometryType, rhs.geometryType).append
                        (minScale, rhs.minScale).append(maxScale, rhs.maxScale).append(extent, 
                        rhs.extent).append(drawingInfo, rhs.drawingInfo).append
                        (allowGeometryUpdates, rhs.allowGeometryUpdates).append(hasAttachments, 
                        rhs.hasAttachments).append(htmlPopupType, rhs.htmlPopupType).append(hasM,
                        rhs.hasM).append(hasZ, rhs.hasZ).append(objectIdField, rhs.objectIdField)
                .append(globalIdField, rhs.globalIdField).append(typeIdField, rhs.typeIdField)
                .append(fields, rhs.fields).append(indexes, rhs.indexes).append(types, rhs.types)
                .append(templates, rhs.templates).append(supportedQueryFormats, rhs
                        .supportedQueryFormats).append(hasStaticData, rhs.hasStaticData).append
                        (maxRecordCount, rhs.maxRecordCount).append(standardMaxRecordCount, rhs
                        .standardMaxRecordCount).append(tileMaxRecordCount, rhs
                        .tileMaxRecordCount).append(maxRecordCountFactor, rhs
                        .maxRecordCountFactor).append(capabilities, rhs.capabilities).isEquals();
    }
