...
public class XssPreventionInfo {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(xssPreventionEnabled).append(xssPreventionRule)
                .append(xssInputRule).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(xssPreventionEnabled, rhs.xssPreventionEnabled).append
                (xssPreventionRule, rhs.xssPreventionRule).append(xssInputRule, rhs.xssInputRule)
                .isEquals();
    }
