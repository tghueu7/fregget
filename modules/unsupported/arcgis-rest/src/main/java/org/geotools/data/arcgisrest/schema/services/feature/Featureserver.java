...
public class Featureserver {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(currentVersion).append(serviceItemId).append
                (serviceDescription).append(hasVersionedData).append(supportsDisconnectedEditing)
                .append(hasStaticData).append(maxRecordCount).append(supportedQueryFormats)
                .append(capabilities).append(description).append(copyrightText).append
                        (spatialReference).append(initialExtent).append(fullExtent).append
                        (allowGeometryUpdates).append(units).append(size).append(syncEnabled)
                .append(syncCapabilities).append(supportsApplyEditsWithGlobalIds).append
                        (editorTrackingInfo).append(xssPreventionInfo).append(layers).append
                        (tables).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(currentVersion, rhs.currentVersion).append
                (serviceItemId, rhs.serviceItemId).append(serviceDescription, rhs
                .serviceDescription).append(hasVersionedData, rhs.hasVersionedData).append
                (supportsDisconnectedEditing, rhs.supportsDisconnectedEditing).append
                (hasStaticData, rhs.hasStaticData).append(maxRecordCount, rhs.maxRecordCount)
                .append(supportedQueryFormats, rhs.supportedQueryFormats).append(capabilities, 
                        rhs.capabilities).append(description, rhs.description).append
                        (copyrightText, rhs.copyrightText).append(spatialReference, rhs
                        .spatialReference).append(initialExtent, rhs.initialExtent).append
                        (fullExtent, rhs.fullExtent).append(allowGeometryUpdates, rhs
                        .allowGeometryUpdates).append(units, rhs.units).append(size, rhs.size)
                .append(syncEnabled, rhs.syncEnabled).append(syncCapabilities, rhs
                        .syncCapabilities).append(supportsApplyEditsWithGlobalIds, rhs
                        .supportsApplyEditsWithGlobalIds).append(editorTrackingInfo, rhs
                        .editorTrackingInfo).append(xssPreventionInfo, rhs.xssPreventionInfo)
                .append(layers, rhs.layers).append(tables, rhs.tables).isEquals();
    }
