...
public class JIntegerField extends JValueField implements ModifyListener {
   ...
   * listeners.
   *
   * <p>This version is useful when two or more controls are synchronized (ie. changes to the value
   * of one control results in changes to the values of other controls). In such a setting, firing
   * change events can result in an endless cycle or a mutex violation.
   *
   * @param value the value to set
