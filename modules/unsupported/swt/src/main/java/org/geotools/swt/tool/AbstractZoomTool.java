...
public abstract class AbstractZoomTool extends CursorTool {
  ...
  /**
   * Constructs a new abstract zoom tool. To activate the tool only on certain mouse events provide
   * a single mask, e.g. {@link SWT#BUTTON1}, or a combination of multiple SWT-masks.
   *
