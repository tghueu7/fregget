...
public class SwtMapFrame extends ApplicationWindow {
  ...
  /**
   * This method is an alternative to {@linkplain #enableToolBar(boolean)}. It requests that a tool
   * bar be created with specific tools, identified by {@linkplain SwtMapFrame.Tool} constants.
   * <code><pre>
  ...
  /**
   * Get the map context associated with this frame. Returns {@code null} if no map context has been
   * set explicitly with the constructor or {@linkplain #setMapContent}.
   *
  ...
  /**
   * Get the renderer being used by this frame. Returns {@code null} if no renderer was set via the
   * constructor or {@linkplain #setRenderer}.
   *
