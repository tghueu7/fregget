...
public class SLDs extends SLD {
        ...
        for (GraphicalSymbol gs : graphic.graphicalSymbols()) {
            if ((gs != null) && (gs instanceof Mark)) {
                ...
                if (fill != null) {
                    ...
                    colour = new Color(colour.getRed() / 255f, colour.getGreen() / 255f, colour
                            .getBlue() / 255f, alpha);
                    if (colour != null) {
                        return colour;
                    }
     ...
     * feature type.  This is admittedly dangerous
    ...
    public static final boolean isLine(GeometryDescriptor geometryType) {
        if (geometryType == null)
            return false;
        Class<?> type = geometryType.getType().getBinding();
        return LineString.class.isAssignableFrom(type) || MultiLineString.class.isAssignableFrom
                (type);
    }
