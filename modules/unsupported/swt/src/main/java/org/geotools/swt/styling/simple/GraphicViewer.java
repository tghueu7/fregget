...
public class GraphicViewer {
    ...
    public Composite createControl(Composite parent, KeyListener klisten, StyleBuilder build) {
        Composite part = AbstractSimpleConfigurator.subpart(parent, Messages.getString
                ("SimpleStyleConfigurator_point_label"));
    ...
    public void setGraphic(Graphic graphic, Mode mode, Color defaultColor) {
        ...
        if (graphic == null) {
            ...
            graphic = builder.createGraphic(null, builder.createMark(StyleBuilder.MARK_SQUARE, 
                    defaultColor), null);
            enabled = true;
        }
        ...
        if (graphic != null && graphic.graphicalSymbols() != null && !graphic.graphicalSymbols()
                .isEmpty()) {
