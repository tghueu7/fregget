...
public class ExcelDataStoreFactory extends AbstractDataStoreFactory implements DataStoreFactorySpi {
    ...
    public static final Param URLP = new Param("url", java.net.URL.class,
            "A URL pointing to the file containing the data", true, null, new KVP(Param.EXT, 
            "xls", Param.EXT, "xlsx"));
    ...
    public boolean canProcess(Map params) {
        ...
        try {
            ...
            boolean accept = url.getFile().toUpperCase().endsWith("XLS") || url.getFile()
                    .toUpperCase().endsWith("XLSX");
            if (accept) {
                return true;
            }
        } catch (IOException e) {
