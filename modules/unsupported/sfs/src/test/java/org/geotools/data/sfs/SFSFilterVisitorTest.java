...
public class SFSFilterVisitorTest extends TestCase {
    ...
    public void testBBOX() throws Exception {
        ...
        assertEquals(URL_LAYER_ASIA + "?bbox=0.0,0.0,10.0,10.0", URLDecoder.decode(builder
                .toString(), "UTF-8"));
    }
    ...
    public void testDWithin() throws Exception {
        ...
        visitor.finish(builder, false);
        assertEquals(URL_LAYER_ASIA + "?epsg=&lat=0.1&lon=100.1&tolerance=10.0", URLDecoder
                .decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testIntersect() throws Exception {
        ...
        visitor.finish(builder, false);
        assertEquals(URL_LAYER_ASIA + "?geometry={\"type\":\"Point\",\"coordinates\":[100.1," +
                "0.1]}", URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testPropertyIsEqualTo() throws Exception {
        ...
        StringBuilder builder = new StringBuilder(URL_LAYER_ASIA);
        SFSFilterVisitor visitor = new SFSFilterVisitor(true);
        PropertyIsEqualTo filter = FF.equals(FF.property(PROPERTY_NAME), FF.literal
                (PROPERTY_VALUE));
    ...
    public void testPropertyIsGreaterThanOrEqualTo() throws Exception {
        ...
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        assertEquals(URL_LAYER_ASIA + "?" + PROPERTY_NAME + "__gte=" + PROPERTY_VALUE + 
                "&queryable="
                + PROPERTY_NAME, URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testPropertyIsLessThanOrEqualTo() throws Exception {
        ...
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        assertEquals(URL_LAYER_ASIA + "?" + PROPERTY_NAME + "__lte=" + PROPERTY_VALUE + 
                "&queryable="
                + PROPERTY_NAME, URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testPropertyIsLike() throws Exception {
        StringBuilder builder = new StringBuilder(URL_LAYER_ASIA);
        SFSFilterVisitor visitor = new SFSFilterVisitor(true);
        PropertyIsLike filter = FF.like(FF.property(PROPERTY_NAME), PROPERTY_VALUE, "%", "_", 
                "\\", true);
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        assertEquals(URL_LAYER_ASIA + "?" + PROPERTY_NAME + "__like=" + PROPERTY_VALUE + 
                "&queryable="
                + PROPERTY_NAME, URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testHints() throws Exception {
        ...
        assertEquals("aProperty__lt=342&queryable=aProperty&hints=first:a%3Db;second:a%25b", 
                result);
    }
