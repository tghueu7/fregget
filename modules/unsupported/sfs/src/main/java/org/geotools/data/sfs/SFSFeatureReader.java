...
class SFSFeatureReader implements SimpleFeatureReader {
  ...
  public SFSFeatureReader(
      ContentState contentState, SFSLayer layer, Query fnQuery, SimpleFeatureType targetSchema)
      throws IOException {
  ...
  public SimpleFeature next() throws IOException, IllegalArgumentException, NoSuchElementException {
    try {
      ...
      // the json reader does not know about the namespaces and puts the geometry in a "geometry"
      // attribute
