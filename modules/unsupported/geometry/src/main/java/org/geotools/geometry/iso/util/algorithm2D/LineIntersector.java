...
public abstract class LineIntersector {
   ...
   * p1-p2 (E.g. p = (139,9) p1 = (139,10), p2 = (280,1) produces distanct 0.0, which is incorrect.
   *
  ...
  /**
   * Computes the index of the intIndex'th intersection point in the direction of a specified input
   * line segment
   *
   * @param segmentIndex is 0 or 1
   * @param intIndex is 0 or 1
