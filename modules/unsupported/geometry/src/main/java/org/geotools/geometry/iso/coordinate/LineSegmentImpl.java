...
public class LineSegmentImpl extends LineStringImpl implements LineSegment {
     ...
     * @param startParam
     */
    public LineSegmentImpl(CoordinateReferenceSystem crs, double[] from, double[] to, double 
            startParam) {
        this(new PointArrayImpl(new DirectPositionImpl(crs, from), new DirectPositionImpl(crs, 
                to)), startParam);
    }
    ...
    public DirectPosition forParamInSegment(double dist) {
        ...
        double par = DoubleOperation.div(DoubleOperation.subtract(dist, this.startParam), this
                .length());
     ...
     * <p>
     * This method is NON-ROBUST, e.g. it might suffer by errors caused by the Floating-point 
     * arithmetic
     *
     * @param p0  -
