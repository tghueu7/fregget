...
public class WKTReader {
     ...
     *
     * @param tokenizer tokenizer over a stream of text in Well-known Text format. The
    ...
    private Point readPointText() throws IOException, ParseException {
        ...
        Point point = new PointImpl(positionFactory.createDirectPosition(this
                .getPreciseCoordinate().getCoordinates())); //primitiveFactory.createPoint(this
        // .getPreciseCoordinate().getCoordinates());
        getNextCloser();
        return point;
    }
    ...
    private Surface readPolygonText() throws IOException, ParseException {
        ...
        if (nextToken.equals(EMPTY)) {
            return new SurfaceImpl((SurfaceBoundary) null); //this.primitiveFactory.createSurface
    ...
    private OrientableCurve createCurve(Coordinate[] aCoords) {
        ...
        LineString lineString = new LineStringImpl(new PointArrayImpl(points), 0.0); //this
