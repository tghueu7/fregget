...
public class GeometryFactoryImpl implements Factory, GeometryFactory {
    ...
    /* (non-Javadoc)
     * @see org.opengis.geometry.coordinate.Factory#createPosition(org.opengis.geometry
    ...
    public PointArrayImpl createPointArray(List<Position> positions) {
        ...
        try {
            ...
            throw new IllegalArgumentException("List contains Position instances which can not be" +
                    " casted to the local geometry Position classes.", e);
        }
        return pa;
    }
     ...
     *
     * @param Coordinate c of a point p. The created envelope will have this coordinate as lower 
     *                   and upper corner
     ...
     * <p>
     * This method creates a LineSegment without references to the parent Curve. this will cause 
    ...
    public ArcString createArcString(List<Position> points) throws 
    ...
    public BSplineSurface createBSplineSurface(List<PointArray> points, int[] degree, 
                                               List<Knot>[] knots, KnotType knotSpec) throws 
            MismatchedReferenceSystemException, MismatchedDimensionException {
        // LATER:
        // TO DO semantic SJ, JR
        // TO DO implementation
    ...
    public GeodesicString createGeodesicString(List<Position> points) throws 
            MismatchedReferenceSystemException, MismatchedDimensionException {
        // LATER:
        // TO DO semantic SJ, JR
        // TO DO implementation
    ...
    public PolyhedralSurface createPolyhedralSurface(List<Polygon> tiles) throws 
            MismatchedReferenceSystemException, MismatchedDimensionException {
        // LATER:
        // TO DO semantic SJ, JR
        // TO DO implementation
    ...
    public Tin createTin(Set<Position> post, Set<LineString> stopLines, Set<LineString> 
            breakLines, double maxLength) throws MismatchedReferenceSystemException, 
            MismatchedDimensionException {
        // LATER:
        // TO DO semantic SJ, JR
        // TO DO implementation
