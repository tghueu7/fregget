...
public abstract class SurfacePatchImpl implements SurfacePatch, Serializable {
    ...
    protected SurfacePatchImpl(SurfaceBoundaryImpl boundary) {
        ...
        // TODO This behaviour must be reviewed again: Probably there are cases when we are not 
        // able to create a SurfacePatch by the boundary, for example when creating Triangles 
        // which are defined by three positions. 
        if (boundary == null)
