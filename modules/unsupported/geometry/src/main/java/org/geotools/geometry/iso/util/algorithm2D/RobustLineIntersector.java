...
public class RobustLineIntersector extends LineIntersector {
  ...
  private Coordinate intersection(Coordinate p1, Coordinate p2, Coordinate q1, Coordinate q2) {
     ...
     *
     * <p>LINESTRING (2089426.5233462777 1180182.3877339689, 2085646.6891757075 1195618.7333999649)
  ...
  /**
   * Normalize the supplied coordinates to so that the midpoint of their intersection envelope lies
   * at the origin.
   *
   * @param n00
   * @param n01
