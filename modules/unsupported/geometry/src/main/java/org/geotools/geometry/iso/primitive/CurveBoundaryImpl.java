...
public class CurveBoundaryImpl extends PrimitiveBoundaryImpl implements
    ...
    public CurveBoundaryImpl(CoordinateReferenceSystem crs, Point start, Point end) {
        super(crs);
        if (start.equals(end))
            throw new IllegalArgumentException("Start- and Endpoint of the CurveBoundary cannot " +
                    "be equal");
    ...
    public CurveBoundaryImpl clone() throws CloneNotSupportedException {
        ...
        return new CurveBoundaryImpl(this.getCoordinateReferenceSystem(), this.getStartPoint()
                .clone(), this.getEndPoint().clone());
    }
    ...
    public String toString() {
        return "[CurveBoundary: StartPoint: " + this.startPoint + " EndPoint: " 
                //$NON-NLS-1$//$NON-NLS-2$
    ...
    public EnvelopeImpl getEnvelope() {
        ...
        // EnvelopeImpl tmpEnv = new EnvelopeImpl(this.startPoint.getDirectPosition(), this
        // .startPoint.getDirectPosition());
