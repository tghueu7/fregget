...
public class EdgeEndBundle extends EdgeEnd {
   ...
   * boundary or not. Finally, in GeometryCollections it can still occur that an edge is both on the
   * boundary and in the interior (e.g. a LineString segment lying on top of a Polygon edge.) In
   * this case as usual the Boundary is given precendence. <br>
