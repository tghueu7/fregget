...
public class Triangle2D extends Simplex2D {
    ...
    public double getRadiusU() {
        ...
        p1 = pts[1];
        p2 = pts[2];
        Point2D pm = new Point2D.Double(((0.5 * p1.getX()) + (0.5 * p0.getX())), ((0.5 * p1.getY
                ()) + (0.5 * p0.getY())));
        double c = Math.sqrt((pm.getX() * pm.getX()) - (2 * (pm.getX() * p2.getX())) + (p2.getX()
                * p2.getX()) + (pm.getY() * pm.getY()) - (2 * (pm.getY() * p2.getY())) + (p2.getY
                () * p2.getY()));
        ...
        double angle = Math.acos(((p0_1.getX() * p0_2.getX()) / (Math.sqrt(Math.pow(p0_1.getX(), 
                2) + Math.pow(p0_1.getY(), 2)) * Math.sqrt((p0_2.getX() * p0_2.getX())))));
        if (p1_1.getY() > 0) {
    ...
    public double getRadiusI() {
        ...
        double p2x = p[2].getX();
        double p2y = p[2].getY();
        double umfang = Math.sqrt(((p0x * p0x) - (2 * p0x * p1x) + (p1x * p1x) + (p0y * p0y) - (2
                * p0y * p1y) + (p1y * p1y))) +
                Math.sqrt(((p1x * p1x) - (2 * p1x * p2x) + (p2x * p2x) + (p1y * p1y) - (2 * p1y *
                        p2y) + (p2y * p2y))) +
                Math.sqrt(((p2x * p2x) - (2 * p2x * p0x) + (p0x * p0x) + (p2y * p2y) - (2 * p2y *
                        p0y) + (p0y * p0y)));
