...
public class SurfaceImpl extends OrientableSurfaceImpl implements Surface {
     ...
     * @throws IllegalArgument Exception if the union of the surface patches is not a surface. 
     * That means that the patches are not continuous.
     */
...
//	}
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.GenericSurface#getUpNormal(org.opengis.geometry
    ...
    public Geometry transform(CoordinateReferenceSystem newCRS,
        ...
        SurfaceBoundaryImpl surfaceBoundary = (SurfaceBoundaryImpl) primitiveFactory
                .createSurfaceBoundary(newExterior, newInteriors);
