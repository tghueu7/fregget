...
public class DirectedEdgeStar extends EdgeEndStar {
   ...
   * the <next> pointer for an incoming dirEdge is set to the next outgoing edge.
   *
  ...
  /**
   * Traverse the star of edges, maintaing the current location in the result area at this node (if
   * any). If any L edges are found in the interior of the result, mark them as covered.
   */
