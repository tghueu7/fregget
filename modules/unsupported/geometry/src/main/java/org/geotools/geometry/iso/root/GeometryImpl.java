...
public abstract class GeometryImpl implements Geometry, Serializable {
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.root.Geometry#getDimension(org.opengis.geometry
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.root.Geometry#transform(org.opengis.referencing.crs
    ...
    public Geometry transform(CoordinateReferenceSystem newCRS,
        ...
        throw new UnsupportedOperationException("Transform not implemented for this geometry type" +
                " yet.");
    }
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.root.Geometry#getDistance(org.opengis.geometry
     * .coordinate.root.Geometry)
     ...
     * scalability.
     *
     * @see org.opengis.geometry.coordinate.root.Geometry#distance(org.opengis.geometry
     * .coordinate.root.Geometry)
     */
        ...
        if (this instanceof PointImpl ||
            ...
            if (this instanceof CurveBoundaryImpl) {
                ...
                if (this instanceof CurveImpl ||
                    ...
                    // SurfaceBoundary: the average of the weighted line segments of all curves 
                    // of the exterior and interior rings
                    if (this instanceof SurfaceBoundaryImpl) {
                        CentroidLine cl = new CentroidLine(this.crs);
                        cl.add(((SurfaceBoundaryImpl) this).getExterior());
                        Iterator<Ring> interiors = ((SurfaceBoundaryImpl) this).getInteriors()
                                .iterator();
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#contains(org.opengis.geometry
     * .coordinate.TransfiniteSet)
     */
...
//		}
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#intersects(org.opengis.geometry
     * .coordinate.TransfiniteSet)
     */
...
//		}
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#equals(org.opengis.geometry.coordinate
     * .TransfiniteSet)
     */
...
//		}
     ...
     * That is that a part of the object lies within this object and another part lies without 
     * this object,
...
//	}
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#union(org.opengis.geometry.coordinate
     * .TransfiniteSet)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#intersection(org.opengis.geometry
     * .coordinate.TransfiniteSet)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#difference(org.opengis.geometry
     * .coordinate.TransfiniteSet)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.coordinate.TransfiniteSet#symmetricDifference(org.opengis
     * .geometry.coordinate.TransfiniteSet)
     */
    ...
    public Complex getClosure() {
        if (this instanceof ComplexImpl) {
            ...
            Assert.isTrue(false, "The closure operation is not implemented for this geometry " +
                    "object");
        return null;
