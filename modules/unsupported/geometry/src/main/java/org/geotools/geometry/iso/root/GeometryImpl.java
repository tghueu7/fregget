...
public abstract class GeometryImpl implements Geometry, Serializable {
   ...
   * and the command of "distance". Currently this implementation works for our needs, but we should
   * consider re-designing it with one of the above approaches for better scalability.
   *
   * @see
  ...
  public DirectPosition getCentroid() {
    ...
    // SurfaceBoundary: the average of the weighted line segments of all curves of the exterior and
    // interior rings
   ...
   * @return TRUE if the Intersection Pattern Matrix describes the topological relation between the
   *     two input geomtries correctly, FALSE if not.
   ...
   * object lies within this object and another part lies without this object, e.g. the other object
   * intersects with the interior, boundary and exterior of this object
   *
   * @param pointSet The other object
