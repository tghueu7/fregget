...
public class CompositeSurfaceImpl extends CompositeImpl<OrientableSurfaceImpl>
  ...
  public SurfaceBoundary getBoundary() {
    ...
    // The result must be a Complex again, could it be a CompositeCurve which contains all (exterior
    // and interior)Rings of the SurfaceBoundaries of the Surfaces which are contained by the
    // CompositeSurface?
    return null;
  }
