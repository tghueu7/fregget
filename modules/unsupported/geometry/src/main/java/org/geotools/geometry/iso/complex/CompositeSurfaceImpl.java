...
//	}
    ...
    public SurfaceBoundary getBoundary() {
        ...
        // (exterior and interior)Rings of the SurfaceBoundaries of the Surfaces which are 
        // contained by the CompositeSurface?
        return null;
    }
    ...
    public Envelope getEnvelope() {
        ...
        //EnvelopeImpl rEnv = this.getFeatGeometryFactory().getGeometryFactoryImpl()
        // .createEnvelope(actSurf.getEnvelope());
