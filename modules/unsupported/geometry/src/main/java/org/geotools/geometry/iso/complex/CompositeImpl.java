...
public abstract class CompositeImpl<T> extends ComplexImpl implements Composite {
   ...
   * forth until Points are included. Thus the association role Composition::generator on Composite
   * is a subset of the association role Complex::element on Complex.
   *
   * <p>Composite::generator[1..n] : Primitive Is realised by the ArrayList of elements in the super
   * Class Complex The Generator elements will be passed through the super constructor
   *
