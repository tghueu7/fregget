...
public class PointImpl extends PrimitiveImpl implements Point {
    ...
    public PointImpl clone() throws CloneNotSupportedException {
        ...
        //return this.getGeometryFactory().getPrimitiveFactory().createPoint(this.getPosition()
        // .getCoordinates());
    }
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.primitive.Point#setPosition(org.opengis.geometry.coordinate
     * .DirectPosition)
     */
    @Deprecated
    public void setPosition(DirectPosition p) {
        this.position = new DirectPositionImpl(p);
        //this.position = this.getGeometryFactory().getGeometryFactoryImpl().createDirectPosition
        // (p);
    }
     ...
     * (non-Javadoc)
     *
     * @see org.opengis.geometry.primitive.Point#getBearing(org.opengis.geometry.coordinate
     * .Position)
     */
    ...
    public Envelope getEnvelope() {
        ...
        //return this.getGeometryFactory().getGeometryFactoryImpl().createEnvelope(this.position
        // .getCoordinates());
    }
    ...
    /* (non-Javadoc)
     * @see org.geotools.geometry.featgeom.root.GeometryImpl#equals(org.opengis.geometry
    ...
    public Geometry transform(CoordinateReferenceSystem newCRS,
        ...
        PositionFactory newPositionFactory = new PositionFactoryImpl(newCRS, getPositionFactory()
                .getPrecision());
