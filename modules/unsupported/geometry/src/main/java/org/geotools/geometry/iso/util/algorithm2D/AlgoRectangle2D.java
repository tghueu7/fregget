...
public class AlgoRectangle2D {
    ...
    public static void setValues(Rectangle2D r, double xmin, double ymin, double xmax, double 
            ymax) {
        if (java.lang.Double.isNaN(xmin) || java.lang.Double.isNaN(ymin) || java.lang.Double
                .isNaN(xmax) || java.lang.Double.isNaN(ymax))
...
//	}
    ...
    public static boolean intersects(Point2D p0, Point2D p1, Point2D p) {
        return (p0.getX() < p1.getX() ? intersects(p0.getX(), p1.getX(), p.getX()) : intersects
                (p1.getX(), p0.getX(), p.getX())) ||
                (p0.getY() < p1.getY() ? intersects(p0.getY(), p1.getY(), p.getY()) : intersects
                        (p1.getY(), p0.getY(), p.getY()));
    }

    public static boolean intersects(Point2D p0, Point2D p1, Point2D q0, Point2D q1) {
        return (((((p0.getX() < p1.getX()) ? p0.getX() : p1.getX()) <= ((q0.getX() > q1.getX()) ?
                q0.getX() : q1.getX())) &&
                (((p0.getX() > p1.getX()) ? p0.getX() : p1.getX()) >= ((q0.getX() < q1.getX()) ? 
                        q0.getX() : q1.getX()))) ||
                ((((p0.getY() < p1.getY()) ? p0.getY() : p1.getY()) <= ((q0.getY() > q1.getY()) ?
                        q0.getY() : q1.getY())) &&
                        ((((p0.getY() > p1.getY()) ? p0.getY() : p1.getY()) >= ((q0.getY() < 
                                q1.getY()) ? q0.getY() : q1.getY())))));
    }
...
//    }
    public static Point2D[] intersectionRectangleLine(Rectangle2D rec, Line2D line) {
        ...
        Point2D p0 = null;
        Point2D p1 = null;
        if ((x1 == x2) && (xmin <= x1 && xmax >= x1) && ((y1 <= ymin && y2 >= ymax) || (y2 <= 
                ymin && y1 >= ymax))) {
            return new Point2D[]{new Point2D.Double(x1, ymin), new Point2D.Double(x1, ymax)};
        }
        if ((y1 == y2) && (ymin <= y1 && ymax >= y1) && ((x1 <= xmin && x2 >= xmax) || (x2 <= 
                xmin && x1 >= xmax))) {
        ...
        if ((p0 != null) && (p0.getX() < xmin || p0.getX() > xmax || p0.getY() < ymin || p0.getY
                () > ymax))
            p0 = null;
        ...
        if ((p0 != null) && (p0.getX() < xmin || p0.getX() > xmax || p0.getY() < ymin || p0.getY
                () > ymax))
            p0 = null;
        if ((p1 != null) && (p1.getX() < xmin || p1.getX() > xmax || p1.getY() < ymin || p1.getY
                () > ymax))
            p1 = null;
