...
public abstract class EdgeRing {
    ...
    public SurfaceImpl toPolygon() {
        ...
        //aGeometryFactory.getPrimitiveFactory().createSurfaceBoundary(this.getRing(),
        // interiorRings);

        return new SurfaceImpl(surfaceBoundary); //aGeometryFactory.getPrimitiveFactory()
    ...
    protected void mergeLabel(Label deLabel, int geomIndex) {
        int loc = deLabel.getLocation(geomIndex, org.geotools.geometry.iso.topograph2D.Position
                .RIGHT);
