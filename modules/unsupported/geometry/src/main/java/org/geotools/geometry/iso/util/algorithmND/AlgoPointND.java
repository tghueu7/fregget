 ...
 * In majority, these algorithms are non-robust in sense that floating-point rounding errors may 
 * occur.
 *
...
public class AlgoPointND {
    ...
    /**
     * Returns the distance from the coordinate represented by <code>p0</code> to the origin of 
...
//	}
     ...
     * The method will return a double array which describes the coordinate at distance 
     * <code>r</code>
     * on this straight line, whith a parametrisation of 0.0 at <code>c0</code> and 1.0 at 
     * <code>c1</code>.
     * <p>
     * Note: This method is NON-ROBUST due to floating-point rounding errors.
     * Inexact results according to floating-point rounding errors may be caused.
