...
public class GeometryGraph extends PlanarGraph {
   ...
   * clockwise oriented, will be calculated and considered. Thus, the direction of the ring does not
   * matter. The left and right topological location arguments assume that the ring is oriented CW.
   ...
   * @param computeRingSelfNodes if <false>, intersection checks are optimized to not test rings for
   *     self-intersection
