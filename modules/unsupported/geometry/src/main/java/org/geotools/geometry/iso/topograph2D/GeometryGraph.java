...
//	}
     ...
     * @param computeRingSelfNodes if <false>, intersection checks are optimized to not test
     ...
     *
     * @param argIndex   Index of the geometry in relation to all input geometries (starts with 
     *                   0, 1, ...)
