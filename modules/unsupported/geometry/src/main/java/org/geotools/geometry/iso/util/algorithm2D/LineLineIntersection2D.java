...
public class LineLineIntersection2D {
  ...
  public void setValues(Line2D line0, Line2D line1) {
    ...
    if (n == 4) {
      /**
       * the segments are colinear and their interiors may overlap. The segments are equal if the
       * four itscs are real numbers, and in this case the four itscs must be 0.0 or 1.0. The second
       * possibility are two real numbers and two Double.NaN. In this case, the interiors of the
       * segments intersect
       */
      int count = 0;
  ...
  public boolean isCoincident() {
    /**
     * the segments are coincident if they overlap and the intersection itscs are 0.0 or 1.0. This
     * implies no NaN in the itscs
     */
    return (itsc != null)
        && (itsc.length == 4)
        && !isNaN(itsc[0])
  ...
  public boolean overlapsInterior() {
    /**
     * the interiors of the segments overlap if at least one of the four itsc is less then 1.0 and
     * greater then 0.0
     */
    return ((itsc != null)
        && (itsc.length == 4)
  ...
  public boolean intersectInteriorInteriorPoint() {
    /**
     * the interiors of the segments intersect at a node if both itscs are real number not equal 0.0
     * and not equal 1.0
     */
  ...
  public boolean isII() {
    /**
     * the interiors of the segments intersect if they intersect at one node or if their interior
     * overlap number and two itscs are Double.NaN
     */
  ...
  public boolean isIB() {
     ...
     * first itsc is a real number between 0.0 and 1.0 and the second itsc is a real number equal
     * 0.0 or 1.0
     *
  ...
  public boolean isBB() {
    /**
     * the boundary of both lines intersect if they have two or four itscs and the first itsc is a
     * real number equal 0.0 or 1.0 and the second itsc is a real itsc not equal 0.0 or 1.0
     *
