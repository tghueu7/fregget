    ...
    public Point2D[] intersectionPoint() {
        ...
        if (itsc == null) return null;
            ...
            if (count == 0) {
                ...
                // (q0,q1) *------------->*   *--------->*       *------------->*         
                // *-------->*
                // result: (0.0,NaN,0.0,0.8)  (0.0,0.8,0.0,NaN)  (NaN,1.0,0.4,1.0)   (0.3,1.0,
                // Nan,1.0)   
...
//    }
    ...
    public static double[] intersection(Point2D p0, Point2D p1, Point2D q0, Point2D q1) {
        ...
        // (q0,q1) *------------->*      *------>*         *------------->*        
        // *------------->*    *------------->*
        //   result: (0.0,1.0,0.0,1.0)  (0.2,0.8,NaN,NaN)   (NaN,NaN,0.2,0.8)    (0.2,NaN,NaN,
        // 0.8)       (NaN,0,8,0.2,NaN)
        //
        // (p0,p1) *----->*                     *------->*    *----->*                     
        // *------->*  
        ...
        // result: (1.0,NaN,NaN,0.0)     (NaN,0.0,1.0,NaN)    (1.0,NaN,NaN,0.0)     (NaN,0.0,1.0,
        // NaN)
        // Seg 0: \ /
        // \/ result: (0.5,0.5)
        // /\
