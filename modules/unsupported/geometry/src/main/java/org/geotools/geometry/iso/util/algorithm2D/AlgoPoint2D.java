...
public class AlgoPoint2D {
  ...
  public static boolean intersectWithHorizontalLineFromRight2D(Point2D p, Point2D p0, Point2D p1) {
  ...
  public static double minAngle2D(Point2D p, Point2D p1, Point2D p2) {
    double ang0 = AlgoPoint2D.getAngle2D(AlgoPoint2D.subtract(p1, p), AlgoPoint2D.subtract(p2, p));
    double ang1 = AlgoPoint2D.getAngle2D(AlgoPoint2D.subtract(p2, p1), AlgoPoint2D.subtract(p, p1));
