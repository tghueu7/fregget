...
public class CompositeCurveImpl extends CompositeImpl<OrientableCurveImpl>
   ...
   *
   * <p>NOTE To get a full representation of the elements in the Complex, the Points on the boundary
   * of the generator set of Curve would be added to the curves in the generator list.
   *
   * <p>The generator elements will be passed through the super constructor. The plausibility of the
   * Curves will be checked within the constructor of the CompositeCurve
   *
  ...
  private void checkConsistency() {
    ...
    if (!ci.hasNext()) throw new IllegalArgumentException("Curve has no elements."); // $NON-NLS-1$
