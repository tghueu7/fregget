...
public class CompositeCurveImpl extends CompositeImpl<OrientableCurveImpl>
        ...
        while (ci.hasNext()) {
            ...
            if (!endPoint.equals(startPoint)) {
                throw new IllegalArgumentException(
                        "Curve elements are not continous. The end point of a curve has to accord" +
                                " to the start point of the following curve."); //$NON-NLS-1$
            }
            c0 = c1;
        }
    ...
    public CompositeCurveImpl clone() throws CloneNotSupportedException {
        ...
        //return (CompositeCurveImpl) this.getFeatGeometryFactory().getComplexFactory()
        // .createCompositeCurve(newElements);
    }
