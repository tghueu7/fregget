...
public class Envelope implements Serializable {
  ...
  /**
   * Returns the <code>Envelope</code>s minimum x-value. min x > max x indicates that this is a null
   * <code>Envelope</code>.
   *
  ...
  /**
   * Returns the <code>Envelope</code>s maximum x-value. min x > max x indicates that this is a null
   * <code>Envelope</code>.
   *
  ...
  /**
   * Returns the <code>Envelope</code>s minimum y-value. min y > max y indicates that this is a null
   * <code>Envelope</code>.
   *
  ...
  /**
   * Returns the <code>Envelope</code>s maximum y-value. min y > max y indicates that this is a null
   * <code>Envelope</code>.
   *
  ...
  /**
   * Enlarges the boundary of the <code>Envelope</code> so that it contains <code>other</code>. Does
   * nothing if <code>other</code> is wholly on or within the boundaries.
   *
  ...
  /**
   * Check if the point <code>(x, y)</code> overlaps (lies inside) the region of this <code>Envelope
   * </code>.
   *
