...
/**
 * This class offers elementary arithmetic operations for the elementary data type 
 * <code>double</code>.
 * The operations are separated from the rest of the code to keep the option to interchange this 
 * package with a exact computation package (where needed).
 * <p>
