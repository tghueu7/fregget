...
//		geomList.addAll(resultPolyList);
     ...
     * That is a Point/Curve/Surface if the parameters only contain one point or one curve or one
     * surface.
     * It is a MultiPoint/MultiCurve/MultiSurface if the parameters contain one list with more 
     * than two entries and the other two lists are empty.
        ...
        if (nS == 0) {
            ...
            if (nC == 0 && nP == 0) {
                ...
                if (nS == 1) {
                    ...
                    // MULTISURFACE
                    return (GeometryImpl) aggregateFactory.createMultiSurface(new HashSet
                            (aSurfaces));
