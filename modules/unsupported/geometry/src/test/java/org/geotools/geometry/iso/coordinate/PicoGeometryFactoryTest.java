...
public class PicoGeometryFactoryTest extends TestCase {
    ...
    private void _testCoordinateObjects(PicoContainer c) {
        ...
        GeometryFactoryImpl cf = (GeometryFactoryImpl) c.getComponentInstanceOfType
                (GeometryFactory.class);
        PrimitiveFactoryImpl tPrimFactory = (PrimitiveFactoryImpl) c.getComponentInstanceOfType
                (PrimitiveFactoryImpl.class);
        PositionFactory positionFactory = (PositionFactory) c.getComponentInstanceOfType
        ...
        SurfaceBoundary boundary = new SurfaceBoundaryImpl(cf.getCoordinateReferenceSystem(), 
