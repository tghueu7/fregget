...
public class PicoMultiCurveTest extends TestCase {
    ...
    private void _testMultiCurve(PicoContainer c) {
        ...
        AggregateFactoryImpl af = (AggregateFactoryImpl) c.getComponentInstanceOfType
                (AggregateFactory.class);
        GeometryFactoryImpl gf = (GeometryFactoryImpl) c.getComponentInstanceOfType
        ...
        LineSegment line1 = gf.createLineSegment(dp1, pf.createDirectPosition(new double[]{20, 
                40}));
        LineSegment line2 = gf.createLineSegment(dp2, pf.createDirectPosition(new double[]{45, 
                25}));
