...
public class PicoPrimitiveFactoryTest extends TestCase {
    ...
    public void testProcessBoundsToInitialSegment() {
        ...
        PrimitiveFactoryImpl factory = (PrimitiveFactoryImpl) container
                .getComponentInstanceOfType(PrimitiveFactoryImpl.class);
        PositionFactory positionFactory = (PositionFactory) container.getComponentInstanceOfType
        ...
        LineSegmentImpl expected = new LineSegmentImpl(crs, new double[]{10, Double.NaN}, new 
                double[]{70, Double.NaN}, 0.0);
    ...
    public void testProcessBoundsToRing() {
        ...
        LineSegmentImpl segment = new LineSegmentImpl(crs, new double[]{10, Double.NaN}, new 
                double[]{70, Double.NaN}, 0.0);
    ...
    public void testCreatePrimitive() {
        ...
        // test equals
        SurfaceBoundary boundary = new SurfaceBoundaryImpl(crs, expectedRing, Collections
                .EMPTY_LIST);
    ...
    public void testBoundaryEquals() {
        ...
        CoordinateReferenceSystem crs = DefaultGeographicCRS.WGS84;
        PicoContainer container = container(crs); // normal 2D
        PositionFactoryImpl pf = (PositionFactoryImpl) container.getComponentInstanceOfType
                (PositionFactory.class);
        PrimitiveFactoryImpl prf = (PrimitiveFactoryImpl) container.getComponentInstanceOfType
