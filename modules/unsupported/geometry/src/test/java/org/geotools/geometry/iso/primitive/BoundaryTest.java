...
public class BoundaryTest extends TestCase {
    ...
    private void _testCurveBoundary1(GeometryBuilder builder) {
        ...
        PrimitiveFactoryImpl tPrimitiveFactory = (PrimitiveFactoryImpl) builder
                .getPrimitiveFactory();
        ...
        CurveBoundaryImpl b2 = new CurveBoundaryImpl(curveBoundary1.getCoordinateReferenceSystem
                (), point1, point2);
        try {
    ...
    private void _testSurfaceBoundary1(GeometryBuilder builder) {
        ...
        SurfaceBoundary surfaceBoundary1 = tPrimFactory.createSurfaceBoundary(exteriorring1, 
                interiors);
        ...
        if (surfaceBoundary1.getInteriors().size() > 0) {
            assertTrue(surfaceBoundary1.getInteriors().get(0) != surfaceBoundary2.getInteriors()
                    .get(0));
        }
