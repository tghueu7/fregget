...
//        System.out.println(ls.contains(p) + " " + ls.covers(p) + " " + p.within(ls) + " " + p
// .coveredBy(ls));
//    }


    /**
     * Tests a topologic relation between geometry objects and asserts the results according to 
     * the given should-values in the parameter list.
     *
...
//		assertTrue(shouldBeCoveredBy == result);
    ...
    private CompositeSurfaceImpl createCompositeSurfaceFromWKT(String aWKTsurface) {
        ...
        surfList.add(surf);
        return (CompositeSurfaceImpl) this.builder.getComplexFactory().createCompositeSurface
                (surfList);
    }
    ...
    private SurfaceImpl createSurfaceAwithoutHole() {
        String wktSurface1 = "SURFACE ((10 90, 30 50, 70 30, 120 40, 150 70, 150 120, 100 150, 30" +
                " 140, 10 90))";
    ...
    private SurfaceImpl createSurfaceAwithHole() {
        String wktSurface1 = "SURFACE ((10 90, 30 50, 70 30, 120 40, 150 70, 150 120, 100 150, 30" +
                " 140, 10 90), (90 60, 110 100, 120 90, 100 60, 90 60))";
        return this.createSurfaceFromWKT(wktSurface1);
    }

    private SurfaceImpl createSurfaceAwithTwoHoles() {
        String wktSurface1 = "SURFACE ((10 90, 30 50, 70 30, 120 40, 150 70, 150 120, 100 150, 30" +
                " 140, 10 90), (90 60, 110 100, 120 90, 100 60, 90 60), (30 100, 30 120, 50 120, " +
                "50 100, 30 100))";
        return this.createSurfaceFromWKT(wktSurface1);
    }
    ...
    private SurfaceImpl createSurfaceBwithHole() {
        // Clockwise oriented
        String wktSurface1 = "SURFACE ((100 10, 70 50, 90 100, 160 140, 200 90, 170 20, 100 10), " +
                "(120 30, 110 50, 120 80, 170 80, 160 40, 120 30))";
        return this.createSurfaceFromWKT(wktSurface1);
    }
    ...
    private CompositeSurfaceImpl createCompositeSurfaceAwithoutHole() {
        String wktSurface = "SURFACE ((10 90, 30 50, 70 30, 120 40, 150 70, 150 120, 100 150, 30 " +
                "140, 10 90))";
