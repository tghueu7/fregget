    ...
    public class graphicObject extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = 0; i < this.m_x.length - 1; i++) {
                if (this.m_objectType == PaintGMObject.TYPE_LINESTRING) {
                    g.drawLine(this.m_x[i] * this.m_scale, this.m_y[i] * this.m_scale * this
                            .m_YOrientation, this.m_x[i + 1] * this.m_scale, this.m_y[i + 1] * 
                            this.m_scale * this.m_YOrientation);
                } else if (this.m_objectType == PaintGMObject.TYPE_POINT) {
                    g.drawLine(this.m_x[i] * this.m_scale, this.m_y[i] * this.m_scale * this
                            .m_YOrientation, this.m_x[i] * this.m_scale, this.m_y[i] * this
                            .m_scale * this.m_YOrientation);
        ...
        private void paintCoordinateSystem(Graphics g) {
            ...
            for (int i = 0; i <= (int) (this.sizeX / 10); i++) {
                g.drawLine(0, i * 10 * this.m_scale * this.m_YOrientation, xMax, i * 10 * this
                        .m_scale * this.m_YOrientation);
            }
        }
