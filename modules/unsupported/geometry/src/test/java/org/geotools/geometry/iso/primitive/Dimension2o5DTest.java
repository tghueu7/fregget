...
//		//System.out.println("Intersection of curves: " + g);
    ...
    private void printCurve(CurveImpl curve1) {
        ...
        ////System.out.println("\nDimension Model: " + curve1.getFeatGeometryFactory()
        // .getDimensionModel());
    ...
    private void _testSurface(GeometryBuilder builder) {
        ...
        ////System.out.println("\n Dimension Model: " + surface.getFeatGeometryFactory()
        // .getDimensionModel());
    ...
    private Curve _createCurve2(GeometryBuilder builder) {
        ...
        PositionImpl p1 = new PositionImpl(tCoordFactory.createDirectPosition(new double[]{10, 0,
                100}));
        PositionImpl p2 = new PositionImpl(tCoordFactory.createDirectPosition(new double[]{50, 
                30, 100}));
