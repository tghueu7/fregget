...
*/
    ...
    private void _testPrimitiveObjects2D(PicoContainer c) {
        ...
        GeometryFactory cf = (GeometryFactoryImpl) c.getComponentInstanceOfType(GeometryFactory
                .class);
        PositionFactoryImpl posf = (PositionFactoryImpl) c.getComponentInstanceOfType
...
//		assertNotNull(prim1);
    ...
    private void _testPrimitiveObjects3D(PicoContainer c) {
        ...
        PrimitiveFactory pf = (PrimitiveFactoryImpl) c.getComponentInstanceOfType
                (PrimitiveFactory.class);
