...
public class PicoSurfaceTest extends TestCase {
  ...
  public void testMain() {
    ...
    PrimitiveFactoryImpl tPrimFactory =
        (PrimitiveFactoryImpl) container.getComponentInstanceOfType(PrimitiveFactoryImpl.class);
  ...
  public void _testOhterSurfaceMethods(
    ...
    // Following is commented-out because we are supposed to have a TriangulatedSurface, not plain
    // Surface.
