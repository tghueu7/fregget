...
public class PicoSurfaceTest extends TestCase {
    ...
    public void testMain() {
        ...
        GeometryFactoryImpl tGeomFactory = (GeometryFactoryImpl) container
                .getComponentInstanceOfType(GeometryFactory.class);
        PrimitiveFactoryImpl tPrimFactory = (PrimitiveFactoryImpl) container
                .getComponentInstanceOfType(PrimitiveFactoryImpl.class);
        //PositionFactory positionFactory = (PositionFactory ) container
        // .getComponentInstanceOfType( PositionFactory.class );
    ...
    private List<Triangle> _testTriangle1(GeometryFactoryImpl aGeomFactory, PrimitiveFactoryImpl 
            tPrimFactory) {
     ...
     * @param aGeomFactory
     */
    private void _testSurface1(GeometryFactoryImpl aGeomFactory, PrimitiveFactoryImpl 
            tPrimFactory) {
    ...
    public Surface _testSurface2(GeometryFactoryImpl aGeomFactory, PrimitiveFactoryImpl 
            tPrimFactory) {
...
//		System.out.print("\ngetDimension: " + surface.getDimension(null));
    ...
    public void _testOhterSurfaceMethods(GeometryFactoryImpl aGeomFactory, PrimitiveFactoryImpl 
            tPrimFactory) {
        ...
        // test obj equals
        assertTrue(surfaceBoundary1.equals((Object) tPrimFactory.createSurfaceBoundary
                (exteriorRing, interiors)));
        ...
        SurfaceBoundaryImpl surfaceBoundary2 = tPrimFactory.createSurfaceBoundary(exteriorRing2, 
                interiors);
        ...
        // plain Surface.
        // This Surface is built above in this test case, so its seems to be something to fix in 
        // the test suite.
