...
public class GeometryTestOperation extends Assert {
    ...
    private static final Logger LOG = org.geotools.util.logging.Logging.getLogger("org.geotools" +
            ".geometry");
     ...
     */
    public GeometryTestOperation(String operation, String arg1, String arg2, String arg3, Object 
            expectedResult) {
    ...
    public void runTest(Geometry a, Geometry b) {
        ...
        assertNotNull("Test Suite Error: No Operation Handler setup for operation: " + operation,
                ophand);
