...
public class ConvexHullTest extends TestCase {
    ...
    private void _testPoints() {
        ...
        MultiPointImpl mp = (MultiPointImpl) this.builder.getAggregateFactory().createMultiPoint
                (points);
    ...
    private SurfaceImpl createSurfaceConcaveX() {
        // Clockwise oriented
        String wktSurface1 = "SURFACE ((100 10, 70 50, 90 100, 130 50, 110 100, 160 140, 200 90, " +
                "170 20, 150 30, 130 10 ,100 10))";
        return this.createSurfaceFromWKT(wktSurface1);
    }
