...
public class PicoPointTest extends TestCase {
    ...
    protected void createPointAndTest(PicoContainer c, double[] ords) {
        ...
        PrimitiveFactoryImpl primitiveFactory = (PrimitiveFactoryImpl) c
                .getComponentInstanceOfType(PrimitiveFactory.class);
        assertSame(positionFactory.getCoordinateReferenceSystem(), primitiveFactory
