...
public class PicoLineSegmentTest extends TestCase {
    ...
    public void testEquals() {
        ...
        GeometryFactoryImpl factory = (GeometryFactoryImpl) container.getComponentInstanceOfType
    ...
    private LineSegmentImpl createLineSegment(DirectPosition positionA, DirectPosition positionB) {
        return new LineSegmentImpl(positionA.getCoordinateReferenceSystem(), positionA
