...
public class CentroidTest extends TestCase {
    ...
    private void _testSurfaces2D() {
        ...
        res = this.createSurfaceAwithoutHole().getBoundary().getExterior().getCentroid()
                .getCoordinate();
        ////System.out.println(this.createSurfaceAwithoutHole().getBoundary().getExterior()
        // .getCentroid());
        assertTrue(Math.round(res[0] * 1000) == 82178);
        assertTrue(Math.round(res[1] * 1000) == 91658);
    ...
    private MultiPointImpl createMultiPointA() {
        ...
        return (MultiPointImpl) new MultiPointImpl(crs, points); //this.factory
        // .getAggregateFactory().createMultiPoint(points);
    }
    ...
    private CurveImpl createCurveX() {
        String wktCurve1 = "CURVE(70 20, 100 20, 100 50, 120 60, 130 80, 120 90, 130 100, 140 " +
                "110, 200 220, -50 220, -60 210, -120 100, 0 0)";
        return this.createCurveFromWKT(wktCurve1);
    }
