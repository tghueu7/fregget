...
public class PicoLineStringLineSegmentTest extends TestCase {
    ...
    private void _testLineString1(PicoContainer c) {
        ...
        GeometryFactoryImpl tGeomFactory = (GeometryFactoryImpl) c.getComponentInstanceOfType
                (GeometryFactory.class);
        PositionFactoryImpl tPosFactory = (PositionFactoryImpl) c.getComponentInstanceOfType
