...
public class PointArrayTest extends TestCase {
    ...
    private void _test1(GeometryBuilder builder) {
        ...
        DirectPosition directPositionAddition = tCoordFactory.createDirectPosition(new 
                double[]{5, 5});
        pa.setDirectPosition(4, directPositionAddition); // test to see of object or values is 
        // stored        
        ...
        assertNotSame("Not the same object we put into 4", directPositionAt4mk2, 
                directPositionAddition);
