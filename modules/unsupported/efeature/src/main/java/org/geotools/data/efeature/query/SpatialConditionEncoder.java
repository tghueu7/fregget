...
public class SpatialConditionEncoder {
    ...
    public static Condition bbox(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return bbox((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition bbox(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return bbox((Geometry) DataBuilder.toValue(type, value), swapped);
    }
    ...
    public static Condition beyond(EDataType type, Literal value, double distance) throws 
            EFeatureEncoderException {
        return beyond((Geometry) DataBuilder.toValue(type, value), distance);
    }

    public static Condition beyond(EDataType type, Object value, double distance) throws 
            EFeatureEncoderException {
        return beyond((Geometry) DataBuilder.toValue(type, value), distance);
    }
    ...
    public static Condition dwithin(EDataType type, Literal value, double distance) throws 
            EFeatureEncoderException {
        return dwithin((Geometry) DataBuilder.toValue(type, value), distance);
    }

    public static Condition dwithin(EDataType type, Object value, double distance) throws 
            EFeatureEncoderException {
        return dwithin((Geometry) DataBuilder.toValue(type, value), distance);
    }

    public static Condition dwithin(Literal value, double distance) throws 
            EFeatureEncoderException {
    ...
    public static Condition contains(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return contains((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition contains(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return contains((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition contains(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition crosses(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return crosses((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition crosses(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return crosses((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition crosses(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition disjoint(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return disjoint((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition disjoint(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return disjoint((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition disjoint(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition equals(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return equals((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition equals(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return equals((Geometry) DataBuilder.toValue(type, value), swapped);
    }
    ...
    public static Condition intersects(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return intersects((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition intersects(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return intersects((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition intersects(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition overlaps(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return overlaps((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition overlaps(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return overlaps((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition overlaps(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition touches(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return touches((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition touches(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return touches((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition touches(Literal value, boolean swapped) throws 
            EFeatureEncoderException {
    ...
    public static Condition within(EDataType type, Literal value, boolean swapped) throws 
            EFeatureEncoderException {
        return within((Geometry) DataBuilder.toValue(type, value), swapped);
    }

    public static Condition within(EDataType type, Object value, boolean swapped) throws 
            EFeatureEncoderException {
        return within((Geometry) DataBuilder.toValue(type, value), swapped);
    }
