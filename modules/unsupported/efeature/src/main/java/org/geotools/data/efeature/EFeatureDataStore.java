...
public class EFeatureDataStore extends ContentDataStore {
     ...
     *                                                       eType    := &lt;eFolder&gt;.&lt;
     *                                                       eFeature&gt;
     *                                                       eFolder  := the name of the 
     *                                                       {@link EFeatureFolderInfo folder} 
     *                                                       which contains the 
     *                                                       {@link EFeatureInfo feature}
     *                                                       eFeature := the name of the 
     *                                                       {@link EFeatureInfo feature type}
     *                                                       </pre>
    ...
    public EFeatureDataStore(String eContextID, String eDomainID, String eNsURI,
                             String eURI, String eTypes, boolean eWritable) throws IOException,
            IllegalArgumentException {
        //
        // Forward using same context factory as EFeatureDataStoreFactory
        //
        this(EFeatureDataStoreFactory.eGetContextFactory().eContext(eContextID), eDomainID,
                eNsURI, eURI, eTypes, eWritable);
    }
     ...
     *                                                    eFeature&gt;
     *                                                    eFolder  := the name of the 
     *                                                    {@link EFeatureFolderInfo folder} which
     *                                                    contains the {@link EFeatureInfo feature}
     *                                                    eFeature := the name of the 
     *                                                    {@link EFeatureInfo feature type}
     *                                                    </pre>
     * @param eWritable - if <code>true</code> {@link EFeature}s are writable
    ...
    public FeatureTypeFactory getFeatureTypeFactory() {
        throw new UnsupportedOperationException("EFeatureDataStore does not support " +
                "FeatureTypeFactory");
    }
     ...
     *
     *                                           eFolder  := the name of the 
     *                                           {@link EFeatureFolderInfo folder} which contains
     *                                           the {@link EFeatureInfo feature}
     *                                           eFeature := the name of the 
     *                                           {@link EFeatureInfo feature}
     *                                           </pre>
     ...
     * @param tx     - (Optional) {@link Transaction} controlling modifications. If 
     *               <code>null</code>,
     ...
     */
    public final FeatureWriter<SimpleFeatureType, SimpleFeature> getEFeatureWriter(String eType,
                                                                                   Filter filter,
                                                                                   Transaction
                                                                                           tx)
            throws IOException {
    ...
    @Override
    public EFeatureReader getFeatureReader(Query query, Transaction transaction) throws 
            IOException {
     ...
     * where
     *
     * eFolder  := the name of the {@link EFeatureFolderInfo folder} which contains the 
     * {@link EFeatureInfo feature}
