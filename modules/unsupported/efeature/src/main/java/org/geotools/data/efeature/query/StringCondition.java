...
public class StringCondition extends org.eclipse.emf.query.conditions.strings.StringCondition {
     ...
     * The numeric {@literal <=} operator.
     */
    public static RelationalOperator LESS_THAN_OR_EQUAL_TO = RelationalOperator
     ...
     * The numeric {@literal >=} operator.
     */
    public static RelationalOperator GREATER_THAN_OR_EQUAL_TO = RelationalOperator
     ...
     *
     * @param between    - if <code>true</code>, use the {@link #BETWEEN} operator. Otherwise use
     *                  the {@link #OUTSIDE} operator
     ...
     * @since 1.2
     */
    public StringCondition(boolean between, String lowerBound, String upperBound, StringAdapter 
            adapter) {
     ...
     *
     * @param between        - if <code>true</code>, use the {@link #BETWEEN} operator. Otherwise
     *                      use the {@link #OUTSIDE} operator
     * @param lowerBound     - the lower bound to test
    ...
    public StringCondition(boolean between, String lowerBound, boolean lowerInclusive,
        ...
        this(between, lowerBound, lowerInclusive, upperBound, upperInclusive, StringAdapter
                .DEFAULT);
    }
