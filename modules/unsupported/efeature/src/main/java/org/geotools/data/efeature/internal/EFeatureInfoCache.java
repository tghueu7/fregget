 ...
 * where
 *
 *  {@link EFeatureInfo#eNsURI() &lt;eNsURI&gt;}        := is the 
 *  {@link EPackage#getNsURI() EMF package namespace URI}
 *  {@link EFeatureInfo#eFolderName() &lt;eFolder&gt;}       := is the 
 *  {@link EFeatureFolderInfo#eName() folder name}
 *  {@link EFeatureInfo#eName() &lt;eFeature&gt;}      := is the {@link EClass#getName() name} of
 *  the {@link EFeature} compatible {@link EClass implementation}
 * </pre>
 * <p>
...
public final class EFeatureInfoCache {
    ...
    private final EFeatureStatus DENIED =
            EFeatureUtils.newStatus(this, EFeatureStatus.FAILURE, "FeatureInfo was not allowed to" +
                    " be cached", null);
