...
public class EFeatureUtils {
    ...
    public static EFeatureStatus newStatus(final Object source, final int type,
        ...
        if (!(cause instanceof Throwable || cause instanceof StackTraceElement[] || cause == 
                null)) {
        ...
        return new EFeatureStatus() {
            ...
            public StackTraceElement[] getStackTrace() {
                return (cause instanceof Throwable ? ((Throwable) cause).getStackTrace() : 
    ...
    public static EStructuralFeature eGetStructuralFeature(EPackage.Registry eRegistry,
                                                           EClass eClass, String eName, String 
                                                                   eNsURI) {
    ...
    public static EFeatureQuery toEFeatureQuery(
        ...
        //
        EFeatureInfo eInfo = EFeatureContextHelper.ePrototype(EFeaturePackage.eINSTANCE
                .getEFeature());
        //
        // Forward
        //
