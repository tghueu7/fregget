...
public class EFeatureContextInfo extends EStructureInfo<EFeatureContextInfo> {
    ...
    /**
     * Adapt given {@link EFeatureInfo structure} to this 
     * {@link EFeatureContext#eContext() context}.
     *
     ...
     *              adapted.
     *              If <code>false</code>, the structure is claimed from it's context (moved into
     *              to this context).
     ...
     */
    protected static final Map<String, EFeaturePackageInfo> synchronize(EFeatureContextInfo 
                                                                                eContextInfo) {
        EChange eChange = new EChange();
    ...
    private static class EChange {
         ...
         * {@link EFeatureContextInfo} instances.
         */
        public final Map<String, EFeaturePackageInfo> synchronize(EFeatureContextInfo 
                                                                          eContextInfo) {
            //
