...
public interface EFeatureIDFactory {
     ...
     * @throws IllegalStateException    If given {@link EObject} is not added to an EMF 
     * {@link Resource}.
     */
     ...
     * @throws IllegalArgumentException If the factory does not create IDs for given {@link EObject}
     */
    public String useID(EObject eObject, String eID) throws IllegalArgumentException, 
