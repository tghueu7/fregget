...
public class EFeatureDelegate implements EFeature, InternalEObject {
     ...
     *                   is a valid structure for 'eImpl'. Use this when option to optimize 
     *                   construction
    ...
    public EFeatureDelegate(EFeatureInfo eStructure, InternalEObject eImpl,
                            boolean eTrusted, EFeatureHints eHints) throws 
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case EFeaturePackage.EFEATURE__DEFAULT:
                return DEFAULT_EDEFAULT == null ? getDefault() != null : !DEFAULT_EDEFAULT.equals
                        (getDefault());
            case EFeaturePackage.EFEATURE__STRUCTURE:
    ...
    public NotificationChain eBasicSetContainer(InternalEObject newContainer,
                                                int newContainerFeatureID, NotificationChain 
                                                            notifications) {
     ...
     */
    public static final EFeatureDelegate create(EFeatureInfo eStructure, InternalEObject eImpl, 
                                                boolean eTrusted) {
     ...
     * @param eTrusted   - if <code>true</code>, the method will not validate structure against 
     *                   implementation.
     * @param eHints     - if {@link EFeatureHints#EFEATURE_SINGLETON_FEATURES} is 
     *                   <code>true</code>,
    ...
    public static final EFeatureDelegate create(EFeatureInfo eStructure,
                                                InternalEObject eImpl, boolean eTrusted, 
