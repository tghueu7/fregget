...
public class DataTypes {
    ...
    private final static Map<String, IDataTypeAdapter<?>> adapterMap = new HashMap<String, 
            IDataTypeAdapter<?>>();
    ...
    public static final byte[] WKB_POLYGON_EMPTY = new byte[]{0, 0, 0, 0, 3, 0, 0, 0, 1, 0, 0, 0,
            0};
    public static final byte[] WKB_LINESTRING_EMPTY = new byte[]{0, 0, 0, 0, 2, 0, 0, 0, 0};
    public static final byte[] WKB_POINT_EMPTY = new byte[]{}; // Apparently, there is no WKB 
    // convention for "POINT EMPTY"
    ...
    private static void support(String name, Class<?> type, IDataTypeAdapter<?> adapter, 
                                Object... unique) {
    ...
    private static void support(Class<?> primitive, Class<?> wrapper, IDataTypeAdapter<?> 
            adapter, Object... unique) {
