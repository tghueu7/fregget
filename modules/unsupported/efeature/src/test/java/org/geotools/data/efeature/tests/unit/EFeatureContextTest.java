...
public class EFeatureContextTest extends AbstractEFeatureTest {
    ...
    private static void assertState(EStructureInfo<?> eInfo, boolean isAvailable, boolean 
            isValid, boolean isDisposed) {
    ...
    private static void assertStructure(String msg, EFeatureInfo eInfo) {
        ...
        assertEquals(msg + ". EFeature[" + eInfo.eName() + "] property count mismatch", pcount, 
                eInfo.eGetAttributeInfoList(true).size());
        assertEquals(msg + ". EFeatureAttributeInfo[" + eInfo.eName() + "] count mismatch", 
                acount, eInfo.eGetAttributeInfoList(false).size());
        assertStructure(msg, eInfo.eName(), eInfo.eGetAttributeInfoList(false));
        assertEquals(msg + ". EFeatureGeometryInfo[" + eInfo.eName() + "] count mismatch", 
                gcount, eInfo.eGetGeometryInfoMap().size());
        assertStructure(msg, eInfo.eGetGeometryInfoMap().values().iterator().next());

    }

    private static void assertStructure(String msg, String eName, 
                                        Collection<EFeatureAttributeInfo> eInfos) {
