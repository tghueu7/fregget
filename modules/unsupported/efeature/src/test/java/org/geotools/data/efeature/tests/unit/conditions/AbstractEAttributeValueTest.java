 ...
 * @source $URL$
 */
public abstract class AbstractEAttributeValueTest extends 
        AbstractEAttributeFilterTest<EFeatureData<Object, Geometry>> {
    ...
    protected static final Values NUMBERS[] = new Values[]{
            new Values(NUMBER_OPS, Integer.class, Integer.MIN_VALUE, Integer.MAX_VALUE, new 
                    Integer(1)),
            new Values(NUMBER_OPS, Double.class, Double.MIN_VALUE, Double.MAX_VALUE, new Double
                    (1.0)),
            ...
            new Values(NUMBER_OPS, Short.class, Short.MIN_VALUE, Short.MAX_VALUE, new Short(
                    (short) 1)),
    ...
    protected static final Values DATES[] = new Values[]{
            new Values(DATE_OPS, Integer.class, new Date(Long.MIN_VALUE), new Date(Long
                    .MAX_VALUE), new Date(0))};

    /**
     * Cached character values
     */
    protected static final Values CHARACTERS[] = new Values[]{
            new Values(CHARACTER_OPS, Character.class, Character.MIN_VALUE, Character.MAX_VALUE, 
     ...
     */
    protected static final EAttribute eAttribute = EFeatureTestsPackage.eINSTANCE
    ...
    @Override
    protected final void updateFixture(EFeatureData<Object, Geometry> eFixture, int value, int 
            pass) {
        //
        // Update values
        //
    ...
    protected abstract Condition createCondition(int value, Object filter) throws 
