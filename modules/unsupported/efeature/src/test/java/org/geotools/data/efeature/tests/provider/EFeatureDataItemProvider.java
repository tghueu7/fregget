                ...
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        "_UI_EFeature_SRID_feature", "_UI_EFeature_type"), 
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        "_UI_EFeature_data_feature", "_UI_EFeature_type"), 
                                //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        "_UI_EFeature_default_feature", "_UI_EFeature_type"), 
                                //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        "_UI_EFeature_structure_feature", "_UI_EFeature_type"), 
                                //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        "_UI_EFeature_ID_feature", "_UI_EFeature_type"), 
                                //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ...
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        ...
                                        "_UI_EFeatureData_type"), //$NON-NLS-1$ //$NON-NLS-2$ 
                                // $NON-NLS-3$
