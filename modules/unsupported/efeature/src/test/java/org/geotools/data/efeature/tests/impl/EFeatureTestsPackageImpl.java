...
public class EFeatureTestsPackageImpl extends EPackageImpl implements EFeatureTestsPackage {
     ...
     * <p>
     * <p>This method is used to initialize {@link EFeatureTestsPackage#eINSTANCE} when that 
     * field is accessed.
    ...
    public static EFeatureTestsPackage init() {
        if (isInited)
            return (EFeatureTestsPackage) EPackage.Registry.INSTANCE.getEPackage
                    (EFeatureTestsPackage.eNS_URI);

        // Obtain or create and register package
        EFeatureTestsPackageImpl theEFeatureTestsPackage = (EFeatureTestsPackageImpl) (EPackage
                .Registry.INSTANCE.get(eNS_URI) instanceof EFeatureTestsPackageImpl ? EPackage
                .Registry.INSTANCE.get(eNS_URI) : new EFeatureTestsPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        EFeaturePackage theEFeaturePackage = (EFeaturePackage) EPackage.Registry.INSTANCE
                .getEPackage(EFeaturePackage.eNS_URI);
        ...
        //$NON-NLS-1$
        ETypeParameter eFeatureCompatibleDataEClass_A = addETypeParameter
                (eFeatureCompatibleDataEClass, "A"); //$NON-NLS-1$
        ETypeParameter eFeatureCompatibleDataEClass_G = addETypeParameter
                (eFeatureCompatibleDataEClass, "G"); //$NON-NLS-1$
        ...
        initEClass(eFeatureDataEClass, EFeatureData.class, "EFeatureData", !IS_ABSTRACT, 
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        g1 = createEGenericType(eFeatureDataEClass_A);
        initEAttribute(getEFeatureData_Attribute(), g1, "attribute", null, 1, 1, EFeatureData
                .class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, 
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        g1 = createEGenericType(eFeatureDataEClass_G);
        initEAttribute(getEFeatureData_Geometry(), g1, "geometry", null, 1, 1, EFeatureData
                .class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, 
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

        initEClass(nonGeoEObjectEClass, NonGeoEObject.class, "NonGeoEObject", !IS_ABSTRACT, 
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getNonGeoEObject_NonGeoAttribute(), ecorePackage.getEInt(), 
                "nonGeoAttribute", null, 0, 1, NonGeoEObject.class, !IS_TRANSIENT, !IS_VOLATILE, 
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); 
        //$NON-NLS-1$

        initEClass(eFeatureCompatibleDataEClass, EFeatureCompatibleData.class, 
                "EFeatureCompatibleData", !IS_ABSTRACT, !IS_INTERFACE, 
                IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getEFeatureCompatibleData_ID(), ecorePackage.getEString(), "ID", null, 1, 
                1, EFeatureCompatibleData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, 
                !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        g1 = createEGenericType(eFeatureCompatibleDataEClass_A);
        initEAttribute(getEFeatureCompatibleData_Attribute(), g1, "attribute", null, 1, 1, 
                EFeatureCompatibleData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, 
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        g1 = createEGenericType(eFeatureCompatibleDataEClass_G);
        initEAttribute(getEFeatureCompatibleData_Geometry(), g1, "geometry", null, 1, 1, 
                EFeatureCompatibleData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, 
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        initEAttribute(getEFeatureCompatibleData_SRID(), ecorePackage.getEString(), "SRID", null,
                1, 1, EFeatureCompatibleData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, 
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
        initEAttribute(getEFeatureCompatibleData_Default(), ecorePackage.getEString(), "default",
                null, 1, 1, EFeatureCompatibleData.class, !IS_TRANSIENT, !IS_VOLATILE, 
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); 
        //$NON-NLS-1$
