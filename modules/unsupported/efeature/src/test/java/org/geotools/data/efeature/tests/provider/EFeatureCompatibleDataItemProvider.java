 ...
 * {@link org.geotools.data.efeature.tests.EFeatureCompatibleData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class EFeatureCompatibleDataItemProvider
                ...
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                getString("_UI_PropertyDescriptor_description", 
                                        ...
                                        "_UI_EFeatureCompatibleData_type"), //$NON-NLS-1$ 
                                // $NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addAttributePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                getResourceLocator(),
                                getString("_UI_EFeatureCompatibleData_attribute_feature"), 
                                //$NON-NLS-1$
                                getString("_UI_PropertyDescriptor_description", 
    ...
    protected void addGeometryPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                getResourceLocator(),
                                getString("_UI_EFeatureCompatibleData_geometry_feature"), 
                                //$NON-NLS-1$
                                getString("_UI_PropertyDescriptor_description", 
    ...
    protected void addDefaultPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                getResourceLocator(),
                                getString("_UI_EFeatureCompatibleData_default_feature"), 
                                //$NON-NLS-1$
                                getString("_UI_PropertyDescriptor_description", 
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage
                ("full/obj16/EFeatureCompatibleData")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
                ...
                getString("_UI_EFeatureCompatibleData_type") + " " + label; //$NON-NLS-1$ 
        // $NON-NLS-2$
    }
