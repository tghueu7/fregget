...
public class LocaleUtils {
  ...
  /**
   * Tests whether the given {@code Locale} is fully supported (ie. has been provided for every GUI
   * text string properties file.
   *
  ...
  /**
   * Tests whether the given {@code Locale} is supported. A locale is treated as supported if it has
   * been provided for at least one GUI text string properties file.
   *
   * @param locale the locale
   ...
   * Locale#ROOT} in the input list. It will be added automatically. If {@code preferredLocales} is
   * {@code null} or empty, the working locale will be set to {@linkplain Locale#ROOT}.
   *
   ...
   * locales, ensuring that only supported locales are present and that {@code Locale.ROOT} appears
   * last.
   *
