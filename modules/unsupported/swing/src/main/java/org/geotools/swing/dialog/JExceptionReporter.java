...
public class JExceptionReporter {
   ...
   *
   * @param exception exception to display
   * @param message message to display; if {@code null} or empty the message will be taken from the
   *     exception
   */
  ...
  /**
   * The dialog used to display the {@code Exception}. It is package-private rather than private to
   * enable unit tests.
   */
