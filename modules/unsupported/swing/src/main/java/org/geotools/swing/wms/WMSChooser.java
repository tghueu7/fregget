...
public class WMSChooser {
    ...
    private static List<String> defaultServers() {
        ...
        servers.add("http://wms.jpl.nasa.gov/wms" +
                ".cgi?Service=WMS&Version=1.1.1&Request=GetCapabilities");
        servers.add("http://localhost:8080/geoserver/wms?service=WMS&request=GetCapabilities");
        servers.add("http://www2.dmsolutions" +
                ".ca/cgi-bin/mswms_gmap?Service=WMS&VERSION=1.1.0&REQUEST=GetCapabilities");
        servers.add("http://giswebservices.massgis.state.ma" +
                ".us/geoserver/wms?service=WMS&request=GetCapabilities");
        servers.add("http://wms.cits.rncan.gc.ca/cgi-bin/cubeserv" +
                ".cgi?VERSION=1.1.0&REQUEST=GetCapabilities");
        servers.add("http://atlas.gc.ca/cgi-bin/atlaswms_en?VERSION=1.1.1&Request=GetCapabilities" +
                "&Service=WMS");
        return servers;
    }
}
