...
public abstract class JPage {
   ...
   *
   * <p>Please note this method will normally only be called once; even if the user clicks forwards
   * and backwards to return to your page. It is only called if getPanel() returns null.
   *
   ...
   *
   * <p>This is a good time to populate your fields with values; hook up any listeners and gernally
   * muck about.
   */
