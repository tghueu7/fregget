...
public class KeyInfo {
  ...
  /**
   * Gets the short text description for this object. This can be useful for GUI labels, menu items
   * etc.
   *
   ...
   * KeyEvent}. For convenience, this method will return {@code false} if the input event is {@code
   * null}.
   *
