...
public class JProgressWindow implements ProgressListener {
  ...
  /**
   * Initial height for the progress window, in pixels. Increase this value if some component (e.g.
   * the "Cancel" button) seems truncated. The current value has been tested for Metal look and
   * feel.
   */
   ...
   * EventQueue#invokeAndWait} method. The {@code set} operations have positive identifiers and are
   * executed by the {@link EventQueue#invokeLater} method.
   *
