...
public class DnDListModel<T> extends AbstractListModel {
   ...
   *
   * @param destIndex the position of the new item: if &lt; 0 the item will be inserted at the start
   *     of the list; if &gt;= the current list size the item will be appended to the end of the
   *     list
   */
   ...
   *     start of the list; if &gt;= the current list size the items will be appended to the end of
   *     the list
   */
