...
public class JWizard extends JDialog {
  ...
  /**
   * Registers the page with this JWizard. The page is stored by its identifier (so other pages can
   * look it up). The page.setJWizard() method is also called so the page can refer to its
