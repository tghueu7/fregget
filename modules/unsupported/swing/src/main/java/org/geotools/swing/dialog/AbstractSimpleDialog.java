...
public abstract class AbstractSimpleDialog extends JDialog {
  ...
  /**
   * Creates the main control panel and components. This must be called by the sub-class. We do this
   * to give sub-classes the chance to initialize fields which can be used within {@linkplain
  ...
  /**
   * Called when the cancel button is pressed. The base implementation simply closes (disposes) the
   * dialog.
   */
