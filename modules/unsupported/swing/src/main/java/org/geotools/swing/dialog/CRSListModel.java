...
public class CRSListModel extends AbstractListModel {
  ...
  /**
   * Constructor. Populates the model with available reference systems for the specified authority.
   * If {@code authority} is {@code null} or empty, it defaults to {@link
