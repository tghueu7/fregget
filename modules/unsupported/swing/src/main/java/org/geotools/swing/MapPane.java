...
public interface MapPane {
  ...
  /**
   * Gets the current mouse event dispatcher which is responsible for converting each input Java AWT
   * mouse event into a {@linkplain org.geotools.swing.event.MapMouseEvent} and forwarding it to
   * each {@linkplain MapMouseListener}.
   *
