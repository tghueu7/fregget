...
public class JMapStatusBar extends JPanel {
  ...
  /**
   * Adds a new item to the status bar. The item will display a border and appear in the status bar
   * configuration menu. If the item is already present in the status bar it will not added again
  ...
  /**
   * Adds a new item to the status bar. If the item is already present in the status bar it will not
   * added again and the method will return {@code false}.
   *
   * @param item the item to add
