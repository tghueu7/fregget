...
public class MapLayerTableCellRenderer extends JPanel implements ListCellRenderer {
  ...
  /**
   * Items used to display layer states and controls. Each item has one or two icons associated with
   * it: one for simple controls, two for toggle controls.
   */
  public static enum LayerControlItem {
    ...
    VISIBLE(
        new ImageIcon(
            MapLayerTableCellRenderer.class.getResource("/org/geotools/swing/icons/eye_open.png")),
        new ImageIcon(
            MapLayerTableCellRenderer.class.getResource(
                "/org/geotools/swing/icons/eye_closed.png"))),

    /**
     * Layer selection - the selected status of layers can be used to include or exclude them in map
     * queries etc.
     */
    SELECTED(
        new ImageIcon(
            MapLayerTableCellRenderer.class.getResource("/org/geotools/swing/icons/tick.png")),
        new ImageIcon(
            MapLayerTableCellRenderer.class.getResource("/org/geotools/swing/icons/cross.png"))),
    ...
    /**
     * Get the icon used to signify the 'off' state. If called for a non-toggle control this returns
     * the single icon.
     *
     * @return the icon
     */
  ...
  /**
   * Check if a point representing a mouse click location lies within the bounds of the layer style
   * label
   *
   * @param p coords of the mouse click; relative to this cell's origin
   * @return true if the point is within the label bounds; false otherwise
  ...
  /**
   * Check if a point representing a mouse click location lies within the bounds of the remove layer
   * label
   *
   * @param p coords of the mouse click; relative to this cell's origin
   * @return true if the point is within the label bounds; false otherwise
