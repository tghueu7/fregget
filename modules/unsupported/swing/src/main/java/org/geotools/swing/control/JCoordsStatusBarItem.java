...
public class JCoordsStatusBarItem extends StatusBarItem {
  ...
  /**
   * Examines the map extent and tries to determine the number of digits that will be needed in the
   * display. If a coordinate reference system with valid extent defined, it is used to determine
   * coordinate limits; otherwise the extent of the envelope is used directly. If all else fails, a
   * default number of digits is set.
   *
