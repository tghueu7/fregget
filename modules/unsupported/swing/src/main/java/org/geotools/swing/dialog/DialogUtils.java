...
public class DialogUtils {
  ...
  /**
   * Returns {@code input} if not {@code null} or empty, otherwise returns {@code fallback}. This is
   * handy for setting dialog titles etc. Note that the input string is considered empty if {@code
   * input.trim().length() == 0}.
   *
  ...
  /**
   * Helper method for {@linkplain #getHtmlLabelTextExtent(java.lang.String, int, boolean)}. This is
   * required because we are creating and invisibly rendering a {@code JLabel} object in this
