...
public class JTextReporter {
  ...
  /**
   * Constant indicating that a text reporter should be displayed as a modal dialog. Use with {@code
  ...
  /**
   * Default flags argument for {@code showDialog} methods. Equivalent to {@code FLAG_ALWAYS_ON_TOP
   * | FLAG_RESIZABLE}.
   */
  ...
  /**
   * A connection to an active text reporter dialog providing methods to update the text displayed,
   * add or remove listeners, and close the dialog programatically.
   */
  public static class Connection {
    ...
    /**
     * Closes the associated dialog. The close operation is run on the event dispatch thread to try
     * to avoid collisions with GUI actions, but you can call this method from any thread.
     *
     * <p>It is safe to call this method speculatively: a {@linkplain Level#INFO} message will be
     * logged but no error thrown.
     */
