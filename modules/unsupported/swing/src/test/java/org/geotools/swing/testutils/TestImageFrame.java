...
public class TestImageFrame {
  ...
  /**
   * Displays the given image in an {@linkplain ImageFrame} and counts down the returned latch when
   * the frame is closed. This allows test methods to display an image and then wait until the user
   * dismisses the frame.
   *
   * <pre><code>
   * // In test method
