...
public class JFileImageChooserTest extends GraphicsTestBase<Dialog> {
  ...
  public void showOpenFileDisplaysSupportedFormats() throws Exception {
    ...
    for (int i = 0; i < N; i++) {
      ...
      assertTrue(
          "file suffix not a supported format: " + suffix, readerFileSuffixes.contains(suffix));
    }
  }
  ...
  public void showSaveFileDisplaysSupportedFormats() throws Exception {
    ...
    for (int i = 0; i < N; i++) {
      ...
      assertTrue(
          "file suffix not a supported format: " + suffix, writerFileSuffixes.contains(suffix));
    }
  }
