        ...
        GuiActionRunner.execute(
            new GuiQuery<JFrame>() {
              ...
              protected JFrame executeInEDT() throws Throwable {
                ...
                /**
                 * mbedward: I tried overriding the label's paintComponent method to disable text
                 * anti-aliasing in order to make searching for the red and blue dots easier, but
                 * the rendering hint did not seem to affect HTML rendering. So instead, the
                 * findColorInRange method is used to allow for the fuzz of colour values.
                 */
