...
public class DefaultsProcess {
    ...
    public Map<String, Object> execute(
            ...
            @DescribeParameter(name = "int", defaultValue = "1", minValue = -1d, maxValue = 2d) 
                    int i,
            @DescribeParameter(name = "double", defaultValue = "0.65e-10", minValue = -1.5, 
                    maxValue = 2.5) double d,
            ...
            @DescribeParameter(name = "rect", defaultValue = "org.geotools.process.factory" +
                    ".BeanProcessFactoryTest#DEFAULT_RECTANGLE") Rectangle rect) {
