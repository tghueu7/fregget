...
public class ProcessFunction implements Function {
  ...
  public ProcessFunction(
    ...
    this.name =
        nsuri == null ? processName.getLocalPart() : nsuri + ":" + processName.getLocalPart();
   ...
   * input expressions, and may be null if no context is available (for instance, when being called
   * to evaluation the inputs for the {@link RenderingProcessFunction} inversion methods).
   *
