...
public class Processors extends FactoryFinder {
   ...
   * results.
   *
   * <p>Note the expected results are generated in part by the input parameters provided; this is to
  ...
  /**
   * Reinitializes all static state, including the ProcessFactory service registry and reference to
   * the last used ProcessFactory
   */
  ...
  /**
   * This progress listener checks if the current Thread is interrupted, it acts as a bridge between
   * Future and ProgressListener code.
   *
   * @author Jody
   */
