 ...
 * @since 1.2.0
 */
public class CombiningCachingFeatureReader implements FeatureReader<SimpleFeatureType, 
        SimpleFeature> {
    ...
    private HashSet<String> collectedFeatureIds;    //need this for now because the "grid" may 
    // store the same feature multiple times per node; we only want to get each feature once
     ...
     */
    public CombiningCachingFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader1,
                                         FeatureReader<SimpleFeatureType, SimpleFeature> reader2,
                                         boolean cache1, boolean cache2, SpatialIndex cache, 
                                         Filter postFilter) throws IOException {
        this.r1 = reader1;
        this.r2 = reader2;
