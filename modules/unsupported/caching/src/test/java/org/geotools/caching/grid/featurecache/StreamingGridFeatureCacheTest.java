...
//				MemoryStorage.createInstance());
    ...
    public void testGetDuplicateFeatures() throws FeatureCacheException,
        ...
        int feature2[] = new int[]{0, 0, 0, 10, 10, 10, 10, 0, 0, 0}; // bound feature to ensure 
        // the tiles are built as shown above
        ...
        Filter upperLeft = filterFactory.bbox(featureType.getGeometryDescriptor().getLocalName(),
                0, 5.1, 4.9, 9.9, featureType.getCoordinateReferenceSystem().toString());
        ...
        Filter upperHalf = filterFactory.bbox(featureType.getGeometryDescriptor().getLocalName(),
                0, 5.1, 9.9, 9.9, featureType.getCoordinateReferenceSystem().toString());
    ...
    public void testPut() throws Exception {
        ...
        SimpleFeature newFeature = makeFeature(rawDataset.getFeatureSource("mycollection")
                .getSchema(), 450, 500);
        DefaultFeatureCollection dfc = new DefaultFeatureCollection("mycollection", rawDataset
                .getFeatureSource("mycollection").getSchema());
        dfc.add(newFeature);
    ...
    public void testWrite() {
        try {
            ...
            try {
                FeatureWriter<SimpleFeatureType, SimpleFeature> writer = rawDataset
                        .getFeatureWriter("mycollection", t);
    ...
    public void testEviction() throws IOException, FeatureCacheException {
        ...
        Object featurescoords[] = new Object[]{feature1, feature2, feature3, feature4, feature5, 
        ...
        DataStore ds = new MemoryDataStore(mm);
        FeatureCache cache = new StreamingGridFeatureCache(ds.getFeatureSource(featureType
                .getTypeName()), 4, 4, MemoryStorage.createInstance());

        FilterFactory ff = new FilterFactoryImpl();
        Filter f1 = ff.bbox("the_geom", 0, 0, 4.4, 4.4, DefaultEngineeringCRS.CARTESIAN_2D
                .toString());
        Envelope e1 = new Envelope(0, 4.4, 0, 4.4);

        Filter f2 = ff.bbox("the_geom", 0, 4.6, 4.4, 8.5, DefaultEngineeringCRS.CARTESIAN_2D
                .toString());
        Envelope e2 = new Envelope(0, 4.4, 4.6, 8.5);

        Filter f3 = ff.bbox("the_geom", 4.6, 0, 8.5, 4.4, DefaultEngineeringCRS.CARTESIAN_2D
                .toString());
        Envelope e3 = new Envelope(4.6, 8.5, 0, 4.4);

        Filter f4 = ff.bbox("the_geom", 4.6, 4.6, 8.5, 8.5, DefaultEngineeringCRS.CARTESIAN_2D
                .toString());
    ...
    public void testPeek() throws FeatureCacheException, IOException {
        ...
        assertTrue(size <= cache.peek(new Envelope(0, 1000, 0, 1000)).size());    //because of 
        // the grid sizes there may actually be more features in the cache at this point
     ...
     */
    public void testQuery() throws IOException, FeatureCacheException, 
        ...
        DefaultQuery query = new DefaultQuery(schema.getTypeName(), Filter.INCLUDE, maxfeatures, 
        ...
        Filter f = filterFactory.bbox(schema.getGeometryDescriptor().getLocalName(), 0, 0, 100, 
                100, schema.getCoordinateReferenceSystem().toString());
