...
public class MarshallerTest extends TestCase {
    ...
    public void testMarshall()
        ...
        ////        		fos.write("<xs:schema xmlns:xs=\"http://www
        // .w3.org/2001/XMLSchema\">\n".getBytes());
        //				t.transform(next, System.out);
        ////				fos.write("</xs:schema>".getBytes());
        ////				fos.close();
        //				FileInputStream fis = new FileInputStream("/tmp/schema.xml");
        //				Schema schema = SchemaFactory.getInstance(null, fis); // "http://www
        // .w3.org/2001/XMLSchema"
        //				System.out.println(GMLComplexTypes.createFeatureType(schema
        // .getComplexTypes()[0]));
        //				fis.close();
