...
public abstract class SurfacePatchImpl extends GenericSurfaceImpl
   ...
   * except in the context of a surface, and therefore this method should never returns {@code null}
   * which would preclude the use of surface patches except in this manner. While this would not
   * affect this specification, allowing {@code null} owner allows other standards based on this one
   * to use surface patches in a more open-ended manner. </font>
   *
   * </blockquote>
   *
