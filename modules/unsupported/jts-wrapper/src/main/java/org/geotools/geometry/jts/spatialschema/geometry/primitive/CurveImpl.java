...
public class CurveImpl extends GeometryImpl implements Curve {
  ...
  /**
   * Not fully implemented. Returns null, unless all CurveSegments are LineStrings, in which case it
   * returns a concatenation of all the LineStrings. In future versions this could be implemented by
   * delegating to the comprising segments.
   */
  ...
  /**
   * Not implemented (and probably never will be since traversal of this association would require a
   * lot of extra work). Always returns an empty set.
   */
