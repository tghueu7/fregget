...
public class PointArrayImpl extends NotifyingArrayList<Position>
  ...
  /**
   * Returns the dimensionality of the coordinates in this array. This may be less than or equal to
   ...
   * {@code dest} argument is non-null, that object will be populated with the value from the list.
   *
   * @param column The location in the array, from 0 inclusive to the array's {@linkplain #size}
   *     exclusive.
   ...
   * @see List#toArray
   * @revisit Should we specify that changes to the returned points will not be reflected into this
   *     array, or should we left the decision to the implementor?
   */
