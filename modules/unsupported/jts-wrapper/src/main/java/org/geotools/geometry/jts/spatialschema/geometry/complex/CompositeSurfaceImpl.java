...
public class CompositeSurfaceImpl extends CompositeImpl
   ...
   * only valid in a 2-dimensional plane. A bounded cylinder has two boundary components, neither of
   * which can logically be classified as its exterior. Thus, in 3 dimensions, there is no valid
   * definition of exterior that covers all cases. </font>
   *
   * </blockquote>
   *
   ...
   * Primitive primitive} of dimension 1 or 2 is associated to two {@code OrientablePrimitive}s, one
   * for each possible orientation. For curves and surfaces, there are exactly two orientable
   ...
   *     containedPrimitive
   * @revisit Using a {@link Set} returns type allows the user to add or remove element in this set
