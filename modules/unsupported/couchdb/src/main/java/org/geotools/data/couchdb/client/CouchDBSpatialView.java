...
public class CouchDBSpatialView extends CouchDBViewSupport {
    ...
    public JSONObject get(double llx, double lly, double urx, double ury) throws IOException, 
            CouchDBException {
        return get(bbox(llx, lly, urx, ury));
    }

    public long count(double llx, double lly, double urx, double ury) throws IOException, 
            CouchDBException {
