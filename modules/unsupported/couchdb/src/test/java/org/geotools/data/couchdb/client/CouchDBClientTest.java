...
public class CouchDBClientTest extends CouchDBTestSupport {
    ...
    public void testOpenDBConnection() throws Exception {
        ...
        try {
            ...
            assertTrue("expected useful failure message", cex.getMessage().indexOf("not_found") >
                    0);
        }
    }
    ...
    public void testSpatialList() throws Exception {
        ...
        /**
         ...
         JSONObject obj = (JSONObject) JSONValue.parseWithException(resolveContent("counties
         .json"));
         ...
         String query = "/_design/main/_spatial/_list/query/counties?bbox=-180,-90,180,
         90&fname=Name&fval=Hon.*";
