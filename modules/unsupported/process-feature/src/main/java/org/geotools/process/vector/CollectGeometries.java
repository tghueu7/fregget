 ...
 * @source $URL$
 */
@DescribeProcess(title = "Collect Geometries", description = "Collects the default geometries of " +
        "the input features and combines them into a single geometry collection")
