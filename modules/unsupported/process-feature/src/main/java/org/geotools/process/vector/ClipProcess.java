          ...
          if (Point.class.isAssignableFrom(binding)
            ...
            if (LineString.class.isAssignableFrom(binding)) {
              ...
              throw new RuntimeException(
                  "Don't know how to handle geometries of type " + binding.getCanonicalName());
            }
    ...
    private class LinearElevationInterpolator implements GeometryComponentFilter {
      ...
      private void applyElevations(LineString ls, LineString original, boolean tolerant) {
        ...
        for (; ; ) {
          ...
          // doing these checks for any non collinear point is expensive, do it only if there is at
      ...
      /**
       * TODO: should we use a spatial index? Would be warranted only if the input has a very large
       * amount of sub-lines
       *
       * @param ls
       * @return
