...
public class BilinearInterpolator {
     ...
     */
    private float interpolateBoundaryCell(float xfrac, float yfrac, float v00, float v10, float 
            v01, float v11) {
        // count noData values
        int count = 0;
     ...
     * @return the interpolated value
     */
    private float interpolateBoundaryCellNorm(float xfrac, float yfrac, float v00, float v10, 
                                              float v01) {
