...
public class ClipProcessTest extends Assert {
  ...
  public void testClipPoly3DIncluded() throws Exception {
    ...
    SimpleFeatureCollection result =
        cp.execute(
            features,
            new WKTReader().read("POLYGON((-10 -10, -10 10010, 10010 10010, 10010 -10, -10 -10))"),
            true);
  ...
  public void testService() throws Exception {
    ...
    arguments.put(
        "clip", new WKTReader().read("POLYGON((-10 -10, -10 10, 5000 10, 5000 -10, -10 -10))"));
  ...
  public void testClipLine3DMidSecondSegment() throws Exception {
    ...
    SimpleFeatureCollection result =
        cp.execute(
            features,
            new WKTReader()
                .read("POLYGON((9000 5000, 9000 10000, 11000 10000, 11000 5000, 9000 5000))"),
            true);
    assertEquals(1, result.size());
    SimpleFeatureIterator fi = result.features();
    // check the first polygon
