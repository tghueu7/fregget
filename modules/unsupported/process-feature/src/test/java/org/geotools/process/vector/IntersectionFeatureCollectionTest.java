...
public class IntersectionFeatureCollectionTest {
    private static final Logger logger = Logger.getLogger("org.geotools.process.feature.gs" +
            ".VectoralZonalStatisticalProcessTest");
    ...
    public void testExceptionOpModeFstCollection() throws Exception {
        ...
        toRemoveSnd.add("cat");
        SimpleFeatureCollection output = process.execute(polylineCollection, featuresCollection, 
                toRemoveFst, toRemoveSnd, IntersectionMode.INTERSECTION, true, false);
    }
    ...
    public void testExceptionOpModeSndCollection() throws Exception {
        ...
        toRetainSnd.add("cat");
        SimpleFeatureCollection output = process.execute(zonesCollection, polylineCollection, 
                toRetainFst, toRetainSnd, IntersectionMode.INTERSECTION, true, false);
    }

    private Polygon createRectangularPolygonByCoords(double xMin, double xMax, double yMin, 
                                                     double yMax, CoordinateReferenceSystem 
                                                             sourceCRS) {
    ...
    // this test verifies if the Illegal argument exception is thrown when a MultiPointCollection
    // is given as first collection
    @Test(expected = IllegalArgumentException.class)
    public void testProcessArguments1() throws IllegalArgumentException {
        SimpleFeatureCollection output2 = process.execute(multipointCollection, 
                featuresCollection, null, null, IntersectionMode.INTERSECTION, null, null);
    }

    // this test verifies if the Illegal argument exception is thrown when a MultiPointCollection
    // is given as second collection and area attributes are required
    @Test(expected = IllegalArgumentException.class)
    public void testProcessArguments2() throws IllegalArgumentException {
        SimpleFeatureCollection output2 = process.execute(featuresCollection, 
                multipointCollection, null, null, IntersectionMode.INTERSECTION, true, false);
    }
    ...
    public void testGetIntersectionAreaRate() {
        ...
        CoordinateReferenceSystem sourceCRS = org.geotools.referencing.crs.DefaultGeographicCRS
                .WGS84;
        ...
        double calculatedRate = IntersectionFeatureCollection.getIntersectionArea(worldPolygon, 
                sourceCRS, coloradoPolygon, sourceCRS, true);
    ...
    public void testReturnedAttributes() throws Exception {
        ...
        SimpleFeatureCollection output2 = process.execute(zonesCollection, featuresCollection, 
                toRetainFst, toRetainSnd, IntersectionMode.INTERSECTION, true, true);
        ...
        SimpleFeatureCollection output3 = process.execute(zonesCollection, featuresCollection, 
                toRetainFst, toRetainSnd, IntersectionMode.INTERSECTION, false, false);
    ...
    public void testExecute() throws Exception {
        ...
        SimpleFeatureCollection output3 = process.execute(features, secondFeatures, null, null, 
                null, false, false);
