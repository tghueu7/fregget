...
public class LRSMeasureProcessTest {
  ...
  public void testBadParamFromLrs() throws Exception {
    ...
    try {
      FeatureCollection result = process.execute(origional, "from_lrs_bad", "to_lrs", point, null);
  ...
  public void testBadParamToLrs() throws Exception {
    ...
    try {
      FeatureCollection result = process.execute(origional, "from_lrs", "to_lrs_bad", point, null);
