...
public class AggregateProcessTest {
    ...
    public void testSum() throws Exception {
        ...
        Results result = AggregateProcess.process(source.getFeatures(), "cat", functions, true, 
                null);
    ...
    public void testSumArea() throws Exception {
        ...
        Results result = AggregateProcess.process(source.getFeatures(), "the_geom", functions, 
                true, null);
    ...
    public void testSumWithGroupBy() throws Exception {
        SimpleFeatureSource source = bugs.getFeatureSource("bugsites");
        Set<AggregationFunction> functions = EnumSet.of(AggregationFunction.Sum);
        Results result = AggregateProcess.process(source.getFeatures(), "cat", functions, 
                Collections.singletonList("str1"), true, null);
