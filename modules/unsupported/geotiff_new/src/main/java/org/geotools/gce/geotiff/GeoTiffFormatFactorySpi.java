...
public final class GeoTiffFormatFactorySpi implements GridFormatFactorySpi {
    ...
    private final static Logger LOGGER = org.geotools.util.logging.Logging.getLogger
            (GeoTiffFormatFactorySpi.class.toString());
    ...
    static {
        ...
        try {
            ...
            final String customTiffReaderName = it.geosolutions.imageioimpl.plugins.tiff
                    .TIFFImageReaderSpi.class.getName();

            // imageio jp2k reader
            final String standardTiffReaderName = com.sun.media.imageioimpl.plugins.tiff
                    .TIFFImageReaderSpi.class.getName();

            if (!ImageIOUtilities.replaceProvider(ImageReaderSpi.class, customTiffReaderName, 
                    standardTiffReaderName, "TIFF")) {
            ...
            // check if our tiff plugin is in the path
            final String tiffName = it.geosolutions.imageioimpl.plugins.tiff.TIFFImageWriterSpi
                    .class.getName();

            // imageio jp2k reader
            final String standardTiffName = com.sun.media.imageioimpl.plugins.tiff
                    .TIFFImageWriterSpi.class.getName();

            if (!ImageIOUtilities.replaceProvider(ImageReaderSpi.class, tiffName, 
                    standardTiffName, "TIFF")) {
