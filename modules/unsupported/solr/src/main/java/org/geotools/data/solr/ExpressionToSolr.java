...
public class ExpressionToSolr implements ExpressionVisitor {
  ...
  public Object visit(Literal expression, Object extraData) {
    ...
    if (literal instanceof Geometry) {
      ...
      // Splits segments exceeds the 180 degrees longitude limit to conforms to SOLR WKT manager
      // specification
      // Using JTS Densify, all segments exceeds the 180 degrees length will be densified, not only
      // the one exceeds it in longitude!
