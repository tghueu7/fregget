...
public class CoverageClassStatsTest {
  ...
  GridCoverage2D createMedfordDemCoverage() throws IOException {
    ...
    BufferedImage img =
        ImageIO.read(
            new File("/Users/jdeolive/Projects/suite_trunk/git/data_dir/data/dem/medford_dem.tif"));
  ...
  GridCoverage2D createSfDemCoverage() throws IOException {
    ...
    BufferedImage img =
        ImageIO.read(
            new File("/Users/jdeolive/Projects/gs_trunk/svn/data/release/data/sf/sfdem.tif"));
  ...
  GridCoverage2D createCoverage() {
    ...
    GridSampleDimension[] bands =
        new GridSampleDimension[] {new GridSampleDimension(ColorInterpretation.GRAY_INDEX.name())};
