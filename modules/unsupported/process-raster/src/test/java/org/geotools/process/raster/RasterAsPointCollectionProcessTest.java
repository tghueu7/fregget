...
public class RasterAsPointCollectionProcessTest {
  ...
  public void testCoverageWithNearestInterp()
      throws MismatchedDimensionException, TransformException {
    // Execution of the RasterAsPointCollectionProcess setting hemisphere, scaleFactor and nearest
    // interpolation
    boolean hemisphere = true;
    float scaleFactor = 2.0f;
  ...
  public void testCoverageWithBilinearInterp()
      throws MismatchedDimensionException, TransformException {
    // Execution of the RasterAsPointCollectionProcess setting hemisphere, scaleFactor and bilinear
    // interpolation
    boolean hemisphere = true;
    float scaleFactor = 2.0f;
  ...
  public void testCoverageWithBicubicInterp()
      throws MismatchedDimensionException, TransformException {
    // Execution of the RasterAsPointCollectionProcess setting hemisphere, scaleFactor and bicubic
    // interpolation
    boolean hemisphere = true;
    float scaleFactor = 2.0f;
