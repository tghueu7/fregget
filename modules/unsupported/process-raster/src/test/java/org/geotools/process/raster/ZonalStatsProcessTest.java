...
public class ZonalStatsProcessTest extends Assert {
  ...
  public void simpleZonalStatsProcess() throws Exception {
    ...
    try {
      ...
      covClassificator =
          CoverageFactoryFinder.getGridCoverageFactory(null)
              .create(
                  ...
                  new GridGeometry2D(
                      new GridEnvelope2D(
                          PlanarImage.wrapRenderedImage(imageClassificator).getBounds()),
      ...
      while (iterator.hasNext()) {
        ...
        assertTrue(
            (feature.toString())
                .equals(results.get(feature.getID() + feature.getAttribute("classification"))));
      }
  ...
  public void testStatisticsOnZeroes() {
    ...
    SimpleFeature feature =
        SimpleFeatureBuilder.build(schema, new Object[] {poly, Integer.valueOf(1)}, "fid123");
