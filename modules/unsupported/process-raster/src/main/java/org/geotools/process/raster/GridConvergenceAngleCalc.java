...
final class GridConvergenceAngleCalc {
   ...
   * System of the supplied position must be the same as was used when constructing the calculator,
   * because using anything else would not make sense as convergence angle depends on projection.
   *
