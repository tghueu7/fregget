 ...
 * </ul>
 * <p>
 * The output of this process is a {@link GridCoverage2D} object containing only the 
 * {@link SampleDimension}s indicated by the input array.
 *
 * @author Nicola Lagomarsini, GeoSolutions S.A.S.
 */
@DescribeProcess(title = "Select Coverages", description = "Returns a raster generated by the " +
        "selection of some bands from the input raster.")
public class BandSelectProcess implements RasterProcess {
    ...
    public GridCoverage2D execute(
            ...
            @DescribeParameter(name = "SampleDimensions", description = "Input sample dimension " +
                    "indexes", min = 1) int[] sampleDims,
            @DescribeParameter(name = "VisibleSampleDimension", description = "Input visible " +
                    "sample dimension index", min = 0) Integer visibleSampleDim)
        ...
        //
        // //
        final ParameterValueGroup param = PROCESSOR.getOperation("SelectSampleDimension")
                .getParameters();
