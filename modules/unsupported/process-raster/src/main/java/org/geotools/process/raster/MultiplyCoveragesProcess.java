 ...
 */
@DescribeProcess(title = "Multiply Coverages", description = "Returns a raster generated by " +
        "pixel-by-pixel multiplication of two source rasters.  Source rasters must have the same " +
