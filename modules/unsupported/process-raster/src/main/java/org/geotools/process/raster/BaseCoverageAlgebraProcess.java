...
public class BaseCoverageAlgebraProcess {
    ...
    static final String MISMATCHING_ENVELOPE_MESSAGE = "coverageA and coverageB should share the " +
            "same Envelope";

    static final String MISMATCHING_GRID_MESSAGE = "coverageA and coverageB should have the same " +
            "gridRange";

    static final String MISMATCHING_CRS_MESSAGE = "coverageA and coverageB should share the same " +
    ...
    public static void checkCompatibleCoverages(GridCoverage2D coverageA, GridCoverage2D 
            coverageB) throws ProcessException {
        if (coverageA == null || coverageB == null) {
            String coveragesNull = coverageA == null ? (coverageB == null ? "coverageA and " +
                    "coverageB" : "coverageA") : "coverageB";
        ...
        if (!CRS.equalsIgnoreMetadata(crsA, crsB)) {
            ...
            try {
                ...
                throw new ProcessException("Exceptions occurred while looking for a mathTransform" +
                        " between the 2 coverage's CRSs", e);
            }
    ...
    public static void checkCompatibleCoveragesForMerge(Collection<GridCoverage2D> coverages) 
        ...
        if (coverages == null || coverages.isEmpty()) {
            throw new ProcessException(Errors.format(ErrorKeys.NULL_ARGUMENT_$1, "Input coverage " +
                    "List"));
        }
