...
public class AggregateTypeConfiguration implements Serializable {
  ...
  /**
   * Builds a new aggregate type configuration, with a store list, assuming the feature type in the
   * store has always the same name
   *
   * @param name the name of the aggregate type
  ...
  /**
   * Builds a qualified name from a name containing the ":" separator, otherwise the given name will
   * be used as the local part
   *
   * @param name
   * @return
   */
