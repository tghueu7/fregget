...
public class DXFExtendedData {
    ...
    public DXFExtendedData(String appName, String layerName, List<Object> attributes, Double 
            distance, Double scaleFactor) {
    ...
    public static DXFExtendedData getExtendedData(DXFLineNumberReader lnr) throws IOException {
        ...
        Double[] wsDisplacement = new Double[3], wsPostion = new Double[3], reals = new 
                Double[3], wDirection = new Double[3];
        ...
        while (loop) {
            ...
            switch (gc) {
                ...
                default:
                    ...
                    data = new DXFExtendedData(appName, layerName, attributes, distance, 
                            scaleFactor);
    ...
    public String toString() {
        return "DXFExtendedData [appName=" + appName + ", layerName=" + layerName + ", " +
                "attributes=" + this.toStringAttributes() + ", distance=" + distance + ", " +
