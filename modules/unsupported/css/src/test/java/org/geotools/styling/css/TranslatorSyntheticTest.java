...
public class TranslatorSyntheticTest extends CssBaseTest {
  ...
  public void testSortBy() throws Exception {
    ...
    org.geotools.styling.FeatureTypeStyle fts =
        (org.geotools.styling.FeatureTypeStyle) style.featureTypeStyles().get(0);
    assertEquals(
        "cat A, name D", fts.getOptions().get(org.geotools.styling.FeatureTypeStyle.SORT_BY));
  }
  ...
  public void testSortByGroup() throws Exception {
    ...
    assertEquals(
        "cat A, name D", fts.getOptions().get((org.geotools.styling.FeatureTypeStyle.SORT_BY)));
    assertEquals(
        "theGroup", fts.getOptions().get(org.geotools.styling.FeatureTypeStyle.SORT_BY_GROUP));
  }
  ...
  public void testModeFlat() throws CQLException, TransformerException {
    ...
    assertEquals(
        ECQL.toFilter("value1=1"), style.featureTypeStyles().get(0).rules().get(0).getFilter());
    assertEquals(
        ECQL.toFilter("value2=2"), style.featureTypeStyles().get(0).rules().get(1).getFilter());
    ...
    assertEquals(
        "#ff0000",
        ((LineSymbolizer) style.featureTypeStyles().get(0).rules().get(1).symbolizers().get(0))
            .getStroke()
            .getColor()
            .toString());
  }
  ...
  public void testModeFlat_include() throws CQLException, TransformerException {
    ...
    assertEquals(
        ECQL.toFilter("include"), style.featureTypeStyles().get(0).rules().get(0).getFilter());
    assertEquals(
        ECQL.toFilter("value1=1"), style.featureTypeStyles().get(0).rules().get(1).getFilter());
    assertEquals(
        ECQL.toFilter("value2=2"), style.featureTypeStyles().get(0).rules().get(2).getFilter());
  }
  ...
  public void testModeFlat1() throws CQLException, TransformerException {
    ...
    assertEquals(
        ECQL.toFilter("value2=2"), style.featureTypeStyles().get(0).rules().get(1).getFilter());
    assertEquals(
        ECQL.toFilter("value1=1"), style.featureTypeStyles().get(0).rules().get(2).getFilter());
    assertEquals(
        "2",
        ((LineSymbolizer) style.featureTypeStyles().get(0).rules().get(0).symbolizers().get(0))
            .getStroke()
            .getWidth()
            .toString());
    assertEquals(
    ...
    assertEquals(
        "10",
        ((LineSymbolizer) style.featureTypeStyles().get(0).rules().get(2).symbolizers().get(0))
            .getStroke()
            .getWidth()
            .toString());
    assertEquals(
  ...
  public void testModeFlat1_1() throws CQLException, TransformerException {
    ...
    assertEquals(
        ECQL.toFilter("value1=1"), style.featureTypeStyles().get(0).rules().get(0).getFilter());
    assertEquals(
        ECQL.toFilter("value2=2"), style.featureTypeStyles().get(1).rules().get(0).getFilter());
    assertEquals(
        ECQL.toFilter("value1=1"), style.featureTypeStyles().get(2).rules().get(0).getFilter());
    assertEquals(
        "2",
        ((LineSymbolizer) style.featureTypeStyles().get(0).rules().get(0).symbolizers().get(0))
            .getStroke()
    ...
    assertEquals(
        "2",
        ((LineSymbolizer) style.featureTypeStyles().get(1).rules().get(0).symbolizers().get(0))
            .getStroke()
            .getWidth()
            .toString());
    assertEquals(
    ...
    assertEquals(
        "10",
        ((LineSymbolizer) style.featureTypeStyles().get(2).rules().get(0).symbolizers().get(0))
            .getStroke()
            .getWidth()
            .toString());
    assertEquals(
  ...
  public void testModeFlat3_mark() throws CQLException, TransformerException {
    ...
    assertEquals(
        ECQL.toFilter("value2=2"), style.featureTypeStyles().get(0).rules().get(2).getFilter());
    assertEquals(
        ECQL.toFilter("value3=3"), style.featureTypeStyles().get(0).rules().get(3).getFilter());
