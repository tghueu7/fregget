...
public class CssRuleTest extends CssBaseTest {
    ...
    public void testSingleZIndex() {
        ...
        assertEquals(1, subRule.properties.size());
        assertEquals(1, subRule.properties.get(PseudoClass.ROOT).size());
    ...
    public void testSaneMultiIndex() {
        ...
        assertEquals(1, subRule1.properties.size());
        assertEquals(1, subRule1.properties.get(PseudoClass.ROOT).size());
        ...
        assertEquals(1, subRule3.properties.size());
        assertEquals(1, subRule3.properties.get(PseudoClass.ROOT).size());
