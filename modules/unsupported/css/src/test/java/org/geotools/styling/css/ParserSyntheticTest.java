...
public class ParserSyntheticTest extends CssBaseTest {
    ...
    public void simpleLine() throws IOException {
        ...
        assertEquals(1, ss.rules.size());
        CssRule r = ss.rules.get(0);
        assertTrue(r.selector instanceof Accept);
    ...
    public void lineWidth() throws IOException {
        ...
        assertNull(r.comment);
        assertTrue(r.selector instanceof Accept);
        assertEquals(2, r.properties.get(PseudoClass.ROOT).size());
        assertProperty(r, 0, "stroke", new Value.Literal("#000000"));
    ...
    public void testFunction() throws IOException {
        ...
        assertProperty(r, 0, "mark",
                new Value.Function(Collections.singletonList((Value) new Value.Literal("circle")),
                        "symbol"));
    }
    ...
    public void testMultiValue() throws IOException {
        ...
        assertTrue(r.selector instanceof Accept);
        assertEquals(1, r.properties.size());
        assertProperty(r, 0, "label-anchor", new Value.Multi(new Value.Literal("50%"),
    ...
    public void ogcSelector() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof Data);
        Data of = (Data) r.selector;
    ...
    public void minScaleSelector() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof ScaleRange);
        ScaleRange sr = (ScaleRange) r.selector;
    ...
    public void qualifiedTypeNameSelector() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof TypeName);
        TypeName s = (TypeName) r.selector;
    ...
    public void idSelector() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof Id);
        Id s = (Id) r.selector;
    ...
    public void pseudoClassSelector() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof PseudoClass);
        PseudoClass s = (PseudoClass) r.selector;
    ...
    public void andDataScale() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof And);
        And s = (And) r.selector;
    ...
    public void orDataScale() throws IOException, CQLException {
        ...
        CssRule r = ss.rules.get(0);
        assertNull(r.comment);
        assertTrue(r.selector instanceof Or);
        Or s = (Or) r.selector;
        assertEquals(new Data(ECQL.toFilter("att < 15")), s.children.get(0));
        assertEquals(new ScaleRange(3000, true, Double.POSITIVE_INFINITY, true), s.children.get(1));
    }
    ...
    public void testComment() {
        ...
        assertEquals(1, ss.rules.size());
        CssRule r = ss.rules.get(0);
        assertEquals("This is a comment", r.comment);
        assertTrue(r.selector instanceof Accept);
    }
    ...
    public void testCommentMultiline() {
        ...
        assertEquals(1, ss.rules.size());
        CssRule r = ss.rules.get(0);
        assertEquals(commentInternal, r.comment);
        assertTrue(r.selector instanceof Accept);
    }
    ...
    public void testMultiRule() {
        ...
        Stylesheet ss = result.parseTreeRoot.getValue();
        assertEquals(2, ss.rules.size());
        CssRule r = ss.rules.get(0);
        assertTrue(r.selector instanceof Accept);
        assertProperty(r, 0, "stroke", new Value.Literal("#000000"));
        r = ss.rules.get(1);
        assertEquals(r.selector, new TypeName("states"));
