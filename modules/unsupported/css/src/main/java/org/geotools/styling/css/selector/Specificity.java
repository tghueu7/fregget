 ...
 * specification:
 * <a href="http://www.w3.org/TR/CSS21/cascade.html#specificity"> "Calculating a selector's 
 * specificity", CSS 2.1 Specification </a>
 * <p>
...
public class Specificity implements Comparable<Specificity> {
    ...
    /**
     * Returns a new Specificity object representing by performing a element by element sum of 
     * the components
     *
     * @param other
     * @return
