...
public class IonicStrategy extends StrictWFS_1_x_Strategy {
  ...
  /**
   * We can't use POST at all against Ionic cause it is not a WFS 1.1 implementation and expect the
   * filters to be encoded as per Filter 1.0, and I wasn't able of creating a WFS 1.1 with Filter
   * 1.0 {@link Configuration} that works.
   *
   * @return false
   */
  @Override
