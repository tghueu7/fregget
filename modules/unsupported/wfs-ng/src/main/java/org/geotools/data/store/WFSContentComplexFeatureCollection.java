...
public class WFSContentComplexFeatureCollection
  ...
  public WFSContentComplexFeatureCollection(
      GetFeatureRequest request, FeatureType schema, QName name, Filter filter) throws IOException {
  ...
  public FeatureIterator<Feature> features() {
    ...
    try {
      ...
      XmlComplexFeatureParser parser = new XmlComplexFeatureParser(stream, schema, name, filter);
