...
public abstract class AbstractGetFeatureResponseParserFactory implements WFSResponseFactory {
    ...
    public WFSException parseException(WFSRequest originatingRequest, InputStream inputStream) 
        ...
        try {
            ...
            if (!(parsed instanceof net.opengis.ows10.ExceptionReportType || parsed instanceof 
        ...
        if (parsed instanceof net.opengis.ows10.ExceptionReportType) {
            net.opengis.ows10.ExceptionReportType report = (net.opengis
                    .ows10.ExceptionReportType) parsed;
            ...
            for (net.opengis.ows10.ExceptionType ex : exceptions) {
                result.addExceptionReport(ex.getExceptionCode() + ": " + String.valueOf(ex
                        .getExceptionText()));
            }
            return result;
        } else {
            net.opengis.ows11.ExceptionReportType report = (net.opengis
                    .ows11.ExceptionReportType) parsed;
            @SuppressWarnings("unchecked")
    ...
    protected abstract GetFeatureParser parser(GetFeatureRequest request, InputStream in) throws 
            IOException;
