...
public class WFSDataAccessFactory implements DataAccessFactory {
  ...
  static {
    ...
    parametersInfo[1] =
        PROTOCOL = new WFSFactoryParam<Boolean>(key, Boolean.class, title, description, null);
  }
    ...
    parametersInfo[3] =
        PASSWORD =
            new WFSFactoryParam<String>(
                key, String.class, title, description, null, Param.IS_PASSWORD, true);
  }
  ...
  static {
    ...
    parametersInfo[4] =
        ENCODING =
            new WFSFactoryParam<String>(
                key, String.class, title, description, defaultValue, Parameter.OPTIONS, options);
  }

  /**
   * Optional {@code Integer} DataStore parameter indicating a timeout in milliseconds for the HTTP
   * connections. <>p> @TODO: specify if its just a connection timeout or also a read timeout
   */
  ...
  static {
    ...
    parametersInfo[7] =
        TRY_GZIP =
            new WFSFactoryParam<Boolean>(key, Boolean.class, title, description, Boolean.TRUE);
  }

  /**
   * Optional {@code Boolean} DataStore parameter indicating whether to be lenient about parsing bad
   * data
   */
    ...
    parametersInfo[10] =
        FILTER_COMPLIANCE =
            new WFSFactoryParam<Integer>(
                key, Integer.class, title, description, null, Parameter.OPTIONS, options);
  }
  ...
  static {
    ...
    List<String> options =
        Arrays.asList(
            new String[] {
              "auto", "strict", "nonstrict", "mapserver", "geoserver", "cubewerx", "ionic", "arcgis"
            });
    parametersInfo[11] =
        WFS_STRATEGY =
            new WFSFactoryParam<String>(
                key, String.class, title, description, "auto", Parameter.OPTIONS, options);
  }
  ...
  static {
    ...
    parametersInfo[12] =
        NAMESPACE =
            new WFSFactoryParam<String>(key, String.class, title, description, null, "advanced");
  }

  /**
   * Optional {@code String} Flag to disable usage of OtherSRS in requests and always use DefaultSRS
   * (eventually reprojecting locally the results)
   */
  ...
  static {
    ...
    parametersInfo[13] =
        USEDEFAULTSRS =
            new WFSFactoryParam<Boolean>(key, Boolean.class, title, description, false, "advanced");
  }
  ...
  static {
    ...
    List<String> options =
        Arrays.asList(
            new String[] {AXIS_ORDER_COMPLIANT, AXIS_ORDER_EAST_NORTH, AXIS_ORDER_NORTH_EAST});
    parametersInfo[14] =
        AXIS_ORDER =
            new WFSFactoryParam<String>(
                key,
  ...
  static {
    ...
    parametersInfo[18] =
        GML_COMPATIBLE_TYPENAMES =
            new WFSFactoryParam<Boolean>(name, Boolean.class, title, description, false);
  }
