...
public abstract class WFSStrategy extends Specification {
   ...
   * @throws IllegalArgumentException if {@code typeName} is not the name of a FeatureType stated in
   ...
   *
   * @param typeName
   * @return a two-element array where the first element is the supported filter and the second the
   *     one to post-process
  ...
  /**
   * Returns the union of the default CRS and the other supported CRS's of the given feature type as
   * declared in the corresponding FeatureType element in the capabilities document, as well as any
   * globally supported CRS identifier declared as a parameter of the GetFeature oepration in the
