...
public class WFSDataStoreFactory extends WFSDataAccessFactory implements DataStoreFactorySpi {
   ...
   *
   * <p>Note the {@code URL} provided as parameter must refer to the actual {@code GetCapabilities}
   ...
   * version.
   *
   * <p>If the query string in the {@code host} URL already contains a VERSION number, that version
   * is <b>discarded</b>.
   *
   ...
   *
   * <p><b>NOTE</b> the default version will be 1.0.0 until the support for 1.1.0 gets stable enough
  ...
  public static URL createGetCapabilitiesRequest(final URL host) {
    ...
    queryString =
        queryString == null || "".equals(queryString.trim()) ? "" : queryString.toUpperCase();
