...
public interface GetParser<F extends Feature> {
  /**
   * Returns the number of features if advertised by the server and the parser was able to get that
   * information for example from the {@code wfs:FeatureCollection} "numberOfFeatures" xml
