...
public class XXEProtectionTest {
    ...
    public void testTransactionProtection() throws Exception {
        ...
        IntegrationTestWFSClient client = new IntegrationTestWFSClient(baseDirectory, config) {
            protected org.geotools.data.ows.Response mockTransaction(org.geotools.data.wfs
                                                                             .internal
                                                                             .TransactionRequest 
                                                                             request) throws java
                    .io.IOException {
        ...
        WFSDataStore store = new WFSDataStore(client);
        SimpleFeatureStore fs = (SimpleFeatureStore) store.getFeatureSource(store.getTypeNames()
                [0]);
        try {
