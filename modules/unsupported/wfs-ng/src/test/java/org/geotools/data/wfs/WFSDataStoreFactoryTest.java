...
public class WFSDataStoreFactoryTest {
  ...
  public void testCanProcess() {
    ...
    params.put(
        WFSDataStoreFactory.URL.key, "http://someserver.example.org/wfs?request=GetCapabilities");
  ...
  /**
   * Test for GZIP settings, backwards compatibility: If no gzip settings is present, client has to
   * enable gzip
   *
   * @throws IOException
   */
