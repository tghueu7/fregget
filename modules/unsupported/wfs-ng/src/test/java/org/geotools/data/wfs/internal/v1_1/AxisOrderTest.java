...
public class AxisOrderTest {
  ...
  public void testGetFeatureWithNorthEastAxisOrderOutputEPSG4326() throws Exception {
    ...
    TestHttpResponse httpResponse =
        new TestHttpResponse(
            "text/xml; subtype=gml/3.1.1", "UTF-8", stream("axisorder/GetFeatureById4326.xml"));

    TestWFSClient wfs =
        createTestProtocol("axisorder/GetCapabilities.xml", new MockHTTPClient(httpResponse));
    ...
    wfs.setAxisOrderOverride(
        WFSDataStoreFactory.AXIS_ORDER_NORTH_EAST, WFSDataStoreFactory.AXIS_ORDER_COMPLIANT);
  ...
  public void testGetFeatureWithNorthEastAxisOrderFilter() throws Exception {
    ...
    TestHttpResponse httpResponse =
        new TestHttpResponse(
            "text/xml; subtype=gml/3.1.1", "UTF-8", stream("axisorder/GetFeaturesByBBox.xml"));
    TestWFSClient wfs =
        createTestProtocol("axisorder/GetCapabilities.xml", new MockHTTPClient(httpResponse));
    ...
    wfs.setAxisOrderOverride(
        WFSDataStoreFactory.AXIS_ORDER_COMPLIANT, WFSDataStoreFactory.AXIS_ORDER_EAST_NORTH);
    ...
    Query query =
        new Query(
            typeName, ff.bbox("the_geom", 4623055.0, 815134.0, 4629904.0, 820740.0, "EPSG:3857"));
  ...
  public void testGetFeatureWithEastNorthAxisOrderFilter() throws Exception {
    ...
    // axis order used will be NORTH / EAST
    wfs.setAxisOrderOverride(
        WFSDataStoreFactory.AXIS_ORDER_COMPLIANT, WFSDataStoreFactory.AXIS_ORDER_NORTH_EAST);
  ...
  public void testGetFeatureWithEastNorthAxisOrderOutputEPSG4326() throws Exception {
    ...
    wfs.setAxisOrderOverride(
        WFSDataStoreFactory.AXIS_ORDER_EAST_NORTH, WFSDataStoreFactory.AXIS_ORDER_COMPLIANT);
  ...
  public void testGetFeatureWithEastNorthAxisOrderOutputEPSG3857() throws Exception {
    TestHttpResponse httpResponse =
        new TestHttpResponse(
            "text/xml; subtype=gml/3.1.1", "UTF-8", stream("axisorder/GetFeatureById.xml"));
    TestWFSClient wfs =
        createTestProtocol("axisorder/GetCapabilities.xml", new MockHTTPClient(httpResponse));
