...
public class AxisOrderTest {
    ...
    public void testGetFeatureWithNorthEastAxisOrderOutputEPSG4326() throws Exception {
        ...
        TestWFSClient wfs = createTestProtocol("axisorder/GetCapabilities.xml", new 
                MockHTTPClient(httpResponse));

        // axis order used will be NORTH / EAST
        wfs.setAxisOrderOverride(WFSDataStoreFactory.AXIS_ORDER_COMPLIANT, WFSDataStoreFactory
        ...
        wfs.setAxisOrderOverride(WFSDataStoreFactory.AXIS_ORDER_NORTH_EAST, WFSDataStoreFactory
                .AXIS_ORDER_COMPLIANT);
    ...
    public void testGetFeatureWithNorthEastAxisOrderFilter() throws Exception {
        ...
        Set<FeatureId> fids = new HashSet<FeatureId>();
        fids.add(new FeatureIdImpl("comuni11.2671"));
        Query query = new Query(typeName, ff.bbox("the_geom", 4623055.0, 815134.0, 4629904.0, 
                820740.0, "EPSG:3857"));
    ...
    public void testGetFeatureWithEastNorthAxisOrderOutputEPSG4326() throws Exception {
        ...
        wfs.setAxisOrderOverride(WFSDataStoreFactory.AXIS_ORDER_EAST_NORTH, WFSDataStoreFactory
                .AXIS_ORDER_COMPLIANT);
