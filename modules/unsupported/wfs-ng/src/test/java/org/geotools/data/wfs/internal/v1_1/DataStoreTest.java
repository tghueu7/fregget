...
public class DataStoreTest {
  ...
  public void testGetSchema() throws IOException, ServiceException {
    ...
    TestWFSClient wfs =
        createTestProtocol(CUBEWERX_GOVUNITCE.CAPABILITIES, new MockHTTPClient(httpResponse));
  ...
  public void testGetDefaultOutputFormat() throws IOException, ServiceException {
    TestHttpResponse httpResponse =
        new TestHttpResponse(
            "text/xml; subtype=gml/2.1.2", "UTF-8", stream("CubeWerx_nsdi/1.1.0/gml212.xml"));
    TestWFSClient wfs =
        createTestProtocol(CUBEWERX_GOVUNITCE.CAPABILITIES, new MockHTTPClient(httpResponse));
  ...
  /**
   * Test for the useDefaultSRS parameter set to true. Query in a CRS different from the DefaultSRS
   * should be done in DefaultSRS and then reprojected.
   *
   * @throws IOException
  ...
  /**
   * Test for the useDefaultSRS parameter set to false. Query in a CRS listed in OtherSRS should be
   * done in OtherSRS and not reprojected.
   *
   * @throws IOException
   * @throws NoSuchAuthorityCodeException
   * @throws FactoryException
  ...
  /**
   * Test for the useDefaultSRS parameter set to false and OtherSRS specified in urn form. Query in
   * a CRS listed in OtherSRS should be done in OtherSRS and not reprojected.
   *
   * @throws IOException
   * @throws NoSuchAuthorityCodeException
   * @throws FactoryException
  ...
  public void tesUseOtherSRSUsingURN()
    ...
    assertEquals(
        ...
        GML2EncodingUtils.epsgCode(featureReader.getFeatureType().getCoordinateReferenceSystem()));
    // GetFeatureRequest request = wfs.getRequest();
