...
public class TinyOwsTest {
    ...
    private WFSDataStore getWFSDataStore(HTTPClient httpClient) throws IOException, 
            ServiceException {
        URL capabilitiesUrl = new URL("http://127.0.0.1:8888/cgi-bin/tinyows?service=WFS&version" +
    ...
    public void testGetFirstFeatures() throws Exception {
        ...
        WFSDataStore wfs = getWFSDataStore(new TinyOwsMockHttpClient() {
            ...
            public HTTPResponse post(URL url, InputStream postContent, String postContentType) 
                ...
                if (stringContains(request,
                    ...
                    return super.post(url, new ByteArrayInputStream(request.getBytes("UTF-8")), 
                            postContentType);
                }
            }
        });
        ...
        Query query = new Query(typeName.getLocalPart(), Filter.INCLUDE, 20, Query.ALL_NAMES, "my" +
                " query");
        ...
        WFSDataStore wfs = getWFSDataStore(new TinyOwsMockHttpClient() {
            ...
            public HTTPResponse post(URL url, InputStream postContent, String postContentType) 
                ...
                if (isResultsRequest(request,
                    ...
                    assertXMLEqual
                            ("tinyows/GetFeatureIncludeAndPropertyGreaterThanAndIncludeRequest" +
                                    ".xml", request);
                    return new TestHttpResponse(url("tinyows/GetFirstFeatures.xml"), "text/xml");
                } else {
                    postContent.reset();
    ...
    class TinyOwsMockHttpClient extends AbstractTestHTTPClient {
        ...
        @Override
        public HTTPResponse post(URL url, InputStream postContent, String postContentType) throws
                IOException {
