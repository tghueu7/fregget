...
public class MapServerOnlineTest {
    ...
    public static final String SERVER_URL_100 = "http://demo.mapserver" +
            ".org/cgi-bin/wfs?SERVICE=WFS&VERSION=1.0.0&REQUEST=GetCapabilities";

    public static final String SERVER_URL_110 = "http://demo.mapserver" +
            ".org/cgi-bin/wfs?SERVICE=WFS&VERSION=1.1.0&REQUEST=GetCapabilities";

    public static final String SERVER_URL_200 = "http://www502.regione.toscana.it/wmsraster/com" +
            ".rt.wms.RTmap/wms?map=wmscartoteca&service=wfs&request=getcapabilities&version=2.0.0";
    ...
    private void testSingleType2(DataStore wfs) throws IOException, NoSuchElementException {
        ...
        ReferencedEnvelope env = new ReferencedEnvelope(4773438.659659, 648995.437355, 
                4773439.659659001, 648996.437355001, crs);
