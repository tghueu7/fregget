...
public class S3ImageInputStreamImplSpi extends ImageInputStreamSpi {
  ...
  /**
   * Constructs a blank {@link ImageInputStreamSpi}. It is up to the subclass to initialize instance
   * variables and/or override method implementations in order to provide working versions of all
   * methods.
   */
   ...
   * @param useCache a boolean indicating whether a cache eraf should be used, in cases where it is
   *     optional.
