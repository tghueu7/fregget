...
public class FunctionParseTest {
  ...
  public void testParseIntervalFunctionNumber() throws IOException, ParseException {
    ...
    assertThat(
        ...
        hasProperty(
            "stops",
            contains(contains(0L, 0L), contains(2L, 5L), contains(5L, 10L), contains(10L, 20L))));
  }
  /**
   * Traverse a nested map using the array of strings, and cast the result to the provided class, or
