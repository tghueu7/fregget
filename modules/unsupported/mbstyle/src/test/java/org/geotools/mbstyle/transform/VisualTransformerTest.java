 ...
 * <p>
 * The first time you run a new test, the reference image must be generated. To do so, run the 
 * test with
...
public class VisualTransformerTest {
    ...
    public void setUp() throws Exception {
        ...
        FontCache.getDefaultInstance().registerFont(
                Font.createFont(Font.TRUETYPE_FONT, TestData.getResource(LabelShieldTest.class, 
                        "Vera.ttf")
                        .openStream()));
    ...
    /**
     * Test generation of a GeoTools style from an MBFillLayer (using a function-defined sprite 
     * fill pattern)
     */
    @Test
    ...
    public void mbSymbolLayerSpritesVisualTest() throws Exception {
        ...
        renderer.setMapContent(mc);
        renderer.setJava2DHints(new RenderingHints(KEY_ANTIALIASING, VALUE_ANTIALIAS_ON));
        BufferedImage image = MapboxTestUtils.showRender("Symbol Sprite Test", renderer, 
                DISPLAY_TIME,
                new ReferencedEnvelope[]{bounds}, null);
    ...
    public void mbSymbolLayerIconSizeVisualTest() throws Exception {
        ...
        renderer.setMapContent(mc);
        renderer.setJava2DHints(new RenderingHints(KEY_ANTIALIASING, VALUE_ANTIALIAS_ON));
        BufferedImage image = MapboxTestUtils.showRender("Symbol Sprite Icon Size Test", 
                renderer, DISPLAY_TIME,
                new ReferencedEnvelope[]{bounds}, null);
    ...
    public void mbSymbolLayerTextVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Symbol Text Test", "symbol-text", true, 
                300, 300);
    }
    ...
    public void mbSymbolLayerTextAndIconVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Symbol Text and Icon Test", 
                "symbol-text-icon", true, 450, 450);
    }
    ...
    public void mbSymbolLayerHaloTextVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Symbol Text Halo Test", 
                "symbol-halo-text", true, 300, 300);
    }
    ...
    public void mbSymbolLayerTextLinePlacementVisualTest() throws Exception {
        ...
        testVisualizeStyleWithLineFeatures(jsonObject, "Symbol Text Line Placement", 
                "symbol-text-line-placement", true);
    }
    ...
    public void mbSymbolLayerTextTransformVisualTest() throws Exception {
        // Read file to JSONObject
        JSONObject jsonObject = MapboxTestUtils.parseTestStyle("symbolTextTransformFunctionTest" +
                ".json");
        testVisualizeStyleWithLineFeatures(jsonObject, "Symbol Text Transform", 
                "symbol-text-transform", false);
    }
    ...
    public void mbSymbolLayerIconLinePlacementVisualTest() throws Exception {
        // Read file to JSONObject
        JSONObject jsonObject = MapboxTestUtils.parseTestStyle
                ("symbolStyleSimpleIconLinePlacementTest.json");
        testVisualizeStyleWithLineFeatures(jsonObject, "Symbol Icon Line Placement", 
                "symbol-icon-line-placement", true);
    }
    ...
    public void mbSymbolLayerIconAndTextLinePlacementVisualTest() throws Exception {
        ...
        testVisualizeStyleWithLineFeatures(jsonObject, "Symbol Text+Icon Line Placement", 
                "symbol-text-icon-line-placement", true);
    }
    ...
    public void mbSymbolLayerIconAndTextPointPlacementVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Symbol Text+Icon Point Placement", 
                "symbol-text-icon-point-placement", true, 300, 300);
    }
    ...
    public void mbCircleLayerVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Circle Style Test", "circle-style-test",
                true, 300, 300);
    }
    ...
    public void mbCircleLayerDefaultsVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Circle Style Test Defaults", 
                "circle-style-test-defaults", true, 300, 300);
    }
    ...
    public void mbCircleLayerOverlapVisualTest() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Circle Style Test Overlap", 
                "circle-style-test-overlap", true, 300, 300);
    }
    ...
    public void mbLineLayerSpriteTest() throws Exception {
        ...
        testVisualizeStyleWithLineFeatures(jsonObject, "Line Style w Sprite", 
                "line-style-sprite", true);
    }
    ...
    public void testDisplacementAsInterpolatedFunction() throws Exception {
        ...
        testVisualizeStyleWithPointFeatures(jsonObject, "Circle Style Test Displacement " +
                "Function", "circle-style-displacement-fn-test", true, 300, 300);
    }
...
//                screenSize, w2s);        
//        
//        JSONObject jsonObject = MapboxTestUtils.parseTestStyle("rasterStyleTestAllProperties
// .json");
//        MBStyle mbStyle = new MBStyle(jsonObject);
//        StyledLayerDescriptor sld = mbStyle.transform();
//        NamedLayer l = (NamedLayer) sld.layers().get(0);
//        Style style = l.getStyles()[0];
//        RasterSymbolizer s = (RasterSymbolizer)style.featureTypeStyles().get(0).getRules()[0]
// .getSymbolizers()[0];      
//
...
//    }
    ...
    public void testVisualizeStyleWithPointFeatures(JSONObject jsonStyle, String renderTitle, 
                                                    String renderComparisonFileName, boolean 
                                                            includeGrid, int width, int height) 
            throws Exception {
    ...
    public void testVisualizeStyleWithLineFeatures(JSONObject jsonStyle, String renderTitle, 
                                                   String renderComparisonFileName, boolean 
                                                           showLines) throws Exception {
        // Read file to JSONObject
    ...
    File file(String name) throws IOException {
        // The first time you run a new test, the reference image must be generated. To do so, 
        // run the test with
