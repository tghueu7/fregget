...
public class VisualTransformerTest {
  ...
  public void mbSymbolLayerIconAndTextLinePlacementVisualTest() throws Exception {
    // Read file to JSONObject
    JSONObject jsonObject =
        MapboxTestUtils.parseTestStyle("symbolStyleSimpleIconAndTextLinePlacementTest.json");
    testVisualizeStyleWithLineFeatures(
  ...
  public void mbSymbolLayerIconAndTextPointPlacementVisualTest() throws Exception {
    // Read file to JSONObject
    JSONObject jsonObject =
        MapboxTestUtils.parseTestStyle("symbolStyleSimpleIconAndTextPointPlacementTest.json");
    testVisualizeStyleWithPointFeatures(
        jsonObject,
  ...
  /**
   * Test visualization of a GeoTools style from an MB Symbol Layer, using included GeoTools (QGIS)
   * marks.
   */
  @Test
  ...
  public Style defaultLineStyle() {
    ...
    Stroke stroke =
        styleFactory.createStroke(filterFactory.literal(Color.BLACK), filterFactory.literal(1));
  ...
  public Style defaultPolyStyle() {
    ...
    Fill fill =
        styleFactory.createFill(filterFactory.literal(Color.BLACK), filterFactory.literal(1));
  ...
  File file(String name) throws IOException {
    ...
    return new File(
        "src/test/resources/org/geotools/mbstyle/transform/test-data/rendered/" + name + ".png");
  }
}
