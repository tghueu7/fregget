...
public class MBObjectParserTest {
  ...
  public void testColorFromFunction() throws ParseException {
    ...
    assertTrue(
        "Parse result must be a function", Function.class.isAssignableFrom(expression.getClass()));
  }
  ...
  public void testEnumToExpression() throws ParseException {
    ...
    expression =
        parser.enumToExpression(
            object, "line-join", LineMBLayer.LineJoin.class, LineMBLayer.LineJoin.MITER);
