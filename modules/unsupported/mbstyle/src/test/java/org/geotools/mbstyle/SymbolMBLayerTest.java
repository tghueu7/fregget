...
public class SymbolMBLayerTest {
    ...
    public void testTextMaxWidth() {
        ...
        assertEquals(160, testLayerDefault.getTextMaxWidth().intValue() * testLayerDefault
                .getTextSize().intValue());
        //Test generated MBStyle values
        assertEquals(100, testLayer.getTextMaxWidth().intValue() * testLayer.getTextSize()
                .intValue());
        //Test values in FeatureTypeStyle transform
        assertEquals("100.0", featureTypeTestValues.get(0).rules().get(0).getSymbolizers()[1]
                .getOptions().get("autoWrap"));
    }
    ...
    public void testTextMaxAngle() {
        ...
        // assertEquals("45.0", featureTypeDefaults.get(0).rules().get(0).getSymbolizers()[0]
        // .getOptions().get("maxAngleDelta"));
        // now null assertEquals("false", featureTypeDefaults.get(0).rules().get(0)
        // .getSymbolizers()[0].getOptions().get("followLine"));
        assertEquals("true", featureTypeLine.get(0).rules().get(0).getSymbolizers()[0].getOptions
                ().get("followLine"));
    }
    ...
    public void testTextKeepUpright() {
        ...
        assertEquals("false", featureTypeLine.get(0).rules().get(0).getSymbolizers()[0]
                .getOptions().get("forceLeftToRight"));
    ...
    public void testTextPadding() {
        ...
        assertEquals("20.0", featureTypePoint.get(0).rules().get(0).getSymbolizers()[1]
                .getOptions().get("spaceAround"));
    ...
    public void testIconPadding() {
        ...
        assertEquals("15.0", featureTypeLine.get(0).rules().get(0).getSymbolizers()[0].getOptions
                ().get("spaceAround"));
    }
    ...
    public void testTextFont() {
        ...
        assertEquals(true, ((JSONObject) fontLayer.getLayout().get("text-font")).containsKey
                ("stops"));
        assertEquals("Apple-Chancery", ((JSONArray) ((JSONArray) ((JSONArray) ((JSONObject) 
                fontLayer.getLayout().get("text-font")).get("stops")).get(0)).get(1)).get(0));
        assertEquals("Apple-Chancery", ((CategorizeFunction) ((TextSymbolizer) featureTypeFont
                .get(0).rules().get(0).getSymbolizers()[0]).fonts().get(0).getFamily().get(0))
                .getParameters().get(1).toString());
        System.out.println(((TextSymbolizer) featureTypeDefaults.get(0).rules().get(0)
                .getSymbolizers()[0]).fonts().get(0).getFamily());
        assertEquals("Open Sans Regular", ((TextSymbolizer) featureTypeDefaults.get(0).rules()
                .get(0).getSymbolizers()[0]).fonts().get(0).getFamily().get(0).toString());
    }
