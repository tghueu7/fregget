...
public class SymbolMBLayerTest {
  ...
  public void testTextMaxWidth() {
    ...
    assertEquals(
        160,
        testLayerDefault.getTextMaxWidth().intValue() * testLayerDefault.getTextSize().intValue());
  ...
  public void testTextMaxAngle() {
    ...
    assertEquals(
        "true",
        featureTypeLine.get(0).rules().get(0).getSymbolizers()[0].getOptions().get("followLine"));
  }
  ...
  public void testTextPadding() {
    ...
    assertEquals(
        "20.0",
        featureTypePoint.get(0).rules().get(0).getSymbolizers()[1].getOptions().get("spaceAround"));
  }
  ...
  public void testIconPadding() {
    ...
    assertEquals(
        "15.0",
        featureTypeLine.get(0).rules().get(0).getSymbolizers()[0].getOptions().get("spaceAround"));
  }
  ...
  public void testTextFont() {
    ...
    assertEquals(
        ...
        ((JSONArray)
                ((JSONArray)
                        ((JSONArray)
                                ((JSONObject) fontLayer.getLayout().get("text-font")).get("stops"))
                            .get(0))
                    .get(1))
            .get(0));
    assertEquals(
        "Apple-Chancery",
        ((CategorizeFunction)
                ((TextSymbolizer) featureTypeFont.get(0).rules().get(0).getSymbolizers()[0])
                    .fonts()
                    .get(0)
                    .getFamily()
                    .get(0))
