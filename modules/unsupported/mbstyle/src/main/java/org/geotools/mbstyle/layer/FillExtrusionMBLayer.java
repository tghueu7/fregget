...
public class FillExtrusionMBLayer extends MBLayer {
  ...
  public List<FeatureTypeStyle> transformInternal(MBStyle styleContext) {
    ...
    if (getFillExtrusionPattern() != null) {
      ...
      ExternalGraphic eg =
          transformer.createExternalGraphicForSprite(getFillExtrusionPattern(), styleContext);
      GraphicFill gf =
          sf.graphicFill(Arrays.asList(eg), fillExtrusionOpacity(), null, null, null, null);
