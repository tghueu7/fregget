...
public abstract class MBLayer {
     ...
     * <p>
     * <em>Paint properties</em> are applied later in the rendering process. A layer that shares 
     * layout
     * properties with another layer can have independent paint properties. Paint properties appear
     * in the layer's "paint" object.
     * </p>
     *
     * @return Default paint properties for this layer, or an empty {@link JSONObject} if no 
     ...
     * @return A feature type style from the provided layer, or null if the visibility of that 
     * layer is false.
     */
    public List<FeatureTypeStyle> transform(MBStyle styleContext, Double minScaleDenominator, 
        ...
        // (with the understanding that the list may be empty if the MBLayer does not contribute 
        // any content
