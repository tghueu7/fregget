...
/**
 * <p>
 * Wrapper for a "stop" in an array function (See {@link MBFunction#isArrayFunction()}), 
 * providing methods to access the stop key and stop value
 * array, as well as a method to reduce it from an array stop to a single-value stop (for a given
 * index).
 * </p>
 * <p>
 * <p>
 * For example, the following "stops" list contains two {@link MBArrayStop}s. (for each stop, the
 ...
 * <p>
 * <p>
 * Used by {@link MBFunction#splitArrayFunction()} to split an array function into multiple 
...
public class MBArrayStop {
     ...
     * <p>
     * <p>
     * For example, for the following {@link MBArrayStop}: <code>[1,   [0,10]]</code> the output 
     ...
     * <p>
     * <p>
     * For example, for the following {@link MBArrayStop}: <code>[0,   [0,10]]</code> the output 
     ...
     * <p>
     * <p>
     * For example, for the {@link MBArrayStop} <code>[0,   [0,10]]</code>, The output of stop
     * .reducedToIndex(1) is the following new stop:
     * <code>[0, 10]</code>
     * </p>
     *
