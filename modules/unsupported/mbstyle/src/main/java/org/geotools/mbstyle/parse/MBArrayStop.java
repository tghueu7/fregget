...
public class MBArrayStop {
   ...
   *
   * <p>For example, for the following {@link MBArrayStop}: <code>[1,   [0,10]]</code> the output of
   * stop.getStopKey() is 1.
   *
   * @return
   */
  ...
  /**
   * Returns the JSON for a new stop derived from this stop, but reduced to a single-value stop with
   * the value from the provided index.
   *
