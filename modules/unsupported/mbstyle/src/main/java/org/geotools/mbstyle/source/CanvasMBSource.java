 ...
 *
 * @see <a href="https://www.mapbox.com/mapbox-gl-js/style-spec/#sources-canvas">https://www
 * .mapbox.com/mapbox-gl-js/style-spec/#sources-canvas</a>
 */
public class CanvasMBSource extends MediaMBSource {
    ...
    /**
     * (Optional)  Defaults to true. Whether the canvas source is animated. If the canvas is 
     * static, animate should be set to false to improve performance.
     *
