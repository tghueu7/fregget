...
public abstract class TileMBSource extends MBSource {
  ...
  /**
   * (Optional) Defaults to 0. Minimum zoom level for which tiles are available, as in the TileJSON
   * spec.
   *
  ...
  /**
   * (Optional) Defaults to 22. Maximum zoom level for which tiles are available, as in the TileJSON
   * spec. Data from tiles at the maxzoom are used when displaying the map at higher zoom levels.
   *
