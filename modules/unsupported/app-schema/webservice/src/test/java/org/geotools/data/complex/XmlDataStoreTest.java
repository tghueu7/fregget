...
public class XmlDataStoreTest extends TestCase {
    ...
    public void testFeaturesCreatedCorrectly() throws Exception {
        ...
        for (int i = 0; i < EXPECTED_SIZE; i++) {
            ...
            assertEquals("urn:cgi:classifier:GSV:LithostratigraphicUnitRank:formation",
                    getUserDataForAttribute(at, new NameImpl("http://www.w3.org/1999/xlink", 
                            "href")));
            ...
            assertEquals(new NameImpl(FeatureChainingTest.GSMLNS, "observationMethod"), at
                    .getName());
            assertEquals(new NameImpl(FeatureChainingTest.GSMLNS, "CGI_TermValuePropertyType"), 
                    at.getDescriptor()
                    .getType().getName());
            ...
            assertEquals(new NameImpl(FeatureChainingTest.GSMLNS, "CGI_TermValueType"), ob
        ...
        assertTrue(at.getUserData() != null && ((Map) at.getUserData().get(Attributes.class))
                .size() == 1);
        assertEquals("gsv:NameSpace", getUserDataForAttribute(at, new NameImpl("codeSpace")));
    ...
    private String getExpectedFilter() {
        final String prefix = 
                "/soapenv:Envelope/soapenv:Body/qaz:getGeologicalFeaturesByFilterStringResponse" +
                        "/qaz:out/qaz:item/";
        return "[[ "
                + prefix
                ...
                + "[ "
                + prefix
                + "gss:urn[@domain='GSV'] = Unit Name1233811724109 UC1233811724109 description " +
                "name ]]";
    }
