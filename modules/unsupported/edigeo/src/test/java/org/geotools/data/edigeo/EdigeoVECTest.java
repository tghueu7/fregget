...
public class EdigeoVECTest extends TestCase {
    ...
    public void testGetType() {
        ...
        try {
            ...
            assertTrue("Face should be componed from at least one Arc", geoms.size() > 0 && geoms
                    .get(0).length > 1);
    ...
    public void testParseCoordinate() {
        ...
        assertTrue("coordinate should be an instance of Coordinate", coordinate instanceof 
                Coordinate);
    ...
    public void testCreateGeometry() {
        ...
        try {
            ...
            assertTrue("Coordinate list should contains at least two edges in order to construct " +
                            "a polygon",
                    coordList.size() > 1);
