...
public class EdigeoDataStore extends AbstractDataStore {
    ...
    public EdigeoDataStore(String path, String obj) throws IOException {
        ...
        EdigeoSCD scd = new EdigeoSCD(edigeoDir.getParentFile().getPath() + FS + thfmap.get
                ("scdfname"));
        HashMap<String, String> scdAtt = scd.readSCDFile(pciObj);

        if (!scdAtt.isEmpty()) {
            EdigeoDIC dic = new EdigeoDIC(edigeoDir.getParentFile().getPath() + FS + thfmap.get
                    ("dicfname"));
    ...
    protected FeatureReader<SimpleFeatureType, SimpleFeature> getFeatureReader(String typeName) 
        ...
        try {
            return new EdigeoFeatureReader(edigeoDir, thfmap.get("vecfname_" + fileExt), pciObj, 
    ...
    public static void main(String[] args) throws IllegalAttributeException {
        ...
        try {
            EdigeoDataStore edDS = new EdigeoDataStore
                    ("/home/mcoudert/app/geotools/geotools-2.5-M3/modules/unsupported/edigeo/src" +
                            "/test/resources/org/geotools/data/edigeo/test-data/E000AB01.THF", 
                            "COMMUNE_id");
            ...
            // /home/mcoudert/public_html/pvs/sample_data/pvs/edigeo2/com-029/feuille-029000AA01
            // /E000AA01.THF
            String typeName = edDS.getTypeNames()[0];
            //FeatureReader readerFR = edDS.getFeatureReader(typeName);
            //reader.
            FeatureSource<SimpleFeatureType, SimpleFeature> source = edDS.getFeatureSource
                    (typeName);
