...
public class WPSUtils {
     ...
     * @return the created DataType input object
     */
    public static DataType createInputDataType(Object obj, int type, String schema, String 
            mimeType) {
    ...
    public static Map<String, Parameter<?>> createInputParamMap(ProcessDescriptionType processDesc,
        ...
        while (iterator.hasNext()) {
            ...
            InternationalString description = Text.text(isAbstractNull(idt) ? "" : idt
                    .getAbstract().getValue());
            Parameter<?> param = new Parameter(identifier, type, title, description, required, 
                    idt.getMinOccurs().intValue(), idt.getMaxOccurs().intValue(), null, null);
    ...
    public static Map<String, Parameter<?>> createOutputParamMap(
        ...
        while (iterator.hasNext()) {
            ...
            // create the parameter
            InternationalString description = Text.text(isAbstractNull(odt) ? "" : odt
                    .getAbstract().getValue());
     ...
     */
    public static Map<String, Object> createResultMap(ExecuteResponseType ert, Map<String, 
            Object> map) {
        if (map == null) {
