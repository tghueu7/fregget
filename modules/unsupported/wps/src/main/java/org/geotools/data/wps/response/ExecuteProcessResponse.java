...
public class ExecuteProcessResponse extends Response {
  ...
  public ExecuteProcessResponse(HTTPResponse httpResponse, boolean raw)
    ...
    try {
      if (!raw) {
        ...
        // could be gml or other stuff, not necessarily a service exception, we need to check if
  ...
  /**
   * If a raw response was requested, and no service exception has been sent, we should get the raw
