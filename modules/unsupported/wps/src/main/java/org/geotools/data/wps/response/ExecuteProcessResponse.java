...
public class ExecuteProcessResponse extends Response {
     ...
     * @throws SAXException
     */
    public ExecuteProcessResponse(HTTPResponse httpResponse, boolean raw) throws IOException, 
            ServiceException {
        super(httpResponse);
            ...
            if (!raw) {
                ...
                if (rawContentType.matches(".*/xml.*")) {
                    ...
                    try {
                        ...
                        inputStream.reset();
                        if ("ServiceException".equals(name) || "ExceptionReport".equals(name) || 
    ...
    private void parseDocumentResponse(InputStream inputStream) throws IOException {
        ...
        if (object instanceof ExecuteResponseType) {
            ...
            if (exeResponse.getStatus() != null && exeResponse.getStatus().getProcessFailed() != 
                    null) {
