...
public class GeobufFeatureCollection {
    ...
    public void encode(SimpleFeatureCollection featureCollection, OutputStream out) throws 
            IOException {
    ...
    protected SimpleFeatureCollection decode(Geobuf.Data data) throws IOException {
        GeobufFeatureType geobufFeatureType = new GeobufFeatureType(
                geobufFeature.getGeobufGeometry().getPrecision(), geobufFeature.getGeobufGeometry
                ().getDimension());
    ...
    protected Geobuf.Data.FeatureCollection encodeAsFeatureCollection(SimpleFeatureCollection 
                                                                              featureCollection) {
        Geobuf.Data.FeatureCollection.Builder featureCollectionBuilder = Geobuf.Data
                .FeatureCollection.newBuilder();
    ...
    protected Geobuf.Data encode(SimpleFeatureCollection featureCollection) {
        ...
        for (AttributeDescriptor descriptor : featureCollection.getSchema()
    ...
    protected ReferencedEnvelope getBounds(InputStream in) throws IOException {
        ...
        if (data.getDataTypeCase() == Geobuf.Data.DataTypeCase.GEOMETRY) {
            ...
            return new ReferencedEnvelope(env.getMinX(), env.getMaxX(), env.getMinY(), env
                    .getMaxY(), null);
        } else if (data.getDataTypeCase() == Geobuf.Data.DataTypeCase.FEATURE) {
