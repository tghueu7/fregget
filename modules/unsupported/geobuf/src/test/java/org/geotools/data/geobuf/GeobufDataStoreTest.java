...
public class GeobufDataStoreTest {
    ...
    public void readPoints() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/points.pbf"));
        ...
        assertEquals("geom:Point,id:Integer,name:String", DataUtilities.encodeType(featureSource
                .getSchema()));
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    assertEquals("POINT (24.257813 49.61071)", feature.getDefaultGeometry()
                            .toString());
                    assertEquals(1, feature.getAttribute("id"));
                    assertEquals("number 1", feature.getAttribute("name"));
                } else if (c == 1) {
                    assertEquals("POINT (-92.460937 40.178873)", feature.getDefaultGeometry()
                            .toString());
    ...
    public void writePoints() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("test2", "geom:Point," +
                "name:String,id:int");
    ...
    public void readLineStrings() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/lines.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:LineString,id:Integer,name:String", DataUtilities.encodeType
        ...
        try {
            ...
            while (it.hasNext()) {
                SimpleFeature feature = it.next();
                if (c == 0) {
                    assertEquals("LINESTRING (94.570313 63.233627, 70.3125 58.263287, 47.460937 " +
                            "57.515823, " +
                            "24.609374 50.513427)", feature.getDefaultGeometry().toString());
                    assertEquals(1, feature.getAttribute("id"));
                    assertEquals("number 1", feature.getAttribute("name"));
                } else if (c == 1) {
                    assertEquals("LINESTRING (-89.296875 40.446947, -61.171875 20.303417, " +
                            "-47.460938 44.339565, " +
                            "-76.992188 58.447733, -107.226563 50.289339)", feature
                            .getDefaultGeometry().toString());
                    assertEquals(2, feature.getAttribute("id"));
                    assertEquals("number 2", feature.getAttribute("name"));
                } else if (c == 2) {
                    assertEquals("LINESTRING (-47.460938 -13.923404, 7.382812 8.407168)", feature
                            .getDefaultGeometry().toString());
    ...
    public void writeLineStrings() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("lines", "geom:LineString," +
                "name:String,id:int");
        store.createSchema(featureType);
        ...
        SimpleFeature feature1 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        gf.createLineString(new Coordinate[]{new Coordinate(0, 0), new Coordinate
                                (10, 10)}),
                        "ABC", 1
                },
                "location.1"
        ...
        SimpleFeature feature2 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        gf.createLineString(new Coordinate[]{new Coordinate(20, 20), new 
                                Coordinate(21, 21), new Coordinate(23, 23)}),
                        "DEF", 2
                },
                "location.2"
        );
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    ...
                    assertEquals("LINESTRING (20 20, 21 21, 23 23)", f.getDefaultGeometry()
                            .toString());
                    assertEquals("2", f.getAttribute("id"));
                    assertEquals("DEF", f.getAttribute("name"));
                }
    ...
    public void readPolygons() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/polygons.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:Polygon,id:Integer,name:String", DataUtilities.encodeType
                (featureSource.getSchema()));
        SimpleFeatureCollection featureCollection = featureSource.getFeatures();
        ...
        try {
            ...
            while (it.hasNext()) {
                SimpleFeature feature = it.next();
                if (c == 0) {
                    assertEquals("POLYGON ((59.0625 57.704147, 37.617187 24.527135, 98.789062 " +
                            "36.031332, " +
                            "59.062499 57.704147, 59.0625 57.704147))", feature
                            .getDefaultGeometry().toString());
                    assertEquals(1, feature.getAttribute("id"));
                    assertEquals("name 1", feature.getAttribute("name"));
                } else if (c == 1) {
                    assertEquals("POLYGON ((-72.773438 58.077876, -89.296876 17.644022, " +
                            "-37.265626 -2.460181, " +
                            "-2.109376 42.811522, -15.117189 60.413853, -50.976564 29.840645, " +
                            "-64.687502 39.909737, " +
                    ...
                    assertEquals("POLYGON ((12.65625 63.548552, 12.65625 69.534517, 29.179687 " +
                            "69.534517, " +
                            "29.179687 63.548552, 12.65625 63.548552))", feature
                            .getDefaultGeometry().toString());
                    assertEquals(3, feature.getAttribute("id"));
                    assertEquals("name 3", feature.getAttribute("name"));
                } else if (c == 3) {
                    assertEquals("POLYGON ((-22.5 67.875541, -22.5 73.124945, -8.789062 " +
                            "73.124945, " +
                            "-8.789062 67.875541, -22.5 67.875541))", feature.getDefaultGeometry
                            ().toString());
    ...
    public void writePolygons() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("lines", "geom:Polygon," +
                "name:String,id:int");
        store.createSchema(featureType);
        ...
        SimpleFeature feature1 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("POLYGON ((59.0625 57.704147, 37.617187 24.527135, 98.789062 " +
                                "36.031332, " +
        ...
        SimpleFeature feature2 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("POLYGON ((-72.773438 58.077876, -89.296876 17.644022, " +
                                "-37.265626 -2.460181, " +
                                "-2.109376 42.811522, -15.117189 60.413853, -50.976564 29.840645," +
                                " -64.687502 39.909737, " +
                                "-58.71094 56.365251, -72.77344 58.077877, -72.773438 58.077876))"),
        ...
        SimpleFeature feature3 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("POLYGON ((12.65625 63.548552, 12.65625 69.534517, 29.179687 " +
                                "69.534517, " +
        ...
        SimpleFeature feature4 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("POLYGON ((-22.5 67.875541, -22.5 73.124945, -8.789062 " +
                                "73.124945, " +
        ...
        SimpleFeatureCollection collection = DataUtilities.collection(new 
                SimpleFeature[]{feature1, feature2, feature3, feature4});
        featureStore.addFeatures(collection);
    ...
    public void readMultiPoints() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/multipoints.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:MultiPoint,id:Integer,name:String", DataUtilities.encodeType
                (featureSource.getSchema()));
        SimpleFeatureCollection featureCollection = featureSource.getFeatures();
        assertEquals(2, featureCollection.size());
        SimpleFeatureIterator it = featureCollection.features();
        try {
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    ...
                    assertEquals("MULTIPOINT ((100 0), (101 1))", feature.getDefaultGeometry()
                            .toString());
                    assertEquals(2, feature.getAttribute("id"));
                    assertEquals("number 2", feature.getAttribute("name"));
                }
    ...
    public void writeMultiPoints() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("test2", "geom:MultiPoint," +
                "name:String,id:int");
        store.createSchema(featureType);
        ...
        SimpleFeature feature1 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("MULTIPOINT ((24.257813 49.61071), (-92.460937 40.178873))"),
                        "ABC", 9
                },
                "location.1"
        );
    ...
    public void readMultiLineStrings() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/multilinestrings.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:MultiLineString,id:Integer,name:String", DataUtilities.encodeType
                (featureSource.getSchema()));
        SimpleFeatureCollection featureCollection = featureSource.getFeatures();
        assertEquals(2, featureCollection.size());
        SimpleFeatureIterator it = featureCollection.features();
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    assertEquals("MULTILINESTRING ((24.257813 49.61071, 45.12 67.45), " +
                            "(-92.460937 40.178873, 54.321 65.562))", feature.getDefaultGeometry
                            ().toString());
                    assertEquals(1, feature.getAttribute("id"));
                    assertEquals("number 1", feature.getAttribute("name"));
                } else if (c == 1) {
    ...
    public void writeMultiLineStrings() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("test2", "geom:MultiLineString," +
                "name:String,id:int");
        store.createSchema(featureType);
        SimpleFeatureStore featureStore = (SimpleFeatureStore) store.getFeatureSource
                ("multilinestrings");
        ...
        SimpleFeature feature1 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("MULTILINESTRING ((24.257813 49.61071, 45.12 67.45), " +
                                "(-92.460937 40.178873, 54.321 65.562))"), "ABC", 9
                },
                "location.1"
        );
        SimpleFeature feature2 = SimpleFeatureBuilder.build(
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    assertEquals("MULTILINESTRING ((24.257813 49.61071, 45.12 67.45), " +
                            "(-92.460937 40.178873, 54.321 65.562))", f.getDefaultGeometry()
                            .toString());
                    assertEquals("9", f.getAttribute("id"));
                    assertEquals("ABC", f.getAttribute("name"));
                } else if (c == 1) {
                    assertEquals("MULTILINESTRING ((100 0, 101 1), (102 2, 103 3))", f
                            .getDefaultGeometry().toString());
    ...
    public void readMultiPolygons() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/multipolygons.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:MultiPolygon,id:Integer,name:String", DataUtilities.encodeType
                (featureSource.getSchema()));
        SimpleFeatureCollection featureCollection = featureSource.getFeatures();
    ...
    public void writeMultiPolygons() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("test2", "geom:MultiPolygon," +
                "name:String,id:int");
        store.createSchema(featureType);
        SimpleFeatureStore featureStore = (SimpleFeatureStore) store.getFeatureSource
                ("multipolygons");
        ...
        SimpleFeatureCollection collection = DataUtilities.collection(new 
                SimpleFeature[]{feature1, feature2, feature3});
        featureStore.addFeatures(collection);
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (c == 0) {
                    assertEquals("MULTIPOLYGON (((102 2, 103 2, 103 3, 102 3, 102 2)), " +
                            "((102 2, 103 2, 103 3, 102 3, 102 2)), " +
                            "((102 2, 103 2, 103 3, 102 3, 102 2)))", f.getDefaultGeometry()
                            .toString());
                    assertEquals("9", f.getAttribute("id"));
                    assertEquals("ABC", f.getAttribute("name"));
                } else if (c == 1) {
                    ...
                    assertEquals("MULTIPOLYGON (((30 20, 45 40, 10 40, 30 20)), " +
                            "((15 5, 40 10, 10 20, 5 10, 15 5)))", f.getDefaultGeometry()
                            .toString());
    ...
    public void readGeometryCollections() throws Exception {
        File file = URLs.urlToFile(getClass().getClassLoader().getResource
                ("org/geotools/data/geobuf/geometrycollections.pbf"));
        Map<String, Serializable> params = new HashMap<>();
        params.put("file", file);
        DataStore store = DataStoreFinder.getDataStore(params);
        assertEquals(1, store.getTypeNames().length);
        ...
        assertEquals("geom:GeometryCollection,id:Integer,name:String", DataUtilities.encodeType
                (featureSource.getSchema()));
        SimpleFeatureCollection featureCollection = featureSource.getFeatures();
        assertEquals(1, featureCollection.size());
        SimpleFeatureIterator it = featureCollection.features();
    ...
    public void writeGeometryCollections() throws Exception {
        ...
        // Write
        SimpleFeatureType featureType = DataUtilities.createType("test2", 
                "geom:GeometryCollection,name:String,id:int");
        store.createSchema(featureType);
        SimpleFeatureStore featureStore = (SimpleFeatureStore) store.getFeatureSource
                ("geometrycollections");
        WKTReader reader = new WKTReader();
        SimpleFeature feature1 = SimpleFeatureBuilder.build(
                featureType, new Object[]{
                        reader.read("GEOMETRYCOLLECTION (POINT (100 0), LINESTRING (101 0, 102 1)" +
                                ")"), "ABC", 9
                },
                "location.1"
        );
