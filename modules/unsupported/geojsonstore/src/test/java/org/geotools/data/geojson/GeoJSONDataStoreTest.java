...
public class GeoJSONDataStoreTest {
    ...
    public void testSource() throws IOException {
        ...
        ReferencedEnvelope expected = new ReferencedEnvelope(-171.79111060289117, -66.96466, 
                18.916190000000142,
    ...
    public void testFeatures() throws IOException {
        ...
        assertEquals("com.vividsolutions.jts.geom.Point", schema.getGeometryDescriptor().getType
                ().getBinding().getCanonicalName());
        assertNotNull(schema);
        int count = 0;
        while (reader.hasNext()) {
