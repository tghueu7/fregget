...
public class ECQLExamples {
  ...
  private static void duringPredicateWithLefHandtExpression() throws Exception {
    ...
    Filter filter =
        ECQL.toFilter("2006-11-30T01:00:00Z DURING 2006-11-30T00:30:00Z/2006-11-30T01:30:00Z ");
  ...
  private static void duringPredicateWithLefHandtAttribute() throws Exception {
    ...
    During filter =
        (During) ECQL.toFilter("lastEarthQuake DURING 1700-01-01T00:00:00Z/2011-01-01T00:00:00Z");
  ...
  private static void comparisonUsingExpressions() throws Exception {
    ...
    Filter filter =
        ECQL.toFilter("(under18YearsOld * 19541453 / 100 ) < (over65YearsOld * 19541453 / 100 )");
  ...
  private static void betweenUsingExpression() throws Exception {
    ...
    Filter filter =
        ECQL.toFilter("area( Polygon((10 10, 20 10, 20 20, 10 10)) ) BETWEEN 10000 AND 30000");
